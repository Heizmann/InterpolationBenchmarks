...
(set-info :ultimate-id string_concat-noarr.i_AllErrorsAtOnce_Iteration1)
...
(assert (! (and (< main_~i~0_4 100) (= main_~j~0_6 0)) :named ssa_6))
(assert (! false :named ssa_7))
(assert (! (< main_~j~0_6 100) :named ssa_8))
(assert (! true :named ssa_9_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_9| (ite (< main_~i~0_4 200) 1 0)) :named ssa_9_LocVarAssigCall))
