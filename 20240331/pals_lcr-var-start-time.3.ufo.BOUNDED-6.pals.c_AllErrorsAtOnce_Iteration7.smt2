...
(set-info :ultimate-id pals_lcr-var-start-time.3.ufo.BOUNDED-6.pals.c_AllErrorsAtOnce_Iteration7)
...
(declare-fun v_main_~c1~0_13_fresh_1 () Int)
...
(declare-fun v_node1_~m1~0_24_fresh_1 () Int)
...
(declare-fun v_node2_~m2~0_24_fresh_1 () Int)
...
(declare-fun v_node3_~m3~0_24_fresh_1 () Int)
(declare-fun ~p2_old~0_46 () Int)
(declare-fun node3_~m3~0_46 () Int)
(declare-fun ~st3~0_50 () Int)
(declare-fun node3_~m3~0_50 () Int)
...
(assert (! (and (<= ~id2~0_4 127) (<= 0 (+ ~send2~0_4 128)) (<= ~id1~0_4 127) (<= 0 (+ ~send3~0_4 128)) (= v_main_~c1~0_13_fresh_1 0) (<= ~send3~0_4 127) (<= ~st2~0_4 127) (<= 0 (+ ~id3~0_4 128)) (<= ~r1~0_4 127) (<= ~st1~0_4 127) (<= 0 (+ 128 ~st3~0_4)) (<= 0 (+ 128 ~st2~0_4)) (<= 0 (+ ~r1~0_4 128)) (<= 0 (+ 128 ~st1~0_4)) (<= 0 (+ ~id2~0_4 128)) (<= ~id3~0_4 127) (<= ~st3~0_4 127) (<= 0 (+ ~send1~0_4 128)) (<= 0 (+ ~id1~0_4 128)) (<= ~send1~0_4 127) (<= ~send2~0_4 127)) :named ssa_4))
...
(assert (! (= ~nomsg~0_1 v_node1_~m1~0_24_fresh_1) :named ssa_31))
...
(assert (! (= ~nomsg~0_1 v_node2_~m2~0_24_fresh_1) :named ssa_38))
...
(assert (! (= ~nomsg~0_1 v_node3_~m3~0_24_fresh_1) :named ssa_45))
(assert (! (and (= ~nomsg~0_1 ~p2_old~0_46) (= ~p2_old~0_44 node3_~m3~0_46) (not (= (mod ~mode3~0_44 256) 0))) :named ssa_46))
(assert (! (not (= ~nomsg~0_1 node3_~m3~0_46)) :named ssa_47))
(assert (! (not (= (mod ~alive3~0_4 256) 0)) :named ssa_48))
(assert (! (<= node3_~m3~0_46 ~id3~0_4) :named ssa_49))
(assert (! (and (= ~st3~0_50 1) (= ~id3~0_4 node3_~m3~0_46)) :named ssa_50))
(assert (! (= ~mode3~0_51 0) :named ssa_51))
(assert (! true :named ssa_52))
(assert (! true :named ssa_53_return))
(assert (! (and (= ~p2_new~0_40 ~p2_old~0_54) (= ~nomsg~0_1 ~p1_new~0_54) (= ~p2_new~0_54 ~nomsg~0_1) (= ~p1_old~0_54 ~p1_new~0_30) (= ~nomsg~0_1 ~p3_new~0_54) (= ~p3_old~0_54 ~p3_new~0_44)) :named ssa_54))
...
(assert (! (and (< 1 (+ ~st1~0_30 ~st2~0_37 ~st3~0_50)) (= check_~tmp~1_57 0)) :named ssa_57))
...
(assert (! true :named ssa_precond))
(assert (! (not (<= (+ ~nomsg~0_-1 1) ~id3~0_-2)) :named ssa_postcond))
...
(declare-fun ~send1~0_-1 () Int)
(declare-fun ~nomsg~0_-1 () Int)
(declare-fun v_node1_~m1~0_25_fresh_1 () Int)
(declare-fun ~r1~0_1 () Int)
(declare-fun ~p3_old~0_1 () Int)
...
(assert (! (not (<= (+ ~p2_old~0_-2 1) ~id3~0_-2)) :named ssa_postcond))
(assert (! (= ~nomsg~0_-1 v_node1_~m1~0_25_fresh_1) :named ssa_0))
...
(assert (! (<= (+ ~p2_old~0_-2 1) ~id3~0_-2) :named ssa_-2_PendingContext))
(assert (! true :named ssa_-2_LocVarAssignPendingContext))
...
(declare-fun ~send2~0_-1 () Int)
(declare-fun ~nomsg~0_-1 () Int)
(declare-fun v_node2_~m2~0_25_fresh_1 () Int)
...
(assert (! (not (<= (+ ~p2_old~0_-2 1) ~id3~0_-2)) :named ssa_postcond))
(assert (! (= ~nomsg~0_-1 v_node2_~m2~0_25_fresh_1) :named ssa_0))
...
(declare-fun ~p2_old~0_-1 () Int)
(declare-fun ~nomsg~0_-1 () Int)
(declare-fun v_node3_~m3~0_25_fresh_1 () Int)
(declare-fun ~p2_old~0_1 () Int)
...
(assert (! (not false) :named ssa_postcond))
(assert (! (= ~nomsg~0_-1 v_node3_~m3~0_25_fresh_1) :named ssa_0))
