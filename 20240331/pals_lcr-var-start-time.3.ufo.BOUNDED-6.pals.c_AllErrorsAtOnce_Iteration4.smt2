...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:16:36+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id pals_lcr-var-start-time.3.ufo.BOUNDED-6.pals.c_AllErrorsAtOnce_Iteration4)
...
(declare-fun v_node1_~m1~0_18_fresh_1 () Int)
...
(declare-fun v_node2_~m2~0_18_fresh_1 () Int)
...
(declare-fun v_node3_~m3~0_18_fresh_1 () Int)
...
(assert (! (and (<= ~id2~0_4 127) (<= 0 (+ ~send2~0_4 128)) (<= ~id1~0_4 127) (<= 0 (+ ~send3~0_4 128)) (<= ~send3~0_4 127) (<= ~st2~0_4 127) (<= 0 (+ ~id3~0_4 128)) (<= ~r1~0_4 127) (<= ~st1~0_4 127) (<= 0 (+ 128 ~st3~0_4)) (<= 0 (+ 128 ~st2~0_4)) (<= 0 (+ ~r1~0_4 128)) (<= 0 (+ 128 ~st1~0_4)) (<= 0 (+ ~id2~0_4 128)) (= v_main_~c1~0_10_fresh_1 0) (<= ~id3~0_4 127) (<= ~st3~0_4 127) (<= 0 (+ ~send1~0_4 128)) (<= 0 (+ ~id1~0_4 128)) (<= ~send1~0_4 127) (<= ~send2~0_4 127)) :named ssa_4))
...
(assert (! (= ~nomsg~0_1 v_node1_~m1~0_18_fresh_1) :named ssa_31))
...
(assert (! (= ~nomsg~0_1 v_node2_~m2~0_18_fresh_1) :named ssa_38))
...
(assert (! (= ~nomsg~0_1 v_node3_~m3~0_18_fresh_1) :named ssa_45))
...
(assert (! true :named ssa_precond))
(assert (! (not (= |main_#t~ret20_19| 1)) :named ssa_postcond))
...
(declare-fun ~send1~0_-1 () Int)
(declare-fun ~nomsg~0_-1 () Int)
(declare-fun v_node1_~m1~0_19_fresh_1 () Int)
(declare-fun ~r1~0_1 () Int)
(declare-fun ~p3_old~0_1 () Int)
...
(assert (! (not true) :named ssa_postcond))
(assert (! (= ~nomsg~0_-1 v_node1_~m1~0_19_fresh_1) :named ssa_0))
...
(declare-fun ~send2~0_-1 () Int)
(declare-fun ~nomsg~0_-1 () Int)
(declare-fun v_node2_~m2~0_19_fresh_1 () Int)
...
(assert (! (not true) :named ssa_postcond))
(assert (! (= ~nomsg~0_-1 v_node2_~m2~0_19_fresh_1) :named ssa_0))
...
(declare-fun ~p2_old~0_-1 () Int)
(declare-fun ~nomsg~0_-1 () Int)
(declare-fun v_node3_~m3~0_19_fresh_1 () Int)
...
(assert (! (not true) :named ssa_postcond))
(assert (! (= ~nomsg~0_-1 v_node3_~m3~0_19_fresh_1) :named ssa_0))
...
(assert (! true :named ssa_precond))
(assert (! (not (not (= |main_#t~ret21_4| 0))) :named ssa_postcond))
(assert (! true :named ssa_0))
