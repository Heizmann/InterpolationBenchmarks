...
(set-info :ultimate-id bor1.i_AllErrorsAtOnce_Iteration4)
...
(assert (! (and (= main_~i~1_4 0) (< |#StackHeapBarrier_-1| |main_~#x~0.base_4|) (= |main_~#x~0.offset_4| 0) (not (= |main_~#x~0.base_4| 0)) (= (select |#valid_3| |main_~#x~0.base_4|) 0) (= 400 v_ArrVal_29_fresh_1) (= v_ArrVal_28_fresh_1 1) (= (store |#length_3| |main_~#x~0.base_4| v_ArrVal_29_fresh_1) |#length_4|) (= (store |#valid_3| |main_~#x~0.base_4| v_ArrVal_28_fresh_1) |#valid_4|)) :named ssa_4))
(assert (! (and (< main_~i~1_4 100) (<= 0 (+ |v_main_#t~nondet5_11_fresh_1| 2147483648)) (= (store (select |#memory_int#1_3| |main_~#x~0.base_4|) (+ (* main_~i~1_4 4) |main_~#x~0.offset_4|) |v_main_#t~nondet5_11_fresh_1|) v_ArrVal_30_fresh_1) (= |v_main_#t~nondet5_11_fresh_1| v_ArrVal_31_fresh_1) (= |#memory_int#1_5| (store |#memory_int#1_3| |main_~#x~0.base_4| v_ArrVal_30_fresh_1)) (<= |v_main_#t~nondet5_11_fresh_1| 2147483647) (= main_~i~1_5 (+ main_~i~1_4 1))) :named ssa_5))
(assert (! (and (< main_~i~1_5 100) (= |v_main_#t~nondet5_12_fresh_1| v_ArrVal_33_fresh_1) (= (store (select |#memory_int#1_5| |main_~#x~0.base_4|) (+ (* main_~i~1_5 4) |main_~#x~0.offset_4|) |v_main_#t~nondet5_12_fresh_1|) v_ArrVal_32_fresh_1) (= (store |#memory_int#1_5| |main_~#x~0.base_4| v_ArrVal_32_fresh_1) |#memory_int#1_6|) (<= 0 (+ |v_main_#t~nondet5_12_fresh_1| 2147483648)) (<= |v_main_#t~nondet5_12_fresh_1| 2147483647) (= main_~i~1_6 (+ main_~i~1_5 1))) :named ssa_6))
...
(assert (! (<= 100 bor_~i~0_13) :named ssa_14))
(assert (! (= |bor_#res_15| (ite (<= (mod bor_~res~0_13 4294967296) 2147483647) (mod bor_~res~0_13 4294967296) (+ (mod bor_~res~0_13 4294967296) (- 4294967296)))) :named ssa_15))
(assert (! (= |bor_#res_15| |main_#t~ret7_16|) :named ssa_16_return))
(assert (! (and (= (store |#memory_int#1_6| |main_~#x~0.base_4| v_ArrVal_34_fresh_1) |#memory_int#1_17|) (= v_main_~temp~0_9_fresh_1 v_ArrVal_36_fresh_1) (<= |main_#t~ret7_16| 2147483647) (= (store (store (select |#memory_int#1_6| |main_~#x~0.base_4|) |main_~#x~0.offset_4| (select (select |#memory_int#1_6| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4))) (+ |main_~#x~0.offset_4| 4) v_main_~temp~0_9_fresh_1) v_ArrVal_34_fresh_1) (= v_ArrVal_35_fresh_1 (select (select |#memory_int#1_6| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4))) (<= 0 (+ |main_#t~ret7_16| 2147483648)) (= v_main_~temp~0_9_fresh_1 (select (select |#memory_int#1_6| |main_~#x~0.base_4|) |main_~#x~0.offset_4|)) (= |main_#t~ret7_16| main_~ret~0_17)) :named ssa_17))
...
(assert (! (and (= bor_~i~0_19 1) (= bor_~x.offset_19 |bor_#in~x.offset_18|) (= bor_~x.base_19 |bor_#in~x.base_18|) (= (select (select |#memory_int#1_17| bor_~x.base_19) bor_~x.offset_19) bor_~res~0_19)) :named ssa_19))
(assert (! (and (< bor_~i~0_19 100) (= (select (select |#memory_int#1_17| bor_~x.base_19) (+ bor_~x.offset_19 (* 4 bor_~i~0_19))) |bor_#t~mem2_20|)) :named ssa_20))
...
(assert (! (= |bor_#res_24| |main_#t~ret10_25|) :named ssa_25_return))
(assert (! (and (<= |main_#t~ret10_25| 2147483647) (= main_~temp~0_26 (select (select |#memory_int#1_17| |main_~#x~0.base_4|) |main_~#x~0.offset_4|)) (= main_~i~2_26 0) (= main_~ret2~0_26 |main_#t~ret10_25|) (<= 0 (+ |main_#t~ret10_25| 2147483648))) :named ssa_26))
(assert (! (<= 99 main_~i~2_26) :named ssa_27))
(assert (! (and (= |#memory_int#1_28| (store |#memory_int#1_17| |main_~#x~0.base_4| v_ArrVal_37_fresh_1)) (= main_~temp~0_26 v_ArrVal_38_fresh_1) (= (store (select |#memory_int#1_17| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 396) main_~temp~0_26) v_ArrVal_37_fresh_1)) :named ssa_28))
(assert (! true :named ssa_29_GlobVarAssigCall))
(assert (! (and (= |bor_#in~x.offset_29| |main_~#x~0.offset_4|) (= |main_~#x~0.base_4| |bor_#in~x.base_29|)) :named ssa_29_LocVarAssigCall))
...
(assert (! (= |bor_#res_35| |main_#t~ret14_36|) :named ssa_36_return))
(assert (! (and (= main_~ret5~0_37 |main_#t~ret14_36|) (<= |main_#t~ret14_36| 2147483647) (<= 0 (+ |main_#t~ret14_36| 2147483648))) :named ssa_37))
(assert (! (or (not (= main_~ret5~0_37 main_~ret~0_17)) (not (= main_~ret2~0_26 main_~ret~0_17))) :named ssa_38))
...
(declare-fun bor_~i~0_4 () Int)
(declare-fun bor_~res~0_5 () Int)
(declare-fun |bor_#res_5| () Int)
(declare-fun |main_#t~ret7_6| () Int)
(declare-fun |bor_#res_6| () Int)
(assert (! true :named ssa_precond))
(assert (! (not false) :named ssa_postcond))
...
(assert (! (<= 100 bor_~i~0_3) :named ssa_4))
(assert (! (= |bor_#res_5| (ite (<= (mod bor_~res~0_3 4294967296) 2147483647) (mod bor_~res~0_3 4294967296) (+ (mod bor_~res~0_3 4294967296) (- 4294967296)))) :named ssa_5))
(assert (! (= |bor_#res_5| |main_#t~ret7_6|) :named ssa_6_return))
(assert (! true :named ssa_-2_PendingContext))
...
(assert (! (<= 100 bor_~i~0_3) :named ssa_4))
(assert (! (= |bor_#res_5| (ite (<= (mod bor_~res~0_3 4294967296) 2147483647) (mod bor_~res~0_3 4294967296) (+ (mod bor_~res~0_3 4294967296) (- 4294967296)))) :named ssa_5))
(assert (! (= |bor_#res_5| |main_#t~ret10_6|) :named ssa_6_return))
...
(assert (! (<= 100 bor_~i~0_3) :named ssa_4))
(assert (! (= |bor_#res_5| (ite (<= (mod bor_~res~0_3 4294967296) 2147483647) (mod bor_~res~0_3 4294967296) (+ (mod bor_~res~0_3 4294967296) (- 4294967296)))) :named ssa_5))
(assert (! (= |bor_#res_5| |main_#t~ret14_6|) :named ssa_6_return))
(assert (! false :named ssa_-2_PendingContext))
