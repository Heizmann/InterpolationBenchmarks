...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:10:55+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id benchmark43_conjunctive.i_AllErrorsAtOnce_Iteration2)
...
(assert (! (and (< 0 |#StackHeapBarrier_-1|) (= (select |#valid_-1| 2) 1) (= (select |#valid_-1| 1) 1) (= (select (select |#memory_int#0_-1| 1) 1) 0) (= (select |#length_-1| 1) 2) (= (select (select |#memory_int#0_-1| 1) 0) 48) (= (select |#length_-1| 2) 26) (= (select |#valid_-1| 0) 0)) :named ssa_1))
(assert (! true :named ssa_2_return))
(assert (! true :named ssa_3_GlobVarAssigCall))
(assert (! true :named ssa_3_LocVarAssigCall))
(assert (! true :named ssa_3_OldVarAssigCall))
(assert (! (and (<= main_~y~0_4 2147483647) (<= 0 (+ main_~y~0_4 2147483648)) (<= 0 (+ main_~x~0_4 2147483648)) (<= main_~x~0_4 2147483647)) :named ssa_4))
(assert (! (and (< main_~x~0_4 100) (< main_~y~0_4 100)) :named ssa_5))
(assert (! (and (< main_~x~0_4 100) (= (+ main_~x~0_4 1) main_~x~0_6) (= main_~y~0_6 (+ main_~y~0_4 1)) (< main_~y~0_4 100)) :named ssa_6))
(assert (! (or (<= 100 main_~y~0_6) (<= 100 main_~x~0_6)) :named ssa_7))
(assert (! true :named ssa_8_GlobVarAssigCall))
(assert (! (= (ite (or (= main_~x~0_6 100) (= main_~y~0_6 100)) 1 0) |__VERIFIER_assert_#in~cond_8|) :named ssa_8_LocVarAssigCall))
...
(assert (! (and (< 0 |#StackHeapBarrier_-1|) (= (select |#valid_-1| 2) 1) (= (select |#valid_-1| 1) 1) (= (select (select |#memory_int#0_-1| 1) 1) 0) (= (select |#length_-1| 1) 2) (= (select (select |#memory_int#0_-1| 1) 0) 48) (= (select |#length_-1| 2) 26) (= (select |#valid_-1| 0) 0)) :named ssa_0))
