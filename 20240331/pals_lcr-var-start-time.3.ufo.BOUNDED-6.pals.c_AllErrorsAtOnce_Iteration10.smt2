...
(set-info :ultimate-id pals_lcr-var-start-time.3.ufo.BOUNDED-6.pals.c_AllErrorsAtOnce_Iteration10)
...
(declare-fun v_main_~c1~0_16_fresh_1 () Int)
...
(declare-fun v_node1_~m1~0_32_fresh_1 () Int)
...
(declare-fun v_node2_~m2~0_32_fresh_1 () Int)
...
(declare-fun v_node3_~m3~0_32_fresh_1 () Int)
...
(declare-fun v_node1_~m1~0_33_fresh_1 () Int)
...
(declare-fun v_node2_~m2~0_33_fresh_1 () Int)
...
(declare-fun v_node3_~m3~0_33_fresh_1 () Int)
(declare-fun ~p2_old~0_82 () Int)
(declare-fun node3_~m3~0_82 () Int)
(declare-fun ~st3~0_86 () Int)
(declare-fun node3_~m3~0_86 () Int)
...
(assert (! (and (<= ~id2~0_4 127) (<= 0 (+ ~send2~0_4 128)) (<= ~id1~0_4 127) (<= 0 (+ ~send3~0_4 128)) (<= ~send3~0_4 127) (<= ~st2~0_4 127) (<= 0 (+ ~id3~0_4 128)) (<= ~r1~0_4 127) (<= ~st1~0_4 127) (<= 0 (+ 128 ~st3~0_4)) (<= 0 (+ 128 ~st2~0_4)) (<= 0 (+ ~r1~0_4 128)) (<= 0 (+ 128 ~st1~0_4)) (<= 0 (+ ~id2~0_4 128)) (<= ~id3~0_4 127) (<= ~st3~0_4 127) (= v_main_~c1~0_16_fresh_1 0) (<= 0 (+ ~send1~0_4 128)) (<= 0 (+ ~id1~0_4 128)) (<= ~send1~0_4 127) (<= ~send2~0_4 127)) :named ssa_4))
...
(assert (! (= ~nomsg~0_1 v_node1_~m1~0_32_fresh_1) :named ssa_31))
...
(assert (! (= ~nomsg~0_1 v_node2_~m2~0_32_fresh_1) :named ssa_38))
...
(assert (! (= ~nomsg~0_1 v_node3_~m3~0_32_fresh_1) :named ssa_45))
...
(assert (! (= ~nomsg~0_1 v_node1_~m1~0_33_fresh_1) :named ssa_67))
...
(assert (! (= ~nomsg~0_1 v_node2_~m2~0_33_fresh_1) :named ssa_74))
...
(assert (! (= ~nomsg~0_1 v_node3_~m3~0_33_fresh_1) :named ssa_81))
(assert (! (and (= ~nomsg~0_1 ~p2_old~0_82) (= ~p2_old~0_80 node3_~m3~0_82) (not (= (mod ~mode3~0_80 256) 0))) :named ssa_82))
(assert (! (not (= ~nomsg~0_1 node3_~m3~0_82)) :named ssa_83))
(assert (! (not (= (mod ~alive3~0_4 256) 0)) :named ssa_84))
(assert (! (<= node3_~m3~0_82 ~id3~0_4) :named ssa_85))
(assert (! (and (= ~st3~0_86 1) (= ~id3~0_4 node3_~m3~0_82)) :named ssa_86))
(assert (! (= ~mode3~0_87 0) :named ssa_87))
(assert (! true :named ssa_88))
(assert (! true :named ssa_89_return))
(assert (! (and (= ~p2_new~0_76 ~p2_old~0_90) (= ~nomsg~0_1 ~p1_new~0_90) (= ~p2_new~0_90 ~nomsg~0_1) (= ~p1_old~0_90 ~p1_new~0_69) (= ~nomsg~0_1 ~p3_new~0_90) (= ~p3_old~0_90 ~p3_new~0_80)) :named ssa_90))
...
(assert (! (and (< 1 (+ ~st1~0_66 ~st2~0_73 ~st3~0_86)) (= check_~tmp~1_93 0)) :named ssa_93))
...
(assert (! true :named ssa_precond))
(assert (! (not (<= (+ ~st2~0_-2 ~st1~0_-2) 0)) :named ssa_postcond))
...
(declare-fun ~send1~0_-1 () Int)
(declare-fun ~nomsg~0_-1 () Int)
(declare-fun v_node1_~m1~0_34_fresh_1 () Int)
(declare-fun ~r1~0_1 () Int)
(declare-fun ~p3_old~0_1 () Int)
...
(assert (! (not (<= (+ ~st2~0_-2 ~st1~0_-1) 0)) :named ssa_postcond))
(assert (! (= ~nomsg~0_-1 v_node1_~m1~0_34_fresh_1) :named ssa_0))
...
(assert (! (<= (+ ~st2~0_-2 ~st1~0_-2) 0) :named ssa_-2_PendingContext))
(assert (! true :named ssa_-2_LocVarAssignPendingContext))
...
(declare-fun ~send2~0_-1 () Int)
(declare-fun ~nomsg~0_-1 () Int)
(declare-fun v_node2_~m2~0_34_fresh_1 () Int)
...
(assert (! (not (<= (+ ~st2~0_-1 ~st1~0_-2) 0)) :named ssa_postcond))
(assert (! (= ~nomsg~0_-1 v_node2_~m2~0_34_fresh_1) :named ssa_0))
...
(declare-fun ~p2_old~0_-1 () Int)
(declare-fun ~nomsg~0_-1 () Int)
(declare-fun v_node3_~m3~0_34_fresh_1 () Int)
...
(assert (! (not (<= (+ ~st2~0_-2 ~st1~0_-2) 0)) :named ssa_postcond))
(assert (! (= ~nomsg~0_-1 v_node3_~m3~0_34_fresh_1) :named ssa_0))
...
(declare-fun ~send1~0_-1 () Int)
(declare-fun ~nomsg~0_-1 () Int)
(declare-fun v_node1_~m1~0_35_fresh_1 () Int)
(declare-fun ~p1_new~0_2 () Int)
(declare-fun ~mode1~0_3 () Int)
(assert (! (and (= |old(~p1_new~0)_-1| ~p1_new~0_-1) (= ~r1~0_-1 |old(~r1~0)_-1|) (= ~send1~0_-1 |old(~send1~0)_-1|) (= |old(~st1~0)_-1| ~st1~0_-1) (= |old(~mode1~0)_-1| ~mode1~0_-1) (= ~p3_old~0_-1 |old(~p3_old~0)_-1|)) :named ssa_precond))
(assert (! (not (<= (+ ~st2~0_-2 ~st1~0_-1) 0)) :named ssa_postcond))
(assert (! (= ~nomsg~0_-1 v_node1_~m1~0_35_fresh_1) :named ssa_0))
...
(declare-fun ~send2~0_-1 () Int)
(declare-fun ~nomsg~0_-1 () Int)
(declare-fun v_node2_~m2~0_35_fresh_1 () Int)
(declare-fun ~p2_new~0_2 () Int)
(declare-fun ~mode2~0_3 () Int)
(assert (! (and (= ~p1_old~0_-1 |old(~p1_old~0)_-1|) (= |old(~mode2~0)_-1| ~mode2~0_-1) (= ~send2~0_-1 |old(~send2~0)_-1|) (= |old(~p2_new~0)_-1| ~p2_new~0_-1) (= |old(~st2~0)_-1| ~st2~0_-1)) :named ssa_precond))
(assert (! (not (<= (+ ~st2~0_-1 ~st1~0_-2) 0)) :named ssa_postcond))
(assert (! (= ~nomsg~0_-1 v_node2_~m2~0_35_fresh_1) :named ssa_0))
(assert (! (= (mod ~mode2~0_-1 256) 0) :named ssa_1))
(assert (! (and (= ~p2_new~0_2 (ite (<= (mod (ite (and (not (= ~send2~0_-1 ~nomsg~0_-1)) (= ~p2_new~0_-1 ~nomsg~0_-1)) ~send2~0_-1 ~p2_new~0_-1) 256) 127) (mod (ite (and (not (= ~send2~0_-1 ~nomsg~0_-1)) (= ~p2_new~0_-1 ~nomsg~0_-1)) ~send2~0_-1 ~p2_new~0_-1) 256) (+ (- 256) (mod (ite (and (not (= ~send2~0_-1 ~nomsg~0_-1)) (= ~p2_new~0_-1 ~nomsg~0_-1)) ~send2~0_-1 ~p2_new~0_-1) 256)))) (not (= (mod ~alive2~0_-2 256) 0))) :named ssa_2))
(assert (! (= ~mode2~0_3 1) :named ssa_3))
(assert (! true :named ssa_4))
...
(declare-fun ~p2_old~0_-1 () Int)
(declare-fun ~nomsg~0_-1 () Int)
(declare-fun v_node3_~m3~0_35_fresh_1 () Int)
(declare-fun ~p2_old~0_1 () Int)
(declare-fun node3_~m3~0_1 () Int)
(declare-fun ~st3~0_5 () Int)
(declare-fun node3_~m3~0_5 () Int)
(declare-fun ~mode3~0_6 () Int)
(assert (! (and (= |old(~p2_old~0)_-1| ~p2_old~0_-1) (= ~p3_new~0_-1 |old(~p3_new~0)_-1|) (= |old(~mode3~0)_-1| ~mode3~0_-1) (= ~send3~0_-1 |old(~send3~0)_-1|) (= |old(~st3~0)_-1| ~st3~0_-1)) :named ssa_precond))
(assert (! (not (and (= ~st3~0_5 1) (<= (+ ~st2~0_-2 ~st1~0_-2) 0))) :named ssa_postcond))
(assert (! (= ~nomsg~0_-1 v_node3_~m3~0_35_fresh_1) :named ssa_0))
(assert (! (and (= ~nomsg~0_-1 ~p2_old~0_1) (= ~p2_old~0_-1 node3_~m3~0_1) (not (= (mod ~mode3~0_-1 256) 0))) :named ssa_1))
(assert (! (not (= ~nomsg~0_-1 node3_~m3~0_1)) :named ssa_2))
(assert (! (not (= (mod ~alive3~0_-2 256) 0)) :named ssa_3))
(assert (! (<= node3_~m3~0_1 ~id3~0_-2) :named ssa_4))
(assert (! (and (= ~st3~0_5 1) (= ~id3~0_-2 node3_~m3~0_1)) :named ssa_5))
(assert (! (= ~mode3~0_6 0) :named ssa_6))
...
(assert (! (and (= ~st3~0_-2 1) (<= (+ ~st2~0_-2 ~st1~0_-2) 0)) :named ssa_-2_PendingContext))
(assert (! true :named ssa_-2_LocVarAssignPendingContext))
(assert (! true :named ssa_-2_OldVarAssignPendingContext))
(check-sat)
(get-interpolants (and ssa_0 ssa_precond) ssa_1 ssa_2 (and ssa_-2_PendingContext ssa_3_return ssa_-2_LocVarAssignPendingContext ssa_-2_OldVarAssignPendingContext ssa_postcond))
