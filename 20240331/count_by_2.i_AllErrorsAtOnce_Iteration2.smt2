...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration2)
...
(assert (! (<= 1000000 main_~i~0_5) :named ssa_6))
(assert (! true :named ssa_7_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_7| (ite (= main_~i~0_5 1000000) 1 0)) :named ssa_7_LocVarAssigCall))
