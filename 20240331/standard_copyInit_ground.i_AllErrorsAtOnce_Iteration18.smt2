...
(set-info :ultimate-id standard_copyInit_ground.i_AllErrorsAtOnce_Iteration18)
...
(assert (! (and (= |#valid_4| (store (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_550_fresh_1) |main_~#b~0.base_4| v_ArrVal_552_fresh_1)) (= main_~i~0_4 0) (< |#StackHeapBarrier_-1| |main_~#a~0.base_4|) (= v_ArrVal_552_fresh_1 1) (= |main_~#b~0.offset_4| 0) (= v_ArrVal_549_fresh_1 400000) (not (= |main_~#a~0.base_4| 0)) (not (= |main_~#b~0.base_4| 0)) (= |#length_4| (store (store |#length_3| |main_~#a~0.base_4| v_ArrVal_551_fresh_1) |main_~#b~0.base_4| v_ArrVal_549_fresh_1)) (= |main_~#a~0.offset_4| 0) (= v_ArrVal_550_fresh_1 1) (= v_ArrVal_551_fresh_1 400000) (< |#StackHeapBarrier_-1| |main_~#b~0.base_4|) (= (select (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_550_fresh_1) |main_~#b~0.base_4|) 0) (= (select |#valid_3| |main_~#a~0.base_4|) 0)) :named ssa_4))
(assert (! (and (< main_~i~0_4 100000) (= v_ArrVal_553_fresh_1 (store (select |#memory_int#2_3| |main_~#a~0.base_4|) (+ (* main_~i~0_4 4) |main_~#a~0.offset_4|) 42)) (= (store |#memory_int#2_3| |main_~#a~0.base_4| v_ArrVal_553_fresh_1) |#memory_int#2_5|) (= main_~i~0_5 (+ main_~i~0_4 1)) (= v_ArrVal_554_fresh_1 42)) :named ssa_5))
(assert (! (and (= (store |#memory_int#2_5| |main_~#a~0.base_4| v_ArrVal_555_fresh_1) |#memory_int#2_6|) (< main_~i~0_5 100000) (= main_~i~0_6 (+ main_~i~0_5 1)) (= v_ArrVal_556_fresh_1 42) (= v_ArrVal_555_fresh_1 (store (select |#memory_int#2_5| |main_~#a~0.base_4|) (+ (* main_~i~0_5 4) |main_~#a~0.offset_4|) 42))) :named ssa_6))
(assert (! (and (= v_ArrVal_558_fresh_1 42) (< main_~i~0_6 100000) (= (store |#memory_int#2_6| |main_~#a~0.base_4| v_ArrVal_557_fresh_1) |#memory_int#2_7|) (= main_~i~0_7 (+ main_~i~0_6 1)) (= v_ArrVal_557_fresh_1 (store (select |#memory_int#2_6| |main_~#a~0.base_4|) (+ (* main_~i~0_6 4) |main_~#a~0.offset_4|) 42))) :named ssa_7))
(assert (! (and (< main_~i~0_7 100000) (= v_ArrVal_559_fresh_1 (store (select |#memory_int#2_7| |main_~#a~0.base_4|) (+ (* main_~i~0_7 4) |main_~#a~0.offset_4|) 42)) (= main_~i~0_8 (+ main_~i~0_7 1)) (= |#memory_int#2_8| (store |#memory_int#2_7| |main_~#a~0.base_4| v_ArrVal_559_fresh_1)) (= v_ArrVal_560_fresh_1 42)) :named ssa_8))
(assert (! (and (= v_ArrVal_561_fresh_1 (store (select |#memory_int#2_8| |main_~#a~0.base_4|) (+ (* main_~i~0_8 4) |main_~#a~0.offset_4|) 42)) (= (store |#memory_int#2_8| |main_~#a~0.base_4| v_ArrVal_561_fresh_1) |#memory_int#2_9|) (< main_~i~0_8 100000) (= main_~i~0_9 (+ main_~i~0_8 1)) (= v_ArrVal_562_fresh_1 42)) :named ssa_9))
(assert (! (and (= v_ArrVal_564_fresh_1 42) (< main_~i~0_9 100000) (= v_ArrVal_563_fresh_1 (store (select |#memory_int#2_9| |main_~#a~0.base_4|) (+ (* main_~i~0_9 4) |main_~#a~0.offset_4|) 42)) (= main_~i~0_10 (+ main_~i~0_9 1)) (= (store |#memory_int#2_9| |main_~#a~0.base_4| v_ArrVal_563_fresh_1) |#memory_int#2_10|)) :named ssa_10))
(assert (! (and (= v_ArrVal_565_fresh_1 (store (select |#memory_int#2_10| |main_~#a~0.base_4|) (+ (* main_~i~0_10 4) |main_~#a~0.offset_4|) 42)) (= v_ArrVal_566_fresh_1 42) (< main_~i~0_10 100000) (= (store |#memory_int#2_10| |main_~#a~0.base_4| v_ArrVal_565_fresh_1) |#memory_int#2_11|) (= main_~i~0_11 (+ main_~i~0_10 1))) :named ssa_11))
(assert (! (and (= (store |#memory_int#2_11| |main_~#a~0.base_4| v_ArrVal_567_fresh_1) |#memory_int#2_12|) (= v_ArrVal_568_fresh_1 42) (< main_~i~0_11 100000) (= v_ArrVal_567_fresh_1 (store (select |#memory_int#2_11| |main_~#a~0.base_4|) (+ (* main_~i~0_11 4) |main_~#a~0.offset_4|) 42)) (= main_~i~0_12 (+ main_~i~0_11 1))) :named ssa_12))
(assert (! (and (= v_ArrVal_569_fresh_1 (store (select |#memory_int#2_12| |main_~#a~0.base_4|) (+ (* main_~i~0_12 4) |main_~#a~0.offset_4|) 42)) (= (store |#memory_int#2_12| |main_~#a~0.base_4| v_ArrVal_569_fresh_1) |#memory_int#2_13|) (= v_ArrVal_570_fresh_1 42) (< main_~i~0_12 100000) (= main_~i~0_13 (+ main_~i~0_12 1))) :named ssa_13))
(assert (! (and (= v_ArrVal_572_fresh_1 42) (= (store |#memory_int#2_13| |main_~#a~0.base_4| v_ArrVal_571_fresh_1) |#memory_int#2_14|) (< main_~i~0_13 100000) (= main_~i~0_14 (+ main_~i~0_13 1)) (= v_ArrVal_571_fresh_1 (store (select |#memory_int#2_13| |main_~#a~0.base_4|) (+ (* main_~i~0_13 4) |main_~#a~0.offset_4|) 42))) :named ssa_14))
(assert (! (and (< main_~i~0_14 100000) (= v_ArrVal_574_fresh_1 42) (= (store |#memory_int#2_14| |main_~#a~0.base_4| v_ArrVal_573_fresh_1) |#memory_int#2_15|) (= main_~i~0_15 (+ main_~i~0_14 1)) (= v_ArrVal_573_fresh_1 (store (select |#memory_int#2_14| |main_~#a~0.base_4|) (+ (* main_~i~0_14 4) |main_~#a~0.offset_4|) 42))) :named ssa_15))
(assert (! (and (< main_~i~0_15 100000) (= |#memory_int#2_16| (store |#memory_int#2_15| |main_~#a~0.base_4| v_ArrVal_575_fresh_1)) (= main_~i~0_16 (+ main_~i~0_15 1)) (= v_ArrVal_575_fresh_1 (store (select |#memory_int#2_15| |main_~#a~0.base_4|) (+ (* main_~i~0_15 4) |main_~#a~0.offset_4|) 42)) (= v_ArrVal_576_fresh_1 42)) :named ssa_16))
(assert (! (and (= v_ArrVal_577_fresh_1 (store (select |#memory_int#2_16| |main_~#a~0.base_4|) (+ (* main_~i~0_16 4) |main_~#a~0.offset_4|) 42)) (= v_ArrVal_578_fresh_1 42) (= |#memory_int#2_17| (store |#memory_int#2_16| |main_~#a~0.base_4| v_ArrVal_577_fresh_1)) (< main_~i~0_16 100000) (= main_~i~0_17 (+ main_~i~0_16 1))) :named ssa_17))
(assert (! (and (= (store |#memory_int#2_17| |main_~#a~0.base_4| v_ArrVal_579_fresh_1) |#memory_int#2_18|) (< main_~i~0_17 100000) (= v_ArrVal_580_fresh_1 42) (= v_ArrVal_579_fresh_1 (store (select |#memory_int#2_17| |main_~#a~0.base_4|) (+ (* main_~i~0_17 4) |main_~#a~0.offset_4|) 42)) (= main_~i~0_18 (+ main_~i~0_17 1))) :named ssa_18))
(assert (! (and (= v_ArrVal_582_fresh_1 42) (< main_~i~0_18 100000) (= |#memory_int#2_19| (store |#memory_int#2_18| |main_~#a~0.base_4| v_ArrVal_581_fresh_1)) (= main_~i~0_19 (+ main_~i~0_18 1)) (= v_ArrVal_581_fresh_1 (store (select |#memory_int#2_18| |main_~#a~0.base_4|) (+ (* main_~i~0_18 4) |main_~#a~0.offset_4|) 42))) :named ssa_19))
(assert (! (and (< main_~i~0_19 100000) (= v_ArrVal_584_fresh_1 42) (= (store |#memory_int#2_19| |main_~#a~0.base_4| v_ArrVal_583_fresh_1) |#memory_int#2_20|) (= v_ArrVal_583_fresh_1 (store (select |#memory_int#2_19| |main_~#a~0.base_4|) (+ (* main_~i~0_19 4) |main_~#a~0.offset_4|) 42)) (= main_~i~0_20 (+ main_~i~0_19 1))) :named ssa_20))
(assert (! (<= 100000 main_~i~0_20) :named ssa_21))
(assert (! (= main_~i~0_22 0) :named ssa_22))
(assert (! (and (= v_ArrVal_585_fresh_1 (select (select |#memory_int#2_20| |main_~#a~0.base_4|) (+ (* main_~i~0_22 4) |main_~#a~0.offset_4|))) (= v_ArrVal_586_fresh_1 (store (select |#memory_int#1_3| |main_~#b~0.base_4|) (+ (* main_~i~0_22 4) |main_~#b~0.offset_4|) v_ArrVal_585_fresh_1)) (= |#memory_int#1_23| (store |#memory_int#1_3| |main_~#b~0.base_4| v_ArrVal_586_fresh_1)) (< main_~i~0_22 100000) (= main_~i~0_23 (+ main_~i~0_22 1))) :named ssa_23))
(assert (! (and (= v_ArrVal_587_fresh_1 (select (select |#memory_int#2_20| |main_~#a~0.base_4|) (+ (* main_~i~0_23 4) |main_~#a~0.offset_4|))) (= (store |#memory_int#1_23| |main_~#b~0.base_4| v_ArrVal_588_fresh_1) |#memory_int#1_24|) (< main_~i~0_23 100000) (= main_~i~0_24 (+ main_~i~0_23 1)) (= v_ArrVal_588_fresh_1 (store (select |#memory_int#1_23| |main_~#b~0.base_4|) (+ (* main_~i~0_23 4) |main_~#b~0.offset_4|) v_ArrVal_587_fresh_1))) :named ssa_24))
(assert (! (and (= v_ArrVal_590_fresh_1 (store (select |#memory_int#1_24| |main_~#b~0.base_4|) (+ (* main_~i~0_24 4) |main_~#b~0.offset_4|) v_ArrVal_589_fresh_1)) (< main_~i~0_24 100000) (= (store |#memory_int#1_24| |main_~#b~0.base_4| v_ArrVal_590_fresh_1) |#memory_int#1_25|) (= main_~i~0_25 (+ main_~i~0_24 1)) (= v_ArrVal_589_fresh_1 (select (select |#memory_int#2_20| |main_~#a~0.base_4|) (+ (* main_~i~0_24 4) |main_~#a~0.offset_4|)))) :named ssa_25))
(assert (! (and (= v_ArrVal_592_fresh_1 (store (select |#memory_int#1_25| |main_~#b~0.base_4|) (+ (* main_~i~0_25 4) |main_~#b~0.offset_4|) v_ArrVal_591_fresh_1)) (= (store |#memory_int#1_25| |main_~#b~0.base_4| v_ArrVal_592_fresh_1) |#memory_int#1_26|) (< main_~i~0_25 100000) (= main_~i~0_26 (+ main_~i~0_25 1)) (= v_ArrVal_591_fresh_1 (select (select |#memory_int#2_20| |main_~#a~0.base_4|) (+ (* main_~i~0_25 4) |main_~#a~0.offset_4|)))) :named ssa_26))
(assert (! (and (= v_ArrVal_594_fresh_1 (store (select |#memory_int#1_26| |main_~#b~0.base_4|) (+ (* main_~i~0_26 4) |main_~#b~0.offset_4|) v_ArrVal_593_fresh_1)) (= v_ArrVal_593_fresh_1 (select (select |#memory_int#2_20| |main_~#a~0.base_4|) (+ (* main_~i~0_26 4) |main_~#a~0.offset_4|))) (< main_~i~0_26 100000) (= (store |#memory_int#1_26| |main_~#b~0.base_4| v_ArrVal_594_fresh_1) |#memory_int#1_27|) (= main_~i~0_27 (+ main_~i~0_26 1))) :named ssa_27))
(assert (! (and (= (store |#memory_int#1_27| |main_~#b~0.base_4| v_ArrVal_596_fresh_1) |#memory_int#1_28|) (= v_ArrVal_595_fresh_1 (select (select |#memory_int#2_20| |main_~#a~0.base_4|) (+ (* main_~i~0_27 4) |main_~#a~0.offset_4|))) (< main_~i~0_27 100000) (= v_ArrVal_596_fresh_1 (store (select |#memory_int#1_27| |main_~#b~0.base_4|) (+ (* main_~i~0_27 4) |main_~#b~0.offset_4|) v_ArrVal_595_fresh_1)) (= main_~i~0_28 (+ main_~i~0_27 1))) :named ssa_28))
(assert (! (and (= v_ArrVal_598_fresh_1 (store (select |#memory_int#1_28| |main_~#b~0.base_4|) (+ (* main_~i~0_28 4) |main_~#b~0.offset_4|) v_ArrVal_597_fresh_1)) (= v_ArrVal_597_fresh_1 (select (select |#memory_int#2_20| |main_~#a~0.base_4|) (+ (* main_~i~0_28 4) |main_~#a~0.offset_4|))) (= (store |#memory_int#1_28| |main_~#b~0.base_4| v_ArrVal_598_fresh_1) |#memory_int#1_29|) (< main_~i~0_28 100000) (= main_~i~0_29 (+ main_~i~0_28 1))) :named ssa_29))
(assert (! (and (= v_ArrVal_600_fresh_1 (store (select |#memory_int#1_29| |main_~#b~0.base_4|) (+ (* main_~i~0_29 4) |main_~#b~0.offset_4|) v_ArrVal_599_fresh_1)) (= (store |#memory_int#1_29| |main_~#b~0.base_4| v_ArrVal_600_fresh_1) |#memory_int#1_30|) (= v_ArrVal_599_fresh_1 (select (select |#memory_int#2_20| |main_~#a~0.base_4|) (+ (* main_~i~0_29 4) |main_~#a~0.offset_4|))) (< main_~i~0_29 100000) (= main_~i~0_30 (+ main_~i~0_29 1))) :named ssa_30))
(assert (! (and (= v_ArrVal_602_fresh_1 (store (select |#memory_int#1_30| |main_~#b~0.base_4|) (+ (* main_~i~0_30 4) |main_~#b~0.offset_4|) v_ArrVal_601_fresh_1)) (= v_ArrVal_601_fresh_1 (select (select |#memory_int#2_20| |main_~#a~0.base_4|) (+ (* main_~i~0_30 4) |main_~#a~0.offset_4|))) (< main_~i~0_30 100000) (= main_~i~0_31 (+ main_~i~0_30 1)) (= (store |#memory_int#1_30| |main_~#b~0.base_4| v_ArrVal_602_fresh_1) |#memory_int#1_31|)) :named ssa_31))
(assert (! (and (= (store |#memory_int#1_31| |main_~#b~0.base_4| v_ArrVal_604_fresh_1) |#memory_int#1_32|) (= v_ArrVal_603_fresh_1 (select (select |#memory_int#2_20| |main_~#a~0.base_4|) (+ (* main_~i~0_31 4) |main_~#a~0.offset_4|))) (< main_~i~0_31 100000) (= v_ArrVal_604_fresh_1 (store (select |#memory_int#1_31| |main_~#b~0.base_4|) (+ (* main_~i~0_31 4) |main_~#b~0.offset_4|) v_ArrVal_603_fresh_1)) (= main_~i~0_32 (+ main_~i~0_31 1))) :named ssa_32))
(assert (! (and (= v_ArrVal_606_fresh_1 (store (select |#memory_int#1_32| |main_~#b~0.base_4|) (+ (* main_~i~0_32 4) |main_~#b~0.offset_4|) v_ArrVal_605_fresh_1)) (= v_ArrVal_605_fresh_1 (select (select |#memory_int#2_20| |main_~#a~0.base_4|) (+ (* main_~i~0_32 4) |main_~#a~0.offset_4|))) (= (store |#memory_int#1_32| |main_~#b~0.base_4| v_ArrVal_606_fresh_1) |#memory_int#1_33|) (< main_~i~0_32 100000) (= main_~i~0_33 (+ main_~i~0_32 1))) :named ssa_33))
(assert (! (and (< main_~i~0_33 100000) (= (store |#memory_int#1_33| |main_~#b~0.base_4| v_ArrVal_608_fresh_1) |#memory_int#1_34|) (= v_ArrVal_608_fresh_1 (store (select |#memory_int#1_33| |main_~#b~0.base_4|) (+ (* main_~i~0_33 4) |main_~#b~0.offset_4|) v_ArrVal_607_fresh_1)) (= main_~i~0_34 (+ main_~i~0_33 1)) (= v_ArrVal_607_fresh_1 (select (select |#memory_int#2_20| |main_~#a~0.base_4|) (+ (* main_~i~0_33 4) |main_~#a~0.offset_4|)))) :named ssa_34))
(assert (! (and (= v_ArrVal_609_fresh_1 (select (select |#memory_int#2_20| |main_~#a~0.base_4|) (+ (* main_~i~0_34 4) |main_~#a~0.offset_4|))) (= |#memory_int#1_35| (store |#memory_int#1_34| |main_~#b~0.base_4| v_ArrVal_610_fresh_1)) (= v_ArrVal_610_fresh_1 (store (select |#memory_int#1_34| |main_~#b~0.base_4|) (+ (* main_~i~0_34 4) |main_~#b~0.offset_4|) v_ArrVal_609_fresh_1)) (< main_~i~0_34 100000) (= main_~i~0_35 (+ main_~i~0_34 1))) :named ssa_35))
(assert (! (and (= v_ArrVal_611_fresh_1 (select (select |#memory_int#2_20| |main_~#a~0.base_4|) (+ (* main_~i~0_35 4) |main_~#a~0.offset_4|))) (= v_ArrVal_612_fresh_1 (store (select |#memory_int#1_35| |main_~#b~0.base_4|) (+ (* main_~i~0_35 4) |main_~#b~0.offset_4|) v_ArrVal_611_fresh_1)) (< main_~i~0_35 100000) (= main_~i~0_36 (+ main_~i~0_35 1)) (= (store |#memory_int#1_35| |main_~#b~0.base_4| v_ArrVal_612_fresh_1) |#memory_int#1_36|)) :named ssa_36))
(assert (! (and (= (store (select |#memory_int#1_36| |main_~#b~0.base_4|) (+ (* main_~i~0_36 4) |main_~#b~0.offset_4|) v_ArrVal_613_fresh_1) v_ArrVal_614_fresh_1) (= (store |#memory_int#1_36| |main_~#b~0.base_4| v_ArrVal_614_fresh_1) |#memory_int#1_37|) (< main_~i~0_36 100000) (= main_~i~0_37 (+ main_~i~0_36 1)) (= v_ArrVal_613_fresh_1 (select (select |#memory_int#2_20| |main_~#a~0.base_4|) (+ (* main_~i~0_36 4) |main_~#a~0.offset_4|)))) :named ssa_37))
(assert (! (and (= (store (select |#memory_int#1_37| |main_~#b~0.base_4|) (+ (* main_~i~0_37 4) |main_~#b~0.offset_4|) v_ArrVal_615_fresh_1) v_ArrVal_616_fresh_1) (< main_~i~0_37 100000) (= |#memory_int#1_38| (store |#memory_int#1_37| |main_~#b~0.base_4| v_ArrVal_616_fresh_1)) (= main_~i~0_38 (+ main_~i~0_37 1)) (= v_ArrVal_615_fresh_1 (select (select |#memory_int#2_20| |main_~#a~0.base_4|) (+ (* main_~i~0_37 4) |main_~#a~0.offset_4|)))) :named ssa_38))
(assert (! (<= 100000 main_~i~0_38) :named ssa_39))
(assert (! (= main_~x~0_40 0) :named ssa_40))
(assert (! (and (< main_~x~0_40 100000) (= |main_#t~mem3_41| (select (select |#memory_int#1_38| |main_~#b~0.base_4|) (+ (* main_~x~0_40 4) |main_~#b~0.offset_4|)))) :named ssa_41))
(assert (! true :named ssa_42_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_42| (ite (= |main_#t~mem3_41| 42) 1 0)) :named ssa_42_LocVarAssigCall))
