...
(set-info :ultimate-id condg.c_AllErrorsAtOnce_Iteration1)
...
(assert (! (and (= (store (store |#length_3| |main_~#sum~0.base_11| v_ArrVal_3_fresh_1) main_~a~0.base_11 v_ArrVal_5_fresh_1) |#length_11|) (< |#StackHeapBarrier_-1| |main_~#sum~0.base_11|) (= (select |#valid_3| |main_~#sum~0.base_11|) 0) (not (= |main_~#sum~0.base_11| 0)) (= v_ArrVal_1_fresh_1 (store (select |#memory_int#1_3| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| 0)) (= |#valid_11| (store (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_6_fresh_1) main_~a~0.base_11 v_ArrVal_2_fresh_1)) (= (select (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_6_fresh_1) main_~a~0.base_11) 0) (< main_~a~0.base_11 |#StackHeapBarrier_-1|) (= main_~i~0_11 0) (= v_ArrVal_4_fresh_1 0) (= v_ArrVal_2_fresh_1 1) (= (store |#memory_int#1_3| |main_~#sum~0.base_11| v_ArrVal_1_fresh_1) |#memory_int#1_11|) (= (* (mod ~N~0_4 1073741824) 4) v_ArrVal_5_fresh_1) (= |main_~#sum~0.offset_11| 0) (= v_ArrVal_6_fresh_1 1) (= main_~a~0.offset_11 0) (not (= main_~a~0.base_11 0)) (= 4 v_ArrVal_3_fresh_1)) :named ssa_11))
