...
(set-info :ultimate-id mono-crafted_11.c_AllErrorsAtOnce_Iteration8)
...
(assert (! (<= 100000000 (mod main_~x~0_16 4294967296)) :named ssa_17))
(assert (! true :named ssa_18_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_18| (ite (= (mod main_~x~0_16 2) 0) 1 0)) :named ssa_18_LocVarAssigCall))
