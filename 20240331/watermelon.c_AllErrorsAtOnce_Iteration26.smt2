...
(set-info :ultimate-id watermelon.c_AllErrorsAtOnce_Iteration26)
...
(declare-fun v_main_~is_divisible2~0_31_fresh_1 () Int)
(declare-fun v_main_~is_divisible1~0_31_fresh_1 () Int)
...
(declare-fun student_version_~w_31 () Int)
...
(declare-fun main_~is_divisible1~0_36 () Int)
...
(assert (! (and (= ~true~0_1 v_main_~is_divisible2~0_31_fresh_1) (= ~true~0_1 v_main_~is_divisible1~0_31_fresh_1)) :named ssa_4))
...
(assert (! (= correct_version_~i~0_14 correct_version_~w_7) :named ssa_16))
(assert (! true :named ssa_17))
(assert (! (= |correct_version_#res_18| correct_version_~is_divisible~0_7) :named ssa_18))
...
(assert (! (and (= (+ 2 student_version_~i~1_28) student_version_~i~1_29) (< student_version_~i~1_28 student_version_~w_22)) :named ssa_29))
(assert (! (<= student_version_~w_22 student_version_~i~1_29) :named ssa_30))
(assert (! (and (not (= student_version_~w_22 student_version_~i~1_29)) (= ~false~0_1 student_version_~is_divisible~1_31)) :named ssa_31))
(assert (! true :named ssa_32))
(assert (! (= student_version_~is_divisible~1_31 |student_version_#res_33|) :named ssa_33))
(assert (! (= |main_#t~ret6_34| |student_version_#res_33|) :named ssa_34_return))
(assert (! (and (<= |main_#t~ret6_34| 2147483647) (= main_~is_divisible2~0_35 |main_#t~ret6_34|) (<= 0 (+ |main_#t~ret6_34| 2147483648))) :named ssa_35))
(assert (! true :named ssa_36_GlobVarAssigCall))
(assert (! (= (ite (= main_~is_divisible1~0_20 main_~is_divisible2~0_35) 1 0) |__VERIFIER_assert_#in~cond_36|) :named ssa_36_LocVarAssigCall))
...
(assert (! true :named ssa_precond))
(assert (! (not (and (<= main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647)) (<= (+ (* (div main_~w~0_-2 4294967296) 4294967296) 12) main_~w~0_-2))) :named ssa_postcond))
...
(assert (! (= correct_version_~i~0_7 correct_version_~w_0) :named ssa_9))
(assert (! true :named ssa_10))
(assert (! (= |correct_version_#res_11| correct_version_~is_divisible~0_0) :named ssa_11))
...
(assert (! (and (<= main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647)) (<= (+ (* (div main_~w~0_-2 4294967296) 4294967296) 12) main_~w~0_-2)) :named ssa_-2_PendingContext))
