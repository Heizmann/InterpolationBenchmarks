...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:12:16+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id ps4-ll_valuebound20.c_AllErrorsAtOnce_Iteration1)
...
(assert (! (and (<= main_~k~0_4 32767) (<= 0 (+ main_~k~0_4 32768))) :named ssa_4))
(assert (! true :named ssa_5_GlobVarAssigCall))
(assert (! (= |assume_abort_if_not_#in~cond_5| (ite (and (<= 0 main_~k~0_4) (<= main_~k~0_4 20)) 1 0)) :named ssa_5_LocVarAssigCall))
...
(assert (! (= |__VERIFIER_assert_#in~cond_12| (ite (= (* main_~y~0_10 main_~y~0_10) (* main_~k~0_4 main_~y~0_10)) 1 0)) :named ssa_12_LocVarAssigCall))
