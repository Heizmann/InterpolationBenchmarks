...
(set-info :ultimate-id mono-crafted_11.c_AllErrorsAtOnce_Iteration4)
...
(assert (! (<= 100000000 (mod main_~x~0_8 4294967296)) :named ssa_9))
(assert (! true :named ssa_10_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_10| (ite (= (mod main_~x~0_8 2) 0) 1 0)) :named ssa_10_LocVarAssigCall))
