...
(set-info :ultimate-id conda.c_AllErrorsAtOnce_Iteration1)
...
(assert (! (and (= (* (mod ~N~0_4 1073741824) 4) v_ArrVal_1_fresh_1) (= (select (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_4_fresh_1) main_~a~0.base_11) 0) (= v_ArrVal_4_fresh_1 1) (= main_~i~0_11 0) (< main_~a~0.base_11 |#StackHeapBarrier_-1|) (= |main_~#sum~0.offset_11| 0) (= 8 v_ArrVal_6_fresh_1) (= (store (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_4_fresh_1) main_~a~0.base_11 v_ArrVal_2_fresh_1) |#valid_11|) (= |#memory_int#1_11| (store |#memory_int#1_3| |main_~#sum~0.base_11| v_ArrVal_5_fresh_1)) (< |#StackHeapBarrier_-1| |main_~#sum~0.base_11|) (= (store (select |#memory_int#1_3| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| v_ArrVal_3_fresh_1) v_ArrVal_5_fresh_1) (= v_ArrVal_2_fresh_1 1) (not (= |main_~#sum~0.base_11| 0)) (= v_ArrVal_3_fresh_1 0) (= (select |#valid_3| |main_~#sum~0.base_11|) 0) (= main_~a~0.offset_11 0) (not (= main_~a~0.base_11 0)) (= |#length_11| (store (store |#length_3| |main_~#sum~0.base_11| v_ArrVal_6_fresh_1) main_~a~0.base_11 v_ArrVal_1_fresh_1))) :named ssa_11))
