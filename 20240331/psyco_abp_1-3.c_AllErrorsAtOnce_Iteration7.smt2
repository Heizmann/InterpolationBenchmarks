...
(set-info :ultimate-id psyco_abp_1-3.c_AllErrorsAtOnce_Iteration7)
...
(declare-fun v_main_~P7~0_16_fresh_1 () Int)
(declare-fun v_main_~P2~0_16_fresh_1 () Int)
(declare-fun v_main_~P5~0_16_fresh_1 () Int)
(declare-fun |main_#t~nondet13_7| () Int)
(declare-fun |main_#t~nondet13_8| () Int)
(declare-fun v_main_~method_id~0_76_fresh_1 () Int)
...
(declare-fun v_main_~P2~0_17_fresh_1 () Int)
(declare-fun v_main_~P7~0_17_fresh_1 () Int)
(declare-fun v_main_~P5~0_17_fresh_1 () Int)
(declare-fun |main_#t~nondet14_13| () Int)
(declare-fun |main_#t~nondet14_14| () Int)
(declare-fun v_main_~method_id~0_77_fresh_1 () Int)
...
(declare-fun v_main_~P7~0_18_fresh_1 () Int)
(declare-fun v_main_~P2~0_18_fresh_1 () Int)
(declare-fun v_main_~P5~0_18_fresh_1 () Int)
...
(declare-fun v_main_~method_id~0_78_fresh_1 () Int)
...
(assert (! (and (<= main_~P4~0_6 2147483647) (<= v_main_~P5~0_16_fresh_1 2147483647) (<= 0 (+ main_~P1~0_6 2147483648)) (<= main_~P3~0_6 2147483647) (<= v_main_~P2~0_16_fresh_1 2147483647) (<= main_~P8~0_6 2147483647) (<= 0 (+ main_~P8~0_6 2147483648)) (<= 0 (+ main_~P6~0_6 2147483648)) (<= 0 (+ main_~P3~0_6 2147483648)) (<= 0 (+ main_~P9~0_6 2147483648)) (<= 0 (+ v_main_~P2~0_16_fresh_1 2147483648)) (<= v_main_~P7~0_16_fresh_1 2147483647) (<= main_~P9~0_6 2147483647) (<= 0 (+ v_main_~P7~0_16_fresh_1 2147483648)) (<= 0 (+ main_~P4~0_6 2147483648)) (<= 0 (+ v_main_~P5~0_16_fresh_1 2147483648)) (<= main_~P1~0_6 2147483647) (<= main_~P6~0_6 2147483647)) :named ssa_6))
...
(assert (! (= 1 v_main_~method_id~0_76_fresh_1) :named ssa_9))
(assert (! (and (= main_~this_buffer_empty~0_10 1) (= main_~q~0_10 1) (= main_~this_expect~0_10 0)) :named ssa_10))
(assert (! (and (<= main_~P4~0_11 2147483647) (<= 0 (+ main_~P1~0_11 2147483648)) (<= v_main_~P7~0_17_fresh_1 2147483647) (<= main_~P3~0_11 2147483647) (<= main_~P8~0_11 2147483647) (<= 0 (+ main_~P8~0_11 2147483648)) (<= 0 (+ main_~P6~0_11 2147483648)) (<= 0 (+ main_~P3~0_11 2147483648)) (<= 0 (+ main_~P9~0_11 2147483648)) (<= main_~P9~0_11 2147483647) (<= 0 (+ v_main_~P5~0_17_fresh_1 2147483648)) (<= 0 (+ main_~P4~0_11 2147483648)) (<= main_~P1~0_11 2147483647) (<= v_main_~P2~0_17_fresh_1 2147483647) (<= 0 (+ v_main_~P2~0_17_fresh_1 2147483648)) (<= v_main_~P5~0_17_fresh_1 2147483647) (<= 0 (+ v_main_~P7~0_17_fresh_1 2147483648)) (<= main_~P6~0_11 2147483647)) :named ssa_11))
...
(assert (! (and (= (ite (and (< main_~P1~0_11 0) (not (= (mod main_~P1~0_11 2) 0))) (+ (- 2) (mod main_~P1~0_11 2)) (mod main_~P1~0_11 2)) 0) (= 2 v_main_~method_id~0_77_fresh_1)) :named ssa_15))
...
(assert (! (and (<= v_main_~P5~0_18_fresh_1 2147483647) (<= main_~P4~0_17 2147483647) (<= 0 (+ v_main_~P5~0_18_fresh_1 2147483648)) (<= v_main_~P2~0_18_fresh_1 2147483647) (<= 0 (+ main_~P1~0_17 2147483648)) (<= v_main_~P7~0_18_fresh_1 2147483647) (<= main_~P3~0_17 2147483647) (<= main_~P8~0_17 2147483647) (<= 0 (+ main_~P8~0_17 2147483648)) (<= 0 (+ main_~P6~0_17 2147483648)) (<= 0 (+ main_~P3~0_17 2147483648)) (<= 0 (+ main_~P9~0_17 2147483648)) (<= 0 (+ v_main_~P2~0_18_fresh_1 2147483648)) (<= main_~P9~0_17 2147483647) (<= 0 (+ main_~P4~0_17 2147483648)) (<= main_~P1~0_17 2147483647) (<= 0 (+ v_main_~P7~0_18_fresh_1 2147483648)) (<= main_~P6~0_17 2147483647)) :named ssa_17))
...
(assert (! (and (= 3 v_main_~method_id~0_78_fresh_1) (= main_~P1~0_17 0)) :named ssa_24))
(assert (! (or (and (= main_~P3~0_17 0) (not (= (mod main_~this_buffer_empty~0_16 4294967296) 1)) (not (= (mod main_~P3~0_17 4294967296) (mod (+ 1 main_~this_expect~0_16) 2)))) (and (= main_~P3~0_17 0) (= (mod main_~this_buffer_empty~0_16 4294967296) 1))) :named ssa_25))
