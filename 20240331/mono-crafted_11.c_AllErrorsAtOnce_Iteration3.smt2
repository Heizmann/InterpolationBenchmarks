...
(set-info :ultimate-id mono-crafted_11.c_AllErrorsAtOnce_Iteration3)
...
(assert (! (<= 100000000 (mod main_~x~0_6 4294967296)) :named ssa_7))
(assert (! true :named ssa_8_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_8| (ite (= (mod main_~x~0_6 2) 0) 1 0)) :named ssa_8_LocVarAssigCall))
