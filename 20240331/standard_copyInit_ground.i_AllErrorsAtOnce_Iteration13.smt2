...
(set-info :ultimate-id standard_copyInit_ground.i_AllErrorsAtOnce_Iteration13)
...
(assert (! (and (= (store (store |#length_3| |main_~#a~0.base_4| v_ArrVal_271_fresh_1) |main_~#b~0.base_4| v_ArrVal_269_fresh_1) |#length_4|) (= v_ArrVal_269_fresh_1 400000) (= main_~i~0_4 0) (< |#StackHeapBarrier_-1| |main_~#a~0.base_4|) (= v_ArrVal_271_fresh_1 400000) (= |main_~#b~0.offset_4| 0) (not (= |main_~#a~0.base_4| 0)) (not (= |main_~#b~0.base_4| 0)) (= (select (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_270_fresh_1) |main_~#b~0.base_4|) 0) (= (store (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_270_fresh_1) |main_~#b~0.base_4| v_ArrVal_272_fresh_1) |#valid_4|) (= |main_~#a~0.offset_4| 0) (< |#StackHeapBarrier_-1| |main_~#b~0.base_4|) (= (select |#valid_3| |main_~#a~0.base_4|) 0) (= v_ArrVal_270_fresh_1 1) (= v_ArrVal_272_fresh_1 1)) :named ssa_4))
(assert (! (and (< main_~i~0_4 100000) (= (store |#memory_int#2_3| |main_~#a~0.base_4| v_ArrVal_273_fresh_1) |#memory_int#2_5|) (= v_ArrVal_274_fresh_1 42) (= v_ArrVal_273_fresh_1 (store (select |#memory_int#2_3| |main_~#a~0.base_4|) (+ (* main_~i~0_4 4) |main_~#a~0.offset_4|) 42)) (= main_~i~0_5 (+ main_~i~0_4 1))) :named ssa_5))
(assert (! (and (= (store |#memory_int#2_5| |main_~#a~0.base_4| v_ArrVal_275_fresh_1) |#memory_int#2_6|) (= v_ArrVal_276_fresh_1 42) (= v_ArrVal_275_fresh_1 (store (select |#memory_int#2_5| |main_~#a~0.base_4|) (+ (* main_~i~0_5 4) |main_~#a~0.offset_4|) 42)) (< main_~i~0_5 100000) (= main_~i~0_6 (+ main_~i~0_5 1))) :named ssa_6))
(assert (! (and (= |#memory_int#2_7| (store |#memory_int#2_6| |main_~#a~0.base_4| v_ArrVal_277_fresh_1)) (< main_~i~0_6 100000) (= v_ArrVal_278_fresh_1 42) (= main_~i~0_7 (+ main_~i~0_6 1)) (= v_ArrVal_277_fresh_1 (store (select |#memory_int#2_6| |main_~#a~0.base_4|) (+ (* main_~i~0_6 4) |main_~#a~0.offset_4|) 42))) :named ssa_7))
(assert (! (and (= (store |#memory_int#2_7| |main_~#a~0.base_4| v_ArrVal_279_fresh_1) |#memory_int#2_8|) (= v_ArrVal_279_fresh_1 (store (select |#memory_int#2_7| |main_~#a~0.base_4|) (+ (* main_~i~0_7 4) |main_~#a~0.offset_4|) 42)) (= v_ArrVal_280_fresh_1 42) (< main_~i~0_7 100000) (= main_~i~0_8 (+ main_~i~0_7 1))) :named ssa_8))
(assert (! (and (= (store |#memory_int#2_8| |main_~#a~0.base_4| v_ArrVal_281_fresh_1) |#memory_int#2_9|) (= v_ArrVal_282_fresh_1 42) (< main_~i~0_8 100000) (= v_ArrVal_281_fresh_1 (store (select |#memory_int#2_8| |main_~#a~0.base_4|) (+ (* main_~i~0_8 4) |main_~#a~0.offset_4|) 42)) (= main_~i~0_9 (+ main_~i~0_8 1))) :named ssa_9))
(assert (! (and (< main_~i~0_9 100000) (= v_ArrVal_283_fresh_1 (store (select |#memory_int#2_9| |main_~#a~0.base_4|) (+ (* main_~i~0_9 4) |main_~#a~0.offset_4|) 42)) (= main_~i~0_10 (+ main_~i~0_9 1)) (= v_ArrVal_284_fresh_1 42) (= (store |#memory_int#2_9| |main_~#a~0.base_4| v_ArrVal_283_fresh_1) |#memory_int#2_10|)) :named ssa_10))
(assert (! (and (= v_ArrVal_285_fresh_1 (store (select |#memory_int#2_10| |main_~#a~0.base_4|) (+ (* main_~i~0_10 4) |main_~#a~0.offset_4|) 42)) (= (store |#memory_int#2_10| |main_~#a~0.base_4| v_ArrVal_285_fresh_1) |#memory_int#2_11|) (< main_~i~0_10 100000) (= v_ArrVal_286_fresh_1 42) (= main_~i~0_11 (+ main_~i~0_10 1))) :named ssa_11))
(assert (! (and (= (store |#memory_int#2_11| |main_~#a~0.base_4| v_ArrVal_287_fresh_1) |#memory_int#2_12|) (= v_ArrVal_287_fresh_1 (store (select |#memory_int#2_11| |main_~#a~0.base_4|) (+ (* main_~i~0_11 4) |main_~#a~0.offset_4|) 42)) (< main_~i~0_11 100000) (= v_ArrVal_288_fresh_1 42) (= main_~i~0_12 (+ main_~i~0_11 1))) :named ssa_12))
(assert (! (and (= v_ArrVal_289_fresh_1 (store (select |#memory_int#2_12| |main_~#a~0.base_4|) (+ (* main_~i~0_12 4) |main_~#a~0.offset_4|) 42)) (< main_~i~0_12 100000) (= v_ArrVal_290_fresh_1 42) (= main_~i~0_13 (+ main_~i~0_12 1)) (= (store |#memory_int#2_12| |main_~#a~0.base_4| v_ArrVal_289_fresh_1) |#memory_int#2_13|)) :named ssa_13))
(assert (! (and (= v_ArrVal_292_fresh_1 42) (= v_ArrVal_291_fresh_1 (store (select |#memory_int#2_13| |main_~#a~0.base_4|) (+ (* main_~i~0_13 4) |main_~#a~0.offset_4|) 42)) (< main_~i~0_13 100000) (= (store |#memory_int#2_13| |main_~#a~0.base_4| v_ArrVal_291_fresh_1) |#memory_int#2_14|) (= main_~i~0_14 (+ main_~i~0_13 1))) :named ssa_14))
(assert (! (and (= v_ArrVal_293_fresh_1 (store (select |#memory_int#2_14| |main_~#a~0.base_4|) (+ (* main_~i~0_14 4) |main_~#a~0.offset_4|) 42)) (= v_ArrVal_294_fresh_1 42) (< main_~i~0_14 100000) (= main_~i~0_15 (+ main_~i~0_14 1)) (= |#memory_int#2_15| (store |#memory_int#2_14| |main_~#a~0.base_4| v_ArrVal_293_fresh_1))) :named ssa_15))
(assert (! (<= 100000 main_~i~0_15) :named ssa_16))
(assert (! (= main_~i~0_17 0) :named ssa_17))
(assert (! (and (= (store |#memory_int#1_3| |main_~#b~0.base_4| v_ArrVal_296_fresh_1) |#memory_int#1_18|) (< main_~i~0_17 100000) (= main_~i~0_18 (+ main_~i~0_17 1)) (= v_ArrVal_295_fresh_1 (select (select |#memory_int#2_15| |main_~#a~0.base_4|) (+ (* main_~i~0_17 4) |main_~#a~0.offset_4|))) (= v_ArrVal_296_fresh_1 (store (select |#memory_int#1_3| |main_~#b~0.base_4|) (+ (* main_~i~0_17 4) |main_~#b~0.offset_4|) v_ArrVal_295_fresh_1))) :named ssa_18))
(assert (! (and (= v_ArrVal_297_fresh_1 (select (select |#memory_int#2_15| |main_~#a~0.base_4|) (+ (* main_~i~0_18 4) |main_~#a~0.offset_4|))) (= v_ArrVal_298_fresh_1 (store (select |#memory_int#1_18| |main_~#b~0.base_4|) (+ (* main_~i~0_18 4) |main_~#b~0.offset_4|) v_ArrVal_297_fresh_1)) (< main_~i~0_18 100000) (= (store |#memory_int#1_18| |main_~#b~0.base_4| v_ArrVal_298_fresh_1) |#memory_int#1_19|) (= main_~i~0_19 (+ main_~i~0_18 1))) :named ssa_19))
(assert (! (and (= (store |#memory_int#1_19| |main_~#b~0.base_4| v_ArrVal_300_fresh_1) |#memory_int#1_20|) (= v_ArrVal_300_fresh_1 (store (select |#memory_int#1_19| |main_~#b~0.base_4|) (+ (* main_~i~0_19 4) |main_~#b~0.offset_4|) v_ArrVal_299_fresh_1)) (= v_ArrVal_299_fresh_1 (select (select |#memory_int#2_15| |main_~#a~0.base_4|) (+ (* main_~i~0_19 4) |main_~#a~0.offset_4|))) (< main_~i~0_19 100000) (= main_~i~0_20 (+ main_~i~0_19 1))) :named ssa_20))
(assert (! (and (= v_ArrVal_301_fresh_1 (select (select |#memory_int#2_15| |main_~#a~0.base_4|) (+ (* main_~i~0_20 4) |main_~#a~0.offset_4|))) (= v_ArrVal_302_fresh_1 (store (select |#memory_int#1_20| |main_~#b~0.base_4|) (+ (* main_~i~0_20 4) |main_~#b~0.offset_4|) v_ArrVal_301_fresh_1)) (< main_~i~0_20 100000) (= main_~i~0_21 (+ main_~i~0_20 1)) (= (store |#memory_int#1_20| |main_~#b~0.base_4| v_ArrVal_302_fresh_1) |#memory_int#1_21|)) :named ssa_21))
(assert (! (and (= (store |#memory_int#1_21| |main_~#b~0.base_4| v_ArrVal_304_fresh_1) |#memory_int#1_22|) (< main_~i~0_21 100000) (= main_~i~0_22 (+ main_~i~0_21 1)) (= v_ArrVal_303_fresh_1 (select (select |#memory_int#2_15| |main_~#a~0.base_4|) (+ (* main_~i~0_21 4) |main_~#a~0.offset_4|))) (= v_ArrVal_304_fresh_1 (store (select |#memory_int#1_21| |main_~#b~0.base_4|) (+ (* main_~i~0_21 4) |main_~#b~0.offset_4|) v_ArrVal_303_fresh_1))) :named ssa_22))
(assert (! (and (= v_ArrVal_305_fresh_1 (select (select |#memory_int#2_15| |main_~#a~0.base_4|) (+ (* main_~i~0_22 4) |main_~#a~0.offset_4|))) (= v_ArrVal_306_fresh_1 (store (select |#memory_int#1_22| |main_~#b~0.base_4|) (+ (* main_~i~0_22 4) |main_~#b~0.offset_4|) v_ArrVal_305_fresh_1)) (< main_~i~0_22 100000) (= (store |#memory_int#1_22| |main_~#b~0.base_4| v_ArrVal_306_fresh_1) |#memory_int#1_23|) (= main_~i~0_23 (+ main_~i~0_22 1))) :named ssa_23))
(assert (! (and (= (store |#memory_int#1_23| |main_~#b~0.base_4| v_ArrVal_308_fresh_1) |#memory_int#1_24|) (= v_ArrVal_308_fresh_1 (store (select |#memory_int#1_23| |main_~#b~0.base_4|) (+ (* main_~i~0_23 4) |main_~#b~0.offset_4|) v_ArrVal_307_fresh_1)) (< main_~i~0_23 100000) (= v_ArrVal_307_fresh_1 (select (select |#memory_int#2_15| |main_~#a~0.base_4|) (+ (* main_~i~0_23 4) |main_~#a~0.offset_4|))) (= main_~i~0_24 (+ main_~i~0_23 1))) :named ssa_24))
(assert (! (and (= |#memory_int#1_25| (store |#memory_int#1_24| |main_~#b~0.base_4| v_ArrVal_310_fresh_1)) (= v_ArrVal_310_fresh_1 (store (select |#memory_int#1_24| |main_~#b~0.base_4|) (+ (* main_~i~0_24 4) |main_~#b~0.offset_4|) v_ArrVal_309_fresh_1)) (= v_ArrVal_309_fresh_1 (select (select |#memory_int#2_15| |main_~#a~0.base_4|) (+ (* main_~i~0_24 4) |main_~#a~0.offset_4|))) (< main_~i~0_24 100000) (= main_~i~0_25 (+ main_~i~0_24 1))) :named ssa_25))
(assert (! (and (= (store |#memory_int#1_25| |main_~#b~0.base_4| v_ArrVal_312_fresh_1) |#memory_int#1_26|) (= v_ArrVal_311_fresh_1 (select (select |#memory_int#2_15| |main_~#a~0.base_4|) (+ (* main_~i~0_25 4) |main_~#a~0.offset_4|))) (< main_~i~0_25 100000) (= v_ArrVal_312_fresh_1 (store (select |#memory_int#1_25| |main_~#b~0.base_4|) (+ (* main_~i~0_25 4) |main_~#b~0.offset_4|) v_ArrVal_311_fresh_1)) (= main_~i~0_26 (+ main_~i~0_25 1))) :named ssa_26))
(assert (! (and (= v_ArrVal_314_fresh_1 (store (select |#memory_int#1_26| |main_~#b~0.base_4|) (+ (* main_~i~0_26 4) |main_~#b~0.offset_4|) v_ArrVal_313_fresh_1)) (= v_ArrVal_313_fresh_1 (select (select |#memory_int#2_15| |main_~#a~0.base_4|) (+ (* main_~i~0_26 4) |main_~#a~0.offset_4|))) (< main_~i~0_26 100000) (= |#memory_int#1_27| (store |#memory_int#1_26| |main_~#b~0.base_4| v_ArrVal_314_fresh_1)) (= main_~i~0_27 (+ main_~i~0_26 1))) :named ssa_27))
(assert (! (and (= (store |#memory_int#1_27| |main_~#b~0.base_4| v_ArrVal_316_fresh_1) |#memory_int#1_28|) (< main_~i~0_27 100000) (= main_~i~0_28 (+ main_~i~0_27 1)) (= v_ArrVal_315_fresh_1 (select (select |#memory_int#2_15| |main_~#a~0.base_4|) (+ (* main_~i~0_27 4) |main_~#a~0.offset_4|))) (= v_ArrVal_316_fresh_1 (store (select |#memory_int#1_27| |main_~#b~0.base_4|) (+ (* main_~i~0_27 4) |main_~#b~0.offset_4|) v_ArrVal_315_fresh_1))) :named ssa_28))
(assert (! (<= 100000 main_~i~0_28) :named ssa_29))
(assert (! (= main_~x~0_30 0) :named ssa_30))
(assert (! (and (< main_~x~0_30 100000) (= |main_#t~mem3_31| (select (select |#memory_int#1_28| |main_~#b~0.base_4|) (+ (* main_~x~0_30 4) |main_~#b~0.offset_4|)))) :named ssa_31))
(assert (! true :named ssa_32_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_32| (ite (= |main_#t~mem3_31| 42) 1 0)) :named ssa_32_LocVarAssigCall))
