...
(set-info :ultimate-id parity.i_AllErrorsAtOnce_Iteration13)
...
(declare-fun c_aux_v_main_~parity2~0_14 () Int)
(declare-fun c_aux_v_main_~parity2~0_15 () Int)
(declare-fun c_aux_v_main_~parity2~0_16 () Int)
(declare-fun c_aux_v_main_~parity2~0_17 () Int)
(declare-fun c_aux_v_main_~parity2~0_18 () Int)
(declare-fun c_aux_v_main_~parity2~0_19 () Int)
...
(declare-fun v_main_~parity2~0_20_fresh_1 () Int)
(declare-fun main_~v2~0_12 () Int)
(declare-fun |main_#t~bitwise3_12| () Int)
(declare-fun main_~v2~0_13 () Int)
(declare-fun |main_#t~bitwise3_13| () Int)
(declare-fun main_~v2~0_15 () Int)
(declare-fun |main_#t~bitwise4_15| () Int)
(declare-fun main_~v2~0_16 () Int)
(declare-fun |main_#t~bitwise4_16| () Int)
(declare-fun |main_#t~bitwise5_3| () Int)
(declare-fun main_~v2~0_18 () Int)
(declare-fun main_~v2~0_19 () Int)
(declare-fun |main_#t~bitwise5_19| () Int)
(declare-fun main_~v2~0_20 () Int)
(declare-fun main_~parity2~0_20 () Int)
(declare-fun |__VERIFIER_assert_#in~cond_21| () Int)
(declare-fun main_~parity2~0_21 () Int)
(declare-fun main_~parity1~0_21 () Int)
...
(assert (! (and (= main_~v2~0_10 main_~v~0_4) (= v_main_~parity2~0_20_fresh_1 0)) :named ssa_10))
(assert (! (not (= (mod main_~v2~0_10 4294967296) 0)) :named ssa_11))
(assert (! (and (= (mod (div (mod main_~v2~0_10 4294967296) 2) 4294967296) 0) (= main_~v2~0_10 |main_#t~bitwise3_12|)) :named ssa_12))
(assert (! (= main_~v2~0_13 |main_#t~bitwise3_12|) :named ssa_13))
(assert (! (not (= (mod main_~v2~0_13 4294967296) 0)) :named ssa_14))
(assert (! (and (= (mod (div (mod main_~v2~0_13 4294967296) 4) 4294967296) 0) (= main_~v2~0_13 |main_#t~bitwise4_15|)) :named ssa_15))
(assert (! (= main_~v2~0_16 |main_#t~bitwise4_15|) :named ssa_16))
(assert (! (not (= (mod main_~v2~0_16 4294967296) 0)) :named ssa_17))
(assert (! (and (<= (mod |main_#t~bitwise5_3| 4294967296) (mod main_~v2~0_16 4294967296)) (<= (mod |main_#t~bitwise5_3| 4294967296) 286331153) (not (= (mod main_~v2~0_16 4294967296) 286331153))) :named ssa_18))
(assert (! (= main_~v2~0_19 (* 286331153 |main_#t~bitwise5_3|)) :named ssa_19))
(assert (! (and (= (mod (div (mod main_~v2~0_19 4294967296) 268435456) 2) 0) (= main_~parity2~0_20 0)) :named ssa_20))
(assert (! true :named ssa_21_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_21| (ite (= main_~parity1~0_6 main_~parity2~0_20) 1 0)) :named ssa_21_LocVarAssigCall))
...
(declare-fun main_~v~0_10 () Int)
(declare-fun main_~v2~0_10 () Int)
(declare-fun v_main_~parity2~0_7_fresh_1 () Int)
(declare-fun main_~v2~0_12 () Int)
(declare-fun |main_#t~bitwise3_12| () Int)
(declare-fun main_~v2~0_13 () Int)
(declare-fun |main_#t~bitwise3_13| () Int)
...
(assert (! (= main_~v1~0_8 |main_#t~bitwise2_7|) :named ssa_8))
(assert (! (= (mod main_~v1~0_8 4294967296) 0) :named ssa_9))
(assert (! (and (= main_~v2~0_10 main_~v~0_4) (= v_main_~parity2~0_7_fresh_1 0)) :named ssa_10))
(assert (! (not (= (mod main_~v2~0_10 4294967296) 0)) :named ssa_11))
(assert (! (and (= (mod (div (mod main_~v2~0_10 4294967296) 2) 4294967296) 0) (= main_~v2~0_10 |main_#t~bitwise3_12|)) :named ssa_12))
(assert (! (= main_~v2~0_13 |main_#t~bitwise3_12|) :named ssa_13))
(assert (! (not (= (mod main_~v2~0_13 4294967296) 0)) :named ssa_14))
...
(assert (! true :named ssa_24))
(check-sat)
(get-value (main_~v~0_4))
(get-value (main_~v~0_10))
(get-value (main_~v1~0_4))
(get-value (main_~v1~0_7))
(get-value (main_~v1~0_8))
(get-value (main_~v1~0_9))
(get-value (|main_#t~nondet1_4|))
(get-value (|main_#t~bitwise2_7|))
(get-value (|main_#t~bitwise2_8|))
(get-value (|main_#t~bitwise4_15|))
(get-value (|main_#t~bitwise4_16|))
(get-value (|main_#t~bitwise3_12|))
(get-value (|main_#t~bitwise3_13|))
(get-value (|main_#t~bitwise5_3|))
(get-value (|main_#t~bitwise5_19|))
(get-value (main_~parity1~0_4))
(get-value (main_~parity1~0_6))
(get-value (main_~parity1~0_21))
(get-value (|#StackHeapBarrier_-1|))
(get-value (|__VERIFIER_assert_#in~cond_21|))
(get-value (main_~v2~0_4))
(get-value (main_~v2~0_10))
(get-value (main_~v2~0_12))
(get-value (main_~v2~0_13))
(get-value (main_~v2~0_15))
(get-value (main_~v2~0_16))
(get-value (main_~v2~0_18))
(get-value (main_~v2~0_19))
(get-value (main_~v2~0_20))
(get-value (main_~parity2~0_4))
(get-value (main_~parity2~0_20))
(get-value (main_~parity2~0_21))
