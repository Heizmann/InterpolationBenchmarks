...
(set-info :ultimate-id brs2.c_AllErrorsAtOnce_Iteration3)
...
(declare-fun |main_~#sum~0.offset_21| () Int)
...
(assert (! (and (= (select |#valid_3| |main_~#sum~0.base_11|) 0) (= (* (mod ~N~0_4 1073741824) 4) v_ArrVal_9_fresh_1) (< |#StackHeapBarrier_-1| |main_~#sum~0.base_11|) (< main_~a~0.base_11 |#StackHeapBarrier_-1|) (= |main_~#sum~0.offset_11| 0) (= |#valid_11| (store (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_10_fresh_1) main_~a~0.base_11 v_ArrVal_11_fresh_1)) (= (store (store |#length_3| |main_~#sum~0.base_11| v_ArrVal_12_fresh_1) main_~a~0.base_11 v_ArrVal_9_fresh_1) |#length_11|) (= v_ArrVal_11_fresh_1 1) (not (= |main_~#sum~0.base_11| 0)) (= v_ArrVal_10_fresh_1 1) (= (select (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_10_fresh_1) main_~a~0.base_11) 0) (= main_~a~0.offset_11 0) (not (= main_~a~0.base_11 0)) (= 8 v_ArrVal_12_fresh_1) (= main_~i~0_11 0)) :named ssa_11))
(assert (! (< main_~i~0_11 ~N~0_4) :named ssa_12))
(assert (! (and (= |#memory_int#3_13| (store |#memory_int#3_3| main_~a~0.base_11 v_ArrVal_14_fresh_1)) (= 2 v_ArrVal_13_fresh_1) (= (store (select |#memory_int#3_3| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_11 4)) v_ArrVal_13_fresh_1) v_ArrVal_14_fresh_1) (= (ite (and (< main_~i~0_11 0) (not (= (mod main_~i~0_11 2) 0))) (+ (mod main_~i~0_11 2) (- 2)) (mod main_~i~0_11 2)) 0)) :named ssa_13))
...
(assert (! (and (= main_~i~0_16 0) (= v_ArrVal_15_fresh_1 0) (= |#memory_int#1_18| (store |#memory_int#1_3| |main_~#sum~0.base_11| v_ArrVal_16_fresh_1)) (= (store (select |#memory_int#1_3| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| v_ArrVal_15_fresh_1) v_ArrVal_16_fresh_1)) :named ssa_18))
(assert (! (= main_~i~0_19 (+ main_~i~0_16 1)) :named ssa_19))
(assert (! (<= ~N~0_4 main_~i~0_19) :named ssa_20))
(assert (! (= |main_#t~mem10_21| (select (select |#memory_int#1_18| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|)) :named ssa_21))
(assert (! true :named ssa_22_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_22| (ite (<= |main_#t~mem10_21| (* 2 ~N~0_4)) 1 0)) :named ssa_22_LocVarAssigCall))
...
(assert (! true :named ssa_precond))
(assert (! (not (<= 1 ~N~0_-2)) :named ssa_postcond))
...
(assert (! (<= 1 ~N~0_-2) :named ssa_-2_PendingContext))
