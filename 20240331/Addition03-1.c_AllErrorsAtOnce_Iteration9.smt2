...
(set-info :ultimate-id Addition03-1.c_AllErrorsAtOnce_Iteration9)
...
(assert (! (and (= 0 addition_~n_34) (= |addition_#res_35| addition_~m_34)) :named ssa_35))
...
(assert (! (= |addition_#res_56| |main_#t~ret8_58|) :named ssa_58_return))
(assert (! (and (<= |main_#t~ret8_58| 9223372036854775807) (<= 0 (+ |main_#t~ret8_58| 9223372036854775808)) (= main_~result~0_59 |main_#t~ret8_58|)) :named ssa_59))
(assert (! (and (< main_~result~0_59 200) (<= 100 main_~n~0_4) (<= 100 main_~m~0_4)) :named ssa_60))
(assert (! true :named ssa_61))
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 (and ssa_27 ssa_29_OldVarAssigCall ssa_20 ssa_17_LocVarAssigCall ssa_21_LocVarAssigCall ssa_5_LocVarAssigCall ssa_31 ssa_5_GlobVarAssigCall ssa_21_OldVarAssigCall ssa_55_return ssa_7 ssa_44 ssa_16 ssa_57 ssa_6 ssa_26 ssa_34 ssa_17_GlobVarAssigCall ssa_25_GlobVarAssigCall ssa_10 ssa_14 ssa_25_OldVarAssigCall ssa_8 ssa_13_LocVarAssigCall ssa_45 ssa_29_GlobVarAssigCall ssa_47 ssa_40_return ssa_53 ssa_13_OldVarAssigCall ssa_25_LocVarAssigCall ssa_33_GlobVarAssigCall ssa_19 ssa_33_LocVarAssigCall ssa_39 ssa_13_GlobVarAssigCall ssa_17_OldVarAssigCall ssa_43_return ssa_38 ssa_12 ssa_32 ssa_5_OldVarAssigCall ssa_50 ssa_11 ssa_48 ssa_49_return ssa_28 ssa_29_LocVarAssigCall ssa_54 ssa_22 ssa_51 ssa_36 ssa_15 ssa_18 ssa_37_return ssa_23 ssa_30 ssa_9_LocVarAssigCall ssa_56 ssa_9_OldVarAssigCall ssa_35 ssa_21_GlobVarAssigCall ssa_9_GlobVarAssigCall ssa_33_OldVarAssigCall ssa_58_return ssa_41 ssa_42 ssa_46_return ssa_24 ssa_52_return) ssa_59 ssa_60 (and ssa_61 ssa_postcond))
...
(declare-fun |addition_#res_52| () Int)
(assert (! true :named ssa_precond))
(assert (! (not (<= main_~n~0_-2 7)) :named ssa_postcond))
...
(assert (! (and (<= 0 (+ 9223372036854775808 |addition_#t~ret4_49|)) (<= |addition_#t~ret4_49| 9223372036854775807) (= |addition_#res_50| |addition_#t~ret4_49|)) :named ssa_50))
(assert (! true :named ssa_51))
(assert (! (= |addition_#res_50| |main_#t~ret8_52|) :named ssa_52_return))
(assert (! true :named ssa_-2_PendingContext))
