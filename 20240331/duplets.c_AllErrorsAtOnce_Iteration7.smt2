...
(set-info :ultimate-id duplets.c_AllErrorsAtOnce_Iteration7)
...
(declare-fun v_mkdup_~x~0_17_fresh_1 () Int)
...
(declare-fun |v_main_#t~mem16_4_fresh_1| () Int)
...
(assert (! (and (= |#valid_10| (store |#valid_3| |main_#t~malloc13.base_10| v_ArrVal_102_fresh_1)) (not (= 0 |main_#t~malloc13.base_10|)) (< |main_#t~malloc13.base_10| |#StackHeapBarrier_-1|) (= |main_#t~malloc13.offset_10| 0) (= v_ArrVal_102_fresh_1 1) (= v_ArrVal_101_fresh_1 (* 4 (mod main_~n~0_4 1073741824))) (= (store |#length_3| |main_#t~malloc13.base_10| v_ArrVal_101_fresh_1) |#length_10|) (= (select |#valid_3| |main_#t~malloc13.base_10|) 0)) :named ssa_10))
(assert (! (= |old(#memory_int#2)_11| |#memory_int#2_11|) :named ssa_11_GlobVarAssigCall))
(assert (! (and (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_9_fresh_1| 4) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_9_fresh_1|) (= |#Ultimate.meminit_#ptr.base_11| |main_#t~malloc13.base_10|) (= |v_#Ultimate.meminit_#ptr.offsetInParam_9_fresh_1| |main_#t~malloc13.offset_10|) (= |v_#Ultimate.meminit_#productInParam_9_fresh_1| (* main_~n~0_4 4))) :named ssa_11_LocVarAssigCall))
(assert (! (= |old(#memory_int#2)_11| |#memory_int#2_3|) :named ssa_11_OldVarAssigCall))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_103_fresh_1) (= (store |#memory_int#2_11| |#Ultimate.meminit_#ptr.base_11| v_ArrVal_103_fresh_1) |#memory_int#2_12|)) :named ssa_12))
...
(assert (! (and (<= v_mkdup_~x~0_17_fresh_1 2147483647) (= v_ArrVal_104_fresh_1 v_mkdup_~x~0_17_fresh_1) (<= 0 (+ v_mkdup_~x~0_17_fresh_1 2147483648)) (= v_ArrVal_105_fresh_1 (store (store (select |#memory_int#2_15| mkdup_~a.base_16) (+ (* mkdup_~i~0_16 4) mkdup_~a.offset_16) v_mkdup_~x~0_17_fresh_1) (+ mkdup_~a.offset_16 (* mkdup_~j~0_16 4)) v_ArrVal_104_fresh_1)) (= |#memory_int#2_32| (store |#memory_int#2_15| mkdup_~a.base_16 v_ArrVal_105_fresh_1)) (= v_ArrVal_106_fresh_1 v_mkdup_~x~0_17_fresh_1)) :named ssa_32))
(assert (! true :named ssa_33_return))
(assert (! (and (= v_ArrVal_108_fresh_1 1) (= |main_~#i~2.offset_34| 0) (= (select |#valid_10| |main_~#i~2.base_34|) 0) (= |main_~#j~2.offset_34| 0) (not (= |main_~#j~2.base_34| 0)) (< |#StackHeapBarrier_-1| |main_~#j~2.base_34|) (not (= |main_~#i~2.base_34| 0)) (= |#valid_34| (store (store |#valid_10| |main_~#i~2.base_34| v_ArrVal_108_fresh_1) |main_~#j~2.base_34| v_ArrVal_110_fresh_1)) (= (select (store |#valid_10| |main_~#i~2.base_34| v_ArrVal_108_fresh_1) |main_~#j~2.base_34|) 0) (< |#StackHeapBarrier_-1| |main_~#i~2.base_34|) (= (store (store |#length_10| |main_~#i~2.base_34| v_ArrVal_107_fresh_1) |main_~#j~2.base_34| v_ArrVal_109_fresh_1) |#length_34|) (= v_ArrVal_109_fresh_1 4) (= v_ArrVal_107_fresh_1 4) (= v_ArrVal_110_fresh_1 1)) :named ssa_34))
...
(assert (! (and (= (store |#memory_int#3_35| finddup_~_j.base_36 v_ArrVal_112_fresh_1) |#memory_int#3_39|) (= v_ArrVal_113_fresh_1 finddup_~j~1_37) (= (store |#memory_int#1_35| finddup_~_i.base_36 v_ArrVal_114_fresh_1) |#memory_int#1_39|) (= v_ArrVal_114_fresh_1 (store (select |#memory_int#1_35| finddup_~_i.base_36) finddup_~_i.offset_36 v_ArrVal_111_fresh_1)) (= v_ArrVal_111_fresh_1 finddup_~i~1_36) (= |finddup_#res_39| 1) (= |finddup_#t~mem8_38| |finddup_#t~mem9_38|) (= v_ArrVal_112_fresh_1 (store (select |#memory_int#3_35| finddup_~_j.base_36) finddup_~_j.offset_36 finddup_~j~1_37))) :named ssa_39))
...
(assert (! (and (or (and (< |v_main_#t~mem15_5_fresh_1| 0) (not |main_#t~short17_48|)) (and |main_#t~short17_48| (<= 0 |v_main_#t~mem15_5_fresh_1|))) (= (select (select |#memory_int#1_39| |main_~#i~2.base_34|) |main_~#i~2.offset_34|) |v_main_#t~mem15_5_fresh_1|)) :named ssa_48))
(assert (! (and (or (and (not |main_#t~short17_49|) (<= main_~n~0_4 |v_main_#t~mem16_4_fresh_1|)) (and (< |v_main_#t~mem16_4_fresh_1| main_~n~0_4) |main_#t~short17_49|)) (= (select (select |#memory_int#1_39| |main_~#i~2.base_34|) |main_~#i~2.offset_34|) |v_main_#t~mem16_4_fresh_1|) |main_#t~short17_48|) :named ssa_49))
...
(assert (! (not true) :named ssa_postcond))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_115_fresh_1) (= (store |#memory_int#2_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_115_fresh_1) |#memory_int#2_0|)) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! true :named ssa_-2_PendingContext))
...
(declare-fun mkdup_~a.base_16 () Int)
(declare-fun mkdup_~i~0_16 () Int)
(declare-fun v_mkdup_~x~0_18_fresh_1 () Int)
...
(assert (! (and (= v_ArrVal_116_fresh_1 v_mkdup_~x~0_18_fresh_1) (= v_ArrVal_118_fresh_1 (store (store (select |#memory_int#2_-1| mkdup_~a.base_0) (+ (* mkdup_~i~0_0 4) mkdup_~a.offset_0) v_ArrVal_116_fresh_1) (+ mkdup_~a.offset_0 (* mkdup_~j~0_0 4)) v_ArrVal_117_fresh_1)) (= (store |#memory_int#2_-1| mkdup_~a.base_0 v_ArrVal_118_fresh_1) |#memory_int#2_16|) (= v_ArrVal_117_fresh_1 v_mkdup_~x~0_18_fresh_1) (<= v_mkdup_~x~0_18_fresh_1 2147483647) (<= 0 (+ v_mkdup_~x~0_18_fresh_1 2147483648))) :named ssa_16))
...
(assert (! (not (and (<= 2 main_~n~0_-2) (= (select (select |#memory_int#1_3| |main_~#i~2.base_-2|) |main_~#i~2.offset_-2|) 0))) :named ssa_postcond))
...
(assert (! (and (= (store |#memory_int#1_-1| finddup_~_i.base_0 v_ArrVal_122_fresh_1) |#memory_int#1_3|) (= v_ArrVal_121_fresh_1 finddup_~j~1_1) (= v_ArrVal_122_fresh_1 (store (select |#memory_int#1_-1| finddup_~_i.base_0) finddup_~_i.offset_0 v_ArrVal_119_fresh_1)) (= v_ArrVal_120_fresh_1 (store (select |#memory_int#3_-1| finddup_~_j.base_0) finddup_~_j.offset_0 finddup_~j~1_1)) (= |finddup_#res_3| 1) (= |finddup_#t~mem8_2| |finddup_#t~mem9_2|) (= (store |#memory_int#3_-1| finddup_~_j.base_0 v_ArrVal_120_fresh_1) |#memory_int#3_3|) (= v_ArrVal_119_fresh_1 finddup_~i~1_0)) :named ssa_3))
(assert (! true :named ssa_4))
...
(assert (! true :named ssa_precond))
(assert (! (not (and (<= 2 main_~n~0_-2) (= (select (select |#memory_int#1_-2| |main_~#i~2.base_-2|) |main_~#i~2.offset_-2|) 0))) :named ssa_postcond))
...
(assert (! true :named ssa_2))
(assert (! true :named ssa_3_return))
(assert (! (and (<= 2 main_~n~0_-2) (= (select (select |#memory_int#1_-2| |main_~#i~2.base_-2|) |main_~#i~2.offset_-2|) 0)) :named ssa_-2_PendingContext))
