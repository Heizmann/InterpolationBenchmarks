...
(set-info :ultimate-id partial_mod_count_3.c_AllErrorsAtOnce_Iteration3)
...
(declare-fun |v_main_#t~post6_5_fresh_1| () Int)
...
(assert (! (and (= (store |#length_3| |main_~#a~0.base_4| v_ArrVal_6_fresh_1) |#length_4|) (= main_~i~0_4 0) (< |#StackHeapBarrier_-1| |main_~#a~0.base_4|) (= main_~j~0_4 0) (not (= |main_~#a~0.base_4| 0)) (= |main_~#a~0.offset_4| 0) (= (select |#valid_3| |main_~#a~0.base_4|) 0) (= |#valid_4| (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_5_fresh_1)) (= v_ArrVal_5_fresh_1 1) (= (* (mod ~N~0_1 1073741824) 4) v_ArrVal_6_fresh_1) (= main_~R~0_4 3)) :named ssa_4))
(assert (! (and (= (store (select |#memory_int#1_3| |main_~#a~0.base_4|) (+ (* main_~i~0_4 4) |main_~#a~0.offset_4|) v_ArrVal_7_fresh_1) v_ArrVal_8_fresh_1) (= (+ main_~i~0_4 1) v_ArrVal_7_fresh_1) (= (store |#memory_int#1_3| |main_~#a~0.base_4| v_ArrVal_8_fresh_1) |#memory_int#1_5|) (< main_~i~0_4 ~N~0_1)) :named ssa_5))
...
(assert (! (<= ~N~0_1 main_~i~0_7) :named ssa_8))
(assert (! (= main_~i~0_9 0) :named ssa_9))
(assert (! (and (= |main_#t~mem5_10| (select (select |#memory_int#1_5| |main_~#a~0.base_4|) (+ (* main_~i~0_9 4) |main_~#a~0.offset_4|))) (< main_~i~0_9 ~N~0_1)) :named ssa_10))
(assert (! (and (= |main_#t~mem5_10| 0) (= main_~j~0_11 (+ |v_main_#t~post6_5_fresh_1| 1)) (= main_~j~0_4 |v_main_#t~post6_5_fresh_1|)) :named ssa_11))
(assert (! true :named ssa_12_GlobVarAssigCall))
(assert (! (= (ite (< main_~j~0_11 (+ 2 (ite (and (not (= (mod ~N~0_1 6) 0)) (< ~N~0_1 0)) (+ (div ~N~0_1 6) 1) (div ~N~0_1 6)))) 1 0) |__VERIFIER_assert_#in~cond_12|) :named ssa_12_LocVarAssigCall))
...
(assert (! (not (<= 1000000 ~N~0_0)) :named ssa_postcond))
