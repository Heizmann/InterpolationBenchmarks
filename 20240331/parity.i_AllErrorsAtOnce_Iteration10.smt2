...
(set-info :ultimate-id parity.i_AllErrorsAtOnce_Iteration10)
...
(declare-fun v_main_~parity2~0_17_fresh_1 () Int)
...
(assert (! (and (= main_~v2~0_10 main_~v~0_4) (= v_main_~parity2~0_17_fresh_1 0)) :named ssa_10))
