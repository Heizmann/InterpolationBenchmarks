...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:09:36+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id string_concat-noarr.i_AllErrorsAtOnce_Iteration37)
...
(declare-fun main_~j~0_80 () Int)
(declare-fun |__VERIFIER_assert_#in~cond_81| () Int)
