...
(set-info :ultimate-id pr5.c_AllErrorsAtOnce_Iteration1)
...
(declare-fun |v_main_#t~mem6_6_fresh_1| () Int)
...
(assert (! (and (= 2 main_~CCCELVOL5~0_5) (= |main_~#volArray~0.offset_5| 0) (< |#StackHeapBarrier_-1| |main_~#volArray~0.base_5|) (= 7 main_~CCCELVOL3~0_5) (= (select |#valid_3| |main_~#volArray~0.base_5|) 0) (= 5 main_~CCCELVOL4~0_5) (< 1 ~CELLCOUNT~0_4) (= v_ArrVal_1_fresh_1 1) (= 3 main_~CCCELVOL2~0_5) (= (* (mod ~CELLCOUNT~0_4 1073741824) 4) v_ArrVal_2_fresh_1) (= (store |#valid_3| |main_~#volArray~0.base_5| v_ArrVal_1_fresh_1) |#valid_5|) (= main_~CCCELVOL1~0_5 1) (= (store |#length_3| |main_~#volArray~0.base_5| v_ArrVal_2_fresh_1) |#length_5|) (not (= |main_~#volArray~0.base_5| 0))) :named ssa_5))
...
(assert (! (and (< main_~i~0_14 ~CELLCOUNT~0_4) (or (and |main_#t~short8_15| (<= main_~MINVAL~0_5 |v_main_#t~mem6_6_fresh_1|)) (and (< |v_main_#t~mem6_6_fresh_1| main_~MINVAL~0_5) (not |main_#t~short8_15|))) (= |v_main_#t~mem6_6_fresh_1| (select (select |#memory_int#1_3| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_14 4))))) :named ssa_15))
