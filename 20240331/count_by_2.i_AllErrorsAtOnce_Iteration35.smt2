...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration35)
...
(assert (! (<= 1000000 main_~i~0_38) :named ssa_39))
(assert (! true :named ssa_40_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_40| (ite (= main_~i~0_38 1000000) 1 0)) :named ssa_40_LocVarAssigCall))
