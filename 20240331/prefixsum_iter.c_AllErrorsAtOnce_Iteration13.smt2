...
(set-info :ultimate-id prefixsum_iter.c_AllErrorsAtOnce_Iteration13)
...
(declare-fun |v_#Ultimate.meminit_#amountOfFieldsInParam_29_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#sizeOfFieldsInParam_29_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#productInParam_29_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#ptr.offsetInParam_29_fresh_1| () Int)
...
(declare-fun |v_#Ultimate.meminit_#ptr.offsetInParam_30_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#productInParam_30_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#sizeOfFieldsInParam_30_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#amountOfFieldsInParam_30_fresh_1| () Int)
...
(declare-fun downsweep_~space_47 () Int)
(declare-fun downsweep_~right~1_48 () Int)
(declare-fun downsweep_~right~1_49 () Int)
(declare-fun |downsweep_#t~mem8_49| () Int)
(declare-fun |downsweep_#t~mem9_49| () Int)
(declare-fun |#memory_int#1_49| () (Array Int (Array Int Int)))
(declare-fun downsweep_~temp~0_49 () Int)
(declare-fun downsweep_~left~1_49 () Int)
(declare-fun |downsweep_#t~mem7_49| () Int)
...
(declare-fun |check_#in~a.offset_55| () Int)
(declare-fun main_~a0~0.offset_55 () Int)
(declare-fun |check_#in~a.base_55| () Int)
(declare-fun main_~a~0.base_55 () Int)
(declare-fun main_~n~0_55 () Int)
(declare-fun main_~a~0.offset_55 () Int)
(declare-fun |check_#in~a0.base_55| () Int)
(declare-fun |check_#in~n_55| () Int)
(declare-fun main_~a0~0.base_55 () Int)
(declare-fun |check_#in~a0.offset_55| () Int)
(declare-fun check_~a0.base_56 () Int)
(declare-fun check_~a.base_56 () Int)
(declare-fun check_~a.offset_56 () Int)
(declare-fun check_~i~0_56 () Int)
(declare-fun check_~sum~0_56 () Int)
(declare-fun check_~a0.offset_56 () Int)
(declare-fun check_~n_56 () Int)
...
(assert (! (and (not (= |main_#t~malloc15.base_21| 0)) (< |main_#t~malloc15.base_21| |#StackHeapBarrier_-1|) (= |main_#t~malloc15.offset_21| 0) (= |#valid_21| (store |#valid_3| |main_#t~malloc15.base_21| v_ArrVal_243_fresh_1)) (= (select |#valid_3| |main_#t~malloc15.base_21|) 0) (= v_ArrVal_244_fresh_1 (* (mod main_~n~0_4 1073741824) 4)) (= (store |#length_3| |main_#t~malloc15.base_21| v_ArrVal_244_fresh_1) |#length_21|) (= v_ArrVal_243_fresh_1 1)) :named ssa_21))
(assert (! (= |old(#memory_int#1)_22| |#memory_int#1_22|) :named ssa_22_GlobVarAssigCall))
(assert (! (and (= |v_#Ultimate.meminit_#ptr.offsetInParam_29_fresh_1| |main_#t~malloc15.offset_21|) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_29_fresh_1|) (= |#Ultimate.meminit_#ptr.base_22| |main_#t~malloc15.base_21|) (= (* main_~n~0_4 4) |v_#Ultimate.meminit_#productInParam_29_fresh_1|) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_29_fresh_1| 4)) :named ssa_22_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_22| |#memory_int#1_3|) :named ssa_22_OldVarAssigCall))
(assert (! (and (= |#memory_int#1_23| (store |#memory_int#1_22| |#Ultimate.meminit_#ptr.base_22| v_ArrVal_245_fresh_1)) (= ((as const (Array Int Int)) 0) v_ArrVal_245_fresh_1)) :named ssa_23))
(assert (! true :named ssa_24_return))
(assert (! (and (= (select |#valid_21| |main_#t~malloc16.base_25|) 0) (= |#length_25| (store |#length_21| |main_#t~malloc16.base_25| v_ArrVal_247_fresh_1)) (not (= |main_#t~malloc16.base_25| 0)) (= v_ArrVal_247_fresh_1 (* (mod main_~n~0_4 1073741824) 4)) (= |#valid_25| (store |#valid_21| |main_#t~malloc16.base_25| v_ArrVal_246_fresh_1)) (= |main_#t~malloc16.offset_25| 0) (= v_ArrVal_246_fresh_1 1) (= main_~a~0.offset_25 |main_#t~malloc15.offset_21|) (= main_~a~0.base_25 |main_#t~malloc15.base_21|) (< |main_#t~malloc16.base_25| |#StackHeapBarrier_-1|)) :named ssa_25))
(assert (! (= |old(#memory_int#1)_26| |#memory_int#1_26|) :named ssa_26_GlobVarAssigCall))
(assert (! (and (= (* main_~n~0_4 4) |v_#Ultimate.meminit_#productInParam_30_fresh_1|) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_30_fresh_1| 4) (= |v_#Ultimate.meminit_#ptr.offsetInParam_30_fresh_1| |main_#t~malloc16.offset_25|) (= |#Ultimate.meminit_#ptr.base_26| |main_#t~malloc16.base_25|) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_30_fresh_1|)) :named ssa_26_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_26| |#memory_int#1_23|) :named ssa_26_OldVarAssigCall))
(assert (! (and (= |#memory_int#1_27| (store |#memory_int#1_26| |#Ultimate.meminit_#ptr.base_26| v_ArrVal_248_fresh_1)) (= ((as const (Array Int Int)) 0) v_ArrVal_248_fresh_1)) :named ssa_27))
...
(assert (! (and (< main_~i~1_29 main_~n~0_4) (= |#memory_int#1_30| (store |#memory_int#1_27| main_~a0~0.base_29 v_ArrVal_250_fresh_1)) (= v_ArrVal_250_fresh_1 (store (select |#memory_int#1_27| main_~a0~0.base_29) (+ main_~a0~0.offset_29 (* main_~i~1_29 4)) v_ArrVal_249_fresh_1)) (= v_ArrVal_249_fresh_1 (select (select |#memory_int#1_27| main_~a~0.base_25) (+ main_~a~0.offset_25 (* main_~i~1_29 4)))) (= main_~i~1_30 (+ main_~i~1_29 1))) :named ssa_30))
(assert (! (and (< main_~i~1_30 main_~n~0_4) (= v_ArrVal_252_fresh_1 (store (select |#memory_int#1_30| main_~a0~0.base_29) (+ main_~a0~0.offset_29 (* main_~i~1_30 4)) v_ArrVal_251_fresh_1)) (= v_ArrVal_251_fresh_1 (select (select |#memory_int#1_30| main_~a~0.base_25) (+ main_~a~0.offset_25 (* main_~i~1_30 4)))) (= |#memory_int#1_31| (store |#memory_int#1_30| main_~a0~0.base_29 v_ArrVal_252_fresh_1)) (= main_~i~1_31 (+ main_~i~1_30 1))) :named ssa_31))
...
(assert (! (and (= (store (select |#memory_int#1_33| upsweep_~a.base_34) (+ (* upsweep_~left~0_35 4) upsweep_~a.offset_34 (* upsweep_~space~0_34 4)) (+ (select (select |#memory_int#1_33| upsweep_~a.base_34) (+ (* upsweep_~left~0_35 4) upsweep_~a.offset_34)) (select (select |#memory_int#1_33| upsweep_~a.base_34) (+ (* upsweep_~left~0_35 4) upsweep_~a.offset_34 (* upsweep_~space~0_34 4))))) v_ArrVal_253_fresh_1) (< upsweep_~left~0_35 upsweep_~n_34) (= (store |#memory_int#1_33| upsweep_~a.base_34 v_ArrVal_253_fresh_1) |#memory_int#1_36|) (= v_ArrVal_254_fresh_1 (+ (select (select |#memory_int#1_33| upsweep_~a.base_34) (+ (* upsweep_~left~0_35 4) upsweep_~a.offset_34)) (select (select |#memory_int#1_33| upsweep_~a.base_34) (+ (* upsweep_~left~0_35 4) upsweep_~a.offset_34 (* upsweep_~space~0_34 4))))) (= (+ (* 2 upsweep_~space~0_34) upsweep_~left~0_35) upsweep_~left~0_36)) :named ssa_36))
...
(assert (! (and (= downsweep_~space_44 (ite (and (not (= (mod |downsweep_#in~space_43| 2) 0)) (< |downsweep_#in~space_43| 0)) (+ (div |downsweep_#in~space_43| 2) 1) (div |downsweep_#in~space_43| 2))) (= downsweep_~a.base_44 |downsweep_#in~a.base_43|) (= downsweep_~a.offset_44 |downsweep_#in~a.offset_43|) (= v_ArrVal_256_fresh_1 (store (select |#memory_int#1_43| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (- 4) (* downsweep_~n_44 4)) v_ArrVal_255_fresh_1)) (= v_ArrVal_255_fresh_1 0) (= downsweep_~n_44 |downsweep_#in~n_43|) (= (store |#memory_int#1_43| downsweep_~a.base_44 v_ArrVal_256_fresh_1) |#memory_int#1_44|)) :named ssa_44))
(assert (! (and (< 0 downsweep_~space_44) (= (+ downsweep_~right~1_45 1) (* 2 downsweep_~space_44))) :named ssa_45))
(assert (! (<= downsweep_~n_44 downsweep_~right~1_45) :named ssa_46))
(assert (! (= downsweep_~space_47 (ite (and (< downsweep_~space_44 0) (not (= (mod downsweep_~space_44 2) 0))) (+ (div downsweep_~space_44 2) 1) (div downsweep_~space_44 2))) :named ssa_47))
(assert (! (and (< 0 downsweep_~space_47) (= (+ downsweep_~right~1_48 1) (* 2 downsweep_~space_47))) :named ssa_48))
(assert (! (and (= v_ArrVal_257_fresh_1 (store (store (select |#memory_int#1_44| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (* downsweep_~right~1_48 4)) (+ (select (select |#memory_int#1_44| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (* downsweep_~right~1_48 4))) (select (select |#memory_int#1_44| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (* downsweep_~right~1_48 4) (* downsweep_~space_47 (- 4)))))) (+ downsweep_~a.offset_44 (* downsweep_~right~1_48 4) (* downsweep_~space_47 (- 4))) (select (select |#memory_int#1_44| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (* downsweep_~right~1_48 4))))) (< downsweep_~right~1_48 downsweep_~n_44) (= downsweep_~right~1_49 (+ (* 2 downsweep_~space_47) downsweep_~right~1_48)) (= v_ArrVal_259_fresh_1 (select (select |#memory_int#1_44| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (* downsweep_~right~1_48 4)))) (= v_ArrVal_258_fresh_1 (+ (select (select |#memory_int#1_44| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (* downsweep_~right~1_48 4))) (select (select |#memory_int#1_44| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (* downsweep_~right~1_48 4) (* downsweep_~space_47 (- 4)))))) (= (store |#memory_int#1_44| downsweep_~a.base_44 v_ArrVal_257_fresh_1) |#memory_int#1_49|)) :named ssa_49))
(assert (! (<= downsweep_~n_44 downsweep_~right~1_49) :named ssa_50))
(assert (! (= downsweep_~space_51 (ite (and (< downsweep_~space_47 0) (not (= (mod downsweep_~space_47 2) 0))) (+ (div downsweep_~space_47 2) 1) (div downsweep_~space_47 2))) :named ssa_51))
(assert (! (<= downsweep_~space_51 0) :named ssa_52))
(assert (! true :named ssa_53))
(assert (! true :named ssa_54_return))
(assert (! true :named ssa_55_GlobVarAssigCall))
(assert (! (and (= main_~a0~0.offset_29 |check_#in~a0.offset_55|) (= main_~a0~0.base_29 |check_#in~a0.base_55|) (= |check_#in~a.offset_55| main_~a~0.offset_25) (= main_~n~0_4 |check_#in~n_55|) (= |check_#in~a.base_55| main_~a~0.base_25)) :named ssa_55_LocVarAssigCall))
(assert (! true :named ssa_55_OldVarAssigCall))
(assert (! (and (= |check_#in~a.offset_55| check_~a.offset_56) (= |check_#in~a0.offset_55| check_~a0.offset_56) (= check_~a.base_56 |check_#in~a.base_55|) (= check_~i~0_56 0) (= check_~a0.base_56 |check_#in~a0.base_55|) (= check_~sum~0_56 0) (= check_~n_56 |check_#in~n_55|)) :named ssa_56))
(assert (! (and (= |check_#t~mem10_57| (select (select |#memory_int#1_49| check_~a.base_56) (+ (* check_~i~0_56 4) check_~a.offset_56))) (< check_~i~0_56 check_~n_56)) :named ssa_57))
(assert (! true :named ssa_58_GlobVarAssigCall))
(assert (! (= (ite (= check_~sum~0_56 |check_#t~mem10_57|) 1 0) |__VERIFIER_assert_#in~cond_58|) :named ssa_58_LocVarAssigCall))
...
(assert (! (not true) :named ssa_postcond))
(assert (! (and (= |#memory_int#1_0| (store |#memory_int#1_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_260_fresh_1)) (= ((as const (Array Int Int)) 0) v_ArrVal_260_fresh_1)) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! true :named ssa_-2_PendingContext))
...
(assert (! (= |#memory_int#1_-1| |old(#memory_int#1)_-1|) :named ssa_precond))
(assert (! (not true) :named ssa_postcond))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_261_fresh_1) (= (store |#memory_int#1_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_261_fresh_1) |#memory_int#1_0|)) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! true :named ssa_-2_PendingContext))
...
(assert (! (= |#memory_int#1_-1| |old(#memory_int#1)_-1|) :named ssa_precond))
(assert (! (not (and (<= 2 |main_#t~ret19_7|) (<= |main_#t~ret19_7| main_~n~0_-2))) :named ssa_postcond))
...
(assert (! (and (= |#memory_int#1_2| (store |#memory_int#1_-1| upsweep_~a.base_0 v_ArrVal_262_fresh_1)) (= (store (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0 (* upsweep_~space~0_0 4)) (+ (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0)) (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0 (* upsweep_~space~0_0 4))))) v_ArrVal_262_fresh_1) (< upsweep_~left~0_1 upsweep_~n_0) (= (+ (* 2 upsweep_~space~0_0) upsweep_~left~0_1) upsweep_~left~0_2) (= v_ArrVal_263_fresh_1 (+ (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0)) (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0 (* upsweep_~space~0_0 4)))))) :named ssa_2))
...
(assert (! (<= 2 main_~n~0_-2) :named ssa_-2_PendingContext))
...
(declare-fun downsweep_~space_3 () Int)
(declare-fun downsweep_~right~1_4 () Int)
(declare-fun downsweep_~right~1_5 () Int)
(declare-fun |downsweep_#t~mem8_5| () Int)
(declare-fun |downsweep_#t~mem9_5| () Int)
(declare-fun |#memory_int#1_5| () (Array Int (Array Int Int)))
(declare-fun downsweep_~temp~0_5 () Int)
(declare-fun downsweep_~left~1_5 () Int)
(declare-fun |downsweep_#t~mem7_5| () Int)
...
(declare-fun downsweep_~space_7 () Int)
(declare-fun downsweep_~space_8 () Int)
(assert (! (= |#memory_int#1_-1| |old(#memory_int#1)_-1|) :named ssa_precond))
(assert (! (not false) :named ssa_postcond))
(assert (! (and (= v_ArrVal_264_fresh_1 0) (= downsweep_~space_0 (ite (and (not (= (mod |downsweep_#in~space_-1| 2) 0)) (< |downsweep_#in~space_-1| 0)) (+ (div |downsweep_#in~space_-1| 2) 1) (div |downsweep_#in~space_-1| 2))) (= downsweep_~a.base_0 |downsweep_#in~a.base_-1|) (= downsweep_~a.offset_0 |downsweep_#in~a.offset_-1|) (= downsweep_~n_0 |downsweep_#in~n_-1|) (= v_ArrVal_265_fresh_1 (store (select |#memory_int#1_-1| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (- 4) (* downsweep_~n_0 4)) v_ArrVal_264_fresh_1)) (= (store |#memory_int#1_-1| downsweep_~a.base_0 v_ArrVal_265_fresh_1) |#memory_int#1_0|)) :named ssa_0))
(assert (! (and (< 0 downsweep_~space_0) (= (+ downsweep_~right~1_1 1) (* 2 downsweep_~space_0))) :named ssa_1))
(assert (! (<= downsweep_~n_0 downsweep_~right~1_1) :named ssa_2))
(assert (! (= downsweep_~space_3 (ite (and (< downsweep_~space_0 0) (not (= (mod downsweep_~space_0 2) 0))) (+ (div downsweep_~space_0 2) 1) (div downsweep_~space_0 2))) :named ssa_3))
(assert (! (and (< 0 downsweep_~space_3) (= (+ downsweep_~right~1_4 1) (* 2 downsweep_~space_3))) :named ssa_4))
(assert (! (and (< downsweep_~right~1_4 downsweep_~n_0) (= v_ArrVal_268_fresh_1 (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_4 4)))) (= v_ArrVal_267_fresh_1 (+ (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_4 4))) (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_4 4) (* downsweep_~space_3 (- 4)))))) (= v_ArrVal_266_fresh_1 (store (store (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_4 4)) (+ (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_4 4))) (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_4 4) (* downsweep_~space_3 (- 4)))))) (+ downsweep_~a.offset_0 (* downsweep_~right~1_4 4) (* downsweep_~space_3 (- 4))) (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_4 4))))) (= |#memory_int#1_5| (store |#memory_int#1_0| downsweep_~a.base_0 v_ArrVal_266_fresh_1)) (= downsweep_~right~1_5 (+ (* 2 downsweep_~space_3) downsweep_~right~1_4))) :named ssa_5))
(assert (! (<= downsweep_~n_0 downsweep_~right~1_5) :named ssa_6))
(assert (! (= downsweep_~space_7 (ite (and (< downsweep_~space_3 0) (not (= (mod downsweep_~space_3 2) 0))) (+ (div downsweep_~space_3 2) 1) (div downsweep_~space_3 2))) :named ssa_7))
(assert (! (<= downsweep_~space_7 0) :named ssa_8))
(assert (! true :named ssa_9))
(assert (! true :named ssa_10_return))
(assert (! (and (<= main_~space~1_-2 main_~n~0_-2) (<= 2 main_~space~1_-2)) :named ssa_-2_PendingContext))
