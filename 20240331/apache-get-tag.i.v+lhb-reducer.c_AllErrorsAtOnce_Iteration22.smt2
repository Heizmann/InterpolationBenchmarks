...
(set-info :ultimate-id apache-get-tag.i.v+lhb-reducer.c_AllErrorsAtOnce_Iteration22)
...
(declare-fun v_main_~main____CPAchecker_TMP_1~0_13_fresh_1 () Int)
(declare-fun v_main_~main____CPAchecker_TMP_0~0_32_fresh_1 () Int)
...
(declare-fun v_main_~main____CPAchecker_TMP_2~0_14_fresh_1 () Int)
(declare-fun v_main_~main____CPAchecker_TMP_0~0_33_fresh_1 () Int)
...
(declare-fun main_~main____CPAchecker_TMP_4~0_17 () Int)
(declare-fun main_~__VERIFIER_assert__cond~4_18 () Int)
(declare-fun main_~main____CPAchecker_TMP_4~0_18 () Int)
(declare-fun v_main_~__tmp_5~0_9_fresh_1 () Int)
(declare-fun main_~__VERIFIER_assert__cond~4_19 () Int)
(declare-fun main_~__VERIFIER_assert__cond~5_19 () Int)
(declare-fun v_main_~__tmp_6~0_8_fresh_1 () Int)
(declare-fun main_~__VERIFIER_assert__cond~5_20 () Int)
...
(assert (! (and (= v_main_~__tmp_13~0_13_fresh_1 (ite (<= 0 main_~main__t~0_5) 1 0)) (= main_~main____CPAchecker_TMP_0~0_6 0) (= main_~__VERIFIER_assert__cond~12_7 v_main_~__tmp_13~0_13_fresh_1)) :named ssa_7))
(assert (! (and (= main_~__VERIFIER_assert__cond~13_8 v_main_~__tmp_14~0_13_fresh_1) (not (= main_~__VERIFIER_assert__cond~12_7 0)) (= (ite (<= main_~main__t~0_5 main_~main__tagbuf_len~0_5) 1 0) v_main_~__tmp_14~0_13_fresh_1)) :named ssa_8))
(assert (! (and (= main_~main____CPAchecker_TMP_0~0_6 ~__tmp_383_0~0_9) (not (= main_~__VERIFIER_assert__cond~13_8 0))) :named ssa_9))
(assert (! (and (= main_~main__t~0_5 v_main_~main____CPAchecker_TMP_1~0_13_fresh_1) (= ~__tmp_383_0~0_9 v_main_~main____CPAchecker_TMP_0~0_32_fresh_1) (= main_~main__t~0_10 (+ main_~main__t~0_5 1))) :named ssa_10))
...
(assert (! (and (= v_main_~__tmp_17~0_7_fresh_1 (ite (<= 0 main_~main__t~0_10) 1 0)) (= v_main_~__tmp_17~0_7_fresh_1 main_~__VERIFIER_assert__cond~16_12) (not (= main_~main____CPAchecker_TMP_0~1_11 0))) :named ssa_12))
(assert (! (and (= v_main_~__tmp_18~0_6_fresh_1 main_~__VERIFIER_assert__cond~17_13) (= (ite (<= main_~main__t~0_10 main_~main__tagbuf_len~0_5) 1 0) v_main_~__tmp_18~0_6_fresh_1) (not (= main_~__VERIFIER_assert__cond~16_12 0))) :named ssa_13))
(assert (! (and (not (= main_~__VERIFIER_assert__cond~17_13 0)) (= main_~main____CPAchecker_TMP_0~1_11 ~__tmp_259_0~0_14)) :named ssa_14))
(assert (! (and (= (+ main_~main__t~0_10 1) main_~main__t~0_15) (= ~__tmp_259_0~0_14 v_main_~main____CPAchecker_TMP_0~0_33_fresh_1) (= v_main_~main____CPAchecker_TMP_2~0_14_fresh_1 main_~main__t~0_10)) :named ssa_15))
...
(assert (! (and (not (= main_~main____CPAchecker_TMP_3~0_16 0)) (<= main_~main____CPAchecker_TMP_4~0_17 2147483647) (<= 0 (+ main_~main____CPAchecker_TMP_4~0_17 2147483648))) :named ssa_17))
(assert (! (and (= v_main_~__tmp_5~0_9_fresh_1 main_~__VERIFIER_assert__cond~4_18) (= v_main_~__tmp_5~0_9_fresh_1 (ite (<= 0 main_~main__t~0_15) 1 0)) (not (= main_~main____CPAchecker_TMP_4~0_17 0))) :named ssa_18))
(assert (! (and (not (= main_~__VERIFIER_assert__cond~4_18 0)) (= v_main_~__tmp_6~0_8_fresh_1 main_~__VERIFIER_assert__cond~5_19) (= (ite (<= main_~main__t~0_15 main_~main__tagbuf_len~0_5) 1 0) v_main_~__tmp_6~0_8_fresh_1)) :named ssa_19))
(assert (! (= main_~__VERIFIER_assert__cond~5_19 0) :named ssa_20))
