...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:16:38+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id pals_lcr-var-start-time.3.ufo.BOUNDED-6.pals.c_AllErrorsAtOnce_Iteration6)
...
(declare-fun v_node1_~m1~0_22_fresh_1 () Int)
(declare-fun ~r1~0_32 () Int)
(declare-fun ~p3_old~0_32 () Int)
(declare-fun node1_~m1~0_32 () Int)
(declare-fun ~st1~0_36 () Int)
(declare-fun node1_~m1~0_36 () Int)
(declare-fun ~mode1~0_37 () Int)
(declare-fun |old(~mode2~0)_40| () Int)
(declare-fun |old(~p1_old~0)_40| () Int)
(declare-fun |old(~p2_new~0)_40| () Int)
(declare-fun |old(~st2~0)_40| () Int)
(declare-fun |old(~send2~0)_40| () Int)
(declare-fun ~mode2~0_40 () Int)
(declare-fun ~p1_old~0_40 () Int)
(declare-fun ~p2_new~0_40 () Int)
(declare-fun ~st2~0_40 () Int)
(declare-fun ~send2~0_40 () Int)
(declare-fun v_node2_~m2~0_22_fresh_1 () Int)
(declare-fun ~p2_new~0_43 () Int)
(declare-fun ~mode2~0_44 () Int)
(declare-fun |old(~st3~0)_47| () Int)
(declare-fun |old(~mode3~0)_47| () Int)
(declare-fun |old(~p3_new~0)_47| () Int)
(declare-fun |old(~send3~0)_47| () Int)
(declare-fun |old(~p2_old~0)_47| () Int)
(declare-fun ~st3~0_47 () Int)
(declare-fun ~mode3~0_47 () Int)
(declare-fun ~p3_new~0_47 () Int)
(declare-fun ~send3~0_47 () Int)
(declare-fun ~p2_old~0_47 () Int)
(declare-fun v_node3_~m3~0_22_fresh_1 () Int)
(declare-fun ~p3_new~0_50 () Int)
(declare-fun ~mode3~0_51 () Int)
(declare-fun ~p3_new~0_54 () Int)
(declare-fun ~p2_new~0_54 () Int)
(declare-fun ~p1_new~0_54 () Int)
(declare-fun ~p1_old~0_54 () Int)
(declare-fun ~p3_old~0_54 () Int)
...
(declare-fun |main_#t~ret21_59| () Int)
(declare-fun |check_#res_59| () Int)
(declare-fun main_~c1~0_60 () Int)
(declare-fun |main_#t~ret21_60| () Int)
(declare-fun main_~c1~0_61 () Int)
(declare-fun |assert_#in~arg_61| () Int)
(declare-fun assert_~arg_62 () Int)
(declare-fun assert_~arg_63 () Int)
...
(assert (! (and (<= ~id2~0_4 127) (<= 0 (+ ~send2~0_4 128)) (<= ~id1~0_4 127) (<= 0 (+ ~send3~0_4 128)) (<= ~send3~0_4 127) (<= ~st2~0_4 127) (<= 0 (+ ~id3~0_4 128)) (<= ~r1~0_4 127) (<= ~st1~0_4 127) (<= 0 (+ 128 ~st3~0_4)) (<= 0 (+ 128 ~st2~0_4)) (<= 0 (+ ~r1~0_4 128)) (= v_main_~c1~0_12_fresh_1 0) (<= 0 (+ 128 ~st1~0_4)) (<= 0 (+ ~id2~0_4 128)) (<= ~id3~0_4 127) (<= ~st3~0_4 127) (<= 0 (+ ~send1~0_4 128)) (<= 0 (+ ~id1~0_4 128)) (<= ~send1~0_4 127) (<= ~send2~0_4 127)) :named ssa_4))
...
(assert (! (= ~nomsg~0_1 v_node1_~m1~0_22_fresh_1) :named ssa_31))
...
(assert (! (not (= ~nomsg~0_1 node1_~m1~0_32)) :named ssa_33))
(assert (! (not (= (mod ~alive1~0_4 256) 0)) :named ssa_34))
(assert (! (<= node1_~m1~0_32 ~id1~0_4) :named ssa_35))
(assert (! (and (= ~id1~0_4 node1_~m1~0_32) (= ~st1~0_36 1)) :named ssa_36))
(assert (! (= ~mode1~0_37 0) :named ssa_37))
(assert (! true :named ssa_38))
(assert (! true :named ssa_39_return))
(assert (! (and (= ~mode2~0_40 |old(~mode2~0)_40|) (= ~p1_old~0_40 |old(~p1_old~0)_40|) (= ~p2_new~0_40 |old(~p2_new~0)_40|) (= ~send2~0_40 |old(~send2~0)_40|) (= |old(~st2~0)_40| ~st2~0_40)) :named ssa_40_GlobVarAssigCall))
(assert (! true :named ssa_40_LocVarAssigCall))
(assert (! (and (= ~st2~0_4 |old(~st2~0)_40|) (= |old(~send2~0)_40| ~send2~0_4) (= ~p1_old~0_28 |old(~p1_old~0)_40|) (= |old(~mode2~0)_40| ~mode2~0_4) (= |old(~p2_new~0)_40| ~p2_new~0_28)) :named ssa_40_OldVarAssigCall))
(assert (! (= ~nomsg~0_1 v_node2_~m2~0_22_fresh_1) :named ssa_41))
(assert (! (= (mod ~mode2~0_40 256) 0) :named ssa_42))
(assert (! (and (= ~p2_new~0_43 (ite (<= (mod (ite (and (not (= ~send2~0_40 ~nomsg~0_1)) (= ~p2_new~0_40 ~nomsg~0_1)) ~send2~0_40 ~p2_new~0_40) 256) 127) (mod (ite (and (not (= ~send2~0_40 ~nomsg~0_1)) (= ~p2_new~0_40 ~nomsg~0_1)) ~send2~0_40 ~p2_new~0_40) 256) (+ (- 256) (mod (ite (and (not (= ~send2~0_40 ~nomsg~0_1)) (= ~p2_new~0_40 ~nomsg~0_1)) ~send2~0_40 ~p2_new~0_40) 256)))) (not (= (mod ~alive2~0_4 256) 0))) :named ssa_43))
(assert (! (= ~mode2~0_44 1) :named ssa_44))
(assert (! true :named ssa_45))
(assert (! true :named ssa_46_return))
(assert (! (and (= ~send3~0_47 |old(~send3~0)_47|) (= |old(~st3~0)_47| ~st3~0_47) (= |old(~p3_new~0)_47| ~p3_new~0_47) (= |old(~p2_old~0)_47| ~p2_old~0_47) (= |old(~mode3~0)_47| ~mode3~0_47)) :named ssa_47_GlobVarAssigCall))
(assert (! true :named ssa_47_LocVarAssigCall))
(assert (! (and (= |old(~send3~0)_47| ~send3~0_4) (= |old(~p3_new~0)_47| ~p3_new~0_28) (= ~p2_old~0_28 |old(~p2_old~0)_47|) (= |old(~mode3~0)_47| ~mode3~0_4) (= |old(~st3~0)_47| ~st3~0_4)) :named ssa_47_OldVarAssigCall))
(assert (! (= ~nomsg~0_1 v_node3_~m3~0_22_fresh_1) :named ssa_48))
(assert (! (= (mod ~mode3~0_47 256) 0) :named ssa_49))
(assert (! (and (= (ite (<= (mod (ite (and (not (= ~send3~0_47 ~nomsg~0_1)) (= ~nomsg~0_1 ~p3_new~0_47)) ~send3~0_47 ~p3_new~0_47) 256) 127) (mod (ite (and (not (= ~send3~0_47 ~nomsg~0_1)) (= ~nomsg~0_1 ~p3_new~0_47)) ~send3~0_47 ~p3_new~0_47) 256) (+ (- 256) (mod (ite (and (not (= ~send3~0_47 ~nomsg~0_1)) (= ~nomsg~0_1 ~p3_new~0_47)) ~send3~0_47 ~p3_new~0_47) 256))) ~p3_new~0_50) (not (= (mod ~alive3~0_4 256) 0))) :named ssa_50))
(assert (! (= ~mode3~0_51 1) :named ssa_51))
(assert (! true :named ssa_52))
(assert (! true :named ssa_53_return))
(assert (! (and (= ~p2_new~0_43 ~p2_old~0_54) (= ~nomsg~0_1 ~p1_new~0_54) (= ~p2_new~0_54 ~nomsg~0_1) (= ~p1_old~0_54 ~p1_new~0_30) (= ~nomsg~0_1 ~p3_new~0_54) (= ~p3_old~0_54 ~p3_new~0_50)) :named ssa_54))
...
(assert (! (and (< 1 (+ ~st1~0_36 ~st2~0_40 ~st3~0_47)) (= check_~tmp~1_57 0)) :named ssa_57))
(assert (! (= |check_#res_58| check_~tmp~1_57) :named ssa_58))
(assert (! (= |check_#res_58| |main_#t~ret21_59|) :named ssa_59_return))
(assert (! (and (<= 0 (+ |main_#t~ret21_59| 2147483648)) (= |main_#t~ret21_59| main_~c1~0_60) (<= |main_#t~ret21_59| 2147483647)) :named ssa_60))
(assert (! true :named ssa_61_GlobVarAssigCall))
(assert (! (= (ite (= 0 main_~c1~0_60) 0 1) |assert_#in~arg_61|) :named ssa_61_LocVarAssigCall))
(assert (! true :named ssa_61_OldVarAssigCall))
(assert (! (= assert_~arg_62 |assert_#in~arg_61|) :named ssa_62))
(assert (! (= (mod assert_~arg_62 256) 0) :named ssa_63))
(assert (! true :named ssa_64))
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 (and ssa_13 ssa_25_return ssa_20 ssa_5_LocVarAssigCall ssa_5_GlobVarAssigCall ssa_7 ssa_16 ssa_6 ssa_10 ssa_14 ssa_8 ssa_9 ssa_19 ssa_12 ssa_5_OldVarAssigCall ssa_11 ssa_22 ssa_15 ssa_21 ssa_18 ssa_23 ssa_17 ssa_24) ssa_26 ssa_27 ssa_28 ssa_29 (and ssa_31 ssa_34 ssa_39_return ssa_30_LocVarAssigCall ssa_37 ssa_38 ssa_30_OldVarAssigCall ssa_32 ssa_36 ssa_33 ssa_35 ssa_30_GlobVarAssigCall) (and ssa_44 ssa_40_OldVarAssigCall ssa_45 ssa_40_LocVarAssigCall ssa_40_GlobVarAssigCall ssa_43 ssa_41 ssa_42 ssa_46_return) (and ssa_47_GlobVarAssigCall ssa_47_OldVarAssigCall ssa_53_return ssa_50 ssa_48 ssa_51 ssa_49 ssa_52 ssa_47_LocVarAssigCall) ssa_54 (and ssa_57 ssa_55_OldVarAssigCall ssa_59_return ssa_58 ssa_55_GlobVarAssigCall ssa_55_LocVarAssigCall ssa_56) ssa_60 (and ssa_61_OldVarAssigCall ssa_61_LocVarAssigCall ssa_61_GlobVarAssigCall) ssa_62 ssa_63 (and ssa_64 ssa_postcond))
...
(assert (! true :named ssa_precond))
(assert (! (not (<= (+ ~nomsg~0_-1 1) ~id1~0_-2)) :named ssa_postcond))
...
(declare-fun ~send1~0_-1 () Int)
(declare-fun ~nomsg~0_-1 () Int)
(declare-fun v_node1_~m1~0_23_fresh_1 () Int)
(declare-fun ~r1~0_1 () Int)
(declare-fun ~p3_old~0_1 () Int)
(declare-fun node1_~m1~0_1 () Int)
(declare-fun ~st1~0_5 () Int)
(declare-fun node1_~m1~0_5 () Int)
...
(assert (! (not false) :named ssa_postcond))
(assert (! (= ~nomsg~0_-1 v_node1_~m1~0_23_fresh_1) :named ssa_0))
...
(assert (! (not (= ~nomsg~0_-1 node1_~m1~0_1)) :named ssa_2))
(assert (! (not (= (mod ~alive1~0_-2 256) 0)) :named ssa_3))
(assert (! (<= node1_~m1~0_1 ~id1~0_-2) :named ssa_4))
(assert (! (and (= ~id1~0_-2 node1_~m1~0_1) (= ~st1~0_5 1)) :named ssa_5))
(assert (! (= ~mode1~0_6 0) :named ssa_6))
(assert (! true :named ssa_7))
(assert (! true :named ssa_8_return))
(assert (! (<= (+ ~p3_old~0_-2 1) ~id1~0_-2) :named ssa_-2_PendingContext))
(assert (! true :named ssa_-2_LocVarAssignPendingContext))
...
(declare-fun ~send2~0_-1 () Int)
(declare-fun ~nomsg~0_-1 () Int)
(declare-fun v_node2_~m2~0_23_fresh_1 () Int)
...
(assert (! (not false) :named ssa_postcond))
(assert (! (= ~nomsg~0_-1 v_node2_~m2~0_23_fresh_1) :named ssa_0))
...
(declare-fun ~p2_old~0_-1 () Int)
(declare-fun ~nomsg~0_-1 () Int)
(declare-fun v_node3_~m3~0_23_fresh_1 () Int)
...
(assert (! (not false) :named ssa_postcond))
(assert (! (= ~nomsg~0_-1 v_node3_~m3~0_23_fresh_1) :named ssa_0))
