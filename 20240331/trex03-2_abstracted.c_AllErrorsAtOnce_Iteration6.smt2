...
(set-info :ultimate-id trex03-2_abstracted.c_AllErrorsAtOnce_Iteration6)
...
(declare-fun v_main_~d2~0_8_fresh_1 () Int)
(declare-fun v_main_~d1~0_8_fresh_1 () Int)
(declare-fun v_main_~d3~0_8_fresh_1 () Int)
...
(declare-fun main_~x2~0_14 () Int)
(declare-fun main_~x1~0_14 () Int)
(declare-fun main_~x3~0_14 () Int)
...
(assert (! (and (= 1 v_main_~d2~0_8_fresh_1) (= 1 v_main_~d3~0_8_fresh_1) (= 1 v_main_~d1~0_8_fresh_1)) :named ssa_4))
...
(assert (! (and (= |main_#t~bitwise17_12| 0) (or (= |main_#t~bitwise16_11| 0) (= (ite (< 0 (mod main_~x3~0_9 4294967296)) 1 0) 0))) :named ssa_12))
(assert (! (= |main_#t~bitwise17_12| 0) :named ssa_13))
(assert (! true :named ssa_14_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_14| (ite (or (= (mod main_~x1~0_9 4294967296) 0) (= (mod main_~x2~0_9 4294967296) 0) (= (mod main_~x3~0_9 4294967296) 0)) 1 0)) :named ssa_14_LocVarAssigCall))
