...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:18:35+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id prefixsum_iter.c_AllErrorsAtOnce_Iteration9)
...
(declare-fun |v_#Ultimate.meminit_#sizeOfFieldsInParam_21_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#productInParam_21_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#ptr.offsetInParam_21_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#amountOfFieldsInParam_21_fresh_1| () Int)
...
(declare-fun |v_#Ultimate.meminit_#sizeOfFieldsInParam_22_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#ptr.offsetInParam_22_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#productInParam_22_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#amountOfFieldsInParam_22_fresh_1| () Int)
...
(assert (! (and (not (= |main_#t~malloc15.base_21| 0)) (= (store |#length_3| |main_#t~malloc15.base_21| v_ArrVal_126_fresh_1) |#length_21|) (< |main_#t~malloc15.base_21| |#StackHeapBarrier_-1|) (= v_ArrVal_126_fresh_1 (* (mod main_~n~0_4 1073741824) 4)) (= v_ArrVal_125_fresh_1 1) (= |main_#t~malloc15.offset_21| 0) (= (select |#valid_3| |main_#t~malloc15.base_21|) 0) (= |#valid_21| (store |#valid_3| |main_#t~malloc15.base_21| v_ArrVal_125_fresh_1))) :named ssa_21))
(assert (! (= |old(#memory_int#1)_22| |#memory_int#1_22|) :named ssa_22_GlobVarAssigCall))
(assert (! (and (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_21_fresh_1|) (= |#Ultimate.meminit_#ptr.base_22| |main_#t~malloc15.base_21|) (= (* main_~n~0_4 4) |v_#Ultimate.meminit_#productInParam_21_fresh_1|) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_21_fresh_1| 4) (= |v_#Ultimate.meminit_#ptr.offsetInParam_21_fresh_1| |main_#t~malloc15.offset_21|)) :named ssa_22_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_22| |#memory_int#1_3|) :named ssa_22_OldVarAssigCall))
(assert (! (and (= |#memory_int#1_23| (store |#memory_int#1_22| |#Ultimate.meminit_#ptr.base_22| v_ArrVal_127_fresh_1)) (= ((as const (Array Int Int)) 0) v_ArrVal_127_fresh_1)) :named ssa_23))
(assert (! true :named ssa_24_return))
(assert (! (and (= (select |#valid_21| |main_#t~malloc16.base_25|) 0) (= |#length_25| (store |#length_21| |main_#t~malloc16.base_25| v_ArrVal_129_fresh_1)) (= v_ArrVal_129_fresh_1 (* (mod main_~n~0_4 1073741824) 4)) (= v_ArrVal_128_fresh_1 1) (not (= |main_#t~malloc16.base_25| 0)) (= |#valid_25| (store |#valid_21| |main_#t~malloc16.base_25| v_ArrVal_128_fresh_1)) (= |main_#t~malloc16.offset_25| 0) (= main_~a~0.offset_25 |main_#t~malloc15.offset_21|) (= main_~a~0.base_25 |main_#t~malloc15.base_21|) (< |main_#t~malloc16.base_25| |#StackHeapBarrier_-1|)) :named ssa_25))
(assert (! (= |old(#memory_int#1)_26| |#memory_int#1_26|) :named ssa_26_GlobVarAssigCall))
(assert (! (and (= (* main_~n~0_4 4) |v_#Ultimate.meminit_#productInParam_22_fresh_1|) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_22_fresh_1|) (= |v_#Ultimate.meminit_#ptr.offsetInParam_22_fresh_1| |main_#t~malloc16.offset_25|) (= |#Ultimate.meminit_#ptr.base_26| |main_#t~malloc16.base_25|) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_22_fresh_1| 4)) :named ssa_26_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_26| |#memory_int#1_23|) :named ssa_26_OldVarAssigCall))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_130_fresh_1) (= (store |#memory_int#1_26| |#Ultimate.meminit_#ptr.base_26| v_ArrVal_130_fresh_1) |#memory_int#1_27|)) :named ssa_27))
...
(assert (! (and (< main_~i~1_29 main_~n~0_4) (= (store (select |#memory_int#1_27| main_~a0~0.base_29) (+ main_~a0~0.offset_29 (* main_~i~1_29 4)) v_ArrVal_131_fresh_1) v_ArrVal_132_fresh_1) (= |#memory_int#1_30| (store |#memory_int#1_27| main_~a0~0.base_29 v_ArrVal_132_fresh_1)) (= v_ArrVal_131_fresh_1 (select (select |#memory_int#1_27| main_~a~0.base_25) (+ main_~a~0.offset_25 (* main_~i~1_29 4)))) (= main_~i~1_30 (+ main_~i~1_29 1))) :named ssa_30))
(assert (! (and (< main_~i~1_30 main_~n~0_4) (= v_ArrVal_133_fresh_1 (select (select |#memory_int#1_30| main_~a~0.base_25) (+ main_~a~0.offset_25 (* main_~i~1_30 4)))) (= v_ArrVal_134_fresh_1 (store (select |#memory_int#1_30| main_~a0~0.base_29) (+ main_~a0~0.offset_29 (* main_~i~1_30 4)) v_ArrVal_133_fresh_1)) (= (store |#memory_int#1_30| main_~a0~0.base_29 v_ArrVal_134_fresh_1) |#memory_int#1_31|) (= main_~i~1_31 (+ main_~i~1_30 1))) :named ssa_31))
...
(assert (! (and (= (store (select |#memory_int#1_33| upsweep_~a.base_34) (+ (* upsweep_~left~0_35 4) upsweep_~a.offset_34 (* upsweep_~space~0_34 4)) (+ (select (select |#memory_int#1_33| upsweep_~a.base_34) (+ (* upsweep_~left~0_35 4) upsweep_~a.offset_34)) (select (select |#memory_int#1_33| upsweep_~a.base_34) (+ (* upsweep_~left~0_35 4) upsweep_~a.offset_34 (* upsweep_~space~0_34 4))))) v_ArrVal_135_fresh_1) (= (store |#memory_int#1_33| upsweep_~a.base_34 v_ArrVal_135_fresh_1) |#memory_int#1_36|) (= v_ArrVal_136_fresh_1 (+ (select (select |#memory_int#1_33| upsweep_~a.base_34) (+ (* upsweep_~left~0_35 4) upsweep_~a.offset_34)) (select (select |#memory_int#1_33| upsweep_~a.base_34) (+ (* upsweep_~left~0_35 4) upsweep_~a.offset_34 (* upsweep_~space~0_34 4))))) (< upsweep_~left~0_35 upsweep_~n_34) (= (+ (* 2 upsweep_~space~0_34) upsweep_~left~0_35) upsweep_~left~0_36)) :named ssa_36))
...
(assert (! (and (= downsweep_~space_44 (ite (and (not (= (mod |downsweep_#in~space_43| 2) 0)) (< |downsweep_#in~space_43| 0)) (+ (div |downsweep_#in~space_43| 2) 1) (div |downsweep_#in~space_43| 2))) (= downsweep_~a.base_44 |downsweep_#in~a.base_43|) (= downsweep_~a.offset_44 |downsweep_#in~a.offset_43|) (= |#memory_int#1_44| (store |#memory_int#1_43| downsweep_~a.base_44 v_ArrVal_138_fresh_1)) (= v_ArrVal_137_fresh_1 0) (= downsweep_~n_44 |downsweep_#in~n_43|) (= v_ArrVal_138_fresh_1 (store (select |#memory_int#1_43| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (- 4) (* downsweep_~n_44 4)) v_ArrVal_137_fresh_1))) :named ssa_44))
(assert (! (and (< 0 downsweep_~space_44) (= (+ downsweep_~right~1_45 1) (* 2 downsweep_~space_44))) :named ssa_45))
(assert (! (and (= v_ArrVal_141_fresh_1 (select (select |#memory_int#1_44| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (* downsweep_~right~1_45 4)))) (< downsweep_~right~1_45 downsweep_~n_44) (= v_ArrVal_140_fresh_1 (+ (select (select |#memory_int#1_44| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (* downsweep_~right~1_45 4))) (select (select |#memory_int#1_44| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (* downsweep_~right~1_45 4) (* downsweep_~space_44 (- 4)))))) (= downsweep_~right~1_46 (+ (* 2 downsweep_~space_44) downsweep_~right~1_45)) (= v_ArrVal_139_fresh_1 (store (store (select |#memory_int#1_44| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (* downsweep_~right~1_45 4)) (+ (select (select |#memory_int#1_44| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (* downsweep_~right~1_45 4))) (select (select |#memory_int#1_44| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (* downsweep_~right~1_45 4) (* downsweep_~space_44 (- 4)))))) (+ downsweep_~a.offset_44 (* downsweep_~right~1_45 4) (* downsweep_~space_44 (- 4))) (select (select |#memory_int#1_44| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (* downsweep_~right~1_45 4))))) (= (store |#memory_int#1_44| downsweep_~a.base_44 v_ArrVal_139_fresh_1) |#memory_int#1_46|)) :named ssa_46))
...
(assert (! (not (= |main_#t~malloc15.offset_-2| 0)) :named ssa_postcond))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_142_fresh_1) (= |#memory_int#1_0| (store |#memory_int#1_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_142_fresh_1))) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! (= |main_#t~malloc15.offset_-2| 0) :named ssa_-2_PendingContext))
...
(assert (! (= |#memory_int#1_-1| |old(#memory_int#1)_-1|) :named ssa_precond))
(assert (! (not (= main_~a~0.offset_-2 0)) :named ssa_postcond))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_143_fresh_1) (= |#memory_int#1_0| (store |#memory_int#1_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_143_fresh_1))) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! (= main_~a~0.offset_-2 0) :named ssa_-2_PendingContext))
...
(assert (! (= |#memory_int#1_-1| |old(#memory_int#1)_-1|) :named ssa_precond))
(assert (! (not (and (<= main_~n~0_-2 2) (= main_~a~0.offset_-2 0) (= |main_#t~ret19_7| 2))) :named ssa_postcond))
...
(assert (! (and (< upsweep_~left~0_1 upsweep_~n_0) (= |#memory_int#1_2| (store |#memory_int#1_-1| upsweep_~a.base_0 v_ArrVal_144_fresh_1)) (= (store (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0 (* upsweep_~space~0_0 4)) (+ (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0)) (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0 (* upsweep_~space~0_0 4))))) v_ArrVal_144_fresh_1) (= (+ (* 2 upsweep_~space~0_0) upsweep_~left~0_1) upsweep_~left~0_2) (= v_ArrVal_145_fresh_1 (+ (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0)) (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0 (* upsweep_~space~0_0 4)))))) :named ssa_2))
...
(assert (! (and (= main_~n~0_-2 2) (= main_~a~0.offset_-2 0)) :named ssa_-2_PendingContext))
...
(assert (! (= |#memory_int#1_-1| |old(#memory_int#1)_-1|) :named ssa_precond))
(assert (! (not (and (= (select (select |#memory_int#1_2| main_~a~0.base_-2) 0) 0) (= main_~a~0.offset_-2 0))) :named ssa_postcond))
(assert (! (and (= downsweep_~space_0 (ite (and (not (= (mod |downsweep_#in~space_-1| 2) 0)) (< |downsweep_#in~space_-1| 0)) (+ (div |downsweep_#in~space_-1| 2) 1) (div |downsweep_#in~space_-1| 2))) (= downsweep_~a.base_0 |downsweep_#in~a.base_-1|) (= downsweep_~a.offset_0 |downsweep_#in~a.offset_-1|) (= v_ArrVal_146_fresh_1 0) (= downsweep_~n_0 |downsweep_#in~n_-1|) (= |#memory_int#1_0| (store |#memory_int#1_-1| downsweep_~a.base_0 v_ArrVal_147_fresh_1)) (= v_ArrVal_147_fresh_1 (store (select |#memory_int#1_-1| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (- 4) (* downsweep_~n_0 4)) v_ArrVal_146_fresh_1))) :named ssa_0))
(assert (! (and (< 0 downsweep_~space_0) (= (+ downsweep_~right~1_1 1) (* 2 downsweep_~space_0))) :named ssa_1))
(assert (! (and (< downsweep_~right~1_1 downsweep_~n_0) (= v_ArrVal_148_fresh_1 (store (store (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4)) (+ (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4))) (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4) (* downsweep_~space_0 (- 4)))))) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4) (* downsweep_~space_0 (- 4))) (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4))))) (= (store |#memory_int#1_0| downsweep_~a.base_0 v_ArrVal_148_fresh_1) |#memory_int#1_2|) (= v_ArrVal_150_fresh_1 (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4)))) (= downsweep_~right~1_2 (+ (* 2 downsweep_~space_0) downsweep_~right~1_1)) (= v_ArrVal_149_fresh_1 (+ (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4))) (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4) (* downsweep_~space_0 (- 4))))))) :named ssa_2))
...
(assert (! (and (<= main_~n~0_-2 2) (= main_~a~0.offset_-2 0) (= 2 main_~space~1_-2)) :named ssa_-2_PendingContext))
