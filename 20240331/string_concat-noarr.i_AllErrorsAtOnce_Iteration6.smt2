...
(set-info :ultimate-id string_concat-noarr.i_AllErrorsAtOnce_Iteration6)
...
(assert (! (or (<= 1000000 main_~i~0_15) (= |main_#t~nondet3_16| 0)) :named ssa_17))
(assert (! (< main_~j~0_15 100) :named ssa_18))
(assert (! true :named ssa_19_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_19| (ite (< main_~i~0_15 200) 1 0)) :named ssa_19_LocVarAssigCall))
