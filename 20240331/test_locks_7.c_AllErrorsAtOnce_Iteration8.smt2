...
(set-info :ultimate-id test_locks_7.c_AllErrorsAtOnce_Iteration8)
...
(declare-fun main_~lk4~0_18 () Int)
...
(assert (! (not (= main_~p4~0_4 0)) :named ssa_17))
(assert (! (not (= main_~lk4~0_10 1)) :named ssa_18))
