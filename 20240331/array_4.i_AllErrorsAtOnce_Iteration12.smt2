...
(set-info :ultimate-id array_4.i_AllErrorsAtOnce_Iteration12)
...
(assert (! (and (= v_ArrVal_109_fresh_1 1) (= (store |#valid_3| |main_~#A~0.base_4| v_ArrVal_109_fresh_1) |#valid_4|) (= (select |#valid_3| |main_~#A~0.base_4|) 0) (= v_ArrVal_110_fresh_1 4096) (not (= |main_~#A~0.base_4| 0)) (= 0 |main_~#A~0.offset_4|) (= (store |#length_3| |main_~#A~0.base_4| v_ArrVal_110_fresh_1) |#length_4|) (< |#StackHeapBarrier_-1| |main_~#A~0.base_4|) (= main_~i~0_4 0)) :named ssa_4))
(assert (! (and (<= |v_main_#t~nondet1_40_fresh_1| 2147483647) (= main_~i~0_5 (+ main_~i~0_4 1)) (= (store |#memory_int#1_3| |main_~#A~0.base_4| v_ArrVal_111_fresh_1) |#memory_int#1_5|) (<= 0 (+ |v_main_#t~nondet1_40_fresh_1| 2147483648)) (< main_~i~0_4 1023) (= v_ArrVal_111_fresh_1 (store (select |#memory_int#1_3| |main_~#A~0.base_4|) (+ (* main_~i~0_4 4) |main_~#A~0.offset_4|) |v_main_#t~nondet1_40_fresh_1|)) (= v_ArrVal_112_fresh_1 |v_main_#t~nondet1_40_fresh_1|)) :named ssa_5))
(assert (! (and (= (store |#memory_int#1_5| |main_~#A~0.base_4| v_ArrVal_113_fresh_1) |#memory_int#1_6|) (= main_~i~0_6 (+ main_~i~0_5 1)) (<= 0 (+ |v_main_#t~nondet1_41_fresh_1| 2147483648)) (<= |v_main_#t~nondet1_41_fresh_1| 2147483647) (< main_~i~0_5 1023) (= v_ArrVal_114_fresh_1 |v_main_#t~nondet1_41_fresh_1|) (= v_ArrVal_113_fresh_1 (store (select |#memory_int#1_5| |main_~#A~0.base_4|) (+ (* main_~i~0_5 4) |main_~#A~0.offset_4|) |v_main_#t~nondet1_41_fresh_1|))) :named ssa_6))
(assert (! (and (= main_~i~0_7 (+ main_~i~0_6 1)) (= v_ArrVal_116_fresh_1 |v_main_#t~nondet1_42_fresh_1|) (= v_ArrVal_115_fresh_1 (store (select |#memory_int#1_6| |main_~#A~0.base_4|) (+ (* main_~i~0_6 4) |main_~#A~0.offset_4|) |v_main_#t~nondet1_42_fresh_1|)) (<= |v_main_#t~nondet1_42_fresh_1| 2147483647) (< main_~i~0_6 1023) (= (store |#memory_int#1_6| |main_~#A~0.base_4| v_ArrVal_115_fresh_1) |#memory_int#1_7|) (<= 0 (+ |v_main_#t~nondet1_42_fresh_1| 2147483648))) :named ssa_7))
(assert (! (and (<= |v_main_#t~nondet1_43_fresh_1| 2147483647) (<= 0 (+ |v_main_#t~nondet1_43_fresh_1| 2147483648)) (= v_ArrVal_117_fresh_1 (store (select |#memory_int#1_7| |main_~#A~0.base_4|) (+ (* main_~i~0_7 4) |main_~#A~0.offset_4|) |v_main_#t~nondet1_43_fresh_1|)) (= main_~i~0_8 (+ main_~i~0_7 1)) (= |#memory_int#1_8| (store |#memory_int#1_7| |main_~#A~0.base_4| v_ArrVal_117_fresh_1)) (< main_~i~0_7 1023) (= v_ArrVal_118_fresh_1 |v_main_#t~nondet1_43_fresh_1|)) :named ssa_8))
(assert (! (and (= (store |#memory_int#1_8| |main_~#A~0.base_4| v_ArrVal_119_fresh_1) |#memory_int#1_9|) (<= |v_main_#t~nondet1_44_fresh_1| 2147483647) (= main_~i~0_9 (+ main_~i~0_8 1)) (< main_~i~0_8 1023) (= v_ArrVal_120_fresh_1 |v_main_#t~nondet1_44_fresh_1|) (<= 0 (+ |v_main_#t~nondet1_44_fresh_1| 2147483648)) (= v_ArrVal_119_fresh_1 (store (select |#memory_int#1_8| |main_~#A~0.base_4|) (+ (* main_~i~0_8 4) |main_~#A~0.offset_4|) |v_main_#t~nondet1_44_fresh_1|))) :named ssa_9))
(assert (! (and (= main_~i~0_10 (+ main_~i~0_9 1)) (= (store (select |#memory_int#1_9| |main_~#A~0.base_4|) (+ (* main_~i~0_9 4) |main_~#A~0.offset_4|) |v_main_#t~nondet1_45_fresh_1|) v_ArrVal_121_fresh_1) (= v_ArrVal_122_fresh_1 |v_main_#t~nondet1_45_fresh_1|) (< main_~i~0_9 1023) (<= |v_main_#t~nondet1_45_fresh_1| 2147483647) (= (store |#memory_int#1_9| |main_~#A~0.base_4| v_ArrVal_121_fresh_1) |#memory_int#1_10|) (<= 0 (+ |v_main_#t~nondet1_45_fresh_1| 2147483648))) :named ssa_10))
(assert (! (and (= (store |#memory_int#1_10| |main_~#A~0.base_4| v_ArrVal_124_fresh_1) |#memory_int#1_11|) (<= |v_main_#t~nondet1_46_fresh_1| 2147483647) (= main_~i~0_11 (+ main_~i~0_10 1)) (= v_ArrVal_124_fresh_1 (store (select |#memory_int#1_10| |main_~#A~0.base_4|) (+ (* main_~i~0_10 4) |main_~#A~0.offset_4|) v_ArrVal_123_fresh_1)) (< main_~i~0_10 1023) (<= 0 (+ |v_main_#t~nondet1_46_fresh_1| 2147483648)) (= v_ArrVal_123_fresh_1 |v_main_#t~nondet1_46_fresh_1|)) :named ssa_11))
(assert (! (and (<= 0 (+ |v_main_#t~nondet1_47_fresh_1| 2147483648)) (= main_~i~0_12 (+ main_~i~0_11 1)) (= v_ArrVal_126_fresh_1 (store (select |#memory_int#1_11| |main_~#A~0.base_4|) (+ (* main_~i~0_11 4) |main_~#A~0.offset_4|) v_ArrVal_125_fresh_1)) (<= |v_main_#t~nondet1_47_fresh_1| 2147483647) (= v_ArrVal_125_fresh_1 |v_main_#t~nondet1_47_fresh_1|) (< main_~i~0_11 1023) (= (store |#memory_int#1_11| |main_~#A~0.base_4| v_ArrVal_126_fresh_1) |#memory_int#1_12|)) :named ssa_12))
(assert (! (<= 1023 main_~i~0_12) :named ssa_13))
(assert (! (and (= (store |#memory_int#1_12| |main_~#A~0.base_4| v_ArrVal_127_fresh_1) |#memory_int#1_14|) (= main_~i~0_14 0) (= v_ArrVal_128_fresh_1 0) (= v_ArrVal_127_fresh_1 (store (select |#memory_int#1_12| |main_~#A~0.base_4|) (+ 4092 |main_~#A~0.offset_4|) 0))) :named ssa_14))
(assert (! (= |main_#t~mem3_15| (select (select |#memory_int#1_14| |main_~#A~0.base_4|) (+ (* main_~i~0_14 4) |main_~#A~0.offset_4|))) :named ssa_15))
(assert (! (and (= main_~i~0_16 (+ main_~i~0_14 1)) (not (= |main_#t~mem3_15| 0))) :named ssa_16))
(assert (! (= |main_#t~mem3_17| (select (select |#memory_int#1_14| |main_~#A~0.base_4|) (+ (* main_~i~0_16 4) |main_~#A~0.offset_4|))) :named ssa_17))
(assert (! (and (= main_~i~0_18 (+ main_~i~0_16 1)) (not (= |main_#t~mem3_17| 0))) :named ssa_18))
(assert (! (= |main_#t~mem3_19| (select (select |#memory_int#1_14| |main_~#A~0.base_4|) (+ (* main_~i~0_18 4) |main_~#A~0.offset_4|))) :named ssa_19))
(assert (! (= |main_#t~mem3_19| 0) :named ssa_20))
(assert (! true :named ssa_21_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_21| (ite (<= main_~i~0_18 1024) 1 0)) :named ssa_21_LocVarAssigCall))
