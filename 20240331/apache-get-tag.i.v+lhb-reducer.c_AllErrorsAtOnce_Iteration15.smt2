...
(set-info :ultimate-id apache-get-tag.i.v+lhb-reducer.c_AllErrorsAtOnce_Iteration15)
...
(declare-fun v_main_~__tmp_2~0_11_fresh_1 () Int)
...
(declare-fun v_main_~main____CPAchecker_TMP_2~0_9_fresh_1 () Int)
(declare-fun v_main_~main____CPAchecker_TMP_0~0_23_fresh_1 () Int)
(declare-fun |main_#t~nondet6_11| () Int)
(declare-fun main_~main____CPAchecker_TMP_3~0_11 () Int)
(declare-fun |main_#t~nondet8_12| () Int)
(declare-fun main_~main____CPAchecker_TMP_6~0_12 () Int)
(declare-fun main_~main____CPAchecker_TMP_3~0_12 () Int)
(declare-fun main_~__VERIFIER_assert__cond~10_13 () Int)
(declare-fun main_~main____CPAchecker_TMP_6~0_13 () Int)
(declare-fun v_main_~__tmp_11~0_5_fresh_1 () Int)
(declare-fun main_~main__t~0_14 () Int)
(declare-fun main_~__VERIFIER_assert__cond~11_14 () Int)
(declare-fun main_~__VERIFIER_assert__cond~10_14 () Int)
(declare-fun main_~main__tagbuf_len~0_14 () Int)
(declare-fun v_main_~__tmp_12~0_4_fresh_1 () Int)
(declare-fun main_~__VERIFIER_assert__cond~11_15 () Int)
...
(assert (! (and (= v_main_~__tmp_1~0_11_fresh_1 main_~__VERIFIER_assert__cond~0_7) (not (= main_~main____CPAchecker_TMP_0~0_6 0)) (= (ite (<= 0 main_~main__t~0_5) 1 0) v_main_~__tmp_1~0_11_fresh_1)) :named ssa_7))
(assert (! (and (not (= main_~__VERIFIER_assert__cond~0_7 0)) (= v_main_~__tmp_2~0_11_fresh_1 main_~__VERIFIER_assert__cond~1_8) (= v_main_~__tmp_2~0_11_fresh_1 (ite (<= main_~main__t~0_5 main_~main__tagbuf_len~0_5) 1 0))) :named ssa_8))
(assert (! (and (not (= main_~__VERIFIER_assert__cond~1_8 0)) (= main_~main____CPAchecker_TMP_0~0_6 ~__tmp_259_0~0_9)) :named ssa_9))
(assert (! (and (= v_main_~main____CPAchecker_TMP_2~0_9_fresh_1 main_~main__t~0_5) (= (+ main_~main__t~0_5 1) main_~main__t~0_10) (= ~__tmp_259_0~0_9 v_main_~main____CPAchecker_TMP_0~0_23_fresh_1)) :named ssa_10))
...
(assert (! (and (<= main_~main____CPAchecker_TMP_6~0_12 2147483647) (<= 0 (+ main_~main____CPAchecker_TMP_6~0_12 2147483648)) (= main_~main____CPAchecker_TMP_3~0_11 0)) :named ssa_12))
(assert (! (and (= (ite (<= 0 main_~main__t~0_10) 1 0) v_main_~__tmp_11~0_5_fresh_1) (not (= main_~main____CPAchecker_TMP_6~0_12 0)) (= v_main_~__tmp_11~0_5_fresh_1 main_~__VERIFIER_assert__cond~10_13)) :named ssa_13))
(assert (! (and (= v_main_~__tmp_12~0_4_fresh_1 main_~__VERIFIER_assert__cond~11_14) (not (= main_~__VERIFIER_assert__cond~10_13 0)) (= v_main_~__tmp_12~0_4_fresh_1 (ite (<= main_~main__t~0_10 main_~main__tagbuf_len~0_5) 1 0))) :named ssa_14))
(assert (! (= main_~__VERIFIER_assert__cond~11_14 0) :named ssa_15))
