...
(set-info :ultimate-id pr5.c_AllErrorsAtOnce_Iteration3)
...
(declare-fun |v_main_#t~mem6_8_fresh_1| () Int)
(declare-fun |main_#t~short8_16| () Bool)
...
(assert (! (and (= |#valid_5| (store |#valid_3| |main_~#volArray~0.base_5| v_ArrVal_5_fresh_1)) (= (* (mod ~CELLCOUNT~0_4 1073741824) 4) v_ArrVal_6_fresh_1) (= 2 main_~CCCELVOL5~0_5) (= |main_~#volArray~0.offset_5| 0) (< |#StackHeapBarrier_-1| |main_~#volArray~0.base_5|) (= 7 main_~CCCELVOL3~0_5) (= (select |#valid_3| |main_~#volArray~0.base_5|) 0) (= 5 main_~CCCELVOL4~0_5) (< 1 ~CELLCOUNT~0_4) (= |#length_5| (store |#length_3| |main_~#volArray~0.base_5| v_ArrVal_6_fresh_1)) (= 3 main_~CCCELVOL2~0_5) (= v_ArrVal_5_fresh_1 1) (= main_~CCCELVOL1~0_5 1) (not (= |main_~#volArray~0.base_5| 0))) :named ssa_5))
...
(assert (! (and (= |v_main_#t~mem6_8_fresh_1| (select (select |#memory_int#1_3| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_14 4)))) (or (and |main_#t~short8_15| (<= main_~MINVAL~0_5 |v_main_#t~mem6_8_fresh_1|)) (and (< |v_main_#t~mem6_8_fresh_1| main_~MINVAL~0_5) (not |main_#t~short8_15|))) (< main_~i~0_14 ~CELLCOUNT~0_4)) :named ssa_15))
(assert (! (and (= |v_main_#t~mem7_6_fresh_1| (select (select |#memory_int#1_3| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_14 4)))) (or (and |main_#t~short8_16| (= |v_main_#t~mem7_6_fresh_1| 0)) (and (not |main_#t~short8_16|) (not (= |v_main_#t~mem7_6_fresh_1| 0)))) (not |main_#t~short8_15|)) :named ssa_16))
(assert (! true :named ssa_17_GlobVarAssigCall))
(assert (! (= (ite |main_#t~short8_16| 1 0) |__VERIFIER_assert_#in~cond_17|) :named ssa_17_LocVarAssigCall))
...
(assert (! true :named ssa_precond))
(assert (! (not (and (<= 2 ~CELLCOUNT~0_-2) (= ~CELLCOUNT~0_-2 (* 5 (div ~CELLCOUNT~0_-2 5))))) :named ssa_postcond))
...
(assert (! (and (<= 2 ~CELLCOUNT~0_-2) (= ~CELLCOUNT~0_-2 (* 5 (div ~CELLCOUNT~0_-2 5)))) :named ssa_-2_PendingContext))
