...
(set-info :ultimate-id apache-get-tag.i.v+lhb-reducer.c_AllErrorsAtOnce_Iteration2)
...
(assert (! (and (= v_main_~__tmp_13~0_4_fresh_1 main_~__VERIFIER_assert__cond~12_7) (= main_~main____CPAchecker_TMP_0~0_6 0) (= v_main_~__tmp_13~0_4_fresh_1 (ite (<= 0 main_~main__t~0_5) 1 0))) :named ssa_7))
(assert (! (and (not (= main_~__VERIFIER_assert__cond~12_7 0)) (= v_main_~__tmp_14~0_4_fresh_1 (ite (<= main_~main__t~0_5 main_~main__tagbuf_len~0_5) 1 0)) (= v_main_~__tmp_14~0_4_fresh_1 main_~__VERIFIER_assert__cond~13_8)) :named ssa_8))
(assert (! (= main_~__VERIFIER_assert__cond~13_8 0) :named ssa_9))
