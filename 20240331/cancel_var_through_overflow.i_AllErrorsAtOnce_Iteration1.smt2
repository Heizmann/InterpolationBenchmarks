...
(set-info :ultimate-id cancel_var_through_overflow.i_AllErrorsAtOnce_Iteration1)
...
(assert (! (and (<= 0 (+ main_~p0~0_4 2147483648)) (<= main_~p1~0_4 2147483647) (<= 0 (+ main_~p1~0_4 2147483648)) (<= main_~p0~0_4 2147483647) (<= 0 (+ v_main_~x~0_4_fresh_1 2147483648)) (<= v_main_~x~0_4_fresh_1 2147483647)) :named ssa_4))
