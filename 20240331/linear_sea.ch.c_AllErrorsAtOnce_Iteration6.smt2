...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:11:33+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id linear_sea.ch.c_AllErrorsAtOnce_Iteration6)
...
(declare-fun |v_main_#t~nondet7_9_fresh_1| () Int)
...
(declare-fun |v_linear_search_#t~mem4_11_fresh_1| () Int)
...
(declare-fun |v_linear_search_#t~mem4_12_fresh_1| () Int)
...
(assert (! (= ~SIZE~0_4 (+ (div (mod |v_main_#t~nondet7_9_fresh_1| 4294967296) 8) 1)) :named ssa_4))
(assert (! (and (= |main_#t~malloc8.offset_5| 0) (= (select |#valid_3| |main_#t~malloc8.base_5|) 0) (= |#valid_5| (store |#valid_3| |main_#t~malloc8.base_5| v_ArrVal_31_fresh_1)) (< |main_#t~malloc8.base_5| |#StackHeapBarrier_-1|) (< 1 (mod ~SIZE~0_4 4294967296)) (not (= |main_#t~malloc8.base_5| 0)) (= (* (mod ~SIZE~0_4 1073741824) 4) v_ArrVal_32_fresh_1) (< (mod ~SIZE~0_4 4294967296) (mod ~MAX~0_1 4294967296)) (= v_ArrVal_31_fresh_1 1) (= (store |#length_3| |main_#t~malloc8.base_5| v_ArrVal_32_fresh_1) |#length_5|)) :named ssa_5))
(assert (! (= |old(#memory_int#1)_6| |#memory_int#1_6|) :named ssa_6_GlobVarAssigCall))
(assert (! (and (= |main_#t~malloc8.offset_5| |v_#Ultimate.meminit_#ptr.offsetInParam_8_fresh_1|) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_8_fresh_1| 4) (= |v_#Ultimate.meminit_#productInParam_8_fresh_1| (* ~SIZE~0_4 4)) (= ~SIZE~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_8_fresh_1|) (= |#Ultimate.meminit_#ptr.base_6| |main_#t~malloc8.base_5|)) :named ssa_6_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_6| |#memory_int#1_3|) :named ssa_6_OldVarAssigCall))
(assert (! (and (= (store |#memory_int#1_6| |#Ultimate.meminit_#ptr.base_6| v_ArrVal_33_fresh_1) |#memory_int#1_7|) (= ((as const (Array Int Int)) 0) v_ArrVal_33_fresh_1)) :named ssa_7))
(assert (! true :named ssa_8_return))
(assert (! (and (= v_ArrVal_34_fresh_1 (store (select |#memory_int#1_7| main_~a~0.base_9) (+ (* (ite (<= (mod (div (mod ~SIZE~0_4 4294967296) 2) 4294967296) 2147483647) (mod (div (mod ~SIZE~0_4 4294967296) 2) 4294967296) (+ (- 4294967296) (mod (div (mod ~SIZE~0_4 4294967296) 2) 4294967296))) 4) main_~a~0.offset_9) 3)) (= |main_#t~malloc8.offset_5| main_~a~0.offset_9) (= main_~a~0.base_9 |main_#t~malloc8.base_5|) (= (store |#memory_int#1_7| main_~a~0.base_9 v_ArrVal_34_fresh_1) |#memory_int#1_9|) (= 3 v_ArrVal_35_fresh_1)) :named ssa_9))
...
(assert (! (and (= (select (select |#memory_int#1_9| linear_search_~a.base_11) (+ (* (ite (<= (mod linear_search_~j~0_11 4294967296) 2147483647) (mod linear_search_~j~0_11 4294967296) (+ (mod linear_search_~j~0_11 4294967296) (- 4294967296))) 4) linear_search_~a.offset_11)) |v_linear_search_#t~mem4_11_fresh_1|) |linear_search_#t~short5_12| (or (and |linear_search_#t~short5_13| (not (= linear_search_~q_11 |v_linear_search_#t~mem4_11_fresh_1|))) (and (not |linear_search_#t~short5_13|) (= linear_search_~q_11 |v_linear_search_#t~mem4_11_fresh_1|)))) :named ssa_13))
...
(assert (! (and (or (and (not |linear_search_#t~short5_16|) (= linear_search_~q_11 |v_linear_search_#t~mem4_12_fresh_1|)) (and (not (= linear_search_~q_11 |v_linear_search_#t~mem4_12_fresh_1|)) |linear_search_#t~short5_16|)) (= (select (select |#memory_int#1_9| linear_search_~a.base_11) (+ (* (ite (<= (mod linear_search_~j~0_14 4294967296) 2147483647) (mod linear_search_~j~0_14 4294967296) (+ (mod linear_search_~j~0_14 4294967296) (- 4294967296))) 4) linear_search_~a.offset_11)) |v_linear_search_#t~mem4_12_fresh_1|) |linear_search_#t~short5_15|) :named ssa_16))
...
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_36_fresh_1) (= (store |#memory_int#1_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_36_fresh_1) |#memory_int#1_0|)) :named ssa_0))
(assert (! true :named ssa_1_return))
...
(declare-fun |v_linear_search_#t~mem4_13_fresh_1| () Int)
...
(declare-fun |v_linear_search_#t~mem4_14_fresh_1| () Int)
...
(assert (! (and (= (select (select |#memory_int#1_-2| linear_search_~a.base_0) (+ (* (ite (<= (mod linear_search_~j~0_0 4294967296) 2147483647) (mod linear_search_~j~0_0 4294967296) (+ (mod linear_search_~j~0_0 4294967296) (- 4294967296))) 4) linear_search_~a.offset_0)) |v_linear_search_#t~mem4_13_fresh_1|) |linear_search_#t~short5_1| (or (and (not (= linear_search_~q_0 |v_linear_search_#t~mem4_13_fresh_1|)) |linear_search_#t~short5_2|) (and (not |linear_search_#t~short5_2|) (= linear_search_~q_0 |v_linear_search_#t~mem4_13_fresh_1|)))) :named ssa_2))
...
(assert (! (and |linear_search_#t~short5_4| (= (select (select |#memory_int#1_-2| linear_search_~a.base_0) (+ (* (ite (<= (mod linear_search_~j~0_3 4294967296) 2147483647) (mod linear_search_~j~0_3 4294967296) (+ (mod linear_search_~j~0_3 4294967296) (- 4294967296))) 4) linear_search_~a.offset_0)) |v_linear_search_#t~mem4_14_fresh_1|) (or (and (not |linear_search_#t~short5_5|) (= linear_search_~q_0 |v_linear_search_#t~mem4_14_fresh_1|)) (and (not (= linear_search_~q_0 |v_linear_search_#t~mem4_14_fresh_1|)) |linear_search_#t~short5_5|))) :named ssa_5))
