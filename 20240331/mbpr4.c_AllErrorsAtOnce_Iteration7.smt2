...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-30T23:52:36+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id mbpr4.c_AllErrorsAtOnce_Iteration7)
...
(declare-fun |v_main_#t~mem21_12_fresh_1| () Int)
...
(declare-fun |v_main_#t~mem21_13_fresh_1| () Int)
(declare-fun |main_#t~short23_42| () Bool)
(declare-fun |v_main_#t~mem22_10_fresh_1| () Int)
...
(assert (! (and (= 7 main_~CCCELVOL3~0_5) (= 5 main_~CCCELVOL4~0_5) (< 1 ~CELLCOUNT~0_4) (= (select |#valid_3| |main_~#volArray~0.base_5|) 0) (= main_~MINVAL~0_5 2) (= 3 main_~CCCELVOL2~0_5) (= (store |#valid_3| |main_~#volArray~0.base_5| v_ArrVal_86_fresh_1) |#valid_5|) (= |#length_5| (store |#length_3| |main_~#volArray~0.base_5| v_ArrVal_85_fresh_1)) (not (= |main_~#volArray~0.base_5| 0)) (= v_ArrVal_86_fresh_1 1) (= v_ArrVal_85_fresh_1 (* (mod ~CELLCOUNT~0_4 1073741824) 4)) (= main_~CCCELVOL1~0_5 1) (= |main_~#volArray~0.offset_5| 0) (< |#StackHeapBarrier_-1| |main_~#volArray~0.base_5|)) :named ssa_5))
...
(assert (! (and (<= main_~MINVAL~0_5 main_~CCCELVOL4~0_5) (= |#memory_int#1_14| (store |#memory_int#1_3| |main_~#volArray~0.base_5| v_ArrVal_87_fresh_1)) (= v_ArrVal_88_fresh_1 main_~CCCELVOL4~0_5) (= (store (select |#memory_int#1_3| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 16) (* main_~i~0_12 16)) main_~CCCELVOL4~0_5) v_ArrVal_87_fresh_1)) :named ssa_14))
(assert (! (and (= main_~i~0_15 (+ main_~i~0_12 1)) (= v_ArrVal_90_fresh_1 (store (store (store (select |#memory_int#1_14| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 12) (* main_~i~0_12 16)) v_ArrVal_89_fresh_1) (+ |main_~#volArray~0.offset_5| (* main_~i~0_12 16) (- 8)) (select (select |#memory_int#1_14| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_12 16) (- 8)))) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_12 16)) (select (select |#memory_int#1_14| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_12 16))))) (= |#memory_int#1_15| (store |#memory_int#1_14| |main_~#volArray~0.base_5| v_ArrVal_90_fresh_1)) (= (select (select |#memory_int#1_14| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_12 16))) v_ArrVal_91_fresh_1) (= (select (select |#memory_int#1_14| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 12) (* main_~i~0_12 16))) v_ArrVal_89_fresh_1) (= v_ArrVal_92_fresh_1 (select (select |#memory_int#1_14| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_12 16) (- 8))))) :named ssa_15))
...
(assert (! (and (<= main_~MINVAL~0_5 main_~CCCELVOL3~0_5) (= (store |#memory_int#1_15| |main_~#volArray~0.base_5| v_ArrVal_94_fresh_1) |#memory_int#1_19|) (= v_ArrVal_93_fresh_1 main_~CCCELVOL3~0_5) (= (store (select |#memory_int#1_15| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_17 16) (- 12)) v_ArrVal_93_fresh_1) v_ArrVal_94_fresh_1)) :named ssa_19))
(assert (! (and (= (select (select |#memory_int#1_19| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_17 16))) v_ArrVal_98_fresh_1) (= (store (store (store (select |#memory_int#1_19| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 16) (* main_~i~0_17 16)) (select (select |#memory_int#1_19| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 16) (* main_~i~0_17 16)))) (+ |main_~#volArray~0.offset_5| (* main_~i~0_17 16) (- 8)) (select (select |#memory_int#1_19| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_17 16) (- 8)))) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_17 16)) (select (select |#memory_int#1_19| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_17 16)))) v_ArrVal_95_fresh_1) (= (select (select |#memory_int#1_19| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_17 16) (- 8))) v_ArrVal_97_fresh_1) (= (select (select |#memory_int#1_19| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 16) (* main_~i~0_17 16))) v_ArrVal_96_fresh_1) (= main_~i~0_20 (+ main_~i~0_17 1)) (= |#memory_int#1_20| (store |#memory_int#1_19| |main_~#volArray~0.base_5| v_ArrVal_95_fresh_1))) :named ssa_20))
...
(assert (! (and (= (store |#memory_int#1_20| |main_~#volArray~0.base_5| v_ArrVal_99_fresh_1) |#memory_int#1_24|) (= (store (select |#memory_int#1_20| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_22 16) (- 8)) main_~CCCELVOL2~0_5) v_ArrVal_99_fresh_1) (= v_ArrVal_100_fresh_1 main_~CCCELVOL2~0_5) (<= main_~MINVAL~0_5 main_~CCCELVOL2~0_5)) :named ssa_24))
(assert (! (and (= v_ArrVal_101_fresh_1 (store (store (store (select |#memory_int#1_24| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 16) (* main_~i~0_22 16)) (select (select |#memory_int#1_24| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 16) (* main_~i~0_22 16)))) (+ |main_~#volArray~0.offset_5| (* main_~i~0_22 16) (- 12)) (select (select |#memory_int#1_24| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_22 16) (- 12)))) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_22 16)) (select (select |#memory_int#1_24| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_22 16))))) (= v_ArrVal_104_fresh_1 (select (select |#memory_int#1_24| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 16) (* main_~i~0_22 16)))) (= (+ main_~i~0_22 1) main_~i~0_25) (= v_ArrVal_103_fresh_1 (select (select |#memory_int#1_24| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_22 16) (- 12)))) (= |#memory_int#1_25| (store |#memory_int#1_24| |main_~#volArray~0.base_5| v_ArrVal_101_fresh_1)) (= v_ArrVal_102_fresh_1 (select (select |#memory_int#1_24| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_22 16))))) :named ssa_25))
...
(assert (! (and (< main_~CCCELVOL1~0_5 main_~MINVAL~0_5) (= v_ArrVal_106_fresh_1 0) (= |#memory_int#1_29| (store |#memory_int#1_25| |main_~#volArray~0.base_5| v_ArrVal_105_fresh_1)) (= v_ArrVal_105_fresh_1 (store (select |#memory_int#1_25| |main_~#volArray~0.base_5|) (+ (* main_~i~0_27 16) |main_~#volArray~0.offset_5| (- 4)) 0))) :named ssa_29))
(assert (! (and (= (store |#memory_int#1_29| |main_~#volArray~0.base_5| v_ArrVal_110_fresh_1) |#memory_int#1_30|) (= v_ArrVal_108_fresh_1 (select (select |#memory_int#1_29| |main_~#volArray~0.base_5|) (+ (* main_~i~0_27 16) |main_~#volArray~0.offset_5| (- 12)))) (= v_ArrVal_109_fresh_1 (select (select |#memory_int#1_29| |main_~#volArray~0.base_5|) (+ (* main_~i~0_27 16) |main_~#volArray~0.offset_5| (- 16)))) (= v_ArrVal_107_fresh_1 (select (select |#memory_int#1_29| |main_~#volArray~0.base_5|) (+ (* main_~i~0_27 16) |main_~#volArray~0.offset_5| (- 8)))) (= v_ArrVal_110_fresh_1 (store (store (store (select |#memory_int#1_29| |main_~#volArray~0.base_5|) (+ (* main_~i~0_27 16) |main_~#volArray~0.offset_5| (- 16)) v_ArrVal_109_fresh_1) (+ (* main_~i~0_27 16) |main_~#volArray~0.offset_5| (- 12)) v_ArrVal_108_fresh_1) (+ (* main_~i~0_27 16) |main_~#volArray~0.offset_5| (- 8)) v_ArrVal_107_fresh_1)) (= main_~i~0_30 (+ main_~i~0_27 1))) :named ssa_30))
...
(assert (! (and (= (select (select |#memory_int#1_30| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_32 4))) |v_main_#t~mem21_12_fresh_1|) (< main_~i~0_32 ~CELLCOUNT~0_4) (or (and (not |main_#t~short23_33|) (< |v_main_#t~mem21_12_fresh_1| main_~MINVAL~0_5)) (and (<= main_~MINVAL~0_5 |v_main_#t~mem21_12_fresh_1|) |main_#t~short23_33|))) :named ssa_33))
...
(assert (! (and (< main_~i~0_40 ~CELLCOUNT~0_4) (or (and (<= main_~MINVAL~0_5 |v_main_#t~mem21_13_fresh_1|) |main_#t~short23_41|) (and (< |v_main_#t~mem21_13_fresh_1| main_~MINVAL~0_5) (not |main_#t~short23_41|))) (= (select (select |#memory_int#1_30| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_40 4))) |v_main_#t~mem21_13_fresh_1|)) :named ssa_41))
(assert (! (and (= (select (select |#memory_int#1_30| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_40 4))) |v_main_#t~mem22_10_fresh_1|) (or (and (not (= 0 |v_main_#t~mem22_10_fresh_1|)) (not |main_#t~short23_42|)) (and |main_#t~short23_42| (= 0 |v_main_#t~mem22_10_fresh_1|))) (not |main_#t~short23_41|)) :named ssa_42))
(assert (! true :named ssa_43_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_43| (ite |main_#t~short23_42| 1 0)) :named ssa_43_LocVarAssigCall))
...
(assert (! true :named ssa_precond))
(assert (! (not (and (= |main_~#volArray~0.offset_-2| 0) (= 7 (select (select |#memory_int#1_-2| |main_~#volArray~0.base_-2|) 4)) (= main_~i~0_-2 0) (= 2 main_~MINVAL~0_-2))) :named ssa_postcond))
...
(assert (! true :named ssa_2))
(assert (! true :named ssa_3_return))
(assert (! (and (= |main_~#volArray~0.offset_-2| 0) (= 7 (select (select |#memory_int#1_-2| |main_~#volArray~0.base_-2|) 4)) (= main_~i~0_-2 0) (= 2 main_~MINVAL~0_-2)) :named ssa_-2_PendingContext))
