...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-30T23:52:39+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id mbpr4.c_AllErrorsAtOnce_Iteration12)
...
(declare-fun |v_main_#t~mem21_31_fresh_1| () Int)
...
(declare-fun |v_main_#t~mem21_32_fresh_1| () Int)
...
(declare-fun |v_main_#t~mem21_33_fresh_1| () Int)
...
(declare-fun |v_main_#t~mem21_34_fresh_1| () Int)
...
(declare-fun |v_main_#t~mem21_35_fresh_1| () Int)
...
(declare-fun |v_main_#t~mem21_36_fresh_1| () Int)
(declare-fun |main_#t~short23_86| () Bool)
(declare-fun |v_main_#t~mem22_15_fresh_1| () Int)
...
(assert (! (and (= v_ArrVal_240_fresh_1 1) (= v_ArrVal_239_fresh_1 (* (mod ~CELLCOUNT~0_4 1073741824) 4)) (= 7 main_~CCCELVOL3~0_5) (= 5 main_~CCCELVOL4~0_5) (< 1 ~CELLCOUNT~0_4) (= (store |#valid_3| |main_~#volArray~0.base_5| v_ArrVal_240_fresh_1) |#valid_5|) (= (select |#valid_3| |main_~#volArray~0.base_5|) 0) (= main_~MINVAL~0_5 2) (= |#length_5| (store |#length_3| |main_~#volArray~0.base_5| v_ArrVal_239_fresh_1)) (= 3 main_~CCCELVOL2~0_5) (not (= |main_~#volArray~0.base_5| 0)) (= main_~CCCELVOL1~0_5 1) (= |main_~#volArray~0.offset_5| 0) (< |#StackHeapBarrier_-1| |main_~#volArray~0.base_5|)) :named ssa_5))
...
(assert (! (and (<= main_~MINVAL~0_5 main_~CCCELVOL4~0_5) (= (store |#memory_int#1_3| |main_~#volArray~0.base_5| v_ArrVal_241_fresh_1) |#memory_int#1_14|) (= v_ArrVal_242_fresh_1 main_~CCCELVOL4~0_5) (= v_ArrVal_241_fresh_1 (store (select |#memory_int#1_3| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 16) (* main_~i~0_12 16)) main_~CCCELVOL4~0_5))) :named ssa_14))
(assert (! (and (= main_~i~0_15 (+ main_~i~0_12 1)) (= v_ArrVal_245_fresh_1 (select (select |#memory_int#1_14| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_12 16)))) (= v_ArrVal_243_fresh_1 (select (select |#memory_int#1_14| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 12) (* main_~i~0_12 16)))) (= v_ArrVal_244_fresh_1 (store (store (store (select |#memory_int#1_14| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 12) (* main_~i~0_12 16)) v_ArrVal_243_fresh_1) (+ |main_~#volArray~0.offset_5| (* main_~i~0_12 16) (- 8)) (select (select |#memory_int#1_14| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_12 16) (- 8)))) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_12 16)) (select (select |#memory_int#1_14| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_12 16))))) (= (store |#memory_int#1_14| |main_~#volArray~0.base_5| v_ArrVal_244_fresh_1) |#memory_int#1_15|) (= v_ArrVal_246_fresh_1 (select (select |#memory_int#1_14| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_12 16) (- 8))))) :named ssa_15))
...
(assert (! (and (<= main_~MINVAL~0_5 main_~CCCELVOL4~0_5) (= (store |#memory_int#1_15| |main_~#volArray~0.base_5| v_ArrVal_247_fresh_1) |#memory_int#1_17|) (= v_ArrVal_248_fresh_1 main_~CCCELVOL4~0_5) (= v_ArrVal_247_fresh_1 (store (select |#memory_int#1_15| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 16) (* main_~i~0_15 16)) main_~CCCELVOL4~0_5))) :named ssa_17))
(assert (! (and (= main_~i~0_18 (+ main_~i~0_15 1)) (= v_ArrVal_250_fresh_1 (store (store (store (select |#memory_int#1_17| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 12) (* main_~i~0_15 16)) v_ArrVal_249_fresh_1) (+ |main_~#volArray~0.offset_5| (* main_~i~0_15 16) (- 8)) (select (select |#memory_int#1_17| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_15 16) (- 8)))) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_15 16)) (select (select |#memory_int#1_17| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_15 16))))) (= v_ArrVal_252_fresh_1 (select (select |#memory_int#1_17| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_15 16) (- 8)))) (= v_ArrVal_251_fresh_1 (select (select |#memory_int#1_17| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_15 16)))) (= v_ArrVal_249_fresh_1 (select (select |#memory_int#1_17| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 12) (* main_~i~0_15 16)))) (= (store |#memory_int#1_17| |main_~#volArray~0.base_5| v_ArrVal_250_fresh_1) |#memory_int#1_18|)) :named ssa_18))
...
(assert (! (and (= v_ArrVal_254_fresh_1 (store (select |#memory_int#1_18| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_20 16) (- 12)) v_ArrVal_253_fresh_1)) (= (store |#memory_int#1_18| |main_~#volArray~0.base_5| v_ArrVal_254_fresh_1) |#memory_int#1_22|) (<= main_~MINVAL~0_5 main_~CCCELVOL3~0_5) (= v_ArrVal_253_fresh_1 main_~CCCELVOL3~0_5)) :named ssa_22))
(assert (! (and (= (select (select |#memory_int#1_22| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_20 16))) v_ArrVal_258_fresh_1) (= main_~i~0_23 (+ main_~i~0_20 1)) (= v_ArrVal_255_fresh_1 (store (store (store (select |#memory_int#1_22| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 16) (* main_~i~0_20 16)) (select (select |#memory_int#1_22| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 16) (* main_~i~0_20 16)))) (+ |main_~#volArray~0.offset_5| (* main_~i~0_20 16) (- 8)) (select (select |#memory_int#1_22| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_20 16) (- 8)))) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_20 16)) (select (select |#memory_int#1_22| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_20 16))))) (= v_ArrVal_256_fresh_1 (select (select |#memory_int#1_22| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 16) (* main_~i~0_20 16)))) (= v_ArrVal_257_fresh_1 (select (select |#memory_int#1_22| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_20 16) (- 8)))) (= (store |#memory_int#1_22| |main_~#volArray~0.base_5| v_ArrVal_255_fresh_1) |#memory_int#1_23|)) :named ssa_23))
...
(assert (! (and (= (store (select |#memory_int#1_23| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_23 16) (- 12)) v_ArrVal_259_fresh_1) v_ArrVal_260_fresh_1) (= v_ArrVal_259_fresh_1 main_~CCCELVOL3~0_5) (<= main_~MINVAL~0_5 main_~CCCELVOL3~0_5) (= |#memory_int#1_25| (store |#memory_int#1_23| |main_~#volArray~0.base_5| v_ArrVal_260_fresh_1))) :named ssa_25))
(assert (! (and (= (store |#memory_int#1_25| |main_~#volArray~0.base_5| v_ArrVal_261_fresh_1) |#memory_int#1_26|) (= (select (select |#memory_int#1_25| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_23 16))) v_ArrVal_264_fresh_1) (= v_ArrVal_262_fresh_1 (select (select |#memory_int#1_25| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 16) (* main_~i~0_23 16)))) (= main_~i~0_26 (+ main_~i~0_23 1)) (= v_ArrVal_263_fresh_1 (select (select |#memory_int#1_25| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_23 16) (- 8)))) (= v_ArrVal_261_fresh_1 (store (store (store (select |#memory_int#1_25| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 16) (* main_~i~0_23 16)) (select (select |#memory_int#1_25| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 16) (* main_~i~0_23 16)))) (+ |main_~#volArray~0.offset_5| (* main_~i~0_23 16) (- 8)) (select (select |#memory_int#1_25| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_23 16) (- 8)))) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_23 16)) (select (select |#memory_int#1_25| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_23 16)))))) :named ssa_26))
...
(assert (! (and (= v_ArrVal_266_fresh_1 main_~CCCELVOL2~0_5) (= v_ArrVal_265_fresh_1 (store (select |#memory_int#1_26| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_28 16) (- 8)) main_~CCCELVOL2~0_5)) (= (store |#memory_int#1_26| |main_~#volArray~0.base_5| v_ArrVal_265_fresh_1) |#memory_int#1_30|) (<= main_~MINVAL~0_5 main_~CCCELVOL2~0_5)) :named ssa_30))
(assert (! (and (= v_ArrVal_268_fresh_1 (select (select |#memory_int#1_30| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_28 16)))) (= v_ArrVal_267_fresh_1 (store (store (store (select |#memory_int#1_30| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 16) (* main_~i~0_28 16)) (select (select |#memory_int#1_30| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 16) (* main_~i~0_28 16)))) (+ |main_~#volArray~0.offset_5| (* main_~i~0_28 16) (- 12)) (select (select |#memory_int#1_30| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_28 16) (- 12)))) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_28 16)) (select (select |#memory_int#1_30| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_28 16))))) (= (+ main_~i~0_28 1) main_~i~0_31) (= v_ArrVal_270_fresh_1 (select (select |#memory_int#1_30| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 16) (* main_~i~0_28 16)))) (= |#memory_int#1_31| (store |#memory_int#1_30| |main_~#volArray~0.base_5| v_ArrVal_267_fresh_1)) (= v_ArrVal_269_fresh_1 (select (select |#memory_int#1_30| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_28 16) (- 12))))) :named ssa_31))
...
(assert (! (and (= v_ArrVal_272_fresh_1 main_~CCCELVOL2~0_5) (= v_ArrVal_271_fresh_1 (store (select |#memory_int#1_31| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_31 16) (- 8)) main_~CCCELVOL2~0_5)) (= |#memory_int#1_33| (store |#memory_int#1_31| |main_~#volArray~0.base_5| v_ArrVal_271_fresh_1)) (<= main_~MINVAL~0_5 main_~CCCELVOL2~0_5)) :named ssa_33))
(assert (! (and (= v_ArrVal_275_fresh_1 (select (select |#memory_int#1_33| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_31 16) (- 12)))) (= v_ArrVal_276_fresh_1 (select (select |#memory_int#1_33| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 16) (* main_~i~0_31 16)))) (= (+ main_~i~0_31 1) main_~i~0_34) (= |#memory_int#1_34| (store |#memory_int#1_33| |main_~#volArray~0.base_5| v_ArrVal_273_fresh_1)) (= v_ArrVal_273_fresh_1 (store (store (store (select |#memory_int#1_33| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 16) (* main_~i~0_31 16)) (select (select |#memory_int#1_33| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 16) (* main_~i~0_31 16)))) (+ |main_~#volArray~0.offset_5| (* main_~i~0_31 16) (- 12)) (select (select |#memory_int#1_33| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_31 16) (- 12)))) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_31 16)) (select (select |#memory_int#1_33| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_31 16))))) (= v_ArrVal_274_fresh_1 (select (select |#memory_int#1_33| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_31 16))))) :named ssa_34))
...
(assert (! (and (= v_ArrVal_278_fresh_1 0) (= v_ArrVal_277_fresh_1 (store (select |#memory_int#1_34| |main_~#volArray~0.base_5|) (+ (* main_~i~0_36 16) |main_~#volArray~0.offset_5| (- 4)) 0)) (= |#memory_int#1_38| (store |#memory_int#1_34| |main_~#volArray~0.base_5| v_ArrVal_277_fresh_1)) (< main_~CCCELVOL1~0_5 main_~MINVAL~0_5)) :named ssa_38))
(assert (! (and (= v_ArrVal_281_fresh_1 (select (select |#memory_int#1_38| |main_~#volArray~0.base_5|) (+ (* main_~i~0_36 16) |main_~#volArray~0.offset_5| (- 16)))) (= |#memory_int#1_39| (store |#memory_int#1_38| |main_~#volArray~0.base_5| v_ArrVal_282_fresh_1)) (= v_ArrVal_279_fresh_1 (select (select |#memory_int#1_38| |main_~#volArray~0.base_5|) (+ (* main_~i~0_36 16) |main_~#volArray~0.offset_5| (- 8)))) (= v_ArrVal_280_fresh_1 (select (select |#memory_int#1_38| |main_~#volArray~0.base_5|) (+ (* main_~i~0_36 16) |main_~#volArray~0.offset_5| (- 12)))) (= v_ArrVal_282_fresh_1 (store (store (store (select |#memory_int#1_38| |main_~#volArray~0.base_5|) (+ (* main_~i~0_36 16) |main_~#volArray~0.offset_5| (- 16)) v_ArrVal_281_fresh_1) (+ (* main_~i~0_36 16) |main_~#volArray~0.offset_5| (- 12)) v_ArrVal_280_fresh_1) (+ (* main_~i~0_36 16) |main_~#volArray~0.offset_5| (- 8)) v_ArrVal_279_fresh_1)) (= main_~i~0_39 (+ main_~i~0_36 1))) :named ssa_39))
...
(assert (! (and (= v_ArrVal_283_fresh_1 (store (select |#memory_int#1_39| |main_~#volArray~0.base_5|) (+ (* main_~i~0_39 16) |main_~#volArray~0.offset_5| (- 4)) 0)) (= v_ArrVal_284_fresh_1 0) (< main_~CCCELVOL1~0_5 main_~MINVAL~0_5) (= (store |#memory_int#1_39| |main_~#volArray~0.base_5| v_ArrVal_283_fresh_1) |#memory_int#1_41|)) :named ssa_41))
(assert (! (and (= |#memory_int#1_42| (store |#memory_int#1_41| |main_~#volArray~0.base_5| v_ArrVal_288_fresh_1)) (= v_ArrVal_288_fresh_1 (store (store (store (select |#memory_int#1_41| |main_~#volArray~0.base_5|) (+ (* main_~i~0_39 16) |main_~#volArray~0.offset_5| (- 16)) v_ArrVal_287_fresh_1) (+ (* main_~i~0_39 16) |main_~#volArray~0.offset_5| (- 12)) v_ArrVal_286_fresh_1) (+ (* main_~i~0_39 16) |main_~#volArray~0.offset_5| (- 8)) v_ArrVal_285_fresh_1)) (= v_ArrVal_287_fresh_1 (select (select |#memory_int#1_41| |main_~#volArray~0.base_5|) (+ (* main_~i~0_39 16) |main_~#volArray~0.offset_5| (- 16)))) (= v_ArrVal_285_fresh_1 (select (select |#memory_int#1_41| |main_~#volArray~0.base_5|) (+ (* main_~i~0_39 16) |main_~#volArray~0.offset_5| (- 8)))) (= v_ArrVal_286_fresh_1 (select (select |#memory_int#1_41| |main_~#volArray~0.base_5|) (+ (* main_~i~0_39 16) |main_~#volArray~0.offset_5| (- 12)))) (= main_~i~0_42 (+ main_~i~0_39 1))) :named ssa_42))
...
(assert (! (and (or (and (<= main_~MINVAL~0_5 |v_main_#t~mem21_31_fresh_1|) |main_#t~short23_45|) (and (< |v_main_#t~mem21_31_fresh_1| main_~MINVAL~0_5) (not |main_#t~short23_45|))) (< main_~i~0_44 ~CELLCOUNT~0_4) (= (select (select |#memory_int#1_42| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_44 4))) |v_main_#t~mem21_31_fresh_1|)) :named ssa_45))
...
(assert (! (and (or (and (<= main_~MINVAL~0_5 |v_main_#t~mem21_32_fresh_1|) |main_#t~short23_53|) (and (not |main_#t~short23_53|) (< |v_main_#t~mem21_32_fresh_1| main_~MINVAL~0_5))) (< main_~i~0_52 ~CELLCOUNT~0_4) (= (select (select |#memory_int#1_42| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_52 4))) |v_main_#t~mem21_32_fresh_1|)) :named ssa_53))
...
(assert (! (and (< main_~i~0_60 ~CELLCOUNT~0_4) (= (select (select |#memory_int#1_42| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_60 4))) |v_main_#t~mem21_33_fresh_1|) (or (and (< |v_main_#t~mem21_33_fresh_1| main_~MINVAL~0_5) (not |main_#t~short23_61|)) (and |main_#t~short23_61| (<= main_~MINVAL~0_5 |v_main_#t~mem21_33_fresh_1|)))) :named ssa_61))
...
(assert (! (and (< main_~i~0_68 ~CELLCOUNT~0_4) (or (and (<= main_~MINVAL~0_5 |v_main_#t~mem21_34_fresh_1|) |main_#t~short23_69|) (and (< |v_main_#t~mem21_34_fresh_1| main_~MINVAL~0_5) (not |main_#t~short23_69|))) (= (select (select |#memory_int#1_42| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_68 4))) |v_main_#t~mem21_34_fresh_1|)) :named ssa_69))
(assert (! |main_#t~short23_69| :named ssa_70))
(assert (! true :named ssa_71_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_71| (ite |main_#t~short23_69| 1 0)) :named ssa_71_LocVarAssigCall))
...
(assert (! (and (< main_~i~0_76 ~CELLCOUNT~0_4) (= (select (select |#memory_int#1_42| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_76 4))) |v_main_#t~mem21_35_fresh_1|) (or (and |main_#t~short23_77| (<= main_~MINVAL~0_5 |v_main_#t~mem21_35_fresh_1|)) (and (< |v_main_#t~mem21_35_fresh_1| main_~MINVAL~0_5) (not |main_#t~short23_77|)))) :named ssa_77))
...
(assert (! (and (< main_~i~0_84 ~CELLCOUNT~0_4) (or (and (<= main_~MINVAL~0_5 |v_main_#t~mem21_36_fresh_1|) |main_#t~short23_85|) (and (< |v_main_#t~mem21_36_fresh_1| main_~MINVAL~0_5) (not |main_#t~short23_85|))) (= (select (select |#memory_int#1_42| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_84 4))) |v_main_#t~mem21_36_fresh_1|)) :named ssa_85))
(assert (! (and (= (select (select |#memory_int#1_42| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_84 4))) |v_main_#t~mem22_15_fresh_1|) (or (and (not (= 0 |v_main_#t~mem22_15_fresh_1|)) (not |main_#t~short23_86|)) (and (= 0 |v_main_#t~mem22_15_fresh_1|) |main_#t~short23_86|)) (not |main_#t~short23_85|)) :named ssa_86))
...
(assert (! true :named ssa_precond))
(assert (! (not (and (= |main_~#volArray~0.offset_-2| 0) (= (select (select |#memory_int#1_-2| |main_~#volArray~0.base_-2|) 12) 0) (= main_~i~0_-2 0) (= 2 main_~MINVAL~0_-2))) :named ssa_postcond))
...
(assert (! true :named ssa_2))
(assert (! true :named ssa_3_return))
(assert (! (and (= |main_~#volArray~0.offset_-2| 0) (= (select (select |#memory_int#1_-2| |main_~#volArray~0.base_-2|) 12) 0) (= main_~i~0_-2 0) (= 2 main_~MINVAL~0_-2)) :named ssa_-2_PendingContext))
...
(declare-fun __VERIFIER_assert_~cond_1 () Int)
(assert (! true :named ssa_precond))
(assert (! (not (and (= |main_~#volArray~0.offset_-2| 0) (= main_~i~0_-2 1) (= (select (select |#memory_int#1_-2| |main_~#volArray~0.base_-2|) 12) 0) (= 2 main_~MINVAL~0_-2))) :named ssa_postcond))
(assert (! (= __VERIFIER_assert_~cond_0 |__VERIFIER_assert_#in~cond_-1|) :named ssa_0))
(assert (! (not (= __VERIFIER_assert_~cond_0 0)) :named ssa_1))
(assert (! true :named ssa_2))
(assert (! true :named ssa_3_return))
(assert (! (and (= |main_~#volArray~0.offset_-2| 0) (= main_~i~0_-2 1) (= (select (select |#memory_int#1_-2| |main_~#volArray~0.base_-2|) 12) 0) (= 2 main_~MINVAL~0_-2)) :named ssa_-2_PendingContext))
(assert (! (= |__VERIFIER_assert_#in~cond_-1| (ite |main_#t~short23_-2| 1 0)) :named ssa_-2_LocVarAssignPendingContext))
(assert (! true :named ssa_-2_OldVarAssignPendingContext))
(check-sat)
(get-interpolants (and ssa_0 ssa_precond) ssa_1 ssa_2 (and ssa_-2_PendingContext ssa_3_return ssa_-2_LocVarAssignPendingContext ssa_-2_OldVarAssignPendingContext ssa_postcond))
...
(declare-fun __VERIFIER_assert_~cond_1 () Int)
(assert (! true :named ssa_precond))
(assert (! (not (and (= |main_~#volArray~0.offset_-2| 0) (= main_~i~0_-2 2) (= (select (select |#memory_int#1_-2| |main_~#volArray~0.base_-2|) 12) 0) (= 2 main_~MINVAL~0_-2))) :named ssa_postcond))
(assert (! (= __VERIFIER_assert_~cond_0 |__VERIFIER_assert_#in~cond_-1|) :named ssa_0))
(assert (! (not (= __VERIFIER_assert_~cond_0 0)) :named ssa_1))
(assert (! true :named ssa_2))
(assert (! true :named ssa_3_return))
(assert (! (and (= |main_~#volArray~0.offset_-2| 0) (= main_~i~0_-2 2) (= (select (select |#memory_int#1_-2| |main_~#volArray~0.base_-2|) 12) 0) (= 2 main_~MINVAL~0_-2)) :named ssa_-2_PendingContext))
(assert (! (= |__VERIFIER_assert_#in~cond_-1| (ite |main_#t~short23_-2| 1 0)) :named ssa_-2_LocVarAssignPendingContext))
(assert (! true :named ssa_-2_OldVarAssignPendingContext))
(check-sat)
(get-interpolants (and ssa_0 ssa_precond) ssa_1 ssa_2 (and ssa_-2_PendingContext ssa_3_return ssa_-2_LocVarAssignPendingContext ssa_-2_OldVarAssignPendingContext ssa_postcond))
