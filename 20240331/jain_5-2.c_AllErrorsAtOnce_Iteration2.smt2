...
(set-info :ultimate-id jain_5-2.c_AllErrorsAtOnce_Iteration2)
...
(assert (! true :named ssa_precond))
(assert (! (not (= 12 (+ main_~y~0_-2 main_~x~0_-2))) :named ssa_postcond))
...
(assert (! (= 12 (+ main_~y~0_-2 main_~x~0_-2)) :named ssa_-2_PendingContext))
