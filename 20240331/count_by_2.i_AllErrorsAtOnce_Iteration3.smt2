...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration3)
...
(assert (! (<= 1000000 main_~i~0_6) :named ssa_7))
(assert (! true :named ssa_8_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_8| (ite (= main_~i~0_6 1000000) 1 0)) :named ssa_8_LocVarAssigCall))
