...
(set-info :ultimate-id id2_b2_o3.c_AllErrorsAtOnce_Iteration8)
...
(assert (! (and (<= (mod id_~ret~0_19 4294967296) 2) (= |id_#res_20| id_~ret~0_19)) :named ssa_20))
...
(assert (! (and (= id2_~ret~1_23 |id2_#res_24|) (<= (mod id2_~ret~1_23 4294967296) 2)) :named ssa_24))
...
(assert (! (and (<= (mod id_~ret~0_27 4294967296) 2) (= |id_#res_28| id_~ret~0_27)) :named ssa_28))
...
(assert (! (= 3 (mod main_~result~0_31 4294967296)) :named ssa_32))
...
(assert (! (and (= id2_~ret~1_17 |id2_#res_18|) (<= (mod id2_~ret~1_17 4294967296) 2)) :named ssa_18))
...
(assert (! (and (<= (mod id_~ret~0_21 4294967296) 2) (= |id_#res_22| id_~ret~0_21)) :named ssa_22))
...
(assert (! (and (<= (mod id_~ret~0_10 4294967296) 2) (= |id_#res_11| id_~ret~0_10)) :named ssa_11))
...
(assert (! (and (= id2_~ret~1_14 |id2_#res_15|) (<= (mod id2_~ret~1_14 4294967296) 2)) :named ssa_15))
