...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:11:28+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id watermelon.c_AllErrorsAtOnce_Iteration30)
...
(declare-fun v_main_~is_divisible2~0_35_fresh_1 () Int)
(declare-fun v_main_~is_divisible1~0_35_fresh_1 () Int)
...
(declare-fun student_version_~w_33 () Int)
(declare-fun student_version_~is_divisible~1_33 () Int)
(declare-fun student_version_~i~1_34 () Int)
(declare-fun |student_version_#res_35| () Int)
(declare-fun student_version_~is_divisible~1_35 () Int)
...
(declare-fun main_~is_divisible1~0_38 () Int)
...
(assert (! (and (= ~true~0_1 v_main_~is_divisible1~0_35_fresh_1) (= ~true~0_1 v_main_~is_divisible2~0_35_fresh_1)) :named ssa_4))
...
(assert (! (= correct_version_~i~0_15 correct_version_~w_7) :named ssa_17))
(assert (! true :named ssa_18))
(assert (! (= |correct_version_#res_19| correct_version_~is_divisible~0_7) :named ssa_19))
...
(assert (! (and (= (+ 2 student_version_~i~1_30) student_version_~i~1_31) (< student_version_~i~1_30 student_version_~w_23)) :named ssa_31))
(assert (! (<= student_version_~w_23 student_version_~i~1_31) :named ssa_32))
(assert (! (and (not (= student_version_~w_23 student_version_~i~1_31)) (= ~false~0_1 student_version_~is_divisible~1_33)) :named ssa_33))
(assert (! true :named ssa_34))
(assert (! (= student_version_~is_divisible~1_33 |student_version_#res_35|) :named ssa_35))
(assert (! (= |main_#t~ret6_36| |student_version_#res_35|) :named ssa_36_return))
(assert (! (and (<= |main_#t~ret6_36| 2147483647) (= main_~is_divisible2~0_37 |main_#t~ret6_36|) (<= 0 (+ |main_#t~ret6_36| 2147483648))) :named ssa_37))
(assert (! true :named ssa_38_GlobVarAssigCall))
(assert (! (= (ite (= main_~is_divisible1~0_21 main_~is_divisible2~0_37) 1 0) |__VERIFIER_assert_#in~cond_38|) :named ssa_38_LocVarAssigCall))
...
(assert (! true :named ssa_precond))
(assert (! (not (and (<= (+ (* (div main_~w~0_-2 4294967296) 4294967296) 14) main_~w~0_-2) (<= main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647)))) :named ssa_postcond))
...
(assert (! (= correct_version_~i~0_8 correct_version_~w_0) :named ssa_10))
(assert (! true :named ssa_11))
(assert (! (= |correct_version_#res_12| correct_version_~is_divisible~0_0) :named ssa_12))
...
(assert (! (and (not (= student_version_~w_0 student_version_~i~1_8)) (= ~false~0_-1 student_version_~is_divisible~1_10)) :named ssa_10))
(assert (! true :named ssa_11))
(assert (! (= student_version_~is_divisible~1_10 |student_version_#res_12|) :named ssa_12))
(assert (! (= |main_#t~ret6_13| |student_version_#res_12|) :named ssa_13_return))
(assert (! (and (<= (+ (* (div main_~w~0_-2 4294967296) 4294967296) 14) main_~w~0_-2) (<= main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647))) :named ssa_-2_PendingContext))
