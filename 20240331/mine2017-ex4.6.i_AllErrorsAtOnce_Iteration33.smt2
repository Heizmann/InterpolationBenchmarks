...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:10:01+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id mine2017-ex4.6.i_AllErrorsAtOnce_Iteration33)
...
(declare-fun main_~x~0_294 () Int)
(declare-fun __VERIFIER_assert_~cond_295 () Int)
(declare-fun __VERIFIER_assert_~cond_296 () Int)
(declare-fun main_~x~0_299 () Int)
(declare-fun |main_#t~post1_299| () Int)
(declare-fun |__VERIFIER_assert_#in~cond_300| () Int)
(declare-fun main_~x~0_300 () Int)
(declare-fun __VERIFIER_assert_~cond_301 () Int)
(declare-fun __VERIFIER_assert_~cond_302 () Int)
(declare-fun |__VERIFIER_assert_#in~cond_306| () Int)
(declare-fun main_~x~0_306 () Int)
(declare-fun __VERIFIER_assert_~cond_307 () Int)
(declare-fun __VERIFIER_assert_~cond_308 () Int)
(declare-fun main_~x~0_311 () Int)
(declare-fun |main_#t~post1_311| () Int)
(declare-fun |__VERIFIER_assert_#in~cond_312| () Int)
(declare-fun main_~x~0_312 () Int)
(declare-fun __VERIFIER_assert_~cond_313 () Int)
(declare-fun __VERIFIER_assert_~cond_314 () Int)
(declare-fun |__VERIFIER_assert_#in~cond_318| () Int)
(declare-fun main_~x~0_318 () Int)
(declare-fun __VERIFIER_assert_~cond_319 () Int)
(declare-fun __VERIFIER_assert_~cond_320 () Int)
(declare-fun main_~x~0_323 () Int)
(declare-fun |main_#t~post1_323| () Int)
(declare-fun |__VERIFIER_assert_#in~cond_324| () Int)
(declare-fun main_~x~0_324 () Int)
(declare-fun __VERIFIER_assert_~cond_325 () Int)
(declare-fun __VERIFIER_assert_~cond_326 () Int)
(declare-fun |__VERIFIER_assert_#in~cond_330| () Int)
(declare-fun main_~x~0_330 () Int)
(declare-fun __VERIFIER_assert_~cond_331 () Int)
(declare-fun __VERIFIER_assert_~cond_332 () Int)
(declare-fun main_~x~0_335 () Int)
(declare-fun |main_#t~post1_335| () Int)
(declare-fun |__VERIFIER_assert_#in~cond_336| () Int)
(declare-fun main_~x~0_336 () Int)
...
(declare-fun main_~x~0_366 () Int)
(declare-fun __VERIFIER_assert_~cond_367 () Int)
(declare-fun __VERIFIER_assert_~cond_368 () Int)
(declare-fun main_~x~0_371 () Int)
(declare-fun |main_#t~post1_371| () Int)
(declare-fun |__VERIFIER_assert_#in~cond_372| () Int)
(declare-fun main_~x~0_372 () Int)
(declare-fun __VERIFIER_assert_~cond_373 () Int)
(declare-fun __VERIFIER_assert_~cond_374 () Int)
