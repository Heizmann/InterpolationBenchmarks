...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:18:23+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id duplets.c_AllErrorsAtOnce_Iteration10)
...
(declare-fun v_mkdup_~x~0_23_fresh_1 () Int)
...
(declare-fun finddup_~_j.offset_39 () Int)
(declare-fun finddup_~_j.base_39 () Int)
(declare-fun finddup_~i~1_39 () Int)
(declare-fun finddup_~_i.base_39 () Int)
(declare-fun finddup_~j~1_39 () Int)
(declare-fun finddup_~_i.offset_39 () Int)
(declare-fun |finddup_#res_39| () Int)
...
(declare-fun |main_#t~ret14_41| () Int)
(declare-fun |finddup_#res_41| () Int)
(declare-fun |main_#t~ret14_42| () Int)
(declare-fun main_~r~0_42 () Int)
(declare-fun |__VERIFIER_assert_#in~cond_43| () Int)
(declare-fun main_~r~0_43 () Int)
...
(declare-fun |main_#t~mem15_55| () Int)
(declare-fun |main_#t~short17_55| () Bool)
(declare-fun |main_#t~mem16_55| () Int)
(declare-fun |v_main_#t~mem18_4_fresh_1| () Int)
(declare-fun |main_#t~short20_56| () Bool)
(declare-fun main_~n~0_56 () Int)
(declare-fun |v_main_#t~mem19_4_fresh_1| () Int)
...
(assert (! (and (not (= 0 |main_#t~malloc13.base_10|)) (< |main_#t~malloc13.base_10| |#StackHeapBarrier_-1|) (= |main_#t~malloc13.offset_10| 0) (= v_ArrVal_151_fresh_1 (* 4 (mod main_~n~0_4 1073741824))) (= (store |#length_3| |main_#t~malloc13.base_10| v_ArrVal_151_fresh_1) |#length_10|) (= (store |#valid_3| |main_#t~malloc13.base_10| v_ArrVal_152_fresh_1) |#valid_10|) (= (select |#valid_3| |main_#t~malloc13.base_10|) 0) (= v_ArrVal_152_fresh_1 1)) :named ssa_10))
(assert (! (= |old(#memory_int#2)_11| |#memory_int#2_11|) :named ssa_11_GlobVarAssigCall))
(assert (! (and (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_12_fresh_1| 4) (= |v_#Ultimate.meminit_#ptr.offsetInParam_12_fresh_1| |main_#t~malloc13.offset_10|) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_12_fresh_1|) (= |v_#Ultimate.meminit_#productInParam_12_fresh_1| (* main_~n~0_4 4)) (= |#Ultimate.meminit_#ptr.base_11| |main_#t~malloc13.base_10|)) :named ssa_11_LocVarAssigCall))
(assert (! (= |old(#memory_int#2)_11| |#memory_int#2_3|) :named ssa_11_OldVarAssigCall))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_153_fresh_1) (= (store |#memory_int#2_11| |#Ultimate.meminit_#ptr.base_11| v_ArrVal_153_fresh_1) |#memory_int#2_12|)) :named ssa_12))
...
(assert (! (and (= v_ArrVal_155_fresh_1 v_mkdup_~x~0_23_fresh_1) (= (store |#memory_int#2_15| mkdup_~a.base_16 v_ArrVal_154_fresh_1) |#memory_int#2_32|) (= v_ArrVal_154_fresh_1 (store (store (select |#memory_int#2_15| mkdup_~a.base_16) (+ (* mkdup_~i~0_16 4) mkdup_~a.offset_16) v_mkdup_~x~0_23_fresh_1) (+ mkdup_~a.offset_16 (* mkdup_~j~0_16 4)) v_mkdup_~x~0_23_fresh_1)) (<= 0 (+ v_mkdup_~x~0_23_fresh_1 2147483648)) (<= v_mkdup_~x~0_23_fresh_1 2147483647) (= v_ArrVal_156_fresh_1 v_mkdup_~x~0_23_fresh_1)) :named ssa_32))
(assert (! true :named ssa_33_return))
(assert (! (and (= |main_~#i~2.offset_34| 0) (= v_ArrVal_160_fresh_1 1) (= (select |#valid_10| |main_~#i~2.base_34|) 0) (= |main_~#j~2.offset_34| 0) (not (= |main_~#j~2.base_34| 0)) (< |#StackHeapBarrier_-1| |main_~#j~2.base_34|) (not (= |main_~#i~2.base_34| 0)) (= |#valid_34| (store (store |#valid_10| |main_~#i~2.base_34| v_ArrVal_158_fresh_1) |main_~#j~2.base_34| v_ArrVal_160_fresh_1)) (= (select (store |#valid_10| |main_~#i~2.base_34| v_ArrVal_158_fresh_1) |main_~#j~2.base_34|) 0) (= v_ArrVal_158_fresh_1 1) (= v_ArrVal_157_fresh_1 4) (= v_ArrVal_159_fresh_1 4) (= (store (store |#length_10| |main_~#i~2.base_34| v_ArrVal_157_fresh_1) |main_~#j~2.base_34| v_ArrVal_159_fresh_1) |#length_34|) (< |#StackHeapBarrier_-1| |main_~#i~2.base_34|)) :named ssa_34))
...
(assert (! (and (= (store |#memory_int#1_35| finddup_~_i.base_36 v_ArrVal_164_fresh_1) |#memory_int#1_39|) (= v_ArrVal_162_fresh_1 (store (select |#memory_int#3_35| finddup_~_j.base_36) finddup_~_j.offset_36 finddup_~j~1_37)) (= (store |#memory_int#3_35| finddup_~_j.base_36 v_ArrVal_162_fresh_1) |#memory_int#3_39|) (= (store (select |#memory_int#1_35| finddup_~_i.base_36) finddup_~_i.offset_36 v_ArrVal_161_fresh_1) v_ArrVal_164_fresh_1) (= |finddup_#res_39| 1) (= |finddup_#t~mem8_38| |finddup_#t~mem9_38|) (= v_ArrVal_163_fresh_1 finddup_~j~1_37) (= v_ArrVal_161_fresh_1 finddup_~i~1_36)) :named ssa_39))
(assert (! true :named ssa_40))
(assert (! (= |main_#t~ret14_41| |finddup_#res_39|) :named ssa_41_return))
(assert (! (and (= main_~r~0_42 |main_#t~ret14_41|) (<= |main_#t~ret14_41| 2147483647) (<= 0 (+ |main_#t~ret14_41| 2147483648))) :named ssa_42))
(assert (! true :named ssa_43_GlobVarAssigCall))
(assert (! (= main_~r~0_42 |__VERIFIER_assert_#in~cond_43|) :named ssa_43_LocVarAssigCall))
...
(assert (! (and (or (and (<= 0 |v_main_#t~mem15_6_fresh_1|) |main_#t~short17_48|) (and (< |v_main_#t~mem15_6_fresh_1| 0) (not |main_#t~short17_48|))) (= (select (select |#memory_int#1_39| |main_~#i~2.base_34|) |main_~#i~2.offset_34|) |v_main_#t~mem15_6_fresh_1|)) :named ssa_48))
(assert (! (and (= (select (select |#memory_int#1_39| |main_~#i~2.base_34|) |main_~#i~2.offset_34|) |v_main_#t~mem16_5_fresh_1|) (or (and (< |v_main_#t~mem16_5_fresh_1| main_~n~0_4) |main_#t~short17_49|) (and (not |main_#t~short17_49|) (<= main_~n~0_4 |v_main_#t~mem16_5_fresh_1|))) |main_#t~short17_48|) :named ssa_49))
(assert (! true :named ssa_50_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_50| (ite |main_#t~short17_49| 1 0)) :named ssa_50_LocVarAssigCall))
...
(assert (! (and (= |v_main_#t~mem18_4_fresh_1| (select (select |#memory_int#3_39| |main_~#j~2.base_34|) |main_~#j~2.offset_34|)) (or (and (< |v_main_#t~mem18_4_fresh_1| 0) (not |main_#t~short20_55|)) (and |main_#t~short20_55| (<= 0 |v_main_#t~mem18_4_fresh_1|)))) :named ssa_55))
(assert (! (and (= (select (select |#memory_int#3_39| |main_~#j~2.base_34|) |main_~#j~2.offset_34|) |v_main_#t~mem19_4_fresh_1|) (or (and (< |v_main_#t~mem19_4_fresh_1| main_~n~0_4) |main_#t~short20_56|) (and (<= main_~n~0_4 |v_main_#t~mem19_4_fresh_1|) (not |main_#t~short20_56|))) |main_#t~short20_55|) :named ssa_56))
(assert (! true :named ssa_57_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_57| (ite |main_#t~short20_56| 1 0)) :named ssa_57_LocVarAssigCall))
...
(assert (! (not true) :named ssa_postcond))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_165_fresh_1) (= (store |#memory_int#2_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_165_fresh_1) |#memory_int#2_0|)) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! true :named ssa_-2_PendingContext))
...
(declare-fun v_mkdup_~x~0_24_fresh_1 () Int)
(assert (! (= |#memory_int#2_-1| |old(#memory_int#2)_-1|) :named ssa_precond))
(assert (! (not true) :named ssa_postcond))
...
(assert (! (and (<= v_mkdup_~x~0_24_fresh_1 2147483647) (= v_ArrVal_168_fresh_1 v_mkdup_~x~0_24_fresh_1) (= v_ArrVal_167_fresh_1 (store (store (select |#memory_int#2_-1| mkdup_~a.base_0) (+ (* mkdup_~i~0_0 4) mkdup_~a.offset_0) v_mkdup_~x~0_24_fresh_1) (+ mkdup_~a.offset_0 (* mkdup_~j~0_0 4)) v_ArrVal_166_fresh_1)) (<= 0 (+ v_mkdup_~x~0_24_fresh_1 2147483648)) (= v_ArrVal_166_fresh_1 v_mkdup_~x~0_24_fresh_1) (= (store |#memory_int#2_-1| mkdup_~a.base_0 v_ArrVal_167_fresh_1) |#memory_int#2_16|)) :named ssa_16))
...
(declare-fun finddup_~_j.offset_3 () Int)
(declare-fun finddup_~_j.base_3 () Int)
(declare-fun finddup_~i~1_3 () Int)
(declare-fun finddup_~_i.base_3 () Int)
(declare-fun finddup_~j~1_3 () Int)
(declare-fun finddup_~_i.offset_3 () Int)
(declare-fun |finddup_#res_3| () Int)
...
(declare-fun |main_#t~ret14_5| () Int)
(declare-fun |finddup_#res_5| () Int)
(assert (! (and (= |#memory_int#1_-1| |old(#memory_int#1)_-1|) (= |#memory_int#3_-1| |old(#memory_int#3)_-1|)) :named ssa_precond))
(assert (! (not (<= (+ (select (select |#memory_int#3_3| |main_~#j~2.base_-2|) |main_~#j~2.offset_-2|) 1) main_~n~0_-2)) :named ssa_postcond))
...
(assert (! (and (= v_ArrVal_171_fresh_1 finddup_~j~1_1) (= (store |#memory_int#1_-1| finddup_~_i.base_0 v_ArrVal_172_fresh_1) |#memory_int#1_3|) (= (store |#memory_int#3_-1| finddup_~_j.base_0 v_ArrVal_170_fresh_1) |#memory_int#3_3|) (= v_ArrVal_169_fresh_1 finddup_~i~1_0) (= v_ArrVal_170_fresh_1 (store (select |#memory_int#3_-1| finddup_~_j.base_0) finddup_~_j.offset_0 finddup_~j~1_1)) (= |finddup_#res_3| 1) (= |finddup_#t~mem8_2| |finddup_#t~mem9_2|) (= (store (select |#memory_int#1_-1| finddup_~_i.base_0) finddup_~_i.offset_0 v_ArrVal_169_fresh_1) v_ArrVal_172_fresh_1)) :named ssa_3))
(assert (! true :named ssa_4))
(assert (! (= |main_#t~ret14_5| |finddup_#res_3|) :named ssa_5_return))
(assert (! true :named ssa_-2_PendingContext))
...
(assert (! true :named ssa_precond))
(assert (! (not (<= (+ (select (select |#memory_int#3_-2| |main_~#j~2.base_-2|) |main_~#j~2.offset_-2|) 1) main_~n~0_-2)) :named ssa_postcond))
...
(assert (! true :named ssa_2))
(assert (! true :named ssa_3_return))
(assert (! (<= (+ (select (select |#memory_int#3_-2| |main_~#j~2.base_-2|) |main_~#j~2.offset_-2|) 1) main_~n~0_-2) :named ssa_-2_PendingContext))
...
(declare-fun |main_~#j~2.base_-2| () Int)
(declare-fun main_~n~0_-2 () Int)
(declare-fun |main_#t~short17_-2| () Bool)
(declare-fun |__VERIFIER_assert_#in~cond_-1| () Int)
(declare-fun |main_#t~short17_-1| () Bool)
(declare-fun __VERIFIER_assert_~cond_0 () Int)
(declare-fun __VERIFIER_assert_~cond_1 () Int)
(assert (! true :named ssa_precond))
(assert (! (not (<= (+ (select (select |#memory_int#3_-2| |main_~#j~2.base_-2|) |main_~#j~2.offset_-2|) 1) main_~n~0_-2)) :named ssa_postcond))
...
(assert (! true :named ssa_3_return))
(assert (! (<= (+ (select (select |#memory_int#3_-2| |main_~#j~2.base_-2|) |main_~#j~2.offset_-2|) 1) main_~n~0_-2) :named ssa_-2_PendingContext))
(assert (! (= |__VERIFIER_assert_#in~cond_-1| (ite |main_#t~short17_-2| 1 0)) :named ssa_-2_LocVarAssignPendingContext))
(assert (! true :named ssa_-2_OldVarAssignPendingContext))
(check-sat)
(get-interpolants (and ssa_0 ssa_precond) ssa_1 ssa_2 (and ssa_-2_PendingContext ssa_3_return ssa_-2_LocVarAssignPendingContext ssa_-2_OldVarAssignPendingContext ssa_postcond))
(echo "finished trace check")
