...
(set-info :ultimate-id id_i20_o20-1.c_AllErrorsAtOnce_Iteration5)
...
(declare-fun main_~result~0_34 () Int)
(declare-fun |main_#t~ret5_34| () Int)
(declare-fun main_~result~0_35 () Int)
...
(assert (! (and (<= 0 (+ |main_#t~ret5_33| 2147483648)) (= main_~result~0_34 |main_#t~ret5_33|) (<= |main_#t~ret5_33| 2147483647)) :named ssa_34))
(assert (! (not (= main_~result~0_34 20)) :named ssa_35))
(assert (! true :named ssa_36))
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 (and ssa_13 ssa_14_OldVarAssigCall ssa_20 ssa_17_LocVarAssigCall ssa_5_LocVarAssigCall ssa_31 ssa_5_GlobVarAssigCall ssa_7 ssa_16 ssa_6 ssa_26 ssa_17_GlobVarAssigCall ssa_8_GlobVarAssigCall ssa_11_LocVarAssigCall ssa_14_LocVarAssigCall ssa_27_return ssa_10 ssa_9 ssa_25 ssa_14_GlobVarAssigCall ssa_24_return ssa_19 ssa_17_OldVarAssigCall ssa_12 ssa_11_OldVarAssigCall ssa_32 ssa_5_OldVarAssigCall ssa_8_OldVarAssigCall ssa_28 ssa_22 ssa_15 ssa_29 ssa_30_return ssa_11_GlobVarAssigCall ssa_33_return ssa_18 ssa_23 ssa_21_return ssa_8_LocVarAssigCall) ssa_34 ssa_35 (and ssa_36 ssa_postcond))
...
(assert (! (and (<= |id_#t~ret4_24| 2147483647) (= |id_#res_25| (+ |id_#t~ret4_24| 1)) (<= 0 (+ |id_#t~ret4_24| 2147483648))) :named ssa_25))
(assert (! true :named ssa_26))
(assert (! (= |id_#res_25| |main_#t~ret5_27|) :named ssa_27_return))
