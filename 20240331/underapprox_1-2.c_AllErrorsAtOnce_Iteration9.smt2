...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:09:01+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id underapprox_1-2.c_AllErrorsAtOnce_Iteration9)
...
(assert (! (and (= main_~x~0_4 0) (= main_~y~0_4 1)) :named ssa_4))
(assert (! (and (= main_~y~0_5 (* main_~y~0_4 2)) (< (mod main_~x~0_4 4294967296) 6) (= main_~x~0_5 (+ main_~x~0_4 1))) :named ssa_5))
(assert (! (and (= main_~y~0_6 (* main_~y~0_5 2)) (< (mod main_~x~0_5 4294967296) 6) (= main_~x~0_6 (+ main_~x~0_5 1))) :named ssa_6))
(assert (! (and (= main_~y~0_7 (* main_~y~0_6 2)) (< (mod main_~x~0_6 4294967296) 6) (= main_~x~0_7 (+ main_~x~0_6 1))) :named ssa_7))
(assert (! (and (= main_~y~0_8 (* main_~y~0_7 2)) (< (mod main_~x~0_7 4294967296) 6) (= main_~x~0_8 (+ main_~x~0_7 1))) :named ssa_8))
(assert (! (and (= main_~y~0_9 (* main_~y~0_8 2)) (< (mod main_~x~0_8 4294967296) 6) (= main_~x~0_9 (+ main_~x~0_8 1))) :named ssa_9))
(assert (! (and (= main_~y~0_10 (* main_~y~0_9 2)) (< (mod main_~x~0_9 4294967296) 6) (= main_~x~0_10 (+ main_~x~0_9 1))) :named ssa_10))
(assert (! (and (= main_~y~0_11 (* main_~y~0_10 2)) (< (mod main_~x~0_10 4294967296) 6) (= main_~x~0_11 (+ main_~x~0_10 1))) :named ssa_11))
(assert (! (<= 6 (mod main_~x~0_11 4294967296)) :named ssa_12))
(assert (! true :named ssa_13_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_13| (mod (mod main_~y~0_11 4294967296) 3)) :named ssa_13_LocVarAssigCall))
