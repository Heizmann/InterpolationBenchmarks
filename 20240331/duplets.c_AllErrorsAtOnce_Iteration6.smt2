...
(set-info :ultimate-id duplets.c_AllErrorsAtOnce_Iteration6)
...
(declare-fun v_mkdup_~x~0_15_fresh_1 () Int)
...
(assert (! (and (not (= 0 |main_#t~malloc13.base_10|)) (< |main_#t~malloc13.base_10| |#StackHeapBarrier_-1|) (= |main_#t~malloc13.offset_10| 0) (= (store |#length_3| |main_#t~malloc13.base_10| v_ArrVal_79_fresh_1) |#length_10|) (= (* 4 (mod main_~n~0_4 1073741824)) v_ArrVal_79_fresh_1) (= v_ArrVal_80_fresh_1 1) (= (select |#valid_3| |main_#t~malloc13.base_10|) 0) (= |#valid_10| (store |#valid_3| |main_#t~malloc13.base_10| v_ArrVal_80_fresh_1))) :named ssa_10))
(assert (! (= |old(#memory_int#2)_11| |#memory_int#2_11|) :named ssa_11_GlobVarAssigCall))
(assert (! (and (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_8_fresh_1| 4) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_8_fresh_1|) (= |v_#Ultimate.meminit_#productInParam_8_fresh_1| (* main_~n~0_4 4)) (= |v_#Ultimate.meminit_#ptr.offsetInParam_8_fresh_1| |main_#t~malloc13.offset_10|) (= |#Ultimate.meminit_#ptr.base_11| |main_#t~malloc13.base_10|)) :named ssa_11_LocVarAssigCall))
(assert (! (= |old(#memory_int#2)_11| |#memory_int#2_3|) :named ssa_11_OldVarAssigCall))
(assert (! (and (= |#memory_int#2_12| (store |#memory_int#2_11| |#Ultimate.meminit_#ptr.base_11| v_ArrVal_81_fresh_1)) (= ((as const (Array Int Int)) 0) v_ArrVal_81_fresh_1)) :named ssa_12))
...
(assert (! (and (<= v_mkdup_~x~0_15_fresh_1 2147483647) (= (store (store (select |#memory_int#2_15| mkdup_~a.base_16) (+ (* mkdup_~i~0_16 4) mkdup_~a.offset_16) v_mkdup_~x~0_15_fresh_1) (+ mkdup_~a.offset_16 (* mkdup_~j~0_16 4)) v_mkdup_~x~0_15_fresh_1) v_ArrVal_82_fresh_1) (= (store |#memory_int#2_15| mkdup_~a.base_16 v_ArrVal_82_fresh_1) |#memory_int#2_32|) (= v_mkdup_~x~0_15_fresh_1 v_ArrVal_83_fresh_1) (<= 0 (+ v_mkdup_~x~0_15_fresh_1 2147483648)) (= v_mkdup_~x~0_15_fresh_1 v_ArrVal_84_fresh_1)) :named ssa_32))
(assert (! true :named ssa_33_return))
(assert (! (and (= |main_~#i~2.offset_34| 0) (= (select (store |#valid_10| |main_~#i~2.base_34| v_ArrVal_86_fresh_1) |main_~#j~2.base_34|) 0) (= |#valid_34| (store (store |#valid_10| |main_~#i~2.base_34| v_ArrVal_86_fresh_1) |main_~#j~2.base_34| v_ArrVal_88_fresh_1)) (= (select |#valid_10| |main_~#i~2.base_34|) 0) (= |main_~#j~2.offset_34| 0) (not (= |main_~#j~2.base_34| 0)) (= v_ArrVal_88_fresh_1 1) (< |#StackHeapBarrier_-1| |main_~#j~2.base_34|) (= 4 v_ArrVal_85_fresh_1) (not (= |main_~#i~2.base_34| 0)) (= 4 v_ArrVal_87_fresh_1) (= v_ArrVal_86_fresh_1 1) (< |#StackHeapBarrier_-1| |main_~#i~2.base_34|) (= |#length_34| (store (store |#length_10| |main_~#i~2.base_34| v_ArrVal_85_fresh_1) |main_~#j~2.base_34| v_ArrVal_87_fresh_1))) :named ssa_34))
...
(assert (! (and (= (store (select |#memory_int#3_35| finddup_~_j.base_36) finddup_~_j.offset_36 finddup_~j~1_37) v_ArrVal_90_fresh_1) (= |#memory_int#3_39| (store |#memory_int#3_35| finddup_~_j.base_36 v_ArrVal_90_fresh_1)) (= finddup_~i~1_36 v_ArrVal_89_fresh_1) (= |finddup_#res_39| 1) (= |finddup_#t~mem8_38| |finddup_#t~mem9_38|) (= finddup_~j~1_37 v_ArrVal_91_fresh_1) (= (store (select |#memory_int#1_35| finddup_~_i.base_36) finddup_~_i.offset_36 v_ArrVal_89_fresh_1) v_ArrVal_92_fresh_1) (= |#memory_int#1_39| (store |#memory_int#1_35| finddup_~_i.base_36 v_ArrVal_92_fresh_1))) :named ssa_39))
...
(assert (! (and (= (select (select |#memory_int#1_39| |main_~#i~2.base_34|) |main_~#i~2.offset_34|) |v_main_#t~mem15_4_fresh_1|) (or (and (< |v_main_#t~mem15_4_fresh_1| 0) (not |main_#t~short17_48|)) (and (<= 0 |v_main_#t~mem15_4_fresh_1|) |main_#t~short17_48|))) :named ssa_48))
(assert (! (not |main_#t~short17_48|) :named ssa_49))
(assert (! true :named ssa_50_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_50| (ite |main_#t~short17_48| 1 0)) :named ssa_50_LocVarAssigCall))
...
(assert (! (not true) :named ssa_postcond))
(assert (! (and (= |#memory_int#2_0| (store |#memory_int#2_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_93_fresh_1)) (= ((as const (Array Int Int)) 0) v_ArrVal_93_fresh_1)) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! true :named ssa_-2_PendingContext))
...
(declare-fun v_mkdup_~x~0_16_fresh_1 () Int)
...
(assert (! (and (= v_mkdup_~x~0_16_fresh_1 v_ArrVal_96_fresh_1) (= v_ArrVal_95_fresh_1 (store (store (select |#memory_int#2_-1| mkdup_~a.base_0) (+ (* mkdup_~i~0_0 4) mkdup_~a.offset_0) v_ArrVal_94_fresh_1) (+ mkdup_~a.offset_0 (* mkdup_~j~0_0 4)) v_mkdup_~x~0_16_fresh_1)) (<= 0 (+ v_mkdup_~x~0_16_fresh_1 2147483648)) (<= v_mkdup_~x~0_16_fresh_1 2147483647) (= v_mkdup_~x~0_16_fresh_1 v_ArrVal_94_fresh_1) (= |#memory_int#2_16| (store |#memory_int#2_-1| mkdup_~a.base_0 v_ArrVal_95_fresh_1))) :named ssa_16))
...
(assert (! (not (= (select (select |#memory_int#1_3| |main_~#i~2.base_-2|) |main_~#i~2.offset_-2|) 0)) :named ssa_postcond))
...
(assert (! (and (= |#memory_int#1_3| (store |#memory_int#1_-1| finddup_~_i.base_0 v_ArrVal_100_fresh_1)) (= (store |#memory_int#3_-1| finddup_~_j.base_0 v_ArrVal_98_fresh_1) |#memory_int#3_3|) (= v_ArrVal_100_fresh_1 (store (select |#memory_int#1_-1| finddup_~_i.base_0) finddup_~_i.offset_0 v_ArrVal_97_fresh_1)) (= |finddup_#res_3| 1) (= |finddup_#t~mem8_2| |finddup_#t~mem9_2|) (= finddup_~i~1_0 v_ArrVal_97_fresh_1) (= (store (select |#memory_int#3_-1| finddup_~_j.base_0) finddup_~_j.offset_0 finddup_~j~1_1) v_ArrVal_98_fresh_1) (= finddup_~j~1_1 v_ArrVal_99_fresh_1)) :named ssa_3))
(assert (! true :named ssa_4))
...
(assert (! true :named ssa_precond))
(assert (! (not (= (select (select |#memory_int#1_-2| |main_~#i~2.base_-2|) |main_~#i~2.offset_-2|) 0)) :named ssa_postcond))
...
(assert (! true :named ssa_2))
(assert (! true :named ssa_3_return))
(assert (! (= (select (select |#memory_int#1_-2| |main_~#i~2.base_-2|) |main_~#i~2.offset_-2|) 0) :named ssa_-2_PendingContext))
