...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration45)
...
(assert (! (<= 1000000 main_~i~0_48) :named ssa_49))
(assert (! true :named ssa_50_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_50| (ite (= main_~i~0_48 1000000) 1 0)) :named ssa_50_LocVarAssigCall))
