...
(set-info :ultimate-id string-1.i_AllErrorsAtOnce_Iteration12)
...
(declare-fun v_main_~found~0_17_fresh_1 () Int)
...
(declare-fun |v_main_#t~nondet4_45_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_46_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_47_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_48_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_49_fresh_1| () Int)
...
(declare-fun |v_main_#t~post10_9_fresh_1| () Int)
...
(declare-fun main_~nc_A~0_37 () Int)
(declare-fun main_~found~0_38 () Int)
(declare-fun main_~j~0_38 () Int)
(declare-fun main_~nc_B~0_38 () Int)
(declare-fun main_~found~0_39 () Int)
...
(assert (! (and (< |#StackHeapBarrier_-1| |main_~#string_A~0.base_4|) (= main_~i~0_4 0) (= (select |#valid_3| |main_~#string_A~0.base_4|) 0) (= |main_~#string_A~0.offset_4| 0) (not (= |main_~#string_B~0.base_4| 0)) (= v_main_~found~0_17_fresh_1 0) (= (store (store |#length_3| |main_~#string_A~0.base_4| v_ArrVal_207_fresh_1) |main_~#string_B~0.base_4| v_ArrVal_206_fresh_1) |#length_4|) (= v_ArrVal_205_fresh_1 1) (= |main_~#string_B~0.offset_4| 0) (= v_ArrVal_207_fresh_1 5) (= |#valid_4| (store (store |#valid_3| |main_~#string_A~0.base_4| v_ArrVal_208_fresh_1) |main_~#string_B~0.base_4| v_ArrVal_205_fresh_1)) (= (select (store |#valid_3| |main_~#string_A~0.base_4| v_ArrVal_208_fresh_1) |main_~#string_B~0.base_4|) 0) (not (= |main_~#string_A~0.base_4| 0)) (= v_ArrVal_206_fresh_1 5) (= v_ArrVal_208_fresh_1 1) (< |#StackHeapBarrier_-1| |main_~#string_B~0.base_4|)) :named ssa_4))
(assert (! (and (<= |v_main_#t~nondet1_45_fresh_1| 127) (= v_ArrVal_210_fresh_1 |v_main_#t~nondet1_45_fresh_1|) (= main_~i~0_5 (+ main_~i~0_4 1)) (= v_ArrVal_209_fresh_1 (store (select |#memory_int#2_3| |main_~#string_A~0.base_4|) (+ main_~i~0_4 |main_~#string_A~0.offset_4|) |v_main_#t~nondet1_45_fresh_1|)) (<= 0 (+ |v_main_#t~nondet1_45_fresh_1| 128)) (= |#memory_int#2_5| (store |#memory_int#2_3| |main_~#string_A~0.base_4| v_ArrVal_209_fresh_1)) (< main_~i~0_4 5)) :named ssa_5))
(assert (! (and (= |#memory_int#2_6| (store |#memory_int#2_5| |main_~#string_A~0.base_4| v_ArrVal_212_fresh_1)) (<= |v_main_#t~nondet1_46_fresh_1| 127) (= main_~i~0_6 (+ main_~i~0_5 1)) (<= 0 (+ |v_main_#t~nondet1_46_fresh_1| 128)) (= v_ArrVal_212_fresh_1 (store (select |#memory_int#2_5| |main_~#string_A~0.base_4|) (+ main_~i~0_5 |main_~#string_A~0.offset_4|) v_ArrVal_211_fresh_1)) (< main_~i~0_5 5) (= v_ArrVal_211_fresh_1 |v_main_#t~nondet1_46_fresh_1|)) :named ssa_6))
(assert (! (and (<= 0 (+ |v_main_#t~nondet1_47_fresh_1| 128)) (= (store |#memory_int#2_6| |main_~#string_A~0.base_4| v_ArrVal_214_fresh_1) |#memory_int#2_7|) (= main_~i~0_7 (+ main_~i~0_6 1)) (= v_ArrVal_213_fresh_1 |v_main_#t~nondet1_47_fresh_1|) (= v_ArrVal_214_fresh_1 (store (select |#memory_int#2_6| |main_~#string_A~0.base_4|) (+ main_~i~0_6 |main_~#string_A~0.offset_4|) v_ArrVal_213_fresh_1)) (< main_~i~0_6 5) (<= |v_main_#t~nondet1_47_fresh_1| 127)) :named ssa_7))
(assert (! (and (= (store |#memory_int#2_7| |main_~#string_A~0.base_4| v_ArrVal_216_fresh_1) |#memory_int#2_8|) (= v_ArrVal_216_fresh_1 (store (select |#memory_int#2_7| |main_~#string_A~0.base_4|) (+ main_~i~0_7 |main_~#string_A~0.offset_4|) v_ArrVal_215_fresh_1)) (<= |v_main_#t~nondet1_48_fresh_1| 127) (= main_~i~0_8 (+ main_~i~0_7 1)) (= v_ArrVal_215_fresh_1 |v_main_#t~nondet1_48_fresh_1|) (< main_~i~0_7 5) (<= 0 (+ |v_main_#t~nondet1_48_fresh_1| 128))) :named ssa_8))
(assert (! (and (= v_ArrVal_217_fresh_1 |v_main_#t~nondet1_49_fresh_1|) (<= 0 (+ |v_main_#t~nondet1_49_fresh_1| 128)) (= main_~i~0_9 (+ main_~i~0_8 1)) (<= |v_main_#t~nondet1_49_fresh_1| 127) (= (store |#memory_int#2_8| |main_~#string_A~0.base_4| v_ArrVal_218_fresh_1) |#memory_int#2_9|) (< main_~i~0_8 5) (= v_ArrVal_218_fresh_1 (store (select |#memory_int#2_8| |main_~#string_A~0.base_4|) (+ main_~i~0_8 |main_~#string_A~0.offset_4|) v_ArrVal_217_fresh_1))) :named ssa_9))
...
(assert (! (and (<= |v_main_#t~nondet4_45_fresh_1| 127) (<= 0 (+ |v_main_#t~nondet4_45_fresh_1| 128)) (= main_~i~0_13 (+ main_~i~0_12 1)) (= v_ArrVal_219_fresh_1 (store (select |#memory_int#1_3| |main_~#string_B~0.base_4|) (+ main_~i~0_12 |main_~#string_B~0.offset_4|) |v_main_#t~nondet4_45_fresh_1|)) (= v_ArrVal_220_fresh_1 |v_main_#t~nondet4_45_fresh_1|) (= (store |#memory_int#1_3| |main_~#string_B~0.base_4| v_ArrVal_219_fresh_1) |#memory_int#1_13|) (< main_~i~0_12 5)) :named ssa_13))
(assert (! (and (= main_~i~0_14 (+ main_~i~0_13 1)) (= v_ArrVal_221_fresh_1 (store (select |#memory_int#1_13| |main_~#string_B~0.base_4|) (+ main_~i~0_13 |main_~#string_B~0.offset_4|) |v_main_#t~nondet4_46_fresh_1|)) (<= |v_main_#t~nondet4_46_fresh_1| 127) (= v_ArrVal_222_fresh_1 |v_main_#t~nondet4_46_fresh_1|) (< main_~i~0_13 5) (<= 0 (+ |v_main_#t~nondet4_46_fresh_1| 128)) (= (store |#memory_int#1_13| |main_~#string_B~0.base_4| v_ArrVal_221_fresh_1) |#memory_int#1_14|)) :named ssa_14))
(assert (! (and (= main_~i~0_15 (+ main_~i~0_14 1)) (= v_ArrVal_224_fresh_1 (store (select |#memory_int#1_14| |main_~#string_B~0.base_4|) (+ main_~i~0_14 |main_~#string_B~0.offset_4|) v_ArrVal_223_fresh_1)) (= v_ArrVal_223_fresh_1 |v_main_#t~nondet4_47_fresh_1|) (< main_~i~0_14 5) (<= |v_main_#t~nondet4_47_fresh_1| 127) (= (store |#memory_int#1_14| |main_~#string_B~0.base_4| v_ArrVal_224_fresh_1) |#memory_int#1_15|) (<= 0 (+ |v_main_#t~nondet4_47_fresh_1| 128))) :named ssa_15))
(assert (! (and (= (store |#memory_int#1_15| |main_~#string_B~0.base_4| v_ArrVal_226_fresh_1) |#memory_int#1_16|) (= main_~i~0_16 (+ main_~i~0_15 1)) (= v_ArrVal_225_fresh_1 |v_main_#t~nondet4_48_fresh_1|) (<= |v_main_#t~nondet4_48_fresh_1| 127) (= v_ArrVal_226_fresh_1 (store (select |#memory_int#1_15| |main_~#string_B~0.base_4|) (+ main_~i~0_15 |main_~#string_B~0.offset_4|) v_ArrVal_225_fresh_1)) (< main_~i~0_15 5) (<= 0 (+ |v_main_#t~nondet4_48_fresh_1| 128))) :named ssa_16))
(assert (! (and (= v_ArrVal_228_fresh_1 |v_main_#t~nondet4_49_fresh_1|) (= main_~i~0_17 (+ main_~i~0_16 1)) (<= 0 (+ |v_main_#t~nondet4_49_fresh_1| 128)) (= v_ArrVal_227_fresh_1 (store (select |#memory_int#1_16| |main_~#string_B~0.base_4|) (+ main_~i~0_16 |main_~#string_B~0.offset_4|) |v_main_#t~nondet4_49_fresh_1|)) (= (store |#memory_int#1_16| |main_~#string_B~0.base_4| v_ArrVal_227_fresh_1) |#memory_int#1_17|) (< main_~i~0_16 5) (<= |v_main_#t~nondet4_49_fresh_1| 127)) :named ssa_17))
...
(assert (! (and (= |v_main_#t~post8_6_fresh_1| main_~nc_A~0_20) (not (= |main_#t~mem7_21| 0)) (= (+ |v_main_#t~post8_6_fresh_1| 1) main_~nc_A~0_22)) :named ssa_22))
...
(assert (! (and (= (+ |v_main_#t~post8_7_fresh_1| 1) main_~nc_A~0_24) (not (= |main_#t~mem7_23| 0)) (= |v_main_#t~post8_7_fresh_1| main_~nc_A~0_22)) :named ssa_24))
...
(assert (! (and (= |v_main_#t~post10_9_fresh_1| main_~nc_B~0_27) (not (= |main_#t~mem9_28| 0)) (= main_~nc_B~0_29 (+ |v_main_#t~post10_9_fresh_1| 1))) :named ssa_29))
...
(assert (! (= |main_#t~mem9_30| 0) :named ssa_31))
(assert (! (and (= main_~j~0_32 0) (<= main_~nc_A~0_24 main_~nc_B~0_29) (= main_~i~0_32 main_~j~0_32)) :named ssa_32))
(assert (! (and (= (select (select |#memory_int#2_9| |main_~#string_A~0.base_4|) (+ |main_~#string_A~0.offset_4| main_~i~0_32)) |main_#t~mem11_33|) (< main_~i~0_32 main_~nc_A~0_24) (< main_~j~0_32 main_~nc_B~0_29) (= (select (select |#memory_int#1_17| |main_~#string_B~0.base_4|) (+ |main_~#string_B~0.offset_4| main_~j~0_32)) |main_#t~mem12_33|)) :named ssa_33))
(assert (! (and (= main_~j~0_34 0) (not (= |main_#t~mem12_33| |main_#t~mem11_33|)) (= (+ main_~i~0_34 main_~j~0_32) (+ main_~i~0_32 1))) :named ssa_34))
(assert (! (and (= (select (select |#memory_int#2_9| |main_~#string_A~0.base_4|) (+ |main_~#string_A~0.offset_4| main_~i~0_34)) |main_#t~mem11_35|) (< main_~i~0_34 main_~nc_A~0_24) (< main_~j~0_34 main_~nc_B~0_29) (= (select (select |#memory_int#1_17| |main_~#string_B~0.base_4|) (+ |main_~#string_B~0.offset_4| main_~j~0_34)) |main_#t~mem12_35|)) :named ssa_35))
(assert (! (and (= main_~j~0_36 (+ main_~j~0_34 1)) (= |main_#t~mem12_35| |main_#t~mem11_35|) (= main_~i~0_36 (+ main_~i~0_34 1))) :named ssa_36))
(assert (! (or (<= main_~nc_B~0_29 main_~j~0_36) (<= main_~nc_A~0_24 main_~i~0_36)) :named ssa_37))
(assert (! (= main_~found~0_38 (ite (< main_~nc_B~0_29 (+ main_~j~0_36 1)) 1 0)) :named ssa_38))
(assert (! true :named ssa_39_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_39| (ite (or (= main_~found~0_38 0) (= main_~found~0_38 1)) 1 0)) :named ssa_39_LocVarAssigCall))
