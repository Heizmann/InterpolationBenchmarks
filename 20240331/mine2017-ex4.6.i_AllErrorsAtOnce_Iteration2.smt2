...
(set-info :ultimate-id mine2017-ex4.6.i_AllErrorsAtOnce_Iteration2)
...
(assert (! (= main_~x~0_4 0) :named ssa_5))
(assert (! true :named ssa_6_GlobVarAssigCall))
(assert (! (= (ite (= main_~x~0_4 0) 1 0) |__VERIFIER_assert_#in~cond_6|) :named ssa_6_LocVarAssigCall))
