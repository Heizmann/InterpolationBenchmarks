...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:18:38+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id prefixsum_iter.c_AllErrorsAtOnce_Iteration20)
...
(declare-fun is_pow2_~x_12 () Int)
(declare-fun is_pow2_~x_14 () Int)
(declare-fun |is_pow2_#res_14| () Int)
(declare-fun |main_#t~ret14_15| () Int)
(declare-fun |is_pow2_#res_15| () Int)
(declare-fun |main_#t~ret14_17| () Int)
...
(declare-fun |main_#t~ret14_22| () Int)
...
(declare-fun |main_#t~malloc15.offset_23| () Int)
(declare-fun main_~n~0_23 () Int)
(declare-fun |#Ultimate.meminit_#ptr.base_23| () Int)
(declare-fun |main_#t~malloc15.base_23| () Int)
(declare-fun |v_#Ultimate.meminit_#sizeOfFieldsInParam_43_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#productInParam_43_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#ptr.offsetInParam_43_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#amountOfFieldsInParam_43_fresh_1| () Int)
(declare-fun |#memory_int#1_24| () (Array Int (Array Int Int)))
(declare-fun v_ArrVal_455_fresh_1 () (Array Int Int))
(declare-fun |main_#t~malloc15.offset_26| () Int)
...
(declare-fun |main_#t~malloc15.base_26| () Int)
...
(declare-fun |main_#t~malloc16.offset_27| () Int)
(declare-fun main_~n~0_27 () Int)
(declare-fun |#Ultimate.meminit_#ptr.base_27| () Int)
(declare-fun |main_#t~malloc16.base_27| () Int)
(declare-fun |v_#Ultimate.meminit_#sizeOfFieldsInParam_44_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#ptr.offsetInParam_44_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#productInParam_44_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#amountOfFieldsInParam_44_fresh_1| () Int)
(declare-fun |#memory_int#1_28| () (Array Int (Array Int Int)))
(declare-fun v_ArrVal_458_fresh_1 () (Array Int Int))
(declare-fun main_~a0~0.offset_30 () Int)
(declare-fun main_~i~1_30 () Int)
(declare-fun |main_#t~malloc16.offset_30| () Int)
(declare-fun main_~a0~0.base_30 () Int)
(declare-fun |main_#t~malloc16.base_30| () Int)
...
(declare-fun upsweep_~n_40 () Int)
(declare-fun upsweep_~space~0_41 () Int)
...
(declare-fun |downsweep_#in~a.offset_44| () Int)
(declare-fun |downsweep_#in~space_44| () Int)
(declare-fun main_~a~0.base_44 () Int)
(declare-fun |downsweep_#in~n_44| () Int)
(declare-fun |downsweep_#in~a.base_44| () Int)
(declare-fun main_~n~0_44 () Int)
(declare-fun main_~a~0.offset_44 () Int)
(declare-fun main_~space~1_44 () Int)
(declare-fun downsweep_~n_45 () Int)
(declare-fun downsweep_~space_45 () Int)
(declare-fun downsweep_~a.offset_45 () Int)
(declare-fun downsweep_~a.base_45 () Int)
...
(declare-fun |check_#t~mem10_61| () Int)
(declare-fun check_~i~0_61 () Int)
(declare-fun |check_#t~mem11_61| () Int)
(declare-fun check_~sum~0_61 () Int)
(declare-fun |check_#t~post12_61| () Int)
(declare-fun |check_#t~mem10_62| () Int)
(declare-fun |__VERIFIER_assert_#in~cond_63| () Int)
(declare-fun |check_#t~mem10_63| () Int)
(declare-fun check_~sum~0_63 () Int)
...
(assert (! (and (< 1 (mod is_pow2_~x_11 4294967296)) (= (mod is_pow2_~x_11 2) 0) (= (div (mod is_pow2_~x_11 4294967296) 2) is_pow2_~x_12)) :named ssa_12))
(assert (! (or (<= (mod is_pow2_~x_12 4294967296) 1) (not (= (mod is_pow2_~x_12 2) 0))) :named ssa_13))
(assert (! (= (ite (= (mod is_pow2_~x_12 4294967296) 1) 1 0) |is_pow2_#res_14|) :named ssa_14))
(assert (! (= |is_pow2_#res_14| |main_#t~ret14_15|) :named ssa_15_return))
(assert (! (and (<= |main_#t~ret14_15| 2147483647) (<= 0 (+ |main_#t~ret14_15| 2147483648))) :named ssa_16))
(assert (! true :named ssa_17_GlobVarAssigCall))
(assert (! (= |assume_abort_if_not_#in~cond_17| |main_#t~ret14_15|) :named ssa_17_LocVarAssigCall))
...
(assert (! (and (= v_ArrVal_453_fresh_1 1) (not (= |main_#t~malloc15.base_22| 0)) (< |main_#t~malloc15.base_22| |#StackHeapBarrier_-1|) (= (store |#valid_3| |main_#t~malloc15.base_22| v_ArrVal_453_fresh_1) |#valid_22|) (= |main_#t~malloc15.offset_22| 0) (= v_ArrVal_454_fresh_1 (* (mod main_~n~0_4 1073741824) 4)) (= (store |#length_3| |main_#t~malloc15.base_22| v_ArrVal_454_fresh_1) |#length_22|) (= (select |#valid_3| |main_#t~malloc15.base_22|) 0)) :named ssa_22))
(assert (! (= |old(#memory_int#1)_23| |#memory_int#1_23|) :named ssa_23_GlobVarAssigCall))
(assert (! (and (= |#Ultimate.meminit_#ptr.base_23| |main_#t~malloc15.base_22|) (= |v_#Ultimate.meminit_#ptr.offsetInParam_43_fresh_1| |main_#t~malloc15.offset_22|) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_43_fresh_1|) (= (* main_~n~0_4 4) |v_#Ultimate.meminit_#productInParam_43_fresh_1|) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_43_fresh_1| 4)) :named ssa_23_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_23| |#memory_int#1_3|) :named ssa_23_OldVarAssigCall))
(assert (! (and (= |#memory_int#1_24| (store |#memory_int#1_23| |#Ultimate.meminit_#ptr.base_23| v_ArrVal_455_fresh_1)) (= ((as const (Array Int Int)) 0) v_ArrVal_455_fresh_1)) :named ssa_24))
(assert (! true :named ssa_25_return))
(assert (! (and (= (select |#valid_22| |main_#t~malloc16.base_26|) 0) (not (= |main_#t~malloc16.base_26| 0)) (= v_ArrVal_456_fresh_1 1) (= v_ArrVal_457_fresh_1 (* (mod main_~n~0_4 1073741824) 4)) (= |main_#t~malloc16.offset_26| 0) (= (store |#valid_22| |main_#t~malloc16.base_26| v_ArrVal_456_fresh_1) |#valid_26|) (= |#length_26| (store |#length_22| |main_#t~malloc16.base_26| v_ArrVal_457_fresh_1)) (= main_~a~0.offset_26 |main_#t~malloc15.offset_22|) (= main_~a~0.base_26 |main_#t~malloc15.base_22|) (< |main_#t~malloc16.base_26| |#StackHeapBarrier_-1|)) :named ssa_26))
(assert (! (= |old(#memory_int#1)_27| |#memory_int#1_27|) :named ssa_27_GlobVarAssigCall))
(assert (! (and (= |v_#Ultimate.meminit_#ptr.offsetInParam_44_fresh_1| |main_#t~malloc16.offset_26|) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_44_fresh_1| 4) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_44_fresh_1|) (= (* main_~n~0_4 4) |v_#Ultimate.meminit_#productInParam_44_fresh_1|) (= |#Ultimate.meminit_#ptr.base_27| |main_#t~malloc16.base_26|)) :named ssa_27_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_27| |#memory_int#1_24|) :named ssa_27_OldVarAssigCall))
(assert (! (and (= |#memory_int#1_28| (store |#memory_int#1_27| |#Ultimate.meminit_#ptr.base_27| v_ArrVal_458_fresh_1)) (= ((as const (Array Int Int)) 0) v_ArrVal_458_fresh_1)) :named ssa_28))
(assert (! true :named ssa_29_return))
(assert (! (and (= main_~i~1_30 0) (= main_~a0~0.base_30 |main_#t~malloc16.base_26|) (= main_~a0~0.offset_30 |main_#t~malloc16.offset_26|)) :named ssa_30))
(assert (! (and (< main_~i~1_30 main_~n~0_4) (= v_ArrVal_460_fresh_1 (store (select |#memory_int#1_28| main_~a0~0.base_30) (+ main_~a0~0.offset_30 (* main_~i~1_30 4)) v_ArrVal_459_fresh_1)) (= |#memory_int#1_31| (store |#memory_int#1_28| main_~a0~0.base_30 v_ArrVal_460_fresh_1)) (= v_ArrVal_459_fresh_1 (select (select |#memory_int#1_28| main_~a~0.base_26) (+ main_~a~0.offset_26 (* main_~i~1_30 4)))) (= main_~i~1_31 (+ main_~i~1_30 1))) :named ssa_31))
(assert (! (and (< main_~i~1_31 main_~n~0_4) (= v_ArrVal_462_fresh_1 (store (select |#memory_int#1_31| main_~a0~0.base_30) (+ main_~a0~0.offset_30 (* main_~i~1_31 4)) v_ArrVal_461_fresh_1)) (= |#memory_int#1_32| (store |#memory_int#1_31| main_~a0~0.base_30 v_ArrVal_462_fresh_1)) (= v_ArrVal_461_fresh_1 (select (select |#memory_int#1_31| main_~a~0.base_26) (+ main_~a~0.offset_26 (* main_~i~1_31 4)))) (= main_~i~1_32 (+ main_~i~1_31 1))) :named ssa_32))
(assert (! (<= main_~n~0_4 main_~i~1_32) :named ssa_33))
(assert (! (= |old(#memory_int#1)_34| |#memory_int#1_34|) :named ssa_34_GlobVarAssigCall))
(assert (! (and (= main_~a~0.base_26 |upsweep_#in~a.base_34|) (= |upsweep_#in~a.offset_34| main_~a~0.offset_26) (= main_~n~0_4 |upsweep_#in~n_34|)) :named ssa_34_LocVarAssigCall))
...
(assert (! (and (= |#memory_int#1_37| (store |#memory_int#1_34| upsweep_~a.base_35 v_ArrVal_463_fresh_1)) (= v_ArrVal_464_fresh_1 (+ (select (select |#memory_int#1_34| upsweep_~a.base_35) (+ (* upsweep_~left~0_36 4) upsweep_~a.offset_35)) (select (select |#memory_int#1_34| upsweep_~a.base_35) (+ (* upsweep_~left~0_36 4) upsweep_~a.offset_35 (* upsweep_~space~0_35 4))))) (= (store (select |#memory_int#1_34| upsweep_~a.base_35) (+ (* upsweep_~left~0_36 4) upsweep_~a.offset_35 (* upsweep_~space~0_35 4)) (+ (select (select |#memory_int#1_34| upsweep_~a.base_35) (+ (* upsweep_~left~0_36 4) upsweep_~a.offset_35)) (select (select |#memory_int#1_34| upsweep_~a.base_35) (+ (* upsweep_~left~0_36 4) upsweep_~a.offset_35 (* upsweep_~space~0_35 4))))) v_ArrVal_463_fresh_1) (< upsweep_~left~0_36 upsweep_~n_35) (= (+ (* 2 upsweep_~space~0_35) upsweep_~left~0_36) upsweep_~left~0_37)) :named ssa_37))
(assert (! (<= upsweep_~n_35 upsweep_~left~0_37) :named ssa_38))
(assert (! (= (* 2 upsweep_~space~0_35) upsweep_~space~0_39) :named ssa_39))
(assert (! (<= upsweep_~n_35 upsweep_~space~0_39) :named ssa_40))
(assert (! (= |upsweep_#res_41| upsweep_~space~0_39) :named ssa_41))
(assert (! (= |main_#t~ret19_42| |upsweep_#res_41|) :named ssa_42_return))
(assert (! (and (<= 0 (+ |main_#t~ret19_42| 2147483648)) (<= |main_#t~ret19_42| 2147483647) (= |main_#t~ret19_42| main_~space~1_43)) :named ssa_43))
(assert (! (= |old(#memory_int#1)_44| |#memory_int#1_44|) :named ssa_44_GlobVarAssigCall))
(assert (! (and (= |downsweep_#in~a.base_44| main_~a~0.base_26) (= main_~n~0_4 |downsweep_#in~n_44|) (= |downsweep_#in~space_44| main_~space~1_43) (= main_~a~0.offset_26 |downsweep_#in~a.offset_44|)) :named ssa_44_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_44| |#memory_int#1_37|) :named ssa_44_OldVarAssigCall))
(assert (! (and (= downsweep_~space_45 (ite (and (not (= (mod |downsweep_#in~space_44| 2) 0)) (< |downsweep_#in~space_44| 0)) (+ (div |downsweep_#in~space_44| 2) 1) (div |downsweep_#in~space_44| 2))) (= v_ArrVal_466_fresh_1 (store (select |#memory_int#1_44| downsweep_~a.base_45) (+ downsweep_~a.offset_45 (- 4) (* downsweep_~n_45 4)) v_ArrVal_465_fresh_1)) (= downsweep_~a.base_45 |downsweep_#in~a.base_44|) (= downsweep_~a.offset_45 |downsweep_#in~a.offset_44|) (= v_ArrVal_465_fresh_1 0) (= (store |#memory_int#1_44| downsweep_~a.base_45 v_ArrVal_466_fresh_1) |#memory_int#1_45|) (= downsweep_~n_45 |downsweep_#in~n_44|)) :named ssa_45))
(assert (! (and (< 0 downsweep_~space_45) (= (+ downsweep_~right~1_46 1) (* 2 downsweep_~space_45))) :named ssa_46))
(assert (! (and (= v_ArrVal_469_fresh_1 (select (select |#memory_int#1_45| downsweep_~a.base_45) (+ downsweep_~a.offset_45 (* downsweep_~right~1_46 4)))) (< downsweep_~right~1_46 downsweep_~n_45) (= (store |#memory_int#1_45| downsweep_~a.base_45 v_ArrVal_467_fresh_1) |#memory_int#1_47|) (= v_ArrVal_468_fresh_1 (+ (select (select |#memory_int#1_45| downsweep_~a.base_45) (+ downsweep_~a.offset_45 (* downsweep_~right~1_46 4))) (select (select |#memory_int#1_45| downsweep_~a.base_45) (+ downsweep_~a.offset_45 (* downsweep_~right~1_46 4) (* downsweep_~space_45 (- 4)))))) (= downsweep_~right~1_47 (+ (* 2 downsweep_~space_45) downsweep_~right~1_46)) (= v_ArrVal_467_fresh_1 (store (store (select |#memory_int#1_45| downsweep_~a.base_45) (+ downsweep_~a.offset_45 (* downsweep_~right~1_46 4)) (+ (select (select |#memory_int#1_45| downsweep_~a.base_45) (+ downsweep_~a.offset_45 (* downsweep_~right~1_46 4))) (select (select |#memory_int#1_45| downsweep_~a.base_45) (+ downsweep_~a.offset_45 (* downsweep_~right~1_46 4) (* downsweep_~space_45 (- 4)))))) (+ downsweep_~a.offset_45 (* downsweep_~right~1_46 4) (* downsweep_~space_45 (- 4))) (select (select |#memory_int#1_45| downsweep_~a.base_45) (+ downsweep_~a.offset_45 (* downsweep_~right~1_46 4)))))) :named ssa_47))
(assert (! (<= downsweep_~n_45 downsweep_~right~1_47) :named ssa_48))
(assert (! (= downsweep_~space_49 (ite (and (< downsweep_~space_45 0) (not (= (mod downsweep_~space_45 2) 0))) (+ (div downsweep_~space_45 2) 1) (div downsweep_~space_45 2))) :named ssa_49))
...
(assert (! (and (= main_~a0~0.offset_30 |check_#in~a0.offset_53|) (= main_~a0~0.base_30 |check_#in~a0.base_53|) (= |check_#in~a.offset_53| main_~a~0.offset_26) (= main_~n~0_4 |check_#in~n_53|) (= |check_#in~a.base_53| main_~a~0.base_26)) :named ssa_53_LocVarAssigCall))
...
(assert (! (not (= __VERIFIER_assert_~cond_57 0)) :named ssa_58))
(assert (! true :named ssa_59))
(assert (! true :named ssa_60_return))
(assert (! (and (= (+ check_~sum~0_54 (select (select |#memory_int#1_47| check_~a0.base_54) (+ (* check_~i~0_54 4) check_~a0.offset_54))) check_~sum~0_61) (= (+ check_~i~0_54 1) check_~i~0_61)) :named ssa_61))
(assert (! (and (= |check_#t~mem10_62| (select (select |#memory_int#1_47| check_~a.base_54) (+ (* check_~i~0_61 4) check_~a.offset_54))) (< check_~i~0_61 check_~n_54)) :named ssa_62))
(assert (! true :named ssa_63_GlobVarAssigCall))
(assert (! (= (ite (= check_~sum~0_61 |check_#t~mem10_62|) 1 0) |__VERIFIER_assert_#in~cond_63|) :named ssa_63_LocVarAssigCall))
...
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 (and ssa_5_LocVarAssigCall ssa_5_GlobVarAssigCall ssa_7 ssa_6 ssa_8 ssa_5_OldVarAssigCall ssa_9_return) (and ssa_13 ssa_10_GlobVarAssigCall ssa_14 ssa_10_OldVarAssigCall ssa_12 ssa_11 ssa_10_LocVarAssigCall ssa_15_return) ssa_16 (and ssa_20 ssa_17_LocVarAssigCall ssa_17_GlobVarAssigCall ssa_19 ssa_17_OldVarAssigCall ssa_18 ssa_21_return) ssa_22 (and ssa_25_return ssa_23_OldVarAssigCall ssa_23_LocVarAssigCall ssa_23_GlobVarAssigCall ssa_24) ssa_26 (and ssa_27_GlobVarAssigCall ssa_29_return ssa_27_OldVarAssigCall ssa_28 ssa_27_LocVarAssigCall) ssa_30 ssa_31 ssa_32 ssa_33 (and ssa_40 ssa_34_GlobVarAssigCall ssa_34_LocVarAssigCall ssa_34_OldVarAssigCall ssa_39 ssa_37 ssa_38 ssa_36 ssa_42_return ssa_35 ssa_41) ssa_43 (and ssa_44_LocVarAssigCall ssa_45 ssa_46 ssa_47 ssa_44_OldVarAssigCall ssa_44_GlobVarAssigCall ssa_50 ssa_48 ssa_51 ssa_49 ssa_52_return) (and ssa_53_GlobVarAssigCall ssa_53_LocVarAssigCall ssa_53_OldVarAssigCall) ssa_54 ssa_55 (and ssa_57 ssa_56_GlobVarAssigCall ssa_56_OldVarAssigCall ssa_56_LocVarAssigCall ssa_58 ssa_59 ssa_60_return) ssa_61 ssa_62 (and ssa_63_OldVarAssigCall ssa_63_LocVarAssigCall ssa_63_GlobVarAssigCall) ssa_64 ssa_65 (and ssa_postcond ssa_66))
...
(declare-fun is_pow2_~x_1 () Int)
(declare-fun is_pow2_~x_3 () Int)
(declare-fun |is_pow2_#res_3| () Int)
(declare-fun |main_#t~ret14_4| () Int)
(declare-fun |is_pow2_#res_4| () Int)
(assert (! true :named ssa_precond))
(assert (! (not true) :named ssa_postcond))
(assert (! (= |is_pow2_#in~x_-1| is_pow2_~x_0) :named ssa_0))
(assert (! (and (< 1 (mod is_pow2_~x_0 4294967296)) (= (mod is_pow2_~x_0 2) 0) (= (div (mod is_pow2_~x_0 4294967296) 2) is_pow2_~x_1)) :named ssa_1))
(assert (! (or (<= (mod is_pow2_~x_1 4294967296) 1) (not (= (mod is_pow2_~x_1 2) 0))) :named ssa_2))
(assert (! (= (ite (= (mod is_pow2_~x_1 4294967296) 1) 1 0) |is_pow2_#res_3|) :named ssa_3))
(assert (! (= |is_pow2_#res_3| |main_#t~ret14_4|) :named ssa_4_return))
(assert (! true :named ssa_-2_PendingContext))
...
(assert (! (not (and (or (not (= (select |#valid_-2| |main_#t~malloc15.base_-2|) 0)) (< 1073741823 main_~n~0_-2) (< main_~n~0_-2 0)) (= |main_#t~malloc15.offset_-2| 0) (= ((as const (Array Int Int)) 0) (select |#memory_int#1_0| |main_#t~malloc15.base_-2|)))) :named ssa_postcond))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_470_fresh_1) (= |#memory_int#1_0| (store |#memory_int#1_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_470_fresh_1))) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! (and (or (not (= (select |#valid_-2| |main_#t~malloc15.base_-2|) 0)) (< 1073741823 main_~n~0_-2) (< main_~n~0_-2 0)) (= |main_#t~malloc15.offset_-2| 0)) :named ssa_-2_PendingContext))
...
(assert (! (= |#memory_int#1_-1| |old(#memory_int#1)_-1|) :named ssa_precond))
(assert (! (not (and (or (not (= |main_#t~malloc16.base_-2| main_~a~0.base_-2)) (< 1073741823 main_~n~0_-2) (< main_~n~0_-2 0)) (or (and (= ((as const (Array Int Int)) 0) (select |#memory_int#1_0| main_~a~0.base_-2)) (= ((as const (Array Int Int)) 0) (select |#memory_int#1_0| |main_#t~malloc16.base_-2|)) (= main_~a~0.offset_-2 0) (= |main_#t~malloc16.offset_-2| 0)) (= |main_#t~malloc16.base_-2| main_~a~0.base_-2)))) :named ssa_postcond))
(assert (! (and (= (store |#memory_int#1_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_471_fresh_1) |#memory_int#1_0|) (= ((as const (Array Int Int)) 0) v_ArrVal_471_fresh_1)) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! (and (= ((as const (Array Int Int)) 0) (select |#memory_int#1_-2| main_~a~0.base_-2)) (or (not (= |main_#t~malloc16.base_-2| main_~a~0.base_-2)) (< 1073741823 main_~n~0_-2) (< main_~n~0_-2 0)) (= main_~a~0.offset_-2 0) (= |main_#t~malloc16.offset_-2| 0)) :named ssa_-2_PendingContext))
...
(declare-fun |old(#length)_-2| () (Array Int Int))
(declare-fun |old(#memory_int#1)_-2| () (Array Int (Array Int Int)))
(declare-fun main_~a0~0.offset_-2 () Int)
(declare-fun main_~a~0.base_-2 () Int)
(declare-fun main_~n~0_-2 () Int)
(declare-fun main_~a~0.offset_-2 () Int)
(declare-fun main_~a0~0.base_-2 () Int)
(declare-fun |old(#memory_int#1)_-1| () (Array Int (Array Int Int)))
...
(assert (! (= |#memory_int#1_-1| |old(#memory_int#1)_-1|) :named ssa_precond))
(assert (! (not (and (= (select (select |#memory_int#1_2| main_~a~0.base_-2) 0) 0) (<= main_~n~0_-2 2) (= main_~a~0.offset_-2 0) (= |main_#t~ret19_7| 2) (= (select (select |#memory_int#1_2| main_~a0~0.base_-2) 0) 0) (not (= main_~a~0.base_-2 main_~a0~0.base_-2)) (= main_~a0~0.offset_-2 0))) :named ssa_postcond))
...
(assert (! (and (= (store (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0 (* upsweep_~space~0_0 4)) (+ (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0)) (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0 (* upsweep_~space~0_0 4))))) v_ArrVal_472_fresh_1) (= v_ArrVal_473_fresh_1 (+ (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0)) (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0 (* upsweep_~space~0_0 4))))) (< upsweep_~left~0_1 upsweep_~n_0) (= (+ (* 2 upsweep_~space~0_0) upsweep_~left~0_1) upsweep_~left~0_2) (= (store |#memory_int#1_-1| upsweep_~a.base_0 v_ArrVal_472_fresh_1) |#memory_int#1_2|)) :named ssa_2))
...
(assert (! (and (= (select (select |#memory_int#1_-2| main_~a~0.base_-2) 0) 0) (= main_~n~0_-2 2) (= main_~a~0.offset_-2 0) (= (select (select |#memory_int#1_-2| main_~a0~0.base_-2) 0) 0) (not (= main_~a~0.base_-2 main_~a0~0.base_-2)) (= main_~a0~0.offset_-2 0)) :named ssa_-2_PendingContext))
...
(assert (! (= |#memory_int#1_-1| |old(#memory_int#1)_-1|) :named ssa_precond))
(assert (! (not (and (= main_~a~0.offset_-2 0) (= (select (select |#memory_int#1_2| main_~a0~0.base_-2) 0) 0) (= (select (select |#memory_int#1_2| main_~a~0.base_-2) 4) 0) (not (= main_~a~0.base_-2 main_~a0~0.base_-2)) (= main_~a0~0.offset_-2 0))) :named ssa_postcond))
(assert (! (and (= downsweep_~space_0 (ite (and (not (= (mod |downsweep_#in~space_-1| 2) 0)) (< |downsweep_#in~space_-1| 0)) (+ (div |downsweep_#in~space_-1| 2) 1) (div |downsweep_#in~space_-1| 2))) (= v_ArrVal_475_fresh_1 (store (select |#memory_int#1_-1| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (- 4) (* downsweep_~n_0 4)) v_ArrVal_474_fresh_1)) (= downsweep_~a.base_0 |downsweep_#in~a.base_-1|) (= downsweep_~a.offset_0 |downsweep_#in~a.offset_-1|) (= v_ArrVal_474_fresh_1 0) (= (store |#memory_int#1_-1| downsweep_~a.base_0 v_ArrVal_475_fresh_1) |#memory_int#1_0|) (= downsweep_~n_0 |downsweep_#in~n_-1|)) :named ssa_0))
(assert (! (and (< 0 downsweep_~space_0) (= (+ downsweep_~right~1_1 1) (* 2 downsweep_~space_0))) :named ssa_1))
(assert (! (and (= v_ArrVal_476_fresh_1 (store (store (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4)) (+ (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4))) (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4) (* downsweep_~space_0 (- 4)))))) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4) (* downsweep_~space_0 (- 4))) (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4))))) (= v_ArrVal_477_fresh_1 (+ (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4))) (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4) (* downsweep_~space_0 (- 4)))))) (< downsweep_~right~1_1 downsweep_~n_0) (= |#memory_int#1_2| (store |#memory_int#1_0| downsweep_~a.base_0 v_ArrVal_476_fresh_1)) (= downsweep_~right~1_2 (+ (* 2 downsweep_~space_0) downsweep_~right~1_1)) (= v_ArrVal_478_fresh_1 (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4))))) :named ssa_2))
...
(assert (! (and (= (select (select |#memory_int#1_-2| main_~a~0.base_-2) 0) 0) (<= main_~n~0_-2 2) (= main_~a~0.offset_-2 0) (= 2 main_~space~1_-2) (= (select (select |#memory_int#1_-2| main_~a0~0.base_-2) 0) 0) (not (= main_~a~0.base_-2 main_~a0~0.base_-2)) (= main_~a0~0.offset_-2 0)) :named ssa_-2_PendingContext))
...
(echo "starting trace check")
(push 1)
(declare-fun check_~a0.base_-2 () Int)
(declare-fun check_~a.base_-2 () Int)
(declare-fun check_~a.offset_-2 () Int)
(declare-fun check_~i~0_-2 () Int)
(declare-fun check_~sum~0_-2 () Int)
(declare-fun check_~a0.offset_-2 () Int)
(declare-fun |#memory_int#1_-1| () (Array Int (Array Int Int)))
(declare-fun |check_#t~mem10_-2| () Int)
(declare-fun |__VERIFIER_assert_#in~cond_-1| () Int)
(declare-fun |check_#t~mem10_-1| () Int)
(declare-fun check_~sum~0_-1 () Int)
(declare-fun __VERIFIER_assert_~cond_0 () Int)
(declare-fun __VERIFIER_assert_~cond_1 () Int)
(assert (! true :named ssa_precond))
(assert (! (not (and (= (select (select |#memory_int#1_-1| check_~a.base_-2) 4) 0) (= check_~a0.offset_-2 0) (= (select (select |#memory_int#1_-1| check_~a0.base_-2) 0) 0) (= check_~i~0_-2 0) (= check_~sum~0_-2 0) (= check_~a.offset_-2 0))) :named ssa_postcond))
...
(assert (! true :named ssa_2))
(assert (! true :named ssa_3_return))
(assert (! (and (= (select (select |#memory_int#1_-1| check_~a.base_-2) 4) 0) (= check_~a0.offset_-2 0) (= (select (select |#memory_int#1_-1| check_~a0.base_-2) 0) 0) (= check_~i~0_-2 0) (= check_~sum~0_-2 0) (= check_~a.offset_-2 0)) :named ssa_-2_PendingContext))
(assert (! (= (ite (= check_~sum~0_-2 |check_#t~mem10_-2|) 1 0) |__VERIFIER_assert_#in~cond_-1|) :named ssa_-2_LocVarAssignPendingContext))
(assert (! true :named ssa_-2_OldVarAssignPendingContext))
(check-sat)
(get-interpolants (and ssa_0 ssa_precond) ssa_1 ssa_2 (and ssa_-2_PendingContext ssa_3_return ssa_-2_LocVarAssignPendingContext ssa_-2_OldVarAssignPendingContext ssa_postcond))
(echo "finished trace check")
