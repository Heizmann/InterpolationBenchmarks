...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:18:07+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id linear_interpolation_2.i_AllErrorsAtOnce_Iteration1)
...
(assert (! (and (< 0 |#StackHeapBarrier_-1|) (= (select |#length_-1| 2) 25) (= (select |#valid_-1| 2) 1) (= (select |#valid_-1| 1) 1) (= (select (select |#memory_int#0_-1| 1) 1) 0) (= (select |#length_-1| 1) 2) (= (select (select |#memory_int#0_-1| 1) 0) 48) (= (select |#valid_-1| 0) 0)) :named ssa_1))
(assert (! true :named ssa_2_return))
(assert (! true :named ssa_3_GlobVarAssigCall))
(assert (! true :named ssa_3_LocVarAssigCall))
(assert (! true :named ssa_3_OldVarAssigCall))
(assert (! (and (<= 0 (+ main_~b~0_4 2147483648)) (<= main_~a~0_4 2147483647) (<= main_~b~0_4 2147483647) (<= 0 (+ main_~a~0_4 2147483648)) (<= 0 (+ main_~x~0_4 2147483648)) (<= main_~x~0_4 2147483647)) :named ssa_4))
(assert (! false :named ssa_5))
(assert (! false :named ssa_6))
(assert (! (= main_~r~0_7 (ite (<= (mod (ite (and (< (* main_~b~0_4 main_~x~0_4) (* main_~a~0_4 main_~b~0_4)) (not (= (mod (+ (* main_~b~0_4 main_~x~0_4) (* main_~a~0_4 main_~b~0_4 255)) 256) 0))) (+ (div (+ (* (- 1) main_~a~0_4 main_~b~0_4) (* main_~b~0_4 main_~x~0_4)) 256) 1) (div (+ (* (- 1) main_~a~0_4 main_~b~0_4) (* main_~b~0_4 main_~x~0_4)) 256)) 4294967296) 2147483647) (mod (ite (and (< (* main_~b~0_4 main_~x~0_4) (* main_~a~0_4 main_~b~0_4)) (not (= (mod (+ (* main_~b~0_4 main_~x~0_4) (* main_~a~0_4 main_~b~0_4 255)) 256) 0))) (+ (div (+ (* (- 1) main_~a~0_4 main_~b~0_4) (* main_~b~0_4 main_~x~0_4)) 256) 1) (div (+ (* (- 1) main_~a~0_4 main_~b~0_4) (* main_~b~0_4 main_~x~0_4)) 256)) 4294967296) (+ (mod (ite (and (< (* main_~b~0_4 main_~x~0_4) (* main_~a~0_4 main_~b~0_4)) (not (= (mod (+ (* main_~b~0_4 main_~x~0_4) (* main_~a~0_4 main_~b~0_4 255)) 256) 0))) (+ (div (+ (* (- 1) main_~a~0_4 main_~b~0_4) (* main_~b~0_4 main_~x~0_4)) 256) 1) (div (+ (* (- 1) main_~a~0_4 main_~b~0_4) (* main_~b~0_4 main_~x~0_4)) 256)) 4294967296) (- 4294967296)))) :named ssa_7))
(assert (! (<= 0 main_~b~0_4) :named ssa_8))
(assert (! true :named ssa_9_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_9| (ite (and (<= main_~r~0_7 main_~b~0_4) (<= 0 main_~r~0_7)) 1 0)) :named ssa_9_LocVarAssigCall))
