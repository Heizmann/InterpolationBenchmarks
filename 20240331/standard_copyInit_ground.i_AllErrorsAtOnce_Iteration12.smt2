...
(set-info :ultimate-id standard_copyInit_ground.i_AllErrorsAtOnce_Iteration12)
...
(assert (! (and (= v_ArrVal_226_fresh_1 1) (= v_ArrVal_228_fresh_1 1) (= main_~i~0_4 0) (< |#StackHeapBarrier_-1| |main_~#a~0.base_4|) (= |main_~#b~0.offset_4| 0) (= v_ArrVal_225_fresh_1 400000) (= (select (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_226_fresh_1) |main_~#b~0.base_4|) 0) (= v_ArrVal_227_fresh_1 400000) (not (= |main_~#a~0.base_4| 0)) (not (= |main_~#b~0.base_4| 0)) (= |#valid_4| (store (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_226_fresh_1) |main_~#b~0.base_4| v_ArrVal_228_fresh_1)) (= |main_~#a~0.offset_4| 0) (= (store (store |#length_3| |main_~#a~0.base_4| v_ArrVal_227_fresh_1) |main_~#b~0.base_4| v_ArrVal_225_fresh_1) |#length_4|) (< |#StackHeapBarrier_-1| |main_~#b~0.base_4|) (= (select |#valid_3| |main_~#a~0.base_4|) 0)) :named ssa_4))
(assert (! (and (= (store |#memory_int#2_3| |main_~#a~0.base_4| v_ArrVal_229_fresh_1) |#memory_int#2_5|) (= v_ArrVal_229_fresh_1 (store (select |#memory_int#2_3| |main_~#a~0.base_4|) (+ (* main_~i~0_4 4) |main_~#a~0.offset_4|) 42)) (< main_~i~0_4 100000) (= v_ArrVal_230_fresh_1 42) (= main_~i~0_5 (+ main_~i~0_4 1))) :named ssa_5))
(assert (! (and (= |#memory_int#2_6| (store |#memory_int#2_5| |main_~#a~0.base_4| v_ArrVal_231_fresh_1)) (= v_ArrVal_232_fresh_1 42) (< main_~i~0_5 100000) (= v_ArrVal_231_fresh_1 (store (select |#memory_int#2_5| |main_~#a~0.base_4|) (+ (* main_~i~0_5 4) |main_~#a~0.offset_4|) 42)) (= main_~i~0_6 (+ main_~i~0_5 1))) :named ssa_6))
(assert (! (and (= v_ArrVal_233_fresh_1 (store (select |#memory_int#2_6| |main_~#a~0.base_4|) (+ (* main_~i~0_6 4) |main_~#a~0.offset_4|) 42)) (< main_~i~0_6 100000) (= (store |#memory_int#2_6| |main_~#a~0.base_4| v_ArrVal_233_fresh_1) |#memory_int#2_7|) (= main_~i~0_7 (+ main_~i~0_6 1)) (= v_ArrVal_234_fresh_1 42)) :named ssa_7))
(assert (! (and (= v_ArrVal_235_fresh_1 (store (select |#memory_int#2_7| |main_~#a~0.base_4|) (+ (* main_~i~0_7 4) |main_~#a~0.offset_4|) 42)) (< main_~i~0_7 100000) (= main_~i~0_8 (+ main_~i~0_7 1)) (= (store |#memory_int#2_7| |main_~#a~0.base_4| v_ArrVal_235_fresh_1) |#memory_int#2_8|) (= v_ArrVal_236_fresh_1 42)) :named ssa_8))
(assert (! (and (= (store |#memory_int#2_8| |main_~#a~0.base_4| v_ArrVal_237_fresh_1) |#memory_int#2_9|) (= v_ArrVal_237_fresh_1 (store (select |#memory_int#2_8| |main_~#a~0.base_4|) (+ (* main_~i~0_8 4) |main_~#a~0.offset_4|) 42)) (< main_~i~0_8 100000) (= v_ArrVal_238_fresh_1 42) (= main_~i~0_9 (+ main_~i~0_8 1))) :named ssa_9))
(assert (! (and (= (store |#memory_int#2_9| |main_~#a~0.base_4| v_ArrVal_239_fresh_1) |#memory_int#2_10|) (< main_~i~0_9 100000) (= v_ArrVal_239_fresh_1 (store (select |#memory_int#2_9| |main_~#a~0.base_4|) (+ (* main_~i~0_9 4) |main_~#a~0.offset_4|) 42)) (= v_ArrVal_240_fresh_1 42) (= main_~i~0_10 (+ main_~i~0_9 1))) :named ssa_10))
(assert (! (and (< main_~i~0_10 100000) (= v_ArrVal_242_fresh_1 42) (= main_~i~0_11 (+ main_~i~0_10 1)) (= v_ArrVal_241_fresh_1 (store (select |#memory_int#2_10| |main_~#a~0.base_4|) (+ (* main_~i~0_10 4) |main_~#a~0.offset_4|) 42)) (= (store |#memory_int#2_10| |main_~#a~0.base_4| v_ArrVal_241_fresh_1) |#memory_int#2_11|)) :named ssa_11))
(assert (! (and (= v_ArrVal_244_fresh_1 42) (< main_~i~0_11 100000) (= v_ArrVal_243_fresh_1 (store (select |#memory_int#2_11| |main_~#a~0.base_4|) (+ (* main_~i~0_11 4) |main_~#a~0.offset_4|) 42)) (= main_~i~0_12 (+ main_~i~0_11 1)) (= (store |#memory_int#2_11| |main_~#a~0.base_4| v_ArrVal_243_fresh_1) |#memory_int#2_12|)) :named ssa_12))
(assert (! (and (= v_ArrVal_245_fresh_1 (store (select |#memory_int#2_12| |main_~#a~0.base_4|) (+ (* main_~i~0_12 4) |main_~#a~0.offset_4|) 42)) (< main_~i~0_12 100000) (= v_ArrVal_246_fresh_1 42) (= main_~i~0_13 (+ main_~i~0_12 1)) (= (store |#memory_int#2_12| |main_~#a~0.base_4| v_ArrVal_245_fresh_1) |#memory_int#2_13|)) :named ssa_13))
(assert (! (and (= v_ArrVal_247_fresh_1 (store (select |#memory_int#2_13| |main_~#a~0.base_4|) (+ (* main_~i~0_13 4) |main_~#a~0.offset_4|) 42)) (= (store |#memory_int#2_13| |main_~#a~0.base_4| v_ArrVal_247_fresh_1) |#memory_int#2_14|) (= v_ArrVal_248_fresh_1 42) (< main_~i~0_13 100000) (= main_~i~0_14 (+ main_~i~0_13 1))) :named ssa_14))
(assert (! (<= 100000 main_~i~0_14) :named ssa_15))
(assert (! (= main_~i~0_16 0) :named ssa_16))
(assert (! (and (= v_ArrVal_250_fresh_1 (store (select |#memory_int#1_3| |main_~#b~0.base_4|) (+ (* main_~i~0_16 4) |main_~#b~0.offset_4|) v_ArrVal_249_fresh_1)) (= |#memory_int#1_17| (store |#memory_int#1_3| |main_~#b~0.base_4| v_ArrVal_250_fresh_1)) (< main_~i~0_16 100000) (= main_~i~0_17 (+ main_~i~0_16 1)) (= v_ArrVal_249_fresh_1 (select (select |#memory_int#2_14| |main_~#a~0.base_4|) (+ (* main_~i~0_16 4) |main_~#a~0.offset_4|)))) :named ssa_17))
(assert (! (and (< main_~i~0_17 100000) (= (store |#memory_int#1_17| |main_~#b~0.base_4| v_ArrVal_252_fresh_1) |#memory_int#1_18|) (= v_ArrVal_251_fresh_1 (select (select |#memory_int#2_14| |main_~#a~0.base_4|) (+ (* main_~i~0_17 4) |main_~#a~0.offset_4|))) (= main_~i~0_18 (+ main_~i~0_17 1)) (= v_ArrVal_252_fresh_1 (store (select |#memory_int#1_17| |main_~#b~0.base_4|) (+ (* main_~i~0_17 4) |main_~#b~0.offset_4|) v_ArrVal_251_fresh_1))) :named ssa_18))
(assert (! (and (= v_ArrVal_254_fresh_1 (store (select |#memory_int#1_18| |main_~#b~0.base_4|) (+ (* main_~i~0_18 4) |main_~#b~0.offset_4|) v_ArrVal_253_fresh_1)) (= v_ArrVal_253_fresh_1 (select (select |#memory_int#2_14| |main_~#a~0.base_4|) (+ (* main_~i~0_18 4) |main_~#a~0.offset_4|))) (= (store |#memory_int#1_18| |main_~#b~0.base_4| v_ArrVal_254_fresh_1) |#memory_int#1_19|) (< main_~i~0_18 100000) (= main_~i~0_19 (+ main_~i~0_18 1))) :named ssa_19))
(assert (! (and (= (store |#memory_int#1_19| |main_~#b~0.base_4| v_ArrVal_256_fresh_1) |#memory_int#1_20|) (= v_ArrVal_256_fresh_1 (store (select |#memory_int#1_19| |main_~#b~0.base_4|) (+ (* main_~i~0_19 4) |main_~#b~0.offset_4|) v_ArrVal_255_fresh_1)) (< main_~i~0_19 100000) (= v_ArrVal_255_fresh_1 (select (select |#memory_int#2_14| |main_~#a~0.base_4|) (+ (* main_~i~0_19 4) |main_~#a~0.offset_4|))) (= main_~i~0_20 (+ main_~i~0_19 1))) :named ssa_20))
(assert (! (and (= (store |#memory_int#1_20| |main_~#b~0.base_4| v_ArrVal_258_fresh_1) |#memory_int#1_21|) (= v_ArrVal_257_fresh_1 (select (select |#memory_int#2_14| |main_~#a~0.base_4|) (+ (* main_~i~0_20 4) |main_~#a~0.offset_4|))) (< main_~i~0_20 100000) (= main_~i~0_21 (+ main_~i~0_20 1)) (= v_ArrVal_258_fresh_1 (store (select |#memory_int#1_20| |main_~#b~0.base_4|) (+ (* main_~i~0_20 4) |main_~#b~0.offset_4|) v_ArrVal_257_fresh_1))) :named ssa_21))
(assert (! (and (= |#memory_int#1_22| (store |#memory_int#1_21| |main_~#b~0.base_4| v_ArrVal_260_fresh_1)) (= v_ArrVal_259_fresh_1 (select (select |#memory_int#2_14| |main_~#a~0.base_4|) (+ (* main_~i~0_21 4) |main_~#a~0.offset_4|))) (= v_ArrVal_260_fresh_1 (store (select |#memory_int#1_21| |main_~#b~0.base_4|) (+ (* main_~i~0_21 4) |main_~#b~0.offset_4|) v_ArrVal_259_fresh_1)) (< main_~i~0_21 100000) (= main_~i~0_22 (+ main_~i~0_21 1))) :named ssa_22))
(assert (! (and (= (store |#memory_int#1_22| |main_~#b~0.base_4| v_ArrVal_262_fresh_1) |#memory_int#1_23|) (= v_ArrVal_262_fresh_1 (store (select |#memory_int#1_22| |main_~#b~0.base_4|) (+ (* main_~i~0_22 4) |main_~#b~0.offset_4|) v_ArrVal_261_fresh_1)) (< main_~i~0_22 100000) (= main_~i~0_23 (+ main_~i~0_22 1)) (= v_ArrVal_261_fresh_1 (select (select |#memory_int#2_14| |main_~#a~0.base_4|) (+ (* main_~i~0_22 4) |main_~#a~0.offset_4|)))) :named ssa_23))
(assert (! (and (= v_ArrVal_263_fresh_1 (select (select |#memory_int#2_14| |main_~#a~0.base_4|) (+ (* main_~i~0_23 4) |main_~#a~0.offset_4|))) (= |#memory_int#1_24| (store |#memory_int#1_23| |main_~#b~0.base_4| v_ArrVal_264_fresh_1)) (= v_ArrVal_264_fresh_1 (store (select |#memory_int#1_23| |main_~#b~0.base_4|) (+ (* main_~i~0_23 4) |main_~#b~0.offset_4|) v_ArrVal_263_fresh_1)) (< main_~i~0_23 100000) (= main_~i~0_24 (+ main_~i~0_23 1))) :named ssa_24))
(assert (! (and (= v_ArrVal_265_fresh_1 (select (select |#memory_int#2_14| |main_~#a~0.base_4|) (+ (* main_~i~0_24 4) |main_~#a~0.offset_4|))) (= (store |#memory_int#1_24| |main_~#b~0.base_4| v_ArrVal_266_fresh_1) |#memory_int#1_25|) (< main_~i~0_24 100000) (= v_ArrVal_266_fresh_1 (store (select |#memory_int#1_24| |main_~#b~0.base_4|) (+ (* main_~i~0_24 4) |main_~#b~0.offset_4|) v_ArrVal_265_fresh_1)) (= main_~i~0_25 (+ main_~i~0_24 1))) :named ssa_25))
(assert (! (and (= v_ArrVal_267_fresh_1 (select (select |#memory_int#2_14| |main_~#a~0.base_4|) (+ (* main_~i~0_25 4) |main_~#a~0.offset_4|))) (= v_ArrVal_268_fresh_1 (store (select |#memory_int#1_25| |main_~#b~0.base_4|) (+ (* main_~i~0_25 4) |main_~#b~0.offset_4|) v_ArrVal_267_fresh_1)) (= (store |#memory_int#1_25| |main_~#b~0.base_4| v_ArrVal_268_fresh_1) |#memory_int#1_26|) (< main_~i~0_25 100000) (= main_~i~0_26 (+ main_~i~0_25 1))) :named ssa_26))
(assert (! (<= 100000 main_~i~0_26) :named ssa_27))
(assert (! (= main_~x~0_28 0) :named ssa_28))
(assert (! (and (< main_~x~0_28 100000) (= |main_#t~mem3_29| (select (select |#memory_int#1_26| |main_~#b~0.base_4|) (+ (* main_~x~0_28 4) |main_~#b~0.offset_4|)))) :named ssa_29))
(assert (! true :named ssa_30_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_30| (ite (= |main_#t~mem3_29| 42) 1 0)) :named ssa_30_LocVarAssigCall))
