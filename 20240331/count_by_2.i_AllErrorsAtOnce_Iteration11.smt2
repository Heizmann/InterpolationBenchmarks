...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration11)
...
(assert (! (<= 1000000 main_~i~0_14) :named ssa_15))
(assert (! true :named ssa_16_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_16| (ite (= main_~i~0_14 1000000) 1 0)) :named ssa_16_LocVarAssigCall))
