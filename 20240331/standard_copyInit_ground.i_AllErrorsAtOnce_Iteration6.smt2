...
(set-info :ultimate-id standard_copyInit_ground.i_AllErrorsAtOnce_Iteration6)
...
(declare-fun |main_#t~mem1_11| () Int)
...
(assert (! (and (= 400000 v_ArrVal_45_fresh_1) (= main_~i~0_4 0) (< |#StackHeapBarrier_-1| |main_~#a~0.base_4|) (= |main_~#b~0.offset_4| 0) (= v_ArrVal_48_fresh_1 1) (= 400000 v_ArrVal_47_fresh_1) (not (= |main_~#a~0.base_4| 0)) (not (= |main_~#b~0.base_4| 0)) (= |main_~#a~0.offset_4| 0) (= |#length_4| (store (store |#length_3| |main_~#a~0.base_4| v_ArrVal_47_fresh_1) |main_~#b~0.base_4| v_ArrVal_45_fresh_1)) (= 0 (select (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_46_fresh_1) |main_~#b~0.base_4|)) (< |#StackHeapBarrier_-1| |main_~#b~0.base_4|) (= v_ArrVal_46_fresh_1 1) (= (select |#valid_3| |main_~#a~0.base_4|) 0) (= (store (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_46_fresh_1) |main_~#b~0.base_4| v_ArrVal_48_fresh_1) |#valid_4|)) :named ssa_4))
(assert (! (and (= (store |#memory_int#2_3| |main_~#a~0.base_4| v_ArrVal_49_fresh_1) |#memory_int#2_5|) (= (store (select |#memory_int#2_3| |main_~#a~0.base_4|) (+ (* main_~i~0_4 4) |main_~#a~0.offset_4|) 42) v_ArrVal_49_fresh_1) (< main_~i~0_4 100000) (= 42 v_ArrVal_50_fresh_1) (= main_~i~0_5 (+ main_~i~0_4 1))) :named ssa_5))
(assert (! (and (= (store |#memory_int#2_5| |main_~#a~0.base_4| v_ArrVal_51_fresh_1) |#memory_int#2_6|) (= 42 v_ArrVal_52_fresh_1) (< main_~i~0_5 100000) (= main_~i~0_6 (+ main_~i~0_5 1)) (= (store (select |#memory_int#2_5| |main_~#a~0.base_4|) (+ (* main_~i~0_5 4) |main_~#a~0.offset_4|) 42) v_ArrVal_51_fresh_1)) :named ssa_6))
(assert (! (and (= (store (select |#memory_int#2_6| |main_~#a~0.base_4|) (+ (* main_~i~0_6 4) |main_~#a~0.offset_4|) 42) v_ArrVal_53_fresh_1) (= 42 v_ArrVal_54_fresh_1) (< main_~i~0_6 100000) (= main_~i~0_7 (+ main_~i~0_6 1)) (= (store |#memory_int#2_6| |main_~#a~0.base_4| v_ArrVal_53_fresh_1) |#memory_int#2_7|)) :named ssa_7))
(assert (! (and (= (store (select |#memory_int#2_7| |main_~#a~0.base_4|) (+ (* main_~i~0_7 4) |main_~#a~0.offset_4|) 42) v_ArrVal_55_fresh_1) (= (store |#memory_int#2_7| |main_~#a~0.base_4| v_ArrVal_55_fresh_1) |#memory_int#2_8|) (< main_~i~0_7 100000) (= 42 v_ArrVal_56_fresh_1) (= main_~i~0_8 (+ main_~i~0_7 1))) :named ssa_8))
(assert (! (<= 100000 main_~i~0_8) :named ssa_9))
(assert (! (= main_~i~0_10 0) :named ssa_10))
(assert (! (and (= (store |#memory_int#1_3| |main_~#b~0.base_4| v_ArrVal_58_fresh_1) |#memory_int#1_11|) (< main_~i~0_10 100000) (= (select (select |#memory_int#2_8| |main_~#a~0.base_4|) (+ (* main_~i~0_10 4) |main_~#a~0.offset_4|)) v_ArrVal_57_fresh_1) (= main_~i~0_11 (+ main_~i~0_10 1)) (= (store (select |#memory_int#1_3| |main_~#b~0.base_4|) (+ (* main_~i~0_10 4) |main_~#b~0.offset_4|) v_ArrVal_57_fresh_1) v_ArrVal_58_fresh_1)) :named ssa_11))
(assert (! (and (= (store |#memory_int#1_11| |main_~#b~0.base_4| v_ArrVal_60_fresh_1) |#memory_int#1_12|) (= (select (select |#memory_int#2_8| |main_~#a~0.base_4|) (+ (* main_~i~0_11 4) |main_~#a~0.offset_4|)) v_ArrVal_59_fresh_1) (= (store (select |#memory_int#1_11| |main_~#b~0.base_4|) (+ (* main_~i~0_11 4) |main_~#b~0.offset_4|) v_ArrVal_59_fresh_1) v_ArrVal_60_fresh_1) (< main_~i~0_11 100000) (= main_~i~0_12 (+ main_~i~0_11 1))) :named ssa_12))
(assert (! (and (= (store (select |#memory_int#1_12| |main_~#b~0.base_4|) (+ (* main_~i~0_12 4) |main_~#b~0.offset_4|) v_ArrVal_61_fresh_1) v_ArrVal_62_fresh_1) (< main_~i~0_12 100000) (= (select (select |#memory_int#2_8| |main_~#a~0.base_4|) (+ (* main_~i~0_12 4) |main_~#a~0.offset_4|)) v_ArrVal_61_fresh_1) (= main_~i~0_13 (+ main_~i~0_12 1)) (= (store |#memory_int#1_12| |main_~#b~0.base_4| v_ArrVal_62_fresh_1) |#memory_int#1_13|)) :named ssa_13))
(assert (! (and (= (select (select |#memory_int#2_8| |main_~#a~0.base_4|) (+ (* main_~i~0_13 4) |main_~#a~0.offset_4|)) v_ArrVal_63_fresh_1) (= v_ArrVal_64_fresh_1 (store (select |#memory_int#1_13| |main_~#b~0.base_4|) (+ (* main_~i~0_13 4) |main_~#b~0.offset_4|) v_ArrVal_63_fresh_1)) (= (store |#memory_int#1_13| |main_~#b~0.base_4| v_ArrVal_64_fresh_1) |#memory_int#1_14|) (< main_~i~0_13 100000) (= main_~i~0_14 (+ main_~i~0_13 1))) :named ssa_14))
(assert (! (<= 100000 main_~i~0_14) :named ssa_15))
(assert (! (= main_~x~0_16 0) :named ssa_16))
(assert (! (and (< main_~x~0_16 100000) (= |main_#t~mem3_17| (select (select |#memory_int#1_14| |main_~#b~0.base_4|) (+ (* main_~x~0_16 4) |main_~#b~0.offset_4|)))) :named ssa_17))
(assert (! true :named ssa_18_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_18| (ite (= |main_#t~mem3_17| 42) 1 0)) :named ssa_18_LocVarAssigCall))
