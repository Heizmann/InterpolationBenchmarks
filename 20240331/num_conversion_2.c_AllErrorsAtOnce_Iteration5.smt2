...
(set-info :ultimate-id num_conversion_2.c_AllErrorsAtOnce_Iteration5)
...
(assert (! (<= 8 (mod main_~c~0_18 256)) :named ssa_19))
(assert (! true :named ssa_20_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_20| (ite (= (mod main_~x~0_4 256) (mod main_~y~0_4 256)) 1 0)) :named ssa_20_LocVarAssigCall))
