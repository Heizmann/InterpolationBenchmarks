...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-30T23:52:31+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id partial_mod_count_limited_5.c_AllErrorsAtOnce_Iteration1)
...
(declare-fun |c_aux_v_main_#t~post9_2| () Int)
...
(declare-fun |v_main_#t~post9_3_fresh_1| () Int)
...
(assert (! (and (= (select |#valid_-1| 1) 1) (= (select |#valid_-1| 2) 1) (= 1000 ~N~0_1) (= (select |#length_-1| 2) 30) (< 0 |#StackHeapBarrier_-1|) (= (select |#valid_-1| 3) 1) (= (select |#valid_-1| 0) 0) (= (select |#length_-1| 1) 2) (= (select |#length_-1| 3) 12) (= (select (select |#memory_int#0_-1| 1) 1) 0) (= (select (select |#memory_int#0_-1| 1) 0) 48)) :named ssa_1))
...
(assert (! (and (< |#StackHeapBarrier_-1| |main_~#a~0.base_4|) (= (* (mod ~N~0_1 1073741824) 4) v_ArrVal_2_fresh_1) (= main_~j~0_4 0) (= (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_1_fresh_1) |#valid_4|) (= v_ArrVal_1_fresh_1 1) (not (= |main_~#a~0.base_4| 0)) (= |main_~#a~0.offset_4| 0) (= (select |#valid_3| |main_~#a~0.base_4|) 0) (= main_~k~0_4 0) (<= 0 (+ main_~lim~0_4 2147483648)) (= (store |#length_3| |main_~#a~0.base_4| v_ArrVal_2_fresh_1) |#length_4|) (<= main_~lim~0_4 2147483647) (= main_~R~0_4 5)) :named ssa_4))
(assert (! true :named ssa_5_GlobVarAssigCall))
(assert (! (= |assume_abort_if_not_#in~cond_5| (ite (and (< (mod main_~lim~0_4 4294967296) (mod (div (mod ~N~0_1 4294967296) (mod main_~R~0_4 4294967296)) 4294967296)) (< 0 main_~lim~0_4)) 1 0)) :named ssa_5_LocVarAssigCall))
(exit)
