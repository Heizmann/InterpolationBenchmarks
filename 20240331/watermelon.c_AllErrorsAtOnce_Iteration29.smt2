...
(set-info :ultimate-id watermelon.c_AllErrorsAtOnce_Iteration29)
...
(declare-fun v_main_~is_divisible2~0_34_fresh_1 () Int)
(declare-fun v_main_~is_divisible1~0_34_fresh_1 () Int)
...
(assert (! (and (= ~true~0_1 v_main_~is_divisible2~0_34_fresh_1) (= ~true~0_1 v_main_~is_divisible1~0_34_fresh_1)) :named ssa_4))
...
(assert (! (= student_version_~w_23 student_version_~i~1_31) :named ssa_33))
(assert (! true :named ssa_34))
(assert (! (= student_version_~is_divisible~1_23 |student_version_#res_35|) :named ssa_35))
...
(assert (! true :named ssa_precond))
(assert (! (not (or (< (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647) main_~w~0_-2) (< main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 14)))) :named ssa_postcond))
...
(assert (! (or (< (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647) main_~w~0_-2) (< main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 14))) :named ssa_-2_PendingContext))
