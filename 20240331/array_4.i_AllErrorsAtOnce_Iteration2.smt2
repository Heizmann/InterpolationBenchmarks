...
(set-info :ultimate-id array_4.i_AllErrorsAtOnce_Iteration2)
...
(assert (! (and (= (select |#valid_3| |main_~#A~0.base_4|) 0) (not (= |main_~#A~0.base_4| 0)) (= (store |#valid_3| |main_~#A~0.base_4| v_ArrVal_5_fresh_1) |#valid_4|) (= 0 |main_~#A~0.offset_4|) (< |#StackHeapBarrier_-1| |main_~#A~0.base_4|) (= 4096 v_ArrVal_6_fresh_1) (= v_ArrVal_5_fresh_1 1) (= (store |#length_3| |main_~#A~0.base_4| v_ArrVal_6_fresh_1) |#length_4|) (= main_~i~0_4 0)) :named ssa_4))
(assert (! (<= 1023 main_~i~0_4) :named ssa_5))
(assert (! (and (= (store (select |#memory_int#1_3| |main_~#A~0.base_4|) (+ 4092 |main_~#A~0.offset_4|) 0) v_ArrVal_7_fresh_1) (= main_~i~0_6 0) (= v_ArrVal_8_fresh_1 0) (= (store |#memory_int#1_3| |main_~#A~0.base_4| v_ArrVal_7_fresh_1) |#memory_int#1_6|)) :named ssa_6))
(assert (! (= |main_#t~mem3_7| (select (select |#memory_int#1_6| |main_~#A~0.base_4|) (+ (* main_~i~0_6 4) |main_~#A~0.offset_4|))) :named ssa_7))
(assert (! (= |main_#t~mem3_7| 0) :named ssa_8))
(assert (! true :named ssa_9_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_9| (ite (<= main_~i~0_6 1024) 1 0)) :named ssa_9_LocVarAssigCall))
