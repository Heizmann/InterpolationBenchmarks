...
(set-info :ultimate-id nested_4.c_AllErrorsAtOnce_Iteration14)
...
(declare-fun |main_#t~pre5_36| () Int)
...
(declare-fun main_~b~0_47 () Int)
(declare-fun |main_#t~pre6_47| () Int)
(declare-fun |main_#t~pre7_49| () Int)
(declare-fun main_~a~0_49 () Int)
...
(declare-fun |main_#t~pre6_71| () Int)
...
(declare-fun main_~b~0_92 () Int)
(declare-fun |main_#t~pre6_92| () Int)
(declare-fun |main_#t~pre7_94| () Int)
(declare-fun main_~a~0_94 () Int)
(declare-fun main_~c~0_96 () Int)
(declare-fun main_~d~0_96 () Int)
(declare-fun main_~b~0_96 () Int)
(declare-fun main_~a~0_96 () Int)
...
(assert (! (<= 6 main_~c~0_24) :named ssa_25))
(assert (! (= (+ main_~b~0_5 1) main_~b~0_26) :named ssa_26))
(assert (! (and (< main_~b~0_26 6) (= main_~c~0_27 0)) :named ssa_27))
...
(assert (! (= main_~c~0_36 (+ main_~c~0_27 1)) :named ssa_36))
...
(assert (! (<= 6 main_~c~0_45) :named ssa_46))
(assert (! (= (+ main_~b~0_26 1) main_~b~0_47) :named ssa_47))
(assert (! (<= 6 main_~b~0_47) :named ssa_48))
(assert (! (= main_~a~0_49 (+ main_~a~0_4 1)) :named ssa_49))
(assert (! (and (= main_~b~0_50 0) (< main_~a~0_49 6)) :named ssa_50))
...
(assert (! (= main_~c~0_69 (+ main_~c~0_60 1)) :named ssa_69))
(assert (! (<= 6 main_~c~0_69) :named ssa_70))
(assert (! (= (+ main_~b~0_50 1) main_~b~0_71) :named ssa_71))
(assert (! (and (< main_~b~0_71 6) (= main_~c~0_72 0)) :named ssa_72))
