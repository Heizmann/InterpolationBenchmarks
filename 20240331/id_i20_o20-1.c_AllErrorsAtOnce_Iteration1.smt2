...
(set-info :ultimate-id id_i20_o20-1.c_AllErrorsAtOnce_Iteration1)
...
(assert (! (and (<= 0 (+ |main_#t~ret5_9| 2147483648)) (= main_~result~0_10 |main_#t~ret5_9|) (<= |main_#t~ret5_9| 2147483647)) :named ssa_10))
(assert (! (not (= main_~result~0_10 20)) :named ssa_11))
...
(assert (! (= |id_#res_1| |main_#t~ret5_3|) :named ssa_3_return))
