...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration37)
...
(assert (! (<= 1000000 main_~i~0_40) :named ssa_41))
(assert (! true :named ssa_42_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_42| (ite (= main_~i~0_40 1000000) 1 0)) :named ssa_42_LocVarAssigCall))
