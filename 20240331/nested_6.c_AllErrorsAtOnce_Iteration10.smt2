...
(set-info :ultimate-id nested_6.c_AllErrorsAtOnce_Iteration10)
...
(declare-fun |main_#t~pre8_37| () Int)
(declare-fun main_~b~0_37 () Int)
(declare-fun |main_#t~pre9_39| () Int)
(declare-fun main_~a~0_39 () Int)
(declare-fun main_~e~0_41 () Int)
(declare-fun main_~f~0_41 () Int)
(declare-fun main_~c~0_41 () Int)
(declare-fun main_~d~0_41 () Int)
(declare-fun main_~b~0_41 () Int)
...
(assert (! (<= 6 main_~c~0_35) :named ssa_36))
(assert (! (= main_~b~0_37 (+ main_~b~0_5 1)) :named ssa_37))
(assert (! (<= 6 main_~b~0_37) :named ssa_38))
(assert (! (= main_~a~0_39 (+ main_~a~0_4 1)) :named ssa_39))
(assert (! (<= 6 main_~a~0_39) :named ssa_40))
(assert (! (or (not (= main_~c~0_35 6)) (not (= main_~d~0_33 6)) (not (= main_~a~0_39 6)) (not (= main_~f~0_29 6)) (not (= main_~e~0_31 6)) (not (= main_~b~0_37 6))) :named ssa_41))
