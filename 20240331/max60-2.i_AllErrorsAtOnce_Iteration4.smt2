...
(set-info :ultimate-id max60-2.i_AllErrorsAtOnce_Iteration4)
...
(declare-fun |v_max_#t~mem2_6_fresh_1| () Int)
...
(declare-fun |max_#res_15| () Int)
(declare-fun |main_#t~ret7_16| () Int)
(declare-fun |max_#res_16| () Int)
...
(declare-fun |v_max_#t~mem2_7_fresh_1| () Int)
...
(declare-fun |v_max_#t~mem2_8_fresh_1| () Int)
...
(assert (! (and (not (= |main_~#x~0.base_4| 0)) (= 240 v_ArrVal_29_fresh_1) (= |#valid_4| (store |#valid_3| |main_~#x~0.base_4| v_ArrVal_28_fresh_1)) (= v_ArrVal_28_fresh_1 1) (= (store |#length_3| |main_~#x~0.base_4| v_ArrVal_29_fresh_1) |#length_4|) (< |#StackHeapBarrier_-1| |main_~#x~0.base_4|) (= main_~i~1_4 0) (= (select |#valid_3| |main_~#x~0.base_4|) 0) (= |main_~#x~0.offset_4| 0)) :named ssa_4))
(assert (! (and (< main_~i~1_4 60) (<= 0 (+ |v_main_#t~nondet5_11_fresh_1| 2147483648)) (= (store |#memory_int#1_3| |main_~#x~0.base_4| v_ArrVal_30_fresh_1) |#memory_int#1_5|) (= |v_main_#t~nondet5_11_fresh_1| v_ArrVal_31_fresh_1) (<= |v_main_#t~nondet5_11_fresh_1| 2147483647) (= (store (select |#memory_int#1_3| |main_~#x~0.base_4|) (+ (* main_~i~1_4 4) |main_~#x~0.offset_4|) |v_main_#t~nondet5_11_fresh_1|) v_ArrVal_30_fresh_1) (= main_~i~1_5 (+ main_~i~1_4 1))) :named ssa_5))
(assert (! (and (= |v_main_#t~nondet5_12_fresh_1| v_ArrVal_33_fresh_1) (< main_~i~1_5 60) (<= 0 (+ |v_main_#t~nondet5_12_fresh_1| 2147483648)) (= (store (select |#memory_int#1_5| |main_~#x~0.base_4|) (+ (* main_~i~1_5 4) |main_~#x~0.offset_4|) |v_main_#t~nondet5_12_fresh_1|) v_ArrVal_32_fresh_1) (<= |v_main_#t~nondet5_12_fresh_1| 2147483647) (= (store |#memory_int#1_5| |main_~#x~0.base_4| v_ArrVal_32_fresh_1) |#memory_int#1_6|) (= main_~i~1_6 (+ main_~i~1_5 1))) :named ssa_6))
...
(assert (! (and (= |max_#t~ite3_12| |v_max_#t~mem2_6_fresh_1|) (= (select (select |#memory_int#1_6| max_~x.base_10) (+ max_~x.offset_10 (* max_~i~0_10 4))) |v_max_#t~mem2_6_fresh_1|) (< max_~ret~0_10 |max_#t~mem1_11|)) :named ssa_12))
(assert (! (and (= max_~ret~0_13 |max_#t~ite3_12|) (= (+ max_~i~0_10 1) max_~i~0_13)) :named ssa_13))
(assert (! (<= 60 max_~i~0_13) :named ssa_14))
(assert (! (= |max_#res_15| (ite (<= (mod max_~ret~0_13 4294967296) 2147483647) (mod max_~ret~0_13 4294967296) (+ (mod max_~ret~0_13 4294967296) (- 4294967296)))) :named ssa_15))
(assert (! (= |main_#t~ret7_16| |max_#res_15|) :named ssa_16_return))
(assert (! (and (= |main_#t~ret7_16| main_~ret~1_17) (= v_main_~temp~0_9_fresh_1 v_ArrVal_36_fresh_1) (= (select (select |#memory_int#1_6| |main_~#x~0.base_4|) |main_~#x~0.offset_4|) v_main_~temp~0_9_fresh_1) (<= |main_#t~ret7_16| 2147483647) (= (select (select |#memory_int#1_6| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4)) v_ArrVal_35_fresh_1) (= (store (store (select |#memory_int#1_6| |main_~#x~0.base_4|) |main_~#x~0.offset_4| (select (select |#memory_int#1_6| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4))) (+ |main_~#x~0.offset_4| 4) v_main_~temp~0_9_fresh_1) v_ArrVal_34_fresh_1) (<= 0 (+ |main_#t~ret7_16| 2147483648)) (= (store |#memory_int#1_6| |main_~#x~0.base_4| v_ArrVal_34_fresh_1) |#memory_int#1_17|)) :named ssa_17))
...
(assert (! (and (= (select (select |#memory_int#1_17| max_~x.base_19) (+ max_~x.offset_19 (* max_~i~0_19 4))) |max_#t~mem1_20|) (< max_~i~0_19 60)) :named ssa_20))
(assert (! (and (< max_~ret~0_19 |max_#t~mem1_20|) (= |max_#t~ite3_21| |v_max_#t~mem2_7_fresh_1|) (= (select (select |#memory_int#1_17| max_~x.base_19) (+ max_~x.offset_19 (* max_~i~0_19 4))) |v_max_#t~mem2_7_fresh_1|)) :named ssa_21))
...
(assert (! (= |max_#res_24| |main_#t~ret10_25|) :named ssa_25_return))
(assert (! (and (<= |main_#t~ret10_25| 2147483647) (= (select (select |#memory_int#1_17| |main_~#x~0.base_4|) |main_~#x~0.offset_4|) main_~temp~0_26) (= main_~i~2_26 0) (= main_~ret2~0_26 |main_#t~ret10_25|) (<= 0 (+ |main_#t~ret10_25| 2147483648))) :named ssa_26))
(assert (! (<= 59 main_~i~2_26) :named ssa_27))
(assert (! (and (= v_ArrVal_38_fresh_1 (store (select |#memory_int#1_17| |main_~#x~0.base_4|) (+ 236 |main_~#x~0.offset_4|) v_ArrVal_37_fresh_1)) (= (store |#memory_int#1_17| |main_~#x~0.base_4| v_ArrVal_38_fresh_1) |#memory_int#1_28|) (= main_~temp~0_26 v_ArrVal_37_fresh_1)) :named ssa_28))
(assert (! true :named ssa_29_GlobVarAssigCall))
(assert (! (and (= |max_#in~x.offset_29| |main_~#x~0.offset_4|) (= |max_#in~x.base_29| |main_~#x~0.base_4|)) :named ssa_29_LocVarAssigCall))
...
(assert (! (and (= |max_#t~ite3_32| |v_max_#t~mem2_8_fresh_1|) (= (select (select |#memory_int#1_28| max_~x.base_30) (+ max_~x.offset_30 (* max_~i~0_30 4))) |v_max_#t~mem2_8_fresh_1|) (< max_~ret~0_30 |max_#t~mem1_31|)) :named ssa_32))
...
(assert (! (= |max_#res_35| |main_#t~ret14_36|) :named ssa_36_return))
...
(declare-fun |v_max_#t~mem2_9_fresh_1| () Int)
...
(declare-fun max_~i~0_4 () Int)
(declare-fun max_~ret~0_5 () Int)
(declare-fun |max_#res_5| () Int)
(declare-fun |main_#t~ret7_6| () Int)
(declare-fun |max_#res_6| () Int)
(assert (! true :named ssa_precond))
(assert (! (not false) :named ssa_postcond))
...
(assert (! (and (= (select (select |#memory_int#1_-2| max_~x.base_0) (+ max_~x.offset_0 (* max_~i~0_0 4))) |v_max_#t~mem2_9_fresh_1|) (< max_~ret~0_0 |max_#t~mem1_1|) (= |max_#t~ite3_2| |v_max_#t~mem2_9_fresh_1|)) :named ssa_2))
(assert (! (and (= max_~ret~0_3 |max_#t~ite3_2|) (= (+ max_~i~0_0 1) max_~i~0_3)) :named ssa_3))
(assert (! (<= 60 max_~i~0_3) :named ssa_4))
(assert (! (= |max_#res_5| (ite (<= (mod max_~ret~0_3 4294967296) 2147483647) (mod max_~ret~0_3 4294967296) (+ (mod max_~ret~0_3 4294967296) (- 4294967296)))) :named ssa_5))
(assert (! (= |main_#t~ret7_6| |max_#res_5|) :named ssa_6_return))
(assert (! true :named ssa_-2_PendingContext))
...
(declare-fun |max_#t~ite3_2| () Int)
(declare-fun |max_#t~mem1_2| () Int)
(declare-fun |v_max_#t~mem2_10_fresh_1| () Int)
(declare-fun max_~ret~0_3 () Int)
(declare-fun |max_#t~mem2_3| () Int)
(declare-fun |max_#t~ite3_3| () Int)
(declare-fun |max_#t~post4_3| () Int)
...
(assert (! (and (= |max_#in~x.base_-1| max_~x.base_0) (= max_~i~0_0 0) (= max_~ret~0_0 0) (= max_~x.offset_0 |max_#in~x.offset_-1|)) :named ssa_0))
(assert (! (and (= (select (select |#memory_int#1_-2| max_~x.base_0) (+ max_~x.offset_0 (* max_~i~0_0 4))) |max_#t~mem1_1|) (< max_~i~0_0 60)) :named ssa_1))
(assert (! (and (= |v_max_#t~mem2_10_fresh_1| |max_#t~ite3_2|) (< max_~ret~0_0 |max_#t~mem1_1|) (= |v_max_#t~mem2_10_fresh_1| (select (select |#memory_int#1_-2| max_~x.base_0) (+ max_~x.offset_0 (* max_~i~0_0 4))))) :named ssa_2))
(assert (! (and (= max_~ret~0_3 |max_#t~ite3_2|) (= (+ max_~i~0_0 1) max_~i~0_3)) :named ssa_3))
(assert (! (<= 60 max_~i~0_3) :named ssa_4))
(assert (! (= |max_#res_5| (ite (<= (mod max_~ret~0_3 4294967296) 2147483647) (mod max_~ret~0_3 4294967296) (+ (mod max_~ret~0_3 4294967296) (- 4294967296)))) :named ssa_5))
(assert (! (= |max_#res_5| |main_#t~ret10_6|) :named ssa_6_return))
...
(declare-fun |max_#t~ite3_2| () Int)
(declare-fun |max_#t~mem1_2| () Int)
(declare-fun |v_max_#t~mem2_11_fresh_1| () Int)
(declare-fun max_~ret~0_3 () Int)
(declare-fun |max_#t~mem2_3| () Int)
(declare-fun |max_#t~ite3_3| () Int)
(declare-fun |max_#t~post4_3| () Int)
...
(assert (! (and (= |max_#in~x.base_-1| max_~x.base_0) (= max_~i~0_0 0) (= max_~ret~0_0 0) (= max_~x.offset_0 |max_#in~x.offset_-1|)) :named ssa_0))
(assert (! (and (= (select (select |#memory_int#1_-2| max_~x.base_0) (+ max_~x.offset_0 (* max_~i~0_0 4))) |max_#t~mem1_1|) (< max_~i~0_0 60)) :named ssa_1))
(assert (! (and (= |v_max_#t~mem2_11_fresh_1| |max_#t~ite3_2|) (< max_~ret~0_0 |max_#t~mem1_1|) (= |v_max_#t~mem2_11_fresh_1| (select (select |#memory_int#1_-2| max_~x.base_0) (+ max_~x.offset_0 (* max_~i~0_0 4))))) :named ssa_2))
(assert (! (and (= max_~ret~0_3 |max_#t~ite3_2|) (= (+ max_~i~0_0 1) max_~i~0_3)) :named ssa_3))
(assert (! (<= 60 max_~i~0_3) :named ssa_4))
(assert (! (= |max_#res_5| (ite (<= (mod max_~ret~0_3 4294967296) 2147483647) (mod max_~ret~0_3 4294967296) (+ (mod max_~ret~0_3 4294967296) (- 4294967296)))) :named ssa_5))
(assert (! (= |max_#res_5| |main_#t~ret14_6|) :named ssa_6_return))
(assert (! false :named ssa_-2_PendingContext))
