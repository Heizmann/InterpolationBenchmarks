...
(set-info :ultimate-id array_ptr_single_elem_init-1.i_AllErrorsAtOnce_Iteration4)
...
(declare-fun |v_main_#t~malloc6.base_7_fresh_1| () Int)
...
(declare-fun |v_main_#t~mem8_8_fresh_1| () Int)
...
(assert (! (and (< 0 |#StackHeapBarrier_-1|) (= (select |#valid_-1| 0) 0) (= (store |#memory_$Pointer$#1.base_0| |~#a~0.base_1| v_ArrVal_51_fresh_1) |#memory_$Pointer$#1.base_1|) (= 31 (select |#length_-1| 2)) (= (select |#valid_-1| 2) 1) (= |~#a~0.base_1| 3) (= ((as const (Array Int Int)) 0) v_ArrVal_51_fresh_1) (= (select |#valid_-1| 3) 1) (= |~#a~0.offset_1| 0) (= (select |#valid_-1| 1) 1) (= |#memory_$Pointer$#1.offset_1| (store |#memory_$Pointer$#1.offset_0| |~#a~0.base_1| v_ArrVal_52_fresh_1)) (= ((as const (Array Int Int)) 0) v_ArrVal_52_fresh_1) (= (select (select |#memory_int#0_-1| 1) 1) 0) (= 2 (select |#length_-1| 1)) (= (select |#length_-1| 3) 400000) (= (select (select |#memory_int#0_-1| 1) 0) 48)) :named ssa_1))
...
(assert (! (and (= main_~s~0.offset_5 v_ArrVal_55_fresh_1) (= (store (select |#memory_$Pointer$#1.base_3| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4)) main_~s~0.base_5) v_ArrVal_56_fresh_1) (= main_~i~0_8 (+ main_~i~0_4 1)) (= (store (select |#memory_$Pointer$#1.offset_3| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4)) v_ArrVal_55_fresh_1) v_ArrVal_58_fresh_1) (= main_~s~0.base_5 v_ArrVal_57_fresh_1) (= (store |#memory_$Pointer$#1.base_3| |~#a~0.base_1| v_ArrVal_56_fresh_1) |#memory_$Pointer$#1.base_8|) (= (select (select |#memory_int#1_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4))) v_ArrVal_54_fresh_1) (= (store |#memory_int#1_3| |~#a~0.base_1| v_ArrVal_53_fresh_1) |#memory_int#1_8|) (= (store (select |#memory_int#1_3| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4)) (select (select |#memory_int#1_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4)))) v_ArrVal_53_fresh_1) (= |#memory_$Pointer$#1.offset_8| (store |#memory_$Pointer$#1.offset_3| |~#a~0.base_1| v_ArrVal_58_fresh_1))) :named ssa_8))
(assert (! (<= 100000 main_~i~0_8) :named ssa_9))
(assert (! (and (= v_ArrVal_61_fresh_1 1) (= (store (select |#memory_$Pointer$#1.offset_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12) 0) v_ArrVal_60_fresh_1) (= (store |#memory_int#1_8| |~#a~0.base_1| v_ArrVal_64_fresh_1) |#memory_int#1_10|) (= 8 v_ArrVal_59_fresh_1) (= (store (select |#memory_int#1_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12) (select (select |#memory_int#1_10| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12))) v_ArrVal_64_fresh_1) (= (store |#length_3| |v_main_#t~malloc6.base_7_fresh_1| v_ArrVal_59_fresh_1) |#length_10|) (= (select |#valid_3| |v_main_#t~malloc6.base_7_fresh_1|) 0) (= |#memory_$Pointer$#1.base_10| (store |#memory_$Pointer$#1.base_8| |~#a~0.base_1| v_ArrVal_65_fresh_1)) (= |#valid_10| (store |#valid_3| |v_main_#t~malloc6.base_7_fresh_1| v_ArrVal_61_fresh_1)) (= (select (select |#memory_int#1_10| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12)) v_ArrVal_66_fresh_1) (< |v_main_#t~malloc6.base_7_fresh_1| |#StackHeapBarrier_-1|) (= v_ArrVal_62_fresh_1 |v_main_#t~malloc6.base_7_fresh_1|) (= main_~i~0_10 0) (= v_ArrVal_63_fresh_1 0) (= (store (select |#memory_$Pointer$#1.base_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12) v_ArrVal_62_fresh_1) v_ArrVal_65_fresh_1) (not (= 0 |v_main_#t~malloc6.base_7_fresh_1|)) (= (store |#memory_$Pointer$#1.offset_8| |~#a~0.base_1| v_ArrVal_60_fresh_1) |#memory_$Pointer$#1.offset_10|)) :named ssa_10))
...
(assert (! (and |main_#t~short9_11| (= (select (select |#memory_int#2_3| main_~s1~0.base_11) (+ main_~s1~0.offset_11 4)) |v_main_#t~mem8_8_fresh_1|) (or (and (not (= |v_main_#t~mem8_8_fresh_1| 0)) (not |main_#t~short9_12|)) (and |main_#t~short9_12| (= |v_main_#t~mem8_8_fresh_1| 0)))) :named ssa_12))
(assert (! (and |main_#t~short9_12| (= |main_#t~mem10.offset_13| (select (select |#memory_$Pointer$#2.offset_3| main_~s1~0.base_11) main_~s1~0.offset_11)) (= (select (select |#memory_$Pointer$#2.base_3| main_~s1~0.base_11) main_~s1~0.offset_11) |main_#t~mem10.base_13|)) :named ssa_13))
...
(assert (! (and (= (store |#memory_$Pointer$#1.base_-1| |~#a~0.base_0| v_ArrVal_67_fresh_1) |#memory_$Pointer$#1.base_0|) (< 0 |#StackHeapBarrier_-1|) (= (select |#valid_-2| 0) 0) (= 31 (select |#length_-2| 2)) (= (select |#valid_-2| 2) 1) (= |~#a~0.base_0| 3) (= ((as const (Array Int Int)) 0) v_ArrVal_68_fresh_1) (= (select |#valid_-2| 3) 1) (= |#memory_$Pointer$#1.offset_0| (store |#memory_$Pointer$#1.offset_-1| |~#a~0.base_0| v_ArrVal_68_fresh_1)) (= |~#a~0.offset_0| 0) (= (select |#valid_-2| 1) 1) (= (select (select |#memory_int#0_-2| 1) 1) 0) (= 2 (select |#length_-2| 1)) (= (select |#length_-2| 3) 400000) (= ((as const (Array Int Int)) 0) v_ArrVal_67_fresh_1) (= (select (select |#memory_int#0_-2| 1) 0) 48)) :named ssa_0))
