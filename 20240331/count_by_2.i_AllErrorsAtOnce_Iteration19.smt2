...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration19)
...
(assert (! (<= 1000000 main_~i~0_22) :named ssa_23))
(assert (! true :named ssa_24_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_24| (ite (= main_~i~0_22 1000000) 1 0)) :named ssa_24_LocVarAssigCall))
