...
(set-info :ultimate-id prefixsum_iter.c_AllErrorsAtOnce_Iteration15)
...
(declare-fun |v_#Ultimate.meminit_#sizeOfFieldsInParam_33_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#productInParam_33_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#ptr.offsetInParam_33_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#amountOfFieldsInParam_33_fresh_1| () Int)
...
(declare-fun |v_#Ultimate.meminit_#sizeOfFieldsInParam_34_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#ptr.offsetInParam_34_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#productInParam_34_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#amountOfFieldsInParam_34_fresh_1| () Int)
...
(assert (! (and (not (= |main_#t~malloc15.base_21| 0)) (< |main_#t~malloc15.base_21| |#StackHeapBarrier_-1|) (= |main_#t~malloc15.offset_21| 0) (= v_ArrVal_296_fresh_1 (* (mod main_~n~0_4 1073741824) 4)) (= (store |#length_3| |main_#t~malloc15.base_21| v_ArrVal_296_fresh_1) |#length_21|) (= v_ArrVal_295_fresh_1 1) (= (store |#valid_3| |main_#t~malloc15.base_21| v_ArrVal_295_fresh_1) |#valid_21|) (= (select |#valid_3| |main_#t~malloc15.base_21|) 0)) :named ssa_21))
(assert (! (= |old(#memory_int#1)_22| |#memory_int#1_22|) :named ssa_22_GlobVarAssigCall))
(assert (! (and (= |#Ultimate.meminit_#ptr.base_22| |main_#t~malloc15.base_21|) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_33_fresh_1| 4) (= |v_#Ultimate.meminit_#ptr.offsetInParam_33_fresh_1| |main_#t~malloc15.offset_21|) (= (* main_~n~0_4 4) |v_#Ultimate.meminit_#productInParam_33_fresh_1|) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_33_fresh_1|)) :named ssa_22_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_22| |#memory_int#1_3|) :named ssa_22_OldVarAssigCall))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_297_fresh_1) (= (store |#memory_int#1_22| |#Ultimate.meminit_#ptr.base_22| v_ArrVal_297_fresh_1) |#memory_int#1_23|)) :named ssa_23))
(assert (! true :named ssa_24_return))
(assert (! (and (= (select |#valid_21| |main_#t~malloc16.base_25|) 0) (not (= |main_#t~malloc16.base_25| 0)) (= |#length_25| (store |#length_21| |main_#t~malloc16.base_25| v_ArrVal_299_fresh_1)) (= v_ArrVal_299_fresh_1 (* (mod main_~n~0_4 1073741824) 4)) (= |#valid_25| (store |#valid_21| |main_#t~malloc16.base_25| v_ArrVal_298_fresh_1)) (= v_ArrVal_298_fresh_1 1) (= |main_#t~malloc16.offset_25| 0) (= main_~a~0.offset_25 |main_#t~malloc15.offset_21|) (= main_~a~0.base_25 |main_#t~malloc15.base_21|) (< |main_#t~malloc16.base_25| |#StackHeapBarrier_-1|)) :named ssa_25))
(assert (! (= |old(#memory_int#1)_26| |#memory_int#1_26|) :named ssa_26_GlobVarAssigCall))
(assert (! (and (= (* main_~n~0_4 4) |v_#Ultimate.meminit_#productInParam_34_fresh_1|) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_34_fresh_1|) (= |v_#Ultimate.meminit_#ptr.offsetInParam_34_fresh_1| |main_#t~malloc16.offset_25|) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_34_fresh_1| 4) (= |#Ultimate.meminit_#ptr.base_26| |main_#t~malloc16.base_25|)) :named ssa_26_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_26| |#memory_int#1_23|) :named ssa_26_OldVarAssigCall))
(assert (! (and (= |#memory_int#1_27| (store |#memory_int#1_26| |#Ultimate.meminit_#ptr.base_26| v_ArrVal_300_fresh_1)) (= ((as const (Array Int Int)) 0) v_ArrVal_300_fresh_1)) :named ssa_27))
...
(assert (! (and (< main_~i~1_29 main_~n~0_4) (= v_ArrVal_302_fresh_1 (store (select |#memory_int#1_27| main_~a0~0.base_29) (+ main_~a0~0.offset_29 (* main_~i~1_29 4)) v_ArrVal_301_fresh_1)) (= (store |#memory_int#1_27| main_~a0~0.base_29 v_ArrVal_302_fresh_1) |#memory_int#1_30|) (= v_ArrVal_301_fresh_1 (select (select |#memory_int#1_27| main_~a~0.base_25) (+ main_~a~0.offset_25 (* main_~i~1_29 4)))) (= main_~i~1_30 (+ main_~i~1_29 1))) :named ssa_30))
(assert (! (and (< main_~i~1_30 main_~n~0_4) (= |#memory_int#1_31| (store |#memory_int#1_30| main_~a0~0.base_29 v_ArrVal_304_fresh_1)) (= main_~i~1_31 (+ main_~i~1_30 1)) (= v_ArrVal_303_fresh_1 (select (select |#memory_int#1_30| main_~a~0.base_25) (+ main_~a~0.offset_25 (* main_~i~1_30 4)))) (= v_ArrVal_304_fresh_1 (store (select |#memory_int#1_30| main_~a0~0.base_29) (+ main_~a0~0.offset_29 (* main_~i~1_30 4)) v_ArrVal_303_fresh_1))) :named ssa_31))
...
(assert (! (and (= v_ArrVal_306_fresh_1 (+ (select (select |#memory_int#1_33| upsweep_~a.base_34) (+ (* upsweep_~left~0_35 4) upsweep_~a.offset_34)) (select (select |#memory_int#1_33| upsweep_~a.base_34) (+ (* upsweep_~left~0_35 4) upsweep_~a.offset_34 (* upsweep_~space~0_34 4))))) (= (store |#memory_int#1_33| upsweep_~a.base_34 v_ArrVal_305_fresh_1) |#memory_int#1_36|) (< upsweep_~left~0_35 upsweep_~n_34) (= (store (select |#memory_int#1_33| upsweep_~a.base_34) (+ (* upsweep_~left~0_35 4) upsweep_~a.offset_34 (* upsweep_~space~0_34 4)) (+ (select (select |#memory_int#1_33| upsweep_~a.base_34) (+ (* upsweep_~left~0_35 4) upsweep_~a.offset_34)) (select (select |#memory_int#1_33| upsweep_~a.base_34) (+ (* upsweep_~left~0_35 4) upsweep_~a.offset_34 (* upsweep_~space~0_34 4))))) v_ArrVal_305_fresh_1) (= (+ (* 2 upsweep_~space~0_34) upsweep_~left~0_35) upsweep_~left~0_36)) :named ssa_36))
...
(assert (! (and (= downsweep_~space_44 (ite (and (not (= (mod |downsweep_#in~space_43| 2) 0)) (< |downsweep_#in~space_43| 0)) (+ (div |downsweep_#in~space_43| 2) 1) (div |downsweep_#in~space_43| 2))) (= downsweep_~a.base_44 |downsweep_#in~a.base_43|) (= downsweep_~a.offset_44 |downsweep_#in~a.offset_43|) (= v_ArrVal_308_fresh_1 (store (select |#memory_int#1_43| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (- 4) (* downsweep_~n_44 4)) v_ArrVal_307_fresh_1)) (= (store |#memory_int#1_43| downsweep_~a.base_44 v_ArrVal_308_fresh_1) |#memory_int#1_44|) (= downsweep_~n_44 |downsweep_#in~n_43|) (= v_ArrVal_307_fresh_1 0)) :named ssa_44))
(assert (! (and (< 0 downsweep_~space_44) (= (+ downsweep_~right~1_45 1) (* 2 downsweep_~space_44))) :named ssa_45))
(assert (! (and (= v_ArrVal_309_fresh_1 (store (store (select |#memory_int#1_44| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (* downsweep_~right~1_45 4)) (+ (select (select |#memory_int#1_44| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (* downsweep_~right~1_45 4))) (select (select |#memory_int#1_44| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (* downsweep_~right~1_45 4) (* downsweep_~space_44 (- 4)))))) (+ downsweep_~a.offset_44 (* downsweep_~right~1_45 4) (* downsweep_~space_44 (- 4))) (select (select |#memory_int#1_44| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (* downsweep_~right~1_45 4))))) (= v_ArrVal_310_fresh_1 (+ (select (select |#memory_int#1_44| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (* downsweep_~right~1_45 4))) (select (select |#memory_int#1_44| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (* downsweep_~right~1_45 4) (* downsweep_~space_44 (- 4)))))) (= v_ArrVal_311_fresh_1 (select (select |#memory_int#1_44| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (* downsweep_~right~1_45 4)))) (< downsweep_~right~1_45 downsweep_~n_44) (= |#memory_int#1_46| (store |#memory_int#1_44| downsweep_~a.base_44 v_ArrVal_309_fresh_1)) (= downsweep_~right~1_46 (+ (* 2 downsweep_~space_44) downsweep_~right~1_45))) :named ssa_46))
...
(assert (! (and (= (store |#memory_int#1_46| downsweep_~a.base_44 v_ArrVal_312_fresh_1) |#memory_int#1_50|) (< downsweep_~right~1_49 downsweep_~n_44) (= v_ArrVal_313_fresh_1 (+ (select (select |#memory_int#1_46| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (* downsweep_~right~1_49 4))) (select (select |#memory_int#1_46| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (* downsweep_~right~1_49 4) (* downsweep_~space_48 (- 4)))))) (= v_ArrVal_312_fresh_1 (store (store (select |#memory_int#1_46| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (* downsweep_~right~1_49 4)) (+ (select (select |#memory_int#1_46| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (* downsweep_~right~1_49 4))) (select (select |#memory_int#1_46| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (* downsweep_~right~1_49 4) (* downsweep_~space_48 (- 4)))))) (+ downsweep_~a.offset_44 (* downsweep_~right~1_49 4) (* downsweep_~space_48 (- 4))) (select (select |#memory_int#1_46| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (* downsweep_~right~1_49 4))))) (= downsweep_~right~1_50 (+ (* 2 downsweep_~space_48) downsweep_~right~1_49)) (= v_ArrVal_314_fresh_1 (select (select |#memory_int#1_46| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (* downsweep_~right~1_49 4))))) :named ssa_50))
(assert (! (<= downsweep_~n_44 downsweep_~right~1_50) :named ssa_51))
...
(assert (! (not true) :named ssa_postcond))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_315_fresh_1) (= |#memory_int#1_0| (store |#memory_int#1_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_315_fresh_1))) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! true :named ssa_-2_PendingContext))
...
(assert (! (= |#memory_int#1_-1| |old(#memory_int#1)_-1|) :named ssa_precond))
(assert (! (not true) :named ssa_postcond))
(assert (! (and (= |#memory_int#1_0| (store |#memory_int#1_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_316_fresh_1)) (= ((as const (Array Int Int)) 0) v_ArrVal_316_fresh_1)) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! true :named ssa_-2_PendingContext))
...
(assert (! (and (< upsweep_~left~0_1 upsweep_~n_0) (= v_ArrVal_318_fresh_1 (+ (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0)) (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0 (* upsweep_~space~0_0 4))))) (= (store (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0 (* upsweep_~space~0_0 4)) (+ (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0)) (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0 (* upsweep_~space~0_0 4))))) v_ArrVal_317_fresh_1) (= (+ (* 2 upsweep_~space~0_0) upsweep_~left~0_1) upsweep_~left~0_2) (= |#memory_int#1_2| (store |#memory_int#1_-1| upsweep_~a.base_0 v_ArrVal_317_fresh_1))) :named ssa_2))
...
(declare-fun downsweep_~right~1_6 () Int)
(declare-fun |downsweep_#t~mem8_6| () Int)
(declare-fun |downsweep_#t~mem9_6| () Int)
(declare-fun |#memory_int#1_6| () (Array Int (Array Int Int)))
(declare-fun downsweep_~temp~0_6 () Int)
(declare-fun downsweep_~left~1_6 () Int)
(declare-fun |downsweep_#t~mem7_6| () Int)
(declare-fun v_ArrVal_324_fresh_1 () (Array Int Int))
(declare-fun v_ArrVal_326_fresh_1 () Int)
(declare-fun v_ArrVal_325_fresh_1 () Int)
(declare-fun downsweep_~right~1_7 () Int)
(declare-fun downsweep_~right~1_8 () Int)
(declare-fun downsweep_~space_8 () Int)
(declare-fun downsweep_~space_9 () Int)
(assert (! (= |#memory_int#1_-1| |old(#memory_int#1)_-1|) :named ssa_precond))
(assert (! (not false) :named ssa_postcond))
(assert (! (and (= downsweep_~space_0 (ite (and (not (= (mod |downsweep_#in~space_-1| 2) 0)) (< |downsweep_#in~space_-1| 0)) (+ (div |downsweep_#in~space_-1| 2) 1) (div |downsweep_#in~space_-1| 2))) (= downsweep_~a.base_0 |downsweep_#in~a.base_-1|) (= downsweep_~a.offset_0 |downsweep_#in~a.offset_-1|) (= (store |#memory_int#1_-1| downsweep_~a.base_0 v_ArrVal_320_fresh_1) |#memory_int#1_0|) (= v_ArrVal_319_fresh_1 0) (= downsweep_~n_0 |downsweep_#in~n_-1|) (= v_ArrVal_320_fresh_1 (store (select |#memory_int#1_-1| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (- 4) (* downsweep_~n_0 4)) v_ArrVal_319_fresh_1))) :named ssa_0))
(assert (! (and (< 0 downsweep_~space_0) (= (+ downsweep_~right~1_1 1) (* 2 downsweep_~space_0))) :named ssa_1))
(assert (! (and (= (store |#memory_int#1_0| downsweep_~a.base_0 v_ArrVal_321_fresh_1) |#memory_int#1_2|) (< downsweep_~right~1_1 downsweep_~n_0) (= v_ArrVal_323_fresh_1 (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4)))) (= v_ArrVal_322_fresh_1 (+ (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4))) (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4) (* downsweep_~space_0 (- 4)))))) (= downsweep_~right~1_2 (+ (* 2 downsweep_~space_0) downsweep_~right~1_1)) (= v_ArrVal_321_fresh_1 (store (store (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4)) (+ (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4))) (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4) (* downsweep_~space_0 (- 4)))))) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4) (* downsweep_~space_0 (- 4))) (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4)))))) :named ssa_2))
...
(assert (! (and (< 0 downsweep_~space_4) (= (+ downsweep_~right~1_5 1) (* 2 downsweep_~space_4))) :named ssa_5))
(assert (! (and (= v_ArrVal_325_fresh_1 (+ (select (select |#memory_int#1_2| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_5 4))) (select (select |#memory_int#1_2| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_5 4) (* downsweep_~space_4 (- 4)))))) (< downsweep_~right~1_5 downsweep_~n_0) (= v_ArrVal_324_fresh_1 (store (store (select |#memory_int#1_2| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_5 4)) (+ (select (select |#memory_int#1_2| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_5 4))) (select (select |#memory_int#1_2| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_5 4) (* downsweep_~space_4 (- 4)))))) (+ downsweep_~a.offset_0 (* downsweep_~right~1_5 4) (* downsweep_~space_4 (- 4))) (select (select |#memory_int#1_2| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_5 4))))) (= downsweep_~right~1_6 (+ (* 2 downsweep_~space_4) downsweep_~right~1_5)) (= (store |#memory_int#1_2| downsweep_~a.base_0 v_ArrVal_324_fresh_1) |#memory_int#1_6|) (= v_ArrVal_326_fresh_1 (select (select |#memory_int#1_2| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_5 4))))) :named ssa_6))
(assert (! (<= downsweep_~n_0 downsweep_~right~1_6) :named ssa_7))
(assert (! (= downsweep_~space_8 (ite (and (< downsweep_~space_4 0) (not (= (mod downsweep_~space_4 2) 0))) (+ (div downsweep_~space_4 2) 1) (div downsweep_~space_4 2))) :named ssa_8))
(assert (! (<= downsweep_~space_8 0) :named ssa_9))
