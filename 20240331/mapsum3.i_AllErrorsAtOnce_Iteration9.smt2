...
(set-info :ultimate-id mapsum3.i_AllErrorsAtOnce_Iteration9)
...
(assert (! (and (< |#StackHeapBarrier_-1| |main_~#x~0.base_4|) (= v_ArrVal_86_fresh_1 40000) (= |#valid_4| (store |#valid_3| |main_~#x~0.base_4| v_ArrVal_85_fresh_1)) (not (= |main_~#x~0.base_4| 0)) (= (store |#length_3| |main_~#x~0.base_4| v_ArrVal_86_fresh_1) |#length_4|) (= (select |#valid_3| |main_~#x~0.base_4|) 0) (= |main_~#x~0.offset_4| 0) (= v_ArrVal_85_fresh_1 1) (= main_~i~1_4 0)) :named ssa_4))
(assert (! (and (< main_~i~1_4 10000) (<= |v_main_#t~nondet3_19_fresh_1| 2147483647) (= |v_main_#t~nondet3_19_fresh_1| v_ArrVal_87_fresh_1) (= |#memory_int#1_5| (store |#memory_int#1_3| |main_~#x~0.base_4| v_ArrVal_88_fresh_1)) (= (store (select |#memory_int#1_3| |main_~#x~0.base_4|) (+ (* main_~i~1_4 4) |main_~#x~0.offset_4|) v_ArrVal_87_fresh_1) v_ArrVal_88_fresh_1) (<= 0 (+ |v_main_#t~nondet3_19_fresh_1| 2147483648)) (= main_~i~1_5 (+ main_~i~1_4 1))) :named ssa_5))
(assert (! (and (< main_~i~1_5 10000) (<= 0 (+ |v_main_#t~nondet3_20_fresh_1| 2147483648)) (<= |v_main_#t~nondet3_20_fresh_1| 2147483647) (= |#memory_int#1_6| (store |#memory_int#1_5| |main_~#x~0.base_4| v_ArrVal_89_fresh_1)) (= (store (select |#memory_int#1_5| |main_~#x~0.base_4|) (+ (* main_~i~1_5 4) |main_~#x~0.offset_4|) |v_main_#t~nondet3_20_fresh_1|) v_ArrVal_89_fresh_1) (= |v_main_#t~nondet3_20_fresh_1| v_ArrVal_90_fresh_1) (= main_~i~1_6 (+ main_~i~1_5 1))) :named ssa_6))
(assert (! (and (< main_~i~1_6 10000) (<= 0 (+ |v_main_#t~nondet3_21_fresh_1| 2147483648)) (= |v_main_#t~nondet3_21_fresh_1| v_ArrVal_91_fresh_1) (= |#memory_int#1_7| (store |#memory_int#1_6| |main_~#x~0.base_4| v_ArrVal_92_fresh_1)) (= (store (select |#memory_int#1_6| |main_~#x~0.base_4|) (+ (* main_~i~1_6 4) |main_~#x~0.offset_4|) v_ArrVal_91_fresh_1) v_ArrVal_92_fresh_1) (<= |v_main_#t~nondet3_21_fresh_1| 2147483647) (= main_~i~1_7 (+ main_~i~1_6 1))) :named ssa_7))
(assert (! (<= 10000 main_~i~1_7) :named ssa_8))
...
(assert (! (and (= mapsum_~ret~0_12 (+ mapsum_~ret~0_11 mapsum_~i~0_11 (select (select |#memory_int#1_7| mapsum_~x.base_11) (+ (* mapsum_~i~0_11 4) mapsum_~x.offset_11)))) (< mapsum_~i~0_11 10000) (= (+ mapsum_~i~0_11 1) mapsum_~i~0_12)) :named ssa_12))
(assert (! (and (= mapsum_~ret~0_13 (+ mapsum_~ret~0_12 mapsum_~i~0_12 (select (select |#memory_int#1_7| mapsum_~x.base_11) (+ (* mapsum_~i~0_12 4) mapsum_~x.offset_11)))) (< mapsum_~i~0_12 10000) (= (+ mapsum_~i~0_12 1) mapsum_~i~0_13)) :named ssa_13))
(assert (! (<= 10000 mapsum_~i~0_13) :named ssa_14))
...
(assert (! (and (= mapsum_~ret~0_20 (+ mapsum_~ret~0_19 mapsum_~i~0_19 (select (select |#memory_int#1_17| mapsum_~x.base_19) (+ (* mapsum_~i~0_19 4) mapsum_~x.offset_19)))) (< mapsum_~i~0_19 10000) (= (+ mapsum_~i~0_19 1) mapsum_~i~0_20)) :named ssa_20))
(assert (! (and (= mapsum_~ret~0_21 (+ mapsum_~ret~0_20 mapsum_~i~0_20 (select (select |#memory_int#1_17| mapsum_~x.base_19) (+ (* mapsum_~i~0_20 4) mapsum_~x.offset_19)))) (< mapsum_~i~0_20 10000) (= (+ mapsum_~i~0_20 1) mapsum_~i~0_21)) :named ssa_21))
...
(assert (! (and (= (store (select |#memory_int#1_17| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| (* main_~i~2_25 4)) v_ArrVal_96_fresh_1) v_ArrVal_97_fresh_1) (= |#memory_int#1_26| (store |#memory_int#1_17| |main_~#x~0.base_4| v_ArrVal_97_fresh_1)) (= main_~i~2_26 (+ main_~i~2_25 1)) (= (select (select |#memory_int#1_17| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4 (* main_~i~2_25 4))) v_ArrVal_96_fresh_1) (< main_~i~2_25 9999)) :named ssa_26))
(assert (! (and (= main_~i~2_27 (+ main_~i~2_26 1)) (= (store (select |#memory_int#1_26| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| (* main_~i~2_26 4)) v_ArrVal_98_fresh_1) v_ArrVal_99_fresh_1) (= (select (select |#memory_int#1_26| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4 (* main_~i~2_26 4))) v_ArrVal_98_fresh_1) (< main_~i~2_26 9999) (= (store |#memory_int#1_26| |main_~#x~0.base_4| v_ArrVal_99_fresh_1) |#memory_int#1_27|)) :named ssa_27))
(assert (! (<= 9999 main_~i~2_27) :named ssa_28))
(assert (! (and (= v_ArrVal_101_fresh_1 (store (select |#memory_int#1_27| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 39996) v_ArrVal_100_fresh_1)) (= |#memory_int#1_29| (store |#memory_int#1_27| |main_~#x~0.base_4| v_ArrVal_101_fresh_1)) (= v_ArrVal_100_fresh_1 main_~temp~0_25)) :named ssa_29))
