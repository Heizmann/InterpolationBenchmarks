...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:09:48+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id gj2007.c.i.p+nlh-reducer.c_AllErrorsAtOnce_Iteration19)
...
(declare-fun c_aux_v_main_~__tmp_1~0_21 () Int)
...
(declare-fun v_main_~__tmp_1~0_22_fresh_1 () Int)
...
(assert (! (and (< main_~main__x~0_70 50) (= main_~main__x~0_72 (+ main_~main__x~0_70 1))) :named ssa_72))
(assert (! (< main_~main__x~0_72 100) :named ssa_73))
(assert (! (and (= main_~main__x~0_74 (+ main_~main__x~0_72 1)) (= main_~main__y~0_74 (+ main_~main__y~0_4 1)) (<= 50 main_~main__x~0_72)) :named ssa_74))
...
(assert (! (and (= v_main_~__tmp_1~0_22_fresh_1 (ite (= main_~main__y~0_138 100) 1 0)) (<= 100 main_~main__x~0_138) (= v_main_~__tmp_1~0_22_fresh_1 main_~__VERIFIER_assert__cond~0_139)) :named ssa_139))
