...
(set-info :ultimate-id standard_minInArray_ground-2.i_AllErrorsAtOnce_Iteration6)
...
(declare-fun |main_#t~mem4_12| () Int)
(declare-fun main_~min~0_12 () Int)
...
(assert (! (and (= |#length_4| (store |#length_3| |main_~#a~0.base_4| v_ArrVal_24_fresh_1)) (not (= |main_~#a~0.base_4| 0)) (= main_~min~0_4 0) (= |#valid_4| (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_23_fresh_1)) (< |#StackHeapBarrier_-1| |main_~#a~0.base_4|) (= |main_~#a~0.offset_4| 0) (= 400000 v_ArrVal_24_fresh_1) (= (select |#valid_3| |main_~#a~0.base_4|) 0) (= main_~i~0_4 0) (= v_ArrVal_23_fresh_1 1)) :named ssa_4))
(assert (! (and (= main_~i~0_5 (+ main_~i~0_4 1)) (= (store (select |#memory_int#1_3| |main_~#a~0.base_4|) (+ (* main_~i~0_4 4) |main_~#a~0.offset_4|) |v_main_#t~nondet1_14_fresh_1|) v_ArrVal_25_fresh_1) (<= 0 (+ |v_main_#t~nondet1_14_fresh_1| 2147483648)) (= (store |#memory_int#1_3| |main_~#a~0.base_4| v_ArrVal_25_fresh_1) |#memory_int#1_5|) (< main_~i~0_4 100000) (= |v_main_#t~nondet1_14_fresh_1| v_ArrVal_26_fresh_1) (<= |v_main_#t~nondet1_14_fresh_1| 2147483647)) :named ssa_5))
(assert (! (and (= main_~i~0_6 (+ main_~i~0_5 1)) (= (store (select |#memory_int#1_5| |main_~#a~0.base_4|) (+ (* main_~i~0_5 4) |main_~#a~0.offset_4|) v_ArrVal_27_fresh_1) v_ArrVal_28_fresh_1) (< main_~i~0_5 100000) (<= 0 (+ |v_main_#t~nondet1_15_fresh_1| 2147483648)) (<= |v_main_#t~nondet1_15_fresh_1| 2147483647) (= |v_main_#t~nondet1_15_fresh_1| v_ArrVal_27_fresh_1) (= (store |#memory_int#1_5| |main_~#a~0.base_4| v_ArrVal_28_fresh_1) |#memory_int#1_6|)) :named ssa_6))
(assert (! (and (<= 0 (+ |v_main_#t~nondet1_16_fresh_1| 2147483648)) (= (store (select |#memory_int#1_6| |main_~#a~0.base_4|) (+ (* main_~i~0_6 4) |main_~#a~0.offset_4|) |v_main_#t~nondet1_16_fresh_1|) v_ArrVal_29_fresh_1) (= (store |#memory_int#1_6| |main_~#a~0.base_4| v_ArrVal_29_fresh_1) |#memory_int#1_7|) (= main_~i~0_7 (+ main_~i~0_6 1)) (= |v_main_#t~nondet1_16_fresh_1| v_ArrVal_30_fresh_1) (< main_~i~0_6 100000) (<= |v_main_#t~nondet1_16_fresh_1| 2147483647)) :named ssa_7))
(assert (! (and (= (store |#memory_int#1_7| |main_~#a~0.base_4| v_ArrVal_31_fresh_1) |#memory_int#1_8|) (= main_~i~0_8 (+ main_~i~0_7 1)) (= |v_main_#t~nondet1_17_fresh_1| v_ArrVal_32_fresh_1) (<= 0 (+ |v_main_#t~nondet1_17_fresh_1| 2147483648)) (< main_~i~0_7 100000) (= v_ArrVal_31_fresh_1 (store (select |#memory_int#1_7| |main_~#a~0.base_4|) (+ (* main_~i~0_7 4) |main_~#a~0.offset_4|) |v_main_#t~nondet1_17_fresh_1|)) (<= |v_main_#t~nondet1_17_fresh_1| 2147483647)) :named ssa_8))
(assert (! (<= 100000 main_~i~0_8) :named ssa_9))
(assert (! (= main_~i~0_10 0) :named ssa_10))
(assert (! (and (= |main_#t~mem3_11| (select (select |#memory_int#1_8| |main_~#a~0.base_4|) (+ (* main_~i~0_10 4) |main_~#a~0.offset_4|))) (< main_~i~0_10 100000)) :named ssa_11))
(assert (! (and (< |main_#t~mem3_11| main_~min~0_4) (= (select (select |#memory_int#1_8| |main_~#a~0.base_4|) (+ (* main_~i~0_10 4) |main_~#a~0.offset_4|)) main_~min~0_12)) :named ssa_12))
(assert (! (= main_~i~0_13 (+ main_~i~0_10 1)) :named ssa_13))
(assert (! (and (= |main_#t~mem3_14| (select (select |#memory_int#1_8| |main_~#a~0.base_4|) (+ (* main_~i~0_13 4) |main_~#a~0.offset_4|))) (< main_~i~0_13 100000)) :named ssa_14))
(assert (! (and (< |main_#t~mem3_14| main_~min~0_12) (= (select (select |#memory_int#1_8| |main_~#a~0.base_4|) (+ (* main_~i~0_13 4) |main_~#a~0.offset_4|)) main_~min~0_15)) :named ssa_15))
(assert (! (= main_~i~0_16 (+ main_~i~0_13 1)) :named ssa_16))
(assert (! (and (= |main_#t~mem3_17| (select (select |#memory_int#1_8| |main_~#a~0.base_4|) (+ (* main_~i~0_16 4) |main_~#a~0.offset_4|))) (< main_~i~0_16 100000)) :named ssa_17))
(assert (! (and (< |main_#t~mem3_17| main_~min~0_15) (= (select (select |#memory_int#1_8| |main_~#a~0.base_4|) (+ (* main_~i~0_16 4) |main_~#a~0.offset_4|)) main_~min~0_18)) :named ssa_18))
(assert (! (= main_~i~0_19 (+ main_~i~0_16 1)) :named ssa_19))
(assert (! (and (= |main_#t~mem3_20| (select (select |#memory_int#1_8| |main_~#a~0.base_4|) (+ (* main_~i~0_19 4) |main_~#a~0.offset_4|))) (< main_~i~0_19 100000)) :named ssa_20))
(assert (! (and (< |main_#t~mem3_20| main_~min~0_18) (= (select (select |#memory_int#1_8| |main_~#a~0.base_4|) (+ (* main_~i~0_19 4) |main_~#a~0.offset_4|)) main_~min~0_21)) :named ssa_21))
(assert (! (= main_~i~0_22 (+ main_~i~0_19 1)) :named ssa_22))
(assert (! (<= 100000 main_~i~0_22) :named ssa_23))
(assert (! (= main_~x~0_24 0) :named ssa_24))
(assert (! (and (< main_~x~0_24 100000) (= |main_#t~mem5_25| (select (select |#memory_int#1_8| |main_~#a~0.base_4|) (+ (* main_~x~0_24 4) |main_~#a~0.offset_4|)))) :named ssa_25))
(assert (! true :named ssa_26_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_26| (ite (<= main_~min~0_21 |main_#t~mem5_25|) 1 0)) :named ssa_26_LocVarAssigCall))
