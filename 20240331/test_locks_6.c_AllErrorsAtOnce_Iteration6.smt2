...
(set-info :ultimate-id test_locks_6.c_AllErrorsAtOnce_Iteration6)
...
(declare-fun main_~lk3~0_16 () Int)
...
(assert (! (not (= main_~p3~0_4 0)) :named ssa_15))
(assert (! (not (= main_~lk3~0_9 1)) :named ssa_16))
