...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:08:40+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id test_locks_6.c_AllErrorsAtOnce_Iteration1)
...
(declare-fun main_~lk1~0_14 () Int)
...
(assert (! (and (not (= main_~p1~0_4 0)) (= main_~lk1~0_7 1)) :named ssa_7))
(assert (! (= main_~p2~0_4 0) :named ssa_8))
(assert (! (and (= main_~lk3~0_9 1) (not (= main_~p3~0_4 0))) :named ssa_9))
(assert (! (and (not (= main_~p4~0_4 0)) (= main_~lk4~0_10 1)) :named ssa_10))
(assert (! (and (= main_~lk5~0_11 1) (not (= main_~p5~0_4 0))) :named ssa_11))
(assert (! (and (= main_~lk6~0_12 1) (not (= main_~p6~0_4 0))) :named ssa_12))
(assert (! (not (= main_~p1~0_4 0)) :named ssa_13))
(assert (! (not (= main_~lk1~0_7 1)) :named ssa_14))
