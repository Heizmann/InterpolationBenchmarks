...
(set-info :ultimate-id watermelon.c_AllErrorsAtOnce_Iteration22)
...
(declare-fun v_main_~is_divisible1~0_27_fresh_1 () Int)
(declare-fun v_main_~is_divisible2~0_27_fresh_1 () Int)
...
(assert (! (and (= ~true~0_1 v_main_~is_divisible1~0_27_fresh_1) (= ~true~0_1 v_main_~is_divisible2~0_27_fresh_1)) :named ssa_4))
...
(assert (! (= correct_version_~i~0_13 correct_version_~w_7) :named ssa_15))
(assert (! true :named ssa_16))
(assert (! (= |correct_version_#res_17| correct_version_~is_divisible~0_7) :named ssa_17))
...
(assert (! (and (not (= student_version_~w_21 student_version_~i~1_27)) (= ~false~0_1 student_version_~is_divisible~1_29)) :named ssa_29))
(assert (! true :named ssa_30))
(assert (! (= student_version_~is_divisible~1_29 |student_version_#res_31|) :named ssa_31))
...
(assert (! true :named ssa_precond))
(assert (! (not (and (<= main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647)) (<= (+ (* (div main_~w~0_-2 4294967296) 4294967296) 10) main_~w~0_-2))) :named ssa_postcond))
...
(assert (! (= correct_version_~i~0_6 correct_version_~w_0) :named ssa_8))
(assert (! true :named ssa_9))
(assert (! (= |correct_version_#res_10| correct_version_~is_divisible~0_0) :named ssa_10))
...
(declare-fun student_version_~is_divisible~1_8 () Int)
...
(assert (! (and (not (= student_version_~w_0 student_version_~i~1_6)) (= ~false~0_-1 student_version_~is_divisible~1_8)) :named ssa_8))
(assert (! true :named ssa_9))
(assert (! (= student_version_~is_divisible~1_8 |student_version_#res_10|) :named ssa_10))
(assert (! (= |main_#t~ret6_11| |student_version_#res_10|) :named ssa_11_return))
(assert (! (and (<= main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647)) (<= (+ (* (div main_~w~0_-2 4294967296) 4294967296) 10) main_~w~0_-2)) :named ssa_-2_PendingContext))
