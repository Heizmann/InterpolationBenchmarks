...
(set-info :ultimate-id array_4.i_AllErrorsAtOnce_Iteration9)
...
(assert (! (and (= v_ArrVal_61_fresh_1 1) (= (select |#valid_3| |main_~#A~0.base_4|) 0) (= (store |#length_3| |main_~#A~0.base_4| v_ArrVal_62_fresh_1) |#length_4|) (not (= |main_~#A~0.base_4| 0)) (= 0 |main_~#A~0.offset_4|) (= 4096 v_ArrVal_62_fresh_1) (< |#StackHeapBarrier_-1| |main_~#A~0.base_4|) (= (store |#valid_3| |main_~#A~0.base_4| v_ArrVal_61_fresh_1) |#valid_4|) (= main_~i~0_4 0)) :named ssa_4))
(assert (! (and (= main_~i~0_5 (+ main_~i~0_4 1)) (<= 0 (+ |v_main_#t~nondet1_22_fresh_1| 2147483648)) (= |v_main_#t~nondet1_22_fresh_1| v_ArrVal_64_fresh_1) (< main_~i~0_4 1023) (= (store (select |#memory_int#1_3| |main_~#A~0.base_4|) (+ (* main_~i~0_4 4) |main_~#A~0.offset_4|) |v_main_#t~nondet1_22_fresh_1|) v_ArrVal_63_fresh_1) (<= |v_main_#t~nondet1_22_fresh_1| 2147483647) (= (store |#memory_int#1_3| |main_~#A~0.base_4| v_ArrVal_63_fresh_1) |#memory_int#1_5|)) :named ssa_5))
(assert (! (and (= |v_main_#t~nondet1_23_fresh_1| v_ArrVal_65_fresh_1) (= main_~i~0_6 (+ main_~i~0_5 1)) (<= 0 (+ |v_main_#t~nondet1_23_fresh_1| 2147483648)) (= (store |#memory_int#1_5| |main_~#A~0.base_4| v_ArrVal_66_fresh_1) |#memory_int#1_6|) (< main_~i~0_5 1023) (= (store (select |#memory_int#1_5| |main_~#A~0.base_4|) (+ (* main_~i~0_5 4) |main_~#A~0.offset_4|) v_ArrVal_65_fresh_1) v_ArrVal_66_fresh_1) (<= |v_main_#t~nondet1_23_fresh_1| 2147483647)) :named ssa_6))
(assert (! (and (<= 0 (+ |v_main_#t~nondet1_24_fresh_1| 2147483648)) (= main_~i~0_7 (+ main_~i~0_6 1)) (= (store |#memory_int#1_6| |main_~#A~0.base_4| v_ArrVal_67_fresh_1) |#memory_int#1_7|) (= (store (select |#memory_int#1_6| |main_~#A~0.base_4|) (+ (* main_~i~0_6 4) |main_~#A~0.offset_4|) |v_main_#t~nondet1_24_fresh_1|) v_ArrVal_67_fresh_1) (= |v_main_#t~nondet1_24_fresh_1| v_ArrVal_68_fresh_1) (< main_~i~0_6 1023) (<= |v_main_#t~nondet1_24_fresh_1| 2147483647)) :named ssa_7))
(assert (! (and (<= 0 (+ |v_main_#t~nondet1_25_fresh_1| 2147483648)) (= main_~i~0_8 (+ main_~i~0_7 1)) (= (store (select |#memory_int#1_7| |main_~#A~0.base_4|) (+ (* main_~i~0_7 4) |main_~#A~0.offset_4|) v_ArrVal_69_fresh_1) v_ArrVal_70_fresh_1) (= |#memory_int#1_8| (store |#memory_int#1_7| |main_~#A~0.base_4| v_ArrVal_70_fresh_1)) (< main_~i~0_7 1023) (<= |v_main_#t~nondet1_25_fresh_1| 2147483647) (= |v_main_#t~nondet1_25_fresh_1| v_ArrVal_69_fresh_1)) :named ssa_8))
(assert (! (and (= main_~i~0_9 (+ main_~i~0_8 1)) (= |v_main_#t~nondet1_26_fresh_1| v_ArrVal_71_fresh_1) (< main_~i~0_8 1023) (= (store (select |#memory_int#1_8| |main_~#A~0.base_4|) (+ (* main_~i~0_8 4) |main_~#A~0.offset_4|) v_ArrVal_71_fresh_1) v_ArrVal_72_fresh_1) (<= 0 (+ |v_main_#t~nondet1_26_fresh_1| 2147483648)) (<= |v_main_#t~nondet1_26_fresh_1| 2147483647) (= |#memory_int#1_9| (store |#memory_int#1_8| |main_~#A~0.base_4| v_ArrVal_72_fresh_1))) :named ssa_9))
(assert (! (<= 1023 main_~i~0_9) :named ssa_10))
(assert (! (and (= (store (select |#memory_int#1_9| |main_~#A~0.base_4|) (+ 4092 |main_~#A~0.offset_4|) 0) v_ArrVal_73_fresh_1) (= |#memory_int#1_11| (store |#memory_int#1_9| |main_~#A~0.base_4| v_ArrVal_73_fresh_1)) (= main_~i~0_11 0) (= v_ArrVal_74_fresh_1 0)) :named ssa_11))
(assert (! (= |main_#t~mem3_12| (select (select |#memory_int#1_11| |main_~#A~0.base_4|) (+ (* main_~i~0_11 4) |main_~#A~0.offset_4|))) :named ssa_12))
(assert (! (and (= main_~i~0_13 (+ main_~i~0_11 1)) (not (= |main_#t~mem3_12| 0))) :named ssa_13))
(assert (! (= |main_#t~mem3_14| (select (select |#memory_int#1_11| |main_~#A~0.base_4|) (+ (* main_~i~0_13 4) |main_~#A~0.offset_4|))) :named ssa_14))
(assert (! (and (= main_~i~0_15 (+ main_~i~0_13 1)) (not (= |main_#t~mem3_14| 0))) :named ssa_15))
(assert (! (= |main_#t~mem3_16| (select (select |#memory_int#1_11| |main_~#A~0.base_4|) (+ (* main_~i~0_15 4) |main_~#A~0.offset_4|))) :named ssa_16))
(assert (! (= |main_#t~mem3_16| 0) :named ssa_17))
(assert (! true :named ssa_18_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_18| (ite (<= main_~i~0_15 1024) 1 0)) :named ssa_18_LocVarAssigCall))
