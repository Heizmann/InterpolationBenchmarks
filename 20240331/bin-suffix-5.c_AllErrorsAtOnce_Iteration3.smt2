...
(set-info :ultimate-id bin-suffix-5.c_AllErrorsAtOnce_Iteration3)
...
(declare-fun |main_#t~bitwise5_8| () Int)
...
(assert (! (not (= (mod main_~x~0_4 4294967296) 0)) :named ssa_7))
(assert (! (and (= main_~x~0_4 |main_#t~bitwise5_8|) (= 5 (mod main_~x~0_4 4294967296))) :named ssa_8))
(assert (! true :named ssa_9_GlobVarAssigCall))
(assert (! (= (ite (= 5 (mod |main_#t~bitwise5_8| 4294967296)) 1 0) |__VERIFIER_assert_#in~cond_9|) :named ssa_9_LocVarAssigCall))
