...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration26)
...
(assert (! (<= 1000000 main_~i~0_29) :named ssa_30))
(assert (! true :named ssa_31_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_31| (ite (= main_~i~0_29 1000000) 1 0)) :named ssa_31_LocVarAssigCall))
