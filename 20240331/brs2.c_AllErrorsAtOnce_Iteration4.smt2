...
(set-info :ultimate-id brs2.c_AllErrorsAtOnce_Iteration4)
...
(declare-fun |main_~#sum~0.offset_24| () Int)
...
(assert (! (and (= (select |#valid_3| |main_~#sum~0.base_11|) 0) (= v_ArrVal_18_fresh_1 1) (= (store (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_18_fresh_1) main_~a~0.base_11 v_ArrVal_19_fresh_1) |#valid_11|) (< |#StackHeapBarrier_-1| |main_~#sum~0.base_11|) (< main_~a~0.base_11 |#StackHeapBarrier_-1|) (= |main_~#sum~0.offset_11| 0) (= (* (mod ~N~0_4 1073741824) 4) v_ArrVal_17_fresh_1) (= (store (store |#length_3| |main_~#sum~0.base_11| v_ArrVal_20_fresh_1) main_~a~0.base_11 v_ArrVal_17_fresh_1) |#length_11|) (= 8 v_ArrVal_20_fresh_1) (= (select (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_18_fresh_1) main_~a~0.base_11) 0) (not (= |main_~#sum~0.base_11| 0)) (= main_~a~0.offset_11 0) (not (= main_~a~0.base_11 0)) (= main_~i~0_11 0) (= v_ArrVal_19_fresh_1 1)) :named ssa_11))
(assert (! (< main_~i~0_11 ~N~0_4) :named ssa_12))
(assert (! (and (= (store (select |#memory_int#3_3| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_11 4)) v_ArrVal_21_fresh_1) v_ArrVal_22_fresh_1) (= (store |#memory_int#3_3| main_~a~0.base_11 v_ArrVal_22_fresh_1) |#memory_int#3_13|) (= 2 v_ArrVal_21_fresh_1) (= (ite (and (< main_~i~0_11 0) (not (= (mod main_~i~0_11 2) 0))) (+ (mod main_~i~0_11 2) (- 2)) (mod main_~i~0_11 2)) 0)) :named ssa_13))
(assert (! (= main_~i~0_14 (+ main_~i~0_11 1)) :named ssa_14))
(assert (! (<= ~N~0_4 main_~i~0_14) :named ssa_15))
(assert (! (= main_~i~0_16 0) :named ssa_16))
(assert (! (< main_~i~0_16 ~N~0_4) :named ssa_17))
(assert (! (and (= (store |#memory_int#1_3| |main_~#sum~0.base_11| v_ArrVal_24_fresh_1) |#memory_int#1_18|) (= main_~i~0_16 0) (= (store (select |#memory_int#1_3| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| v_ArrVal_23_fresh_1) v_ArrVal_24_fresh_1) (= v_ArrVal_23_fresh_1 0)) :named ssa_18))
(assert (! (= main_~i~0_19 (+ main_~i~0_16 1)) :named ssa_19))
(assert (! (< main_~i~0_19 ~N~0_4) :named ssa_20))
(assert (! (and (= (store (select |#memory_int#1_18| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| v_ArrVal_25_fresh_1) v_ArrVal_26_fresh_1) (= (store |#memory_int#1_18| |main_~#sum~0.base_11| v_ArrVal_26_fresh_1) |#memory_int#1_21|) (= (+ (select (select |#memory_int#1_18| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|) (select (select |#memory_int#3_13| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_19 4)))) v_ArrVal_25_fresh_1) (not (= main_~i~0_19 0))) :named ssa_21))
(assert (! (= main_~i~0_22 (+ main_~i~0_19 1)) :named ssa_22))
(assert (! (<= ~N~0_4 main_~i~0_22) :named ssa_23))
(assert (! (= |main_#t~mem10_24| (select (select |#memory_int#1_21| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|)) :named ssa_24))
(assert (! true :named ssa_25_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_25| (ite (<= |main_#t~mem10_24| (* 2 ~N~0_4)) 1 0)) :named ssa_25_LocVarAssigCall))
