...
(set-info :ultimate-id underapprox_1-2.c_AllErrorsAtOnce_Iteration3)
...
(assert (! (<= 6 (mod main_~x~0_5 4294967296)) :named ssa_6))
(assert (! true :named ssa_7_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_7| (mod (mod main_~y~0_5 4294967296) 3)) :named ssa_7_LocVarAssigCall))
