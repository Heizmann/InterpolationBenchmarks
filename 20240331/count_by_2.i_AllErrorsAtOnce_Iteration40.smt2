...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration40)
...
(assert (! (<= 1000000 main_~i~0_43) :named ssa_44))
(assert (! true :named ssa_45_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_45| (ite (= main_~i~0_43 1000000) 1 0)) :named ssa_45_LocVarAssigCall))
