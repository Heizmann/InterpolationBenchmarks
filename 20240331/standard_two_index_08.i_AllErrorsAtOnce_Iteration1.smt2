...
(set-info :ultimate-id standard_two_index_08.i_AllErrorsAtOnce_Iteration1)
...
(assert (! (and (= (select (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_2_fresh_1) |main_~#b~0.base_4|) 0) (= main_~j~0_4 0) (= v_ArrVal_4_fresh_1 1) (< |#StackHeapBarrier_-1| |main_~#a~0.base_4|) (= |main_~#b~0.offset_4| 0) (= main_~i~0_4 0) (not (= |main_~#a~0.base_4| 0)) (not (= |main_~#b~0.base_4| 0)) (= |main_~#a~0.offset_4| 0) (= v_ArrVal_2_fresh_1 1) (= |#valid_4| (store (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_2_fresh_1) |main_~#b~0.base_4| v_ArrVal_4_fresh_1)) (< |#StackHeapBarrier_-1| |main_~#b~0.base_4|) (= (select |#valid_3| |main_~#a~0.base_4|) 0) (= 400000 v_ArrVal_3_fresh_1) (= 400000 v_ArrVal_1_fresh_1) (= |#length_4| (store (store |#length_3| |main_~#a~0.base_4| v_ArrVal_3_fresh_1) |main_~#b~0.base_4| v_ArrVal_1_fresh_1))) :named ssa_4))
