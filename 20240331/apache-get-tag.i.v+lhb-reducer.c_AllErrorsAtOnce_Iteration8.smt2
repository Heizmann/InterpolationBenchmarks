...
(set-info :ultimate-id apache-get-tag.i.v+lhb-reducer.c_AllErrorsAtOnce_Iteration8)
...
(declare-fun v_main_~main____CPAchecker_TMP_1~0_6_fresh_1 () Int)
(declare-fun v_main_~main____CPAchecker_TMP_0~0_16_fresh_1 () Int)
(declare-fun main_~__VERIFIER_assert__cond~14_11 () Int)
(declare-fun v_main_~__tmp_15~0_5_fresh_1 () Int)
(declare-fun main_~main__t~0_12 () Int)
(declare-fun main_~__VERIFIER_assert__cond~15_12 () Int)
(declare-fun main_~__VERIFIER_assert__cond~14_12 () Int)
(declare-fun main_~main__tagbuf_len~0_12 () Int)
(declare-fun v_main_~__tmp_16~0_4_fresh_1 () Int)
(declare-fun main_~__VERIFIER_assert__cond~15_13 () Int)
...
(assert (! (and (= v_main_~__tmp_13~0_8_fresh_1 main_~__VERIFIER_assert__cond~12_7) (= v_main_~__tmp_13~0_8_fresh_1 (ite (<= 0 main_~main__t~0_5) 1 0)) (= main_~main____CPAchecker_TMP_0~0_6 0)) :named ssa_7))
(assert (! (and (not (= main_~__VERIFIER_assert__cond~12_7 0)) (= v_main_~__tmp_14~0_8_fresh_1 (ite (<= main_~main__t~0_5 main_~main__tagbuf_len~0_5) 1 0)) (= v_main_~__tmp_14~0_8_fresh_1 main_~__VERIFIER_assert__cond~13_8)) :named ssa_8))
(assert (! (and (= main_~main____CPAchecker_TMP_0~0_6 ~__tmp_383_0~0_9) (not (= main_~__VERIFIER_assert__cond~13_8 0))) :named ssa_9))
(assert (! (and (= ~__tmp_383_0~0_9 v_main_~main____CPAchecker_TMP_0~0_16_fresh_1) (= v_main_~main____CPAchecker_TMP_1~0_6_fresh_1 main_~main__t~0_5) (= main_~main__t~0_10 (+ main_~main__t~0_5 1))) :named ssa_10))
(assert (! (and (= main_~main__t~0_10 main_~main__tagbuf_len~0_5) (= v_main_~__tmp_15~0_5_fresh_1 main_~__VERIFIER_assert__cond~14_11) (= (ite (<= 0 main_~main__t~0_10) 1 0) v_main_~__tmp_15~0_5_fresh_1)) :named ssa_11))
(assert (! (and (= v_main_~__tmp_16~0_4_fresh_1 (ite (<= main_~main__t~0_10 main_~main__tagbuf_len~0_5) 1 0)) (= v_main_~__tmp_16~0_4_fresh_1 main_~__VERIFIER_assert__cond~15_12) (not (= main_~__VERIFIER_assert__cond~14_11 0))) :named ssa_12))
(assert (! (= main_~__VERIFIER_assert__cond~15_12 0) :named ssa_13))
