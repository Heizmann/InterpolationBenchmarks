...
(set-info :ultimate-id nested_6.c_AllErrorsAtOnce_Iteration8)
...
(declare-fun |main_#t~pre6_15| () Int)
(declare-fun |main_#t~pre7_17| () Int)
(declare-fun main_~c~0_17 () Int)
(declare-fun |main_#t~pre8_19| () Int)
(declare-fun main_~b~0_19 () Int)
...
(declare-fun main_~b~0_23 () Int)
(declare-fun main_~a~0_23 () Int)
...
(assert (! (<= 6 main_~d~0_15) :named ssa_16))
(assert (! (= (+ main_~c~0_6 1) main_~c~0_17) :named ssa_17))
(assert (! (<= 6 main_~c~0_17) :named ssa_18))
(assert (! (= main_~b~0_19 (+ main_~b~0_5 1)) :named ssa_19))
(assert (! (<= 6 main_~b~0_19) :named ssa_20))
(assert (! (= main_~a~0_21 (+ main_~a~0_4 1)) :named ssa_21))
(assert (! (<= 6 main_~a~0_21) :named ssa_22))
(assert (! (or (not (= main_~c~0_17 6)) (not (= main_~d~0_15 6)) (not (= main_~a~0_21 6)) (not (= main_~f~0_11 6)) (not (= main_~e~0_13 6)) (not (= main_~b~0_19 6))) :named ssa_23))
