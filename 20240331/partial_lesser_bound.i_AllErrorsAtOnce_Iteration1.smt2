...
(set-info :ultimate-id partial_lesser_bound.i_AllErrorsAtOnce_Iteration1)
...
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_2_fresh_1) (= (store |#memory_$Pointer$#1.base_0| |~#a~0.base_1| v_ArrVal_2_fresh_1) |#memory_$Pointer$#1.base_1|) (= ((as const (Array Int Int)) 0) v_ArrVal_1_fresh_1) (< 0 |#StackHeapBarrier_-1|) (= (select |#valid_-1| 0) 0) (= (select |#valid_-1| 2) 1) (= |~#a~0.offset_1| 0) (= 23 (select |#length_-1| 2)) (= 4000000 (select |#length_-1| 3)) (= (select |#valid_-1| 3) 1) (= |~#a~0.base_1| 3) (= (select |#valid_-1| 1) 1) (= ~i~0_1 0) (= (store |#memory_$Pointer$#1.offset_0| |~#a~0.base_1| v_ArrVal_1_fresh_1) |#memory_$Pointer$#1.offset_1|) (= (select (select |#memory_int#0_-1| 1) 1) 0) (= 2 (select |#length_-1| 1)) (= (select (select |#memory_int#0_-1| 1) 0) 48)) :named ssa_1))
...
(assert (! (and (< 0 |#StackHeapBarrier_-1|) (= (select |#valid_-2| 0) 0) (= (select |#valid_-2| 2) 1) (= |~#a~0.offset_0| 0) (= 23 (select |#length_-2| 2)) (= 4000000 (select |#length_-2| 3)) (= ((as const (Array Int Int)) 0) v_ArrVal_3_fresh_1) (= (select |#valid_-2| 3) 1) (= |~#a~0.base_0| 3) (= ((as const (Array Int Int)) 0) v_ArrVal_4_fresh_1) (= (store |#memory_$Pointer$#1.base_-1| |~#a~0.base_0| v_ArrVal_4_fresh_1) |#memory_$Pointer$#1.base_0|) (= (select |#valid_-2| 1) 1) (= ~i~0_0 0) (= (select (select |#memory_int#0_-2| 1) 1) 0) (= 2 (select |#length_-2| 1)) (= (store |#memory_$Pointer$#1.offset_-1| |~#a~0.base_0| v_ArrVal_3_fresh_1) |#memory_$Pointer$#1.offset_0|) (= (select (select |#memory_int#0_-2| 1) 0) 48)) :named ssa_0))
