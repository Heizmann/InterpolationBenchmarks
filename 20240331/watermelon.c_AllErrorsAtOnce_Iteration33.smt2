...
(set-info :ultimate-id watermelon.c_AllErrorsAtOnce_Iteration33)
...
(declare-fun v_main_~is_divisible1~0_38_fresh_1 () Int)
(declare-fun v_main_~is_divisible2~0_38_fresh_1 () Int)
...
(assert (! (and (= ~true~0_1 v_main_~is_divisible2~0_38_fresh_1) (= ~true~0_1 v_main_~is_divisible1~0_38_fresh_1)) :named ssa_4))
...
(assert (! (= student_version_~w_24 student_version_~i~1_33) :named ssa_35))
(assert (! true :named ssa_36))
(assert (! (= student_version_~is_divisible~1_24 |student_version_#res_37|) :named ssa_37))
...
(assert (! true :named ssa_precond))
(assert (! (not (or (< (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647) main_~w~0_-2) (< main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 16)))) :named ssa_postcond))
...
(assert (! (= student_version_~w_0 student_version_~i~1_9) :named ssa_11))
(assert (! true :named ssa_12))
(assert (! (= student_version_~is_divisible~1_0 |student_version_#res_13|) :named ssa_13))
(assert (! (= |main_#t~ret6_14| |student_version_#res_13|) :named ssa_14_return))
(assert (! (or (< (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647) main_~w~0_-2) (< main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 16))) :named ssa_-2_PendingContext))
