...
(set-info :ultimate-id prefixsum_iter.c_AllErrorsAtOnce_Iteration5)
...
(declare-fun |v_#Ultimate.meminit_#productInParam_13_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#ptr.offsetInParam_13_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#sizeOfFieldsInParam_13_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#amountOfFieldsInParam_13_fresh_1| () Int)
...
(declare-fun |v_#Ultimate.meminit_#amountOfFieldsInParam_14_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#ptr.offsetInParam_14_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#productInParam_14_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#sizeOfFieldsInParam_14_fresh_1| () Int)
...
(declare-fun |downsweep_#in~a.offset_38| () Int)
(declare-fun |downsweep_#in~space_38| () Int)
(declare-fun main_~a~0.base_38 () Int)
(declare-fun |downsweep_#in~n_38| () Int)
(declare-fun |downsweep_#in~a.base_38| () Int)
(declare-fun main_~n~0_38 () Int)
(declare-fun main_~a~0.offset_38 () Int)
(declare-fun main_~space~1_38 () Int)
(declare-fun downsweep_~n_39 () Int)
(declare-fun downsweep_~space_39 () Int)
(declare-fun downsweep_~a.offset_39 () Int)
(declare-fun downsweep_~a.base_39 () Int)
...
(declare-fun |check_#in~a.offset_43| () Int)
(declare-fun main_~a0~0.offset_43 () Int)
(declare-fun |check_#in~a.base_43| () Int)
(declare-fun main_~a~0.base_43 () Int)
(declare-fun main_~n~0_43 () Int)
(declare-fun main_~a~0.offset_43 () Int)
(declare-fun |check_#in~a0.base_43| () Int)
(declare-fun |check_#in~n_43| () Int)
(declare-fun main_~a0~0.base_43 () Int)
(declare-fun |check_#in~a0.offset_43| () Int)
(declare-fun check_~a0.base_44 () Int)
(declare-fun check_~a.base_44 () Int)
(declare-fun check_~a.offset_44 () Int)
(declare-fun check_~i~0_44 () Int)
(declare-fun check_~sum~0_44 () Int)
(declare-fun check_~a0.offset_44 () Int)
(declare-fun check_~n_44 () Int)
(declare-fun |check_#t~mem10_45| () Int)
(declare-fun |__VERIFIER_assert_#in~cond_46| () Int)
(declare-fun |check_#t~mem10_46| () Int)
(declare-fun check_~sum~0_46 () Int)
(declare-fun __VERIFIER_assert_~cond_47 () Int)
(declare-fun __VERIFIER_assert_~cond_48 () Int)
(declare-fun |check_#t~mem10_51| () Int)
(declare-fun check_~i~0_51 () Int)
(declare-fun |check_#t~mem11_51| () Int)
(declare-fun check_~sum~0_51 () Int)
(declare-fun |check_#t~post12_51| () Int)
...
(assert (! (and (not (= |main_#t~malloc15.base_21| 0)) (< |main_#t~malloc15.base_21| |#StackHeapBarrier_-1|) (= |main_#t~malloc15.offset_21| 0) (= v_ArrVal_57_fresh_1 1) (= |#length_21| (store |#length_3| |main_#t~malloc15.base_21| v_ArrVal_58_fresh_1)) (= v_ArrVal_58_fresh_1 (* (mod main_~n~0_4 1073741824) 4)) (= |#valid_21| (store |#valid_3| |main_#t~malloc15.base_21| v_ArrVal_57_fresh_1)) (= (select |#valid_3| |main_#t~malloc15.base_21|) 0)) :named ssa_21))
(assert (! (= |old(#memory_int#1)_22| |#memory_int#1_22|) :named ssa_22_GlobVarAssigCall))
(assert (! (and (= |#Ultimate.meminit_#ptr.base_22| |main_#t~malloc15.base_21|) (= |v_#Ultimate.meminit_#ptr.offsetInParam_13_fresh_1| |main_#t~malloc15.offset_21|) (= (* main_~n~0_4 4) |v_#Ultimate.meminit_#productInParam_13_fresh_1|) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_13_fresh_1|) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_13_fresh_1| 4)) :named ssa_22_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_22| |#memory_int#1_3|) :named ssa_22_OldVarAssigCall))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_59_fresh_1) (= (store |#memory_int#1_22| |#Ultimate.meminit_#ptr.base_22| v_ArrVal_59_fresh_1) |#memory_int#1_23|)) :named ssa_23))
(assert (! true :named ssa_24_return))
(assert (! (and (= |#valid_25| (store |#valid_21| |main_#t~malloc16.base_25| v_ArrVal_60_fresh_1)) (= (select |#valid_21| |main_#t~malloc16.base_25|) 0) (not (= |main_#t~malloc16.base_25| 0)) (= v_ArrVal_60_fresh_1 1) (= |main_#t~malloc16.offset_25| 0) (= main_~a~0.offset_25 |main_#t~malloc15.offset_21|) (= main_~a~0.base_25 |main_#t~malloc15.base_21|) (< |main_#t~malloc16.base_25| |#StackHeapBarrier_-1|) (= (* (mod main_~n~0_4 1073741824) 4) v_ArrVal_61_fresh_1) (= (store |#length_21| |main_#t~malloc16.base_25| v_ArrVal_61_fresh_1) |#length_25|)) :named ssa_25))
(assert (! (= |old(#memory_int#1)_26| |#memory_int#1_26|) :named ssa_26_GlobVarAssigCall))
(assert (! (and (= (* main_~n~0_4 4) |v_#Ultimate.meminit_#productInParam_14_fresh_1|) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_14_fresh_1| 4) (= |v_#Ultimate.meminit_#ptr.offsetInParam_14_fresh_1| |main_#t~malloc16.offset_25|) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_14_fresh_1|) (= |#Ultimate.meminit_#ptr.base_26| |main_#t~malloc16.base_25|)) :named ssa_26_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_26| |#memory_int#1_23|) :named ssa_26_OldVarAssigCall))
(assert (! (and (= (store |#memory_int#1_26| |#Ultimate.meminit_#ptr.base_26| v_ArrVal_62_fresh_1) |#memory_int#1_27|) (= ((as const (Array Int Int)) 0) v_ArrVal_62_fresh_1)) :named ssa_27))
...
(assert (! (and (< main_~i~1_29 main_~n~0_4) (= (select (select |#memory_int#1_27| main_~a~0.base_25) (+ main_~a~0.offset_25 (* main_~i~1_29 4))) v_ArrVal_63_fresh_1) (= (store |#memory_int#1_27| main_~a0~0.base_29 v_ArrVal_64_fresh_1) |#memory_int#1_30|) (= (store (select |#memory_int#1_27| main_~a0~0.base_29) (+ main_~a0~0.offset_29 (* main_~i~1_29 4)) v_ArrVal_63_fresh_1) v_ArrVal_64_fresh_1) (= main_~i~1_30 (+ main_~i~1_29 1))) :named ssa_30))
...
(assert (! (<= upsweep_~n_33 upsweep_~space~0_33) :named ssa_34))
(assert (! (= |upsweep_#res_35| upsweep_~space~0_33) :named ssa_35))
(assert (! (= |main_#t~ret19_36| |upsweep_#res_35|) :named ssa_36_return))
(assert (! (and (<= 0 (+ |main_#t~ret19_36| 2147483648)) (<= |main_#t~ret19_36| 2147483647) (= |main_#t~ret19_36| main_~space~1_37)) :named ssa_37))
(assert (! (= |old(#memory_int#1)_38| |#memory_int#1_38|) :named ssa_38_GlobVarAssigCall))
(assert (! (and (= |downsweep_#in~a.base_38| main_~a~0.base_25) (= main_~n~0_4 |downsweep_#in~n_38|) (= |downsweep_#in~space_38| main_~space~1_37) (= main_~a~0.offset_25 |downsweep_#in~a.offset_38|)) :named ssa_38_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_38| |#memory_int#1_32|) :named ssa_38_OldVarAssigCall))
(assert (! (and (= (store |#memory_int#1_38| downsweep_~a.base_39 v_ArrVal_66_fresh_1) |#memory_int#1_39|) (= downsweep_~space_39 (ite (and (not (= (mod |downsweep_#in~space_38| 2) 0)) (< |downsweep_#in~space_38| 0)) (+ (div |downsweep_#in~space_38| 2) 1) (div |downsweep_#in~space_38| 2))) (= (store (select |#memory_int#1_38| downsweep_~a.base_39) (+ downsweep_~a.offset_39 (- 4) (* downsweep_~n_39 4)) v_ArrVal_65_fresh_1) v_ArrVal_66_fresh_1) (= downsweep_~a.base_39 |downsweep_#in~a.base_38|) (= downsweep_~a.offset_39 |downsweep_#in~a.offset_38|) (= v_ArrVal_65_fresh_1 0) (= downsweep_~n_39 |downsweep_#in~n_38|)) :named ssa_39))
(assert (! (<= downsweep_~space_39 0) :named ssa_40))
(assert (! true :named ssa_41))
(assert (! true :named ssa_42_return))
(assert (! true :named ssa_43_GlobVarAssigCall))
(assert (! (and (= main_~a0~0.offset_29 |check_#in~a0.offset_43|) (= main_~a0~0.base_29 |check_#in~a0.base_43|) (= |check_#in~a.offset_43| main_~a~0.offset_25) (= main_~n~0_4 |check_#in~n_43|) (= |check_#in~a.base_43| main_~a~0.base_25)) :named ssa_43_LocVarAssigCall))
(assert (! true :named ssa_43_OldVarAssigCall))
(assert (! (and (= |check_#in~a.offset_43| check_~a.offset_44) (= |check_#in~a0.offset_43| check_~a0.offset_44) (= check_~a.base_44 |check_#in~a.base_43|) (= check_~i~0_44 0) (= check_~a0.base_44 |check_#in~a0.base_43|) (= check_~sum~0_44 0) (= check_~n_44 |check_#in~n_43|)) :named ssa_44))
(assert (! (and (= |check_#t~mem10_45| (select (select |#memory_int#1_39| check_~a.base_44) (+ (* check_~i~0_44 4) check_~a.offset_44))) (< check_~i~0_44 check_~n_44)) :named ssa_45))
(assert (! true :named ssa_46_GlobVarAssigCall))
(assert (! (= (ite (= check_~sum~0_44 |check_#t~mem10_45|) 1 0) |__VERIFIER_assert_#in~cond_46|) :named ssa_46_LocVarAssigCall))
...
(assert (! (and (= (+ check_~sum~0_44 (select (select |#memory_int#1_39| check_~a0.base_44) (+ (* check_~i~0_44 4) check_~a0.offset_44))) check_~sum~0_51) (= (+ check_~i~0_44 1) check_~i~0_51)) :named ssa_51))
(assert (! (and (= |check_#t~mem10_52| (select (select |#memory_int#1_39| check_~a.base_44) (+ (* check_~i~0_51 4) check_~a.offset_44))) (< check_~i~0_51 check_~n_44)) :named ssa_52))
(assert (! true :named ssa_53_GlobVarAssigCall))
(assert (! (= (ite (= check_~sum~0_51 |check_#t~mem10_52|) 1 0) |__VERIFIER_assert_#in~cond_53|) :named ssa_53_LocVarAssigCall))
...
(assert (! (not true) :named ssa_postcond))
(assert (! (and (= |#memory_int#1_0| (store |#memory_int#1_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_67_fresh_1)) (= ((as const (Array Int Int)) 0) v_ArrVal_67_fresh_1)) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! true :named ssa_-2_PendingContext))
...
(assert (! (= |#memory_int#1_-1| |old(#memory_int#1)_-1|) :named ssa_precond))
(assert (! (not true) :named ssa_postcond))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_68_fresh_1) (= (store |#memory_int#1_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_68_fresh_1) |#memory_int#1_0|)) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! true :named ssa_-2_PendingContext))
...
(assert (! (= |#memory_int#1_-1| |old(#memory_int#1)_-1|) :named ssa_precond))
(assert (! (not (<= main_~n~0_-2 1)) :named ssa_postcond))
...
(assert (! (<= main_~n~0_-2 1) :named ssa_-2_PendingContext))
...
(assert (! (= |#memory_int#1_-1| |old(#memory_int#1)_-1|) :named ssa_precond))
(assert (! (not (<= main_~n~0_-2 1)) :named ssa_postcond))
(assert (! (and (= downsweep_~space_0 (ite (and (not (= (mod |downsweep_#in~space_-1| 2) 0)) (< |downsweep_#in~space_-1| 0)) (+ (div |downsweep_#in~space_-1| 2) 1) (div |downsweep_#in~space_-1| 2))) (= downsweep_~a.base_0 |downsweep_#in~a.base_-1|) (= downsweep_~a.offset_0 |downsweep_#in~a.offset_-1|) (= v_ArrVal_69_fresh_1 0) (= |#memory_int#1_0| (store |#memory_int#1_-1| downsweep_~a.base_0 v_ArrVal_70_fresh_1)) (= downsweep_~n_0 |downsweep_#in~n_-1|) (= (store (select |#memory_int#1_-1| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (- 4) (* downsweep_~n_0 4)) v_ArrVal_69_fresh_1) v_ArrVal_70_fresh_1)) :named ssa_0))
...
(assert (! true :named ssa_precond))
(assert (! (not (and (<= check_~n_-2 1) (= check_~i~0_-2 0))) :named ssa_postcond))
...
(assert (! true :named ssa_2))
(assert (! true :named ssa_3_return))
(assert (! (and (<= check_~n_-2 1) (= check_~i~0_-2 0)) :named ssa_-2_PendingContext))
