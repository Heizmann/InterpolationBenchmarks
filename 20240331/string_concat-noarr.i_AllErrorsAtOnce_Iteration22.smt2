...
(set-info :ultimate-id string_concat-noarr.i_AllErrorsAtOnce_Iteration22)
...
(assert (! (or (<= 1000000 main_~i~0_47) (= |main_#t~nondet3_48| 0)) :named ssa_49))
(assert (! (< main_~j~0_47 100) :named ssa_50))
(assert (! true :named ssa_51_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_51| (ite (< main_~i~0_47 200) 1 0)) :named ssa_51_LocVarAssigCall))
