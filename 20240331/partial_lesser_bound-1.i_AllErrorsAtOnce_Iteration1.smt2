...
(set-info :ultimate-id partial_lesser_bound-1.i_AllErrorsAtOnce_Iteration1)
...
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_1_fresh_1) (< 0 |#StackHeapBarrier_-1|) (= |~#a~0.offset_1| 0) (= |~#a~0.base_1| 3) (= (select (select |#memory_int#0_0| 1) 1) 0) (= 40000000 (select |#length_-1| 3)) (= |#memory_int#1_1| (store |#memory_int#1_0| |~#a~0.base_1| v_ArrVal_1_fresh_1)) (= (select |#length_-1| 2) 25) (= (select |#valid_-1| 3) 1) (= (select |#valid_-1| 2) 1) (= (select (select |#memory_int#0_0| 1) 0) 48) (= ~i~0_1 0) (= (select |#valid_-1| 1) 1) (= (select |#length_-1| 1) 2) (= (select |#valid_-1| 0) 0)) :named ssa_1))
