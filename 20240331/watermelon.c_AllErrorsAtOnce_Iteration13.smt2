...
(set-info :ultimate-id watermelon.c_AllErrorsAtOnce_Iteration13)
...
(declare-fun v_main_~is_divisible1~0_18_fresh_1 () Int)
(declare-fun v_main_~is_divisible2~0_18_fresh_1 () Int)
...
(assert (! (and (= ~true~0_1 v_main_~is_divisible2~0_18_fresh_1) (= ~true~0_1 v_main_~is_divisible1~0_18_fresh_1)) :named ssa_4))
...
(assert (! (= student_version_~w_19 student_version_~i~1_23) :named ssa_25))
(assert (! true :named ssa_26))
(assert (! (= student_version_~is_divisible~1_19 |student_version_#res_27|) :named ssa_27))
...
(assert (! true :named ssa_precond))
(assert (! (not (or (< (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647) main_~w~0_-2) (< main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 6)))) :named ssa_postcond))
...
(assert (! (= student_version_~w_0 student_version_~i~1_4) :named ssa_6))
(assert (! true :named ssa_7))
(assert (! (= student_version_~is_divisible~1_0 |student_version_#res_8|) :named ssa_8))
(assert (! (= |main_#t~ret6_9| |student_version_#res_8|) :named ssa_9_return))
(assert (! (or (< (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647) main_~w~0_-2) (< main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 6))) :named ssa_-2_PendingContext))
