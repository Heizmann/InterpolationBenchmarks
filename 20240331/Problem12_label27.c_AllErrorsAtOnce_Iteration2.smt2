...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-30T23:56:30+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id Problem12_label27.c_AllErrorsAtOnce_Iteration2)
...
(assert (! (not (<= (+ ~a17~0_0 124) 0)) :named ssa_postcond))
