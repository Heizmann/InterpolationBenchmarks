...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-30T23:53:03+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id pr5.c_AllErrorsAtOnce_Iteration22)
...
(declare-fun |v_main_#t~mem6_57_fresh_1| () Int)
...
(declare-fun |v_main_#t~mem6_58_fresh_1| () Int)
...
(declare-fun |v_main_#t~mem6_59_fresh_1| () Int)
...
(declare-fun |v_main_#t~mem6_60_fresh_1| () Int)
...
(declare-fun |v_main_#t~mem6_61_fresh_1| () Int)
...
(declare-fun |main_#t~post9_61| () Int)
(declare-fun |main_#t~short8_61| () Bool)
(declare-fun |main_#t~short8_62| () Bool)
(declare-fun |v_main_#t~mem6_62_fresh_1| () Int)
(declare-fun |main_#t~short8_63| () Bool)
(declare-fun |v_main_#t~mem7_25_fresh_1| () Int)
(declare-fun |__VERIFIER_assert_#in~cond_64| () Int)
(declare-fun |main_#t~short8_64| () Bool)
...
(assert (! (and (= 2 main_~CCCELVOL5~0_5) (= |main_~#volArray~0.offset_5| 0) (< |#StackHeapBarrier_-1| |main_~#volArray~0.base_5|) (= 7 main_~CCCELVOL3~0_5) (= (select |#valid_3| |main_~#volArray~0.base_5|) 0) (= 5 main_~CCCELVOL4~0_5) (= |#valid_5| (store |#valid_3| |main_~#volArray~0.base_5| v_ArrVal_243_fresh_1)) (< 1 ~CELLCOUNT~0_4) (= 3 main_~CCCELVOL2~0_5) (= v_ArrVal_244_fresh_1 (* (mod ~CELLCOUNT~0_4 1073741824) 4)) (= (store |#length_3| |main_~#volArray~0.base_5| v_ArrVal_244_fresh_1) |#length_5|) (= main_~CCCELVOL1~0_5 1) (not (= |main_~#volArray~0.base_5| 0)) (= v_ArrVal_243_fresh_1 1)) :named ssa_5))
...
(assert (! (and (< main_~CCCELVOL5~0_5 main_~MINVAL~0_5) (= v_ArrVal_246_fresh_1 0) (= v_ArrVal_245_fresh_1 (store (select |#memory_int#1_3| |main_~#volArray~0.base_5|) (+ (- 20) |main_~#volArray~0.offset_5| (* main_~i~0_12 20)) 0)) (= (store |#memory_int#1_3| |main_~#volArray~0.base_5| v_ArrVal_245_fresh_1) |#memory_int#1_14|)) :named ssa_14))
(assert (! (and (= v_ArrVal_248_fresh_1 main_~CCCELVOL4~0_5) (= v_ArrVal_247_fresh_1 (store (select |#memory_int#1_14| |main_~#volArray~0.base_5|) (+ (* main_~i~0_12 20) |main_~#volArray~0.offset_5| (- 16)) main_~CCCELVOL4~0_5)) (= (store |#memory_int#1_14| |main_~#volArray~0.base_5| v_ArrVal_247_fresh_1) |#memory_int#1_15|) (<= main_~MINVAL~0_5 main_~CCCELVOL4~0_5)) :named ssa_15))
(assert (! (and (<= main_~MINVAL~0_5 main_~CCCELVOL3~0_5) (= v_ArrVal_249_fresh_1 main_~CCCELVOL3~0_5) (= |#memory_int#1_16| (store |#memory_int#1_15| |main_~#volArray~0.base_5| v_ArrVal_250_fresh_1)) (= v_ArrVal_250_fresh_1 (store (select |#memory_int#1_15| |main_~#volArray~0.base_5|) (+ (* main_~i~0_12 20) |main_~#volArray~0.offset_5| (- 12)) v_ArrVal_249_fresh_1))) :named ssa_16))
(assert (! (and (<= main_~MINVAL~0_5 main_~CCCELVOL2~0_5) (= v_ArrVal_252_fresh_1 main_~CCCELVOL2~0_5) (= (store |#memory_int#1_16| |main_~#volArray~0.base_5| v_ArrVal_251_fresh_1) |#memory_int#1_17|) (= v_ArrVal_251_fresh_1 (store (select |#memory_int#1_16| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_12 20) (- 8)) main_~CCCELVOL2~0_5))) :named ssa_17))
(assert (! (and (< main_~CCCELVOL1~0_5 main_~MINVAL~0_5) (= |#memory_int#1_18| (store |#memory_int#1_17| |main_~#volArray~0.base_5| v_ArrVal_254_fresh_1)) (= (store (select |#memory_int#1_17| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_12 20) (- 4)) v_ArrVal_253_fresh_1) v_ArrVal_254_fresh_1) (= v_ArrVal_253_fresh_1 0)) :named ssa_18))
...
(assert (! (and (< main_~i~0_21 ~CELLCOUNT~0_4) (or (and |main_#t~short8_22| (<= main_~MINVAL~0_5 |v_main_#t~mem6_57_fresh_1|)) (and (< |v_main_#t~mem6_57_fresh_1| main_~MINVAL~0_5) (not |main_#t~short8_22|))) (= (select (select |#memory_int#1_18| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_21 4))) |v_main_#t~mem6_57_fresh_1|)) :named ssa_22))
...
(assert (! (and (or (and |main_#t~short8_30| (<= main_~MINVAL~0_5 |v_main_#t~mem6_58_fresh_1|)) (and (not |main_#t~short8_30|) (< |v_main_#t~mem6_58_fresh_1| main_~MINVAL~0_5))) (< main_~i~0_29 ~CELLCOUNT~0_4) (= (select (select |#memory_int#1_18| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_29 4))) |v_main_#t~mem6_58_fresh_1|)) :named ssa_30))
...
(assert (! (and (or (and |main_#t~short8_38| (<= main_~MINVAL~0_5 |v_main_#t~mem6_59_fresh_1|)) (and (not |main_#t~short8_38|) (< |v_main_#t~mem6_59_fresh_1| main_~MINVAL~0_5))) (< main_~i~0_37 ~CELLCOUNT~0_4) (= (select (select |#memory_int#1_18| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_37 4))) |v_main_#t~mem6_59_fresh_1|)) :named ssa_38))
...
(assert (! (and (= (select (select |#memory_int#1_18| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_45 4))) |v_main_#t~mem6_60_fresh_1|) (< main_~i~0_45 ~CELLCOUNT~0_4) (or (and (< |v_main_#t~mem6_60_fresh_1| main_~MINVAL~0_5) (not |main_#t~short8_46|)) (and |main_#t~short8_46| (<= main_~MINVAL~0_5 |v_main_#t~mem6_60_fresh_1|)))) :named ssa_46))
...
(assert (! (and (or (and |main_#t~short8_54| (<= main_~MINVAL~0_5 |v_main_#t~mem6_61_fresh_1|)) (and (< |v_main_#t~mem6_61_fresh_1| main_~MINVAL~0_5) (not |main_#t~short8_54|))) (= (select (select |#memory_int#1_18| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_53 4))) |v_main_#t~mem6_61_fresh_1|) (< main_~i~0_53 ~CELLCOUNT~0_4)) :named ssa_54))
(assert (! |main_#t~short8_54| :named ssa_55))
(assert (! true :named ssa_56_GlobVarAssigCall))
(assert (! (= (ite |main_#t~short8_54| 1 0) |__VERIFIER_assert_#in~cond_56|) :named ssa_56_LocVarAssigCall))
...
(assert (! (= main_~i~0_61 (+ main_~i~0_53 1)) :named ssa_61))
(assert (! (and (= (select (select |#memory_int#1_18| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_61 4))) |v_main_#t~mem6_62_fresh_1|) (or (and (not |main_#t~short8_62|) (< |v_main_#t~mem6_62_fresh_1| main_~MINVAL~0_5)) (and |main_#t~short8_62| (<= main_~MINVAL~0_5 |v_main_#t~mem6_62_fresh_1|))) (< main_~i~0_61 ~CELLCOUNT~0_4)) :named ssa_62))
(assert (! (and (or (and (not (= |v_main_#t~mem7_25_fresh_1| 0)) (not |main_#t~short8_63|)) (and |main_#t~short8_63| (= |v_main_#t~mem7_25_fresh_1| 0))) (= |v_main_#t~mem7_25_fresh_1| (select (select |#memory_int#1_18| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_61 4)))) (not |main_#t~short8_62|)) :named ssa_63))
(assert (! true :named ssa_64_GlobVarAssigCall))
(assert (! (= (ite |main_#t~short8_63| 1 0) |__VERIFIER_assert_#in~cond_64|) :named ssa_64_LocVarAssigCall))
...
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 ssa_5 ssa_6 (and ssa_11_return ssa_7_LocVarAssigCall ssa_10 ssa_8 ssa_9 ssa_7_OldVarAssigCall ssa_7_GlobVarAssigCall) ssa_12 ssa_13 ssa_14 ssa_15 ssa_16 ssa_17 ssa_18 ssa_19 ssa_20 ssa_21 ssa_22 ssa_23 (and ssa_24_GlobVarAssigCall ssa_27 ssa_26 ssa_24_LocVarAssigCall ssa_25 ssa_28_return ssa_24_OldVarAssigCall) ssa_29 ssa_30 ssa_31 (and ssa_34 ssa_32_LocVarAssigCall ssa_32_OldVarAssigCall ssa_32_GlobVarAssigCall ssa_36_return ssa_33 ssa_35) ssa_37 ssa_38 ssa_39 (and ssa_40_OldVarAssigCall ssa_40_LocVarAssigCall ssa_40_GlobVarAssigCall ssa_43 ssa_44_return ssa_41 ssa_42) ssa_45 ssa_46 ssa_47 (and ssa_48_OldVarAssigCall ssa_50 ssa_48_GlobVarAssigCall ssa_51 ssa_49 ssa_48_LocVarAssigCall ssa_52_return) ssa_53 ssa_54 ssa_55 (and ssa_57 ssa_56_GlobVarAssigCall ssa_56_OldVarAssigCall ssa_56_LocVarAssigCall ssa_58 ssa_59 ssa_60_return) ssa_61 ssa_62 ssa_63 (and ssa_64_OldVarAssigCall ssa_64_GlobVarAssigCall ssa_64_LocVarAssigCall) ssa_65 ssa_66 (and ssa_67 ssa_postcond))
...
(assert (! true :named ssa_precond))
(assert (! (not (= ~CELLCOUNT~0_-2 (* 5 (div ~CELLCOUNT~0_-2 5)))) :named ssa_postcond))
...
(assert (! (= ~CELLCOUNT~0_-2 (* 5 (div ~CELLCOUNT~0_-2 5))) :named ssa_-2_PendingContext))
...
(assert (! true :named ssa_precond))
(assert (! (not (and (<= (div ~CELLCOUNT~0_-2 5) 1) (= ~CELLCOUNT~0_-2 (* 5 (div ~CELLCOUNT~0_-2 5))) (= main_~i~0_-2 0))) :named ssa_postcond))
...
(assert (! true :named ssa_2))
(assert (! true :named ssa_3_return))
(assert (! (and (<= (div ~CELLCOUNT~0_-2 5) 1) (= ~CELLCOUNT~0_-2 (* 5 (div ~CELLCOUNT~0_-2 5))) (= main_~i~0_-2 0)) :named ssa_-2_PendingContext))
...
(declare-fun __VERIFIER_assert_~cond_1 () Int)
(assert (! true :named ssa_precond))
(assert (! (not (and (<= (* 5 (div ~CELLCOUNT~0_-2 5)) (+ main_~i~0_-2 4)) (= ~CELLCOUNT~0_-2 (* 5 (div ~CELLCOUNT~0_-2 5))))) :named ssa_postcond))
(assert (! (= __VERIFIER_assert_~cond_0 |__VERIFIER_assert_#in~cond_-1|) :named ssa_0))
(assert (! (not (= __VERIFIER_assert_~cond_0 0)) :named ssa_1))
(assert (! true :named ssa_2))
(assert (! true :named ssa_3_return))
(assert (! (and (<= (* 5 (div ~CELLCOUNT~0_-2 5)) (+ main_~i~0_-2 4)) (= ~CELLCOUNT~0_-2 (* 5 (div ~CELLCOUNT~0_-2 5)))) :named ssa_-2_PendingContext))
(assert (! (= (ite |main_#t~short8_-2| 1 0) |__VERIFIER_assert_#in~cond_-1|) :named ssa_-2_LocVarAssignPendingContext))
(assert (! true :named ssa_-2_OldVarAssignPendingContext))
(check-sat)
(get-interpolants (and ssa_0 ssa_precond) ssa_1 ssa_2 (and ssa_-2_PendingContext ssa_3_return ssa_-2_LocVarAssignPendingContext ssa_-2_OldVarAssignPendingContext ssa_postcond))
...
(declare-fun __VERIFIER_assert_~cond_1 () Int)
(assert (! true :named ssa_precond))
(assert (! (not (and (= ~CELLCOUNT~0_-2 (* 5 (div ~CELLCOUNT~0_-2 5))) (<= (* 5 (div ~CELLCOUNT~0_-2 5)) (+ main_~i~0_-2 3)))) :named ssa_postcond))
(assert (! (= __VERIFIER_assert_~cond_0 |__VERIFIER_assert_#in~cond_-1|) :named ssa_0))
(assert (! (not (= __VERIFIER_assert_~cond_0 0)) :named ssa_1))
(assert (! true :named ssa_2))
(assert (! true :named ssa_3_return))
(assert (! (and (= ~CELLCOUNT~0_-2 (* 5 (div ~CELLCOUNT~0_-2 5))) (<= (* 5 (div ~CELLCOUNT~0_-2 5)) (+ main_~i~0_-2 3))) :named ssa_-2_PendingContext))
(assert (! (= (ite |main_#t~short8_-2| 1 0) |__VERIFIER_assert_#in~cond_-1|) :named ssa_-2_LocVarAssignPendingContext))
(assert (! true :named ssa_-2_OldVarAssignPendingContext))
(check-sat)
(get-interpolants (and ssa_0 ssa_precond) ssa_1 ssa_2 (and ssa_-2_PendingContext ssa_3_return ssa_-2_LocVarAssignPendingContext ssa_-2_OldVarAssignPendingContext ssa_postcond))
...
(declare-fun __VERIFIER_assert_~cond_1 () Int)
(assert (! true :named ssa_precond))
(assert (! (not (and (<= (* 5 (div ~CELLCOUNT~0_-2 5)) (+ main_~i~0_-2 2)) (= ~CELLCOUNT~0_-2 (* 5 (div ~CELLCOUNT~0_-2 5))))) :named ssa_postcond))
(assert (! (= __VERIFIER_assert_~cond_0 |__VERIFIER_assert_#in~cond_-1|) :named ssa_0))
(assert (! (not (= __VERIFIER_assert_~cond_0 0)) :named ssa_1))
(assert (! true :named ssa_2))
(assert (! true :named ssa_3_return))
(assert (! (and (<= (* 5 (div ~CELLCOUNT~0_-2 5)) (+ main_~i~0_-2 2)) (= ~CELLCOUNT~0_-2 (* 5 (div ~CELLCOUNT~0_-2 5)))) :named ssa_-2_PendingContext))
(assert (! (= (ite |main_#t~short8_-2| 1 0) |__VERIFIER_assert_#in~cond_-1|) :named ssa_-2_LocVarAssignPendingContext))
(assert (! true :named ssa_-2_OldVarAssignPendingContext))
(check-sat)
(get-interpolants (and ssa_0 ssa_precond) ssa_1 ssa_2 (and ssa_-2_PendingContext ssa_3_return ssa_-2_LocVarAssignPendingContext ssa_-2_OldVarAssignPendingContext ssa_postcond))
...
(declare-fun __VERIFIER_assert_~cond_1 () Int)
(assert (! true :named ssa_precond))
(assert (! (not (and (<= (* 5 (div ~CELLCOUNT~0_-2 5)) (+ main_~i~0_-2 1)) (= ~CELLCOUNT~0_-2 (* 5 (div ~CELLCOUNT~0_-2 5))))) :named ssa_postcond))
(assert (! (= __VERIFIER_assert_~cond_0 |__VERIFIER_assert_#in~cond_-1|) :named ssa_0))
(assert (! (not (= __VERIFIER_assert_~cond_0 0)) :named ssa_1))
(assert (! true :named ssa_2))
(assert (! true :named ssa_3_return))
(assert (! (and (<= (* 5 (div ~CELLCOUNT~0_-2 5)) (+ main_~i~0_-2 1)) (= ~CELLCOUNT~0_-2 (* 5 (div ~CELLCOUNT~0_-2 5)))) :named ssa_-2_PendingContext))
(assert (! (= (ite |main_#t~short8_-2| 1 0) |__VERIFIER_assert_#in~cond_-1|) :named ssa_-2_LocVarAssignPendingContext))
(assert (! true :named ssa_-2_OldVarAssignPendingContext))
(check-sat)
(get-interpolants (and ssa_0 ssa_precond) ssa_1 ssa_2 (and ssa_-2_PendingContext ssa_3_return ssa_-2_LocVarAssignPendingContext ssa_-2_OldVarAssignPendingContext ssa_postcond))
