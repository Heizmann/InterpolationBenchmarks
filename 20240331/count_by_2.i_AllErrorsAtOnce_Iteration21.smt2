...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration21)
...
(assert (! (<= 1000000 main_~i~0_24) :named ssa_25))
(assert (! true :named ssa_26_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_26| (ite (= main_~i~0_24 1000000) 1 0)) :named ssa_26_LocVarAssigCall))
