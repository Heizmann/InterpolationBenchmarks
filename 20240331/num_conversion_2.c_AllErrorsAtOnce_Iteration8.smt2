...
(set-info :ultimate-id num_conversion_2.c_AllErrorsAtOnce_Iteration8)
...
(assert (! (<= 8 (mod main_~c~0_39 256)) :named ssa_40))
(assert (! true :named ssa_41_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_41| (ite (= (mod main_~x~0_4 256) (mod main_~y~0_4 256)) 1 0)) :named ssa_41_LocVarAssigCall))
