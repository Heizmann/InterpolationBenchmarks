...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration46)
...
(assert (! (<= 1000000 main_~i~0_49) :named ssa_50))
(assert (! true :named ssa_51_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_51| (ite (= main_~i~0_49 1000000) 1 0)) :named ssa_51_LocVarAssigCall))
