...
(set-info :ultimate-id prefixsum_iter.c_AllErrorsAtOnce_Iteration8)
...
(declare-fun |v_#Ultimate.meminit_#productInParam_19_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#ptr.offsetInParam_19_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#amountOfFieldsInParam_19_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#sizeOfFieldsInParam_19_fresh_1| () Int)
...
(declare-fun |v_#Ultimate.meminit_#sizeOfFieldsInParam_20_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#ptr.offsetInParam_20_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#productInParam_20_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#amountOfFieldsInParam_20_fresh_1| () Int)
...
(declare-fun |check_#in~a.offset_51| () Int)
(declare-fun main_~a0~0.offset_51 () Int)
(declare-fun |check_#in~a.base_51| () Int)
(declare-fun main_~a~0.base_51 () Int)
(declare-fun main_~n~0_51 () Int)
(declare-fun main_~a~0.offset_51 () Int)
(declare-fun |check_#in~a0.base_51| () Int)
(declare-fun |check_#in~n_51| () Int)
(declare-fun main_~a0~0.base_51 () Int)
(declare-fun |check_#in~a0.offset_51| () Int)
(declare-fun check_~a0.base_52 () Int)
(declare-fun check_~a.base_52 () Int)
(declare-fun check_~a.offset_52 () Int)
(declare-fun check_~i~0_52 () Int)
(declare-fun check_~sum~0_52 () Int)
(declare-fun check_~a0.offset_52 () Int)
(declare-fun check_~n_52 () Int)
(declare-fun |check_#t~mem10_53| () Int)
...
(assert (! (and (not (= |main_#t~malloc15.base_21| 0)) (= (store |#valid_3| |main_#t~malloc15.base_21| v_ArrVal_105_fresh_1) |#valid_21|) (= |#length_21| (store |#length_3| |main_#t~malloc15.base_21| v_ArrVal_106_fresh_1)) (< |main_#t~malloc15.base_21| |#StackHeapBarrier_-1|) (= |main_#t~malloc15.offset_21| 0) (= v_ArrVal_105_fresh_1 1) (= v_ArrVal_106_fresh_1 (* (mod main_~n~0_4 1073741824) 4)) (= (select |#valid_3| |main_#t~malloc15.base_21|) 0)) :named ssa_21))
(assert (! (= |old(#memory_int#1)_22| |#memory_int#1_22|) :named ssa_22_GlobVarAssigCall))
(assert (! (and (= |#Ultimate.meminit_#ptr.base_22| |main_#t~malloc15.base_21|) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_19_fresh_1| 4) (= (* main_~n~0_4 4) |v_#Ultimate.meminit_#productInParam_19_fresh_1|) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_19_fresh_1|) (= |v_#Ultimate.meminit_#ptr.offsetInParam_19_fresh_1| |main_#t~malloc15.offset_21|)) :named ssa_22_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_22| |#memory_int#1_3|) :named ssa_22_OldVarAssigCall))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_107_fresh_1) (= (store |#memory_int#1_22| |#Ultimate.meminit_#ptr.base_22| v_ArrVal_107_fresh_1) |#memory_int#1_23|)) :named ssa_23))
(assert (! true :named ssa_24_return))
(assert (! (and (= v_ArrVal_108_fresh_1 1) (= (select |#valid_21| |main_#t~malloc16.base_25|) 0) (not (= |main_#t~malloc16.base_25| 0)) (= v_ArrVal_109_fresh_1 (* (mod main_~n~0_4 1073741824) 4)) (= |main_#t~malloc16.offset_25| 0) (= (store |#valid_21| |main_#t~malloc16.base_25| v_ArrVal_108_fresh_1) |#valid_25|) (= main_~a~0.offset_25 |main_#t~malloc15.offset_21|) (= main_~a~0.base_25 |main_#t~malloc15.base_21|) (< |main_#t~malloc16.base_25| |#StackHeapBarrier_-1|) (= |#length_25| (store |#length_21| |main_#t~malloc16.base_25| v_ArrVal_109_fresh_1))) :named ssa_25))
(assert (! (= |old(#memory_int#1)_26| |#memory_int#1_26|) :named ssa_26_GlobVarAssigCall))
(assert (! (and (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_20_fresh_1| 4) (= |v_#Ultimate.meminit_#ptr.offsetInParam_20_fresh_1| |main_#t~malloc16.offset_25|) (= (* main_~n~0_4 4) |v_#Ultimate.meminit_#productInParam_20_fresh_1|) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_20_fresh_1|) (= |#Ultimate.meminit_#ptr.base_26| |main_#t~malloc16.base_25|)) :named ssa_26_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_26| |#memory_int#1_23|) :named ssa_26_OldVarAssigCall))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_110_fresh_1) (= (store |#memory_int#1_26| |#Ultimate.meminit_#ptr.base_26| v_ArrVal_110_fresh_1) |#memory_int#1_27|)) :named ssa_27))
...
(assert (! (and (< main_~i~1_29 main_~n~0_4) (= |#memory_int#1_30| (store |#memory_int#1_27| main_~a0~0.base_29 v_ArrVal_112_fresh_1)) (= v_ArrVal_111_fresh_1 (select (select |#memory_int#1_27| main_~a~0.base_25) (+ main_~a~0.offset_25 (* main_~i~1_29 4)))) (= v_ArrVal_112_fresh_1 (store (select |#memory_int#1_27| main_~a0~0.base_29) (+ main_~a0~0.offset_29 (* main_~i~1_29 4)) v_ArrVal_111_fresh_1)) (= main_~i~1_30 (+ main_~i~1_29 1))) :named ssa_30))
(assert (! (and (< main_~i~1_30 main_~n~0_4) (= v_ArrVal_113_fresh_1 (select (select |#memory_int#1_30| main_~a~0.base_25) (+ main_~a~0.offset_25 (* main_~i~1_30 4)))) (= (store |#memory_int#1_30| main_~a0~0.base_29 v_ArrVal_114_fresh_1) |#memory_int#1_31|) (= (store (select |#memory_int#1_30| main_~a0~0.base_29) (+ main_~a0~0.offset_29 (* main_~i~1_30 4)) v_ArrVal_113_fresh_1) v_ArrVal_114_fresh_1) (= main_~i~1_31 (+ main_~i~1_30 1))) :named ssa_31))
...
(assert (! (and (= v_ArrVal_116_fresh_1 (+ (select (select |#memory_int#1_33| upsweep_~a.base_34) (+ (* upsweep_~left~0_35 4) upsweep_~a.offset_34)) (select (select |#memory_int#1_33| upsweep_~a.base_34) (+ (* upsweep_~left~0_35 4) upsweep_~a.offset_34 (* upsweep_~space~0_34 4))))) (< upsweep_~left~0_35 upsweep_~n_34) (= (store |#memory_int#1_33| upsweep_~a.base_34 v_ArrVal_115_fresh_1) |#memory_int#1_36|) (= (+ (* 2 upsweep_~space~0_34) upsweep_~left~0_35) upsweep_~left~0_36) (= (store (select |#memory_int#1_33| upsweep_~a.base_34) (+ (* upsweep_~left~0_35 4) upsweep_~a.offset_34 (* upsweep_~space~0_34 4)) (+ (select (select |#memory_int#1_33| upsweep_~a.base_34) (+ (* upsweep_~left~0_35 4) upsweep_~a.offset_34)) (select (select |#memory_int#1_33| upsweep_~a.base_34) (+ (* upsweep_~left~0_35 4) upsweep_~a.offset_34 (* upsweep_~space~0_34 4))))) v_ArrVal_115_fresh_1)) :named ssa_36))
...
(assert (! (and (= downsweep_~space_44 (ite (and (not (= (mod |downsweep_#in~space_43| 2) 0)) (< |downsweep_#in~space_43| 0)) (+ (div |downsweep_#in~space_43| 2) 1) (div |downsweep_#in~space_43| 2))) (= v_ArrVal_117_fresh_1 0) (= downsweep_~a.base_44 |downsweep_#in~a.base_43|) (= downsweep_~a.offset_44 |downsweep_#in~a.offset_43|) (= v_ArrVal_118_fresh_1 (store (select |#memory_int#1_43| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (- 4) (* downsweep_~n_44 4)) v_ArrVal_117_fresh_1)) (= |#memory_int#1_44| (store |#memory_int#1_43| downsweep_~a.base_44 v_ArrVal_118_fresh_1)) (= downsweep_~n_44 |downsweep_#in~n_43|)) :named ssa_44))
...
(assert (! (<= downsweep_~space_47 0) :named ssa_48))
(assert (! true :named ssa_49))
(assert (! true :named ssa_50_return))
(assert (! true :named ssa_51_GlobVarAssigCall))
(assert (! (and (= main_~a0~0.offset_29 |check_#in~a0.offset_51|) (= main_~a0~0.base_29 |check_#in~a0.base_51|) (= |check_#in~a.offset_51| main_~a~0.offset_25) (= main_~n~0_4 |check_#in~n_51|) (= |check_#in~a.base_51| main_~a~0.base_25)) :named ssa_51_LocVarAssigCall))
(assert (! true :named ssa_51_OldVarAssigCall))
(assert (! (and (= |check_#in~a.offset_51| check_~a.offset_52) (= |check_#in~a0.offset_51| check_~a0.offset_52) (= check_~a.base_52 |check_#in~a.base_51|) (= check_~i~0_52 0) (= check_~a0.base_52 |check_#in~a0.base_51|) (= check_~sum~0_52 0) (= check_~n_52 |check_#in~n_51|)) :named ssa_52))
(assert (! (and (= |check_#t~mem10_53| (select (select |#memory_int#1_44| check_~a.base_52) (+ (* check_~i~0_52 4) check_~a.offset_52))) (< check_~i~0_52 check_~n_52)) :named ssa_53))
(assert (! true :named ssa_54_GlobVarAssigCall))
(assert (! (= (ite (= check_~sum~0_52 |check_#t~mem10_53|) 1 0) |__VERIFIER_assert_#in~cond_54|) :named ssa_54_LocVarAssigCall))
...
(assert (! (not true) :named ssa_postcond))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_119_fresh_1) (= |#memory_int#1_0| (store |#memory_int#1_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_119_fresh_1))) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! true :named ssa_-2_PendingContext))
...
(assert (! (= |#memory_int#1_-1| |old(#memory_int#1)_-1|) :named ssa_precond))
(assert (! (not true) :named ssa_postcond))
(assert (! (and (= (store |#memory_int#1_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_120_fresh_1) |#memory_int#1_0|) (= ((as const (Array Int Int)) 0) v_ArrVal_120_fresh_1)) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! true :named ssa_-2_PendingContext))
...
(assert (! (= |#memory_int#1_-1| |old(#memory_int#1)_-1|) :named ssa_precond))
(assert (! (not (<= 2 main_~n~0_-2)) :named ssa_postcond))
...
(assert (! (= |#memory_int#1_-1| |old(#memory_int#1)_-1|) :named ssa_precond))
(assert (! (not false) :named ssa_postcond))
(assert (! (and (= downsweep_~space_0 (ite (and (not (= (mod |downsweep_#in~space_-1| 2) 0)) (< |downsweep_#in~space_-1| 0)) (+ (div |downsweep_#in~space_-1| 2) 1) (div |downsweep_#in~space_-1| 2))) (= downsweep_~a.base_0 |downsweep_#in~a.base_-1|) (= downsweep_~a.offset_0 |downsweep_#in~a.offset_-1|) (= (store |#memory_int#1_-1| downsweep_~a.base_0 v_ArrVal_124_fresh_1) |#memory_int#1_0|) (= downsweep_~n_0 |downsweep_#in~n_-1|) (= v_ArrVal_124_fresh_1 (store (select |#memory_int#1_-1| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (- 4) (* downsweep_~n_0 4)) v_ArrVal_123_fresh_1)) (= v_ArrVal_123_fresh_1 0)) :named ssa_0))
...
(assert (! (<= downsweep_~space_3 0) :named ssa_4))
