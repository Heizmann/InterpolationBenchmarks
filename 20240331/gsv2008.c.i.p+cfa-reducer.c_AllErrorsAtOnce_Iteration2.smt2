...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:09:50+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id gsv2008.c.i.p+cfa-reducer.c_AllErrorsAtOnce_Iteration2)
...
(declare-fun v_main_~main____CPAchecker_TMP_0~0_3_fresh_1 () Int)
...
(assert (! (and (= (+ main_~main__y~0_4 1) main_~main__y~0_7) (< main_~main__x~0_4 0) (= (+ main_~main__x~0_4 main_~main__y~0_4) main_~main__x~0_7) (= v_main_~main____CPAchecker_TMP_0~0_3_fresh_1 main_~main__y~0_4)) :named ssa_7))
(assert (! (and (<= 0 main_~main__x~0_7) (= (ite (< 0 main_~main__y~0_7) 1 0) v_main_~__tmp_1~0_5_fresh_1) (= v_main_~__tmp_1~0_5_fresh_1 main_~__VERIFIER_assert__cond~0_8)) :named ssa_8))
(assert (! (= main_~__VERIFIER_assert__cond~0_8 0) :named ssa_9))
