...
(set-info :ultimate-id watermelon.c_AllErrorsAtOnce_Iteration16)
...
(declare-fun v_main_~is_divisible2~0_21_fresh_1 () Int)
(declare-fun v_main_~is_divisible1~0_21_fresh_1 () Int)
...
(declare-fun student_version_~w_26 () Int)
...
(declare-fun student_version_~is_divisible~1_28 () Int)
...
(declare-fun main_~is_divisible1~0_31 () Int)
...
(assert (! (and (= ~true~0_1 v_main_~is_divisible2~0_21_fresh_1) (= ~true~0_1 v_main_~is_divisible1~0_21_fresh_1)) :named ssa_4))
...
(assert (! (and (= (+ 2 student_version_~i~1_23) student_version_~i~1_24) (< student_version_~i~1_23 student_version_~w_19)) :named ssa_24))
(assert (! (<= student_version_~w_19 student_version_~i~1_24) :named ssa_25))
(assert (! (and (not (= student_version_~w_19 student_version_~i~1_24)) (= ~false~0_1 student_version_~is_divisible~1_26)) :named ssa_26))
(assert (! true :named ssa_27))
(assert (! (= student_version_~is_divisible~1_26 |student_version_#res_28|) :named ssa_28))
(assert (! (= |main_#t~ret6_29| |student_version_#res_28|) :named ssa_29_return))
(assert (! (and (<= |main_#t~ret6_29| 2147483647) (= main_~is_divisible2~0_30 |main_#t~ret6_29|) (<= 0 (+ |main_#t~ret6_29| 2147483648))) :named ssa_30))
(assert (! true :named ssa_31_GlobVarAssigCall))
(assert (! (= (ite (= main_~is_divisible1~0_17 main_~is_divisible2~0_30) 1 0) |__VERIFIER_assert_#in~cond_31|) :named ssa_31_LocVarAssigCall))
...
(assert (! true :named ssa_precond))
(assert (! (not (or (< (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647) main_~w~0_-2) (< main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 7)))) :named ssa_postcond))
...
(assert (! (and (not (= student_version_~w_0 student_version_~i~1_5)) (= ~false~0_-1 student_version_~is_divisible~1_7)) :named ssa_7))
(assert (! true :named ssa_8))
(assert (! (= student_version_~is_divisible~1_7 |student_version_#res_9|) :named ssa_9))
(assert (! (= |main_#t~ret6_10| |student_version_#res_9|) :named ssa_10_return))
(assert (! (or (< (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647) main_~w~0_-2) (< main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 7))) :named ssa_-2_PendingContext))
