...
(set-info :ultimate-id mono-crafted_11.c_AllErrorsAtOnce_Iteration23)
...
(assert (! (<= 100000000 (mod main_~x~0_46 4294967296)) :named ssa_47))
(assert (! true :named ssa_48_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_48| (ite (= (mod main_~x~0_46 2) 0) 1 0)) :named ssa_48_LocVarAssigCall))
