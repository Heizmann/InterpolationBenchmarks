...
(set-info :ultimate-id id2_b3_o5.c_AllErrorsAtOnce_Iteration5)
...
(assert (! (and (= |id_#res_21| 3) (< 3 (mod id_~ret~0_20 4294967296))) :named ssa_21))
...
(assert (! (and (= |id_#res_15| 3) (< 3 (mod id_~ret~0_14 4294967296))) :named ssa_15))
