...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-30T23:50:43+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id brs2.c_AllErrorsAtOnce_Iteration10)
...
(declare-fun |main_~#sum~0.offset_39| () Int)
...
(assert (! (and (= v_ArrVal_101_fresh_1 1) (= (select |#valid_3| |main_~#sum~0.base_11|) 0) (< |#StackHeapBarrier_-1| |main_~#sum~0.base_11|) (= (store (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_100_fresh_1) main_~a~0.base_11 v_ArrVal_101_fresh_1) |#valid_11|) (< main_~a~0.base_11 |#StackHeapBarrier_-1|) (= |main_~#sum~0.offset_11| 0) (= v_ArrVal_100_fresh_1 1) (= (* (mod ~N~0_4 1073741824) 4) v_ArrVal_99_fresh_1) (= (store (store |#length_3| |main_~#sum~0.base_11| v_ArrVal_102_fresh_1) main_~a~0.base_11 v_ArrVal_99_fresh_1) |#length_11|) (= (select (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_100_fresh_1) main_~a~0.base_11) 0) (not (= |main_~#sum~0.base_11| 0)) (= v_ArrVal_102_fresh_1 8) (= main_~a~0.offset_11 0) (not (= main_~a~0.base_11 0)) (= main_~i~0_11 0)) :named ssa_11))
(assert (! (< main_~i~0_11 ~N~0_4) :named ssa_12))
(assert (! (and (= v_ArrVal_104_fresh_1 (store (select |#memory_int#3_3| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_11 4)) v_ArrVal_103_fresh_1)) (= (store |#memory_int#3_3| main_~a~0.base_11 v_ArrVal_104_fresh_1) |#memory_int#3_13|) (= (ite (and (< main_~i~0_11 0) (not (= (mod main_~i~0_11 2) 0))) (+ (mod main_~i~0_11 2) (- 2)) (mod main_~i~0_11 2)) 0) (= v_ArrVal_103_fresh_1 2)) :named ssa_13))
(assert (! (= main_~i~0_14 (+ main_~i~0_11 1)) :named ssa_14))
(assert (! (< main_~i~0_14 ~N~0_4) :named ssa_15))
(assert (! (and (= (store |#memory_int#3_13| main_~a~0.base_11 v_ArrVal_105_fresh_1) |#memory_int#3_16|) (= v_ArrVal_106_fresh_1 0) (not (= (ite (and (not (= (mod main_~i~0_14 2) 0)) (< main_~i~0_14 0)) (+ (- 2) (mod main_~i~0_14 2)) (mod main_~i~0_14 2)) 0)) (= v_ArrVal_105_fresh_1 (store (select |#memory_int#3_13| main_~a~0.base_11) (+ (* main_~i~0_14 4) main_~a~0.offset_11) 0))) :named ssa_16))
(assert (! (= main_~i~0_17 (+ main_~i~0_14 1)) :named ssa_17))
(assert (! (< main_~i~0_17 ~N~0_4) :named ssa_18))
(assert (! (and (= v_ArrVal_107_fresh_1 2) (= (ite (and (< main_~i~0_17 0) (not (= (mod main_~i~0_17 2) 0))) (+ (mod main_~i~0_17 2) (- 2)) (mod main_~i~0_17 2)) 0) (= v_ArrVal_108_fresh_1 (store (select |#memory_int#3_16| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_17 4)) v_ArrVal_107_fresh_1)) (= (store |#memory_int#3_16| main_~a~0.base_11 v_ArrVal_108_fresh_1) |#memory_int#3_19|)) :named ssa_19))
(assert (! (= main_~i~0_20 (+ main_~i~0_17 1)) :named ssa_20))
(assert (! (< main_~i~0_20 ~N~0_4) :named ssa_21))
(assert (! (and (= v_ArrVal_109_fresh_1 (store (select |#memory_int#3_19| main_~a~0.base_11) (+ (* main_~i~0_20 4) main_~a~0.offset_11) 0)) (not (= (ite (and (not (= (mod main_~i~0_20 2) 0)) (< main_~i~0_20 0)) (+ (- 2) (mod main_~i~0_20 2)) (mod main_~i~0_20 2)) 0)) (= (store |#memory_int#3_19| main_~a~0.base_11 v_ArrVal_109_fresh_1) |#memory_int#3_22|) (= v_ArrVal_110_fresh_1 0)) :named ssa_22))
...
(assert (! (and (= v_ArrVal_111_fresh_1 0) (= main_~i~0_25 0) (= (store |#memory_int#1_3| |main_~#sum~0.base_11| v_ArrVal_112_fresh_1) |#memory_int#1_27|) (= v_ArrVal_112_fresh_1 (store (select |#memory_int#1_3| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| v_ArrVal_111_fresh_1))) :named ssa_27))
(assert (! (= main_~i~0_28 (+ main_~i~0_25 1)) :named ssa_28))
(assert (! (< main_~i~0_28 ~N~0_4) :named ssa_29))
(assert (! (and (= v_ArrVal_114_fresh_1 (store (select |#memory_int#1_27| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| v_ArrVal_113_fresh_1)) (= v_ArrVal_113_fresh_1 (+ (select (select |#memory_int#1_27| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|) (select (select |#memory_int#3_22| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_28 4))))) (= (store |#memory_int#1_27| |main_~#sum~0.base_11| v_ArrVal_114_fresh_1) |#memory_int#1_30|) (not (= main_~i~0_28 0))) :named ssa_30))
(assert (! (= main_~i~0_31 (+ main_~i~0_28 1)) :named ssa_31))
(assert (! (< main_~i~0_31 ~N~0_4) :named ssa_32))
(assert (! (and (= v_ArrVal_116_fresh_1 (store (select |#memory_int#1_30| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| v_ArrVal_115_fresh_1)) (= (store |#memory_int#1_30| |main_~#sum~0.base_11| v_ArrVal_116_fresh_1) |#memory_int#1_33|) (= v_ArrVal_115_fresh_1 (+ (select (select |#memory_int#1_30| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|) (select (select |#memory_int#3_22| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_31 4))))) (not (= main_~i~0_31 0))) :named ssa_33))
(assert (! (= main_~i~0_34 (+ main_~i~0_31 1)) :named ssa_34))
(assert (! (< main_~i~0_34 ~N~0_4) :named ssa_35))
(assert (! (and (= v_ArrVal_117_fresh_1 (+ (select (select |#memory_int#1_33| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|) (select (select |#memory_int#3_22| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_34 4))))) (= v_ArrVal_118_fresh_1 (store (select |#memory_int#1_33| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| v_ArrVal_117_fresh_1)) (= (store |#memory_int#1_33| |main_~#sum~0.base_11| v_ArrVal_118_fresh_1) |#memory_int#1_36|) (not (= main_~i~0_34 0))) :named ssa_36))
(assert (! (= main_~i~0_37 (+ main_~i~0_34 1)) :named ssa_37))
(assert (! (<= ~N~0_4 main_~i~0_37) :named ssa_38))
(assert (! (= |main_#t~mem10_39| (select (select |#memory_int#1_36| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|)) :named ssa_39))
(assert (! true :named ssa_40_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_40| (ite (<= |main_#t~mem10_39| (* 2 ~N~0_4)) 1 0)) :named ssa_40_LocVarAssigCall))
