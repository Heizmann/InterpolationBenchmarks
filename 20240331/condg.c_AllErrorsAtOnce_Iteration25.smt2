...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-30T23:51:11+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id condg.c_AllErrorsAtOnce_Iteration25)
...
(declare-fun |main_#t~post15_44| () Int)
...
(assert (! (and (= v_ArrVal_538_fresh_1 0) (< |#StackHeapBarrier_-1| |main_~#sum~0.base_11|) (= (select |#valid_3| |main_~#sum~0.base_11|) 0) (not (= |main_~#sum~0.base_11| 0)) (= v_ArrVal_536_fresh_1 1) (< main_~a~0.base_11 |#StackHeapBarrier_-1|) (= main_~i~0_11 0) (= v_ArrVal_539_fresh_1 (* (mod ~N~0_4 1073741824) 4)) (= (select (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_540_fresh_1) main_~a~0.base_11) 0) (= |#valid_11| (store (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_540_fresh_1) main_~a~0.base_11 v_ArrVal_536_fresh_1)) (= v_ArrVal_535_fresh_1 (store (select |#memory_int#1_3| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| 0)) (= |#length_11| (store (store |#length_3| |main_~#sum~0.base_11| v_ArrVal_537_fresh_1) main_~a~0.base_11 v_ArrVal_539_fresh_1)) (= |main_~#sum~0.offset_11| 0) (= main_~a~0.offset_11 0) (= (store |#memory_int#1_3| |main_~#sum~0.base_11| v_ArrVal_535_fresh_1) |#memory_int#1_11|) (not (= main_~a~0.base_11 0)) (= v_ArrVal_540_fresh_1 1) (= v_ArrVal_537_fresh_1 4)) :named ssa_11))
(assert (! (and (= main_~i~0_12 (+ main_~i~0_11 1)) (= v_ArrVal_541_fresh_1 (store (select |#memory_int#3_3| main_~a~0.base_11) (+ (* main_~i~0_11 4) main_~a~0.offset_11) 1)) (= v_ArrVal_542_fresh_1 1) (= |#memory_int#3_12| (store |#memory_int#3_3| main_~a~0.base_11 v_ArrVal_541_fresh_1)) (< main_~i~0_11 ~N~0_4)) :named ssa_12))
(assert (! (and (= v_ArrVal_543_fresh_1 (store (select |#memory_int#3_12| main_~a~0.base_11) (+ (* main_~i~0_12 4) main_~a~0.offset_11) 1)) (= main_~i~0_13 (+ main_~i~0_12 1)) (= |#memory_int#3_13| (store |#memory_int#3_12| main_~a~0.base_11 v_ArrVal_543_fresh_1)) (= v_ArrVal_544_fresh_1 1) (< main_~i~0_12 ~N~0_4)) :named ssa_13))
(assert (! (and (= v_ArrVal_545_fresh_1 (store (select |#memory_int#3_13| main_~a~0.base_11) (+ (* main_~i~0_13 4) main_~a~0.offset_11) 1)) (= main_~i~0_14 (+ main_~i~0_13 1)) (= v_ArrVal_546_fresh_1 1) (= (store |#memory_int#3_13| main_~a~0.base_11 v_ArrVal_545_fresh_1) |#memory_int#3_14|) (< main_~i~0_13 ~N~0_4)) :named ssa_14))
(assert (! (and (= main_~i~0_15 (+ main_~i~0_14 1)) (= |#memory_int#3_15| (store |#memory_int#3_14| main_~a~0.base_11 v_ArrVal_547_fresh_1)) (= v_ArrVal_547_fresh_1 (store (select |#memory_int#3_14| main_~a~0.base_11) (+ (* main_~i~0_14 4) main_~a~0.offset_11) 1)) (= v_ArrVal_548_fresh_1 1) (< main_~i~0_14 ~N~0_4)) :named ssa_15))
(assert (! (<= ~N~0_4 main_~i~0_15) :named ssa_16))
(assert (! (= main_~i~0_17 0) :named ssa_17))
(assert (! (and (= (store |#memory_int#1_11| |main_~#sum~0.base_11| v_ArrVal_549_fresh_1) |#memory_int#1_18|) (< main_~i~0_17 ~N~0_4) (= v_ArrVal_549_fresh_1 (store (select |#memory_int#1_11| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| (+ (select (select |#memory_int#3_15| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_17 4))) (select (select |#memory_int#1_11| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|)))) (= main_~i~0_18 (+ main_~i~0_17 1)) (= v_ArrVal_550_fresh_1 (+ (select (select |#memory_int#3_15| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_17 4))) (select (select |#memory_int#1_11| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|)))) :named ssa_18))
(assert (! (and (= v_ArrVal_552_fresh_1 (+ (select (select |#memory_int#3_15| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_18 4))) (select (select |#memory_int#1_18| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|))) (< main_~i~0_18 ~N~0_4) (= v_ArrVal_551_fresh_1 (store (select |#memory_int#1_18| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| (+ (select (select |#memory_int#3_15| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_18 4))) (select (select |#memory_int#1_18| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|)))) (= main_~i~0_19 (+ main_~i~0_18 1)) (= (store |#memory_int#1_18| |main_~#sum~0.base_11| v_ArrVal_551_fresh_1) |#memory_int#1_19|)) :named ssa_19))
(assert (! (and (= |#memory_int#1_20| (store |#memory_int#1_19| |main_~#sum~0.base_11| v_ArrVal_553_fresh_1)) (= v_ArrVal_554_fresh_1 (+ (select (select |#memory_int#3_15| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_19 4))) (select (select |#memory_int#1_19| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|))) (< main_~i~0_19 ~N~0_4) (= v_ArrVal_553_fresh_1 (store (select |#memory_int#1_19| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| (+ (select (select |#memory_int#3_15| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_19 4))) (select (select |#memory_int#1_19| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|)))) (= main_~i~0_20 (+ main_~i~0_19 1))) :named ssa_20))
(assert (! (and (= (store |#memory_int#1_20| |main_~#sum~0.base_11| v_ArrVal_555_fresh_1) |#memory_int#1_21|) (< main_~i~0_20 ~N~0_4) (= v_ArrVal_556_fresh_1 (+ (select (select |#memory_int#3_15| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_20 4))) (select (select |#memory_int#1_20| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|))) (= v_ArrVal_555_fresh_1 (store (select |#memory_int#1_20| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| (+ (select (select |#memory_int#3_15| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_20 4))) (select (select |#memory_int#1_20| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|)))) (= main_~i~0_21 (+ main_~i~0_20 1))) :named ssa_21))
...
(assert (! (and (= (store (select |#memory_int#3_15| main_~a~0.base_11) (+ (* main_~i~0_23 4) main_~a~0.offset_11) v_ArrVal_557_fresh_1) v_ArrVal_558_fresh_1) (= (+ v_ArrVal_557_fresh_1 1) (select (select |#memory_int#3_15| main_~a~0.base_11) (+ (* main_~i~0_23 4) main_~a~0.offset_11))) (= (store |#memory_int#3_15| main_~a~0.base_11 v_ArrVal_558_fresh_1) |#memory_int#3_25|) (= |main_#t~mem10_24| ~N~0_4)) :named ssa_25))
...
(assert (! (and (= v_ArrVal_560_fresh_1 (store (select |#memory_int#3_25| main_~a~0.base_11) (+ (* main_~i~0_26 4) main_~a~0.offset_11) v_ArrVal_559_fresh_1)) (= (store |#memory_int#3_25| main_~a~0.base_11 v_ArrVal_560_fresh_1) |#memory_int#3_28|) (= (+ v_ArrVal_559_fresh_1 1) (select (select |#memory_int#3_25| main_~a~0.base_11) (+ (* main_~i~0_26 4) main_~a~0.offset_11))) (= |main_#t~mem10_27| ~N~0_4)) :named ssa_28))
...
(assert (! (and (= (select (select |#memory_int#3_28| main_~a~0.base_11) (+ (* main_~i~0_29 4) main_~a~0.offset_11)) (+ v_ArrVal_561_fresh_1 1)) (= v_ArrVal_562_fresh_1 (store (select |#memory_int#3_28| main_~a~0.base_11) (+ (* main_~i~0_29 4) main_~a~0.offset_11) v_ArrVal_561_fresh_1)) (= |main_#t~mem10_30| ~N~0_4) (= (store |#memory_int#3_28| main_~a~0.base_11 v_ArrVal_562_fresh_1) |#memory_int#3_31|)) :named ssa_31))
...
(assert (! (and (= (+ v_ArrVal_563_fresh_1 1) (select (select |#memory_int#3_31| main_~a~0.base_11) (+ (* main_~i~0_32 4) main_~a~0.offset_11))) (= v_ArrVal_564_fresh_1 (store (select |#memory_int#3_31| main_~a~0.base_11) (+ (* main_~i~0_32 4) main_~a~0.offset_11) v_ArrVal_563_fresh_1)) (= (store |#memory_int#3_31| main_~a~0.base_11 v_ArrVal_564_fresh_1) |#memory_int#3_34|) (= |main_#t~mem10_33| ~N~0_4)) :named ssa_34))
(assert (! (= main_~i~0_35 (+ main_~i~0_32 1)) :named ssa_35))
(assert (! (<= ~N~0_4 main_~i~0_35) :named ssa_36))
(assert (! (= main_~i~0_37 0) :named ssa_37))
(assert (! (and (< main_~i~0_37 ~N~0_4) (= |main_#t~mem14_38| (select (select |#memory_int#3_34| main_~a~0.base_11) (+ (* main_~i~0_37 4) main_~a~0.offset_11)))) :named ssa_38))
(assert (! true :named ssa_39_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_39| (ite (= |main_#t~mem14_38| 0) 1 0)) :named ssa_39_LocVarAssigCall))
...
(assert (! (= main_~i~0_44 (+ main_~i~0_37 1)) :named ssa_44))
(assert (! (and (< main_~i~0_44 ~N~0_4) (= |main_#t~mem14_45| (select (select |#memory_int#3_34| main_~a~0.base_11) (+ (* main_~i~0_44 4) main_~a~0.offset_11)))) :named ssa_45))
(assert (! true :named ssa_46_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_46| (ite (= |main_#t~mem14_45| 0) 1 0)) :named ssa_46_LocVarAssigCall))
...
(declare-fun |main_#t~mem14_-2| () Int)
(declare-fun |__VERIFIER_assert_#in~cond_-1| () Int)
(declare-fun |main_#t~mem14_-1| () Int)
(declare-fun __VERIFIER_assert_~cond_0 () Int)
(declare-fun __VERIFIER_assert_~cond_1 () Int)
(assert (! true :named ssa_precond))
(assert (! (not (and (= (select (select |#memory_int#3_-2| main_~a~0.base_-2) 4) 0) (= main_~a~0.offset_-2 0) (= main_~i~0_-2 0))) :named ssa_postcond))
...
(assert (! true :named ssa_2))
(assert (! true :named ssa_3_return))
(assert (! (and (= (select (select |#memory_int#3_-2| main_~a~0.base_-2) 4) 0) (= main_~a~0.offset_-2 0) (= main_~i~0_-2 0)) :named ssa_-2_PendingContext))
(assert (! (= |__VERIFIER_assert_#in~cond_-1| (ite (= |main_#t~mem14_-2| 0) 1 0)) :named ssa_-2_LocVarAssignPendingContext))
(assert (! true :named ssa_-2_OldVarAssignPendingContext))
(check-sat)
(get-interpolants (and ssa_0 ssa_precond) ssa_1 ssa_2 (and ssa_-2_PendingContext ssa_3_return ssa_-2_LocVarAssignPendingContext ssa_-2_OldVarAssignPendingContext ssa_postcond))
(echo "finished trace check")
