...
(set-info :ultimate-id zonotope_3.c_AllErrorsAtOnce_Iteration5)
...
(declare-fun v_main_~y~0_13_fresh_1 () Real)
...
(declare-fun v_main_~z~0_13_fresh_1 () Real)
...
(declare-fun v_main_~u~0_11_fresh_1 () Real)
...
(declare-fun v_~someBinaryFLOATComparisonOperation_27_fresh_1 () Bool)
(declare-fun v_~someBinaryFLOATComparisonOperation_28_fresh_1 () Bool)
...
(declare-fun v_main_~y~0_14_fresh_1 () Real)
...
(declare-fun v_main_~z~0_14_fresh_1 () Real)
...
(declare-fun v_~someBinaryFLOATComparisonOperation_30_fresh_1 () Bool)
(declare-fun v_~someBinaryFLOATComparisonOperation_29_fresh_1 () Bool)
...
(declare-fun v_main_~y~0_15_fresh_1 () Real)
...
(declare-fun v_main_~z~0_15_fresh_1 () Real)
...
(declare-fun v_~someBinaryFLOATComparisonOperation_31_fresh_1 () Bool)
(declare-fun v_~someBinaryFLOATComparisonOperation_32_fresh_1 () Bool)
...
(declare-fun v_main_~y~0_16_fresh_1 () Real)
...
(declare-fun v_main_~z~0_16_fresh_1 () Real)
...
(declare-fun main_~t~0_88 () Real)
(declare-fun |__VERIFIER_assert_#in~cond_89| () Int)
(declare-fun v_~someBinaryFLOATComparisonOperation_34_fresh_1 () Bool)
(declare-fun v_~someBinaryFLOATComparisonOperation_33_fresh_1 () Bool)
(declare-fun __VERIFIER_assert_~cond_90 () Int)
...
(assert (! (= v_main_~y~0_13_fresh_1 |main_#t~ret4_7|) :named ssa_8))
...
(assert (! (= v_main_~z~0_13_fresh_1 |main_#t~ret5_11|) :named ssa_12))
...
(assert (! (= v_main_~u~0_11_fresh_1 |main_#t~ret6_15|) :named ssa_16))
...
(assert (! (= (ite (and v_~someBinaryFLOATComparisonOperation_27_fresh_1 v_~someBinaryFLOATComparisonOperation_28_fresh_1) 1 0) |assume_abort_if_not_#in~cond_22|) :named ssa_22_LocVarAssigCall))
...
(assert (! (= v_main_~y~0_14_fresh_1 |main_#t~ret9_29|) :named ssa_30))
...
(assert (! (= v_main_~z~0_14_fresh_1 |main_#t~ret10_33|) :named ssa_34))
...
(assert (! (= |assume_abort_if_not_#in~cond_44| (ite (and v_~someBinaryFLOATComparisonOperation_29_fresh_1 v_~someBinaryFLOATComparisonOperation_30_fresh_1) 1 0)) :named ssa_44_LocVarAssigCall))
...
(assert (! (= v_main_~y~0_15_fresh_1 |main_#t~ret9_51|) :named ssa_52))
...
(assert (! (= v_main_~z~0_15_fresh_1 |main_#t~ret10_55|) :named ssa_56))
...
(assert (! (= |assume_abort_if_not_#in~cond_66| (ite (and v_~someBinaryFLOATComparisonOperation_32_fresh_1 v_~someBinaryFLOATComparisonOperation_31_fresh_1) 1 0)) :named ssa_66_LocVarAssigCall))
...
(assert (! (= v_main_~y~0_16_fresh_1 |main_#t~ret9_73|) :named ssa_74))
...
(assert (! (= v_main_~z~0_16_fresh_1 |main_#t~ret10_77|) :named ssa_78))
