...
(set-info :ultimate-id array_ptr_single_elem_init-1.i_AllErrorsAtOnce_Iteration9)
...
(assert (! (and (< 0 |#StackHeapBarrier_-1|) (= (select |#valid_-1| 0) 0) (= 31 (select |#length_-1| 2)) (= (select |#valid_-1| 2) 1) (= |~#a~0.base_1| 3) (= ((as const (Array Int Int)) 0) v_ArrVal_201_fresh_1) (= (select |#valid_-1| 3) 1) (= ((as const (Array Int Int)) 0) v_ArrVal_202_fresh_1) (= |~#a~0.offset_1| 0) (= (store |#memory_$Pointer$#1.base_0| |~#a~0.base_1| v_ArrVal_201_fresh_1) |#memory_$Pointer$#1.base_1|) (= (select |#valid_-1| 1) 1) (= |#memory_$Pointer$#1.offset_1| (store |#memory_$Pointer$#1.offset_0| |~#a~0.base_1| v_ArrVal_202_fresh_1)) (= (select (select |#memory_int#0_-1| 1) 1) 0) (= 2 (select |#length_-1| 1)) (= (select |#length_-1| 3) 400000) (= (select (select |#memory_int#0_-1| 1) 0) 48)) :named ssa_1))
...
(assert (! (and (= v_ArrVal_208_fresh_1 (store (select |#memory_$Pointer$#1.offset_3| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4)) v_ArrVal_205_fresh_1)) (= v_ArrVal_206_fresh_1 (store (select |#memory_$Pointer$#1.base_3| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4)) main_~s~0.base_5)) (= main_~i~0_8 (+ main_~i~0_4 1)) (= (store |#memory_$Pointer$#1.base_3| |~#a~0.base_1| v_ArrVal_206_fresh_1) |#memory_$Pointer$#1.base_8|) (= v_ArrVal_207_fresh_1 main_~s~0.base_5) (= v_ArrVal_204_fresh_1 (select (select |#memory_int#1_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4)))) (= (store |#memory_int#1_3| |~#a~0.base_1| v_ArrVal_203_fresh_1) |#memory_int#1_8|) (= |#memory_$Pointer$#1.offset_8| (store |#memory_$Pointer$#1.offset_3| |~#a~0.base_1| v_ArrVal_208_fresh_1)) (= v_ArrVal_205_fresh_1 main_~s~0.offset_5) (= v_ArrVal_203_fresh_1 (store (select |#memory_int#1_3| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4)) (select (select |#memory_int#1_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4)))))) :named ssa_8))
...
(assert (! (and (= v_ArrVal_209_fresh_1 (store (select |#memory_int#1_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_8 4)) (select (select |#memory_int#1_12| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_8 4))))) (= |#memory_$Pointer$#1.offset_12| (store |#memory_$Pointer$#1.offset_8| |~#a~0.base_1| v_ArrVal_214_fresh_1)) (= v_ArrVal_214_fresh_1 (store (select |#memory_$Pointer$#1.offset_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_8 4)) v_ArrVal_211_fresh_1)) (= v_ArrVal_210_fresh_1 (select (select |#memory_int#1_12| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_8 4)))) (= main_~i~0_12 (+ main_~i~0_8 1)) (= (store |#memory_$Pointer$#1.base_8| |~#a~0.base_1| v_ArrVal_212_fresh_1) |#memory_$Pointer$#1.base_12|) (= (store |#memory_int#1_8| |~#a~0.base_1| v_ArrVal_209_fresh_1) |#memory_int#1_12|) (= v_ArrVal_212_fresh_1 (store (select |#memory_$Pointer$#1.base_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_8 4)) main_~s~0.base_9)) (= v_ArrVal_213_fresh_1 main_~s~0.base_9) (= v_ArrVal_211_fresh_1 main_~s~0.offset_9)) :named ssa_12))
...
(assert (! (and (= |#memory_$Pointer$#1.base_16| (store |#memory_$Pointer$#1.base_12| |~#a~0.base_1| v_ArrVal_218_fresh_1)) (= v_ArrVal_217_fresh_1 main_~s~0.offset_13) (= v_ArrVal_219_fresh_1 main_~s~0.base_13) (= main_~i~0_16 (+ main_~i~0_12 1)) (= v_ArrVal_218_fresh_1 (store (select |#memory_$Pointer$#1.base_12| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_12 4)) main_~s~0.base_13)) (= v_ArrVal_220_fresh_1 (store (select |#memory_$Pointer$#1.offset_12| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_12 4)) v_ArrVal_217_fresh_1)) (= (store |#memory_int#1_12| |~#a~0.base_1| v_ArrVal_215_fresh_1) |#memory_int#1_16|) (= |#memory_$Pointer$#1.offset_16| (store |#memory_$Pointer$#1.offset_12| |~#a~0.base_1| v_ArrVal_220_fresh_1)) (= v_ArrVal_216_fresh_1 (select (select |#memory_int#1_16| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_12 4)))) (= v_ArrVal_215_fresh_1 (store (select |#memory_int#1_12| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_12 4)) (select (select |#memory_int#1_16| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_12 4)))))) :named ssa_16))
...
(assert (! (and (= v_ArrVal_224_fresh_1 (store (select |#memory_$Pointer$#1.base_16| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_16 4)) main_~s~0.base_17)) (= v_ArrVal_221_fresh_1 (store (select |#memory_int#1_16| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_16 4)) (select (select |#memory_int#1_20| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_16 4))))) (= (store (select |#memory_$Pointer$#1.offset_16| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_16 4)) v_ArrVal_223_fresh_1) v_ArrVal_226_fresh_1) (= |#memory_$Pointer$#1.offset_20| (store |#memory_$Pointer$#1.offset_16| |~#a~0.base_1| v_ArrVal_226_fresh_1)) (= main_~i~0_20 (+ main_~i~0_16 1)) (= v_ArrVal_225_fresh_1 main_~s~0.base_17) (= v_ArrVal_222_fresh_1 (select (select |#memory_int#1_20| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_16 4)))) (= (store |#memory_$Pointer$#1.base_16| |~#a~0.base_1| v_ArrVal_224_fresh_1) |#memory_$Pointer$#1.base_20|) (= v_ArrVal_223_fresh_1 main_~s~0.offset_17) (= (store |#memory_int#1_16| |~#a~0.base_1| v_ArrVal_221_fresh_1) |#memory_int#1_20|)) :named ssa_20))
...
(assert (! (and (= v_ArrVal_228_fresh_1 (select (select |#memory_int#1_24| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_20 4)))) (= v_ArrVal_229_fresh_1 main_~s~0.offset_21) (= (store |#memory_int#1_20| |~#a~0.base_1| v_ArrVal_227_fresh_1) |#memory_int#1_24|) (= v_ArrVal_231_fresh_1 main_~s~0.base_21) (= main_~i~0_24 (+ main_~i~0_20 1)) (= (store |#memory_$Pointer$#1.base_20| |~#a~0.base_1| v_ArrVal_230_fresh_1) |#memory_$Pointer$#1.base_24|) (= v_ArrVal_232_fresh_1 (store (select |#memory_$Pointer$#1.offset_20| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_20 4)) v_ArrVal_229_fresh_1)) (= v_ArrVal_230_fresh_1 (store (select |#memory_$Pointer$#1.base_20| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_20 4)) main_~s~0.base_21)) (= |#memory_$Pointer$#1.offset_24| (store |#memory_$Pointer$#1.offset_20| |~#a~0.base_1| v_ArrVal_232_fresh_1)) (= v_ArrVal_227_fresh_1 (store (select |#memory_int#1_20| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_20 4)) (select (select |#memory_int#1_24| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_20 4)))))) :named ssa_24))
...
(assert (! (and (= (store |#memory_int#1_24| |~#a~0.base_1| v_ArrVal_233_fresh_1) |#memory_int#1_28|) (= main_~i~0_28 (+ main_~i~0_24 1)) (= v_ArrVal_233_fresh_1 (store (select |#memory_int#1_24| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_24 4)) (select (select |#memory_int#1_28| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_24 4))))) (= v_ArrVal_236_fresh_1 (store (select |#memory_$Pointer$#1.base_24| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_24 4)) main_~s~0.base_25)) (= v_ArrVal_235_fresh_1 main_~s~0.offset_25) (= (store (select |#memory_$Pointer$#1.offset_24| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_24 4)) v_ArrVal_235_fresh_1) v_ArrVal_238_fresh_1) (= (store |#memory_$Pointer$#1.base_24| |~#a~0.base_1| v_ArrVal_236_fresh_1) |#memory_$Pointer$#1.base_28|) (= (store |#memory_$Pointer$#1.offset_24| |~#a~0.base_1| v_ArrVal_238_fresh_1) |#memory_$Pointer$#1.offset_28|) (= v_ArrVal_234_fresh_1 (select (select |#memory_int#1_28| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_24 4)))) (= v_ArrVal_237_fresh_1 main_~s~0.base_25)) :named ssa_28))
(assert (! (<= 100000 main_~i~0_28) :named ssa_29))
(assert (! (and (= v_ArrVal_240_fresh_1 1) (= (store |#length_3| |v_main_#t~malloc6.base_12_fresh_1| v_ArrVal_243_fresh_1) |#length_30|) (= v_ArrVal_245_fresh_1 |v_main_#t~malloc6.base_12_fresh_1|) (= v_ArrVal_241_fresh_1 (store (select |#memory_$Pointer$#1.base_28| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12) |v_main_#t~malloc6.base_12_fresh_1|)) (= v_ArrVal_239_fresh_1 (store (select |#memory_$Pointer$#1.offset_28| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12) 0)) (< |v_main_#t~malloc6.base_12_fresh_1| |#StackHeapBarrier_-1|) (= v_ArrVal_242_fresh_1 0) (= (select |#valid_3| |v_main_#t~malloc6.base_12_fresh_1|) 0) (= |#memory_$Pointer$#1.offset_30| (store |#memory_$Pointer$#1.offset_28| |~#a~0.base_1| v_ArrVal_239_fresh_1)) (= v_ArrVal_244_fresh_1 (store (select |#memory_int#1_28| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12) (select (select |#memory_int#1_30| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12)))) (= |#valid_30| (store |#valid_3| |v_main_#t~malloc6.base_12_fresh_1| v_ArrVal_240_fresh_1)) (= (store |#memory_int#1_28| |~#a~0.base_1| v_ArrVal_244_fresh_1) |#memory_int#1_30|) (= v_ArrVal_246_fresh_1 (select (select |#memory_int#1_30| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12))) (not (= |v_main_#t~malloc6.base_12_fresh_1| 0)) (= main_~i~0_30 0) (= (store |#memory_$Pointer$#1.base_28| |~#a~0.base_1| v_ArrVal_241_fresh_1) |#memory_$Pointer$#1.base_30|) (= v_ArrVal_243_fresh_1 8)) :named ssa_30))
(assert (! (and (= (select (select |#memory_$Pointer$#1.base_30| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_30 4))) main_~s1~0.base_31) (= main_~s1~0.offset_31 (select (select |#memory_$Pointer$#1.offset_30| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_30 4)))) (< main_~i~0_30 100000) (or (and (not |main_#t~short9_31|) (or (and (= main_~s1~0.offset_31 0) (= main_~s1~0.base_31 0)) (= main_~i~0_30 3))) (and |main_#t~short9_31| (or (not (= main_~s1~0.offset_31 0)) (not (= main_~s1~0.base_31 0))) (not (= main_~i~0_30 3))))) :named ssa_31))
(assert (! (and |main_#t~short9_31| (or (and (not (= |v_main_#t~mem8_13_fresh_1| 0)) (not |main_#t~short9_32|)) (and |main_#t~short9_32| (= |v_main_#t~mem8_13_fresh_1| 0))) (= (select (select |#memory_int#2_3| main_~s1~0.base_31) (+ main_~s1~0.offset_31 4)) |v_main_#t~mem8_13_fresh_1|)) :named ssa_32))
(assert (! (and |main_#t~short9_32| (= |main_#t~mem10.offset_33| (select (select |#memory_$Pointer$#2.offset_3| main_~s1~0.base_31) main_~s1~0.offset_31)) (= (select (select |#memory_$Pointer$#2.base_3| main_~s1~0.base_31) main_~s1~0.offset_31) |main_#t~mem10.base_33|)) :named ssa_33))
(assert (! true :named ssa_34_GlobVarAssigCall))
(assert (! (= (ite (or (not (= |main_#t~mem10.base_33| 0)) (not (= |main_#t~mem10.offset_33| 0))) 1 0) |__VERIFIER_assert_#in~cond_34|) :named ssa_34_LocVarAssigCall))
...
(assert (! (and (< 0 |#StackHeapBarrier_-1|) (= (select |#valid_-2| 0) 0) (= 31 (select |#length_-2| 2)) (= (select |#valid_-2| 2) 1) (= |~#a~0.base_0| 3) (= ((as const (Array Int Int)) 0) v_ArrVal_247_fresh_1) (= (select |#valid_-2| 3) 1) (= |~#a~0.offset_0| 0) (= |#memory_$Pointer$#1.offset_0| (store |#memory_$Pointer$#1.offset_-1| |~#a~0.base_0| v_ArrVal_248_fresh_1)) (= (select |#valid_-2| 1) 1) (= (store |#memory_$Pointer$#1.base_-1| |~#a~0.base_0| v_ArrVal_247_fresh_1) |#memory_$Pointer$#1.base_0|) (= (select (select |#memory_int#0_-2| 1) 1) 0) (= 2 (select |#length_-2| 1)) (= ((as const (Array Int Int)) 0) v_ArrVal_248_fresh_1) (= (select |#length_-2| 3) 400000) (= (select (select |#memory_int#0_-2| 1) 0) 48)) :named ssa_0))
