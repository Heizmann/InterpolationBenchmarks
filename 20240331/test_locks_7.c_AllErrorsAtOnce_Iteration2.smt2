...
(set-info :ultimate-id test_locks_7.c_AllErrorsAtOnce_Iteration2)
...
(declare-fun main_~lk1~0_15 () Int)
...
(assert (! (not (= main_~p1~0_4 0)) :named ssa_14))
(assert (! (not (= main_~lk1~0_6 1)) :named ssa_15))
