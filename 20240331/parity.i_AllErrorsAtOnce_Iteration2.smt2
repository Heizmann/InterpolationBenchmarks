...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-30T23:53:33+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id parity.i_AllErrorsAtOnce_Iteration2)
...
(declare-fun v_main_~parity2~0_9_fresh_1 () Int)
...
(assert (! (and (= v_main_~parity2~0_9_fresh_1 0) (= main_~v2~0_6 main_~v~0_4)) :named ssa_6))
...
(assert (! (and (= (mod main_~v2~0_10 4294967296) 0) (= |main_#t~bitwise5_11| 0)) :named ssa_11))
(assert (! (= main_~v2~0_12 (* 286331153 |main_#t~bitwise5_11|)) :named ssa_12))
(assert (! (and (= (mod (div (mod main_~v2~0_12 4294967296) 268435456) 2) 0) (= main_~parity2~0_13 0)) :named ssa_13))
(assert (! true :named ssa_14_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_14| (ite (= main_~parity1~0_4 main_~parity2~0_13) 1 0)) :named ssa_14_LocVarAssigCall))
