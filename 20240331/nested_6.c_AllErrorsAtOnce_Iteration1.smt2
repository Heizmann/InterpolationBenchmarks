...
(set-info :ultimate-id nested_6.c_AllErrorsAtOnce_Iteration1)
...
(declare-fun main_~e~0_6 () Int)
(declare-fun main_~f~0_6 () Int)
(declare-fun main_~c~0_6 () Int)
(declare-fun main_~d~0_6 () Int)
(declare-fun main_~b~0_6 () Int)
(declare-fun main_~a~0_6 () Int)
...
(assert (! (<= 6 main_~a~0_4) :named ssa_5))
(assert (! (or (not (= main_~c~0_4 6)) (not (= main_~d~0_4 6)) (not (= main_~a~0_4 6)) (not (= main_~f~0_4 6)) (not (= main_~e~0_4 6)) (not (= main_~b~0_4 6))) :named ssa_6))
