...
(set-info :ultimate-id mono-crafted_11.c_AllErrorsAtOnce_Iteration7)
...
(assert (! (<= 100000000 (mod main_~x~0_14 4294967296)) :named ssa_15))
(assert (! true :named ssa_16_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_16| (ite (= (mod main_~x~0_14 2) 0) 1 0)) :named ssa_16_LocVarAssigCall))
