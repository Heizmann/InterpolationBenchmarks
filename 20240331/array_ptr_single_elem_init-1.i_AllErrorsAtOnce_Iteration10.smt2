...
(set-info :ultimate-id array_ptr_single_elem_init-1.i_AllErrorsAtOnce_Iteration10)
...
(declare-fun |v_main_#t~malloc6.base_13_fresh_1| () Int)
...
(declare-fun main_~s1~0.offset_35 () Int)
(declare-fun |main_#t~short9_35| () Bool)
(declare-fun main_~s1~0.base_35 () Int)
(declare-fun |main_#t~short9_36| () Bool)
(declare-fun |v_main_#t~mem8_14_fresh_1| () Int)
(declare-fun |main_#t~mem10.base_37| () Int)
(declare-fun |main_#t~mem10.offset_37| () Int)
(declare-fun |main_#t~mem8_37| () Int)
(declare-fun main_~s1~0.offset_37 () Int)
(declare-fun |main_#t~short9_37| () Bool)
(declare-fun main_~s1~0.base_37 () Int)
...
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_249_fresh_1) (< 0 |#StackHeapBarrier_-1|) (= ((as const (Array Int Int)) 0) v_ArrVal_250_fresh_1) (= |#memory_$Pointer$#1.offset_1| (store |#memory_$Pointer$#1.offset_0| |~#a~0.base_1| v_ArrVal_250_fresh_1)) (= (select |#valid_-1| 0) 0) (= 31 (select |#length_-1| 2)) (= (select |#valid_-1| 2) 1) (= |~#a~0.base_1| 3) (= (select |#valid_-1| 3) 1) (= |~#a~0.offset_1| 0) (= (select |#valid_-1| 1) 1) (= (select (select |#memory_int#0_-1| 1) 1) 0) (= 2 (select |#length_-1| 1)) (= (select |#length_-1| 3) 400000) (= (select (select |#memory_int#0_-1| 1) 0) 48) (= (store |#memory_$Pointer$#1.base_0| |~#a~0.base_1| v_ArrVal_249_fresh_1) |#memory_$Pointer$#1.base_1|)) :named ssa_1))
...
(assert (! (and (= v_ArrVal_256_fresh_1 (store (select |#memory_$Pointer$#1.offset_3| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4)) v_ArrVal_253_fresh_1)) (= (store |#memory_$Pointer$#1.base_3| |~#a~0.base_1| v_ArrVal_254_fresh_1) |#memory_$Pointer$#1.base_8|) (= main_~i~0_8 (+ main_~i~0_4 1)) (= v_ArrVal_252_fresh_1 (select (select |#memory_int#1_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4)))) (= v_ArrVal_253_fresh_1 main_~s~0.offset_5) (= (store |#memory_int#1_3| |~#a~0.base_1| v_ArrVal_251_fresh_1) |#memory_int#1_8|) (= v_ArrVal_254_fresh_1 (store (select |#memory_$Pointer$#1.base_3| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4)) main_~s~0.base_5)) (= v_ArrVal_255_fresh_1 main_~s~0.base_5) (= (store |#memory_$Pointer$#1.offset_3| |~#a~0.base_1| v_ArrVal_256_fresh_1) |#memory_$Pointer$#1.offset_8|) (= v_ArrVal_251_fresh_1 (store (select |#memory_int#1_3| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4)) (select (select |#memory_int#1_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4)))))) :named ssa_8))
...
(assert (! (and (= v_ArrVal_262_fresh_1 (store (select |#memory_$Pointer$#1.offset_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_8 4)) v_ArrVal_259_fresh_1)) (= v_ArrVal_259_fresh_1 main_~s~0.offset_9) (= main_~i~0_12 (+ main_~i~0_8 1)) (= v_ArrVal_257_fresh_1 (store (select |#memory_int#1_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_8 4)) (select (select |#memory_int#1_12| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_8 4))))) (= (store |#memory_int#1_8| |~#a~0.base_1| v_ArrVal_257_fresh_1) |#memory_int#1_12|) (= |#memory_$Pointer$#1.offset_12| (store |#memory_$Pointer$#1.offset_8| |~#a~0.base_1| v_ArrVal_262_fresh_1)) (= v_ArrVal_261_fresh_1 main_~s~0.base_9) (= v_ArrVal_258_fresh_1 (select (select |#memory_int#1_12| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_8 4)))) (= |#memory_$Pointer$#1.base_12| (store |#memory_$Pointer$#1.base_8| |~#a~0.base_1| v_ArrVal_260_fresh_1)) (= v_ArrVal_260_fresh_1 (store (select |#memory_$Pointer$#1.base_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_8 4)) main_~s~0.base_9))) :named ssa_12))
...
(assert (! (and (= main_~i~0_16 (+ main_~i~0_12 1)) (= (store |#memory_$Pointer$#1.base_12| |~#a~0.base_1| v_ArrVal_266_fresh_1) |#memory_$Pointer$#1.base_16|) (= v_ArrVal_266_fresh_1 (store (select |#memory_$Pointer$#1.base_12| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_12 4)) main_~s~0.base_13)) (= v_ArrVal_263_fresh_1 (store (select |#memory_int#1_12| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_12 4)) (select (select |#memory_int#1_16| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_12 4))))) (= v_ArrVal_264_fresh_1 (select (select |#memory_int#1_16| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_12 4)))) (= v_ArrVal_267_fresh_1 main_~s~0.base_13) (= v_ArrVal_265_fresh_1 main_~s~0.offset_13) (= (store |#memory_$Pointer$#1.offset_12| |~#a~0.base_1| v_ArrVal_268_fresh_1) |#memory_$Pointer$#1.offset_16|) (= (store |#memory_int#1_12| |~#a~0.base_1| v_ArrVal_263_fresh_1) |#memory_int#1_16|) (= v_ArrVal_268_fresh_1 (store (select |#memory_$Pointer$#1.offset_12| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_12 4)) v_ArrVal_265_fresh_1))) :named ssa_16))
...
(assert (! (and (= v_ArrVal_271_fresh_1 main_~s~0.offset_17) (= v_ArrVal_269_fresh_1 (store (select |#memory_int#1_16| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_16 4)) (select (select |#memory_int#1_20| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_16 4))))) (= (store |#memory_int#1_16| |~#a~0.base_1| v_ArrVal_269_fresh_1) |#memory_int#1_20|) (= v_ArrVal_273_fresh_1 main_~s~0.base_17) (= v_ArrVal_272_fresh_1 (store (select |#memory_$Pointer$#1.base_16| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_16 4)) main_~s~0.base_17)) (= main_~i~0_20 (+ main_~i~0_16 1)) (= |#memory_$Pointer$#1.offset_20| (store |#memory_$Pointer$#1.offset_16| |~#a~0.base_1| v_ArrVal_274_fresh_1)) (= v_ArrVal_270_fresh_1 (select (select |#memory_int#1_20| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_16 4)))) (= (store |#memory_$Pointer$#1.base_16| |~#a~0.base_1| v_ArrVal_272_fresh_1) |#memory_$Pointer$#1.base_20|) (= (store (select |#memory_$Pointer$#1.offset_16| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_16 4)) v_ArrVal_271_fresh_1) v_ArrVal_274_fresh_1)) :named ssa_20))
...
(assert (! (and (= v_ArrVal_277_fresh_1 main_~s~0.offset_21) (= v_ArrVal_276_fresh_1 (select (select |#memory_int#1_24| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_20 4)))) (= |#memory_$Pointer$#1.offset_24| (store |#memory_$Pointer$#1.offset_20| |~#a~0.base_1| v_ArrVal_280_fresh_1)) (= v_ArrVal_278_fresh_1 (store (select |#memory_$Pointer$#1.base_20| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_20 4)) main_~s~0.base_21)) (= main_~i~0_24 (+ main_~i~0_20 1)) (= (store |#memory_int#1_20| |~#a~0.base_1| v_ArrVal_275_fresh_1) |#memory_int#1_24|) (= v_ArrVal_279_fresh_1 main_~s~0.base_21) (= (store |#memory_$Pointer$#1.base_20| |~#a~0.base_1| v_ArrVal_278_fresh_1) |#memory_$Pointer$#1.base_24|) (= v_ArrVal_280_fresh_1 (store (select |#memory_$Pointer$#1.offset_20| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_20 4)) v_ArrVal_277_fresh_1)) (= v_ArrVal_275_fresh_1 (store (select |#memory_int#1_20| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_20 4)) (select (select |#memory_int#1_24| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_20 4)))))) :named ssa_24))
...
(assert (! (and (= v_ArrVal_286_fresh_1 (store (select |#memory_$Pointer$#1.offset_24| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_24 4)) v_ArrVal_283_fresh_1)) (= (store |#memory_$Pointer$#1.base_24| |~#a~0.base_1| v_ArrVal_284_fresh_1) |#memory_$Pointer$#1.base_28|) (= main_~i~0_28 (+ main_~i~0_24 1)) (= v_ArrVal_283_fresh_1 main_~s~0.offset_25) (= |#memory_$Pointer$#1.offset_28| (store |#memory_$Pointer$#1.offset_24| |~#a~0.base_1| v_ArrVal_286_fresh_1)) (= v_ArrVal_281_fresh_1 (store (select |#memory_int#1_24| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_24 4)) (select (select |#memory_int#1_28| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_24 4))))) (= v_ArrVal_284_fresh_1 (store (select |#memory_$Pointer$#1.base_24| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_24 4)) main_~s~0.base_25)) (= v_ArrVal_282_fresh_1 (select (select |#memory_int#1_28| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_24 4)))) (= (store |#memory_int#1_24| |~#a~0.base_1| v_ArrVal_281_fresh_1) |#memory_int#1_28|) (= v_ArrVal_285_fresh_1 main_~s~0.base_25)) :named ssa_28))
...
(assert (! (and (= (store |#memory_$Pointer$#1.offset_28| |~#a~0.base_1| v_ArrVal_292_fresh_1) |#memory_$Pointer$#1.offset_32|) (= v_ArrVal_290_fresh_1 (store (select |#memory_$Pointer$#1.base_28| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_28 4)) main_~s~0.base_29)) (= v_ArrVal_292_fresh_1 (store (select |#memory_$Pointer$#1.offset_28| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_28 4)) v_ArrVal_289_fresh_1)) (= (store |#memory_$Pointer$#1.base_28| |~#a~0.base_1| v_ArrVal_290_fresh_1) |#memory_$Pointer$#1.base_32|) (= main_~i~0_32 (+ main_~i~0_28 1)) (= v_ArrVal_289_fresh_1 main_~s~0.offset_29) (= v_ArrVal_287_fresh_1 (store (select |#memory_int#1_28| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_28 4)) (select (select |#memory_int#1_32| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_28 4))))) (= v_ArrVal_291_fresh_1 main_~s~0.base_29) (= v_ArrVal_288_fresh_1 (select (select |#memory_int#1_32| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_28 4)))) (= (store |#memory_int#1_28| |~#a~0.base_1| v_ArrVal_287_fresh_1) |#memory_int#1_32|)) :named ssa_32))
(assert (! (<= 100000 main_~i~0_32) :named ssa_33))
(assert (! (and (= |#memory_$Pointer$#1.offset_34| (store |#memory_$Pointer$#1.offset_32| |~#a~0.base_1| v_ArrVal_293_fresh_1)) (= (store |#length_3| |v_main_#t~malloc6.base_13_fresh_1| v_ArrVal_299_fresh_1) |#length_34|) (= v_ArrVal_300_fresh_1 (select (select |#memory_int#1_34| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12))) (= v_ArrVal_297_fresh_1 (store (select |#memory_int#1_32| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12) (select (select |#memory_int#1_34| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12)))) (not (= |v_main_#t~malloc6.base_13_fresh_1| 0)) (= v_ArrVal_296_fresh_1 (store (select |#memory_$Pointer$#1.base_32| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12) |v_main_#t~malloc6.base_13_fresh_1|)) (= |#memory_int#1_34| (store |#memory_int#1_32| |~#a~0.base_1| v_ArrVal_297_fresh_1)) (= v_ArrVal_293_fresh_1 (store (select |#memory_$Pointer$#1.offset_32| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12) 0)) (= |#valid_34| (store |#valid_3| |v_main_#t~malloc6.base_13_fresh_1| v_ArrVal_295_fresh_1)) (= (select |#valid_3| |v_main_#t~malloc6.base_13_fresh_1|) 0) (= main_~i~0_34 0) (= v_ArrVal_294_fresh_1 0) (= v_ArrVal_295_fresh_1 1) (= |#memory_$Pointer$#1.base_34| (store |#memory_$Pointer$#1.base_32| |~#a~0.base_1| v_ArrVal_296_fresh_1)) (= v_ArrVal_298_fresh_1 |v_main_#t~malloc6.base_13_fresh_1|) (= v_ArrVal_299_fresh_1 8) (< |v_main_#t~malloc6.base_13_fresh_1| |#StackHeapBarrier_-1|)) :named ssa_34))
(assert (! (and (= (select (select |#memory_$Pointer$#1.base_34| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_34 4))) main_~s1~0.base_35) (= main_~s1~0.offset_35 (select (select |#memory_$Pointer$#1.offset_34| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_34 4)))) (< main_~i~0_34 100000) (or (and (not |main_#t~short9_35|) (or (and (= main_~s1~0.offset_35 0) (= main_~s1~0.base_35 0)) (= main_~i~0_34 3))) (and |main_#t~short9_35| (or (not (= main_~s1~0.offset_35 0)) (not (= main_~s1~0.base_35 0))) (not (= main_~i~0_34 3))))) :named ssa_35))
(assert (! (and |main_#t~short9_35| (= (select (select |#memory_int#2_3| main_~s1~0.base_35) (+ main_~s1~0.offset_35 4)) |v_main_#t~mem8_14_fresh_1|) (or (and (not (= |v_main_#t~mem8_14_fresh_1| 0)) (not |main_#t~short9_36|)) (and |main_#t~short9_36| (= |v_main_#t~mem8_14_fresh_1| 0)))) :named ssa_36))
(assert (! (and |main_#t~short9_36| (= |main_#t~mem10.offset_37| (select (select |#memory_$Pointer$#2.offset_3| main_~s1~0.base_35) main_~s1~0.offset_35)) (= (select (select |#memory_$Pointer$#2.base_3| main_~s1~0.base_35) main_~s1~0.offset_35) |main_#t~mem10.base_37|)) :named ssa_37))
(assert (! true :named ssa_38_GlobVarAssigCall))
(assert (! (= (ite (or (not (= |main_#t~mem10.base_37| 0)) (not (= |main_#t~mem10.offset_37| 0))) 1 0) |__VERIFIER_assert_#in~cond_38|) :named ssa_38_LocVarAssigCall))
...
(assert (! (and (< 0 |#StackHeapBarrier_-1|) (= (select |#valid_-2| 0) 0) (= 31 (select |#length_-2| 2)) (= (select |#valid_-2| 2) 1) (= |~#a~0.base_0| 3) (= (select |#valid_-2| 3) 1) (= ((as const (Array Int Int)) 0) v_ArrVal_302_fresh_1) (= ((as const (Array Int Int)) 0) v_ArrVal_301_fresh_1) (= |~#a~0.offset_0| 0) (= (select |#valid_-2| 1) 1) (= (store |#memory_$Pointer$#1.base_-1| |~#a~0.base_0| v_ArrVal_301_fresh_1) |#memory_$Pointer$#1.base_0|) (= (select (select |#memory_int#0_-2| 1) 1) 0) (= 2 (select |#length_-2| 1)) (= (select |#length_-2| 3) 400000) (= (store |#memory_$Pointer$#1.offset_-1| |~#a~0.base_0| v_ArrVal_302_fresh_1) |#memory_$Pointer$#1.offset_0|) (= (select (select |#memory_int#0_-2| 1) 0) 48)) :named ssa_0))
