...
(set-info :ultimate-id conda.c_AllErrorsAtOnce_Iteration2)
...
(declare-fun |main_~#sum~0.offset_17| () Int)
...
(assert (! (and (= |#valid_11| (store (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_10_fresh_1) main_~a~0.base_11 v_ArrVal_8_fresh_1)) (= v_ArrVal_8_fresh_1 1) (= main_~i~0_11 0) (= (store (store |#length_3| |main_~#sum~0.base_11| v_ArrVal_12_fresh_1) main_~a~0.base_11 v_ArrVal_7_fresh_1) |#length_11|) (< main_~a~0.base_11 |#StackHeapBarrier_-1|) (= (* (mod ~N~0_4 1073741824) 4) v_ArrVal_7_fresh_1) (= |main_~#sum~0.offset_11| 0) (= (store |#memory_int#1_3| |main_~#sum~0.base_11| v_ArrVal_11_fresh_1) |#memory_int#1_11|) (< |#StackHeapBarrier_-1| |main_~#sum~0.base_11|) (= (select (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_10_fresh_1) main_~a~0.base_11) 0) (not (= |main_~#sum~0.base_11| 0)) (= v_ArrVal_10_fresh_1 1) (= (select |#valid_3| |main_~#sum~0.base_11|) 0) (= main_~a~0.offset_11 0) (not (= main_~a~0.base_11 0)) (= 8 v_ArrVal_12_fresh_1) (= v_ArrVal_11_fresh_1 (store (select |#memory_int#1_3| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| v_ArrVal_9_fresh_1)) (= v_ArrVal_9_fresh_1 0)) :named ssa_11))
...
(assert (! (= (select (select |#memory_int#1_11| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|) |main_#t~mem14_17|) :named ssa_17))
(assert (! true :named ssa_18_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_18| (ite (= (* 2 ~N~0_4) |main_#t~mem14_17|) 1 0)) :named ssa_18_LocVarAssigCall))
