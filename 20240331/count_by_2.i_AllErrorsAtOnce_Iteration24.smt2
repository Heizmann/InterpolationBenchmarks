...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration24)
...
(assert (! (<= 1000000 main_~i~0_27) :named ssa_28))
(assert (! true :named ssa_29_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_29| (ite (= main_~i~0_27 1000000) 1 0)) :named ssa_29_LocVarAssigCall))
