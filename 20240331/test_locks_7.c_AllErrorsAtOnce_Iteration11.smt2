...
(set-info :ultimate-id test_locks_7.c_AllErrorsAtOnce_Iteration11)
...
(declare-fun main_~lk5~0_19 () Int)
...
(assert (! (not (= main_~p5~0_4 0)) :named ssa_18))
(assert (! (not (= main_~lk5~0_11 1)) :named ssa_19))
