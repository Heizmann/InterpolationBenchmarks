...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration38)
...
(assert (! (<= 1000000 main_~i~0_41) :named ssa_42))
(assert (! true :named ssa_43_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_43| (ite (= main_~i~0_41 1000000) 1 0)) :named ssa_43_LocVarAssigCall))
