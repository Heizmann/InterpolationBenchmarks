...
(set-info :ultimate-id id_i20_o20-1.c_AllErrorsAtOnce_Iteration11)
...
(declare-fun main_~result~0_70 () Int)
(declare-fun |main_#t~ret5_70| () Int)
(declare-fun main_~result~0_71 () Int)
...
(assert (! (and (<= 0 (+ |main_#t~ret5_69| 2147483648)) (= main_~result~0_70 |main_#t~ret5_69|) (<= |main_#t~ret5_69| 2147483647)) :named ssa_70))
(assert (! (not (= main_~result~0_70 20)) :named ssa_71))
(assert (! true :named ssa_72))
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 (and ssa_13 ssa_14_OldVarAssigCall ssa_27 ssa_29_OldVarAssigCall ssa_17_LocVarAssigCall ssa_64 ssa_5_LocVarAssigCall ssa_31 ssa_5_GlobVarAssigCall ssa_35_LocVarAssigCall ssa_68 ssa_7 ssa_44 ssa_16 ssa_6 ssa_55 ssa_67 ssa_34 ssa_17_GlobVarAssigCall ssa_8_GlobVarAssigCall ssa_11_LocVarAssigCall ssa_14_LocVarAssigCall ssa_26_GlobVarAssigCall ssa_40 ssa_10 ssa_9 ssa_63_return ssa_29_GlobVarAssigCall ssa_32_LocVarAssigCall ssa_46 ssa_51_return ssa_26_LocVarAssigCall ssa_35_GlobVarAssigCall ssa_47 ssa_25 ssa_53 ssa_39_return ssa_14_GlobVarAssigCall ssa_32_OldVarAssigCall ssa_23_OldVarAssigCall ssa_20_GlobVarAssigCall ssa_20_OldVarAssigCall ssa_69_return ssa_45_return ssa_57_return ssa_58 ssa_19 ssa_61 ssa_59 ssa_62 ssa_54_return ssa_43 ssa_23_LocVarAssigCall ssa_37 ssa_17_OldVarAssigCall ssa_20_LocVarAssigCall ssa_38 ssa_12 ssa_11_OldVarAssigCall ssa_5_OldVarAssigCall ssa_32_GlobVarAssigCall ssa_50 ssa_60_return ssa_8_OldVarAssigCall ssa_65 ssa_48_return ssa_66_return ssa_28 ssa_29_LocVarAssigCall ssa_22 ssa_36 ssa_15 ssa_49 ssa_42_return ssa_23_GlobVarAssigCall ssa_21 ssa_11_GlobVarAssigCall ssa_52 ssa_18 ssa_30 ssa_56 ssa_33 ssa_35_OldVarAssigCall ssa_41 ssa_8_LocVarAssigCall ssa_24 ssa_26_OldVarAssigCall) ssa_70 ssa_71 (and ssa_72 ssa_postcond))
...
(declare-fun |id_#res_61| () Int)
(declare-fun |id_#t~ret4_61| () Int)
(declare-fun |main_#t~ret5_63| () Int)
(declare-fun |id_#res_63| () Int)
(assert (! true :named ssa_precond))
(assert (! (not false) :named ssa_postcond))
...
(assert (! (and (<= |id_#t~ret4_60| 2147483647) (= |id_#res_61| (+ |id_#t~ret4_60| 1)) (<= 0 (+ |id_#t~ret4_60| 2147483648))) :named ssa_61))
(assert (! true :named ssa_62))
(assert (! (= |id_#res_61| |main_#t~ret5_63|) :named ssa_63_return))
