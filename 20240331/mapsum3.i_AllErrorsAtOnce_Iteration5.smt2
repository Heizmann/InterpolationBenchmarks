...
(set-info :ultimate-id mapsum3.i_AllErrorsAtOnce_Iteration5)
...
(assert (! (and (= |#valid_4| (store |#valid_3| |main_~#x~0.base_4| v_ArrVal_35_fresh_1)) (< |#StackHeapBarrier_-1| |main_~#x~0.base_4|) (= v_ArrVal_36_fresh_1 40000) (= v_ArrVal_35_fresh_1 1) (not (= |main_~#x~0.base_4| 0)) (= (select |#valid_3| |main_~#x~0.base_4|) 0) (= |main_~#x~0.offset_4| 0) (= |#length_4| (store |#length_3| |main_~#x~0.base_4| v_ArrVal_36_fresh_1)) (= main_~i~1_4 0)) :named ssa_4))
(assert (! (and (< main_~i~1_4 10000) (= v_ArrVal_38_fresh_1 (store (select |#memory_int#1_3| |main_~#x~0.base_4|) (+ (* main_~i~1_4 4) |main_~#x~0.offset_4|) v_ArrVal_37_fresh_1)) (= (store |#memory_int#1_3| |main_~#x~0.base_4| v_ArrVal_38_fresh_1) |#memory_int#1_5|) (= |v_main_#t~nondet3_11_fresh_1| v_ArrVal_37_fresh_1) (<= |v_main_#t~nondet3_11_fresh_1| 2147483647) (<= 0 (+ |v_main_#t~nondet3_11_fresh_1| 2147483648)) (= main_~i~1_5 (+ main_~i~1_4 1))) :named ssa_5))
(assert (! (and (<= |v_main_#t~nondet3_12_fresh_1| 2147483647) (<= 0 (+ |v_main_#t~nondet3_12_fresh_1| 2147483648)) (= |v_main_#t~nondet3_12_fresh_1| v_ArrVal_39_fresh_1) (< main_~i~1_5 10000) (= (store (select |#memory_int#1_5| |main_~#x~0.base_4|) (+ (* main_~i~1_5 4) |main_~#x~0.offset_4|) v_ArrVal_39_fresh_1) v_ArrVal_40_fresh_1) (= (store |#memory_int#1_5| |main_~#x~0.base_4| v_ArrVal_40_fresh_1) |#memory_int#1_6|) (= main_~i~1_6 (+ main_~i~1_5 1))) :named ssa_6))
...
(assert (! (<= 10000 mapsum_~i~0_11) :named ssa_12))
...
(assert (! (and (= mapsum_~ret~0_18 (+ mapsum_~ret~0_17 mapsum_~i~0_17 (select (select |#memory_int#1_15| mapsum_~x.base_17) (+ (* mapsum_~i~0_17 4) mapsum_~x.offset_17)))) (< mapsum_~i~0_17 10000) (= (+ mapsum_~i~0_17 1) mapsum_~i~0_18)) :named ssa_18))
...
(assert (! (<= 9999 main_~i~2_22) :named ssa_23))
(assert (! (and (= (store |#memory_int#1_15| |main_~#x~0.base_4| v_ArrVal_45_fresh_1) |#memory_int#1_24|) (= main_~temp~0_22 v_ArrVal_44_fresh_1) (= v_ArrVal_45_fresh_1 (store (select |#memory_int#1_15| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 39996) v_ArrVal_44_fresh_1))) :named ssa_24))
...
(assert (! (<= 10000 mapsum_~i~0_1) :named ssa_2))
