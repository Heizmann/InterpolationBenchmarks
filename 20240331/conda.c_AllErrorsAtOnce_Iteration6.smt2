...
(set-info :ultimate-id conda.c_AllErrorsAtOnce_Iteration6)
...
(declare-fun |main_~#sum~0.offset_23| () Int)
...
(assert (! (and (= main_~i~0_11 0) (< main_~a~0.base_11 |#StackHeapBarrier_-1|) (= |main_~#sum~0.offset_11| 0) (= v_ArrVal_52_fresh_1 1) (= v_ArrVal_54_fresh_1 1) (= (store (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_54_fresh_1) main_~a~0.base_11 v_ArrVal_52_fresh_1) |#valid_11|) (= 8 v_ArrVal_56_fresh_1) (= (store (select |#memory_int#1_3| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| v_ArrVal_53_fresh_1) v_ArrVal_55_fresh_1) (< |#StackHeapBarrier_-1| |main_~#sum~0.base_11|) (= (* (mod ~N~0_4 1073741824) 4) v_ArrVal_51_fresh_1) (not (= |main_~#sum~0.base_11| 0)) (= (select (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_54_fresh_1) main_~a~0.base_11) 0) (= (select |#valid_3| |main_~#sum~0.base_11|) 0) (= (store (store |#length_3| |main_~#sum~0.base_11| v_ArrVal_56_fresh_1) main_~a~0.base_11 v_ArrVal_51_fresh_1) |#length_11|) (= main_~a~0.offset_11 0) (= (store |#memory_int#1_3| |main_~#sum~0.base_11| v_ArrVal_55_fresh_1) |#memory_int#1_11|) (not (= main_~a~0.base_11 0)) (= v_ArrVal_53_fresh_1 0)) :named ssa_11))
(assert (! (and (= v_ArrVal_57_fresh_1 (store (select |#memory_int#3_3| main_~a~0.base_11) (+ (* main_~i~0_11 4) main_~a~0.offset_11) 1)) (= main_~i~0_12 (+ main_~i~0_11 1)) (< main_~i~0_11 ~N~0_4) (= v_ArrVal_58_fresh_1 1) (= |#memory_int#3_12| (store |#memory_int#3_3| main_~a~0.base_11 v_ArrVal_57_fresh_1))) :named ssa_12))
...
(assert (! (and (= |main_#t~mem7_15| 1) (= (store (select |#memory_int#3_12| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_14 4)) (+ (select (select |#memory_int#3_12| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_14 4))) 1)) v_ArrVal_59_fresh_1) (= (+ (select (select |#memory_int#3_12| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_14 4))) 1) v_ArrVal_60_fresh_1) (= (store |#memory_int#3_12| main_~a~0.base_11 v_ArrVal_59_fresh_1) |#memory_int#3_16|)) :named ssa_16))
(assert (! (= main_~i~0_17 (+ main_~i~0_14 1)) :named ssa_17))
(assert (! (<= ~N~0_4 main_~i~0_17) :named ssa_18))
(assert (! (= main_~i~0_19 0) :named ssa_19))
(assert (! (and (= (store |#memory_int#1_11| |main_~#sum~0.base_11| v_ArrVal_61_fresh_1) |#memory_int#1_20|) (= v_ArrVal_61_fresh_1 (store (select |#memory_int#1_11| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| (+ (select (select |#memory_int#3_16| main_~a~0.base_11) (+ (* main_~i~0_19 4) main_~a~0.offset_11)) (select (select |#memory_int#1_11| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|)))) (= v_ArrVal_62_fresh_1 (+ (select (select |#memory_int#3_16| main_~a~0.base_11) (+ (* main_~i~0_19 4) main_~a~0.offset_11)) (select (select |#memory_int#1_11| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|))) (< main_~i~0_19 ~N~0_4) (= main_~i~0_20 (+ main_~i~0_19 1))) :named ssa_20))
(assert (! (and (< main_~i~0_20 ~N~0_4) (= v_ArrVal_64_fresh_1 (+ (select (select |#memory_int#3_16| main_~a~0.base_11) (+ (* main_~i~0_20 4) main_~a~0.offset_11)) (select (select |#memory_int#1_20| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|))) (= v_ArrVal_63_fresh_1 (store (select |#memory_int#1_20| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| (+ (select (select |#memory_int#3_16| main_~a~0.base_11) (+ (* main_~i~0_20 4) main_~a~0.offset_11)) (select (select |#memory_int#1_20| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|)))) (= main_~i~0_21 (+ main_~i~0_20 1)) (= (store |#memory_int#1_20| |main_~#sum~0.base_11| v_ArrVal_63_fresh_1) |#memory_int#1_21|)) :named ssa_21))
(assert (! (<= ~N~0_4 main_~i~0_21) :named ssa_22))
(assert (! (= (select (select |#memory_int#1_21| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|) |main_#t~mem14_23|) :named ssa_23))
(assert (! true :named ssa_24_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_24| (ite (= (* 2 ~N~0_4) |main_#t~mem14_23|) 1 0)) :named ssa_24_LocVarAssigCall))
