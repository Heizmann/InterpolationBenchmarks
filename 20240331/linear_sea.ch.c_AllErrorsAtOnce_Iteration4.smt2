...
(set-info :ultimate-id linear_sea.ch.c_AllErrorsAtOnce_Iteration4)
...
(declare-fun |v_main_#t~nondet7_7_fresh_1| () Int)
...
(assert (! (= ~SIZE~0_4 (+ (div (mod |v_main_#t~nondet7_7_fresh_1| 4294967296) 8) 1)) :named ssa_4))
(assert (! (and (= |main_#t~malloc8.offset_5| 0) (= (select |#valid_3| |main_#t~malloc8.base_5|) 0) (< |main_#t~malloc8.base_5| |#StackHeapBarrier_-1|) (< 1 (mod ~SIZE~0_4 4294967296)) (not (= |main_#t~malloc8.base_5| 0)) (= (store |#valid_3| |main_#t~malloc8.base_5| v_ArrVal_19_fresh_1) |#valid_5|) (< (mod ~SIZE~0_4 4294967296) (mod ~MAX~0_1 4294967296)) (= |#length_5| (store |#length_3| |main_#t~malloc8.base_5| v_ArrVal_20_fresh_1)) (= v_ArrVal_19_fresh_1 1) (= (* (mod ~SIZE~0_4 1073741824) 4) v_ArrVal_20_fresh_1)) :named ssa_5))
(assert (! (= |old(#memory_int#1)_6| |#memory_int#1_6|) :named ssa_6_GlobVarAssigCall))
(assert (! (and (= ~SIZE~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_6_fresh_1|) (= |main_#t~malloc8.offset_5| |v_#Ultimate.meminit_#ptr.offsetInParam_6_fresh_1|) (= |v_#Ultimate.meminit_#productInParam_6_fresh_1| (* ~SIZE~0_4 4)) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_6_fresh_1| 4) (= |#Ultimate.meminit_#ptr.base_6| |main_#t~malloc8.base_5|)) :named ssa_6_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_6| |#memory_int#1_3|) :named ssa_6_OldVarAssigCall))
(assert (! (and (= |#memory_int#1_7| (store |#memory_int#1_6| |#Ultimate.meminit_#ptr.base_6| v_ArrVal_21_fresh_1)) (= ((as const (Array Int Int)) 0) v_ArrVal_21_fresh_1)) :named ssa_7))
(assert (! true :named ssa_8_return))
(assert (! (and (= |main_#t~malloc8.offset_5| main_~a~0.offset_9) (= main_~a~0.base_9 |main_#t~malloc8.base_5|) (= 3 v_ArrVal_23_fresh_1) (= (store |#memory_int#1_7| main_~a~0.base_9 v_ArrVal_22_fresh_1) |#memory_int#1_9|) (= v_ArrVal_22_fresh_1 (store (select |#memory_int#1_7| main_~a~0.base_9) (+ (* (ite (<= (mod (div (mod ~SIZE~0_4 4294967296) 2) 4294967296) 2147483647) (mod (div (mod ~SIZE~0_4 4294967296) 2) 4294967296) (+ (- 4294967296) (mod (div (mod ~SIZE~0_4 4294967296) 2) 4294967296))) 4) main_~a~0.offset_9) 3))) :named ssa_9))
...
(assert (! (not |linear_search_#t~short5_12|) :named ssa_13))
(assert (! (not |linear_search_#t~short5_12|) :named ssa_14))
...
(assert (! (not (and (<= (div ~MAX~0_0 4294967296) 0) (<= 100000 ~MAX~0_0))) :named ssa_postcond))
...
(assert (! (not (and (<= 0 (div ~SIZE~0_-2 4294967296)) (<= (+ (* 8589934592 (div ~SIZE~0_-2 4294967296)) 2) ~SIZE~0_-2))) :named ssa_postcond))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_24_fresh_1) (= |#memory_int#1_0| (store |#memory_int#1_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_24_fresh_1))) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! (and (<= 0 (div ~SIZE~0_-2 4294967296)) (<= (+ (* 8589934592 (div ~SIZE~0_-2 4294967296)) 2) ~SIZE~0_-2)) :named ssa_-2_PendingContext))
...
(assert (! (not |linear_search_#t~short5_1|) :named ssa_2))
(assert (! (not |linear_search_#t~short5_1|) :named ssa_3))
