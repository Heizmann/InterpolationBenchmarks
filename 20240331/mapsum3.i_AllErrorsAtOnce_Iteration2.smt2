...
(set-info :ultimate-id mapsum3.i_AllErrorsAtOnce_Iteration2)
...
(assert (! (and (= v_ArrVal_8_fresh_1 1) (< |#StackHeapBarrier_-1| |main_~#x~0.base_4|) (= v_ArrVal_9_fresh_1 40000) (= |#valid_4| (store |#valid_3| |main_~#x~0.base_4| v_ArrVal_8_fresh_1)) (= |#length_4| (store |#length_3| |main_~#x~0.base_4| v_ArrVal_9_fresh_1)) (not (= |main_~#x~0.base_4| 0)) (= (select |#valid_3| |main_~#x~0.base_4|) 0) (= |main_~#x~0.offset_4| 0) (= main_~i~1_4 0)) :named ssa_4))
(assert (! (<= 10000 main_~i~1_4) :named ssa_5))
...
(assert (! (<= 10000 mapsum_~i~0_8) :named ssa_9))
...
(assert (! (and (= (store |#memory_int#1_3| |main_~#x~0.base_4| v_ArrVal_12_fresh_1) |#memory_int#1_12|) (= (select (select |#memory_int#1_3| |main_~#x~0.base_4|) |main_~#x~0.offset_4|) v_main_~temp~0_7_fresh_1) (<= 0 (+ |main_#t~ret5_11| 2147483648)) (= v_main_~temp~0_7_fresh_1 v_ArrVal_11_fresh_1) (= |main_#t~ret5_11| main_~ret~1_12) (<= |main_#t~ret5_11| 2147483647) (= (select (select |#memory_int#1_3| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4)) v_ArrVal_10_fresh_1) (= (store (store (select |#memory_int#1_3| |main_~#x~0.base_4|) |main_~#x~0.offset_4| v_ArrVal_10_fresh_1) (+ |main_~#x~0.offset_4| 4) v_ArrVal_11_fresh_1) v_ArrVal_12_fresh_1)) :named ssa_12))
...
(assert (! (<= 9999 main_~i~2_18) :named ssa_19))
(assert (! (and (= (store (select |#memory_int#1_12| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 39996) v_ArrVal_13_fresh_1) v_ArrVal_14_fresh_1) (= main_~temp~0_18 v_ArrVal_13_fresh_1) (= (store |#memory_int#1_12| |main_~#x~0.base_4| v_ArrVal_14_fresh_1) |#memory_int#1_20|)) :named ssa_20))
