...
(set-info :ultimate-id string-1.i_AllErrorsAtOnce_Iteration11)
...
(declare-fun v_main_~found~0_16_fresh_1 () Int)
...
(declare-fun |v_main_#t~nondet4_40_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_41_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_42_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_43_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_44_fresh_1| () Int)
...
(declare-fun |v_main_#t~post8_5_fresh_1| () Int)
...
(assert (! (and (< |#StackHeapBarrier_-1| |main_~#string_A~0.base_4|) (= v_ArrVal_183_fresh_1 5) (= main_~i~0_4 0) (= v_ArrVal_182_fresh_1 5) (= (select |#valid_3| |main_~#string_A~0.base_4|) 0) (= |main_~#string_A~0.offset_4| 0) (not (= |main_~#string_B~0.base_4| 0)) (= (store (store |#valid_3| |main_~#string_A~0.base_4| v_ArrVal_184_fresh_1) |main_~#string_B~0.base_4| v_ArrVal_181_fresh_1) |#valid_4|) (= v_main_~found~0_16_fresh_1 0) (= |main_~#string_B~0.offset_4| 0) (= v_ArrVal_181_fresh_1 1) (not (= |main_~#string_A~0.base_4| 0)) (= (store (store |#length_3| |main_~#string_A~0.base_4| v_ArrVal_183_fresh_1) |main_~#string_B~0.base_4| v_ArrVal_182_fresh_1) |#length_4|) (< |#StackHeapBarrier_-1| |main_~#string_B~0.base_4|) (= v_ArrVal_184_fresh_1 1) (= (select (store |#valid_3| |main_~#string_A~0.base_4| v_ArrVal_184_fresh_1) |main_~#string_B~0.base_4|) 0)) :named ssa_4))
(assert (! (and (<= |v_main_#t~nondet1_40_fresh_1| 127) (= v_ArrVal_186_fresh_1 |v_main_#t~nondet1_40_fresh_1|) (<= 0 (+ |v_main_#t~nondet1_40_fresh_1| 128)) (= main_~i~0_5 (+ main_~i~0_4 1)) (= v_ArrVal_185_fresh_1 (store (select |#memory_int#2_3| |main_~#string_A~0.base_4|) (+ main_~i~0_4 |main_~#string_A~0.offset_4|) |v_main_#t~nondet1_40_fresh_1|)) (= (store |#memory_int#2_3| |main_~#string_A~0.base_4| v_ArrVal_185_fresh_1) |#memory_int#2_5|) (< main_~i~0_4 5)) :named ssa_5))
(assert (! (and (<= 0 (+ |v_main_#t~nondet1_41_fresh_1| 128)) (= v_ArrVal_188_fresh_1 (store (select |#memory_int#2_5| |main_~#string_A~0.base_4|) (+ main_~i~0_5 |main_~#string_A~0.offset_4|) v_ArrVal_187_fresh_1)) (= main_~i~0_6 (+ main_~i~0_5 1)) (= (store |#memory_int#2_5| |main_~#string_A~0.base_4| v_ArrVal_188_fresh_1) |#memory_int#2_6|) (< main_~i~0_5 5) (= v_ArrVal_187_fresh_1 |v_main_#t~nondet1_41_fresh_1|) (<= |v_main_#t~nondet1_41_fresh_1| 127)) :named ssa_6))
(assert (! (and (<= |v_main_#t~nondet1_42_fresh_1| 127) (<= 0 (+ |v_main_#t~nondet1_42_fresh_1| 128)) (= main_~i~0_7 (+ main_~i~0_6 1)) (= v_ArrVal_189_fresh_1 (store (select |#memory_int#2_6| |main_~#string_A~0.base_4|) (+ main_~i~0_6 |main_~#string_A~0.offset_4|) |v_main_#t~nondet1_42_fresh_1|)) (< main_~i~0_6 5) (= (store |#memory_int#2_6| |main_~#string_A~0.base_4| v_ArrVal_189_fresh_1) |#memory_int#2_7|) (= v_ArrVal_190_fresh_1 |v_main_#t~nondet1_42_fresh_1|)) :named ssa_7))
(assert (! (and (= v_ArrVal_192_fresh_1 (store (select |#memory_int#2_7| |main_~#string_A~0.base_4|) (+ main_~i~0_7 |main_~#string_A~0.offset_4|) v_ArrVal_191_fresh_1)) (<= |v_main_#t~nondet1_43_fresh_1| 127) (= (store |#memory_int#2_7| |main_~#string_A~0.base_4| v_ArrVal_192_fresh_1) |#memory_int#2_8|) (<= 0 (+ |v_main_#t~nondet1_43_fresh_1| 128)) (= v_ArrVal_191_fresh_1 |v_main_#t~nondet1_43_fresh_1|) (= main_~i~0_8 (+ main_~i~0_7 1)) (< main_~i~0_7 5)) :named ssa_8))
(assert (! (and (= (store |#memory_int#2_8| |main_~#string_A~0.base_4| v_ArrVal_194_fresh_1) |#memory_int#2_9|) (<= |v_main_#t~nondet1_44_fresh_1| 127) (= v_ArrVal_193_fresh_1 |v_main_#t~nondet1_44_fresh_1|) (<= 0 (+ |v_main_#t~nondet1_44_fresh_1| 128)) (= main_~i~0_9 (+ main_~i~0_8 1)) (< main_~i~0_8 5) (= v_ArrVal_194_fresh_1 (store (select |#memory_int#2_8| |main_~#string_A~0.base_4|) (+ main_~i~0_8 |main_~#string_A~0.offset_4|) v_ArrVal_193_fresh_1))) :named ssa_9))
...
(assert (! (and (<= |v_main_#t~nondet4_40_fresh_1| 127) (= v_ArrVal_195_fresh_1 (store (select |#memory_int#1_3| |main_~#string_B~0.base_4|) (+ main_~i~0_12 |main_~#string_B~0.offset_4|) |v_main_#t~nondet4_40_fresh_1|)) (= v_ArrVal_196_fresh_1 |v_main_#t~nondet4_40_fresh_1|) (<= 0 (+ |v_main_#t~nondet4_40_fresh_1| 128)) (= main_~i~0_13 (+ main_~i~0_12 1)) (= (store |#memory_int#1_3| |main_~#string_B~0.base_4| v_ArrVal_195_fresh_1) |#memory_int#1_13|) (< main_~i~0_12 5)) :named ssa_13))
(assert (! (and (<= 0 (+ |v_main_#t~nondet4_41_fresh_1| 128)) (= main_~i~0_14 (+ main_~i~0_13 1)) (<= |v_main_#t~nondet4_41_fresh_1| 127) (< main_~i~0_13 5) (= (store (select |#memory_int#1_13| |main_~#string_B~0.base_4|) (+ main_~i~0_13 |main_~#string_B~0.offset_4|) |v_main_#t~nondet4_41_fresh_1|) v_ArrVal_197_fresh_1) (= v_ArrVal_198_fresh_1 |v_main_#t~nondet4_41_fresh_1|) (= (store |#memory_int#1_13| |main_~#string_B~0.base_4| v_ArrVal_197_fresh_1) |#memory_int#1_14|)) :named ssa_14))
(assert (! (and (= (store |#memory_int#1_14| |main_~#string_B~0.base_4| v_ArrVal_199_fresh_1) |#memory_int#1_15|) (= main_~i~0_15 (+ main_~i~0_14 1)) (<= |v_main_#t~nondet4_42_fresh_1| 127) (= v_ArrVal_200_fresh_1 |v_main_#t~nondet4_42_fresh_1|) (<= 0 (+ |v_main_#t~nondet4_42_fresh_1| 128)) (< main_~i~0_14 5) (= v_ArrVal_199_fresh_1 (store (select |#memory_int#1_14| |main_~#string_B~0.base_4|) (+ main_~i~0_14 |main_~#string_B~0.offset_4|) |v_main_#t~nondet4_42_fresh_1|))) :named ssa_15))
(assert (! (and (= v_ArrVal_201_fresh_1 |v_main_#t~nondet4_43_fresh_1|) (= main_~i~0_16 (+ main_~i~0_15 1)) (= (store (select |#memory_int#1_15| |main_~#string_B~0.base_4|) (+ main_~i~0_15 |main_~#string_B~0.offset_4|) v_ArrVal_201_fresh_1) v_ArrVal_202_fresh_1) (<= 0 (+ |v_main_#t~nondet4_43_fresh_1| 128)) (= (store |#memory_int#1_15| |main_~#string_B~0.base_4| v_ArrVal_202_fresh_1) |#memory_int#1_16|) (< main_~i~0_15 5) (<= |v_main_#t~nondet4_43_fresh_1| 127)) :named ssa_16))
(assert (! (and (= (store |#memory_int#1_16| |main_~#string_B~0.base_4| v_ArrVal_204_fresh_1) |#memory_int#1_17|) (= v_ArrVal_203_fresh_1 |v_main_#t~nondet4_44_fresh_1|) (= main_~i~0_17 (+ main_~i~0_16 1)) (<= |v_main_#t~nondet4_44_fresh_1| 127) (<= 0 (+ |v_main_#t~nondet4_44_fresh_1| 128)) (= v_ArrVal_204_fresh_1 (store (select |#memory_int#1_16| |main_~#string_B~0.base_4|) (+ main_~i~0_16 |main_~#string_B~0.offset_4|) v_ArrVal_203_fresh_1)) (< main_~i~0_16 5)) :named ssa_17))
...
(assert (! (and (= main_~nc_A~0_22 (+ |v_main_#t~post8_5_fresh_1| 1)) (= |v_main_#t~post8_5_fresh_1| main_~nc_A~0_20) (not (= |main_#t~mem7_21| 0))) :named ssa_22))
...
(assert (! (and (= |v_main_#t~post10_7_fresh_1| main_~nc_B~0_25) (not (= |main_#t~mem9_26| 0)) (= (+ |v_main_#t~post10_7_fresh_1| 1) main_~nc_B~0_27)) :named ssa_27))
...
(assert (! (and (= (+ |v_main_#t~post10_8_fresh_1| 1) main_~nc_B~0_29) (= |v_main_#t~post10_8_fresh_1| main_~nc_B~0_27) (not (= |main_#t~mem9_28| 0))) :named ssa_29))
...
(assert (! (and (= main_~j~0_32 0) (<= main_~nc_A~0_22 main_~nc_B~0_29) (= main_~i~0_32 main_~j~0_32)) :named ssa_32))
(assert (! (and (= (select (select |#memory_int#2_9| |main_~#string_A~0.base_4|) (+ |main_~#string_A~0.offset_4| main_~i~0_32)) |main_#t~mem11_33|) (< main_~i~0_32 main_~nc_A~0_22) (< main_~j~0_32 main_~nc_B~0_29) (= (select (select |#memory_int#1_17| |main_~#string_B~0.base_4|) (+ |main_~#string_B~0.offset_4| main_~j~0_32)) |main_#t~mem12_33|)) :named ssa_33))
(assert (! (and (= main_~j~0_34 (+ main_~j~0_32 1)) (= |main_#t~mem12_33| |main_#t~mem11_33|) (= main_~i~0_34 (+ main_~i~0_32 1))) :named ssa_34))
(assert (! (or (<= main_~nc_B~0_29 main_~j~0_34) (<= main_~nc_A~0_22 main_~i~0_34)) :named ssa_35))
(assert (! (= main_~found~0_36 (ite (< main_~nc_B~0_29 (+ main_~j~0_34 1)) 1 0)) :named ssa_36))
