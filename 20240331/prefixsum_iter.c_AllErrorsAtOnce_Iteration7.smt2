...
(set-info :ultimate-id prefixsum_iter.c_AllErrorsAtOnce_Iteration7)
...
(declare-fun |v_#Ultimate.meminit_#amountOfFieldsInParam_17_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#sizeOfFieldsInParam_17_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#productInParam_17_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#ptr.offsetInParam_17_fresh_1| () Int)
...
(declare-fun |v_#Ultimate.meminit_#amountOfFieldsInParam_18_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#sizeOfFieldsInParam_18_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#ptr.offsetInParam_18_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#productInParam_18_fresh_1| () Int)
...
(declare-fun upsweep_~space~0_36 () Int)
(declare-fun |upsweep_#res_36| () Int)
(declare-fun |main_#t~ret19_37| () Int)
(declare-fun |upsweep_#res_37| () Int)
(declare-fun |main_#t~ret19_38| () Int)
(declare-fun main_~space~1_38 () Int)
(declare-fun |old(#memory_int#1)_39| () (Array Int (Array Int Int)))
(declare-fun |#memory_int#1_39| () (Array Int (Array Int Int)))
(declare-fun |downsweep_#in~a.offset_39| () Int)
(declare-fun |downsweep_#in~space_39| () Int)
(declare-fun main_~a~0.base_39 () Int)
(declare-fun |downsweep_#in~n_39| () Int)
(declare-fun |downsweep_#in~a.base_39| () Int)
(declare-fun main_~n~0_39 () Int)
(declare-fun main_~a~0.offset_39 () Int)
(declare-fun main_~space~1_39 () Int)
(declare-fun downsweep_~n_40 () Int)
(declare-fun downsweep_~space_40 () Int)
(declare-fun downsweep_~a.offset_40 () Int)
(declare-fun downsweep_~a.base_40 () Int)
...
(declare-fun downsweep_~space_41 () Int)
(declare-fun |check_#in~a.offset_44| () Int)
(declare-fun main_~a0~0.offset_44 () Int)
(declare-fun |check_#in~a.base_44| () Int)
(declare-fun main_~a~0.base_44 () Int)
(declare-fun main_~n~0_44 () Int)
(declare-fun main_~a~0.offset_44 () Int)
(declare-fun |check_#in~a0.base_44| () Int)
(declare-fun |check_#in~n_44| () Int)
(declare-fun main_~a0~0.base_44 () Int)
(declare-fun |check_#in~a0.offset_44| () Int)
(declare-fun check_~a0.base_45 () Int)
(declare-fun check_~a.base_45 () Int)
(declare-fun check_~a.offset_45 () Int)
(declare-fun check_~i~0_45 () Int)
(declare-fun check_~sum~0_45 () Int)
(declare-fun check_~a0.offset_45 () Int)
(declare-fun check_~n_45 () Int)
(declare-fun |check_#t~mem10_46| () Int)
(declare-fun |__VERIFIER_assert_#in~cond_47| () Int)
(declare-fun |check_#t~mem10_47| () Int)
(declare-fun check_~sum~0_47 () Int)
(declare-fun __VERIFIER_assert_~cond_48 () Int)
(declare-fun __VERIFIER_assert_~cond_49 () Int)
(declare-fun |check_#t~mem10_52| () Int)
(declare-fun check_~i~0_52 () Int)
(declare-fun |check_#t~mem11_52| () Int)
(declare-fun check_~sum~0_52 () Int)
(declare-fun |check_#t~post12_52| () Int)
...
(assert (! (and (not (= |main_#t~malloc15.base_21| 0)) (< |main_#t~malloc15.base_21| |#StackHeapBarrier_-1|) (= |main_#t~malloc15.offset_21| 0) (= v_ArrVal_89_fresh_1 1) (= (store |#length_3| |main_#t~malloc15.base_21| v_ArrVal_90_fresh_1) |#length_21|) (= (store |#valid_3| |main_#t~malloc15.base_21| v_ArrVal_89_fresh_1) |#valid_21|) (= (select |#valid_3| |main_#t~malloc15.base_21|) 0) (= v_ArrVal_90_fresh_1 (* (mod main_~n~0_4 1073741824) 4))) :named ssa_21))
(assert (! (= |old(#memory_int#1)_22| |#memory_int#1_22|) :named ssa_22_GlobVarAssigCall))
(assert (! (and (= |#Ultimate.meminit_#ptr.base_22| |main_#t~malloc15.base_21|) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_17_fresh_1| 4) (= |v_#Ultimate.meminit_#ptr.offsetInParam_17_fresh_1| |main_#t~malloc15.offset_21|) (= (* main_~n~0_4 4) |v_#Ultimate.meminit_#productInParam_17_fresh_1|) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_17_fresh_1|)) :named ssa_22_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_22| |#memory_int#1_3|) :named ssa_22_OldVarAssigCall))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_91_fresh_1) (= (store |#memory_int#1_22| |#Ultimate.meminit_#ptr.base_22| v_ArrVal_91_fresh_1) |#memory_int#1_23|)) :named ssa_23))
(assert (! true :named ssa_24_return))
(assert (! (and (= (select |#valid_21| |main_#t~malloc16.base_25|) 0) (not (= |main_#t~malloc16.base_25| 0)) (= (store |#valid_21| |main_#t~malloc16.base_25| v_ArrVal_92_fresh_1) |#valid_25|) (= (store |#length_21| |main_#t~malloc16.base_25| v_ArrVal_93_fresh_1) |#length_25|) (= |main_#t~malloc16.offset_25| 0) (= (* (mod main_~n~0_4 1073741824) 4) v_ArrVal_93_fresh_1) (= main_~a~0.offset_25 |main_#t~malloc15.offset_21|) (= v_ArrVal_92_fresh_1 1) (= main_~a~0.base_25 |main_#t~malloc15.base_21|) (< |main_#t~malloc16.base_25| |#StackHeapBarrier_-1|)) :named ssa_25))
(assert (! (= |old(#memory_int#1)_26| |#memory_int#1_26|) :named ssa_26_GlobVarAssigCall))
(assert (! (and (= (* main_~n~0_4 4) |v_#Ultimate.meminit_#productInParam_18_fresh_1|) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_18_fresh_1| 4) (= |#Ultimate.meminit_#ptr.base_26| |main_#t~malloc16.base_25|) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_18_fresh_1|) (= |v_#Ultimate.meminit_#ptr.offsetInParam_18_fresh_1| |main_#t~malloc16.offset_25|)) :named ssa_26_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_26| |#memory_int#1_23|) :named ssa_26_OldVarAssigCall))
(assert (! (and (= |#memory_int#1_27| (store |#memory_int#1_26| |#Ultimate.meminit_#ptr.base_26| v_ArrVal_94_fresh_1)) (= ((as const (Array Int Int)) 0) v_ArrVal_94_fresh_1)) :named ssa_27))
...
(assert (! (and (< main_~i~1_29 main_~n~0_4) (= (store (select |#memory_int#1_27| main_~a0~0.base_29) (+ main_~a0~0.offset_29 (* main_~i~1_29 4)) v_ArrVal_95_fresh_1) v_ArrVal_96_fresh_1) (= (store |#memory_int#1_27| main_~a0~0.base_29 v_ArrVal_96_fresh_1) |#memory_int#1_30|) (= (select (select |#memory_int#1_27| main_~a~0.base_25) (+ main_~a~0.offset_25 (* main_~i~1_29 4))) v_ArrVal_95_fresh_1) (= main_~i~1_30 (+ main_~i~1_29 1))) :named ssa_30))
(assert (! (and (< main_~i~1_30 main_~n~0_4) (= (select (select |#memory_int#1_30| main_~a~0.base_25) (+ main_~a~0.offset_25 (* main_~i~1_30 4))) v_ArrVal_97_fresh_1) (= |#memory_int#1_31| (store |#memory_int#1_30| main_~a0~0.base_29 v_ArrVal_98_fresh_1)) (= (store (select |#memory_int#1_30| main_~a0~0.base_29) (+ main_~a0~0.offset_29 (* main_~i~1_30 4)) v_ArrVal_97_fresh_1) v_ArrVal_98_fresh_1) (= main_~i~1_31 (+ main_~i~1_30 1))) :named ssa_31))
...
(assert (! (<= upsweep_~n_34 upsweep_~space~0_34) :named ssa_35))
(assert (! (= |upsweep_#res_36| upsweep_~space~0_34) :named ssa_36))
(assert (! (= |main_#t~ret19_37| |upsweep_#res_36|) :named ssa_37_return))
(assert (! (and (<= 0 (+ |main_#t~ret19_37| 2147483648)) (<= |main_#t~ret19_37| 2147483647) (= |main_#t~ret19_37| main_~space~1_38)) :named ssa_38))
(assert (! (= |old(#memory_int#1)_39| |#memory_int#1_39|) :named ssa_39_GlobVarAssigCall))
(assert (! (and (= |downsweep_#in~a.base_39| main_~a~0.base_25) (= main_~n~0_4 |downsweep_#in~n_39|) (= |downsweep_#in~space_39| main_~space~1_38) (= main_~a~0.offset_25 |downsweep_#in~a.offset_39|)) :named ssa_39_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_39| |#memory_int#1_33|) :named ssa_39_OldVarAssigCall))
(assert (! (and (= downsweep_~space_40 (ite (and (not (= (mod |downsweep_#in~space_39| 2) 0)) (< |downsweep_#in~space_39| 0)) (+ (div |downsweep_#in~space_39| 2) 1) (div |downsweep_#in~space_39| 2))) (= v_ArrVal_100_fresh_1 (store (select |#memory_int#1_39| downsweep_~a.base_40) (+ downsweep_~a.offset_40 (- 4) (* downsweep_~n_40 4)) v_ArrVal_99_fresh_1)) (= downsweep_~a.base_40 |downsweep_#in~a.base_39|) (= downsweep_~a.offset_40 |downsweep_#in~a.offset_39|) (= v_ArrVal_99_fresh_1 0) (= |#memory_int#1_40| (store |#memory_int#1_39| downsweep_~a.base_40 v_ArrVal_100_fresh_1)) (= downsweep_~n_40 |downsweep_#in~n_39|)) :named ssa_40))
(assert (! (<= downsweep_~space_40 0) :named ssa_41))
(assert (! true :named ssa_42))
(assert (! true :named ssa_43_return))
(assert (! true :named ssa_44_GlobVarAssigCall))
(assert (! (and (= main_~a0~0.offset_29 |check_#in~a0.offset_44|) (= main_~a0~0.base_29 |check_#in~a0.base_44|) (= |check_#in~a.offset_44| main_~a~0.offset_25) (= main_~n~0_4 |check_#in~n_44|) (= |check_#in~a.base_44| main_~a~0.base_25)) :named ssa_44_LocVarAssigCall))
(assert (! true :named ssa_44_OldVarAssigCall))
(assert (! (and (= |check_#in~a.offset_44| check_~a.offset_45) (= |check_#in~a0.offset_44| check_~a0.offset_45) (= check_~a.base_45 |check_#in~a.base_44|) (= check_~i~0_45 0) (= check_~a0.base_45 |check_#in~a0.base_44|) (= check_~sum~0_45 0) (= check_~n_45 |check_#in~n_44|)) :named ssa_45))
(assert (! (and (= |check_#t~mem10_46| (select (select |#memory_int#1_40| check_~a.base_45) (+ (* check_~i~0_45 4) check_~a.offset_45))) (< check_~i~0_45 check_~n_45)) :named ssa_46))
(assert (! true :named ssa_47_GlobVarAssigCall))
(assert (! (= (ite (= check_~sum~0_45 |check_#t~mem10_46|) 1 0) |__VERIFIER_assert_#in~cond_47|) :named ssa_47_LocVarAssigCall))
...
(assert (! (and (= (+ check_~sum~0_45 (select (select |#memory_int#1_40| check_~a0.base_45) (+ (* check_~i~0_45 4) check_~a0.offset_45))) check_~sum~0_52) (= (+ check_~i~0_45 1) check_~i~0_52)) :named ssa_52))
(assert (! (and (= |check_#t~mem10_53| (select (select |#memory_int#1_40| check_~a.base_45) (+ (* check_~i~0_52 4) check_~a.offset_45))) (< check_~i~0_52 check_~n_45)) :named ssa_53))
...
(assert (! (not true) :named ssa_postcond))
(assert (! (and (= (store |#memory_int#1_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_101_fresh_1) |#memory_int#1_0|) (= ((as const (Array Int Int)) 0) v_ArrVal_101_fresh_1)) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! true :named ssa_-2_PendingContext))
...
(assert (! (= |#memory_int#1_-1| |old(#memory_int#1)_-1|) :named ssa_precond))
(assert (! (not true) :named ssa_postcond))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_102_fresh_1) (= |#memory_int#1_0| (store |#memory_int#1_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_102_fresh_1))) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! true :named ssa_-2_PendingContext))
...
(assert (! (= |#memory_int#1_-1| |old(#memory_int#1)_-1|) :named ssa_precond))
(assert (! (not false) :named ssa_postcond))
(assert (! (and (= downsweep_~space_0 (ite (and (not (= (mod |downsweep_#in~space_-1| 2) 0)) (< |downsweep_#in~space_-1| 0)) (+ (div |downsweep_#in~space_-1| 2) 1) (div |downsweep_#in~space_-1| 2))) (= downsweep_~a.base_0 |downsweep_#in~a.base_-1|) (= downsweep_~a.offset_0 |downsweep_#in~a.offset_-1|) (= v_ArrVal_104_fresh_1 (store (select |#memory_int#1_-1| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (- 4) (* downsweep_~n_0 4)) v_ArrVal_103_fresh_1)) (= |#memory_int#1_0| (store |#memory_int#1_-1| downsweep_~a.base_0 v_ArrVal_104_fresh_1)) (= v_ArrVal_103_fresh_1 0) (= downsweep_~n_0 |downsweep_#in~n_-1|)) :named ssa_0))
