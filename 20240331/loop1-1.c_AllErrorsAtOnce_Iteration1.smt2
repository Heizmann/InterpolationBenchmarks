...
(set-info :ultimate-id loop1-1.c_AllErrorsAtOnce_Iteration1)
...
(declare-fun v_main_~exp~0_4_fresh_1 () Real)
...
(assert (! (= |assume_abort_if_not_#in~cond_5| (ite v_~someBinaryDOUBLEComparisonOperation_7_fresh_1 1 0)) :named ssa_5_LocVarAssigCall))
...
(assert (! (= |assume_abort_if_not_#in~cond_10| (ite v_~someBinaryDOUBLEComparisonOperation_8_fresh_1 1 0)) :named ssa_10_LocVarAssigCall))
...
(assert (! (and (= v_main_~term~0_4_fresh_1 1.0) (= main_~count~0_15 1) (= v_main_~exp~0_4_fresh_1 1.0)) :named ssa_15))
(assert (! false :named ssa_16))
(assert (! true :named ssa_17_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_17| (ite v_~someBinaryFLOATComparisonOperation_4_fresh_1 1 0)) :named ssa_17_LocVarAssigCall))
...
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 (and ssa_5_LocVarAssigCall ssa_5_GlobVarAssigCall ssa_7 ssa_6 ssa_8 ssa_5_OldVarAssigCall ssa_9_return) (and ssa_13 ssa_10_GlobVarAssigCall ssa_10_OldVarAssigCall ssa_12 ssa_11 ssa_10_LocVarAssigCall ssa_14_return) ssa_15 ssa_16 (and ssa_17_LocVarAssigCall ssa_17_GlobVarAssigCall ssa_17_OldVarAssigCall) ssa_18 ssa_19 (and ssa_20 ssa_postcond))
...
(assert (! true :named ssa_-2_PendingContext))
(assert (! (= |assume_abort_if_not_#in~cond_-1| (ite v_~someBinaryDOUBLEComparisonOperation_4_fresh_1 1 0)) :named ssa_-2_LocVarAssignPendingContext))
(assert (! true :named ssa_-2_OldVarAssignPendingContext))
(check-sat)
...
(assert (! (= |assume_abort_if_not_#in~cond_-1| (ite v_~someBinaryDOUBLEComparisonOperation_6_fresh_1 1 0)) :named ssa_-2_LocVarAssignPendingContext))
(assert (! true :named ssa_-2_OldVarAssignPendingContext))
(check-sat)
(get-interpolants (and ssa_0 ssa_precond) ssa_1 ssa_2 (and ssa_-2_PendingContext ssa_3_return ssa_-2_LocVarAssignPendingContext ssa_-2_OldVarAssignPendingContext ssa_postcond))
(echo "finished trace check")
