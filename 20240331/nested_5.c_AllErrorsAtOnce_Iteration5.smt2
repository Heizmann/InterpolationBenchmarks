...
(set-info :ultimate-id nested_5.c_AllErrorsAtOnce_Iteration5)
...
(declare-fun |main_#t~pre6_9| () Int)
(declare-fun |main_#t~pre7_11| () Int)
(declare-fun main_~b~0_11 () Int)
(declare-fun |main_#t~pre8_13| () Int)
...
(assert (! (= main_~c~0_9 (+ main_~c~0_6 1)) :named ssa_9))
(assert (! (<= 6 main_~c~0_9) :named ssa_10))
(assert (! (= (+ main_~b~0_5 1) main_~b~0_11) :named ssa_11))
(assert (! (<= 6 main_~b~0_11) :named ssa_12))
(assert (! (= (+ main_~a~0_4 1) main_~a~0_13) :named ssa_13))
(assert (! (<= 6 main_~a~0_13) :named ssa_14))
(assert (! (or (not (= main_~d~0_7 6)) (not (= main_~b~0_11 6)) (not (= main_~a~0_13 6)) (not (= main_~e~0_4 6)) (not (= main_~c~0_9 6))) :named ssa_15))
