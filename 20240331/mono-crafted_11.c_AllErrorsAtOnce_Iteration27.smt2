...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:11:03+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id mono-crafted_11.c_AllErrorsAtOnce_Iteration27)
...
(assert (! (<= 100000000 (mod main_~x~0_54 4294967296)) :named ssa_55))
(assert (! true :named ssa_56_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_56| (ite (= (mod main_~x~0_54 2) 0) 1 0)) :named ssa_56_LocVarAssigCall))
