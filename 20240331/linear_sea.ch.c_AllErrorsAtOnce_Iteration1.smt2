...
(set-info :ultimate-id linear_sea.ch.c_AllErrorsAtOnce_Iteration1)
...
(declare-fun |v_main_#t~nondet7_4_fresh_1| () Int)
...
(assert (! (= ~SIZE~0_4 (+ (div (mod |v_main_#t~nondet7_4_fresh_1| 4294967296) 8) 1)) :named ssa_4))
(assert (! (and (= |main_#t~malloc8.offset_5| 0) (= (select |#valid_3| |main_#t~malloc8.base_5|) 0) (= v_ArrVal_1_fresh_1 1) (= |#length_5| (store |#length_3| |main_#t~malloc8.base_5| v_ArrVal_2_fresh_1)) (< |main_#t~malloc8.base_5| |#StackHeapBarrier_-1|) (< 1 (mod ~SIZE~0_4 4294967296)) (not (= |main_#t~malloc8.base_5| 0)) (= (store |#valid_3| |main_#t~malloc8.base_5| v_ArrVal_1_fresh_1) |#valid_5|) (< (mod ~SIZE~0_4 4294967296) (mod ~MAX~0_1 4294967296)) (= (* (mod ~SIZE~0_4 1073741824) 4) v_ArrVal_2_fresh_1)) :named ssa_5))
(assert (! (= |old(#memory_int#1)_6| |#memory_int#1_6|) :named ssa_6_GlobVarAssigCall))
(assert (! (and (= ~SIZE~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_3_fresh_1|) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_3_fresh_1| 4) (= |v_#Ultimate.meminit_#productInParam_3_fresh_1| (* ~SIZE~0_4 4)) (= |main_#t~malloc8.offset_5| |v_#Ultimate.meminit_#ptr.offsetInParam_3_fresh_1|) (= |#Ultimate.meminit_#ptr.base_6| |main_#t~malloc8.base_5|)) :named ssa_6_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_6| |#memory_int#1_3|) :named ssa_6_OldVarAssigCall))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_3_fresh_1) (= (store |#memory_int#1_6| |#Ultimate.meminit_#ptr.base_6| v_ArrVal_3_fresh_1) |#memory_int#1_7|)) :named ssa_7))
(assert (! true :named ssa_8_return))
(assert (! (and (= |main_#t~malloc8.offset_5| main_~a~0.offset_9) (= main_~a~0.base_9 |main_#t~malloc8.base_5|) (= 3 v_ArrVal_5_fresh_1) (= v_ArrVal_4_fresh_1 (store (select |#memory_int#1_7| main_~a~0.base_9) (+ (* (ite (<= (mod (div (mod ~SIZE~0_4 4294967296) 2) 4294967296) 2147483647) (mod (div (mod ~SIZE~0_4 4294967296) 2) 4294967296) (+ (- 4294967296) (mod (div (mod ~SIZE~0_4 4294967296) 2) 4294967296))) 4) main_~a~0.offset_9) 3)) (= (store |#memory_int#1_7| main_~a~0.base_9 v_ArrVal_4_fresh_1) |#memory_int#1_9|)) :named ssa_9))
...
(assert (! (and (< (mod linear_search_~j~0_11 4294967296) (mod ~SIZE~0_4 4294967296)) (= |linear_search_#res_13| 1)) :named ssa_13))
(assert (! true :named ssa_14))
(assert (! (= |main_#t~ret9_15| |linear_search_#res_13|) :named ssa_15_return))
(assert (! (and (<= 0 (+ |main_#t~ret9_15| 2147483648)) (<= |main_#t~ret9_15| 2147483647)) :named ssa_16))
(assert (! true :named ssa_17_GlobVarAssigCall))
(assert (! (= |main_#t~ret9_15| |__VERIFIER_assert_#in~cond_17|) :named ssa_17_LocVarAssigCall))
...
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 ssa_5 (and ssa_8_return ssa_7 ssa_6_OldVarAssigCall ssa_6_GlobVarAssigCall ssa_6_LocVarAssigCall) ssa_9 (and ssa_13 ssa_10_GlobVarAssigCall ssa_14 ssa_10_OldVarAssigCall ssa_12 ssa_11 ssa_10_LocVarAssigCall ssa_15_return) ssa_16 (and ssa_17_LocVarAssigCall ssa_17_GlobVarAssigCall ssa_17_OldVarAssigCall) ssa_18 ssa_19 (and ssa_20 ssa_postcond))
...
(assert (! (not true) :named ssa_postcond))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_6_fresh_1) (= (store |#memory_int#1_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_6_fresh_1) |#memory_int#1_0|)) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! true :named ssa_-2_PendingContext))
...
(declare-fun |linear_search_#res_2| () Int)
(declare-fun linear_search_~j~0_2 () Int)
(declare-fun |linear_search_#res_4| () Int)
(declare-fun |main_#t~ret9_4| () Int)
(assert (! true :named ssa_precond))
(assert (! (not false) :named ssa_postcond))
...
(assert (! (and (< (mod linear_search_~j~0_0 4294967296) (mod ~SIZE~0_-2 4294967296)) (= |linear_search_#res_2| 1)) :named ssa_2))
(assert (! true :named ssa_3))
(assert (! (= |main_#t~ret9_4| |linear_search_#res_2|) :named ssa_4_return))
(assert (! true :named ssa_-2_PendingContext))
