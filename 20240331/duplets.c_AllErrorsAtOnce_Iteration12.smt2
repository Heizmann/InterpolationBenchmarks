...
(set-info :ultimate-id duplets.c_AllErrorsAtOnce_Iteration12)
...
(declare-fun v_mkdup_~x~0_27_fresh_1 () Int)
...
(assert (! (and (not (= 0 |main_#t~malloc13.base_10|)) (= v_ArrVal_195_fresh_1 (* 4 (mod main_~n~0_4 1073741824))) (< |main_#t~malloc13.base_10| |#StackHeapBarrier_-1|) (= (store |#valid_3| |main_#t~malloc13.base_10| v_ArrVal_196_fresh_1) |#valid_10|) (= |main_#t~malloc13.offset_10| 0) (= v_ArrVal_196_fresh_1 1) (= (select |#valid_3| |main_#t~malloc13.base_10|) 0) (= (store |#length_3| |main_#t~malloc13.base_10| v_ArrVal_195_fresh_1) |#length_10|)) :named ssa_10))
(assert (! (= |old(#memory_int#2)_11| |#memory_int#2_11|) :named ssa_11_GlobVarAssigCall))
(assert (! (and (= |v_#Ultimate.meminit_#productInParam_14_fresh_1| (* main_~n~0_4 4)) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_14_fresh_1| 4) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_14_fresh_1|) (= |v_#Ultimate.meminit_#ptr.offsetInParam_14_fresh_1| |main_#t~malloc13.offset_10|) (= |#Ultimate.meminit_#ptr.base_11| |main_#t~malloc13.base_10|)) :named ssa_11_LocVarAssigCall))
(assert (! (= |old(#memory_int#2)_11| |#memory_int#2_3|) :named ssa_11_OldVarAssigCall))
(assert (! (and (= |#memory_int#2_12| (store |#memory_int#2_11| |#Ultimate.meminit_#ptr.base_11| v_ArrVal_197_fresh_1)) (= ((as const (Array Int Int)) 0) v_ArrVal_197_fresh_1)) :named ssa_12))
...
(assert (! (and (= v_ArrVal_198_fresh_1 (store (store (select |#memory_int#2_15| mkdup_~a.base_16) (+ (* mkdup_~i~0_16 4) mkdup_~a.offset_16) v_mkdup_~x~0_27_fresh_1) (+ mkdup_~a.offset_16 (* mkdup_~j~0_16 4)) v_mkdup_~x~0_27_fresh_1)) (= |#memory_int#2_32| (store |#memory_int#2_15| mkdup_~a.base_16 v_ArrVal_198_fresh_1)) (= v_ArrVal_199_fresh_1 v_mkdup_~x~0_27_fresh_1) (= v_ArrVal_200_fresh_1 v_mkdup_~x~0_27_fresh_1) (<= 0 (+ v_mkdup_~x~0_27_fresh_1 2147483648)) (<= v_mkdup_~x~0_27_fresh_1 2147483647)) :named ssa_32))
(assert (! true :named ssa_33_return))
(assert (! (and (= |main_~#i~2.offset_34| 0) (= v_ArrVal_203_fresh_1 4) (= (store (store |#length_10| |main_~#i~2.base_34| v_ArrVal_201_fresh_1) |main_~#j~2.base_34| v_ArrVal_203_fresh_1) |#length_34|) (= (select |#valid_10| |main_~#i~2.base_34|) 0) (= |main_~#j~2.offset_34| 0) (= v_ArrVal_201_fresh_1 4) (= (select (store |#valid_10| |main_~#i~2.base_34| v_ArrVal_202_fresh_1) |main_~#j~2.base_34|) 0) (not (= |main_~#j~2.base_34| 0)) (= v_ArrVal_204_fresh_1 1) (= v_ArrVal_202_fresh_1 1) (< |#StackHeapBarrier_-1| |main_~#j~2.base_34|) (not (= |main_~#i~2.base_34| 0)) (< |#StackHeapBarrier_-1| |main_~#i~2.base_34|) (= (store (store |#valid_10| |main_~#i~2.base_34| v_ArrVal_202_fresh_1) |main_~#j~2.base_34| v_ArrVal_204_fresh_1) |#valid_34|)) :named ssa_34))
...
(assert (! (and (= v_ArrVal_206_fresh_1 (store (select |#memory_int#3_35| finddup_~_j.base_36) finddup_~_j.offset_36 finddup_~j~1_44)) (= (store |#memory_int#1_35| finddup_~_i.base_36 v_ArrVal_208_fresh_1) |#memory_int#1_46|) (= v_ArrVal_208_fresh_1 (store (select |#memory_int#1_35| finddup_~_i.base_36) finddup_~_i.offset_36 v_ArrVal_205_fresh_1)) (= |finddup_#res_46| 1) (= v_ArrVal_205_fresh_1 finddup_~i~1_43) (= v_ArrVal_207_fresh_1 finddup_~j~1_44) (= |finddup_#t~mem8_45| |finddup_#t~mem9_45|) (= (store |#memory_int#3_35| finddup_~_j.base_36 v_ArrVal_206_fresh_1) |#memory_int#3_46|)) :named ssa_46))
...
(assert (! (and (or (and (<= 0 |v_main_#t~mem15_8_fresh_1|) |main_#t~short17_55|) (and (< |v_main_#t~mem15_8_fresh_1| 0) (not |main_#t~short17_55|))) (= (select (select |#memory_int#1_46| |main_~#i~2.base_34|) |main_~#i~2.offset_34|) |v_main_#t~mem15_8_fresh_1|)) :named ssa_55))
(assert (! (not |main_#t~short17_55|) :named ssa_56))
(assert (! true :named ssa_57_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_57| (ite |main_#t~short17_55| 1 0)) :named ssa_57_LocVarAssigCall))
...
(assert (! (not true) :named ssa_postcond))
(assert (! (and (= (store |#memory_int#2_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_209_fresh_1) |#memory_int#2_0|) (= ((as const (Array Int Int)) 0) v_ArrVal_209_fresh_1)) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! true :named ssa_-2_PendingContext))
...
(declare-fun mkdup_~a.base_16 () Int)
(declare-fun mkdup_~i~0_16 () Int)
(declare-fun v_mkdup_~x~0_28_fresh_1 () Int)
...
(assert (! (and (= v_ArrVal_210_fresh_1 v_mkdup_~x~0_28_fresh_1) (= (store |#memory_int#2_-1| mkdup_~a.base_0 v_ArrVal_212_fresh_1) |#memory_int#2_16|) (<= v_mkdup_~x~0_28_fresh_1 2147483647) (<= 0 (+ v_mkdup_~x~0_28_fresh_1 2147483648)) (= v_ArrVal_211_fresh_1 v_mkdup_~x~0_28_fresh_1) (= v_ArrVal_212_fresh_1 (store (store (select |#memory_int#2_-1| mkdup_~a.base_0) (+ (* mkdup_~i~0_0 4) mkdup_~a.offset_0) v_ArrVal_210_fresh_1) (+ mkdup_~a.offset_0 (* mkdup_~j~0_0 4)) v_ArrVal_211_fresh_1))) :named ssa_16))
...
(assert (! (not (<= 1 (select (select |#memory_int#1_10| |main_~#i~2.base_-2|) |main_~#i~2.offset_-2|))) :named ssa_postcond))
...
(assert (! (and (= v_ArrVal_214_fresh_1 (store (select |#memory_int#3_-1| finddup_~_j.base_0) finddup_~_j.offset_0 finddup_~j~1_8)) (= (store |#memory_int#3_-1| finddup_~_j.base_0 v_ArrVal_214_fresh_1) |#memory_int#3_10|) (= |finddup_#res_10| 1) (= |finddup_#t~mem8_9| |finddup_#t~mem9_9|) (= v_ArrVal_213_fresh_1 finddup_~i~1_7) (= v_ArrVal_215_fresh_1 finddup_~j~1_8) (= v_ArrVal_216_fresh_1 (store (select |#memory_int#1_-1| finddup_~_i.base_0) finddup_~_i.offset_0 v_ArrVal_213_fresh_1)) (= |#memory_int#1_10| (store |#memory_int#1_-1| finddup_~_i.base_0 v_ArrVal_216_fresh_1))) :named ssa_10))
...
(assert (! true :named ssa_precond))
(assert (! (not (<= 1 (select (select |#memory_int#1_-2| |main_~#i~2.base_-2|) |main_~#i~2.offset_-2|))) :named ssa_postcond))
...
(assert (! true :named ssa_2))
(assert (! true :named ssa_3_return))
(assert (! (<= 1 (select (select |#memory_int#1_-2| |main_~#i~2.base_-2|) |main_~#i~2.offset_-2|)) :named ssa_-2_PendingContext))
