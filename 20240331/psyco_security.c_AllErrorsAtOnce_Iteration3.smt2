...
(set-info :ultimate-id psyco_security.c_AllErrorsAtOnce_Iteration3)
...
(declare-fun v_main_~method_id~0_46_fresh_1 () Int)
...
(declare-fun v_main_~method_id~0_47_fresh_1 () Int)
(declare-fun main_~this_state~0_16 () Int)
...
(assert (! (= 3 v_main_~method_id~0_46_fresh_1) :named ssa_9))
...
(assert (! (and (= main_~q~0_10 1) (<= |main_#t~nondet5_13| 2147483647) (<= 0 (+ |main_#t~nondet5_13| 2147483648))) :named ssa_13))
(assert (! (not (= |main_#t~nondet5_13| 0)) :named ssa_14))
(assert (! (= 4 v_main_~method_id~0_47_fresh_1) :named ssa_15))
(assert (! (= 2 main_~this_state~0_10) :named ssa_16))
