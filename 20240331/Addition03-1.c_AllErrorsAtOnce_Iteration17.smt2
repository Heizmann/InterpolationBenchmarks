...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:15:10+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id Addition03-1.c_AllErrorsAtOnce_Iteration17)
...
(declare-fun |main_#t~ret8_114| () Int)
(declare-fun |addition_#res_114| () Int)
(declare-fun main_~result~0_115 () Int)
(declare-fun |main_#t~ret8_115| () Int)
(declare-fun main_~result~0_116 () Int)
(declare-fun main_~m~0_116 () Int)
(declare-fun main_~n~0_116 () Int)
...
(assert (! (and (= 0 addition_~n_66) (= |addition_#res_67| addition_~m_66)) :named ssa_67))
...
(assert (! (= |addition_#res_112| |main_#t~ret8_114|) :named ssa_114_return))
(assert (! (and (<= |main_#t~ret8_114| 9223372036854775807) (<= 0 (+ |main_#t~ret8_114| 9223372036854775808)) (= main_~result~0_115 |main_#t~ret8_114|)) :named ssa_115))
(assert (! (and (< main_~result~0_115 200) (<= 100 main_~n~0_4) (<= 100 main_~m~0_4)) :named ssa_116))
(assert (! true :named ssa_117))
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 (and ssa_57_OldVarAssigCall ssa_65_OldVarAssigCall ssa_77 ssa_27 ssa_29_OldVarAssigCall ssa_20 ssa_41_GlobVarAssigCall ssa_17_LocVarAssigCall ssa_21_LocVarAssigCall ssa_95 ssa_64 ssa_5_LocVarAssigCall ssa_31 ssa_60 ssa_5_GlobVarAssigCall ssa_21_OldVarAssigCall ssa_76 ssa_88 ssa_68 ssa_7 ssa_44 ssa_16 ssa_109 ssa_6 ssa_26 ssa_55 ssa_67 ssa_34 ssa_17_GlobVarAssigCall ssa_100 ssa_74 ssa_25_GlobVarAssigCall ssa_102_return ssa_40 ssa_10 ssa_14 ssa_25_OldVarAssigCall ssa_111_return ssa_8 ssa_13_LocVarAssigCall ssa_29_GlobVarAssigCall ssa_46 ssa_53_GlobVarAssigCall ssa_89 ssa_47 ssa_93_return ssa_94 ssa_13_OldVarAssigCall ssa_113 ssa_25_LocVarAssigCall ssa_82 ssa_37_LocVarAssigCall ssa_101 ssa_49_LocVarAssigCall ssa_85 ssa_105_return ssa_69_return ssa_86 ssa_58 ssa_110 ssa_33_GlobVarAssigCall ssa_90_return ssa_19 ssa_83 ssa_33_LocVarAssigCall ssa_59 ssa_96_return ssa_61_OldVarAssigCall ssa_39 ssa_53_LocVarAssigCall ssa_62 ssa_43 ssa_13_GlobVarAssigCall ssa_41_OldVarAssigCall ssa_17_OldVarAssigCall ssa_38 ssa_79 ssa_12 ssa_97 ssa_32 ssa_5_OldVarAssigCall ssa_50 ssa_65_LocVarAssigCall ssa_61_LocVarAssigCall ssa_104 ssa_103 ssa_72_return ssa_61_GlobVarAssigCall ssa_81_return ssa_41_LocVarAssigCall ssa_11 ssa_48 ssa_53_OldVarAssigCall ssa_106 ssa_84_return ssa_28 ssa_29_LocVarAssigCall ssa_54 ssa_37_GlobVarAssigCall ssa_22 ssa_98 ssa_51 ssa_36 ssa_15 ssa_80 ssa_107 ssa_63 ssa_45_OldVarAssigCall ssa_45_LocVarAssigCall ssa_78_return ssa_87_return ssa_52 ssa_18 ssa_49_GlobVarAssigCall ssa_108_return ssa_23 ssa_91 ssa_30 ssa_70 ssa_66 ssa_114_return ssa_9_LocVarAssigCall ssa_92 ssa_56 ssa_57_LocVarAssigCall ssa_99_return ssa_9_OldVarAssigCall ssa_35 ssa_75_return ssa_21_GlobVarAssigCall ssa_9_GlobVarAssigCall ssa_65_GlobVarAssigCall ssa_112 ssa_33_OldVarAssigCall ssa_45_GlobVarAssigCall ssa_49_OldVarAssigCall ssa_42 ssa_71 ssa_57_GlobVarAssigCall ssa_24 ssa_37_OldVarAssigCall ssa_73) ssa_115 ssa_116 (and ssa_117 ssa_postcond))
...
(declare-fun |addition_#res_108| () Int)
(assert (! true :named ssa_precond))
(assert (! (not (<= main_~n~0_-2 15)) :named ssa_postcond))
...
(assert (! (and (<= 0 (+ 9223372036854775808 |addition_#t~ret4_105|)) (<= |addition_#t~ret4_105| 9223372036854775807) (= |addition_#res_106| |addition_#t~ret4_105|)) :named ssa_106))
(assert (! true :named ssa_107))
(assert (! (= |addition_#res_106| |main_#t~ret8_108|) :named ssa_108_return))
(assert (! true :named ssa_-2_PendingContext))
