...
(set-info :ultimate-id watermelon.c_AllErrorsAtOnce_Iteration7)
...
(declare-fun v_main_~is_divisible2~0_12_fresh_1 () Int)
(declare-fun v_main_~is_divisible1~0_12_fresh_1 () Int)
...
(declare-fun |student_version_#res_21| () Int)
(declare-fun |main_#t~ret6_22| () Int)
(declare-fun main_~is_divisible2~0_22 () Int)
(declare-fun |__VERIFIER_assert_#in~cond_23| () Int)
(declare-fun main_~is_divisible1~0_23 () Int)
(declare-fun main_~is_divisible2~0_23 () Int)
...
(assert (! (and (= ~true~0_1 v_main_~is_divisible2~0_12_fresh_1) (= ~true~0_1 v_main_~is_divisible1~0_12_fresh_1)) :named ssa_4))
...
(assert (! (and (< student_version_~w_18 4) (= ~false~0_1 student_version_~is_divisible~1_19)) :named ssa_19))
(assert (! (= student_version_~is_divisible~1_19 |student_version_#res_20|) :named ssa_20))
(assert (! (= |main_#t~ret6_21| |student_version_#res_20|) :named ssa_21_return))
(assert (! (and (<= |main_#t~ret6_21| 2147483647) (= main_~is_divisible2~0_22 |main_#t~ret6_21|) (<= 0 (+ |main_#t~ret6_21| 2147483648))) :named ssa_22))
(assert (! true :named ssa_23_GlobVarAssigCall))
(assert (! (= (ite (= main_~is_divisible1~0_16 main_~is_divisible2~0_22) 1 0) |__VERIFIER_assert_#in~cond_23|) :named ssa_23_LocVarAssigCall))
...
(assert (! true :named ssa_precond))
(assert (! (not (and (<= main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647)) (<= (+ (* (div main_~w~0_-2 4294967296) 4294967296) 4) main_~w~0_-2))) :named ssa_postcond))
...
(declare-fun ~false~0_-1 () Int)
(declare-fun student_version_~w_1 () Int)
(declare-fun student_version_~is_divisible~1_1 () Int)
(declare-fun |student_version_#res_2| () Int)
(declare-fun student_version_~is_divisible~1_2 () Int)
(declare-fun |main_#t~ret6_3| () Int)
(declare-fun |student_version_#res_3| () Int)
(assert (! true :named ssa_precond))
(assert (! (not false) :named ssa_postcond))
(assert (! (and (= student_version_~w_0 |student_version_#in~w_-1|) (= ~true~0_-1 student_version_~is_divisible~1_0)) :named ssa_0))
(assert (! (and (< student_version_~w_0 4) (= ~false~0_-1 student_version_~is_divisible~1_1)) :named ssa_1))
(assert (! (= student_version_~is_divisible~1_1 |student_version_#res_2|) :named ssa_2))
(assert (! (= |main_#t~ret6_3| |student_version_#res_2|) :named ssa_3_return))
(assert (! (and (<= main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647)) (<= (+ (* (div main_~w~0_-2 4294967296) 4294967296) 4) main_~w~0_-2)) :named ssa_-2_PendingContext))
