...
(set-info :ultimate-id Addition03-1.c_AllErrorsAtOnce_Iteration12)
...
(declare-fun |main_#t~ret8_79| () Int)
(declare-fun |addition_#res_79| () Int)
(declare-fun main_~result~0_80 () Int)
(declare-fun |main_#t~ret8_80| () Int)
(declare-fun main_~result~0_81 () Int)
(declare-fun main_~m~0_81 () Int)
(declare-fun main_~n~0_81 () Int)
...
(assert (! (and (= 0 addition_~n_46) (= |addition_#res_47| addition_~m_46)) :named ssa_47))
...
(assert (! (= |addition_#res_77| |main_#t~ret8_79|) :named ssa_79_return))
(assert (! (and (<= |main_#t~ret8_79| 9223372036854775807) (<= 0 (+ |main_#t~ret8_79| 9223372036854775808)) (= main_~result~0_80 |main_#t~ret8_79|)) :named ssa_80))
(assert (! (and (< main_~result~0_80 200) (<= 100 main_~n~0_4) (<= 100 main_~m~0_4)) :named ssa_81))
(assert (! true :named ssa_82))
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 (and ssa_75 ssa_77 ssa_27 ssa_29_OldVarAssigCall ssa_20 ssa_41_GlobVarAssigCall ssa_17_LocVarAssigCall ssa_21_LocVarAssigCall ssa_5_LocVarAssigCall ssa_31 ssa_60 ssa_5_GlobVarAssigCall ssa_21_OldVarAssigCall ssa_55_return ssa_68 ssa_7 ssa_44 ssa_16 ssa_57 ssa_6 ssa_26 ssa_34 ssa_17_GlobVarAssigCall ssa_74 ssa_25_GlobVarAssigCall ssa_40 ssa_10 ssa_14 ssa_25_OldVarAssigCall ssa_8 ssa_13_LocVarAssigCall ssa_29_GlobVarAssigCall ssa_46 ssa_47 ssa_53 ssa_13_OldVarAssigCall ssa_25_LocVarAssigCall ssa_37_LocVarAssigCall ssa_67_return ssa_33_GlobVarAssigCall ssa_19 ssa_70_return ssa_33_LocVarAssigCall ssa_59 ssa_39 ssa_62 ssa_43 ssa_61_return ssa_73_return ssa_72 ssa_13_GlobVarAssigCall ssa_41_OldVarAssigCall ssa_17_OldVarAssigCall ssa_38 ssa_12 ssa_32 ssa_5_OldVarAssigCall ssa_50 ssa_65 ssa_41_LocVarAssigCall ssa_64_return ssa_11 ssa_48 ssa_49_return ssa_28 ssa_29_LocVarAssigCall ssa_54 ssa_37_GlobVarAssigCall ssa_22 ssa_51 ssa_36 ssa_15 ssa_63 ssa_45_OldVarAssigCall ssa_45_LocVarAssigCall ssa_78 ssa_18 ssa_23 ssa_30 ssa_66 ssa_69 ssa_9_LocVarAssigCall ssa_56 ssa_9_OldVarAssigCall ssa_35 ssa_76_return ssa_21_GlobVarAssigCall ssa_79_return ssa_9_GlobVarAssigCall ssa_33_OldVarAssigCall ssa_58_return ssa_45_GlobVarAssigCall ssa_42 ssa_71 ssa_24 ssa_37_OldVarAssigCall ssa_52_return) ssa_80 ssa_81 (and ssa_82 ssa_postcond))
...
(declare-fun |addition_#t~ret4_71| () Int)
(declare-fun |addition_#res_71| () Int)
(declare-fun |main_#t~ret8_73| () Int)
(declare-fun |addition_#res_73| () Int)
(assert (! true :named ssa_precond))
(assert (! (not (<= main_~n~0_-2 10)) :named ssa_postcond))
...
(assert (! (and (<= 0 (+ 9223372036854775808 |addition_#t~ret4_70|)) (<= |addition_#t~ret4_70| 9223372036854775807) (= |addition_#res_71| |addition_#t~ret4_70|)) :named ssa_71))
(assert (! true :named ssa_72))
(assert (! (= |addition_#res_71| |main_#t~ret8_73|) :named ssa_73_return))
(assert (! true :named ssa_-2_PendingContext))
