...
(set-info :ultimate-id avg40-2.i_AllErrorsAtOnce_Iteration1)
...
(assert (! (and (= main_~i~1_4 0) (= |main_~#x~0.offset_4| 0) (= (store |#valid_3| |main_~#x~0.base_4| v_ArrVal_1_fresh_1) |#valid_4|) (= (select |#valid_3| |main_~#x~0.base_4|) 0) (< |#StackHeapBarrier_-1| |main_~#x~0.base_4|) (= v_ArrVal_1_fresh_1 1) (= |#length_4| (store |#length_3| |main_~#x~0.base_4| v_ArrVal_2_fresh_1)) (not (= |main_~#x~0.base_4| 0)) (= 160 v_ArrVal_2_fresh_1)) :named ssa_4))
...
(assert (! (and (= v_main_~temp~0_6_fresh_1 v_ArrVal_4_fresh_1) (= (store (store (select |#memory_int#1_3| |main_~#x~0.base_4|) |main_~#x~0.offset_4| v_ArrVal_3_fresh_1) (+ |main_~#x~0.offset_4| 4) v_ArrVal_4_fresh_1) v_ArrVal_5_fresh_1) (= (select (select |#memory_int#1_3| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4)) v_ArrVal_3_fresh_1) (<= 0 (+ |main_#t~ret5_11| 2147483648)) (= |main_#t~ret5_11| main_~ret~1_12) (<= |main_#t~ret5_11| 2147483647) (= (select (select |#memory_int#1_3| |main_~#x~0.base_4|) |main_~#x~0.offset_4|) v_main_~temp~0_6_fresh_1) (= (store |#memory_int#1_3| |main_~#x~0.base_4| v_ArrVal_5_fresh_1) |#memory_int#1_12|)) :named ssa_12))
...
(assert (! (and (= main_~temp~0_18 v_ArrVal_6_fresh_1) (= (store (select |#memory_int#1_12| |main_~#x~0.base_4|) (+ 156 |main_~#x~0.offset_4|) v_ArrVal_6_fresh_1) v_ArrVal_7_fresh_1) (= (store |#memory_int#1_12| |main_~#x~0.base_4| v_ArrVal_7_fresh_1) |#memory_int#1_20|)) :named ssa_20))
