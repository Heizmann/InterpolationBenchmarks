...
(set-info :ultimate-id watermelon.c_AllErrorsAtOnce_Iteration6)
...
(declare-fun v_main_~is_divisible2~0_11_fresh_1 () Int)
(declare-fun v_main_~is_divisible1~0_11_fresh_1 () Int)
...
(assert (! (and (= ~true~0_1 v_main_~is_divisible2~0_11_fresh_1) (= ~true~0_1 v_main_~is_divisible1~0_11_fresh_1)) :named ssa_4))
...
(assert (! (and (= (+ 2 student_version_~i~1_15) student_version_~i~1_16) (< student_version_~i~1_15 student_version_~w_13)) :named ssa_16))
(assert (! (<= student_version_~w_13 student_version_~i~1_16) :named ssa_17))
(assert (! (= student_version_~w_13 student_version_~i~1_16) :named ssa_18))
(assert (! true :named ssa_19))
(assert (! (= student_version_~is_divisible~1_13 |student_version_#res_20|) :named ssa_20))
...
(assert (! (= (ite (= main_~is_divisible1~0_11 main_~is_divisible2~0_22) 1 0) |__VERIFIER_assert_#in~cond_23|) :named ssa_23_LocVarAssigCall))
...
(assert (! true :named ssa_precond))
(assert (! (not (or (< (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647) main_~w~0_-2) (< main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 4)))) :named ssa_postcond))
...
(assert (! (or (< (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647) main_~w~0_-2) (< main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 4))) :named ssa_-2_PendingContext))
