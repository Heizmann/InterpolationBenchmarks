...
(set-info :ultimate-id underapprox_1-2.c_AllErrorsAtOnce_Iteration5)
...
(assert (! (<= 6 (mod main_~x~0_7 4294967296)) :named ssa_8))
(assert (! true :named ssa_9_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_9| (mod (mod main_~y~0_7 4294967296) 3)) :named ssa_9_LocVarAssigCall))
