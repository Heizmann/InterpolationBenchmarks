...
(set-info :ultimate-id watermelon.c_AllErrorsAtOnce_Iteration9)
...
(declare-fun v_main_~is_divisible1~0_14_fresh_1 () Int)
(declare-fun v_main_~is_divisible2~0_14_fresh_1 () Int)
...
(assert (! (and (= ~true~0_1 v_main_~is_divisible1~0_14_fresh_1) (= ~true~0_1 v_main_~is_divisible2~0_14_fresh_1)) :named ssa_4))
...
(assert (! (and (not (= student_version_~w_18 student_version_~i~1_21)) (= ~false~0_1 student_version_~is_divisible~1_23)) :named ssa_23))
(assert (! true :named ssa_24))
(assert (! (= student_version_~is_divisible~1_23 |student_version_#res_25|) :named ssa_25))
...
(assert (! (and (not (= student_version_~w_0 student_version_~i~1_3)) (= ~false~0_-1 student_version_~is_divisible~1_5)) :named ssa_5))
(assert (! true :named ssa_6))
(assert (! (= student_version_~is_divisible~1_5 |student_version_#res_7|) :named ssa_7))
