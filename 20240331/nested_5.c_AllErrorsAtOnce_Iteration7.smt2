...
(set-info :ultimate-id nested_5.c_AllErrorsAtOnce_Iteration7)
...
(assert (! (<= 6 main_~e~0_9) :named ssa_10))
(assert (! (= main_~d~0_11 (+ main_~d~0_7 1)) :named ssa_11))
(assert (! (<= 6 main_~d~0_11) :named ssa_12))
(assert (! (= main_~c~0_13 (+ main_~c~0_6 1)) :named ssa_13))
(assert (! (<= 6 main_~c~0_13) :named ssa_14))
(assert (! (= (+ main_~b~0_5 1) main_~b~0_15) :named ssa_15))
(assert (! (<= 6 main_~b~0_15) :named ssa_16))
(assert (! (= (+ main_~a~0_4 1) main_~a~0_17) :named ssa_17))
(assert (! (<= 6 main_~a~0_17) :named ssa_18))
(assert (! (or (not (= main_~d~0_11 6)) (not (= main_~b~0_15 6)) (not (= main_~a~0_17 6)) (not (= main_~e~0_9 6)) (not (= main_~c~0_13 6))) :named ssa_19))
