...
(set-info :ultimate-id avg40-2.i_AllErrorsAtOnce_Iteration7)
...
(assert (! (and (= main_~i~1_4 0) (= |main_~#x~0.offset_4| 0) (= (select |#valid_3| |main_~#x~0.base_4|) 0) (< |#StackHeapBarrier_-1| |main_~#x~0.base_4|) (= |#valid_4| (store |#valid_3| |main_~#x~0.base_4| v_ArrVal_57_fresh_1)) (= v_ArrVal_57_fresh_1 1) (= 160 v_ArrVal_58_fresh_1) (= (store |#length_3| |main_~#x~0.base_4| v_ArrVal_58_fresh_1) |#length_4|) (not (= |main_~#x~0.base_4| 0))) :named ssa_4))
(assert (! (and (= (store |#memory_int#1_3| |main_~#x~0.base_4| v_ArrVal_60_fresh_1) |#memory_int#1_5|) (<= |v_main_#t~nondet3_15_fresh_1| 2147483647) (< main_~i~1_4 40) (= (store (select |#memory_int#1_3| |main_~#x~0.base_4|) (+ (* main_~i~1_4 4) |main_~#x~0.offset_4|) v_ArrVal_59_fresh_1) v_ArrVal_60_fresh_1) (<= 0 (+ |v_main_#t~nondet3_15_fresh_1| 2147483648)) (= |v_main_#t~nondet3_15_fresh_1| v_ArrVal_59_fresh_1) (= main_~i~1_5 (+ main_~i~1_4 1))) :named ssa_5))
(assert (! (and (= (store (select |#memory_int#1_5| |main_~#x~0.base_4|) (+ (* main_~i~1_5 4) |main_~#x~0.offset_4|) v_ArrVal_61_fresh_1) v_ArrVal_62_fresh_1) (< main_~i~1_5 40) (= |v_main_#t~nondet3_16_fresh_1| v_ArrVal_61_fresh_1) (= (store |#memory_int#1_5| |main_~#x~0.base_4| v_ArrVal_62_fresh_1) |#memory_int#1_6|) (<= 0 (+ |v_main_#t~nondet3_16_fresh_1| 2147483648)) (<= |v_main_#t~nondet3_16_fresh_1| 2147483647) (= main_~i~1_6 (+ main_~i~1_5 1))) :named ssa_6))
...
(assert (! (and (= v_main_~temp~0_12_fresh_1 v_ArrVal_65_fresh_1) (<= 0 (+ |main_#t~ret5_15| 2147483648)) (= |main_#t~ret5_15| main_~ret~1_16) (= (store (store (select |#memory_int#1_6| |main_~#x~0.base_4|) |main_~#x~0.offset_4| v_ArrVal_63_fresh_1) (+ |main_~#x~0.offset_4| 4) v_main_~temp~0_12_fresh_1) v_ArrVal_64_fresh_1) (<= |main_#t~ret5_15| 2147483647) (= (select (select |#memory_int#1_6| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4)) v_ArrVal_63_fresh_1) (= (store |#memory_int#1_6| |main_~#x~0.base_4| v_ArrVal_64_fresh_1) |#memory_int#1_16|) (= v_main_~temp~0_12_fresh_1 (select (select |#memory_int#1_6| |main_~#x~0.base_4|) |main_~#x~0.offset_4|))) :named ssa_16))
...
(assert (! (and (= |#memory_int#1_25| (store |#memory_int#1_16| |main_~#x~0.base_4| v_ArrVal_66_fresh_1)) (< main_~i~2_24 39) (= v_ArrVal_66_fresh_1 (store (select |#memory_int#1_16| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| (* main_~i~2_24 4)) (select (select |#memory_int#1_16| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4 (* main_~i~2_24 4))))) (= (select (select |#memory_int#1_16| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4 (* main_~i~2_24 4))) v_ArrVal_67_fresh_1) (= main_~i~2_25 (+ main_~i~2_24 1))) :named ssa_25))
(assert (! (<= 39 main_~i~2_25) :named ssa_26))
(assert (! (and (= (store |#memory_int#1_25| |main_~#x~0.base_4| v_ArrVal_69_fresh_1) |#memory_int#1_27|) (= main_~temp~0_24 v_ArrVal_68_fresh_1) (= v_ArrVal_69_fresh_1 (store (select |#memory_int#1_25| |main_~#x~0.base_4|) (+ 156 |main_~#x~0.offset_4|) v_ArrVal_68_fresh_1))) :named ssa_27))
(assert (! true :named ssa_28_GlobVarAssigCall))
(assert (! (and (= |main_~#x~0.base_4| |avg_#in~x.base_28|) (= |main_~#x~0.offset_4| |avg_#in~x.offset_28|)) :named ssa_28_LocVarAssigCall))
...
(assert (! (= |main_#t~ret12_34| |avg_#res_33|) :named ssa_34_return))
