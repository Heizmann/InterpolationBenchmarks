...
(set-info :ultimate-id parity.i_AllErrorsAtOnce_Iteration8)
...
(declare-fun v_main_~parity2~0_15_fresh_1 () Int)
...
(declare-fun main_~parity1~0_19 () Int)
...
(assert (! (and (= main_~v2~0_10 main_~v~0_4) (= v_main_~parity2~0_15_fresh_1 0)) :named ssa_10))
...
(assert (! (and (= (mod main_~v2~0_13 4294967296) 0) (= (div (mod main_~v2~0_13 4294967296) 4) |main_#t~bitwise4_14|)) :named ssa_14))
(assert (! (= main_~v2~0_15 |main_#t~bitwise4_14|) :named ssa_15))
(assert (! (and (= (mod main_~v2~0_15 4294967296) 0) (= |main_#t~bitwise5_16| 0)) :named ssa_16))
(assert (! (= main_~v2~0_17 (* 286331153 |main_#t~bitwise5_16|)) :named ssa_17))
(assert (! (and (= (mod (div (mod main_~v2~0_17 4294967296) 268435456) 2) 0) (= main_~parity2~0_18 0)) :named ssa_18))
(assert (! true :named ssa_19_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_19| (ite (= main_~parity1~0_6 main_~parity2~0_18) 1 0)) :named ssa_19_LocVarAssigCall))
