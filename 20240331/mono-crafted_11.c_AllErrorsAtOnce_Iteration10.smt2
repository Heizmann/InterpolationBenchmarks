...
(set-info :ultimate-id mono-crafted_11.c_AllErrorsAtOnce_Iteration10)
...
(assert (! (<= 100000000 (mod main_~x~0_20 4294967296)) :named ssa_21))
(assert (! true :named ssa_22_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_22| (ite (= (mod main_~x~0_20 2) 0) 1 0)) :named ssa_22_LocVarAssigCall))
