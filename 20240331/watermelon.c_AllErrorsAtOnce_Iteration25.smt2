...
(set-info :ultimate-id watermelon.c_AllErrorsAtOnce_Iteration25)
...
(declare-fun v_main_~is_divisible2~0_30_fresh_1 () Int)
(declare-fun v_main_~is_divisible1~0_30_fresh_1 () Int)
...
(assert (! (and (= ~true~0_1 v_main_~is_divisible2~0_30_fresh_1) (= ~true~0_1 v_main_~is_divisible1~0_30_fresh_1)) :named ssa_4))
...
(assert (! (= student_version_~w_22 student_version_~i~1_29) :named ssa_31))
(assert (! true :named ssa_32))
(assert (! (= student_version_~is_divisible~1_22 |student_version_#res_33|) :named ssa_33))
...
(assert (! true :named ssa_precond))
(assert (! (not (or (< (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647) main_~w~0_-2) (< main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 12)))) :named ssa_postcond))
...
(assert (! (or (< (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647) main_~w~0_-2) (< main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 12))) :named ssa_-2_PendingContext))
