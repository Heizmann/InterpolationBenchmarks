...
(set-info :ultimate-id nested_6.c_AllErrorsAtOnce_Iteration7)
...
(declare-fun |main_#t~pre6_14| () Int)
(declare-fun |main_#t~pre7_16| () Int)
(declare-fun main_~c~0_16 () Int)
(declare-fun |main_#t~pre8_18| () Int)
(declare-fun main_~b~0_18 () Int)
(declare-fun |main_#t~pre9_20| () Int)
(declare-fun main_~a~0_20 () Int)
...
(assert (! (<= 6 main_~f~0_10) :named ssa_11))
(assert (! (= main_~e~0_12 (+ main_~e~0_8 1)) :named ssa_12))
(assert (! (<= 6 main_~e~0_12) :named ssa_13))
(assert (! (= main_~d~0_14 (+ main_~d~0_7 1)) :named ssa_14))
(assert (! (<= 6 main_~d~0_14) :named ssa_15))
(assert (! (= (+ main_~c~0_6 1) main_~c~0_16) :named ssa_16))
(assert (! (<= 6 main_~c~0_16) :named ssa_17))
(assert (! (= main_~b~0_18 (+ main_~b~0_5 1)) :named ssa_18))
(assert (! (<= 6 main_~b~0_18) :named ssa_19))
(assert (! (= main_~a~0_20 (+ main_~a~0_4 1)) :named ssa_20))
(assert (! (<= 6 main_~a~0_20) :named ssa_21))
(assert (! (or (not (= main_~c~0_16 6)) (not (= main_~d~0_14 6)) (not (= main_~a~0_20 6)) (not (= main_~f~0_10 6)) (not (= main_~e~0_12 6)) (not (= main_~b~0_18 6))) :named ssa_22))
