...
(set-info :ultimate-id string_concat-noarr.i_AllErrorsAtOnce_Iteration24)
...
(assert (! (or (<= 1000000 main_~i~0_51) (= |main_#t~nondet3_52| 0)) :named ssa_53))
(assert (! (< main_~j~0_51 100) :named ssa_54))
(assert (! true :named ssa_55_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_55| (ite (< main_~i~0_51 200) 1 0)) :named ssa_55_LocVarAssigCall))
