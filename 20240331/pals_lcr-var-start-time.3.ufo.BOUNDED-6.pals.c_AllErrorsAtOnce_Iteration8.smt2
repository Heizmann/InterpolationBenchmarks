...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:16:39+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id pals_lcr-var-start-time.3.ufo.BOUNDED-6.pals.c_AllErrorsAtOnce_Iteration8)
...
(declare-fun v_main_~c1~0_14_fresh_1 () Int)
...
(declare-fun v_node1_~m1~0_26_fresh_1 () Int)
...
(declare-fun v_node2_~m2~0_26_fresh_1 () Int)
(declare-fun node2_~m2~0_39 () Int)
(declare-fun ~p1_old~0_39 () Int)
(declare-fun node2_~m2~0_43 () Int)
(declare-fun ~st2~0_43 () Int)
...
(declare-fun v_node3_~m3~0_26_fresh_1 () Int)
...
(assert (! (and (<= ~id2~0_4 127) (<= 0 (+ ~send2~0_4 128)) (<= ~id1~0_4 127) (<= 0 (+ ~send3~0_4 128)) (<= ~send3~0_4 127) (= v_main_~c1~0_14_fresh_1 0) (<= ~st2~0_4 127) (<= 0 (+ ~id3~0_4 128)) (<= ~r1~0_4 127) (<= ~st1~0_4 127) (<= 0 (+ 128 ~st3~0_4)) (<= 0 (+ 128 ~st2~0_4)) (<= 0 (+ ~r1~0_4 128)) (<= 0 (+ 128 ~st1~0_4)) (<= 0 (+ ~id2~0_4 128)) (<= ~id3~0_4 127) (<= ~st3~0_4 127) (<= 0 (+ ~send1~0_4 128)) (<= 0 (+ ~id1~0_4 128)) (<= ~send1~0_4 127) (<= ~send2~0_4 127)) :named ssa_4))
...
(assert (! (= ~nomsg~0_1 v_node1_~m1~0_26_fresh_1) :named ssa_31))
...
(assert (! (= ~nomsg~0_1 v_node2_~m2~0_26_fresh_1) :named ssa_38))
(assert (! (and (= ~p1_old~0_39 ~nomsg~0_1) (= ~p1_old~0_37 node2_~m2~0_39) (not (= (mod ~mode2~0_37 256) 0))) :named ssa_39))
(assert (! (not (= node2_~m2~0_39 ~nomsg~0_1)) :named ssa_40))
(assert (! (not (= (mod ~alive2~0_4 256) 0)) :named ssa_41))
(assert (! (<= node2_~m2~0_39 ~id2~0_4) :named ssa_42))
(assert (! (and (= ~st2~0_43 1) (= node2_~m2~0_39 ~id2~0_4)) :named ssa_43))
(assert (! (= ~mode2~0_44 0) :named ssa_44))
...
(assert (! (= ~nomsg~0_1 v_node3_~m3~0_26_fresh_1) :named ssa_48))
...
(assert (! (and (= ~p2_new~0_37 ~p2_old~0_54) (= ~nomsg~0_1 ~p1_new~0_54) (= ~p2_new~0_54 ~nomsg~0_1) (= ~p1_old~0_54 ~p1_new~0_30) (= ~nomsg~0_1 ~p3_new~0_54) (= ~p3_old~0_54 ~p3_new~0_50)) :named ssa_54))
...
(assert (! (and (< 1 (+ ~st1~0_30 ~st2~0_43 ~st3~0_47)) (= check_~tmp~1_57 0)) :named ssa_57))
...
(declare-fun ~send1~0_-1 () Int)
(declare-fun ~nomsg~0_-1 () Int)
(declare-fun v_node1_~m1~0_27_fresh_1 () Int)
(declare-fun ~r1~0_1 () Int)
(declare-fun ~p3_old~0_1 () Int)
...
(assert (! (= ~nomsg~0_-1 v_node1_~m1~0_27_fresh_1) :named ssa_0))
...
(declare-fun ~send2~0_-1 () Int)
(declare-fun ~nomsg~0_-1 () Int)
(declare-fun v_node2_~m2~0_27_fresh_1 () Int)
...
(assert (! (not false) :named ssa_postcond))
(assert (! (= ~nomsg~0_-1 v_node2_~m2~0_27_fresh_1) :named ssa_0))
...
(declare-fun ~p2_old~0_-1 () Int)
(declare-fun ~nomsg~0_-1 () Int)
(declare-fun v_node3_~m3~0_27_fresh_1 () Int)
...
(assert (! (not false) :named ssa_postcond))
(assert (! (= ~nomsg~0_-1 v_node3_~m3~0_27_fresh_1) :named ssa_0))
