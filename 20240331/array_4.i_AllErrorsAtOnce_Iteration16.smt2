...
(set-info :ultimate-id array_4.i_AllErrorsAtOnce_Iteration16)
...
(assert (! (and (= (select |#valid_3| |main_~#A~0.base_4|) 0) (not (= |main_~#A~0.base_4| 0)) (= v_ArrVal_202_fresh_1 4096) (= 0 |main_~#A~0.offset_4|) (= |#valid_4| (store |#valid_3| |main_~#A~0.base_4| v_ArrVal_201_fresh_1)) (= v_ArrVal_201_fresh_1 1) (< |#StackHeapBarrier_-1| |main_~#A~0.base_4|) (= (store |#length_3| |main_~#A~0.base_4| v_ArrVal_202_fresh_1) |#length_4|) (= main_~i~0_4 0)) :named ssa_4))
(assert (! (and (= main_~i~0_5 (+ main_~i~0_4 1)) (= v_ArrVal_203_fresh_1 |v_main_#t~nondet1_78_fresh_1|) (= (store |#memory_int#1_3| |main_~#A~0.base_4| v_ArrVal_204_fresh_1) |#memory_int#1_5|) (< main_~i~0_4 1023) (<= |v_main_#t~nondet1_78_fresh_1| 2147483647) (<= 0 (+ |v_main_#t~nondet1_78_fresh_1| 2147483648)) (= v_ArrVal_204_fresh_1 (store (select |#memory_int#1_3| |main_~#A~0.base_4|) (+ (* main_~i~0_4 4) |main_~#A~0.offset_4|) v_ArrVal_203_fresh_1))) :named ssa_5))
(assert (! (and (<= |v_main_#t~nondet1_79_fresh_1| 2147483647) (= main_~i~0_6 (+ main_~i~0_5 1)) (<= 0 (+ |v_main_#t~nondet1_79_fresh_1| 2147483648)) (= v_ArrVal_206_fresh_1 |v_main_#t~nondet1_79_fresh_1|) (< main_~i~0_5 1023) (= (store |#memory_int#1_5| |main_~#A~0.base_4| v_ArrVal_205_fresh_1) |#memory_int#1_6|) (= (store (select |#memory_int#1_5| |main_~#A~0.base_4|) (+ (* main_~i~0_5 4) |main_~#A~0.offset_4|) |v_main_#t~nondet1_79_fresh_1|) v_ArrVal_205_fresh_1)) :named ssa_6))
(assert (! (and (= main_~i~0_7 (+ main_~i~0_6 1)) (= v_ArrVal_207_fresh_1 (store (select |#memory_int#1_6| |main_~#A~0.base_4|) (+ (* main_~i~0_6 4) |main_~#A~0.offset_4|) |v_main_#t~nondet1_80_fresh_1|)) (< main_~i~0_6 1023) (= v_ArrVal_208_fresh_1 |v_main_#t~nondet1_80_fresh_1|) (<= |v_main_#t~nondet1_80_fresh_1| 2147483647) (= (store |#memory_int#1_6| |main_~#A~0.base_4| v_ArrVal_207_fresh_1) |#memory_int#1_7|) (<= 0 (+ |v_main_#t~nondet1_80_fresh_1| 2147483648))) :named ssa_7))
(assert (! (and (<= |v_main_#t~nondet1_81_fresh_1| 2147483647) (<= 0 (+ |v_main_#t~nondet1_81_fresh_1| 2147483648)) (= main_~i~0_8 (+ main_~i~0_7 1)) (= v_ArrVal_210_fresh_1 (store (select |#memory_int#1_7| |main_~#A~0.base_4|) (+ (* main_~i~0_7 4) |main_~#A~0.offset_4|) v_ArrVal_209_fresh_1)) (< main_~i~0_7 1023) (= (store |#memory_int#1_7| |main_~#A~0.base_4| v_ArrVal_210_fresh_1) |#memory_int#1_8|) (= v_ArrVal_209_fresh_1 |v_main_#t~nondet1_81_fresh_1|)) :named ssa_8))
(assert (! (and (<= |v_main_#t~nondet1_82_fresh_1| 2147483647) (= main_~i~0_9 (+ main_~i~0_8 1)) (= v_ArrVal_211_fresh_1 (store (select |#memory_int#1_8| |main_~#A~0.base_4|) (+ (* main_~i~0_8 4) |main_~#A~0.offset_4|) |v_main_#t~nondet1_82_fresh_1|)) (= v_ArrVal_212_fresh_1 |v_main_#t~nondet1_82_fresh_1|) (<= 0 (+ |v_main_#t~nondet1_82_fresh_1| 2147483648)) (= |#memory_int#1_9| (store |#memory_int#1_8| |main_~#A~0.base_4| v_ArrVal_211_fresh_1)) (< main_~i~0_8 1023)) :named ssa_9))
(assert (! (and (= main_~i~0_10 (+ main_~i~0_9 1)) (= (store |#memory_int#1_9| |main_~#A~0.base_4| v_ArrVal_214_fresh_1) |#memory_int#1_10|) (= v_ArrVal_214_fresh_1 (store (select |#memory_int#1_9| |main_~#A~0.base_4|) (+ (* main_~i~0_9 4) |main_~#A~0.offset_4|) v_ArrVal_213_fresh_1)) (<= |v_main_#t~nondet1_83_fresh_1| 2147483647) (< main_~i~0_9 1023) (= v_ArrVal_213_fresh_1 |v_main_#t~nondet1_83_fresh_1|) (<= 0 (+ |v_main_#t~nondet1_83_fresh_1| 2147483648))) :named ssa_10))
(assert (! (and (= main_~i~0_11 (+ main_~i~0_10 1)) (= v_ArrVal_216_fresh_1 |v_main_#t~nondet1_84_fresh_1|) (<= |v_main_#t~nondet1_84_fresh_1| 2147483647) (< main_~i~0_10 1023) (<= 0 (+ |v_main_#t~nondet1_84_fresh_1| 2147483648)) (= v_ArrVal_215_fresh_1 (store (select |#memory_int#1_10| |main_~#A~0.base_4|) (+ (* main_~i~0_10 4) |main_~#A~0.offset_4|) |v_main_#t~nondet1_84_fresh_1|)) (= (store |#memory_int#1_10| |main_~#A~0.base_4| v_ArrVal_215_fresh_1) |#memory_int#1_11|)) :named ssa_11))
(assert (! (and (= |#memory_int#1_12| (store |#memory_int#1_11| |main_~#A~0.base_4| v_ArrVal_218_fresh_1)) (= main_~i~0_12 (+ main_~i~0_11 1)) (= v_ArrVal_218_fresh_1 (store (select |#memory_int#1_11| |main_~#A~0.base_4|) (+ (* main_~i~0_11 4) |main_~#A~0.offset_4|) v_ArrVal_217_fresh_1)) (= v_ArrVal_217_fresh_1 |v_main_#t~nondet1_85_fresh_1|) (< main_~i~0_11 1023) (<= |v_main_#t~nondet1_85_fresh_1| 2147483647) (<= 0 (+ |v_main_#t~nondet1_85_fresh_1| 2147483648))) :named ssa_12))
(assert (! (and (= main_~i~0_13 (+ main_~i~0_12 1)) (< main_~i~0_12 1023) (= v_ArrVal_219_fresh_1 |v_main_#t~nondet1_86_fresh_1|) (= v_ArrVal_220_fresh_1 (store (select |#memory_int#1_12| |main_~#A~0.base_4|) (+ (* main_~i~0_12 4) |main_~#A~0.offset_4|) v_ArrVal_219_fresh_1)) (= (store |#memory_int#1_12| |main_~#A~0.base_4| v_ArrVal_220_fresh_1) |#memory_int#1_13|) (<= |v_main_#t~nondet1_86_fresh_1| 2147483647) (<= 0 (+ |v_main_#t~nondet1_86_fresh_1| 2147483648))) :named ssa_13))
(assert (! (and (= (store |#memory_int#1_13| |main_~#A~0.base_4| v_ArrVal_221_fresh_1) |#memory_int#1_14|) (= v_ArrVal_221_fresh_1 (store (select |#memory_int#1_13| |main_~#A~0.base_4|) (+ (* main_~i~0_13 4) |main_~#A~0.offset_4|) |v_main_#t~nondet1_87_fresh_1|)) (= main_~i~0_14 (+ main_~i~0_13 1)) (< main_~i~0_13 1023) (<= |v_main_#t~nondet1_87_fresh_1| 2147483647) (<= 0 (+ |v_main_#t~nondet1_87_fresh_1| 2147483648)) (= v_ArrVal_222_fresh_1 |v_main_#t~nondet1_87_fresh_1|)) :named ssa_14))
(assert (! (and (<= 0 (+ |v_main_#t~nondet1_88_fresh_1| 2147483648)) (<= |v_main_#t~nondet1_88_fresh_1| 2147483647) (= (store |#memory_int#1_14| |main_~#A~0.base_4| v_ArrVal_224_fresh_1) |#memory_int#1_15|) (= main_~i~0_15 (+ main_~i~0_14 1)) (= v_ArrVal_224_fresh_1 (store (select |#memory_int#1_14| |main_~#A~0.base_4|) (+ (* main_~i~0_14 4) |main_~#A~0.offset_4|) v_ArrVal_223_fresh_1)) (< main_~i~0_14 1023) (= v_ArrVal_223_fresh_1 |v_main_#t~nondet1_88_fresh_1|)) :named ssa_15))
(assert (! (and (= v_ArrVal_226_fresh_1 (store (select |#memory_int#1_15| |main_~#A~0.base_4|) (+ (* main_~i~0_15 4) |main_~#A~0.offset_4|) v_ArrVal_225_fresh_1)) (= main_~i~0_16 (+ main_~i~0_15 1)) (= (store |#memory_int#1_15| |main_~#A~0.base_4| v_ArrVal_226_fresh_1) |#memory_int#1_16|) (< main_~i~0_15 1023) (= v_ArrVal_225_fresh_1 |v_main_#t~nondet1_89_fresh_1|) (<= 0 (+ |v_main_#t~nondet1_89_fresh_1| 2147483648)) (<= |v_main_#t~nondet1_89_fresh_1| 2147483647)) :named ssa_16))
(assert (! (<= 1023 main_~i~0_16) :named ssa_17))
(assert (! (and (= v_ArrVal_227_fresh_1 (store (select |#memory_int#1_16| |main_~#A~0.base_4|) (+ 4092 |main_~#A~0.offset_4|) 0)) (= (store |#memory_int#1_16| |main_~#A~0.base_4| v_ArrVal_227_fresh_1) |#memory_int#1_18|) (= v_ArrVal_228_fresh_1 0) (= main_~i~0_18 0)) :named ssa_18))
(assert (! (= |main_#t~mem3_19| (select (select |#memory_int#1_18| |main_~#A~0.base_4|) (+ (* main_~i~0_18 4) |main_~#A~0.offset_4|))) :named ssa_19))
(assert (! (and (= main_~i~0_20 (+ main_~i~0_18 1)) (not (= |main_#t~mem3_19| 0))) :named ssa_20))
(assert (! (= |main_#t~mem3_21| (select (select |#memory_int#1_18| |main_~#A~0.base_4|) (+ (* main_~i~0_20 4) |main_~#A~0.offset_4|))) :named ssa_21))
(assert (! (and (= main_~i~0_22 (+ main_~i~0_20 1)) (not (= |main_#t~mem3_21| 0))) :named ssa_22))
(assert (! (= |main_#t~mem3_23| (select (select |#memory_int#1_18| |main_~#A~0.base_4|) (+ (* main_~i~0_22 4) |main_~#A~0.offset_4|))) :named ssa_23))
(assert (! (= |main_#t~mem3_23| 0) :named ssa_24))
(assert (! true :named ssa_25_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_25| (ite (<= main_~i~0_22 1024) 1 0)) :named ssa_25_LocVarAssigCall))
