...
(set-info :ultimate-id mbpr4.c_AllErrorsAtOnce_Iteration2)
...
(assert (! (and (= v_ArrVal_4_fresh_1 1) (= 7 main_~CCCELVOL3~0_5) (= 5 main_~CCCELVOL4~0_5) (= v_ArrVal_3_fresh_1 (* (mod ~CELLCOUNT~0_4 1073741824) 4)) (< 1 ~CELLCOUNT~0_4) (= (select |#valid_3| |main_~#volArray~0.base_5|) 0) (= main_~MINVAL~0_5 2) (= 3 main_~CCCELVOL2~0_5) (= (store |#valid_3| |main_~#volArray~0.base_5| v_ArrVal_4_fresh_1) |#valid_5|) (not (= |main_~#volArray~0.base_5| 0)) (= main_~CCCELVOL1~0_5 1) (= |main_~#volArray~0.offset_5| 0) (< |#StackHeapBarrier_-1| |main_~#volArray~0.base_5|) (= (store |#length_3| |main_~#volArray~0.base_5| v_ArrVal_3_fresh_1) |#length_5|)) :named ssa_5))
...
(assert (! (and (= (select (select |#memory_int#1_3| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_20 4))) |v_main_#t~mem21_7_fresh_1|) (< main_~i~0_20 ~CELLCOUNT~0_4) (or (and (< |v_main_#t~mem21_7_fresh_1| main_~MINVAL~0_5) (not |main_#t~short23_21|)) (and |main_#t~short23_21| (<= main_~MINVAL~0_5 |v_main_#t~mem21_7_fresh_1|)))) :named ssa_21))
(assert (! |main_#t~short23_21| :named ssa_22))
(assert (! true :named ssa_23_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_23| (ite |main_#t~short23_21| 1 0)) :named ssa_23_LocVarAssigCall))
