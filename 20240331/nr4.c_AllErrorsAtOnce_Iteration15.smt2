...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-30T23:52:50+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id nr4.c_AllErrorsAtOnce_Iteration15)
...
(declare-fun |v_main_#t~mem7_32_fresh_1| () Int)
...
(assert (! (and (< |#StackHeapBarrier_-1| |main_~#volArray~0.base_5|) (= |main_~#volArray~0.offset_5| 0) (= v_ArrVal_102_fresh_1 1) (= (store |#length_3| |main_~#volArray~0.base_5| v_ArrVal_101_fresh_1) |#length_5|) (not (= |main_~#volArray~0.base_5| 0)) (= 0 (select |#valid_3| |main_~#volArray~0.base_5|)) (= main_~MINVAL~0_5 2) (< 1 ~CELLCOUNT~0_4) (= (store |#valid_3| |main_~#volArray~0.base_5| v_ArrVal_102_fresh_1) |#valid_5|) (= v_ArrVal_101_fresh_1 (* (mod ~CELLCOUNT~0_4 1073741824) 4))) :named ssa_5))
...
(assert (! (and (= v_ArrVal_104_fresh_1 main_~j~0_13) (= v_ArrVal_103_fresh_1 (store (select |#memory_int#1_3| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~j~0_13 (- 4)) (* main_~i~0_12 16)) main_~j~0_13)) (= |#memory_int#1_15| (store |#memory_int#1_3| |main_~#volArray~0.base_5| v_ArrVal_103_fresh_1)) (<= main_~MINVAL~0_5 main_~j~0_13)) :named ssa_15))
(assert (! (= main_~j~0_13 (+ main_~j~0_16 1)) :named ssa_16))
(assert (! (<= 1 main_~j~0_16) :named ssa_17))
(assert (! (and (= (store |#memory_int#1_15| |main_~#volArray~0.base_5| v_ArrVal_105_fresh_1) |#memory_int#1_18|) (= v_ArrVal_105_fresh_1 (store (select |#memory_int#1_15| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~j~0_16 (- 4)) (* main_~i~0_12 16)) main_~j~0_16)) (= v_ArrVal_106_fresh_1 main_~j~0_16) (<= main_~MINVAL~0_5 main_~j~0_16)) :named ssa_18))
(assert (! (= main_~j~0_16 (+ main_~j~0_19 1)) :named ssa_19))
(assert (! (<= 1 main_~j~0_19) :named ssa_20))
(assert (! (and (= v_ArrVal_108_fresh_1 main_~j~0_19) (<= main_~MINVAL~0_5 main_~j~0_19) (= v_ArrVal_107_fresh_1 (store (select |#memory_int#1_18| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~j~0_19 (- 4)) (* main_~i~0_12 16)) main_~j~0_19)) (= (store |#memory_int#1_18| |main_~#volArray~0.base_5| v_ArrVal_107_fresh_1) |#memory_int#1_21|)) :named ssa_21))
(assert (! (= main_~j~0_19 (+ main_~j~0_22 1)) :named ssa_22))
(assert (! (<= 1 main_~j~0_22) :named ssa_23))
(assert (! (and (< main_~j~0_22 main_~MINVAL~0_5) (= v_ArrVal_110_fresh_1 (store (select |#memory_int#1_21| |main_~#volArray~0.base_5|) (+ (* main_~i~0_12 16) |main_~#volArray~0.offset_5| (* main_~j~0_22 (- 4))) v_ArrVal_109_fresh_1)) (= v_ArrVal_109_fresh_1 0) (= (store |#memory_int#1_21| |main_~#volArray~0.base_5| v_ArrVal_110_fresh_1) |#memory_int#1_24|)) :named ssa_24))
...
(assert (! (and (= v_ArrVal_111_fresh_1 (store (select |#memory_int#1_24| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~j~0_28 (- 4)) (* main_~i~0_27 16)) main_~j~0_28)) (= (store |#memory_int#1_24| |main_~#volArray~0.base_5| v_ArrVal_111_fresh_1) |#memory_int#1_30|) (= v_ArrVal_112_fresh_1 main_~j~0_28) (<= main_~MINVAL~0_5 main_~j~0_28)) :named ssa_30))
(assert (! (= main_~j~0_28 (+ main_~j~0_31 1)) :named ssa_31))
(assert (! (<= 1 main_~j~0_31) :named ssa_32))
(assert (! (and (= (store |#memory_int#1_30| |main_~#volArray~0.base_5| v_ArrVal_113_fresh_1) |#memory_int#1_33|) (= v_ArrVal_114_fresh_1 main_~j~0_31) (= v_ArrVal_113_fresh_1 (store (select |#memory_int#1_30| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~j~0_31 (- 4)) (* main_~i~0_27 16)) main_~j~0_31)) (<= main_~MINVAL~0_5 main_~j~0_31)) :named ssa_33))
(assert (! (= main_~j~0_31 (+ main_~j~0_34 1)) :named ssa_34))
(assert (! (<= 1 main_~j~0_34) :named ssa_35))
(assert (! (and (= v_ArrVal_115_fresh_1 (store (select |#memory_int#1_33| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~j~0_34 (- 4)) (* main_~i~0_27 16)) main_~j~0_34)) (= (store |#memory_int#1_33| |main_~#volArray~0.base_5| v_ArrVal_115_fresh_1) |#memory_int#1_36|) (= v_ArrVal_116_fresh_1 main_~j~0_34) (<= main_~MINVAL~0_5 main_~j~0_34)) :named ssa_36))
(assert (! (= main_~j~0_34 (+ main_~j~0_37 1)) :named ssa_37))
(assert (! (<= 1 main_~j~0_37) :named ssa_38))
(assert (! (and (< main_~j~0_37 main_~MINVAL~0_5) (= (store (select |#memory_int#1_36| |main_~#volArray~0.base_5|) (+ (* main_~i~0_27 16) |main_~#volArray~0.offset_5| (* main_~j~0_37 (- 4))) v_ArrVal_117_fresh_1) v_ArrVal_118_fresh_1) (= v_ArrVal_117_fresh_1 0) (= (store |#memory_int#1_36| |main_~#volArray~0.base_5| v_ArrVal_118_fresh_1) |#memory_int#1_39|)) :named ssa_39))
...
(assert (! (and (< main_~i~0_44 ~CELLCOUNT~0_4) (= (select (select |#memory_int#1_39| |main_~#volArray~0.base_5|) (+ (* main_~i~0_44 4) |main_~#volArray~0.offset_5|)) |v_main_#t~mem7_30_fresh_1|) (or (and (< |v_main_#t~mem7_30_fresh_1| main_~MINVAL~0_5) (not |main_#t~short9_45|)) (and |main_#t~short9_45| (<= main_~MINVAL~0_5 |v_main_#t~mem7_30_fresh_1|)))) :named ssa_45))
...
(assert (! (and (= (select (select |#memory_int#1_39| |main_~#volArray~0.base_5|) (+ (* main_~i~0_52 4) |main_~#volArray~0.offset_5|)) |v_main_#t~mem7_31_fresh_1|) (< main_~i~0_52 ~CELLCOUNT~0_4) (or (and |main_#t~short9_53| (<= main_~MINVAL~0_5 |v_main_#t~mem7_31_fresh_1|)) (and (< |v_main_#t~mem7_31_fresh_1| main_~MINVAL~0_5) (not |main_#t~short9_53|)))) :named ssa_53))
...
(assert (! (and (= (select (select |#memory_int#1_39| |main_~#volArray~0.base_5|) (+ (* main_~i~0_60 4) |main_~#volArray~0.offset_5|)) |v_main_#t~mem7_32_fresh_1|) (or (and |main_#t~short9_61| (<= main_~MINVAL~0_5 |v_main_#t~mem7_32_fresh_1|)) (and (< |v_main_#t~mem7_32_fresh_1| main_~MINVAL~0_5) (not |main_#t~short9_61|))) (< main_~i~0_60 ~CELLCOUNT~0_4)) :named ssa_61))
(assert (! (and (not |main_#t~short9_61|) (= |v_main_#t~mem8_18_fresh_1| (select (select |#memory_int#1_39| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_60 4)))) (or (and |main_#t~short9_62| (= |v_main_#t~mem8_18_fresh_1| 0)) (and (not |main_#t~short9_62|) (not (= |v_main_#t~mem8_18_fresh_1| 0))))) :named ssa_62))
(assert (! true :named ssa_63_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_63| (ite |main_#t~short9_62| 1 0)) :named ssa_63_LocVarAssigCall))
...
(assert (! true :named ssa_precond))
(assert (! (not (and (= main_~i~0_-2 0) (= 2 main_~MINVAL~0_-2) (or (< 1 (select (select |#memory_int#1_-2| |main_~#volArray~0.base_-2|) (+ |main_~#volArray~0.offset_-2| 8))) (= (select (select |#memory_int#1_-2| |main_~#volArray~0.base_-2|) (+ |main_~#volArray~0.offset_-2| 8)) 0)))) :named ssa_postcond))
...
(assert (! true :named ssa_2))
(assert (! true :named ssa_3_return))
(assert (! (and (= main_~i~0_-2 0) (= 2 main_~MINVAL~0_-2) (or (< 1 (select (select |#memory_int#1_-2| |main_~#volArray~0.base_-2|) (+ |main_~#volArray~0.offset_-2| 8))) (= (select (select |#memory_int#1_-2| |main_~#volArray~0.base_-2|) (+ |main_~#volArray~0.offset_-2| 8)) 0))) :named ssa_-2_PendingContext))
...
(declare-fun __VERIFIER_assert_~cond_1 () Int)
(assert (! true :named ssa_precond))
(assert (! (not (and (= 2 main_~MINVAL~0_-2) (or (< 1 (select (select |#memory_int#1_-2| |main_~#volArray~0.base_-2|) (+ |main_~#volArray~0.offset_-2| 4 (* main_~i~0_-2 4)))) (= (select (select |#memory_int#1_-2| |main_~#volArray~0.base_-2|) (+ |main_~#volArray~0.offset_-2| 4 (* main_~i~0_-2 4))) 0)))) :named ssa_postcond))
(assert (! (= __VERIFIER_assert_~cond_0 |__VERIFIER_assert_#in~cond_-1|) :named ssa_0))
(assert (! (not (= __VERIFIER_assert_~cond_0 0)) :named ssa_1))
(assert (! true :named ssa_2))
(assert (! true :named ssa_3_return))
(assert (! (and (= 2 main_~MINVAL~0_-2) (or (< 1 (select (select |#memory_int#1_-2| |main_~#volArray~0.base_-2|) (+ |main_~#volArray~0.offset_-2| 4 (* main_~i~0_-2 4)))) (= (select (select |#memory_int#1_-2| |main_~#volArray~0.base_-2|) (+ |main_~#volArray~0.offset_-2| 4 (* main_~i~0_-2 4))) 0))) :named ssa_-2_PendingContext))
(assert (! (= |__VERIFIER_assert_#in~cond_-1| (ite |main_#t~short9_-2| 1 0)) :named ssa_-2_LocVarAssignPendingContext))
(assert (! true :named ssa_-2_OldVarAssignPendingContext))
(check-sat)
(get-interpolants (and ssa_0 ssa_precond) ssa_1 ssa_2 (and ssa_-2_PendingContext ssa_3_return ssa_-2_LocVarAssignPendingContext ssa_-2_OldVarAssignPendingContext ssa_postcond))
