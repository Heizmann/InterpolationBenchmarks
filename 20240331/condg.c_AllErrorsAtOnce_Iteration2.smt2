...
(set-info :ultimate-id condg.c_AllErrorsAtOnce_Iteration2)
...
(assert (! (and (= (* (mod ~N~0_4 1073741824) 4) v_ArrVal_11_fresh_1) (= v_ArrVal_8_fresh_1 1) (< |#StackHeapBarrier_-1| |main_~#sum~0.base_11|) (= 4 v_ArrVal_9_fresh_1) (= (select |#valid_3| |main_~#sum~0.base_11|) 0) (not (= |main_~#sum~0.base_11| 0)) (= (store (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_12_fresh_1) main_~a~0.base_11 v_ArrVal_8_fresh_1) |#valid_11|) (< main_~a~0.base_11 |#StackHeapBarrier_-1|) (= main_~i~0_11 0) (= v_ArrVal_7_fresh_1 (store (select |#memory_int#1_3| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| 0)) (= (store |#memory_int#1_3| |main_~#sum~0.base_11| v_ArrVal_7_fresh_1) |#memory_int#1_11|) (= |#length_11| (store (store |#length_3| |main_~#sum~0.base_11| v_ArrVal_9_fresh_1) main_~a~0.base_11 v_ArrVal_11_fresh_1)) (= v_ArrVal_10_fresh_1 0) (= |main_~#sum~0.offset_11| 0) (= main_~a~0.offset_11 0) (not (= main_~a~0.base_11 0)) (= v_ArrVal_12_fresh_1 1) (= (select (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_12_fresh_1) main_~a~0.base_11) 0)) :named ssa_11))
(assert (! (<= ~N~0_4 main_~i~0_11) :named ssa_12))
...
(assert (! (and (< main_~i~0_17 ~N~0_4) (= |main_#t~mem14_18| (select (select |#memory_int#3_3| main_~a~0.base_11) (+ (* main_~i~0_17 4) main_~a~0.offset_11)))) :named ssa_18))
(assert (! true :named ssa_19_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_19| (ite (= |main_#t~mem14_18| 0) 1 0)) :named ssa_19_LocVarAssigCall))
