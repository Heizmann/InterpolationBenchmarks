...
(set-info :ultimate-id standard_copyInit_ground.i_AllErrorsAtOnce_Iteration3)
...
(declare-fun |main_#t~mem1_8| () Int)
...
(assert (! (and (= (select (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_10_fresh_1) |main_~#b~0.base_4|) 0) (= main_~i~0_4 0) (< |#StackHeapBarrier_-1| |main_~#a~0.base_4|) (= |main_~#b~0.offset_4| 0) (= 400000 v_ArrVal_9_fresh_1) (not (= |main_~#a~0.base_4| 0)) (not (= |main_~#b~0.base_4| 0)) (= (store (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_10_fresh_1) |main_~#b~0.base_4| v_ArrVal_12_fresh_1) |#valid_4|) (= |main_~#a~0.offset_4| 0) (= 400000 v_ArrVal_11_fresh_1) (< |#StackHeapBarrier_-1| |main_~#b~0.base_4|) (= (select |#valid_3| |main_~#a~0.base_4|) 0) (= v_ArrVal_10_fresh_1 1) (= (store (store |#length_3| |main_~#a~0.base_4| v_ArrVal_11_fresh_1) |main_~#b~0.base_4| v_ArrVal_9_fresh_1) |#length_4|) (= v_ArrVal_12_fresh_1 1)) :named ssa_4))
(assert (! (and (= |#memory_int#2_5| (store |#memory_int#2_3| |main_~#a~0.base_4| v_ArrVal_13_fresh_1)) (= 42 v_ArrVal_14_fresh_1) (< main_~i~0_4 100000) (= (store (select |#memory_int#2_3| |main_~#a~0.base_4|) (+ (* main_~i~0_4 4) |main_~#a~0.offset_4|) 42) v_ArrVal_13_fresh_1) (= main_~i~0_5 (+ main_~i~0_4 1))) :named ssa_5))
(assert (! (<= 100000 main_~i~0_5) :named ssa_6))
(assert (! (= main_~i~0_7 0) :named ssa_7))
(assert (! (and (= (store |#memory_int#1_3| |main_~#b~0.base_4| v_ArrVal_16_fresh_1) |#memory_int#1_8|) (= (store (select |#memory_int#1_3| |main_~#b~0.base_4|) (+ (* main_~i~0_7 4) |main_~#b~0.offset_4|) v_ArrVal_15_fresh_1) v_ArrVal_16_fresh_1) (= (select (select |#memory_int#2_5| |main_~#a~0.base_4|) (+ (* main_~i~0_7 4) |main_~#a~0.offset_4|)) v_ArrVal_15_fresh_1) (< main_~i~0_7 100000) (= main_~i~0_8 (+ main_~i~0_7 1))) :named ssa_8))
(assert (! (<= 100000 main_~i~0_8) :named ssa_9))
(assert (! (= main_~x~0_10 0) :named ssa_10))
(assert (! (and (< main_~x~0_10 100000) (= |main_#t~mem3_11| (select (select |#memory_int#1_8| |main_~#b~0.base_4|) (+ (* main_~x~0_10 4) |main_~#b~0.offset_4|)))) :named ssa_11))
(assert (! true :named ssa_12_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_12| (ite (= |main_#t~mem3_11| 42) 1 0)) :named ssa_12_LocVarAssigCall))
