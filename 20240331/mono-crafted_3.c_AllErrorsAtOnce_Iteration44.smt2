...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:11:17+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id mono-crafted_3.c_AllErrorsAtOnce_Iteration44)
...
(declare-fun |v_main_#t~post4_83_fresh_1| () Int)
(declare-fun main_~x~0_8 () Int)
(declare-fun |v_main_#t~post4_84_fresh_1| () Int)
...
(assert (! (and (< main_~x~0_4 500000) (= main_~x~0_4 |v_main_#t~post4_83_fresh_1|) (= main_~x~0_6 (+ |v_main_#t~post4_83_fresh_1| 1))) :named ssa_6))
(assert (! (< main_~x~0_6 1000000) :named ssa_7))
(assert (! (and (< main_~x~0_6 500000) (= (+ |v_main_#t~post4_84_fresh_1| 1) main_~x~0_8) (= main_~x~0_6 |v_main_#t~post4_84_fresh_1|)) :named ssa_8))
...
(assert (! (<= main_~y~0_49 0) :named ssa_50))
(assert (! true :named ssa_51_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_51| (ite (= main_~x~0_49 main_~z~0_49) 1 0)) :named ssa_51_LocVarAssigCall))
