...
(set-info :ultimate-id mono-crafted_3.c_AllErrorsAtOnce_Iteration4)
...
(declare-fun |v_main_#t~post4_4_fresh_1| () Int)
(declare-fun main_~x~0_8 () Int)
(declare-fun main_~z~0_8 () Int)
(declare-fun main_~y~0_8 () Int)
(declare-fun |main_#t~post8_8| () Int)
(declare-fun |main_#t~post7_8| () Int)
...
(assert (! (and (= main_~x~0_6 (+ |v_main_#t~post4_4_fresh_1| 1)) (< main_~x~0_4 500000) (= main_~x~0_4 |v_main_#t~post4_4_fresh_1|)) :named ssa_6))
(assert (! (<= 1000000 main_~x~0_6) :named ssa_7))
(assert (! (and (= main_~z~0_8 (+ main_~z~0_4 1)) (= main_~x~0_6 (+ main_~x~0_8 1)) (= main_~y~0_4 (+ main_~y~0_8 2)) (< 0 main_~y~0_4)) :named ssa_8))
(assert (! (<= main_~y~0_8 0) :named ssa_9))
(assert (! true :named ssa_10_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_10| (ite (= main_~x~0_8 main_~z~0_8) 1 0)) :named ssa_10_LocVarAssigCall))
