...
(set-info :ultimate-id Addition03-1.c_AllErrorsAtOnce_Iteration6)
...
(assert (! (and (= 0 addition_~n_22) (= |addition_#res_23| addition_~m_22)) :named ssa_23))
...
(assert (! (= |addition_#res_35| |main_#t~ret8_37|) :named ssa_37_return))
(assert (! (and (<= |main_#t~ret8_37| 9223372036854775807) (<= 0 (+ |main_#t~ret8_37| 9223372036854775808)) (= main_~result~0_38 |main_#t~ret8_37|)) :named ssa_38))
(assert (! (and (< main_~result~0_38 200) (<= 100 main_~n~0_4) (<= 100 main_~m~0_4)) :named ssa_39))
(assert (! true :named ssa_40))
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 (and ssa_25_return ssa_27 ssa_20 ssa_17_LocVarAssigCall ssa_21_LocVarAssigCall ssa_5_LocVarAssigCall ssa_5_GlobVarAssigCall ssa_21_OldVarAssigCall ssa_7 ssa_16 ssa_6 ssa_26 ssa_17_GlobVarAssigCall ssa_10 ssa_14 ssa_8 ssa_13_LocVarAssigCall ssa_34_return ssa_13_OldVarAssigCall ssa_31_return ssa_28_return ssa_19 ssa_13_GlobVarAssigCall ssa_17_OldVarAssigCall ssa_12 ssa_32 ssa_5_OldVarAssigCall ssa_11 ssa_22 ssa_36 ssa_15 ssa_29 ssa_18 ssa_37_return ssa_23 ssa_30 ssa_9_LocVarAssigCall ssa_33 ssa_9_OldVarAssigCall ssa_35 ssa_21_GlobVarAssigCall ssa_9_GlobVarAssigCall ssa_24) ssa_38 ssa_39 (and ssa_40 ssa_postcond))
...
(declare-fun |addition_#res_31| () Int)
(assert (! true :named ssa_precond))
(assert (! (not (<= main_~n~0_-2 4)) :named ssa_postcond))
...
(assert (! (and (<= 0 (+ 9223372036854775808 |addition_#t~ret4_28|)) (<= |addition_#t~ret4_28| 9223372036854775807) (= |addition_#res_29| |addition_#t~ret4_28|)) :named ssa_29))
(assert (! true :named ssa_30))
(assert (! (= |addition_#res_29| |main_#t~ret8_31|) :named ssa_31_return))
(assert (! true :named ssa_-2_PendingContext))
