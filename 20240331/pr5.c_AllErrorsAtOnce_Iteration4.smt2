...
(set-info :ultimate-id pr5.c_AllErrorsAtOnce_Iteration4)
...
(declare-fun |v_main_#t~mem6_9_fresh_1| () Int)
(declare-fun |main_#t~short8_23| () Bool)
(declare-fun |v_main_#t~mem7_7_fresh_1| () Int)
...
(assert (! (and (= (* (mod ~CELLCOUNT~0_4 1073741824) 4) v_ArrVal_8_fresh_1) (= 2 main_~CCCELVOL5~0_5) (= |main_~#volArray~0.offset_5| 0) (< |#StackHeapBarrier_-1| |main_~#volArray~0.base_5|) (= 7 main_~CCCELVOL3~0_5) (= (select |#valid_3| |main_~#volArray~0.base_5|) 0) (= 5 main_~CCCELVOL4~0_5) (= v_ArrVal_7_fresh_1 1) (< 1 ~CELLCOUNT~0_4) (= (store |#length_3| |main_~#volArray~0.base_5| v_ArrVal_8_fresh_1) |#length_5|) (= 3 main_~CCCELVOL2~0_5) (= main_~CCCELVOL1~0_5 1) (not (= |main_~#volArray~0.base_5| 0)) (= |#valid_5| (store |#valid_3| |main_~#volArray~0.base_5| v_ArrVal_7_fresh_1))) :named ssa_5))
...
(assert (! (and (= |#memory_int#1_14| (store |#memory_int#1_3| |main_~#volArray~0.base_5| v_ArrVal_9_fresh_1)) (< main_~CCCELVOL5~0_5 main_~MINVAL~0_5) (= v_ArrVal_10_fresh_1 0) (= v_ArrVal_9_fresh_1 (store (select |#memory_int#1_3| |main_~#volArray~0.base_5|) (+ (- 20) |main_~#volArray~0.offset_5| (* main_~i~0_12 20)) 0))) :named ssa_14))
(assert (! (and (= (store (select |#memory_int#1_14| |main_~#volArray~0.base_5|) (+ (* main_~i~0_12 20) |main_~#volArray~0.offset_5| (- 16)) main_~CCCELVOL4~0_5) v_ArrVal_11_fresh_1) (= v_ArrVal_12_fresh_1 main_~CCCELVOL4~0_5) (= (store |#memory_int#1_14| |main_~#volArray~0.base_5| v_ArrVal_11_fresh_1) |#memory_int#1_15|) (<= main_~MINVAL~0_5 main_~CCCELVOL4~0_5)) :named ssa_15))
(assert (! (and (= v_ArrVal_13_fresh_1 main_~CCCELVOL3~0_5) (<= main_~MINVAL~0_5 main_~CCCELVOL3~0_5) (= (store |#memory_int#1_15| |main_~#volArray~0.base_5| v_ArrVal_14_fresh_1) |#memory_int#1_16|) (= (store (select |#memory_int#1_15| |main_~#volArray~0.base_5|) (+ (* main_~i~0_12 20) |main_~#volArray~0.offset_5| (- 12)) v_ArrVal_13_fresh_1) v_ArrVal_14_fresh_1)) :named ssa_16))
(assert (! (and (= v_ArrVal_16_fresh_1 main_~CCCELVOL2~0_5) (<= main_~MINVAL~0_5 main_~CCCELVOL2~0_5) (= (store |#memory_int#1_16| |main_~#volArray~0.base_5| v_ArrVal_15_fresh_1) |#memory_int#1_17|) (= v_ArrVal_15_fresh_1 (store (select |#memory_int#1_16| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_12 20) (- 8)) main_~CCCELVOL2~0_5))) :named ssa_17))
(assert (! (and (<= main_~MINVAL~0_5 main_~CCCELVOL1~0_5) (= |#memory_int#1_18| (store |#memory_int#1_17| |main_~#volArray~0.base_5| v_ArrVal_17_fresh_1)) (= v_ArrVal_18_fresh_1 main_~CCCELVOL1~0_5) (= (store (select |#memory_int#1_17| |main_~#volArray~0.base_5|) (+ (* main_~i~0_12 20) |main_~#volArray~0.offset_5| (- 4)) main_~CCCELVOL1~0_5) v_ArrVal_17_fresh_1)) :named ssa_18))
...
(assert (! (and (or (and (not |main_#t~short8_22|) (< |v_main_#t~mem6_9_fresh_1| main_~MINVAL~0_5)) (and |main_#t~short8_22| (<= main_~MINVAL~0_5 |v_main_#t~mem6_9_fresh_1|))) (< main_~i~0_21 ~CELLCOUNT~0_4) (= |v_main_#t~mem6_9_fresh_1| (select (select |#memory_int#1_18| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_21 4))))) :named ssa_22))
(assert (! (and (= |v_main_#t~mem7_7_fresh_1| (select (select |#memory_int#1_18| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_21 4)))) (not |main_#t~short8_22|) (or (and (not |main_#t~short8_23|) (not (= |v_main_#t~mem7_7_fresh_1| 0))) (and (= |v_main_#t~mem7_7_fresh_1| 0) |main_#t~short8_23|))) :named ssa_23))
