...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:09:55+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id mine2017-ex4.6.i_AllErrorsAtOnce_Iteration18)
