...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration27)
...
(assert (! (<= 1000000 main_~i~0_30) :named ssa_31))
(assert (! true :named ssa_32_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_32| (ite (= main_~i~0_30 1000000) 1 0)) :named ssa_32_LocVarAssigCall))
