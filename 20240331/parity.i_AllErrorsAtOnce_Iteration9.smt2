...
(set-info :ultimate-id parity.i_AllErrorsAtOnce_Iteration9)
...
(declare-fun v_main_~parity2~0_16_fresh_1 () Int)
(declare-fun |main_#t~bitwise3_3| () Int)
(declare-fun main_~v2~0_13 () Int)
(declare-fun main_~v2~0_14 () Int)
(declare-fun |main_#t~bitwise3_14| () Int)
...
(assert (! (and (= main_~v2~0_10 main_~v~0_4) (= v_main_~parity2~0_16_fresh_1 0)) :named ssa_10))
(assert (! (not (= (mod main_~v2~0_10 4294967296) 0)) :named ssa_11))
(assert (! (not (= (mod (div (mod main_~v2~0_10 4294967296) 2) 4294967296) 0)) :named ssa_12))
(assert (! (and (<= (mod |main_#t~bitwise3_3| 4294967296) (+ (mod main_~v2~0_10 4294967296) (mod (div (mod main_~v2~0_10 4294967296) 2) 4294967296))) (not (= (mod main_~v2~0_10 4294967296) (mod (div (mod main_~v2~0_10 4294967296) 2) 4294967296)))) :named ssa_13))
(assert (! (= main_~v2~0_14 |main_#t~bitwise3_3|) :named ssa_14))
(assert (! (and (= (mod main_~v2~0_14 4294967296) 0) (= (div (mod main_~v2~0_14 4294967296) 4) |main_#t~bitwise4_15|)) :named ssa_15))
(assert (! (= main_~v2~0_16 |main_#t~bitwise4_15|) :named ssa_16))
(assert (! (and (= (mod main_~v2~0_16 4294967296) 0) (= |main_#t~bitwise5_17| 0)) :named ssa_17))
(assert (! (= main_~v2~0_18 (* 286331153 |main_#t~bitwise5_17|)) :named ssa_18))
(assert (! (and (= (mod (div (mod main_~v2~0_18 4294967296) 268435456) 2) 0) (= main_~parity2~0_19 0)) :named ssa_19))
(assert (! true :named ssa_20_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_20| (ite (= main_~parity1~0_6 main_~parity2~0_19) 1 0)) :named ssa_20_LocVarAssigCall))
