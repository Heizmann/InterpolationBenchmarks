...
(set-info :ultimate-id duplets.c_AllErrorsAtOnce_Iteration9)
...
(declare-fun v_mkdup_~x~0_21_fresh_1 () Int)
...
(declare-fun finddup_~j~1_45 () Int)
(declare-fun |finddup_#t~post11_46| () Int)
(declare-fun finddup_~i~1_46 () Int)
(declare-fun finddup_~n_47 () Int)
(declare-fun finddup_~i~1_47 () Int)
(declare-fun |finddup_#res_48| () Int)
(declare-fun |main_#t~ret14_50| () Int)
(declare-fun |finddup_#res_50| () Int)
(declare-fun |main_#t~ret14_51| () Int)
(declare-fun main_~r~0_51 () Int)
(declare-fun |__VERIFIER_assert_#in~cond_52| () Int)
(declare-fun main_~r~0_52 () Int)
...
(assert (! (and (= (store |#length_3| |main_#t~malloc13.base_10| v_ArrVal_137_fresh_1) |#length_10|) (not (= 0 |main_#t~malloc13.base_10|)) (< |main_#t~malloc13.base_10| |#StackHeapBarrier_-1|) (= |#valid_10| (store |#valid_3| |main_#t~malloc13.base_10| v_ArrVal_138_fresh_1)) (= |main_#t~malloc13.offset_10| 0) (= v_ArrVal_137_fresh_1 (* 4 (mod main_~n~0_4 1073741824))) (= (select |#valid_3| |main_#t~malloc13.base_10|) 0) (= v_ArrVal_138_fresh_1 1)) :named ssa_10))
(assert (! (= |old(#memory_int#2)_11| |#memory_int#2_11|) :named ssa_11_GlobVarAssigCall))
(assert (! (and (= |v_#Ultimate.meminit_#ptr.offsetInParam_11_fresh_1| |main_#t~malloc13.offset_10|) (= |v_#Ultimate.meminit_#productInParam_11_fresh_1| (* main_~n~0_4 4)) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_11_fresh_1| 4) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_11_fresh_1|) (= |#Ultimate.meminit_#ptr.base_11| |main_#t~malloc13.base_10|)) :named ssa_11_LocVarAssigCall))
(assert (! (= |old(#memory_int#2)_11| |#memory_int#2_3|) :named ssa_11_OldVarAssigCall))
(assert (! (and (= (store |#memory_int#2_11| |#Ultimate.meminit_#ptr.base_11| v_ArrVal_139_fresh_1) |#memory_int#2_12|) (= ((as const (Array Int Int)) 0) v_ArrVal_139_fresh_1)) :named ssa_12))
...
(assert (! (and (= v_ArrVal_142_fresh_1 (store (store (select |#memory_int#2_15| mkdup_~a.base_16) (+ (* mkdup_~i~0_16 4) mkdup_~a.offset_16) v_ArrVal_140_fresh_1) (+ mkdup_~a.offset_16 (* mkdup_~j~0_16 4)) v_ArrVal_141_fresh_1)) (= v_ArrVal_140_fresh_1 v_mkdup_~x~0_21_fresh_1) (= v_ArrVal_141_fresh_1 v_mkdup_~x~0_21_fresh_1) (<= 0 (+ v_mkdup_~x~0_21_fresh_1 2147483648)) (<= v_mkdup_~x~0_21_fresh_1 2147483647) (= |#memory_int#2_32| (store |#memory_int#2_15| mkdup_~a.base_16 v_ArrVal_142_fresh_1))) :named ssa_32))
(assert (! true :named ssa_33_return))
(assert (! (and (= |main_~#i~2.offset_34| 0) (= (select |#valid_10| |main_~#i~2.base_34|) 0) (= |main_~#j~2.offset_34| 0) (= |#valid_34| (store (store |#valid_10| |main_~#i~2.base_34| v_ArrVal_144_fresh_1) |main_~#j~2.base_34| v_ArrVal_146_fresh_1)) (= v_ArrVal_146_fresh_1 1) (= v_ArrVal_144_fresh_1 1) (not (= |main_~#j~2.base_34| 0)) (= (select (store |#valid_10| |main_~#i~2.base_34| v_ArrVal_144_fresh_1) |main_~#j~2.base_34|) 0) (< |#StackHeapBarrier_-1| |main_~#j~2.base_34|) (= v_ArrVal_145_fresh_1 4) (not (= |main_~#i~2.base_34| 0)) (= |#length_34| (store (store |#length_10| |main_~#i~2.base_34| v_ArrVal_143_fresh_1) |main_~#j~2.base_34| v_ArrVal_145_fresh_1)) (< |#StackHeapBarrier_-1| |main_~#i~2.base_34|) (= v_ArrVal_143_fresh_1 4)) :named ssa_34))
...
(assert (! (<= finddup_~n_36 finddup_~j~1_44) :named ssa_45))
(assert (! (= finddup_~i~1_46 (+ finddup_~i~1_43 1)) :named ssa_46))
(assert (! (<= finddup_~n_36 finddup_~i~1_46) :named ssa_47))
(assert (! (= |finddup_#res_48| 0) :named ssa_48))
(assert (! true :named ssa_49))
(assert (! (= |main_#t~ret14_50| |finddup_#res_48|) :named ssa_50_return))
(assert (! (and (= main_~r~0_51 |main_#t~ret14_50|) (<= |main_#t~ret14_50| 2147483647) (<= 0 (+ |main_#t~ret14_50| 2147483648))) :named ssa_51))
(assert (! true :named ssa_52_GlobVarAssigCall))
(assert (! (= main_~r~0_51 |__VERIFIER_assert_#in~cond_52|) :named ssa_52_LocVarAssigCall))
...
(assert (! (not true) :named ssa_postcond))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_147_fresh_1) (= (store |#memory_int#2_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_147_fresh_1) |#memory_int#2_0|)) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! true :named ssa_-2_PendingContext))
...
(declare-fun v_mkdup_~x~0_22_fresh_1 () Int)
...
(assert (! (and (= v_ArrVal_149_fresh_1 v_mkdup_~x~0_22_fresh_1) (= v_ArrVal_148_fresh_1 v_mkdup_~x~0_22_fresh_1) (= v_ArrVal_150_fresh_1 (store (store (select |#memory_int#2_-1| mkdup_~a.base_0) (+ (* mkdup_~i~0_0 4) mkdup_~a.offset_0) v_ArrVal_149_fresh_1) (+ mkdup_~a.offset_0 (* mkdup_~j~0_0 4)) v_ArrVal_148_fresh_1)) (= |#memory_int#2_16| (store |#memory_int#2_-1| mkdup_~a.base_0 v_ArrVal_150_fresh_1)) (<= 0 (+ v_mkdup_~x~0_22_fresh_1 2147483648)) (<= v_mkdup_~x~0_22_fresh_1 2147483647)) :named ssa_16))
...
(declare-fun finddup_~j~1_9 () Int)
(declare-fun |finddup_#t~post11_10| () Int)
(declare-fun finddup_~i~1_10 () Int)
(declare-fun finddup_~n_11 () Int)
(declare-fun finddup_~i~1_11 () Int)
(declare-fun |finddup_#res_12| () Int)
(declare-fun |main_#t~ret14_14| () Int)
(declare-fun |finddup_#res_14| () Int)
...
(assert (! (<= finddup_~n_0 finddup_~j~1_8) :named ssa_9))
(assert (! (= finddup_~i~1_10 (+ finddup_~i~1_7 1)) :named ssa_10))
(assert (! (<= finddup_~n_0 finddup_~i~1_10) :named ssa_11))
(assert (! (= |finddup_#res_12| 0) :named ssa_12))
(assert (! true :named ssa_13))
(assert (! (= |main_#t~ret14_14| |finddup_#res_12|) :named ssa_14_return))
(assert (! true :named ssa_-2_PendingContext))
