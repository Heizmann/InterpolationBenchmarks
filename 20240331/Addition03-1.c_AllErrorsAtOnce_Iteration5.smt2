...
(set-info :ultimate-id Addition03-1.c_AllErrorsAtOnce_Iteration5)
...
(assert (! (and (= 0 addition_~n_18) (= |addition_#res_19| addition_~m_18)) :named ssa_19))
...
(assert (! (and (<= 0 (+ 9223372036854775808 |addition_#t~ret4_24|)) (<= |addition_#t~ret4_24| 9223372036854775807) (= |addition_#res_25| |addition_#t~ret4_24|)) :named ssa_25))
...
(assert (! (= |addition_#res_28| |main_#t~ret8_30|) :named ssa_30_return))
(assert (! (and (<= |main_#t~ret8_30| 9223372036854775807) (<= 0 (+ |main_#t~ret8_30| 9223372036854775808)) (= main_~result~0_31 |main_#t~ret8_30|)) :named ssa_31))
(assert (! (and (< main_~result~0_31 200) (<= 100 main_~n~0_4) (<= 100 main_~m~0_4)) :named ssa_32))
(assert (! true :named ssa_33))
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 (and ssa_20 ssa_17_LocVarAssigCall ssa_5_LocVarAssigCall ssa_5_GlobVarAssigCall ssa_7 ssa_16 ssa_6 ssa_26 ssa_17_GlobVarAssigCall ssa_27_return ssa_10 ssa_14 ssa_8 ssa_13_LocVarAssigCall ssa_25 ssa_13_OldVarAssigCall ssa_24_return ssa_19 ssa_13_GlobVarAssigCall ssa_17_OldVarAssigCall ssa_12 ssa_5_OldVarAssigCall ssa_11 ssa_28 ssa_22 ssa_15 ssa_29 ssa_30_return ssa_18 ssa_23 ssa_21_return ssa_9_LocVarAssigCall ssa_9_OldVarAssigCall ssa_9_GlobVarAssigCall) ssa_31 ssa_32 (and ssa_postcond ssa_33))
...
(declare-fun |addition_#res_24| () Int)
(assert (! true :named ssa_precond))
(assert (! (not (<= main_~n~0_-2 3)) :named ssa_postcond))
...
(assert (! (and (<= 0 (+ 9223372036854775808 |addition_#t~ret4_21|)) (<= |addition_#t~ret4_21| 9223372036854775807) (= |addition_#res_22| |addition_#t~ret4_21|)) :named ssa_22))
(assert (! true :named ssa_23))
(assert (! (= |addition_#res_22| |main_#t~ret8_24|) :named ssa_24_return))
(assert (! true :named ssa_-2_PendingContext))
