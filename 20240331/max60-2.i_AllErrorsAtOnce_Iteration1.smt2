...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:15:27+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id max60-2.i_AllErrorsAtOnce_Iteration1)
...
(declare-fun |max_#in~x.base_7| () Int)
(declare-fun |main_~#x~0.offset_7| () Int)
(declare-fun |max_#in~x.offset_7| () Int)
(declare-fun |main_~#x~0.base_7| () Int)
(declare-fun max_~ret~0_8 () Int)
(declare-fun max_~x.base_8 () Int)
(declare-fun max_~x.offset_8 () Int)
(declare-fun max_~i~0_8 () Int)
(declare-fun max_~ret~0_10 () Int)
(declare-fun |max_#res_10| () Int)
...
(assert (! (and (not (= |main_~#x~0.base_4| 0)) (= (store |#valid_3| |main_~#x~0.base_4| v_ArrVal_1_fresh_1) |#valid_4|) (= (store |#length_3| |main_~#x~0.base_4| v_ArrVal_2_fresh_1) |#length_4|) (= v_ArrVal_1_fresh_1 1) (= 240 v_ArrVal_2_fresh_1) (< |#StackHeapBarrier_-1| |main_~#x~0.base_4|) (= main_~i~1_4 0) (= (select |#valid_3| |main_~#x~0.base_4|) 0) (= |main_~#x~0.offset_4| 0)) :named ssa_4))
(assert (! (<= 60 main_~i~1_4) :named ssa_5))
(assert (! true :named ssa_6))
(assert (! true :named ssa_7_GlobVarAssigCall))
(assert (! (and (= |max_#in~x.base_7| |main_~#x~0.base_4|) (= |max_#in~x.offset_7| |main_~#x~0.offset_4|)) :named ssa_7_LocVarAssigCall))
(assert (! true :named ssa_7_OldVarAssigCall))
(assert (! (and (= |max_#in~x.base_7| max_~x.base_8) (= max_~i~0_8 0) (= max_~ret~0_8 0) (= max_~x.offset_8 |max_#in~x.offset_7|)) :named ssa_8))
(assert (! false :named ssa_9))
(assert (! (= |max_#res_10| (ite (<= (mod max_~ret~0_8 4294967296) 2147483647) (mod max_~ret~0_8 4294967296) (+ (mod max_~ret~0_8 4294967296) (- 4294967296)))) :named ssa_10))
(assert (! (= |main_#t~ret7_11| |max_#res_10|) :named ssa_11_return))
(assert (! (and (= |#memory_int#1_12| (store |#memory_int#1_3| |main_~#x~0.base_4| v_ArrVal_5_fresh_1)) (= (select (select |#memory_int#1_3| |main_~#x~0.base_4|) |main_~#x~0.offset_4|) v_main_~temp~0_6_fresh_1) (= (store (store (select |#memory_int#1_3| |main_~#x~0.base_4|) |main_~#x~0.offset_4| v_ArrVal_4_fresh_1) (+ |main_~#x~0.offset_4| 4) v_ArrVal_3_fresh_1) v_ArrVal_5_fresh_1) (= |main_#t~ret7_11| main_~ret~1_12) (<= |main_#t~ret7_11| 2147483647) (= (select (select |#memory_int#1_3| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4)) v_ArrVal_4_fresh_1) (<= 0 (+ |main_#t~ret7_11| 2147483648)) (= v_main_~temp~0_6_fresh_1 v_ArrVal_3_fresh_1)) :named ssa_12))
...
(assert (! (= |max_#res_16| (ite (<= (mod max_~ret~0_14 4294967296) 2147483647) (mod max_~ret~0_14 4294967296) (+ (mod max_~ret~0_14 4294967296) (- 4294967296)))) :named ssa_16))
(assert (! (= |max_#res_16| |main_#t~ret10_17|) :named ssa_17_return))
(assert (! (and (<= |main_#t~ret10_17| 2147483647) (= (select (select |#memory_int#1_12| |main_~#x~0.base_4|) |main_~#x~0.offset_4|) main_~temp~0_18) (= main_~i~2_18 0) (= main_~ret2~0_18 |main_#t~ret10_17|) (<= 0 (+ |main_#t~ret10_17| 2147483648))) :named ssa_18))
(assert (! (<= 59 main_~i~2_18) :named ssa_19))
(assert (! (and (= (store (select |#memory_int#1_12| |main_~#x~0.base_4|) (+ 236 |main_~#x~0.offset_4|) v_ArrVal_6_fresh_1) v_ArrVal_7_fresh_1) (= (store |#memory_int#1_12| |main_~#x~0.base_4| v_ArrVal_7_fresh_1) |#memory_int#1_20|) (= main_~temp~0_18 v_ArrVal_6_fresh_1)) :named ssa_20))
(assert (! true :named ssa_21_GlobVarAssigCall))
(assert (! (and (= |max_#in~x.offset_21| |main_~#x~0.offset_4|) (= |max_#in~x.base_21| |main_~#x~0.base_4|)) :named ssa_21_LocVarAssigCall))
...
(assert (! (= |max_#res_24| |main_#t~ret14_25|) :named ssa_25_return))
