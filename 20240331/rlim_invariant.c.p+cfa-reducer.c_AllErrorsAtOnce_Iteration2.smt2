...
(set-info :ultimate-id rlim_invariant.c.p+cfa-reducer.c_AllErrorsAtOnce_Iteration2)
...
(declare-fun v_~someBinaryDOUBLEComparisonOperation_29_fresh_1 () Bool)
(declare-fun main_~main____CPAchecker_TMP_0~0_7 () Int)
(declare-fun v_~someBinaryDOUBLEComparisonOperation_30_fresh_1 () Bool)
(declare-fun main_~main____CPAchecker_TMP_0~0_8 () Int)
(declare-fun main_~main____CPAchecker_TMP_1~0_8 () Int)
(declare-fun v_~someBinaryDOUBLEComparisonOperation_31_fresh_1 () Bool)
...
(declare-fun v_main_~main__S~0_5_fresh_1 () Real)
...
(declare-fun v_~someBinaryDOUBLEComparisonOperation_32_fresh_1 () Bool)
(declare-fun main_~main____CPAchecker_TMP_2~0_15 () Int)
(declare-fun v_~someBinaryDOUBLEComparisonOperation_33_fresh_1 () Bool)
...
(assert (! v_~someBinaryDOUBLEComparisonOperation_29_fresh_1 :named ssa_6))
(assert (! (and (= main_~main____CPAchecker_TMP_0~0_7 1) v_~someBinaryDOUBLEComparisonOperation_30_fresh_1) :named ssa_7))
(assert (! (not (= main_~main____CPAchecker_TMP_0~0_7 0)) :named ssa_8))
(assert (! (not v_~someBinaryDOUBLEComparisonOperation_31_fresh_1) :named ssa_9))
(assert (! (= main_~main____CPAchecker_TMP_1~0_10 0) :named ssa_10))
(assert (! (and (not (= main_~main____CPAchecker_TMP_1~0_10 0)) (= main_~main__X~0_5 main_~main__Y~0_11) (= v_main_~main__S~0_5_fresh_1 main_~main__Y~0_4)) :named ssa_11))
(assert (! v_~someBinaryFLOATComparisonOperation_10_fresh_1 :named ssa_12))
(assert (! true :named ssa_13))
(assert (! v_~someBinaryDOUBLEComparisonOperation_32_fresh_1 :named ssa_14))
(assert (! (and (= main_~main____CPAchecker_TMP_2~0_15 1) v_~someBinaryDOUBLEComparisonOperation_33_fresh_1) :named ssa_15))
(assert (! (and (= v_main_~__tmp_1~0_5_fresh_1 main_~__VERIFIER_assert__cond~0_16) (= main_~main____CPAchecker_TMP_2~0_15 v_main_~__tmp_1~0_5_fresh_1)) :named ssa_16))
