...
(set-info :ultimate-id id2_b3_o5.c_AllErrorsAtOnce_Iteration8)
...
(assert (! (and (= |id_#res_28| 3) (< 3 (mod id_~ret~0_27 4294967296))) :named ssa_28))
...
(assert (! (and (= |id_#res_22| 3) (< 3 (mod id_~ret~0_21 4294967296))) :named ssa_22))
