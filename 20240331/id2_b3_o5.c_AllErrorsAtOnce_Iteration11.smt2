...
(set-info :ultimate-id id2_b3_o5.c_AllErrorsAtOnce_Iteration11)
...
(assert (! (and (= (mod id_~x_18 4294967296) 0) (= |id_#res_19| 0)) :named ssa_19))
(assert (! true :named ssa_20))
(assert (! (= |id_#res_19| |id2_#t~ret5_21|) :named ssa_21_return))
(assert (! (= (+ |id2_#t~ret5_21| 1) id2_~ret~1_22) :named ssa_22))
(assert (! (and (<= (mod id2_~ret~1_22 4294967296) 3) (= id2_~ret~1_22 |id2_#res_23|)) :named ssa_23))
(assert (! true :named ssa_24))
(assert (! (= |id_#t~ret4_25| |id2_#res_23|) :named ssa_25_return))
(assert (! (= id_~ret~0_26 (+ |id_#t~ret4_25| 1)) :named ssa_26))
(assert (! (and (<= (mod id_~ret~0_26 4294967296) 3) (= |id_#res_27| id_~ret~0_26)) :named ssa_27))
(assert (! true :named ssa_28))
(assert (! (= |id_#res_27| |id2_#t~ret5_29|) :named ssa_29_return))
(assert (! (= (+ |id2_#t~ret5_29| 1) id2_~ret~1_30) :named ssa_30))
(assert (! (and (<= (mod id2_~ret~1_30 4294967296) 3) (= id2_~ret~1_30 |id2_#res_31|)) :named ssa_31))
(assert (! true :named ssa_32))
(assert (! (= |id_#t~ret4_33| |id2_#res_31|) :named ssa_33_return))
(assert (! (= id_~ret~0_34 (+ |id_#t~ret4_33| 1)) :named ssa_34))
(assert (! (and (<= (mod id_~ret~0_34 4294967296) 3) (= |id_#res_35| id_~ret~0_34)) :named ssa_35))
(assert (! true :named ssa_36))
(assert (! (= |id_#res_35| |main_#t~ret7_37|) :named ssa_37_return))
(assert (! (= main_~result~0_38 |main_#t~ret7_37|) :named ssa_38))
(assert (! (= 5 (mod main_~result~0_38 4294967296)) :named ssa_39))
(assert (! true :named ssa_40))
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 (and ssa_13 ssa_25_return ssa_14_OldVarAssigCall ssa_27 ssa_20 ssa_17_LocVarAssigCall ssa_5_LocVarAssigCall ssa_31 ssa_5_GlobVarAssigCall ssa_7 ssa_16 ssa_6 ssa_26 ssa_34 ssa_17_GlobVarAssigCall ssa_8_GlobVarAssigCall ssa_11_LocVarAssigCall ssa_14_LocVarAssigCall ssa_10 ssa_9 ssa_14_GlobVarAssigCall ssa_19 ssa_29_return ssa_17_OldVarAssigCall ssa_12 ssa_11_OldVarAssigCall ssa_32 ssa_5_OldVarAssigCall ssa_8_OldVarAssigCall ssa_28 ssa_22 ssa_36 ssa_15 ssa_11_GlobVarAssigCall ssa_33_return ssa_18 ssa_37_return ssa_23 ssa_21_return ssa_30 ssa_35 ssa_8_LocVarAssigCall ssa_24) ssa_38 ssa_39 (and ssa_40 ssa_postcond))
...
(assert (! (and (<= (mod id2_~ret~1_16 4294967296) 3) (= id2_~ret~1_16 |id2_#res_17|)) :named ssa_17))
...
(assert (! (and (<= (mod id_~ret~0_20 4294967296) 3) (= |id_#res_21| id_~ret~0_20)) :named ssa_21))
(assert (! true :named ssa_22))
(assert (! (= |id_#res_21| |id2_#t~ret5_23|) :named ssa_23_return))
(assert (! (= (+ |id2_#t~ret5_23| 1) id2_~ret~1_24) :named ssa_24))
(assert (! (and (<= (mod id2_~ret~1_24 4294967296) 3) (= id2_~ret~1_24 |id2_#res_25|)) :named ssa_25))
(assert (! true :named ssa_26))
(assert (! (= |id_#t~ret4_27| |id2_#res_25|) :named ssa_27_return))
(assert (! (= id_~ret~0_28 (+ |id_#t~ret4_27| 1)) :named ssa_28))
(assert (! (and (<= (mod id_~ret~0_28 4294967296) 3) (= |id_#res_29| id_~ret~0_28)) :named ssa_29))
(assert (! true :named ssa_30))
(assert (! (= |id_#res_29| |main_#t~ret7_31|) :named ssa_31_return))
(assert (! true :named ssa_-2_PendingContext))
...
(declare-fun |id2_#t~ret5_12| () Int)
(declare-fun id2_~ret~1_13 () Int)
(declare-fun |id2_#t~ret5_13| () Int)
(declare-fun id2_~ret~1_14 () Int)
(declare-fun |id2_#res_14| () Int)
...
(assert (! true :named ssa_precond))
(assert (! (not (= |id_#t~ret4_24| 3)) :named ssa_postcond))
...
(assert (! (and (= (mod id_~x_9 4294967296) 0) (= |id_#res_10| 0)) :named ssa_10))
(assert (! true :named ssa_11))
(assert (! (= |id_#res_10| |id2_#t~ret5_12|) :named ssa_12_return))
(assert (! (= (+ |id2_#t~ret5_12| 1) id2_~ret~1_13) :named ssa_13))
(assert (! (and (<= (mod id2_~ret~1_13 4294967296) 3) (= id2_~ret~1_13 |id2_#res_14|)) :named ssa_14))
(assert (! true :named ssa_15))
(assert (! (= |id_#t~ret4_16| |id2_#res_14|) :named ssa_16_return))
(assert (! (= id_~ret~0_17 (+ |id_#t~ret4_16| 1)) :named ssa_17))
(assert (! (and (<= (mod id_~ret~0_17 4294967296) 3) (= |id_#res_18| id_~ret~0_17)) :named ssa_18))
(assert (! true :named ssa_19))
(assert (! (= |id_#res_18| |id2_#t~ret5_20|) :named ssa_20_return))
(assert (! (= (+ |id2_#t~ret5_20| 1) id2_~ret~1_21) :named ssa_21))
(assert (! (and (<= (mod id2_~ret~1_21 4294967296) 3) (= id2_~ret~1_21 |id2_#res_22|)) :named ssa_22))
...
(assert (! true :named ssa_precond))
(assert (! (not (= 2 |id2_#t~ret5_17|)) :named ssa_postcond))
(assert (! (= id_~x_0 |id_#in~x_-1|) :named ssa_0))
(assert (! (not (= (mod id_~x_0 4294967296) 0)) :named ssa_1))
(assert (! true :named ssa_2_GlobVarAssigCall))
(assert (! (= (+ |id2_#in~x_2| 1) id_~x_0) :named ssa_2_LocVarAssigCall))
...
(assert (! (and (<= (mod id2_~ret~1_10 4294967296) 3) (= id2_~ret~1_10 |id2_#res_11|)) :named ssa_11))
...
(assert (! (and (<= (mod id_~ret~0_14 4294967296) 3) (= |id_#res_15| id_~ret~0_14)) :named ssa_15))
(assert (! true :named ssa_16))
(assert (! (= |id_#res_15| |id2_#t~ret5_17|) :named ssa_17_return))
(assert (! true :named ssa_-2_PendingContext))
...
(assert (! (and (<= (mod id2_~ret~1_7 4294967296) 3) (= id2_~ret~1_7 |id2_#res_8|)) :named ssa_8))
