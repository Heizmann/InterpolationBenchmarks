...
(set-info :ultimate-id psyco_abp_1-3.c_AllErrorsAtOnce_Iteration4)
...
(declare-fun v_main_~P5~0_8_fresh_1 () Int)
(declare-fun v_main_~P2~0_8_fresh_1 () Int)
(declare-fun v_main_~P7~0_8_fresh_1 () Int)
(declare-fun |main_#t~nondet13_7| () Int)
(declare-fun |main_#t~nondet13_8| () Int)
(declare-fun v_main_~method_id~0_68_fresh_1 () Int)
...
(declare-fun v_main_~P7~0_9_fresh_1 () Int)
(declare-fun v_main_~P5~0_9_fresh_1 () Int)
(declare-fun v_main_~P2~0_9_fresh_1 () Int)
(declare-fun |main_#t~nondet20_14| () Int)
(declare-fun |main_#t~nondet20_15| () Int)
(declare-fun v_main_~method_id~0_69_fresh_1 () Int)
(declare-fun main_~this_expect~0_17 () Int)
(declare-fun main_~P1~0_17 () Int)
(declare-fun main_~this_buffer_empty~0_17 () Int)
...
(assert (! (and (<= main_~P4~0_6 2147483647) (<= 0 (+ main_~P1~0_6 2147483648)) (<= main_~P3~0_6 2147483647) (<= main_~P8~0_6 2147483647) (<= 0 (+ main_~P8~0_6 2147483648)) (<= 0 (+ main_~P6~0_6 2147483648)) (<= 0 (+ v_main_~P2~0_8_fresh_1 2147483648)) (<= 0 (+ main_~P3~0_6 2147483648)) (<= 0 (+ main_~P9~0_6 2147483648)) (<= v_main_~P2~0_8_fresh_1 2147483647) (<= v_main_~P7~0_8_fresh_1 2147483647) (<= main_~P9~0_6 2147483647) (<= 0 (+ main_~P4~0_6 2147483648)) (<= main_~P1~0_6 2147483647) (<= 0 (+ v_main_~P5~0_8_fresh_1 2147483648)) (<= 0 (+ v_main_~P7~0_8_fresh_1 2147483648)) (<= main_~P6~0_6 2147483647) (<= v_main_~P5~0_8_fresh_1 2147483647)) :named ssa_6))
...
(assert (! (= 1 v_main_~method_id~0_68_fresh_1) :named ssa_9))
(assert (! (and (= main_~this_buffer_empty~0_10 1) (= main_~q~0_10 1) (= main_~this_expect~0_10 0)) :named ssa_10))
(assert (! (and (<= main_~P4~0_11 2147483647) (<= 0 (+ v_main_~P2~0_9_fresh_1 2147483648)) (<= 0 (+ v_main_~P5~0_9_fresh_1 2147483648)) (<= 0 (+ main_~P1~0_11 2147483648)) (<= main_~P3~0_11 2147483647) (<= main_~P8~0_11 2147483647) (<= 0 (+ main_~P8~0_11 2147483648)) (<= 0 (+ main_~P6~0_11 2147483648)) (<= 0 (+ main_~P3~0_11 2147483648)) (<= 0 (+ main_~P9~0_11 2147483648)) (<= 0 (+ v_main_~P7~0_9_fresh_1 2147483648)) (<= main_~P9~0_11 2147483647) (<= 0 (+ main_~P4~0_11 2147483648)) (<= main_~P1~0_11 2147483647) (<= v_main_~P5~0_9_fresh_1 2147483647) (<= v_main_~P7~0_9_fresh_1 2147483647) (<= main_~P6~0_11 2147483647) (<= v_main_~P2~0_9_fresh_1 2147483647)) :named ssa_11))
(assert (! (not (= main_~q~0_10 0)) :named ssa_12))
(assert (! (not (= main_~q~0_10 1)) :named ssa_13))
(assert (! (and (<= |main_#t~nondet20_14| 2147483647) (= main_~q~0_10 2) (<= 0 (+ |main_#t~nondet20_14| 2147483648))) :named ssa_14))
(assert (! (not (= |main_#t~nondet20_14| 0)) :named ssa_15))
(assert (! (and (= 2 v_main_~method_id~0_69_fresh_1) (= (ite (and (< main_~P1~0_11 0) (not (= (mod main_~P1~0_11 2) 0))) (+ (- 2) (mod main_~P1~0_11 2)) (mod main_~P1~0_11 2)) 0)) :named ssa_16))
(assert (! (and (= (mod (ite (and (not (= (mod main_~P1~0_11 2) 0)) (< main_~P1~0_11 0)) (+ (- 2) (mod main_~P1~0_11 2)) (mod main_~P1~0_11 2)) 4294967296) (mod main_~this_expect~0_10 2)) (= (mod main_~this_buffer_empty~0_10 4294967296) 1) (= (ite (and (not (= (mod main_~P1~0_11 2) 0)) (< main_~P1~0_11 0)) (+ (- 2) (mod main_~P1~0_11 2)) (mod main_~P1~0_11 2)) 0)) :named ssa_17))
