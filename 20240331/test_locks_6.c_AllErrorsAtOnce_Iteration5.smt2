...
(set-info :ultimate-id test_locks_6.c_AllErrorsAtOnce_Iteration5)
...
(declare-fun main_~lk2~0_15 () Int)
...
(assert (! (not (= main_~p2~0_4 0)) :named ssa_14))
(assert (! (not (= main_~lk2~0_8 1)) :named ssa_15))
