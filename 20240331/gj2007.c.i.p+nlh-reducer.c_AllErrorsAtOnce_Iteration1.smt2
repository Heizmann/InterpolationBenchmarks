...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:09:39+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id gj2007.c.i.p+nlh-reducer.c_AllErrorsAtOnce_Iteration1)
...
(assert (! (and (= (+ main_~main__x~0_6 1) main_~main__x~0_8) (= (+ main_~main__y~0_4 1) main_~main__y~0_8) (<= 50 main_~main__x~0_6)) :named ssa_8))
(assert (! (< main_~main__x~0_8 100) :named ssa_9))
(assert (! (and (= main_~main__x~0_10 (+ main_~main__x~0_8 1)) (= (+ main_~main__y~0_8 1) main_~main__y~0_10) (<= 50 main_~main__x~0_8)) :named ssa_10))
...
(assert (! (and (= (+ main_~main__y~0_10 1) main_~main__y~0_14) (= main_~main__x~0_14 (+ main_~main__x~0_12 1)) (<= 50 main_~main__x~0_12)) :named ssa_14))
...
(assert (! (and (= (+ main_~main__y~0_14 1) main_~main__y~0_18) (= (+ main_~main__x~0_16 1) main_~main__x~0_18) (<= 50 main_~main__x~0_16)) :named ssa_18))
...
(assert (! (and (<= 50 main_~main__x~0_22) (= main_~main__y~0_24 (+ main_~main__y~0_18 1)) (= (+ main_~main__x~0_22 1) main_~main__x~0_24)) :named ssa_24))
...
(assert (! (and (= (+ main_~main__x~0_26 1) main_~main__x~0_28) (= (+ main_~main__y~0_24 1) main_~main__y~0_28) (<= 50 main_~main__x~0_26)) :named ssa_28))
(assert (! (< main_~main__x~0_28 100) :named ssa_29))
(assert (! (and (<= 50 main_~main__x~0_28) (= (+ main_~main__y~0_28 1) main_~main__y~0_30) (= main_~main__x~0_30 (+ main_~main__x~0_28 1))) :named ssa_30))
...
(assert (! (and (= (+ main_~main__y~0_32 1) main_~main__y~0_40) (= (+ main_~main__x~0_38 1) main_~main__x~0_40) (<= 50 main_~main__x~0_38)) :named ssa_40))
...
(assert (! (and (= main_~main__y~0_46 (+ main_~main__y~0_42 1)) (= main_~main__x~0_46 (+ main_~main__x~0_44 1)) (<= 50 main_~main__x~0_44)) :named ssa_46))
...
(assert (! (and (= (+ main_~main__y~0_46 1) main_~main__y~0_50) (= main_~main__x~0_50 (+ main_~main__x~0_48 1)) (<= 50 main_~main__x~0_48)) :named ssa_50))
...
(assert (! (and (= main_~main__x~0_56 (+ main_~main__x~0_54 1)) (<= 50 main_~main__x~0_54) (= (+ main_~main__y~0_50 1) main_~main__y~0_56)) :named ssa_56))
...
(assert (! (and (= main_~main__y~0_60 (+ main_~main__y~0_56 1)) (= (+ main_~main__x~0_58 1) main_~main__x~0_60) (<= 50 main_~main__x~0_58)) :named ssa_60))
...
(assert (! (and (<= 50 main_~main__x~0_70) (= main_~main__y~0_72 (+ main_~main__y~0_64 1)) (= (+ main_~main__x~0_70 1) main_~main__x~0_72)) :named ssa_72))
...
(assert (! (and (= main_~main__x~0_76 (+ main_~main__x~0_74 1)) (< main_~main__x~0_74 50)) :named ssa_76))
(assert (! (< main_~main__x~0_76 100) :named ssa_77))
(assert (! (and (= main_~main__x~0_78 (+ main_~main__x~0_76 1)) (<= 50 main_~main__x~0_76) (= (+ main_~main__y~0_74 1) main_~main__y~0_78)) :named ssa_78))
(assert (! (< main_~main__x~0_78 100) :named ssa_79))
(assert (! (and (< main_~main__x~0_78 50) (= (+ main_~main__x~0_78 1) main_~main__x~0_80)) :named ssa_80))
(assert (! (< main_~main__x~0_80 100) :named ssa_81))
(assert (! (and (<= 50 main_~main__x~0_80) (= (+ main_~main__x~0_80 1) main_~main__x~0_82) (= main_~main__y~0_82 (+ main_~main__y~0_78 1))) :named ssa_82))
(assert (! (< main_~main__x~0_82 100) :named ssa_83))
(assert (! (and (< main_~main__x~0_82 50) (= main_~main__x~0_84 (+ main_~main__x~0_82 1))) :named ssa_84))
(assert (! (< main_~main__x~0_84 100) :named ssa_85))
(assert (! (and (= (+ main_~main__x~0_84 1) main_~main__x~0_86) (< main_~main__x~0_84 50)) :named ssa_86))
(assert (! (< main_~main__x~0_86 100) :named ssa_87))
(assert (! (and (= (+ main_~main__x~0_86 1) main_~main__x~0_88) (= (+ main_~main__y~0_82 1) main_~main__y~0_88) (<= 50 main_~main__x~0_86)) :named ssa_88))
(assert (! (< main_~main__x~0_88 100) :named ssa_89))
(assert (! (and (< main_~main__x~0_88 50) (= main_~main__x~0_90 (+ main_~main__x~0_88 1))) :named ssa_90))
(assert (! (< main_~main__x~0_90 100) :named ssa_91))
(assert (! (and (<= 50 main_~main__x~0_90) (= (+ main_~main__y~0_88 1) main_~main__y~0_92) (= (+ main_~main__x~0_90 1) main_~main__x~0_92)) :named ssa_92))
...
(assert (! (and (= (+ main_~main__x~0_96 1) main_~main__x~0_98) (< main_~main__x~0_96 50)) :named ssa_98))
(assert (! (< main_~main__x~0_98 100) :named ssa_99))
(assert (! (and (< main_~main__x~0_98 50) (= main_~main__x~0_100 (+ main_~main__x~0_98 1))) :named ssa_100))
(assert (! (< main_~main__x~0_100 100) :named ssa_101))
(assert (! (and (< main_~main__x~0_100 50) (= main_~main__x~0_102 (+ main_~main__x~0_100 1))) :named ssa_102))
(assert (! (< main_~main__x~0_102 100) :named ssa_103))
(assert (! (and (= (+ main_~main__x~0_102 1) main_~main__x~0_104) (<= 50 main_~main__x~0_102) (= (+ main_~main__y~0_96 1) main_~main__y~0_104)) :named ssa_104))
...
(assert (! (and (= main_~main__x~0_108 (+ main_~main__x~0_106 1)) (< main_~main__x~0_106 50)) :named ssa_108))
(assert (! (< main_~main__x~0_108 100) :named ssa_109))
(assert (! (and (= (+ main_~main__y~0_106 1) main_~main__y~0_110) (<= 50 main_~main__x~0_108) (= (+ main_~main__x~0_108 1) main_~main__x~0_110)) :named ssa_110))
(assert (! (< main_~main__x~0_110 100) :named ssa_111))
(assert (! (and (< main_~main__x~0_110 50) (= (+ main_~main__x~0_110 1) main_~main__x~0_112)) :named ssa_112))
(assert (! (< main_~main__x~0_112 100) :named ssa_113))
(assert (! (and (<= 50 main_~main__x~0_112) (= (+ main_~main__x~0_112 1) main_~main__x~0_114) (= (+ main_~main__y~0_110 1) main_~main__y~0_114)) :named ssa_114))
(assert (! (< main_~main__x~0_114 100) :named ssa_115))
(assert (! (and (< main_~main__x~0_114 50) (= main_~main__x~0_116 (+ main_~main__x~0_114 1))) :named ssa_116))
(assert (! (< main_~main__x~0_116 100) :named ssa_117))
(assert (! (and (= (+ main_~main__x~0_116 1) main_~main__x~0_118) (< main_~main__x~0_116 50)) :named ssa_118))
(assert (! (< main_~main__x~0_118 100) :named ssa_119))
(assert (! (and (= (+ main_~main__y~0_114 1) main_~main__y~0_120) (<= 50 main_~main__x~0_118) (= (+ main_~main__x~0_118 1) main_~main__x~0_120)) :named ssa_120))
(assert (! (< main_~main__x~0_120 100) :named ssa_121))
(assert (! (and (= main_~main__x~0_122 (+ main_~main__x~0_120 1)) (< main_~main__x~0_120 50)) :named ssa_122))
(assert (! (< main_~main__x~0_122 100) :named ssa_123))
(assert (! (and (= (+ main_~main__y~0_120 1) main_~main__y~0_124) (<= 50 main_~main__x~0_122) (= (+ main_~main__x~0_122 1) main_~main__x~0_124)) :named ssa_124))
...
(assert (! (and (< main_~main__x~0_128 50) (= main_~main__x~0_130 (+ main_~main__x~0_128 1))) :named ssa_130))
(assert (! (< main_~main__x~0_130 100) :named ssa_131))
(assert (! (and (< main_~main__x~0_130 50) (= (+ main_~main__x~0_130 1) main_~main__x~0_132)) :named ssa_132))
(assert (! (< main_~main__x~0_132 100) :named ssa_133))
(assert (! (and (= main_~main__x~0_134 (+ main_~main__x~0_132 1)) (< main_~main__x~0_132 50)) :named ssa_134))
(assert (! (< main_~main__x~0_134 100) :named ssa_135))
(assert (! (and (<= 50 main_~main__x~0_134) (= main_~main__x~0_136 (+ main_~main__x~0_134 1)) (= main_~main__y~0_136 (+ main_~main__y~0_128 1))) :named ssa_136))
...
(assert (! (and (<= 100 main_~main__x~0_138) (= v_main_~__tmp_1~0_4_fresh_1 (ite (= main_~main__y~0_138 100) 1 0)) (= v_main_~__tmp_1~0_4_fresh_1 main_~__VERIFIER_assert__cond~0_139)) :named ssa_139))
