...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:14:27+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id id2_b2_o3.c_AllErrorsAtOnce_Iteration9)
...
(assert (! (and (= id2_~ret~1_22 |id2_#res_23|) (<= (mod id2_~ret~1_22 4294967296) 2)) :named ssa_23))
...
(assert (! (and (<= (mod id_~ret~0_26 4294967296) 2) (= |id_#res_27| id_~ret~0_26)) :named ssa_27))
...
(assert (! (and (= id2_~ret~1_30 |id2_#res_31|) (<= (mod id2_~ret~1_30 4294967296) 2)) :named ssa_31))
...
(assert (! (and (<= (mod id_~ret~0_34 4294967296) 2) (= |id_#res_35| id_~ret~0_34)) :named ssa_35))
...
(assert (! (= 3 (mod main_~result~0_38 4294967296)) :named ssa_39))
...
(assert (! (and (= id2_~ret~1_24 |id2_#res_25|) (<= (mod id2_~ret~1_24 4294967296) 2)) :named ssa_25))
...
(assert (! (and (<= (mod id_~ret~0_28 4294967296) 2) (= |id_#res_29| id_~ret~0_28)) :named ssa_29))
...
(assert (! (and (= id2_~ret~1_13 |id2_#res_14|) (<= (mod id2_~ret~1_13 4294967296) 2)) :named ssa_14))
...
(assert (! (and (<= (mod id_~ret~0_17 4294967296) 2) (= |id_#res_18| id_~ret~0_17)) :named ssa_18))
...
(assert (! (and (= id2_~ret~1_21 |id2_#res_22|) (<= (mod id2_~ret~1_21 4294967296) 2)) :named ssa_22))
