...
(set-info :ultimate-id standard_minInArray_ground-2.i_AllErrorsAtOnce_Iteration17)
...
(declare-fun |main_#t~mem5_69| () Int)
(declare-fun |__VERIFIER_assert_#in~cond_70| () Int)
(declare-fun |main_#t~mem5_70| () Int)
...
(assert (! (and (= |#length_4| (store |#length_3| |main_~#a~0.base_4| v_ArrVal_244_fresh_1)) (not (= |main_~#a~0.base_4| 0)) (= main_~min~0_4 0) (< |#StackHeapBarrier_-1| |main_~#a~0.base_4|) (= |main_~#a~0.offset_4| 0) (= v_ArrVal_244_fresh_1 400000) (= (select |#valid_3| |main_~#a~0.base_4|) 0) (= (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_243_fresh_1) |#valid_4|) (= main_~i~0_4 0) (= v_ArrVal_243_fresh_1 1)) :named ssa_4))
(assert (! (and (= (store |#memory_int#1_3| |main_~#a~0.base_4| v_ArrVal_245_fresh_1) |#memory_int#1_5|) (= v_ArrVal_245_fresh_1 (store (select |#memory_int#1_3| |main_~#a~0.base_4|) (+ (* main_~i~0_4 4) |main_~#a~0.offset_4|) |v_main_#t~nondet1_113_fresh_1|)) (= main_~i~0_5 (+ main_~i~0_4 1)) (= v_ArrVal_246_fresh_1 |v_main_#t~nondet1_113_fresh_1|) (<= |v_main_#t~nondet1_113_fresh_1| 2147483647) (<= 0 (+ |v_main_#t~nondet1_113_fresh_1| 2147483648)) (< main_~i~0_4 100000)) :named ssa_5))
(assert (! (and (= (store (select |#memory_int#1_5| |main_~#a~0.base_4|) (+ (* main_~i~0_5 4) |main_~#a~0.offset_4|) v_ArrVal_247_fresh_1) v_ArrVal_248_fresh_1) (= main_~i~0_6 (+ main_~i~0_5 1)) (<= 0 (+ |v_main_#t~nondet1_114_fresh_1| 2147483648)) (= (store |#memory_int#1_5| |main_~#a~0.base_4| v_ArrVal_248_fresh_1) |#memory_int#1_6|) (< main_~i~0_5 100000) (<= |v_main_#t~nondet1_114_fresh_1| 2147483647) (= v_ArrVal_247_fresh_1 |v_main_#t~nondet1_114_fresh_1|)) :named ssa_6))
(assert (! (and (= main_~i~0_7 (+ main_~i~0_6 1)) (<= |v_main_#t~nondet1_115_fresh_1| 2147483647) (< main_~i~0_6 100000) (= v_ArrVal_249_fresh_1 (store (select |#memory_int#1_6| |main_~#a~0.base_4|) (+ (* main_~i~0_6 4) |main_~#a~0.offset_4|) |v_main_#t~nondet1_115_fresh_1|)) (= (store |#memory_int#1_6| |main_~#a~0.base_4| v_ArrVal_249_fresh_1) |#memory_int#1_7|) (= v_ArrVal_250_fresh_1 |v_main_#t~nondet1_115_fresh_1|) (<= 0 (+ |v_main_#t~nondet1_115_fresh_1| 2147483648))) :named ssa_7))
(assert (! (and (= v_ArrVal_251_fresh_1 (store (select |#memory_int#1_7| |main_~#a~0.base_4|) (+ (* main_~i~0_7 4) |main_~#a~0.offset_4|) |v_main_#t~nondet1_116_fresh_1|)) (<= |v_main_#t~nondet1_116_fresh_1| 2147483647) (= main_~i~0_8 (+ main_~i~0_7 1)) (<= 0 (+ |v_main_#t~nondet1_116_fresh_1| 2147483648)) (= (store |#memory_int#1_7| |main_~#a~0.base_4| v_ArrVal_251_fresh_1) |#memory_int#1_8|) (< main_~i~0_7 100000) (= v_ArrVal_252_fresh_1 |v_main_#t~nondet1_116_fresh_1|)) :named ssa_8))
(assert (! (and (= main_~i~0_9 (+ main_~i~0_8 1)) (= v_ArrVal_253_fresh_1 |v_main_#t~nondet1_117_fresh_1|) (= (store |#memory_int#1_8| |main_~#a~0.base_4| v_ArrVal_254_fresh_1) |#memory_int#1_9|) (<= |v_main_#t~nondet1_117_fresh_1| 2147483647) (< main_~i~0_8 100000) (= v_ArrVal_254_fresh_1 (store (select |#memory_int#1_8| |main_~#a~0.base_4|) (+ (* main_~i~0_8 4) |main_~#a~0.offset_4|) v_ArrVal_253_fresh_1)) (<= 0 (+ |v_main_#t~nondet1_117_fresh_1| 2147483648))) :named ssa_9))
(assert (! (and (= main_~i~0_10 (+ main_~i~0_9 1)) (= (store (select |#memory_int#1_9| |main_~#a~0.base_4|) (+ (* main_~i~0_9 4) |main_~#a~0.offset_4|) |v_main_#t~nondet1_118_fresh_1|) v_ArrVal_255_fresh_1) (<= |v_main_#t~nondet1_118_fresh_1| 2147483647) (= v_ArrVal_256_fresh_1 |v_main_#t~nondet1_118_fresh_1|) (< main_~i~0_9 100000) (<= 0 (+ |v_main_#t~nondet1_118_fresh_1| 2147483648)) (= (store |#memory_int#1_9| |main_~#a~0.base_4| v_ArrVal_255_fresh_1) |#memory_int#1_10|)) :named ssa_10))
(assert (! (and (= (store |#memory_int#1_10| |main_~#a~0.base_4| v_ArrVal_257_fresh_1) |#memory_int#1_11|) (= main_~i~0_11 (+ main_~i~0_10 1)) (= v_ArrVal_258_fresh_1 |v_main_#t~nondet1_119_fresh_1|) (<= |v_main_#t~nondet1_119_fresh_1| 2147483647) (< main_~i~0_10 100000) (<= 0 (+ |v_main_#t~nondet1_119_fresh_1| 2147483648)) (= v_ArrVal_257_fresh_1 (store (select |#memory_int#1_10| |main_~#a~0.base_4|) (+ (* main_~i~0_10 4) |main_~#a~0.offset_4|) |v_main_#t~nondet1_119_fresh_1|))) :named ssa_11))
(assert (! (and (= main_~i~0_12 (+ main_~i~0_11 1)) (= v_ArrVal_259_fresh_1 (store (select |#memory_int#1_11| |main_~#a~0.base_4|) (+ (* main_~i~0_11 4) |main_~#a~0.offset_4|) |v_main_#t~nondet1_120_fresh_1|)) (<= |v_main_#t~nondet1_120_fresh_1| 2147483647) (< main_~i~0_11 100000) (= v_ArrVal_260_fresh_1 |v_main_#t~nondet1_120_fresh_1|) (<= 0 (+ |v_main_#t~nondet1_120_fresh_1| 2147483648)) (= (store |#memory_int#1_11| |main_~#a~0.base_4| v_ArrVal_259_fresh_1) |#memory_int#1_12|)) :named ssa_12))
(assert (! (and (= main_~i~0_13 (+ main_~i~0_12 1)) (= v_ArrVal_262_fresh_1 |v_main_#t~nondet1_121_fresh_1|) (= v_ArrVal_261_fresh_1 (store (select |#memory_int#1_12| |main_~#a~0.base_4|) (+ (* main_~i~0_12 4) |main_~#a~0.offset_4|) |v_main_#t~nondet1_121_fresh_1|)) (<= |v_main_#t~nondet1_121_fresh_1| 2147483647) (< main_~i~0_12 100000) (<= 0 (+ |v_main_#t~nondet1_121_fresh_1| 2147483648)) (= (store |#memory_int#1_12| |main_~#a~0.base_4| v_ArrVal_261_fresh_1) |#memory_int#1_13|)) :named ssa_13))
(assert (! (and (<= 0 (+ |v_main_#t~nondet1_122_fresh_1| 2147483648)) (<= |v_main_#t~nondet1_122_fresh_1| 2147483647) (= main_~i~0_14 (+ main_~i~0_13 1)) (< main_~i~0_13 100000) (= (store (select |#memory_int#1_13| |main_~#a~0.base_4|) (+ (* main_~i~0_13 4) |main_~#a~0.offset_4|) |v_main_#t~nondet1_122_fresh_1|) v_ArrVal_263_fresh_1) (= |#memory_int#1_14| (store |#memory_int#1_13| |main_~#a~0.base_4| v_ArrVal_263_fresh_1)) (= v_ArrVal_264_fresh_1 |v_main_#t~nondet1_122_fresh_1|)) :named ssa_14))
(assert (! (and (= v_ArrVal_266_fresh_1 (store (select |#memory_int#1_14| |main_~#a~0.base_4|) (+ (* main_~i~0_14 4) |main_~#a~0.offset_4|) v_ArrVal_265_fresh_1)) (<= 0 (+ |v_main_#t~nondet1_123_fresh_1| 2147483648)) (= main_~i~0_15 (+ main_~i~0_14 1)) (< main_~i~0_14 100000) (= v_ArrVal_265_fresh_1 |v_main_#t~nondet1_123_fresh_1|) (<= |v_main_#t~nondet1_123_fresh_1| 2147483647) (= (store |#memory_int#1_14| |main_~#a~0.base_4| v_ArrVal_266_fresh_1) |#memory_int#1_15|)) :named ssa_15))
(assert (! (and (= (store |#memory_int#1_15| |main_~#a~0.base_4| v_ArrVal_268_fresh_1) |#memory_int#1_16|) (= main_~i~0_16 (+ main_~i~0_15 1)) (= v_ArrVal_267_fresh_1 |v_main_#t~nondet1_124_fresh_1|) (< main_~i~0_15 100000) (<= 0 (+ |v_main_#t~nondet1_124_fresh_1| 2147483648)) (<= |v_main_#t~nondet1_124_fresh_1| 2147483647) (= v_ArrVal_268_fresh_1 (store (select |#memory_int#1_15| |main_~#a~0.base_4|) (+ (* main_~i~0_15 4) |main_~#a~0.offset_4|) v_ArrVal_267_fresh_1))) :named ssa_16))
(assert (! (and (= v_ArrVal_270_fresh_1 |v_main_#t~nondet1_125_fresh_1|) (= (store |#memory_int#1_16| |main_~#a~0.base_4| v_ArrVal_269_fresh_1) |#memory_int#1_17|) (= main_~i~0_17 (+ main_~i~0_16 1)) (< main_~i~0_16 100000) (<= 0 (+ |v_main_#t~nondet1_125_fresh_1| 2147483648)) (= v_ArrVal_269_fresh_1 (store (select |#memory_int#1_16| |main_~#a~0.base_4|) (+ (* main_~i~0_16 4) |main_~#a~0.offset_4|) |v_main_#t~nondet1_125_fresh_1|)) (<= |v_main_#t~nondet1_125_fresh_1| 2147483647)) :named ssa_17))
(assert (! (and (<= |v_main_#t~nondet1_126_fresh_1| 2147483647) (= main_~i~0_18 (+ main_~i~0_17 1)) (< main_~i~0_17 100000) (= v_ArrVal_272_fresh_1 (store (select |#memory_int#1_17| |main_~#a~0.base_4|) (+ (* main_~i~0_17 4) |main_~#a~0.offset_4|) v_ArrVal_271_fresh_1)) (= v_ArrVal_271_fresh_1 |v_main_#t~nondet1_126_fresh_1|) (<= 0 (+ |v_main_#t~nondet1_126_fresh_1| 2147483648)) (= (store |#memory_int#1_17| |main_~#a~0.base_4| v_ArrVal_272_fresh_1) |#memory_int#1_18|)) :named ssa_18))
(assert (! (and (= main_~i~0_19 (+ main_~i~0_18 1)) (< main_~i~0_18 100000) (= v_ArrVal_273_fresh_1 |v_main_#t~nondet1_127_fresh_1|) (<= |v_main_#t~nondet1_127_fresh_1| 2147483647) (= (store |#memory_int#1_18| |main_~#a~0.base_4| v_ArrVal_274_fresh_1) |#memory_int#1_19|) (= v_ArrVal_274_fresh_1 (store (select |#memory_int#1_18| |main_~#a~0.base_4|) (+ (* main_~i~0_18 4) |main_~#a~0.offset_4|) v_ArrVal_273_fresh_1)) (<= 0 (+ |v_main_#t~nondet1_127_fresh_1| 2147483648))) :named ssa_19))
(assert (! (<= 100000 main_~i~0_19) :named ssa_20))
(assert (! (= main_~i~0_21 0) :named ssa_21))
(assert (! (and (= |main_#t~mem3_22| (select (select |#memory_int#1_19| |main_~#a~0.base_4|) (+ (* main_~i~0_21 4) |main_~#a~0.offset_4|))) (< main_~i~0_21 100000)) :named ssa_22))
(assert (! (and (< |main_#t~mem3_22| main_~min~0_4) (= (select (select |#memory_int#1_19| |main_~#a~0.base_4|) (+ (* main_~i~0_21 4) |main_~#a~0.offset_4|)) main_~min~0_23)) :named ssa_23))
(assert (! (= main_~i~0_24 (+ main_~i~0_21 1)) :named ssa_24))
(assert (! (and (= |main_#t~mem3_25| (select (select |#memory_int#1_19| |main_~#a~0.base_4|) (+ (* main_~i~0_24 4) |main_~#a~0.offset_4|))) (< main_~i~0_24 100000)) :named ssa_25))
(assert (! (and (< |main_#t~mem3_25| main_~min~0_23) (= (select (select |#memory_int#1_19| |main_~#a~0.base_4|) (+ (* main_~i~0_24 4) |main_~#a~0.offset_4|)) main_~min~0_26)) :named ssa_26))
(assert (! (= main_~i~0_27 (+ main_~i~0_24 1)) :named ssa_27))
(assert (! (and (= |main_#t~mem3_28| (select (select |#memory_int#1_19| |main_~#a~0.base_4|) (+ (* main_~i~0_27 4) |main_~#a~0.offset_4|))) (< main_~i~0_27 100000)) :named ssa_28))
(assert (! (and (< |main_#t~mem3_28| main_~min~0_26) (= (select (select |#memory_int#1_19| |main_~#a~0.base_4|) (+ (* main_~i~0_27 4) |main_~#a~0.offset_4|)) main_~min~0_29)) :named ssa_29))
(assert (! (= main_~i~0_30 (+ main_~i~0_27 1)) :named ssa_30))
(assert (! (and (= |main_#t~mem3_31| (select (select |#memory_int#1_19| |main_~#a~0.base_4|) (+ (* main_~i~0_30 4) |main_~#a~0.offset_4|))) (< main_~i~0_30 100000)) :named ssa_31))
(assert (! (and (< |main_#t~mem3_31| main_~min~0_29) (= (select (select |#memory_int#1_19| |main_~#a~0.base_4|) (+ (* main_~i~0_30 4) |main_~#a~0.offset_4|)) main_~min~0_32)) :named ssa_32))
(assert (! (= main_~i~0_33 (+ main_~i~0_30 1)) :named ssa_33))
(assert (! (and (= |main_#t~mem3_34| (select (select |#memory_int#1_19| |main_~#a~0.base_4|) (+ (* main_~i~0_33 4) |main_~#a~0.offset_4|))) (< main_~i~0_33 100000)) :named ssa_34))
(assert (! (and (< |main_#t~mem3_34| main_~min~0_32) (= (select (select |#memory_int#1_19| |main_~#a~0.base_4|) (+ (* main_~i~0_33 4) |main_~#a~0.offset_4|)) main_~min~0_35)) :named ssa_35))
(assert (! (= main_~i~0_36 (+ main_~i~0_33 1)) :named ssa_36))
(assert (! (and (= |main_#t~mem3_37| (select (select |#memory_int#1_19| |main_~#a~0.base_4|) (+ (* main_~i~0_36 4) |main_~#a~0.offset_4|))) (< main_~i~0_36 100000)) :named ssa_37))
(assert (! (and (< |main_#t~mem3_37| main_~min~0_35) (= (select (select |#memory_int#1_19| |main_~#a~0.base_4|) (+ (* main_~i~0_36 4) |main_~#a~0.offset_4|)) main_~min~0_38)) :named ssa_38))
(assert (! (= main_~i~0_39 (+ main_~i~0_36 1)) :named ssa_39))
(assert (! (and (= |main_#t~mem3_40| (select (select |#memory_int#1_19| |main_~#a~0.base_4|) (+ (* main_~i~0_39 4) |main_~#a~0.offset_4|))) (< main_~i~0_39 100000)) :named ssa_40))
(assert (! (and (< |main_#t~mem3_40| main_~min~0_38) (= (select (select |#memory_int#1_19| |main_~#a~0.base_4|) (+ (* main_~i~0_39 4) |main_~#a~0.offset_4|)) main_~min~0_41)) :named ssa_41))
(assert (! (= main_~i~0_42 (+ main_~i~0_39 1)) :named ssa_42))
(assert (! (and (= |main_#t~mem3_43| (select (select |#memory_int#1_19| |main_~#a~0.base_4|) (+ (* main_~i~0_42 4) |main_~#a~0.offset_4|))) (< main_~i~0_42 100000)) :named ssa_43))
(assert (! (and (< |main_#t~mem3_43| main_~min~0_41) (= (select (select |#memory_int#1_19| |main_~#a~0.base_4|) (+ (* main_~i~0_42 4) |main_~#a~0.offset_4|)) main_~min~0_44)) :named ssa_44))
(assert (! (= main_~i~0_45 (+ main_~i~0_42 1)) :named ssa_45))
(assert (! (and (= |main_#t~mem3_46| (select (select |#memory_int#1_19| |main_~#a~0.base_4|) (+ (* main_~i~0_45 4) |main_~#a~0.offset_4|))) (< main_~i~0_45 100000)) :named ssa_46))
(assert (! (and (< |main_#t~mem3_46| main_~min~0_44) (= (select (select |#memory_int#1_19| |main_~#a~0.base_4|) (+ (* main_~i~0_45 4) |main_~#a~0.offset_4|)) main_~min~0_47)) :named ssa_47))
(assert (! (= main_~i~0_48 (+ main_~i~0_45 1)) :named ssa_48))
(assert (! (and (= |main_#t~mem3_49| (select (select |#memory_int#1_19| |main_~#a~0.base_4|) (+ (* main_~i~0_48 4) |main_~#a~0.offset_4|))) (< main_~i~0_48 100000)) :named ssa_49))
(assert (! (and (< |main_#t~mem3_49| main_~min~0_47) (= (select (select |#memory_int#1_19| |main_~#a~0.base_4|) (+ (* main_~i~0_48 4) |main_~#a~0.offset_4|)) main_~min~0_50)) :named ssa_50))
(assert (! (= main_~i~0_51 (+ main_~i~0_48 1)) :named ssa_51))
(assert (! (and (= |main_#t~mem3_52| (select (select |#memory_int#1_19| |main_~#a~0.base_4|) (+ (* main_~i~0_51 4) |main_~#a~0.offset_4|))) (< main_~i~0_51 100000)) :named ssa_52))
(assert (! (and (< |main_#t~mem3_52| main_~min~0_50) (= (select (select |#memory_int#1_19| |main_~#a~0.base_4|) (+ (* main_~i~0_51 4) |main_~#a~0.offset_4|)) main_~min~0_53)) :named ssa_53))
(assert (! (= main_~i~0_54 (+ main_~i~0_51 1)) :named ssa_54))
(assert (! (and (= |main_#t~mem3_55| (select (select |#memory_int#1_19| |main_~#a~0.base_4|) (+ (* main_~i~0_54 4) |main_~#a~0.offset_4|))) (< main_~i~0_54 100000)) :named ssa_55))
(assert (! (and (< |main_#t~mem3_55| main_~min~0_53) (= (select (select |#memory_int#1_19| |main_~#a~0.base_4|) (+ (* main_~i~0_54 4) |main_~#a~0.offset_4|)) main_~min~0_56)) :named ssa_56))
(assert (! (= main_~i~0_57 (+ main_~i~0_54 1)) :named ssa_57))
(assert (! (and (= |main_#t~mem3_58| (select (select |#memory_int#1_19| |main_~#a~0.base_4|) (+ (* main_~i~0_57 4) |main_~#a~0.offset_4|))) (< main_~i~0_57 100000)) :named ssa_58))
(assert (! (and (< |main_#t~mem3_58| main_~min~0_56) (= (select (select |#memory_int#1_19| |main_~#a~0.base_4|) (+ (* main_~i~0_57 4) |main_~#a~0.offset_4|)) main_~min~0_59)) :named ssa_59))
(assert (! (= main_~i~0_60 (+ main_~i~0_57 1)) :named ssa_60))
(assert (! (and (= |main_#t~mem3_61| (select (select |#memory_int#1_19| |main_~#a~0.base_4|) (+ (* main_~i~0_60 4) |main_~#a~0.offset_4|))) (< main_~i~0_60 100000)) :named ssa_61))
(assert (! (and (< |main_#t~mem3_61| main_~min~0_59) (= (select (select |#memory_int#1_19| |main_~#a~0.base_4|) (+ (* main_~i~0_60 4) |main_~#a~0.offset_4|)) main_~min~0_62)) :named ssa_62))
(assert (! (= main_~i~0_63 (+ main_~i~0_60 1)) :named ssa_63))
(assert (! (and (= |main_#t~mem3_64| (select (select |#memory_int#1_19| |main_~#a~0.base_4|) (+ (* main_~i~0_63 4) |main_~#a~0.offset_4|))) (< main_~i~0_63 100000)) :named ssa_64))
(assert (! (and (< |main_#t~mem3_64| main_~min~0_62) (= (select (select |#memory_int#1_19| |main_~#a~0.base_4|) (+ (* main_~i~0_63 4) |main_~#a~0.offset_4|)) main_~min~0_65)) :named ssa_65))
(assert (! (= main_~i~0_66 (+ main_~i~0_63 1)) :named ssa_66))
(assert (! (<= 100000 main_~i~0_66) :named ssa_67))
(assert (! (= main_~x~0_68 0) :named ssa_68))
(assert (! (and (< main_~x~0_68 100000) (= |main_#t~mem5_69| (select (select |#memory_int#1_19| |main_~#a~0.base_4|) (+ (* main_~x~0_68 4) |main_~#a~0.offset_4|)))) :named ssa_69))
(assert (! true :named ssa_70_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_70| (ite (<= main_~min~0_65 |main_#t~mem5_69|) 1 0)) :named ssa_70_LocVarAssigCall))
