...
(set-info :ultimate-id psyco_security.c_AllErrorsAtOnce_Iteration2)
...
(declare-fun main_~this_state~0_11 () Int)
...
(assert (! (and (= main_~q~0_4 1) (<= |main_#t~nondet5_8| 2147483647) (<= 0 (+ |main_#t~nondet5_8| 2147483648))) :named ssa_8))
(assert (! (not (= |main_#t~nondet5_8| 0)) :named ssa_9))
(assert (! (= 4 v_main_~method_id~0_45_fresh_1) :named ssa_10))
(assert (! (= 2 main_~this_state~0_4) :named ssa_11))
