...
(set-info :ultimate-id nested_4.c_AllErrorsAtOnce_Iteration3)
...
(declare-fun |main_#t~pre7_7| () Int)
...
(assert (! (or (not (= main_~c~0_4 6)) (not (= main_~d~0_4 6)) (not (= main_~b~0_5 6)) (not (= main_~a~0_7 6))) :named ssa_9))
