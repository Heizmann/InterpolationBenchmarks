...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-30T23:50:51+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id conda.c_AllErrorsAtOnce_Iteration3)
...
(assert (! (and (= (* (mod ~N~0_4 1073741824) 4) v_ArrVal_13_fresh_1) (= main_~i~0_11 0) (= 8 v_ArrVal_18_fresh_1) (< main_~a~0.base_11 |#StackHeapBarrier_-1|) (= |main_~#sum~0.offset_11| 0) (= v_ArrVal_16_fresh_1 1) (= (store |#memory_int#1_3| |main_~#sum~0.base_11| v_ArrVal_17_fresh_1) |#memory_int#1_11|) (= (store (select |#memory_int#1_3| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| v_ArrVal_15_fresh_1) v_ArrVal_17_fresh_1) (= (select (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_16_fresh_1) main_~a~0.base_11) 0) (= |#valid_11| (store (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_16_fresh_1) main_~a~0.base_11 v_ArrVal_14_fresh_1)) (= v_ArrVal_15_fresh_1 0) (< |#StackHeapBarrier_-1| |main_~#sum~0.base_11|) (= v_ArrVal_14_fresh_1 1) (not (= |main_~#sum~0.base_11| 0)) (= (select |#valid_3| |main_~#sum~0.base_11|) 0) (= (store (store |#length_3| |main_~#sum~0.base_11| v_ArrVal_18_fresh_1) main_~a~0.base_11 v_ArrVal_13_fresh_1) |#length_11|) (= main_~a~0.offset_11 0) (not (= main_~a~0.base_11 0))) :named ssa_11))
(assert (! (and (= v_ArrVal_19_fresh_1 (store (select |#memory_int#3_3| main_~a~0.base_11) (+ (* main_~i~0_11 4) main_~a~0.offset_11) 1)) (= v_ArrVal_20_fresh_1 1) (= main_~i~0_12 (+ main_~i~0_11 1)) (< main_~i~0_11 ~N~0_4) (= |#memory_int#3_12| (store |#memory_int#3_3| main_~a~0.base_11 v_ArrVal_19_fresh_1))) :named ssa_12))
...
(assert (! (and (= |main_#t~mem7_15| 1) (= (store (select |#memory_int#3_12| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_14 4)) (+ (select (select |#memory_int#3_12| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_14 4))) 1)) v_ArrVal_21_fresh_1) (= (+ (select (select |#memory_int#3_12| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_14 4))) 1) v_ArrVal_22_fresh_1) (= (store |#memory_int#3_12| main_~a~0.base_11 v_ArrVal_21_fresh_1) |#memory_int#3_16|)) :named ssa_16))
(assert (! (= main_~i~0_17 (+ main_~i~0_14 1)) :named ssa_17))
(assert (! (<= ~N~0_4 main_~i~0_17) :named ssa_18))
(assert (! (= main_~i~0_19 0) :named ssa_19))
(assert (! (and (= v_ArrVal_24_fresh_1 (+ (select (select |#memory_int#3_16| main_~a~0.base_11) (+ (* main_~i~0_19 4) main_~a~0.offset_11)) (select (select |#memory_int#1_11| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|))) (< main_~i~0_19 ~N~0_4) (= main_~i~0_20 (+ main_~i~0_19 1)) (= v_ArrVal_23_fresh_1 (store (select |#memory_int#1_11| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| (+ (select (select |#memory_int#3_16| main_~a~0.base_11) (+ (* main_~i~0_19 4) main_~a~0.offset_11)) (select (select |#memory_int#1_11| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|)))) (= (store |#memory_int#1_11| |main_~#sum~0.base_11| v_ArrVal_23_fresh_1) |#memory_int#1_20|)) :named ssa_20))
