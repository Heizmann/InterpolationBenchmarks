...
(set-info :ultimate-id id2_b2_o3.c_AllErrorsAtOnce_Iteration7)
...
(assert (! (and (< 2 (mod id2_~ret~1_23 4294967296)) (= 2 |id2_#res_24|)) :named ssa_24))
...
(assert (! (and (< 2 (mod id2_~ret~1_17 4294967296)) (= 2 |id2_#res_18|)) :named ssa_18))
...
(assert (! (and (< 2 (mod id2_~ret~1_14 4294967296)) (= 2 |id2_#res_15|)) :named ssa_15))
