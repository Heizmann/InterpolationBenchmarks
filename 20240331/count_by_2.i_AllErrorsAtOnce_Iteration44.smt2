...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:10:11+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration44)
...
(assert (! (<= 1000000 main_~i~0_47) :named ssa_48))
(assert (! true :named ssa_49_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_49| (ite (= main_~i~0_47 1000000) 1 0)) :named ssa_49_LocVarAssigCall))
