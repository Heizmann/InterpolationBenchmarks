...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:10:53+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id benchmark14_linear.i_AllErrorsAtOnce_Iteration1)
...
(assert (! (and (< 0 |#StackHeapBarrier_-1|) (= 21 (select |#length_-1| 2)) (= (select |#valid_-1| 2) 1) (= (select |#valid_-1| 1) 1) (= (select (select |#memory_int#0_-1| 1) 1) 0) (= (select |#length_-1| 1) 2) (= (select (select |#memory_int#0_-1| 1) 0) 48) (= (select |#valid_-1| 0) 0)) :named ssa_1))
(assert (! true :named ssa_2_return))
(assert (! true :named ssa_3_GlobVarAssigCall))
(assert (! true :named ssa_3_LocVarAssigCall))
(assert (! true :named ssa_3_OldVarAssigCall))
(assert (! (and (<= 0 (+ main_~i~0_4 2147483648)) (<= main_~i~0_4 2147483647)) :named ssa_4))
(assert (! (and (<= main_~i~0_4 200) (<= 0 main_~i~0_4)) :named ssa_5))
(assert (! (<= main_~i~0_4 0) :named ssa_6))
(assert (! true :named ssa_7_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_7| (ite (<= 0 main_~i~0_4) 1 0)) :named ssa_7_LocVarAssigCall))
...
(assert (! (and (< 0 |#StackHeapBarrier_-1|) (= 21 (select |#length_-1| 2)) (= (select |#valid_-1| 2) 1) (= (select |#valid_-1| 1) 1) (= (select (select |#memory_int#0_-1| 1) 1) 0) (= (select |#length_-1| 1) 2) (= (select (select |#memory_int#0_-1| 1) 0) 48) (= (select |#valid_-1| 0) 0)) :named ssa_0))
