...
(set-info :ultimate-id condg.c_AllErrorsAtOnce_Iteration6)
...
(declare-fun |main_#t~post9_15| () Int)
...
(declare-fun |main_#t~mem11_22| () Int)
...
(declare-fun |main_#t~mem14_26| () Int)
...
(assert (! (and (= 4 v_ArrVal_53_fresh_1) (< |#StackHeapBarrier_-1| |main_~#sum~0.base_11|) (= (select |#valid_3| |main_~#sum~0.base_11|) 0) (not (= |main_~#sum~0.base_11| 0)) (= (select (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_56_fresh_1) main_~a~0.base_11) 0) (< main_~a~0.base_11 |#StackHeapBarrier_-1|) (= main_~i~0_11 0) (= v_ArrVal_51_fresh_1 (store (select |#memory_int#1_3| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| 0)) (= v_ArrVal_56_fresh_1 1) (= v_ArrVal_52_fresh_1 1) (= (store (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_56_fresh_1) main_~a~0.base_11 v_ArrVal_52_fresh_1) |#valid_11|) (= (* (mod ~N~0_4 1073741824) 4) v_ArrVal_55_fresh_1) (= (store (store |#length_3| |main_~#sum~0.base_11| v_ArrVal_53_fresh_1) main_~a~0.base_11 v_ArrVal_55_fresh_1) |#length_11|) (= v_ArrVal_54_fresh_1 0) (= |main_~#sum~0.offset_11| 0) (= main_~a~0.offset_11 0) (not (= main_~a~0.base_11 0)) (= (store |#memory_int#1_3| |main_~#sum~0.base_11| v_ArrVal_51_fresh_1) |#memory_int#1_11|)) :named ssa_11))
(assert (! (and (= (store (select |#memory_int#3_3| main_~a~0.base_11) (+ (* main_~i~0_11 4) main_~a~0.offset_11) 1) v_ArrVal_57_fresh_1) (= main_~i~0_12 (+ main_~i~0_11 1)) (= v_ArrVal_58_fresh_1 1) (= |#memory_int#3_12| (store |#memory_int#3_3| main_~a~0.base_11 v_ArrVal_57_fresh_1)) (< main_~i~0_11 ~N~0_4)) :named ssa_12))
(assert (! (<= ~N~0_4 main_~i~0_12) :named ssa_13))
(assert (! (= main_~i~0_14 0) :named ssa_14))
(assert (! (and (= (+ (select (select |#memory_int#3_12| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_14 4))) (select (select |#memory_int#1_11| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|)) v_ArrVal_60_fresh_1) (< main_~i~0_14 ~N~0_4) (= (store (select |#memory_int#1_11| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| (+ (select (select |#memory_int#3_12| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_14 4))) (select (select |#memory_int#1_11| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|))) v_ArrVal_59_fresh_1) (= (store |#memory_int#1_11| |main_~#sum~0.base_11| v_ArrVal_59_fresh_1) |#memory_int#1_15|) (= main_~i~0_15 (+ main_~i~0_14 1))) :named ssa_15))
(assert (! (<= ~N~0_4 main_~i~0_15) :named ssa_16))
(assert (! (= main_~i~0_17 0) :named ssa_17))
(assert (! (and (< main_~i~0_17 ~N~0_4) (= |main_#t~mem10_18| (select (select |#memory_int#1_15| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|))) :named ssa_18))
(assert (! (and (= (store (select |#memory_int#3_12| main_~a~0.base_11) (+ (* main_~i~0_17 4) main_~a~0.offset_11) v_ArrVal_61_fresh_1) v_ArrVal_62_fresh_1) (= (+ v_ArrVal_61_fresh_1 1) (select (select |#memory_int#3_12| main_~a~0.base_11) (+ (* main_~i~0_17 4) main_~a~0.offset_11))) (= |main_#t~mem10_18| ~N~0_4) (= (store |#memory_int#3_12| main_~a~0.base_11 v_ArrVal_62_fresh_1) |#memory_int#3_19|)) :named ssa_19))
(assert (! (= main_~i~0_20 (+ main_~i~0_17 1)) :named ssa_20))
(assert (! (and (< main_~i~0_20 ~N~0_4) (= |main_#t~mem10_21| (select (select |#memory_int#1_15| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|))) :named ssa_21))
(assert (! (and (= (store (select |#memory_int#3_19| main_~a~0.base_11) (+ (* main_~i~0_20 4) main_~a~0.offset_11) v_ArrVal_63_fresh_1) v_ArrVal_64_fresh_1) (= |#memory_int#3_22| (store |#memory_int#3_19| main_~a~0.base_11 v_ArrVal_64_fresh_1)) (= |main_#t~mem10_21| ~N~0_4) (= (+ v_ArrVal_63_fresh_1 1) (select (select |#memory_int#3_19| main_~a~0.base_11) (+ (* main_~i~0_20 4) main_~a~0.offset_11)))) :named ssa_22))
(assert (! (= main_~i~0_23 (+ main_~i~0_20 1)) :named ssa_23))
(assert (! (<= ~N~0_4 main_~i~0_23) :named ssa_24))
(assert (! (= main_~i~0_25 0) :named ssa_25))
(assert (! (and (< main_~i~0_25 ~N~0_4) (= |main_#t~mem14_26| (select (select |#memory_int#3_22| main_~a~0.base_11) (+ (* main_~i~0_25 4) main_~a~0.offset_11)))) :named ssa_26))
(assert (! true :named ssa_27_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_27| (ite (= |main_#t~mem14_26| 0) 1 0)) :named ssa_27_LocVarAssigCall))
