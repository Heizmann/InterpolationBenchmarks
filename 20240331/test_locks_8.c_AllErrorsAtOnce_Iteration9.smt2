...
(set-info :ultimate-id test_locks_8.c_AllErrorsAtOnce_Iteration9)
...
(declare-fun main_~lk4~0_19 () Int)
...
(assert (! (not (= main_~p4~0_4 0)) :named ssa_18))
(assert (! (not (= main_~lk4~0_10 1)) :named ssa_19))
