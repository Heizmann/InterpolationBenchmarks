...
(set-info :ultimate-id id_i20_o20-1.c_AllErrorsAtOnce_Iteration10)
...
(declare-fun main_~result~0_64 () Int)
(declare-fun |main_#t~ret5_64| () Int)
(declare-fun main_~result~0_65 () Int)
...
(assert (! (and (<= 0 (+ |main_#t~ret5_63| 2147483648)) (= main_~result~0_64 |main_#t~ret5_63|) (<= |main_#t~ret5_63| 2147483647)) :named ssa_64))
(assert (! (not (= main_~result~0_64 20)) :named ssa_65))
(assert (! true :named ssa_66))
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 (and ssa_13 ssa_14_OldVarAssigCall ssa_27 ssa_29_OldVarAssigCall ssa_17_LocVarAssigCall ssa_5_LocVarAssigCall ssa_31 ssa_5_GlobVarAssigCall ssa_7 ssa_44 ssa_16 ssa_6 ssa_55 ssa_34 ssa_17_GlobVarAssigCall ssa_8_GlobVarAssigCall ssa_11_LocVarAssigCall ssa_14_LocVarAssigCall ssa_26_GlobVarAssigCall ssa_40 ssa_10 ssa_9 ssa_63_return ssa_29_GlobVarAssigCall ssa_32_LocVarAssigCall ssa_46 ssa_51_return ssa_26_LocVarAssigCall ssa_47 ssa_25 ssa_53 ssa_39_return ssa_14_GlobVarAssigCall ssa_32_OldVarAssigCall ssa_23_OldVarAssigCall ssa_20_GlobVarAssigCall ssa_20_OldVarAssigCall ssa_45_return ssa_57_return ssa_58 ssa_19 ssa_61 ssa_59 ssa_62 ssa_54_return ssa_43 ssa_23_LocVarAssigCall ssa_37 ssa_17_OldVarAssigCall ssa_20_LocVarAssigCall ssa_38 ssa_12 ssa_11_OldVarAssigCall ssa_5_OldVarAssigCall ssa_32_GlobVarAssigCall ssa_50 ssa_60_return ssa_8_OldVarAssigCall ssa_48_return ssa_28 ssa_29_LocVarAssigCall ssa_22 ssa_15 ssa_49 ssa_42_return ssa_23_GlobVarAssigCall ssa_21 ssa_11_GlobVarAssigCall ssa_52 ssa_18 ssa_30 ssa_36_return ssa_56 ssa_33 ssa_35 ssa_41 ssa_8_LocVarAssigCall ssa_24 ssa_26_OldVarAssigCall) ssa_64 ssa_65 (and ssa_postcond ssa_66))
...
(declare-fun |id_#res_55| () Int)
(declare-fun |id_#t~ret4_55| () Int)
(declare-fun |main_#t~ret5_57| () Int)
(declare-fun |id_#res_57| () Int)
(assert (! true :named ssa_precond))
(assert (! (not false) :named ssa_postcond))
...
(assert (! (and (<= |id_#t~ret4_54| 2147483647) (= |id_#res_55| (+ |id_#t~ret4_54| 1)) (<= 0 (+ |id_#t~ret4_54| 2147483648))) :named ssa_55))
(assert (! true :named ssa_56))
(assert (! (= |id_#res_55| |main_#t~ret5_57|) :named ssa_57_return))
