...
(set-info :ultimate-id mono-crafted_11.c_AllErrorsAtOnce_Iteration6)
...
(assert (! (<= 100000000 (mod main_~x~0_12 4294967296)) :named ssa_13))
(assert (! true :named ssa_14_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_14| (ite (= (mod main_~x~0_12 2) 0) 1 0)) :named ssa_14_LocVarAssigCall))
