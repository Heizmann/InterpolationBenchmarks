...
(set-info :ultimate-id nested_5.c_AllErrorsAtOnce_Iteration6)
...
(declare-fun |main_#t~pre8_16| () Int)
...
(assert (! (= (+ main_~b~0_5 1) main_~b~0_14) :named ssa_14))
(assert (! (<= 6 main_~b~0_14) :named ssa_15))
(assert (! (= (+ main_~a~0_4 1) main_~a~0_16) :named ssa_16))
(assert (! (<= 6 main_~a~0_16) :named ssa_17))
(assert (! (or (not (= main_~d~0_10 6)) (not (= main_~b~0_14 6)) (not (= main_~a~0_16 6)) (not (= main_~e~0_8 6)) (not (= main_~c~0_12 6))) :named ssa_18))
