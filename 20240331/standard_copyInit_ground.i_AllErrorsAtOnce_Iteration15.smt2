...
(set-info :ultimate-id standard_copyInit_ground.i_AllErrorsAtOnce_Iteration15)
...
(assert (! (and (= main_~i~0_4 0) (< |#StackHeapBarrier_-1| |main_~#a~0.base_4|) (= |main_~#b~0.offset_4| 0) (= v_ArrVal_372_fresh_1 1) (= (store (store |#length_3| |main_~#a~0.base_4| v_ArrVal_371_fresh_1) |main_~#b~0.base_4| v_ArrVal_369_fresh_1) |#length_4|) (not (= |main_~#a~0.base_4| 0)) (not (= |main_~#b~0.base_4| 0)) (= |#valid_4| (store (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_370_fresh_1) |main_~#b~0.base_4| v_ArrVal_372_fresh_1)) (= |main_~#a~0.offset_4| 0) (< |#StackHeapBarrier_-1| |main_~#b~0.base_4|) (= v_ArrVal_370_fresh_1 1) (= (select |#valid_3| |main_~#a~0.base_4|) 0) (= v_ArrVal_371_fresh_1 400000) (= v_ArrVal_369_fresh_1 400000) (= (select (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_370_fresh_1) |main_~#b~0.base_4|) 0)) :named ssa_4))
(assert (! (and (= v_ArrVal_373_fresh_1 (store (select |#memory_int#2_3| |main_~#a~0.base_4|) (+ (* main_~i~0_4 4) |main_~#a~0.offset_4|) 42)) (= (store |#memory_int#2_3| |main_~#a~0.base_4| v_ArrVal_373_fresh_1) |#memory_int#2_5|) (= v_ArrVal_374_fresh_1 42) (< main_~i~0_4 100000) (= main_~i~0_5 (+ main_~i~0_4 1))) :named ssa_5))
(assert (! (and (= v_ArrVal_376_fresh_1 42) (= |#memory_int#2_6| (store |#memory_int#2_5| |main_~#a~0.base_4| v_ArrVal_375_fresh_1)) (= v_ArrVal_375_fresh_1 (store (select |#memory_int#2_5| |main_~#a~0.base_4|) (+ (* main_~i~0_5 4) |main_~#a~0.offset_4|) 42)) (< main_~i~0_5 100000) (= main_~i~0_6 (+ main_~i~0_5 1))) :named ssa_6))
(assert (! (and (< main_~i~0_6 100000) (= v_ArrVal_378_fresh_1 42) (= v_ArrVal_377_fresh_1 (store (select |#memory_int#2_6| |main_~#a~0.base_4|) (+ (* main_~i~0_6 4) |main_~#a~0.offset_4|) 42)) (= main_~i~0_7 (+ main_~i~0_6 1)) (= |#memory_int#2_7| (store |#memory_int#2_6| |main_~#a~0.base_4| v_ArrVal_377_fresh_1))) :named ssa_7))
(assert (! (and (= (store |#memory_int#2_7| |main_~#a~0.base_4| v_ArrVal_379_fresh_1) |#memory_int#2_8|) (< main_~i~0_7 100000) (= v_ArrVal_380_fresh_1 42) (= main_~i~0_8 (+ main_~i~0_7 1)) (= v_ArrVal_379_fresh_1 (store (select |#memory_int#2_7| |main_~#a~0.base_4|) (+ (* main_~i~0_7 4) |main_~#a~0.offset_4|) 42))) :named ssa_8))
(assert (! (and (= v_ArrVal_381_fresh_1 (store (select |#memory_int#2_8| |main_~#a~0.base_4|) (+ (* main_~i~0_8 4) |main_~#a~0.offset_4|) 42)) (= (store |#memory_int#2_8| |main_~#a~0.base_4| v_ArrVal_381_fresh_1) |#memory_int#2_9|) (< main_~i~0_8 100000) (= main_~i~0_9 (+ main_~i~0_8 1)) (= v_ArrVal_382_fresh_1 42)) :named ssa_9))
(assert (! (and (= (store |#memory_int#2_9| |main_~#a~0.base_4| v_ArrVal_383_fresh_1) |#memory_int#2_10|) (< main_~i~0_9 100000) (= v_ArrVal_384_fresh_1 42) (= main_~i~0_10 (+ main_~i~0_9 1)) (= v_ArrVal_383_fresh_1 (store (select |#memory_int#2_9| |main_~#a~0.base_4|) (+ (* main_~i~0_9 4) |main_~#a~0.offset_4|) 42))) :named ssa_10))
(assert (! (and (= v_ArrVal_386_fresh_1 42) (= (store |#memory_int#2_10| |main_~#a~0.base_4| v_ArrVal_385_fresh_1) |#memory_int#2_11|) (= v_ArrVal_385_fresh_1 (store (select |#memory_int#2_10| |main_~#a~0.base_4|) (+ (* main_~i~0_10 4) |main_~#a~0.offset_4|) 42)) (< main_~i~0_10 100000) (= main_~i~0_11 (+ main_~i~0_10 1))) :named ssa_11))
(assert (! (and (= v_ArrVal_388_fresh_1 42) (< main_~i~0_11 100000) (= main_~i~0_12 (+ main_~i~0_11 1)) (= v_ArrVal_387_fresh_1 (store (select |#memory_int#2_11| |main_~#a~0.base_4|) (+ (* main_~i~0_11 4) |main_~#a~0.offset_4|) 42)) (= (store |#memory_int#2_11| |main_~#a~0.base_4| v_ArrVal_387_fresh_1) |#memory_int#2_12|)) :named ssa_12))
(assert (! (and (= v_ArrVal_390_fresh_1 42) (= v_ArrVal_389_fresh_1 (store (select |#memory_int#2_12| |main_~#a~0.base_4|) (+ (* main_~i~0_12 4) |main_~#a~0.offset_4|) 42)) (< main_~i~0_12 100000) (= main_~i~0_13 (+ main_~i~0_12 1)) (= (store |#memory_int#2_12| |main_~#a~0.base_4| v_ArrVal_389_fresh_1) |#memory_int#2_13|)) :named ssa_13))
(assert (! (and (= (store |#memory_int#2_13| |main_~#a~0.base_4| v_ArrVal_391_fresh_1) |#memory_int#2_14|) (< main_~i~0_13 100000) (= v_ArrVal_391_fresh_1 (store (select |#memory_int#2_13| |main_~#a~0.base_4|) (+ (* main_~i~0_13 4) |main_~#a~0.offset_4|) 42)) (= v_ArrVal_392_fresh_1 42) (= main_~i~0_14 (+ main_~i~0_13 1))) :named ssa_14))
(assert (! (and (< main_~i~0_14 100000) (= (store |#memory_int#2_14| |main_~#a~0.base_4| v_ArrVal_393_fresh_1) |#memory_int#2_15|) (= v_ArrVal_393_fresh_1 (store (select |#memory_int#2_14| |main_~#a~0.base_4|) (+ (* main_~i~0_14 4) |main_~#a~0.offset_4|) 42)) (= main_~i~0_15 (+ main_~i~0_14 1)) (= v_ArrVal_394_fresh_1 42)) :named ssa_15))
(assert (! (and (= |#memory_int#2_16| (store |#memory_int#2_15| |main_~#a~0.base_4| v_ArrVal_395_fresh_1)) (= v_ArrVal_395_fresh_1 (store (select |#memory_int#2_15| |main_~#a~0.base_4|) (+ (* main_~i~0_15 4) |main_~#a~0.offset_4|) 42)) (< main_~i~0_15 100000) (= main_~i~0_16 (+ main_~i~0_15 1)) (= v_ArrVal_396_fresh_1 42)) :named ssa_16))
(assert (! (and (= (store |#memory_int#2_16| |main_~#a~0.base_4| v_ArrVal_397_fresh_1) |#memory_int#2_17|) (< main_~i~0_16 100000) (= v_ArrVal_398_fresh_1 42) (= main_~i~0_17 (+ main_~i~0_16 1)) (= v_ArrVal_397_fresh_1 (store (select |#memory_int#2_16| |main_~#a~0.base_4|) (+ (* main_~i~0_16 4) |main_~#a~0.offset_4|) 42))) :named ssa_17))
(assert (! (<= 100000 main_~i~0_17) :named ssa_18))
(assert (! (= main_~i~0_19 0) :named ssa_19))
(assert (! (and (= v_ArrVal_400_fresh_1 (store (select |#memory_int#1_3| |main_~#b~0.base_4|) (+ (* main_~i~0_19 4) |main_~#b~0.offset_4|) v_ArrVal_399_fresh_1)) (= (store |#memory_int#1_3| |main_~#b~0.base_4| v_ArrVal_400_fresh_1) |#memory_int#1_20|) (< main_~i~0_19 100000) (= main_~i~0_20 (+ main_~i~0_19 1)) (= v_ArrVal_399_fresh_1 (select (select |#memory_int#2_17| |main_~#a~0.base_4|) (+ (* main_~i~0_19 4) |main_~#a~0.offset_4|)))) :named ssa_20))
(assert (! (and (= v_ArrVal_401_fresh_1 (select (select |#memory_int#2_17| |main_~#a~0.base_4|) (+ (* main_~i~0_20 4) |main_~#a~0.offset_4|))) (= |#memory_int#1_21| (store |#memory_int#1_20| |main_~#b~0.base_4| v_ArrVal_402_fresh_1)) (< main_~i~0_20 100000) (= main_~i~0_21 (+ main_~i~0_20 1)) (= v_ArrVal_402_fresh_1 (store (select |#memory_int#1_20| |main_~#b~0.base_4|) (+ (* main_~i~0_20 4) |main_~#b~0.offset_4|) v_ArrVal_401_fresh_1))) :named ssa_21))
(assert (! (and (= (store |#memory_int#1_21| |main_~#b~0.base_4| v_ArrVal_404_fresh_1) |#memory_int#1_22|) (= v_ArrVal_403_fresh_1 (select (select |#memory_int#2_17| |main_~#a~0.base_4|) (+ (* main_~i~0_21 4) |main_~#a~0.offset_4|))) (< main_~i~0_21 100000) (= v_ArrVal_404_fresh_1 (store (select |#memory_int#1_21| |main_~#b~0.base_4|) (+ (* main_~i~0_21 4) |main_~#b~0.offset_4|) v_ArrVal_403_fresh_1)) (= main_~i~0_22 (+ main_~i~0_21 1))) :named ssa_22))
(assert (! (and (= v_ArrVal_406_fresh_1 (store (select |#memory_int#1_22| |main_~#b~0.base_4|) (+ (* main_~i~0_22 4) |main_~#b~0.offset_4|) v_ArrVal_405_fresh_1)) (= (store |#memory_int#1_22| |main_~#b~0.base_4| v_ArrVal_406_fresh_1) |#memory_int#1_23|) (= v_ArrVal_405_fresh_1 (select (select |#memory_int#2_17| |main_~#a~0.base_4|) (+ (* main_~i~0_22 4) |main_~#a~0.offset_4|))) (< main_~i~0_22 100000) (= main_~i~0_23 (+ main_~i~0_22 1))) :named ssa_23))
(assert (! (and (= v_ArrVal_408_fresh_1 (store (select |#memory_int#1_23| |main_~#b~0.base_4|) (+ (* main_~i~0_23 4) |main_~#b~0.offset_4|) v_ArrVal_407_fresh_1)) (= v_ArrVal_407_fresh_1 (select (select |#memory_int#2_17| |main_~#a~0.base_4|) (+ (* main_~i~0_23 4) |main_~#a~0.offset_4|))) (= (store |#memory_int#1_23| |main_~#b~0.base_4| v_ArrVal_408_fresh_1) |#memory_int#1_24|) (< main_~i~0_23 100000) (= main_~i~0_24 (+ main_~i~0_23 1))) :named ssa_24))
(assert (! (and (= v_ArrVal_409_fresh_1 (select (select |#memory_int#2_17| |main_~#a~0.base_4|) (+ (* main_~i~0_24 4) |main_~#a~0.offset_4|))) (= (store (select |#memory_int#1_24| |main_~#b~0.base_4|) (+ (* main_~i~0_24 4) |main_~#b~0.offset_4|) v_ArrVal_409_fresh_1) v_ArrVal_410_fresh_1) (< main_~i~0_24 100000) (= main_~i~0_25 (+ main_~i~0_24 1)) (= (store |#memory_int#1_24| |main_~#b~0.base_4| v_ArrVal_410_fresh_1) |#memory_int#1_25|)) :named ssa_25))
(assert (! (and (= v_ArrVal_412_fresh_1 (store (select |#memory_int#1_25| |main_~#b~0.base_4|) (+ (* main_~i~0_25 4) |main_~#b~0.offset_4|) v_ArrVal_411_fresh_1)) (= v_ArrVal_411_fresh_1 (select (select |#memory_int#2_17| |main_~#a~0.base_4|) (+ (* main_~i~0_25 4) |main_~#a~0.offset_4|))) (= (store |#memory_int#1_25| |main_~#b~0.base_4| v_ArrVal_412_fresh_1) |#memory_int#1_26|) (< main_~i~0_25 100000) (= main_~i~0_26 (+ main_~i~0_25 1))) :named ssa_26))
(assert (! (and (= v_ArrVal_414_fresh_1 (store (select |#memory_int#1_26| |main_~#b~0.base_4|) (+ (* main_~i~0_26 4) |main_~#b~0.offset_4|) v_ArrVal_413_fresh_1)) (= (store |#memory_int#1_26| |main_~#b~0.base_4| v_ArrVal_414_fresh_1) |#memory_int#1_27|) (< main_~i~0_26 100000) (= v_ArrVal_413_fresh_1 (select (select |#memory_int#2_17| |main_~#a~0.base_4|) (+ (* main_~i~0_26 4) |main_~#a~0.offset_4|))) (= main_~i~0_27 (+ main_~i~0_26 1))) :named ssa_27))
(assert (! (and (= (store (select |#memory_int#1_27| |main_~#b~0.base_4|) (+ (* main_~i~0_27 4) |main_~#b~0.offset_4|) v_ArrVal_415_fresh_1) v_ArrVal_416_fresh_1) (= v_ArrVal_415_fresh_1 (select (select |#memory_int#2_17| |main_~#a~0.base_4|) (+ (* main_~i~0_27 4) |main_~#a~0.offset_4|))) (= |#memory_int#1_28| (store |#memory_int#1_27| |main_~#b~0.base_4| v_ArrVal_416_fresh_1)) (< main_~i~0_27 100000) (= main_~i~0_28 (+ main_~i~0_27 1))) :named ssa_28))
(assert (! (and (= (store |#memory_int#1_28| |main_~#b~0.base_4| v_ArrVal_418_fresh_1) |#memory_int#1_29|) (= v_ArrVal_418_fresh_1 (store (select |#memory_int#1_28| |main_~#b~0.base_4|) (+ (* main_~i~0_28 4) |main_~#b~0.offset_4|) v_ArrVal_417_fresh_1)) (< main_~i~0_28 100000) (= v_ArrVal_417_fresh_1 (select (select |#memory_int#2_17| |main_~#a~0.base_4|) (+ (* main_~i~0_28 4) |main_~#a~0.offset_4|))) (= main_~i~0_29 (+ main_~i~0_28 1))) :named ssa_29))
(assert (! (and (= v_ArrVal_419_fresh_1 (select (select |#memory_int#2_17| |main_~#a~0.base_4|) (+ (* main_~i~0_29 4) |main_~#a~0.offset_4|))) (= v_ArrVal_420_fresh_1 (store (select |#memory_int#1_29| |main_~#b~0.base_4|) (+ (* main_~i~0_29 4) |main_~#b~0.offset_4|) v_ArrVal_419_fresh_1)) (= (store |#memory_int#1_29| |main_~#b~0.base_4| v_ArrVal_420_fresh_1) |#memory_int#1_30|) (< main_~i~0_29 100000) (= main_~i~0_30 (+ main_~i~0_29 1))) :named ssa_30))
(assert (! (and (= |#memory_int#1_31| (store |#memory_int#1_30| |main_~#b~0.base_4| v_ArrVal_422_fresh_1)) (= v_ArrVal_422_fresh_1 (store (select |#memory_int#1_30| |main_~#b~0.base_4|) (+ (* main_~i~0_30 4) |main_~#b~0.offset_4|) v_ArrVal_421_fresh_1)) (= v_ArrVal_421_fresh_1 (select (select |#memory_int#2_17| |main_~#a~0.base_4|) (+ (* main_~i~0_30 4) |main_~#a~0.offset_4|))) (< main_~i~0_30 100000) (= main_~i~0_31 (+ main_~i~0_30 1))) :named ssa_31))
(assert (! (and (= v_ArrVal_423_fresh_1 (select (select |#memory_int#2_17| |main_~#a~0.base_4|) (+ (* main_~i~0_31 4) |main_~#a~0.offset_4|))) (= |#memory_int#1_32| (store |#memory_int#1_31| |main_~#b~0.base_4| v_ArrVal_424_fresh_1)) (< main_~i~0_31 100000) (= main_~i~0_32 (+ main_~i~0_31 1)) (= v_ArrVal_424_fresh_1 (store (select |#memory_int#1_31| |main_~#b~0.base_4|) (+ (* main_~i~0_31 4) |main_~#b~0.offset_4|) v_ArrVal_423_fresh_1))) :named ssa_32))
(assert (! (<= 100000 main_~i~0_32) :named ssa_33))
(assert (! (= main_~x~0_34 0) :named ssa_34))
(assert (! (and (< main_~x~0_34 100000) (= |main_#t~mem3_35| (select (select |#memory_int#1_32| |main_~#b~0.base_4|) (+ (* main_~x~0_34 4) |main_~#b~0.offset_4|)))) :named ssa_35))
(assert (! true :named ssa_36_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_36| (ite (= |main_#t~mem3_35| 42) 1 0)) :named ssa_36_LocVarAssigCall))
