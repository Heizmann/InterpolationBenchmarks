...
(set-info :ultimate-id id_i20_o20-1.c_AllErrorsAtOnce_Iteration7)
...
(declare-fun main_~result~0_47 () Int)
...
(assert (! (and (<= 0 (+ |main_#t~ret5_45| 2147483648)) (= main_~result~0_46 |main_#t~ret5_45|) (<= |main_#t~ret5_45| 2147483647)) :named ssa_46))
(assert (! (not (= main_~result~0_46 20)) :named ssa_47))
(assert (! true :named ssa_48))
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 (and ssa_13 ssa_14_OldVarAssigCall ssa_17_LocVarAssigCall ssa_5_LocVarAssigCall ssa_31 ssa_5_GlobVarAssigCall ssa_7 ssa_44 ssa_16 ssa_6 ssa_26 ssa_34 ssa_17_GlobVarAssigCall ssa_8_GlobVarAssigCall ssa_11_LocVarAssigCall ssa_14_LocVarAssigCall ssa_27_return ssa_40 ssa_10 ssa_9 ssa_25 ssa_39_return ssa_14_GlobVarAssigCall ssa_23_OldVarAssigCall ssa_20_GlobVarAssigCall ssa_20_OldVarAssigCall ssa_45_return ssa_19 ssa_43 ssa_23_LocVarAssigCall ssa_37 ssa_17_OldVarAssigCall ssa_20_LocVarAssigCall ssa_38 ssa_12 ssa_11_OldVarAssigCall ssa_32 ssa_5_OldVarAssigCall ssa_8_OldVarAssigCall ssa_28 ssa_22 ssa_15 ssa_29 ssa_42_return ssa_23_GlobVarAssigCall ssa_21 ssa_30_return ssa_11_GlobVarAssigCall ssa_33_return ssa_18 ssa_36_return ssa_35 ssa_41 ssa_8_LocVarAssigCall ssa_24) ssa_46 ssa_47 (and ssa_48 ssa_postcond))
