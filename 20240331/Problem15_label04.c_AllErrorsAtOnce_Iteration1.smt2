...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-30T23:56:38+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id Problem15_label04.c_AllErrorsAtOnce_Iteration1)
