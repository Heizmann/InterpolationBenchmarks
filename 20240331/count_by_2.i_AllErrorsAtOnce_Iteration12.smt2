...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration12)
...
(assert (! (<= 1000000 main_~i~0_15) :named ssa_16))
(assert (! true :named ssa_17_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_17| (ite (= main_~i~0_15 1000000) 1 0)) :named ssa_17_LocVarAssigCall))
