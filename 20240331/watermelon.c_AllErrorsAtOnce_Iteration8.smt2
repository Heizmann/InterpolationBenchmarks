...
(set-info :ultimate-id watermelon.c_AllErrorsAtOnce_Iteration8)
...
(declare-fun v_main_~is_divisible2~0_13_fresh_1 () Int)
(declare-fun v_main_~is_divisible1~0_13_fresh_1 () Int)
...
(assert (! (and (= ~true~0_1 v_main_~is_divisible2~0_13_fresh_1) (= ~true~0_1 v_main_~is_divisible1~0_13_fresh_1)) :named ssa_4))
...
(assert (! (and (not (= correct_version_~i~0_10 correct_version_~w_7)) (= ~false~0_1 correct_version_~is_divisible~0_12)) :named ssa_12))
(assert (! true :named ssa_13))
(assert (! (= |correct_version_#res_14| correct_version_~is_divisible~0_12) :named ssa_14))
...
(declare-fun ~false~0_-1 () Int)
(declare-fun correct_version_~is_divisible~0_5 () Int)
...
(assert (! (and (not (= correct_version_~i~0_3 correct_version_~w_0)) (= ~false~0_-1 correct_version_~is_divisible~0_5)) :named ssa_5))
(assert (! true :named ssa_6))
(assert (! (= |correct_version_#res_7| correct_version_~is_divisible~0_5) :named ssa_7))
