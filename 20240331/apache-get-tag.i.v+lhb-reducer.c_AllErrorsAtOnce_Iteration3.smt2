...
(set-info :ultimate-id apache-get-tag.i.v+lhb-reducer.c_AllErrorsAtOnce_Iteration3)
...
(declare-fun v_main_~main____CPAchecker_TMP_2~0_3_fresh_1 () Int)
(declare-fun v_main_~main____CPAchecker_TMP_0~0_11_fresh_1 () Int)
...
(assert (! (and (= (ite (<= 0 main_~main__t~0_5) 1 0) v_main_~__tmp_1~0_5_fresh_1) (not (= main_~main____CPAchecker_TMP_0~0_6 0)) (= v_main_~__tmp_1~0_5_fresh_1 main_~__VERIFIER_assert__cond~0_7)) :named ssa_7))
(assert (! (and (= v_main_~__tmp_2~0_5_fresh_1 (ite (<= main_~main__t~0_5 main_~main__tagbuf_len~0_5) 1 0)) (not (= main_~__VERIFIER_assert__cond~0_7 0)) (= v_main_~__tmp_2~0_5_fresh_1 main_~__VERIFIER_assert__cond~1_8)) :named ssa_8))
(assert (! (and (not (= main_~__VERIFIER_assert__cond~1_8 0)) (= main_~main____CPAchecker_TMP_0~0_6 ~__tmp_259_0~0_9)) :named ssa_9))
(assert (! (and (= (+ main_~main__t~0_5 1) main_~main__t~0_10) (= v_main_~main____CPAchecker_TMP_2~0_3_fresh_1 main_~main__t~0_5) (= ~__tmp_259_0~0_9 v_main_~main____CPAchecker_TMP_0~0_11_fresh_1)) :named ssa_10))
(assert (! (and (= v_main_~__tmp_3~0_4_fresh_1 main_~__VERIFIER_assert__cond~2_11) (= v_main_~__tmp_3~0_4_fresh_1 (ite (<= 0 main_~main__t~0_10) 1 0)) (= main_~main__t~0_10 main_~main__tagbuf_len~0_5)) :named ssa_11))
(assert (! (= main_~__VERIFIER_assert__cond~2_11 0) :named ssa_12))
