...
(set-info :ultimate-id parity.i_AllErrorsAtOnce_Iteration6)
...
(declare-fun main_~parity1~0_17 () Int)
...
(assert (! (and (= main_~v2~0_6 main_~v~0_4) (= v_main_~parity2~0_13_fresh_1 0)) :named ssa_6))
(assert (! (not (= (mod main_~v2~0_6 4294967296) 0)) :named ssa_7))
(assert (! (and (= (mod (div (mod main_~v2~0_6 4294967296) 2) 4294967296) 0) (= main_~v2~0_6 |main_#t~bitwise3_8|)) :named ssa_8))
(assert (! (= main_~v2~0_9 |main_#t~bitwise3_8|) :named ssa_9))
(assert (! (not (= (mod main_~v2~0_9 4294967296) 0)) :named ssa_10))
(assert (! (and (= (mod (div (mod main_~v2~0_9 4294967296) 4) 4294967296) 0) (= main_~v2~0_9 |main_#t~bitwise4_11|)) :named ssa_11))
(assert (! (= main_~v2~0_12 |main_#t~bitwise4_11|) :named ssa_12))
(assert (! (not (= (mod main_~v2~0_12 4294967296) 0)) :named ssa_13))
(assert (! (and (= main_~v2~0_12 |main_#t~bitwise5_14|) (= (mod main_~v2~0_12 4294967296) 286331153)) :named ssa_14))
(assert (! (= main_~v2~0_15 (* 286331153 |main_#t~bitwise5_14|)) :named ssa_15))
(assert (! (and (not (= (mod (div (mod main_~v2~0_15 4294967296) 268435456) 2) 0)) (= main_~parity2~0_16 1)) :named ssa_16))
(assert (! true :named ssa_17_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_17| (ite (= main_~parity1~0_4 main_~parity2~0_16) 1 0)) :named ssa_17_LocVarAssigCall))
