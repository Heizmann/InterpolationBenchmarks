...
(set-info :ultimate-id psyco_abp_1-3.c_AllErrorsAtOnce_Iteration3)
...
(declare-fun v_main_~P5~0_6_fresh_1 () Int)
(declare-fun v_main_~P2~0_6_fresh_1 () Int)
(declare-fun v_main_~P7~0_6_fresh_1 () Int)
(declare-fun |main_#t~nondet13_7| () Int)
(declare-fun |main_#t~nondet13_8| () Int)
(declare-fun v_main_~method_id~0_66_fresh_1 () Int)
...
(declare-fun v_main_~P2~0_7_fresh_1 () Int)
(declare-fun v_main_~P5~0_7_fresh_1 () Int)
(declare-fun v_main_~P7~0_7_fresh_1 () Int)
(declare-fun |main_#t~nondet14_13| () Int)
(declare-fun |main_#t~nondet14_14| () Int)
(declare-fun v_main_~method_id~0_67_fresh_1 () Int)
...
(assert (! (and (<= main_~P4~0_6 2147483647) (<= 0 (+ main_~P1~0_6 2147483648)) (<= main_~P3~0_6 2147483647) (<= main_~P8~0_6 2147483647) (<= 0 (+ main_~P8~0_6 2147483648)) (<= 0 (+ main_~P6~0_6 2147483648)) (<= 0 (+ main_~P3~0_6 2147483648)) (<= 0 (+ main_~P9~0_6 2147483648)) (<= v_main_~P7~0_6_fresh_1 2147483647) (<= 0 (+ v_main_~P5~0_6_fresh_1 2147483648)) (<= main_~P9~0_6 2147483647) (<= 0 (+ v_main_~P2~0_6_fresh_1 2147483648)) (<= 0 (+ main_~P4~0_6 2147483648)) (<= main_~P1~0_6 2147483647) (<= v_main_~P2~0_6_fresh_1 2147483647) (<= v_main_~P5~0_6_fresh_1 2147483647) (<= 0 (+ v_main_~P7~0_6_fresh_1 2147483648)) (<= main_~P6~0_6 2147483647)) :named ssa_6))
...
(assert (! (= 1 v_main_~method_id~0_66_fresh_1) :named ssa_9))
(assert (! (and (= main_~this_buffer_empty~0_10 1) (= main_~q~0_10 1) (= main_~this_expect~0_10 0)) :named ssa_10))
(assert (! (and (<= main_~P4~0_11 2147483647) (<= v_main_~P7~0_7_fresh_1 2147483647) (<= 0 (+ main_~P1~0_11 2147483648)) (<= v_main_~P2~0_7_fresh_1 2147483647) (<= main_~P3~0_11 2147483647) (<= main_~P8~0_11 2147483647) (<= 0 (+ main_~P8~0_11 2147483648)) (<= 0 (+ main_~P6~0_11 2147483648)) (<= 0 (+ v_main_~P7~0_7_fresh_1 2147483648)) (<= 0 (+ main_~P3~0_11 2147483648)) (<= 0 (+ main_~P9~0_11 2147483648)) (<= 0 (+ v_main_~P2~0_7_fresh_1 2147483648)) (<= main_~P9~0_11 2147483647) (<= 0 (+ main_~P4~0_11 2147483648)) (<= main_~P1~0_11 2147483647) (<= 0 (+ v_main_~P5~0_7_fresh_1 2147483648)) (<= main_~P6~0_11 2147483647) (<= v_main_~P5~0_7_fresh_1 2147483647)) :named ssa_11))
...
(assert (! (and (= (ite (and (< main_~P1~0_11 0) (not (= (mod main_~P1~0_11 2) 0))) (+ (- 2) (mod main_~P1~0_11 2)) (mod main_~P1~0_11 2)) 0) (= 2 v_main_~method_id~0_67_fresh_1)) :named ssa_15))
(assert (! (or (and (not (= (mod main_~this_buffer_empty~0_10 4294967296) 1)) (= (ite (and (< main_~P1~0_11 0) (not (= (mod main_~P1~0_11 2) 0))) (+ (- 2) (mod main_~P1~0_11 2)) (mod main_~P1~0_11 2)) 0)) (and (= (ite (and (< main_~P1~0_11 0) (not (= (mod main_~P1~0_11 2) 0))) (+ (- 2) (mod main_~P1~0_11 2)) (mod main_~P1~0_11 2)) 0) (= (mod main_~this_buffer_empty~0_10 4294967296) 1) (not (= (mod (ite (and (< main_~P1~0_11 0) (not (= (mod main_~P1~0_11 2) 0))) (+ (- 2) (mod main_~P1~0_11 2)) (mod main_~P1~0_11 2)) 4294967296) (mod main_~this_expect~0_10 2))))) :named ssa_16))
