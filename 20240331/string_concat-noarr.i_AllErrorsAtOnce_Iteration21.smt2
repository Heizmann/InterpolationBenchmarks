...
(set-info :ultimate-id string_concat-noarr.i_AllErrorsAtOnce_Iteration21)
...
(assert (! (or (<= 1000000 main_~i~0_45) (= |main_#t~nondet3_46| 0)) :named ssa_47))
(assert (! (< main_~j~0_45 100) :named ssa_48))
(assert (! true :named ssa_49_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_49| (ite (< main_~i~0_45 200) 1 0)) :named ssa_49_LocVarAssigCall))
