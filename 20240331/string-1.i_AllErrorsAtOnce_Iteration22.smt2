...
(set-info :ultimate-id string-1.i_AllErrorsAtOnce_Iteration22)
...
(declare-fun v_main_~found~0_27_fresh_1 () Int)
...
(declare-fun |v_main_#t~nondet4_95_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_96_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_97_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_98_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_99_fresh_1| () Int)
...
(assert (! (and (< |#StackHeapBarrier_-1| |main_~#string_A~0.base_4|) (= v_ArrVal_447_fresh_1 5) (= (store (store |#valid_3| |main_~#string_A~0.base_4| v_ArrVal_448_fresh_1) |main_~#string_B~0.base_4| v_ArrVal_445_fresh_1) |#valid_4|) (= main_~i~0_4 0) (= v_ArrVal_445_fresh_1 1) (= (select |#valid_3| |main_~#string_A~0.base_4|) 0) (= |main_~#string_A~0.offset_4| 0) (not (= |main_~#string_B~0.base_4| 0)) (= |main_~#string_B~0.offset_4| 0) (= v_main_~found~0_27_fresh_1 0) (= (select (store |#valid_3| |main_~#string_A~0.base_4| v_ArrVal_448_fresh_1) |main_~#string_B~0.base_4|) 0) (not (= |main_~#string_A~0.base_4| 0)) (= v_ArrVal_446_fresh_1 5) (< |#StackHeapBarrier_-1| |main_~#string_B~0.base_4|) (= |#length_4| (store (store |#length_3| |main_~#string_A~0.base_4| v_ArrVal_447_fresh_1) |main_~#string_B~0.base_4| v_ArrVal_446_fresh_1)) (= v_ArrVal_448_fresh_1 1)) :named ssa_4))
(assert (! (and (= (store |#memory_int#2_3| |main_~#string_A~0.base_4| v_ArrVal_449_fresh_1) |#memory_int#2_5|) (<= |v_main_#t~nondet1_95_fresh_1| 127) (= main_~i~0_5 (+ main_~i~0_4 1)) (<= 0 (+ |v_main_#t~nondet1_95_fresh_1| 128)) (< main_~i~0_4 5) (= v_ArrVal_450_fresh_1 |v_main_#t~nondet1_95_fresh_1|) (= v_ArrVal_449_fresh_1 (store (select |#memory_int#2_3| |main_~#string_A~0.base_4|) (+ main_~i~0_4 |main_~#string_A~0.offset_4|) |v_main_#t~nondet1_95_fresh_1|))) :named ssa_5))
(assert (! (and (= v_ArrVal_451_fresh_1 |v_main_#t~nondet1_96_fresh_1|) (<= |v_main_#t~nondet1_96_fresh_1| 127) (= v_ArrVal_452_fresh_1 (store (select |#memory_int#2_5| |main_~#string_A~0.base_4|) (+ main_~i~0_5 |main_~#string_A~0.offset_4|) v_ArrVal_451_fresh_1)) (= main_~i~0_6 (+ main_~i~0_5 1)) (= |#memory_int#2_6| (store |#memory_int#2_5| |main_~#string_A~0.base_4| v_ArrVal_452_fresh_1)) (<= 0 (+ |v_main_#t~nondet1_96_fresh_1| 128)) (< main_~i~0_5 5)) :named ssa_6))
(assert (! (and (<= 0 (+ |v_main_#t~nondet1_97_fresh_1| 128)) (= v_ArrVal_454_fresh_1 |v_main_#t~nondet1_97_fresh_1|) (= main_~i~0_7 (+ main_~i~0_6 1)) (= (store |#memory_int#2_6| |main_~#string_A~0.base_4| v_ArrVal_453_fresh_1) |#memory_int#2_7|) (<= |v_main_#t~nondet1_97_fresh_1| 127) (< main_~i~0_6 5) (= v_ArrVal_453_fresh_1 (store (select |#memory_int#2_6| |main_~#string_A~0.base_4|) (+ main_~i~0_6 |main_~#string_A~0.offset_4|) |v_main_#t~nondet1_97_fresh_1|))) :named ssa_7))
(assert (! (and (<= |v_main_#t~nondet1_98_fresh_1| 127) (<= 0 (+ |v_main_#t~nondet1_98_fresh_1| 128)) (= main_~i~0_8 (+ main_~i~0_7 1)) (= v_ArrVal_455_fresh_1 |v_main_#t~nondet1_98_fresh_1|) (= v_ArrVal_456_fresh_1 (store (select |#memory_int#2_7| |main_~#string_A~0.base_4|) (+ main_~i~0_7 |main_~#string_A~0.offset_4|) v_ArrVal_455_fresh_1)) (< main_~i~0_7 5) (= (store |#memory_int#2_7| |main_~#string_A~0.base_4| v_ArrVal_456_fresh_1) |#memory_int#2_8|)) :named ssa_8))
(assert (! (and (<= |v_main_#t~nondet1_99_fresh_1| 127) (= (store |#memory_int#2_8| |main_~#string_A~0.base_4| v_ArrVal_457_fresh_1) |#memory_int#2_9|) (= v_ArrVal_457_fresh_1 (store (select |#memory_int#2_8| |main_~#string_A~0.base_4|) (+ main_~i~0_8 |main_~#string_A~0.offset_4|) |v_main_#t~nondet1_99_fresh_1|)) (= v_ArrVal_458_fresh_1 |v_main_#t~nondet1_99_fresh_1|) (= main_~i~0_9 (+ main_~i~0_8 1)) (<= 0 (+ |v_main_#t~nondet1_99_fresh_1| 128)) (< main_~i~0_8 5)) :named ssa_9))
...
(assert (! (and (= |#memory_int#1_13| (store |#memory_int#1_3| |main_~#string_B~0.base_4| v_ArrVal_459_fresh_1)) (= v_ArrVal_460_fresh_1 |v_main_#t~nondet4_95_fresh_1|) (= main_~i~0_13 (+ main_~i~0_12 1)) (<= 0 (+ |v_main_#t~nondet4_95_fresh_1| 128)) (<= |v_main_#t~nondet4_95_fresh_1| 127) (= v_ArrVal_459_fresh_1 (store (select |#memory_int#1_3| |main_~#string_B~0.base_4|) (+ main_~i~0_12 |main_~#string_B~0.offset_4|) |v_main_#t~nondet4_95_fresh_1|)) (< main_~i~0_12 5)) :named ssa_13))
(assert (! (and (<= 0 (+ |v_main_#t~nondet4_96_fresh_1| 128)) (= main_~i~0_14 (+ main_~i~0_13 1)) (= (store |#memory_int#1_13| |main_~#string_B~0.base_4| v_ArrVal_461_fresh_1) |#memory_int#1_14|) (<= |v_main_#t~nondet4_96_fresh_1| 127) (= v_ArrVal_461_fresh_1 (store (select |#memory_int#1_13| |main_~#string_B~0.base_4|) (+ main_~i~0_13 |main_~#string_B~0.offset_4|) |v_main_#t~nondet4_96_fresh_1|)) (= v_ArrVal_462_fresh_1 |v_main_#t~nondet4_96_fresh_1|) (< main_~i~0_13 5)) :named ssa_14))
(assert (! (and (<= 0 (+ |v_main_#t~nondet4_97_fresh_1| 128)) (= v_ArrVal_464_fresh_1 |v_main_#t~nondet4_97_fresh_1|) (= main_~i~0_15 (+ main_~i~0_14 1)) (<= |v_main_#t~nondet4_97_fresh_1| 127) (< main_~i~0_14 5) (= (store (select |#memory_int#1_14| |main_~#string_B~0.base_4|) (+ main_~i~0_14 |main_~#string_B~0.offset_4|) |v_main_#t~nondet4_97_fresh_1|) v_ArrVal_463_fresh_1) (= (store |#memory_int#1_14| |main_~#string_B~0.base_4| v_ArrVal_463_fresh_1) |#memory_int#1_15|)) :named ssa_15))
(assert (! (and (<= 0 (+ |v_main_#t~nondet4_98_fresh_1| 128)) (= v_ArrVal_465_fresh_1 (store (select |#memory_int#1_15| |main_~#string_B~0.base_4|) (+ main_~i~0_15 |main_~#string_B~0.offset_4|) |v_main_#t~nondet4_98_fresh_1|)) (= (store |#memory_int#1_15| |main_~#string_B~0.base_4| v_ArrVal_465_fresh_1) |#memory_int#1_16|) (= main_~i~0_16 (+ main_~i~0_15 1)) (<= |v_main_#t~nondet4_98_fresh_1| 127) (= v_ArrVal_466_fresh_1 |v_main_#t~nondet4_98_fresh_1|) (< main_~i~0_15 5)) :named ssa_16))
(assert (! (and (= main_~i~0_17 (+ main_~i~0_16 1)) (= (store |#memory_int#1_16| |main_~#string_B~0.base_4| v_ArrVal_468_fresh_1) |#memory_int#1_17|) (< main_~i~0_16 5) (= v_ArrVal_467_fresh_1 |v_main_#t~nondet4_99_fresh_1|) (= v_ArrVal_468_fresh_1 (store (select |#memory_int#1_16| |main_~#string_B~0.base_4|) (+ main_~i~0_16 |main_~#string_B~0.offset_4|) v_ArrVal_467_fresh_1)) (<= 0 (+ |v_main_#t~nondet4_99_fresh_1| 128)) (<= |v_main_#t~nondet4_99_fresh_1| 127)) :named ssa_17))
...
(assert (! (and (= (+ |v_main_#t~post8_29_fresh_1| 1) main_~nc_A~0_22) (= |v_main_#t~post8_29_fresh_1| main_~nc_A~0_20) (not (= |main_#t~mem7_21| 0))) :named ssa_22))
...
(assert (! (and (= |v_main_#t~post8_30_fresh_1| main_~nc_A~0_22) (= (+ |v_main_#t~post8_30_fresh_1| 1) main_~nc_A~0_24) (not (= |main_#t~mem7_23| 0))) :named ssa_24))
...
(assert (! (and (= main_~nc_A~0_26 (+ |v_main_#t~post8_31_fresh_1| 1)) (= |v_main_#t~post8_31_fresh_1| main_~nc_A~0_24) (not (= |main_#t~mem7_25| 0))) :named ssa_26))
...
(assert (! (and (= |v_main_#t~post10_32_fresh_1| main_~nc_B~0_29) (= (+ |v_main_#t~post10_32_fresh_1| 1) main_~nc_B~0_31) (not (= |main_#t~mem9_30| 0))) :named ssa_31))
...
(assert (! (and (= (+ |v_main_#t~post10_33_fresh_1| 1) main_~nc_B~0_33) (= |v_main_#t~post10_33_fresh_1| main_~nc_B~0_31) (not (= |main_#t~mem9_32| 0))) :named ssa_33))
...
(assert (! (and (= (+ |v_main_#t~post10_34_fresh_1| 1) main_~nc_B~0_35) (not (= |main_#t~mem9_34| 0)) (= |v_main_#t~post10_34_fresh_1| main_~nc_B~0_33)) :named ssa_35))
...
(assert (! (or (<= main_~nc_B~0_35 main_~j~0_46) (<= main_~nc_A~0_26 main_~i~0_46)) :named ssa_47))
(assert (! (= main_~found~0_48 (ite (< main_~nc_B~0_35 (+ main_~j~0_46 1)) 1 0)) :named ssa_48))
