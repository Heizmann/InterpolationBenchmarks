...
(set-info :ultimate-id nr4.c_AllErrorsAtOnce_Iteration3)
...
(assert (! (and (< |#StackHeapBarrier_-1| |main_~#volArray~0.base_5|) (= |main_~#volArray~0.offset_5| 0) (not (= |main_~#volArray~0.base_5| 0)) (= 0 (select |#valid_3| |main_~#volArray~0.base_5|)) (= main_~MINVAL~0_5 2) (= (store |#length_3| |main_~#volArray~0.base_5| v_ArrVal_5_fresh_1) |#length_5|) (< 1 ~CELLCOUNT~0_4) (= (store |#valid_3| |main_~#volArray~0.base_5| v_ArrVal_6_fresh_1) |#valid_5|) (= v_ArrVal_6_fresh_1 1) (= (* (mod ~CELLCOUNT~0_4 1073741824) 4) v_ArrVal_5_fresh_1)) :named ssa_5))
...
(assert (! (and (= (select (select |#memory_int#1_3| |main_~#volArray~0.base_5|) (+ (* main_~i~0_14 4) |main_~#volArray~0.offset_5|)) |v_main_#t~mem7_8_fresh_1|) (< main_~i~0_14 ~CELLCOUNT~0_4) (or (and |main_#t~short9_15| (<= main_~MINVAL~0_5 |v_main_#t~mem7_8_fresh_1|)) (and (< |v_main_#t~mem7_8_fresh_1| main_~MINVAL~0_5) (not |main_#t~short9_15|)))) :named ssa_15))
(assert (! (and (or (and (not |main_#t~short9_16|) (not (= |v_main_#t~mem8_6_fresh_1| 0))) (and |main_#t~short9_16| (= |v_main_#t~mem8_6_fresh_1| 0))) (= |v_main_#t~mem8_6_fresh_1| (select (select |#memory_int#1_3| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_14 4)))) (not |main_#t~short9_15|)) :named ssa_16))
(assert (! true :named ssa_17_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_17| (ite |main_#t~short9_16| 1 0)) :named ssa_17_LocVarAssigCall))
