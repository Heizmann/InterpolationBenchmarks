...
(set-info :ultimate-id nested_6.c_AllErrorsAtOnce_Iteration9)
...
(declare-fun |main_#t~pre7_22| () Int)
(declare-fun main_~c~0_22 () Int)
(declare-fun |main_#t~pre8_24| () Int)
(declare-fun main_~b~0_24 () Int)
(declare-fun |main_#t~pre9_26| () Int)
(declare-fun main_~a~0_26 () Int)
(declare-fun main_~e~0_28 () Int)
(declare-fun main_~f~0_28 () Int)
(declare-fun main_~c~0_28 () Int)
(declare-fun main_~d~0_28 () Int)
(declare-fun main_~b~0_28 () Int)
(declare-fun main_~a~0_28 () Int)
...
(assert (! (= (+ main_~c~0_6 1) main_~c~0_22) :named ssa_22))
(assert (! (<= 6 main_~c~0_22) :named ssa_23))
(assert (! (= main_~b~0_24 (+ main_~b~0_5 1)) :named ssa_24))
(assert (! (<= 6 main_~b~0_24) :named ssa_25))
(assert (! (= main_~a~0_26 (+ main_~a~0_4 1)) :named ssa_26))
(assert (! (<= 6 main_~a~0_26) :named ssa_27))
(assert (! (or (not (= main_~c~0_22 6)) (not (= main_~d~0_20 6)) (not (= main_~a~0_26 6)) (not (= main_~f~0_16 6)) (not (= main_~e~0_18 6)) (not (= main_~b~0_24 6))) :named ssa_28))
