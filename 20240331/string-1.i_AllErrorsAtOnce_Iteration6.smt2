...
(set-info :ultimate-id string-1.i_AllErrorsAtOnce_Iteration6)
...
(declare-fun v_main_~found~0_11_fresh_1 () Int)
...
(declare-fun main_~nc_A~0_27 () Int)
(declare-fun main_~found~0_28 () Int)
(declare-fun main_~j~0_28 () Int)
(declare-fun main_~nc_B~0_28 () Int)
(declare-fun main_~found~0_29 () Int)
...
(assert (! (and (= v_ArrVal_61_fresh_1 1) (< |#StackHeapBarrier_-1| |main_~#string_A~0.base_4|) (= main_~i~0_4 0) (= 5 v_ArrVal_63_fresh_1) (= (select |#valid_3| |main_~#string_A~0.base_4|) 0) (= |main_~#string_A~0.offset_4| 0) (= (select (store |#valid_3| |main_~#string_A~0.base_4| v_ArrVal_64_fresh_1) |main_~#string_B~0.base_4|) 0) (not (= |main_~#string_B~0.base_4| 0)) (= |#valid_4| (store (store |#valid_3| |main_~#string_A~0.base_4| v_ArrVal_64_fresh_1) |main_~#string_B~0.base_4| v_ArrVal_61_fresh_1)) (= |main_~#string_B~0.offset_4| 0) (= |#length_4| (store (store |#length_3| |main_~#string_A~0.base_4| v_ArrVal_63_fresh_1) |main_~#string_B~0.base_4| v_ArrVal_62_fresh_1)) (= v_main_~found~0_11_fresh_1 0) (= v_ArrVal_64_fresh_1 1) (not (= |main_~#string_A~0.base_4| 0)) (< |#StackHeapBarrier_-1| |main_~#string_B~0.base_4|) (= 5 v_ArrVal_62_fresh_1)) :named ssa_4))
(assert (! (and (= |v_main_#t~nondet1_15_fresh_1| v_ArrVal_65_fresh_1) (= (store (select |#memory_int#2_3| |main_~#string_A~0.base_4|) (+ main_~i~0_4 |main_~#string_A~0.offset_4|) v_ArrVal_65_fresh_1) v_ArrVal_66_fresh_1) (<= |v_main_#t~nondet1_15_fresh_1| 127) (<= 0 (+ |v_main_#t~nondet1_15_fresh_1| 128)) (= main_~i~0_5 (+ main_~i~0_4 1)) (= (store |#memory_int#2_3| |main_~#string_A~0.base_4| v_ArrVal_66_fresh_1) |#memory_int#2_5|) (< main_~i~0_4 5)) :named ssa_5))
(assert (! (and (= |#memory_int#2_6| (store |#memory_int#2_5| |main_~#string_A~0.base_4| v_ArrVal_68_fresh_1)) (= |v_main_#t~nondet1_16_fresh_1| v_ArrVal_67_fresh_1) (<= |v_main_#t~nondet1_16_fresh_1| 127) (= main_~i~0_6 (+ main_~i~0_5 1)) (<= 0 (+ |v_main_#t~nondet1_16_fresh_1| 128)) (= (store (select |#memory_int#2_5| |main_~#string_A~0.base_4|) (+ main_~i~0_5 |main_~#string_A~0.offset_4|) v_ArrVal_67_fresh_1) v_ArrVal_68_fresh_1) (< main_~i~0_5 5)) :named ssa_6))
(assert (! (and (= |v_main_#t~nondet1_17_fresh_1| v_ArrVal_70_fresh_1) (<= |v_main_#t~nondet1_17_fresh_1| 127) (<= 0 (+ |v_main_#t~nondet1_17_fresh_1| 128)) (= (store (select |#memory_int#2_6| |main_~#string_A~0.base_4|) (+ main_~i~0_6 |main_~#string_A~0.offset_4|) |v_main_#t~nondet1_17_fresh_1|) v_ArrVal_69_fresh_1) (= main_~i~0_7 (+ main_~i~0_6 1)) (< main_~i~0_6 5) (= |#memory_int#2_7| (store |#memory_int#2_6| |main_~#string_A~0.base_4| v_ArrVal_69_fresh_1))) :named ssa_7))
(assert (! (and (= |v_main_#t~nondet1_18_fresh_1| v_ArrVal_72_fresh_1) (= (store |#memory_int#2_7| |main_~#string_A~0.base_4| v_ArrVal_71_fresh_1) |#memory_int#2_8|) (= main_~i~0_8 (+ main_~i~0_7 1)) (<= 0 (+ |v_main_#t~nondet1_18_fresh_1| 128)) (< main_~i~0_7 5) (<= |v_main_#t~nondet1_18_fresh_1| 127) (= (store (select |#memory_int#2_7| |main_~#string_A~0.base_4|) (+ main_~i~0_7 |main_~#string_A~0.offset_4|) |v_main_#t~nondet1_18_fresh_1|) v_ArrVal_71_fresh_1)) :named ssa_8))
(assert (! (and (<= 0 (+ |v_main_#t~nondet1_19_fresh_1| 128)) (= |v_main_#t~nondet1_19_fresh_1| v_ArrVal_74_fresh_1) (<= |v_main_#t~nondet1_19_fresh_1| 127) (= main_~i~0_9 (+ main_~i~0_8 1)) (= (store (select |#memory_int#2_8| |main_~#string_A~0.base_4|) (+ main_~i~0_8 |main_~#string_A~0.offset_4|) |v_main_#t~nondet1_19_fresh_1|) v_ArrVal_73_fresh_1) (< main_~i~0_8 5) (= (store |#memory_int#2_8| |main_~#string_A~0.base_4| v_ArrVal_73_fresh_1) |#memory_int#2_9|)) :named ssa_9))
...
(assert (! (and (= (store |#memory_int#1_3| |main_~#string_B~0.base_4| v_ArrVal_75_fresh_1) |#memory_int#1_13|) (= main_~i~0_13 (+ main_~i~0_12 1)) (= (store (select |#memory_int#1_3| |main_~#string_B~0.base_4|) (+ main_~i~0_12 |main_~#string_B~0.offset_4|) |v_main_#t~nondet4_15_fresh_1|) v_ArrVal_75_fresh_1) (= |v_main_#t~nondet4_15_fresh_1| v_ArrVal_76_fresh_1) (<= |v_main_#t~nondet4_15_fresh_1| 127) (<= 0 (+ |v_main_#t~nondet4_15_fresh_1| 128)) (< main_~i~0_12 5)) :named ssa_13))
(assert (! (and (= main_~i~0_14 (+ main_~i~0_13 1)) (= |v_main_#t~nondet4_16_fresh_1| v_ArrVal_78_fresh_1) (<= |v_main_#t~nondet4_16_fresh_1| 127) (<= 0 (+ |v_main_#t~nondet4_16_fresh_1| 128)) (< main_~i~0_13 5) (= (store |#memory_int#1_13| |main_~#string_B~0.base_4| v_ArrVal_77_fresh_1) |#memory_int#1_14|) (= (store (select |#memory_int#1_13| |main_~#string_B~0.base_4|) (+ main_~i~0_13 |main_~#string_B~0.offset_4|) |v_main_#t~nondet4_16_fresh_1|) v_ArrVal_77_fresh_1)) :named ssa_14))
(assert (! (and (= (store (select |#memory_int#1_14| |main_~#string_B~0.base_4|) (+ main_~i~0_14 |main_~#string_B~0.offset_4|) |v_main_#t~nondet4_17_fresh_1|) v_ArrVal_79_fresh_1) (= |v_main_#t~nondet4_17_fresh_1| v_ArrVal_80_fresh_1) (= main_~i~0_15 (+ main_~i~0_14 1)) (<= 0 (+ |v_main_#t~nondet4_17_fresh_1| 128)) (<= |v_main_#t~nondet4_17_fresh_1| 127) (= (store |#memory_int#1_14| |main_~#string_B~0.base_4| v_ArrVal_79_fresh_1) |#memory_int#1_15|) (< main_~i~0_14 5)) :named ssa_15))
(assert (! (and (= (store (select |#memory_int#1_15| |main_~#string_B~0.base_4|) (+ main_~i~0_15 |main_~#string_B~0.offset_4|) |v_main_#t~nondet4_18_fresh_1|) v_ArrVal_81_fresh_1) (= (store |#memory_int#1_15| |main_~#string_B~0.base_4| v_ArrVal_81_fresh_1) |#memory_int#1_16|) (= main_~i~0_16 (+ main_~i~0_15 1)) (<= 0 (+ |v_main_#t~nondet4_18_fresh_1| 128)) (< main_~i~0_15 5) (<= |v_main_#t~nondet4_18_fresh_1| 127) (= |v_main_#t~nondet4_18_fresh_1| v_ArrVal_82_fresh_1)) :named ssa_16))
(assert (! (and (<= |v_main_#t~nondet4_19_fresh_1| 127) (= main_~i~0_17 (+ main_~i~0_16 1)) (<= 0 (+ |v_main_#t~nondet4_19_fresh_1| 128)) (= (store (select |#memory_int#1_16| |main_~#string_B~0.base_4|) (+ main_~i~0_16 |main_~#string_B~0.offset_4|) v_ArrVal_83_fresh_1) v_ArrVal_84_fresh_1) (= |v_main_#t~nondet4_19_fresh_1| v_ArrVal_83_fresh_1) (< main_~i~0_16 5) (= |#memory_int#1_17| (store |#memory_int#1_16| |main_~#string_B~0.base_4| v_ArrVal_84_fresh_1))) :named ssa_17))
...
(assert (! (= |main_#t~mem9_24| 0) :named ssa_25))
(assert (! (and (= main_~j~0_26 0) (<= main_~nc_A~0_20 main_~nc_B~0_23) (= main_~i~0_26 main_~j~0_26)) :named ssa_26))
(assert (! (or (<= main_~nc_B~0_23 main_~j~0_26) (<= main_~nc_A~0_20 main_~i~0_26)) :named ssa_27))
(assert (! (= main_~found~0_28 (ite (< main_~nc_B~0_23 (+ main_~j~0_26 1)) 1 0)) :named ssa_28))
(assert (! true :named ssa_29_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_29| (ite (or (= main_~found~0_28 0) (= main_~found~0_28 1)) 1 0)) :named ssa_29_LocVarAssigCall))
