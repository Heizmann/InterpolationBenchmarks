...
(set-info :ultimate-id nr4.c_AllErrorsAtOnce_Iteration4)
...
(declare-fun |main_#t~short9_18| () Bool)
...
(assert (! (and (= v_ArrVal_8_fresh_1 1) (= (store |#valid_3| |main_~#volArray~0.base_5| v_ArrVal_8_fresh_1) |#valid_5|) (= (store |#length_3| |main_~#volArray~0.base_5| v_ArrVal_7_fresh_1) |#length_5|) (< |#StackHeapBarrier_-1| |main_~#volArray~0.base_5|) (= |main_~#volArray~0.offset_5| 0) (not (= |main_~#volArray~0.base_5| 0)) (= 0 (select |#valid_3| |main_~#volArray~0.base_5|)) (= main_~MINVAL~0_5 2) (< 1 ~CELLCOUNT~0_4) (= (* (mod ~CELLCOUNT~0_4 1073741824) 4) v_ArrVal_7_fresh_1)) :named ssa_5))
...
(assert (! (< main_~j~0_13 1) :named ssa_14))
...
(assert (! (and (< main_~i~0_17 ~CELLCOUNT~0_4) (or (and (< |v_main_#t~mem7_9_fresh_1| main_~MINVAL~0_5) (not |main_#t~short9_18|)) (and |main_#t~short9_18| (<= main_~MINVAL~0_5 |v_main_#t~mem7_9_fresh_1|))) (= (select (select |#memory_int#1_3| |main_~#volArray~0.base_5|) (+ (* main_~i~0_17 4) |main_~#volArray~0.offset_5|)) |v_main_#t~mem7_9_fresh_1|)) :named ssa_18))
(assert (! (and (= |v_main_#t~mem8_7_fresh_1| (select (select |#memory_int#1_3| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_17 4)))) (not |main_#t~short9_18|) (or (and (= |v_main_#t~mem8_7_fresh_1| 0) |main_#t~short9_19|) (and (not |main_#t~short9_19|) (not (= |v_main_#t~mem8_7_fresh_1| 0))))) :named ssa_19))
(assert (! true :named ssa_20_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_20| (ite |main_#t~short9_19| 1 0)) :named ssa_20_LocVarAssigCall))
