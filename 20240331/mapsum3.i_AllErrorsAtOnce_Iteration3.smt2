...
(set-info :ultimate-id mapsum3.i_AllErrorsAtOnce_Iteration3)
...
(assert (! (and (= (store |#length_3| |main_~#x~0.base_4| v_ArrVal_16_fresh_1) |#length_4|) (< |#StackHeapBarrier_-1| |main_~#x~0.base_4|) (= v_ArrVal_16_fresh_1 40000) (= v_ArrVal_15_fresh_1 1) (= |#valid_4| (store |#valid_3| |main_~#x~0.base_4| v_ArrVal_15_fresh_1)) (not (= |main_~#x~0.base_4| 0)) (= (select |#valid_3| |main_~#x~0.base_4|) 0) (= |main_~#x~0.offset_4| 0) (= main_~i~1_4 0)) :named ssa_4))
(assert (! (and (= (store |#memory_int#1_3| |main_~#x~0.base_4| v_ArrVal_17_fresh_1) |#memory_int#1_5|) (< main_~i~1_4 10000) (<= 0 (+ |v_main_#t~nondet3_8_fresh_1| 2147483648)) (= |v_main_#t~nondet3_8_fresh_1| v_ArrVal_18_fresh_1) (<= |v_main_#t~nondet3_8_fresh_1| 2147483647) (= (store (select |#memory_int#1_3| |main_~#x~0.base_4|) (+ (* main_~i~1_4 4) |main_~#x~0.offset_4|) |v_main_#t~nondet3_8_fresh_1|) v_ArrVal_17_fresh_1) (= main_~i~1_5 (+ main_~i~1_4 1))) :named ssa_5))
(assert (! (<= 10000 main_~i~1_5) :named ssa_6))
...
(assert (! (<= 10000 mapsum_~i~0_9) :named ssa_10))
...
(assert (! (<= 9999 main_~i~2_19) :named ssa_20))
(assert (! (and (= main_~temp~0_19 v_ArrVal_22_fresh_1) (= (store (select |#memory_int#1_13| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 39996) v_ArrVal_22_fresh_1) v_ArrVal_23_fresh_1) (= (store |#memory_int#1_13| |main_~#x~0.base_4| v_ArrVal_23_fresh_1) |#memory_int#1_21|)) :named ssa_21))
