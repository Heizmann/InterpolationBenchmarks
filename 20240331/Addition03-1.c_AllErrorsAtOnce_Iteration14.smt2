...
(set-info :ultimate-id Addition03-1.c_AllErrorsAtOnce_Iteration14)
...
(declare-fun |main_#t~ret8_93| () Int)
...
(declare-fun main_~m~0_95 () Int)
(declare-fun main_~n~0_95 () Int)
...
(assert (! (and (= 0 addition_~n_54) (= |addition_#res_55| addition_~m_54)) :named ssa_55))
...
(assert (! (= |addition_#res_91| |main_#t~ret8_93|) :named ssa_93_return))
(assert (! (and (<= |main_#t~ret8_93| 9223372036854775807) (<= 0 (+ |main_#t~ret8_93| 9223372036854775808)) (= main_~result~0_94 |main_#t~ret8_93|)) :named ssa_94))
(assert (! (and (< main_~result~0_94 200) (<= 100 main_~n~0_4) (<= 100 main_~m~0_4)) :named ssa_95))
(assert (! true :named ssa_96))
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 (and ssa_77 ssa_27 ssa_29_OldVarAssigCall ssa_20 ssa_41_GlobVarAssigCall ssa_17_LocVarAssigCall ssa_21_LocVarAssigCall ssa_64 ssa_5_LocVarAssigCall ssa_31 ssa_5_GlobVarAssigCall ssa_21_OldVarAssigCall ssa_76 ssa_88 ssa_68 ssa_7 ssa_44 ssa_16 ssa_6 ssa_26 ssa_55 ssa_67 ssa_34 ssa_17_GlobVarAssigCall ssa_74 ssa_25_GlobVarAssigCall ssa_40 ssa_10 ssa_14 ssa_25_OldVarAssigCall ssa_8 ssa_13_LocVarAssigCall ssa_63_return ssa_29_GlobVarAssigCall ssa_46 ssa_53_GlobVarAssigCall ssa_89 ssa_47 ssa_93_return ssa_13_OldVarAssigCall ssa_25_LocVarAssigCall ssa_82 ssa_37_LocVarAssigCall ssa_49_LocVarAssigCall ssa_85 ssa_69_return ssa_86 ssa_57_return ssa_58 ssa_33_GlobVarAssigCall ssa_90_return ssa_19 ssa_83 ssa_61 ssa_33_LocVarAssigCall ssa_59 ssa_39 ssa_53_LocVarAssigCall ssa_62 ssa_43 ssa_13_GlobVarAssigCall ssa_41_OldVarAssigCall ssa_17_OldVarAssigCall ssa_38 ssa_79 ssa_12 ssa_32 ssa_5_OldVarAssigCall ssa_50 ssa_60_return ssa_65 ssa_72_return ssa_81_return ssa_41_LocVarAssigCall ssa_11 ssa_48 ssa_53_OldVarAssigCall ssa_66_return ssa_84_return ssa_28 ssa_29_LocVarAssigCall ssa_54 ssa_37_GlobVarAssigCall ssa_22 ssa_51 ssa_36 ssa_15 ssa_80 ssa_45_OldVarAssigCall ssa_45_LocVarAssigCall ssa_78_return ssa_87_return ssa_52 ssa_18 ssa_49_GlobVarAssigCall ssa_23 ssa_91 ssa_30 ssa_70 ssa_9_LocVarAssigCall ssa_92 ssa_56 ssa_9_OldVarAssigCall ssa_35 ssa_75_return ssa_21_GlobVarAssigCall ssa_9_GlobVarAssigCall ssa_33_OldVarAssigCall ssa_45_GlobVarAssigCall ssa_49_OldVarAssigCall ssa_42 ssa_71 ssa_24 ssa_37_OldVarAssigCall ssa_73) ssa_94 ssa_95 (and ssa_96 ssa_postcond))
...
(declare-fun |addition_#t~ret4_85| () Int)
(declare-fun |addition_#res_85| () Int)
(declare-fun |main_#t~ret8_87| () Int)
(declare-fun |addition_#res_87| () Int)
(assert (! true :named ssa_precond))
(assert (! (not (<= main_~n~0_-2 12)) :named ssa_postcond))
...
(assert (! (and (<= 0 (+ 9223372036854775808 |addition_#t~ret4_84|)) (<= |addition_#t~ret4_84| 9223372036854775807) (= |addition_#res_85| |addition_#t~ret4_84|)) :named ssa_85))
(assert (! true :named ssa_86))
(assert (! (= |addition_#res_85| |main_#t~ret8_87|) :named ssa_87_return))
(assert (! true :named ssa_-2_PendingContext))
