...
(set-info :ultimate-id standard_minInArray_ground-2.i_AllErrorsAtOnce_Iteration11)
...
(declare-fun main_~min~0_17 () Int)
...
(assert (! (and (not (= |main_~#a~0.base_4| 0)) (= v_ArrVal_93_fresh_1 1) (= main_~min~0_4 0) (< |#StackHeapBarrier_-1| |main_~#a~0.base_4|) (= |main_~#a~0.offset_4| 0) (= (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_93_fresh_1) |#valid_4|) (= 400000 v_ArrVal_94_fresh_1) (= (store |#length_3| |main_~#a~0.base_4| v_ArrVal_94_fresh_1) |#length_4|) (= (select |#valid_3| |main_~#a~0.base_4|) 0) (= main_~i~0_4 0)) :named ssa_4))
(assert (! (and (<= |v_main_#t~nondet1_44_fresh_1| 2147483647) (= main_~i~0_5 (+ main_~i~0_4 1)) (= (store (select |#memory_int#1_3| |main_~#a~0.base_4|) (+ (* main_~i~0_4 4) |main_~#a~0.offset_4|) v_ArrVal_95_fresh_1) v_ArrVal_96_fresh_1) (= (store |#memory_int#1_3| |main_~#a~0.base_4| v_ArrVal_96_fresh_1) |#memory_int#1_5|) (< main_~i~0_4 100000) (<= 0 (+ |v_main_#t~nondet1_44_fresh_1| 2147483648)) (= |v_main_#t~nondet1_44_fresh_1| v_ArrVal_95_fresh_1)) :named ssa_5))
(assert (! (and (= v_ArrVal_98_fresh_1 (store (select |#memory_int#1_5| |main_~#a~0.base_4|) (+ (* main_~i~0_5 4) |main_~#a~0.offset_4|) v_ArrVal_97_fresh_1)) (= (store |#memory_int#1_5| |main_~#a~0.base_4| v_ArrVal_98_fresh_1) |#memory_int#1_6|) (= main_~i~0_6 (+ main_~i~0_5 1)) (< main_~i~0_5 100000) (= |v_main_#t~nondet1_45_fresh_1| v_ArrVal_97_fresh_1) (<= |v_main_#t~nondet1_45_fresh_1| 2147483647) (<= 0 (+ |v_main_#t~nondet1_45_fresh_1| 2147483648))) :named ssa_6))
(assert (! (and (= (store |#memory_int#1_6| |main_~#a~0.base_4| v_ArrVal_99_fresh_1) |#memory_int#1_7|) (= (store (select |#memory_int#1_6| |main_~#a~0.base_4|) (+ (* main_~i~0_6 4) |main_~#a~0.offset_4|) |v_main_#t~nondet1_46_fresh_1|) v_ArrVal_99_fresh_1) (<= |v_main_#t~nondet1_46_fresh_1| 2147483647) (= main_~i~0_7 (+ main_~i~0_6 1)) (< main_~i~0_6 100000) (<= 0 (+ |v_main_#t~nondet1_46_fresh_1| 2147483648)) (= v_ArrVal_100_fresh_1 |v_main_#t~nondet1_46_fresh_1|)) :named ssa_7))
(assert (! (and (<= 0 (+ |v_main_#t~nondet1_47_fresh_1| 2147483648)) (= main_~i~0_8 (+ main_~i~0_7 1)) (<= |v_main_#t~nondet1_47_fresh_1| 2147483647) (< main_~i~0_7 100000) (= (store |#memory_int#1_7| |main_~#a~0.base_4| v_ArrVal_102_fresh_1) |#memory_int#1_8|) (= v_ArrVal_102_fresh_1 (store (select |#memory_int#1_7| |main_~#a~0.base_4|) (+ (* main_~i~0_7 4) |main_~#a~0.offset_4|) v_ArrVal_101_fresh_1)) (= v_ArrVal_101_fresh_1 |v_main_#t~nondet1_47_fresh_1|)) :named ssa_8))
(assert (! (and (<= 0 (+ |v_main_#t~nondet1_48_fresh_1| 2147483648)) (= v_ArrVal_103_fresh_1 (store (select |#memory_int#1_8| |main_~#a~0.base_4|) (+ (* main_~i~0_8 4) |main_~#a~0.offset_4|) |v_main_#t~nondet1_48_fresh_1|)) (= main_~i~0_9 (+ main_~i~0_8 1)) (= v_ArrVal_104_fresh_1 |v_main_#t~nondet1_48_fresh_1|) (< main_~i~0_8 100000) (<= |v_main_#t~nondet1_48_fresh_1| 2147483647) (= (store |#memory_int#1_8| |main_~#a~0.base_4| v_ArrVal_103_fresh_1) |#memory_int#1_9|)) :named ssa_9))
(assert (! (and (<= 0 (+ |v_main_#t~nondet1_49_fresh_1| 2147483648)) (= v_ArrVal_106_fresh_1 |v_main_#t~nondet1_49_fresh_1|) (= main_~i~0_10 (+ main_~i~0_9 1)) (< main_~i~0_9 100000) (= (store |#memory_int#1_9| |main_~#a~0.base_4| v_ArrVal_105_fresh_1) |#memory_int#1_10|) (= v_ArrVal_105_fresh_1 (store (select |#memory_int#1_9| |main_~#a~0.base_4|) (+ (* main_~i~0_9 4) |main_~#a~0.offset_4|) |v_main_#t~nondet1_49_fresh_1|)) (<= |v_main_#t~nondet1_49_fresh_1| 2147483647)) :named ssa_10))
(assert (! (and (<= |v_main_#t~nondet1_50_fresh_1| 2147483647) (= main_~i~0_11 (+ main_~i~0_10 1)) (= v_ArrVal_107_fresh_1 |v_main_#t~nondet1_50_fresh_1|) (< main_~i~0_10 100000) (= v_ArrVal_108_fresh_1 (store (select |#memory_int#1_10| |main_~#a~0.base_4|) (+ (* main_~i~0_10 4) |main_~#a~0.offset_4|) v_ArrVal_107_fresh_1)) (<= 0 (+ |v_main_#t~nondet1_50_fresh_1| 2147483648)) (= (store |#memory_int#1_10| |main_~#a~0.base_4| v_ArrVal_108_fresh_1) |#memory_int#1_11|)) :named ssa_11))
(assert (! (and (= main_~i~0_12 (+ main_~i~0_11 1)) (<= |v_main_#t~nondet1_51_fresh_1| 2147483647) (<= 0 (+ |v_main_#t~nondet1_51_fresh_1| 2147483648)) (< main_~i~0_11 100000) (= v_ArrVal_109_fresh_1 (store (select |#memory_int#1_11| |main_~#a~0.base_4|) (+ (* main_~i~0_11 4) |main_~#a~0.offset_4|) |v_main_#t~nondet1_51_fresh_1|)) (= v_ArrVal_110_fresh_1 |v_main_#t~nondet1_51_fresh_1|) (= |#memory_int#1_12| (store |#memory_int#1_11| |main_~#a~0.base_4| v_ArrVal_109_fresh_1))) :named ssa_12))
(assert (! (and (= main_~i~0_13 (+ main_~i~0_12 1)) (< main_~i~0_12 100000) (= (store |#memory_int#1_12| |main_~#a~0.base_4| v_ArrVal_111_fresh_1) |#memory_int#1_13|) (= v_ArrVal_112_fresh_1 |v_main_#t~nondet1_52_fresh_1|) (<= 0 (+ |v_main_#t~nondet1_52_fresh_1| 2147483648)) (= v_ArrVal_111_fresh_1 (store (select |#memory_int#1_12| |main_~#a~0.base_4|) (+ (* main_~i~0_12 4) |main_~#a~0.offset_4|) |v_main_#t~nondet1_52_fresh_1|)) (<= |v_main_#t~nondet1_52_fresh_1| 2147483647)) :named ssa_13))
(assert (! (<= 100000 main_~i~0_13) :named ssa_14))
(assert (! (= main_~i~0_15 0) :named ssa_15))
(assert (! (and (= |main_#t~mem3_16| (select (select |#memory_int#1_13| |main_~#a~0.base_4|) (+ (* main_~i~0_15 4) |main_~#a~0.offset_4|))) (< main_~i~0_15 100000)) :named ssa_16))
(assert (! (and (< |main_#t~mem3_16| main_~min~0_4) (= (select (select |#memory_int#1_13| |main_~#a~0.base_4|) (+ (* main_~i~0_15 4) |main_~#a~0.offset_4|)) main_~min~0_17)) :named ssa_17))
(assert (! (= main_~i~0_18 (+ main_~i~0_15 1)) :named ssa_18))
(assert (! (and (= |main_#t~mem3_19| (select (select |#memory_int#1_13| |main_~#a~0.base_4|) (+ (* main_~i~0_18 4) |main_~#a~0.offset_4|))) (< main_~i~0_18 100000)) :named ssa_19))
(assert (! (and (< |main_#t~mem3_19| main_~min~0_17) (= (select (select |#memory_int#1_13| |main_~#a~0.base_4|) (+ (* main_~i~0_18 4) |main_~#a~0.offset_4|)) main_~min~0_20)) :named ssa_20))
(assert (! (= main_~i~0_21 (+ main_~i~0_18 1)) :named ssa_21))
(assert (! (and (= |main_#t~mem3_22| (select (select |#memory_int#1_13| |main_~#a~0.base_4|) (+ (* main_~i~0_21 4) |main_~#a~0.offset_4|))) (< main_~i~0_21 100000)) :named ssa_22))
(assert (! (and (< |main_#t~mem3_22| main_~min~0_20) (= (select (select |#memory_int#1_13| |main_~#a~0.base_4|) (+ (* main_~i~0_21 4) |main_~#a~0.offset_4|)) main_~min~0_23)) :named ssa_23))
(assert (! (= main_~i~0_24 (+ main_~i~0_21 1)) :named ssa_24))
(assert (! (and (= |main_#t~mem3_25| (select (select |#memory_int#1_13| |main_~#a~0.base_4|) (+ (* main_~i~0_24 4) |main_~#a~0.offset_4|))) (< main_~i~0_24 100000)) :named ssa_25))
(assert (! (and (< |main_#t~mem3_25| main_~min~0_23) (= (select (select |#memory_int#1_13| |main_~#a~0.base_4|) (+ (* main_~i~0_24 4) |main_~#a~0.offset_4|)) main_~min~0_26)) :named ssa_26))
(assert (! (= main_~i~0_27 (+ main_~i~0_24 1)) :named ssa_27))
(assert (! (and (= |main_#t~mem3_28| (select (select |#memory_int#1_13| |main_~#a~0.base_4|) (+ (* main_~i~0_27 4) |main_~#a~0.offset_4|))) (< main_~i~0_27 100000)) :named ssa_28))
(assert (! (and (< |main_#t~mem3_28| main_~min~0_26) (= (select (select |#memory_int#1_13| |main_~#a~0.base_4|) (+ (* main_~i~0_27 4) |main_~#a~0.offset_4|)) main_~min~0_29)) :named ssa_29))
(assert (! (= main_~i~0_30 (+ main_~i~0_27 1)) :named ssa_30))
(assert (! (and (= |main_#t~mem3_31| (select (select |#memory_int#1_13| |main_~#a~0.base_4|) (+ (* main_~i~0_30 4) |main_~#a~0.offset_4|))) (< main_~i~0_30 100000)) :named ssa_31))
(assert (! (and (< |main_#t~mem3_31| main_~min~0_29) (= (select (select |#memory_int#1_13| |main_~#a~0.base_4|) (+ (* main_~i~0_30 4) |main_~#a~0.offset_4|)) main_~min~0_32)) :named ssa_32))
(assert (! (= main_~i~0_33 (+ main_~i~0_30 1)) :named ssa_33))
(assert (! (and (= |main_#t~mem3_34| (select (select |#memory_int#1_13| |main_~#a~0.base_4|) (+ (* main_~i~0_33 4) |main_~#a~0.offset_4|))) (< main_~i~0_33 100000)) :named ssa_34))
(assert (! (and (< |main_#t~mem3_34| main_~min~0_32) (= (select (select |#memory_int#1_13| |main_~#a~0.base_4|) (+ (* main_~i~0_33 4) |main_~#a~0.offset_4|)) main_~min~0_35)) :named ssa_35))
(assert (! (= main_~i~0_36 (+ main_~i~0_33 1)) :named ssa_36))
(assert (! (and (= |main_#t~mem3_37| (select (select |#memory_int#1_13| |main_~#a~0.base_4|) (+ (* main_~i~0_36 4) |main_~#a~0.offset_4|))) (< main_~i~0_36 100000)) :named ssa_37))
(assert (! (and (< |main_#t~mem3_37| main_~min~0_35) (= (select (select |#memory_int#1_13| |main_~#a~0.base_4|) (+ (* main_~i~0_36 4) |main_~#a~0.offset_4|)) main_~min~0_38)) :named ssa_38))
(assert (! (= main_~i~0_39 (+ main_~i~0_36 1)) :named ssa_39))
(assert (! (and (= |main_#t~mem3_40| (select (select |#memory_int#1_13| |main_~#a~0.base_4|) (+ (* main_~i~0_39 4) |main_~#a~0.offset_4|))) (< main_~i~0_39 100000)) :named ssa_40))
(assert (! (and (< |main_#t~mem3_40| main_~min~0_38) (= (select (select |#memory_int#1_13| |main_~#a~0.base_4|) (+ (* main_~i~0_39 4) |main_~#a~0.offset_4|)) main_~min~0_41)) :named ssa_41))
(assert (! (= main_~i~0_42 (+ main_~i~0_39 1)) :named ssa_42))
(assert (! (<= 100000 main_~i~0_42) :named ssa_43))
(assert (! (= main_~x~0_44 0) :named ssa_44))
(assert (! (and (< main_~x~0_44 100000) (= |main_#t~mem5_45| (select (select |#memory_int#1_13| |main_~#a~0.base_4|) (+ (* main_~x~0_44 4) |main_~#a~0.offset_4|)))) :named ssa_45))
(assert (! true :named ssa_46_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_46| (ite (<= main_~min~0_41 |main_#t~mem5_45|) 1 0)) :named ssa_46_LocVarAssigCall))
