...
(set-info :ultimate-id nr4.c_AllErrorsAtOnce_Iteration7)
...
(declare-fun |main_#t~short9_26| () Bool)
...
(assert (! (and (= v_ArrVal_20_fresh_1 1) (= |#length_5| (store |#length_3| |main_~#volArray~0.base_5| v_ArrVal_19_fresh_1)) (< |#StackHeapBarrier_-1| |main_~#volArray~0.base_5|) (= |main_~#volArray~0.offset_5| 0) (= (* (mod ~CELLCOUNT~0_4 1073741824) 4) v_ArrVal_19_fresh_1) (not (= |main_~#volArray~0.base_5| 0)) (= 0 (select |#valid_3| |main_~#volArray~0.base_5|)) (= main_~MINVAL~0_5 2) (= (store |#valid_3| |main_~#volArray~0.base_5| v_ArrVal_20_fresh_1) |#valid_5|) (< 1 ~CELLCOUNT~0_4)) :named ssa_5))
...
(assert (! (and (= (store (select |#memory_int#1_3| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~j~0_13 (- 4)) (* main_~i~0_12 16)) main_~j~0_13) v_ArrVal_21_fresh_1) (= (store |#memory_int#1_3| |main_~#volArray~0.base_5| v_ArrVal_21_fresh_1) |#memory_int#1_15|) (= main_~j~0_13 v_ArrVal_22_fresh_1) (<= main_~MINVAL~0_5 main_~j~0_13)) :named ssa_15))
(assert (! (= main_~j~0_13 (+ main_~j~0_16 1)) :named ssa_16))
(assert (! (<= 1 main_~j~0_16) :named ssa_17))
(assert (! (and (< main_~j~0_16 main_~MINVAL~0_5) (= (store (select |#memory_int#1_15| |main_~#volArray~0.base_5|) (+ (* main_~i~0_12 16) |main_~#volArray~0.offset_5| (* main_~j~0_16 (- 4))) v_ArrVal_23_fresh_1) v_ArrVal_24_fresh_1) (= v_ArrVal_23_fresh_1 0) (= (store |#memory_int#1_15| |main_~#volArray~0.base_5| v_ArrVal_24_fresh_1) |#memory_int#1_18|)) :named ssa_18))
(assert (! (= main_~j~0_16 (+ main_~j~0_19 1)) :named ssa_19))
(assert (! (< main_~j~0_19 1) :named ssa_20))
(assert (! (= main_~i~0_21 (+ main_~i~0_12 1)) :named ssa_21))
(assert (! (< (ite (and (not (= (mod ~CELLCOUNT~0_4 4) 0)) (< ~CELLCOUNT~0_4 0)) (+ (div ~CELLCOUNT~0_4 4) 1) (div ~CELLCOUNT~0_4 4)) main_~i~0_21) :named ssa_22))
(assert (! (= main_~i~0_23 0) :named ssa_23))
(assert (! (and (< main_~i~0_23 ~CELLCOUNT~0_4) (= (select (select |#memory_int#1_18| |main_~#volArray~0.base_5|) (+ (* main_~i~0_23 4) |main_~#volArray~0.offset_5|)) |v_main_#t~mem7_12_fresh_1|) (or (and |main_#t~short9_24| (<= main_~MINVAL~0_5 |v_main_#t~mem7_12_fresh_1|)) (and (< |v_main_#t~mem7_12_fresh_1| main_~MINVAL~0_5) (not |main_#t~short9_24|)))) :named ssa_24))
(assert (! (and (= |v_main_#t~mem8_10_fresh_1| (select (select |#memory_int#1_18| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_23 4)))) (or (and (not |main_#t~short9_25|) (not (= |v_main_#t~mem8_10_fresh_1| 0))) (and |main_#t~short9_25| (= |v_main_#t~mem8_10_fresh_1| 0))) (not |main_#t~short9_24|)) :named ssa_25))
(assert (! true :named ssa_26_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_26| (ite |main_#t~short9_25| 1 0)) :named ssa_26_LocVarAssigCall))
