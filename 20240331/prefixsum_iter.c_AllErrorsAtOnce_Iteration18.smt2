...
(set-info :ultimate-id prefixsum_iter.c_AllErrorsAtOnce_Iteration18)
...
(declare-fun |v_#Ultimate.meminit_#amountOfFieldsInParam_39_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#sizeOfFieldsInParam_39_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#productInParam_39_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#ptr.offsetInParam_39_fresh_1| () Int)
...
(declare-fun |v_#Ultimate.meminit_#ptr.offsetInParam_40_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#productInParam_40_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#sizeOfFieldsInParam_40_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#amountOfFieldsInParam_40_fresh_1| () Int)
...
(declare-fun downsweep_~space_48 () Int)
(declare-fun downsweep_~space_49 () Int)
(declare-fun |check_#in~a.offset_52| () Int)
(declare-fun main_~a0~0.offset_52 () Int)
(declare-fun |check_#in~a.base_52| () Int)
(declare-fun main_~a~0.base_52 () Int)
(declare-fun main_~n~0_52 () Int)
(declare-fun main_~a~0.offset_52 () Int)
(declare-fun |check_#in~a0.base_52| () Int)
(declare-fun |check_#in~n_52| () Int)
(declare-fun main_~a0~0.base_52 () Int)
(declare-fun |check_#in~a0.offset_52| () Int)
(declare-fun check_~a0.base_53 () Int)
(declare-fun check_~a.base_53 () Int)
(declare-fun check_~a.offset_53 () Int)
(declare-fun check_~i~0_53 () Int)
(declare-fun check_~sum~0_53 () Int)
(declare-fun check_~a0.offset_53 () Int)
(declare-fun check_~n_53 () Int)
(declare-fun |check_#t~mem10_54| () Int)
...
(declare-fun check_~i~0_60 () Int)
(declare-fun |check_#t~mem11_60| () Int)
(declare-fun check_~sum~0_60 () Int)
(declare-fun |check_#t~post12_60| () Int)
...
(assert (! (and (= (store |#valid_3| |main_#t~malloc15.base_21| v_ArrVal_391_fresh_1) |#valid_21|) (not (= |main_#t~malloc15.base_21| 0)) (= v_ArrVal_392_fresh_1 (* (mod main_~n~0_4 1073741824) 4)) (< |main_#t~malloc15.base_21| |#StackHeapBarrier_-1|) (= |main_#t~malloc15.offset_21| 0) (= |#length_21| (store |#length_3| |main_#t~malloc15.base_21| v_ArrVal_392_fresh_1)) (= v_ArrVal_391_fresh_1 1) (= (select |#valid_3| |main_#t~malloc15.base_21|) 0)) :named ssa_21))
(assert (! (= |old(#memory_int#1)_22| |#memory_int#1_22|) :named ssa_22_GlobVarAssigCall))
(assert (! (and (= |#Ultimate.meminit_#ptr.base_22| |main_#t~malloc15.base_21|) (= |v_#Ultimate.meminit_#ptr.offsetInParam_39_fresh_1| |main_#t~malloc15.offset_21|) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_39_fresh_1|) (= (* main_~n~0_4 4) |v_#Ultimate.meminit_#productInParam_39_fresh_1|) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_39_fresh_1| 4)) :named ssa_22_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_22| |#memory_int#1_3|) :named ssa_22_OldVarAssigCall))
(assert (! (and (= |#memory_int#1_23| (store |#memory_int#1_22| |#Ultimate.meminit_#ptr.base_22| v_ArrVal_393_fresh_1)) (= ((as const (Array Int Int)) 0) v_ArrVal_393_fresh_1)) :named ssa_23))
(assert (! true :named ssa_24_return))
(assert (! (and (= (select |#valid_21| |main_#t~malloc16.base_25|) 0) (= v_ArrVal_394_fresh_1 1) (not (= |main_#t~malloc16.base_25| 0)) (= v_ArrVal_395_fresh_1 (* (mod main_~n~0_4 1073741824) 4)) (= (store |#length_21| |main_#t~malloc16.base_25| v_ArrVal_395_fresh_1) |#length_25|) (= |main_#t~malloc16.offset_25| 0) (= main_~a~0.offset_25 |main_#t~malloc15.offset_21|) (= main_~a~0.base_25 |main_#t~malloc15.base_21|) (< |main_#t~malloc16.base_25| |#StackHeapBarrier_-1|) (= |#valid_25| (store |#valid_21| |main_#t~malloc16.base_25| v_ArrVal_394_fresh_1))) :named ssa_25))
(assert (! (= |old(#memory_int#1)_26| |#memory_int#1_26|) :named ssa_26_GlobVarAssigCall))
(assert (! (and (= (* main_~n~0_4 4) |v_#Ultimate.meminit_#productInParam_40_fresh_1|) (= |v_#Ultimate.meminit_#ptr.offsetInParam_40_fresh_1| |main_#t~malloc16.offset_25|) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_40_fresh_1| 4) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_40_fresh_1|) (= |#Ultimate.meminit_#ptr.base_26| |main_#t~malloc16.base_25|)) :named ssa_26_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_26| |#memory_int#1_23|) :named ssa_26_OldVarAssigCall))
(assert (! (and (= |#memory_int#1_27| (store |#memory_int#1_26| |#Ultimate.meminit_#ptr.base_26| v_ArrVal_396_fresh_1)) (= ((as const (Array Int Int)) 0) v_ArrVal_396_fresh_1)) :named ssa_27))
...
(assert (! (and (< main_~i~1_29 main_~n~0_4) (= v_ArrVal_398_fresh_1 (store (select |#memory_int#1_27| main_~a0~0.base_29) (+ main_~a0~0.offset_29 (* main_~i~1_29 4)) v_ArrVal_397_fresh_1)) (= v_ArrVal_397_fresh_1 (select (select |#memory_int#1_27| main_~a~0.base_25) (+ main_~a~0.offset_25 (* main_~i~1_29 4)))) (= (store |#memory_int#1_27| main_~a0~0.base_29 v_ArrVal_398_fresh_1) |#memory_int#1_30|) (= main_~i~1_30 (+ main_~i~1_29 1))) :named ssa_30))
(assert (! (and (< main_~i~1_30 main_~n~0_4) (= v_ArrVal_399_fresh_1 (select (select |#memory_int#1_30| main_~a~0.base_25) (+ main_~a~0.offset_25 (* main_~i~1_30 4)))) (= (store |#memory_int#1_30| main_~a0~0.base_29 v_ArrVal_400_fresh_1) |#memory_int#1_31|) (= v_ArrVal_400_fresh_1 (store (select |#memory_int#1_30| main_~a0~0.base_29) (+ main_~a0~0.offset_29 (* main_~i~1_30 4)) v_ArrVal_399_fresh_1)) (= main_~i~1_31 (+ main_~i~1_30 1))) :named ssa_31))
...
(assert (! (and (= |#memory_int#1_36| (store |#memory_int#1_33| upsweep_~a.base_34 v_ArrVal_401_fresh_1)) (< upsweep_~left~0_35 upsweep_~n_34) (= (store (select |#memory_int#1_33| upsweep_~a.base_34) (+ (* upsweep_~left~0_35 4) upsweep_~a.offset_34 (* upsweep_~space~0_34 4)) (+ (select (select |#memory_int#1_33| upsweep_~a.base_34) (+ (* upsweep_~left~0_35 4) upsweep_~a.offset_34)) (select (select |#memory_int#1_33| upsweep_~a.base_34) (+ (* upsweep_~left~0_35 4) upsweep_~a.offset_34 (* upsweep_~space~0_34 4))))) v_ArrVal_401_fresh_1) (= (+ (* 2 upsweep_~space~0_34) upsweep_~left~0_35) upsweep_~left~0_36) (= v_ArrVal_402_fresh_1 (+ (select (select |#memory_int#1_33| upsweep_~a.base_34) (+ (* upsweep_~left~0_35 4) upsweep_~a.offset_34)) (select (select |#memory_int#1_33| upsweep_~a.base_34) (+ (* upsweep_~left~0_35 4) upsweep_~a.offset_34 (* upsweep_~space~0_34 4)))))) :named ssa_36))
...
(assert (! (and (= downsweep_~space_44 (ite (and (not (= (mod |downsweep_#in~space_43| 2) 0)) (< |downsweep_#in~space_43| 0)) (+ (div |downsweep_#in~space_43| 2) 1) (div |downsweep_#in~space_43| 2))) (= downsweep_~a.base_44 |downsweep_#in~a.base_43|) (= v_ArrVal_403_fresh_1 0) (= downsweep_~a.offset_44 |downsweep_#in~a.offset_43|) (= downsweep_~n_44 |downsweep_#in~n_43|) (= v_ArrVal_404_fresh_1 (store (select |#memory_int#1_43| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (- 4) (* downsweep_~n_44 4)) v_ArrVal_403_fresh_1)) (= |#memory_int#1_44| (store |#memory_int#1_43| downsweep_~a.base_44 v_ArrVal_404_fresh_1))) :named ssa_44))
(assert (! (and (< 0 downsweep_~space_44) (= (+ downsweep_~right~1_45 1) (* 2 downsweep_~space_44))) :named ssa_45))
(assert (! (and (= v_ArrVal_407_fresh_1 (select (select |#memory_int#1_44| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (* downsweep_~right~1_45 4)))) (< downsweep_~right~1_45 downsweep_~n_44) (= v_ArrVal_405_fresh_1 (store (store (select |#memory_int#1_44| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (* downsweep_~right~1_45 4)) (+ (select (select |#memory_int#1_44| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (* downsweep_~right~1_45 4))) (select (select |#memory_int#1_44| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (* downsweep_~right~1_45 4) (* downsweep_~space_44 (- 4)))))) (+ downsweep_~a.offset_44 (* downsweep_~right~1_45 4) (* downsweep_~space_44 (- 4))) (select (select |#memory_int#1_44| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (* downsweep_~right~1_45 4))))) (= (store |#memory_int#1_44| downsweep_~a.base_44 v_ArrVal_405_fresh_1) |#memory_int#1_46|) (= downsweep_~right~1_46 (+ (* 2 downsweep_~space_44) downsweep_~right~1_45)) (= v_ArrVal_406_fresh_1 (+ (select (select |#memory_int#1_44| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (* downsweep_~right~1_45 4))) (select (select |#memory_int#1_44| downsweep_~a.base_44) (+ downsweep_~a.offset_44 (* downsweep_~right~1_45 4) (* downsweep_~space_44 (- 4))))))) :named ssa_46))
(assert (! (<= downsweep_~n_44 downsweep_~right~1_46) :named ssa_47))
(assert (! (= downsweep_~space_48 (ite (and (< downsweep_~space_44 0) (not (= (mod downsweep_~space_44 2) 0))) (+ (div downsweep_~space_44 2) 1) (div downsweep_~space_44 2))) :named ssa_48))
(assert (! (<= downsweep_~space_48 0) :named ssa_49))
(assert (! true :named ssa_50))
(assert (! true :named ssa_51_return))
(assert (! true :named ssa_52_GlobVarAssigCall))
(assert (! (and (= main_~a0~0.offset_29 |check_#in~a0.offset_52|) (= main_~a0~0.base_29 |check_#in~a0.base_52|) (= |check_#in~a.offset_52| main_~a~0.offset_25) (= main_~n~0_4 |check_#in~n_52|) (= |check_#in~a.base_52| main_~a~0.base_25)) :named ssa_52_LocVarAssigCall))
(assert (! true :named ssa_52_OldVarAssigCall))
(assert (! (and (= |check_#in~a.offset_52| check_~a.offset_53) (= |check_#in~a0.offset_52| check_~a0.offset_53) (= check_~a.base_53 |check_#in~a.base_52|) (= check_~i~0_53 0) (= check_~a0.base_53 |check_#in~a0.base_52|) (= check_~sum~0_53 0) (= check_~n_53 |check_#in~n_52|)) :named ssa_53))
(assert (! (and (= |check_#t~mem10_54| (select (select |#memory_int#1_46| check_~a.base_53) (+ (* check_~i~0_53 4) check_~a.offset_53))) (< check_~i~0_53 check_~n_53)) :named ssa_54))
(assert (! true :named ssa_55_GlobVarAssigCall))
(assert (! (= (ite (= check_~sum~0_53 |check_#t~mem10_54|) 1 0) |__VERIFIER_assert_#in~cond_55|) :named ssa_55_LocVarAssigCall))
...
(assert (! (and (= (+ check_~sum~0_53 (select (select |#memory_int#1_46| check_~a0.base_53) (+ (* check_~i~0_53 4) check_~a0.offset_53))) check_~sum~0_60) (= (+ check_~i~0_53 1) check_~i~0_60)) :named ssa_60))
(assert (! (and (= |check_#t~mem10_61| (select (select |#memory_int#1_46| check_~a.base_53) (+ (* check_~i~0_60 4) check_~a.offset_53))) (< check_~i~0_60 check_~n_53)) :named ssa_61))
(assert (! true :named ssa_62_GlobVarAssigCall))
(assert (! (= (ite (= check_~sum~0_60 |check_#t~mem10_61|) 1 0) |__VERIFIER_assert_#in~cond_62|) :named ssa_62_LocVarAssigCall))
...
(assert (! true :named ssa_precond))
(assert (! (not (not (= main_~n~0_-2 2))) :named ssa_postcond))
...
(assert (! true :named ssa_2))
(assert (! true :named ssa_3_return))
(assert (! (not (= main_~n~0_-2 2)) :named ssa_-2_PendingContext))
...
(assert (! (not (not (= main_~n~0_-2 2))) :named ssa_postcond))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_408_fresh_1) (= |#memory_int#1_0| (store |#memory_int#1_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_408_fresh_1))) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! (not (= main_~n~0_-2 2)) :named ssa_-2_PendingContext))
...
(assert (! (= |#memory_int#1_-1| |old(#memory_int#1)_-1|) :named ssa_precond))
(assert (! (not (not (= main_~n~0_-2 2))) :named ssa_postcond))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_409_fresh_1) (= |#memory_int#1_0| (store |#memory_int#1_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_409_fresh_1))) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! (not (= main_~n~0_-2 2)) :named ssa_-2_PendingContext))
...
(assert (! (and (= |#memory_int#1_2| (store |#memory_int#1_-1| upsweep_~a.base_0 v_ArrVal_410_fresh_1)) (= (store (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0 (* upsweep_~space~0_0 4)) (+ (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0)) (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0 (* upsweep_~space~0_0 4))))) v_ArrVal_410_fresh_1) (< upsweep_~left~0_1 upsweep_~n_0) (= (+ (* 2 upsweep_~space~0_0) upsweep_~left~0_1) upsweep_~left~0_2) (= v_ArrVal_411_fresh_1 (+ (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0)) (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0 (* upsweep_~space~0_0 4)))))) :named ssa_2))
...
(assert (! (= |#memory_int#1_-1| |old(#memory_int#1)_-1|) :named ssa_precond))
(assert (! (not false) :named ssa_postcond))
(assert (! (and (= downsweep_~space_0 (ite (and (not (= (mod |downsweep_#in~space_-1| 2) 0)) (< |downsweep_#in~space_-1| 0)) (+ (div |downsweep_#in~space_-1| 2) 1) (div |downsweep_#in~space_-1| 2))) (= downsweep_~a.base_0 |downsweep_#in~a.base_-1|) (= downsweep_~a.offset_0 |downsweep_#in~a.offset_-1|) (= v_ArrVal_413_fresh_1 (store (select |#memory_int#1_-1| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (- 4) (* downsweep_~n_0 4)) v_ArrVal_412_fresh_1)) (= v_ArrVal_412_fresh_1 0) (= (store |#memory_int#1_-1| downsweep_~a.base_0 v_ArrVal_413_fresh_1) |#memory_int#1_0|) (= downsweep_~n_0 |downsweep_#in~n_-1|)) :named ssa_0))
(assert (! (and (< 0 downsweep_~space_0) (= (+ downsweep_~right~1_1 1) (* 2 downsweep_~space_0))) :named ssa_1))
(assert (! (and (< downsweep_~right~1_1 downsweep_~n_0) (= v_ArrVal_414_fresh_1 (store (store (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4)) (+ (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4))) (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4) (* downsweep_~space_0 (- 4)))))) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4) (* downsweep_~space_0 (- 4))) (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4))))) (= (store |#memory_int#1_0| downsweep_~a.base_0 v_ArrVal_414_fresh_1) |#memory_int#1_2|) (= v_ArrVal_416_fresh_1 (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4)))) (= downsweep_~right~1_2 (+ (* 2 downsweep_~space_0) downsweep_~right~1_1)) (= v_ArrVal_415_fresh_1 (+ (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4))) (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4) (* downsweep_~space_0 (- 4))))))) :named ssa_2))
