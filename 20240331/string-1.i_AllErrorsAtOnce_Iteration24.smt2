...
(set-info :ultimate-id string-1.i_AllErrorsAtOnce_Iteration24)
...
(declare-fun v_main_~found~0_29_fresh_1 () Int)
...
(declare-fun |v_main_#t~nondet1_105_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet1_106_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet1_107_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet1_108_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet1_109_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_105_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_106_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_107_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_108_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_109_fresh_1| () Int)
...
(assert (! (and (< |#StackHeapBarrier_-1| |main_~#string_A~0.base_4|) (= v_ArrVal_494_fresh_1 5) (= v_ArrVal_496_fresh_1 1) (= (store (store |#length_3| |main_~#string_A~0.base_4| v_ArrVal_495_fresh_1) |main_~#string_B~0.base_4| v_ArrVal_494_fresh_1) |#length_4|) (= main_~i~0_4 0) (= (select (store |#valid_3| |main_~#string_A~0.base_4| v_ArrVal_496_fresh_1) |main_~#string_B~0.base_4|) 0) (= (select |#valid_3| |main_~#string_A~0.base_4|) 0) (= |main_~#string_A~0.offset_4| 0) (not (= |main_~#string_B~0.base_4| 0)) (= v_ArrVal_493_fresh_1 1) (= |main_~#string_B~0.offset_4| 0) (= v_ArrVal_495_fresh_1 5) (= v_main_~found~0_29_fresh_1 0) (not (= |main_~#string_A~0.base_4| 0)) (= |#valid_4| (store (store |#valid_3| |main_~#string_A~0.base_4| v_ArrVal_496_fresh_1) |main_~#string_B~0.base_4| v_ArrVal_493_fresh_1)) (< |#StackHeapBarrier_-1| |main_~#string_B~0.base_4|)) :named ssa_4))
(assert (! (and (<= |v_main_#t~nondet1_105_fresh_1| 127) (<= 0 (+ |v_main_#t~nondet1_105_fresh_1| 128)) (= v_ArrVal_498_fresh_1 (store (select |#memory_int#2_3| |main_~#string_A~0.base_4|) (+ main_~i~0_4 |main_~#string_A~0.offset_4|) v_ArrVal_497_fresh_1)) (= v_ArrVal_497_fresh_1 |v_main_#t~nondet1_105_fresh_1|) (= main_~i~0_5 (+ main_~i~0_4 1)) (< main_~i~0_4 5) (= (store |#memory_int#2_3| |main_~#string_A~0.base_4| v_ArrVal_498_fresh_1) |#memory_int#2_5|)) :named ssa_5))
(assert (! (and (= (store |#memory_int#2_5| |main_~#string_A~0.base_4| v_ArrVal_499_fresh_1) |#memory_int#2_6|) (<= 0 (+ |v_main_#t~nondet1_106_fresh_1| 128)) (= main_~i~0_6 (+ main_~i~0_5 1)) (<= |v_main_#t~nondet1_106_fresh_1| 127) (= v_ArrVal_499_fresh_1 (store (select |#memory_int#2_5| |main_~#string_A~0.base_4|) (+ main_~i~0_5 |main_~#string_A~0.offset_4|) |v_main_#t~nondet1_106_fresh_1|)) (< main_~i~0_5 5) (= v_ArrVal_500_fresh_1 |v_main_#t~nondet1_106_fresh_1|)) :named ssa_6))
(assert (! (and (= |#memory_int#2_7| (store |#memory_int#2_6| |main_~#string_A~0.base_4| v_ArrVal_501_fresh_1)) (= v_ArrVal_501_fresh_1 (store (select |#memory_int#2_6| |main_~#string_A~0.base_4|) (+ main_~i~0_6 |main_~#string_A~0.offset_4|) |v_main_#t~nondet1_107_fresh_1|)) (<= 0 (+ |v_main_#t~nondet1_107_fresh_1| 128)) (= main_~i~0_7 (+ main_~i~0_6 1)) (<= |v_main_#t~nondet1_107_fresh_1| 127) (= v_ArrVal_502_fresh_1 |v_main_#t~nondet1_107_fresh_1|) (< main_~i~0_6 5)) :named ssa_7))
(assert (! (and (= v_ArrVal_503_fresh_1 |v_main_#t~nondet1_108_fresh_1|) (<= |v_main_#t~nondet1_108_fresh_1| 127) (<= 0 (+ |v_main_#t~nondet1_108_fresh_1| 128)) (= (store |#memory_int#2_7| |main_~#string_A~0.base_4| v_ArrVal_504_fresh_1) |#memory_int#2_8|) (= main_~i~0_8 (+ main_~i~0_7 1)) (= v_ArrVal_504_fresh_1 (store (select |#memory_int#2_7| |main_~#string_A~0.base_4|) (+ main_~i~0_7 |main_~#string_A~0.offset_4|) v_ArrVal_503_fresh_1)) (< main_~i~0_7 5)) :named ssa_8))
(assert (! (and (= (store |#memory_int#2_8| |main_~#string_A~0.base_4| v_ArrVal_506_fresh_1) |#memory_int#2_9|) (<= 0 (+ |v_main_#t~nondet1_109_fresh_1| 128)) (= main_~i~0_9 (+ main_~i~0_8 1)) (= (store (select |#memory_int#2_8| |main_~#string_A~0.base_4|) (+ main_~i~0_8 |main_~#string_A~0.offset_4|) v_ArrVal_505_fresh_1) v_ArrVal_506_fresh_1) (<= |v_main_#t~nondet1_109_fresh_1| 127) (= v_ArrVal_505_fresh_1 |v_main_#t~nondet1_109_fresh_1|) (< main_~i~0_8 5)) :named ssa_9))
...
(assert (! (and (= main_~i~0_13 (+ main_~i~0_12 1)) (= (store |#memory_int#1_3| |main_~#string_B~0.base_4| v_ArrVal_508_fresh_1) |#memory_int#1_13|) (<= 0 (+ |v_main_#t~nondet4_105_fresh_1| 128)) (= v_ArrVal_508_fresh_1 (store (select |#memory_int#1_3| |main_~#string_B~0.base_4|) (+ main_~i~0_12 |main_~#string_B~0.offset_4|) v_ArrVal_507_fresh_1)) (<= |v_main_#t~nondet4_105_fresh_1| 127) (< main_~i~0_12 5) (= v_ArrVal_507_fresh_1 |v_main_#t~nondet4_105_fresh_1|)) :named ssa_13))
(assert (! (and (= v_ArrVal_509_fresh_1 |v_main_#t~nondet4_106_fresh_1|) (= v_ArrVal_510_fresh_1 (store (select |#memory_int#1_13| |main_~#string_B~0.base_4|) (+ main_~i~0_13 |main_~#string_B~0.offset_4|) v_ArrVal_509_fresh_1)) (= main_~i~0_14 (+ main_~i~0_13 1)) (= (store |#memory_int#1_13| |main_~#string_B~0.base_4| v_ArrVal_510_fresh_1) |#memory_int#1_14|) (<= 0 (+ |v_main_#t~nondet4_106_fresh_1| 128)) (< main_~i~0_13 5) (<= |v_main_#t~nondet4_106_fresh_1| 127)) :named ssa_14))
(assert (! (and (= |#memory_int#1_15| (store |#memory_int#1_14| |main_~#string_B~0.base_4| v_ArrVal_511_fresh_1)) (= main_~i~0_15 (+ main_~i~0_14 1)) (<= 0 (+ |v_main_#t~nondet4_107_fresh_1| 128)) (<= |v_main_#t~nondet4_107_fresh_1| 127) (< main_~i~0_14 5) (= v_ArrVal_512_fresh_1 |v_main_#t~nondet4_107_fresh_1|) (= v_ArrVal_511_fresh_1 (store (select |#memory_int#1_14| |main_~#string_B~0.base_4|) (+ main_~i~0_14 |main_~#string_B~0.offset_4|) |v_main_#t~nondet4_107_fresh_1|))) :named ssa_15))
(assert (! (and (<= |v_main_#t~nondet4_108_fresh_1| 127) (= main_~i~0_16 (+ main_~i~0_15 1)) (= v_ArrVal_514_fresh_1 |v_main_#t~nondet4_108_fresh_1|) (<= 0 (+ |v_main_#t~nondet4_108_fresh_1| 128)) (< main_~i~0_15 5) (= v_ArrVal_513_fresh_1 (store (select |#memory_int#1_15| |main_~#string_B~0.base_4|) (+ main_~i~0_15 |main_~#string_B~0.offset_4|) |v_main_#t~nondet4_108_fresh_1|)) (= (store |#memory_int#1_15| |main_~#string_B~0.base_4| v_ArrVal_513_fresh_1) |#memory_int#1_16|)) :named ssa_16))
(assert (! (and (<= |v_main_#t~nondet4_109_fresh_1| 127) (= main_~i~0_17 (+ main_~i~0_16 1)) (= v_ArrVal_515_fresh_1 (store (select |#memory_int#1_16| |main_~#string_B~0.base_4|) (+ main_~i~0_16 |main_~#string_B~0.offset_4|) |v_main_#t~nondet4_109_fresh_1|)) (= (store |#memory_int#1_16| |main_~#string_B~0.base_4| v_ArrVal_515_fresh_1) |#memory_int#1_17|) (<= 0 (+ |v_main_#t~nondet4_109_fresh_1| 128)) (< main_~i~0_16 5) (= v_ArrVal_516_fresh_1 |v_main_#t~nondet4_109_fresh_1|)) :named ssa_17))
...
(assert (! (and (= main_~nc_A~0_22 (+ |v_main_#t~post8_35_fresh_1| 1)) (= |v_main_#t~post8_35_fresh_1| main_~nc_A~0_20) (not (= |main_#t~mem7_21| 0))) :named ssa_22))
...
(assert (! (and (= main_~nc_A~0_24 (+ |v_main_#t~post8_36_fresh_1| 1)) (not (= |main_#t~mem7_23| 0)) (= |v_main_#t~post8_36_fresh_1| main_~nc_A~0_22)) :named ssa_24))
...
(assert (! (and (= (+ |v_main_#t~post8_37_fresh_1| 1) main_~nc_A~0_26) (= |v_main_#t~post8_37_fresh_1| main_~nc_A~0_24) (not (= |main_#t~mem7_25| 0))) :named ssa_26))
...
(assert (! (and (= (+ |v_main_#t~post10_39_fresh_1| 1) main_~nc_B~0_31) (not (= |main_#t~mem9_30| 0)) (= |v_main_#t~post10_39_fresh_1| main_~nc_B~0_29)) :named ssa_31))
...
(assert (! (and (= (+ |v_main_#t~post10_40_fresh_1| 1) main_~nc_B~0_33) (not (= |main_#t~mem9_32| 0)) (= |v_main_#t~post10_40_fresh_1| main_~nc_B~0_31)) :named ssa_33))
...
(assert (! (and (= main_~nc_B~0_35 (+ |v_main_#t~post10_41_fresh_1| 1)) (= |v_main_#t~post10_41_fresh_1| main_~nc_B~0_33) (not (= |main_#t~mem9_34| 0))) :named ssa_35))
...
(assert (! (or (<= main_~nc_B~0_35 main_~j~0_48) (<= main_~nc_A~0_26 main_~i~0_48)) :named ssa_49))
(assert (! (= main_~found~0_50 (ite (< main_~nc_B~0_35 (+ main_~j~0_48 1)) 1 0)) :named ssa_50))
