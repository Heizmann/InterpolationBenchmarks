...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration41)
...
(assert (! (<= 1000000 main_~i~0_44) :named ssa_45))
(assert (! true :named ssa_46_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_46| (ite (= main_~i~0_44 1000000) 1 0)) :named ssa_46_LocVarAssigCall))
