...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:11:25+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id watermelon.c_AllErrorsAtOnce_Iteration21)
...
(declare-fun v_main_~is_divisible1~0_26_fresh_1 () Int)
(declare-fun v_main_~is_divisible2~0_26_fresh_1 () Int)
...
(declare-fun student_version_~w_29 () Int)
(declare-fun student_version_~i~1_30 () Int)
(declare-fun |student_version_#res_31| () Int)
(declare-fun student_version_~is_divisible~1_31 () Int)
(declare-fun |main_#t~ret6_32| () Int)
(declare-fun |student_version_#res_32| () Int)
(declare-fun |main_#t~ret6_33| () Int)
(declare-fun main_~is_divisible2~0_33 () Int)
(declare-fun |__VERIFIER_assert_#in~cond_34| () Int)
(declare-fun main_~is_divisible1~0_34 () Int)
(declare-fun main_~is_divisible2~0_34 () Int)
...
(assert (! (and (= ~true~0_1 v_main_~is_divisible2~0_26_fresh_1) (= ~true~0_1 v_main_~is_divisible1~0_26_fresh_1)) :named ssa_4))
...
(assert (! (and (= (+ 2 student_version_~i~1_26) student_version_~i~1_27) (< student_version_~i~1_26 student_version_~w_21)) :named ssa_27))
(assert (! (<= student_version_~w_21 student_version_~i~1_27) :named ssa_28))
(assert (! (= student_version_~w_21 student_version_~i~1_27) :named ssa_29))
(assert (! true :named ssa_30))
(assert (! (= student_version_~is_divisible~1_21 |student_version_#res_31|) :named ssa_31))
(assert (! (= |main_#t~ret6_32| |student_version_#res_31|) :named ssa_32_return))
(assert (! (and (<= |main_#t~ret6_32| 2147483647) (= main_~is_divisible2~0_33 |main_#t~ret6_32|) (<= 0 (+ |main_#t~ret6_32| 2147483648))) :named ssa_33))
(assert (! true :named ssa_34_GlobVarAssigCall))
(assert (! (= (ite (= main_~is_divisible1~0_19 main_~is_divisible2~0_33) 1 0) |__VERIFIER_assert_#in~cond_34|) :named ssa_34_LocVarAssigCall))
...
(assert (! true :named ssa_precond))
(assert (! (not (or (< (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647) main_~w~0_-2) (< main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 10)))) :named ssa_postcond))
...
(declare-fun student_version_~w_8 () Int)
(declare-fun student_version_~i~1_9 () Int)
(declare-fun |student_version_#res_10| () Int)
(declare-fun student_version_~is_divisible~1_10 () Int)
(declare-fun |main_#t~ret6_11| () Int)
...
(assert (! (<= student_version_~w_0 student_version_~i~1_6) :named ssa_7))
(assert (! (= student_version_~w_0 student_version_~i~1_6) :named ssa_8))
(assert (! true :named ssa_9))
(assert (! (= student_version_~is_divisible~1_0 |student_version_#res_10|) :named ssa_10))
(assert (! (= |main_#t~ret6_11| |student_version_#res_10|) :named ssa_11_return))
(assert (! (or (< (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647) main_~w~0_-2) (< main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 10))) :named ssa_-2_PendingContext))
