...
(set-info :ultimate-id mono-crafted_11.c_AllErrorsAtOnce_Iteration25)
...
(assert (! (<= 100000000 (mod main_~x~0_50 4294967296)) :named ssa_51))
(assert (! true :named ssa_52_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_52| (ite (= (mod main_~x~0_50 2) 0) 1 0)) :named ssa_52_LocVarAssigCall))
