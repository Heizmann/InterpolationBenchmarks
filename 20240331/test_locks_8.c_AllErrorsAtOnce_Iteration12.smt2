...
(set-info :ultimate-id test_locks_8.c_AllErrorsAtOnce_Iteration12)
...
(declare-fun main_~lk5~0_20 () Int)
...
(assert (! (not (= main_~p5~0_4 0)) :named ssa_19))
(assert (! (not (= main_~lk5~0_11 1)) :named ssa_20))
