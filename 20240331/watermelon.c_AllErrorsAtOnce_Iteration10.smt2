...
(set-info :ultimate-id watermelon.c_AllErrorsAtOnce_Iteration10)
...
(declare-fun v_main_~is_divisible1~0_15_fresh_1 () Int)
(declare-fun v_main_~is_divisible2~0_15_fresh_1 () Int)
...
(assert (! (and (= ~true~0_1 v_main_~is_divisible1~0_15_fresh_1) (= ~true~0_1 v_main_~is_divisible2~0_15_fresh_1)) :named ssa_4))
...
(assert (! (<= student_version_~w_18 student_version_~i~1_21) :named ssa_22))
(assert (! (= student_version_~w_18 student_version_~i~1_21) :named ssa_23))
(assert (! true :named ssa_24))
(assert (! (= student_version_~is_divisible~1_18 |student_version_#res_25|) :named ssa_25))
(assert (! (= |main_#t~ret6_26| |student_version_#res_25|) :named ssa_26_return))
(assert (! (and (<= |main_#t~ret6_26| 2147483647) (= main_~is_divisible2~0_27 |main_#t~ret6_26|) (<= 0 (+ |main_#t~ret6_26| 2147483648))) :named ssa_27))
(assert (! true :named ssa_28_GlobVarAssigCall))
(assert (! (= (ite (= main_~is_divisible1~0_16 main_~is_divisible2~0_27) 1 0) |__VERIFIER_assert_#in~cond_28|) :named ssa_28_LocVarAssigCall))
...
(assert (! true :named ssa_precond))
(assert (! (not (= ~true~0_-1 |main_#t~ret5_8|)) :named ssa_postcond))
...
(echo "starting trace check")
(push 1)
(declare-fun main_~is_divisible1~0_-2 () Int)
(declare-fun ~true~0_-1 () Int)
(declare-fun main_~w~0_-2 () Int)
(declare-fun main_~w~0_-1 () Int)
...
(assert (! true :named ssa_precond))
(assert (! (not (= |main_#t~ret6_8| main_~is_divisible1~0_-2)) :named ssa_postcond))
...
(assert (! (= ~true~0_-1 main_~is_divisible1~0_-2) :named ssa_-2_PendingContext))
