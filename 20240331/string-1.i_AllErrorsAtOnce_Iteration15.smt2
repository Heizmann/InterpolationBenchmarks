...
(set-info :ultimate-id string-1.i_AllErrorsAtOnce_Iteration15)
...
(declare-fun v_main_~found~0_20_fresh_1 () Int)
...
(declare-fun |v_main_#t~nondet4_60_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_61_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_62_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_63_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_64_fresh_1| () Int)
...
(assert (! (and (< |#StackHeapBarrier_-1| |main_~#string_A~0.base_4|) (= main_~i~0_4 0) (= (select |#valid_3| |main_~#string_A~0.base_4|) 0) (= v_ArrVal_279_fresh_1 5) (= |main_~#string_A~0.offset_4| 0) (not (= |main_~#string_B~0.base_4| 0)) (= v_ArrVal_278_fresh_1 5) (= v_ArrVal_280_fresh_1 1) (= v_main_~found~0_20_fresh_1 0) (= (select (store |#valid_3| |main_~#string_A~0.base_4| v_ArrVal_280_fresh_1) |main_~#string_B~0.base_4|) 0) (= |main_~#string_B~0.offset_4| 0) (= v_ArrVal_277_fresh_1 1) (= |#valid_4| (store (store |#valid_3| |main_~#string_A~0.base_4| v_ArrVal_280_fresh_1) |main_~#string_B~0.base_4| v_ArrVal_277_fresh_1)) (not (= |main_~#string_A~0.base_4| 0)) (< |#StackHeapBarrier_-1| |main_~#string_B~0.base_4|) (= (store (store |#length_3| |main_~#string_A~0.base_4| v_ArrVal_279_fresh_1) |main_~#string_B~0.base_4| v_ArrVal_278_fresh_1) |#length_4|)) :named ssa_4))
(assert (! (and (= v_ArrVal_282_fresh_1 (store (select |#memory_int#2_3| |main_~#string_A~0.base_4|) (+ main_~i~0_4 |main_~#string_A~0.offset_4|) v_ArrVal_281_fresh_1)) (= main_~i~0_5 (+ main_~i~0_4 1)) (<= 0 (+ |v_main_#t~nondet1_60_fresh_1| 128)) (= (store |#memory_int#2_3| |main_~#string_A~0.base_4| v_ArrVal_282_fresh_1) |#memory_int#2_5|) (< main_~i~0_4 5) (<= |v_main_#t~nondet1_60_fresh_1| 127) (= v_ArrVal_281_fresh_1 |v_main_#t~nondet1_60_fresh_1|)) :named ssa_5))
(assert (! (and (= v_ArrVal_283_fresh_1 |v_main_#t~nondet1_61_fresh_1|) (= v_ArrVal_284_fresh_1 (store (select |#memory_int#2_5| |main_~#string_A~0.base_4|) (+ main_~i~0_5 |main_~#string_A~0.offset_4|) v_ArrVal_283_fresh_1)) (= main_~i~0_6 (+ main_~i~0_5 1)) (<= 0 (+ |v_main_#t~nondet1_61_fresh_1| 128)) (<= |v_main_#t~nondet1_61_fresh_1| 127) (< main_~i~0_5 5) (= (store |#memory_int#2_5| |main_~#string_A~0.base_4| v_ArrVal_284_fresh_1) |#memory_int#2_6|)) :named ssa_6))
(assert (! (and (<= |v_main_#t~nondet1_62_fresh_1| 127) (= v_ArrVal_285_fresh_1 (store (select |#memory_int#2_6| |main_~#string_A~0.base_4|) (+ main_~i~0_6 |main_~#string_A~0.offset_4|) |v_main_#t~nondet1_62_fresh_1|)) (= main_~i~0_7 (+ main_~i~0_6 1)) (= (store |#memory_int#2_6| |main_~#string_A~0.base_4| v_ArrVal_285_fresh_1) |#memory_int#2_7|) (<= 0 (+ |v_main_#t~nondet1_62_fresh_1| 128)) (< main_~i~0_6 5) (= v_ArrVal_286_fresh_1 |v_main_#t~nondet1_62_fresh_1|)) :named ssa_7))
(assert (! (and (<= |v_main_#t~nondet1_63_fresh_1| 127) (<= 0 (+ |v_main_#t~nondet1_63_fresh_1| 128)) (= (store (select |#memory_int#2_7| |main_~#string_A~0.base_4|) (+ main_~i~0_7 |main_~#string_A~0.offset_4|) |v_main_#t~nondet1_63_fresh_1|) v_ArrVal_287_fresh_1) (= (store |#memory_int#2_7| |main_~#string_A~0.base_4| v_ArrVal_287_fresh_1) |#memory_int#2_8|) (= main_~i~0_8 (+ main_~i~0_7 1)) (= v_ArrVal_288_fresh_1 |v_main_#t~nondet1_63_fresh_1|) (< main_~i~0_7 5)) :named ssa_8))
(assert (! (and (= (store (select |#memory_int#2_8| |main_~#string_A~0.base_4|) (+ main_~i~0_8 |main_~#string_A~0.offset_4|) v_ArrVal_289_fresh_1) v_ArrVal_290_fresh_1) (<= |v_main_#t~nondet1_64_fresh_1| 127) (<= 0 (+ |v_main_#t~nondet1_64_fresh_1| 128)) (= main_~i~0_9 (+ main_~i~0_8 1)) (= v_ArrVal_289_fresh_1 |v_main_#t~nondet1_64_fresh_1|) (< main_~i~0_8 5) (= (store |#memory_int#2_8| |main_~#string_A~0.base_4| v_ArrVal_290_fresh_1) |#memory_int#2_9|)) :named ssa_9))
...
(assert (! (and (<= |v_main_#t~nondet4_60_fresh_1| 127) (= (store |#memory_int#1_3| |main_~#string_B~0.base_4| v_ArrVal_292_fresh_1) |#memory_int#1_13|) (= main_~i~0_13 (+ main_~i~0_12 1)) (= v_ArrVal_291_fresh_1 |v_main_#t~nondet4_60_fresh_1|) (= v_ArrVal_292_fresh_1 (store (select |#memory_int#1_3| |main_~#string_B~0.base_4|) (+ main_~i~0_12 |main_~#string_B~0.offset_4|) v_ArrVal_291_fresh_1)) (<= 0 (+ |v_main_#t~nondet4_60_fresh_1| 128)) (< main_~i~0_12 5)) :named ssa_13))
(assert (! (and (= (store |#memory_int#1_13| |main_~#string_B~0.base_4| v_ArrVal_293_fresh_1) |#memory_int#1_14|) (<= 0 (+ |v_main_#t~nondet4_61_fresh_1| 128)) (= main_~i~0_14 (+ main_~i~0_13 1)) (= v_ArrVal_293_fresh_1 (store (select |#memory_int#1_13| |main_~#string_B~0.base_4|) (+ main_~i~0_13 |main_~#string_B~0.offset_4|) |v_main_#t~nondet4_61_fresh_1|)) (= v_ArrVal_294_fresh_1 |v_main_#t~nondet4_61_fresh_1|) (< main_~i~0_13 5) (<= |v_main_#t~nondet4_61_fresh_1| 127)) :named ssa_14))
(assert (! (and (= main_~i~0_15 (+ main_~i~0_14 1)) (= v_ArrVal_296_fresh_1 |v_main_#t~nondet4_62_fresh_1|) (<= 0 (+ |v_main_#t~nondet4_62_fresh_1| 128)) (= v_ArrVal_295_fresh_1 (store (select |#memory_int#1_14| |main_~#string_B~0.base_4|) (+ main_~i~0_14 |main_~#string_B~0.offset_4|) |v_main_#t~nondet4_62_fresh_1|)) (< main_~i~0_14 5) (<= |v_main_#t~nondet4_62_fresh_1| 127) (= (store |#memory_int#1_14| |main_~#string_B~0.base_4| v_ArrVal_295_fresh_1) |#memory_int#1_15|)) :named ssa_15))
(assert (! (and (= main_~i~0_16 (+ main_~i~0_15 1)) (= (store |#memory_int#1_15| |main_~#string_B~0.base_4| v_ArrVal_297_fresh_1) |#memory_int#1_16|) (<= |v_main_#t~nondet4_63_fresh_1| 127) (<= 0 (+ |v_main_#t~nondet4_63_fresh_1| 128)) (< main_~i~0_15 5) (= v_ArrVal_298_fresh_1 |v_main_#t~nondet4_63_fresh_1|) (= v_ArrVal_297_fresh_1 (store (select |#memory_int#1_15| |main_~#string_B~0.base_4|) (+ main_~i~0_15 |main_~#string_B~0.offset_4|) |v_main_#t~nondet4_63_fresh_1|))) :named ssa_16))
(assert (! (and (= (store |#memory_int#1_16| |main_~#string_B~0.base_4| v_ArrVal_299_fresh_1) |#memory_int#1_17|) (<= |v_main_#t~nondet4_64_fresh_1| 127) (= main_~i~0_17 (+ main_~i~0_16 1)) (<= 0 (+ |v_main_#t~nondet4_64_fresh_1| 128)) (= v_ArrVal_299_fresh_1 (store (select |#memory_int#1_16| |main_~#string_B~0.base_4|) (+ main_~i~0_16 |main_~#string_B~0.offset_4|) |v_main_#t~nondet4_64_fresh_1|)) (< main_~i~0_16 5) (= v_ArrVal_300_fresh_1 |v_main_#t~nondet4_64_fresh_1|)) :named ssa_17))
...
(assert (! (and (= |v_main_#t~post8_12_fresh_1| main_~nc_A~0_20) (= (+ |v_main_#t~post8_12_fresh_1| 1) main_~nc_A~0_22) (not (= |main_#t~mem7_21| 0))) :named ssa_22))
...
(assert (! (and (= main_~nc_A~0_24 (+ |v_main_#t~post8_13_fresh_1| 1)) (= |v_main_#t~post8_13_fresh_1| main_~nc_A~0_22) (not (= |main_#t~mem7_23| 0))) :named ssa_24))
...
(assert (! (and (= |v_main_#t~post10_14_fresh_1| main_~nc_B~0_27) (not (= |main_#t~mem9_28| 0)) (= (+ |v_main_#t~post10_14_fresh_1| 1) main_~nc_B~0_29)) :named ssa_29))
...
(assert (! (and (= |v_main_#t~post10_15_fresh_1| main_~nc_B~0_29) (= (+ |v_main_#t~post10_15_fresh_1| 1) main_~nc_B~0_31) (not (= |main_#t~mem9_30| 0))) :named ssa_31))
...
(assert (! (or (<= main_~nc_B~0_31 main_~j~0_40) (<= main_~nc_A~0_24 main_~i~0_40)) :named ssa_41))
(assert (! (= main_~found~0_42 (ite (< main_~nc_B~0_31 (+ main_~j~0_40 1)) 1 0)) :named ssa_42))
