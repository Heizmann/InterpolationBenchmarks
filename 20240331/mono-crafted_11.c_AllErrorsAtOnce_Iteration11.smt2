...
(set-info :ultimate-id mono-crafted_11.c_AllErrorsAtOnce_Iteration11)
...
(assert (! (<= 100000000 (mod main_~x~0_22 4294967296)) :named ssa_23))
(assert (! true :named ssa_24_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_24| (ite (= (mod main_~x~0_22 2) 0) 1 0)) :named ssa_24_LocVarAssigCall))
