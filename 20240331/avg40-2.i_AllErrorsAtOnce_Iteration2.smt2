...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:15:16+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id avg40-2.i_AllErrorsAtOnce_Iteration2)
...
(declare-fun |avg_#in~x.base_7| () Int)
(declare-fun |main_~#x~0.offset_7| () Int)
(declare-fun |avg_#in~x.offset_7| () Int)
(declare-fun |main_~#x~0.base_7| () Int)
(declare-fun avg_~ret~0_8 () Int)
(declare-fun avg_~x.base_8 () Int)
(declare-fun avg_~i~0_8 () Int)
(declare-fun avg_~x.offset_8 () Int)
(declare-fun avg_~i~0_9 () Int)
(declare-fun avg_~ret~0_10 () Int)
(declare-fun |avg_#res_10| () Int)
...
(assert (! (and (= main_~i~1_4 0) (= v_ArrVal_8_fresh_1 1) (= |main_~#x~0.offset_4| 0) (= (select |#valid_3| |main_~#x~0.base_4|) 0) (< |#StackHeapBarrier_-1| |main_~#x~0.base_4|) (not (= |main_~#x~0.base_4| 0)) (= |#length_4| (store |#length_3| |main_~#x~0.base_4| v_ArrVal_9_fresh_1)) (= |#valid_4| (store |#valid_3| |main_~#x~0.base_4| v_ArrVal_8_fresh_1)) (= 160 v_ArrVal_9_fresh_1)) :named ssa_4))
(assert (! (<= 40 main_~i~1_4) :named ssa_5))
(assert (! true :named ssa_6))
(assert (! true :named ssa_7_GlobVarAssigCall))
(assert (! (and (= |main_~#x~0.offset_4| |avg_#in~x.offset_7|) (= |main_~#x~0.base_4| |avg_#in~x.base_7|)) :named ssa_7_LocVarAssigCall))
(assert (! true :named ssa_7_OldVarAssigCall))
(assert (! (and (= avg_~ret~0_8 0) (= avg_~x.base_8 |avg_#in~x.base_7|) (= avg_~x.offset_8 |avg_#in~x.offset_7|) (= avg_~i~0_8 0)) :named ssa_8))
(assert (! (<= 40 avg_~i~0_8) :named ssa_9))
(assert (! (= (ite (<= (mod (ite (and (not (= (mod avg_~ret~0_8 40) 0)) (< avg_~ret~0_8 0)) (+ (div avg_~ret~0_8 40) 1) (div avg_~ret~0_8 40)) 4294967296) 2147483647) (mod (ite (and (not (= (mod avg_~ret~0_8 40) 0)) (< avg_~ret~0_8 0)) (+ (div avg_~ret~0_8 40) 1) (div avg_~ret~0_8 40)) 4294967296) (+ (mod (ite (and (not (= (mod avg_~ret~0_8 40) 0)) (< avg_~ret~0_8 0)) (+ (div avg_~ret~0_8 40) 1) (div avg_~ret~0_8 40)) 4294967296) (- 4294967296))) |avg_#res_10|) :named ssa_10))
(assert (! (= |main_#t~ret5_11| |avg_#res_10|) :named ssa_11_return))
(assert (! (and (= (store (store (select |#memory_int#1_3| |main_~#x~0.base_4|) |main_~#x~0.offset_4| v_ArrVal_10_fresh_1) (+ |main_~#x~0.offset_4| 4) v_main_~temp~0_7_fresh_1) v_ArrVal_11_fresh_1) (= (select (select |#memory_int#1_3| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4)) v_ArrVal_10_fresh_1) (<= 0 (+ |main_#t~ret5_11| 2147483648)) (= |main_#t~ret5_11| main_~ret~1_12) (<= |main_#t~ret5_11| 2147483647) (= (select (select |#memory_int#1_3| |main_~#x~0.base_4|) |main_~#x~0.offset_4|) v_main_~temp~0_7_fresh_1) (= v_main_~temp~0_7_fresh_1 v_ArrVal_12_fresh_1) (= (store |#memory_int#1_3| |main_~#x~0.base_4| v_ArrVal_11_fresh_1) |#memory_int#1_12|)) :named ssa_12))
...
(assert (! (= |main_#t~ret8_17| |avg_#res_16|) :named ssa_17_return))
(assert (! (and (= main_~ret2~0_18 |main_#t~ret8_17|) (<= |main_#t~ret8_17| 2147483647) (<= 0 (+ |main_#t~ret8_17| 2147483648)) (= main_~i~2_18 0) (= main_~temp~0_18 (select (select |#memory_int#1_12| |main_~#x~0.base_4|) |main_~#x~0.offset_4|))) :named ssa_18))
(assert (! (<= 39 main_~i~2_18) :named ssa_19))
(assert (! (and (= main_~temp~0_18 v_ArrVal_13_fresh_1) (= (store (select |#memory_int#1_12| |main_~#x~0.base_4|) (+ 156 |main_~#x~0.offset_4|) v_ArrVal_13_fresh_1) v_ArrVal_14_fresh_1) (= (store |#memory_int#1_12| |main_~#x~0.base_4| v_ArrVal_14_fresh_1) |#memory_int#1_20|)) :named ssa_20))
(assert (! true :named ssa_21_GlobVarAssigCall))
(assert (! (and (= |main_~#x~0.base_4| |avg_#in~x.base_21|) (= |main_~#x~0.offset_4| |avg_#in~x.offset_21|)) :named ssa_21_LocVarAssigCall))
...
(assert (! (= |main_#t~ret12_25| |avg_#res_24|) :named ssa_25_return))
