...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration13)
...
(assert (! (<= 1000000 main_~i~0_16) :named ssa_17))
(assert (! true :named ssa_18_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_18| (ite (= main_~i~0_16 1000000) 1 0)) :named ssa_18_LocVarAssigCall))
