...
(set-info :ultimate-id id2_b2_o3.c_AllErrorsAtOnce_Iteration2)
...
(assert (! (and (= |id_#res_14| 2) (< 2 (mod id_~ret~0_13 4294967296))) :named ssa_14))
...
(assert (! (and (= |id_#res_8| 2) (< 2 (mod id_~ret~0_7 4294967296))) :named ssa_8))
