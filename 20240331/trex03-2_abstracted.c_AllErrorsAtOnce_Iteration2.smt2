...
(set-info :ultimate-id trex03-2_abstracted.c_AllErrorsAtOnce_Iteration2)
...
(declare-fun v_main_~d3~0_4_fresh_1 () Int)
(declare-fun v_main_~d2~0_4_fresh_1 () Int)
(declare-fun v_main_~d1~0_4_fresh_1 () Int)
...
(assert (! (and (= 1 v_main_~d2~0_4_fresh_1) (= 1 v_main_~d3~0_4_fresh_1) (= 1 v_main_~d1~0_4_fresh_1)) :named ssa_4))
