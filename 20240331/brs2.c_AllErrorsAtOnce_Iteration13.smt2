...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-30T23:50:46+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id brs2.c_AllErrorsAtOnce_Iteration13)
...
(declare-fun |main_#t~post9_31| () Int)
...
(declare-fun |main_~#sum~0.offset_48| () Int)
...
(assert (! (and (= (select |#valid_3| |main_~#sum~0.base_11|) 0) (< |#StackHeapBarrier_-1| |main_~#sum~0.base_11|) (= (store (store |#length_3| |main_~#sum~0.base_11| v_ArrVal_168_fresh_1) main_~a~0.base_11 v_ArrVal_165_fresh_1) |#length_11|) (< main_~a~0.base_11 |#StackHeapBarrier_-1|) (= |main_~#sum~0.offset_11| 0) (= (select (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_166_fresh_1) main_~a~0.base_11) 0) (= (store (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_166_fresh_1) main_~a~0.base_11 v_ArrVal_167_fresh_1) |#valid_11|) (= v_ArrVal_165_fresh_1 (* (mod ~N~0_4 1073741824) 4)) (= v_ArrVal_166_fresh_1 1) (not (= |main_~#sum~0.base_11| 0)) (= main_~a~0.offset_11 0) (not (= main_~a~0.base_11 0)) (= v_ArrVal_167_fresh_1 1) (= v_ArrVal_168_fresh_1 8) (= main_~i~0_11 0)) :named ssa_11))
(assert (! (< main_~i~0_11 ~N~0_4) :named ssa_12))
(assert (! (and (= v_ArrVal_169_fresh_1 2) (= v_ArrVal_170_fresh_1 (store (select |#memory_int#3_3| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_11 4)) v_ArrVal_169_fresh_1)) (= (store |#memory_int#3_3| main_~a~0.base_11 v_ArrVal_170_fresh_1) |#memory_int#3_13|) (= (ite (and (< main_~i~0_11 0) (not (= (mod main_~i~0_11 2) 0))) (+ (mod main_~i~0_11 2) (- 2)) (mod main_~i~0_11 2)) 0)) :named ssa_13))
(assert (! (= main_~i~0_14 (+ main_~i~0_11 1)) :named ssa_14))
(assert (! (< main_~i~0_14 ~N~0_4) :named ssa_15))
(assert (! (and (= v_ArrVal_172_fresh_1 0) (not (= (ite (and (not (= (mod main_~i~0_14 2) 0)) (< main_~i~0_14 0)) (+ (- 2) (mod main_~i~0_14 2)) (mod main_~i~0_14 2)) 0)) (= (store |#memory_int#3_13| main_~a~0.base_11 v_ArrVal_171_fresh_1) |#memory_int#3_16|) (= v_ArrVal_171_fresh_1 (store (select |#memory_int#3_13| main_~a~0.base_11) (+ (* main_~i~0_14 4) main_~a~0.offset_11) 0))) :named ssa_16))
(assert (! (= main_~i~0_17 (+ main_~i~0_14 1)) :named ssa_17))
(assert (! (< main_~i~0_17 ~N~0_4) :named ssa_18))
(assert (! (and (= (store |#memory_int#3_16| main_~a~0.base_11 v_ArrVal_174_fresh_1) |#memory_int#3_19|) (= v_ArrVal_174_fresh_1 (store (select |#memory_int#3_16| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_17 4)) v_ArrVal_173_fresh_1)) (= (ite (and (< main_~i~0_17 0) (not (= (mod main_~i~0_17 2) 0))) (+ (mod main_~i~0_17 2) (- 2)) (mod main_~i~0_17 2)) 0) (= v_ArrVal_173_fresh_1 2)) :named ssa_19))
(assert (! (= main_~i~0_20 (+ main_~i~0_17 1)) :named ssa_20))
(assert (! (< main_~i~0_20 ~N~0_4) :named ssa_21))
(assert (! (and (= (store |#memory_int#3_19| main_~a~0.base_11 v_ArrVal_175_fresh_1) |#memory_int#3_22|) (= v_ArrVal_175_fresh_1 (store (select |#memory_int#3_19| main_~a~0.base_11) (+ (* main_~i~0_20 4) main_~a~0.offset_11) 0)) (not (= (ite (and (not (= (mod main_~i~0_20 2) 0)) (< main_~i~0_20 0)) (+ (- 2) (mod main_~i~0_20 2)) (mod main_~i~0_20 2)) 0)) (= v_ArrVal_176_fresh_1 0)) :named ssa_22))
(assert (! (= main_~i~0_23 (+ main_~i~0_20 1)) :named ssa_23))
(assert (! (< main_~i~0_23 ~N~0_4) :named ssa_24))
(assert (! (and (= v_ArrVal_177_fresh_1 2) (= (store |#memory_int#3_22| main_~a~0.base_11 v_ArrVal_178_fresh_1) |#memory_int#3_25|) (= v_ArrVal_178_fresh_1 (store (select |#memory_int#3_22| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_23 4)) v_ArrVal_177_fresh_1)) (= (ite (and (< main_~i~0_23 0) (not (= (mod main_~i~0_23 2) 0))) (+ (mod main_~i~0_23 2) (- 2)) (mod main_~i~0_23 2)) 0)) :named ssa_25))
(assert (! (= main_~i~0_26 (+ main_~i~0_23 1)) :named ssa_26))
(assert (! (<= ~N~0_4 main_~i~0_26) :named ssa_27))
(assert (! (= main_~i~0_28 0) :named ssa_28))
(assert (! (< main_~i~0_28 ~N~0_4) :named ssa_29))
(assert (! (and (= v_ArrVal_180_fresh_1 (store (select |#memory_int#1_3| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| v_ArrVal_179_fresh_1)) (= main_~i~0_28 0) (= |#memory_int#1_30| (store |#memory_int#1_3| |main_~#sum~0.base_11| v_ArrVal_180_fresh_1)) (= v_ArrVal_179_fresh_1 0)) :named ssa_30))
(assert (! (= main_~i~0_31 (+ main_~i~0_28 1)) :named ssa_31))
(assert (! (< main_~i~0_31 ~N~0_4) :named ssa_32))
(assert (! (and (= (store |#memory_int#1_30| |main_~#sum~0.base_11| v_ArrVal_182_fresh_1) |#memory_int#1_33|) (= v_ArrVal_182_fresh_1 (store (select |#memory_int#1_30| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| v_ArrVal_181_fresh_1)) (= v_ArrVal_181_fresh_1 (+ (select (select |#memory_int#1_30| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|) (select (select |#memory_int#3_25| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_31 4))))) (not (= main_~i~0_31 0))) :named ssa_33))
(assert (! (= main_~i~0_34 (+ main_~i~0_31 1)) :named ssa_34))
(assert (! (< main_~i~0_34 ~N~0_4) :named ssa_35))
(assert (! (and (= v_ArrVal_184_fresh_1 (store (select |#memory_int#1_33| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| v_ArrVal_183_fresh_1)) (= v_ArrVal_183_fresh_1 (+ (select (select |#memory_int#1_33| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|) (select (select |#memory_int#3_25| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_34 4))))) (= (store |#memory_int#1_33| |main_~#sum~0.base_11| v_ArrVal_184_fresh_1) |#memory_int#1_36|) (not (= main_~i~0_34 0))) :named ssa_36))
(assert (! (= main_~i~0_37 (+ main_~i~0_34 1)) :named ssa_37))
(assert (! (< main_~i~0_37 ~N~0_4) :named ssa_38))
(assert (! (and (= (store |#memory_int#1_36| |main_~#sum~0.base_11| v_ArrVal_186_fresh_1) |#memory_int#1_39|) (= v_ArrVal_185_fresh_1 (+ (select (select |#memory_int#1_36| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|) (select (select |#memory_int#3_25| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_37 4))))) (= v_ArrVal_186_fresh_1 (store (select |#memory_int#1_36| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| v_ArrVal_185_fresh_1)) (not (= main_~i~0_37 0))) :named ssa_39))
(assert (! (= main_~i~0_40 (+ main_~i~0_37 1)) :named ssa_40))
(assert (! (< main_~i~0_40 ~N~0_4) :named ssa_41))
(assert (! (and (= (store (select |#memory_int#1_39| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| v_ArrVal_187_fresh_1) v_ArrVal_188_fresh_1) (= v_ArrVal_187_fresh_1 (+ (select (select |#memory_int#1_39| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|) (select (select |#memory_int#3_25| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_40 4))))) (= (store |#memory_int#1_39| |main_~#sum~0.base_11| v_ArrVal_188_fresh_1) |#memory_int#1_42|) (not (= main_~i~0_40 0))) :named ssa_42))
(assert (! (= main_~i~0_43 (+ main_~i~0_40 1)) :named ssa_43))
(assert (! (< main_~i~0_43 ~N~0_4) :named ssa_44))
(assert (! (and (= v_ArrVal_190_fresh_1 (store (select |#memory_int#1_42| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| v_ArrVal_189_fresh_1)) (= v_ArrVal_189_fresh_1 (+ (select (select |#memory_int#1_42| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|) (select (select |#memory_int#3_25| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_43 4))))) (= (store |#memory_int#1_42| |main_~#sum~0.base_11| v_ArrVal_190_fresh_1) |#memory_int#1_45|) (not (= main_~i~0_43 0))) :named ssa_45))
(assert (! (= main_~i~0_46 (+ main_~i~0_43 1)) :named ssa_46))
(assert (! (<= ~N~0_4 main_~i~0_46) :named ssa_47))
(assert (! (= |main_#t~mem10_48| (select (select |#memory_int#1_45| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|)) :named ssa_48))
(assert (! true :named ssa_49_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_49| (ite (<= |main_#t~mem10_48| (* 2 ~N~0_4)) 1 0)) :named ssa_49_LocVarAssigCall))
