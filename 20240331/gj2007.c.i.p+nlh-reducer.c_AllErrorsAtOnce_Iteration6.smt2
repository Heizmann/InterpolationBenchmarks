...
(set-info :ultimate-id gj2007.c.i.p+nlh-reducer.c_AllErrorsAtOnce_Iteration6)
...
(assert (! (and (<= 50 main_~main__x~0_22) (= main_~main__y~0_24 (+ main_~main__y~0_4 1)) (= (+ main_~main__x~0_22 1) main_~main__x~0_24)) :named ssa_24))
...
(assert (! (and (= v_main_~__tmp_1~0_9_fresh_1 (ite (= main_~main__y~0_138 100) 1 0)) (<= 100 main_~main__x~0_138) (= v_main_~__tmp_1~0_9_fresh_1 main_~__VERIFIER_assert__cond~0_139)) :named ssa_139))
