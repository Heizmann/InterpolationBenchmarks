...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:09:17+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id eq1.c_AllErrorsAtOnce_Iteration2)
...
(declare-fun |c_main_#t~pre10| () Int)
(declare-fun |c_main_#t~pre10_primed| () Int)
(declare-fun |c_main_#t~pre11| () Int)
(declare-fun |c_main_#t~pre11_primed| () Int)
...
(assert (! (and (= (select (select |#memory_int#1_-1| 2) 2) 49) (< 0 |#StackHeapBarrier_-1|) (= 46 (select (select |#memory_int#1_-1| 2) 3)) (= 12 (select |#length_-1| 3)) (= (select (select |#memory_int#1_-1| 2) 4) 99) (= (select (select |#memory_int#1_-1| 2) 5) 0) (= 101 (select (select |#memory_int#1_-1| 2) 0)) (= (select (select |#memory_int#1_-1| 2) 1) 113) (= 6 (select |#length_-1| 2)) (= (select |#valid_-1| 3) 1) (= (select |#valid_-1| 2) 1) (= (select |#valid_-1| 1) 1) (= (select (select |#memory_int#0_-1| 1) 1) 0) (= (select |#length_-1| 1) 2) (= (select (select |#memory_int#0_-1| 1) 0) 48) (= (select |#valid_-1| 0) 0)) :named ssa_1))
(assert (! true :named ssa_2_return))
(assert (! true :named ssa_3_GlobVarAssigCall))
(assert (! true :named ssa_3_LocVarAssigCall))
(assert (! true :named ssa_3_OldVarAssigCall))
(assert (! (and (= main_~y~0_4 main_~z~0_4) (= main_~w~0_4 main_~x~0_4)) :named ssa_4))
(assert (! true :named ssa_5))
(assert (! (= (mod |main_#t~nondet6_5| 4294967296) 0) :named ssa_6))
(assert (! true :named ssa_7_GlobVarAssigCall))
(assert (! (= (ite (and (= (mod main_~y~0_4 4294967296) (mod main_~z~0_4 4294967296)) (= (mod main_~w~0_4 4294967296) (mod main_~x~0_4 4294967296))) 1 0) |__VERIFIER_assert_#in~cond_7|) :named ssa_7_LocVarAssigCall))
