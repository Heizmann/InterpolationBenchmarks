...
(set-info :ultimate-id avg40-2.i_AllErrorsAtOnce_Iteration6)
...
(assert (! (and (= main_~i~1_4 0) (= |main_~#x~0.offset_4| 0) (= (select |#valid_3| |main_~#x~0.base_4|) 0) (< |#StackHeapBarrier_-1| |main_~#x~0.base_4|) (= |#valid_4| (store |#valid_3| |main_~#x~0.base_4| v_ArrVal_46_fresh_1)) (= 160 v_ArrVal_47_fresh_1) (not (= |main_~#x~0.base_4| 0)) (= (store |#length_3| |main_~#x~0.base_4| v_ArrVal_47_fresh_1) |#length_4|) (= v_ArrVal_46_fresh_1 1)) :named ssa_4))
(assert (! (and (<= |v_main_#t~nondet3_13_fresh_1| 2147483647) (< main_~i~1_4 40) (= v_ArrVal_49_fresh_1 (store (select |#memory_int#1_3| |main_~#x~0.base_4|) (+ (* main_~i~1_4 4) |main_~#x~0.offset_4|) v_ArrVal_48_fresh_1)) (= |v_main_#t~nondet3_13_fresh_1| v_ArrVal_48_fresh_1) (= |#memory_int#1_5| (store |#memory_int#1_3| |main_~#x~0.base_4| v_ArrVal_49_fresh_1)) (<= 0 (+ |v_main_#t~nondet3_13_fresh_1| 2147483648)) (= main_~i~1_5 (+ main_~i~1_4 1))) :named ssa_5))
(assert (! (and (< main_~i~1_5 40) (<= 0 (+ |v_main_#t~nondet3_14_fresh_1| 2147483648)) (= v_ArrVal_50_fresh_1 (store (select |#memory_int#1_5| |main_~#x~0.base_4|) (+ (* main_~i~1_5 4) |main_~#x~0.offset_4|) |v_main_#t~nondet3_14_fresh_1|)) (= (store |#memory_int#1_5| |main_~#x~0.base_4| v_ArrVal_50_fresh_1) |#memory_int#1_6|) (<= |v_main_#t~nondet3_14_fresh_1| 2147483647) (= |v_main_#t~nondet3_14_fresh_1| v_ArrVal_51_fresh_1) (= main_~i~1_6 (+ main_~i~1_5 1))) :named ssa_6))
...
(assert (! (and (= (store (store (select |#memory_int#1_6| |main_~#x~0.base_4|) |main_~#x~0.offset_4| v_ArrVal_52_fresh_1) (+ |main_~#x~0.offset_4| 4) v_ArrVal_53_fresh_1) v_ArrVal_54_fresh_1) (<= 0 (+ |main_#t~ret5_15| 2147483648)) (= v_main_~temp~0_11_fresh_1 (select (select |#memory_int#1_6| |main_~#x~0.base_4|) |main_~#x~0.offset_4|)) (= |main_#t~ret5_15| main_~ret~1_16) (<= |main_#t~ret5_15| 2147483647) (= (select (select |#memory_int#1_6| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4)) v_ArrVal_52_fresh_1) (= v_main_~temp~0_11_fresh_1 v_ArrVal_53_fresh_1) (= |#memory_int#1_16| (store |#memory_int#1_6| |main_~#x~0.base_4| v_ArrVal_54_fresh_1))) :named ssa_16))
...
(assert (! (<= 39 main_~i~2_24) :named ssa_25))
(assert (! (and (= (store |#memory_int#1_16| |main_~#x~0.base_4| v_ArrVal_56_fresh_1) |#memory_int#1_26|) (= main_~temp~0_24 v_ArrVal_55_fresh_1) (= v_ArrVal_56_fresh_1 (store (select |#memory_int#1_16| |main_~#x~0.base_4|) (+ 156 |main_~#x~0.offset_4|) v_ArrVal_55_fresh_1))) :named ssa_26))
(assert (! true :named ssa_27_GlobVarAssigCall))
(assert (! (and (= |main_~#x~0.base_4| |avg_#in~x.base_27|) (= |main_~#x~0.offset_4| |avg_#in~x.offset_27|)) :named ssa_27_LocVarAssigCall))
...
(assert (! (= |main_#t~ret12_33| |avg_#res_32|) :named ssa_33_return))
