...
(set-info :ultimate-id string-1.i_AllErrorsAtOnce_Iteration9)
...
(declare-fun v_main_~found~0_14_fresh_1 () Int)
...
(declare-fun |v_main_#t~nondet4_30_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_31_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_32_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_33_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_34_fresh_1| () Int)
...
(declare-fun |v_main_#t~post8_3_fresh_1| () Int)
...
(declare-fun |v_main_#t~post10_5_fresh_1| () Int)
...
(declare-fun |main_#t~post14_32| () Int)
(declare-fun main_~i~0_33 () Int)
(declare-fun main_~nc_A~0_33 () Int)
(declare-fun main_~found~0_34 () Int)
(declare-fun main_~j~0_34 () Int)
(declare-fun main_~nc_B~0_34 () Int)
(declare-fun main_~found~0_35 () Int)
...
(assert (! (and (< |#StackHeapBarrier_-1| |main_~#string_A~0.base_4|) (= v_main_~found~0_14_fresh_1 0) (= (store (store |#length_3| |main_~#string_A~0.base_4| v_ArrVal_135_fresh_1) |main_~#string_B~0.base_4| v_ArrVal_134_fresh_1) |#length_4|) (= main_~i~0_4 0) (= (select |#valid_3| |main_~#string_A~0.base_4|) 0) (= |main_~#string_A~0.offset_4| 0) (= |#valid_4| (store (store |#valid_3| |main_~#string_A~0.base_4| v_ArrVal_136_fresh_1) |main_~#string_B~0.base_4| v_ArrVal_133_fresh_1)) (not (= |main_~#string_B~0.base_4| 0)) (= |main_~#string_B~0.offset_4| 0) (= v_ArrVal_135_fresh_1 5) (= v_ArrVal_134_fresh_1 5) (not (= |main_~#string_A~0.base_4| 0)) (= v_ArrVal_133_fresh_1 1) (= v_ArrVal_136_fresh_1 1) (< |#StackHeapBarrier_-1| |main_~#string_B~0.base_4|) (= (select (store |#valid_3| |main_~#string_A~0.base_4| v_ArrVal_136_fresh_1) |main_~#string_B~0.base_4|) 0)) :named ssa_4))
(assert (! (and (= v_ArrVal_137_fresh_1 (store (select |#memory_int#2_3| |main_~#string_A~0.base_4|) (+ main_~i~0_4 |main_~#string_A~0.offset_4|) |v_main_#t~nondet1_30_fresh_1|)) (<= |v_main_#t~nondet1_30_fresh_1| 127) (<= 0 (+ |v_main_#t~nondet1_30_fresh_1| 128)) (= main_~i~0_5 (+ main_~i~0_4 1)) (= v_ArrVal_138_fresh_1 |v_main_#t~nondet1_30_fresh_1|) (= (store |#memory_int#2_3| |main_~#string_A~0.base_4| v_ArrVal_137_fresh_1) |#memory_int#2_5|) (< main_~i~0_4 5)) :named ssa_5))
(assert (! (and (<= 0 (+ |v_main_#t~nondet1_31_fresh_1| 128)) (<= |v_main_#t~nondet1_31_fresh_1| 127) (= main_~i~0_6 (+ main_~i~0_5 1)) (= (store |#memory_int#2_5| |main_~#string_A~0.base_4| v_ArrVal_139_fresh_1) |#memory_int#2_6|) (= v_ArrVal_140_fresh_1 |v_main_#t~nondet1_31_fresh_1|) (< main_~i~0_5 5) (= v_ArrVal_139_fresh_1 (store (select |#memory_int#2_5| |main_~#string_A~0.base_4|) (+ main_~i~0_5 |main_~#string_A~0.offset_4|) |v_main_#t~nondet1_31_fresh_1|))) :named ssa_6))
(assert (! (and (= v_ArrVal_142_fresh_1 |v_main_#t~nondet1_32_fresh_1|) (= (store |#memory_int#2_6| |main_~#string_A~0.base_4| v_ArrVal_141_fresh_1) |#memory_int#2_7|) (<= |v_main_#t~nondet1_32_fresh_1| 127) (<= 0 (+ |v_main_#t~nondet1_32_fresh_1| 128)) (= v_ArrVal_141_fresh_1 (store (select |#memory_int#2_6| |main_~#string_A~0.base_4|) (+ main_~i~0_6 |main_~#string_A~0.offset_4|) |v_main_#t~nondet1_32_fresh_1|)) (= main_~i~0_7 (+ main_~i~0_6 1)) (< main_~i~0_6 5)) :named ssa_7))
(assert (! (and (= v_ArrVal_144_fresh_1 (store (select |#memory_int#2_7| |main_~#string_A~0.base_4|) (+ main_~i~0_7 |main_~#string_A~0.offset_4|) v_ArrVal_143_fresh_1)) (<= 0 (+ |v_main_#t~nondet1_33_fresh_1| 128)) (= main_~i~0_8 (+ main_~i~0_7 1)) (<= |v_main_#t~nondet1_33_fresh_1| 127) (= |#memory_int#2_8| (store |#memory_int#2_7| |main_~#string_A~0.base_4| v_ArrVal_144_fresh_1)) (< main_~i~0_7 5) (= v_ArrVal_143_fresh_1 |v_main_#t~nondet1_33_fresh_1|)) :named ssa_8))
(assert (! (and (= v_ArrVal_145_fresh_1 |v_main_#t~nondet1_34_fresh_1|) (= main_~i~0_9 (+ main_~i~0_8 1)) (= (store |#memory_int#2_8| |main_~#string_A~0.base_4| v_ArrVal_146_fresh_1) |#memory_int#2_9|) (= v_ArrVal_146_fresh_1 (store (select |#memory_int#2_8| |main_~#string_A~0.base_4|) (+ main_~i~0_8 |main_~#string_A~0.offset_4|) v_ArrVal_145_fresh_1)) (< main_~i~0_8 5) (<= 0 (+ |v_main_#t~nondet1_34_fresh_1| 128)) (<= |v_main_#t~nondet1_34_fresh_1| 127)) :named ssa_9))
...
(assert (! (and (= (store |#memory_int#1_3| |main_~#string_B~0.base_4| v_ArrVal_148_fresh_1) |#memory_int#1_13|) (= main_~i~0_13 (+ main_~i~0_12 1)) (<= |v_main_#t~nondet4_30_fresh_1| 127) (<= 0 (+ |v_main_#t~nondet4_30_fresh_1| 128)) (= v_ArrVal_147_fresh_1 |v_main_#t~nondet4_30_fresh_1|) (< main_~i~0_12 5) (= v_ArrVal_148_fresh_1 (store (select |#memory_int#1_3| |main_~#string_B~0.base_4|) (+ main_~i~0_12 |main_~#string_B~0.offset_4|) v_ArrVal_147_fresh_1))) :named ssa_13))
(assert (! (and (= v_ArrVal_149_fresh_1 |v_main_#t~nondet4_31_fresh_1|) (= main_~i~0_14 (+ main_~i~0_13 1)) (= (store |#memory_int#1_13| |main_~#string_B~0.base_4| v_ArrVal_150_fresh_1) |#memory_int#1_14|) (= (store (select |#memory_int#1_13| |main_~#string_B~0.base_4|) (+ main_~i~0_13 |main_~#string_B~0.offset_4|) v_ArrVal_149_fresh_1) v_ArrVal_150_fresh_1) (< main_~i~0_13 5) (<= 0 (+ |v_main_#t~nondet4_31_fresh_1| 128)) (<= |v_main_#t~nondet4_31_fresh_1| 127)) :named ssa_14))
(assert (! (and (<= |v_main_#t~nondet4_32_fresh_1| 127) (<= 0 (+ |v_main_#t~nondet4_32_fresh_1| 128)) (= main_~i~0_15 (+ main_~i~0_14 1)) (= (store |#memory_int#1_14| |main_~#string_B~0.base_4| v_ArrVal_151_fresh_1) |#memory_int#1_15|) (= v_ArrVal_151_fresh_1 (store (select |#memory_int#1_14| |main_~#string_B~0.base_4|) (+ main_~i~0_14 |main_~#string_B~0.offset_4|) |v_main_#t~nondet4_32_fresh_1|)) (< main_~i~0_14 5) (= v_ArrVal_152_fresh_1 |v_main_#t~nondet4_32_fresh_1|)) :named ssa_15))
(assert (! (and (= v_ArrVal_153_fresh_1 (store (select |#memory_int#1_15| |main_~#string_B~0.base_4|) (+ main_~i~0_15 |main_~#string_B~0.offset_4|) |v_main_#t~nondet4_33_fresh_1|)) (= main_~i~0_16 (+ main_~i~0_15 1)) (<= 0 (+ |v_main_#t~nondet4_33_fresh_1| 128)) (= v_ArrVal_154_fresh_1 |v_main_#t~nondet4_33_fresh_1|) (<= |v_main_#t~nondet4_33_fresh_1| 127) (= |#memory_int#1_16| (store |#memory_int#1_15| |main_~#string_B~0.base_4| v_ArrVal_153_fresh_1)) (< main_~i~0_15 5)) :named ssa_16))
(assert (! (and (= v_ArrVal_156_fresh_1 (store (select |#memory_int#1_16| |main_~#string_B~0.base_4|) (+ main_~i~0_16 |main_~#string_B~0.offset_4|) v_ArrVal_155_fresh_1)) (= main_~i~0_17 (+ main_~i~0_16 1)) (<= 0 (+ |v_main_#t~nondet4_34_fresh_1| 128)) (<= |v_main_#t~nondet4_34_fresh_1| 127) (= (store |#memory_int#1_16| |main_~#string_B~0.base_4| v_ArrVal_156_fresh_1) |#memory_int#1_17|) (= v_ArrVal_155_fresh_1 |v_main_#t~nondet4_34_fresh_1|) (< main_~i~0_16 5)) :named ssa_17))
...
(assert (! (and (= |v_main_#t~post8_3_fresh_1| main_~nc_A~0_20) (not (= |main_#t~mem7_21| 0)) (= (+ |v_main_#t~post8_3_fresh_1| 1) main_~nc_A~0_22)) :named ssa_22))
...
(assert (! (and (= |v_main_#t~post10_5_fresh_1| main_~nc_B~0_25) (= (+ |v_main_#t~post10_5_fresh_1| 1) main_~nc_B~0_27) (not (= |main_#t~mem9_26| 0))) :named ssa_27))
...
(assert (! (and (= main_~j~0_32 (+ main_~j~0_30 1)) (= |main_#t~mem12_31| |main_#t~mem11_31|) (= main_~i~0_32 (+ main_~i~0_30 1))) :named ssa_32))
(assert (! (or (<= main_~nc_B~0_27 main_~j~0_32) (<= main_~nc_A~0_22 main_~i~0_32)) :named ssa_33))
(assert (! (= main_~found~0_34 (ite (< main_~nc_B~0_27 (+ main_~j~0_32 1)) 1 0)) :named ssa_34))
(assert (! true :named ssa_35_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_35| (ite (or (= main_~found~0_34 0) (= main_~found~0_34 1)) 1 0)) :named ssa_35_LocVarAssigCall))
