...
(set-info :ultimate-id prefixsum_iter.c_AllErrorsAtOnce_Iteration14)
...
(declare-fun |v_#Ultimate.meminit_#sizeOfFieldsInParam_31_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#productInParam_31_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#ptr.offsetInParam_31_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#amountOfFieldsInParam_31_fresh_1| () Int)
...
(declare-fun |v_#Ultimate.meminit_#sizeOfFieldsInParam_32_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#ptr.offsetInParam_32_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#productInParam_32_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#amountOfFieldsInParam_32_fresh_1| () Int)
...
(declare-fun |downsweep_#in~a.offset_46| () Int)
(declare-fun |downsweep_#in~space_46| () Int)
(declare-fun main_~a~0.base_46 () Int)
(declare-fun |downsweep_#in~n_46| () Int)
(declare-fun |downsweep_#in~a.base_46| () Int)
(declare-fun main_~n~0_46 () Int)
(declare-fun main_~a~0.offset_46 () Int)
(declare-fun main_~space~1_46 () Int)
(declare-fun downsweep_~n_47 () Int)
(declare-fun downsweep_~space_47 () Int)
(declare-fun downsweep_~a.offset_47 () Int)
(declare-fun downsweep_~a.base_47 () Int)
...
(assert (! (and (not (= |main_#t~malloc15.base_21| 0)) (= |#valid_21| (store |#valid_3| |main_#t~malloc15.base_21| v_ArrVal_269_fresh_1)) (< |main_#t~malloc15.base_21| |#StackHeapBarrier_-1|) (= v_ArrVal_270_fresh_1 (* (mod main_~n~0_4 1073741824) 4)) (= |main_#t~malloc15.offset_21| 0) (= |#length_21| (store |#length_3| |main_#t~malloc15.base_21| v_ArrVal_270_fresh_1)) (= (select |#valid_3| |main_#t~malloc15.base_21|) 0) (= v_ArrVal_269_fresh_1 1)) :named ssa_21))
(assert (! (= |old(#memory_int#1)_22| |#memory_int#1_22|) :named ssa_22_GlobVarAssigCall))
(assert (! (and (= |#Ultimate.meminit_#ptr.base_22| |main_#t~malloc15.base_21|) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_31_fresh_1|) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_31_fresh_1| 4) (= |v_#Ultimate.meminit_#ptr.offsetInParam_31_fresh_1| |main_#t~malloc15.offset_21|) (= (* main_~n~0_4 4) |v_#Ultimate.meminit_#productInParam_31_fresh_1|)) :named ssa_22_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_22| |#memory_int#1_3|) :named ssa_22_OldVarAssigCall))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_271_fresh_1) (= (store |#memory_int#1_22| |#Ultimate.meminit_#ptr.base_22| v_ArrVal_271_fresh_1) |#memory_int#1_23|)) :named ssa_23))
(assert (! true :named ssa_24_return))
(assert (! (and (= (select |#valid_21| |main_#t~malloc16.base_25|) 0) (= |#length_25| (store |#length_21| |main_#t~malloc16.base_25| v_ArrVal_273_fresh_1)) (not (= |main_#t~malloc16.base_25| 0)) (= v_ArrVal_273_fresh_1 (* (mod main_~n~0_4 1073741824) 4)) (= |main_#t~malloc16.offset_25| 0) (= |#valid_25| (store |#valid_21| |main_#t~malloc16.base_25| v_ArrVal_272_fresh_1)) (= main_~a~0.offset_25 |main_#t~malloc15.offset_21|) (= main_~a~0.base_25 |main_#t~malloc15.base_21|) (< |main_#t~malloc16.base_25| |#StackHeapBarrier_-1|) (= v_ArrVal_272_fresh_1 1)) :named ssa_25))
(assert (! (= |old(#memory_int#1)_26| |#memory_int#1_26|) :named ssa_26_GlobVarAssigCall))
(assert (! (and (= |v_#Ultimate.meminit_#ptr.offsetInParam_32_fresh_1| |main_#t~malloc16.offset_25|) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_32_fresh_1|) (= (* main_~n~0_4 4) |v_#Ultimate.meminit_#productInParam_32_fresh_1|) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_32_fresh_1| 4) (= |#Ultimate.meminit_#ptr.base_26| |main_#t~malloc16.base_25|)) :named ssa_26_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_26| |#memory_int#1_23|) :named ssa_26_OldVarAssigCall))
(assert (! (and (= |#memory_int#1_27| (store |#memory_int#1_26| |#Ultimate.meminit_#ptr.base_26| v_ArrVal_274_fresh_1)) (= ((as const (Array Int Int)) 0) v_ArrVal_274_fresh_1)) :named ssa_27))
...
(assert (! (and (< main_~i~1_29 main_~n~0_4) (= (store |#memory_int#1_27| main_~a0~0.base_29 v_ArrVal_276_fresh_1) |#memory_int#1_30|) (= v_ArrVal_275_fresh_1 (select (select |#memory_int#1_27| main_~a~0.base_25) (+ main_~a~0.offset_25 (* main_~i~1_29 4)))) (= v_ArrVal_276_fresh_1 (store (select |#memory_int#1_27| main_~a0~0.base_29) (+ main_~a0~0.offset_29 (* main_~i~1_29 4)) v_ArrVal_275_fresh_1)) (= main_~i~1_30 (+ main_~i~1_29 1))) :named ssa_30))
(assert (! (and (< main_~i~1_30 main_~n~0_4) (= v_ArrVal_278_fresh_1 (store (select |#memory_int#1_30| main_~a0~0.base_29) (+ main_~a0~0.offset_29 (* main_~i~1_30 4)) v_ArrVal_277_fresh_1)) (= (store |#memory_int#1_30| main_~a0~0.base_29 v_ArrVal_278_fresh_1) |#memory_int#1_31|) (= v_ArrVal_277_fresh_1 (select (select |#memory_int#1_30| main_~a~0.base_25) (+ main_~a~0.offset_25 (* main_~i~1_30 4)))) (= main_~i~1_31 (+ main_~i~1_30 1))) :named ssa_31))
...
(assert (! (and (= v_ArrVal_280_fresh_1 (+ (select (select |#memory_int#1_33| upsweep_~a.base_34) (+ (* upsweep_~left~0_35 4) upsweep_~a.offset_34)) (select (select |#memory_int#1_33| upsweep_~a.base_34) (+ (* upsweep_~left~0_35 4) upsweep_~a.offset_34 (* upsweep_~space~0_34 4))))) (< upsweep_~left~0_35 upsweep_~n_34) (= (store (select |#memory_int#1_33| upsweep_~a.base_34) (+ (* upsweep_~left~0_35 4) upsweep_~a.offset_34 (* upsweep_~space~0_34 4)) (+ (select (select |#memory_int#1_33| upsweep_~a.base_34) (+ (* upsweep_~left~0_35 4) upsweep_~a.offset_34)) (select (select |#memory_int#1_33| upsweep_~a.base_34) (+ (* upsweep_~left~0_35 4) upsweep_~a.offset_34 (* upsweep_~space~0_34 4))))) v_ArrVal_279_fresh_1) (= (+ (* 2 upsweep_~space~0_34) upsweep_~left~0_35) upsweep_~left~0_36) (= |#memory_int#1_36| (store |#memory_int#1_33| upsweep_~a.base_34 v_ArrVal_279_fresh_1))) :named ssa_36))
...
(assert (! (<= upsweep_~n_34 upsweep_~left~0_39) :named ssa_40))
(assert (! (= (* 2 upsweep_~space~0_38) upsweep_~space~0_41) :named ssa_41))
(assert (! (<= upsweep_~n_34 upsweep_~space~0_41) :named ssa_42))
(assert (! (= |upsweep_#res_43| upsweep_~space~0_41) :named ssa_43))
(assert (! (= |main_#t~ret19_44| |upsweep_#res_43|) :named ssa_44_return))
(assert (! (and (<= 0 (+ |main_#t~ret19_44| 2147483648)) (<= |main_#t~ret19_44| 2147483647) (= |main_#t~ret19_44| main_~space~1_45)) :named ssa_45))
(assert (! (= |old(#memory_int#1)_46| |#memory_int#1_46|) :named ssa_46_GlobVarAssigCall))
(assert (! (and (= |downsweep_#in~a.base_46| main_~a~0.base_25) (= main_~n~0_4 |downsweep_#in~n_46|) (= |downsweep_#in~space_46| main_~space~1_45) (= main_~a~0.offset_25 |downsweep_#in~a.offset_46|)) :named ssa_46_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_46| |#memory_int#1_36|) :named ssa_46_OldVarAssigCall))
(assert (! (and (= downsweep_~space_47 (ite (and (not (= (mod |downsweep_#in~space_46| 2) 0)) (< |downsweep_#in~space_46| 0)) (+ (div |downsweep_#in~space_46| 2) 1) (div |downsweep_#in~space_46| 2))) (= v_ArrVal_282_fresh_1 (store (select |#memory_int#1_46| downsweep_~a.base_47) (+ downsweep_~a.offset_47 (- 4) (* downsweep_~n_47 4)) v_ArrVal_281_fresh_1)) (= v_ArrVal_281_fresh_1 0) (= downsweep_~a.base_47 |downsweep_#in~a.base_46|) (= downsweep_~a.offset_47 |downsweep_#in~a.offset_46|) (= downsweep_~n_47 |downsweep_#in~n_46|) (= (store |#memory_int#1_46| downsweep_~a.base_47 v_ArrVal_282_fresh_1) |#memory_int#1_47|)) :named ssa_47))
(assert (! (and (< 0 downsweep_~space_47) (= (+ downsweep_~right~1_48 1) (* 2 downsweep_~space_47))) :named ssa_48))
(assert (! (and (= v_ArrVal_285_fresh_1 (select (select |#memory_int#1_47| downsweep_~a.base_47) (+ downsweep_~a.offset_47 (* downsweep_~right~1_48 4)))) (< downsweep_~right~1_48 downsweep_~n_47) (= downsweep_~right~1_49 (+ (* 2 downsweep_~space_47) downsweep_~right~1_48)) (= (store |#memory_int#1_47| downsweep_~a.base_47 v_ArrVal_283_fresh_1) |#memory_int#1_49|) (= v_ArrVal_284_fresh_1 (+ (select (select |#memory_int#1_47| downsweep_~a.base_47) (+ downsweep_~a.offset_47 (* downsweep_~right~1_48 4))) (select (select |#memory_int#1_47| downsweep_~a.base_47) (+ downsweep_~a.offset_47 (* downsweep_~right~1_48 4) (* downsweep_~space_47 (- 4)))))) (= v_ArrVal_283_fresh_1 (store (store (select |#memory_int#1_47| downsweep_~a.base_47) (+ downsweep_~a.offset_47 (* downsweep_~right~1_48 4)) (+ (select (select |#memory_int#1_47| downsweep_~a.base_47) (+ downsweep_~a.offset_47 (* downsweep_~right~1_48 4))) (select (select |#memory_int#1_47| downsweep_~a.base_47) (+ downsweep_~a.offset_47 (* downsweep_~right~1_48 4) (* downsweep_~space_47 (- 4)))))) (+ downsweep_~a.offset_47 (* downsweep_~right~1_48 4) (* downsweep_~space_47 (- 4))) (select (select |#memory_int#1_47| downsweep_~a.base_47) (+ downsweep_~a.offset_47 (* downsweep_~right~1_48 4)))))) :named ssa_49))
(assert (! (<= downsweep_~n_47 downsweep_~right~1_49) :named ssa_50))
...
(assert (! (not true) :named ssa_postcond))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_286_fresh_1) (= (store |#memory_int#1_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_286_fresh_1) |#memory_int#1_0|)) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! true :named ssa_-2_PendingContext))
...
(assert (! (= |#memory_int#1_-1| |old(#memory_int#1)_-1|) :named ssa_precond))
(assert (! (not true) :named ssa_postcond))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_287_fresh_1) (= |#memory_int#1_0| (store |#memory_int#1_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_287_fresh_1))) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! true :named ssa_-2_PendingContext))
...
(declare-fun upsweep_~n_8 () Int)
(declare-fun upsweep_~space~0_9 () Int)
(declare-fun |upsweep_#res_9| () Int)
...
(assert (! (and (= (store (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0 (* upsweep_~space~0_0 4)) (+ (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0)) (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0 (* upsweep_~space~0_0 4))))) v_ArrVal_288_fresh_1) (= |#memory_int#1_2| (store |#memory_int#1_-1| upsweep_~a.base_0 v_ArrVal_288_fresh_1)) (< upsweep_~left~0_1 upsweep_~n_0) (= (+ (* 2 upsweep_~space~0_0) upsweep_~left~0_1) upsweep_~left~0_2) (= v_ArrVal_289_fresh_1 (+ (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0)) (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0 (* upsweep_~space~0_0 4)))))) :named ssa_2))
...
(assert (! (<= upsweep_~n_0 upsweep_~left~0_5) :named ssa_6))
(assert (! (= (* 2 upsweep_~space~0_4) upsweep_~space~0_7) :named ssa_7))
(assert (! (<= upsweep_~n_0 upsweep_~space~0_7) :named ssa_8))
(assert (! (= |upsweep_#res_9| upsweep_~space~0_7) :named ssa_9))
(assert (! (= |main_#t~ret19_10| |upsweep_#res_9|) :named ssa_10_return))
(assert (! true :named ssa_-2_PendingContext))
...
(assert (! (= |#memory_int#1_-1| |old(#memory_int#1)_-1|) :named ssa_precond))
(assert (! (not false) :named ssa_postcond))
(assert (! (and (= v_ArrVal_291_fresh_1 (store (select |#memory_int#1_-1| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (- 4) (* downsweep_~n_0 4)) v_ArrVal_290_fresh_1)) (= downsweep_~space_0 (ite (and (not (= (mod |downsweep_#in~space_-1| 2) 0)) (< |downsweep_#in~space_-1| 0)) (+ (div |downsweep_#in~space_-1| 2) 1) (div |downsweep_#in~space_-1| 2))) (= v_ArrVal_290_fresh_1 0) (= downsweep_~a.base_0 |downsweep_#in~a.base_-1|) (= downsweep_~a.offset_0 |downsweep_#in~a.offset_-1|) (= (store |#memory_int#1_-1| downsweep_~a.base_0 v_ArrVal_291_fresh_1) |#memory_int#1_0|) (= downsweep_~n_0 |downsweep_#in~n_-1|)) :named ssa_0))
(assert (! (and (< 0 downsweep_~space_0) (= (+ downsweep_~right~1_1 1) (* 2 downsweep_~space_0))) :named ssa_1))
(assert (! (and (= (store |#memory_int#1_0| downsweep_~a.base_0 v_ArrVal_292_fresh_1) |#memory_int#1_2|) (= v_ArrVal_294_fresh_1 (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4)))) (< downsweep_~right~1_1 downsweep_~n_0) (= v_ArrVal_293_fresh_1 (+ (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4))) (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4) (* downsweep_~space_0 (- 4)))))) (= downsweep_~right~1_2 (+ (* 2 downsweep_~space_0) downsweep_~right~1_1)) (= v_ArrVal_292_fresh_1 (store (store (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4)) (+ (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4))) (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4) (* downsweep_~space_0 (- 4)))))) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4) (* downsweep_~space_0 (- 4))) (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4)))))) :named ssa_2))
