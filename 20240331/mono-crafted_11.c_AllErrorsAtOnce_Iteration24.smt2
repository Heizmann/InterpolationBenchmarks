...
(set-info :ultimate-id mono-crafted_11.c_AllErrorsAtOnce_Iteration24)
...
(assert (! (<= 100000000 (mod main_~x~0_48 4294967296)) :named ssa_49))
(assert (! true :named ssa_50_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_50| (ite (= (mod main_~x~0_48 2) 0) 1 0)) :named ssa_50_LocVarAssigCall))
