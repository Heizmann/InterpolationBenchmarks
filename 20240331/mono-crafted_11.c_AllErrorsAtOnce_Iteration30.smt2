...
(set-info :ultimate-id mono-crafted_11.c_AllErrorsAtOnce_Iteration30)
...
(assert (! (<= 100000000 (mod main_~x~0_60 4294967296)) :named ssa_61))
(assert (! true :named ssa_62_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_62| (ite (= (mod main_~x~0_60 2) 0) 1 0)) :named ssa_62_LocVarAssigCall))
