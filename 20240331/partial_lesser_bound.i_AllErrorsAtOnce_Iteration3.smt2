...
(set-info :ultimate-id partial_lesser_bound.i_AllErrorsAtOnce_Iteration3)
...
(declare-fun |main_#t~malloc2.offset_8| () Int)
(declare-fun |v_main_#t~malloc2.base_8_fresh_1| () Int)
...
(declare-fun |main_#t~mem4.base_11| () Int)
(declare-fun |main_#t~mem4.offset_11| () Int)
(declare-fun |__VERIFIER_assert_#in~cond_12| () Int)
(declare-fun |main_#t~mem4.base_12| () Int)
(declare-fun |main_#t~mem4.offset_12| () Int)
...
(assert (! (and (= (store (select |#memory_$Pointer$#1.offset_3| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_4 4)) v_ArrVal_12_fresh_1) v_ArrVal_13_fresh_1) (= (store (select |#memory_int#1_3| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_4 4)) (select (select |#memory_int#1_5| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_4 4)))) v_ArrVal_11_fresh_1) (= (store (select |#memory_$Pointer$#1.base_3| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_4 4)) 0) v_ArrVal_14_fresh_1) (= |#memory_int#1_5| (store |#memory_int#1_3| |~#a~0.base_1| v_ArrVal_11_fresh_1)) (= v_ArrVal_12_fresh_1 0) (= v_ArrVal_15_fresh_1 0) (= (select (select |#memory_int#1_5| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_4 4))) v_ArrVal_16_fresh_1) (= (store |#memory_$Pointer$#1.base_3| |~#a~0.base_1| v_ArrVal_14_fresh_1) |#memory_$Pointer$#1.base_5|) (= (store |#memory_$Pointer$#1.offset_3| |~#a~0.base_1| v_ArrVal_13_fresh_1) |#memory_$Pointer$#1.offset_5|) (= ~i~0_5 (+ ~i~0_4 1)) (< ~i~0_4 1000000)) :named ssa_5))
(assert (! (<= 1000000 ~i~0_5) :named ssa_6))
(assert (! (= ~i~0_7 0) :named ssa_7))
(assert (! (and (= ~i~0_8 (+ ~i~0_7 1)) (= v_ArrVal_18_fresh_1 1) (= v_ArrVal_24_fresh_1 (store (select |#memory_$Pointer$#1.offset_5| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_7 4)) v_ArrVal_20_fresh_1)) (= |#memory_$Pointer$#1.offset_8| (store |#memory_$Pointer$#1.offset_5| |~#a~0.base_1| v_ArrVal_24_fresh_1)) (= (store |#memory_$Pointer$#1.base_5| |~#a~0.base_1| v_ArrVal_19_fresh_1) |#memory_$Pointer$#1.base_8|) (= v_ArrVal_20_fresh_1 0) (= 4 v_ArrVal_22_fresh_1) (not (= |v_main_#t~malloc2.base_8_fresh_1| 0)) (= (store |#length_3| |v_main_#t~malloc2.base_8_fresh_1| v_ArrVal_22_fresh_1) |#length_8|) (< ~i~0_7 500000) (< |v_main_#t~malloc2.base_8_fresh_1| |#StackHeapBarrier_-1|) (= v_ArrVal_19_fresh_1 (store (select |#memory_$Pointer$#1.base_5| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_7 4)) |v_main_#t~malloc2.base_8_fresh_1|)) (= (store |#memory_int#1_5| |~#a~0.base_1| v_ArrVal_21_fresh_1) |#memory_int#1_8|) (= |v_main_#t~malloc2.base_8_fresh_1| v_ArrVal_23_fresh_1) (= v_ArrVal_17_fresh_1 (select (select |#memory_int#1_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_7 4)))) (= (store |#valid_3| |v_main_#t~malloc2.base_8_fresh_1| v_ArrVal_18_fresh_1) |#valid_8|) (= (store (select |#memory_int#1_5| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_7 4)) v_ArrVal_17_fresh_1) v_ArrVal_21_fresh_1) (= (select |#valid_3| |v_main_#t~malloc2.base_8_fresh_1|) 0)) :named ssa_8))
(assert (! (<= 500000 ~i~0_8) :named ssa_9))
(assert (! (= ~i~0_10 0) :named ssa_10))
(assert (! (and (< ~i~0_10 500000) (= |main_#t~mem4.offset_11| (select (select |#memory_$Pointer$#1.offset_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* 4 ~i~0_10)))) (= |main_#t~mem4.base_11| (select (select |#memory_$Pointer$#1.base_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* 4 ~i~0_10))))) :named ssa_11))
(assert (! true :named ssa_12_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_12| (ite (or (not (= |main_#t~mem4.offset_11| 0)) (not (= |main_#t~mem4.base_11| 0))) 1 0)) :named ssa_12_LocVarAssigCall))
...
(assert (! (and (< 0 |#StackHeapBarrier_-1|) (= (select |#valid_-2| 0) 0) (= (select |#valid_-2| 2) 1) (= |~#a~0.offset_0| 0) (= 23 (select |#length_-2| 2)) (= 4000000 (select |#length_-2| 3)) (= (select |#valid_-2| 3) 1) (= |~#a~0.base_0| 3) (= (store |#memory_$Pointer$#1.offset_-1| |~#a~0.base_0| v_ArrVal_25_fresh_1) |#memory_$Pointer$#1.offset_0|) (= ((as const (Array Int Int)) 0) v_ArrVal_26_fresh_1) (= (store |#memory_$Pointer$#1.base_-1| |~#a~0.base_0| v_ArrVal_26_fresh_1) |#memory_$Pointer$#1.base_0|) (= (select |#valid_-2| 1) 1) (= ~i~0_0 0) (= ((as const (Array Int Int)) 0) v_ArrVal_25_fresh_1) (= (select (select |#memory_int#0_-2| 1) 1) 0) (= 2 (select |#length_-2| 1)) (= (select (select |#memory_int#0_-2| 1) 0) 48)) :named ssa_0))
