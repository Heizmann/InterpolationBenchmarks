...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:13:08+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id psyco_abp_1-3.c_AllErrorsAtOnce_Iteration6)
...
(declare-fun v_main_~P2~0_13_fresh_1 () Int)
(declare-fun v_main_~P7~0_13_fresh_1 () Int)
(declare-fun v_main_~P5~0_13_fresh_1 () Int)
(declare-fun |main_#t~nondet13_7| () Int)
(declare-fun |main_#t~nondet13_8| () Int)
(declare-fun v_main_~method_id~0_73_fresh_1 () Int)
...
(declare-fun v_main_~P7~0_14_fresh_1 () Int)
(declare-fun v_main_~P2~0_14_fresh_1 () Int)
(declare-fun v_main_~P5~0_14_fresh_1 () Int)
(declare-fun |main_#t~nondet14_13| () Int)
(declare-fun |main_#t~nondet14_14| () Int)
(declare-fun v_main_~method_id~0_74_fresh_1 () Int)
...
(declare-fun v_main_~P7~0_15_fresh_1 () Int)
(declare-fun v_main_~P2~0_15_fresh_1 () Int)
(declare-fun v_main_~P5~0_15_fresh_1 () Int)
(declare-fun |main_#t~nondet26_21| () Int)
(declare-fun |main_#t~nondet26_22| () Int)
(declare-fun v_main_~method_id~0_75_fresh_1 () Int)
(declare-fun main_~this_expect~0_24 () Int)
(declare-fun main_~P1~0_24 () Int)
(declare-fun main_~this_buffer_empty~0_24 () Int)
...
(assert (! (and (<= main_~P4~0_6 2147483647) (<= 0 (+ main_~P1~0_6 2147483648)) (<= v_main_~P7~0_13_fresh_1 2147483647) (<= 0 (+ v_main_~P2~0_13_fresh_1 2147483648)) (<= main_~P3~0_6 2147483647) (<= main_~P8~0_6 2147483647) (<= 0 (+ main_~P8~0_6 2147483648)) (<= 0 (+ main_~P6~0_6 2147483648)) (<= v_main_~P5~0_13_fresh_1 2147483647) (<= 0 (+ main_~P3~0_6 2147483648)) (<= 0 (+ main_~P9~0_6 2147483648)) (<= 0 (+ v_main_~P7~0_13_fresh_1 2147483648)) (<= main_~P9~0_6 2147483647) (<= 0 (+ main_~P4~0_6 2147483648)) (<= main_~P1~0_6 2147483647) (<= 0 (+ v_main_~P5~0_13_fresh_1 2147483648)) (<= v_main_~P2~0_13_fresh_1 2147483647) (<= main_~P6~0_6 2147483647)) :named ssa_6))
...
(assert (! (= 1 v_main_~method_id~0_73_fresh_1) :named ssa_9))
(assert (! (and (= main_~this_buffer_empty~0_10 1) (= main_~q~0_10 1) (= main_~this_expect~0_10 0)) :named ssa_10))
(assert (! (and (<= main_~P4~0_11 2147483647) (<= v_main_~P7~0_14_fresh_1 2147483647) (<= 0 (+ v_main_~P7~0_14_fresh_1 2147483648)) (<= 0 (+ v_main_~P5~0_14_fresh_1 2147483648)) (<= 0 (+ main_~P1~0_11 2147483648)) (<= main_~P3~0_11 2147483647) (<= main_~P8~0_11 2147483647) (<= 0 (+ main_~P8~0_11 2147483648)) (<= 0 (+ main_~P6~0_11 2147483648)) (<= 0 (+ main_~P3~0_11 2147483648)) (<= 0 (+ main_~P9~0_11 2147483648)) (<= v_main_~P2~0_14_fresh_1 2147483647) (<= main_~P9~0_11 2147483647) (<= 0 (+ main_~P4~0_11 2147483648)) (<= main_~P1~0_11 2147483647) (<= v_main_~P5~0_14_fresh_1 2147483647) (<= main_~P6~0_11 2147483647) (<= 0 (+ v_main_~P2~0_14_fresh_1 2147483648))) :named ssa_11))
...
(assert (! (and (= (ite (and (< main_~P1~0_11 0) (not (= (mod main_~P1~0_11 2) 0))) (+ (- 2) (mod main_~P1~0_11 2)) (mod main_~P1~0_11 2)) 0) (= 2 v_main_~method_id~0_74_fresh_1)) :named ssa_15))
...
(assert (! (and (<= main_~P4~0_17 2147483647) (<= 0 (+ main_~P1~0_17 2147483648)) (<= 0 (+ v_main_~P2~0_15_fresh_1 2147483648)) (<= main_~P3~0_17 2147483647) (<= main_~P8~0_17 2147483647) (<= 0 (+ main_~P8~0_17 2147483648)) (<= 0 (+ main_~P6~0_17 2147483648)) (<= 0 (+ main_~P3~0_17 2147483648)) (<= 0 (+ main_~P9~0_17 2147483648)) (<= v_main_~P5~0_15_fresh_1 2147483647) (<= v_main_~P7~0_15_fresh_1 2147483647) (<= 0 (+ v_main_~P7~0_15_fresh_1 2147483648)) (<= v_main_~P2~0_15_fresh_1 2147483647) (<= main_~P9~0_17 2147483647) (<= 0 (+ main_~P4~0_17 2147483648)) (<= 0 (+ v_main_~P5~0_15_fresh_1 2147483648)) (<= main_~P1~0_17 2147483647) (<= main_~P6~0_17 2147483647)) :named ssa_17))
...
(assert (! (not (= |main_#t~nondet26_21| 0)) :named ssa_22))
(assert (! (and (= 2 v_main_~method_id~0_75_fresh_1) (= (ite (and (< main_~P1~0_17 0) (not (= (mod main_~P1~0_17 2) 0))) (+ (mod main_~P1~0_17 2) (- 2)) (mod main_~P1~0_17 2)) 0)) :named ssa_23))
(assert (! (and (= (ite (and (not (= (mod main_~P1~0_17 2) 0)) (< main_~P1~0_17 0)) (+ (- 2) (mod main_~P1~0_17 2)) (mod main_~P1~0_17 2)) 0) (= (mod main_~this_expect~0_16 2) (mod (ite (and (not (= (mod main_~P1~0_17 2) 0)) (< main_~P1~0_17 0)) (+ (- 2) (mod main_~P1~0_17 2)) (mod main_~P1~0_17 2)) 4294967296)) (= (mod main_~this_buffer_empty~0_16 4294967296) 1)) :named ssa_24))
