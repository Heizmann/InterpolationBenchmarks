...
(set-info :ultimate-id mbpr4.c_AllErrorsAtOnce_Iteration3)
...
(declare-fun |main_#t~short23_21| () Bool)
(declare-fun |v_main_#t~mem21_8_fresh_1| () Int)
(declare-fun |main_#t~short23_22| () Bool)
(declare-fun |v_main_#t~mem22_6_fresh_1| () Int)
(declare-fun |main_#t~short23_23| () Bool)
...
(assert (! (and (= |#length_5| (store |#length_3| |main_~#volArray~0.base_5| v_ArrVal_5_fresh_1)) (= 7 main_~CCCELVOL3~0_5) (= 5 main_~CCCELVOL4~0_5) (< 1 ~CELLCOUNT~0_4) (= v_ArrVal_5_fresh_1 (* (mod ~CELLCOUNT~0_4 1073741824) 4)) (= (select |#valid_3| |main_~#volArray~0.base_5|) 0) (= main_~MINVAL~0_5 2) (= 3 main_~CCCELVOL2~0_5) (= |#valid_5| (store |#valid_3| |main_~#volArray~0.base_5| v_ArrVal_6_fresh_1)) (not (= |main_~#volArray~0.base_5| 0)) (= v_ArrVal_6_fresh_1 1) (= main_~CCCELVOL1~0_5 1) (= |main_~#volArray~0.offset_5| 0) (< |#StackHeapBarrier_-1| |main_~#volArray~0.base_5|)) :named ssa_5))
...
(assert (! (< (ite (and (not (= (mod ~CELLCOUNT~0_4 4) 0)) (< ~CELLCOUNT~0_4 0)) (+ (div ~CELLCOUNT~0_4 4) 1) (div ~CELLCOUNT~0_4 4)) main_~i~0_12) :named ssa_13))
(assert (! (= main_~i~0_14 1) :named ssa_14))
(assert (! (< (ite (and (not (= (mod ~CELLCOUNT~0_4 4) 0)) (< ~CELLCOUNT~0_4 0)) (+ (div ~CELLCOUNT~0_4 4) 1) (div ~CELLCOUNT~0_4 4)) main_~i~0_14) :named ssa_15))
(assert (! (= main_~i~0_16 1) :named ssa_16))
(assert (! (< (ite (and (< ~CELLCOUNT~0_4 0) (not (= (mod ~CELLCOUNT~0_4 4) 0))) (+ (div ~CELLCOUNT~0_4 4) 1) (div ~CELLCOUNT~0_4 4)) main_~i~0_16) :named ssa_17))
(assert (! (= main_~i~0_18 1) :named ssa_18))
(assert (! (< (ite (and (< ~CELLCOUNT~0_4 0) (not (= (mod ~CELLCOUNT~0_4 4) 0))) (+ (div ~CELLCOUNT~0_4 4) 1) (div ~CELLCOUNT~0_4 4)) main_~i~0_18) :named ssa_19))
(assert (! (= main_~i~0_20 0) :named ssa_20))
(assert (! (and (or (and (<= main_~MINVAL~0_5 |v_main_#t~mem21_8_fresh_1|) |main_#t~short23_21|) (and (< |v_main_#t~mem21_8_fresh_1| main_~MINVAL~0_5) (not |main_#t~short23_21|))) (< main_~i~0_20 ~CELLCOUNT~0_4) (= (select (select |#memory_int#1_3| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_20 4))) |v_main_#t~mem21_8_fresh_1|)) :named ssa_21))
(assert (! (and (= |v_main_#t~mem22_6_fresh_1| (select (select |#memory_int#1_3| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_20 4)))) (not |main_#t~short23_21|) (or (and (not (= |v_main_#t~mem22_6_fresh_1| 0)) (not |main_#t~short23_22|)) (and |main_#t~short23_22| (= |v_main_#t~mem22_6_fresh_1| 0)))) :named ssa_22))
(assert (! true :named ssa_23_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_23| (ite |main_#t~short23_22| 1 0)) :named ssa_23_LocVarAssigCall))
...
(assert (! true :named ssa_precond))
(assert (! (not (and (<= 2 ~CELLCOUNT~0_-2) (= ~CELLCOUNT~0_-2 (* (div ~CELLCOUNT~0_-2 4) 4)))) :named ssa_postcond))
...
(assert (! (and (<= 2 ~CELLCOUNT~0_-2) (= ~CELLCOUNT~0_-2 (* (div ~CELLCOUNT~0_-2 4) 4))) :named ssa_-2_PendingContext))
