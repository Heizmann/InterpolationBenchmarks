...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:09:31+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id string_concat-noarr.i_AllErrorsAtOnce_Iteration23)
...
(assert (! (or (<= 1000000 main_~i~0_49) (= |main_#t~nondet3_50| 0)) :named ssa_51))
(assert (! (< main_~j~0_49 100) :named ssa_52))
(assert (! true :named ssa_53_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_53| (ite (< main_~i~0_49 200) 1 0)) :named ssa_53_LocVarAssigCall))
