...
(set-info :ultimate-id Addition03-1.c_AllErrorsAtOnce_Iteration11)
...
(declare-fun |main_#t~ret8_72| () Int)
(declare-fun |addition_#res_72| () Int)
(declare-fun main_~result~0_73 () Int)
(declare-fun |main_#t~ret8_73| () Int)
(declare-fun main_~result~0_74 () Int)
(declare-fun main_~m~0_74 () Int)
(declare-fun main_~n~0_74 () Int)
...
(assert (! (and (= 0 addition_~n_42) (= |addition_#res_43| addition_~m_42)) :named ssa_43))
...
(assert (! (= |addition_#res_70| |main_#t~ret8_72|) :named ssa_72_return))
(assert (! (and (<= |main_#t~ret8_72| 9223372036854775807) (<= 0 (+ |main_#t~ret8_72| 9223372036854775808)) (= main_~result~0_73 |main_#t~ret8_72|)) :named ssa_73))
(assert (! (and (< main_~result~0_73 200) (<= 100 main_~n~0_4) (<= 100 main_~m~0_4)) :named ssa_74))
(assert (! true :named ssa_75))
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 (and ssa_27 ssa_29_OldVarAssigCall ssa_20 ssa_41_GlobVarAssigCall ssa_17_LocVarAssigCall ssa_21_LocVarAssigCall ssa_64 ssa_5_LocVarAssigCall ssa_31 ssa_5_GlobVarAssigCall ssa_21_OldVarAssigCall ssa_68 ssa_7 ssa_44 ssa_16 ssa_6 ssa_26 ssa_55 ssa_67 ssa_34 ssa_17_GlobVarAssigCall ssa_25_GlobVarAssigCall ssa_40 ssa_10 ssa_14 ssa_25_OldVarAssigCall ssa_8 ssa_13_LocVarAssigCall ssa_63_return ssa_29_GlobVarAssigCall ssa_46 ssa_51_return ssa_47 ssa_53 ssa_13_OldVarAssigCall ssa_25_LocVarAssigCall ssa_37_LocVarAssigCall ssa_69_return ssa_45_return ssa_57_return ssa_58 ssa_33_GlobVarAssigCall ssa_19 ssa_61 ssa_33_LocVarAssigCall ssa_59 ssa_39 ssa_62 ssa_54_return ssa_43 ssa_13_GlobVarAssigCall ssa_41_OldVarAssigCall ssa_17_OldVarAssigCall ssa_38 ssa_12 ssa_32 ssa_5_OldVarAssigCall ssa_50 ssa_60_return ssa_65 ssa_72_return ssa_48_return ssa_41_LocVarAssigCall ssa_11 ssa_66_return ssa_28 ssa_29_LocVarAssigCall ssa_37_GlobVarAssigCall ssa_22 ssa_36 ssa_15 ssa_49 ssa_52 ssa_18 ssa_23 ssa_30 ssa_70 ssa_9_LocVarAssigCall ssa_56 ssa_9_OldVarAssigCall ssa_35 ssa_21_GlobVarAssigCall ssa_9_GlobVarAssigCall ssa_33_OldVarAssigCall ssa_42 ssa_71 ssa_24 ssa_37_OldVarAssigCall) ssa_73 ssa_74 (and ssa_75 ssa_postcond))
...
(declare-fun |addition_#t~ret4_64| () Int)
(declare-fun |addition_#res_64| () Int)
(declare-fun |main_#t~ret8_66| () Int)
(declare-fun |addition_#res_66| () Int)
(assert (! true :named ssa_precond))
(assert (! (not (<= main_~n~0_-2 9)) :named ssa_postcond))
...
(assert (! (and (<= 0 (+ 9223372036854775808 |addition_#t~ret4_63|)) (<= |addition_#t~ret4_63| 9223372036854775807) (= |addition_#res_64| |addition_#t~ret4_63|)) :named ssa_64))
(assert (! true :named ssa_65))
(assert (! (= |addition_#res_64| |main_#t~ret8_66|) :named ssa_66_return))
(assert (! true :named ssa_-2_PendingContext))
