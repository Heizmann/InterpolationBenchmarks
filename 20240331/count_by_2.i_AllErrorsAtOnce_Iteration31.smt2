...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration31)
...
(assert (! (<= 1000000 main_~i~0_34) :named ssa_35))
(assert (! true :named ssa_36_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_36| (ite (= main_~i~0_34 1000000) 1 0)) :named ssa_36_LocVarAssigCall))
