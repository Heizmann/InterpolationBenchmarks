...
(set-info :ultimate-id array3_pattern.c_AllErrorsAtOnce_Iteration1)
...
(declare-fun main_~sum1~0_15 () Int)
(declare-fun main_~sum2~0_15 () Int)
...
(assert (! (and (< |#StackHeapBarrier_-1| |main_~#array1~0.base_10|) (= main_~sum2~0_10 0) (= (+ main_~num~0_10 1) 0) (= (store (store |#valid_3| |main_~#array1~0.base_10| v_ArrVal_2_fresh_1) |main_~#array2~0.base_10| v_ArrVal_4_fresh_1) |#valid_10|) (= v_ArrVal_4_fresh_1 1) (= (* (mod ~ARR_SIZE~0_4 1073741824) 4) v_ArrVal_1_fresh_1) (= main_~count~0_10 0) (= main_~sum1~0_10 0) (= |main_~#array2~0.offset_10| 0) (= |main_~#array1~0.offset_10| 0) (not (= |main_~#array2~0.base_10| 0)) (= (select (store |#valid_3| |main_~#array1~0.base_10| v_ArrVal_2_fresh_1) |main_~#array2~0.base_10|) 0) (= v_ArrVal_2_fresh_1 1) (= (select |#valid_3| |main_~#array1~0.base_10|) 0) (= (* (mod ~ARR_SIZE~0_4 1073741824) 4) v_ArrVal_3_fresh_1) (< |#StackHeapBarrier_-1| |main_~#array2~0.base_10|) (= (store (store |#length_3| |main_~#array1~0.base_10| v_ArrVal_1_fresh_1) |main_~#array2~0.base_10| v_ArrVal_3_fresh_1) |#length_10|) (not (= |main_~#array1~0.base_10| 0))) :named ssa_10))
...
(assert (! (= (ite (= main_~sum1~0_10 main_~sum2~0_10) 1 0) |__VERIFIER_assert_#in~cond_15|) :named ssa_15_LocVarAssigCall))
