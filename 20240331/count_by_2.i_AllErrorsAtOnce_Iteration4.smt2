...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration4)
...
(assert (! (<= 1000000 main_~i~0_7) :named ssa_8))
(assert (! true :named ssa_9_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_9| (ite (= main_~i~0_7 1000000) 1 0)) :named ssa_9_LocVarAssigCall))
