...
(set-info :ultimate-id array_tiling_poly6.c_AllErrorsAtOnce_Iteration1)
...
(assert (! (and (not (= |main_~#a~0.base_10| 0)) (< |#StackHeapBarrier_-1| |main_~#a~0.base_10|) (= main_~i~0_10 0) (= |#valid_10| (store |#valid_3| |main_~#a~0.base_10| v_ArrVal_2_fresh_1)) (= |main_~#a~0.offset_10| 0) (= v_ArrVal_2_fresh_1 1) (= (store |#length_3| |main_~#a~0.base_10| v_ArrVal_1_fresh_1) |#length_10|) (= (select |#valid_3| |main_~#a~0.base_10|) 0) (= (* (mod main_~S~0_4 536870912) 8) v_ArrVal_1_fresh_1)) :named ssa_10))
