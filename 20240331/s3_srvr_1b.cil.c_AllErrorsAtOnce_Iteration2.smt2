...
(set-info :ultimate-id s3_srvr_1b.cil.c_AllErrorsAtOnce_Iteration2)
...
(declare-fun main_~blastFlag~0_11 () Int)
(declare-fun main_~s__state~0_11 () Int)
...
(assert (! (and (<= main_~s__state~0_9 8512) (< 2 main_~blastFlag~0_8)) :named ssa_11))
