...
(set-info :ultimate-id underapprox_1-2.c_AllErrorsAtOnce_Iteration4)
...
(assert (! (<= 6 (mod main_~x~0_6 4294967296)) :named ssa_7))
(assert (! true :named ssa_8_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_8| (mod (mod main_~y~0_6 4294967296) 3)) :named ssa_8_LocVarAssigCall))
