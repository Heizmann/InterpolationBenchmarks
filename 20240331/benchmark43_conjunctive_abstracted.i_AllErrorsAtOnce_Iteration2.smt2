...
(set-info :ultimate-id benchmark43_conjunctive_abstracted.i_AllErrorsAtOnce_Iteration2)
...
(assert (! (= |main_#t~bitwise3_7| 0) :named ssa_8))
(assert (! true :named ssa_9_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_9| (ite (or (= main_~y~0_4 100) (= main_~x~0_4 100)) 1 0)) :named ssa_9_LocVarAssigCall))
