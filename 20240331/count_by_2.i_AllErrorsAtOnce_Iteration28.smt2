...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration28)
...
(assert (! (<= 1000000 main_~i~0_31) :named ssa_32))
(assert (! true :named ssa_33_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_33| (ite (= main_~i~0_31 1000000) 1 0)) :named ssa_33_LocVarAssigCall))
