...
(set-info :ultimate-id lcp.c_AllErrorsAtOnce_Iteration1)
...
(declare-fun |lcp_#res_23| () Int)
(declare-fun lcp_~l~0_23 () Int)
(declare-fun |main_#t~ret18_24| () Int)
(declare-fun |lcp_#res_24| () Int)
(declare-fun |main_#t~ret18_25| () Int)
(declare-fun main_~l~1_25 () Int)
(declare-fun |check_#in~y_26| () Int)
(declare-fun |check_#in~x_26| () Int)
(declare-fun |check_#in~a.offset_26| () Int)
(declare-fun main_~x~0_26 () Int)
(declare-fun main_~l~1_26 () Int)
(declare-fun |check_#in~a.base_26| () Int)
(declare-fun main_~a~0.base_26 () Int)
(declare-fun main_~y~0_26 () Int)
(declare-fun main_~n~0_26 () Int)
(declare-fun |check_#in~l_26| () Int)
(declare-fun main_~a~0.offset_26 () Int)
(declare-fun |check_#in~n_26| () Int)
(declare-fun check_~y_27 () Int)
(declare-fun check_~x_27 () Int)
(declare-fun check_~a.base_27 () Int)
(declare-fun check_~a.offset_27 () Int)
(declare-fun check_~i~0_27 () Int)
(declare-fun check_~n_27 () Int)
(declare-fun |check_#t~nondet9_27| () Int)
(declare-fun check_~l_27 () Int)
(declare-fun check_~i~0_28 () Int)
(declare-fun |assume_abort_if_not_#in~cond_28| () Int)
(declare-fun check_~l_28 () Int)
(declare-fun assume_abort_if_not_~cond_29 () Int)
(declare-fun |check_#t~mem10_33| () Int)
(declare-fun check_~i~0_33 () Int)
(declare-fun |check_#t~mem11_33| () Int)
(declare-fun |__VERIFIER_assert_#in~cond_34| () Int)
(declare-fun |check_#t~mem10_34| () Int)
(declare-fun |check_#t~mem11_34| () Int)
...
(assert (! (and (not (= |main_#t~malloc15.base_10| 0)) (< |main_#t~malloc15.base_10| |#StackHeapBarrier_-1|) (= |main_#t~malloc15.offset_10| 0) (= v_ArrVal_1_fresh_1 1) (= (store |#valid_3| |main_#t~malloc15.base_10| v_ArrVal_1_fresh_1) |#valid_10|) (= (* 4 (mod main_~n~0_4 1073741824)) v_ArrVal_2_fresh_1) (= (store |#length_3| |main_#t~malloc15.base_10| v_ArrVal_2_fresh_1) |#length_10|) (= (select |#valid_3| |main_#t~malloc15.base_10|) 0)) :named ssa_10))
(assert (! (= |old(#memory_int#2)_11| |#memory_int#2_11|) :named ssa_11_GlobVarAssigCall))
(assert (! (and (= |#Ultimate.meminit_#ptr.base_11| |main_#t~malloc15.base_10|) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_3_fresh_1|) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_3_fresh_1| 4) (= |v_#Ultimate.meminit_#ptr.offsetInParam_3_fresh_1| |main_#t~malloc15.offset_10|) (= |v_#Ultimate.meminit_#productInParam_3_fresh_1| (* main_~n~0_4 4))) :named ssa_11_LocVarAssigCall))
(assert (! (= |old(#memory_int#2)_11| |#memory_int#2_3|) :named ssa_11_OldVarAssigCall))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_3_fresh_1) (= (store |#memory_int#2_11| |#Ultimate.meminit_#ptr.base_11| v_ArrVal_3_fresh_1) |#memory_int#2_12|)) :named ssa_12))
...
(assert (! (= |lcp_#res_23| lcp_~l~0_21) :named ssa_23))
(assert (! (= |lcp_#res_23| |main_#t~ret18_24|) :named ssa_24_return))
(assert (! (and (<= |main_#t~ret18_24| 2147483647) (= main_~l~1_25 |main_#t~ret18_24|) (<= 0 (+ |main_#t~ret18_24| 2147483648))) :named ssa_25))
(assert (! true :named ssa_26_GlobVarAssigCall))
(assert (! (and (= main_~n~0_4 |check_#in~n_26|) (= |check_#in~a.base_26| main_~a~0.base_14) (= main_~y~0_14 |check_#in~y_26|) (= main_~x~0_14 |check_#in~x_26|) (= |check_#in~a.offset_26| main_~a~0.offset_14) (= |check_#in~l_26| main_~l~1_25)) :named ssa_26_LocVarAssigCall))
(assert (! true :named ssa_26_OldVarAssigCall))
(assert (! (and (= check_~y_27 |check_#in~y_26|) (= check_~a.base_27 |check_#in~a.base_26|) (<= 0 (+ check_~i~0_27 2147483648)) (= |check_#in~a.offset_26| check_~a.offset_27) (<= check_~i~0_27 2147483647) (= check_~n_27 |check_#in~n_26|) (= check_~l_27 |check_#in~l_26|) (= check_~x_27 |check_#in~x_26|)) :named ssa_27))
(assert (! true :named ssa_28_GlobVarAssigCall))
(assert (! (= |assume_abort_if_not_#in~cond_28| (ite (and (<= 0 check_~i~0_27) (< check_~i~0_27 check_~l_27)) 1 0)) :named ssa_28_LocVarAssigCall))
...
(assert (! (and (= |check_#t~mem10_33| (select (select |#memory_int#2_12| check_~a.base_27) (+ (* check_~x_27 4) check_~a.offset_27 (* check_~i~0_27 4)))) (= (select (select |#memory_int#2_12| check_~a.base_27) (+ (* check_~y_27 4) check_~a.offset_27 (* check_~i~0_27 4))) |check_#t~mem11_33|)) :named ssa_33))
(assert (! true :named ssa_34_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_34| (ite (= |check_#t~mem11_33| |check_#t~mem10_33|) 1 0)) :named ssa_34_LocVarAssigCall))
...
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 (and ssa_5_LocVarAssigCall ssa_5_GlobVarAssigCall ssa_7 ssa_6 ssa_8 ssa_5_OldVarAssigCall ssa_9_return) ssa_10 (and ssa_11_LocVarAssigCall ssa_13_return ssa_12 ssa_11_OldVarAssigCall ssa_11_GlobVarAssigCall) ssa_14 (and ssa_16 ssa_15_LocVarAssigCall ssa_15_GlobVarAssigCall ssa_19_return ssa_18 ssa_17 ssa_15_OldVarAssigCall) (and ssa_20_GlobVarAssigCall ssa_20_OldVarAssigCall ssa_24_return ssa_20_LocVarAssigCall ssa_22 ssa_21 ssa_23) ssa_25 (and ssa_26_GlobVarAssigCall ssa_26_LocVarAssigCall ssa_26_OldVarAssigCall) ssa_27 (and ssa_31 ssa_32_return ssa_28_OldVarAssigCall ssa_29 ssa_30 ssa_28_GlobVarAssigCall ssa_28_LocVarAssigCall) ssa_33 (and ssa_34_GlobVarAssigCall ssa_34_LocVarAssigCall ssa_34_OldVarAssigCall) ssa_35 ssa_36 (and ssa_37 ssa_postcond))
...
(assert (! (not false) :named ssa_postcond))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_4_fresh_1) (= (store |#memory_int#2_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_4_fresh_1) |#memory_int#2_0|)) :named ssa_0))
(assert (! true :named ssa_1_return))
...
(declare-fun |lcp_#res_2| () Int)
(declare-fun lcp_~l~0_2 () Int)
(declare-fun |main_#t~ret18_3| () Int)
(declare-fun |lcp_#res_3| () Int)
(assert (! true :named ssa_precond))
(assert (! (not false) :named ssa_postcond))
...
(assert (! false :named ssa_1))
(assert (! (= |lcp_#res_2| lcp_~l~0_0) :named ssa_2))
(assert (! (= |lcp_#res_2| |main_#t~ret18_3|) :named ssa_3_return))
(assert (! false :named ssa_-2_PendingContext))
