...
(set-info :ultimate-id mapsum3.i_AllErrorsAtOnce_Iteration11)
...
(declare-fun |mapsum_#in~x.base_12| () Int)
(declare-fun |mapsum_#in~x.offset_12| () Int)
(declare-fun |main_~#x~0.base_12| () Int)
(declare-fun mapsum_~x.base_13 () Int)
(declare-fun mapsum_~ret~0_13 () Int)
(declare-fun mapsum_~x.offset_13 () Int)
(declare-fun mapsum_~i~0_13 () Int)
(declare-fun |mapsum_#t~mem1_14| () Int)
(declare-fun mapsum_~ret~0_14 () Int)
(declare-fun |mapsum_#t~post2_14| () Int)
...
(assert (! (and (= (store |#length_3| |main_~#x~0.base_4| v_ArrVal_122_fresh_1) |#length_4|) (< |#StackHeapBarrier_-1| |main_~#x~0.base_4|) (= v_ArrVal_121_fresh_1 1) (= v_ArrVal_122_fresh_1 40000) (not (= |main_~#x~0.base_4| 0)) (= (select |#valid_3| |main_~#x~0.base_4|) 0) (= |main_~#x~0.offset_4| 0) (= main_~i~1_4 0) (= |#valid_4| (store |#valid_3| |main_~#x~0.base_4| v_ArrVal_121_fresh_1))) :named ssa_4))
(assert (! (and (< main_~i~1_4 10000) (= v_ArrVal_124_fresh_1 |v_main_#t~nondet3_26_fresh_1|) (<= |v_main_#t~nondet3_26_fresh_1| 2147483647) (<= 0 (+ |v_main_#t~nondet3_26_fresh_1| 2147483648)) (= (store |#memory_int#1_3| |main_~#x~0.base_4| v_ArrVal_123_fresh_1) |#memory_int#1_5|) (= v_ArrVal_123_fresh_1 (store (select |#memory_int#1_3| |main_~#x~0.base_4|) (+ (* main_~i~1_4 4) |main_~#x~0.offset_4|) |v_main_#t~nondet3_26_fresh_1|)) (= main_~i~1_5 (+ main_~i~1_4 1))) :named ssa_5))
(assert (! (and (< main_~i~1_5 10000) (<= 0 (+ |v_main_#t~nondet3_27_fresh_1| 2147483648)) (= v_ArrVal_125_fresh_1 |v_main_#t~nondet3_27_fresh_1|) (<= |v_main_#t~nondet3_27_fresh_1| 2147483647) (= (store |#memory_int#1_5| |main_~#x~0.base_4| v_ArrVal_126_fresh_1) |#memory_int#1_6|) (= main_~i~1_6 (+ main_~i~1_5 1)) (= v_ArrVal_126_fresh_1 (store (select |#memory_int#1_5| |main_~#x~0.base_4|) (+ (* main_~i~1_5 4) |main_~#x~0.offset_4|) v_ArrVal_125_fresh_1))) :named ssa_6))
(assert (! (and (<= |v_main_#t~nondet3_28_fresh_1| 2147483647) (< main_~i~1_6 10000) (<= 0 (+ |v_main_#t~nondet3_28_fresh_1| 2147483648)) (= v_ArrVal_127_fresh_1 |v_main_#t~nondet3_28_fresh_1|) (= v_ArrVal_128_fresh_1 (store (select |#memory_int#1_6| |main_~#x~0.base_4|) (+ (* main_~i~1_6 4) |main_~#x~0.offset_4|) v_ArrVal_127_fresh_1)) (= (store |#memory_int#1_6| |main_~#x~0.base_4| v_ArrVal_128_fresh_1) |#memory_int#1_7|) (= main_~i~1_7 (+ main_~i~1_6 1))) :named ssa_7))
(assert (! (and (< main_~i~1_7 10000) (= v_ArrVal_129_fresh_1 |v_main_#t~nondet3_29_fresh_1|) (<= 0 (+ |v_main_#t~nondet3_29_fresh_1| 2147483648)) (<= |v_main_#t~nondet3_29_fresh_1| 2147483647) (= (store |#memory_int#1_7| |main_~#x~0.base_4| v_ArrVal_130_fresh_1) |#memory_int#1_8|) (= v_ArrVal_130_fresh_1 (store (select |#memory_int#1_7| |main_~#x~0.base_4|) (+ (* main_~i~1_7 4) |main_~#x~0.offset_4|) v_ArrVal_129_fresh_1)) (= main_~i~1_8 (+ main_~i~1_7 1))) :named ssa_8))
(assert (! (and (< main_~i~1_8 10000) (<= 0 (+ |v_main_#t~nondet3_30_fresh_1| 2147483648)) (<= |v_main_#t~nondet3_30_fresh_1| 2147483647) (= v_ArrVal_131_fresh_1 |v_main_#t~nondet3_30_fresh_1|) (= (store (select |#memory_int#1_8| |main_~#x~0.base_4|) (+ (* main_~i~1_8 4) |main_~#x~0.offset_4|) v_ArrVal_131_fresh_1) v_ArrVal_132_fresh_1) (= |#memory_int#1_9| (store |#memory_int#1_8| |main_~#x~0.base_4| v_ArrVal_132_fresh_1)) (= main_~i~1_9 (+ main_~i~1_8 1))) :named ssa_9))
(assert (! (<= 10000 main_~i~1_9) :named ssa_10))
(assert (! true :named ssa_11))
(assert (! true :named ssa_12_GlobVarAssigCall))
(assert (! (and (= |main_~#x~0.base_4| |mapsum_#in~x.base_12|) (= |mapsum_#in~x.offset_12| |main_~#x~0.offset_4|)) :named ssa_12_LocVarAssigCall))
(assert (! true :named ssa_12_OldVarAssigCall))
(assert (! (and (= |mapsum_#in~x.offset_12| mapsum_~x.offset_13) (= mapsum_~ret~0_13 0) (= mapsum_~x.base_13 |mapsum_#in~x.base_12|) (= mapsum_~i~0_13 0)) :named ssa_13))
(assert (! (and (= mapsum_~ret~0_14 (+ mapsum_~ret~0_13 mapsum_~i~0_13 (select (select |#memory_int#1_9| mapsum_~x.base_13) (+ (* mapsum_~i~0_13 4) mapsum_~x.offset_13)))) (< mapsum_~i~0_13 10000) (= (+ mapsum_~i~0_13 1) mapsum_~i~0_14)) :named ssa_14))
(assert (! (and (= mapsum_~ret~0_15 (+ mapsum_~ret~0_14 mapsum_~i~0_14 (select (select |#memory_int#1_9| mapsum_~x.base_13) (+ (* mapsum_~i~0_14 4) mapsum_~x.offset_13)))) (< mapsum_~i~0_14 10000) (= (+ mapsum_~i~0_14 1) mapsum_~i~0_15)) :named ssa_15))
(assert (! (<= 10000 mapsum_~i~0_15) :named ssa_16))
...
(assert (! (= |main_#t~ret5_18| |mapsum_#res_17|) :named ssa_18_return))
(assert (! (and (<= 0 (+ |main_#t~ret5_18| 2147483648)) (= v_ArrVal_133_fresh_1 (select (select |#memory_int#1_9| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4))) (= (store |#memory_int#1_9| |main_~#x~0.base_4| v_ArrVal_134_fresh_1) |#memory_int#1_19|) (= |main_#t~ret5_18| main_~ret~1_19) (<= |main_#t~ret5_18| 2147483647) (= v_ArrVal_135_fresh_1 v_main_~temp~0_16_fresh_1) (= (store (store (select |#memory_int#1_9| |main_~#x~0.base_4|) |main_~#x~0.offset_4| v_ArrVal_133_fresh_1) (+ |main_~#x~0.offset_4| 4) v_main_~temp~0_16_fresh_1) v_ArrVal_134_fresh_1) (= v_main_~temp~0_16_fresh_1 (select (select |#memory_int#1_9| |main_~#x~0.base_4|) |main_~#x~0.offset_4|))) :named ssa_19))
(assert (! true :named ssa_20_GlobVarAssigCall))
(assert (! (and (= |mapsum_#in~x.offset_20| |main_~#x~0.offset_4|) (= |main_~#x~0.base_4| |mapsum_#in~x.base_20|)) :named ssa_20_LocVarAssigCall))
...
(assert (! (and (= mapsum_~ret~0_22 (+ mapsum_~ret~0_21 mapsum_~i~0_21 (select (select |#memory_int#1_19| mapsum_~x.base_21) (+ (* mapsum_~i~0_21 4) mapsum_~x.offset_21)))) (< mapsum_~i~0_21 10000) (= (+ mapsum_~i~0_21 1) mapsum_~i~0_22)) :named ssa_22))
(assert (! (and (= mapsum_~ret~0_23 (+ mapsum_~ret~0_22 mapsum_~i~0_22 (select (select |#memory_int#1_19| mapsum_~x.base_21) (+ (* mapsum_~i~0_22 4) mapsum_~x.offset_21)))) (< mapsum_~i~0_22 10000) (= (+ mapsum_~i~0_22 1) mapsum_~i~0_23)) :named ssa_23))
...
(assert (! (= |main_#t~ret8_26| |mapsum_#res_25|) :named ssa_26_return))
(assert (! (and (= (select (select |#memory_int#1_19| |main_~#x~0.base_4|) |main_~#x~0.offset_4|) main_~temp~0_27) (<= |main_#t~ret8_26| 2147483647) (= main_~ret2~0_27 |main_#t~ret8_26|) (<= 0 (+ |main_#t~ret8_26| 2147483648)) (= main_~i~2_27 0)) :named ssa_27))
(assert (! (and (= (store |#memory_int#1_19| |main_~#x~0.base_4| v_ArrVal_137_fresh_1) |#memory_int#1_28|) (= v_ArrVal_137_fresh_1 (store (select |#memory_int#1_19| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| (* main_~i~2_27 4)) v_ArrVal_136_fresh_1)) (= main_~i~2_28 (+ main_~i~2_27 1)) (< main_~i~2_27 9999) (= v_ArrVal_136_fresh_1 (select (select |#memory_int#1_19| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4 (* main_~i~2_27 4))))) :named ssa_28))
(assert (! (and (= main_~i~2_29 (+ main_~i~2_28 1)) (< main_~i~2_28 9999) (= v_ArrVal_139_fresh_1 (store (select |#memory_int#1_28| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| (* main_~i~2_28 4)) v_ArrVal_138_fresh_1)) (= |#memory_int#1_29| (store |#memory_int#1_28| |main_~#x~0.base_4| v_ArrVal_139_fresh_1)) (= v_ArrVal_138_fresh_1 (select (select |#memory_int#1_28| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4 (* main_~i~2_28 4))))) :named ssa_29))
(assert (! (<= 9999 main_~i~2_29) :named ssa_30))
(assert (! (and (= (store |#memory_int#1_29| |main_~#x~0.base_4| v_ArrVal_141_fresh_1) |#memory_int#1_31|) (= v_ArrVal_140_fresh_1 main_~temp~0_27) (= v_ArrVal_141_fresh_1 (store (select |#memory_int#1_29| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 39996) v_ArrVal_140_fresh_1))) :named ssa_31))
...
(assert (! (= |main_#t~ret12_38| |mapsum_#res_37|) :named ssa_38_return))
