...
(set-info :ultimate-id watermelon.c_AllErrorsAtOnce_Iteration1)
...
(declare-fun v_main_~is_divisible1~0_6_fresh_1 () Int)
(declare-fun v_main_~is_divisible2~0_6_fresh_1 () Int)
...
(declare-fun student_version_~w_14 () Int)
(declare-fun student_version_~is_divisible~1_14 () Int)
(declare-fun |student_version_#res_15| () Int)
(declare-fun student_version_~is_divisible~1_15 () Int)
(declare-fun |main_#t~ret6_16| () Int)
(declare-fun |student_version_#res_16| () Int)
(declare-fun |main_#t~ret6_17| () Int)
(declare-fun main_~is_divisible2~0_17 () Int)
(declare-fun |__VERIFIER_assert_#in~cond_18| () Int)
(declare-fun main_~is_divisible1~0_18 () Int)
(declare-fun main_~is_divisible2~0_18 () Int)
...
(assert (! (and (= v_main_~is_divisible1~0_6_fresh_1 ~true~0_1) (= v_main_~is_divisible2~0_6_fresh_1 ~true~0_1)) :named ssa_4))
...
(assert (! (and (< student_version_~w_13 4) (= ~false~0_1 student_version_~is_divisible~1_14)) :named ssa_14))
(assert (! (= student_version_~is_divisible~1_14 |student_version_#res_15|) :named ssa_15))
(assert (! (= |main_#t~ret6_16| |student_version_#res_15|) :named ssa_16_return))
(assert (! (and (<= |main_#t~ret6_16| 2147483647) (= main_~is_divisible2~0_17 |main_#t~ret6_16|) (<= 0 (+ |main_#t~ret6_16| 2147483648))) :named ssa_17))
(assert (! true :named ssa_18_GlobVarAssigCall))
(assert (! (= (ite (= main_~is_divisible1~0_11 main_~is_divisible2~0_17) 1 0) |__VERIFIER_assert_#in~cond_18|) :named ssa_18_LocVarAssigCall))
...
(assert (! true :named ssa_precond))
(assert (! (not (= ~false~0_-1 |main_#t~ret5_3|)) :named ssa_postcond))
...
(assert (! true :named ssa_precond))
(assert (! (not (= |main_#t~ret6_3| main_~is_divisible1~0_-2)) :named ssa_postcond))
...
(assert (! (= ~false~0_-1 main_~is_divisible1~0_-2) :named ssa_-2_PendingContext))
