...
(set-info :ultimate-id psyco_security.c_AllErrorsAtOnce_Iteration6)
...
(declare-fun v_main_~method_id~0_53_fresh_1 () Int)
...
(declare-fun v_main_~method_id~0_54_fresh_1 () Int)
...
(declare-fun |main_#t~nondet6_22| () Int)
(declare-fun |main_#t~nondet6_23| () Int)
(declare-fun v_main_~method_id~0_55_fresh_1 () Int)
(declare-fun main_~this_state~0_25 () Int)
...
(assert (! (= 3 v_main_~method_id~0_53_fresh_1) :named ssa_9))
...
(assert (! (= 2 v_main_~method_id~0_54_fresh_1) :named ssa_17))
...
(assert (! (and (= main_~q~0_18 1) (<= |main_#t~nondet5_21| 2147483647) (<= 0 (+ |main_#t~nondet5_21| 2147483648))) :named ssa_21))
(assert (! (and (<= 0 (+ |main_#t~nondet6_22| 2147483648)) (= |main_#t~nondet5_21| 0) (<= |main_#t~nondet6_22| 2147483647)) :named ssa_22))
(assert (! (not (= |main_#t~nondet6_22| 0)) :named ssa_23))
(assert (! (= 5 v_main_~method_id~0_55_fresh_1) :named ssa_24))
(assert (! (= 3 main_~this_state~0_18) :named ssa_25))
