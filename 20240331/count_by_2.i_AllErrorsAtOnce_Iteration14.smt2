...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration14)
...
(assert (! (<= 1000000 main_~i~0_17) :named ssa_18))
(assert (! true :named ssa_19_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_19| (ite (= main_~i~0_17 1000000) 1 0)) :named ssa_19_LocVarAssigCall))
