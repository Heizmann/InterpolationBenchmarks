...
(set-info :ultimate-id mapsum3.i_AllErrorsAtOnce_Iteration16)
...
(assert (! (and (= mapsum_~ret~0_19 (+ mapsum_~ret~0_18 mapsum_~i~0_18 (select (select |#memory_int#1_14| mapsum_~x.base_18) (+ (* mapsum_~i~0_18 4) mapsum_~x.offset_18)))) (< mapsum_~i~0_18 10000) (= (+ mapsum_~i~0_18 1) mapsum_~i~0_19)) :named ssa_19))
(assert (! (and (= mapsum_~ret~0_20 (+ mapsum_~ret~0_19 mapsum_~i~0_19 (select (select |#memory_int#1_14| mapsum_~x.base_18) (+ (* mapsum_~i~0_19 4) mapsum_~x.offset_18)))) (< mapsum_~i~0_19 10000) (= (+ mapsum_~i~0_19 1) mapsum_~i~0_20)) :named ssa_20))
...
(assert (! (and (= mapsum_~ret~0_27 (+ mapsum_~ret~0_26 mapsum_~i~0_26 (select (select |#memory_int#1_24| mapsum_~x.base_26) (+ (* mapsum_~i~0_26 4) mapsum_~x.offset_26)))) (< mapsum_~i~0_26 10000) (= (+ mapsum_~i~0_26 1) mapsum_~i~0_27)) :named ssa_27))
(assert (! (and (= mapsum_~ret~0_28 (+ mapsum_~ret~0_27 mapsum_~i~0_27 (select (select |#memory_int#1_24| mapsum_~x.base_26) (+ (* mapsum_~i~0_27 4) mapsum_~x.offset_26)))) (< mapsum_~i~0_27 10000) (= (+ mapsum_~i~0_27 1) mapsum_~i~0_28)) :named ssa_28))
...
(assert (! (and (= v_ArrVal_272_fresh_1 (store (select |#memory_int#1_24| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| (* main_~i~2_32 4)) v_ArrVal_271_fresh_1)) (= |#memory_int#1_33| (store |#memory_int#1_24| |main_~#x~0.base_4| v_ArrVal_272_fresh_1)) (= main_~i~2_33 (+ main_~i~2_32 1)) (< main_~i~2_32 9999) (= v_ArrVal_271_fresh_1 (select (select |#memory_int#1_24| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4 (* main_~i~2_32 4))))) :named ssa_33))
(assert (! (and (= v_ArrVal_273_fresh_1 (select (select |#memory_int#1_33| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4 (* main_~i~2_33 4)))) (= v_ArrVal_274_fresh_1 (store (select |#memory_int#1_33| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| (* main_~i~2_33 4)) v_ArrVal_273_fresh_1)) (= main_~i~2_34 (+ main_~i~2_33 1)) (< main_~i~2_33 9999) (= (store |#memory_int#1_33| |main_~#x~0.base_4| v_ArrVal_274_fresh_1) |#memory_int#1_34|)) :named ssa_34))
(assert (! (<= 9999 main_~i~2_34) :named ssa_35))
(assert (! (and (= v_ArrVal_276_fresh_1 (store (select |#memory_int#1_34| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 39996) v_ArrVal_275_fresh_1)) (= (store |#memory_int#1_34| |main_~#x~0.base_4| v_ArrVal_276_fresh_1) |#memory_int#1_36|) (= v_ArrVal_275_fresh_1 main_~temp~0_32)) :named ssa_36))
