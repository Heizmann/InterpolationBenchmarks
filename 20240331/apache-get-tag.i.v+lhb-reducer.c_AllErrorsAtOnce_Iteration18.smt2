...
(set-info :ultimate-id apache-get-tag.i.v+lhb-reducer.c_AllErrorsAtOnce_Iteration18)
...
(declare-fun v_main_~main____CPAchecker_TMP_2~0_12_fresh_1 () Int)
(declare-fun v_main_~main____CPAchecker_TMP_0~0_26_fresh_1 () Int)
...
(assert (! (and (= (ite (<= 0 main_~main__t~0_5) 1 0) v_main_~__tmp_1~0_14_fresh_1) (not (= main_~main____CPAchecker_TMP_0~0_6 0)) (= v_main_~__tmp_1~0_14_fresh_1 main_~__VERIFIER_assert__cond~0_7)) :named ssa_7))
(assert (! (and (not (= main_~__VERIFIER_assert__cond~0_7 0)) (= v_main_~__tmp_2~0_14_fresh_1 (ite (<= main_~main__t~0_5 main_~main__tagbuf_len~0_5) 1 0)) (= v_main_~__tmp_2~0_14_fresh_1 main_~__VERIFIER_assert__cond~1_8)) :named ssa_8))
(assert (! (and (not (= main_~__VERIFIER_assert__cond~1_8 0)) (= main_~main____CPAchecker_TMP_0~0_6 ~__tmp_259_0~0_9)) :named ssa_9))
(assert (! (and (= v_main_~main____CPAchecker_TMP_2~0_12_fresh_1 main_~main__t~0_5) (= (+ main_~main__t~0_5 1) main_~main__t~0_10) (= ~__tmp_259_0~0_9 v_main_~main____CPAchecker_TMP_0~0_26_fresh_1)) :named ssa_10))
...
(assert (! (and (= v_main_~__tmp_5~0_7_fresh_1 main_~__VERIFIER_assert__cond~4_13) (= v_main_~__tmp_5~0_7_fresh_1 (ite (<= 0 main_~main__t~0_10) 1 0)) (not (= main_~main____CPAchecker_TMP_4~0_12 0))) :named ssa_13))
(assert (! (and (= (ite (<= main_~main__t~0_10 main_~main__tagbuf_len~0_5) 1 0) v_main_~__tmp_6~0_6_fresh_1) (= v_main_~__tmp_6~0_6_fresh_1 main_~__VERIFIER_assert__cond~5_14) (not (= main_~__VERIFIER_assert__cond~4_13 0))) :named ssa_14))
(assert (! (and (not (= main_~__VERIFIER_assert__cond~5_14 0)) (= v_main_~main____CPAchecker_TMP_5~0_4_fresh_1 main_~main__t~0_10) (= main_~main__t~0_15 (+ main_~main__t~0_10 1))) :named ssa_15))
(assert (! (and (= main_~main__t~0_15 main_~main__tagbuf_len~0_5) (= v_main_~__tmp_7~0_5_fresh_1 (ite (<= 0 main_~main__t~0_15) 1 0)) (= v_main_~__tmp_7~0_5_fresh_1 main_~__VERIFIER_assert__cond~6_16)) :named ssa_16))
(assert (! (and (= v_main_~__tmp_8~0_4_fresh_1 main_~__VERIFIER_assert__cond~7_17) (= v_main_~__tmp_8~0_4_fresh_1 (ite (<= main_~main__t~0_15 main_~main__tagbuf_len~0_5) 1 0)) (not (= main_~__VERIFIER_assert__cond~6_16 0))) :named ssa_17))
(assert (! (= main_~__VERIFIER_assert__cond~7_17 0) :named ssa_18))
