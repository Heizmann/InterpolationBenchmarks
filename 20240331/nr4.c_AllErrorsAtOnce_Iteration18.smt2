...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-30T23:52:52+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id nr4.c_AllErrorsAtOnce_Iteration18)
...
(declare-fun |v_main_#t~mem7_42_fresh_1| () Int)
...
(declare-fun |v_main_#t~mem7_43_fresh_1| () Int)
...
(declare-fun |v_main_#t~mem7_44_fresh_1| () Int)
...
(declare-fun |v_main_#t~mem7_45_fresh_1| () Int)
...
(declare-fun |v_main_#t~mem7_46_fresh_1| () Int)
...
(declare-fun |v_main_#t~mem7_47_fresh_1| () Int)
...
(assert (! (and (= v_ArrVal_155_fresh_1 (* (mod ~CELLCOUNT~0_4 1073741824) 4)) (< |#StackHeapBarrier_-1| |main_~#volArray~0.base_5|) (= |main_~#volArray~0.offset_5| 0) (= v_ArrVal_156_fresh_1 1) (not (= |main_~#volArray~0.base_5| 0)) (= (store |#length_3| |main_~#volArray~0.base_5| v_ArrVal_155_fresh_1) |#length_5|) (= 0 (select |#valid_3| |main_~#volArray~0.base_5|)) (= main_~MINVAL~0_5 2) (< 1 ~CELLCOUNT~0_4) (= |#valid_5| (store |#valid_3| |main_~#volArray~0.base_5| v_ArrVal_156_fresh_1))) :named ssa_5))
...
(assert (! (and (= (store |#memory_int#1_3| |main_~#volArray~0.base_5| v_ArrVal_157_fresh_1) |#memory_int#1_15|) (= v_ArrVal_158_fresh_1 main_~j~0_13) (= v_ArrVal_157_fresh_1 (store (select |#memory_int#1_3| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~j~0_13 (- 4)) (* main_~i~0_12 16)) main_~j~0_13)) (<= main_~MINVAL~0_5 main_~j~0_13)) :named ssa_15))
(assert (! (= main_~j~0_13 (+ main_~j~0_16 1)) :named ssa_16))
(assert (! (<= 1 main_~j~0_16) :named ssa_17))
(assert (! (and (= (store |#memory_int#1_15| |main_~#volArray~0.base_5| v_ArrVal_159_fresh_1) |#memory_int#1_18|) (= v_ArrVal_160_fresh_1 main_~j~0_16) (<= main_~MINVAL~0_5 main_~j~0_16) (= v_ArrVal_159_fresh_1 (store (select |#memory_int#1_15| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~j~0_16 (- 4)) (* main_~i~0_12 16)) main_~j~0_16))) :named ssa_18))
(assert (! (= main_~j~0_16 (+ main_~j~0_19 1)) :named ssa_19))
(assert (! (<= 1 main_~j~0_19) :named ssa_20))
(assert (! (and (= v_ArrVal_162_fresh_1 main_~j~0_19) (= (store |#memory_int#1_18| |main_~#volArray~0.base_5| v_ArrVal_161_fresh_1) |#memory_int#1_21|) (= v_ArrVal_161_fresh_1 (store (select |#memory_int#1_18| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~j~0_19 (- 4)) (* main_~i~0_12 16)) main_~j~0_19)) (<= main_~MINVAL~0_5 main_~j~0_19)) :named ssa_21))
(assert (! (= main_~j~0_19 (+ main_~j~0_22 1)) :named ssa_22))
(assert (! (<= 1 main_~j~0_22) :named ssa_23))
(assert (! (and (< main_~j~0_22 main_~MINVAL~0_5) (= v_ArrVal_163_fresh_1 0) (= (store (select |#memory_int#1_21| |main_~#volArray~0.base_5|) (+ (* main_~i~0_12 16) |main_~#volArray~0.offset_5| (* main_~j~0_22 (- 4))) v_ArrVal_163_fresh_1) v_ArrVal_164_fresh_1) (= |#memory_int#1_24| (store |#memory_int#1_21| |main_~#volArray~0.base_5| v_ArrVal_164_fresh_1))) :named ssa_24))
...
(assert (! (and (= v_ArrVal_166_fresh_1 main_~j~0_28) (= v_ArrVal_165_fresh_1 (store (select |#memory_int#1_24| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~j~0_28 (- 4)) (* main_~i~0_27 16)) main_~j~0_28)) (= (store |#memory_int#1_24| |main_~#volArray~0.base_5| v_ArrVal_165_fresh_1) |#memory_int#1_30|) (<= main_~MINVAL~0_5 main_~j~0_28)) :named ssa_30))
(assert (! (= main_~j~0_28 (+ main_~j~0_31 1)) :named ssa_31))
(assert (! (<= 1 main_~j~0_31) :named ssa_32))
(assert (! (and (= v_ArrVal_168_fresh_1 main_~j~0_31) (= |#memory_int#1_33| (store |#memory_int#1_30| |main_~#volArray~0.base_5| v_ArrVal_167_fresh_1)) (<= main_~MINVAL~0_5 main_~j~0_31) (= v_ArrVal_167_fresh_1 (store (select |#memory_int#1_30| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~j~0_31 (- 4)) (* main_~i~0_27 16)) main_~j~0_31))) :named ssa_33))
(assert (! (= main_~j~0_31 (+ main_~j~0_34 1)) :named ssa_34))
(assert (! (<= 1 main_~j~0_34) :named ssa_35))
(assert (! (and (= v_ArrVal_170_fresh_1 main_~j~0_34) (= (store |#memory_int#1_33| |main_~#volArray~0.base_5| v_ArrVal_169_fresh_1) |#memory_int#1_36|) (= v_ArrVal_169_fresh_1 (store (select |#memory_int#1_33| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~j~0_34 (- 4)) (* main_~i~0_27 16)) main_~j~0_34)) (<= main_~MINVAL~0_5 main_~j~0_34)) :named ssa_36))
(assert (! (= main_~j~0_34 (+ main_~j~0_37 1)) :named ssa_37))
(assert (! (<= 1 main_~j~0_37) :named ssa_38))
(assert (! (and (< main_~j~0_37 main_~MINVAL~0_5) (= v_ArrVal_172_fresh_1 (store (select |#memory_int#1_36| |main_~#volArray~0.base_5|) (+ (* main_~i~0_27 16) |main_~#volArray~0.offset_5| (* main_~j~0_37 (- 4))) v_ArrVal_171_fresh_1)) (= (store |#memory_int#1_36| |main_~#volArray~0.base_5| v_ArrVal_172_fresh_1) |#memory_int#1_39|) (= v_ArrVal_171_fresh_1 0)) :named ssa_39))
...
(assert (! (and (< main_~i~0_44 ~CELLCOUNT~0_4) (or (and (< |v_main_#t~mem7_42_fresh_1| main_~MINVAL~0_5) (not |main_#t~short9_45|)) (and |main_#t~short9_45| (<= main_~MINVAL~0_5 |v_main_#t~mem7_42_fresh_1|))) (= (select (select |#memory_int#1_39| |main_~#volArray~0.base_5|) (+ (* main_~i~0_44 4) |main_~#volArray~0.offset_5|)) |v_main_#t~mem7_42_fresh_1|)) :named ssa_45))
...
(assert (! (and (< main_~i~0_52 ~CELLCOUNT~0_4) (or (and (< |v_main_#t~mem7_43_fresh_1| main_~MINVAL~0_5) (not |main_#t~short9_53|)) (and (<= main_~MINVAL~0_5 |v_main_#t~mem7_43_fresh_1|) |main_#t~short9_53|)) (= (select (select |#memory_int#1_39| |main_~#volArray~0.base_5|) (+ (* main_~i~0_52 4) |main_~#volArray~0.offset_5|)) |v_main_#t~mem7_43_fresh_1|)) :named ssa_53))
...
(assert (! (and (or (and |main_#t~short9_61| (<= main_~MINVAL~0_5 |v_main_#t~mem7_44_fresh_1|)) (and (< |v_main_#t~mem7_44_fresh_1| main_~MINVAL~0_5) (not |main_#t~short9_61|))) (< main_~i~0_60 ~CELLCOUNT~0_4) (= (select (select |#memory_int#1_39| |main_~#volArray~0.base_5|) (+ (* main_~i~0_60 4) |main_~#volArray~0.offset_5|)) |v_main_#t~mem7_44_fresh_1|)) :named ssa_61))
...
(assert (! (and (< main_~i~0_68 ~CELLCOUNT~0_4) (or (and |main_#t~short9_69| (<= main_~MINVAL~0_5 |v_main_#t~mem7_45_fresh_1|)) (and (< |v_main_#t~mem7_45_fresh_1| main_~MINVAL~0_5) (not |main_#t~short9_69|))) (= (select (select |#memory_int#1_39| |main_~#volArray~0.base_5|) (+ (* main_~i~0_68 4) |main_~#volArray~0.offset_5|)) |v_main_#t~mem7_45_fresh_1|)) :named ssa_69))
...
(assert (! (and (= (select (select |#memory_int#1_39| |main_~#volArray~0.base_5|) (+ (* main_~i~0_76 4) |main_~#volArray~0.offset_5|)) |v_main_#t~mem7_46_fresh_1|) (< main_~i~0_76 ~CELLCOUNT~0_4) (or (and |main_#t~short9_77| (<= main_~MINVAL~0_5 |v_main_#t~mem7_46_fresh_1|)) (and (< |v_main_#t~mem7_46_fresh_1| main_~MINVAL~0_5) (not |main_#t~short9_77|)))) :named ssa_77))
...
(assert (! (and (< main_~i~0_84 ~CELLCOUNT~0_4) (or (and |main_#t~short9_85| (<= main_~MINVAL~0_5 |v_main_#t~mem7_47_fresh_1|)) (and (< |v_main_#t~mem7_47_fresh_1| main_~MINVAL~0_5) (not |main_#t~short9_85|))) (= (select (select |#memory_int#1_39| |main_~#volArray~0.base_5|) (+ (* main_~i~0_84 4) |main_~#volArray~0.offset_5|)) |v_main_#t~mem7_47_fresh_1|)) :named ssa_85))
(assert (! (and (not |main_#t~short9_85|) (= |v_main_#t~mem8_21_fresh_1| (select (select |#memory_int#1_39| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_84 4)))) (or (and |main_#t~short9_86| (= |v_main_#t~mem8_21_fresh_1| 0)) (and (not |main_#t~short9_86|) (not (= |v_main_#t~mem8_21_fresh_1| 0))))) :named ssa_86))
