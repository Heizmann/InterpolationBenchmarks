...
(set-info :ultimate-id array_4.i_AllErrorsAtOnce_Iteration11)
...
(assert (! (and (= v_ArrVal_91_fresh_1 1) (= (select |#valid_3| |main_~#A~0.base_4|) 0) (not (= |main_~#A~0.base_4| 0)) (= |#valid_4| (store |#valid_3| |main_~#A~0.base_4| v_ArrVal_91_fresh_1)) (= 0 |main_~#A~0.offset_4|) (< |#StackHeapBarrier_-1| |main_~#A~0.base_4|) (= |#length_4| (store |#length_3| |main_~#A~0.base_4| v_ArrVal_92_fresh_1)) (= 4096 v_ArrVal_92_fresh_1) (= main_~i~0_4 0)) :named ssa_4))
(assert (! (and (= main_~i~0_5 (+ main_~i~0_4 1)) (< main_~i~0_4 1023) (= (store (select |#memory_int#1_3| |main_~#A~0.base_4|) (+ (* main_~i~0_4 4) |main_~#A~0.offset_4|) |v_main_#t~nondet1_33_fresh_1|) v_ArrVal_93_fresh_1) (= |v_main_#t~nondet1_33_fresh_1| v_ArrVal_94_fresh_1) (= |#memory_int#1_5| (store |#memory_int#1_3| |main_~#A~0.base_4| v_ArrVal_93_fresh_1)) (<= |v_main_#t~nondet1_33_fresh_1| 2147483647) (<= 0 (+ |v_main_#t~nondet1_33_fresh_1| 2147483648))) :named ssa_5))
(assert (! (and (= |v_main_#t~nondet1_34_fresh_1| v_ArrVal_95_fresh_1) (<= |v_main_#t~nondet1_34_fresh_1| 2147483647) (= main_~i~0_6 (+ main_~i~0_5 1)) (< main_~i~0_5 1023) (<= 0 (+ |v_main_#t~nondet1_34_fresh_1| 2147483648)) (= (store |#memory_int#1_5| |main_~#A~0.base_4| v_ArrVal_96_fresh_1) |#memory_int#1_6|) (= (store (select |#memory_int#1_5| |main_~#A~0.base_4|) (+ (* main_~i~0_5 4) |main_~#A~0.offset_4|) v_ArrVal_95_fresh_1) v_ArrVal_96_fresh_1)) :named ssa_6))
(assert (! (and (= |v_main_#t~nondet1_35_fresh_1| v_ArrVal_97_fresh_1) (<= 0 (+ |v_main_#t~nondet1_35_fresh_1| 2147483648)) (= main_~i~0_7 (+ main_~i~0_6 1)) (= (store (select |#memory_int#1_6| |main_~#A~0.base_4|) (+ (* main_~i~0_6 4) |main_~#A~0.offset_4|) v_ArrVal_97_fresh_1) v_ArrVal_98_fresh_1) (<= |v_main_#t~nondet1_35_fresh_1| 2147483647) (= (store |#memory_int#1_6| |main_~#A~0.base_4| v_ArrVal_98_fresh_1) |#memory_int#1_7|) (< main_~i~0_6 1023)) :named ssa_7))
(assert (! (and (= (store |#memory_int#1_7| |main_~#A~0.base_4| v_ArrVal_100_fresh_1) |#memory_int#1_8|) (<= 0 (+ |v_main_#t~nondet1_36_fresh_1| 2147483648)) (= main_~i~0_8 (+ main_~i~0_7 1)) (< main_~i~0_7 1023) (= |v_main_#t~nondet1_36_fresh_1| v_ArrVal_99_fresh_1) (<= |v_main_#t~nondet1_36_fresh_1| 2147483647) (= v_ArrVal_100_fresh_1 (store (select |#memory_int#1_7| |main_~#A~0.base_4|) (+ (* main_~i~0_7 4) |main_~#A~0.offset_4|) v_ArrVal_99_fresh_1))) :named ssa_8))
(assert (! (and (= main_~i~0_9 (+ main_~i~0_8 1)) (= v_ArrVal_102_fresh_1 (store (select |#memory_int#1_8| |main_~#A~0.base_4|) (+ (* main_~i~0_8 4) |main_~#A~0.offset_4|) v_ArrVal_101_fresh_1)) (<= |v_main_#t~nondet1_37_fresh_1| 2147483647) (< main_~i~0_8 1023) (= (store |#memory_int#1_8| |main_~#A~0.base_4| v_ArrVal_102_fresh_1) |#memory_int#1_9|) (<= 0 (+ |v_main_#t~nondet1_37_fresh_1| 2147483648)) (= v_ArrVal_101_fresh_1 |v_main_#t~nondet1_37_fresh_1|)) :named ssa_9))
(assert (! (and (<= |v_main_#t~nondet1_38_fresh_1| 2147483647) (= main_~i~0_10 (+ main_~i~0_9 1)) (< main_~i~0_9 1023) (= v_ArrVal_104_fresh_1 (store (select |#memory_int#1_9| |main_~#A~0.base_4|) (+ (* main_~i~0_9 4) |main_~#A~0.offset_4|) v_ArrVal_103_fresh_1)) (= |#memory_int#1_10| (store |#memory_int#1_9| |main_~#A~0.base_4| v_ArrVal_104_fresh_1)) (= v_ArrVal_103_fresh_1 |v_main_#t~nondet1_38_fresh_1|) (<= 0 (+ |v_main_#t~nondet1_38_fresh_1| 2147483648))) :named ssa_10))
(assert (! (and (= main_~i~0_11 (+ main_~i~0_10 1)) (<= 0 (+ |v_main_#t~nondet1_39_fresh_1| 2147483648)) (<= |v_main_#t~nondet1_39_fresh_1| 2147483647) (< main_~i~0_10 1023) (= v_ArrVal_106_fresh_1 (store (select |#memory_int#1_10| |main_~#A~0.base_4|) (+ (* main_~i~0_10 4) |main_~#A~0.offset_4|) v_ArrVal_105_fresh_1)) (= |#memory_int#1_11| (store |#memory_int#1_10| |main_~#A~0.base_4| v_ArrVal_106_fresh_1)) (= v_ArrVal_105_fresh_1 |v_main_#t~nondet1_39_fresh_1|)) :named ssa_11))
(assert (! (<= 1023 main_~i~0_11) :named ssa_12))
(assert (! (and (= v_ArrVal_108_fresh_1 0) (= main_~i~0_13 0) (= |#memory_int#1_13| (store |#memory_int#1_11| |main_~#A~0.base_4| v_ArrVal_107_fresh_1)) (= v_ArrVal_107_fresh_1 (store (select |#memory_int#1_11| |main_~#A~0.base_4|) (+ 4092 |main_~#A~0.offset_4|) 0))) :named ssa_13))
(assert (! (= |main_#t~mem3_14| (select (select |#memory_int#1_13| |main_~#A~0.base_4|) (+ (* main_~i~0_13 4) |main_~#A~0.offset_4|))) :named ssa_14))
(assert (! (and (= main_~i~0_15 (+ main_~i~0_13 1)) (not (= |main_#t~mem3_14| 0))) :named ssa_15))
(assert (! (= |main_#t~mem3_16| (select (select |#memory_int#1_13| |main_~#A~0.base_4|) (+ (* main_~i~0_15 4) |main_~#A~0.offset_4|))) :named ssa_16))
(assert (! (and (= main_~i~0_17 (+ main_~i~0_15 1)) (not (= |main_#t~mem3_16| 0))) :named ssa_17))
(assert (! (= |main_#t~mem3_18| (select (select |#memory_int#1_13| |main_~#A~0.base_4|) (+ (* main_~i~0_17 4) |main_~#A~0.offset_4|))) :named ssa_18))
(assert (! (= |main_#t~mem3_18| 0) :named ssa_19))
(assert (! true :named ssa_20_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_20| (ite (<= main_~i~0_17 1024) 1 0)) :named ssa_20_LocVarAssigCall))
