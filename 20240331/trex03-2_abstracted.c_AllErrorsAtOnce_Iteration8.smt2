...
(set-info :ultimate-id trex03-2_abstracted.c_AllErrorsAtOnce_Iteration8)
...
(declare-fun c_aux_v_main_~d3~0_9 () Int)
(declare-fun c_aux_v_main_~d2~0_9 () Int)
(declare-fun c_aux_v_main_~d1~0_9 () Int)
...
(declare-fun v_main_~d1~0_10_fresh_1 () Int)
(declare-fun v_main_~d2~0_10_fresh_1 () Int)
(declare-fun v_main_~d3~0_10_fresh_1 () Int)
...
(declare-fun |main_#t~bitwise17_3| () Int)
...
(assert (! (and (= v_main_~d3~0_10_fresh_1 1) (= v_main_~d1~0_10_fresh_1 1) (= v_main_~d2~0_10_fresh_1 1)) :named ssa_4))
...
(assert (! (and (or (<= |main_#t~bitwise17_3| (ite (< 0 (mod main_~x3~0_9 4294967296)) 1 0)) (and (< (ite (< 0 (mod main_~x3~0_9 4294967296)) 1 0) 0) (<= 0 |main_#t~bitwise16_11|))) (not (= |main_#t~bitwise16_11| (ite (< 0 (mod main_~x3~0_9 4294967296)) 1 0))) (or (and (<= 0 (ite (< 0 (mod main_~x3~0_9 4294967296)) 1 0)) (<= 0 |main_#t~bitwise16_11|)) (< (+ |main_#t~bitwise16_11| (ite (< 0 (mod main_~x3~0_9 4294967296)) 1 0)) |main_#t~bitwise17_3|)) (or (<= |main_#t~bitwise17_3| |main_#t~bitwise16_11|) (and (< |main_#t~bitwise16_11| 0) (<= 0 (ite (< 0 (mod main_~x3~0_9 4294967296)) 1 0)))) (or (and (< (ite (< 0 (mod main_~x3~0_9 4294967296)) 1 0) 0) (< |main_#t~bitwise16_11| 0)) (<= 0 |main_#t~bitwise17_3|)) (<= 0 (+ |main_#t~bitwise17_3| 2147483648))) :named ssa_13))
(assert (! (= |main_#t~bitwise17_3| 0) :named ssa_14))
