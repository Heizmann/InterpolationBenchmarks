...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-30T23:51:02+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id condg.c_AllErrorsAtOnce_Iteration3)
...
(declare-fun |main_#t~mem12_19| () Int)
...
(assert (! (and (= v_ArrVal_18_fresh_1 1) (= v_ArrVal_16_fresh_1 0) (= (select (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_18_fresh_1) main_~a~0.base_11) 0) (< |#StackHeapBarrier_-1| |main_~#sum~0.base_11|) (= (select |#valid_3| |main_~#sum~0.base_11|) 0) (not (= |main_~#sum~0.base_11| 0)) (< main_~a~0.base_11 |#StackHeapBarrier_-1|) (= |#memory_int#1_11| (store |#memory_int#1_3| |main_~#sum~0.base_11| v_ArrVal_13_fresh_1)) (= main_~i~0_11 0) (= (* (mod ~N~0_4 1073741824) 4) v_ArrVal_17_fresh_1) (= |#valid_11| (store (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_18_fresh_1) main_~a~0.base_11 v_ArrVal_14_fresh_1)) (= 4 v_ArrVal_15_fresh_1) (= v_ArrVal_14_fresh_1 1) (= v_ArrVal_13_fresh_1 (store (select |#memory_int#1_3| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| 0)) (= |main_~#sum~0.offset_11| 0) (= main_~a~0.offset_11 0) (not (= main_~a~0.base_11 0)) (= (store (store |#length_3| |main_~#sum~0.base_11| v_ArrVal_15_fresh_1) main_~a~0.base_11 v_ArrVal_17_fresh_1) |#length_11|)) :named ssa_11))
(assert (! (and (= (store (select |#memory_int#3_3| main_~a~0.base_11) (+ (* main_~i~0_11 4) main_~a~0.offset_11) 1) v_ArrVal_19_fresh_1) (= v_ArrVal_20_fresh_1 1) (= main_~i~0_12 (+ main_~i~0_11 1)) (= |#memory_int#3_12| (store |#memory_int#3_3| main_~a~0.base_11 v_ArrVal_19_fresh_1)) (< main_~i~0_11 ~N~0_4)) :named ssa_12))
(assert (! (<= ~N~0_4 main_~i~0_12) :named ssa_13))
(assert (! (= main_~i~0_14 0) :named ssa_14))
(assert (! (and (= (+ (select (select |#memory_int#3_12| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_14 4))) (select (select |#memory_int#1_11| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|)) v_ArrVal_22_fresh_1) (< main_~i~0_14 ~N~0_4) (= (store (select |#memory_int#1_11| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| (+ (select (select |#memory_int#3_12| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_14 4))) (select (select |#memory_int#1_11| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|))) v_ArrVal_21_fresh_1) (= |#memory_int#1_15| (store |#memory_int#1_11| |main_~#sum~0.base_11| v_ArrVal_21_fresh_1)) (= main_~i~0_15 (+ main_~i~0_14 1))) :named ssa_15))
...
(assert (! (and (= (store (select |#memory_int#3_12| main_~a~0.base_11) (+ (* main_~i~0_17 4) main_~a~0.offset_11) v_ArrVal_23_fresh_1) v_ArrVal_24_fresh_1) (= (+ (select (select |#memory_int#3_12| main_~a~0.base_11) (+ (* main_~i~0_17 4) main_~a~0.offset_11)) 1) v_ArrVal_23_fresh_1) (= (store |#memory_int#3_12| main_~a~0.base_11 v_ArrVal_24_fresh_1) |#memory_int#3_19|) (not (= |main_#t~mem10_18| ~N~0_4))) :named ssa_19))
(assert (! (= main_~i~0_20 (+ main_~i~0_17 1)) :named ssa_20))
(assert (! (<= ~N~0_4 main_~i~0_20) :named ssa_21))
(assert (! (= main_~i~0_22 0) :named ssa_22))
(assert (! (and (< main_~i~0_22 ~N~0_4) (= |main_#t~mem14_23| (select (select |#memory_int#3_19| main_~a~0.base_11) (+ (* main_~i~0_22 4) main_~a~0.offset_11)))) :named ssa_23))
(assert (! true :named ssa_24_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_24| (ite (= |main_#t~mem14_23| 0) 1 0)) :named ssa_24_LocVarAssigCall))
...
(assert (! true :named ssa_precond))
(assert (! (not (or (= ~N~0_-2 1) (< 1 ~N~0_-2))) :named ssa_postcond))
...
(assert (! (or (= ~N~0_-2 1) (< 1 ~N~0_-2)) :named ssa_-2_PendingContext))
