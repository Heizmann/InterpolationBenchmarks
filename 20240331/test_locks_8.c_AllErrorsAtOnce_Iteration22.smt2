...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:08:46+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id test_locks_8.c_AllErrorsAtOnce_Iteration22)
...
(declare-fun main_~lk8~0_23 () Int)
...
(assert (! (= main_~p8~0_4 0) :named ssa_14))
(assert (! (= main_~p1~0_4 0) :named ssa_15))
(assert (! (= main_~p2~0_4 0) :named ssa_16))
(assert (! (= main_~p3~0_4 0) :named ssa_17))
(assert (! (= main_~p4~0_4 0) :named ssa_18))
(assert (! (= main_~p5~0_4 0) :named ssa_19))
(assert (! (= main_~p6~0_4 0) :named ssa_20))
(assert (! (= main_~p7~0_4 0) :named ssa_21))
(assert (! (not (= main_~p8~0_4 0)) :named ssa_22))
(assert (! (not (= main_~lk8~0_6 1)) :named ssa_23))
