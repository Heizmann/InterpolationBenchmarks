...
(set-info :ultimate-id nr4.c_AllErrorsAtOnce_Iteration5)
...
(declare-fun |main_#t~short9_22| () Bool)
...
(assert (! (and (< |#StackHeapBarrier_-1| |main_~#volArray~0.base_5|) (= |main_~#volArray~0.offset_5| 0) (= (store |#valid_3| |main_~#volArray~0.base_5| v_ArrVal_10_fresh_1) |#valid_5|) (not (= |main_~#volArray~0.base_5| 0)) (= 0 (select |#valid_3| |main_~#volArray~0.base_5|)) (= main_~MINVAL~0_5 2) (= v_ArrVal_10_fresh_1 1) (= (* (mod ~CELLCOUNT~0_4 1073741824) 4) v_ArrVal_9_fresh_1) (< 1 ~CELLCOUNT~0_4) (= (store |#length_3| |main_~#volArray~0.base_5| v_ArrVal_9_fresh_1) |#length_5|)) :named ssa_5))
...
(assert (! (and (= main_~j~0_13 v_ArrVal_12_fresh_1) (= (store |#memory_int#1_3| |main_~#volArray~0.base_5| v_ArrVal_11_fresh_1) |#memory_int#1_15|) (<= main_~MINVAL~0_5 main_~j~0_13) (= (store (select |#memory_int#1_3| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~j~0_13 (- 4)) (* main_~i~0_12 16)) main_~j~0_13) v_ArrVal_11_fresh_1)) :named ssa_15))
(assert (! (= main_~j~0_13 (+ main_~j~0_16 1)) :named ssa_16))
(assert (! (< main_~j~0_16 1) :named ssa_17))
(assert (! (= main_~i~0_18 (+ main_~i~0_12 1)) :named ssa_18))
...
(assert (! (and (< main_~i~0_20 ~CELLCOUNT~0_4) (= (select (select |#memory_int#1_15| |main_~#volArray~0.base_5|) (+ (* main_~i~0_20 4) |main_~#volArray~0.offset_5|)) |v_main_#t~mem7_10_fresh_1|) (or (and (< |v_main_#t~mem7_10_fresh_1| main_~MINVAL~0_5) (not |main_#t~short9_21|)) (and |main_#t~short9_21| (<= main_~MINVAL~0_5 |v_main_#t~mem7_10_fresh_1|)))) :named ssa_21))
(assert (! (and (not |main_#t~short9_21|) (or (and |main_#t~short9_22| (= |v_main_#t~mem8_8_fresh_1| 0)) (and (not (= |v_main_#t~mem8_8_fresh_1| 0)) (not |main_#t~short9_22|))) (= |v_main_#t~mem8_8_fresh_1| (select (select |#memory_int#1_15| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_20 4))))) :named ssa_22))
(assert (! true :named ssa_23_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_23| (ite |main_#t~short9_22| 1 0)) :named ssa_23_LocVarAssigCall))
