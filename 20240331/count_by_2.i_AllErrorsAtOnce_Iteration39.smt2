...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:10:09+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration39)
...
(assert (! (<= 1000000 main_~i~0_42) :named ssa_43))
(assert (! true :named ssa_44_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_44| (ite (= main_~i~0_42 1000000) 1 0)) :named ssa_44_LocVarAssigCall))
