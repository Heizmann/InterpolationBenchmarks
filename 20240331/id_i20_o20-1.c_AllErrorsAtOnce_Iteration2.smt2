...
(set-info :ultimate-id id_i20_o20-1.c_AllErrorsAtOnce_Iteration2)
...
(declare-fun main_~result~0_16 () Int)
...
(assert (! (= |id_#res_7| |main_#t~ret5_9|) :named ssa_9_return))
