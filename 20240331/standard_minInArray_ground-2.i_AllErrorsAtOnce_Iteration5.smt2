...
(set-info :ultimate-id standard_minInArray_ground-2.i_AllErrorsAtOnce_Iteration5)
...
(declare-fun main_~min~0_11 () Int)
...
(assert (! (and (not (= |main_~#a~0.base_4| 0)) (= 400000 v_ArrVal_16_fresh_1) (= main_~min~0_4 0) (= (store |#length_3| |main_~#a~0.base_4| v_ArrVal_16_fresh_1) |#length_4|) (< |#StackHeapBarrier_-1| |main_~#a~0.base_4|) (= v_ArrVal_15_fresh_1 1) (= |main_~#a~0.offset_4| 0) (= |#valid_4| (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_15_fresh_1)) (= (select |#valid_3| |main_~#a~0.base_4|) 0) (= main_~i~0_4 0)) :named ssa_4))
(assert (! (and (= |v_main_#t~nondet1_11_fresh_1| v_ArrVal_17_fresh_1) (= main_~i~0_5 (+ main_~i~0_4 1)) (<= 0 (+ |v_main_#t~nondet1_11_fresh_1| 2147483648)) (< main_~i~0_4 100000) (<= |v_main_#t~nondet1_11_fresh_1| 2147483647) (= (store (select |#memory_int#1_3| |main_~#a~0.base_4|) (+ (* main_~i~0_4 4) |main_~#a~0.offset_4|) v_ArrVal_17_fresh_1) v_ArrVal_18_fresh_1) (= (store |#memory_int#1_3| |main_~#a~0.base_4| v_ArrVal_18_fresh_1) |#memory_int#1_5|)) :named ssa_5))
(assert (! (and (= (store (select |#memory_int#1_5| |main_~#a~0.base_4|) (+ (* main_~i~0_5 4) |main_~#a~0.offset_4|) v_ArrVal_19_fresh_1) v_ArrVal_20_fresh_1) (<= |v_main_#t~nondet1_12_fresh_1| 2147483647) (= main_~i~0_6 (+ main_~i~0_5 1)) (= |v_main_#t~nondet1_12_fresh_1| v_ArrVal_19_fresh_1) (<= 0 (+ |v_main_#t~nondet1_12_fresh_1| 2147483648)) (< main_~i~0_5 100000) (= (store |#memory_int#1_5| |main_~#a~0.base_4| v_ArrVal_20_fresh_1) |#memory_int#1_6|)) :named ssa_6))
(assert (! (and (= |v_main_#t~nondet1_13_fresh_1| v_ArrVal_21_fresh_1) (= main_~i~0_7 (+ main_~i~0_6 1)) (<= 0 (+ |v_main_#t~nondet1_13_fresh_1| 2147483648)) (<= |v_main_#t~nondet1_13_fresh_1| 2147483647) (< main_~i~0_6 100000) (= (store (select |#memory_int#1_6| |main_~#a~0.base_4|) (+ (* main_~i~0_6 4) |main_~#a~0.offset_4|) v_ArrVal_21_fresh_1) v_ArrVal_22_fresh_1) (= (store |#memory_int#1_6| |main_~#a~0.base_4| v_ArrVal_22_fresh_1) |#memory_int#1_7|)) :named ssa_7))
(assert (! (<= 100000 main_~i~0_7) :named ssa_8))
(assert (! (= main_~i~0_9 0) :named ssa_9))
(assert (! (and (= |main_#t~mem3_10| (select (select |#memory_int#1_7| |main_~#a~0.base_4|) (+ (* main_~i~0_9 4) |main_~#a~0.offset_4|))) (< main_~i~0_9 100000)) :named ssa_10))
(assert (! (and (< |main_#t~mem3_10| main_~min~0_4) (= (select (select |#memory_int#1_7| |main_~#a~0.base_4|) (+ (* main_~i~0_9 4) |main_~#a~0.offset_4|)) main_~min~0_11)) :named ssa_11))
(assert (! (= main_~i~0_12 (+ main_~i~0_9 1)) :named ssa_12))
(assert (! (and (= |main_#t~mem3_13| (select (select |#memory_int#1_7| |main_~#a~0.base_4|) (+ (* main_~i~0_12 4) |main_~#a~0.offset_4|))) (< main_~i~0_12 100000)) :named ssa_13))
(assert (! (and (< |main_#t~mem3_13| main_~min~0_11) (= (select (select |#memory_int#1_7| |main_~#a~0.base_4|) (+ (* main_~i~0_12 4) |main_~#a~0.offset_4|)) main_~min~0_14)) :named ssa_14))
(assert (! (= main_~i~0_15 (+ main_~i~0_12 1)) :named ssa_15))
(assert (! (and (= |main_#t~mem3_16| (select (select |#memory_int#1_7| |main_~#a~0.base_4|) (+ (* main_~i~0_15 4) |main_~#a~0.offset_4|))) (< main_~i~0_15 100000)) :named ssa_16))
(assert (! (and (< |main_#t~mem3_16| main_~min~0_14) (= (select (select |#memory_int#1_7| |main_~#a~0.base_4|) (+ (* main_~i~0_15 4) |main_~#a~0.offset_4|)) main_~min~0_17)) :named ssa_17))
(assert (! (= main_~i~0_18 (+ main_~i~0_15 1)) :named ssa_18))
(assert (! (<= 100000 main_~i~0_18) :named ssa_19))
(assert (! (= main_~x~0_20 0) :named ssa_20))
(assert (! (and (< main_~x~0_20 100000) (= |main_#t~mem5_21| (select (select |#memory_int#1_7| |main_~#a~0.base_4|) (+ (* main_~x~0_20 4) |main_~#a~0.offset_4|)))) :named ssa_21))
(assert (! true :named ssa_22_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_22| (ite (<= main_~min~0_17 |main_#t~mem5_21|) 1 0)) :named ssa_22_LocVarAssigCall))
