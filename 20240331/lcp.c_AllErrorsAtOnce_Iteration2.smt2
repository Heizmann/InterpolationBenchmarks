...
(set-info :ultimate-id lcp.c_AllErrorsAtOnce_Iteration2)
...
(declare-fun |v_lcp_#t~mem5_5_fresh_1| () Int)
(declare-fun |v_lcp_#t~mem6_5_fresh_1| () Int)
...
(assert (! (and (not (= |main_#t~malloc15.base_10| 0)) (< |main_#t~malloc15.base_10| |#StackHeapBarrier_-1|) (= |main_#t~malloc15.offset_10| 0) (= (* 4 (mod main_~n~0_4 1073741824)) v_ArrVal_6_fresh_1) (= (store |#length_3| |main_#t~malloc15.base_10| v_ArrVal_6_fresh_1) |#length_10|) (= v_ArrVal_5_fresh_1 1) (= (select |#valid_3| |main_#t~malloc15.base_10|) 0) (= (store |#valid_3| |main_#t~malloc15.base_10| v_ArrVal_5_fresh_1) |#valid_10|)) :named ssa_10))
(assert (! (= |old(#memory_int#2)_11| |#memory_int#2_11|) :named ssa_11_GlobVarAssigCall))
(assert (! (and (= |#Ultimate.meminit_#ptr.base_11| |main_#t~malloc15.base_10|) (= |v_#Ultimate.meminit_#ptr.offsetInParam_4_fresh_1| |main_#t~malloc15.offset_10|) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_4_fresh_1| 4) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_4_fresh_1|) (= |v_#Ultimate.meminit_#productInParam_4_fresh_1| (* main_~n~0_4 4))) :named ssa_11_LocVarAssigCall))
(assert (! (= |old(#memory_int#2)_11| |#memory_int#2_3|) :named ssa_11_OldVarAssigCall))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_7_fresh_1) (= (store |#memory_int#2_11| |#Ultimate.meminit_#ptr.base_11| v_ArrVal_7_fresh_1) |#memory_int#2_12|)) :named ssa_12))
...
(assert (! (and (or (and (= |v_lcp_#t~mem6_5_fresh_1| |v_lcp_#t~mem5_5_fresh_1|) |lcp_#t~short7_23|) (and (not (= |v_lcp_#t~mem6_5_fresh_1| |v_lcp_#t~mem5_5_fresh_1|)) (not |lcp_#t~short7_23|))) (= (select (select |#memory_int#2_12| lcp_~a.base_21) (+ lcp_~a.offset_21 (* lcp_~l~0_21 4) (* lcp_~y_21 4))) |v_lcp_#t~mem6_5_fresh_1|) (= |v_lcp_#t~mem5_5_fresh_1| (select (select |#memory_int#2_12| lcp_~a.base_21) (+ lcp_~a.offset_21 (* lcp_~l~0_21 4) (* lcp_~x_21 4)))) |lcp_#t~short7_22|) :named ssa_23))
(assert (! (not |lcp_#t~short7_23|) :named ssa_24))
...
(assert (! (and (= |#memory_int#2_0| (store |#memory_int#2_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_8_fresh_1)) (= ((as const (Array Int Int)) 0) v_ArrVal_8_fresh_1)) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! true :named ssa_-2_PendingContext))
...
(declare-fun |v_lcp_#t~mem6_6_fresh_1| () Int)
(declare-fun |v_lcp_#t~mem5_6_fresh_1| () Int)
...
(assert (! (and (= (select (select |#memory_int#2_-2| lcp_~a.base_0) (+ lcp_~a.offset_0 (* lcp_~l~0_0 4) (* lcp_~y_0 4))) |v_lcp_#t~mem6_6_fresh_1|) (= |v_lcp_#t~mem5_6_fresh_1| (select (select |#memory_int#2_-2| lcp_~a.base_0) (+ lcp_~a.offset_0 (* lcp_~l~0_0 4) (* lcp_~x_0 4)))) (or (and (not (= |v_lcp_#t~mem6_6_fresh_1| |v_lcp_#t~mem5_6_fresh_1|)) (not |lcp_#t~short7_2|)) (and (= |v_lcp_#t~mem6_6_fresh_1| |v_lcp_#t~mem5_6_fresh_1|) |lcp_#t~short7_2|)) |lcp_#t~short7_1|) :named ssa_2))
(assert (! (not |lcp_#t~short7_2|) :named ssa_3))
