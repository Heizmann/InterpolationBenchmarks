...
(set-info :ultimate-id string_concat-noarr.i_AllErrorsAtOnce_Iteration4)
...
(assert (! (or (<= 1000000 main_~i~0_11) (= |main_#t~nondet3_12| 0)) :named ssa_13))
(assert (! (< main_~j~0_11 100) :named ssa_14))
(assert (! true :named ssa_15_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_15| (ite (< main_~i~0_11 200) 1 0)) :named ssa_15_LocVarAssigCall))
