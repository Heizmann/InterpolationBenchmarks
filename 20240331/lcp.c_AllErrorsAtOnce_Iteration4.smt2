...
(set-info :ultimate-id lcp.c_AllErrorsAtOnce_Iteration4)
...
(declare-fun |v_#Ultimate.meminit_#ptr.offsetInParam_6_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#sizeOfFieldsInParam_6_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#amountOfFieldsInParam_6_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#productInParam_6_fresh_1| () Int)
...
(declare-fun |check_#t~mem10_41| () Int)
(declare-fun |check_#t~mem11_41| () Int)
(declare-fun |check_#t~mem13_42| () Int)
(declare-fun check_~y_42 () Int)
(declare-fun check_~x_42 () Int)
(declare-fun check_~a.base_42 () Int)
(declare-fun check_~a.offset_42 () Int)
(declare-fun |check_#t~mem12_42| () Int)
(declare-fun check_~n_42 () Int)
(declare-fun check_~l_42 () Int)
(declare-fun |check_#t~mem13_43| () Int)
(declare-fun |__VERIFIER_assert_#in~cond_43| () Int)
(declare-fun |check_#t~mem12_43| () Int)
...
(assert (! (and (not (= |main_#t~malloc15.base_10| 0)) (= (* 4 (mod main_~n~0_4 1073741824)) v_ArrVal_14_fresh_1) (= |#length_10| (store |#length_3| |main_#t~malloc15.base_10| v_ArrVal_14_fresh_1)) (< |main_#t~malloc15.base_10| |#StackHeapBarrier_-1|) (= |main_#t~malloc15.offset_10| 0) (= |#valid_10| (store |#valid_3| |main_#t~malloc15.base_10| v_ArrVal_13_fresh_1)) (= v_ArrVal_13_fresh_1 1) (= (select |#valid_3| |main_#t~malloc15.base_10|) 0)) :named ssa_10))
(assert (! (= |old(#memory_int#2)_11| |#memory_int#2_11|) :named ssa_11_GlobVarAssigCall))
(assert (! (and (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_6_fresh_1|) (= |#Ultimate.meminit_#ptr.base_11| |main_#t~malloc15.base_10|) (= |v_#Ultimate.meminit_#productInParam_6_fresh_1| (* main_~n~0_4 4)) (= |v_#Ultimate.meminit_#ptr.offsetInParam_6_fresh_1| |main_#t~malloc15.offset_10|) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_6_fresh_1| 4)) :named ssa_11_LocVarAssigCall))
(assert (! (= |old(#memory_int#2)_11| |#memory_int#2_3|) :named ssa_11_OldVarAssigCall))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_15_fresh_1) (= |#memory_int#2_12| (store |#memory_int#2_11| |#Ultimate.meminit_#ptr.base_11| v_ArrVal_15_fresh_1))) :named ssa_12))
...
(assert (! (and (< (+ check_~l_29 check_~y_29) check_~n_29) (< (+ check_~l_29 check_~x_29) check_~n_29) (= (select (select |#memory_int#2_12| check_~a.base_29) (+ (* check_~l_29 4) (* check_~y_29 4) check_~a.offset_29)) |check_#t~mem13_42|) (= (select (select |#memory_int#2_12| check_~a.base_29) (+ (* check_~l_29 4) (* check_~x_29 4) check_~a.offset_29)) |check_#t~mem12_42|)) :named ssa_42))
(assert (! true :named ssa_43_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_43| (ite (not (= |check_#t~mem13_42| |check_#t~mem12_42|)) 1 0)) :named ssa_43_LocVarAssigCall))
...
(assert (! (not true) :named ssa_postcond))
(assert (! (and (= |#memory_int#2_0| (store |#memory_int#2_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_16_fresh_1)) (= ((as const (Array Int Int)) 0) v_ArrVal_16_fresh_1)) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! true :named ssa_-2_PendingContext))
...
(assert (! true :named ssa_precond))
(assert (! (not (and (= |main_#t~ret18_5| 0) (or (< main_~n~0_-2 (+ main_~y~0_-2 1)) (< main_~n~0_-2 (+ main_~x~0_-2 1))))) :named ssa_postcond))
...
(declare-fun assume_abort_if_not_~cond_1 () Int)
(assert (! true :named ssa_precond))
(assert (! (not (and (= check_~l_-2 0) (or (< check_~n_-2 (+ check_~y_-2 1)) (< check_~n_-2 (+ check_~x_-2 1))))) :named ssa_postcond))
(assert (! (= |assume_abort_if_not_#in~cond_-1| assume_abort_if_not_~cond_0) :named ssa_0))
(assert (! (not (= assume_abort_if_not_~cond_0 0)) :named ssa_1))
(assert (! true :named ssa_2))
(assert (! true :named ssa_3_return))
(assert (! (and (= check_~l_-2 0) (or (< check_~n_-2 (+ check_~y_-2 1)) (< check_~n_-2 (+ check_~x_-2 1)))) :named ssa_-2_PendingContext))
