...
(set-info :ultimate-id mono-crafted_11.c_AllErrorsAtOnce_Iteration16)
...
(assert (! (<= 100000000 (mod main_~x~0_32 4294967296)) :named ssa_33))
(assert (! true :named ssa_34_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_34| (ite (= (mod main_~x~0_32 2) 0) 1 0)) :named ssa_34_LocVarAssigCall))
