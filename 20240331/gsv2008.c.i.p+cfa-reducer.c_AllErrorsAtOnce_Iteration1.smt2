...
(set-info :ultimate-id gsv2008.c.i.p+cfa-reducer.c_AllErrorsAtOnce_Iteration1)
...
(assert (! (and (<= 0 main_~main__x~0_4) (= (ite (< 0 main_~main__y~0_4) 1 0) v_main_~__tmp_1~0_4_fresh_1) (= v_main_~__tmp_1~0_4_fresh_1 main_~__VERIFIER_assert__cond~0_7)) :named ssa_7))
(assert (! (= main_~__VERIFIER_assert__cond~0_7 0) :named ssa_8))
