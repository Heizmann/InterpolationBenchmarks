...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration18)
...
(assert (! (<= 1000000 main_~i~0_21) :named ssa_22))
(assert (! true :named ssa_23_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_23| (ite (= main_~i~0_21 1000000) 1 0)) :named ssa_23_LocVarAssigCall))
