...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:11:22+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id watermelon.c_AllErrorsAtOnce_Iteration12)
...
(declare-fun v_main_~is_divisible1~0_17_fresh_1 () Int)
(declare-fun v_main_~is_divisible2~0_17_fresh_1 () Int)
...
(declare-fun correct_version_~w_12 () Int)
...
(declare-fun |correct_version_#res_15| () Int)
(declare-fun |main_#t~ret5_16| () Int)
(declare-fun main_~is_divisible1~0_16 () Int)
(declare-fun main_~w~0_17 () Int)
(declare-fun |student_version_#in~w_17| () Int)
(declare-fun student_version_~w_18 () Int)
(declare-fun student_version_~is_divisible~1_18 () Int)
(declare-fun student_version_~i~1_19 () Int)
(declare-fun student_version_~i~1_20 () Int)
...
(declare-fun |student_version_#res_26| () Int)
(declare-fun student_version_~is_divisible~1_26 () Int)
(declare-fun |main_#t~ret6_27| () Int)
(declare-fun |student_version_#res_27| () Int)
(declare-fun |main_#t~ret6_28| () Int)
(declare-fun main_~is_divisible2~0_28 () Int)
(declare-fun |__VERIFIER_assert_#in~cond_29| () Int)
(declare-fun main_~is_divisible1~0_29 () Int)
(declare-fun main_~is_divisible2~0_29 () Int)
...
(assert (! (and (= ~true~0_1 v_main_~is_divisible1~0_17_fresh_1) (= ~true~0_1 v_main_~is_divisible2~0_17_fresh_1)) :named ssa_4))
...
(assert (! (<= correct_version_~w_7 correct_version_~i~0_10) :named ssa_11))
(assert (! (= correct_version_~i~0_10 correct_version_~w_7) :named ssa_12))
(assert (! true :named ssa_13))
(assert (! (= |correct_version_#res_14| correct_version_~is_divisible~0_7) :named ssa_14))
(assert (! (= |main_#t~ret5_15| |correct_version_#res_14|) :named ssa_15_return))
(assert (! (and (= main_~is_divisible1~0_16 |main_#t~ret5_15|) (<= 0 (+ |main_#t~ret5_15| 2147483648)) (<= |main_#t~ret5_15| 2147483647)) :named ssa_16))
(assert (! true :named ssa_17_GlobVarAssigCall))
(assert (! (= |student_version_#in~w_17| (ite (<= (mod main_~w~0_4 4294967296) 2147483647) (mod main_~w~0_4 4294967296) (+ (mod main_~w~0_4 4294967296) (- 4294967296)))) :named ssa_17_LocVarAssigCall))
(assert (! true :named ssa_17_OldVarAssigCall))
(assert (! (and (= student_version_~w_18 |student_version_#in~w_17|) (= ~true~0_1 student_version_~is_divisible~1_18)) :named ssa_18))
(assert (! (and (<= 4 student_version_~w_18) (= student_version_~i~1_19 0)) :named ssa_19))
(assert (! (and (= (+ 2 student_version_~i~1_19) student_version_~i~1_20) (< student_version_~i~1_19 student_version_~w_18)) :named ssa_20))
(assert (! (and (= (+ 2 student_version_~i~1_20) student_version_~i~1_21) (< student_version_~i~1_20 student_version_~w_18)) :named ssa_21))
(assert (! (and (= (+ 2 student_version_~i~1_21) student_version_~i~1_22) (< student_version_~i~1_21 student_version_~w_18)) :named ssa_22))
(assert (! (<= student_version_~w_18 student_version_~i~1_22) :named ssa_23))
(assert (! (and (not (= student_version_~w_18 student_version_~i~1_22)) (= ~false~0_1 student_version_~is_divisible~1_24)) :named ssa_24))
(assert (! true :named ssa_25))
(assert (! (= student_version_~is_divisible~1_24 |student_version_#res_26|) :named ssa_26))
(assert (! (= |main_#t~ret6_27| |student_version_#res_26|) :named ssa_27_return))
(assert (! (and (<= |main_#t~ret6_27| 2147483647) (= main_~is_divisible2~0_28 |main_#t~ret6_27|) (<= 0 (+ |main_#t~ret6_27| 2147483648))) :named ssa_28))
(assert (! true :named ssa_29_GlobVarAssigCall))
(assert (! (= (ite (= main_~is_divisible1~0_16 main_~is_divisible2~0_28) 1 0) |__VERIFIER_assert_#in~cond_29|) :named ssa_29_LocVarAssigCall))
...
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 ssa_5 (and ssa_13 ssa_7 ssa_10 ssa_14 ssa_8 ssa_9 ssa_6_OldVarAssigCall ssa_12 ssa_6_GlobVarAssigCall ssa_11 ssa_6_LocVarAssigCall ssa_15_return) ssa_16 (and ssa_20 ssa_17_LocVarAssigCall ssa_26 ssa_17_GlobVarAssigCall ssa_27_return ssa_25 ssa_19 ssa_17_OldVarAssigCall ssa_22 ssa_21 ssa_18 ssa_23 ssa_24) ssa_28 (and ssa_29_OldVarAssigCall ssa_29_GlobVarAssigCall ssa_29_LocVarAssigCall) ssa_30 ssa_31 (and ssa_32 ssa_postcond))
...
(declare-fun correct_version_~w_5 () Int)
(declare-fun correct_version_~i~0_5 () Int)
(declare-fun correct_version_~i~0_6 () Int)
(declare-fun correct_version_~is_divisible~0_7 () Int)
(declare-fun |correct_version_#res_7| () Int)
(declare-fun |main_#t~ret5_8| () Int)
(declare-fun |correct_version_#res_8| () Int)
(assert (! true :named ssa_precond))
(assert (! (not (or (< (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647) main_~w~0_-2) (< main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 5)))) :named ssa_postcond))
...
(assert (! (<= correct_version_~w_0 correct_version_~i~0_3) :named ssa_4))
(assert (! (= correct_version_~i~0_3 correct_version_~w_0) :named ssa_5))
(assert (! true :named ssa_6))
(assert (! (= |correct_version_#res_7| correct_version_~is_divisible~0_0) :named ssa_7))
(assert (! (= |main_#t~ret5_8| |correct_version_#res_7|) :named ssa_8_return))
(assert (! true :named ssa_-2_PendingContext))
...
(assert (! (<= student_version_~w_0 student_version_~i~1_4) :named ssa_5))
(assert (! (and (not (= student_version_~w_0 student_version_~i~1_4)) (= ~false~0_-1 student_version_~is_divisible~1_6)) :named ssa_6))
(assert (! true :named ssa_7))
(assert (! (= student_version_~is_divisible~1_6 |student_version_#res_8|) :named ssa_8))
(assert (! (= |main_#t~ret6_9| |student_version_#res_8|) :named ssa_9_return))
(assert (! (or (< (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647) main_~w~0_-2) (< main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 5))) :named ssa_-2_PendingContext))
