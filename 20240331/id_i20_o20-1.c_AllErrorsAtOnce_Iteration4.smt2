...
(set-info :ultimate-id id_i20_o20-1.c_AllErrorsAtOnce_Iteration4)
...
(declare-fun main_~result~0_28 () Int)
(declare-fun |main_#t~ret5_28| () Int)
(declare-fun main_~result~0_29 () Int)
...
(assert (! (and (<= 0 (+ |main_#t~ret5_27| 2147483648)) (= main_~result~0_28 |main_#t~ret5_27|) (<= |main_#t~ret5_27| 2147483647)) :named ssa_28))
(assert (! (not (= main_~result~0_28 20)) :named ssa_29))
(assert (! true :named ssa_30))
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 (and ssa_13 ssa_14_OldVarAssigCall ssa_20 ssa_5_LocVarAssigCall ssa_18_return ssa_5_GlobVarAssigCall ssa_7 ssa_16 ssa_6 ssa_26 ssa_8_GlobVarAssigCall ssa_11_LocVarAssigCall ssa_14_LocVarAssigCall ssa_27_return ssa_10 ssa_9 ssa_25 ssa_14_GlobVarAssigCall ssa_24_return ssa_19 ssa_12 ssa_11_OldVarAssigCall ssa_5_OldVarAssigCall ssa_8_OldVarAssigCall ssa_22 ssa_15 ssa_11_GlobVarAssigCall ssa_23 ssa_21_return ssa_17 ssa_8_LocVarAssigCall) ssa_28 ssa_29 (and ssa_postcond ssa_30))
