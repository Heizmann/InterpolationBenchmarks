...
(set-info :ultimate-id standard_minInArray_ground-2.i_AllErrorsAtOnce_Iteration8)
...
(declare-fun |main_#t~mem4_14| () Int)
(declare-fun main_~min~0_14 () Int)
...
(assert (! (and (not (= |main_~#a~0.base_4| 0)) (= 400000 v_ArrVal_46_fresh_1) (= main_~min~0_4 0) (< |#StackHeapBarrier_-1| |main_~#a~0.base_4|) (= |#length_4| (store |#length_3| |main_~#a~0.base_4| v_ArrVal_46_fresh_1)) (= |main_~#a~0.offset_4| 0) (= v_ArrVal_45_fresh_1 1) (= (select |#valid_3| |main_~#a~0.base_4|) 0) (= main_~i~0_4 0) (= |#valid_4| (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_45_fresh_1))) :named ssa_4))
(assert (! (and (= (store |#memory_int#1_3| |main_~#a~0.base_4| v_ArrVal_47_fresh_1) |#memory_int#1_5|) (= main_~i~0_5 (+ main_~i~0_4 1)) (= (store (select |#memory_int#1_3| |main_~#a~0.base_4|) (+ (* main_~i~0_4 4) |main_~#a~0.offset_4|) |v_main_#t~nondet1_23_fresh_1|) v_ArrVal_47_fresh_1) (<= 0 (+ |v_main_#t~nondet1_23_fresh_1| 2147483648)) (< main_~i~0_4 100000) (= |v_main_#t~nondet1_23_fresh_1| v_ArrVal_48_fresh_1) (<= |v_main_#t~nondet1_23_fresh_1| 2147483647)) :named ssa_5))
(assert (! (and (<= 0 (+ |v_main_#t~nondet1_24_fresh_1| 2147483648)) (= (store |#memory_int#1_5| |main_~#a~0.base_4| v_ArrVal_50_fresh_1) |#memory_int#1_6|) (= main_~i~0_6 (+ main_~i~0_5 1)) (= (store (select |#memory_int#1_5| |main_~#a~0.base_4|) (+ (* main_~i~0_5 4) |main_~#a~0.offset_4|) v_ArrVal_49_fresh_1) v_ArrVal_50_fresh_1) (< main_~i~0_5 100000) (= |v_main_#t~nondet1_24_fresh_1| v_ArrVal_49_fresh_1) (<= |v_main_#t~nondet1_24_fresh_1| 2147483647)) :named ssa_6))
(assert (! (and (<= 0 (+ |v_main_#t~nondet1_25_fresh_1| 2147483648)) (= (store |#memory_int#1_6| |main_~#a~0.base_4| v_ArrVal_52_fresh_1) |#memory_int#1_7|) (= main_~i~0_7 (+ main_~i~0_6 1)) (< main_~i~0_6 100000) (<= |v_main_#t~nondet1_25_fresh_1| 2147483647) (= v_ArrVal_52_fresh_1 (store (select |#memory_int#1_6| |main_~#a~0.base_4|) (+ (* main_~i~0_6 4) |main_~#a~0.offset_4|) v_ArrVal_51_fresh_1)) (= |v_main_#t~nondet1_25_fresh_1| v_ArrVal_51_fresh_1)) :named ssa_7))
(assert (! (and (= v_ArrVal_54_fresh_1 (store (select |#memory_int#1_7| |main_~#a~0.base_4|) (+ (* main_~i~0_7 4) |main_~#a~0.offset_4|) v_ArrVal_53_fresh_1)) (= main_~i~0_8 (+ main_~i~0_7 1)) (= |v_main_#t~nondet1_26_fresh_1| v_ArrVal_53_fresh_1) (< main_~i~0_7 100000) (<= 0 (+ |v_main_#t~nondet1_26_fresh_1| 2147483648)) (<= |v_main_#t~nondet1_26_fresh_1| 2147483647) (= (store |#memory_int#1_7| |main_~#a~0.base_4| v_ArrVal_54_fresh_1) |#memory_int#1_8|)) :named ssa_8))
(assert (! (and (= (store |#memory_int#1_8| |main_~#a~0.base_4| v_ArrVal_56_fresh_1) |#memory_int#1_9|) (= main_~i~0_9 (+ main_~i~0_8 1)) (<= |v_main_#t~nondet1_27_fresh_1| 2147483647) (< main_~i~0_8 100000) (<= 0 (+ |v_main_#t~nondet1_27_fresh_1| 2147483648)) (= v_ArrVal_56_fresh_1 (store (select |#memory_int#1_8| |main_~#a~0.base_4|) (+ (* main_~i~0_8 4) |main_~#a~0.offset_4|) v_ArrVal_55_fresh_1)) (= |v_main_#t~nondet1_27_fresh_1| v_ArrVal_55_fresh_1)) :named ssa_9))
(assert (! (and (= main_~i~0_10 (+ main_~i~0_9 1)) (= (store (select |#memory_int#1_9| |main_~#a~0.base_4|) (+ (* main_~i~0_9 4) |main_~#a~0.offset_4|) v_ArrVal_57_fresh_1) v_ArrVal_58_fresh_1) (< main_~i~0_9 100000) (<= 0 (+ |v_main_#t~nondet1_28_fresh_1| 2147483648)) (<= |v_main_#t~nondet1_28_fresh_1| 2147483647) (= |#memory_int#1_10| (store |#memory_int#1_9| |main_~#a~0.base_4| v_ArrVal_58_fresh_1)) (= |v_main_#t~nondet1_28_fresh_1| v_ArrVal_57_fresh_1)) :named ssa_10))
(assert (! (<= 100000 main_~i~0_10) :named ssa_11))
(assert (! (= main_~i~0_12 0) :named ssa_12))
(assert (! (and (= |main_#t~mem3_13| (select (select |#memory_int#1_10| |main_~#a~0.base_4|) (+ (* main_~i~0_12 4) |main_~#a~0.offset_4|))) (< main_~i~0_12 100000)) :named ssa_13))
(assert (! (and (< |main_#t~mem3_13| main_~min~0_4) (= (select (select |#memory_int#1_10| |main_~#a~0.base_4|) (+ (* main_~i~0_12 4) |main_~#a~0.offset_4|)) main_~min~0_14)) :named ssa_14))
(assert (! (= main_~i~0_15 (+ main_~i~0_12 1)) :named ssa_15))
(assert (! (and (= |main_#t~mem3_16| (select (select |#memory_int#1_10| |main_~#a~0.base_4|) (+ (* main_~i~0_15 4) |main_~#a~0.offset_4|))) (< main_~i~0_15 100000)) :named ssa_16))
(assert (! (and (< |main_#t~mem3_16| main_~min~0_14) (= (select (select |#memory_int#1_10| |main_~#a~0.base_4|) (+ (* main_~i~0_15 4) |main_~#a~0.offset_4|)) main_~min~0_17)) :named ssa_17))
(assert (! (= main_~i~0_18 (+ main_~i~0_15 1)) :named ssa_18))
(assert (! (and (= |main_#t~mem3_19| (select (select |#memory_int#1_10| |main_~#a~0.base_4|) (+ (* main_~i~0_18 4) |main_~#a~0.offset_4|))) (< main_~i~0_18 100000)) :named ssa_19))
(assert (! (and (< |main_#t~mem3_19| main_~min~0_17) (= (select (select |#memory_int#1_10| |main_~#a~0.base_4|) (+ (* main_~i~0_18 4) |main_~#a~0.offset_4|)) main_~min~0_20)) :named ssa_20))
(assert (! (= main_~i~0_21 (+ main_~i~0_18 1)) :named ssa_21))
(assert (! (and (= |main_#t~mem3_22| (select (select |#memory_int#1_10| |main_~#a~0.base_4|) (+ (* main_~i~0_21 4) |main_~#a~0.offset_4|))) (< main_~i~0_21 100000)) :named ssa_22))
(assert (! (and (< |main_#t~mem3_22| main_~min~0_20) (= (select (select |#memory_int#1_10| |main_~#a~0.base_4|) (+ (* main_~i~0_21 4) |main_~#a~0.offset_4|)) main_~min~0_23)) :named ssa_23))
(assert (! (= main_~i~0_24 (+ main_~i~0_21 1)) :named ssa_24))
(assert (! (and (= |main_#t~mem3_25| (select (select |#memory_int#1_10| |main_~#a~0.base_4|) (+ (* main_~i~0_24 4) |main_~#a~0.offset_4|))) (< main_~i~0_24 100000)) :named ssa_25))
(assert (! (and (< |main_#t~mem3_25| main_~min~0_23) (= (select (select |#memory_int#1_10| |main_~#a~0.base_4|) (+ (* main_~i~0_24 4) |main_~#a~0.offset_4|)) main_~min~0_26)) :named ssa_26))
(assert (! (= main_~i~0_27 (+ main_~i~0_24 1)) :named ssa_27))
(assert (! (and (= |main_#t~mem3_28| (select (select |#memory_int#1_10| |main_~#a~0.base_4|) (+ (* main_~i~0_27 4) |main_~#a~0.offset_4|))) (< main_~i~0_27 100000)) :named ssa_28))
(assert (! (and (< |main_#t~mem3_28| main_~min~0_26) (= (select (select |#memory_int#1_10| |main_~#a~0.base_4|) (+ (* main_~i~0_27 4) |main_~#a~0.offset_4|)) main_~min~0_29)) :named ssa_29))
(assert (! (= main_~i~0_30 (+ main_~i~0_27 1)) :named ssa_30))
(assert (! (<= 100000 main_~i~0_30) :named ssa_31))
(assert (! (= main_~x~0_32 0) :named ssa_32))
(assert (! (and (< main_~x~0_32 100000) (= |main_#t~mem5_33| (select (select |#memory_int#1_10| |main_~#a~0.base_4|) (+ (* main_~x~0_32 4) |main_~#a~0.offset_4|)))) :named ssa_33))
(assert (! true :named ssa_34_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_34| (ite (<= main_~min~0_29 |main_#t~mem5_33|) 1 0)) :named ssa_34_LocVarAssigCall))
