...
(set-info :ultimate-id scalar_loopdep.i_AllErrorsAtOnce_Iteration2)
...
(assert (! (and (< 0 |#StackHeapBarrier_-1|) (= |~#a~0.base_1| 3) (= ((as const (Array Int Int)) 0) v_ArrVal_3_fresh_1) (= (select (select |#memory_int#0_0| 1) 1) 0) (= 400000 (select |#length_-1| 3)) (= (select |#valid_-1| 3) 1) (= (select |#valid_-1| 2) 1) (= (select (select |#memory_int#0_0| 1) 0) 48) (= |~#a~0.offset_1| 0) (= (select |#valid_-1| 1) 1) (= (select |#length_-1| 1) 2) (= (select |#valid_-1| 0) 0) (= (store |#memory_int#1_0| |~#a~0.base_1| v_ArrVal_3_fresh_1) |#memory_int#1_1|) (= (select |#length_-1| 2) 17)) :named ssa_1))
...
(assert (! (and (< 0 |#StackHeapBarrier_-1|) (= |~#a~0.base_0| 3) (= |#memory_int#1_0| (store |#memory_int#1_-1| |~#a~0.base_0| v_ArrVal_4_fresh_1)) (= (select (select |#memory_int#0_-1| 1) 1) 0) (= ((as const (Array Int Int)) 0) v_ArrVal_4_fresh_1) (= 400000 (select |#length_-1| 3)) (= (select |#valid_-1| 3) 1) (= (select |#valid_-1| 2) 1) (= (select (select |#memory_int#0_-1| 1) 0) 48) (= |~#a~0.offset_0| 0) (= (select |#valid_-1| 1) 1) (= (select |#length_-1| 1) 2) (= (select |#valid_-1| 0) 0) (= (select |#length_-1| 2) 17)) :named ssa_0))
