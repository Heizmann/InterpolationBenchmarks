...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:11:40+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id linear_sea.ch.c_AllErrorsAtOnce_Iteration10)
...
(declare-fun |c_aux_v_main_#t~nondet7_10| () Int)
...
(declare-fun |c_aux_v_linear_search_#t~mem4_15| () Int)
(declare-fun c_aux_v_ArrVal_42 () (Array Int Int))
(declare-fun |c_aux_v_linear_search_#t~mem4_16| () Int)
(declare-fun |c_aux_v_main_#t~nondet7_11| () Int)
...
(declare-fun |c_aux_v_linear_search_#t~mem4_17| () Int)
(declare-fun |c_aux_v_linear_search_#t~mem4_18| () Int)
(declare-fun |c_aux_v_linear_search_#t~mem4_19| () Int)
(declare-fun c_aux_v_ArrVal_48 () (Array Int Int))
(declare-fun |c_aux_v_linear_search_#t~mem4_20| () Int)
(declare-fun |c_aux_v_linear_search_#t~mem4_21| () Int)
(declare-fun |c_aux_v_linear_search_#t~mem4_22| () Int)
(declare-fun |c_aux_v_main_#t~nondet7_12| () Int)
...
(declare-fun |c_aux_v_linear_search_#t~mem4_23| () Int)
(declare-fun |c_aux_v_linear_search_#t~mem4_24| () Int)
(declare-fun |c_aux_v_linear_search_#t~mem4_25| () Int)
(declare-fun |c_aux_v_linear_search_#t~mem4_26| () Int)
(declare-fun c_aux_v_ArrVal_54 () (Array Int Int))
(declare-fun |c_aux_v_linear_search_#t~mem4_27| () Int)
(declare-fun |c_aux_v_linear_search_#t~mem4_28| () Int)
(declare-fun |c_aux_v_linear_search_#t~mem4_29| () Int)
(declare-fun |c_aux_v_linear_search_#t~mem4_30| () Int)
...
(declare-fun |v_main_#t~nondet7_13_fresh_1| () Int)
...
(declare-fun |v_linear_search_#t~mem4_31_fresh_1| () Int)
...
(declare-fun |linear_search_#t~short5_16| () Bool)
(declare-fun |v_linear_search_#t~mem4_32_fresh_1| () Int)
...
(declare-fun |linear_search_#t~short5_19| () Bool)
(declare-fun |v_linear_search_#t~mem4_33_fresh_1| () Int)
(declare-fun |linear_search_#t~short5_20| () Bool)
(declare-fun |linear_search_#t~post6_20| () Int)
(declare-fun linear_search_~j~0_20 () Int)
(declare-fun |linear_search_#t~mem4_20| () Int)
(declare-fun |linear_search_#t~short5_21| () Bool)
(declare-fun |linear_search_#t~short5_22| () Bool)
(declare-fun |v_linear_search_#t~mem4_34_fresh_1| () Int)
(declare-fun |linear_search_#t~short5_23| () Bool)
(declare-fun |linear_search_#t~post6_23| () Int)
(declare-fun linear_search_~j~0_23 () Int)
(declare-fun |linear_search_#t~mem4_23| () Int)
(declare-fun |linear_search_#t~short5_24| () Bool)
(declare-fun |linear_search_#t~short5_25| () Bool)
(declare-fun |v_linear_search_#t~mem4_35_fresh_1| () Int)
(declare-fun |linear_search_#t~short5_26| () Bool)
(declare-fun |linear_search_#t~post6_26| () Int)
(declare-fun linear_search_~j~0_26 () Int)
(declare-fun |linear_search_#t~mem4_26| () Int)
(declare-fun |linear_search_#t~short5_27| () Bool)
(declare-fun |linear_search_#t~short5_29| () Bool)
(declare-fun |linear_search_#t~mem4_29| () Int)
(declare-fun |linear_search_#res_30| () Int)
(declare-fun linear_search_~j~0_30 () Int)
(declare-fun |linear_search_#res_32| () Int)
(declare-fun |main_#t~ret9_32| () Int)
(declare-fun |__VERIFIER_assert_#in~cond_34| () Int)
(declare-fun |main_#t~ret9_34| () Int)
...
(assert (! (= (+ (div (mod |v_main_#t~nondet7_13_fresh_1| 4294967296) 8) 1) ~SIZE~0_4) :named ssa_4))
(assert (! (and (= |main_#t~malloc8.offset_5| 0) (= (store |#valid_3| |main_#t~malloc8.base_5| v_ArrVal_55_fresh_1) |#valid_5|) (= (select |#valid_3| |main_#t~malloc8.base_5|) 0) (< |main_#t~malloc8.base_5| |#StackHeapBarrier_-1|) (= (* (mod ~SIZE~0_4 1073741824) 4) v_ArrVal_56_fresh_1) (< 1 (mod ~SIZE~0_4 4294967296)) (not (= |main_#t~malloc8.base_5| 0)) (< (mod ~SIZE~0_4 4294967296) (mod ~MAX~0_1 4294967296)) (= v_ArrVal_55_fresh_1 1) (= (store |#length_3| |main_#t~malloc8.base_5| v_ArrVal_56_fresh_1) |#length_5|)) :named ssa_5))
(assert (! (= |old(#memory_int#1)_6| |#memory_int#1_6|) :named ssa_6_GlobVarAssigCall))
(assert (! (and (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_12_fresh_1| 4) (= (* ~SIZE~0_4 4) |v_#Ultimate.meminit_#productInParam_12_fresh_1|) (= ~SIZE~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_12_fresh_1|) (= |v_#Ultimate.meminit_#ptr.offsetInParam_12_fresh_1| |main_#t~malloc8.offset_5|) (= |#Ultimate.meminit_#ptr.base_6| |main_#t~malloc8.base_5|)) :named ssa_6_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_6| |#memory_int#1_3|) :named ssa_6_OldVarAssigCall))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_57_fresh_1) (= |#memory_int#1_7| (store |#memory_int#1_6| |#Ultimate.meminit_#ptr.base_6| v_ArrVal_57_fresh_1))) :named ssa_7))
(assert (! true :named ssa_8_return))
(assert (! (and (= (store |#memory_int#1_7| main_~a~0.base_9 v_ArrVal_58_fresh_1) |#memory_int#1_9|) (= |main_#t~malloc8.offset_5| main_~a~0.offset_9) (= main_~a~0.base_9 |main_#t~malloc8.base_5|) (= 3 v_ArrVal_59_fresh_1) (= v_ArrVal_58_fresh_1 (store (select |#memory_int#1_7| main_~a~0.base_9) (+ (* (ite (<= (mod (div (mod ~SIZE~0_4 4294967296) 2) 4294967296) 2147483647) (mod (div (mod ~SIZE~0_4 4294967296) 2) 4294967296) (+ (- 4294967296) (mod (div (mod ~SIZE~0_4 4294967296) 2) 4294967296))) 4) main_~a~0.offset_9) 3))) :named ssa_9))
...
(assert (! (and |linear_search_#t~short5_12| (or (and (not |linear_search_#t~short5_13|) (= linear_search_~q_11 |v_linear_search_#t~mem4_31_fresh_1|)) (and |linear_search_#t~short5_13| (not (= linear_search_~q_11 |v_linear_search_#t~mem4_31_fresh_1|)))) (= (select (select |#memory_int#1_9| linear_search_~a.base_11) (+ (* (ite (<= (mod linear_search_~j~0_11 4294967296) 2147483647) (mod linear_search_~j~0_11 4294967296) (+ (mod linear_search_~j~0_11 4294967296) (- 4294967296))) 4) linear_search_~a.offset_11)) |v_linear_search_#t~mem4_31_fresh_1|)) :named ssa_13))
...
(assert (! (and |linear_search_#t~short5_15| (= (select (select |#memory_int#1_9| linear_search_~a.base_11) (+ (* (ite (<= (mod linear_search_~j~0_14 4294967296) 2147483647) (mod linear_search_~j~0_14 4294967296) (+ (mod linear_search_~j~0_14 4294967296) (- 4294967296))) 4) linear_search_~a.offset_11)) |v_linear_search_#t~mem4_32_fresh_1|) (or (and (= linear_search_~q_11 |v_linear_search_#t~mem4_32_fresh_1|) (not |linear_search_#t~short5_16|)) (and (not (= linear_search_~q_11 |v_linear_search_#t~mem4_32_fresh_1|)) |linear_search_#t~short5_16|))) :named ssa_16))
(assert (! (and (= (+ linear_search_~j~0_14 1) linear_search_~j~0_17) |linear_search_#t~short5_16|) :named ssa_17))
...
(assert (! (and (or (and (not |linear_search_#t~short5_19|) (= linear_search_~q_11 |v_linear_search_#t~mem4_33_fresh_1|)) (and (not (= linear_search_~q_11 |v_linear_search_#t~mem4_33_fresh_1|)) |linear_search_#t~short5_19|)) (= (select (select |#memory_int#1_9| linear_search_~a.base_11) (+ (* (ite (<= (mod linear_search_~j~0_17 4294967296) 2147483647) (mod linear_search_~j~0_17 4294967296) (+ (mod linear_search_~j~0_17 4294967296) (- 4294967296))) 4) linear_search_~a.offset_11)) |v_linear_search_#t~mem4_33_fresh_1|) |linear_search_#t~short5_18|) :named ssa_19))
(assert (! (and (= (+ linear_search_~j~0_17 1) linear_search_~j~0_20) |linear_search_#t~short5_19|) :named ssa_20))
(assert (! (or (and (not |linear_search_#t~short5_21|) (<= (mod linear_search_~n_11 4294967296) (mod linear_search_~j~0_20 4294967296))) (and (< (mod linear_search_~j~0_20 4294967296) (mod linear_search_~n_11 4294967296)) |linear_search_#t~short5_21|)) :named ssa_21))
(assert (! (and |linear_search_#t~short5_21| (or (and (= linear_search_~q_11 |v_linear_search_#t~mem4_34_fresh_1|) (not |linear_search_#t~short5_22|)) (and |linear_search_#t~short5_22| (not (= linear_search_~q_11 |v_linear_search_#t~mem4_34_fresh_1|)))) (= (select (select |#memory_int#1_9| linear_search_~a.base_11) (+ (* (ite (<= (mod linear_search_~j~0_20 4294967296) 2147483647) (mod linear_search_~j~0_20 4294967296) (+ (mod linear_search_~j~0_20 4294967296) (- 4294967296))) 4) linear_search_~a.offset_11)) |v_linear_search_#t~mem4_34_fresh_1|)) :named ssa_22))
(assert (! (and (= (+ linear_search_~j~0_20 1) linear_search_~j~0_23) |linear_search_#t~short5_22|) :named ssa_23))
(assert (! (or (and (not |linear_search_#t~short5_24|) (<= (mod linear_search_~n_11 4294967296) (mod linear_search_~j~0_23 4294967296))) (and (< (mod linear_search_~j~0_23 4294967296) (mod linear_search_~n_11 4294967296)) |linear_search_#t~short5_24|)) :named ssa_24))
(assert (! (and |linear_search_#t~short5_24| (or (and (not |linear_search_#t~short5_25|) (= linear_search_~q_11 |v_linear_search_#t~mem4_35_fresh_1|)) (and |linear_search_#t~short5_25| (not (= linear_search_~q_11 |v_linear_search_#t~mem4_35_fresh_1|)))) (= (select (select |#memory_int#1_9| linear_search_~a.base_11) (+ (* (ite (<= (mod linear_search_~j~0_23 4294967296) 2147483647) (mod linear_search_~j~0_23 4294967296) (+ (mod linear_search_~j~0_23 4294967296) (- 4294967296))) 4) linear_search_~a.offset_11)) |v_linear_search_#t~mem4_35_fresh_1|)) :named ssa_25))
(assert (! (and (= (+ linear_search_~j~0_23 1) linear_search_~j~0_26) |linear_search_#t~short5_25|) :named ssa_26))
(assert (! (or (and (not |linear_search_#t~short5_27|) (<= (mod linear_search_~n_11 4294967296) (mod linear_search_~j~0_26 4294967296))) (and (< (mod linear_search_~j~0_26 4294967296) (mod linear_search_~n_11 4294967296)) |linear_search_#t~short5_27|)) :named ssa_27))
(assert (! (not |linear_search_#t~short5_27|) :named ssa_28))
(assert (! (not |linear_search_#t~short5_27|) :named ssa_29))
(assert (! (and (<= (mod ~SIZE~0_4 4294967296) (mod linear_search_~j~0_26 4294967296)) (= |linear_search_#res_30| 0)) :named ssa_30))
(assert (! true :named ssa_31))
(assert (! (= |main_#t~ret9_32| |linear_search_#res_30|) :named ssa_32_return))
(assert (! (and (<= 0 (+ |main_#t~ret9_32| 2147483648)) (<= |main_#t~ret9_32| 2147483647)) :named ssa_33))
(assert (! true :named ssa_34_GlobVarAssigCall))
(assert (! (= |main_#t~ret9_32| |__VERIFIER_assert_#in~cond_34|) :named ssa_34_LocVarAssigCall))
...
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 ssa_5 (and ssa_8_return ssa_7 ssa_6_OldVarAssigCall ssa_6_GlobVarAssigCall ssa_6_LocVarAssigCall) ssa_9 (and ssa_13 ssa_27 ssa_20 ssa_31 ssa_16 ssa_26 ssa_10_GlobVarAssigCall ssa_14 ssa_25 ssa_10_OldVarAssigCall ssa_19 ssa_32_return ssa_12 ssa_11 ssa_28 ssa_22 ssa_15 ssa_29 ssa_21 ssa_18 ssa_23 ssa_30 ssa_17 ssa_10_LocVarAssigCall ssa_24) ssa_33 (and ssa_34_GlobVarAssigCall ssa_34_LocVarAssigCall ssa_34_OldVarAssigCall) ssa_35 ssa_36 (and ssa_37 ssa_postcond))
...
(assert (! (not (and (<= 0 (div ~MAX~0_0 4294967296)) (<= ~MAX~0_0 100000))) :named ssa_postcond))
...
(assert (! (not (and (<= ~SIZE~0_-2 (+ 99999 (* (div ~SIZE~0_-2 4294967296) 4294967296))) (= |main_#t~malloc8.offset_-2| 0))) :named ssa_postcond))
(assert (! (and (= (store |#memory_int#1_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_60_fresh_1) |#memory_int#1_0|) (= ((as const (Array Int Int)) 0) v_ArrVal_60_fresh_1)) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! (and (<= ~SIZE~0_-2 (+ 99999 (* (div ~SIZE~0_-2 4294967296) 4294967296))) (= |main_#t~malloc8.offset_-2| 0)) :named ssa_-2_PendingContext))
...
(declare-fun |v_linear_search_#t~mem4_36_fresh_1| () Int)
...
(declare-fun |linear_search_#t~short5_5| () Bool)
(declare-fun |v_linear_search_#t~mem4_37_fresh_1| () Int)
...
(declare-fun |linear_search_#t~short5_8| () Bool)
(declare-fun |v_linear_search_#t~mem4_38_fresh_1| () Int)
(declare-fun |linear_search_#t~short5_9| () Bool)
(declare-fun |linear_search_#t~post6_9| () Int)
(declare-fun linear_search_~j~0_9 () Int)
(declare-fun |linear_search_#t~mem4_9| () Int)
(declare-fun |linear_search_#t~short5_10| () Bool)
(declare-fun |linear_search_#t~short5_11| () Bool)
(declare-fun |v_linear_search_#t~mem4_39_fresh_1| () Int)
(declare-fun |linear_search_#t~short5_12| () Bool)
(declare-fun |linear_search_#t~post6_12| () Int)
(declare-fun linear_search_~j~0_12 () Int)
(declare-fun |linear_search_#t~mem4_12| () Int)
(declare-fun |linear_search_#t~short5_13| () Bool)
(declare-fun |linear_search_#t~short5_14| () Bool)
(declare-fun |v_linear_search_#t~mem4_40_fresh_1| () Int)
(declare-fun |linear_search_#t~short5_15| () Bool)
(declare-fun |linear_search_#t~post6_15| () Int)
(declare-fun linear_search_~j~0_15 () Int)
(declare-fun |linear_search_#t~mem4_15| () Int)
(declare-fun |linear_search_#t~short5_16| () Bool)
(declare-fun |linear_search_#t~short5_18| () Bool)
(declare-fun |linear_search_#t~mem4_18| () Int)
(declare-fun |linear_search_#res_19| () Int)
(declare-fun linear_search_~j~0_19 () Int)
(declare-fun |linear_search_#res_21| () Int)
(declare-fun |main_#t~ret9_21| () Int)
(assert (! true :named ssa_precond))
(assert (! (not false) :named ssa_postcond))
...
(assert (! (and (or (and (not (= linear_search_~q_0 |v_linear_search_#t~mem4_36_fresh_1|)) |linear_search_#t~short5_2|) (and (not |linear_search_#t~short5_2|) (= linear_search_~q_0 |v_linear_search_#t~mem4_36_fresh_1|))) |linear_search_#t~short5_1| (= (select (select |#memory_int#1_-2| linear_search_~a.base_0) (+ (* (ite (<= (mod linear_search_~j~0_0 4294967296) 2147483647) (mod linear_search_~j~0_0 4294967296) (+ (mod linear_search_~j~0_0 4294967296) (- 4294967296))) 4) linear_search_~a.offset_0)) |v_linear_search_#t~mem4_36_fresh_1|)) :named ssa_2))
...
(assert (! (and (or (and (not (= linear_search_~q_0 |v_linear_search_#t~mem4_37_fresh_1|)) |linear_search_#t~short5_5|) (and (= linear_search_~q_0 |v_linear_search_#t~mem4_37_fresh_1|) (not |linear_search_#t~short5_5|))) |linear_search_#t~short5_4| (= (select (select |#memory_int#1_-2| linear_search_~a.base_0) (+ (* (ite (<= (mod linear_search_~j~0_3 4294967296) 2147483647) (mod linear_search_~j~0_3 4294967296) (+ (mod linear_search_~j~0_3 4294967296) (- 4294967296))) 4) linear_search_~a.offset_0)) |v_linear_search_#t~mem4_37_fresh_1|)) :named ssa_5))
(assert (! (and (= (+ linear_search_~j~0_3 1) linear_search_~j~0_6) |linear_search_#t~short5_5|) :named ssa_6))
...
(assert (! (and (or (and (= linear_search_~q_0 |v_linear_search_#t~mem4_38_fresh_1|) (not |linear_search_#t~short5_8|)) (and |linear_search_#t~short5_8| (not (= linear_search_~q_0 |v_linear_search_#t~mem4_38_fresh_1|)))) (= (select (select |#memory_int#1_-2| linear_search_~a.base_0) (+ (* (ite (<= (mod linear_search_~j~0_6 4294967296) 2147483647) (mod linear_search_~j~0_6 4294967296) (+ (mod linear_search_~j~0_6 4294967296) (- 4294967296))) 4) linear_search_~a.offset_0)) |v_linear_search_#t~mem4_38_fresh_1|) |linear_search_#t~short5_7|) :named ssa_8))
(assert (! (and (= (+ linear_search_~j~0_6 1) linear_search_~j~0_9) |linear_search_#t~short5_8|) :named ssa_9))
(assert (! (or (and (not |linear_search_#t~short5_10|) (<= (mod linear_search_~n_0 4294967296) (mod linear_search_~j~0_9 4294967296))) (and (< (mod linear_search_~j~0_9 4294967296) (mod linear_search_~n_0 4294967296)) |linear_search_#t~short5_10|)) :named ssa_10))
(assert (! (and (or (and (= linear_search_~q_0 |v_linear_search_#t~mem4_39_fresh_1|) (not |linear_search_#t~short5_11|)) (and |linear_search_#t~short5_11| (not (= linear_search_~q_0 |v_linear_search_#t~mem4_39_fresh_1|)))) (= (select (select |#memory_int#1_-2| linear_search_~a.base_0) (+ (* (ite (<= (mod linear_search_~j~0_9 4294967296) 2147483647) (mod linear_search_~j~0_9 4294967296) (+ (mod linear_search_~j~0_9 4294967296) (- 4294967296))) 4) linear_search_~a.offset_0)) |v_linear_search_#t~mem4_39_fresh_1|) |linear_search_#t~short5_10|) :named ssa_11))
(assert (! (and (= (+ linear_search_~j~0_9 1) linear_search_~j~0_12) |linear_search_#t~short5_11|) :named ssa_12))
(assert (! (or (and (not |linear_search_#t~short5_13|) (<= (mod linear_search_~n_0 4294967296) (mod linear_search_~j~0_12 4294967296))) (and (< (mod linear_search_~j~0_12 4294967296) (mod linear_search_~n_0 4294967296)) |linear_search_#t~short5_13|)) :named ssa_13))
(assert (! (and (or (and (not (= linear_search_~q_0 |v_linear_search_#t~mem4_40_fresh_1|)) |linear_search_#t~short5_14|) (and (= linear_search_~q_0 |v_linear_search_#t~mem4_40_fresh_1|) (not |linear_search_#t~short5_14|))) |linear_search_#t~short5_13| (= (select (select |#memory_int#1_-2| linear_search_~a.base_0) (+ (* (ite (<= (mod linear_search_~j~0_12 4294967296) 2147483647) (mod linear_search_~j~0_12 4294967296) (+ (mod linear_search_~j~0_12 4294967296) (- 4294967296))) 4) linear_search_~a.offset_0)) |v_linear_search_#t~mem4_40_fresh_1|)) :named ssa_14))
(assert (! (and (= (+ linear_search_~j~0_12 1) linear_search_~j~0_15) |linear_search_#t~short5_14|) :named ssa_15))
(assert (! (or (and (not |linear_search_#t~short5_16|) (<= (mod linear_search_~n_0 4294967296) (mod linear_search_~j~0_15 4294967296))) (and (< (mod linear_search_~j~0_15 4294967296) (mod linear_search_~n_0 4294967296)) |linear_search_#t~short5_16|)) :named ssa_16))
(assert (! (not |linear_search_#t~short5_16|) :named ssa_17))
(assert (! (not |linear_search_#t~short5_16|) :named ssa_18))
(assert (! (and (<= (mod ~SIZE~0_-2 4294967296) (mod linear_search_~j~0_15 4294967296)) (= |linear_search_#res_19| 0)) :named ssa_19))
(assert (! true :named ssa_20))
(assert (! (= |main_#t~ret9_21| |linear_search_#res_19|) :named ssa_21_return))
(assert (! (and (= (select (select |#memory_int#1_-2| main_~a~0.base_-2) (+ (* (- 17179869184) (div (+ (* (- 2147483648) (div ~SIZE~0_-2 4294967296)) (div ~SIZE~0_-2 2)) 4294967296)) (* (- 8589934592) (div ~SIZE~0_-2 4294967296)) (* 4 (div ~SIZE~0_-2 2)))) 3) (= main_~a~0.offset_-2 0) (<= ~SIZE~0_-2 (+ 99999 (* (div ~SIZE~0_-2 4294967296) 4294967296)))) :named ssa_-2_PendingContext))
