...
(set-info :ultimate-id Addition03-1.c_AllErrorsAtOnce_Iteration3)
...
(declare-fun main_~m~0_18 () Int)
(declare-fun main_~n~0_18 () Int)
...
(assert (! (and (= 0 addition_~n_10) (= |addition_#res_11| addition_~m_10)) :named ssa_11))
(assert (! true :named ssa_12))
(assert (! (= |addition_#res_11| |addition_#t~ret4_13|) :named ssa_13_return))
(assert (! (and (<= 0 (+ 9223372036854775808 |addition_#t~ret4_13|)) (<= |addition_#t~ret4_13| 9223372036854775807) (= |addition_#res_14| |addition_#t~ret4_13|)) :named ssa_14))
(assert (! true :named ssa_15))
(assert (! (= |addition_#res_14| |main_#t~ret8_16|) :named ssa_16_return))
(assert (! (and (<= |main_#t~ret8_16| 9223372036854775807) (<= 0 (+ |main_#t~ret8_16| 9223372036854775808)) (= main_~result~0_17 |main_#t~ret8_16|)) :named ssa_17))
(assert (! (and (< main_~result~0_17 200) (<= 100 main_~n~0_4) (<= 100 main_~m~0_4)) :named ssa_18))
(assert (! true :named ssa_19))
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 (and ssa_5_LocVarAssigCall ssa_5_GlobVarAssigCall ssa_7 ssa_6 ssa_10 ssa_14 ssa_8 ssa_13_return ssa_12 ssa_5_OldVarAssigCall ssa_11 ssa_15 ssa_16_return ssa_9_LocVarAssigCall ssa_9_OldVarAssigCall ssa_9_GlobVarAssigCall) ssa_17 ssa_18 (and ssa_19 ssa_postcond))
...
(assert (! (= |addition_#res_8| |main_#t~ret8_10|) :named ssa_10_return))
(assert (! true :named ssa_-2_PendingContext))
