...
(set-info :ultimate-id string-1.i_AllErrorsAtOnce_Iteration2)
...
(declare-fun v_main_~found~0_7_fresh_1 () Int)
...
(declare-fun |v_main_#t~nondet1_5_fresh_1| () Int)
...
(declare-fun main_~nc_A~0_12 () Int)
(declare-fun |main_#t~mem7_13| () Int)
(declare-fun |main_#t~mem7_14| () Int)
(declare-fun main_~nc_B~0_15 () Int)
...
(declare-fun main_~nc_A~0_19 () Int)
(declare-fun main_~found~0_20 () Int)
(declare-fun main_~j~0_20 () Int)
(declare-fun main_~nc_B~0_20 () Int)
(declare-fun main_~found~0_21 () Int)
...
(assert (! (and (< |#StackHeapBarrier_-1| |main_~#string_A~0.base_4|) (= v_ArrVal_8_fresh_1 1) (= main_~i~0_4 0) (= (select |#valid_3| |main_~#string_A~0.base_4|) 0) (= |main_~#string_A~0.offset_4| 0) (= 5 v_ArrVal_6_fresh_1) (not (= |main_~#string_B~0.base_4| 0)) (= |#valid_4| (store (store |#valid_3| |main_~#string_A~0.base_4| v_ArrVal_8_fresh_1) |main_~#string_B~0.base_4| v_ArrVal_5_fresh_1)) (= 5 v_ArrVal_7_fresh_1) (= |main_~#string_B~0.offset_4| 0) (= v_main_~found~0_7_fresh_1 0) (= (select (store |#valid_3| |main_~#string_A~0.base_4| v_ArrVal_8_fresh_1) |main_~#string_B~0.base_4|) 0) (= v_ArrVal_5_fresh_1 1) (not (= |main_~#string_A~0.base_4| 0)) (= |#length_4| (store (store |#length_3| |main_~#string_A~0.base_4| v_ArrVal_7_fresh_1) |main_~#string_B~0.base_4| v_ArrVal_6_fresh_1)) (< |#StackHeapBarrier_-1| |main_~#string_B~0.base_4|)) :named ssa_4))
(assert (! (and (<= |v_main_#t~nondet1_5_fresh_1| 127) (= (store |#memory_int#2_3| |main_~#string_A~0.base_4| v_ArrVal_10_fresh_1) |#memory_int#2_5|) (= |v_main_#t~nondet1_5_fresh_1| v_ArrVal_9_fresh_1) (= v_ArrVal_10_fresh_1 (store (select |#memory_int#2_3| |main_~#string_A~0.base_4|) (+ main_~i~0_4 |main_~#string_A~0.offset_4|) v_ArrVal_9_fresh_1)) (= main_~i~0_5 (+ main_~i~0_4 1)) (<= 0 (+ |v_main_#t~nondet1_5_fresh_1| 128)) (< main_~i~0_4 5)) :named ssa_5))
(assert (! (<= 5 main_~i~0_5) :named ssa_6))
(assert (! (= (select (select |#memory_int#2_5| |main_~#string_A~0.base_4|) (+ |main_~#string_A~0.offset_4| 4)) |main_#t~mem3_7|) :named ssa_7))
(assert (! (and (= main_~i~0_8 0) (= |main_#t~mem3_7| 0)) :named ssa_8))
(assert (! (and (= (store (select |#memory_int#1_3| |main_~#string_B~0.base_4|) (+ main_~i~0_8 |main_~#string_B~0.offset_4|) |v_main_#t~nondet4_5_fresh_1|) v_ArrVal_11_fresh_1) (= main_~i~0_9 (+ main_~i~0_8 1)) (= |v_main_#t~nondet4_5_fresh_1| v_ArrVal_12_fresh_1) (<= 0 (+ |v_main_#t~nondet4_5_fresh_1| 128)) (= (store |#memory_int#1_3| |main_~#string_B~0.base_4| v_ArrVal_11_fresh_1) |#memory_int#1_9|) (< main_~i~0_8 5) (<= |v_main_#t~nondet4_5_fresh_1| 127)) :named ssa_9))
(assert (! (<= 5 main_~i~0_9) :named ssa_10))
(assert (! (= |main_#t~mem6_11| (select (select |#memory_int#1_9| |main_~#string_B~0.base_4|) (+ |main_~#string_B~0.offset_4| 4))) :named ssa_11))
(assert (! (and (= main_~nc_A~0_12 0) (= |main_#t~mem6_11| 0)) :named ssa_12))
(assert (! (= (select (select |#memory_int#2_5| |main_~#string_A~0.base_4|) (+ |main_~#string_A~0.offset_4| main_~nc_A~0_12)) |main_#t~mem7_13|) :named ssa_13))
(assert (! (= |main_#t~mem7_13| 0) :named ssa_14))
(assert (! (= main_~nc_B~0_15 0) :named ssa_15))
(assert (! (= |main_#t~mem9_16| (select (select |#memory_int#1_9| |main_~#string_B~0.base_4|) (+ |main_~#string_B~0.offset_4| main_~nc_B~0_15))) :named ssa_16))
(assert (! (= |main_#t~mem9_16| 0) :named ssa_17))
(assert (! (and (= main_~j~0_18 0) (<= main_~nc_A~0_12 main_~nc_B~0_15) (= main_~i~0_18 main_~j~0_18)) :named ssa_18))
(assert (! (or (<= main_~nc_B~0_15 main_~j~0_18) (<= main_~nc_A~0_12 main_~i~0_18)) :named ssa_19))
(assert (! (= main_~found~0_20 (ite (< main_~nc_B~0_15 (+ main_~j~0_18 1)) 1 0)) :named ssa_20))
(assert (! true :named ssa_21_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_21| (ite (or (= main_~found~0_20 0) (= main_~found~0_20 1)) 1 0)) :named ssa_21_LocVarAssigCall))
