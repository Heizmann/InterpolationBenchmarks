...
(set-info :ultimate-id Addition03-1.c_AllErrorsAtOnce_Iteration7)
...
(assert (! (and (= 0 addition_~n_26) (= |addition_#res_27| addition_~m_26)) :named ssa_27))
...
(assert (! (= |addition_#res_42| |main_#t~ret8_44|) :named ssa_44_return))
(assert (! (and (<= |main_#t~ret8_44| 9223372036854775807) (<= 0 (+ |main_#t~ret8_44| 9223372036854775808)) (= main_~result~0_45 |main_#t~ret8_44|)) :named ssa_45))
(assert (! (and (< main_~result~0_45 200) (<= 100 main_~n~0_4) (<= 100 main_~m~0_4)) :named ssa_46))
(assert (! true :named ssa_47))
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 (and ssa_27 ssa_20 ssa_17_LocVarAssigCall ssa_21_LocVarAssigCall ssa_5_LocVarAssigCall ssa_31 ssa_5_GlobVarAssigCall ssa_21_OldVarAssigCall ssa_7 ssa_16 ssa_6 ssa_26 ssa_34 ssa_17_GlobVarAssigCall ssa_25_GlobVarAssigCall ssa_40 ssa_10 ssa_14 ssa_25_OldVarAssigCall ssa_38_return ssa_8 ssa_13_LocVarAssigCall ssa_13_OldVarAssigCall ssa_25_LocVarAssigCall ssa_19 ssa_29_return ssa_32_return ssa_39 ssa_43 ssa_37 ssa_13_GlobVarAssigCall ssa_17_OldVarAssigCall ssa_12 ssa_41_return ssa_5_OldVarAssigCall ssa_11 ssa_28 ssa_22 ssa_36 ssa_15 ssa_35_return ssa_18 ssa_23 ssa_30 ssa_9_LocVarAssigCall ssa_33 ssa_9_OldVarAssigCall ssa_21_GlobVarAssigCall ssa_9_GlobVarAssigCall ssa_44_return ssa_42 ssa_24) ssa_45 ssa_46 (and ssa_47 ssa_postcond))
...
(declare-fun |addition_#res_38| () Int)
(assert (! true :named ssa_precond))
(assert (! (not (<= main_~n~0_-2 5)) :named ssa_postcond))
...
(assert (! (and (<= 0 (+ 9223372036854775808 |addition_#t~ret4_35|)) (<= |addition_#t~ret4_35| 9223372036854775807) (= |addition_#res_36| |addition_#t~ret4_35|)) :named ssa_36))
(assert (! true :named ssa_37))
(assert (! (= |addition_#res_36| |main_#t~ret8_38|) :named ssa_38_return))
(assert (! true :named ssa_-2_PendingContext))
