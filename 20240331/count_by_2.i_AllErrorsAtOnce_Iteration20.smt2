...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration20)
...
(assert (! (<= 1000000 main_~i~0_23) :named ssa_24))
(assert (! true :named ssa_25_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_25| (ite (= main_~i~0_23 1000000) 1 0)) :named ssa_25_LocVarAssigCall))
