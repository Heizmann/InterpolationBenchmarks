...
(set-info :ultimate-id benchmark43_conjunctive.i_AllErrorsAtOnce_Iteration1)
...
(assert (! (or (<= 100 main_~y~0_4) (<= 100 main_~x~0_4)) :named ssa_6))
(assert (! true :named ssa_7_GlobVarAssigCall))
(assert (! (= (ite (or (= main_~x~0_4 100) (= main_~y~0_4 100)) 1 0) |__VERIFIER_assert_#in~cond_7|) :named ssa_7_LocVarAssigCall))
