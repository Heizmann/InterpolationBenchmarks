...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:11:36+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id linear_sea.ch.c_AllErrorsAtOnce_Iteration9)
...
(declare-fun |v_main_#t~nondet7_12_fresh_1| () Int)
...
(declare-fun |v_linear_search_#t~mem4_23_fresh_1| () Int)
...
(declare-fun |v_linear_search_#t~mem4_24_fresh_1| () Int)
...
(declare-fun |v_linear_search_#t~mem4_25_fresh_1| () Int)
...
(declare-fun |v_linear_search_#t~mem4_26_fresh_1| () Int)
...
(declare-fun |linear_search_#res_27| () Int)
(declare-fun linear_search_~j~0_27 () Int)
(declare-fun |linear_search_#res_29| () Int)
(declare-fun |main_#t~ret9_29| () Int)
...
(assert (! (= ~SIZE~0_4 (+ (div (mod |v_main_#t~nondet7_12_fresh_1| 4294967296) 8) 1)) :named ssa_4))
(assert (! (and (= |main_#t~malloc8.offset_5| 0) (= (select |#valid_3| |main_#t~malloc8.base_5|) 0) (= (store |#length_3| |main_#t~malloc8.base_5| v_ArrVal_50_fresh_1) |#length_5|) (< |main_#t~malloc8.base_5| |#StackHeapBarrier_-1|) (= (* (mod ~SIZE~0_4 1073741824) 4) v_ArrVal_50_fresh_1) (< 1 (mod ~SIZE~0_4 4294967296)) (not (= |main_#t~malloc8.base_5| 0)) (< (mod ~SIZE~0_4 4294967296) (mod ~MAX~0_1 4294967296)) (= v_ArrVal_49_fresh_1 1) (= (store |#valid_3| |main_#t~malloc8.base_5| v_ArrVal_49_fresh_1) |#valid_5|)) :named ssa_5))
(assert (! (= |old(#memory_int#1)_6| |#memory_int#1_6|) :named ssa_6_GlobVarAssigCall))
(assert (! (and (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_11_fresh_1| 4) (= |v_#Ultimate.meminit_#ptr.offsetInParam_11_fresh_1| |main_#t~malloc8.offset_5|) (= (* ~SIZE~0_4 4) |v_#Ultimate.meminit_#productInParam_11_fresh_1|) (= ~SIZE~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_11_fresh_1|) (= |#Ultimate.meminit_#ptr.base_6| |main_#t~malloc8.base_5|)) :named ssa_6_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_6| |#memory_int#1_3|) :named ssa_6_OldVarAssigCall))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_51_fresh_1) (= (store |#memory_int#1_6| |#Ultimate.meminit_#ptr.base_6| v_ArrVal_51_fresh_1) |#memory_int#1_7|)) :named ssa_7))
(assert (! true :named ssa_8_return))
(assert (! (and (= |main_#t~malloc8.offset_5| main_~a~0.offset_9) (= main_~a~0.base_9 |main_#t~malloc8.base_5|) (= v_ArrVal_52_fresh_1 (store (select |#memory_int#1_7| main_~a~0.base_9) (+ (* (ite (<= (mod (div (mod ~SIZE~0_4 4294967296) 2) 4294967296) 2147483647) (mod (div (mod ~SIZE~0_4 4294967296) 2) 4294967296) (+ (- 4294967296) (mod (div (mod ~SIZE~0_4 4294967296) 2) 4294967296))) 4) main_~a~0.offset_9) 3)) (= 3 v_ArrVal_53_fresh_1) (= (store |#memory_int#1_7| main_~a~0.base_9 v_ArrVal_52_fresh_1) |#memory_int#1_9|)) :named ssa_9))
...
(assert (! (and (or (and (not (= linear_search_~q_11 |v_linear_search_#t~mem4_23_fresh_1|)) |linear_search_#t~short5_13|) (and (not |linear_search_#t~short5_13|) (= linear_search_~q_11 |v_linear_search_#t~mem4_23_fresh_1|))) |linear_search_#t~short5_12| (= (select (select |#memory_int#1_9| linear_search_~a.base_11) (+ (* (ite (<= (mod linear_search_~j~0_11 4294967296) 2147483647) (mod linear_search_~j~0_11 4294967296) (+ (mod linear_search_~j~0_11 4294967296) (- 4294967296))) 4) linear_search_~a.offset_11)) |v_linear_search_#t~mem4_23_fresh_1|)) :named ssa_13))
...
(assert (! (and |linear_search_#t~short5_15| (= (select (select |#memory_int#1_9| linear_search_~a.base_11) (+ (* (ite (<= (mod linear_search_~j~0_14 4294967296) 2147483647) (mod linear_search_~j~0_14 4294967296) (+ (mod linear_search_~j~0_14 4294967296) (- 4294967296))) 4) linear_search_~a.offset_11)) |v_linear_search_#t~mem4_24_fresh_1|) (or (and (not |linear_search_#t~short5_16|) (= linear_search_~q_11 |v_linear_search_#t~mem4_24_fresh_1|)) (and (not (= linear_search_~q_11 |v_linear_search_#t~mem4_24_fresh_1|)) |linear_search_#t~short5_16|))) :named ssa_16))
...
(assert (! (and (or (and (not |linear_search_#t~short5_19|) (= linear_search_~q_11 |v_linear_search_#t~mem4_25_fresh_1|)) (and |linear_search_#t~short5_19| (not (= linear_search_~q_11 |v_linear_search_#t~mem4_25_fresh_1|)))) |linear_search_#t~short5_18| (= (select (select |#memory_int#1_9| linear_search_~a.base_11) (+ (* (ite (<= (mod linear_search_~j~0_17 4294967296) 2147483647) (mod linear_search_~j~0_17 4294967296) (+ (mod linear_search_~j~0_17 4294967296) (- 4294967296))) 4) linear_search_~a.offset_11)) |v_linear_search_#t~mem4_25_fresh_1|)) :named ssa_19))
...
(assert (! (and |linear_search_#t~short5_21| (= (select (select |#memory_int#1_9| linear_search_~a.base_11) (+ (* (ite (<= (mod linear_search_~j~0_20 4294967296) 2147483647) (mod linear_search_~j~0_20 4294967296) (+ (mod linear_search_~j~0_20 4294967296) (- 4294967296))) 4) linear_search_~a.offset_11)) |v_linear_search_#t~mem4_26_fresh_1|) (or (and (not (= linear_search_~q_11 |v_linear_search_#t~mem4_26_fresh_1|)) |linear_search_#t~short5_22|) (and (= linear_search_~q_11 |v_linear_search_#t~mem4_26_fresh_1|) (not |linear_search_#t~short5_22|)))) :named ssa_22))
...
(assert (! (not |linear_search_#t~short5_24|) :named ssa_25))
(assert (! (not |linear_search_#t~short5_24|) :named ssa_26))
(assert (! (and (<= (mod ~SIZE~0_4 4294967296) (mod linear_search_~j~0_23 4294967296)) (= |linear_search_#res_27| 0)) :named ssa_27))
(assert (! true :named ssa_28))
(assert (! (= |main_#t~ret9_29| |linear_search_#res_27|) :named ssa_29_return))
(assert (! (and (<= 0 (+ |main_#t~ret9_29| 2147483648)) (<= |main_#t~ret9_29| 2147483647)) :named ssa_30))
(assert (! true :named ssa_31_GlobVarAssigCall))
(assert (! (= |main_#t~ret9_29| |__VERIFIER_assert_#in~cond_31|) :named ssa_31_LocVarAssigCall))
...
(assert (! (and (= |#memory_int#1_0| (store |#memory_int#1_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_54_fresh_1)) (= ((as const (Array Int Int)) 0) v_ArrVal_54_fresh_1)) :named ssa_0))
(assert (! true :named ssa_1_return))
...
(declare-fun |v_linear_search_#t~mem4_27_fresh_1| () Int)
...
(declare-fun |v_linear_search_#t~mem4_28_fresh_1| () Int)
...
(declare-fun |v_linear_search_#t~mem4_29_fresh_1| () Int)
...
(declare-fun |v_linear_search_#t~mem4_30_fresh_1| () Int)
(declare-fun |linear_search_#t~short5_12| () Bool)
...
(declare-fun |linear_search_#res_16| () Int)
(declare-fun linear_search_~j~0_16 () Int)
(declare-fun |linear_search_#res_18| () Int)
...
(assert (! (and (or (and (not (= linear_search_~q_0 |v_linear_search_#t~mem4_27_fresh_1|)) |linear_search_#t~short5_2|) (and (not |linear_search_#t~short5_2|) (= linear_search_~q_0 |v_linear_search_#t~mem4_27_fresh_1|))) |linear_search_#t~short5_1| (= (select (select |#memory_int#1_-2| linear_search_~a.base_0) (+ (* (ite (<= (mod linear_search_~j~0_0 4294967296) 2147483647) (mod linear_search_~j~0_0 4294967296) (+ (mod linear_search_~j~0_0 4294967296) (- 4294967296))) 4) linear_search_~a.offset_0)) |v_linear_search_#t~mem4_27_fresh_1|)) :named ssa_2))
...
(assert (! (and (or (and (= linear_search_~q_0 |v_linear_search_#t~mem4_28_fresh_1|) (not |linear_search_#t~short5_5|)) (and |linear_search_#t~short5_5| (not (= linear_search_~q_0 |v_linear_search_#t~mem4_28_fresh_1|)))) (= (select (select |#memory_int#1_-2| linear_search_~a.base_0) (+ (* (ite (<= (mod linear_search_~j~0_3 4294967296) 2147483647) (mod linear_search_~j~0_3 4294967296) (+ (mod linear_search_~j~0_3 4294967296) (- 4294967296))) 4) linear_search_~a.offset_0)) |v_linear_search_#t~mem4_28_fresh_1|) |linear_search_#t~short5_4|) :named ssa_5))
...
(assert (! (and |linear_search_#t~short5_7| (= (select (select |#memory_int#1_-2| linear_search_~a.base_0) (+ (* (ite (<= (mod linear_search_~j~0_6 4294967296) 2147483647) (mod linear_search_~j~0_6 4294967296) (+ (mod linear_search_~j~0_6 4294967296) (- 4294967296))) 4) linear_search_~a.offset_0)) |v_linear_search_#t~mem4_29_fresh_1|) (or (and (not (= linear_search_~q_0 |v_linear_search_#t~mem4_29_fresh_1|)) |linear_search_#t~short5_8|) (and (= linear_search_~q_0 |v_linear_search_#t~mem4_29_fresh_1|) (not |linear_search_#t~short5_8|)))) :named ssa_8))
...
(assert (! (and (or (and |linear_search_#t~short5_11| (not (= linear_search_~q_0 |v_linear_search_#t~mem4_30_fresh_1|))) (and (= linear_search_~q_0 |v_linear_search_#t~mem4_30_fresh_1|) (not |linear_search_#t~short5_11|))) |linear_search_#t~short5_10| (= (select (select |#memory_int#1_-2| linear_search_~a.base_0) (+ (* (ite (<= (mod linear_search_~j~0_9 4294967296) 2147483647) (mod linear_search_~j~0_9 4294967296) (+ (mod linear_search_~j~0_9 4294967296) (- 4294967296))) 4) linear_search_~a.offset_0)) |v_linear_search_#t~mem4_30_fresh_1|)) :named ssa_11))
...
(assert (! (not |linear_search_#t~short5_13|) :named ssa_15))
(assert (! (and (<= (mod ~SIZE~0_-2 4294967296) (mod linear_search_~j~0_12 4294967296)) (= |linear_search_#res_16| 0)) :named ssa_16))
(assert (! true :named ssa_17))
(assert (! (= |main_#t~ret9_18| |linear_search_#res_16|) :named ssa_18_return))
