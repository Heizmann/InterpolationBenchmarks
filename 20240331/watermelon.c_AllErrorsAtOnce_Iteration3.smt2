...
(set-info :ultimate-id watermelon.c_AllErrorsAtOnce_Iteration3)
...
(declare-fun v_main_~is_divisible1~0_8_fresh_1 () Int)
(declare-fun v_main_~is_divisible2~0_8_fresh_1 () Int)
...
(declare-fun main_~is_divisible1~0_14 () Int)
(declare-fun main_~w~0_15 () Int)
(declare-fun |student_version_#in~w_15| () Int)
(declare-fun student_version_~w_16 () Int)
(declare-fun student_version_~is_divisible~1_16 () Int)
(declare-fun student_version_~w_17 () Int)
(declare-fun student_version_~is_divisible~1_17 () Int)
...
(assert (! (and (= v_main_~is_divisible1~0_8_fresh_1 ~true~0_1) (= v_main_~is_divisible2~0_8_fresh_1 ~true~0_1)) :named ssa_4))
...
(assert (! (<= correct_version_~w_7 correct_version_~i~0_8) :named ssa_9))
(assert (! (= correct_version_~i~0_8 correct_version_~w_7) :named ssa_10))
(assert (! true :named ssa_11))
(assert (! (= |correct_version_#res_12| correct_version_~is_divisible~0_7) :named ssa_12))
(assert (! (= |main_#t~ret5_13| |correct_version_#res_12|) :named ssa_13_return))
(assert (! (and (= main_~is_divisible1~0_14 |main_#t~ret5_13|) (<= 0 (+ |main_#t~ret5_13| 2147483648)) (<= |main_#t~ret5_13| 2147483647)) :named ssa_14))
(assert (! true :named ssa_15_GlobVarAssigCall))
(assert (! (= |student_version_#in~w_15| (ite (<= (mod main_~w~0_4 4294967296) 2147483647) (mod main_~w~0_4 4294967296) (+ (mod main_~w~0_4 4294967296) (- 4294967296)))) :named ssa_15_LocVarAssigCall))
(assert (! true :named ssa_15_OldVarAssigCall))
(assert (! (and (= student_version_~w_16 |student_version_#in~w_15|) (= ~true~0_1 student_version_~is_divisible~1_16)) :named ssa_16))
(assert (! (and (< student_version_~w_16 4) (= ~false~0_1 student_version_~is_divisible~1_17)) :named ssa_17))
(assert (! (= student_version_~is_divisible~1_17 |student_version_#res_18|) :named ssa_18))
...
(assert (! (= (ite (= main_~is_divisible1~0_14 main_~is_divisible2~0_20) 1 0) |__VERIFIER_assert_#in~cond_21|) :named ssa_21_LocVarAssigCall))
...
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 ssa_5 (and ssa_7 ssa_10 ssa_8 ssa_9 ssa_13_return ssa_6_OldVarAssigCall ssa_12 ssa_6_GlobVarAssigCall ssa_11 ssa_6_LocVarAssigCall) ssa_14 (and ssa_16 ssa_15_LocVarAssigCall ssa_15_GlobVarAssigCall ssa_19_return ssa_18 ssa_17 ssa_15_OldVarAssigCall) ssa_20 (and ssa_21_LocVarAssigCall ssa_21_OldVarAssigCall ssa_21_GlobVarAssigCall) ssa_22 ssa_23 (and ssa_postcond ssa_24))
...
(declare-fun correct_version_~w_3 () Int)
...
(declare-fun |correct_version_#res_5| () Int)
(declare-fun |main_#t~ret5_6| () Int)
(declare-fun |correct_version_#res_6| () Int)
(assert (! true :named ssa_precond))
(assert (! (not false) :named ssa_postcond))
...
(assert (! (<= correct_version_~w_0 correct_version_~i~0_1) :named ssa_2))
(assert (! (= correct_version_~i~0_1 correct_version_~w_0) :named ssa_3))
(assert (! true :named ssa_4))
(assert (! (= |correct_version_#res_5| correct_version_~is_divisible~0_0) :named ssa_5))
(assert (! (= |main_#t~ret5_6| |correct_version_#res_5|) :named ssa_6_return))
(assert (! true :named ssa_-2_PendingContext))
