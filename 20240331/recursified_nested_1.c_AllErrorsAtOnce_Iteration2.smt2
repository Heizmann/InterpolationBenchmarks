...
(set-info :ultimate-id recursified_nested_1.c_AllErrorsAtOnce_Iteration2)
...
(assert (! (and (= (select (select |#memory_int#1_3| |main_~#a~0.base_4|) |main_~#a~0.offset_4|) 6) (= (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_7_fresh_1) |#valid_4|) (= v_ArrVal_7_fresh_1 1) (< |#StackHeapBarrier_-1| |main_~#a~0.base_4|) (= v_ArrVal_6_fresh_1 0) (= (store (select |#memory_int#1_3| |main_~#a~0.base_4|) |main_~#a~0.offset_4| v_ArrVal_6_fresh_1) v_ArrVal_8_fresh_1) (not (= |main_~#a~0.base_4| 0)) (= |main_~#a~0.offset_4| 0) (= (store |#length_3| |main_~#a~0.base_4| v_ArrVal_5_fresh_1) |#length_4|) (= (select |#valid_3| |main_~#a~0.base_4|) 0) (= (store |#memory_int#1_3| |main_~#a~0.base_4| v_ArrVal_8_fresh_1) |#memory_int#1_4|) (= 4 v_ArrVal_5_fresh_1)) :named ssa_4))
...
(assert (! (and (< |func_to_recursive_line_19_to_19_0_#t~mem4_6| 6) (= v_ArrVal_10_fresh_1 (+ (select (select |#memory_int#1_5| func_to_recursive_line_19_to_19_0_~a.base_6) func_to_recursive_line_19_to_19_0_~a.offset_6) 1)) (= |#memory_int#1_7| (store |#memory_int#1_5| func_to_recursive_line_19_to_19_0_~a.base_6 v_ArrVal_9_fresh_1)) (= (store (select |#memory_int#1_5| func_to_recursive_line_19_to_19_0_~a.base_6) func_to_recursive_line_19_to_19_0_~a.offset_6 (+ (select (select |#memory_int#1_5| func_to_recursive_line_19_to_19_0_~a.base_6) func_to_recursive_line_19_to_19_0_~a.offset_6) 1)) v_ArrVal_9_fresh_1)) :named ssa_7))
...
(assert (! (and (< |func_to_recursive_line_19_to_19_0_#t~mem4_0| 6) (= (store |#memory_int#1_-1| func_to_recursive_line_19_to_19_0_~a.base_0 v_ArrVal_11_fresh_1) |#memory_int#1_1|) (= (store (select |#memory_int#1_-1| func_to_recursive_line_19_to_19_0_~a.base_0) func_to_recursive_line_19_to_19_0_~a.offset_0 (+ (select (select |#memory_int#1_-1| func_to_recursive_line_19_to_19_0_~a.base_0) func_to_recursive_line_19_to_19_0_~a.offset_0) 1)) v_ArrVal_11_fresh_1) (= v_ArrVal_12_fresh_1 (+ (select (select |#memory_int#1_-1| func_to_recursive_line_19_to_19_0_~a.base_0) func_to_recursive_line_19_to_19_0_~a.offset_0) 1))) :named ssa_1))
