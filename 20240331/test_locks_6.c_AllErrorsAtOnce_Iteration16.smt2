...
(set-info :ultimate-id test_locks_6.c_AllErrorsAtOnce_Iteration16)
...
(declare-fun main_~lk6~0_19 () Int)
...
(assert (! (= main_~p5~0_4 0) :named ssa_17))
(assert (! (not (= main_~p6~0_4 0)) :named ssa_18))
(assert (! (not (= main_~lk6~0_6 1)) :named ssa_19))
