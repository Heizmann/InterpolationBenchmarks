...
(set-info :ultimate-id duplets.c_AllErrorsAtOnce_Iteration2)
...
(declare-fun v_mkdup_~x~0_7_fresh_1 () Int)
...
(declare-fun finddup_~n_37 () Int)
(declare-fun finddup_~i~1_37 () Int)
(declare-fun |finddup_#res_38| () Int)
(declare-fun |main_#t~ret14_40| () Int)
(declare-fun |finddup_#res_40| () Int)
(declare-fun |main_#t~ret14_41| () Int)
(declare-fun main_~r~0_41 () Int)
...
(assert (! (and (= (* 4 (mod main_~n~0_4 1073741824)) v_ArrVal_15_fresh_1) (not (= 0 |main_#t~malloc13.base_10|)) (< |main_#t~malloc13.base_10| |#StackHeapBarrier_-1|) (= |main_#t~malloc13.offset_10| 0) (= v_ArrVal_16_fresh_1 1) (= (select |#valid_3| |main_#t~malloc13.base_10|) 0) (= (store |#valid_3| |main_#t~malloc13.base_10| v_ArrVal_16_fresh_1) |#valid_10|) (= (store |#length_3| |main_#t~malloc13.base_10| v_ArrVal_15_fresh_1) |#length_10|)) :named ssa_10))
(assert (! (= |old(#memory_int#2)_11| |#memory_int#2_11|) :named ssa_11_GlobVarAssigCall))
(assert (! (and (= |v_#Ultimate.meminit_#ptr.offsetInParam_4_fresh_1| |main_#t~malloc13.offset_10|) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_4_fresh_1|) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_4_fresh_1| 4) (= |v_#Ultimate.meminit_#productInParam_4_fresh_1| (* main_~n~0_4 4)) (= |#Ultimate.meminit_#ptr.base_11| |main_#t~malloc13.base_10|)) :named ssa_11_LocVarAssigCall))
(assert (! (= |old(#memory_int#2)_11| |#memory_int#2_3|) :named ssa_11_OldVarAssigCall))
(assert (! (and (= |#memory_int#2_12| (store |#memory_int#2_11| |#Ultimate.meminit_#ptr.base_11| v_ArrVal_17_fresh_1)) (= ((as const (Array Int Int)) 0) v_ArrVal_17_fresh_1)) :named ssa_12))
...
(assert (! (and (= |#memory_int#2_32| (store |#memory_int#2_15| mkdup_~a.base_16 v_ArrVal_18_fresh_1)) (= (store (store (select |#memory_int#2_15| mkdup_~a.base_16) (+ (* mkdup_~i~0_16 4) mkdup_~a.offset_16) v_mkdup_~x~0_7_fresh_1) (+ mkdup_~a.offset_16 (* mkdup_~j~0_16 4)) v_mkdup_~x~0_7_fresh_1) v_ArrVal_18_fresh_1) (<= 0 (+ v_mkdup_~x~0_7_fresh_1 2147483648)) (= v_mkdup_~x~0_7_fresh_1 v_ArrVal_20_fresh_1) (<= v_mkdup_~x~0_7_fresh_1 2147483647) (= v_mkdup_~x~0_7_fresh_1 v_ArrVal_19_fresh_1)) :named ssa_32))
(assert (! true :named ssa_33_return))
(assert (! (and (= 4 v_ArrVal_21_fresh_1) (= |main_~#i~2.offset_34| 0) (= (select |#valid_10| |main_~#i~2.base_34|) 0) (= |main_~#j~2.offset_34| 0) (not (= |main_~#j~2.base_34| 0)) (< |#StackHeapBarrier_-1| |main_~#j~2.base_34|) (= 4 v_ArrVal_23_fresh_1) (= v_ArrVal_24_fresh_1 1) (= v_ArrVal_22_fresh_1 1) (= (store (store |#length_10| |main_~#i~2.base_34| v_ArrVal_21_fresh_1) |main_~#j~2.base_34| v_ArrVal_23_fresh_1) |#length_34|) (not (= |main_~#i~2.base_34| 0)) (= |#valid_34| (store (store |#valid_10| |main_~#i~2.base_34| v_ArrVal_22_fresh_1) |main_~#j~2.base_34| v_ArrVal_24_fresh_1)) (< |#StackHeapBarrier_-1| |main_~#i~2.base_34|) (= (select (store |#valid_10| |main_~#i~2.base_34| v_ArrVal_22_fresh_1) |main_~#j~2.base_34|) 0)) :named ssa_34))
...
(assert (! (<= finddup_~n_36 finddup_~i~1_36) :named ssa_37))
(assert (! (= |finddup_#res_38| 0) :named ssa_38))
(assert (! true :named ssa_39))
(assert (! (= |main_#t~ret14_40| |finddup_#res_38|) :named ssa_40_return))
(assert (! (and (= main_~r~0_41 |main_#t~ret14_40|) (<= |main_#t~ret14_40| 2147483647) (<= 0 (+ |main_#t~ret14_40| 2147483648))) :named ssa_41))
(assert (! true :named ssa_42_GlobVarAssigCall))
(assert (! (= main_~r~0_41 |__VERIFIER_assert_#in~cond_42|) :named ssa_42_LocVarAssigCall))
...
(assert (! (not true) :named ssa_postcond))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_25_fresh_1) (= (store |#memory_int#2_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_25_fresh_1) |#memory_int#2_0|)) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! true :named ssa_-2_PendingContext))
...
(declare-fun v_mkdup_~x~0_8_fresh_1 () Int)
(declare-fun v_ArrVal_26_fresh_1 () Int)
(declare-fun v_ArrVal_27_fresh_1 () (Array Int Int))
(assert (! (= |#memory_int#2_-1| |old(#memory_int#2)_-1|) :named ssa_precond))
(assert (! (not (<= 1 main_~n~0_-2)) :named ssa_postcond))
...
(assert (! (and (= v_ArrVal_27_fresh_1 (store (store (select |#memory_int#2_-1| mkdup_~a.base_0) (+ (* mkdup_~i~0_0 4) mkdup_~a.offset_0) v_mkdup_~x~0_8_fresh_1) (+ mkdup_~a.offset_0 (* mkdup_~j~0_0 4)) v_ArrVal_26_fresh_1)) (= v_mkdup_~x~0_8_fresh_1 v_ArrVal_26_fresh_1) (= v_mkdup_~x~0_8_fresh_1 v_ArrVal_28_fresh_1) (= |#memory_int#2_16| (store |#memory_int#2_-1| mkdup_~a.base_0 v_ArrVal_27_fresh_1)) (<= 0 (+ v_mkdup_~x~0_8_fresh_1 2147483648)) (<= v_mkdup_~x~0_8_fresh_1 2147483647)) :named ssa_16))
...
(declare-fun assume_abort_if_not_~cond_1 () Int)
(assert (! true :named ssa_precond))
(assert (! (not (and (<= 1 mkdup_~n_-2) (= |mkdup_#in~n_-2| mkdup_~n_-2))) :named ssa_postcond))
(assert (! (= |assume_abort_if_not_#in~cond_-1| assume_abort_if_not_~cond_0) :named ssa_0))
(assert (! (not (= assume_abort_if_not_~cond_0 0)) :named ssa_1))
(assert (! true :named ssa_2))
(assert (! true :named ssa_3_return))
...
(declare-fun assume_abort_if_not_~cond_1 () Int)
(assert (! true :named ssa_precond))
(assert (! (not (<= 1 |mkdup_#in~n_-2|)) :named ssa_postcond))
(assert (! (= |assume_abort_if_not_#in~cond_-1| assume_abort_if_not_~cond_0) :named ssa_0))
(assert (! (not (= assume_abort_if_not_~cond_0 0)) :named ssa_1))
(assert (! true :named ssa_2))
(assert (! true :named ssa_3_return))
(assert (! (and (<= 1 mkdup_~n_-2) (= |mkdup_#in~n_-2| mkdup_~n_-2)) :named ssa_-2_PendingContext))
...
(assert (! true :named ssa_2))
(assert (! true :named ssa_3_return))
(assert (! (<= 1 |mkdup_#in~n_-2|) :named ssa_-2_PendingContext))
...
(declare-fun finddup_~n_1 () Int)
(declare-fun finddup_~i~1_1 () Int)
(declare-fun |finddup_#res_2| () Int)
(declare-fun |main_#t~ret14_4| () Int)
(declare-fun |finddup_#res_4| () Int)
...
(assert (! (<= finddup_~n_0 finddup_~i~1_0) :named ssa_1))
(assert (! (= |finddup_#res_2| 0) :named ssa_2))
(assert (! true :named ssa_3))
(assert (! (= |main_#t~ret14_4| |finddup_#res_2|) :named ssa_4_return))
(assert (! (<= 1 main_~n~0_-2) :named ssa_-2_PendingContext))
