...
(set-info :ultimate-id zonotope_3.c_AllErrorsAtOnce_Iteration3)
...
(declare-fun v_main_~y~0_8_fresh_1 () Real)
...
(declare-fun v_main_~z~0_8_fresh_1 () Real)
...
(declare-fun v_main_~u~0_9_fresh_1 () Real)
...
(declare-fun v_main_~y~0_9_fresh_1 () Real)
...
(declare-fun v_main_~z~0_9_fresh_1 () Real)
...
(assert (! (= v_main_~y~0_8_fresh_1 |main_#t~ret4_7|) :named ssa_8))
...
(assert (! (= v_main_~z~0_8_fresh_1 |main_#t~ret5_11|) :named ssa_12))
...
(assert (! (= v_main_~u~0_9_fresh_1 |main_#t~ret6_15|) :named ssa_16))
...
(assert (! (= |assume_abort_if_not_#in~cond_22| (ite (and v_~someBinaryFLOATComparisonOperation_18_fresh_1 v_~someBinaryFLOATComparisonOperation_17_fresh_1) 1 0)) :named ssa_22_LocVarAssigCall))
...
(assert (! (= v_main_~y~0_9_fresh_1 |main_#t~ret9_29|) :named ssa_30))
...
(assert (! (= v_main_~z~0_9_fresh_1 |main_#t~ret10_33|) :named ssa_34))
...
(assert (! (= (ite (and v_~someBinaryFLOATComparisonOperation_20_fresh_1 v_~someBinaryFLOATComparisonOperation_19_fresh_1) 1 0) |__VERIFIER_assert_#in~cond_45|) :named ssa_45_LocVarAssigCall))
