...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration17)
...
(assert (! (<= 1000000 main_~i~0_20) :named ssa_21))
(assert (! true :named ssa_22_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_22| (ite (= main_~i~0_20 1000000) 1 0)) :named ssa_22_LocVarAssigCall))
