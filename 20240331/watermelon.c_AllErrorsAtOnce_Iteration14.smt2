...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:11:23+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id watermelon.c_AllErrorsAtOnce_Iteration14)
...
(declare-fun v_main_~is_divisible1~0_19_fresh_1 () Int)
(declare-fun v_main_~is_divisible2~0_19_fresh_1 () Int)
...
(declare-fun student_version_~w_25 () Int)
(declare-fun student_version_~is_divisible~1_25 () Int)
(declare-fun student_version_~i~1_26 () Int)
(declare-fun |student_version_#res_27| () Int)
(declare-fun student_version_~is_divisible~1_27 () Int)
(declare-fun |main_#t~ret6_28| () Int)
(declare-fun |student_version_#res_28| () Int)
(declare-fun |main_#t~ret6_29| () Int)
(declare-fun main_~is_divisible2~0_29 () Int)
(declare-fun |__VERIFIER_assert_#in~cond_30| () Int)
(declare-fun main_~is_divisible1~0_30 () Int)
(declare-fun main_~is_divisible2~0_30 () Int)
...
(assert (! (and (= ~true~0_1 v_main_~is_divisible1~0_19_fresh_1) (= ~true~0_1 v_main_~is_divisible2~0_19_fresh_1)) :named ssa_4))
...
(assert (! (= correct_version_~i~0_11 correct_version_~w_7) :named ssa_13))
(assert (! true :named ssa_14))
(assert (! (= |correct_version_#res_15| correct_version_~is_divisible~0_7) :named ssa_15))
...
(assert (! (and (= (+ 2 student_version_~i~1_22) student_version_~i~1_23) (< student_version_~i~1_22 student_version_~w_19)) :named ssa_23))
(assert (! (<= student_version_~w_19 student_version_~i~1_23) :named ssa_24))
(assert (! (and (not (= student_version_~w_19 student_version_~i~1_23)) (= ~false~0_1 student_version_~is_divisible~1_25)) :named ssa_25))
(assert (! true :named ssa_26))
(assert (! (= student_version_~is_divisible~1_25 |student_version_#res_27|) :named ssa_27))
(assert (! (= |main_#t~ret6_28| |student_version_#res_27|) :named ssa_28_return))
(assert (! (and (<= |main_#t~ret6_28| 2147483647) (= main_~is_divisible2~0_29 |main_#t~ret6_28|) (<= 0 (+ |main_#t~ret6_28| 2147483648))) :named ssa_29))
(assert (! true :named ssa_30_GlobVarAssigCall))
(assert (! (= (ite (= main_~is_divisible1~0_17 main_~is_divisible2~0_29) 1 0) |__VERIFIER_assert_#in~cond_30|) :named ssa_30_LocVarAssigCall))
...
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 ssa_5 (and ssa_13 ssa_7 ssa_10 ssa_14 ssa_8 ssa_9 ssa_6_OldVarAssigCall ssa_12 ssa_6_GlobVarAssigCall ssa_11 ssa_15 ssa_6_LocVarAssigCall ssa_16_return) ssa_17 (and ssa_27 ssa_20 ssa_18_LocVarAssigCall ssa_26 ssa_25 ssa_28_return ssa_19 ssa_18_GlobVarAssigCall ssa_22 ssa_21 ssa_23 ssa_18_OldVarAssigCall ssa_24) ssa_29 (and ssa_30_LocVarAssigCall ssa_30_OldVarAssigCall ssa_30_GlobVarAssigCall) ssa_31 ssa_32 (and ssa_postcond ssa_33))
...
(assert (! true :named ssa_precond))
(assert (! (not (and (<= main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647)) (<= (+ (* (div main_~w~0_-2 4294967296) 4294967296) 6) main_~w~0_-2))) :named ssa_postcond))
...
(assert (! (= correct_version_~i~0_4 correct_version_~w_0) :named ssa_6))
(assert (! true :named ssa_7))
(assert (! (= |correct_version_#res_8| correct_version_~is_divisible~0_0) :named ssa_8))
...
(assert (! (and (<= main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647)) (<= (+ (* (div main_~w~0_-2 4294967296) 4294967296) 6) main_~w~0_-2)) :named ssa_-2_PendingContext))
