...
(set-info :ultimate-id mono-crafted_11.c_AllErrorsAtOnce_Iteration13)
...
(assert (! (<= 100000000 (mod main_~x~0_26 4294967296)) :named ssa_27))
(assert (! true :named ssa_28_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_28| (ite (= (mod main_~x~0_26 2) 0) 1 0)) :named ssa_28_LocVarAssigCall))
