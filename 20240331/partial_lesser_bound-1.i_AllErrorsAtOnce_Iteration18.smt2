...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-30T23:51:49+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id partial_lesser_bound-1.i_AllErrorsAtOnce_Iteration18)
...
(assert (! (and (< 0 |#StackHeapBarrier_-1|) (= |~#a~0.offset_1| 0) (= |~#a~0.base_1| 3) (= |#memory_int#1_1| (store |#memory_int#1_0| |~#a~0.base_1| v_ArrVal_515_fresh_1)) (= (select (select |#memory_int#0_0| 1) 1) 0) (= 40000000 (select |#length_-1| 3)) (= (select |#length_-1| 2) 25) (= (select |#valid_-1| 3) 1) (= (select |#valid_-1| 2) 1) (= (select (select |#memory_int#0_0| 1) 0) 48) (= ~i~0_1 0) (= ((as const (Array Int Int)) 0) v_ArrVal_515_fresh_1) (= (select |#valid_-1| 1) 1) (= (select |#length_-1| 1) 2) (= (select |#valid_-1| 0) 0)) :named ssa_1))
...
(assert (! (and (= v_ArrVal_517_fresh_1 0) (< ~i~0_4 10000000) (= ~i~0_5 (+ ~i~0_4 1)) (= (store |#memory_int#1_3| |~#a~0.base_1| v_ArrVal_516_fresh_1) |#memory_int#1_5|) (= v_ArrVal_516_fresh_1 (store (select |#memory_int#1_3| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_4 4)) 0))) :named ssa_5))
(assert (! (and (= v_ArrVal_518_fresh_1 (store (select |#memory_int#1_5| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_5 4)) 0)) (= (store |#memory_int#1_5| |~#a~0.base_1| v_ArrVal_518_fresh_1) |#memory_int#1_6|) (< ~i~0_5 10000000) (= v_ArrVal_519_fresh_1 0) (= ~i~0_6 (+ ~i~0_5 1))) :named ssa_6))
(assert (! (and (< ~i~0_6 10000000) (= |#memory_int#1_7| (store |#memory_int#1_6| |~#a~0.base_1| v_ArrVal_520_fresh_1)) (= v_ArrVal_521_fresh_1 0) (= v_ArrVal_520_fresh_1 (store (select |#memory_int#1_6| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_6 4)) 0)) (= ~i~0_7 (+ ~i~0_6 1))) :named ssa_7))
(assert (! (and (= v_ArrVal_523_fresh_1 0) (= |#memory_int#1_8| (store |#memory_int#1_7| |~#a~0.base_1| v_ArrVal_522_fresh_1)) (< ~i~0_7 10000000) (= v_ArrVal_522_fresh_1 (store (select |#memory_int#1_7| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_7 4)) 0)) (= ~i~0_8 (+ ~i~0_7 1))) :named ssa_8))
(assert (! (and (= v_ArrVal_524_fresh_1 (store (select |#memory_int#1_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_8 4)) 0)) (< ~i~0_8 10000000) (= v_ArrVal_525_fresh_1 0) (= ~i~0_9 (+ ~i~0_8 1)) (= |#memory_int#1_9| (store |#memory_int#1_8| |~#a~0.base_1| v_ArrVal_524_fresh_1))) :named ssa_9))
(assert (! (and (< ~i~0_9 10000000) (= v_ArrVal_526_fresh_1 (store (select |#memory_int#1_9| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_9 4)) 0)) (= ~i~0_10 (+ ~i~0_9 1)) (= v_ArrVal_527_fresh_1 0) (= (store |#memory_int#1_9| |~#a~0.base_1| v_ArrVal_526_fresh_1) |#memory_int#1_10|)) :named ssa_10))
(assert (! (and (= |#memory_int#1_11| (store |#memory_int#1_10| |~#a~0.base_1| v_ArrVal_528_fresh_1)) (< ~i~0_10 10000000) (= v_ArrVal_529_fresh_1 0) (= v_ArrVal_528_fresh_1 (store (select |#memory_int#1_10| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_10 4)) 0)) (= ~i~0_11 (+ ~i~0_10 1))) :named ssa_11))
(assert (! (and (< ~i~0_11 10000000) (= v_ArrVal_530_fresh_1 (store (select |#memory_int#1_11| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_11 4)) 0)) (= v_ArrVal_531_fresh_1 0) (= ~i~0_12 (+ ~i~0_11 1)) (= |#memory_int#1_12| (store |#memory_int#1_11| |~#a~0.base_1| v_ArrVal_530_fresh_1))) :named ssa_12))
(assert (! (and (= v_ArrVal_533_fresh_1 0) (< ~i~0_12 10000000) (= (store |#memory_int#1_12| |~#a~0.base_1| v_ArrVal_532_fresh_1) |#memory_int#1_13|) (= ~i~0_13 (+ ~i~0_12 1)) (= v_ArrVal_532_fresh_1 (store (select |#memory_int#1_12| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_12 4)) 0))) :named ssa_13))
(assert (! (and (= |#memory_int#1_14| (store |#memory_int#1_13| |~#a~0.base_1| v_ArrVal_534_fresh_1)) (< ~i~0_13 10000000) (= v_ArrVal_535_fresh_1 0) (= v_ArrVal_534_fresh_1 (store (select |#memory_int#1_13| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_13 4)) 0)) (= ~i~0_14 (+ ~i~0_13 1))) :named ssa_14))
(assert (! (and (= v_ArrVal_537_fresh_1 0) (< ~i~0_14 10000000) (= ~i~0_15 (+ ~i~0_14 1)) (= |#memory_int#1_15| (store |#memory_int#1_14| |~#a~0.base_1| v_ArrVal_536_fresh_1)) (= v_ArrVal_536_fresh_1 (store (select |#memory_int#1_14| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_14 4)) 0))) :named ssa_15))
(assert (! (and (= v_ArrVal_538_fresh_1 (store (select |#memory_int#1_15| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_15 4)) 0)) (= |#memory_int#1_16| (store |#memory_int#1_15| |~#a~0.base_1| v_ArrVal_538_fresh_1)) (< ~i~0_15 10000000) (= v_ArrVal_539_fresh_1 0) (= ~i~0_16 (+ ~i~0_15 1))) :named ssa_16))
(assert (! (and (< ~i~0_16 10000000) (= (store |#memory_int#1_16| |~#a~0.base_1| v_ArrVal_540_fresh_1) |#memory_int#1_17|) (= v_ArrVal_540_fresh_1 (store (select |#memory_int#1_16| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_16 4)) 0)) (= ~i~0_17 (+ ~i~0_16 1)) (= v_ArrVal_541_fresh_1 0)) :named ssa_17))
(assert (! (and (= v_ArrVal_542_fresh_1 (store (select |#memory_int#1_17| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_17 4)) 0)) (< ~i~0_17 10000000) (= |#memory_int#1_18| (store |#memory_int#1_17| |~#a~0.base_1| v_ArrVal_542_fresh_1)) (= v_ArrVal_543_fresh_1 0) (= ~i~0_18 (+ ~i~0_17 1))) :named ssa_18))
(assert (! (and (= |#memory_int#1_19| (store |#memory_int#1_18| |~#a~0.base_1| v_ArrVal_544_fresh_1)) (< ~i~0_18 10000000) (= v_ArrVal_545_fresh_1 0) (= ~i~0_19 (+ ~i~0_18 1)) (= v_ArrVal_544_fresh_1 (store (select |#memory_int#1_18| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_18 4)) 0))) :named ssa_19))
(assert (! (and (= v_ArrVal_546_fresh_1 (store (select |#memory_int#1_19| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_19 4)) 0)) (= v_ArrVal_547_fresh_1 0) (< ~i~0_19 10000000) (= (store |#memory_int#1_19| |~#a~0.base_1| v_ArrVal_546_fresh_1) |#memory_int#1_20|) (= ~i~0_20 (+ ~i~0_19 1))) :named ssa_20))
(assert (! (<= 10000000 ~i~0_20) :named ssa_21))
(assert (! (= ~i~0_22 0) :named ssa_22))
(assert (! (and (= ~i~0_23 (+ ~i~0_22 1)) (= (store |#memory_int#1_20| |~#a~0.base_1| v_ArrVal_548_fresh_1) |#memory_int#1_23|) (= v_ArrVal_549_fresh_1 10) (= v_ArrVal_548_fresh_1 (store (select |#memory_int#1_20| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_22 4)) 10)) (< ~i~0_22 5000000)) :named ssa_23))
(assert (! (and (= ~i~0_24 (+ ~i~0_23 1)) (< ~i~0_23 5000000) (= (store |#memory_int#1_23| |~#a~0.base_1| v_ArrVal_550_fresh_1) |#memory_int#1_24|) (= v_ArrVal_551_fresh_1 10) (= v_ArrVal_550_fresh_1 (store (select |#memory_int#1_23| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_23 4)) 10))) :named ssa_24))
(assert (! (and (= v_ArrVal_553_fresh_1 10) (= ~i~0_25 (+ ~i~0_24 1)) (< ~i~0_24 5000000) (= (store |#memory_int#1_24| |~#a~0.base_1| v_ArrVal_552_fresh_1) |#memory_int#1_25|) (= v_ArrVal_552_fresh_1 (store (select |#memory_int#1_24| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_24 4)) 10))) :named ssa_25))
(assert (! (and (= ~i~0_26 (+ ~i~0_25 1)) (= |#memory_int#1_26| (store |#memory_int#1_25| |~#a~0.base_1| v_ArrVal_554_fresh_1)) (= v_ArrVal_554_fresh_1 (store (select |#memory_int#1_25| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_25 4)) 10)) (< ~i~0_25 5000000) (= v_ArrVal_555_fresh_1 10)) :named ssa_26))
(assert (! (and (= ~i~0_27 (+ ~i~0_26 1)) (= v_ArrVal_556_fresh_1 (store (select |#memory_int#1_26| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_26 4)) 10)) (= |#memory_int#1_27| (store |#memory_int#1_26| |~#a~0.base_1| v_ArrVal_556_fresh_1)) (< ~i~0_26 5000000) (= v_ArrVal_557_fresh_1 10)) :named ssa_27))
(assert (! (and (= ~i~0_28 (+ ~i~0_27 1)) (< ~i~0_27 5000000) (= (store |#memory_int#1_27| |~#a~0.base_1| v_ArrVal_558_fresh_1) |#memory_int#1_28|) (= v_ArrVal_559_fresh_1 10) (= v_ArrVal_558_fresh_1 (store (select |#memory_int#1_27| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_27 4)) 10))) :named ssa_28))
(assert (! (and (= v_ArrVal_560_fresh_1 (store (select |#memory_int#1_28| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_28 4)) 10)) (= ~i~0_29 (+ ~i~0_28 1)) (= |#memory_int#1_29| (store |#memory_int#1_28| |~#a~0.base_1| v_ArrVal_560_fresh_1)) (< ~i~0_28 5000000) (= v_ArrVal_561_fresh_1 10)) :named ssa_29))
(assert (! (and (= ~i~0_30 (+ ~i~0_29 1)) (= v_ArrVal_563_fresh_1 10) (< ~i~0_29 5000000) (= v_ArrVal_562_fresh_1 (store (select |#memory_int#1_29| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_29 4)) 10)) (= |#memory_int#1_30| (store |#memory_int#1_29| |~#a~0.base_1| v_ArrVal_562_fresh_1))) :named ssa_30))
(assert (! (and (= ~i~0_31 (+ ~i~0_30 1)) (= v_ArrVal_564_fresh_1 (store (select |#memory_int#1_30| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_30 4)) 10)) (< ~i~0_30 5000000) (= |#memory_int#1_31| (store |#memory_int#1_30| |~#a~0.base_1| v_ArrVal_564_fresh_1)) (= v_ArrVal_565_fresh_1 10)) :named ssa_31))
(assert (! (and (= ~i~0_32 (+ ~i~0_31 1)) (= (store |#memory_int#1_31| |~#a~0.base_1| v_ArrVal_566_fresh_1) |#memory_int#1_32|) (= v_ArrVal_566_fresh_1 (store (select |#memory_int#1_31| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_31 4)) 10)) (< ~i~0_31 5000000) (= v_ArrVal_567_fresh_1 10)) :named ssa_32))
(assert (! (and (= ~i~0_33 (+ ~i~0_32 1)) (= (store |#memory_int#1_32| |~#a~0.base_1| v_ArrVal_568_fresh_1) |#memory_int#1_33|) (= v_ArrVal_568_fresh_1 (store (select |#memory_int#1_32| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_32 4)) 10)) (< ~i~0_32 5000000) (= v_ArrVal_569_fresh_1 10)) :named ssa_33))
(assert (! (and (= ~i~0_34 (+ ~i~0_33 1)) (= |#memory_int#1_34| (store |#memory_int#1_33| |~#a~0.base_1| v_ArrVal_570_fresh_1)) (= v_ArrVal_571_fresh_1 10) (< ~i~0_33 5000000) (= v_ArrVal_570_fresh_1 (store (select |#memory_int#1_33| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_33 4)) 10))) :named ssa_34))
(assert (! (and (= ~i~0_35 (+ ~i~0_34 1)) (= v_ArrVal_573_fresh_1 10) (= v_ArrVal_572_fresh_1 (store (select |#memory_int#1_34| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_34 4)) 10)) (< ~i~0_34 5000000) (= (store |#memory_int#1_34| |~#a~0.base_1| v_ArrVal_572_fresh_1) |#memory_int#1_35|)) :named ssa_35))
(assert (! (and (= ~i~0_36 (+ ~i~0_35 1)) (= (store |#memory_int#1_35| |~#a~0.base_1| v_ArrVal_574_fresh_1) |#memory_int#1_36|) (= v_ArrVal_574_fresh_1 (store (select |#memory_int#1_35| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_35 4)) 10)) (< ~i~0_35 5000000) (= v_ArrVal_575_fresh_1 10)) :named ssa_36))
(assert (! (and (= ~i~0_37 (+ ~i~0_36 1)) (= v_ArrVal_577_fresh_1 10) (< ~i~0_36 5000000) (= |#memory_int#1_37| (store |#memory_int#1_36| |~#a~0.base_1| v_ArrVal_576_fresh_1)) (= v_ArrVal_576_fresh_1 (store (select |#memory_int#1_36| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_36 4)) 10))) :named ssa_37))
(assert (! (and (= ~i~0_38 (+ ~i~0_37 1)) (= (store |#memory_int#1_37| |~#a~0.base_1| v_ArrVal_578_fresh_1) |#memory_int#1_38|) (< ~i~0_37 5000000) (= v_ArrVal_579_fresh_1 10) (= v_ArrVal_578_fresh_1 (store (select |#memory_int#1_37| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* ~i~0_37 4)) 10))) :named ssa_38))
(assert (! (<= 5000000 ~i~0_38) :named ssa_39))
(assert (! (= ~i~0_40 0) :named ssa_40))
(assert (! (and (< ~i~0_40 5000000) (= (select (select |#memory_int#1_38| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* 4 ~i~0_40))) |main_#t~mem3_41|)) :named ssa_41))
(assert (! true :named ssa_42_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_42| (ite (= |main_#t~mem3_41| 10) 1 0)) :named ssa_42_LocVarAssigCall))
...
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_580_fresh_1) (< 0 |#StackHeapBarrier_-1|) (= |~#a~0.offset_0| 0) (= |~#a~0.base_0| 3) (= (select (select |#memory_int#0_-1| 1) 1) 0) (= |#memory_int#1_0| (store |#memory_int#1_-1| |~#a~0.base_0| v_ArrVal_580_fresh_1)) (= 40000000 (select |#length_-1| 3)) (= (select |#length_-1| 2) 25) (= (select |#valid_-1| 3) 1) (= (select |#valid_-1| 2) 1) (= (select (select |#memory_int#0_-1| 1) 0) 48) (= ~i~0_0 0) (= (select |#valid_-1| 1) 1) (= (select |#length_-1| 1) 2) (= (select |#valid_-1| 0) 0)) :named ssa_0))
