...
(set-info :ultimate-id array_4.i_AllErrorsAtOnce_Iteration17)
...
(assert (! (and (= (select |#valid_3| |main_~#A~0.base_4|) 0) (not (= |main_~#A~0.base_4| 0)) (= 0 |main_~#A~0.offset_4|) (= (store |#length_3| |main_~#A~0.base_4| v_ArrVal_230_fresh_1) |#length_4|) (< |#StackHeapBarrier_-1| |main_~#A~0.base_4|) (= v_ArrVal_229_fresh_1 1) (= |#valid_4| (store |#valid_3| |main_~#A~0.base_4| v_ArrVal_229_fresh_1)) (= main_~i~0_4 0) (= v_ArrVal_230_fresh_1 4096)) :named ssa_4))
(assert (! (and (<= 0 (+ |v_main_#t~nondet1_90_fresh_1| 2147483648)) (= main_~i~0_5 (+ main_~i~0_4 1)) (< main_~i~0_4 1023) (<= |v_main_#t~nondet1_90_fresh_1| 2147483647) (= v_ArrVal_231_fresh_1 (store (select |#memory_int#1_3| |main_~#A~0.base_4|) (+ (* main_~i~0_4 4) |main_~#A~0.offset_4|) |v_main_#t~nondet1_90_fresh_1|)) (= v_ArrVal_232_fresh_1 |v_main_#t~nondet1_90_fresh_1|) (= (store |#memory_int#1_3| |main_~#A~0.base_4| v_ArrVal_231_fresh_1) |#memory_int#1_5|)) :named ssa_5))
(assert (! (and (= v_ArrVal_233_fresh_1 (store (select |#memory_int#1_5| |main_~#A~0.base_4|) (+ (* main_~i~0_5 4) |main_~#A~0.offset_4|) |v_main_#t~nondet1_91_fresh_1|)) (= main_~i~0_6 (+ main_~i~0_5 1)) (<= 0 (+ |v_main_#t~nondet1_91_fresh_1| 2147483648)) (< main_~i~0_5 1023) (= v_ArrVal_234_fresh_1 |v_main_#t~nondet1_91_fresh_1|) (<= |v_main_#t~nondet1_91_fresh_1| 2147483647) (= (store |#memory_int#1_5| |main_~#A~0.base_4| v_ArrVal_233_fresh_1) |#memory_int#1_6|)) :named ssa_6))
(assert (! (and (= v_ArrVal_235_fresh_1 (store (select |#memory_int#1_6| |main_~#A~0.base_4|) (+ (* main_~i~0_6 4) |main_~#A~0.offset_4|) |v_main_#t~nondet1_92_fresh_1|)) (= main_~i~0_7 (+ main_~i~0_6 1)) (<= 0 (+ |v_main_#t~nondet1_92_fresh_1| 2147483648)) (< main_~i~0_6 1023) (<= |v_main_#t~nondet1_92_fresh_1| 2147483647) (= v_ArrVal_236_fresh_1 |v_main_#t~nondet1_92_fresh_1|) (= (store |#memory_int#1_6| |main_~#A~0.base_4| v_ArrVal_235_fresh_1) |#memory_int#1_7|)) :named ssa_7))
(assert (! (and (= v_ArrVal_237_fresh_1 |v_main_#t~nondet1_93_fresh_1|) (= main_~i~0_8 (+ main_~i~0_7 1)) (= v_ArrVal_238_fresh_1 (store (select |#memory_int#1_7| |main_~#A~0.base_4|) (+ (* main_~i~0_7 4) |main_~#A~0.offset_4|) v_ArrVal_237_fresh_1)) (< main_~i~0_7 1023) (<= 0 (+ |v_main_#t~nondet1_93_fresh_1| 2147483648)) (= (store |#memory_int#1_7| |main_~#A~0.base_4| v_ArrVal_238_fresh_1) |#memory_int#1_8|) (<= |v_main_#t~nondet1_93_fresh_1| 2147483647)) :named ssa_8))
(assert (! (and (= main_~i~0_9 (+ main_~i~0_8 1)) (< main_~i~0_8 1023) (= v_ArrVal_239_fresh_1 (store (select |#memory_int#1_8| |main_~#A~0.base_4|) (+ (* main_~i~0_8 4) |main_~#A~0.offset_4|) |v_main_#t~nondet1_94_fresh_1|)) (= (store |#memory_int#1_8| |main_~#A~0.base_4| v_ArrVal_239_fresh_1) |#memory_int#1_9|) (<= |v_main_#t~nondet1_94_fresh_1| 2147483647) (<= 0 (+ |v_main_#t~nondet1_94_fresh_1| 2147483648)) (= v_ArrVal_240_fresh_1 |v_main_#t~nondet1_94_fresh_1|)) :named ssa_9))
(assert (! (and (= v_ArrVal_241_fresh_1 |v_main_#t~nondet1_95_fresh_1|) (= v_ArrVal_242_fresh_1 (store (select |#memory_int#1_9| |main_~#A~0.base_4|) (+ (* main_~i~0_9 4) |main_~#A~0.offset_4|) v_ArrVal_241_fresh_1)) (= main_~i~0_10 (+ main_~i~0_9 1)) (= (store |#memory_int#1_9| |main_~#A~0.base_4| v_ArrVal_242_fresh_1) |#memory_int#1_10|) (<= |v_main_#t~nondet1_95_fresh_1| 2147483647) (<= 0 (+ |v_main_#t~nondet1_95_fresh_1| 2147483648)) (< main_~i~0_9 1023)) :named ssa_10))
(assert (! (and (= v_ArrVal_243_fresh_1 (store (select |#memory_int#1_10| |main_~#A~0.base_4|) (+ (* main_~i~0_10 4) |main_~#A~0.offset_4|) |v_main_#t~nondet1_96_fresh_1|)) (<= 0 (+ |v_main_#t~nondet1_96_fresh_1| 2147483648)) (= main_~i~0_11 (+ main_~i~0_10 1)) (= v_ArrVal_244_fresh_1 |v_main_#t~nondet1_96_fresh_1|) (< main_~i~0_10 1023) (= (store |#memory_int#1_10| |main_~#A~0.base_4| v_ArrVal_243_fresh_1) |#memory_int#1_11|) (<= |v_main_#t~nondet1_96_fresh_1| 2147483647)) :named ssa_11))
(assert (! (and (<= 0 (+ |v_main_#t~nondet1_97_fresh_1| 2147483648)) (= main_~i~0_12 (+ main_~i~0_11 1)) (< main_~i~0_11 1023) (= v_ArrVal_246_fresh_1 |v_main_#t~nondet1_97_fresh_1|) (<= |v_main_#t~nondet1_97_fresh_1| 2147483647) (= (store |#memory_int#1_11| |main_~#A~0.base_4| v_ArrVal_245_fresh_1) |#memory_int#1_12|) (= v_ArrVal_245_fresh_1 (store (select |#memory_int#1_11| |main_~#A~0.base_4|) (+ (* main_~i~0_11 4) |main_~#A~0.offset_4|) |v_main_#t~nondet1_97_fresh_1|))) :named ssa_12))
(assert (! (and (= v_ArrVal_247_fresh_1 (store (select |#memory_int#1_12| |main_~#A~0.base_4|) (+ (* main_~i~0_12 4) |main_~#A~0.offset_4|) |v_main_#t~nondet1_98_fresh_1|)) (= v_ArrVal_248_fresh_1 |v_main_#t~nondet1_98_fresh_1|) (= main_~i~0_13 (+ main_~i~0_12 1)) (< main_~i~0_12 1023) (= |#memory_int#1_13| (store |#memory_int#1_12| |main_~#A~0.base_4| v_ArrVal_247_fresh_1)) (<= |v_main_#t~nondet1_98_fresh_1| 2147483647) (<= 0 (+ |v_main_#t~nondet1_98_fresh_1| 2147483648))) :named ssa_13))
(assert (! (and (= v_ArrVal_249_fresh_1 |v_main_#t~nondet1_99_fresh_1|) (<= |v_main_#t~nondet1_99_fresh_1| 2147483647) (= main_~i~0_14 (+ main_~i~0_13 1)) (= v_ArrVal_250_fresh_1 (store (select |#memory_int#1_13| |main_~#A~0.base_4|) (+ (* main_~i~0_13 4) |main_~#A~0.offset_4|) v_ArrVal_249_fresh_1)) (< main_~i~0_13 1023) (<= 0 (+ |v_main_#t~nondet1_99_fresh_1| 2147483648)) (= (store |#memory_int#1_13| |main_~#A~0.base_4| v_ArrVal_250_fresh_1) |#memory_int#1_14|)) :named ssa_14))
(assert (! (and (<= 0 (+ |v_main_#t~nondet1_100_fresh_1| 2147483648)) (= main_~i~0_15 (+ main_~i~0_14 1)) (= (store |#memory_int#1_14| |main_~#A~0.base_4| v_ArrVal_251_fresh_1) |#memory_int#1_15|) (< main_~i~0_14 1023) (= v_ArrVal_251_fresh_1 (store (select |#memory_int#1_14| |main_~#A~0.base_4|) (+ (* main_~i~0_14 4) |main_~#A~0.offset_4|) |v_main_#t~nondet1_100_fresh_1|)) (= v_ArrVal_252_fresh_1 |v_main_#t~nondet1_100_fresh_1|) (<= |v_main_#t~nondet1_100_fresh_1| 2147483647)) :named ssa_15))
(assert (! (and (= main_~i~0_16 (+ main_~i~0_15 1)) (<= 0 (+ |v_main_#t~nondet1_101_fresh_1| 2147483648)) (< main_~i~0_15 1023) (= v_ArrVal_254_fresh_1 |v_main_#t~nondet1_101_fresh_1|) (<= |v_main_#t~nondet1_101_fresh_1| 2147483647) (= v_ArrVal_253_fresh_1 (store (select |#memory_int#1_15| |main_~#A~0.base_4|) (+ (* main_~i~0_15 4) |main_~#A~0.offset_4|) |v_main_#t~nondet1_101_fresh_1|)) (= (store |#memory_int#1_15| |main_~#A~0.base_4| v_ArrVal_253_fresh_1) |#memory_int#1_16|)) :named ssa_16))
(assert (! (and (<= |v_main_#t~nondet1_102_fresh_1| 2147483647) (= v_ArrVal_255_fresh_1 (store (select |#memory_int#1_16| |main_~#A~0.base_4|) (+ (* main_~i~0_16 4) |main_~#A~0.offset_4|) |v_main_#t~nondet1_102_fresh_1|)) (= main_~i~0_17 (+ main_~i~0_16 1)) (< main_~i~0_16 1023) (<= 0 (+ |v_main_#t~nondet1_102_fresh_1| 2147483648)) (= (store |#memory_int#1_16| |main_~#A~0.base_4| v_ArrVal_255_fresh_1) |#memory_int#1_17|) (= v_ArrVal_256_fresh_1 |v_main_#t~nondet1_102_fresh_1|)) :named ssa_17))
(assert (! (<= 1023 main_~i~0_17) :named ssa_18))
(assert (! (and (= (store |#memory_int#1_17| |main_~#A~0.base_4| v_ArrVal_257_fresh_1) |#memory_int#1_19|) (= main_~i~0_19 0) (= v_ArrVal_257_fresh_1 (store (select |#memory_int#1_17| |main_~#A~0.base_4|) (+ 4092 |main_~#A~0.offset_4|) 0)) (= v_ArrVal_258_fresh_1 0)) :named ssa_19))
(assert (! (= |main_#t~mem3_20| (select (select |#memory_int#1_19| |main_~#A~0.base_4|) (+ (* main_~i~0_19 4) |main_~#A~0.offset_4|))) :named ssa_20))
(assert (! (and (= main_~i~0_21 (+ main_~i~0_19 1)) (not (= |main_#t~mem3_20| 0))) :named ssa_21))
(assert (! (= |main_#t~mem3_22| (select (select |#memory_int#1_19| |main_~#A~0.base_4|) (+ (* main_~i~0_21 4) |main_~#A~0.offset_4|))) :named ssa_22))
(assert (! (and (= main_~i~0_23 (+ main_~i~0_21 1)) (not (= |main_#t~mem3_22| 0))) :named ssa_23))
(assert (! (= |main_#t~mem3_24| (select (select |#memory_int#1_19| |main_~#A~0.base_4|) (+ (* main_~i~0_23 4) |main_~#A~0.offset_4|))) :named ssa_24))
(assert (! (= |main_#t~mem3_24| 0) :named ssa_25))
(assert (! true :named ssa_26_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_26| (ite (<= main_~i~0_23 1024) 1 0)) :named ssa_26_LocVarAssigCall))
