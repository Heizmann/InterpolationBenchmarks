...
(set-info :ultimate-id prefixsum_iter.c_AllErrorsAtOnce_Iteration6)
...
(declare-fun downsweep_~right~1_44 () Int)
...
(declare-fun |check_#in~a.offset_50| () Int)
(declare-fun main_~a0~0.offset_50 () Int)
(declare-fun |check_#in~a.base_50| () Int)
(declare-fun main_~a~0.base_50 () Int)
(declare-fun main_~n~0_50 () Int)
(declare-fun main_~a~0.offset_50 () Int)
(declare-fun |check_#in~a0.base_50| () Int)
(declare-fun |check_#in~n_50| () Int)
(declare-fun main_~a0~0.base_50 () Int)
(declare-fun |check_#in~a0.offset_50| () Int)
(declare-fun check_~a0.base_51 () Int)
(declare-fun check_~a.base_51 () Int)
(declare-fun check_~a.offset_51 () Int)
(declare-fun check_~i~0_51 () Int)
(declare-fun check_~sum~0_51 () Int)
(declare-fun check_~a0.offset_51 () Int)
(declare-fun check_~n_51 () Int)
...
(assert (! (and (not (= |main_#t~malloc15.base_21| 0)) (= (store |#valid_3| |main_#t~malloc15.base_21| v_ArrVal_71_fresh_1) |#valid_21|) (< |main_#t~malloc15.base_21| |#StackHeapBarrier_-1|) (= |main_#t~malloc15.offset_21| 0) (= (store |#length_3| |main_#t~malloc15.base_21| v_ArrVal_72_fresh_1) |#length_21|) (= v_ArrVal_71_fresh_1 1) (= v_ArrVal_72_fresh_1 (* (mod main_~n~0_4 1073741824) 4)) (= (select |#valid_3| |main_#t~malloc15.base_21|) 0)) :named ssa_21))
(assert (! (= |old(#memory_int#1)_22| |#memory_int#1_22|) :named ssa_22_GlobVarAssigCall))
(assert (! (and (= |#Ultimate.meminit_#ptr.base_22| |main_#t~malloc15.base_21|) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_15_fresh_1|) (= |v_#Ultimate.meminit_#ptr.offsetInParam_15_fresh_1| |main_#t~malloc15.offset_21|) (= (* main_~n~0_4 4) |v_#Ultimate.meminit_#productInParam_15_fresh_1|) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_15_fresh_1| 4)) :named ssa_22_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_22| |#memory_int#1_3|) :named ssa_22_OldVarAssigCall))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_73_fresh_1) (= (store |#memory_int#1_22| |#Ultimate.meminit_#ptr.base_22| v_ArrVal_73_fresh_1) |#memory_int#1_23|)) :named ssa_23))
(assert (! true :named ssa_24_return))
(assert (! (and (= (select |#valid_21| |main_#t~malloc16.base_25|) 0) (not (= |main_#t~malloc16.base_25| 0)) (= v_ArrVal_74_fresh_1 1) (= (store |#length_21| |main_#t~malloc16.base_25| v_ArrVal_75_fresh_1) |#length_25|) (= (* (mod main_~n~0_4 1073741824) 4) v_ArrVal_75_fresh_1) (= |#valid_25| (store |#valid_21| |main_#t~malloc16.base_25| v_ArrVal_74_fresh_1)) (= |main_#t~malloc16.offset_25| 0) (= main_~a~0.offset_25 |main_#t~malloc15.offset_21|) (= main_~a~0.base_25 |main_#t~malloc15.base_21|) (< |main_#t~malloc16.base_25| |#StackHeapBarrier_-1|)) :named ssa_25))
(assert (! (= |old(#memory_int#1)_26| |#memory_int#1_26|) :named ssa_26_GlobVarAssigCall))
(assert (! (and (= (* main_~n~0_4 4) |v_#Ultimate.meminit_#productInParam_16_fresh_1|) (= |v_#Ultimate.meminit_#ptr.offsetInParam_16_fresh_1| |main_#t~malloc16.offset_25|) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_16_fresh_1|) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_16_fresh_1| 4) (= |#Ultimate.meminit_#ptr.base_26| |main_#t~malloc16.base_25|)) :named ssa_26_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_26| |#memory_int#1_23|) :named ssa_26_OldVarAssigCall))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_76_fresh_1) (= (store |#memory_int#1_26| |#Ultimate.meminit_#ptr.base_26| v_ArrVal_76_fresh_1) |#memory_int#1_27|)) :named ssa_27))
...
(assert (! (and (< main_~i~1_29 main_~n~0_4) (= |#memory_int#1_30| (store |#memory_int#1_27| main_~a0~0.base_29 v_ArrVal_78_fresh_1)) (= (store (select |#memory_int#1_27| main_~a0~0.base_29) (+ main_~a0~0.offset_29 (* main_~i~1_29 4)) v_ArrVal_77_fresh_1) v_ArrVal_78_fresh_1) (= (select (select |#memory_int#1_27| main_~a~0.base_25) (+ main_~a~0.offset_25 (* main_~i~1_29 4))) v_ArrVal_77_fresh_1) (= main_~i~1_30 (+ main_~i~1_29 1))) :named ssa_30))
...
(assert (! (and (< upsweep_~left~0_34 upsweep_~n_33) (= (store (select |#memory_int#1_32| upsweep_~a.base_33) (+ (* upsweep_~left~0_34 4) upsweep_~a.offset_33 (* upsweep_~space~0_33 4)) (+ (select (select |#memory_int#1_32| upsweep_~a.base_33) (+ (* upsweep_~left~0_34 4) upsweep_~a.offset_33)) (select (select |#memory_int#1_32| upsweep_~a.base_33) (+ (* upsweep_~left~0_34 4) upsweep_~a.offset_33 (* upsweep_~space~0_33 4))))) v_ArrVal_79_fresh_1) (= (+ (* 2 upsweep_~space~0_33) upsweep_~left~0_34) upsweep_~left~0_35) (= (store |#memory_int#1_32| upsweep_~a.base_33 v_ArrVal_79_fresh_1) |#memory_int#1_35|) (= (+ (select (select |#memory_int#1_32| upsweep_~a.base_33) (+ (* upsweep_~left~0_34 4) upsweep_~a.offset_33)) (select (select |#memory_int#1_32| upsweep_~a.base_33) (+ (* upsweep_~left~0_34 4) upsweep_~a.offset_33 (* upsweep_~space~0_33 4)))) v_ArrVal_80_fresh_1)) :named ssa_35))
...
(assert (! (and (= downsweep_~space_43 (ite (and (not (= (mod |downsweep_#in~space_42| 2) 0)) (< |downsweep_#in~space_42| 0)) (+ (div |downsweep_#in~space_42| 2) 1) (div |downsweep_#in~space_42| 2))) (= downsweep_~a.base_43 |downsweep_#in~a.base_42|) (= downsweep_~a.offset_43 |downsweep_#in~a.offset_42|) (= v_ArrVal_81_fresh_1 0) (= (store (select |#memory_int#1_42| downsweep_~a.base_43) (+ downsweep_~a.offset_43 (- 4) (* downsweep_~n_43 4)) v_ArrVal_81_fresh_1) v_ArrVal_82_fresh_1) (= (store |#memory_int#1_42| downsweep_~a.base_43 v_ArrVal_82_fresh_1) |#memory_int#1_43|) (= downsweep_~n_43 |downsweep_#in~n_42|)) :named ssa_43))
(assert (! (and (< 0 downsweep_~space_43) (= (+ downsweep_~right~1_44 1) (* 2 downsweep_~space_43))) :named ssa_44))
(assert (! (<= downsweep_~n_43 downsweep_~right~1_44) :named ssa_45))
(assert (! (= downsweep_~space_46 (ite (and (< downsweep_~space_43 0) (not (= (mod downsweep_~space_43 2) 0))) (+ (div downsweep_~space_43 2) 1) (div downsweep_~space_43 2))) :named ssa_46))
(assert (! (<= downsweep_~space_46 0) :named ssa_47))
(assert (! true :named ssa_48))
(assert (! true :named ssa_49_return))
(assert (! true :named ssa_50_GlobVarAssigCall))
(assert (! (and (= main_~a0~0.offset_29 |check_#in~a0.offset_50|) (= main_~a0~0.base_29 |check_#in~a0.base_50|) (= |check_#in~a.offset_50| main_~a~0.offset_25) (= main_~n~0_4 |check_#in~n_50|) (= |check_#in~a.base_50| main_~a~0.base_25)) :named ssa_50_LocVarAssigCall))
(assert (! true :named ssa_50_OldVarAssigCall))
(assert (! (and (= |check_#in~a.offset_50| check_~a.offset_51) (= |check_#in~a0.offset_50| check_~a0.offset_51) (= check_~a.base_51 |check_#in~a.base_50|) (= check_~i~0_51 0) (= check_~a0.base_51 |check_#in~a0.base_50|) (= check_~sum~0_51 0) (= check_~n_51 |check_#in~n_50|)) :named ssa_51))
(assert (! (and (= |check_#t~mem10_52| (select (select |#memory_int#1_43| check_~a.base_51) (+ (* check_~i~0_51 4) check_~a.offset_51))) (< check_~i~0_51 check_~n_51)) :named ssa_52))
...
(assert (! (not true) :named ssa_postcond))
(assert (! (and (= (store |#memory_int#1_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_83_fresh_1) |#memory_int#1_0|) (= ((as const (Array Int Int)) 0) v_ArrVal_83_fresh_1)) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! true :named ssa_-2_PendingContext))
...
(assert (! (= |#memory_int#1_-1| |old(#memory_int#1)_-1|) :named ssa_precond))
(assert (! (not true) :named ssa_postcond))
(assert (! (and (= (store |#memory_int#1_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_84_fresh_1) |#memory_int#1_0|) (= ((as const (Array Int Int)) 0) v_ArrVal_84_fresh_1)) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! true :named ssa_-2_PendingContext))
...
(assert (! (and (= (+ (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0)) (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0 (* upsweep_~space~0_0 4)))) v_ArrVal_86_fresh_1) (= (store |#memory_int#1_-1| upsweep_~a.base_0 v_ArrVal_85_fresh_1) |#memory_int#1_2|) (< upsweep_~left~0_1 upsweep_~n_0) (= (+ (* 2 upsweep_~space~0_0) upsweep_~left~0_1) upsweep_~left~0_2) (= (store (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0 (* upsweep_~space~0_0 4)) (+ (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0)) (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0 (* upsweep_~space~0_0 4))))) v_ArrVal_85_fresh_1)) :named ssa_2))
...
(assert (! (= |#memory_int#1_-1| |old(#memory_int#1)_-1|) :named ssa_precond))
(assert (! (not false) :named ssa_postcond))
(assert (! (and (= downsweep_~space_0 (ite (and (not (= (mod |downsweep_#in~space_-1| 2) 0)) (< |downsweep_#in~space_-1| 0)) (+ (div |downsweep_#in~space_-1| 2) 1) (div |downsweep_#in~space_-1| 2))) (= (store |#memory_int#1_-1| downsweep_~a.base_0 v_ArrVal_88_fresh_1) |#memory_int#1_0|) (= downsweep_~a.base_0 |downsweep_#in~a.base_-1|) (= (store (select |#memory_int#1_-1| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (- 4) (* downsweep_~n_0 4)) v_ArrVal_87_fresh_1) v_ArrVal_88_fresh_1) (= downsweep_~a.offset_0 |downsweep_#in~a.offset_-1|) (= downsweep_~n_0 |downsweep_#in~n_-1|) (= v_ArrVal_87_fresh_1 0)) :named ssa_0))
