...
(set-info :ultimate-id id2_b3_o5.c_AllErrorsAtOnce_Iteration9)
...
(declare-fun main_~result~0_31 () Int)
...
(assert (! (= |id_#res_28| |main_#t~ret7_30|) :named ssa_30_return))
(assert (! (= main_~result~0_31 |main_#t~ret7_30|) :named ssa_31))
(assert (! (= 5 (mod main_~result~0_31 4294967296)) :named ssa_32))
(assert (! true :named ssa_33))
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 (and ssa_13 ssa_14_OldVarAssigCall ssa_27 ssa_20 ssa_5_LocVarAssigCall ssa_18_return ssa_5_GlobVarAssigCall ssa_7 ssa_16 ssa_6 ssa_8_GlobVarAssigCall ssa_11_LocVarAssigCall ssa_14_LocVarAssigCall ssa_10 ssa_9 ssa_25 ssa_14_GlobVarAssigCall ssa_26_return ssa_19 ssa_22_return ssa_12 ssa_11_OldVarAssigCall ssa_5_OldVarAssigCall ssa_8_OldVarAssigCall ssa_28 ssa_15 ssa_29 ssa_21 ssa_30_return ssa_11_GlobVarAssigCall ssa_23 ssa_17 ssa_8_LocVarAssigCall ssa_24) ssa_31 ssa_32 (and ssa_postcond ssa_33))
...
(assert (! true :named ssa_precond))
(assert (! (not (= 3 |main_#t~ret7_24|)) :named ssa_postcond))
...
(assert (! (= |id_#res_22| |main_#t~ret7_24|) :named ssa_24_return))
(assert (! true :named ssa_-2_PendingContext))
