...
(set-info :ultimate-id standard_copyInit_ground.i_AllErrorsAtOnce_Iteration10)
...
(assert (! (and (= v_ArrVal_150_fresh_1 1) (= v_ArrVal_151_fresh_1 400000) (= main_~i~0_4 0) (< |#StackHeapBarrier_-1| |main_~#a~0.base_4|) (= |main_~#b~0.offset_4| 0) (= |#length_4| (store (store |#length_3| |main_~#a~0.base_4| v_ArrVal_151_fresh_1) |main_~#b~0.base_4| v_ArrVal_149_fresh_1)) (not (= |main_~#a~0.base_4| 0)) (= v_ArrVal_149_fresh_1 400000) (= (select (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_150_fresh_1) |main_~#b~0.base_4|) 0) (not (= |main_~#b~0.base_4| 0)) (= |#valid_4| (store (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_150_fresh_1) |main_~#b~0.base_4| v_ArrVal_152_fresh_1)) (= |main_~#a~0.offset_4| 0) (< |#StackHeapBarrier_-1| |main_~#b~0.base_4|) (= v_ArrVal_152_fresh_1 1) (= (select |#valid_3| |main_~#a~0.base_4|) 0)) :named ssa_4))
(assert (! (and (= v_ArrVal_154_fresh_1 42) (= v_ArrVal_153_fresh_1 (store (select |#memory_int#2_3| |main_~#a~0.base_4|) (+ (* main_~i~0_4 4) |main_~#a~0.offset_4|) 42)) (= (store |#memory_int#2_3| |main_~#a~0.base_4| v_ArrVal_153_fresh_1) |#memory_int#2_5|) (< main_~i~0_4 100000) (= main_~i~0_5 (+ main_~i~0_4 1))) :named ssa_5))
(assert (! (and (= v_ArrVal_156_fresh_1 42) (< main_~i~0_5 100000) (= v_ArrVal_155_fresh_1 (store (select |#memory_int#2_5| |main_~#a~0.base_4|) (+ (* main_~i~0_5 4) |main_~#a~0.offset_4|) 42)) (= (store |#memory_int#2_5| |main_~#a~0.base_4| v_ArrVal_155_fresh_1) |#memory_int#2_6|) (= main_~i~0_6 (+ main_~i~0_5 1))) :named ssa_6))
(assert (! (and (= v_ArrVal_157_fresh_1 (store (select |#memory_int#2_6| |main_~#a~0.base_4|) (+ (* main_~i~0_6 4) |main_~#a~0.offset_4|) 42)) (< main_~i~0_6 100000) (= (store |#memory_int#2_6| |main_~#a~0.base_4| v_ArrVal_157_fresh_1) |#memory_int#2_7|) (= v_ArrVal_158_fresh_1 42) (= main_~i~0_7 (+ main_~i~0_6 1))) :named ssa_7))
(assert (! (and (= (store |#memory_int#2_7| |main_~#a~0.base_4| v_ArrVal_159_fresh_1) |#memory_int#2_8|) (= v_ArrVal_159_fresh_1 (store (select |#memory_int#2_7| |main_~#a~0.base_4|) (+ (* main_~i~0_7 4) |main_~#a~0.offset_4|) 42)) (= v_ArrVal_160_fresh_1 42) (< main_~i~0_7 100000) (= main_~i~0_8 (+ main_~i~0_7 1))) :named ssa_8))
(assert (! (and (= (store |#memory_int#2_8| |main_~#a~0.base_4| v_ArrVal_161_fresh_1) |#memory_int#2_9|) (< main_~i~0_8 100000) (= main_~i~0_9 (+ main_~i~0_8 1)) (= v_ArrVal_161_fresh_1 (store (select |#memory_int#2_8| |main_~#a~0.base_4|) (+ (* main_~i~0_8 4) |main_~#a~0.offset_4|) 42)) (= v_ArrVal_162_fresh_1 42)) :named ssa_9))
(assert (! (and (= (store |#memory_int#2_9| |main_~#a~0.base_4| v_ArrVal_163_fresh_1) |#memory_int#2_10|) (= v_ArrVal_164_fresh_1 42) (< main_~i~0_9 100000) (= v_ArrVal_163_fresh_1 (store (select |#memory_int#2_9| |main_~#a~0.base_4|) (+ (* main_~i~0_9 4) |main_~#a~0.offset_4|) 42)) (= main_~i~0_10 (+ main_~i~0_9 1))) :named ssa_10))
(assert (! (and (< main_~i~0_10 100000) (= v_ArrVal_165_fresh_1 (store (select |#memory_int#2_10| |main_~#a~0.base_4|) (+ (* main_~i~0_10 4) |main_~#a~0.offset_4|) 42)) (= |#memory_int#2_11| (store |#memory_int#2_10| |main_~#a~0.base_4| v_ArrVal_165_fresh_1)) (= main_~i~0_11 (+ main_~i~0_10 1)) (= v_ArrVal_166_fresh_1 42)) :named ssa_11))
(assert (! (and (< main_~i~0_11 100000) (= v_ArrVal_168_fresh_1 42) (= main_~i~0_12 (+ main_~i~0_11 1)) (= |#memory_int#2_12| (store |#memory_int#2_11| |main_~#a~0.base_4| v_ArrVal_167_fresh_1)) (= v_ArrVal_167_fresh_1 (store (select |#memory_int#2_11| |main_~#a~0.base_4|) (+ (* main_~i~0_11 4) |main_~#a~0.offset_4|) 42))) :named ssa_12))
(assert (! (<= 100000 main_~i~0_12) :named ssa_13))
(assert (! (= main_~i~0_14 0) :named ssa_14))
(assert (! (and (= v_ArrVal_169_fresh_1 (select (select |#memory_int#2_12| |main_~#a~0.base_4|) (+ (* main_~i~0_14 4) |main_~#a~0.offset_4|))) (= v_ArrVal_170_fresh_1 (store (select |#memory_int#1_3| |main_~#b~0.base_4|) (+ (* main_~i~0_14 4) |main_~#b~0.offset_4|) v_ArrVal_169_fresh_1)) (= (store |#memory_int#1_3| |main_~#b~0.base_4| v_ArrVal_170_fresh_1) |#memory_int#1_15|) (< main_~i~0_14 100000) (= main_~i~0_15 (+ main_~i~0_14 1))) :named ssa_15))
(assert (! (and (= v_ArrVal_171_fresh_1 (select (select |#memory_int#2_12| |main_~#a~0.base_4|) (+ (* main_~i~0_15 4) |main_~#a~0.offset_4|))) (= (store |#memory_int#1_15| |main_~#b~0.base_4| v_ArrVal_172_fresh_1) |#memory_int#1_16|) (= v_ArrVal_172_fresh_1 (store (select |#memory_int#1_15| |main_~#b~0.base_4|) (+ (* main_~i~0_15 4) |main_~#b~0.offset_4|) v_ArrVal_171_fresh_1)) (< main_~i~0_15 100000) (= main_~i~0_16 (+ main_~i~0_15 1))) :named ssa_16))
(assert (! (and (= v_ArrVal_174_fresh_1 (store (select |#memory_int#1_16| |main_~#b~0.base_4|) (+ (* main_~i~0_16 4) |main_~#b~0.offset_4|) v_ArrVal_173_fresh_1)) (= (store |#memory_int#1_16| |main_~#b~0.base_4| v_ArrVal_174_fresh_1) |#memory_int#1_17|) (< main_~i~0_16 100000) (= main_~i~0_17 (+ main_~i~0_16 1)) (= v_ArrVal_173_fresh_1 (select (select |#memory_int#2_12| |main_~#a~0.base_4|) (+ (* main_~i~0_16 4) |main_~#a~0.offset_4|)))) :named ssa_17))
(assert (! (and (= (store |#memory_int#1_17| |main_~#b~0.base_4| v_ArrVal_176_fresh_1) |#memory_int#1_18|) (= v_ArrVal_175_fresh_1 (select (select |#memory_int#2_12| |main_~#a~0.base_4|) (+ (* main_~i~0_17 4) |main_~#a~0.offset_4|))) (= v_ArrVal_176_fresh_1 (store (select |#memory_int#1_17| |main_~#b~0.base_4|) (+ (* main_~i~0_17 4) |main_~#b~0.offset_4|) v_ArrVal_175_fresh_1)) (< main_~i~0_17 100000) (= main_~i~0_18 (+ main_~i~0_17 1))) :named ssa_18))
(assert (! (and (= v_ArrVal_177_fresh_1 (select (select |#memory_int#2_12| |main_~#a~0.base_4|) (+ (* main_~i~0_18 4) |main_~#a~0.offset_4|))) (= v_ArrVal_178_fresh_1 (store (select |#memory_int#1_18| |main_~#b~0.base_4|) (+ (* main_~i~0_18 4) |main_~#b~0.offset_4|) v_ArrVal_177_fresh_1)) (< main_~i~0_18 100000) (= main_~i~0_19 (+ main_~i~0_18 1)) (= (store |#memory_int#1_18| |main_~#b~0.base_4| v_ArrVal_178_fresh_1) |#memory_int#1_19|)) :named ssa_19))
(assert (! (and (= v_ArrVal_179_fresh_1 (select (select |#memory_int#2_12| |main_~#a~0.base_4|) (+ (* main_~i~0_19 4) |main_~#a~0.offset_4|))) (= v_ArrVal_180_fresh_1 (store (select |#memory_int#1_19| |main_~#b~0.base_4|) (+ (* main_~i~0_19 4) |main_~#b~0.offset_4|) v_ArrVal_179_fresh_1)) (< main_~i~0_19 100000) (= main_~i~0_20 (+ main_~i~0_19 1)) (= (store |#memory_int#1_19| |main_~#b~0.base_4| v_ArrVal_180_fresh_1) |#memory_int#1_20|)) :named ssa_20))
(assert (! (and (= (store |#memory_int#1_20| |main_~#b~0.base_4| v_ArrVal_182_fresh_1) |#memory_int#1_21|) (= v_ArrVal_182_fresh_1 (store (select |#memory_int#1_20| |main_~#b~0.base_4|) (+ (* main_~i~0_20 4) |main_~#b~0.offset_4|) v_ArrVal_181_fresh_1)) (< main_~i~0_20 100000) (= main_~i~0_21 (+ main_~i~0_20 1)) (= v_ArrVal_181_fresh_1 (select (select |#memory_int#2_12| |main_~#a~0.base_4|) (+ (* main_~i~0_20 4) |main_~#a~0.offset_4|)))) :named ssa_21))
(assert (! (and (= v_ArrVal_184_fresh_1 (store (select |#memory_int#1_21| |main_~#b~0.base_4|) (+ (* main_~i~0_21 4) |main_~#b~0.offset_4|) v_ArrVal_183_fresh_1)) (= v_ArrVal_183_fresh_1 (select (select |#memory_int#2_12| |main_~#a~0.base_4|) (+ (* main_~i~0_21 4) |main_~#a~0.offset_4|))) (= (store |#memory_int#1_21| |main_~#b~0.base_4| v_ArrVal_184_fresh_1) |#memory_int#1_22|) (< main_~i~0_21 100000) (= main_~i~0_22 (+ main_~i~0_21 1))) :named ssa_22))
(assert (! (<= 100000 main_~i~0_22) :named ssa_23))
(assert (! (= main_~x~0_24 0) :named ssa_24))
(assert (! (and (< main_~x~0_24 100000) (= |main_#t~mem3_25| (select (select |#memory_int#1_22| |main_~#b~0.base_4|) (+ (* main_~x~0_24 4) |main_~#b~0.offset_4|)))) :named ssa_25))
(assert (! true :named ssa_26_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_26| (ite (= |main_#t~mem3_25| 42) 1 0)) :named ssa_26_LocVarAssigCall))
