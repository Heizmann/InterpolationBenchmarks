...
(set-info :ultimate-id id2_b2_o3.c_AllErrorsAtOnce_Iteration4)
...
(assert (! (and (< 2 (mod id2_~ret~1_16 4294967296)) (= 2 |id2_#res_17|)) :named ssa_17))
...
(assert (! (and (< 2 (mod id2_~ret~1_10 4294967296)) (= 2 |id2_#res_11|)) :named ssa_11))
...
(assert (! (and (< 2 (mod id2_~ret~1_7 4294967296)) (= 2 |id2_#res_8|)) :named ssa_8))
