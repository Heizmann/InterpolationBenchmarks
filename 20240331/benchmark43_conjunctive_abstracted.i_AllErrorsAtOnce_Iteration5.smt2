...
(set-info :ultimate-id benchmark43_conjunctive_abstracted.i_AllErrorsAtOnce_Iteration5)
...
(declare-fun |main_#t~bitwise7_15| () Int)
...
(assert (! (and (not (= (ite (< main_~y~0_12 100) 1 0) 0)) (not (= (ite (< main_~x~0_12 100) 1 0) 0))) :named ssa_13))
(assert (! (and (= (ite (< main_~y~0_12 100) 1 0) |main_#t~bitwise7_14|) (= (ite (< main_~y~0_12 100) 1 0) (ite (< main_~x~0_12 100) 1 0))) :named ssa_14))
(assert (! (= |main_#t~bitwise7_14| 0) :named ssa_15))
(assert (! true :named ssa_16_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_16| (ite (or (= main_~y~0_12 100) (= main_~x~0_12 100)) 1 0)) :named ssa_16_LocVarAssigCall))
