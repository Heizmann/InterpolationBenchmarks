...
(set-info :ultimate-id duplets.c_AllErrorsAtOnce_Iteration5)
...
(declare-fun v_mkdup_~x~0_13_fresh_1 () Int)
...
(declare-fun finddup_~n_42 () Int)
(declare-fun finddup_~i~1_42 () Int)
(declare-fun |finddup_#res_43| () Int)
(declare-fun |main_#t~ret14_45| () Int)
(declare-fun |finddup_#res_45| () Int)
(declare-fun |main_#t~ret14_46| () Int)
(declare-fun main_~r~0_46 () Int)
(declare-fun |__VERIFIER_assert_#in~cond_47| () Int)
(declare-fun main_~r~0_47 () Int)
...
(assert (! (and (not (= 0 |main_#t~malloc13.base_10|)) (< |main_#t~malloc13.base_10| |#StackHeapBarrier_-1|) (= |main_#t~malloc13.offset_10| 0) (= (store |#length_3| |main_#t~malloc13.base_10| v_ArrVal_65_fresh_1) |#length_10|) (= (select |#valid_3| |main_#t~malloc13.base_10|) 0) (= (* 4 (mod main_~n~0_4 1073741824)) v_ArrVal_65_fresh_1) (= v_ArrVal_66_fresh_1 1) (= |#valid_10| (store |#valid_3| |main_#t~malloc13.base_10| v_ArrVal_66_fresh_1))) :named ssa_10))
(assert (! (= |old(#memory_int#2)_11| |#memory_int#2_11|) :named ssa_11_GlobVarAssigCall))
(assert (! (and (= |v_#Ultimate.meminit_#ptr.offsetInParam_7_fresh_1| |main_#t~malloc13.offset_10|) (= |v_#Ultimate.meminit_#productInParam_7_fresh_1| (* main_~n~0_4 4)) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_7_fresh_1| 4) (= |#Ultimate.meminit_#ptr.base_11| |main_#t~malloc13.base_10|) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_7_fresh_1|)) :named ssa_11_LocVarAssigCall))
(assert (! (= |old(#memory_int#2)_11| |#memory_int#2_3|) :named ssa_11_OldVarAssigCall))
(assert (! (and (= (store |#memory_int#2_11| |#Ultimate.meminit_#ptr.base_11| v_ArrVal_67_fresh_1) |#memory_int#2_12|) (= ((as const (Array Int Int)) 0) v_ArrVal_67_fresh_1)) :named ssa_12))
...
(assert (! (and (= (store (store (select |#memory_int#2_15| mkdup_~a.base_16) (+ (* mkdup_~i~0_16 4) mkdup_~a.offset_16) v_ArrVal_68_fresh_1) (+ mkdup_~a.offset_16 (* mkdup_~j~0_16 4)) v_mkdup_~x~0_13_fresh_1) v_ArrVal_69_fresh_1) (= v_mkdup_~x~0_13_fresh_1 v_ArrVal_68_fresh_1) (= (store |#memory_int#2_15| mkdup_~a.base_16 v_ArrVal_69_fresh_1) |#memory_int#2_32|) (<= 0 (+ v_mkdup_~x~0_13_fresh_1 2147483648)) (= v_mkdup_~x~0_13_fresh_1 v_ArrVal_70_fresh_1) (<= v_mkdup_~x~0_13_fresh_1 2147483647)) :named ssa_32))
(assert (! true :named ssa_33_return))
(assert (! (and (= |main_~#i~2.offset_34| 0) (= (select |#valid_10| |main_~#i~2.base_34|) 0) (= |#length_34| (store (store |#length_10| |main_~#i~2.base_34| v_ArrVal_71_fresh_1) |main_~#j~2.base_34| v_ArrVal_73_fresh_1)) (= |main_~#j~2.offset_34| 0) (= (select (store |#valid_10| |main_~#i~2.base_34| v_ArrVal_72_fresh_1) |main_~#j~2.base_34|) 0) (not (= |main_~#j~2.base_34| 0)) (< |#StackHeapBarrier_-1| |main_~#j~2.base_34|) (= 4 v_ArrVal_73_fresh_1) (= v_ArrVal_74_fresh_1 1) (= |#valid_34| (store (store |#valid_10| |main_~#i~2.base_34| v_ArrVal_72_fresh_1) |main_~#j~2.base_34| v_ArrVal_74_fresh_1)) (not (= |main_~#i~2.base_34| 0)) (< |#StackHeapBarrier_-1| |main_~#i~2.base_34|) (= v_ArrVal_72_fresh_1 1) (= 4 v_ArrVal_71_fresh_1)) :named ssa_34))
...
(assert (! (<= finddup_~n_36 finddup_~i~1_41) :named ssa_42))
(assert (! (= |finddup_#res_43| 0) :named ssa_43))
(assert (! true :named ssa_44))
(assert (! (= |main_#t~ret14_45| |finddup_#res_43|) :named ssa_45_return))
(assert (! (and (= main_~r~0_46 |main_#t~ret14_45|) (<= |main_#t~ret14_45| 2147483647) (<= 0 (+ |main_#t~ret14_45| 2147483648))) :named ssa_46))
(assert (! true :named ssa_47_GlobVarAssigCall))
(assert (! (= main_~r~0_46 |__VERIFIER_assert_#in~cond_47|) :named ssa_47_LocVarAssigCall))
...
(assert (! (not true) :named ssa_postcond))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_75_fresh_1) (= (store |#memory_int#2_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_75_fresh_1) |#memory_int#2_0|)) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! true :named ssa_-2_PendingContext))
...
(declare-fun v_mkdup_~x~0_14_fresh_1 () Int)
(assert (! (= |#memory_int#2_-1| |old(#memory_int#2)_-1|) :named ssa_precond))
(assert (! (not true) :named ssa_postcond))
...
(assert (! (and (= (store (store (select |#memory_int#2_-1| mkdup_~a.base_0) (+ (* mkdup_~i~0_0 4) mkdup_~a.offset_0) v_ArrVal_76_fresh_1) (+ mkdup_~a.offset_0 (* mkdup_~j~0_0 4)) v_ArrVal_77_fresh_1) v_ArrVal_78_fresh_1) (= (store |#memory_int#2_-1| mkdup_~a.base_0 v_ArrVal_78_fresh_1) |#memory_int#2_16|) (= v_mkdup_~x~0_14_fresh_1 v_ArrVal_77_fresh_1) (= v_mkdup_~x~0_14_fresh_1 v_ArrVal_76_fresh_1) (<= v_mkdup_~x~0_14_fresh_1 2147483647) (<= 0 (+ v_mkdup_~x~0_14_fresh_1 2147483648))) :named ssa_16))
...
(declare-fun finddup_~n_6 () Int)
(declare-fun finddup_~i~1_6 () Int)
(declare-fun |finddup_#res_7| () Int)
(declare-fun |main_#t~ret14_9| () Int)
(declare-fun |finddup_#res_9| () Int)
...
(assert (! (<= finddup_~n_0 finddup_~i~1_5) :named ssa_6))
(assert (! (= |finddup_#res_7| 0) :named ssa_7))
(assert (! true :named ssa_8))
(assert (! (= |main_#t~ret14_9| |finddup_#res_7|) :named ssa_9_return))
(assert (! true :named ssa_-2_PendingContext))
