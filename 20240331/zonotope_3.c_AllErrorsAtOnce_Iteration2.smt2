...
(set-info :ultimate-id zonotope_3.c_AllErrorsAtOnce_Iteration2)
...
(declare-fun v_main_~y~0_7_fresh_1 () Real)
...
(declare-fun v_main_~z~0_7_fresh_1 () Real)
...
(declare-fun v_main_~u~0_8_fresh_1 () Real)
...
(assert (! (= v_main_~y~0_7_fresh_1 |main_#t~ret4_7|) :named ssa_8))
...
(assert (! (= v_main_~z~0_7_fresh_1 |main_#t~ret5_11|) :named ssa_12))
...
(assert (! (= v_main_~u~0_8_fresh_1 |main_#t~ret6_15|) :named ssa_16))
...
(assert (! (= |__VERIFIER_assert_#in~cond_23| (ite (and v_~someBinaryFLOATComparisonOperation_16_fresh_1 v_~someBinaryFLOATComparisonOperation_15_fresh_1) 1 0)) :named ssa_23_LocVarAssigCall))
