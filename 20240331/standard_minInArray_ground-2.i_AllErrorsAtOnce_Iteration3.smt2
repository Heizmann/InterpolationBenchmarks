...
(set-info :ultimate-id standard_minInArray_ground-2.i_AllErrorsAtOnce_Iteration3)
...
(assert (! (and (not (= |main_~#a~0.base_4| 0)) (= (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_5_fresh_1) |#valid_4|) (= main_~min~0_4 0) (< |#StackHeapBarrier_-1| |main_~#a~0.base_4|) (= |main_~#a~0.offset_4| 0) (= |#length_4| (store |#length_3| |main_~#a~0.base_4| v_ArrVal_6_fresh_1)) (= v_ArrVal_5_fresh_1 1) (= 400000 v_ArrVal_6_fresh_1) (= (select |#valid_3| |main_~#a~0.base_4|) 0) (= main_~i~0_4 0)) :named ssa_4))
(assert (! (and (= main_~i~0_5 (+ main_~i~0_4 1)) (= |v_main_#t~nondet1_8_fresh_1| v_ArrVal_7_fresh_1) (< main_~i~0_4 100000) (= (store (select |#memory_int#1_3| |main_~#a~0.base_4|) (+ (* main_~i~0_4 4) |main_~#a~0.offset_4|) v_ArrVal_7_fresh_1) v_ArrVal_8_fresh_1) (<= |v_main_#t~nondet1_8_fresh_1| 2147483647) (= (store |#memory_int#1_3| |main_~#a~0.base_4| v_ArrVal_8_fresh_1) |#memory_int#1_5|) (<= 0 (+ |v_main_#t~nondet1_8_fresh_1| 2147483648))) :named ssa_5))
(assert (! (<= 100000 main_~i~0_5) :named ssa_6))
(assert (! (= main_~i~0_7 0) :named ssa_7))
(assert (! (and (= |main_#t~mem3_8| (select (select |#memory_int#1_5| |main_~#a~0.base_4|) (+ (* main_~i~0_7 4) |main_~#a~0.offset_4|))) (< main_~i~0_7 100000)) :named ssa_8))
(assert (! (and (< |main_#t~mem3_8| main_~min~0_4) (= (select (select |#memory_int#1_5| |main_~#a~0.base_4|) (+ (* main_~i~0_7 4) |main_~#a~0.offset_4|)) main_~min~0_9)) :named ssa_9))
(assert (! (= main_~i~0_10 (+ main_~i~0_7 1)) :named ssa_10))
(assert (! (<= 100000 main_~i~0_10) :named ssa_11))
(assert (! (= main_~x~0_12 0) :named ssa_12))
(assert (! (and (< main_~x~0_12 100000) (= |main_#t~mem5_13| (select (select |#memory_int#1_5| |main_~#a~0.base_4|) (+ (* main_~x~0_12 4) |main_~#a~0.offset_4|)))) :named ssa_13))
(assert (! true :named ssa_14_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_14| (ite (<= main_~min~0_9 |main_#t~mem5_13|) 1 0)) :named ssa_14_LocVarAssigCall))
