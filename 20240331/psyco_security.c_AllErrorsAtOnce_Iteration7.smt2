...
(set-info :ultimate-id psyco_security.c_AllErrorsAtOnce_Iteration7)
...
(declare-fun v_main_~method_id~0_56_fresh_1 () Int)
...
(declare-fun v_main_~method_id~0_57_fresh_1 () Int)
(declare-fun main_~q~0_17 () Int)
(declare-fun main_~this_state~0_17 () Int)
(declare-fun |main_#t~nondet13_22| () Int)
(declare-fun |main_#t~nondet14_23| () Int)
(declare-fun |main_#t~nondet13_23| () Int)
(declare-fun |main_#t~nondet15_24| () Int)
(declare-fun |main_#t~nondet14_24| () Int)
(declare-fun |main_#t~nondet15_25| () Int)
(declare-fun v_main_~method_id~0_58_fresh_1 () Int)
(declare-fun main_~this_state~0_27 () Int)
...
(assert (! (= 3 v_main_~method_id~0_56_fresh_1) :named ssa_9))
...
(assert (! (not (= |main_#t~nondet8_14| 0)) :named ssa_15))
(assert (! (= 1 v_main_~method_id~0_57_fresh_1) :named ssa_16))
(assert (! (and (= 2 main_~this_state~0_17) (= main_~q~0_17 3)) :named ssa_17))
(assert (! true :named ssa_18))
(assert (! (not (= main_~q~0_17 0)) :named ssa_19))
(assert (! (not (= main_~q~0_17 1)) :named ssa_20))
(assert (! (not (= main_~q~0_17 2)) :named ssa_21))
(assert (! (and (= main_~q~0_17 3) (<= 0 (+ |main_#t~nondet13_22| 2147483648)) (<= |main_#t~nondet13_22| 2147483647)) :named ssa_22))
(assert (! (and (= |main_#t~nondet13_22| 0) (<= |main_#t~nondet14_23| 2147483647) (<= 0 (+ |main_#t~nondet14_23| 2147483648))) :named ssa_23))
(assert (! (and (<= 0 (+ |main_#t~nondet15_24| 2147483648)) (= |main_#t~nondet14_23| 0) (<= |main_#t~nondet15_24| 2147483647)) :named ssa_24))
(assert (! (not (= |main_#t~nondet15_24| 0)) :named ssa_25))
(assert (! (= 4 v_main_~method_id~0_58_fresh_1) :named ssa_26))
(assert (! (not (= 2 main_~this_state~0_17)) :named ssa_27))
