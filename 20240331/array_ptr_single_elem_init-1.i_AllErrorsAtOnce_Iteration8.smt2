...
(set-info :ultimate-id array_ptr_single_elem_init-1.i_AllErrorsAtOnce_Iteration8)
...
(declare-fun |v_main_#t~malloc6.base_11_fresh_1| () Int)
...
(declare-fun main_~s1~0.offset_27 () Int)
(declare-fun |main_#t~short9_27| () Bool)
(declare-fun main_~s1~0.base_27 () Int)
(declare-fun |main_#t~short9_28| () Bool)
(declare-fun |v_main_#t~mem8_12_fresh_1| () Int)
(declare-fun |main_#t~mem10.base_29| () Int)
(declare-fun |main_#t~mem10.offset_29| () Int)
(declare-fun |main_#t~mem8_29| () Int)
(declare-fun main_~s1~0.offset_29 () Int)
(declare-fun |main_#t~short9_29| () Bool)
(declare-fun main_~s1~0.base_29 () Int)
(declare-fun |main_#t~mem10.base_30| () Int)
(declare-fun |__VERIFIER_assert_#in~cond_30| () Int)
(declare-fun |main_#t~mem10.offset_30| () Int)
...
(assert (! (and (< 0 |#StackHeapBarrier_-1|) (= (select |#valid_-1| 0) 0) (= 31 (select |#length_-1| 2)) (= (select |#valid_-1| 2) 1) (= |~#a~0.base_1| 3) (= (select |#valid_-1| 3) 1) (= (store |#memory_$Pointer$#1.base_0| |~#a~0.base_1| v_ArrVal_159_fresh_1) |#memory_$Pointer$#1.base_1|) (= |~#a~0.offset_1| 0) (= (select |#valid_-1| 1) 1) (= |#memory_$Pointer$#1.offset_1| (store |#memory_$Pointer$#1.offset_0| |~#a~0.base_1| v_ArrVal_160_fresh_1)) (= (select (select |#memory_int#0_-1| 1) 1) 0) (= 2 (select |#length_-1| 1)) (= ((as const (Array Int Int)) 0) v_ArrVal_160_fresh_1) (= (select |#length_-1| 3) 400000) (= ((as const (Array Int Int)) 0) v_ArrVal_159_fresh_1) (= (select (select |#memory_int#0_-1| 1) 0) 48)) :named ssa_1))
...
(assert (! (and (= (store |#memory_int#1_3| |~#a~0.base_1| v_ArrVal_161_fresh_1) |#memory_int#1_8|) (= v_ArrVal_166_fresh_1 (store (select |#memory_$Pointer$#1.offset_3| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4)) v_ArrVal_163_fresh_1)) (= main_~i~0_8 (+ main_~i~0_4 1)) (= v_ArrVal_162_fresh_1 (select (select |#memory_int#1_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4)))) (= v_ArrVal_165_fresh_1 main_~s~0.base_5) (= v_ArrVal_163_fresh_1 main_~s~0.offset_5) (= (store |#memory_$Pointer$#1.base_3| |~#a~0.base_1| v_ArrVal_164_fresh_1) |#memory_$Pointer$#1.base_8|) (= v_ArrVal_164_fresh_1 (store (select |#memory_$Pointer$#1.base_3| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4)) main_~s~0.base_5)) (= |#memory_$Pointer$#1.offset_8| (store |#memory_$Pointer$#1.offset_3| |~#a~0.base_1| v_ArrVal_166_fresh_1)) (= v_ArrVal_161_fresh_1 (store (select |#memory_int#1_3| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4)) (select (select |#memory_int#1_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4)))))) :named ssa_8))
...
(assert (! (and (= v_ArrVal_167_fresh_1 (store (select |#memory_int#1_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_8 4)) (select (select |#memory_int#1_12| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_8 4))))) (= v_ArrVal_172_fresh_1 (store (select |#memory_$Pointer$#1.offset_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_8 4)) v_ArrVal_169_fresh_1)) (= v_ArrVal_168_fresh_1 (select (select |#memory_int#1_12| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_8 4)))) (= main_~i~0_12 (+ main_~i~0_8 1)) (= v_ArrVal_170_fresh_1 (store (select |#memory_$Pointer$#1.base_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_8 4)) main_~s~0.base_9)) (= |#memory_int#1_12| (store |#memory_int#1_8| |~#a~0.base_1| v_ArrVal_167_fresh_1)) (= v_ArrVal_171_fresh_1 main_~s~0.base_9) (= (store |#memory_$Pointer$#1.base_8| |~#a~0.base_1| v_ArrVal_170_fresh_1) |#memory_$Pointer$#1.base_12|) (= v_ArrVal_169_fresh_1 main_~s~0.offset_9) (= |#memory_$Pointer$#1.offset_12| (store |#memory_$Pointer$#1.offset_8| |~#a~0.base_1| v_ArrVal_172_fresh_1))) :named ssa_12))
...
(assert (! (and (= (store |#memory_$Pointer$#1.base_12| |~#a~0.base_1| v_ArrVal_176_fresh_1) |#memory_$Pointer$#1.base_16|) (= v_ArrVal_175_fresh_1 main_~s~0.offset_13) (= v_ArrVal_176_fresh_1 (store (select |#memory_$Pointer$#1.base_12| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_12 4)) main_~s~0.base_13)) (= (store |#memory_$Pointer$#1.offset_12| |~#a~0.base_1| v_ArrVal_178_fresh_1) |#memory_$Pointer$#1.offset_16|) (= main_~i~0_16 (+ main_~i~0_12 1)) (= v_ArrVal_178_fresh_1 (store (select |#memory_$Pointer$#1.offset_12| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_12 4)) v_ArrVal_175_fresh_1)) (= (store |#memory_int#1_12| |~#a~0.base_1| v_ArrVal_173_fresh_1) |#memory_int#1_16|) (= v_ArrVal_174_fresh_1 (select (select |#memory_int#1_16| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_12 4)))) (= v_ArrVal_173_fresh_1 (store (select |#memory_int#1_12| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_12 4)) (select (select |#memory_int#1_16| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_12 4))))) (= v_ArrVal_177_fresh_1 main_~s~0.base_13)) :named ssa_16))
...
(assert (! (and (= v_ArrVal_180_fresh_1 (select (select |#memory_int#1_20| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_16 4)))) (= v_ArrVal_184_fresh_1 (store (select |#memory_$Pointer$#1.offset_16| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_16 4)) v_ArrVal_181_fresh_1)) (= main_~i~0_20 (+ main_~i~0_16 1)) (= |#memory_$Pointer$#1.offset_20| (store |#memory_$Pointer$#1.offset_16| |~#a~0.base_1| v_ArrVal_184_fresh_1)) (= v_ArrVal_182_fresh_1 (store (select |#memory_$Pointer$#1.base_16| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_16 4)) main_~s~0.base_17)) (= v_ArrVal_183_fresh_1 main_~s~0.base_17) (= (store |#memory_$Pointer$#1.base_16| |~#a~0.base_1| v_ArrVal_182_fresh_1) |#memory_$Pointer$#1.base_20|) (= v_ArrVal_179_fresh_1 (store (select |#memory_int#1_16| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_16 4)) (select (select |#memory_int#1_20| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_16 4))))) (= v_ArrVal_181_fresh_1 main_~s~0.offset_17) (= (store |#memory_int#1_16| |~#a~0.base_1| v_ArrVal_179_fresh_1) |#memory_int#1_20|)) :named ssa_20))
...
(assert (! (and (= v_ArrVal_185_fresh_1 (store (select |#memory_int#1_20| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_20 4)) (select (select |#memory_int#1_24| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_20 4))))) (= (store |#memory_$Pointer$#1.offset_20| |~#a~0.base_1| v_ArrVal_190_fresh_1) |#memory_$Pointer$#1.offset_24|) (= (store |#memory_int#1_20| |~#a~0.base_1| v_ArrVal_185_fresh_1) |#memory_int#1_24|) (= main_~i~0_24 (+ main_~i~0_20 1)) (= v_ArrVal_188_fresh_1 (store (select |#memory_$Pointer$#1.base_20| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_20 4)) main_~s~0.base_21)) (= v_ArrVal_187_fresh_1 main_~s~0.offset_21) (= v_ArrVal_186_fresh_1 (select (select |#memory_int#1_24| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_20 4)))) (= v_ArrVal_190_fresh_1 (store (select |#memory_$Pointer$#1.offset_20| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_20 4)) v_ArrVal_187_fresh_1)) (= v_ArrVal_189_fresh_1 main_~s~0.base_21) (= (store |#memory_$Pointer$#1.base_20| |~#a~0.base_1| v_ArrVal_188_fresh_1) |#memory_$Pointer$#1.base_24|)) :named ssa_24))
(assert (! (<= 100000 main_~i~0_24) :named ssa_25))
(assert (! (and (= v_ArrVal_197_fresh_1 (store (select |#memory_$Pointer$#1.base_24| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12) v_ArrVal_196_fresh_1)) (= (store |#memory_$Pointer$#1.base_24| |~#a~0.base_1| v_ArrVal_197_fresh_1) |#memory_$Pointer$#1.base_26|) (= |#memory_$Pointer$#1.offset_26| (store |#memory_$Pointer$#1.offset_24| |~#a~0.base_1| v_ArrVal_191_fresh_1)) (= (select |#valid_3| |v_main_#t~malloc6.base_11_fresh_1|) 0) (= (store |#memory_int#1_24| |~#a~0.base_1| v_ArrVal_195_fresh_1) |#memory_int#1_26|) (not (= |v_main_#t~malloc6.base_11_fresh_1| 0)) (= v_ArrVal_191_fresh_1 (store (select |#memory_$Pointer$#1.offset_24| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12) 0)) (= v_ArrVal_194_fresh_1 0) (= v_ArrVal_198_fresh_1 (select (select |#memory_int#1_26| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12))) (= v_ArrVal_195_fresh_1 (store (select |#memory_int#1_24| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12) (select (select |#memory_int#1_26| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12)))) (= (store |#length_3| |v_main_#t~malloc6.base_11_fresh_1| v_ArrVal_193_fresh_1) |#length_26|) (< |v_main_#t~malloc6.base_11_fresh_1| |#StackHeapBarrier_-1|) (= v_ArrVal_193_fresh_1 8) (= main_~i~0_26 0) (= v_ArrVal_196_fresh_1 |v_main_#t~malloc6.base_11_fresh_1|) (= |#valid_26| (store |#valid_3| |v_main_#t~malloc6.base_11_fresh_1| v_ArrVal_192_fresh_1)) (= v_ArrVal_192_fresh_1 1)) :named ssa_26))
(assert (! (and (= (select (select |#memory_$Pointer$#1.base_26| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_26 4))) main_~s1~0.base_27) (= main_~s1~0.offset_27 (select (select |#memory_$Pointer$#1.offset_26| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_26 4)))) (< main_~i~0_26 100000) (or (and (not |main_#t~short9_27|) (or (and (= main_~s1~0.offset_27 0) (= main_~s1~0.base_27 0)) (= main_~i~0_26 3))) (and |main_#t~short9_27| (or (not (= main_~s1~0.offset_27 0)) (not (= main_~s1~0.base_27 0))) (not (= main_~i~0_26 3))))) :named ssa_27))
(assert (! (and |main_#t~short9_27| (or (and (not |main_#t~short9_28|) (not (= |v_main_#t~mem8_12_fresh_1| 0))) (and (= |v_main_#t~mem8_12_fresh_1| 0) |main_#t~short9_28|)) (= (select (select |#memory_int#2_3| main_~s1~0.base_27) (+ main_~s1~0.offset_27 4)) |v_main_#t~mem8_12_fresh_1|)) :named ssa_28))
(assert (! (and |main_#t~short9_28| (= |main_#t~mem10.offset_29| (select (select |#memory_$Pointer$#2.offset_3| main_~s1~0.base_27) main_~s1~0.offset_27)) (= (select (select |#memory_$Pointer$#2.base_3| main_~s1~0.base_27) main_~s1~0.offset_27) |main_#t~mem10.base_29|)) :named ssa_29))
(assert (! true :named ssa_30_GlobVarAssigCall))
(assert (! (= (ite (or (not (= |main_#t~mem10.base_29| 0)) (not (= |main_#t~mem10.offset_29| 0))) 1 0) |__VERIFIER_assert_#in~cond_30|) :named ssa_30_LocVarAssigCall))
...
(assert (! (and (< 0 |#StackHeapBarrier_-1|) (= (select |#valid_-2| 0) 0) (= 31 (select |#length_-2| 2)) (= (select |#valid_-2| 2) 1) (= |~#a~0.base_0| 3) (= |#memory_$Pointer$#1.offset_0| (store |#memory_$Pointer$#1.offset_-1| |~#a~0.base_0| v_ArrVal_200_fresh_1)) (= (select |#valid_-2| 3) 1) (= ((as const (Array Int Int)) 0) v_ArrVal_199_fresh_1) (= (store |#memory_$Pointer$#1.base_-1| |~#a~0.base_0| v_ArrVal_199_fresh_1) |#memory_$Pointer$#1.base_0|) (= |~#a~0.offset_0| 0) (= (select |#valid_-2| 1) 1) (= ((as const (Array Int Int)) 0) v_ArrVal_200_fresh_1) (= (select (select |#memory_int#0_-2| 1) 1) 0) (= 2 (select |#length_-2| 1)) (= (select |#length_-2| 3) 400000) (= (select (select |#memory_int#0_-2| 1) 0) 48)) :named ssa_0))
