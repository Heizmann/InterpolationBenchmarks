...
(set-info :ultimate-id mono-crafted_11.c_AllErrorsAtOnce_Iteration28)
...
(assert (! (<= 100000000 (mod main_~x~0_56 4294967296)) :named ssa_57))
(assert (! true :named ssa_58_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_58| (ite (= (mod main_~x~0_56 2) 0) 1 0)) :named ssa_58_LocVarAssigCall))
