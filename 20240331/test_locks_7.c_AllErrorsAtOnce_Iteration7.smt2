...
(set-info :ultimate-id test_locks_7.c_AllErrorsAtOnce_Iteration7)
...
(declare-fun main_~lk3~0_17 () Int)
...
(assert (! (not (= main_~p3~0_4 0)) :named ssa_16))
(assert (! (not (= main_~lk3~0_6 1)) :named ssa_17))
