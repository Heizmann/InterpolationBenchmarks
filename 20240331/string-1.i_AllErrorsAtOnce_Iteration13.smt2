...
(set-info :ultimate-id string-1.i_AllErrorsAtOnce_Iteration13)
...
(declare-fun v_main_~found~0_18_fresh_1 () Int)
...
(declare-fun |v_main_#t~nondet4_50_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_51_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_52_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_53_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_54_fresh_1| () Int)
...
(assert (! (and (< |#StackHeapBarrier_-1| |main_~#string_A~0.base_4|) (= |#valid_4| (store (store |#valid_3| |main_~#string_A~0.base_4| v_ArrVal_232_fresh_1) |main_~#string_B~0.base_4| v_ArrVal_229_fresh_1)) (= v_ArrVal_230_fresh_1 5) (= main_~i~0_4 0) (= (select |#valid_3| |main_~#string_A~0.base_4|) 0) (= |#length_4| (store (store |#length_3| |main_~#string_A~0.base_4| v_ArrVal_231_fresh_1) |main_~#string_B~0.base_4| v_ArrVal_230_fresh_1)) (= |main_~#string_A~0.offset_4| 0) (= (select (store |#valid_3| |main_~#string_A~0.base_4| v_ArrVal_232_fresh_1) |main_~#string_B~0.base_4|) 0) (not (= |main_~#string_B~0.base_4| 0)) (= |main_~#string_B~0.offset_4| 0) (= v_main_~found~0_18_fresh_1 0) (not (= |main_~#string_A~0.base_4| 0)) (= v_ArrVal_231_fresh_1 5) (= v_ArrVal_229_fresh_1 1) (< |#StackHeapBarrier_-1| |main_~#string_B~0.base_4|) (= v_ArrVal_232_fresh_1 1)) :named ssa_4))
(assert (! (and (= v_ArrVal_234_fresh_1 (store (select |#memory_int#2_3| |main_~#string_A~0.base_4|) (+ main_~i~0_4 |main_~#string_A~0.offset_4|) v_ArrVal_233_fresh_1)) (<= 0 (+ |v_main_#t~nondet1_50_fresh_1| 128)) (= main_~i~0_5 (+ main_~i~0_4 1)) (<= |v_main_#t~nondet1_50_fresh_1| 127) (= v_ArrVal_233_fresh_1 |v_main_#t~nondet1_50_fresh_1|) (= (store |#memory_int#2_3| |main_~#string_A~0.base_4| v_ArrVal_234_fresh_1) |#memory_int#2_5|) (< main_~i~0_4 5)) :named ssa_5))
(assert (! (and (<= 0 (+ |v_main_#t~nondet1_51_fresh_1| 128)) (= (store |#memory_int#2_5| |main_~#string_A~0.base_4| v_ArrVal_236_fresh_1) |#memory_int#2_6|) (= v_ArrVal_235_fresh_1 |v_main_#t~nondet1_51_fresh_1|) (<= |v_main_#t~nondet1_51_fresh_1| 127) (= main_~i~0_6 (+ main_~i~0_5 1)) (= v_ArrVal_236_fresh_1 (store (select |#memory_int#2_5| |main_~#string_A~0.base_4|) (+ main_~i~0_5 |main_~#string_A~0.offset_4|) v_ArrVal_235_fresh_1)) (< main_~i~0_5 5)) :named ssa_6))
(assert (! (and (= v_ArrVal_238_fresh_1 |v_main_#t~nondet1_52_fresh_1|) (<= |v_main_#t~nondet1_52_fresh_1| 127) (= main_~i~0_7 (+ main_~i~0_6 1)) (= v_ArrVal_237_fresh_1 (store (select |#memory_int#2_6| |main_~#string_A~0.base_4|) (+ main_~i~0_6 |main_~#string_A~0.offset_4|) |v_main_#t~nondet1_52_fresh_1|)) (<= 0 (+ |v_main_#t~nondet1_52_fresh_1| 128)) (= (store |#memory_int#2_6| |main_~#string_A~0.base_4| v_ArrVal_237_fresh_1) |#memory_int#2_7|) (< main_~i~0_6 5)) :named ssa_7))
(assert (! (and (= v_ArrVal_239_fresh_1 (store (select |#memory_int#2_7| |main_~#string_A~0.base_4|) (+ main_~i~0_7 |main_~#string_A~0.offset_4|) |v_main_#t~nondet1_53_fresh_1|)) (<= |v_main_#t~nondet1_53_fresh_1| 127) (= (store |#memory_int#2_7| |main_~#string_A~0.base_4| v_ArrVal_239_fresh_1) |#memory_int#2_8|) (= main_~i~0_8 (+ main_~i~0_7 1)) (= v_ArrVal_240_fresh_1 |v_main_#t~nondet1_53_fresh_1|) (<= 0 (+ |v_main_#t~nondet1_53_fresh_1| 128)) (< main_~i~0_7 5)) :named ssa_8))
(assert (! (and (<= |v_main_#t~nondet1_54_fresh_1| 127) (= main_~i~0_9 (+ main_~i~0_8 1)) (<= 0 (+ |v_main_#t~nondet1_54_fresh_1| 128)) (= v_ArrVal_242_fresh_1 (store (select |#memory_int#2_8| |main_~#string_A~0.base_4|) (+ main_~i~0_8 |main_~#string_A~0.offset_4|) v_ArrVal_241_fresh_1)) (< main_~i~0_8 5) (= (store |#memory_int#2_8| |main_~#string_A~0.base_4| v_ArrVal_242_fresh_1) |#memory_int#2_9|) (= v_ArrVal_241_fresh_1 |v_main_#t~nondet1_54_fresh_1|)) :named ssa_9))
...
(assert (! (and (<= 0 (+ |v_main_#t~nondet4_50_fresh_1| 128)) (<= |v_main_#t~nondet4_50_fresh_1| 127) (= main_~i~0_13 (+ main_~i~0_12 1)) (= v_ArrVal_244_fresh_1 (store (select |#memory_int#1_3| |main_~#string_B~0.base_4|) (+ main_~i~0_12 |main_~#string_B~0.offset_4|) v_ArrVal_243_fresh_1)) (= |#memory_int#1_13| (store |#memory_int#1_3| |main_~#string_B~0.base_4| v_ArrVal_244_fresh_1)) (< main_~i~0_12 5) (= v_ArrVal_243_fresh_1 |v_main_#t~nondet4_50_fresh_1|)) :named ssa_13))
(assert (! (and (<= |v_main_#t~nondet4_51_fresh_1| 127) (= v_ArrVal_246_fresh_1 (store (select |#memory_int#1_13| |main_~#string_B~0.base_4|) (+ main_~i~0_13 |main_~#string_B~0.offset_4|) v_ArrVal_245_fresh_1)) (<= 0 (+ |v_main_#t~nondet4_51_fresh_1| 128)) (= (store |#memory_int#1_13| |main_~#string_B~0.base_4| v_ArrVal_246_fresh_1) |#memory_int#1_14|) (= main_~i~0_14 (+ main_~i~0_13 1)) (= v_ArrVal_245_fresh_1 |v_main_#t~nondet4_51_fresh_1|) (< main_~i~0_13 5)) :named ssa_14))
(assert (! (and (= v_ArrVal_248_fresh_1 (store (select |#memory_int#1_14| |main_~#string_B~0.base_4|) (+ main_~i~0_14 |main_~#string_B~0.offset_4|) v_ArrVal_247_fresh_1)) (= (store |#memory_int#1_14| |main_~#string_B~0.base_4| v_ArrVal_248_fresh_1) |#memory_int#1_15|) (= main_~i~0_15 (+ main_~i~0_14 1)) (= v_ArrVal_247_fresh_1 |v_main_#t~nondet4_52_fresh_1|) (< main_~i~0_14 5) (<= 0 (+ |v_main_#t~nondet4_52_fresh_1| 128)) (<= |v_main_#t~nondet4_52_fresh_1| 127)) :named ssa_15))
(assert (! (and (= main_~i~0_16 (+ main_~i~0_15 1)) (<= 0 (+ |v_main_#t~nondet4_53_fresh_1| 128)) (<= |v_main_#t~nondet4_53_fresh_1| 127) (= v_ArrVal_249_fresh_1 (store (select |#memory_int#1_15| |main_~#string_B~0.base_4|) (+ main_~i~0_15 |main_~#string_B~0.offset_4|) |v_main_#t~nondet4_53_fresh_1|)) (= v_ArrVal_250_fresh_1 |v_main_#t~nondet4_53_fresh_1|) (< main_~i~0_15 5) (= (store |#memory_int#1_15| |main_~#string_B~0.base_4| v_ArrVal_249_fresh_1) |#memory_int#1_16|)) :named ssa_16))
(assert (! (and (= (store |#memory_int#1_16| |main_~#string_B~0.base_4| v_ArrVal_251_fresh_1) |#memory_int#1_17|) (= v_ArrVal_251_fresh_1 (store (select |#memory_int#1_16| |main_~#string_B~0.base_4|) (+ main_~i~0_16 |main_~#string_B~0.offset_4|) |v_main_#t~nondet4_54_fresh_1|)) (= main_~i~0_17 (+ main_~i~0_16 1)) (<= |v_main_#t~nondet4_54_fresh_1| 127) (= v_ArrVal_252_fresh_1 |v_main_#t~nondet4_54_fresh_1|) (< main_~i~0_16 5) (<= 0 (+ |v_main_#t~nondet4_54_fresh_1| 128))) :named ssa_17))
...
(assert (! (and (= |v_main_#t~post8_8_fresh_1| main_~nc_A~0_20) (= (+ |v_main_#t~post8_8_fresh_1| 1) main_~nc_A~0_22) (not (= |main_#t~mem7_21| 0))) :named ssa_22))
...
(assert (! (and (= (+ |v_main_#t~post8_9_fresh_1| 1) main_~nc_A~0_24) (= |v_main_#t~post8_9_fresh_1| main_~nc_A~0_22) (not (= |main_#t~mem7_23| 0))) :named ssa_24))
...
(assert (! (and (= |v_main_#t~post10_10_fresh_1| main_~nc_B~0_27) (= (+ |v_main_#t~post10_10_fresh_1| 1) main_~nc_B~0_29) (not (= |main_#t~mem9_28| 0))) :named ssa_29))
...
(assert (! (and (= (+ |v_main_#t~post10_11_fresh_1| 1) main_~nc_B~0_31) (not (= |main_#t~mem9_30| 0)) (= |v_main_#t~post10_11_fresh_1| main_~nc_B~0_29)) :named ssa_31))
