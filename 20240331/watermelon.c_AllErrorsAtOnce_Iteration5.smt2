...
(set-info :ultimate-id watermelon.c_AllErrorsAtOnce_Iteration5)
...
(declare-fun v_main_~is_divisible2~0_10_fresh_1 () Int)
(declare-fun v_main_~is_divisible1~0_10_fresh_1 () Int)
...
(declare-fun main_~is_divisible1~0_15 () Int)
(declare-fun main_~w~0_16 () Int)
(declare-fun |student_version_#in~w_16| () Int)
...
(assert (! (and (= ~true~0_1 v_main_~is_divisible1~0_10_fresh_1) (= ~true~0_1 v_main_~is_divisible2~0_10_fresh_1)) :named ssa_4))
...
(assert (! (<= correct_version_~w_7 correct_version_~i~0_9) :named ssa_10))
(assert (! (= correct_version_~i~0_9 correct_version_~w_7) :named ssa_11))
(assert (! true :named ssa_12))
(assert (! (= |correct_version_#res_13| correct_version_~is_divisible~0_7) :named ssa_13))
(assert (! (= |main_#t~ret5_14| |correct_version_#res_13|) :named ssa_14_return))
(assert (! (and (= main_~is_divisible1~0_15 |main_#t~ret5_14|) (<= 0 (+ |main_#t~ret5_14| 2147483648)) (<= |main_#t~ret5_14| 2147483647)) :named ssa_15))
(assert (! true :named ssa_16_GlobVarAssigCall))
(assert (! (= |student_version_#in~w_16| (ite (<= (mod main_~w~0_4 4294967296) 2147483647) (mod main_~w~0_4 4294967296) (+ (mod main_~w~0_4 4294967296) (- 4294967296)))) :named ssa_16_LocVarAssigCall))
(assert (! true :named ssa_16_OldVarAssigCall))
(assert (! (and (= student_version_~w_17 |student_version_#in~w_16|) (= ~true~0_1 student_version_~is_divisible~1_17)) :named ssa_17))
(assert (! (and (< student_version_~w_17 4) (= ~false~0_1 student_version_~is_divisible~1_18)) :named ssa_18))
(assert (! (= student_version_~is_divisible~1_18 |student_version_#res_19|) :named ssa_19))
...
(assert (! (= (ite (= main_~is_divisible1~0_15 main_~is_divisible2~0_21) 1 0) |__VERIFIER_assert_#in~cond_22|) :named ssa_22_LocVarAssigCall))
...
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 ssa_5 (and ssa_13 ssa_7 ssa_10 ssa_8 ssa_9 ssa_6_OldVarAssigCall ssa_12 ssa_6_GlobVarAssigCall ssa_11 ssa_6_LocVarAssigCall ssa_14_return) ssa_15 (and ssa_19 ssa_16_OldVarAssigCall ssa_16_LocVarAssigCall ssa_20_return ssa_16_GlobVarAssigCall ssa_18 ssa_17) ssa_21 (and ssa_22_OldVarAssigCall ssa_22_LocVarAssigCall ssa_22_GlobVarAssigCall) ssa_23 ssa_24 (and ssa_25 ssa_postcond))
...
(declare-fun correct_version_~w_4 () Int)
...
(declare-fun |main_#t~ret5_7| () Int)
...
(assert (! (<= correct_version_~w_0 correct_version_~i~0_2) :named ssa_3))
(assert (! (= correct_version_~i~0_2 correct_version_~w_0) :named ssa_4))
(assert (! true :named ssa_5))
(assert (! (= |correct_version_#res_6| correct_version_~is_divisible~0_0) :named ssa_6))
(assert (! (= |main_#t~ret5_7| |correct_version_#res_6|) :named ssa_7_return))
(assert (! true :named ssa_-2_PendingContext))
