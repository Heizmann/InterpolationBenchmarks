...
(set-info :ultimate-id mono-crafted_11.c_AllErrorsAtOnce_Iteration14)
...
(assert (! (<= 100000000 (mod main_~x~0_28 4294967296)) :named ssa_29))
(assert (! true :named ssa_30_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_30| (ite (= (mod main_~x~0_28 2) 0) 1 0)) :named ssa_30_LocVarAssigCall))
