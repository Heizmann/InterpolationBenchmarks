...
(set-info :ultimate-id array_init_pair_symmetr2.c_AllErrorsAtOnce_Iteration6)
...
(declare-fun |main_#t~post9_92| () Int)
...
(declare-fun |main_#t~post9_93| () Int)
...
(declare-fun |main_#t~mem8_94| () Int)
(declare-fun |main_#t~post9_94| () Int)
...
(declare-fun |main_#t~mem8_95| () Int)
(declare-fun |main_#t~post9_95| () Int)
...
(declare-fun |main_#t~mem8_96| () Int)
(declare-fun |main_#t~post9_96| () Int)
...
(declare-fun |main_#t~mem10_99| () Int)
(declare-fun |__VERIFIER_assert_#in~cond_100| () Int)
(declare-fun |main_#t~mem10_100| () Int)
...
(assert (! (and (= (store (select |#memory_int#2_3| |main_~#a~0.base_4|) (+ (* main_~i~0_4 4) |main_~#a~0.offset_4|) main_~x~0_5) v_ArrVal_97_fresh_1) (= (store (select |#memory_int#1_3| |main_~#b~0.base_4|) (+ |main_~#b~0.offset_4| (* main_~i~0_4 4)) v_ArrVal_98_fresh_1) v_ArrVal_99_fresh_1) (= (store |#memory_int#1_3| |main_~#b~0.base_4| v_ArrVal_99_fresh_1) |#memory_int#1_21|) (= v_ArrVal_100_fresh_1 main_~x~0_5) (= main_~i~0_21 (+ main_~i~0_4 1)) (= (store |#memory_int#2_3| |main_~#a~0.base_4| v_ArrVal_97_fresh_1) |#memory_int#2_21|) (= main_~y~0_5 v_ArrVal_98_fresh_1)) :named ssa_21))
...
(assert (! (and (= v_ArrVal_103_fresh_1 (store (select |#memory_int#1_21| |main_~#b~0.base_4|) (+ |main_~#b~0.offset_4| (* main_~i~0_21 4)) v_ArrVal_102_fresh_1)) (= (store |#memory_int#1_21| |main_~#b~0.base_4| v_ArrVal_103_fresh_1) |#memory_int#1_38|) (= (store |#memory_int#2_21| |main_~#a~0.base_4| v_ArrVal_101_fresh_1) |#memory_int#2_38|) (= main_~i~0_38 (+ main_~i~0_21 1)) (= v_ArrVal_104_fresh_1 main_~x~0_22) (= v_ArrVal_101_fresh_1 (store (select |#memory_int#2_21| |main_~#a~0.base_4|) (+ (* main_~i~0_21 4) |main_~#a~0.offset_4|) main_~x~0_22)) (= v_ArrVal_102_fresh_1 main_~y~0_22)) :named ssa_38))
...
(assert (! (and (= v_ArrVal_108_fresh_1 main_~x~0_39) (= v_ArrVal_107_fresh_1 (store (select |#memory_int#1_38| |main_~#b~0.base_4|) (+ |main_~#b~0.offset_4| (* main_~i~0_38 4)) v_ArrVal_106_fresh_1)) (= v_ArrVal_105_fresh_1 (store (select |#memory_int#2_38| |main_~#a~0.base_4|) (+ (* main_~i~0_38 4) |main_~#a~0.offset_4|) main_~x~0_39)) (= main_~i~0_55 (+ main_~i~0_38 1)) (= (store |#memory_int#1_38| |main_~#b~0.base_4| v_ArrVal_107_fresh_1) |#memory_int#1_55|) (= (store |#memory_int#2_38| |main_~#a~0.base_4| v_ArrVal_105_fresh_1) |#memory_int#2_55|) (= v_ArrVal_106_fresh_1 main_~y~0_39)) :named ssa_55))
...
(assert (! (and (= v_ArrVal_111_fresh_1 (store (select |#memory_int#1_55| |main_~#b~0.base_4|) (+ |main_~#b~0.offset_4| (* main_~i~0_55 4)) v_ArrVal_110_fresh_1)) (= (store |#memory_int#1_55| |main_~#b~0.base_4| v_ArrVal_111_fresh_1) |#memory_int#1_72|) (= main_~i~0_72 (+ main_~i~0_55 1)) (= |#memory_int#2_72| (store |#memory_int#2_55| |main_~#a~0.base_4| v_ArrVal_109_fresh_1)) (= v_ArrVal_109_fresh_1 (store (select |#memory_int#2_55| |main_~#a~0.base_4|) (+ (* main_~i~0_55 4) |main_~#a~0.offset_4|) main_~x~0_56)) (= v_ArrVal_112_fresh_1 main_~x~0_56) (= v_ArrVal_110_fresh_1 main_~y~0_56)) :named ssa_72))
...
(assert (! (and (= (store |#memory_int#2_72| |main_~#a~0.base_4| v_ArrVal_113_fresh_1) |#memory_int#2_89|) (= v_ArrVal_116_fresh_1 main_~x~0_73) (= v_ArrVal_114_fresh_1 main_~y~0_73) (= (store |#memory_int#1_72| |main_~#b~0.base_4| v_ArrVal_115_fresh_1) |#memory_int#1_89|) (= main_~i~0_89 (+ main_~i~0_72 1)) (= v_ArrVal_115_fresh_1 (store (select |#memory_int#1_72| |main_~#b~0.base_4|) (+ |main_~#b~0.offset_4| (* main_~i~0_72 4)) v_ArrVal_114_fresh_1)) (= v_ArrVal_113_fresh_1 (store (select |#memory_int#2_72| |main_~#a~0.base_4|) (+ (* main_~i~0_72 4) |main_~#a~0.offset_4|) main_~x~0_73))) :named ssa_89))
(assert (! (<= ~N~0_1 main_~i~0_89) :named ssa_90))
(assert (! (= main_~i~0_91 0) :named ssa_91))
(assert (! (and (= v_ArrVal_118_fresh_1 (store (select |#memory_int#3_3| |main_~#c~0.base_4|) (+ (* main_~i~0_91 4) |main_~#c~0.offset_4|) v_ArrVal_117_fresh_1)) (= |#memory_int#3_92| (store |#memory_int#3_3| |main_~#c~0.base_4| v_ArrVal_118_fresh_1)) (= main_~i~0_92 (+ main_~i~0_91 1)) (< main_~i~0_91 ~N~0_1) (= (select (select |#memory_int#2_89| |main_~#a~0.base_4|) (+ (* main_~i~0_91 4) |main_~#a~0.offset_4|)) (+ v_ArrVal_117_fresh_1 (select (select |#memory_int#1_89| |main_~#b~0.base_4|) (+ (* main_~i~0_91 4) |main_~#b~0.offset_4|))))) :named ssa_92))
(assert (! (and (= (store |#memory_int#3_92| |main_~#c~0.base_4| v_ArrVal_120_fresh_1) |#memory_int#3_93|) (= v_ArrVal_120_fresh_1 (store (select |#memory_int#3_92| |main_~#c~0.base_4|) (+ (* main_~i~0_92 4) |main_~#c~0.offset_4|) v_ArrVal_119_fresh_1)) (= (select (select |#memory_int#2_89| |main_~#a~0.base_4|) (+ (* main_~i~0_92 4) |main_~#a~0.offset_4|)) (+ v_ArrVal_119_fresh_1 (select (select |#memory_int#1_89| |main_~#b~0.base_4|) (+ (* main_~i~0_92 4) |main_~#b~0.offset_4|)))) (= main_~i~0_93 (+ main_~i~0_92 1)) (< main_~i~0_92 ~N~0_1)) :named ssa_93))
(assert (! (and (= (store |#memory_int#3_93| |main_~#c~0.base_4| v_ArrVal_122_fresh_1) |#memory_int#3_94|) (= (store (select |#memory_int#3_93| |main_~#c~0.base_4|) (+ (* main_~i~0_93 4) |main_~#c~0.offset_4|) v_ArrVal_121_fresh_1) v_ArrVal_122_fresh_1) (= (+ v_ArrVal_121_fresh_1 (select (select |#memory_int#1_89| |main_~#b~0.base_4|) (+ (* main_~i~0_93 4) |main_~#b~0.offset_4|))) (select (select |#memory_int#2_89| |main_~#a~0.base_4|) (+ (* main_~i~0_93 4) |main_~#a~0.offset_4|))) (= main_~i~0_94 (+ main_~i~0_93 1)) (< main_~i~0_93 ~N~0_1)) :named ssa_94))
(assert (! (and (= (store |#memory_int#3_94| |main_~#c~0.base_4| v_ArrVal_124_fresh_1) |#memory_int#3_95|) (= (select (select |#memory_int#2_89| |main_~#a~0.base_4|) (+ (* main_~i~0_94 4) |main_~#a~0.offset_4|)) (+ v_ArrVal_123_fresh_1 (select (select |#memory_int#1_89| |main_~#b~0.base_4|) (+ (* main_~i~0_94 4) |main_~#b~0.offset_4|)))) (= main_~i~0_95 (+ main_~i~0_94 1)) (< main_~i~0_94 ~N~0_1) (= v_ArrVal_124_fresh_1 (store (select |#memory_int#3_94| |main_~#c~0.base_4|) (+ (* main_~i~0_94 4) |main_~#c~0.offset_4|) v_ArrVal_123_fresh_1))) :named ssa_95))
(assert (! (and (= main_~i~0_96 (+ main_~i~0_95 1)) (= (store |#memory_int#3_95| |main_~#c~0.base_4| v_ArrVal_126_fresh_1) |#memory_int#3_96|) (< main_~i~0_95 ~N~0_1) (= (select (select |#memory_int#2_89| |main_~#a~0.base_4|) (+ (* main_~i~0_95 4) |main_~#a~0.offset_4|)) (+ v_ArrVal_125_fresh_1 (select (select |#memory_int#1_89| |main_~#b~0.base_4|) (+ (* main_~i~0_95 4) |main_~#b~0.offset_4|)))) (= v_ArrVal_126_fresh_1 (store (select |#memory_int#3_95| |main_~#c~0.base_4|) (+ (* main_~i~0_95 4) |main_~#c~0.offset_4|) v_ArrVal_125_fresh_1))) :named ssa_96))
(assert (! (<= ~N~0_1 main_~i~0_96) :named ssa_97))
(assert (! (= main_~i~0_98 1) :named ssa_98))
(assert (! (and (< main_~i~0_98 ~N~0_1) (= |main_#t~mem10_99| (select (select |#memory_int#3_96| |main_~#c~0.base_4|) (+ (* main_~i~0_98 4) |main_~#c~0.offset_4|)))) :named ssa_99))
(assert (! true :named ssa_100_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_100| (ite (< 0 |main_#t~mem10_99|) 1 0)) :named ssa_100_LocVarAssigCall))
