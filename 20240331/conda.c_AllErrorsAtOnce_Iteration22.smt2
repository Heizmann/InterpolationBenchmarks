...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-30T23:51:00+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id conda.c_AllErrorsAtOnce_Iteration22)
...
(declare-fun |main_#t~post10_28| () Int)
...
(declare-fun |main_#t~post10_31| () Int)
...
(declare-fun |main_#t~post10_34| () Int)
...
(declare-fun |main_~#sum~0.offset_43| () Int)
...
(assert (! (and (= v_ArrVal_478_fresh_1 8) (= (store |#memory_int#1_3| |main_~#sum~0.base_11| v_ArrVal_477_fresh_1) |#memory_int#1_11|) (= v_ArrVal_476_fresh_1 1) (= |#valid_11| (store (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_476_fresh_1) main_~a~0.base_11 v_ArrVal_474_fresh_1)) (= main_~i~0_11 0) (= v_ArrVal_477_fresh_1 (store (select |#memory_int#1_3| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| v_ArrVal_475_fresh_1)) (< main_~a~0.base_11 |#StackHeapBarrier_-1|) (= |main_~#sum~0.offset_11| 0) (= (select (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_476_fresh_1) main_~a~0.base_11) 0) (< |#StackHeapBarrier_-1| |main_~#sum~0.base_11|) (= v_ArrVal_475_fresh_1 0) (= v_ArrVal_473_fresh_1 (* (mod ~N~0_4 1073741824) 4)) (not (= |main_~#sum~0.base_11| 0)) (= (select |#valid_3| |main_~#sum~0.base_11|) 0) (= main_~a~0.offset_11 0) (not (= main_~a~0.base_11 0)) (= v_ArrVal_474_fresh_1 1) (= |#length_11| (store (store |#length_3| |main_~#sum~0.base_11| v_ArrVal_478_fresh_1) main_~a~0.base_11 v_ArrVal_473_fresh_1))) :named ssa_11))
(assert (! (and (= main_~i~0_12 (+ main_~i~0_11 1)) (< main_~i~0_11 ~N~0_4) (= v_ArrVal_480_fresh_1 1) (= |#memory_int#3_12| (store |#memory_int#3_3| main_~a~0.base_11 v_ArrVal_479_fresh_1)) (= v_ArrVal_479_fresh_1 (store (select |#memory_int#3_3| main_~a~0.base_11) (+ (* main_~i~0_11 4) main_~a~0.offset_11) 1))) :named ssa_12))
(assert (! (and (= |#memory_int#3_13| (store |#memory_int#3_12| main_~a~0.base_11 v_ArrVal_481_fresh_1)) (= v_ArrVal_482_fresh_1 1) (= v_ArrVal_481_fresh_1 (store (select |#memory_int#3_12| main_~a~0.base_11) (+ (* main_~i~0_12 4) main_~a~0.offset_11) 1)) (= main_~i~0_13 (+ main_~i~0_12 1)) (< main_~i~0_12 ~N~0_4)) :named ssa_13))
(assert (! (and (= (store |#memory_int#3_13| main_~a~0.base_11 v_ArrVal_483_fresh_1) |#memory_int#3_14|) (= main_~i~0_14 (+ main_~i~0_13 1)) (< main_~i~0_13 ~N~0_4) (= v_ArrVal_484_fresh_1 1) (= v_ArrVal_483_fresh_1 (store (select |#memory_int#3_13| main_~a~0.base_11) (+ (* main_~i~0_13 4) main_~a~0.offset_11) 1))) :named ssa_14))
(assert (! (and (= v_ArrVal_485_fresh_1 (store (select |#memory_int#3_14| main_~a~0.base_11) (+ (* main_~i~0_14 4) main_~a~0.offset_11) 1)) (= main_~i~0_15 (+ main_~i~0_14 1)) (< main_~i~0_14 ~N~0_4) (= v_ArrVal_486_fresh_1 1) (= |#memory_int#3_15| (store |#memory_int#3_14| main_~a~0.base_11 v_ArrVal_485_fresh_1))) :named ssa_15))
(assert (! (and (= v_ArrVal_487_fresh_1 (store (select |#memory_int#3_15| main_~a~0.base_11) (+ (* main_~i~0_15 4) main_~a~0.offset_11) 1)) (= v_ArrVal_488_fresh_1 1) (= main_~i~0_16 (+ main_~i~0_15 1)) (< main_~i~0_15 ~N~0_4) (= (store |#memory_int#3_15| main_~a~0.base_11 v_ArrVal_487_fresh_1) |#memory_int#3_16|)) :named ssa_16))
(assert (! (and (= v_ArrVal_489_fresh_1 (store (select |#memory_int#3_16| main_~a~0.base_11) (+ (* main_~i~0_16 4) main_~a~0.offset_11) 1)) (= (store |#memory_int#3_16| main_~a~0.base_11 v_ArrVal_489_fresh_1) |#memory_int#3_17|) (= main_~i~0_17 (+ main_~i~0_16 1)) (= v_ArrVal_490_fresh_1 1) (< main_~i~0_16 ~N~0_4)) :named ssa_17))
(assert (! (<= ~N~0_4 main_~i~0_17) :named ssa_18))
(assert (! (= main_~i~0_19 0) :named ssa_19))
(assert (! (and (< main_~i~0_19 ~N~0_4) (= (select (select |#memory_int#3_17| main_~a~0.base_11) (+ (* main_~i~0_19 4) main_~a~0.offset_11)) |main_#t~mem7_20|)) :named ssa_20))
(assert (! (and (= |main_#t~mem7_20| 1) (= (store |#memory_int#3_17| main_~a~0.base_11 v_ArrVal_491_fresh_1) |#memory_int#3_21|) (= v_ArrVal_492_fresh_1 (+ (select (select |#memory_int#3_17| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_19 4))) 1)) (= v_ArrVal_491_fresh_1 (store (select |#memory_int#3_17| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_19 4)) (+ (select (select |#memory_int#3_17| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_19 4))) 1)))) :named ssa_21))
...
(assert (! (and (= |main_#t~mem7_23| 1) (= |#memory_int#3_24| (store |#memory_int#3_21| main_~a~0.base_11 v_ArrVal_493_fresh_1)) (= v_ArrVal_494_fresh_1 (+ (select (select |#memory_int#3_21| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_22 4))) 1)) (= v_ArrVal_493_fresh_1 (store (select |#memory_int#3_21| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_22 4)) (+ (select (select |#memory_int#3_21| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_22 4))) 1)))) :named ssa_24))
(assert (! (= main_~i~0_25 (+ main_~i~0_22 1)) :named ssa_25))
(assert (! (and (< main_~i~0_25 ~N~0_4) (= (select (select |#memory_int#3_24| main_~a~0.base_11) (+ (* main_~i~0_25 4) main_~a~0.offset_11)) |main_#t~mem7_26|)) :named ssa_26))
(assert (! (and (= |main_#t~mem7_26| 1) (= v_ArrVal_496_fresh_1 (+ (select (select |#memory_int#3_24| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_25 4))) 1)) (= v_ArrVal_495_fresh_1 (store (select |#memory_int#3_24| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_25 4)) (+ (select (select |#memory_int#3_24| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_25 4))) 1))) (= (store |#memory_int#3_24| main_~a~0.base_11 v_ArrVal_495_fresh_1) |#memory_int#3_27|)) :named ssa_27))
(assert (! (= main_~i~0_28 (+ main_~i~0_25 1)) :named ssa_28))
(assert (! (and (< main_~i~0_28 ~N~0_4) (= (select (select |#memory_int#3_27| main_~a~0.base_11) (+ (* main_~i~0_28 4) main_~a~0.offset_11)) |main_#t~mem7_29|)) :named ssa_29))
(assert (! (and (= |main_#t~mem7_29| 1) (= |#memory_int#3_30| (store |#memory_int#3_27| main_~a~0.base_11 v_ArrVal_497_fresh_1)) (= v_ArrVal_498_fresh_1 (+ (select (select |#memory_int#3_27| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_28 4))) 1)) (= v_ArrVal_497_fresh_1 (store (select |#memory_int#3_27| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_28 4)) (+ (select (select |#memory_int#3_27| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_28 4))) 1)))) :named ssa_30))
(assert (! (= main_~i~0_31 (+ main_~i~0_28 1)) :named ssa_31))
(assert (! (and (< main_~i~0_31 ~N~0_4) (= (select (select |#memory_int#3_30| main_~a~0.base_11) (+ (* main_~i~0_31 4) main_~a~0.offset_11)) |main_#t~mem7_32|)) :named ssa_32))
(assert (! (and (= |main_#t~mem7_32| 1) (= (store |#memory_int#3_30| main_~a~0.base_11 v_ArrVal_499_fresh_1) |#memory_int#3_33|) (= v_ArrVal_500_fresh_1 (+ (select (select |#memory_int#3_30| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_31 4))) 1)) (= v_ArrVal_499_fresh_1 (store (select |#memory_int#3_30| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_31 4)) (+ (select (select |#memory_int#3_30| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_31 4))) 1)))) :named ssa_33))
(assert (! (= main_~i~0_34 (+ main_~i~0_31 1)) :named ssa_34))
(assert (! (<= ~N~0_4 main_~i~0_34) :named ssa_35))
(assert (! (= main_~i~0_36 0) :named ssa_36))
(assert (! (and (= (store |#memory_int#1_11| |main_~#sum~0.base_11| v_ArrVal_501_fresh_1) |#memory_int#1_37|) (= v_ArrVal_501_fresh_1 (store (select |#memory_int#1_11| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| (+ (select (select |#memory_int#3_33| main_~a~0.base_11) (+ (* main_~i~0_36 4) main_~a~0.offset_11)) (select (select |#memory_int#1_11| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|)))) (< main_~i~0_36 ~N~0_4) (= main_~i~0_37 (+ main_~i~0_36 1)) (= v_ArrVal_502_fresh_1 (+ (select (select |#memory_int#3_33| main_~a~0.base_11) (+ (* main_~i~0_36 4) main_~a~0.offset_11)) (select (select |#memory_int#1_11| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|)))) :named ssa_37))
(assert (! (and (= v_ArrVal_504_fresh_1 (+ (select (select |#memory_int#3_33| main_~a~0.base_11) (+ (* main_~i~0_37 4) main_~a~0.offset_11)) (select (select |#memory_int#1_37| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|))) (< main_~i~0_37 ~N~0_4) (= v_ArrVal_503_fresh_1 (store (select |#memory_int#1_37| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| (+ (select (select |#memory_int#3_33| main_~a~0.base_11) (+ (* main_~i~0_37 4) main_~a~0.offset_11)) (select (select |#memory_int#1_37| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|)))) (= main_~i~0_38 (+ main_~i~0_37 1)) (= (store |#memory_int#1_37| |main_~#sum~0.base_11| v_ArrVal_503_fresh_1) |#memory_int#1_38|)) :named ssa_38))
(assert (! (and (= v_ArrVal_505_fresh_1 (store (select |#memory_int#1_38| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| (+ (select (select |#memory_int#3_33| main_~a~0.base_11) (+ (* main_~i~0_38 4) main_~a~0.offset_11)) (select (select |#memory_int#1_38| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|)))) (= |#memory_int#1_39| (store |#memory_int#1_38| |main_~#sum~0.base_11| v_ArrVal_505_fresh_1)) (< main_~i~0_38 ~N~0_4) (= main_~i~0_39 (+ main_~i~0_38 1)) (= v_ArrVal_506_fresh_1 (+ (select (select |#memory_int#3_33| main_~a~0.base_11) (+ (* main_~i~0_38 4) main_~a~0.offset_11)) (select (select |#memory_int#1_38| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|)))) :named ssa_39))
(assert (! (and (= (store |#memory_int#1_39| |main_~#sum~0.base_11| v_ArrVal_507_fresh_1) |#memory_int#1_40|) (< main_~i~0_39 ~N~0_4) (= main_~i~0_40 (+ main_~i~0_39 1)) (= v_ArrVal_508_fresh_1 (+ (select (select |#memory_int#3_33| main_~a~0.base_11) (+ (* main_~i~0_39 4) main_~a~0.offset_11)) (select (select |#memory_int#1_39| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|))) (= v_ArrVal_507_fresh_1 (store (select |#memory_int#1_39| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| (+ (select (select |#memory_int#3_33| main_~a~0.base_11) (+ (* main_~i~0_39 4) main_~a~0.offset_11)) (select (select |#memory_int#1_39| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|))))) :named ssa_40))
(assert (! (and (= (store |#memory_int#1_40| |main_~#sum~0.base_11| v_ArrVal_509_fresh_1) |#memory_int#1_41|) (= v_ArrVal_510_fresh_1 (+ (select (select |#memory_int#3_33| main_~a~0.base_11) (+ (* main_~i~0_40 4) main_~a~0.offset_11)) (select (select |#memory_int#1_40| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|))) (< main_~i~0_40 ~N~0_4) (= v_ArrVal_509_fresh_1 (store (select |#memory_int#1_40| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| (+ (select (select |#memory_int#3_33| main_~a~0.base_11) (+ (* main_~i~0_40 4) main_~a~0.offset_11)) (select (select |#memory_int#1_40| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|)))) (= main_~i~0_41 (+ main_~i~0_40 1))) :named ssa_41))
(assert (! (<= ~N~0_4 main_~i~0_41) :named ssa_42))
(assert (! (= (select (select |#memory_int#1_41| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|) |main_#t~mem14_43|) :named ssa_43))
(assert (! true :named ssa_44_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_44| (ite (= (* 2 ~N~0_4) |main_#t~mem14_43|) 1 0)) :named ssa_44_LocVarAssigCall))
