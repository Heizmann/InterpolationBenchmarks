...
(set-info :ultimate-id Addition03-1.c_AllErrorsAtOnce_Iteration4)
...
(declare-fun main_~m~0_25 () Int)
(declare-fun main_~n~0_25 () Int)
...
(assert (! (and (= 0 addition_~n_14) (= |addition_#res_15| addition_~m_14)) :named ssa_15))
(assert (! true :named ssa_16))
(assert (! (= |addition_#res_15| |addition_#t~ret4_17|) :named ssa_17_return))
(assert (! (and (<= 0 (+ 9223372036854775808 |addition_#t~ret4_17|)) (<= |addition_#t~ret4_17| 9223372036854775807) (= |addition_#res_18| |addition_#t~ret4_17|)) :named ssa_18))
(assert (! true :named ssa_19))
(assert (! (= |addition_#res_18| |addition_#t~ret4_20|) :named ssa_20_return))
(assert (! (and (<= 0 (+ 9223372036854775808 |addition_#t~ret4_20|)) (<= |addition_#t~ret4_20| 9223372036854775807) (= |addition_#res_21| |addition_#t~ret4_20|)) :named ssa_21))
(assert (! true :named ssa_22))
(assert (! (= |addition_#res_21| |main_#t~ret8_23|) :named ssa_23_return))
(assert (! (and (<= |main_#t~ret8_23| 9223372036854775807) (<= 0 (+ |main_#t~ret8_23| 9223372036854775808)) (= main_~result~0_24 |main_#t~ret8_23|)) :named ssa_24))
(assert (! (and (< main_~result~0_24 200) (<= 100 main_~n~0_4) (<= 100 main_~m~0_4)) :named ssa_25))
(assert (! true :named ssa_26))
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 (and ssa_5_LocVarAssigCall ssa_5_GlobVarAssigCall ssa_7 ssa_16 ssa_6 ssa_10 ssa_14 ssa_8 ssa_13_LocVarAssigCall ssa_13_OldVarAssigCall ssa_19 ssa_20_return ssa_13_GlobVarAssigCall ssa_12 ssa_5_OldVarAssigCall ssa_17_return ssa_11 ssa_22 ssa_15 ssa_21 ssa_18 ssa_23_return ssa_9_LocVarAssigCall ssa_9_OldVarAssigCall ssa_9_GlobVarAssigCall) ssa_24 ssa_25 (and ssa_26 ssa_postcond))
...
(assert (! true :named ssa_16))
(assert (! (= |addition_#res_15| |main_#t~ret8_17|) :named ssa_17_return))
(assert (! true :named ssa_-2_PendingContext))
