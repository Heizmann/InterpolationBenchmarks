...
(set-info :ultimate-id newton_2_1.i_AllErrorsAtOnce_Iteration2)
...
(assert (! (not v_~someBinaryDOUBLEComparisonOperation_6_fresh_1) :named ssa_24))
...
(assert (! true :named ssa_22_return))
(assert (! true :named ssa_23))
(assert (! (not v_~someBinaryDOUBLEComparisonOperation_4_fresh_1) :named ssa_24))
(assert (! true :named ssa_25))
(check-sat)
