...
(set-info :ultimate-id watermelon.c_AllErrorsAtOnce_Iteration23)
...
(declare-fun v_main_~is_divisible1~0_28_fresh_1 () Int)
(declare-fun v_main_~is_divisible2~0_28_fresh_1 () Int)
...
(declare-fun correct_version_~w_16 () Int)
...
(declare-fun main_~is_divisible1~0_20 () Int)
(declare-fun main_~w~0_21 () Int)
(declare-fun |student_version_#in~w_21| () Int)
(declare-fun student_version_~w_22 () Int)
(declare-fun student_version_~is_divisible~1_22 () Int)
...
(assert (! (and (= ~true~0_1 v_main_~is_divisible2~0_28_fresh_1) (= ~true~0_1 v_main_~is_divisible1~0_28_fresh_1)) :named ssa_4))
...
(assert (! (<= correct_version_~w_7 correct_version_~i~0_14) :named ssa_15))
(assert (! (and (not (= correct_version_~i~0_14 correct_version_~w_7)) (= ~false~0_1 correct_version_~is_divisible~0_16)) :named ssa_16))
(assert (! true :named ssa_17))
(assert (! (= |correct_version_#res_18| correct_version_~is_divisible~0_16) :named ssa_18))
(assert (! (= |main_#t~ret5_19| |correct_version_#res_18|) :named ssa_19_return))
(assert (! (and (= main_~is_divisible1~0_20 |main_#t~ret5_19|) (<= 0 (+ |main_#t~ret5_19| 2147483648)) (<= |main_#t~ret5_19| 2147483647)) :named ssa_20))
(assert (! true :named ssa_21_GlobVarAssigCall))
(assert (! (= |student_version_#in~w_21| (ite (<= (mod main_~w~0_4 4294967296) 2147483647) (mod main_~w~0_4 4294967296) (+ (mod main_~w~0_4 4294967296) (- 4294967296)))) :named ssa_21_LocVarAssigCall))
(assert (! true :named ssa_21_OldVarAssigCall))
(assert (! (and (= student_version_~w_22 |student_version_#in~w_21|) (= ~true~0_1 student_version_~is_divisible~1_22)) :named ssa_22))
(assert (! (and (<= 4 student_version_~w_22) (= student_version_~i~1_23 0)) :named ssa_23))
(assert (! (and (= (+ 2 student_version_~i~1_23) student_version_~i~1_24) (< student_version_~i~1_23 student_version_~w_22)) :named ssa_24))
(assert (! (and (= (+ 2 student_version_~i~1_24) student_version_~i~1_25) (< student_version_~i~1_24 student_version_~w_22)) :named ssa_25))
(assert (! (and (= (+ 2 student_version_~i~1_25) student_version_~i~1_26) (< student_version_~i~1_25 student_version_~w_22)) :named ssa_26))
(assert (! (and (= (+ 2 student_version_~i~1_26) student_version_~i~1_27) (< student_version_~i~1_26 student_version_~w_22)) :named ssa_27))
(assert (! (and (= (+ 2 student_version_~i~1_27) student_version_~i~1_28) (< student_version_~i~1_27 student_version_~w_22)) :named ssa_28))
(assert (! (<= student_version_~w_22 student_version_~i~1_28) :named ssa_29))
(assert (! (= student_version_~w_22 student_version_~i~1_28) :named ssa_30))
(assert (! true :named ssa_31))
(assert (! (= student_version_~is_divisible~1_22 |student_version_#res_32|) :named ssa_32))
...
(assert (! (= (ite (= main_~is_divisible1~0_20 main_~is_divisible2~0_34) 1 0) |__VERIFIER_assert_#in~cond_35|) :named ssa_35_LocVarAssigCall))
...
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 ssa_5 (and ssa_13 ssa_7 ssa_16 ssa_10 ssa_14 ssa_8 ssa_9 ssa_6_OldVarAssigCall ssa_12 ssa_6_GlobVarAssigCall ssa_19_return ssa_11 ssa_15 ssa_6_LocVarAssigCall ssa_18 ssa_17) ssa_20 (and ssa_27 ssa_21_LocVarAssigCall ssa_31 ssa_21_OldVarAssigCall ssa_26 ssa_25 ssa_32 ssa_28 ssa_22 ssa_29 ssa_33_return ssa_23 ssa_30 ssa_21_GlobVarAssigCall ssa_24) ssa_34 (and ssa_35_LocVarAssigCall ssa_35_GlobVarAssigCall ssa_35_OldVarAssigCall) ssa_36 ssa_37 (and ssa_38 ssa_postcond))
...
(declare-fun correct_version_~w_9 () Int)
(declare-fun correct_version_~i~0_9 () Int)
(declare-fun correct_version_~i~0_10 () Int)
...
(assert (! true :named ssa_precond))
(assert (! (not (and (<= main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647)) (<= (+ (* (div main_~w~0_-2 4294967296) 4294967296) 11) main_~w~0_-2))) :named ssa_postcond))
...
(assert (! (<= correct_version_~w_0 correct_version_~i~0_7) :named ssa_8))
(assert (! (and (not (= correct_version_~i~0_7 correct_version_~w_0)) (= ~false~0_-1 correct_version_~is_divisible~0_9)) :named ssa_9))
(assert (! true :named ssa_10))
(assert (! (= |correct_version_#res_11| correct_version_~is_divisible~0_9) :named ssa_11))
(assert (! (= |main_#t~ret5_12| |correct_version_#res_11|) :named ssa_12_return))
(assert (! true :named ssa_-2_PendingContext))
...
(assert (! (and (<= main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647)) (<= (+ (* (div main_~w~0_-2 4294967296) 4294967296) 11) main_~w~0_-2)) :named ssa_-2_PendingContext))
