...
(set-info :ultimate-id standard_minInArray_ground-2.i_AllErrorsAtOnce_Iteration10)
...
(declare-fun main_~min~0_16 () Int)
...
(assert (! (and (= v_ArrVal_75_fresh_1 1) (not (= |main_~#a~0.base_4| 0)) (= main_~min~0_4 0) (< |#StackHeapBarrier_-1| |main_~#a~0.base_4|) (= 400000 v_ArrVal_76_fresh_1) (= |#length_4| (store |#length_3| |main_~#a~0.base_4| v_ArrVal_76_fresh_1)) (= |main_~#a~0.offset_4| 0) (= |#valid_4| (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_75_fresh_1)) (= (select |#valid_3| |main_~#a~0.base_4|) 0) (= main_~i~0_4 0)) :named ssa_4))
(assert (! (and (<= 0 (+ |v_main_#t~nondet1_36_fresh_1| 2147483648)) (= main_~i~0_5 (+ main_~i~0_4 1)) (< main_~i~0_4 100000) (<= |v_main_#t~nondet1_36_fresh_1| 2147483647) (= |v_main_#t~nondet1_36_fresh_1| v_ArrVal_78_fresh_1) (= (store |#memory_int#1_3| |main_~#a~0.base_4| v_ArrVal_77_fresh_1) |#memory_int#1_5|) (= (store (select |#memory_int#1_3| |main_~#a~0.base_4|) (+ (* main_~i~0_4 4) |main_~#a~0.offset_4|) |v_main_#t~nondet1_36_fresh_1|) v_ArrVal_77_fresh_1)) :named ssa_5))
(assert (! (and (= main_~i~0_6 (+ main_~i~0_5 1)) (<= |v_main_#t~nondet1_37_fresh_1| 2147483647) (= |v_main_#t~nondet1_37_fresh_1| v_ArrVal_79_fresh_1) (< main_~i~0_5 100000) (= (store |#memory_int#1_5| |main_~#a~0.base_4| v_ArrVal_80_fresh_1) |#memory_int#1_6|) (<= 0 (+ |v_main_#t~nondet1_37_fresh_1| 2147483648)) (= (store (select |#memory_int#1_5| |main_~#a~0.base_4|) (+ (* main_~i~0_5 4) |main_~#a~0.offset_4|) v_ArrVal_79_fresh_1) v_ArrVal_80_fresh_1)) :named ssa_6))
(assert (! (and (<= |v_main_#t~nondet1_38_fresh_1| 2147483647) (= (store |#memory_int#1_6| |main_~#a~0.base_4| v_ArrVal_81_fresh_1) |#memory_int#1_7|) (= main_~i~0_7 (+ main_~i~0_6 1)) (= (store (select |#memory_int#1_6| |main_~#a~0.base_4|) (+ (* main_~i~0_6 4) |main_~#a~0.offset_4|) |v_main_#t~nondet1_38_fresh_1|) v_ArrVal_81_fresh_1) (< main_~i~0_6 100000) (= |v_main_#t~nondet1_38_fresh_1| v_ArrVal_82_fresh_1) (<= 0 (+ |v_main_#t~nondet1_38_fresh_1| 2147483648))) :named ssa_7))
(assert (! (and (= main_~i~0_8 (+ main_~i~0_7 1)) (<= 0 (+ |v_main_#t~nondet1_39_fresh_1| 2147483648)) (<= |v_main_#t~nondet1_39_fresh_1| 2147483647) (= (store |#memory_int#1_7| |main_~#a~0.base_4| v_ArrVal_83_fresh_1) |#memory_int#1_8|) (< main_~i~0_7 100000) (= |v_main_#t~nondet1_39_fresh_1| v_ArrVal_84_fresh_1) (= (store (select |#memory_int#1_7| |main_~#a~0.base_4|) (+ (* main_~i~0_7 4) |main_~#a~0.offset_4|) |v_main_#t~nondet1_39_fresh_1|) v_ArrVal_83_fresh_1)) :named ssa_8))
(assert (! (and (<= |v_main_#t~nondet1_40_fresh_1| 2147483647) (= main_~i~0_9 (+ main_~i~0_8 1)) (= (store |#memory_int#1_8| |main_~#a~0.base_4| v_ArrVal_86_fresh_1) |#memory_int#1_9|) (<= 0 (+ |v_main_#t~nondet1_40_fresh_1| 2147483648)) (< main_~i~0_8 100000) (= (store (select |#memory_int#1_8| |main_~#a~0.base_4|) (+ (* main_~i~0_8 4) |main_~#a~0.offset_4|) v_ArrVal_85_fresh_1) v_ArrVal_86_fresh_1) (= |v_main_#t~nondet1_40_fresh_1| v_ArrVal_85_fresh_1)) :named ssa_9))
(assert (! (and (= main_~i~0_10 (+ main_~i~0_9 1)) (= |v_main_#t~nondet1_41_fresh_1| v_ArrVal_87_fresh_1) (<= 0 (+ |v_main_#t~nondet1_41_fresh_1| 2147483648)) (<= |v_main_#t~nondet1_41_fresh_1| 2147483647) (< main_~i~0_9 100000) (= (store (select |#memory_int#1_9| |main_~#a~0.base_4|) (+ (* main_~i~0_9 4) |main_~#a~0.offset_4|) v_ArrVal_87_fresh_1) v_ArrVal_88_fresh_1) (= (store |#memory_int#1_9| |main_~#a~0.base_4| v_ArrVal_88_fresh_1) |#memory_int#1_10|)) :named ssa_10))
(assert (! (and (= main_~i~0_11 (+ main_~i~0_10 1)) (= |v_main_#t~nondet1_42_fresh_1| v_ArrVal_90_fresh_1) (< main_~i~0_10 100000) (<= |v_main_#t~nondet1_42_fresh_1| 2147483647) (= (store |#memory_int#1_10| |main_~#a~0.base_4| v_ArrVal_89_fresh_1) |#memory_int#1_11|) (<= 0 (+ |v_main_#t~nondet1_42_fresh_1| 2147483648)) (= v_ArrVal_89_fresh_1 (store (select |#memory_int#1_10| |main_~#a~0.base_4|) (+ (* main_~i~0_10 4) |main_~#a~0.offset_4|) |v_main_#t~nondet1_42_fresh_1|))) :named ssa_11))
(assert (! (and (<= |v_main_#t~nondet1_43_fresh_1| 2147483647) (<= 0 (+ |v_main_#t~nondet1_43_fresh_1| 2147483648)) (= (store |#memory_int#1_11| |main_~#a~0.base_4| v_ArrVal_91_fresh_1) |#memory_int#1_12|) (= main_~i~0_12 (+ main_~i~0_11 1)) (< main_~i~0_11 100000) (= |v_main_#t~nondet1_43_fresh_1| v_ArrVal_92_fresh_1) (= (store (select |#memory_int#1_11| |main_~#a~0.base_4|) (+ (* main_~i~0_11 4) |main_~#a~0.offset_4|) |v_main_#t~nondet1_43_fresh_1|) v_ArrVal_91_fresh_1)) :named ssa_12))
(assert (! (<= 100000 main_~i~0_12) :named ssa_13))
(assert (! (= main_~i~0_14 0) :named ssa_14))
(assert (! (and (= |main_#t~mem3_15| (select (select |#memory_int#1_12| |main_~#a~0.base_4|) (+ (* main_~i~0_14 4) |main_~#a~0.offset_4|))) (< main_~i~0_14 100000)) :named ssa_15))
(assert (! (and (< |main_#t~mem3_15| main_~min~0_4) (= (select (select |#memory_int#1_12| |main_~#a~0.base_4|) (+ (* main_~i~0_14 4) |main_~#a~0.offset_4|)) main_~min~0_16)) :named ssa_16))
(assert (! (= main_~i~0_17 (+ main_~i~0_14 1)) :named ssa_17))
(assert (! (and (= |main_#t~mem3_18| (select (select |#memory_int#1_12| |main_~#a~0.base_4|) (+ (* main_~i~0_17 4) |main_~#a~0.offset_4|))) (< main_~i~0_17 100000)) :named ssa_18))
(assert (! (and (< |main_#t~mem3_18| main_~min~0_16) (= (select (select |#memory_int#1_12| |main_~#a~0.base_4|) (+ (* main_~i~0_17 4) |main_~#a~0.offset_4|)) main_~min~0_19)) :named ssa_19))
(assert (! (= main_~i~0_20 (+ main_~i~0_17 1)) :named ssa_20))
(assert (! (and (= |main_#t~mem3_21| (select (select |#memory_int#1_12| |main_~#a~0.base_4|) (+ (* main_~i~0_20 4) |main_~#a~0.offset_4|))) (< main_~i~0_20 100000)) :named ssa_21))
(assert (! (and (< |main_#t~mem3_21| main_~min~0_19) (= (select (select |#memory_int#1_12| |main_~#a~0.base_4|) (+ (* main_~i~0_20 4) |main_~#a~0.offset_4|)) main_~min~0_22)) :named ssa_22))
(assert (! (= main_~i~0_23 (+ main_~i~0_20 1)) :named ssa_23))
(assert (! (and (= |main_#t~mem3_24| (select (select |#memory_int#1_12| |main_~#a~0.base_4|) (+ (* main_~i~0_23 4) |main_~#a~0.offset_4|))) (< main_~i~0_23 100000)) :named ssa_24))
(assert (! (and (< |main_#t~mem3_24| main_~min~0_22) (= (select (select |#memory_int#1_12| |main_~#a~0.base_4|) (+ (* main_~i~0_23 4) |main_~#a~0.offset_4|)) main_~min~0_25)) :named ssa_25))
(assert (! (= main_~i~0_26 (+ main_~i~0_23 1)) :named ssa_26))
(assert (! (and (= |main_#t~mem3_27| (select (select |#memory_int#1_12| |main_~#a~0.base_4|) (+ (* main_~i~0_26 4) |main_~#a~0.offset_4|))) (< main_~i~0_26 100000)) :named ssa_27))
(assert (! (and (< |main_#t~mem3_27| main_~min~0_25) (= (select (select |#memory_int#1_12| |main_~#a~0.base_4|) (+ (* main_~i~0_26 4) |main_~#a~0.offset_4|)) main_~min~0_28)) :named ssa_28))
(assert (! (= main_~i~0_29 (+ main_~i~0_26 1)) :named ssa_29))
(assert (! (and (= |main_#t~mem3_30| (select (select |#memory_int#1_12| |main_~#a~0.base_4|) (+ (* main_~i~0_29 4) |main_~#a~0.offset_4|))) (< main_~i~0_29 100000)) :named ssa_30))
(assert (! (and (< |main_#t~mem3_30| main_~min~0_28) (= (select (select |#memory_int#1_12| |main_~#a~0.base_4|) (+ (* main_~i~0_29 4) |main_~#a~0.offset_4|)) main_~min~0_31)) :named ssa_31))
(assert (! (= main_~i~0_32 (+ main_~i~0_29 1)) :named ssa_32))
(assert (! (and (= |main_#t~mem3_33| (select (select |#memory_int#1_12| |main_~#a~0.base_4|) (+ (* main_~i~0_32 4) |main_~#a~0.offset_4|))) (< main_~i~0_32 100000)) :named ssa_33))
(assert (! (and (< |main_#t~mem3_33| main_~min~0_31) (= (select (select |#memory_int#1_12| |main_~#a~0.base_4|) (+ (* main_~i~0_32 4) |main_~#a~0.offset_4|)) main_~min~0_34)) :named ssa_34))
(assert (! (= main_~i~0_35 (+ main_~i~0_32 1)) :named ssa_35))
(assert (! (and (= |main_#t~mem3_36| (select (select |#memory_int#1_12| |main_~#a~0.base_4|) (+ (* main_~i~0_35 4) |main_~#a~0.offset_4|))) (< main_~i~0_35 100000)) :named ssa_36))
(assert (! (and (< |main_#t~mem3_36| main_~min~0_34) (= (select (select |#memory_int#1_12| |main_~#a~0.base_4|) (+ (* main_~i~0_35 4) |main_~#a~0.offset_4|)) main_~min~0_37)) :named ssa_37))
(assert (! (= main_~i~0_38 (+ main_~i~0_35 1)) :named ssa_38))
(assert (! (<= 100000 main_~i~0_38) :named ssa_39))
(assert (! (= main_~x~0_40 0) :named ssa_40))
(assert (! (and (< main_~x~0_40 100000) (= |main_#t~mem5_41| (select (select |#memory_int#1_12| |main_~#a~0.base_4|) (+ (* main_~x~0_40 4) |main_~#a~0.offset_4|)))) :named ssa_41))
(assert (! true :named ssa_42_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_42| (ite (<= main_~min~0_37 |main_#t~mem5_41|) 1 0)) :named ssa_42_LocVarAssigCall))
