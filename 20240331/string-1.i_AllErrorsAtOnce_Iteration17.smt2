...
(set-info :ultimate-id string-1.i_AllErrorsAtOnce_Iteration17)
...
(declare-fun v_main_~found~0_22_fresh_1 () Int)
...
(declare-fun |v_main_#t~nondet4_70_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_71_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_72_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_73_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_74_fresh_1| () Int)
...
(assert (! (and (< |#StackHeapBarrier_-1| |main_~#string_A~0.base_4|) (= v_ArrVal_326_fresh_1 5) (= (select (store |#valid_3| |main_~#string_A~0.base_4| v_ArrVal_328_fresh_1) |main_~#string_B~0.base_4|) 0) (= v_ArrVal_328_fresh_1 1) (= main_~i~0_4 0) (= v_ArrVal_327_fresh_1 5) (= (store (store |#valid_3| |main_~#string_A~0.base_4| v_ArrVal_328_fresh_1) |main_~#string_B~0.base_4| v_ArrVal_325_fresh_1) |#valid_4|) (= (select |#valid_3| |main_~#string_A~0.base_4|) 0) (= |main_~#string_A~0.offset_4| 0) (not (= |main_~#string_B~0.base_4| 0)) (= |main_~#string_B~0.offset_4| 0) (= v_ArrVal_325_fresh_1 1) (= v_main_~found~0_22_fresh_1 0) (not (= |main_~#string_A~0.base_4| 0)) (< |#StackHeapBarrier_-1| |main_~#string_B~0.base_4|) (= |#length_4| (store (store |#length_3| |main_~#string_A~0.base_4| v_ArrVal_327_fresh_1) |main_~#string_B~0.base_4| v_ArrVal_326_fresh_1))) :named ssa_4))
(assert (! (and (<= 0 (+ |v_main_#t~nondet1_70_fresh_1| 128)) (= (store |#memory_int#2_3| |main_~#string_A~0.base_4| v_ArrVal_330_fresh_1) |#memory_int#2_5|) (= main_~i~0_5 (+ main_~i~0_4 1)) (= v_ArrVal_330_fresh_1 (store (select |#memory_int#2_3| |main_~#string_A~0.base_4|) (+ main_~i~0_4 |main_~#string_A~0.offset_4|) v_ArrVal_329_fresh_1)) (<= |v_main_#t~nondet1_70_fresh_1| 127) (< main_~i~0_4 5) (= v_ArrVal_329_fresh_1 |v_main_#t~nondet1_70_fresh_1|)) :named ssa_5))
(assert (! (and (<= |v_main_#t~nondet1_71_fresh_1| 127) (= |#memory_int#2_6| (store |#memory_int#2_5| |main_~#string_A~0.base_4| v_ArrVal_332_fresh_1)) (= v_ArrVal_332_fresh_1 (store (select |#memory_int#2_5| |main_~#string_A~0.base_4|) (+ main_~i~0_5 |main_~#string_A~0.offset_4|) v_ArrVal_331_fresh_1)) (<= 0 (+ |v_main_#t~nondet1_71_fresh_1| 128)) (= main_~i~0_6 (+ main_~i~0_5 1)) (= v_ArrVal_331_fresh_1 |v_main_#t~nondet1_71_fresh_1|) (< main_~i~0_5 5)) :named ssa_6))
(assert (! (and (<= 0 (+ |v_main_#t~nondet1_72_fresh_1| 128)) (= v_ArrVal_334_fresh_1 |v_main_#t~nondet1_72_fresh_1|) (<= |v_main_#t~nondet1_72_fresh_1| 127) (= main_~i~0_7 (+ main_~i~0_6 1)) (= (store |#memory_int#2_6| |main_~#string_A~0.base_4| v_ArrVal_333_fresh_1) |#memory_int#2_7|) (< main_~i~0_6 5) (= v_ArrVal_333_fresh_1 (store (select |#memory_int#2_6| |main_~#string_A~0.base_4|) (+ main_~i~0_6 |main_~#string_A~0.offset_4|) |v_main_#t~nondet1_72_fresh_1|))) :named ssa_7))
(assert (! (and (= v_ArrVal_335_fresh_1 |v_main_#t~nondet1_73_fresh_1|) (= (store |#memory_int#2_7| |main_~#string_A~0.base_4| v_ArrVal_336_fresh_1) |#memory_int#2_8|) (<= 0 (+ |v_main_#t~nondet1_73_fresh_1| 128)) (<= |v_main_#t~nondet1_73_fresh_1| 127) (= main_~i~0_8 (+ main_~i~0_7 1)) (< main_~i~0_7 5) (= (store (select |#memory_int#2_7| |main_~#string_A~0.base_4|) (+ main_~i~0_7 |main_~#string_A~0.offset_4|) v_ArrVal_335_fresh_1) v_ArrVal_336_fresh_1)) :named ssa_8))
(assert (! (and (<= |v_main_#t~nondet1_74_fresh_1| 127) (= main_~i~0_9 (+ main_~i~0_8 1)) (= v_ArrVal_337_fresh_1 (store (select |#memory_int#2_8| |main_~#string_A~0.base_4|) (+ main_~i~0_8 |main_~#string_A~0.offset_4|) |v_main_#t~nondet1_74_fresh_1|)) (= |#memory_int#2_9| (store |#memory_int#2_8| |main_~#string_A~0.base_4| v_ArrVal_337_fresh_1)) (<= 0 (+ |v_main_#t~nondet1_74_fresh_1| 128)) (= v_ArrVal_338_fresh_1 |v_main_#t~nondet1_74_fresh_1|) (< main_~i~0_8 5)) :named ssa_9))
...
(assert (! (and (<= |v_main_#t~nondet4_70_fresh_1| 127) (= v_ArrVal_339_fresh_1 |v_main_#t~nondet4_70_fresh_1|) (= main_~i~0_13 (+ main_~i~0_12 1)) (= v_ArrVal_340_fresh_1 (store (select |#memory_int#1_3| |main_~#string_B~0.base_4|) (+ main_~i~0_12 |main_~#string_B~0.offset_4|) v_ArrVal_339_fresh_1)) (= (store |#memory_int#1_3| |main_~#string_B~0.base_4| v_ArrVal_340_fresh_1) |#memory_int#1_13|) (<= 0 (+ |v_main_#t~nondet4_70_fresh_1| 128)) (< main_~i~0_12 5)) :named ssa_13))
(assert (! (and (= (store |#memory_int#1_13| |main_~#string_B~0.base_4| v_ArrVal_341_fresh_1) |#memory_int#1_14|) (= v_ArrVal_342_fresh_1 |v_main_#t~nondet4_71_fresh_1|) (= main_~i~0_14 (+ main_~i~0_13 1)) (= v_ArrVal_341_fresh_1 (store (select |#memory_int#1_13| |main_~#string_B~0.base_4|) (+ main_~i~0_13 |main_~#string_B~0.offset_4|) |v_main_#t~nondet4_71_fresh_1|)) (<= 0 (+ |v_main_#t~nondet4_71_fresh_1| 128)) (< main_~i~0_13 5) (<= |v_main_#t~nondet4_71_fresh_1| 127)) :named ssa_14))
(assert (! (and (= (store |#memory_int#1_14| |main_~#string_B~0.base_4| v_ArrVal_343_fresh_1) |#memory_int#1_15|) (= v_ArrVal_344_fresh_1 |v_main_#t~nondet4_72_fresh_1|) (= main_~i~0_15 (+ main_~i~0_14 1)) (<= 0 (+ |v_main_#t~nondet4_72_fresh_1| 128)) (<= |v_main_#t~nondet4_72_fresh_1| 127) (< main_~i~0_14 5) (= v_ArrVal_343_fresh_1 (store (select |#memory_int#1_14| |main_~#string_B~0.base_4|) (+ main_~i~0_14 |main_~#string_B~0.offset_4|) |v_main_#t~nondet4_72_fresh_1|))) :named ssa_15))
(assert (! (and (= |#memory_int#1_16| (store |#memory_int#1_15| |main_~#string_B~0.base_4| v_ArrVal_345_fresh_1)) (= v_ArrVal_346_fresh_1 |v_main_#t~nondet4_73_fresh_1|) (= main_~i~0_16 (+ main_~i~0_15 1)) (<= |v_main_#t~nondet4_73_fresh_1| 127) (= v_ArrVal_345_fresh_1 (store (select |#memory_int#1_15| |main_~#string_B~0.base_4|) (+ main_~i~0_15 |main_~#string_B~0.offset_4|) |v_main_#t~nondet4_73_fresh_1|)) (< main_~i~0_15 5) (<= 0 (+ |v_main_#t~nondet4_73_fresh_1| 128))) :named ssa_16))
(assert (! (and (= (store (select |#memory_int#1_16| |main_~#string_B~0.base_4|) (+ main_~i~0_16 |main_~#string_B~0.offset_4|) |v_main_#t~nondet4_74_fresh_1|) v_ArrVal_347_fresh_1) (= main_~i~0_17 (+ main_~i~0_16 1)) (<= 0 (+ |v_main_#t~nondet4_74_fresh_1| 128)) (= (store |#memory_int#1_16| |main_~#string_B~0.base_4| v_ArrVal_347_fresh_1) |#memory_int#1_17|) (= v_ArrVal_348_fresh_1 |v_main_#t~nondet4_74_fresh_1|) (<= |v_main_#t~nondet4_74_fresh_1| 127) (< main_~i~0_16 5)) :named ssa_17))
...
(assert (! (and (not (= |main_#t~mem7_21| 0)) (= (+ |v_main_#t~post8_16_fresh_1| 1) main_~nc_A~0_22) (= |v_main_#t~post8_16_fresh_1| main_~nc_A~0_20)) :named ssa_22))
...
(assert (! (and (= (+ |v_main_#t~post8_17_fresh_1| 1) main_~nc_A~0_24) (not (= |main_#t~mem7_23| 0)) (= |v_main_#t~post8_17_fresh_1| main_~nc_A~0_22)) :named ssa_24))
...
(assert (! (and (= |v_main_#t~post10_19_fresh_1| main_~nc_B~0_27) (not (= |main_#t~mem9_28| 0)) (= main_~nc_B~0_29 (+ |v_main_#t~post10_19_fresh_1| 1))) :named ssa_29))
...
(assert (! (and (= (+ |v_main_#t~post10_20_fresh_1| 1) main_~nc_B~0_31) (= |v_main_#t~post10_20_fresh_1| main_~nc_B~0_29) (not (= |main_#t~mem9_30| 0))) :named ssa_31))
...
(assert (! (and (= main_~j~0_36 0) (not (= |main_#t~mem12_35| |main_#t~mem11_35|)) (= (+ main_~i~0_36 main_~j~0_34) (+ main_~i~0_34 1))) :named ssa_36))
...
(assert (! (and (= (select (select |#memory_int#2_9| |main_~#string_A~0.base_4|) (+ |main_~#string_A~0.offset_4| main_~i~0_38)) |main_#t~mem11_39|) (< main_~i~0_38 main_~nc_A~0_24) (< main_~j~0_38 main_~nc_B~0_31) (= (select (select |#memory_int#1_17| |main_~#string_B~0.base_4|) (+ |main_~#string_B~0.offset_4| main_~j~0_38)) |main_#t~mem12_39|)) :named ssa_39))
(assert (! (and (= main_~j~0_40 (+ main_~j~0_38 1)) (= |main_#t~mem12_39| |main_#t~mem11_39|) (= main_~i~0_40 (+ main_~i~0_38 1))) :named ssa_40))
(assert (! (and (= (select (select |#memory_int#2_9| |main_~#string_A~0.base_4|) (+ |main_~#string_A~0.offset_4| main_~i~0_40)) |main_#t~mem11_41|) (< main_~i~0_40 main_~nc_A~0_24) (< main_~j~0_40 main_~nc_B~0_31) (= (select (select |#memory_int#1_17| |main_~#string_B~0.base_4|) (+ |main_~#string_B~0.offset_4| main_~j~0_40)) |main_#t~mem12_41|)) :named ssa_41))
(assert (! (and (= main_~j~0_42 (+ main_~j~0_40 1)) (= |main_#t~mem12_41| |main_#t~mem11_41|) (= main_~i~0_42 (+ main_~i~0_40 1))) :named ssa_42))
(assert (! (or (<= main_~nc_B~0_31 main_~j~0_42) (<= main_~nc_A~0_24 main_~i~0_42)) :named ssa_43))
(assert (! (= main_~found~0_44 (ite (< main_~nc_B~0_31 (+ main_~j~0_42 1)) 1 0)) :named ssa_44))
