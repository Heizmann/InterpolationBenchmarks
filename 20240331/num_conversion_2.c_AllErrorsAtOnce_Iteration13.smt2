...
(set-info :ultimate-id num_conversion_2.c_AllErrorsAtOnce_Iteration13)
...
(assert (! (= (mod main_~bit~0_10 256) 0) :named ssa_11))
...
(assert (! (= |__VERIFIER_assert_#in~cond_63| (ite (= (mod main_~x~0_4 256) (mod main_~y~0_4 256)) 1 0)) :named ssa_63_LocVarAssigCall))
