...
(set-info :ultimate-id underapprox_1-2.c_AllErrorsAtOnce_Iteration2)
...
(assert (! (<= 6 (mod main_~x~0_4 4294967296)) :named ssa_5))
(assert (! true :named ssa_6_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_6| (mod (mod main_~y~0_4 4294967296) 3)) :named ssa_6_LocVarAssigCall))
