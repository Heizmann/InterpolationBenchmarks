...
(set-info :ultimate-id gj2007.c.i.p+nlh-reducer.c_AllErrorsAtOnce_Iteration4)
...
(assert (! (and (= (+ main_~main__y~0_4 1) main_~main__y~0_14) (= main_~main__x~0_14 (+ main_~main__x~0_12 1)) (<= 50 main_~main__x~0_12)) :named ssa_14))
...
(assert (! (and (= v_main_~__tmp_1~0_7_fresh_1 main_~__VERIFIER_assert__cond~0_139) (= v_main_~__tmp_1~0_7_fresh_1 (ite (= main_~main__y~0_138 100) 1 0)) (<= 100 main_~main__x~0_138)) :named ssa_139))
