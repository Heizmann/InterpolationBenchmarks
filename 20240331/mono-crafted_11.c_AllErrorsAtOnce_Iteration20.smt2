...
(set-info :ultimate-id mono-crafted_11.c_AllErrorsAtOnce_Iteration20)
...
(assert (! (<= 100000000 (mod main_~x~0_40 4294967296)) :named ssa_41))
(assert (! true :named ssa_42_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_42| (ite (= (mod main_~x~0_40 2) 0) 1 0)) :named ssa_42_LocVarAssigCall))
