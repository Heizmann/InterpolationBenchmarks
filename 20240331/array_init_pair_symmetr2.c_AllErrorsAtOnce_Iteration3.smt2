...
(set-info :ultimate-id array_init_pair_symmetr2.c_AllErrorsAtOnce_Iteration3)
...
(declare-fun |main_#t~post9_41| () Int)
...
(declare-fun |main_#t~post9_42| () Int)
...
(assert (! (and (= (store (select |#memory_int#2_3| |main_~#a~0.base_4|) (+ (* main_~i~0_4 4) |main_~#a~0.offset_4|) main_~x~0_5) v_ArrVal_25_fresh_1) (= main_~i~0_21 (+ main_~i~0_4 1)) (= |#memory_int#2_21| (store |#memory_int#2_3| |main_~#a~0.base_4| v_ArrVal_25_fresh_1)) (= main_~x~0_5 v_ArrVal_28_fresh_1) (= (store |#memory_int#1_3| |main_~#b~0.base_4| v_ArrVal_27_fresh_1) |#memory_int#1_21|) (= (store (select |#memory_int#1_3| |main_~#b~0.base_4|) (+ |main_~#b~0.offset_4| (* main_~i~0_4 4)) v_ArrVal_26_fresh_1) v_ArrVal_27_fresh_1) (= main_~y~0_5 v_ArrVal_26_fresh_1)) :named ssa_21))
...
(assert (! (and (= (store (select |#memory_int#2_21| |main_~#a~0.base_4|) (+ (* main_~i~0_21 4) |main_~#a~0.offset_4|) main_~x~0_22) v_ArrVal_29_fresh_1) (= main_~x~0_22 v_ArrVal_32_fresh_1) (= |#memory_int#2_38| (store |#memory_int#2_21| |main_~#a~0.base_4| v_ArrVal_29_fresh_1)) (= main_~i~0_38 (+ main_~i~0_21 1)) (= main_~y~0_22 v_ArrVal_30_fresh_1) (= v_ArrVal_31_fresh_1 (store (select |#memory_int#1_21| |main_~#b~0.base_4|) (+ |main_~#b~0.offset_4| (* main_~i~0_21 4)) v_ArrVal_30_fresh_1)) (= |#memory_int#1_38| (store |#memory_int#1_21| |main_~#b~0.base_4| v_ArrVal_31_fresh_1))) :named ssa_38))
(assert (! (<= ~N~0_1 main_~i~0_38) :named ssa_39))
(assert (! (= main_~i~0_40 0) :named ssa_40))
(assert (! (and (= (store (select |#memory_int#3_3| |main_~#c~0.base_4|) (+ (* main_~i~0_40 4) |main_~#c~0.offset_4|) v_ArrVal_33_fresh_1) v_ArrVal_34_fresh_1) (= main_~i~0_41 (+ main_~i~0_40 1)) (= |#memory_int#3_41| (store |#memory_int#3_3| |main_~#c~0.base_4| v_ArrVal_34_fresh_1)) (< main_~i~0_40 ~N~0_1) (= (select (select |#memory_int#2_38| |main_~#a~0.base_4|) (+ (* main_~i~0_40 4) |main_~#a~0.offset_4|)) (+ v_ArrVal_33_fresh_1 (select (select |#memory_int#1_38| |main_~#b~0.base_4|) (+ (* main_~i~0_40 4) |main_~#b~0.offset_4|))))) :named ssa_41))
(assert (! (and (= (store |#memory_int#3_41| |main_~#c~0.base_4| v_ArrVal_36_fresh_1) |#memory_int#3_42|) (= main_~i~0_42 (+ main_~i~0_41 1)) (= (store (select |#memory_int#3_41| |main_~#c~0.base_4|) (+ (* main_~i~0_41 4) |main_~#c~0.offset_4|) v_ArrVal_35_fresh_1) v_ArrVal_36_fresh_1) (= (+ v_ArrVal_35_fresh_1 (select (select |#memory_int#1_38| |main_~#b~0.base_4|) (+ (* main_~i~0_41 4) |main_~#b~0.offset_4|))) (select (select |#memory_int#2_38| |main_~#a~0.base_4|) (+ (* main_~i~0_41 4) |main_~#a~0.offset_4|))) (< main_~i~0_41 ~N~0_1)) :named ssa_42))
(assert (! (<= ~N~0_1 main_~i~0_42) :named ssa_43))
(assert (! (= main_~i~0_44 1) :named ssa_44))
(assert (! (and (< main_~i~0_44 ~N~0_1) (= |main_#t~mem10_45| (select (select |#memory_int#3_42| |main_~#c~0.base_4|) (+ (* main_~i~0_44 4) |main_~#c~0.offset_4|)))) :named ssa_45))
(assert (! true :named ssa_46_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_46| (ite (< 0 |main_#t~mem10_45|) 1 0)) :named ssa_46_LocVarAssigCall))
