...
(set-info :ultimate-id gj2007.c.i.p+nlh-reducer.c_AllErrorsAtOnce_Iteration14)
...
(declare-fun v_main_~__tmp_1~0_17_fresh_1 () Int)
...
(assert (! (and (= main_~main__x~0_56 (+ main_~main__x~0_54 1)) (<= 50 main_~main__x~0_54) (= (+ main_~main__y~0_4 1) main_~main__y~0_56)) :named ssa_56))
...
(assert (! (and (= v_main_~__tmp_1~0_17_fresh_1 (ite (= main_~main__y~0_138 100) 1 0)) (<= 100 main_~main__x~0_138) (= v_main_~__tmp_1~0_17_fresh_1 main_~__VERIFIER_assert__cond~0_139)) :named ssa_139))
