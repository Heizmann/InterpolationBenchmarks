...
(set-info :ultimate-id prefixsum_iter.c_AllErrorsAtOnce_Iteration3)
...
(assert (! (and (not (= |main_#t~malloc15.base_21| 0)) (< |main_#t~malloc15.base_21| |#StackHeapBarrier_-1|) (= |main_#t~malloc15.offset_21| 0) (= (store |#length_3| |main_#t~malloc15.base_21| v_ArrVal_26_fresh_1) |#length_21|) (= v_ArrVal_25_fresh_1 1) (= v_ArrVal_26_fresh_1 (* (mod main_~n~0_4 1073741824) 4)) (= (select |#valid_3| |main_#t~malloc15.base_21|) 0) (= |#valid_21| (store |#valid_3| |main_#t~malloc15.base_21| v_ArrVal_25_fresh_1))) :named ssa_21))
(assert (! (= |old(#memory_int#1)_22| |#memory_int#1_22|) :named ssa_22_GlobVarAssigCall))
(assert (! (and (= |#Ultimate.meminit_#ptr.base_22| |main_#t~malloc15.base_21|) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_9_fresh_1| 4) (= |v_#Ultimate.meminit_#ptr.offsetInParam_9_fresh_1| |main_#t~malloc15.offset_21|) (= |v_#Ultimate.meminit_#productInParam_9_fresh_1| (* main_~n~0_4 4)) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_9_fresh_1|)) :named ssa_22_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_22| |#memory_int#1_3|) :named ssa_22_OldVarAssigCall))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_27_fresh_1) (= (store |#memory_int#1_22| |#Ultimate.meminit_#ptr.base_22| v_ArrVal_27_fresh_1) |#memory_int#1_23|)) :named ssa_23))
(assert (! true :named ssa_24_return))
(assert (! (and (= (select |#valid_21| |main_#t~malloc16.base_25|) 0) (= (* (mod main_~n~0_4 1073741824) 4) v_ArrVal_29_fresh_1) (not (= |main_#t~malloc16.base_25| 0)) (= v_ArrVal_28_fresh_1 1) (= |#valid_25| (store |#valid_21| |main_#t~malloc16.base_25| v_ArrVal_28_fresh_1)) (= |#length_25| (store |#length_21| |main_#t~malloc16.base_25| v_ArrVal_29_fresh_1)) (= |main_#t~malloc16.offset_25| 0) (= main_~a~0.offset_25 |main_#t~malloc15.offset_21|) (= main_~a~0.base_25 |main_#t~malloc15.base_21|) (< |main_#t~malloc16.base_25| |#StackHeapBarrier_-1|)) :named ssa_25))
(assert (! (= |old(#memory_int#1)_26| |#memory_int#1_26|) :named ssa_26_GlobVarAssigCall))
(assert (! (and (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_10_fresh_1| 4) (= (* main_~n~0_4 4) |v_#Ultimate.meminit_#productInParam_10_fresh_1|) (= |v_#Ultimate.meminit_#ptr.offsetInParam_10_fresh_1| |main_#t~malloc16.offset_25|) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_10_fresh_1|) (= |#Ultimate.meminit_#ptr.base_26| |main_#t~malloc16.base_25|)) :named ssa_26_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_26| |#memory_int#1_23|) :named ssa_26_OldVarAssigCall))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_30_fresh_1) (= (store |#memory_int#1_26| |#Ultimate.meminit_#ptr.base_26| v_ArrVal_30_fresh_1) |#memory_int#1_27|)) :named ssa_27))
...
(assert (! (and (< main_~i~1_29 main_~n~0_4) (= (select (select |#memory_int#1_27| main_~a~0.base_25) (+ main_~a~0.offset_25 (* main_~i~1_29 4))) v_ArrVal_31_fresh_1) (= |#memory_int#1_30| (store |#memory_int#1_27| main_~a0~0.base_29 v_ArrVal_32_fresh_1)) (= (store (select |#memory_int#1_27| main_~a0~0.base_29) (+ main_~a0~0.offset_29 (* main_~i~1_29 4)) v_ArrVal_31_fresh_1) v_ArrVal_32_fresh_1) (= main_~i~1_30 (+ main_~i~1_29 1))) :named ssa_30))
...
(assert (! (and (= (store (select |#memory_int#1_38| downsweep_~a.base_39) (+ downsweep_~a.offset_39 (- 4) (* downsweep_~n_39 4)) v_ArrVal_33_fresh_1) v_ArrVal_34_fresh_1) (= downsweep_~space_39 (ite (and (not (= (mod |downsweep_#in~space_38| 2) 0)) (< |downsweep_#in~space_38| 0)) (+ (div |downsweep_#in~space_38| 2) 1) (div |downsweep_#in~space_38| 2))) (= downsweep_~a.base_39 |downsweep_#in~a.base_38|) (= downsweep_~a.offset_39 |downsweep_#in~a.offset_38|) (= v_ArrVal_33_fresh_1 0) (= (store |#memory_int#1_38| downsweep_~a.base_39 v_ArrVal_34_fresh_1) |#memory_int#1_39|) (= downsweep_~n_39 |downsweep_#in~n_38|)) :named ssa_39))
...
(assert (! (not (and (= (select |#valid_-2| |main_#t~malloc15.base_-2|) 1) (= ((as const (Array Int Int)) 0) (select |#memory_int#1_0| |main_#t~malloc15.base_-2|)))) :named ssa_postcond))
(assert (! (and (= (store |#memory_int#1_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_35_fresh_1) |#memory_int#1_0|) (= ((as const (Array Int Int)) 0) v_ArrVal_35_fresh_1)) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! (= (select |#valid_-2| |main_#t~malloc15.base_-2|) 1) :named ssa_-2_PendingContext))
...
(assert (! (= |#memory_int#1_-1| |old(#memory_int#1)_-1|) :named ssa_precond))
(assert (! (not (and (= ((as const (Array Int Int)) 0) (select |#memory_int#1_0| main_~a~0.base_-2)) (not (= |main_#t~malloc16.base_-2| main_~a~0.base_-2)))) :named ssa_postcond))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_36_fresh_1) (= |#memory_int#1_0| (store |#memory_int#1_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_36_fresh_1))) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! (and (= ((as const (Array Int Int)) 0) (select |#memory_int#1_-2| main_~a~0.base_-2)) (not (= |main_#t~malloc16.base_-2| main_~a~0.base_-2))) :named ssa_-2_PendingContext))
...
(assert (! (= |#memory_int#1_-1| |old(#memory_int#1)_-1|) :named ssa_precond))
(assert (! (not (and (= ((as const (Array Int Int)) 0) (select |#memory_int#1_-1| main_~a~0.base_-2)) (not (= main_~a~0.base_-2 main_~a0~0.base_-2)))) :named ssa_postcond))
...
(assert (! (and (= ((as const (Array Int Int)) 0) (select |#memory_int#1_-2| main_~a~0.base_-2)) (not (= main_~a~0.base_-2 main_~a0~0.base_-2))) :named ssa_-2_PendingContext))
...
(assert (! (= |#memory_int#1_-1| |old(#memory_int#1)_-1|) :named ssa_precond))
(assert (! (not (and (= ((as const (Array Int Int)) 0) (select |#memory_int#1_0| main_~a~0.base_-2)) (not (= main_~a~0.base_-2 main_~a0~0.base_-2)))) :named ssa_postcond))
(assert (! (and (= downsweep_~space_0 (ite (and (not (= (mod |downsweep_#in~space_-1| 2) 0)) (< |downsweep_#in~space_-1| 0)) (+ (div |downsweep_#in~space_-1| 2) 1) (div |downsweep_#in~space_-1| 2))) (= (store (select |#memory_int#1_-1| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (- 4) (* downsweep_~n_0 4)) v_ArrVal_37_fresh_1) v_ArrVal_38_fresh_1) (= (store |#memory_int#1_-1| downsweep_~a.base_0 v_ArrVal_38_fresh_1) |#memory_int#1_0|) (= downsweep_~a.base_0 |downsweep_#in~a.base_-1|) (= downsweep_~a.offset_0 |downsweep_#in~a.offset_-1|) (= v_ArrVal_37_fresh_1 0) (= downsweep_~n_0 |downsweep_#in~n_-1|)) :named ssa_0))
