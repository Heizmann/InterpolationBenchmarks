...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:11:16+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id mono-crafted_3.c_AllErrorsAtOnce_Iteration42)
...
(declare-fun |v_main_#t~post4_79_fresh_1| () Int)
(declare-fun main_~x~0_8 () Int)
(declare-fun |v_main_#t~post4_80_fresh_1| () Int)
...
(assert (! (and (= main_~x~0_6 (+ |v_main_#t~post4_79_fresh_1| 1)) (< main_~x~0_4 500000) (= main_~x~0_4 |v_main_#t~post4_79_fresh_1|)) :named ssa_6))
(assert (! (< main_~x~0_6 1000000) :named ssa_7))
(assert (! (and (< main_~x~0_6 500000) (= main_~x~0_6 |v_main_#t~post4_80_fresh_1|) (= main_~x~0_8 (+ |v_main_#t~post4_80_fresh_1| 1))) :named ssa_8))
...
(assert (! (<= main_~y~0_47 0) :named ssa_48))
(assert (! true :named ssa_49_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_49| (ite (= main_~x~0_47 main_~z~0_47) 1 0)) :named ssa_49_LocVarAssigCall))
