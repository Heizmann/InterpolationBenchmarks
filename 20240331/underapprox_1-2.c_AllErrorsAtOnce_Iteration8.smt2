...
(set-info :ultimate-id underapprox_1-2.c_AllErrorsAtOnce_Iteration8)
...
(assert (! (<= 6 (mod main_~x~0_10 4294967296)) :named ssa_11))
(assert (! true :named ssa_12_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_12| (mod (mod main_~y~0_10 4294967296) 3)) :named ssa_12_LocVarAssigCall))
