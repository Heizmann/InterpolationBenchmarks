...
(set-info :ultimate-id brs2.c_AllErrorsAtOnce_Iteration6)
...
(assert (! (and (= (select |#valid_3| |main_~#sum~0.base_11|) 0) (= 8 v_ArrVal_42_fresh_1) (< |#StackHeapBarrier_-1| |main_~#sum~0.base_11|) (= (* (mod ~N~0_4 1073741824) 4) v_ArrVal_39_fresh_1) (= v_ArrVal_40_fresh_1 1) (< main_~a~0.base_11 |#StackHeapBarrier_-1|) (= |main_~#sum~0.offset_11| 0) (= v_ArrVal_41_fresh_1 1) (= |#valid_11| (store (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_40_fresh_1) main_~a~0.base_11 v_ArrVal_41_fresh_1)) (not (= |main_~#sum~0.base_11| 0)) (= (select (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_40_fresh_1) main_~a~0.base_11) 0) (= (store (store |#length_3| |main_~#sum~0.base_11| v_ArrVal_42_fresh_1) main_~a~0.base_11 v_ArrVal_39_fresh_1) |#length_11|) (= main_~a~0.offset_11 0) (not (= main_~a~0.base_11 0)) (= main_~i~0_11 0)) :named ssa_11))
(assert (! (< main_~i~0_11 ~N~0_4) :named ssa_12))
(assert (! (and (= 2 v_ArrVal_43_fresh_1) (= (store |#memory_int#3_3| main_~a~0.base_11 v_ArrVal_44_fresh_1) |#memory_int#3_13|) (= (store (select |#memory_int#3_3| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_11 4)) v_ArrVal_43_fresh_1) v_ArrVal_44_fresh_1) (= (ite (and (< main_~i~0_11 0) (not (= (mod main_~i~0_11 2) 0))) (+ (mod main_~i~0_11 2) (- 2)) (mod main_~i~0_11 2)) 0)) :named ssa_13))
(assert (! (= main_~i~0_14 (+ main_~i~0_11 1)) :named ssa_14))
(assert (! (< main_~i~0_14 ~N~0_4) :named ssa_15))
(assert (! (and (= v_ArrVal_46_fresh_1 0) (not (= (ite (and (not (= (mod main_~i~0_14 2) 0)) (< main_~i~0_14 0)) (+ (- 2) (mod main_~i~0_14 2)) (mod main_~i~0_14 2)) 0)) (= (store |#memory_int#3_13| main_~a~0.base_11 v_ArrVal_45_fresh_1) |#memory_int#3_16|) (= v_ArrVal_45_fresh_1 (store (select |#memory_int#3_13| main_~a~0.base_11) (+ (* main_~i~0_14 4) main_~a~0.offset_11) 0))) :named ssa_16))
...
(assert (! (and (= main_~i~0_19 0) (= (store |#memory_int#1_3| |main_~#sum~0.base_11| v_ArrVal_48_fresh_1) |#memory_int#1_21|) (= v_ArrVal_48_fresh_1 (store (select |#memory_int#1_3| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| v_ArrVal_47_fresh_1)) (= v_ArrVal_47_fresh_1 0)) :named ssa_21))
(assert (! (= main_~i~0_22 (+ main_~i~0_19 1)) :named ssa_22))
(assert (! (< main_~i~0_22 ~N~0_4) :named ssa_23))
(assert (! (and (= (store (select |#memory_int#1_21| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| v_ArrVal_49_fresh_1) v_ArrVal_50_fresh_1) (= (+ (select (select |#memory_int#1_21| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|) (select (select |#memory_int#3_16| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_22 4)))) v_ArrVal_49_fresh_1) (= |#memory_int#1_24| (store |#memory_int#1_21| |main_~#sum~0.base_11| v_ArrVal_50_fresh_1)) (not (= main_~i~0_22 0))) :named ssa_24))
