...
(set-info :ultimate-id underapprox_1-2.c_AllErrorsAtOnce_Iteration6)
...
(assert (! (<= 6 (mod main_~x~0_8 4294967296)) :named ssa_9))
(assert (! true :named ssa_10_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_10| (mod (mod main_~y~0_8 4294967296) 3)) :named ssa_10_LocVarAssigCall))
