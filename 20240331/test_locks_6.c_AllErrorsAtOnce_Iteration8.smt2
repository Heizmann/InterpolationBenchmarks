...
(set-info :ultimate-id test_locks_6.c_AllErrorsAtOnce_Iteration8)
...
(declare-fun main_~lk4~0_17 () Int)
...
(assert (! (not (= main_~p4~0_4 0)) :named ssa_16))
(assert (! (not (= main_~lk4~0_10 1)) :named ssa_17))
