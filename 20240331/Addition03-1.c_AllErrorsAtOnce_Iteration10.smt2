...
(set-info :ultimate-id Addition03-1.c_AllErrorsAtOnce_Iteration10)
...
(declare-fun |main_#t~ret8_65| () Int)
(declare-fun |addition_#res_65| () Int)
(declare-fun main_~result~0_66 () Int)
(declare-fun |main_#t~ret8_66| () Int)
(declare-fun main_~result~0_67 () Int)
(declare-fun main_~m~0_67 () Int)
(declare-fun main_~n~0_67 () Int)
...
(assert (! (and (= 0 addition_~n_38) (= |addition_#res_39| addition_~m_38)) :named ssa_39))
...
(assert (! (= |addition_#res_63| |main_#t~ret8_65|) :named ssa_65_return))
(assert (! (and (<= |main_#t~ret8_65| 9223372036854775807) (<= 0 (+ |main_#t~ret8_65| 9223372036854775808)) (= main_~result~0_66 |main_#t~ret8_65|)) :named ssa_66))
(assert (! (and (< main_~result~0_66 200) (<= 100 main_~n~0_4) (<= 100 main_~m~0_4)) :named ssa_67))
(assert (! true :named ssa_68))
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 (and ssa_27 ssa_29_OldVarAssigCall ssa_20 ssa_17_LocVarAssigCall ssa_21_LocVarAssigCall ssa_64 ssa_5_LocVarAssigCall ssa_31 ssa_60 ssa_5_GlobVarAssigCall ssa_21_OldVarAssigCall ssa_7 ssa_16 ssa_57 ssa_6 ssa_26 ssa_55 ssa_34 ssa_17_GlobVarAssigCall ssa_47_return ssa_25_GlobVarAssigCall ssa_40 ssa_10 ssa_14 ssa_25_OldVarAssigCall ssa_8 ssa_13_LocVarAssigCall ssa_45 ssa_29_GlobVarAssigCall ssa_46 ssa_59_return ssa_50_return ssa_13_OldVarAssigCall ssa_25_LocVarAssigCall ssa_37_LocVarAssigCall ssa_58 ssa_33_GlobVarAssigCall ssa_19 ssa_53_return ssa_61 ssa_33_LocVarAssigCall ssa_39 ssa_43 ssa_13_GlobVarAssigCall ssa_17_OldVarAssigCall ssa_38 ssa_12 ssa_56_return ssa_41_return ssa_32 ssa_5_OldVarAssigCall ssa_11 ssa_48 ssa_28 ssa_29_LocVarAssigCall ssa_54 ssa_65_return ssa_37_GlobVarAssigCall ssa_22 ssa_51 ssa_36 ssa_15 ssa_49 ssa_63 ssa_52 ssa_18 ssa_23 ssa_30 ssa_9_LocVarAssigCall ssa_9_OldVarAssigCall ssa_35 ssa_21_GlobVarAssigCall ssa_9_GlobVarAssigCall ssa_33_OldVarAssigCall ssa_62_return ssa_44_return ssa_42 ssa_24 ssa_37_OldVarAssigCall) ssa_66 ssa_67 (and ssa_68 ssa_postcond))
...
(declare-fun |addition_#res_59| () Int)
(assert (! true :named ssa_precond))
(assert (! (not (<= main_~n~0_-2 8)) :named ssa_postcond))
...
(assert (! (and (<= 0 (+ 9223372036854775808 |addition_#t~ret4_56|)) (<= |addition_#t~ret4_56| 9223372036854775807) (= |addition_#res_57| |addition_#t~ret4_56|)) :named ssa_57))
(assert (! true :named ssa_58))
(assert (! (= |addition_#res_57| |main_#t~ret8_59|) :named ssa_59_return))
(assert (! true :named ssa_-2_PendingContext))
