...
(set-info :ultimate-id test_locks_7.c_AllErrorsAtOnce_Iteration19)
...
(declare-fun main_~lk7~0_21 () Int)
...
(assert (! (= main_~p6~0_4 0) :named ssa_12))
(assert (! (= main_~p7~0_4 0) :named ssa_13))
(assert (! (= main_~p1~0_4 0) :named ssa_14))
(assert (! (= main_~p2~0_4 0) :named ssa_15))
(assert (! (= main_~p3~0_4 0) :named ssa_16))
(assert (! (= main_~p4~0_4 0) :named ssa_17))
(assert (! (= main_~p5~0_4 0) :named ssa_18))
(assert (! (= main_~p6~0_4 0) :named ssa_19))
(assert (! (not (= main_~p7~0_4 0)) :named ssa_20))
(assert (! (not (= main_~lk7~0_6 1)) :named ssa_21))
