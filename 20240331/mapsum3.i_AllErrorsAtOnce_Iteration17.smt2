...
(set-info :ultimate-id mapsum3.i_AllErrorsAtOnce_Iteration17)
...
(assert (! (and (= (store |#valid_3| |main_~#x~0.base_4| v_ArrVal_277_fresh_1) |#valid_4|) (< |#StackHeapBarrier_-1| |main_~#x~0.base_4|) (= v_ArrVal_278_fresh_1 40000) (not (= |main_~#x~0.base_4| 0)) (= (select |#valid_3| |main_~#x~0.base_4|) 0) (= v_ArrVal_277_fresh_1 1) (= |main_~#x~0.offset_4| 0) (= main_~i~1_4 0) (= (store |#length_3| |main_~#x~0.base_4| v_ArrVal_278_fresh_1) |#length_4|)) :named ssa_4))
(assert (! (and (< main_~i~1_4 10000) (= (store |#memory_int#1_3| |main_~#x~0.base_4| v_ArrVal_280_fresh_1) |#memory_int#1_5|) (= v_ArrVal_279_fresh_1 |v_main_#t~nondet3_71_fresh_1|) (<= |v_main_#t~nondet3_71_fresh_1| 2147483647) (<= 0 (+ |v_main_#t~nondet3_71_fresh_1| 2147483648)) (= (store (select |#memory_int#1_3| |main_~#x~0.base_4|) (+ (* main_~i~1_4 4) |main_~#x~0.offset_4|) v_ArrVal_279_fresh_1) v_ArrVal_280_fresh_1) (= main_~i~1_5 (+ main_~i~1_4 1))) :named ssa_5))
(assert (! (and (< main_~i~1_5 10000) (= v_ArrVal_282_fresh_1 (store (select |#memory_int#1_5| |main_~#x~0.base_4|) (+ (* main_~i~1_5 4) |main_~#x~0.offset_4|) v_ArrVal_281_fresh_1)) (= (store |#memory_int#1_5| |main_~#x~0.base_4| v_ArrVal_282_fresh_1) |#memory_int#1_6|) (<= |v_main_#t~nondet3_72_fresh_1| 2147483647) (<= 0 (+ |v_main_#t~nondet3_72_fresh_1| 2147483648)) (= v_ArrVal_281_fresh_1 |v_main_#t~nondet3_72_fresh_1|) (= main_~i~1_6 (+ main_~i~1_5 1))) :named ssa_6))
(assert (! (and (< main_~i~1_6 10000) (= v_ArrVal_283_fresh_1 |v_main_#t~nondet3_73_fresh_1|) (<= 0 (+ |v_main_#t~nondet3_73_fresh_1| 2147483648)) (<= |v_main_#t~nondet3_73_fresh_1| 2147483647) (= (store |#memory_int#1_6| |main_~#x~0.base_4| v_ArrVal_284_fresh_1) |#memory_int#1_7|) (= v_ArrVal_284_fresh_1 (store (select |#memory_int#1_6| |main_~#x~0.base_4|) (+ (* main_~i~1_6 4) |main_~#x~0.offset_4|) v_ArrVal_283_fresh_1)) (= main_~i~1_7 (+ main_~i~1_6 1))) :named ssa_7))
(assert (! (and (= (store (select |#memory_int#1_7| |main_~#x~0.base_4|) (+ (* main_~i~1_7 4) |main_~#x~0.offset_4|) |v_main_#t~nondet3_74_fresh_1|) v_ArrVal_285_fresh_1) (= v_ArrVal_286_fresh_1 |v_main_#t~nondet3_74_fresh_1|) (< main_~i~1_7 10000) (<= 0 (+ |v_main_#t~nondet3_74_fresh_1| 2147483648)) (<= |v_main_#t~nondet3_74_fresh_1| 2147483647) (= (store |#memory_int#1_7| |main_~#x~0.base_4| v_ArrVal_285_fresh_1) |#memory_int#1_8|) (= main_~i~1_8 (+ main_~i~1_7 1))) :named ssa_8))
(assert (! (and (<= 0 (+ |v_main_#t~nondet3_75_fresh_1| 2147483648)) (< main_~i~1_8 10000) (<= |v_main_#t~nondet3_75_fresh_1| 2147483647) (= v_ArrVal_287_fresh_1 |v_main_#t~nondet3_75_fresh_1|) (= |#memory_int#1_9| (store |#memory_int#1_8| |main_~#x~0.base_4| v_ArrVal_288_fresh_1)) (= v_ArrVal_288_fresh_1 (store (select |#memory_int#1_8| |main_~#x~0.base_4|) (+ (* main_~i~1_8 4) |main_~#x~0.offset_4|) v_ArrVal_287_fresh_1)) (= main_~i~1_9 (+ main_~i~1_8 1))) :named ssa_9))
(assert (! (and (< main_~i~1_9 10000) (= v_ArrVal_289_fresh_1 (store (select |#memory_int#1_9| |main_~#x~0.base_4|) (+ (* main_~i~1_9 4) |main_~#x~0.offset_4|) |v_main_#t~nondet3_76_fresh_1|)) (= (store |#memory_int#1_9| |main_~#x~0.base_4| v_ArrVal_289_fresh_1) |#memory_int#1_10|) (<= |v_main_#t~nondet3_76_fresh_1| 2147483647) (<= 0 (+ |v_main_#t~nondet3_76_fresh_1| 2147483648)) (= v_ArrVal_290_fresh_1 |v_main_#t~nondet3_76_fresh_1|) (= main_~i~1_10 (+ main_~i~1_9 1))) :named ssa_10))
(assert (! (and (< main_~i~1_10 10000) (= v_ArrVal_292_fresh_1 (store (select |#memory_int#1_10| |main_~#x~0.base_4|) (+ (* main_~i~1_10 4) |main_~#x~0.offset_4|) v_ArrVal_291_fresh_1)) (= (store |#memory_int#1_10| |main_~#x~0.base_4| v_ArrVal_292_fresh_1) |#memory_int#1_11|) (= v_ArrVal_291_fresh_1 |v_main_#t~nondet3_77_fresh_1|) (<= |v_main_#t~nondet3_77_fresh_1| 2147483647) (<= 0 (+ |v_main_#t~nondet3_77_fresh_1| 2147483648)) (= main_~i~1_11 (+ main_~i~1_10 1))) :named ssa_11))
(assert (! (and (< main_~i~1_11 10000) (<= 0 (+ |v_main_#t~nondet3_78_fresh_1| 2147483648)) (= (store (select |#memory_int#1_11| |main_~#x~0.base_4|) (+ (* main_~i~1_11 4) |main_~#x~0.offset_4|) v_ArrVal_293_fresh_1) v_ArrVal_294_fresh_1) (= (store |#memory_int#1_11| |main_~#x~0.base_4| v_ArrVal_294_fresh_1) |#memory_int#1_12|) (<= |v_main_#t~nondet3_78_fresh_1| 2147483647) (= v_ArrVal_293_fresh_1 |v_main_#t~nondet3_78_fresh_1|) (= main_~i~1_12 (+ main_~i~1_11 1))) :named ssa_12))
(assert (! (and (= |#memory_int#1_13| (store |#memory_int#1_12| |main_~#x~0.base_4| v_ArrVal_296_fresh_1)) (< main_~i~1_12 10000) (<= |v_main_#t~nondet3_79_fresh_1| 2147483647) (= v_ArrVal_296_fresh_1 (store (select |#memory_int#1_12| |main_~#x~0.base_4|) (+ (* main_~i~1_12 4) |main_~#x~0.offset_4|) v_ArrVal_295_fresh_1)) (= v_ArrVal_295_fresh_1 |v_main_#t~nondet3_79_fresh_1|) (<= 0 (+ |v_main_#t~nondet3_79_fresh_1| 2147483648)) (= main_~i~1_13 (+ main_~i~1_12 1))) :named ssa_13))
(assert (! (and (< main_~i~1_13 10000) (<= 0 (+ |v_main_#t~nondet3_80_fresh_1| 2147483648)) (= (store (select |#memory_int#1_13| |main_~#x~0.base_4|) (+ (* main_~i~1_13 4) |main_~#x~0.offset_4|) |v_main_#t~nondet3_80_fresh_1|) v_ArrVal_297_fresh_1) (= v_ArrVal_298_fresh_1 |v_main_#t~nondet3_80_fresh_1|) (<= |v_main_#t~nondet3_80_fresh_1| 2147483647) (= (store |#memory_int#1_13| |main_~#x~0.base_4| v_ArrVal_297_fresh_1) |#memory_int#1_14|) (= main_~i~1_14 (+ main_~i~1_13 1))) :named ssa_14))
(assert (! (and (< main_~i~1_14 10000) (= v_ArrVal_299_fresh_1 (store (select |#memory_int#1_14| |main_~#x~0.base_4|) (+ (* main_~i~1_14 4) |main_~#x~0.offset_4|) |v_main_#t~nondet3_81_fresh_1|)) (= (store |#memory_int#1_14| |main_~#x~0.base_4| v_ArrVal_299_fresh_1) |#memory_int#1_15|) (<= 0 (+ |v_main_#t~nondet3_81_fresh_1| 2147483648)) (<= |v_main_#t~nondet3_81_fresh_1| 2147483647) (= v_ArrVal_300_fresh_1 |v_main_#t~nondet3_81_fresh_1|) (= main_~i~1_15 (+ main_~i~1_14 1))) :named ssa_15))
(assert (! (<= 10000 main_~i~1_15) :named ssa_16))
(assert (! true :named ssa_17))
(assert (! true :named ssa_18_GlobVarAssigCall))
(assert (! (and (= |main_~#x~0.base_4| |mapsum_#in~x.base_18|) (= |mapsum_#in~x.offset_18| |main_~#x~0.offset_4|)) :named ssa_18_LocVarAssigCall))
...
(assert (! (and (= mapsum_~ret~0_20 (+ mapsum_~ret~0_19 mapsum_~i~0_19 (select (select |#memory_int#1_15| mapsum_~x.base_19) (+ (* mapsum_~i~0_19 4) mapsum_~x.offset_19)))) (< mapsum_~i~0_19 10000) (= (+ mapsum_~i~0_19 1) mapsum_~i~0_20)) :named ssa_20))
(assert (! (and (= mapsum_~ret~0_21 (+ mapsum_~ret~0_20 mapsum_~i~0_20 (select (select |#memory_int#1_15| mapsum_~x.base_19) (+ (* mapsum_~i~0_20 4) mapsum_~x.offset_19)))) (< mapsum_~i~0_20 10000) (= (+ mapsum_~i~0_20 1) mapsum_~i~0_21)) :named ssa_21))
(assert (! (<= 10000 mapsum_~i~0_21) :named ssa_22))
...
(assert (! (= |main_#t~ret5_24| |mapsum_#res_23|) :named ssa_24_return))
(assert (! (and (= (store (store (select |#memory_int#1_15| |main_~#x~0.base_4|) |main_~#x~0.offset_4| v_ArrVal_302_fresh_1) (+ |main_~#x~0.offset_4| 4) v_ArrVal_301_fresh_1) v_ArrVal_303_fresh_1) (<= 0 (+ |main_#t~ret5_24| 2147483648)) (= v_ArrVal_302_fresh_1 (select (select |#memory_int#1_15| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4))) (= |main_#t~ret5_24| main_~ret~1_25) (<= |main_#t~ret5_24| 2147483647) (= v_ArrVal_301_fresh_1 v_main_~temp~0_22_fresh_1) (= v_main_~temp~0_22_fresh_1 (select (select |#memory_int#1_15| |main_~#x~0.base_4|) |main_~#x~0.offset_4|)) (= (store |#memory_int#1_15| |main_~#x~0.base_4| v_ArrVal_303_fresh_1) |#memory_int#1_25|)) :named ssa_25))
(assert (! true :named ssa_26_GlobVarAssigCall))
(assert (! (and (= |mapsum_#in~x.offset_26| |main_~#x~0.offset_4|) (= |main_~#x~0.base_4| |mapsum_#in~x.base_26|)) :named ssa_26_LocVarAssigCall))
...
(assert (! (and (= mapsum_~ret~0_28 (+ mapsum_~ret~0_27 mapsum_~i~0_27 (select (select |#memory_int#1_25| mapsum_~x.base_27) (+ (* mapsum_~i~0_27 4) mapsum_~x.offset_27)))) (< mapsum_~i~0_27 10000) (= (+ mapsum_~i~0_27 1) mapsum_~i~0_28)) :named ssa_28))
(assert (! (and (= mapsum_~ret~0_29 (+ mapsum_~ret~0_28 mapsum_~i~0_28 (select (select |#memory_int#1_25| mapsum_~x.base_27) (+ (* mapsum_~i~0_28 4) mapsum_~x.offset_27)))) (< mapsum_~i~0_28 10000) (= (+ mapsum_~i~0_28 1) mapsum_~i~0_29)) :named ssa_29))
...
(assert (! (= |main_#t~ret8_32| |mapsum_#res_31|) :named ssa_32_return))
(assert (! (and (= (select (select |#memory_int#1_25| |main_~#x~0.base_4|) |main_~#x~0.offset_4|) main_~temp~0_33) (<= |main_#t~ret8_32| 2147483647) (= main_~ret2~0_33 |main_#t~ret8_32|) (<= 0 (+ |main_#t~ret8_32| 2147483648)) (= main_~i~2_33 0)) :named ssa_33))
(assert (! (and (= v_ArrVal_304_fresh_1 (select (select |#memory_int#1_25| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4 (* main_~i~2_33 4)))) (= v_ArrVal_305_fresh_1 (store (select |#memory_int#1_25| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| (* main_~i~2_33 4)) v_ArrVal_304_fresh_1)) (= main_~i~2_34 (+ main_~i~2_33 1)) (< main_~i~2_33 9999) (= |#memory_int#1_34| (store |#memory_int#1_25| |main_~#x~0.base_4| v_ArrVal_305_fresh_1))) :named ssa_34))
(assert (! (and (= main_~i~2_35 (+ main_~i~2_34 1)) (< main_~i~2_34 9999) (= v_ArrVal_306_fresh_1 (select (select |#memory_int#1_34| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4 (* main_~i~2_34 4)))) (= v_ArrVal_307_fresh_1 (store (select |#memory_int#1_34| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| (* main_~i~2_34 4)) v_ArrVal_306_fresh_1)) (= (store |#memory_int#1_34| |main_~#x~0.base_4| v_ArrVal_307_fresh_1) |#memory_int#1_35|)) :named ssa_35))
(assert (! (<= 9999 main_~i~2_35) :named ssa_36))
(assert (! (and (= v_ArrVal_309_fresh_1 (store (select |#memory_int#1_35| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 39996) v_ArrVal_308_fresh_1)) (= v_ArrVal_308_fresh_1 main_~temp~0_33) (= (store |#memory_int#1_35| |main_~#x~0.base_4| v_ArrVal_309_fresh_1) |#memory_int#1_37|)) :named ssa_37))
...
(assert (! (= |main_#t~ret12_44| |mapsum_#res_43|) :named ssa_44_return))
