...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration33)
...
(assert (! (<= 1000000 main_~i~0_36) :named ssa_37))
(assert (! true :named ssa_38_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_38| (ite (= main_~i~0_36 1000000) 1 0)) :named ssa_38_LocVarAssigCall))
