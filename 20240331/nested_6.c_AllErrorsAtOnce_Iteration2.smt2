...
(set-info :ultimate-id nested_6.c_AllErrorsAtOnce_Iteration2)
...
(declare-fun |main_#t~pre9_7| () Int)
...
(assert (! (= main_~a~0_7 (+ main_~a~0_4 1)) :named ssa_7))
(assert (! (<= 6 main_~a~0_7) :named ssa_8))
(assert (! (or (not (= main_~c~0_4 6)) (not (= main_~d~0_4 6)) (not (= main_~a~0_7 6)) (not (= main_~f~0_4 6)) (not (= main_~e~0_4 6)) (not (= main_~b~0_5 6))) :named ssa_9))
