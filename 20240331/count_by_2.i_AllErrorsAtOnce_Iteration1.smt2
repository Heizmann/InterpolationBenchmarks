...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration1)
...
(assert (! (<= 1000000 main_~i~0_4) :named ssa_5))
(assert (! true :named ssa_6_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_6| (ite (= main_~i~0_4 1000000) 1 0)) :named ssa_6_LocVarAssigCall))
