...
(set-info :ultimate-id array_ptr_single_elem_init-1.i_AllErrorsAtOnce_Iteration12)
...
(declare-fun |v_main_#t~malloc6.base_15_fresh_1| () Int)
...
(declare-fun |main_#t~mem7.base_43| () Int)
(declare-fun |main_#t~mem7.offset_43| () Int)
(declare-fun main_~s1~0.offset_43 () Int)
(declare-fun |main_#t~short9_43| () Bool)
(declare-fun main_~s1~0.base_43 () Int)
(declare-fun |main_#t~short9_44| () Bool)
(declare-fun |v_main_#t~mem8_16_fresh_1| () Int)
(declare-fun |main_#t~mem10.base_45| () Int)
(declare-fun |main_#t~mem10.offset_45| () Int)
(declare-fun |main_#t~mem8_45| () Int)
(declare-fun main_~s1~0.offset_45 () Int)
(declare-fun |main_#t~short9_45| () Bool)
(declare-fun main_~s1~0.base_45 () Int)
(declare-fun |main_#t~mem10.base_46| () Int)
(declare-fun |__VERIFIER_assert_#in~cond_46| () Int)
(declare-fun |main_#t~mem10.offset_46| () Int)
...
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_364_fresh_1) (= ((as const (Array Int Int)) 0) v_ArrVal_363_fresh_1) (< 0 |#StackHeapBarrier_-1|) (= |#memory_$Pointer$#1.offset_1| (store |#memory_$Pointer$#1.offset_0| |~#a~0.base_1| v_ArrVal_364_fresh_1)) (= (select |#valid_-1| 0) 0) (= 31 (select |#length_-1| 2)) (= (select |#valid_-1| 2) 1) (= |~#a~0.base_1| 3) (= (select |#valid_-1| 3) 1) (= (store |#memory_$Pointer$#1.base_0| |~#a~0.base_1| v_ArrVal_363_fresh_1) |#memory_$Pointer$#1.base_1|) (= |~#a~0.offset_1| 0) (= (select |#valid_-1| 1) 1) (= (select (select |#memory_int#0_-1| 1) 1) 0) (= 2 (select |#length_-1| 1)) (= (select |#length_-1| 3) 400000) (= (select (select |#memory_int#0_-1| 1) 0) 48)) :named ssa_1))
...
(assert (! (and (= (store |#memory_$Pointer$#1.base_3| |~#a~0.base_1| v_ArrVal_368_fresh_1) |#memory_$Pointer$#1.base_8|) (= main_~i~0_8 (+ main_~i~0_4 1)) (= v_ArrVal_366_fresh_1 (select (select |#memory_int#1_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4)))) (= v_ArrVal_368_fresh_1 (store (select |#memory_$Pointer$#1.base_3| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4)) main_~s~0.base_5)) (= (store |#memory_$Pointer$#1.offset_3| |~#a~0.base_1| v_ArrVal_370_fresh_1) |#memory_$Pointer$#1.offset_8|) (= v_ArrVal_367_fresh_1 main_~s~0.offset_5) (= v_ArrVal_365_fresh_1 (store (select |#memory_int#1_3| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4)) (select (select |#memory_int#1_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4))))) (= v_ArrVal_369_fresh_1 main_~s~0.base_5) (= v_ArrVal_370_fresh_1 (store (select |#memory_$Pointer$#1.offset_3| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4)) v_ArrVal_367_fresh_1)) (= (store |#memory_int#1_3| |~#a~0.base_1| v_ArrVal_365_fresh_1) |#memory_int#1_8|)) :named ssa_8))
...
(assert (! (and (= v_ArrVal_376_fresh_1 (store (select |#memory_$Pointer$#1.offset_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_8 4)) v_ArrVal_373_fresh_1)) (= v_ArrVal_373_fresh_1 main_~s~0.offset_9) (= main_~i~0_12 (+ main_~i~0_8 1)) (= |#memory_$Pointer$#1.offset_12| (store |#memory_$Pointer$#1.offset_8| |~#a~0.base_1| v_ArrVal_376_fresh_1)) (= (store |#memory_$Pointer$#1.base_8| |~#a~0.base_1| v_ArrVal_374_fresh_1) |#memory_$Pointer$#1.base_12|) (= v_ArrVal_375_fresh_1 main_~s~0.base_9) (= v_ArrVal_371_fresh_1 (store (select |#memory_int#1_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_8 4)) (select (select |#memory_int#1_12| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_8 4))))) (= v_ArrVal_372_fresh_1 (select (select |#memory_int#1_12| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_8 4)))) (= v_ArrVal_374_fresh_1 (store (select |#memory_$Pointer$#1.base_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_8 4)) main_~s~0.base_9)) (= (store |#memory_int#1_8| |~#a~0.base_1| v_ArrVal_371_fresh_1) |#memory_int#1_12|)) :named ssa_12))
...
(assert (! (and (= v_ArrVal_377_fresh_1 (store (select |#memory_int#1_12| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_12 4)) (select (select |#memory_int#1_16| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_12 4))))) (= v_ArrVal_380_fresh_1 (store (select |#memory_$Pointer$#1.base_12| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_12 4)) main_~s~0.base_13)) (= (store |#memory_int#1_12| |~#a~0.base_1| v_ArrVal_377_fresh_1) |#memory_int#1_16|) (= main_~i~0_16 (+ main_~i~0_12 1)) (= v_ArrVal_379_fresh_1 main_~s~0.offset_13) (= |#memory_$Pointer$#1.offset_16| (store |#memory_$Pointer$#1.offset_12| |~#a~0.base_1| v_ArrVal_382_fresh_1)) (= v_ArrVal_378_fresh_1 (select (select |#memory_int#1_16| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_12 4)))) (= (store |#memory_$Pointer$#1.base_12| |~#a~0.base_1| v_ArrVal_380_fresh_1) |#memory_$Pointer$#1.base_16|) (= v_ArrVal_381_fresh_1 main_~s~0.base_13) (= v_ArrVal_382_fresh_1 (store (select |#memory_$Pointer$#1.offset_12| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_12 4)) v_ArrVal_379_fresh_1))) :named ssa_16))
...
(assert (! (and (= v_ArrVal_384_fresh_1 (select (select |#memory_int#1_20| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_16 4)))) (= |#memory_int#1_20| (store |#memory_int#1_16| |~#a~0.base_1| v_ArrVal_383_fresh_1)) (= (store |#memory_$Pointer$#1.offset_16| |~#a~0.base_1| v_ArrVal_388_fresh_1) |#memory_$Pointer$#1.offset_20|) (= main_~i~0_20 (+ main_~i~0_16 1)) (= v_ArrVal_385_fresh_1 main_~s~0.offset_17) (= v_ArrVal_386_fresh_1 (store (select |#memory_$Pointer$#1.base_16| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_16 4)) main_~s~0.base_17)) (= v_ArrVal_387_fresh_1 main_~s~0.base_17) (= v_ArrVal_388_fresh_1 (store (select |#memory_$Pointer$#1.offset_16| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_16 4)) v_ArrVal_385_fresh_1)) (= (store |#memory_$Pointer$#1.base_16| |~#a~0.base_1| v_ArrVal_386_fresh_1) |#memory_$Pointer$#1.base_20|) (= v_ArrVal_383_fresh_1 (store (select |#memory_int#1_16| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_16 4)) (select (select |#memory_int#1_20| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_16 4)))))) :named ssa_20))
...
(assert (! (and (= v_ArrVal_393_fresh_1 main_~s~0.base_21) (= v_ArrVal_389_fresh_1 (store (select |#memory_int#1_20| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_20 4)) (select (select |#memory_int#1_24| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_20 4))))) (= (store (select |#memory_$Pointer$#1.offset_20| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_20 4)) v_ArrVal_391_fresh_1) v_ArrVal_394_fresh_1) (= v_ArrVal_391_fresh_1 main_~s~0.offset_21) (= main_~i~0_24 (+ main_~i~0_20 1)) (= v_ArrVal_392_fresh_1 (store (select |#memory_$Pointer$#1.base_20| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_20 4)) main_~s~0.base_21)) (= (store |#memory_$Pointer$#1.offset_20| |~#a~0.base_1| v_ArrVal_394_fresh_1) |#memory_$Pointer$#1.offset_24|) (= (store |#memory_$Pointer$#1.base_20| |~#a~0.base_1| v_ArrVal_392_fresh_1) |#memory_$Pointer$#1.base_24|) (= (store |#memory_int#1_20| |~#a~0.base_1| v_ArrVal_389_fresh_1) |#memory_int#1_24|) (= v_ArrVal_390_fresh_1 (select (select |#memory_int#1_24| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_20 4))))) :named ssa_24))
...
(assert (! (and (= v_ArrVal_398_fresh_1 (store (select |#memory_$Pointer$#1.base_24| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_24 4)) main_~s~0.base_25)) (= v_ArrVal_396_fresh_1 (select (select |#memory_int#1_28| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_24 4)))) (= main_~i~0_28 (+ main_~i~0_24 1)) (= v_ArrVal_395_fresh_1 (store (select |#memory_int#1_24| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_24 4)) (select (select |#memory_int#1_28| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_24 4))))) (= v_ArrVal_400_fresh_1 (store (select |#memory_$Pointer$#1.offset_24| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_24 4)) v_ArrVal_397_fresh_1)) (= v_ArrVal_397_fresh_1 main_~s~0.offset_25) (= (store |#memory_$Pointer$#1.base_24| |~#a~0.base_1| v_ArrVal_398_fresh_1) |#memory_$Pointer$#1.base_28|) (= |#memory_int#1_28| (store |#memory_int#1_24| |~#a~0.base_1| v_ArrVal_395_fresh_1)) (= v_ArrVal_399_fresh_1 main_~s~0.base_25) (= (store |#memory_$Pointer$#1.offset_24| |~#a~0.base_1| v_ArrVal_400_fresh_1) |#memory_$Pointer$#1.offset_28|)) :named ssa_28))
...
(assert (! (and (= v_ArrVal_401_fresh_1 (store (select |#memory_int#1_28| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_28 4)) (select (select |#memory_int#1_32| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_28 4))))) (= v_ArrVal_404_fresh_1 (store (select |#memory_$Pointer$#1.base_28| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_28 4)) main_~s~0.base_29)) (= (store |#memory_$Pointer$#1.base_28| |~#a~0.base_1| v_ArrVal_404_fresh_1) |#memory_$Pointer$#1.base_32|) (= v_ArrVal_402_fresh_1 (select (select |#memory_int#1_32| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_28 4)))) (= |#memory_$Pointer$#1.offset_32| (store |#memory_$Pointer$#1.offset_28| |~#a~0.base_1| v_ArrVal_406_fresh_1)) (= main_~i~0_32 (+ main_~i~0_28 1)) (= v_ArrVal_406_fresh_1 (store (select |#memory_$Pointer$#1.offset_28| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_28 4)) v_ArrVal_403_fresh_1)) (= v_ArrVal_403_fresh_1 main_~s~0.offset_29) (= |#memory_int#1_32| (store |#memory_int#1_28| |~#a~0.base_1| v_ArrVal_401_fresh_1)) (= v_ArrVal_405_fresh_1 main_~s~0.base_29)) :named ssa_32))
...
(assert (! (and (= v_ArrVal_411_fresh_1 main_~s~0.base_33) (= |#memory_int#1_36| (store |#memory_int#1_32| |~#a~0.base_1| v_ArrVal_407_fresh_1)) (= v_ArrVal_410_fresh_1 (store (select |#memory_$Pointer$#1.base_32| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_32 4)) main_~s~0.base_33)) (= main_~i~0_36 (+ main_~i~0_32 1)) (= v_ArrVal_412_fresh_1 (store (select |#memory_$Pointer$#1.offset_32| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_32 4)) v_ArrVal_409_fresh_1)) (= v_ArrVal_409_fresh_1 main_~s~0.offset_33) (= (store |#memory_$Pointer$#1.base_32| |~#a~0.base_1| v_ArrVal_410_fresh_1) |#memory_$Pointer$#1.base_36|) (= v_ArrVal_408_fresh_1 (select (select |#memory_int#1_36| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_32 4)))) (= (store |#memory_$Pointer$#1.offset_32| |~#a~0.base_1| v_ArrVal_412_fresh_1) |#memory_$Pointer$#1.offset_36|) (= v_ArrVal_407_fresh_1 (store (select |#memory_int#1_32| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_32 4)) (select (select |#memory_int#1_36| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_32 4)))))) :named ssa_36))
...
(assert (! (and (= v_ArrVal_414_fresh_1 (select (select |#memory_int#1_40| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_36 4)))) (= (store (select |#memory_$Pointer$#1.offset_36| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_36 4)) v_ArrVal_415_fresh_1) v_ArrVal_418_fresh_1) (= v_ArrVal_416_fresh_1 (store (select |#memory_$Pointer$#1.base_36| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_36 4)) main_~s~0.base_37)) (= v_ArrVal_415_fresh_1 main_~s~0.offset_37) (= main_~i~0_40 (+ main_~i~0_36 1)) (= (store |#memory_int#1_36| |~#a~0.base_1| v_ArrVal_413_fresh_1) |#memory_int#1_40|) (= v_ArrVal_417_fresh_1 main_~s~0.base_37) (= (store |#memory_$Pointer$#1.base_36| |~#a~0.base_1| v_ArrVal_416_fresh_1) |#memory_$Pointer$#1.base_40|) (= v_ArrVal_413_fresh_1 (store (select |#memory_int#1_36| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_36 4)) (select (select |#memory_int#1_40| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_36 4))))) (= (store |#memory_$Pointer$#1.offset_36| |~#a~0.base_1| v_ArrVal_418_fresh_1) |#memory_$Pointer$#1.offset_40|)) :named ssa_40))
(assert (! (<= 100000 main_~i~0_40) :named ssa_41))
(assert (! (and (= v_ArrVal_425_fresh_1 |v_main_#t~malloc6.base_15_fresh_1|) (< |v_main_#t~malloc6.base_15_fresh_1| |#StackHeapBarrier_-1|) (= v_ArrVal_420_fresh_1 1) (= |#memory_$Pointer$#1.offset_42| (store |#memory_$Pointer$#1.offset_40| |~#a~0.base_1| v_ArrVal_419_fresh_1)) (= v_ArrVal_424_fresh_1 (store (select |#memory_int#1_40| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12) (select (select |#memory_int#1_42| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12)))) (= v_ArrVal_421_fresh_1 8) (= v_ArrVal_419_fresh_1 (store (select |#memory_$Pointer$#1.offset_40| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12) 0)) (= (select |#valid_3| |v_main_#t~malloc6.base_15_fresh_1|) 0) (= v_ArrVal_423_fresh_1 0) (= v_ArrVal_426_fresh_1 (select (select |#memory_int#1_42| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12))) (= (store |#memory_int#1_40| |~#a~0.base_1| v_ArrVal_424_fresh_1) |#memory_int#1_42|) (= (store |#memory_$Pointer$#1.base_40| |~#a~0.base_1| v_ArrVal_422_fresh_1) |#memory_$Pointer$#1.base_42|) (= main_~i~0_42 0) (= v_ArrVal_422_fresh_1 (store (select |#memory_$Pointer$#1.base_40| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12) |v_main_#t~malloc6.base_15_fresh_1|)) (not (= |v_main_#t~malloc6.base_15_fresh_1| 0)) (= |#length_42| (store |#length_3| |v_main_#t~malloc6.base_15_fresh_1| v_ArrVal_421_fresh_1)) (= |#valid_42| (store |#valid_3| |v_main_#t~malloc6.base_15_fresh_1| v_ArrVal_420_fresh_1))) :named ssa_42))
(assert (! (and (= (select (select |#memory_$Pointer$#1.base_42| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_42 4))) main_~s1~0.base_43) (= main_~s1~0.offset_43 (select (select |#memory_$Pointer$#1.offset_42| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_42 4)))) (< main_~i~0_42 100000) (or (and (not |main_#t~short9_43|) (or (and (= main_~s1~0.offset_43 0) (= main_~s1~0.base_43 0)) (= main_~i~0_42 3))) (and |main_#t~short9_43| (or (not (= main_~s1~0.offset_43 0)) (not (= main_~s1~0.base_43 0))) (not (= main_~i~0_42 3))))) :named ssa_43))
(assert (! (and |main_#t~short9_43| (or (and |main_#t~short9_44| (= |v_main_#t~mem8_16_fresh_1| 0)) (and (not (= |v_main_#t~mem8_16_fresh_1| 0)) (not |main_#t~short9_44|))) (= (select (select |#memory_int#2_3| main_~s1~0.base_43) (+ main_~s1~0.offset_43 4)) |v_main_#t~mem8_16_fresh_1|)) :named ssa_44))
(assert (! (and |main_#t~short9_44| (= |main_#t~mem10.offset_45| (select (select |#memory_$Pointer$#2.offset_3| main_~s1~0.base_43) main_~s1~0.offset_43)) (= (select (select |#memory_$Pointer$#2.base_3| main_~s1~0.base_43) main_~s1~0.offset_43) |main_#t~mem10.base_45|)) :named ssa_45))
(assert (! true :named ssa_46_GlobVarAssigCall))
(assert (! (= (ite (or (not (= |main_#t~mem10.base_45| 0)) (not (= |main_#t~mem10.offset_45| 0))) 1 0) |__VERIFIER_assert_#in~cond_46|) :named ssa_46_LocVarAssigCall))
...
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_428_fresh_1) (< 0 |#StackHeapBarrier_-1|) (= (select |#valid_-2| 0) 0) (= 31 (select |#length_-2| 2)) (= (select |#valid_-2| 2) 1) (= |~#a~0.base_0| 3) (= (select |#valid_-2| 3) 1) (= ((as const (Array Int Int)) 0) v_ArrVal_427_fresh_1) (= (store |#memory_$Pointer$#1.offset_-1| |~#a~0.base_0| v_ArrVal_428_fresh_1) |#memory_$Pointer$#1.offset_0|) (= |~#a~0.offset_0| 0) (= (select |#valid_-2| 1) 1) (= (select (select |#memory_int#0_-2| 1) 1) 0) (= 2 (select |#length_-2| 1)) (= (select |#length_-2| 3) 400000) (= (select (select |#memory_int#0_-2| 1) 0) 48) (= |#memory_$Pointer$#1.base_0| (store |#memory_$Pointer$#1.base_-1| |~#a~0.base_0| v_ArrVal_427_fresh_1))) :named ssa_0))
