...
(set-info :ultimate-id nr4.c_AllErrorsAtOnce_Iteration6)
...
(assert (! (and (= (* (mod ~CELLCOUNT~0_4 1073741824) 4) v_ArrVal_13_fresh_1) (= (store |#length_3| |main_~#volArray~0.base_5| v_ArrVal_13_fresh_1) |#length_5|) (< |#StackHeapBarrier_-1| |main_~#volArray~0.base_5|) (= |main_~#volArray~0.offset_5| 0) (not (= |main_~#volArray~0.base_5| 0)) (= v_ArrVal_14_fresh_1 1) (= (store |#valid_3| |main_~#volArray~0.base_5| v_ArrVal_14_fresh_1) |#valid_5|) (= 0 (select |#valid_3| |main_~#volArray~0.base_5|)) (= main_~MINVAL~0_5 2) (< 1 ~CELLCOUNT~0_4)) :named ssa_5))
...
(assert (! (and (= (store (select |#memory_int#1_3| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~j~0_13 (- 4)) (* main_~i~0_12 16)) main_~j~0_13) v_ArrVal_15_fresh_1) (= (store |#memory_int#1_3| |main_~#volArray~0.base_5| v_ArrVal_15_fresh_1) |#memory_int#1_15|) (= main_~j~0_13 v_ArrVal_16_fresh_1) (<= main_~MINVAL~0_5 main_~j~0_13)) :named ssa_15))
(assert (! (= main_~j~0_13 (+ main_~j~0_16 1)) :named ssa_16))
(assert (! (<= 1 main_~j~0_16) :named ssa_17))
(assert (! (and (= main_~j~0_16 v_ArrVal_18_fresh_1) (= (store (select |#memory_int#1_15| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~j~0_16 (- 4)) (* main_~i~0_12 16)) main_~j~0_16) v_ArrVal_17_fresh_1) (<= main_~MINVAL~0_5 main_~j~0_16) (= |#memory_int#1_18| (store |#memory_int#1_15| |main_~#volArray~0.base_5| v_ArrVal_17_fresh_1))) :named ssa_18))
...
(assert (! (and (= (select (select |#memory_int#1_18| |main_~#volArray~0.base_5|) (+ (* main_~i~0_23 4) |main_~#volArray~0.offset_5|)) |v_main_#t~mem7_11_fresh_1|) (< main_~i~0_23 ~CELLCOUNT~0_4) (or (and |main_#t~short9_24| (<= main_~MINVAL~0_5 |v_main_#t~mem7_11_fresh_1|)) (and (< |v_main_#t~mem7_11_fresh_1| main_~MINVAL~0_5) (not |main_#t~short9_24|)))) :named ssa_24))
(assert (! (and (not |main_#t~short9_24|) (= |v_main_#t~mem8_9_fresh_1| (select (select |#memory_int#1_18| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_23 4)))) (or (and (not |main_#t~short9_25|) (not (= |v_main_#t~mem8_9_fresh_1| 0))) (and |main_#t~short9_25| (= |v_main_#t~mem8_9_fresh_1| 0)))) :named ssa_25))
