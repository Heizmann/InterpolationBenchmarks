...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:15:07+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id Addition03-1.c_AllErrorsAtOnce_Iteration13)
...
(declare-fun |main_#t~ret8_86| () Int)
(declare-fun |addition_#res_86| () Int)
(declare-fun main_~result~0_87 () Int)
(declare-fun |main_#t~ret8_87| () Int)
(declare-fun main_~result~0_88 () Int)
(declare-fun main_~m~0_88 () Int)
(declare-fun main_~n~0_88 () Int)
...
(assert (! (and (= 0 addition_~n_50) (= |addition_#res_51| addition_~m_50)) :named ssa_51))
...
(assert (! (= |addition_#res_84| |main_#t~ret8_86|) :named ssa_86_return))
(assert (! (and (<= |main_#t~ret8_86| 9223372036854775807) (<= 0 (+ |main_#t~ret8_86| 9223372036854775808)) (= main_~result~0_87 |main_#t~ret8_86|)) :named ssa_87))
(assert (! (and (< main_~result~0_87 200) (<= 100 main_~n~0_4) (<= 100 main_~m~0_4)) :named ssa_88))
(assert (! true :named ssa_89))
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 (and ssa_75 ssa_27 ssa_29_OldVarAssigCall ssa_20 ssa_41_GlobVarAssigCall ssa_17_LocVarAssigCall ssa_21_LocVarAssigCall ssa_64 ssa_5_LocVarAssigCall ssa_31 ssa_60 ssa_5_GlobVarAssigCall ssa_21_OldVarAssigCall ssa_76 ssa_81 ssa_7 ssa_84 ssa_44 ssa_16 ssa_57 ssa_6 ssa_26 ssa_55 ssa_67 ssa_34 ssa_17_GlobVarAssigCall ssa_25_GlobVarAssigCall ssa_40 ssa_10 ssa_14 ssa_25_OldVarAssigCall ssa_86_return ssa_8 ssa_13_LocVarAssigCall ssa_29_GlobVarAssigCall ssa_46 ssa_47 ssa_59_return ssa_13_OldVarAssigCall ssa_25_LocVarAssigCall ssa_82 ssa_37_LocVarAssigCall ssa_49_LocVarAssigCall ssa_85 ssa_58 ssa_33_GlobVarAssigCall ssa_83_return ssa_19 ssa_53_return ssa_61 ssa_33_LocVarAssigCall ssa_39 ssa_43 ssa_72 ssa_13_GlobVarAssigCall ssa_41_OldVarAssigCall ssa_17_OldVarAssigCall ssa_38 ssa_79 ssa_74_return ssa_12 ssa_56_return ssa_32 ssa_5_OldVarAssigCall ssa_50 ssa_71_return ssa_41_LocVarAssigCall ssa_11 ssa_48 ssa_28 ssa_29_LocVarAssigCall ssa_54 ssa_65_return ssa_37_GlobVarAssigCall ssa_22 ssa_51 ssa_36 ssa_15 ssa_80_return ssa_63 ssa_45_OldVarAssigCall ssa_45_LocVarAssigCall ssa_68_return ssa_78 ssa_52 ssa_18 ssa_49_GlobVarAssigCall ssa_23 ssa_30 ssa_70 ssa_66 ssa_69 ssa_9_LocVarAssigCall ssa_9_OldVarAssigCall ssa_35 ssa_21_GlobVarAssigCall ssa_9_GlobVarAssigCall ssa_33_OldVarAssigCall ssa_77_return ssa_62_return ssa_45_GlobVarAssigCall ssa_49_OldVarAssigCall ssa_42 ssa_24 ssa_37_OldVarAssigCall ssa_73) ssa_87 ssa_88 (and ssa_89 ssa_postcond))
...
(declare-fun |addition_#t~ret4_78| () Int)
(declare-fun |addition_#res_78| () Int)
(declare-fun |main_#t~ret8_80| () Int)
(declare-fun |addition_#res_80| () Int)
(assert (! true :named ssa_precond))
(assert (! (not (<= main_~n~0_-2 11)) :named ssa_postcond))
...
(assert (! (and (<= 0 (+ 9223372036854775808 |addition_#t~ret4_77|)) (<= |addition_#t~ret4_77| 9223372036854775807) (= |addition_#res_78| |addition_#t~ret4_77|)) :named ssa_78))
(assert (! true :named ssa_79))
(assert (! (= |addition_#res_78| |main_#t~ret8_80|) :named ssa_80_return))
(assert (! true :named ssa_-2_PendingContext))
