...
(set-info :ultimate-id num_conversion_2.c_AllErrorsAtOnce_Iteration9)
...
(assert (! (<= 8 (mod main_~c~0_46 256)) :named ssa_47))
(assert (! true :named ssa_48_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_48| (ite (= (mod main_~x~0_4 256) (mod main_~y~0_4 256)) 1 0)) :named ssa_48_LocVarAssigCall))
