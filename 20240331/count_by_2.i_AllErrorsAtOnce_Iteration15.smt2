...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration15)
...
(assert (! (<= 1000000 main_~i~0_18) :named ssa_19))
(assert (! true :named ssa_20_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_20| (ite (= main_~i~0_18 1000000) 1 0)) :named ssa_20_LocVarAssigCall))
