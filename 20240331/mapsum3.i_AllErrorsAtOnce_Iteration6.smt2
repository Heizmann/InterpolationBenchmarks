...
(set-info :ultimate-id mapsum3.i_AllErrorsAtOnce_Iteration6)
...
(assert (! (and (= v_ArrVal_47_fresh_1 40000) (< |#StackHeapBarrier_-1| |main_~#x~0.base_4|) (= |#length_4| (store |#length_3| |main_~#x~0.base_4| v_ArrVal_47_fresh_1)) (= |#valid_4| (store |#valid_3| |main_~#x~0.base_4| v_ArrVal_46_fresh_1)) (not (= |main_~#x~0.base_4| 0)) (= (select |#valid_3| |main_~#x~0.base_4|) 0) (= v_ArrVal_46_fresh_1 1) (= |main_~#x~0.offset_4| 0) (= main_~i~1_4 0)) :named ssa_4))
(assert (! (and (<= |v_main_#t~nondet3_13_fresh_1| 2147483647) (< main_~i~1_4 10000) (= (store (select |#memory_int#1_3| |main_~#x~0.base_4|) (+ (* main_~i~1_4 4) |main_~#x~0.offset_4|) |v_main_#t~nondet3_13_fresh_1|) v_ArrVal_48_fresh_1) (= |v_main_#t~nondet3_13_fresh_1| v_ArrVal_49_fresh_1) (= |#memory_int#1_5| (store |#memory_int#1_3| |main_~#x~0.base_4| v_ArrVal_48_fresh_1)) (<= 0 (+ |v_main_#t~nondet3_13_fresh_1| 2147483648)) (= main_~i~1_5 (+ main_~i~1_4 1))) :named ssa_5))
(assert (! (and (< main_~i~1_5 10000) (<= 0 (+ |v_main_#t~nondet3_14_fresh_1| 2147483648)) (= (store (select |#memory_int#1_5| |main_~#x~0.base_4|) (+ (* main_~i~1_5 4) |main_~#x~0.offset_4|) |v_main_#t~nondet3_14_fresh_1|) v_ArrVal_50_fresh_1) (= (store |#memory_int#1_5| |main_~#x~0.base_4| v_ArrVal_50_fresh_1) |#memory_int#1_6|) (<= |v_main_#t~nondet3_14_fresh_1| 2147483647) (= |v_main_#t~nondet3_14_fresh_1| v_ArrVal_51_fresh_1) (= main_~i~1_6 (+ main_~i~1_5 1))) :named ssa_6))
...
(assert (! (<= 9999 main_~i~2_24) :named ssa_25))
(assert (! (and (= main_~temp~0_24 v_ArrVal_55_fresh_1) (= (store |#memory_int#1_16| |main_~#x~0.base_4| v_ArrVal_56_fresh_1) |#memory_int#1_26|) (= (store (select |#memory_int#1_16| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 39996) v_ArrVal_55_fresh_1) v_ArrVal_56_fresh_1)) :named ssa_26))
