...
(set-info :ultimate-id duplets.c_AllErrorsAtOnce_Iteration11)
...
(declare-fun v_mkdup_~x~0_25_fresh_1 () Int)
...
(assert (! (and (= v_ArrVal_173_fresh_1 (* 4 (mod main_~n~0_4 1073741824))) (not (= 0 |main_#t~malloc13.base_10|)) (< |main_#t~malloc13.base_10| |#StackHeapBarrier_-1|) (= |main_#t~malloc13.offset_10| 0) (= v_ArrVal_174_fresh_1 1) (= |#length_10| (store |#length_3| |main_#t~malloc13.base_10| v_ArrVal_173_fresh_1)) (= |#valid_10| (store |#valid_3| |main_#t~malloc13.base_10| v_ArrVal_174_fresh_1)) (= (select |#valid_3| |main_#t~malloc13.base_10|) 0)) :named ssa_10))
(assert (! (= |old(#memory_int#2)_11| |#memory_int#2_11|) :named ssa_11_GlobVarAssigCall))
(assert (! (and (= |v_#Ultimate.meminit_#productInParam_13_fresh_1| (* main_~n~0_4 4)) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_13_fresh_1|) (= |v_#Ultimate.meminit_#ptr.offsetInParam_13_fresh_1| |main_#t~malloc13.offset_10|) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_13_fresh_1| 4) (= |#Ultimate.meminit_#ptr.base_11| |main_#t~malloc13.base_10|)) :named ssa_11_LocVarAssigCall))
(assert (! (= |old(#memory_int#2)_11| |#memory_int#2_3|) :named ssa_11_OldVarAssigCall))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_175_fresh_1) (= (store |#memory_int#2_11| |#Ultimate.meminit_#ptr.base_11| v_ArrVal_175_fresh_1) |#memory_int#2_12|)) :named ssa_12))
...
(assert (! (and (= (store |#memory_int#2_15| mkdup_~a.base_16 v_ArrVal_177_fresh_1) |#memory_int#2_32|) (= v_ArrVal_178_fresh_1 v_mkdup_~x~0_25_fresh_1) (<= v_mkdup_~x~0_25_fresh_1 2147483647) (<= 0 (+ v_mkdup_~x~0_25_fresh_1 2147483648)) (= (store (store (select |#memory_int#2_15| mkdup_~a.base_16) (+ (* mkdup_~i~0_16 4) mkdup_~a.offset_16) v_mkdup_~x~0_25_fresh_1) (+ mkdup_~a.offset_16 (* mkdup_~j~0_16 4)) v_ArrVal_176_fresh_1) v_ArrVal_177_fresh_1) (= v_ArrVal_176_fresh_1 v_mkdup_~x~0_25_fresh_1)) :named ssa_32))
(assert (! true :named ssa_33_return))
(assert (! (and (= (store (store |#valid_10| |main_~#i~2.base_34| v_ArrVal_180_fresh_1) |main_~#j~2.base_34| v_ArrVal_182_fresh_1) |#valid_34|) (= |main_~#i~2.offset_34| 0) (= v_ArrVal_180_fresh_1 1) (= (select |#valid_10| |main_~#i~2.base_34|) 0) (= |main_~#j~2.offset_34| 0) (= v_ArrVal_181_fresh_1 4) (not (= |main_~#j~2.base_34| 0)) (= v_ArrVal_182_fresh_1 1) (< |#StackHeapBarrier_-1| |main_~#j~2.base_34|) (= v_ArrVal_179_fresh_1 4) (not (= |main_~#i~2.base_34| 0)) (< |#StackHeapBarrier_-1| |main_~#i~2.base_34|) (= (select (store |#valid_10| |main_~#i~2.base_34| v_ArrVal_180_fresh_1) |main_~#j~2.base_34|) 0) (= (store (store |#length_10| |main_~#i~2.base_34| v_ArrVal_179_fresh_1) |main_~#j~2.base_34| v_ArrVal_181_fresh_1) |#length_34|)) :named ssa_34))
...
(assert (! (and (= v_ArrVal_186_fresh_1 (store (select |#memory_int#1_35| finddup_~_i.base_36) finddup_~_i.offset_36 v_ArrVal_183_fresh_1)) (= v_ArrVal_185_fresh_1 finddup_~j~1_37) (= v_ArrVal_184_fresh_1 (store (select |#memory_int#3_35| finddup_~_j.base_36) finddup_~_j.offset_36 finddup_~j~1_37)) (= |finddup_#res_39| 1) (= |finddup_#t~mem8_38| |finddup_#t~mem9_38|) (= (store |#memory_int#3_35| finddup_~_j.base_36 v_ArrVal_184_fresh_1) |#memory_int#3_39|) (= (store |#memory_int#1_35| finddup_~_i.base_36 v_ArrVal_186_fresh_1) |#memory_int#1_39|) (= v_ArrVal_183_fresh_1 finddup_~i~1_36)) :named ssa_39))
...
(assert (! (and (or (and |main_#t~short17_48| (<= 0 |v_main_#t~mem15_7_fresh_1|)) (and (< |v_main_#t~mem15_7_fresh_1| 0) (not |main_#t~short17_48|))) (= (select (select |#memory_int#1_39| |main_~#i~2.base_34|) |main_~#i~2.offset_34|) |v_main_#t~mem15_7_fresh_1|)) :named ssa_48))
(assert (! (and (= (select (select |#memory_int#1_39| |main_~#i~2.base_34|) |main_~#i~2.offset_34|) |v_main_#t~mem16_6_fresh_1|) |main_#t~short17_48| (or (and (not |main_#t~short17_49|) (<= main_~n~0_4 |v_main_#t~mem16_6_fresh_1|)) (and (< |v_main_#t~mem16_6_fresh_1| main_~n~0_4) |main_#t~short17_49|))) :named ssa_49))
...
(assert (! (and (= |v_main_#t~mem18_5_fresh_1| (select (select |#memory_int#3_39| |main_~#j~2.base_34|) |main_~#j~2.offset_34|)) (or (and (<= 0 |v_main_#t~mem18_5_fresh_1|) |main_#t~short20_55|) (and (< |v_main_#t~mem18_5_fresh_1| 0) (not |main_#t~short20_55|)))) :named ssa_55))
(assert (! (not |main_#t~short20_55|) :named ssa_56))
(assert (! true :named ssa_57_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_57| (ite |main_#t~short20_55| 1 0)) :named ssa_57_LocVarAssigCall))
...
(assert (! (not true) :named ssa_postcond))
(assert (! (and (= (store |#memory_int#2_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_187_fresh_1) |#memory_int#2_0|) (= ((as const (Array Int Int)) 0) v_ArrVal_187_fresh_1)) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! true :named ssa_-2_PendingContext))
...
(declare-fun mkdup_~a.base_16 () Int)
(declare-fun mkdup_~i~0_16 () Int)
(declare-fun v_mkdup_~x~0_26_fresh_1 () Int)
...
(assert (! (and (= v_ArrVal_188_fresh_1 v_mkdup_~x~0_26_fresh_1) (= v_ArrVal_190_fresh_1 v_mkdup_~x~0_26_fresh_1) (<= v_mkdup_~x~0_26_fresh_1 2147483647) (= v_ArrVal_189_fresh_1 (store (store (select |#memory_int#2_-1| mkdup_~a.base_0) (+ (* mkdup_~i~0_0 4) mkdup_~a.offset_0) v_mkdup_~x~0_26_fresh_1) (+ mkdup_~a.offset_0 (* mkdup_~j~0_0 4)) v_ArrVal_188_fresh_1)) (<= 0 (+ v_mkdup_~x~0_26_fresh_1 2147483648)) (= |#memory_int#2_16| (store |#memory_int#2_-1| mkdup_~a.base_0 v_ArrVal_189_fresh_1))) :named ssa_16))
...
(assert (! (not (<= 1 (select (select |#memory_int#3_3| |main_~#j~2.base_-2|) |main_~#j~2.offset_-2|))) :named ssa_postcond))
...
(assert (! (and (= v_ArrVal_194_fresh_1 (store (select |#memory_int#1_-1| finddup_~_i.base_0) finddup_~_i.offset_0 v_ArrVal_191_fresh_1)) (= v_ArrVal_191_fresh_1 finddup_~i~1_0) (= v_ArrVal_192_fresh_1 (store (select |#memory_int#3_-1| finddup_~_j.base_0) finddup_~_j.offset_0 finddup_~j~1_1)) (= |#memory_int#1_3| (store |#memory_int#1_-1| finddup_~_i.base_0 v_ArrVal_194_fresh_1)) (= |finddup_#res_3| 1) (= v_ArrVal_193_fresh_1 finddup_~j~1_1) (= |finddup_#t~mem8_2| |finddup_#t~mem9_2|) (= (store |#memory_int#3_-1| finddup_~_j.base_0 v_ArrVal_192_fresh_1) |#memory_int#3_3|)) :named ssa_3))
(assert (! true :named ssa_4))
...
(assert (! true :named ssa_precond))
(assert (! (not (<= 1 (select (select |#memory_int#3_-2| |main_~#j~2.base_-2|) |main_~#j~2.offset_-2|))) :named ssa_postcond))
...
(assert (! true :named ssa_2))
(assert (! true :named ssa_3_return))
(assert (! (<= 1 (select (select |#memory_int#3_-2| |main_~#j~2.base_-2|) |main_~#j~2.offset_-2|)) :named ssa_-2_PendingContext))
