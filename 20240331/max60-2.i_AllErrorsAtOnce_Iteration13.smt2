...
(set-info :ultimate-id max60-2.i_AllErrorsAtOnce_Iteration13)
...
(declare-fun |max_#in~x.base_15| () Int)
(declare-fun |main_~#x~0.offset_15| () Int)
(declare-fun |max_#in~x.offset_15| () Int)
(declare-fun |main_~#x~0.base_15| () Int)
(declare-fun max_~ret~0_16 () Int)
(declare-fun max_~x.base_16 () Int)
(declare-fun max_~x.offset_16 () Int)
...
(declare-fun |v_max_#t~mem2_108_fresh_1| () Int)
(declare-fun max_~ret~0_19 () Int)
(declare-fun |max_#t~mem2_19| () Int)
(declare-fun |max_#t~ite3_19| () Int)
(declare-fun |max_#t~post4_19| () Int)
...
(declare-fun |v_max_#t~mem2_109_fresh_1| () Int)
...
(declare-fun v_main_~temp~0_18_fresh_1 () Int)
...
(declare-fun |v_max_#t~mem2_110_fresh_1| () Int)
...
(declare-fun |v_max_#t~mem2_111_fresh_1| () Int)
...
(declare-fun |v_max_#t~mem2_112_fresh_1| () Int)
...
(declare-fun |v_max_#t~mem2_113_fresh_1| () Int)
...
(assert (! (and (not (= |main_~#x~0.base_4| 0)) (= (store |#valid_3| |main_~#x~0.base_4| v_ArrVal_183_fresh_1) |#valid_4|) (= v_ArrVal_184_fresh_1 240) (= (store |#length_3| |main_~#x~0.base_4| v_ArrVal_184_fresh_1) |#length_4|) (< |#StackHeapBarrier_-1| |main_~#x~0.base_4|) (= main_~i~1_4 0) (= (select |#valid_3| |main_~#x~0.base_4|) 0) (= |main_~#x~0.offset_4| 0) (= v_ArrVal_183_fresh_1 1)) :named ssa_4))
(assert (! (and (<= |v_main_#t~nondet5_44_fresh_1| 2147483647) (= (store (select |#memory_int#1_3| |main_~#x~0.base_4|) (+ (* main_~i~1_4 4) |main_~#x~0.offset_4|) |v_main_#t~nondet5_44_fresh_1|) v_ArrVal_185_fresh_1) (< main_~i~1_4 60) (<= 0 (+ |v_main_#t~nondet5_44_fresh_1| 2147483648)) (= |#memory_int#1_5| (store |#memory_int#1_3| |main_~#x~0.base_4| v_ArrVal_185_fresh_1)) (= v_ArrVal_186_fresh_1 |v_main_#t~nondet5_44_fresh_1|) (= main_~i~1_5 (+ main_~i~1_4 1))) :named ssa_5))
(assert (! (and (< main_~i~1_5 60) (= (store |#memory_int#1_5| |main_~#x~0.base_4| v_ArrVal_187_fresh_1) |#memory_int#1_6|) (= v_ArrVal_188_fresh_1 |v_main_#t~nondet5_45_fresh_1|) (<= |v_main_#t~nondet5_45_fresh_1| 2147483647) (<= 0 (+ |v_main_#t~nondet5_45_fresh_1| 2147483648)) (= v_ArrVal_187_fresh_1 (store (select |#memory_int#1_5| |main_~#x~0.base_4|) (+ (* main_~i~1_5 4) |main_~#x~0.offset_4|) |v_main_#t~nondet5_45_fresh_1|)) (= main_~i~1_6 (+ main_~i~1_5 1))) :named ssa_6))
(assert (! (and (<= 0 (+ |v_main_#t~nondet5_46_fresh_1| 2147483648)) (= |#memory_int#1_7| (store |#memory_int#1_6| |main_~#x~0.base_4| v_ArrVal_190_fresh_1)) (< main_~i~1_6 60) (= v_ArrVal_190_fresh_1 (store (select |#memory_int#1_6| |main_~#x~0.base_4|) (+ (* main_~i~1_6 4) |main_~#x~0.offset_4|) v_ArrVal_189_fresh_1)) (= v_ArrVal_189_fresh_1 |v_main_#t~nondet5_46_fresh_1|) (<= |v_main_#t~nondet5_46_fresh_1| 2147483647) (= main_~i~1_7 (+ main_~i~1_6 1))) :named ssa_7))
(assert (! (and (<= 0 (+ |v_main_#t~nondet5_47_fresh_1| 2147483648)) (< main_~i~1_7 60) (= |#memory_int#1_8| (store |#memory_int#1_7| |main_~#x~0.base_4| v_ArrVal_192_fresh_1)) (= v_ArrVal_192_fresh_1 (store (select |#memory_int#1_7| |main_~#x~0.base_4|) (+ (* main_~i~1_7 4) |main_~#x~0.offset_4|) v_ArrVal_191_fresh_1)) (<= |v_main_#t~nondet5_47_fresh_1| 2147483647) (= v_ArrVal_191_fresh_1 |v_main_#t~nondet5_47_fresh_1|) (= main_~i~1_8 (+ main_~i~1_7 1))) :named ssa_8))
(assert (! (and (= v_ArrVal_194_fresh_1 |v_main_#t~nondet5_48_fresh_1|) (< main_~i~1_8 60) (<= |v_main_#t~nondet5_48_fresh_1| 2147483647) (<= 0 (+ |v_main_#t~nondet5_48_fresh_1| 2147483648)) (= (store |#memory_int#1_8| |main_~#x~0.base_4| v_ArrVal_193_fresh_1) |#memory_int#1_9|) (= v_ArrVal_193_fresh_1 (store (select |#memory_int#1_8| |main_~#x~0.base_4|) (+ (* main_~i~1_8 4) |main_~#x~0.offset_4|) |v_main_#t~nondet5_48_fresh_1|)) (= main_~i~1_9 (+ main_~i~1_8 1))) :named ssa_9))
(assert (! (and (= v_ArrVal_196_fresh_1 |v_main_#t~nondet5_49_fresh_1|) (< main_~i~1_9 60) (= (store (select |#memory_int#1_9| |main_~#x~0.base_4|) (+ (* main_~i~1_9 4) |main_~#x~0.offset_4|) |v_main_#t~nondet5_49_fresh_1|) v_ArrVal_195_fresh_1) (= |#memory_int#1_10| (store |#memory_int#1_9| |main_~#x~0.base_4| v_ArrVal_195_fresh_1)) (<= |v_main_#t~nondet5_49_fresh_1| 2147483647) (<= 0 (+ |v_main_#t~nondet5_49_fresh_1| 2147483648)) (= main_~i~1_10 (+ main_~i~1_9 1))) :named ssa_10))
(assert (! (and (= v_ArrVal_198_fresh_1 (store (select |#memory_int#1_10| |main_~#x~0.base_4|) (+ (* main_~i~1_10 4) |main_~#x~0.offset_4|) v_ArrVal_197_fresh_1)) (< main_~i~1_10 60) (<= 0 (+ |v_main_#t~nondet5_50_fresh_1| 2147483648)) (<= |v_main_#t~nondet5_50_fresh_1| 2147483647) (= |#memory_int#1_11| (store |#memory_int#1_10| |main_~#x~0.base_4| v_ArrVal_198_fresh_1)) (= main_~i~1_11 (+ main_~i~1_10 1)) (= v_ArrVal_197_fresh_1 |v_main_#t~nondet5_50_fresh_1|)) :named ssa_11))
(assert (! (and (= (store |#memory_int#1_11| |main_~#x~0.base_4| v_ArrVal_200_fresh_1) |#memory_int#1_12|) (<= |v_main_#t~nondet5_51_fresh_1| 2147483647) (< main_~i~1_11 60) (= v_ArrVal_199_fresh_1 |v_main_#t~nondet5_51_fresh_1|) (= (store (select |#memory_int#1_11| |main_~#x~0.base_4|) (+ (* main_~i~1_11 4) |main_~#x~0.offset_4|) v_ArrVal_199_fresh_1) v_ArrVal_200_fresh_1) (<= 0 (+ |v_main_#t~nondet5_51_fresh_1| 2147483648)) (= main_~i~1_12 (+ main_~i~1_11 1))) :named ssa_12))
(assert (! (<= 60 main_~i~1_12) :named ssa_13))
(assert (! true :named ssa_14))
(assert (! true :named ssa_15_GlobVarAssigCall))
(assert (! (and (= |max_#in~x.base_15| |main_~#x~0.base_4|) (= |max_#in~x.offset_15| |main_~#x~0.offset_4|)) :named ssa_15_LocVarAssigCall))
(assert (! true :named ssa_15_OldVarAssigCall))
(assert (! (and (= |max_#in~x.base_15| max_~x.base_16) (= max_~i~0_16 0) (= max_~ret~0_16 0) (= max_~x.offset_16 |max_#in~x.offset_15|)) :named ssa_16))
(assert (! (and (= (select (select |#memory_int#1_12| max_~x.base_16) (+ max_~x.offset_16 (* max_~i~0_16 4))) |max_#t~mem1_17|) (< max_~i~0_16 60)) :named ssa_17))
(assert (! (and (< max_~ret~0_16 |max_#t~mem1_17|) (= (select (select |#memory_int#1_12| max_~x.base_16) (+ max_~x.offset_16 (* max_~i~0_16 4))) |v_max_#t~mem2_108_fresh_1|) (= |v_max_#t~mem2_108_fresh_1| |max_#t~ite3_18|)) :named ssa_18))
(assert (! (and (= max_~ret~0_19 |max_#t~ite3_18|) (= (+ max_~i~0_16 1) max_~i~0_19)) :named ssa_19))
(assert (! (and (= (select (select |#memory_int#1_12| max_~x.base_16) (+ max_~x.offset_16 (* max_~i~0_19 4))) |max_#t~mem1_20|) (< max_~i~0_19 60)) :named ssa_20))
(assert (! (and (< max_~ret~0_19 |max_#t~mem1_20|) (= (select (select |#memory_int#1_12| max_~x.base_16) (+ max_~x.offset_16 (* max_~i~0_19 4))) |v_max_#t~mem2_109_fresh_1|) (= |v_max_#t~mem2_109_fresh_1| |max_#t~ite3_21|)) :named ssa_21))
(assert (! (and (= max_~ret~0_22 |max_#t~ite3_21|) (= (+ max_~i~0_19 1) max_~i~0_22)) :named ssa_22))
(assert (! (<= 60 max_~i~0_22) :named ssa_23))
(assert (! (= |max_#res_24| (ite (<= (mod max_~ret~0_22 4294967296) 2147483647) (mod max_~ret~0_22 4294967296) (+ (mod max_~ret~0_22 4294967296) (- 4294967296)))) :named ssa_24))
(assert (! (= |main_#t~ret7_25| |max_#res_24|) :named ssa_25_return))
(assert (! (and (= (store |#memory_int#1_12| |main_~#x~0.base_4| v_ArrVal_202_fresh_1) |#memory_int#1_26|) (= |main_#t~ret7_25| main_~ret~1_26) (<= |main_#t~ret7_25| 2147483647) (= (select (select |#memory_int#1_12| |main_~#x~0.base_4|) |main_~#x~0.offset_4|) v_main_~temp~0_18_fresh_1) (= v_ArrVal_201_fresh_1 v_main_~temp~0_18_fresh_1) (= v_ArrVal_203_fresh_1 (select (select |#memory_int#1_12| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4))) (<= 0 (+ |main_#t~ret7_25| 2147483648)) (= v_ArrVal_202_fresh_1 (store (store (select |#memory_int#1_12| |main_~#x~0.base_4|) |main_~#x~0.offset_4| (select (select |#memory_int#1_12| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4))) (+ |main_~#x~0.offset_4| 4) v_ArrVal_201_fresh_1))) :named ssa_26))
...
(assert (! (and (= (select (select |#memory_int#1_26| max_~x.base_28) (+ max_~x.offset_28 (* max_~i~0_28 4))) |max_#t~mem1_29|) (< max_~i~0_28 60)) :named ssa_29))
(assert (! (and (< max_~ret~0_28 |max_#t~mem1_29|) (= |v_max_#t~mem2_110_fresh_1| |max_#t~ite3_30|) (= (select (select |#memory_int#1_26| max_~x.base_28) (+ max_~x.offset_28 (* max_~i~0_28 4))) |v_max_#t~mem2_110_fresh_1|)) :named ssa_30))
(assert (! (and (= max_~ret~0_31 |max_#t~ite3_30|) (= (+ max_~i~0_28 1) max_~i~0_31)) :named ssa_31))
(assert (! (and (= (select (select |#memory_int#1_26| max_~x.base_28) (+ max_~x.offset_28 (* max_~i~0_31 4))) |max_#t~mem1_32|) (< max_~i~0_31 60)) :named ssa_32))
(assert (! (and (= |v_max_#t~mem2_111_fresh_1| |max_#t~ite3_33|) (< max_~ret~0_31 |max_#t~mem1_32|) (= (select (select |#memory_int#1_26| max_~x.base_28) (+ max_~x.offset_28 (* max_~i~0_31 4))) |v_max_#t~mem2_111_fresh_1|)) :named ssa_33))
...
(assert (! (= |max_#res_36| |main_#t~ret10_37|) :named ssa_37_return))
(assert (! (and (<= |main_#t~ret10_37| 2147483647) (= (select (select |#memory_int#1_26| |main_~#x~0.base_4|) |main_~#x~0.offset_4|) main_~temp~0_38) (= main_~i~2_38 0) (= main_~ret2~0_38 |main_#t~ret10_37|) (<= 0 (+ |main_#t~ret10_37| 2147483648))) :named ssa_38))
(assert (! (and (= v_ArrVal_205_fresh_1 (select (select |#memory_int#1_26| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4 (* main_~i~2_38 4)))) (< main_~i~2_38 59) (= main_~i~2_39 (+ main_~i~2_38 1)) (= (store |#memory_int#1_26| |main_~#x~0.base_4| v_ArrVal_204_fresh_1) |#memory_int#1_39|) (= v_ArrVal_204_fresh_1 (store (select |#memory_int#1_26| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| (* main_~i~2_38 4)) (select (select |#memory_int#1_26| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4 (* main_~i~2_38 4)))))) :named ssa_39))
(assert (! (and (= v_ArrVal_207_fresh_1 (select (select |#memory_int#1_39| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4 (* main_~i~2_39 4)))) (= |#memory_int#1_40| (store |#memory_int#1_39| |main_~#x~0.base_4| v_ArrVal_206_fresh_1)) (< main_~i~2_39 59) (= main_~i~2_40 (+ main_~i~2_39 1)) (= v_ArrVal_206_fresh_1 (store (select |#memory_int#1_39| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| (* main_~i~2_39 4)) (select (select |#memory_int#1_39| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4 (* main_~i~2_39 4)))))) :named ssa_40))
(assert (! (<= 59 main_~i~2_40) :named ssa_41))
(assert (! (and (= v_ArrVal_208_fresh_1 main_~temp~0_38) (= v_ArrVal_209_fresh_1 (store (select |#memory_int#1_40| |main_~#x~0.base_4|) (+ 236 |main_~#x~0.offset_4|) v_ArrVal_208_fresh_1)) (= (store |#memory_int#1_40| |main_~#x~0.base_4| v_ArrVal_209_fresh_1) |#memory_int#1_42|)) :named ssa_42))
(assert (! true :named ssa_43_GlobVarAssigCall))
(assert (! (and (= |max_#in~x.offset_43| |main_~#x~0.offset_4|) (= |max_#in~x.base_43| |main_~#x~0.base_4|)) :named ssa_43_LocVarAssigCall))
...
(assert (! (and (< max_~ret~0_44 |max_#t~mem1_45|) (= (select (select |#memory_int#1_42| max_~x.base_44) (+ max_~x.offset_44 (* max_~i~0_44 4))) |v_max_#t~mem2_112_fresh_1|) (= |v_max_#t~mem2_112_fresh_1| |max_#t~ite3_46|)) :named ssa_46))
...
(assert (! (and (< max_~ret~0_47 |max_#t~mem1_48|) (= (select (select |#memory_int#1_42| max_~x.base_44) (+ max_~x.offset_44 (* max_~i~0_47 4))) |v_max_#t~mem2_113_fresh_1|) (= |v_max_#t~mem2_113_fresh_1| |max_#t~ite3_49|)) :named ssa_49))
...
(assert (! (= |max_#res_52| |main_#t~ret14_53|) :named ssa_53_return))
...
(declare-fun |v_max_#t~mem2_114_fresh_1| () Int)
...
(declare-fun |v_max_#t~mem2_115_fresh_1| () Int)
...
(assert (! (and (< max_~ret~0_0 |max_#t~mem1_1|) (= |v_max_#t~mem2_114_fresh_1| |max_#t~ite3_2|) (= (select (select |#memory_int#1_-2| max_~x.base_0) (+ max_~x.offset_0 (* max_~i~0_0 4))) |v_max_#t~mem2_114_fresh_1|)) :named ssa_2))
...
(assert (! (and (< max_~ret~0_3 |max_#t~mem1_4|) (= (select (select |#memory_int#1_-2| max_~x.base_0) (+ max_~x.offset_0 (* max_~i~0_3 4))) |v_max_#t~mem2_115_fresh_1|) (= |v_max_#t~mem2_115_fresh_1| |max_#t~ite3_5|)) :named ssa_5))
...
(declare-fun |max_#t~ite3_2| () Int)
(declare-fun |max_#t~mem1_2| () Int)
(declare-fun |v_max_#t~mem2_116_fresh_1| () Int)
(declare-fun max_~ret~0_3 () Int)
(declare-fun |max_#t~mem2_3| () Int)
(declare-fun |max_#t~ite3_3| () Int)
(declare-fun |max_#t~post4_3| () Int)
...
(declare-fun |max_#t~ite3_5| () Int)
(declare-fun |max_#t~mem1_5| () Int)
(declare-fun |v_max_#t~mem2_117_fresh_1| () Int)
(declare-fun max_~ret~0_6 () Int)
(declare-fun |max_#t~mem2_6| () Int)
(declare-fun |max_#t~ite3_6| () Int)
(declare-fun |max_#t~post4_6| () Int)
...
(assert (! (and (= |max_#in~x.base_-1| max_~x.base_0) (= max_~i~0_0 0) (= max_~ret~0_0 0) (= max_~x.offset_0 |max_#in~x.offset_-1|)) :named ssa_0))
(assert (! (and (= (select (select |#memory_int#1_-2| max_~x.base_0) (+ max_~x.offset_0 (* max_~i~0_0 4))) |max_#t~mem1_1|) (< max_~i~0_0 60)) :named ssa_1))
(assert (! (and (= |v_max_#t~mem2_116_fresh_1| |max_#t~ite3_2|) (= (select (select |#memory_int#1_-2| max_~x.base_0) (+ max_~x.offset_0 (* max_~i~0_0 4))) |v_max_#t~mem2_116_fresh_1|) (< max_~ret~0_0 |max_#t~mem1_1|)) :named ssa_2))
(assert (! (and (= max_~ret~0_3 |max_#t~ite3_2|) (= (+ max_~i~0_0 1) max_~i~0_3)) :named ssa_3))
(assert (! (and (= (select (select |#memory_int#1_-2| max_~x.base_0) (+ max_~x.offset_0 (* max_~i~0_3 4))) |max_#t~mem1_4|) (< max_~i~0_3 60)) :named ssa_4))
(assert (! (and (= |v_max_#t~mem2_117_fresh_1| |max_#t~ite3_5|) (< max_~ret~0_3 |max_#t~mem1_4|) (= (select (select |#memory_int#1_-2| max_~x.base_0) (+ max_~x.offset_0 (* max_~i~0_3 4))) |v_max_#t~mem2_117_fresh_1|)) :named ssa_5))
(assert (! (and (= max_~ret~0_6 |max_#t~ite3_5|) (= (+ max_~i~0_3 1) max_~i~0_6)) :named ssa_6))
(assert (! (<= 60 max_~i~0_6) :named ssa_7))
(assert (! (= |max_#res_8| (ite (<= (mod max_~ret~0_6 4294967296) 2147483647) (mod max_~ret~0_6 4294967296) (+ (mod max_~ret~0_6 4294967296) (- 4294967296)))) :named ssa_8))
...
(declare-fun |max_#t~ite3_2| () Int)
(declare-fun |max_#t~mem1_2| () Int)
(declare-fun |v_max_#t~mem2_118_fresh_1| () Int)
(declare-fun max_~ret~0_3 () Int)
(declare-fun |max_#t~mem2_3| () Int)
(declare-fun |max_#t~ite3_3| () Int)
(declare-fun |max_#t~post4_3| () Int)
...
(declare-fun |max_#t~ite3_5| () Int)
(declare-fun |max_#t~mem1_5| () Int)
(declare-fun |v_max_#t~mem2_119_fresh_1| () Int)
(declare-fun max_~ret~0_6 () Int)
(declare-fun |max_#t~mem2_6| () Int)
(declare-fun |max_#t~ite3_6| () Int)
(declare-fun |max_#t~post4_6| () Int)
...
(assert (! (and (= |max_#in~x.base_-1| max_~x.base_0) (= max_~i~0_0 0) (= max_~ret~0_0 0) (= max_~x.offset_0 |max_#in~x.offset_-1|)) :named ssa_0))
(assert (! (and (= (select (select |#memory_int#1_-2| max_~x.base_0) (+ max_~x.offset_0 (* max_~i~0_0 4))) |max_#t~mem1_1|) (< max_~i~0_0 60)) :named ssa_1))
(assert (! (and (= (select (select |#memory_int#1_-2| max_~x.base_0) (+ max_~x.offset_0 (* max_~i~0_0 4))) |v_max_#t~mem2_118_fresh_1|) (< max_~ret~0_0 |max_#t~mem1_1|) (= |v_max_#t~mem2_118_fresh_1| |max_#t~ite3_2|)) :named ssa_2))
(assert (! (and (= max_~ret~0_3 |max_#t~ite3_2|) (= (+ max_~i~0_0 1) max_~i~0_3)) :named ssa_3))
(assert (! (and (= (select (select |#memory_int#1_-2| max_~x.base_0) (+ max_~x.offset_0 (* max_~i~0_3 4))) |max_#t~mem1_4|) (< max_~i~0_3 60)) :named ssa_4))
(assert (! (and (= (select (select |#memory_int#1_-2| max_~x.base_0) (+ max_~x.offset_0 (* max_~i~0_3 4))) |v_max_#t~mem2_119_fresh_1|) (< max_~ret~0_3 |max_#t~mem1_4|) (= |v_max_#t~mem2_119_fresh_1| |max_#t~ite3_5|)) :named ssa_5))
(assert (! (and (= max_~ret~0_6 |max_#t~ite3_5|) (= (+ max_~i~0_3 1) max_~i~0_6)) :named ssa_6))
(assert (! (<= 60 max_~i~0_6) :named ssa_7))
(assert (! (= |max_#res_8| (ite (<= (mod max_~ret~0_6 4294967296) 2147483647) (mod max_~ret~0_6 4294967296) (+ (mod max_~ret~0_6 4294967296) (- 4294967296)))) :named ssa_8))
