...
(set-info :ultimate-id duplets.c_AllErrorsAtOnce_Iteration14)
...
(declare-fun c_aux_v_mkdup_~x~0_29 () Int)
...
(declare-fun c_aux_v_mkdup_~x~0_30 () Int)
...
(declare-fun |v_#Ultimate.meminit_#amountOfFieldsInParam_16_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#productInParam_16_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#ptr.offsetInParam_16_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#sizeOfFieldsInParam_16_fresh_1| () Int)
...
(declare-fun v_mkdup_~x~0_31_fresh_1 () Int)
...
(declare-fun |finddup_#t~post10_46| () Int)
(declare-fun finddup_~j~1_46 () Int)
(declare-fun |finddup_#t~mem9_46| () Int)
(declare-fun |finddup_#t~mem8_46| () Int)
(declare-fun finddup_~j~1_47 () Int)
(declare-fun |finddup_#t~post11_48| () Int)
(declare-fun finddup_~i~1_48 () Int)
(declare-fun finddup_~j~1_49 () Int)
(declare-fun finddup_~j~1_50 () Int)
(declare-fun |finddup_#t~post11_51| () Int)
(declare-fun finddup_~i~1_51 () Int)
(declare-fun finddup_~n_52 () Int)
(declare-fun finddup_~i~1_52 () Int)
(declare-fun |finddup_#res_53| () Int)
(declare-fun |main_#t~ret14_55| () Int)
(declare-fun |finddup_#res_55| () Int)
(declare-fun |main_#t~ret14_56| () Int)
(declare-fun main_~r~0_56 () Int)
(declare-fun |__VERIFIER_assert_#in~cond_57| () Int)
(declare-fun main_~r~0_57 () Int)
...
(assert (! (and (= v_ArrVal_239_fresh_1 (* 4 (mod main_~n~0_4 1073741824))) (= v_ArrVal_240_fresh_1 1) (not (= 0 |main_#t~malloc13.base_10|)) (= (store |#valid_3| |main_#t~malloc13.base_10| v_ArrVal_240_fresh_1) |#valid_10|) (< |main_#t~malloc13.base_10| |#StackHeapBarrier_-1|) (= |main_#t~malloc13.offset_10| 0) (= |#length_10| (store |#length_3| |main_#t~malloc13.base_10| v_ArrVal_239_fresh_1)) (= (select |#valid_3| |main_#t~malloc13.base_10|) 0)) :named ssa_10))
(assert (! (= |old(#memory_int#2)_11| |#memory_int#2_11|) :named ssa_11_GlobVarAssigCall))
(assert (! (and (= |v_#Ultimate.meminit_#productInParam_16_fresh_1| (* main_~n~0_4 4)) (= |v_#Ultimate.meminit_#ptr.offsetInParam_16_fresh_1| |main_#t~malloc13.offset_10|) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_16_fresh_1|) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_16_fresh_1| 4) (= |#Ultimate.meminit_#ptr.base_11| |main_#t~malloc13.base_10|)) :named ssa_11_LocVarAssigCall))
(assert (! (= |old(#memory_int#2)_11| |#memory_int#2_3|) :named ssa_11_OldVarAssigCall))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_241_fresh_1) (= |#memory_int#2_12| (store |#memory_int#2_11| |#Ultimate.meminit_#ptr.base_11| v_ArrVal_241_fresh_1))) :named ssa_12))
...
(assert (! (and (<= 0 (+ v_mkdup_~x~0_31_fresh_1 2147483648)) (<= v_mkdup_~x~0_31_fresh_1 2147483647) (= |#memory_int#2_32| (store |#memory_int#2_15| mkdup_~a.base_16 v_ArrVal_244_fresh_1)) (= v_ArrVal_243_fresh_1 v_mkdup_~x~0_31_fresh_1) (= v_ArrVal_242_fresh_1 v_mkdup_~x~0_31_fresh_1) (= v_ArrVal_244_fresh_1 (store (store (select |#memory_int#2_15| mkdup_~a.base_16) (+ (* mkdup_~i~0_16 4) mkdup_~a.offset_16) v_ArrVal_243_fresh_1) (+ mkdup_~a.offset_16 (* mkdup_~j~0_16 4)) v_ArrVal_242_fresh_1))) :named ssa_32))
(assert (! true :named ssa_33_return))
(assert (! (and (= |main_~#i~2.offset_34| 0) (= |#valid_34| (store (store |#valid_10| |main_~#i~2.base_34| v_ArrVal_246_fresh_1) |main_~#j~2.base_34| v_ArrVal_248_fresh_1)) (= |#length_34| (store (store |#length_10| |main_~#i~2.base_34| v_ArrVal_245_fresh_1) |main_~#j~2.base_34| v_ArrVal_247_fresh_1)) (= (select |#valid_10| |main_~#i~2.base_34|) 0) (= |main_~#j~2.offset_34| 0) (not (= |main_~#j~2.base_34| 0)) (< |#StackHeapBarrier_-1| |main_~#j~2.base_34|) (= v_ArrVal_245_fresh_1 4) (= v_ArrVal_248_fresh_1 1) (not (= |main_~#i~2.base_34| 0)) (= (select (store |#valid_10| |main_~#i~2.base_34| v_ArrVal_246_fresh_1) |main_~#j~2.base_34|) 0) (< |#StackHeapBarrier_-1| |main_~#i~2.base_34|) (= v_ArrVal_246_fresh_1 1) (= v_ArrVal_247_fresh_1 4)) :named ssa_34))
...
(assert (! (and (not (= |finddup_#t~mem8_45| |finddup_#t~mem9_45|)) (= finddup_~j~1_46 (+ finddup_~j~1_44 1))) :named ssa_46))
(assert (! (<= finddup_~n_36 finddup_~j~1_46) :named ssa_47))
(assert (! (= finddup_~i~1_48 (+ finddup_~i~1_43 1)) :named ssa_48))
(assert (! (and (< finddup_~i~1_48 finddup_~n_36) (= finddup_~j~1_49 (+ finddup_~i~1_48 1))) :named ssa_49))
(assert (! (<= finddup_~n_36 finddup_~j~1_49) :named ssa_50))
(assert (! (= finddup_~i~1_51 (+ finddup_~i~1_48 1)) :named ssa_51))
(assert (! (<= finddup_~n_36 finddup_~i~1_51) :named ssa_52))
(assert (! (= |finddup_#res_53| 0) :named ssa_53))
(assert (! true :named ssa_54))
(assert (! (= |main_#t~ret14_55| |finddup_#res_53|) :named ssa_55_return))
(assert (! (and (= main_~r~0_56 |main_#t~ret14_55|) (<= |main_#t~ret14_55| 2147483647) (<= 0 (+ |main_#t~ret14_55| 2147483648))) :named ssa_56))
(assert (! true :named ssa_57_GlobVarAssigCall))
(assert (! (= main_~r~0_56 |__VERIFIER_assert_#in~cond_57|) :named ssa_57_LocVarAssigCall))
...
(assert (! (not (= ((as const (Array Int Int)) 0) (select |#memory_int#2_0| |main_#t~malloc13.base_-2|))) :named ssa_postcond))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_249_fresh_1) (= |#memory_int#2_0| (store |#memory_int#2_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_249_fresh_1))) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! true :named ssa_-2_PendingContext))
...
(declare-fun v_mkdup_~x~0_32_fresh_1 () Int)
(assert (! (= |#memory_int#2_-1| |old(#memory_int#2)_-1|) :named ssa_precond))
(assert (! (not (and (or (= ((as const (Array Int Int)) 0) (store (select |#memory_int#2_16| main_~a~0.base_-2) (@diff (select |#memory_int#2_16| main_~a~0.base_-2) ((as const (Array Int Int)) 0)) 0)) (= (select (select |#memory_int#2_16| main_~a~0.base_-2) (@diff (store (select |#memory_int#2_16| main_~a~0.base_-2) (@diff (select |#memory_int#2_16| main_~a~0.base_-2) ((as const (Array Int Int)) 0)) 0) ((as const (Array Int Int)) 0))) (select (select |#memory_int#2_16| main_~a~0.base_-2) (@diff (select |#memory_int#2_16| main_~a~0.base_-2) ((as const (Array Int Int)) 0))))) (= ((as const (Array Int Int)) 0) (store (store (select |#memory_int#2_16| main_~a~0.base_-2) (@diff (select |#memory_int#2_16| main_~a~0.base_-2) ((as const (Array Int Int)) 0)) 0) (@diff (store (select |#memory_int#2_16| main_~a~0.base_-2) (@diff (select |#memory_int#2_16| main_~a~0.base_-2) ((as const (Array Int Int)) 0)) 0) ((as const (Array Int Int)) 0)) 0)))) :named ssa_postcond))
...
(assert (! (and (= v_ArrVal_251_fresh_1 (store (store (select |#memory_int#2_-1| mkdup_~a.base_0) (+ (* mkdup_~i~0_0 4) mkdup_~a.offset_0) v_mkdup_~x~0_32_fresh_1) (+ mkdup_~a.offset_0 (* mkdup_~j~0_0 4)) v_ArrVal_250_fresh_1)) (= |#memory_int#2_16| (store |#memory_int#2_-1| mkdup_~a.base_0 v_ArrVal_251_fresh_1)) (<= v_mkdup_~x~0_32_fresh_1 2147483647) (<= 0 (+ v_mkdup_~x~0_32_fresh_1 2147483648)) (= v_ArrVal_250_fresh_1 v_mkdup_~x~0_32_fresh_1) (= v_ArrVal_252_fresh_1 v_mkdup_~x~0_32_fresh_1)) :named ssa_16))
...
(declare-fun assume_abort_if_not_~cond_1 () Int)
(assert (! true :named ssa_precond))
(assert (! (not (and (= |#memory_int#2_-2| |old(#memory_int#2)_-2|) (= mkdup_~a.base_-2 |mkdup_#in~a.base_-2|))) :named ssa_postcond))
(assert (! (= |assume_abort_if_not_#in~cond_-1| assume_abort_if_not_~cond_0) :named ssa_0))
(assert (! (not (= assume_abort_if_not_~cond_0 0)) :named ssa_1))
(assert (! true :named ssa_2))
(assert (! true :named ssa_3_return))
(assert (! (and (= |#memory_int#2_-2| |old(#memory_int#2)_-2|) (= mkdup_~a.base_-2 |mkdup_#in~a.base_-2|)) :named ssa_-2_PendingContext))
...
(declare-fun |finddup_#t~post10_10| () Int)
(declare-fun finddup_~j~1_10 () Int)
(declare-fun |finddup_#t~mem9_10| () Int)
(declare-fun |finddup_#t~mem8_10| () Int)
(declare-fun finddup_~j~1_11 () Int)
(declare-fun |finddup_#t~post11_12| () Int)
(declare-fun finddup_~i~1_12 () Int)
(declare-fun finddup_~j~1_13 () Int)
(declare-fun finddup_~j~1_14 () Int)
(declare-fun |finddup_#t~post11_15| () Int)
(declare-fun finddup_~i~1_15 () Int)
(declare-fun finddup_~n_16 () Int)
(declare-fun finddup_~i~1_16 () Int)
(declare-fun |finddup_#res_17| () Int)
(declare-fun |main_#t~ret14_19| () Int)
(declare-fun |finddup_#res_19| () Int)
...
(assert (! (and (not (= |finddup_#t~mem8_9| |finddup_#t~mem9_9|)) (= finddup_~j~1_10 (+ finddup_~j~1_8 1))) :named ssa_10))
(assert (! (<= finddup_~n_0 finddup_~j~1_10) :named ssa_11))
(assert (! (= finddup_~i~1_12 (+ finddup_~i~1_7 1)) :named ssa_12))
(assert (! (and (< finddup_~i~1_12 finddup_~n_0) (= finddup_~j~1_13 (+ finddup_~i~1_12 1))) :named ssa_13))
(assert (! (<= finddup_~n_0 finddup_~j~1_13) :named ssa_14))
(assert (! (= finddup_~i~1_15 (+ finddup_~i~1_12 1)) :named ssa_15))
(assert (! (<= finddup_~n_0 finddup_~i~1_15) :named ssa_16))
(assert (! (= |finddup_#res_17| 0) :named ssa_17))
(assert (! true :named ssa_18))
(assert (! (= |main_#t~ret14_19| |finddup_#res_17|) :named ssa_19_return))
(assert (! (and (or (= ((as const (Array Int Int)) 0) (store (select |#memory_int#2_-2| main_~a~0.base_-2) (@diff (select |#memory_int#2_-2| main_~a~0.base_-2) ((as const (Array Int Int)) 0)) 0)) (= (select (select |#memory_int#2_-2| main_~a~0.base_-2) (@diff (store (select |#memory_int#2_-2| main_~a~0.base_-2) (@diff (select |#memory_int#2_-2| main_~a~0.base_-2) ((as const (Array Int Int)) 0)) 0) ((as const (Array Int Int)) 0))) (select (select |#memory_int#2_-2| main_~a~0.base_-2) (@diff (select |#memory_int#2_-2| main_~a~0.base_-2) ((as const (Array Int Int)) 0))))) (= ((as const (Array Int Int)) 0) (store (store (select |#memory_int#2_-2| main_~a~0.base_-2) (@diff (select |#memory_int#2_-2| main_~a~0.base_-2) ((as const (Array Int Int)) 0)) 0) (@diff (store (select |#memory_int#2_-2| main_~a~0.base_-2) (@diff (select |#memory_int#2_-2| main_~a~0.base_-2) ((as const (Array Int Int)) 0)) 0) ((as const (Array Int Int)) 0)) 0))) :named ssa_-2_PendingContext))
