...
(set-info :ultimate-id nested_5.c_AllErrorsAtOnce_Iteration9)
...
(assert (! (<= 6 main_~c~0_19) :named ssa_20))
(assert (! (= (+ main_~b~0_5 1) main_~b~0_21) :named ssa_21))
(assert (! (<= 6 main_~b~0_21) :named ssa_22))
(assert (! (= (+ main_~a~0_4 1) main_~a~0_23) :named ssa_23))
(assert (! (<= 6 main_~a~0_23) :named ssa_24))
(assert (! (or (not (= main_~d~0_17 6)) (not (= main_~b~0_21 6)) (not (= main_~a~0_23 6)) (not (= main_~e~0_15 6)) (not (= main_~c~0_19 6))) :named ssa_25))
