...
(set-info :ultimate-id id_i20_o20-1.c_AllErrorsAtOnce_Iteration6)
...
(declare-fun main_~result~0_41 () Int)
...
(assert (! (= |id_#res_37| |main_#t~ret5_39|) :named ssa_39_return))
(assert (! (and (<= 0 (+ |main_#t~ret5_39| 2147483648)) (= main_~result~0_40 |main_#t~ret5_39|) (<= |main_#t~ret5_39| 2147483647)) :named ssa_40))
(assert (! (not (= main_~result~0_40 20)) :named ssa_41))
(assert (! true :named ssa_42))
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 (and ssa_13 ssa_14_OldVarAssigCall ssa_17_LocVarAssigCall ssa_5_LocVarAssigCall ssa_31 ssa_5_GlobVarAssigCall ssa_7 ssa_16 ssa_6 ssa_26 ssa_34 ssa_17_GlobVarAssigCall ssa_8_GlobVarAssigCall ssa_11_LocVarAssigCall ssa_14_LocVarAssigCall ssa_27_return ssa_10 ssa_9 ssa_25 ssa_39_return ssa_14_GlobVarAssigCall ssa_20_GlobVarAssigCall ssa_20_OldVarAssigCall ssa_24_return ssa_19 ssa_37 ssa_17_OldVarAssigCall ssa_20_LocVarAssigCall ssa_38 ssa_12 ssa_11_OldVarAssigCall ssa_32 ssa_5_OldVarAssigCall ssa_8_OldVarAssigCall ssa_28 ssa_22 ssa_15 ssa_29 ssa_21 ssa_30_return ssa_11_GlobVarAssigCall ssa_33_return ssa_18 ssa_23 ssa_36_return ssa_35 ssa_8_LocVarAssigCall) ssa_40 ssa_41 (and ssa_postcond ssa_42))
...
(assert (! (and (<= |id_#t~ret4_30| 2147483647) (= |id_#res_31| (+ |id_#t~ret4_30| 1)) (<= 0 (+ |id_#t~ret4_30| 2147483648))) :named ssa_31))
(assert (! true :named ssa_32))
(assert (! (= |id_#res_31| |main_#t~ret5_33|) :named ssa_33_return))
