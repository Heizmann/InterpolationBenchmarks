...
(set-info :ultimate-id watermelon.c_AllErrorsAtOnce_Iteration20)
...
(declare-fun v_main_~is_divisible1~0_25_fresh_1 () Int)
(declare-fun v_main_~is_divisible2~0_25_fresh_1 () Int)
...
(assert (! (and (= ~true~0_1 v_main_~is_divisible2~0_25_fresh_1) (= ~true~0_1 v_main_~is_divisible1~0_25_fresh_1)) :named ssa_4))
...
(assert (! (= correct_version_~i~0_12 correct_version_~w_7) :named ssa_14))
(assert (! true :named ssa_15))
(assert (! (= |correct_version_#res_16| correct_version_~is_divisible~0_7) :named ssa_16))
...
(assert (! (and (= (+ 2 student_version_~i~1_25) student_version_~i~1_26) (< student_version_~i~1_25 student_version_~w_20)) :named ssa_26))
(assert (! (<= student_version_~w_20 student_version_~i~1_26) :named ssa_27))
(assert (! (and (not (= student_version_~w_20 student_version_~i~1_26)) (= ~false~0_1 student_version_~is_divisible~1_28)) :named ssa_28))
(assert (! true :named ssa_29))
(assert (! (= student_version_~is_divisible~1_28 |student_version_#res_30|) :named ssa_30))
...
(assert (! (= (ite (= main_~is_divisible1~0_18 main_~is_divisible2~0_32) 1 0) |__VERIFIER_assert_#in~cond_33|) :named ssa_33_LocVarAssigCall))
...
(assert (! true :named ssa_precond))
(assert (! (not (or (< (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647) main_~w~0_-2) (< main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 9)))) :named ssa_postcond))
...
(assert (! (= correct_version_~i~0_5 correct_version_~w_0) :named ssa_7))
(assert (! true :named ssa_8))
(assert (! (= |correct_version_#res_9| correct_version_~is_divisible~0_0) :named ssa_9))
...
(assert (! (or (< (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647) main_~w~0_-2) (< main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 9))) :named ssa_-2_PendingContext))
