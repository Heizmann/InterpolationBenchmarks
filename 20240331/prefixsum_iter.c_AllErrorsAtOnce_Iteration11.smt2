...
(set-info :ultimate-id prefixsum_iter.c_AllErrorsAtOnce_Iteration11)
...
(declare-fun |v_#Ultimate.meminit_#amountOfFieldsInParam_25_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#productInParam_25_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#ptr.offsetInParam_25_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#sizeOfFieldsInParam_25_fresh_1| () Int)
...
(declare-fun |v_#Ultimate.meminit_#amountOfFieldsInParam_26_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#ptr.offsetInParam_26_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#productInParam_26_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#sizeOfFieldsInParam_26_fresh_1| () Int)
...
(assert (! (and (= (store |#length_3| |main_#t~malloc15.base_21| v_ArrVal_184_fresh_1) |#length_21|) (not (= |main_#t~malloc15.base_21| 0)) (< |main_#t~malloc15.base_21| |#StackHeapBarrier_-1|) (= |main_#t~malloc15.offset_21| 0) (= |#valid_21| (store |#valid_3| |main_#t~malloc15.base_21| v_ArrVal_183_fresh_1)) (= v_ArrVal_184_fresh_1 (* (mod main_~n~0_4 1073741824) 4)) (= (select |#valid_3| |main_#t~malloc15.base_21|) 0) (= v_ArrVal_183_fresh_1 1)) :named ssa_21))
(assert (! (= |old(#memory_int#1)_22| |#memory_int#1_22|) :named ssa_22_GlobVarAssigCall))
(assert (! (and (= |#Ultimate.meminit_#ptr.base_22| |main_#t~malloc15.base_21|) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_25_fresh_1| 4) (= (* main_~n~0_4 4) |v_#Ultimate.meminit_#productInParam_25_fresh_1|) (= |v_#Ultimate.meminit_#ptr.offsetInParam_25_fresh_1| |main_#t~malloc15.offset_21|) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_25_fresh_1|)) :named ssa_22_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_22| |#memory_int#1_3|) :named ssa_22_OldVarAssigCall))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_185_fresh_1) (= |#memory_int#1_23| (store |#memory_int#1_22| |#Ultimate.meminit_#ptr.base_22| v_ArrVal_185_fresh_1))) :named ssa_23))
(assert (! true :named ssa_24_return))
(assert (! (and (= (select |#valid_21| |main_#t~malloc16.base_25|) 0) (= v_ArrVal_186_fresh_1 1) (not (= |main_#t~malloc16.base_25| 0)) (= v_ArrVal_187_fresh_1 (* (mod main_~n~0_4 1073741824) 4)) (= |#length_25| (store |#length_21| |main_#t~malloc16.base_25| v_ArrVal_187_fresh_1)) (= (store |#valid_21| |main_#t~malloc16.base_25| v_ArrVal_186_fresh_1) |#valid_25|) (= |main_#t~malloc16.offset_25| 0) (= main_~a~0.offset_25 |main_#t~malloc15.offset_21|) (= main_~a~0.base_25 |main_#t~malloc15.base_21|) (< |main_#t~malloc16.base_25| |#StackHeapBarrier_-1|)) :named ssa_25))
(assert (! (= |old(#memory_int#1)_26| |#memory_int#1_26|) :named ssa_26_GlobVarAssigCall))
(assert (! (and (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_26_fresh_1|) (= (* main_~n~0_4 4) |v_#Ultimate.meminit_#productInParam_26_fresh_1|) (= |v_#Ultimate.meminit_#ptr.offsetInParam_26_fresh_1| |main_#t~malloc16.offset_25|) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_26_fresh_1| 4) (= |#Ultimate.meminit_#ptr.base_26| |main_#t~malloc16.base_25|)) :named ssa_26_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_26| |#memory_int#1_23|) :named ssa_26_OldVarAssigCall))
(assert (! (and (= |#memory_int#1_27| (store |#memory_int#1_26| |#Ultimate.meminit_#ptr.base_26| v_ArrVal_188_fresh_1)) (= ((as const (Array Int Int)) 0) v_ArrVal_188_fresh_1)) :named ssa_27))
...
(assert (! (and (< main_~i~1_29 main_~n~0_4) (= v_ArrVal_189_fresh_1 (select (select |#memory_int#1_27| main_~a~0.base_25) (+ main_~a~0.offset_25 (* main_~i~1_29 4)))) (= |#memory_int#1_30| (store |#memory_int#1_27| main_~a0~0.base_29 v_ArrVal_190_fresh_1)) (= v_ArrVal_190_fresh_1 (store (select |#memory_int#1_27| main_~a0~0.base_29) (+ main_~a0~0.offset_29 (* main_~i~1_29 4)) v_ArrVal_189_fresh_1)) (= main_~i~1_30 (+ main_~i~1_29 1))) :named ssa_30))
(assert (! (and (< main_~i~1_30 main_~n~0_4) (= v_ArrVal_192_fresh_1 (store (select |#memory_int#1_30| main_~a0~0.base_29) (+ main_~a0~0.offset_29 (* main_~i~1_30 4)) v_ArrVal_191_fresh_1)) (= |#memory_int#1_31| (store |#memory_int#1_30| main_~a0~0.base_29 v_ArrVal_192_fresh_1)) (= v_ArrVal_191_fresh_1 (select (select |#memory_int#1_30| main_~a~0.base_25) (+ main_~a~0.offset_25 (* main_~i~1_30 4)))) (= main_~i~1_31 (+ main_~i~1_30 1))) :named ssa_31))
(assert (! (and (< main_~i~1_31 main_~n~0_4) (= v_ArrVal_193_fresh_1 (select (select |#memory_int#1_31| main_~a~0.base_25) (+ main_~a~0.offset_25 (* main_~i~1_31 4)))) (= |#memory_int#1_32| (store |#memory_int#1_31| main_~a0~0.base_29 v_ArrVal_194_fresh_1)) (= v_ArrVal_194_fresh_1 (store (select |#memory_int#1_31| main_~a0~0.base_29) (+ main_~a0~0.offset_29 (* main_~i~1_31 4)) v_ArrVal_193_fresh_1)) (= main_~i~1_32 (+ main_~i~1_31 1))) :named ssa_32))
...
(assert (! (and (= (store (select |#memory_int#1_34| upsweep_~a.base_35) (+ (* upsweep_~left~0_36 4) upsweep_~a.offset_35 (* upsweep_~space~0_35 4)) (+ (select (select |#memory_int#1_34| upsweep_~a.base_35) (+ (* upsweep_~left~0_36 4) upsweep_~a.offset_35)) (select (select |#memory_int#1_34| upsweep_~a.base_35) (+ (* upsweep_~left~0_36 4) upsweep_~a.offset_35 (* upsweep_~space~0_35 4))))) v_ArrVal_195_fresh_1) (< upsweep_~left~0_36 upsweep_~n_35) (= (store |#memory_int#1_34| upsweep_~a.base_35 v_ArrVal_195_fresh_1) |#memory_int#1_37|) (= v_ArrVal_196_fresh_1 (+ (select (select |#memory_int#1_34| upsweep_~a.base_35) (+ (* upsweep_~left~0_36 4) upsweep_~a.offset_35)) (select (select |#memory_int#1_34| upsweep_~a.base_35) (+ (* upsweep_~left~0_36 4) upsweep_~a.offset_35 (* upsweep_~space~0_35 4))))) (= (+ (* 2 upsweep_~space~0_35) upsweep_~left~0_36) upsweep_~left~0_37)) :named ssa_37))
...
(assert (! (and (= |downsweep_#in~a.base_44| main_~a~0.base_25) (= main_~n~0_4 |downsweep_#in~n_44|) (= |downsweep_#in~space_44| main_~space~1_43) (= main_~a~0.offset_25 |downsweep_#in~a.offset_44|)) :named ssa_44_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_44| |#memory_int#1_37|) :named ssa_44_OldVarAssigCall))
(assert (! (and (= downsweep_~space_45 (ite (and (not (= (mod |downsweep_#in~space_44| 2) 0)) (< |downsweep_#in~space_44| 0)) (+ (div |downsweep_#in~space_44| 2) 1) (div |downsweep_#in~space_44| 2))) (= downsweep_~a.base_45 |downsweep_#in~a.base_44|) (= |#memory_int#1_45| (store |#memory_int#1_44| downsweep_~a.base_45 v_ArrVal_198_fresh_1)) (= downsweep_~a.offset_45 |downsweep_#in~a.offset_44|) (= v_ArrVal_198_fresh_1 (store (select |#memory_int#1_44| downsweep_~a.base_45) (+ downsweep_~a.offset_45 (- 4) (* downsweep_~n_45 4)) v_ArrVal_197_fresh_1)) (= v_ArrVal_197_fresh_1 0) (= downsweep_~n_45 |downsweep_#in~n_44|)) :named ssa_45))
(assert (! (and (< 0 downsweep_~space_45) (= (+ downsweep_~right~1_46 1) (* 2 downsweep_~space_45))) :named ssa_46))
(assert (! (and (= v_ArrVal_201_fresh_1 (select (select |#memory_int#1_45| downsweep_~a.base_45) (+ downsweep_~a.offset_45 (* downsweep_~right~1_46 4)))) (< downsweep_~right~1_46 downsweep_~n_45) (= v_ArrVal_200_fresh_1 (+ (select (select |#memory_int#1_45| downsweep_~a.base_45) (+ downsweep_~a.offset_45 (* downsweep_~right~1_46 4))) (select (select |#memory_int#1_45| downsweep_~a.base_45) (+ downsweep_~a.offset_45 (* downsweep_~right~1_46 4) (* downsweep_~space_45 (- 4)))))) (= v_ArrVal_199_fresh_1 (store (store (select |#memory_int#1_45| downsweep_~a.base_45) (+ downsweep_~a.offset_45 (* downsweep_~right~1_46 4)) (+ (select (select |#memory_int#1_45| downsweep_~a.base_45) (+ downsweep_~a.offset_45 (* downsweep_~right~1_46 4))) (select (select |#memory_int#1_45| downsweep_~a.base_45) (+ downsweep_~a.offset_45 (* downsweep_~right~1_46 4) (* downsweep_~space_45 (- 4)))))) (+ downsweep_~a.offset_45 (* downsweep_~right~1_46 4) (* downsweep_~space_45 (- 4))) (select (select |#memory_int#1_45| downsweep_~a.base_45) (+ downsweep_~a.offset_45 (* downsweep_~right~1_46 4))))) (= downsweep_~right~1_47 (+ (* 2 downsweep_~space_45) downsweep_~right~1_46)) (= (store |#memory_int#1_45| downsweep_~a.base_45 v_ArrVal_199_fresh_1) |#memory_int#1_47|)) :named ssa_47))
...
(assert (! (not true) :named ssa_postcond))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_202_fresh_1) (= (store |#memory_int#1_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_202_fresh_1) |#memory_int#1_0|)) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! true :named ssa_-2_PendingContext))
...
(assert (! (= |#memory_int#1_-1| |old(#memory_int#1)_-1|) :named ssa_precond))
(assert (! (not true) :named ssa_postcond))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_203_fresh_1) (= (store |#memory_int#1_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_203_fresh_1) |#memory_int#1_0|)) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! true :named ssa_-2_PendingContext))
...
(assert (! (and (= v_ArrVal_205_fresh_1 (+ (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0)) (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0 (* upsweep_~space~0_0 4))))) (< upsweep_~left~0_1 upsweep_~n_0) (= (+ (* 2 upsweep_~space~0_0) upsweep_~left~0_1) upsweep_~left~0_2) (= |#memory_int#1_2| (store |#memory_int#1_-1| upsweep_~a.base_0 v_ArrVal_204_fresh_1)) (= (store (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0 (* upsweep_~space~0_0 4)) (+ (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0)) (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0 (* upsweep_~space~0_0 4))))) v_ArrVal_204_fresh_1)) :named ssa_2))
...
(assert (! (= |#memory_int#1_-1| |old(#memory_int#1)_-1|) :named ssa_precond))
(assert (! (not false) :named ssa_postcond))
(assert (! (and (= downsweep_~space_0 (ite (and (not (= (mod |downsweep_#in~space_-1| 2) 0)) (< |downsweep_#in~space_-1| 0)) (+ (div |downsweep_#in~space_-1| 2) 1) (div |downsweep_#in~space_-1| 2))) (= downsweep_~a.base_0 |downsweep_#in~a.base_-1|) (= downsweep_~a.offset_0 |downsweep_#in~a.offset_-1|) (= v_ArrVal_207_fresh_1 (store (select |#memory_int#1_-1| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (- 4) (* downsweep_~n_0 4)) v_ArrVal_206_fresh_1)) (= downsweep_~n_0 |downsweep_#in~n_-1|) (= (store |#memory_int#1_-1| downsweep_~a.base_0 v_ArrVal_207_fresh_1) |#memory_int#1_0|) (= v_ArrVal_206_fresh_1 0)) :named ssa_0))
(assert (! (and (< 0 downsweep_~space_0) (= (+ downsweep_~right~1_1 1) (* 2 downsweep_~space_0))) :named ssa_1))
(assert (! (and (= v_ArrVal_210_fresh_1 (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4)))) (= (store |#memory_int#1_0| downsweep_~a.base_0 v_ArrVal_208_fresh_1) |#memory_int#1_2|) (= v_ArrVal_209_fresh_1 (+ (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4))) (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4) (* downsweep_~space_0 (- 4)))))) (< downsweep_~right~1_1 downsweep_~n_0) (= v_ArrVal_208_fresh_1 (store (store (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4)) (+ (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4))) (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4) (* downsweep_~space_0 (- 4)))))) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4) (* downsweep_~space_0 (- 4))) (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4))))) (= downsweep_~right~1_2 (+ (* 2 downsweep_~space_0) downsweep_~right~1_1))) :named ssa_2))
