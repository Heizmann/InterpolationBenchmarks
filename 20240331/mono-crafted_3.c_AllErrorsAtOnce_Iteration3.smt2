...
(set-info :ultimate-id mono-crafted_3.c_AllErrorsAtOnce_Iteration3)
...
(assert (! (and (= main_~x~0_4 |v_main_#t~post4_3_fresh_1|) (< main_~x~0_4 500000) (= main_~x~0_6 (+ |v_main_#t~post4_3_fresh_1| 1))) :named ssa_6))
(assert (! (<= 1000000 main_~x~0_6) :named ssa_7))
(assert (! (<= main_~y~0_4 0) :named ssa_8))
(assert (! true :named ssa_9_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_9| (ite (= main_~x~0_6 main_~z~0_4) 1 0)) :named ssa_9_LocVarAssigCall))
