...
(set-info :ultimate-id nested_6.c_AllErrorsAtOnce_Iteration3)
...
(declare-fun |main_#t~pre8_8| () Int)
(declare-fun main_~b~0_8 () Int)
(declare-fun |main_#t~pre9_10| () Int)
(declare-fun main_~a~0_10 () Int)
...
(assert (! (<= 6 main_~c~0_6) :named ssa_7))
(assert (! (= main_~b~0_8 (+ main_~b~0_5 1)) :named ssa_8))
(assert (! (<= 6 main_~b~0_8) :named ssa_9))
(assert (! (= main_~a~0_10 (+ main_~a~0_4 1)) :named ssa_10))
(assert (! (<= 6 main_~a~0_10) :named ssa_11))
(assert (! (or (not (= main_~c~0_6 6)) (not (= main_~d~0_4 6)) (not (= main_~a~0_10 6)) (not (= main_~f~0_4 6)) (not (= main_~e~0_4 6)) (not (= main_~b~0_8 6))) :named ssa_12))
