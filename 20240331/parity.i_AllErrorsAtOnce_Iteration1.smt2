...
(set-info :ultimate-id parity.i_AllErrorsAtOnce_Iteration1)
...
(declare-fun v_main_~parity2~0_8_fresh_1 () Int)
...
(assert (! (and (= main_~v2~0_6 main_~v~0_4) (= v_main_~parity2~0_8_fresh_1 0)) :named ssa_6))
