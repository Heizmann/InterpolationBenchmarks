...
(set-info :ultimate-id nr4.c_AllErrorsAtOnce_Iteration2)
...
(assert (! (and (= (store |#length_3| |main_~#volArray~0.base_5| v_ArrVal_3_fresh_1) |#length_5|) (= v_ArrVal_4_fresh_1 1) (= (store |#valid_3| |main_~#volArray~0.base_5| v_ArrVal_4_fresh_1) |#valid_5|) (< |#StackHeapBarrier_-1| |main_~#volArray~0.base_5|) (= |main_~#volArray~0.offset_5| 0) (= (* (mod ~CELLCOUNT~0_4 1073741824) 4) v_ArrVal_3_fresh_1) (not (= |main_~#volArray~0.base_5| 0)) (= 0 (select |#valid_3| |main_~#volArray~0.base_5|)) (= main_~MINVAL~0_5 2) (< 1 ~CELLCOUNT~0_4)) :named ssa_5))
...
(assert (! (and (< main_~i~0_14 ~CELLCOUNT~0_4) (or (and (not |main_#t~short9_15|) (< |v_main_#t~mem7_7_fresh_1| main_~MINVAL~0_5)) (and |main_#t~short9_15| (<= main_~MINVAL~0_5 |v_main_#t~mem7_7_fresh_1|))) (= (select (select |#memory_int#1_3| |main_~#volArray~0.base_5|) (+ (* main_~i~0_14 4) |main_~#volArray~0.offset_5|)) |v_main_#t~mem7_7_fresh_1|)) :named ssa_15))
