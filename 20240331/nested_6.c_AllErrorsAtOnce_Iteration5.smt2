...
(set-info :ultimate-id nested_6.c_AllErrorsAtOnce_Iteration5)
...
(declare-fun |main_#t~pre7_12| () Int)
(declare-fun main_~c~0_12 () Int)
(declare-fun |main_#t~pre8_14| () Int)
(declare-fun main_~b~0_14 () Int)
(declare-fun |main_#t~pre9_16| () Int)
...
(assert (! (<= 6 main_~e~0_8) :named ssa_9))
(assert (! (= main_~d~0_10 (+ main_~d~0_7 1)) :named ssa_10))
(assert (! (<= 6 main_~d~0_10) :named ssa_11))
(assert (! (= (+ main_~c~0_6 1) main_~c~0_12) :named ssa_12))
(assert (! (<= 6 main_~c~0_12) :named ssa_13))
(assert (! (= main_~b~0_14 (+ main_~b~0_5 1)) :named ssa_14))
(assert (! (<= 6 main_~b~0_14) :named ssa_15))
(assert (! (= main_~a~0_16 (+ main_~a~0_4 1)) :named ssa_16))
(assert (! (<= 6 main_~a~0_16) :named ssa_17))
(assert (! (or (not (= main_~c~0_12 6)) (not (= main_~d~0_10 6)) (not (= main_~a~0_16 6)) (not (= main_~f~0_4 6)) (not (= main_~e~0_8 6)) (not (= main_~b~0_14 6))) :named ssa_18))
