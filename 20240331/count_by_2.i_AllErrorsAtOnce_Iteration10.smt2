...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration10)
...
(assert (! (<= 1000000 main_~i~0_13) :named ssa_14))
(assert (! true :named ssa_15_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_15| (ite (= main_~i~0_13 1000000) 1 0)) :named ssa_15_LocVarAssigCall))
