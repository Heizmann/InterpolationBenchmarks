...
(set-info :ultimate-id mono-crafted_11.c_AllErrorsAtOnce_Iteration2)
...
(assert (! (<= 100000000 (mod main_~x~0_4 4294967296)) :named ssa_5))
(assert (! true :named ssa_6_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_6| (ite (= (mod main_~x~0_4 2) 0) 1 0)) :named ssa_6_LocVarAssigCall))
