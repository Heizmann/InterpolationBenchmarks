...
(set-info :ultimate-id eq1.c_AllErrorsAtOnce_Iteration1)
...
(assert (! (= (ite (and (= (mod main_~y~0_4 4294967296) (mod main_~z~0_4 4294967296)) (= (mod main_~w~0_4 4294967296) (mod main_~x~0_4 4294967296))) 1 0) |__VERIFIER_assert_#in~cond_6|) :named ssa_6_LocVarAssigCall))
