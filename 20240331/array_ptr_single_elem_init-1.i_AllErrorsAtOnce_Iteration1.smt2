...
(set-info :ultimate-id array_ptr_single_elem_init-1.i_AllErrorsAtOnce_Iteration1)
...
(declare-fun |v_main_#t~malloc6.base_4_fresh_1| () Int)
...
(declare-fun |v_main_#t~mem8_5_fresh_1| () Int)
...
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_2_fresh_1) (= |#memory_$Pointer$#1.offset_1| (store |#memory_$Pointer$#1.offset_0| |~#a~0.base_1| v_ArrVal_2_fresh_1)) (= ((as const (Array Int Int)) 0) v_ArrVal_1_fresh_1) (< 0 |#StackHeapBarrier_-1|) (= (select |#valid_-1| 0) 0) (= 31 (select |#length_-1| 2)) (= (select |#valid_-1| 2) 1) (= |~#a~0.base_1| 3) (= (select |#valid_-1| 3) 1) (= |~#a~0.offset_1| 0) (= (select |#valid_-1| 1) 1) (= (store |#memory_$Pointer$#1.base_0| |~#a~0.base_1| v_ArrVal_1_fresh_1) |#memory_$Pointer$#1.base_1|) (= (select (select |#memory_int#0_-1| 1) 1) 0) (= 2 (select |#length_-1| 1)) (= (select |#length_-1| 3) 400000) (= (select (select |#memory_int#0_-1| 1) 0) 48)) :named ssa_1))
...
(assert (! (and (< |v_main_#t~malloc6.base_4_fresh_1| |#StackHeapBarrier_-1|) (not (= 0 |v_main_#t~malloc6.base_4_fresh_1|)) (= (store (select |#memory_$Pointer$#1.offset_3| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12) 0) v_ArrVal_3_fresh_1) (= |#length_6| (store |#length_3| |v_main_#t~malloc6.base_4_fresh_1| v_ArrVal_5_fresh_1)) (= (select (select |#memory_int#1_6| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12)) v_ArrVal_10_fresh_1) (= |#valid_6| (store |#valid_3| |v_main_#t~malloc6.base_4_fresh_1| v_ArrVal_6_fresh_1)) (= (store (select |#memory_int#1_3| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12) (select (select |#memory_int#1_6| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12))) v_ArrVal_9_fresh_1) (= (store |#memory_$Pointer$#1.offset_3| |~#a~0.base_1| v_ArrVal_3_fresh_1) |#memory_$Pointer$#1.offset_6|) (= (store (select |#memory_$Pointer$#1.base_3| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12) v_ArrVal_4_fresh_1) v_ArrVal_7_fresh_1) (= (store |#memory_$Pointer$#1.base_3| |~#a~0.base_1| v_ArrVal_7_fresh_1) |#memory_$Pointer$#1.base_6|) (= main_~i~0_6 0) (= v_ArrVal_8_fresh_1 0) (= v_ArrVal_4_fresh_1 |v_main_#t~malloc6.base_4_fresh_1|) (= (store |#memory_int#1_3| |~#a~0.base_1| v_ArrVal_9_fresh_1) |#memory_int#1_6|) (= v_ArrVal_6_fresh_1 1) (= (select |#valid_3| |v_main_#t~malloc6.base_4_fresh_1|) 0) (= 8 v_ArrVal_5_fresh_1)) :named ssa_6))
...
(assert (! (and (or (and (not (= |v_main_#t~mem8_5_fresh_1| 0)) (not |main_#t~short9_8|)) (and |main_#t~short9_8| (= |v_main_#t~mem8_5_fresh_1| 0))) |main_#t~short9_7| (= (select (select |#memory_int#2_3| main_~s1~0.base_7) (+ main_~s1~0.offset_7 4)) |v_main_#t~mem8_5_fresh_1|)) :named ssa_8))
...
(assert (! (and (< 0 |#StackHeapBarrier_-1|) (= (select |#valid_-2| 0) 0) (= 31 (select |#length_-2| 2)) (= (select |#valid_-2| 2) 1) (= |~#a~0.base_0| 3) (= (select |#valid_-2| 3) 1) (= ((as const (Array Int Int)) 0) v_ArrVal_12_fresh_1) (= |~#a~0.offset_0| 0) (= (select |#valid_-2| 1) 1) (= ((as const (Array Int Int)) 0) v_ArrVal_11_fresh_1) (= (store |#memory_$Pointer$#1.base_-1| |~#a~0.base_0| v_ArrVal_11_fresh_1) |#memory_$Pointer$#1.base_0|) (= (select (select |#memory_int#0_-2| 1) 1) 0) (= 2 (select |#length_-2| 1)) (= (select |#length_-2| 3) 400000) (= |#memory_$Pointer$#1.offset_0| (store |#memory_$Pointer$#1.offset_-1| |~#a~0.base_0| v_ArrVal_12_fresh_1)) (= (select (select |#memory_int#0_-2| 1) 0) 48)) :named ssa_0))
