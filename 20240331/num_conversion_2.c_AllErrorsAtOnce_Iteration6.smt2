...
(set-info :ultimate-id num_conversion_2.c_AllErrorsAtOnce_Iteration6)
...
(assert (! (<= 8 (mod main_~c~0_25 256)) :named ssa_26))
(assert (! true :named ssa_27_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_27| (ite (= (mod main_~x~0_4 256) (mod main_~y~0_4 256)) 1 0)) :named ssa_27_LocVarAssigCall))
