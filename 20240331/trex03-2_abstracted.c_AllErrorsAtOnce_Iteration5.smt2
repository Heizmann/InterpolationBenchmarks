...
(set-info :ultimate-id trex03-2_abstracted.c_AllErrorsAtOnce_Iteration5)
...
(declare-fun v_main_~d1~0_7_fresh_1 () Int)
(declare-fun v_main_~d2~0_7_fresh_1 () Int)
(declare-fun v_main_~d3~0_7_fresh_1 () Int)
...
(assert (! (and (= 1 v_main_~d3~0_7_fresh_1) (= 1 v_main_~d2~0_7_fresh_1) (= 1 v_main_~d1~0_7_fresh_1)) :named ssa_4))
...
(assert (! (and (= |main_#t~bitwise10_7| 0) (or (= |main_#t~bitwise9_6| 0) (= (ite (< 0 (mod main_~x3~0_4 4294967296)) 1 0) 0))) :named ssa_7))
(assert (! (= |main_#t~bitwise10_7| 0) :named ssa_8))
(assert (! (and (not (= (ite (< 0 (mod main_~x2~0_4 4294967296)) 1 0) 0)) (not (= (ite (< 0 (mod main_~x1~0_4 4294967296)) 1 0) 0))) :named ssa_9))
(assert (! (and (= |main_#t~bitwise16_10| (ite (< 0 (mod main_~x2~0_4 4294967296)) 1 0)) (= (ite (< 0 (mod main_~x1~0_4 4294967296)) 1 0) (ite (< 0 (mod main_~x2~0_4 4294967296)) 1 0))) :named ssa_10))
(assert (! (and (= |main_#t~bitwise17_11| 0) (or (= |main_#t~bitwise16_10| 0) (= (ite (< 0 (mod main_~x3~0_4 4294967296)) 1 0) 0))) :named ssa_11))
(assert (! (= |main_#t~bitwise17_11| 0) :named ssa_12))
(assert (! true :named ssa_13_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_13| (ite (or (= (mod main_~x1~0_4 4294967296) 0) (= (mod main_~x2~0_4 4294967296) 0) (= (mod main_~x3~0_4 4294967296) 0)) 1 0)) :named ssa_13_LocVarAssigCall))
