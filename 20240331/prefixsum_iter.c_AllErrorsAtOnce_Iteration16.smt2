...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:18:37+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id prefixsum_iter.c_AllErrorsAtOnce_Iteration16)
...
(declare-fun |v_#Ultimate.meminit_#productInParam_35_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#ptr.offsetInParam_35_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#sizeOfFieldsInParam_35_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#amountOfFieldsInParam_35_fresh_1| () Int)
...
(declare-fun |v_#Ultimate.meminit_#amountOfFieldsInParam_36_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#ptr.offsetInParam_36_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#productInParam_36_fresh_1| () Int)
(declare-fun |v_#Ultimate.meminit_#sizeOfFieldsInParam_36_fresh_1| () Int)
...
(declare-fun |upsweep_#t~mem6_40| () Int)
(declare-fun |upsweep_#t~mem5_40| () Int)
(declare-fun upsweep_~right~0_40 () Int)
...
(declare-fun upsweep_~n_43 () Int)
(declare-fun upsweep_~space~0_44 () Int)
(declare-fun |upsweep_#res_44| () Int)
(declare-fun |main_#t~ret19_45| () Int)
(declare-fun |upsweep_#res_45| () Int)
(declare-fun |main_#t~ret19_46| () Int)
(declare-fun main_~space~1_46 () Int)
(declare-fun |old(#memory_int#1)_47| () (Array Int (Array Int Int)))
(declare-fun |#memory_int#1_47| () (Array Int (Array Int Int)))
(declare-fun |downsweep_#in~a.offset_47| () Int)
(declare-fun |downsweep_#in~space_47| () Int)
(declare-fun main_~a~0.base_47 () Int)
(declare-fun |downsweep_#in~n_47| () Int)
(declare-fun |downsweep_#in~a.base_47| () Int)
(declare-fun main_~n~0_47 () Int)
(declare-fun main_~a~0.offset_47 () Int)
(declare-fun main_~space~1_47 () Int)
(declare-fun downsweep_~n_48 () Int)
(declare-fun downsweep_~space_48 () Int)
(declare-fun downsweep_~a.offset_48 () Int)
(declare-fun downsweep_~a.base_48 () Int)
...
(declare-fun |downsweep_#t~mem8_50| () Int)
(declare-fun |downsweep_#t~mem9_50| () Int)
(declare-fun |#memory_int#1_50| () (Array Int (Array Int Int)))
(declare-fun downsweep_~temp~0_50 () Int)
(declare-fun downsweep_~left~1_50 () Int)
(declare-fun |downsweep_#t~mem7_50| () Int)
...
(declare-fun downsweep_~space_52 () Int)
(declare-fun downsweep_~space_53 () Int)
(declare-fun |check_#in~a.offset_56| () Int)
(declare-fun main_~a0~0.offset_56 () Int)
(declare-fun |check_#in~a.base_56| () Int)
(declare-fun main_~a~0.base_56 () Int)
(declare-fun main_~n~0_56 () Int)
(declare-fun main_~a~0.offset_56 () Int)
(declare-fun |check_#in~a0.base_56| () Int)
(declare-fun |check_#in~n_56| () Int)
(declare-fun main_~a0~0.base_56 () Int)
(declare-fun |check_#in~a0.offset_56| () Int)
(declare-fun check_~a0.base_57 () Int)
(declare-fun check_~a.base_57 () Int)
(declare-fun check_~a.offset_57 () Int)
(declare-fun check_~i~0_57 () Int)
(declare-fun check_~sum~0_57 () Int)
(declare-fun check_~a0.offset_57 () Int)
(declare-fun check_~n_57 () Int)
(declare-fun |check_#t~mem10_58| () Int)
...
(assert (! (and (not (= |main_#t~malloc15.base_21| 0)) (= |#length_21| (store |#length_3| |main_#t~malloc15.base_21| v_ArrVal_328_fresh_1)) (< |main_#t~malloc15.base_21| |#StackHeapBarrier_-1|) (= |main_#t~malloc15.offset_21| 0) (= |#valid_21| (store |#valid_3| |main_#t~malloc15.base_21| v_ArrVal_327_fresh_1)) (= v_ArrVal_327_fresh_1 1) (= v_ArrVal_328_fresh_1 (* (mod main_~n~0_4 1073741824) 4)) (= (select |#valid_3| |main_#t~malloc15.base_21|) 0)) :named ssa_21))
(assert (! (= |old(#memory_int#1)_22| |#memory_int#1_22|) :named ssa_22_GlobVarAssigCall))
(assert (! (and (= |#Ultimate.meminit_#ptr.base_22| |main_#t~malloc15.base_21|) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_35_fresh_1| 4) (= (* main_~n~0_4 4) |v_#Ultimate.meminit_#productInParam_35_fresh_1|) (= |v_#Ultimate.meminit_#ptr.offsetInParam_35_fresh_1| |main_#t~malloc15.offset_21|) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_35_fresh_1|)) :named ssa_22_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_22| |#memory_int#1_3|) :named ssa_22_OldVarAssigCall))
(assert (! (and (= |#memory_int#1_23| (store |#memory_int#1_22| |#Ultimate.meminit_#ptr.base_22| v_ArrVal_329_fresh_1)) (= ((as const (Array Int Int)) 0) v_ArrVal_329_fresh_1)) :named ssa_23))
(assert (! true :named ssa_24_return))
(assert (! (and (= |#valid_25| (store |#valid_21| |main_#t~malloc16.base_25| v_ArrVal_330_fresh_1)) (= (select |#valid_21| |main_#t~malloc16.base_25|) 0) (not (= |main_#t~malloc16.base_25| 0)) (= v_ArrVal_330_fresh_1 1) (= |main_#t~malloc16.offset_25| 0) (= main_~a~0.offset_25 |main_#t~malloc15.offset_21|) (= main_~a~0.base_25 |main_#t~malloc15.base_21|) (< |main_#t~malloc16.base_25| |#StackHeapBarrier_-1|) (= v_ArrVal_331_fresh_1 (* (mod main_~n~0_4 1073741824) 4)) (= (store |#length_21| |main_#t~malloc16.base_25| v_ArrVal_331_fresh_1) |#length_25|)) :named ssa_25))
(assert (! (= |old(#memory_int#1)_26| |#memory_int#1_26|) :named ssa_26_GlobVarAssigCall))
(assert (! (and (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_36_fresh_1| 4) (= |v_#Ultimate.meminit_#ptr.offsetInParam_36_fresh_1| |main_#t~malloc16.offset_25|) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_36_fresh_1|) (= (* main_~n~0_4 4) |v_#Ultimate.meminit_#productInParam_36_fresh_1|) (= |#Ultimate.meminit_#ptr.base_26| |main_#t~malloc16.base_25|)) :named ssa_26_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_26| |#memory_int#1_23|) :named ssa_26_OldVarAssigCall))
(assert (! (and (= |#memory_int#1_27| (store |#memory_int#1_26| |#Ultimate.meminit_#ptr.base_26| v_ArrVal_332_fresh_1)) (= ((as const (Array Int Int)) 0) v_ArrVal_332_fresh_1)) :named ssa_27))
...
(assert (! (and (< main_~i~1_29 main_~n~0_4) (= |#memory_int#1_30| (store |#memory_int#1_27| main_~a0~0.base_29 v_ArrVal_334_fresh_1)) (= v_ArrVal_334_fresh_1 (store (select |#memory_int#1_27| main_~a0~0.base_29) (+ main_~a0~0.offset_29 (* main_~i~1_29 4)) v_ArrVal_333_fresh_1)) (= v_ArrVal_333_fresh_1 (select (select |#memory_int#1_27| main_~a~0.base_25) (+ main_~a~0.offset_25 (* main_~i~1_29 4)))) (= main_~i~1_30 (+ main_~i~1_29 1))) :named ssa_30))
(assert (! (and (< main_~i~1_30 main_~n~0_4) (= v_ArrVal_335_fresh_1 (select (select |#memory_int#1_30| main_~a~0.base_25) (+ main_~a~0.offset_25 (* main_~i~1_30 4)))) (= v_ArrVal_336_fresh_1 (store (select |#memory_int#1_30| main_~a0~0.base_29) (+ main_~a0~0.offset_29 (* main_~i~1_30 4)) v_ArrVal_335_fresh_1)) (= (store |#memory_int#1_30| main_~a0~0.base_29 v_ArrVal_336_fresh_1) |#memory_int#1_31|) (= main_~i~1_31 (+ main_~i~1_30 1))) :named ssa_31))
...
(assert (! (and (= (store |#memory_int#1_33| upsweep_~a.base_34 v_ArrVal_337_fresh_1) |#memory_int#1_36|) (< upsweep_~left~0_35 upsweep_~n_34) (= (+ (* 2 upsweep_~space~0_34) upsweep_~left~0_35) upsweep_~left~0_36) (= v_ArrVal_338_fresh_1 (+ (select (select |#memory_int#1_33| upsweep_~a.base_34) (+ (* upsweep_~left~0_35 4) upsweep_~a.offset_34)) (select (select |#memory_int#1_33| upsweep_~a.base_34) (+ (* upsweep_~left~0_35 4) upsweep_~a.offset_34 (* upsweep_~space~0_34 4))))) (= (store (select |#memory_int#1_33| upsweep_~a.base_34) (+ (* upsweep_~left~0_35 4) upsweep_~a.offset_34 (* upsweep_~space~0_34 4)) (+ (select (select |#memory_int#1_33| upsweep_~a.base_34) (+ (* upsweep_~left~0_35 4) upsweep_~a.offset_34)) (select (select |#memory_int#1_33| upsweep_~a.base_34) (+ (* upsweep_~left~0_35 4) upsweep_~a.offset_34 (* upsweep_~space~0_34 4))))) v_ArrVal_337_fresh_1)) :named ssa_36))
(assert (! (<= upsweep_~n_34 upsweep_~left~0_36) :named ssa_37))
(assert (! (= (* 2 upsweep_~space~0_34) upsweep_~space~0_38) :named ssa_38))
(assert (! (and (= upsweep_~space~0_38 (+ upsweep_~left~0_39 1)) (< upsweep_~space~0_38 upsweep_~n_34)) :named ssa_39))
(assert (! (and (= (store (select |#memory_int#1_36| upsweep_~a.base_34) (+ (* upsweep_~left~0_39 4) upsweep_~a.offset_34 (* upsweep_~space~0_38 4)) (+ (select (select |#memory_int#1_36| upsweep_~a.base_34) (+ (* upsweep_~left~0_39 4) upsweep_~a.offset_34)) (select (select |#memory_int#1_36| upsweep_~a.base_34) (+ (* upsweep_~left~0_39 4) upsweep_~a.offset_34 (* upsweep_~space~0_38 4))))) v_ArrVal_339_fresh_1) (< upsweep_~left~0_39 upsweep_~n_34) (= (store |#memory_int#1_36| upsweep_~a.base_34 v_ArrVal_339_fresh_1) |#memory_int#1_40|) (= v_ArrVal_340_fresh_1 (+ (select (select |#memory_int#1_36| upsweep_~a.base_34) (+ (* upsweep_~left~0_39 4) upsweep_~a.offset_34)) (select (select |#memory_int#1_36| upsweep_~a.base_34) (+ (* upsweep_~left~0_39 4) upsweep_~a.offset_34 (* upsweep_~space~0_38 4))))) (= (+ (* 2 upsweep_~space~0_38) upsweep_~left~0_39) upsweep_~left~0_40)) :named ssa_40))
(assert (! (<= upsweep_~n_34 upsweep_~left~0_40) :named ssa_41))
(assert (! (= (* 2 upsweep_~space~0_38) upsweep_~space~0_42) :named ssa_42))
(assert (! (<= upsweep_~n_34 upsweep_~space~0_42) :named ssa_43))
(assert (! (= |upsweep_#res_44| upsweep_~space~0_42) :named ssa_44))
(assert (! (= |main_#t~ret19_45| |upsweep_#res_44|) :named ssa_45_return))
(assert (! (and (<= 0 (+ |main_#t~ret19_45| 2147483648)) (<= |main_#t~ret19_45| 2147483647) (= |main_#t~ret19_45| main_~space~1_46)) :named ssa_46))
(assert (! (= |old(#memory_int#1)_47| |#memory_int#1_47|) :named ssa_47_GlobVarAssigCall))
(assert (! (and (= |downsweep_#in~a.base_47| main_~a~0.base_25) (= main_~n~0_4 |downsweep_#in~n_47|) (= |downsweep_#in~space_47| main_~space~1_46) (= main_~a~0.offset_25 |downsweep_#in~a.offset_47|)) :named ssa_47_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_47| |#memory_int#1_40|) :named ssa_47_OldVarAssigCall))
(assert (! (and (= |#memory_int#1_48| (store |#memory_int#1_47| downsweep_~a.base_48 v_ArrVal_342_fresh_1)) (= downsweep_~space_48 (ite (and (not (= (mod |downsweep_#in~space_47| 2) 0)) (< |downsweep_#in~space_47| 0)) (+ (div |downsweep_#in~space_47| 2) 1) (div |downsweep_#in~space_47| 2))) (= (store (select |#memory_int#1_47| downsweep_~a.base_48) (+ downsweep_~a.offset_48 (- 4) (* downsweep_~n_48 4)) v_ArrVal_341_fresh_1) v_ArrVal_342_fresh_1) (= downsweep_~a.base_48 |downsweep_#in~a.base_47|) (= downsweep_~a.offset_48 |downsweep_#in~a.offset_47|) (= v_ArrVal_341_fresh_1 0) (= downsweep_~n_48 |downsweep_#in~n_47|)) :named ssa_48))
(assert (! (and (< 0 downsweep_~space_48) (= (+ downsweep_~right~1_49 1) (* 2 downsweep_~space_48))) :named ssa_49))
(assert (! (and (< downsweep_~right~1_49 downsweep_~n_48) (= v_ArrVal_344_fresh_1 (+ (select (select |#memory_int#1_48| downsweep_~a.base_48) (+ downsweep_~a.offset_48 (* downsweep_~right~1_49 4))) (select (select |#memory_int#1_48| downsweep_~a.base_48) (+ downsweep_~a.offset_48 (* downsweep_~right~1_49 4) (* downsweep_~space_48 (- 4)))))) (= v_ArrVal_343_fresh_1 (store (store (select |#memory_int#1_48| downsweep_~a.base_48) (+ downsweep_~a.offset_48 (* downsweep_~right~1_49 4)) (+ (select (select |#memory_int#1_48| downsweep_~a.base_48) (+ downsweep_~a.offset_48 (* downsweep_~right~1_49 4))) (select (select |#memory_int#1_48| downsweep_~a.base_48) (+ downsweep_~a.offset_48 (* downsweep_~right~1_49 4) (* downsweep_~space_48 (- 4)))))) (+ downsweep_~a.offset_48 (* downsweep_~right~1_49 4) (* downsweep_~space_48 (- 4))) (select (select |#memory_int#1_48| downsweep_~a.base_48) (+ downsweep_~a.offset_48 (* downsweep_~right~1_49 4))))) (= |#memory_int#1_50| (store |#memory_int#1_48| downsweep_~a.base_48 v_ArrVal_343_fresh_1)) (= downsweep_~right~1_50 (+ (* 2 downsweep_~space_48) downsweep_~right~1_49)) (= v_ArrVal_345_fresh_1 (select (select |#memory_int#1_48| downsweep_~a.base_48) (+ downsweep_~a.offset_48 (* downsweep_~right~1_49 4))))) :named ssa_50))
(assert (! (<= downsweep_~n_48 downsweep_~right~1_50) :named ssa_51))
(assert (! (= downsweep_~space_52 (ite (and (< downsweep_~space_48 0) (not (= (mod downsweep_~space_48 2) 0))) (+ (div downsweep_~space_48 2) 1) (div downsweep_~space_48 2))) :named ssa_52))
(assert (! (<= downsweep_~space_52 0) :named ssa_53))
(assert (! true :named ssa_54))
(assert (! true :named ssa_55_return))
(assert (! true :named ssa_56_GlobVarAssigCall))
(assert (! (and (= main_~a0~0.offset_29 |check_#in~a0.offset_56|) (= main_~a0~0.base_29 |check_#in~a0.base_56|) (= |check_#in~a.offset_56| main_~a~0.offset_25) (= main_~n~0_4 |check_#in~n_56|) (= |check_#in~a.base_56| main_~a~0.base_25)) :named ssa_56_LocVarAssigCall))
(assert (! true :named ssa_56_OldVarAssigCall))
(assert (! (and (= |check_#in~a.offset_56| check_~a.offset_57) (= |check_#in~a0.offset_56| check_~a0.offset_57) (= check_~a.base_57 |check_#in~a.base_56|) (= check_~i~0_57 0) (= check_~a0.base_57 |check_#in~a0.base_56|) (= check_~sum~0_57 0) (= check_~n_57 |check_#in~n_56|)) :named ssa_57))
(assert (! (and (= |check_#t~mem10_58| (select (select |#memory_int#1_50| check_~a.base_57) (+ (* check_~i~0_57 4) check_~a.offset_57))) (< check_~i~0_57 check_~n_57)) :named ssa_58))
(assert (! true :named ssa_59_GlobVarAssigCall))
(assert (! (= (ite (= check_~sum~0_57 |check_#t~mem10_58|) 1 0) |__VERIFIER_assert_#in~cond_59|) :named ssa_59_LocVarAssigCall))
...
(assert (! (not true) :named ssa_postcond))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_346_fresh_1) (= |#memory_int#1_0| (store |#memory_int#1_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_346_fresh_1))) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! true :named ssa_-2_PendingContext))
...
(assert (! (= |#memory_int#1_-1| |old(#memory_int#1)_-1|) :named ssa_precond))
(assert (! (not true) :named ssa_postcond))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_347_fresh_1) (= (store |#memory_int#1_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_347_fresh_1) |#memory_int#1_0|)) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! true :named ssa_-2_PendingContext))
...
(declare-fun |upsweep_#t~mem6_6| () Int)
(declare-fun |upsweep_#t~mem5_6| () Int)
(declare-fun upsweep_~right~0_6 () Int)
...
(declare-fun upsweep_~space~0_8 () Int)
(declare-fun upsweep_~n_9 () Int)
(declare-fun upsweep_~space~0_10 () Int)
(declare-fun |upsweep_#res_10| () Int)
...
(assert (! (and (< upsweep_~left~0_1 upsweep_~n_0) (= (+ (* 2 upsweep_~space~0_0) upsweep_~left~0_1) upsweep_~left~0_2) (= (store |#memory_int#1_-1| upsweep_~a.base_0 v_ArrVal_348_fresh_1) |#memory_int#1_2|) (= (store (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0 (* upsweep_~space~0_0 4)) (+ (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0)) (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0 (* upsweep_~space~0_0 4))))) v_ArrVal_348_fresh_1) (= v_ArrVal_349_fresh_1 (+ (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0)) (select (select |#memory_int#1_-1| upsweep_~a.base_0) (+ (* upsweep_~left~0_1 4) upsweep_~a.offset_0 (* upsweep_~space~0_0 4)))))) :named ssa_2))
(assert (! (<= upsweep_~n_0 upsweep_~left~0_2) :named ssa_3))
(assert (! (= (* 2 upsweep_~space~0_0) upsweep_~space~0_4) :named ssa_4))
(assert (! (and (= upsweep_~space~0_4 (+ upsweep_~left~0_5 1)) (< upsweep_~space~0_4 upsweep_~n_0)) :named ssa_5))
(assert (! (and (= |#memory_int#1_6| (store |#memory_int#1_2| upsweep_~a.base_0 v_ArrVal_350_fresh_1)) (= (store (select |#memory_int#1_2| upsweep_~a.base_0) (+ (* upsweep_~left~0_5 4) upsweep_~a.offset_0 (* upsweep_~space~0_4 4)) (+ (select (select |#memory_int#1_2| upsweep_~a.base_0) (+ (* upsweep_~left~0_5 4) upsweep_~a.offset_0)) (select (select |#memory_int#1_2| upsweep_~a.base_0) (+ (* upsweep_~left~0_5 4) upsweep_~a.offset_0 (* upsweep_~space~0_4 4))))) v_ArrVal_350_fresh_1) (< upsweep_~left~0_5 upsweep_~n_0) (= (+ (* 2 upsweep_~space~0_4) upsweep_~left~0_5) upsweep_~left~0_6) (= v_ArrVal_351_fresh_1 (+ (select (select |#memory_int#1_2| upsweep_~a.base_0) (+ (* upsweep_~left~0_5 4) upsweep_~a.offset_0)) (select (select |#memory_int#1_2| upsweep_~a.base_0) (+ (* upsweep_~left~0_5 4) upsweep_~a.offset_0 (* upsweep_~space~0_4 4)))))) :named ssa_6))
(assert (! (<= upsweep_~n_0 upsweep_~left~0_6) :named ssa_7))
(assert (! (= (* 2 upsweep_~space~0_4) upsweep_~space~0_8) :named ssa_8))
(assert (! (<= upsweep_~n_0 upsweep_~space~0_8) :named ssa_9))
(assert (! (= |upsweep_#res_10| upsweep_~space~0_8) :named ssa_10))
(assert (! (= |main_#t~ret19_11| |upsweep_#res_10|) :named ssa_11_return))
...
(assert (! (= |#memory_int#1_-1| |old(#memory_int#1)_-1|) :named ssa_precond))
(assert (! (not false) :named ssa_postcond))
(assert (! (and (= downsweep_~space_0 (ite (and (not (= (mod |downsweep_#in~space_-1| 2) 0)) (< |downsweep_#in~space_-1| 0)) (+ (div |downsweep_#in~space_-1| 2) 1) (div |downsweep_#in~space_-1| 2))) (= v_ArrVal_353_fresh_1 (store (select |#memory_int#1_-1| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (- 4) (* downsweep_~n_0 4)) v_ArrVal_352_fresh_1)) (= downsweep_~a.base_0 |downsweep_#in~a.base_-1|) (= downsweep_~a.offset_0 |downsweep_#in~a.offset_-1|) (= |#memory_int#1_0| (store |#memory_int#1_-1| downsweep_~a.base_0 v_ArrVal_353_fresh_1)) (= v_ArrVal_352_fresh_1 0) (= downsweep_~n_0 |downsweep_#in~n_-1|)) :named ssa_0))
(assert (! (and (< 0 downsweep_~space_0) (= (+ downsweep_~right~1_1 1) (* 2 downsweep_~space_0))) :named ssa_1))
(assert (! (and (= |#memory_int#1_2| (store |#memory_int#1_0| downsweep_~a.base_0 v_ArrVal_354_fresh_1)) (< downsweep_~right~1_1 downsweep_~n_0) (= v_ArrVal_356_fresh_1 (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4)))) (= downsweep_~right~1_2 (+ (* 2 downsweep_~space_0) downsweep_~right~1_1)) (= v_ArrVal_354_fresh_1 (store (store (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4)) (+ (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4))) (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4) (* downsweep_~space_0 (- 4)))))) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4) (* downsweep_~space_0 (- 4))) (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4))))) (= v_ArrVal_355_fresh_1 (+ (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4))) (select (select |#memory_int#1_0| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (* downsweep_~right~1_1 4) (* downsweep_~space_0 (- 4))))))) :named ssa_2))
