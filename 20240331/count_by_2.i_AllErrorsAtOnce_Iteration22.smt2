...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration22)
...
(assert (! (<= 1000000 main_~i~0_25) :named ssa_26))
(assert (! true :named ssa_27_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_27| (ite (= main_~i~0_25 1000000) 1 0)) :named ssa_27_LocVarAssigCall))
