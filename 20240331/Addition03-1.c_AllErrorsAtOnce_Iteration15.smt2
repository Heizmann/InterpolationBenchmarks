...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:15:08+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id Addition03-1.c_AllErrorsAtOnce_Iteration15)
...
(declare-fun |main_#t~ret8_100| () Int)
(declare-fun |addition_#res_100| () Int)
(declare-fun main_~result~0_101 () Int)
(declare-fun |main_#t~ret8_101| () Int)
(declare-fun main_~result~0_102 () Int)
(declare-fun main_~m~0_102 () Int)
(declare-fun main_~n~0_102 () Int)
...
(assert (! (and (= 0 addition_~n_58) (= |addition_#res_59| addition_~m_58)) :named ssa_59))
...
(assert (! (= |addition_#res_98| |main_#t~ret8_100|) :named ssa_100_return))
(assert (! (and (<= |main_#t~ret8_100| 9223372036854775807) (<= 0 (+ |main_#t~ret8_100| 9223372036854775808)) (= main_~result~0_101 |main_#t~ret8_100|)) :named ssa_101))
(assert (! (and (< main_~result~0_101 200) (<= 100 main_~n~0_4) (<= 100 main_~m~0_4)) :named ssa_102))
(assert (! true :named ssa_103))
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 (and ssa_57_OldVarAssigCall ssa_75 ssa_77 ssa_27 ssa_29_OldVarAssigCall ssa_20 ssa_41_GlobVarAssigCall ssa_17_LocVarAssigCall ssa_21_LocVarAssigCall ssa_95 ssa_5_LocVarAssigCall ssa_31 ssa_99 ssa_60 ssa_5_GlobVarAssigCall ssa_21_OldVarAssigCall ssa_81 ssa_68 ssa_7 ssa_84 ssa_44 ssa_16 ssa_6 ssa_26 ssa_55 ssa_34 ssa_17_GlobVarAssigCall ssa_74 ssa_25_GlobVarAssigCall ssa_40 ssa_10 ssa_14 ssa_25_OldVarAssigCall ssa_96 ssa_8 ssa_13_LocVarAssigCall ssa_29_GlobVarAssigCall ssa_46 ssa_53_GlobVarAssigCall ssa_89 ssa_47 ssa_90 ssa_13_OldVarAssigCall ssa_25_LocVarAssigCall ssa_37_LocVarAssigCall ssa_49_LocVarAssigCall ssa_86 ssa_97_return ssa_88_return ssa_67_return ssa_58 ssa_33_GlobVarAssigCall ssa_19 ssa_83 ssa_70_return ssa_87 ssa_33_LocVarAssigCall ssa_59 ssa_39 ssa_53_LocVarAssigCall ssa_62 ssa_43 ssa_61_return ssa_73_return ssa_72 ssa_13_GlobVarAssigCall ssa_41_OldVarAssigCall ssa_17_OldVarAssigCall ssa_94_return ssa_38 ssa_100_return ssa_12 ssa_82_return ssa_32 ssa_5_OldVarAssigCall ssa_50 ssa_65 ssa_41_LocVarAssigCall ssa_64_return ssa_11 ssa_48 ssa_53_OldVarAssigCall ssa_28 ssa_29_LocVarAssigCall ssa_54 ssa_37_GlobVarAssigCall ssa_22 ssa_98 ssa_51 ssa_36 ssa_15 ssa_80 ssa_63 ssa_45_OldVarAssigCall ssa_45_LocVarAssigCall ssa_78 ssa_85_return ssa_52 ssa_18 ssa_49_GlobVarAssigCall ssa_23 ssa_30 ssa_66 ssa_69 ssa_9_LocVarAssigCall ssa_92 ssa_56 ssa_57_LocVarAssigCall ssa_93 ssa_9_OldVarAssigCall ssa_35 ssa_76_return ssa_21_GlobVarAssigCall ssa_79_return ssa_9_GlobVarAssigCall ssa_33_OldVarAssigCall ssa_45_GlobVarAssigCall ssa_49_OldVarAssigCall ssa_42 ssa_71 ssa_57_GlobVarAssigCall ssa_91_return ssa_24 ssa_37_OldVarAssigCall) ssa_101 ssa_102 (and ssa_103 ssa_postcond))
...
(declare-fun |addition_#t~ret4_92| () Int)
(declare-fun |addition_#res_92| () Int)
(declare-fun |main_#t~ret8_94| () Int)
(declare-fun |addition_#res_94| () Int)
(assert (! true :named ssa_precond))
(assert (! (not (<= main_~n~0_-2 13)) :named ssa_postcond))
...
(assert (! (and (<= 0 (+ 9223372036854775808 |addition_#t~ret4_91|)) (<= |addition_#t~ret4_91| 9223372036854775807) (= |addition_#res_92| |addition_#t~ret4_91|)) :named ssa_92))
(assert (! true :named ssa_93))
(assert (! (= |addition_#res_92| |main_#t~ret8_94|) :named ssa_94_return))
(assert (! true :named ssa_-2_PendingContext))
