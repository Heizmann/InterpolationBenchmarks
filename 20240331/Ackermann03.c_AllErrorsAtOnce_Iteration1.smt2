...
(set-info :ultimate-id Ackermann03.c_AllErrorsAtOnce_Iteration1)
...
(assert (! (and (= main_~n~0_5 2) (= main_~m~0_4 2) (not (= 7 main_~result~0_12))) :named ssa_13))
...
(assert (! true :named ssa_precond))
(assert (! (not (<= main_~m~0_-2 0)) :named ssa_postcond))
