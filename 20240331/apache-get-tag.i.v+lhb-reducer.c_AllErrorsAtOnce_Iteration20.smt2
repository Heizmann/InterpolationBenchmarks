...
(set-info :ultimate-id apache-get-tag.i.v+lhb-reducer.c_AllErrorsAtOnce_Iteration20)
...
(declare-fun v_main_~main____CPAchecker_TMP_0~0_28_fresh_1 () Int)
(declare-fun v_main_~main____CPAchecker_TMP_1~0_9_fresh_1 () Int)
...
(declare-fun v_main_~main____CPAchecker_TMP_1~0_10_fresh_1 () Int)
(declare-fun v_main_~main____CPAchecker_TMP_0~0_29_fresh_1 () Int)
(declare-fun main_~main____CPAchecker_TMP_0~1_16 () Int)
(declare-fun |main_#t~nondet9_16| () Int)
(declare-fun main_~__VERIFIER_assert__cond~18_17 () Int)
(declare-fun v_main_~__tmp_19~0_7_fresh_1 () Int)
(declare-fun main_~__VERIFIER_assert__cond~19_18 () Int)
(declare-fun main_~__VERIFIER_assert__cond~18_18 () Int)
(declare-fun v_main_~__tmp_20~0_6_fresh_1 () Int)
(declare-fun main_~__VERIFIER_assert__cond~19_19 () Int)
...
(assert (! (and (= main_~__VERIFIER_assert__cond~12_7 v_main_~__tmp_13~0_11_fresh_1) (= main_~main____CPAchecker_TMP_0~0_6 0) (= v_main_~__tmp_13~0_11_fresh_1 (ite (<= 0 main_~main__t~0_5) 1 0))) :named ssa_7))
(assert (! (and (= (ite (<= main_~main__t~0_5 main_~main__tagbuf_len~0_5) 1 0) v_main_~__tmp_14~0_11_fresh_1) (= main_~__VERIFIER_assert__cond~13_8 v_main_~__tmp_14~0_11_fresh_1) (not (= main_~__VERIFIER_assert__cond~12_7 0))) :named ssa_8))
(assert (! (and (= main_~main____CPAchecker_TMP_0~0_6 ~__tmp_383_0~0_9) (not (= main_~__VERIFIER_assert__cond~13_8 0))) :named ssa_9))
(assert (! (and (= v_main_~main____CPAchecker_TMP_1~0_9_fresh_1 main_~main__t~0_5) (= ~__tmp_383_0~0_9 v_main_~main____CPAchecker_TMP_0~0_28_fresh_1) (= main_~main__t~0_10 (+ main_~main__t~0_5 1))) :named ssa_10))
...
(assert (! (and (= v_main_~__tmp_19~0_6_fresh_1 main_~__VERIFIER_assert__cond~18_12) (= v_main_~__tmp_19~0_6_fresh_1 (ite (<= 0 main_~main__t~0_10) 1 0)) (= main_~main____CPAchecker_TMP_0~1_11 0)) :named ssa_12))
(assert (! (and (= (ite (<= main_~main__t~0_10 main_~main__tagbuf_len~0_5) 1 0) v_main_~__tmp_20~0_5_fresh_1) (not (= main_~__VERIFIER_assert__cond~18_12 0)) (= v_main_~__tmp_20~0_5_fresh_1 main_~__VERIFIER_assert__cond~19_13)) :named ssa_13))
(assert (! (and (not (= main_~__VERIFIER_assert__cond~19_13 0)) (= main_~main____CPAchecker_TMP_0~1_11 ~__tmp_383_0~0_14)) :named ssa_14))
(assert (! (and (= main_~main__t~0_10 v_main_~main____CPAchecker_TMP_1~0_10_fresh_1) (= ~__tmp_383_0~0_14 v_main_~main____CPAchecker_TMP_0~0_29_fresh_1) (= main_~main__t~0_15 (+ main_~main__t~0_10 1))) :named ssa_15))
...
(assert (! (and (= v_main_~__tmp_19~0_7_fresh_1 main_~__VERIFIER_assert__cond~18_17) (= main_~main____CPAchecker_TMP_0~1_16 0) (= v_main_~__tmp_19~0_7_fresh_1 (ite (<= 0 main_~main__t~0_15) 1 0))) :named ssa_17))
(assert (! (and (not (= main_~__VERIFIER_assert__cond~18_17 0)) (= (ite (<= main_~main__t~0_15 main_~main__tagbuf_len~0_5) 1 0) v_main_~__tmp_20~0_6_fresh_1) (= v_main_~__tmp_20~0_6_fresh_1 main_~__VERIFIER_assert__cond~19_18)) :named ssa_18))
(assert (! (= main_~__VERIFIER_assert__cond~19_18 0) :named ssa_19))
