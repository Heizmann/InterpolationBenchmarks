...
(set-info :ultimate-id mono-crafted_11.c_AllErrorsAtOnce_Iteration15)
...
(assert (! (<= 100000000 (mod main_~x~0_30 4294967296)) :named ssa_31))
(assert (! true :named ssa_32_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_32| (ite (= (mod main_~x~0_30 2) 0) 1 0)) :named ssa_32_LocVarAssigCall))
