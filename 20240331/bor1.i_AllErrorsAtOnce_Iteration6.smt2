...
(set-info :ultimate-id bor1.i_AllErrorsAtOnce_Iteration6)
...
(assert (! (and (= main_~i~1_4 0) (< |#StackHeapBarrier_-1| |main_~#x~0.base_4|) (= v_ArrVal_50_fresh_1 1) (= |main_~#x~0.offset_4| 0) (not (= |main_~#x~0.base_4| 0)) (= 400 v_ArrVal_51_fresh_1) (= (select |#valid_3| |main_~#x~0.base_4|) 0) (= |#valid_4| (store |#valid_3| |main_~#x~0.base_4| v_ArrVal_50_fresh_1)) (= (store |#length_3| |main_~#x~0.base_4| v_ArrVal_51_fresh_1) |#length_4|)) :named ssa_4))
(assert (! (and (< main_~i~1_4 100) (<= |v_main_#t~nondet5_15_fresh_1| 2147483647) (= |v_main_#t~nondet5_15_fresh_1| v_ArrVal_53_fresh_1) (<= 0 (+ |v_main_#t~nondet5_15_fresh_1| 2147483648)) (= (store (select |#memory_int#1_3| |main_~#x~0.base_4|) (+ (* main_~i~1_4 4) |main_~#x~0.offset_4|) |v_main_#t~nondet5_15_fresh_1|) v_ArrVal_52_fresh_1) (= |#memory_int#1_5| (store |#memory_int#1_3| |main_~#x~0.base_4| v_ArrVal_52_fresh_1)) (= main_~i~1_5 (+ main_~i~1_4 1))) :named ssa_5))
(assert (! (and (< main_~i~1_5 100) (= |v_main_#t~nondet5_16_fresh_1| v_ArrVal_55_fresh_1) (= (store |#memory_int#1_5| |main_~#x~0.base_4| v_ArrVal_54_fresh_1) |#memory_int#1_6|) (= v_ArrVal_54_fresh_1 (store (select |#memory_int#1_5| |main_~#x~0.base_4|) (+ (* main_~i~1_5 4) |main_~#x~0.offset_4|) |v_main_#t~nondet5_16_fresh_1|)) (<= 0 (+ |v_main_#t~nondet5_16_fresh_1| 2147483648)) (<= |v_main_#t~nondet5_16_fresh_1| 2147483647) (= main_~i~1_6 (+ main_~i~1_5 1))) :named ssa_6))
...
(assert (! (and (= v_main_~temp~0_11_fresh_1 v_ArrVal_57_fresh_1) (<= |main_#t~ret7_19| 2147483647) (= (store (store (select |#memory_int#1_6| |main_~#x~0.base_4|) |main_~#x~0.offset_4| (select (select |#memory_int#1_6| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4))) (+ |main_~#x~0.offset_4| 4) v_main_~temp~0_11_fresh_1) v_ArrVal_56_fresh_1) (= v_main_~temp~0_11_fresh_1 (select (select |#memory_int#1_6| |main_~#x~0.base_4|) |main_~#x~0.offset_4|)) (<= 0 (+ |main_#t~ret7_19| 2147483648)) (= (store |#memory_int#1_6| |main_~#x~0.base_4| v_ArrVal_56_fresh_1) |#memory_int#1_20|) (= v_ArrVal_58_fresh_1 (select (select |#memory_int#1_6| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4))) (= |main_#t~ret7_19| main_~ret~0_20)) :named ssa_20))
...
(assert (! (and (= (select (select |#memory_int#1_20| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4 (* main_~i~2_32 4))) v_ArrVal_60_fresh_1) (= (store (select |#memory_int#1_20| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| (* main_~i~2_32 4)) (select (select |#memory_int#1_20| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4 (* main_~i~2_32 4)))) v_ArrVal_59_fresh_1) (= (store |#memory_int#1_20| |main_~#x~0.base_4| v_ArrVal_59_fresh_1) |#memory_int#1_33|) (= main_~i~2_33 (+ main_~i~2_32 1)) (< main_~i~2_32 99)) :named ssa_33))
(assert (! (<= 99 main_~i~2_33) :named ssa_34))
(assert (! (and (= main_~temp~0_32 v_ArrVal_62_fresh_1) (= |#memory_int#1_35| (store |#memory_int#1_33| |main_~#x~0.base_4| v_ArrVal_61_fresh_1)) (= (store (select |#memory_int#1_33| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 396) main_~temp~0_32) v_ArrVal_61_fresh_1)) :named ssa_35))
(assert (! true :named ssa_36_GlobVarAssigCall))
(assert (! (and (= |bor_#in~x.offset_36| |main_~#x~0.offset_4|) (= |main_~#x~0.base_4| |bor_#in~x.base_36|)) :named ssa_36_LocVarAssigCall))
...
(assert (! (= |bor_#res_45| |main_#t~ret14_46|) :named ssa_46_return))
(assert (! (and (= main_~ret5~0_47 |main_#t~ret14_46|) (<= |main_#t~ret14_46| 2147483647) (<= 0 (+ |main_#t~ret14_46| 2147483648))) :named ssa_47))
(assert (! (or (not (= main_~ret5~0_47 main_~ret~0_20)) (not (= main_~ret2~0_32 main_~ret~0_20))) :named ssa_48))
