...
(set-info :ultimate-id underapprox_1-2.c_AllErrorsAtOnce_Iteration7)
...
(assert (! (<= 6 (mod main_~x~0_9 4294967296)) :named ssa_10))
(assert (! true :named ssa_11_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_11| (mod (mod main_~y~0_9 4294967296) 3)) :named ssa_11_LocVarAssigCall))
