...
(set-info :ultimate-id watermelon.c_AllErrorsAtOnce_Iteration11)
...
(declare-fun v_main_~is_divisible1~0_16_fresh_1 () Int)
(declare-fun v_main_~is_divisible2~0_16_fresh_1 () Int)
...
(declare-fun correct_version_~w_13 () Int)
...
(declare-fun main_~is_divisible1~0_17 () Int)
(declare-fun main_~w~0_18 () Int)
(declare-fun |student_version_#in~w_18| () Int)
(declare-fun student_version_~w_19 () Int)
...
(assert (! (and (= ~true~0_1 v_main_~is_divisible1~0_16_fresh_1) (= ~true~0_1 v_main_~is_divisible2~0_16_fresh_1)) :named ssa_4))
...
(assert (! (<= correct_version_~w_7 correct_version_~i~0_11) :named ssa_12))
(assert (! (and (not (= correct_version_~i~0_11 correct_version_~w_7)) (= ~false~0_1 correct_version_~is_divisible~0_13)) :named ssa_13))
(assert (! true :named ssa_14))
(assert (! (= |correct_version_#res_15| correct_version_~is_divisible~0_13) :named ssa_15))
(assert (! (= |main_#t~ret5_16| |correct_version_#res_15|) :named ssa_16_return))
(assert (! (and (= main_~is_divisible1~0_17 |main_#t~ret5_16|) (<= 0 (+ |main_#t~ret5_16| 2147483648)) (<= |main_#t~ret5_16| 2147483647)) :named ssa_17))
(assert (! true :named ssa_18_GlobVarAssigCall))
(assert (! (= |student_version_#in~w_18| (ite (<= (mod main_~w~0_4 4294967296) 2147483647) (mod main_~w~0_4 4294967296) (+ (mod main_~w~0_4 4294967296) (- 4294967296)))) :named ssa_18_LocVarAssigCall))
(assert (! true :named ssa_18_OldVarAssigCall))
(assert (! (and (= student_version_~w_19 |student_version_#in~w_18|) (= ~true~0_1 student_version_~is_divisible~1_19)) :named ssa_19))
(assert (! (and (<= 4 student_version_~w_19) (= student_version_~i~1_20 0)) :named ssa_20))
(assert (! (and (= (+ 2 student_version_~i~1_20) student_version_~i~1_21) (< student_version_~i~1_20 student_version_~w_19)) :named ssa_21))
(assert (! (and (= (+ 2 student_version_~i~1_21) student_version_~i~1_22) (< student_version_~i~1_21 student_version_~w_19)) :named ssa_22))
(assert (! (<= student_version_~w_19 student_version_~i~1_22) :named ssa_23))
(assert (! (= student_version_~w_19 student_version_~i~1_22) :named ssa_24))
(assert (! true :named ssa_25))
(assert (! (= student_version_~is_divisible~1_19 |student_version_#res_26|) :named ssa_26))
...
(assert (! (= (ite (= main_~is_divisible1~0_17 main_~is_divisible2~0_28) 1 0) |__VERIFIER_assert_#in~cond_29|) :named ssa_29_LocVarAssigCall))
...
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 ssa_5 (and ssa_13 ssa_7 ssa_10 ssa_14 ssa_8 ssa_9 ssa_6_OldVarAssigCall ssa_12 ssa_6_GlobVarAssigCall ssa_11 ssa_15 ssa_6_LocVarAssigCall ssa_16_return) ssa_17 (and ssa_20 ssa_18_LocVarAssigCall ssa_26 ssa_27_return ssa_25 ssa_19 ssa_18_GlobVarAssigCall ssa_22 ssa_21 ssa_23 ssa_18_OldVarAssigCall ssa_24) ssa_28 (and ssa_29_OldVarAssigCall ssa_29_GlobVarAssigCall ssa_29_LocVarAssigCall) ssa_30 ssa_31 (and ssa_32 ssa_postcond))
...
(declare-fun ~false~0_-1 () Int)
(declare-fun correct_version_~is_divisible~0_6 () Int)
(declare-fun correct_version_~w_6 () Int)
...
(declare-fun |main_#t~ret5_9| () Int)
(declare-fun |correct_version_#res_9| () Int)
(assert (! true :named ssa_precond))
(assert (! (not (and (<= main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647)) (<= (+ (* (div main_~w~0_-2 4294967296) 4294967296) 5) main_~w~0_-2))) :named ssa_postcond))
...
(assert (! (<= correct_version_~w_0 correct_version_~i~0_4) :named ssa_5))
(assert (! (and (not (= correct_version_~i~0_4 correct_version_~w_0)) (= ~false~0_-1 correct_version_~is_divisible~0_6)) :named ssa_6))
(assert (! true :named ssa_7))
(assert (! (= |correct_version_#res_8| correct_version_~is_divisible~0_6) :named ssa_8))
(assert (! (= |main_#t~ret5_9| |correct_version_#res_8|) :named ssa_9_return))
(assert (! true :named ssa_-2_PendingContext))
...
(declare-fun student_version_~w_5 () Int)
(declare-fun student_version_~i~1_6 () Int)
(declare-fun |student_version_#res_7| () Int)
(declare-fun student_version_~is_divisible~1_7 () Int)
(declare-fun |main_#t~ret6_8| () Int)
...
(assert (! (<= student_version_~w_0 student_version_~i~1_3) :named ssa_4))
(assert (! (= student_version_~w_0 student_version_~i~1_3) :named ssa_5))
(assert (! true :named ssa_6))
(assert (! (= student_version_~is_divisible~1_0 |student_version_#res_7|) :named ssa_7))
(assert (! (= |main_#t~ret6_8| |student_version_#res_7|) :named ssa_8_return))
(assert (! (and (<= main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647)) (<= (+ (* (div main_~w~0_-2 4294967296) 4294967296) 5) main_~w~0_-2)) :named ssa_-2_PendingContext))
