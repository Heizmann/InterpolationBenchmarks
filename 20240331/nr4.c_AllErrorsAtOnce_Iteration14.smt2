...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-30T23:52:49+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id nr4.c_AllErrorsAtOnce_Iteration14)
...
(declare-fun |v_main_#t~mem7_26_fresh_1| () Int)
...
(declare-fun |main_#t~post10_45| () Int)
...
(declare-fun |main_#t~short9_46| () Bool)
...
(declare-fun |main_#t~post10_53| () Int)
...
(declare-fun |main_#t~short9_54| () Bool)
...
(declare-fun |main_#t~post10_61| () Int)
...
(assert (! (and (= (store |#valid_3| |main_~#volArray~0.base_5| v_ArrVal_92_fresh_1) |#valid_5|) (< |#StackHeapBarrier_-1| |main_~#volArray~0.base_5|) (= |main_~#volArray~0.offset_5| 0) (= (* (mod ~CELLCOUNT~0_4 1073741824) 4) v_ArrVal_91_fresh_1) (not (= |main_~#volArray~0.base_5| 0)) (= |#length_5| (store |#length_3| |main_~#volArray~0.base_5| v_ArrVal_91_fresh_1)) (= 0 (select |#valid_3| |main_~#volArray~0.base_5|)) (= main_~MINVAL~0_5 2) (< 1 ~CELLCOUNT~0_4) (= v_ArrVal_92_fresh_1 1)) :named ssa_5))
...
(assert (! (and (= (store |#memory_int#1_3| |main_~#volArray~0.base_5| v_ArrVal_93_fresh_1) |#memory_int#1_15|) (= (store (select |#memory_int#1_3| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~j~0_13 (- 4)) (* main_~i~0_12 16)) main_~j~0_13) v_ArrVal_93_fresh_1) (= main_~j~0_13 v_ArrVal_94_fresh_1) (<= main_~MINVAL~0_5 main_~j~0_13)) :named ssa_15))
(assert (! (= main_~j~0_13 (+ main_~j~0_16 1)) :named ssa_16))
(assert (! (<= 1 main_~j~0_16) :named ssa_17))
(assert (! (and (= (store |#memory_int#1_15| |main_~#volArray~0.base_5| v_ArrVal_95_fresh_1) |#memory_int#1_18|) (= main_~j~0_16 v_ArrVal_96_fresh_1) (<= main_~MINVAL~0_5 main_~j~0_16) (= (store (select |#memory_int#1_15| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~j~0_16 (- 4)) (* main_~i~0_12 16)) main_~j~0_16) v_ArrVal_95_fresh_1)) :named ssa_18))
(assert (! (= main_~j~0_16 (+ main_~j~0_19 1)) :named ssa_19))
(assert (! (<= 1 main_~j~0_19) :named ssa_20))
(assert (! (and (= (store |#memory_int#1_18| |main_~#volArray~0.base_5| v_ArrVal_97_fresh_1) |#memory_int#1_21|) (= (store (select |#memory_int#1_18| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~j~0_19 (- 4)) (* main_~i~0_12 16)) main_~j~0_19) v_ArrVal_97_fresh_1) (<= main_~MINVAL~0_5 main_~j~0_19) (= main_~j~0_19 v_ArrVal_98_fresh_1)) :named ssa_21))
(assert (! (= main_~j~0_19 (+ main_~j~0_22 1)) :named ssa_22))
(assert (! (<= 1 main_~j~0_22) :named ssa_23))
(assert (! (and (< main_~j~0_22 main_~MINVAL~0_5) (= v_ArrVal_99_fresh_1 0) (= (store |#memory_int#1_21| |main_~#volArray~0.base_5| v_ArrVal_100_fresh_1) |#memory_int#1_24|) (= (store (select |#memory_int#1_21| |main_~#volArray~0.base_5|) (+ (* main_~i~0_12 16) |main_~#volArray~0.offset_5| (* main_~j~0_22 (- 4))) v_ArrVal_99_fresh_1) v_ArrVal_100_fresh_1)) :named ssa_24))
...
(assert (! (and (or (and |main_#t~short9_30| (<= main_~MINVAL~0_5 |v_main_#t~mem7_25_fresh_1|)) (and (< |v_main_#t~mem7_25_fresh_1| main_~MINVAL~0_5) (not |main_#t~short9_30|))) (< main_~i~0_29 ~CELLCOUNT~0_4) (= (select (select |#memory_int#1_24| |main_~#volArray~0.base_5|) (+ (* main_~i~0_29 4) |main_~#volArray~0.offset_5|)) |v_main_#t~mem7_25_fresh_1|)) :named ssa_30))
...
(assert (! (and (< main_~i~0_37 ~CELLCOUNT~0_4) (or (and (< |v_main_#t~mem7_26_fresh_1| main_~MINVAL~0_5) (not |main_#t~short9_38|)) (and |main_#t~short9_38| (<= main_~MINVAL~0_5 |v_main_#t~mem7_26_fresh_1|))) (= (select (select |#memory_int#1_24| |main_~#volArray~0.base_5|) (+ (* main_~i~0_37 4) |main_~#volArray~0.offset_5|)) |v_main_#t~mem7_26_fresh_1|)) :named ssa_38))
(assert (! |main_#t~short9_38| :named ssa_39))
(assert (! true :named ssa_40_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_40| (ite |main_#t~short9_38| 1 0)) :named ssa_40_LocVarAssigCall))
...
(assert (! (and (or (and |main_#t~short9_46| (<= main_~MINVAL~0_5 |v_main_#t~mem7_27_fresh_1|)) (and (< |v_main_#t~mem7_27_fresh_1| main_~MINVAL~0_5) (not |main_#t~short9_46|))) (< main_~i~0_45 ~CELLCOUNT~0_4) (= (select (select |#memory_int#1_24| |main_~#volArray~0.base_5|) (+ (* main_~i~0_45 4) |main_~#volArray~0.offset_5|)) |v_main_#t~mem7_27_fresh_1|)) :named ssa_46))
(assert (! |main_#t~short9_46| :named ssa_47))
(assert (! true :named ssa_48_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_48| (ite |main_#t~short9_46| 1 0)) :named ssa_48_LocVarAssigCall))
...
(assert (! (and (< main_~i~0_53 ~CELLCOUNT~0_4) (or (and |main_#t~short9_54| (<= main_~MINVAL~0_5 |v_main_#t~mem7_28_fresh_1|)) (and (< |v_main_#t~mem7_28_fresh_1| main_~MINVAL~0_5) (not |main_#t~short9_54|))) (= (select (select |#memory_int#1_24| |main_~#volArray~0.base_5|) (+ (* main_~i~0_53 4) |main_~#volArray~0.offset_5|)) |v_main_#t~mem7_28_fresh_1|)) :named ssa_54))
(assert (! |main_#t~short9_54| :named ssa_55))
(assert (! true :named ssa_56_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_56| (ite |main_#t~short9_54| 1 0)) :named ssa_56_LocVarAssigCall))
...
(assert (! (and (= (select (select |#memory_int#1_24| |main_~#volArray~0.base_5|) (+ (* main_~i~0_61 4) |main_~#volArray~0.offset_5|)) |v_main_#t~mem7_29_fresh_1|) (< main_~i~0_61 ~CELLCOUNT~0_4) (or (and |main_#t~short9_62| (<= main_~MINVAL~0_5 |v_main_#t~mem7_29_fresh_1|)) (and (< |v_main_#t~mem7_29_fresh_1| main_~MINVAL~0_5) (not |main_#t~short9_62|)))) :named ssa_62))
(assert (! (and (not |main_#t~short9_62|) (or (and |main_#t~short9_63| (= |v_main_#t~mem8_17_fresh_1| 0)) (and (not |main_#t~short9_63|) (not (= |v_main_#t~mem8_17_fresh_1| 0)))) (= |v_main_#t~mem8_17_fresh_1| (select (select |#memory_int#1_24| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_61 4))))) :named ssa_63))
(assert (! true :named ssa_64_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_64| (ite |main_#t~short9_63| 1 0)) :named ssa_64_LocVarAssigCall))
...
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 ssa_5 ssa_6 (and ssa_11_return ssa_7_LocVarAssigCall ssa_10 ssa_8 ssa_9 ssa_7_OldVarAssigCall ssa_7_GlobVarAssigCall) ssa_12 ssa_13 ssa_14 ssa_15 ssa_16 ssa_17 ssa_18 ssa_19 ssa_20 ssa_21 ssa_22 ssa_23 ssa_24 ssa_25 ssa_26 ssa_27 ssa_28 ssa_29 ssa_30 ssa_31 (and ssa_34 ssa_32_LocVarAssigCall ssa_32_OldVarAssigCall ssa_32_GlobVarAssigCall ssa_36_return ssa_33 ssa_35) ssa_37 ssa_38 ssa_39 (and ssa_40_OldVarAssigCall ssa_40_LocVarAssigCall ssa_40_GlobVarAssigCall ssa_43 ssa_44_return ssa_41 ssa_42) ssa_45 ssa_46 ssa_47 (and ssa_48_OldVarAssigCall ssa_50 ssa_48_GlobVarAssigCall ssa_51 ssa_49 ssa_48_LocVarAssigCall ssa_52_return) ssa_53 ssa_54 ssa_55 (and ssa_57 ssa_56_GlobVarAssigCall ssa_56_OldVarAssigCall ssa_56_LocVarAssigCall ssa_58 ssa_59 ssa_60_return) ssa_61 ssa_62 ssa_63 (and ssa_64_OldVarAssigCall ssa_64_GlobVarAssigCall ssa_64_LocVarAssigCall) ssa_65 ssa_66 (and ssa_67 ssa_postcond))
