...
(set-info :ultimate-id gj2007.c.i.p+nlh-reducer.c_AllErrorsAtOnce_Iteration10)
...
(assert (! (and (= (+ main_~main__y~0_4 1) main_~main__y~0_40) (= (+ main_~main__x~0_38 1) main_~main__x~0_40) (<= 50 main_~main__x~0_38)) :named ssa_40))
...
(assert (! (and (= v_main_~__tmp_1~0_13_fresh_1 main_~__VERIFIER_assert__cond~0_139) (<= 100 main_~main__x~0_138) (= v_main_~__tmp_1~0_13_fresh_1 (ite (= main_~main__y~0_138 100) 1 0))) :named ssa_139))
