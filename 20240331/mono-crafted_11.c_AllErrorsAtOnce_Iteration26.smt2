...
(set-info :ultimate-id mono-crafted_11.c_AllErrorsAtOnce_Iteration26)
...
(assert (! (<= 100000000 (mod main_~x~0_52 4294967296)) :named ssa_53))
(assert (! true :named ssa_54_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_54| (ite (= (mod main_~x~0_52 2) 0) 1 0)) :named ssa_54_LocVarAssigCall))
