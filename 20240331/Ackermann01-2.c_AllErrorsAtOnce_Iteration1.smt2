...
(set-info :ultimate-id Ackermann01-2.c_AllErrorsAtOnce_Iteration1)
...
(declare-fun |main_#t~ret9_11| () Int)
...
(assert (! (= |main_#t~ret9_11| |ackermann_#res_9|) :named ssa_11_return))
(assert (! (and (<= 0 (+ |main_#t~ret9_11| 2147483648)) (= main_~result~0_12 |main_#t~ret9_11|) (<= |main_#t~ret9_11| 2147483647)) :named ssa_12))
(assert (! (and (< main_~result~0_12 0) (<= 0 main_~m~0_4) (<= 0 main_~n~0_5)) :named ssa_13))
(assert (! true :named ssa_14))
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 ssa_5 ssa_6 (and ssa_11_return ssa_7_LocVarAssigCall ssa_10 ssa_8 ssa_9 ssa_7_OldVarAssigCall ssa_7_GlobVarAssigCall) ssa_12 ssa_13 (and ssa_14 ssa_postcond))
...
(declare-fun |main_#t~ret9_3| () Int)
(assert (! true :named ssa_precond))
(assert (! (not (<= 1 |main_#t~ret9_3|)) :named ssa_postcond))
...
(assert (! (= |main_#t~ret9_3| |ackermann_#res_1|) :named ssa_3_return))
(assert (! (<= 0 main_~n~0_-2) :named ssa_-2_PendingContext))
