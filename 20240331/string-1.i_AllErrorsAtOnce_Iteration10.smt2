...
(set-info :ultimate-id string-1.i_AllErrorsAtOnce_Iteration10)
...
(declare-fun v_main_~found~0_15_fresh_1 () Int)
...
(declare-fun |v_main_#t~nondet1_36_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet1_37_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet1_38_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet1_39_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_35_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_36_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_37_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_38_fresh_1| () Int)
...
(declare-fun |v_main_#t~nondet4_39_fresh_1| () Int)
...
(declare-fun |v_main_#t~post8_4_fresh_1| () Int)
...
(declare-fun |v_main_#t~post10_6_fresh_1| () Int)
...
(declare-fun |main_#t~post14_34| () Int)
(declare-fun main_~i~0_35 () Int)
(declare-fun main_~nc_A~0_35 () Int)
(declare-fun main_~found~0_36 () Int)
(declare-fun main_~j~0_36 () Int)
(declare-fun main_~nc_B~0_36 () Int)
(declare-fun main_~found~0_37 () Int)
...
(assert (! (and (< |#StackHeapBarrier_-1| |main_~#string_A~0.base_4|) (= v_ArrVal_160_fresh_1 1) (= |#valid_4| (store (store |#valid_3| |main_~#string_A~0.base_4| v_ArrVal_160_fresh_1) |main_~#string_B~0.base_4| v_ArrVal_157_fresh_1)) (= main_~i~0_4 0) (= (select (store |#valid_3| |main_~#string_A~0.base_4| v_ArrVal_160_fresh_1) |main_~#string_B~0.base_4|) 0) (= (select |#valid_3| |main_~#string_A~0.base_4|) 0) (= |main_~#string_A~0.offset_4| 0) (not (= |main_~#string_B~0.base_4| 0)) (= v_ArrVal_157_fresh_1 1) (= v_main_~found~0_15_fresh_1 0) (= |main_~#string_B~0.offset_4| 0) (= v_ArrVal_159_fresh_1 5) (= v_ArrVal_158_fresh_1 5) (= |#length_4| (store (store |#length_3| |main_~#string_A~0.base_4| v_ArrVal_159_fresh_1) |main_~#string_B~0.base_4| v_ArrVal_158_fresh_1)) (not (= |main_~#string_A~0.base_4| 0)) (< |#StackHeapBarrier_-1| |main_~#string_B~0.base_4|)) :named ssa_4))
(assert (! (and (= v_ArrVal_162_fresh_1 (store (select |#memory_int#2_3| |main_~#string_A~0.base_4|) (+ main_~i~0_4 |main_~#string_A~0.offset_4|) v_ArrVal_161_fresh_1)) (= (store |#memory_int#2_3| |main_~#string_A~0.base_4| v_ArrVal_162_fresh_1) |#memory_int#2_5|) (= v_ArrVal_161_fresh_1 |v_main_#t~nondet1_35_fresh_1|) (<= |v_main_#t~nondet1_35_fresh_1| 127) (= main_~i~0_5 (+ main_~i~0_4 1)) (<= 0 (+ |v_main_#t~nondet1_35_fresh_1| 128)) (< main_~i~0_4 5)) :named ssa_5))
(assert (! (and (= v_ArrVal_163_fresh_1 (store (select |#memory_int#2_5| |main_~#string_A~0.base_4|) (+ main_~i~0_5 |main_~#string_A~0.offset_4|) |v_main_#t~nondet1_36_fresh_1|)) (<= 0 (+ |v_main_#t~nondet1_36_fresh_1| 128)) (= v_ArrVal_164_fresh_1 |v_main_#t~nondet1_36_fresh_1|) (= (store |#memory_int#2_5| |main_~#string_A~0.base_4| v_ArrVal_163_fresh_1) |#memory_int#2_6|) (= main_~i~0_6 (+ main_~i~0_5 1)) (<= |v_main_#t~nondet1_36_fresh_1| 127) (< main_~i~0_5 5)) :named ssa_6))
(assert (! (and (= (store |#memory_int#2_6| |main_~#string_A~0.base_4| v_ArrVal_165_fresh_1) |#memory_int#2_7|) (<= 0 (+ |v_main_#t~nondet1_37_fresh_1| 128)) (<= |v_main_#t~nondet1_37_fresh_1| 127) (= v_ArrVal_166_fresh_1 |v_main_#t~nondet1_37_fresh_1|) (= main_~i~0_7 (+ main_~i~0_6 1)) (= v_ArrVal_165_fresh_1 (store (select |#memory_int#2_6| |main_~#string_A~0.base_4|) (+ main_~i~0_6 |main_~#string_A~0.offset_4|) |v_main_#t~nondet1_37_fresh_1|)) (< main_~i~0_6 5)) :named ssa_7))
(assert (! (and (<= |v_main_#t~nondet1_38_fresh_1| 127) (= v_ArrVal_167_fresh_1 (store (select |#memory_int#2_7| |main_~#string_A~0.base_4|) (+ main_~i~0_7 |main_~#string_A~0.offset_4|) |v_main_#t~nondet1_38_fresh_1|)) (= main_~i~0_8 (+ main_~i~0_7 1)) (<= 0 (+ |v_main_#t~nondet1_38_fresh_1| 128)) (< main_~i~0_7 5) (= (store |#memory_int#2_7| |main_~#string_A~0.base_4| v_ArrVal_167_fresh_1) |#memory_int#2_8|) (= v_ArrVal_168_fresh_1 |v_main_#t~nondet1_38_fresh_1|)) :named ssa_8))
(assert (! (and (= v_ArrVal_170_fresh_1 (store (select |#memory_int#2_8| |main_~#string_A~0.base_4|) (+ main_~i~0_8 |main_~#string_A~0.offset_4|) v_ArrVal_169_fresh_1)) (= (store |#memory_int#2_8| |main_~#string_A~0.base_4| v_ArrVal_170_fresh_1) |#memory_int#2_9|) (= v_ArrVal_169_fresh_1 |v_main_#t~nondet1_39_fresh_1|) (<= |v_main_#t~nondet1_39_fresh_1| 127) (= main_~i~0_9 (+ main_~i~0_8 1)) (<= 0 (+ |v_main_#t~nondet1_39_fresh_1| 128)) (< main_~i~0_8 5)) :named ssa_9))
...
(assert (! (and (= v_ArrVal_172_fresh_1 |v_main_#t~nondet4_35_fresh_1|) (= main_~i~0_13 (+ main_~i~0_12 1)) (= (store |#memory_int#1_3| |main_~#string_B~0.base_4| v_ArrVal_171_fresh_1) |#memory_int#1_13|) (= v_ArrVal_171_fresh_1 (store (select |#memory_int#1_3| |main_~#string_B~0.base_4|) (+ main_~i~0_12 |main_~#string_B~0.offset_4|) |v_main_#t~nondet4_35_fresh_1|)) (<= 0 (+ |v_main_#t~nondet4_35_fresh_1| 128)) (< main_~i~0_12 5) (<= |v_main_#t~nondet4_35_fresh_1| 127)) :named ssa_13))
(assert (! (and (= |#memory_int#1_14| (store |#memory_int#1_13| |main_~#string_B~0.base_4| v_ArrVal_174_fresh_1)) (= main_~i~0_14 (+ main_~i~0_13 1)) (= v_ArrVal_174_fresh_1 (store (select |#memory_int#1_13| |main_~#string_B~0.base_4|) (+ main_~i~0_13 |main_~#string_B~0.offset_4|) v_ArrVal_173_fresh_1)) (<= 0 (+ |v_main_#t~nondet4_36_fresh_1| 128)) (< main_~i~0_13 5) (<= |v_main_#t~nondet4_36_fresh_1| 127) (= v_ArrVal_173_fresh_1 |v_main_#t~nondet4_36_fresh_1|)) :named ssa_14))
(assert (! (and (<= 0 (+ |v_main_#t~nondet4_37_fresh_1| 128)) (= main_~i~0_15 (+ main_~i~0_14 1)) (= (store |#memory_int#1_14| |main_~#string_B~0.base_4| v_ArrVal_176_fresh_1) |#memory_int#1_15|) (= v_ArrVal_176_fresh_1 (store (select |#memory_int#1_14| |main_~#string_B~0.base_4|) (+ main_~i~0_14 |main_~#string_B~0.offset_4|) v_ArrVal_175_fresh_1)) (< main_~i~0_14 5) (<= |v_main_#t~nondet4_37_fresh_1| 127) (= v_ArrVal_175_fresh_1 |v_main_#t~nondet4_37_fresh_1|)) :named ssa_15))
(assert (! (and (= v_ArrVal_178_fresh_1 |v_main_#t~nondet4_38_fresh_1|) (= main_~i~0_16 (+ main_~i~0_15 1)) (<= 0 (+ |v_main_#t~nondet4_38_fresh_1| 128)) (= (store |#memory_int#1_15| |main_~#string_B~0.base_4| v_ArrVal_177_fresh_1) |#memory_int#1_16|) (= v_ArrVal_177_fresh_1 (store (select |#memory_int#1_15| |main_~#string_B~0.base_4|) (+ main_~i~0_15 |main_~#string_B~0.offset_4|) |v_main_#t~nondet4_38_fresh_1|)) (<= |v_main_#t~nondet4_38_fresh_1| 127) (< main_~i~0_15 5)) :named ssa_16))
(assert (! (and (= v_ArrVal_180_fresh_1 (store (select |#memory_int#1_16| |main_~#string_B~0.base_4|) (+ main_~i~0_16 |main_~#string_B~0.offset_4|) v_ArrVal_179_fresh_1)) (= main_~i~0_17 (+ main_~i~0_16 1)) (= (store |#memory_int#1_16| |main_~#string_B~0.base_4| v_ArrVal_180_fresh_1) |#memory_int#1_17|) (<= |v_main_#t~nondet4_39_fresh_1| 127) (<= 0 (+ |v_main_#t~nondet4_39_fresh_1| 128)) (= v_ArrVal_179_fresh_1 |v_main_#t~nondet4_39_fresh_1|) (< main_~i~0_16 5)) :named ssa_17))
...
(assert (! (and (= (+ |v_main_#t~post8_4_fresh_1| 1) main_~nc_A~0_22) (= |v_main_#t~post8_4_fresh_1| main_~nc_A~0_20) (not (= |main_#t~mem7_21| 0))) :named ssa_22))
...
(assert (! (= |main_#t~mem7_23| 0) :named ssa_24))
(assert (! (= main_~nc_B~0_25 0) :named ssa_25))
...
(assert (! (and (= main_~nc_B~0_27 (+ |v_main_#t~post10_6_fresh_1| 1)) (= |v_main_#t~post10_6_fresh_1| main_~nc_B~0_25) (not (= |main_#t~mem9_26| 0))) :named ssa_27))
...
(assert (! (= |main_#t~mem9_28| 0) :named ssa_29))
(assert (! (and (= main_~j~0_30 0) (<= main_~nc_A~0_22 main_~nc_B~0_27) (= main_~i~0_30 main_~j~0_30)) :named ssa_30))
(assert (! (and (= (select (select |#memory_int#2_9| |main_~#string_A~0.base_4|) (+ |main_~#string_A~0.offset_4| main_~i~0_30)) |main_#t~mem11_31|) (< main_~i~0_30 main_~nc_A~0_22) (< main_~j~0_30 main_~nc_B~0_27) (= (select (select |#memory_int#1_17| |main_~#string_B~0.base_4|) (+ |main_~#string_B~0.offset_4| main_~j~0_30)) |main_#t~mem12_31|)) :named ssa_31))
(assert (! (and (= main_~j~0_32 0) (not (= |main_#t~mem12_31| |main_#t~mem11_31|)) (= (+ main_~i~0_32 main_~j~0_30) (+ main_~i~0_30 1))) :named ssa_32))
(assert (! (and (= (select (select |#memory_int#2_9| |main_~#string_A~0.base_4|) (+ |main_~#string_A~0.offset_4| main_~i~0_32)) |main_#t~mem11_33|) (< main_~i~0_32 main_~nc_A~0_22) (< main_~j~0_32 main_~nc_B~0_27) (= (select (select |#memory_int#1_17| |main_~#string_B~0.base_4|) (+ |main_~#string_B~0.offset_4| main_~j~0_32)) |main_#t~mem12_33|)) :named ssa_33))
(assert (! (and (= main_~j~0_34 (+ main_~j~0_32 1)) (= |main_#t~mem12_33| |main_#t~mem11_33|) (= main_~i~0_34 (+ main_~i~0_32 1))) :named ssa_34))
(assert (! (or (<= main_~nc_B~0_27 main_~j~0_34) (<= main_~nc_A~0_22 main_~i~0_34)) :named ssa_35))
(assert (! (= main_~found~0_36 (ite (< main_~nc_B~0_27 (+ main_~j~0_34 1)) 1 0)) :named ssa_36))
(assert (! true :named ssa_37_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_37| (ite (or (= main_~found~0_36 0) (= main_~found~0_36 1)) 1 0)) :named ssa_37_LocVarAssigCall))
