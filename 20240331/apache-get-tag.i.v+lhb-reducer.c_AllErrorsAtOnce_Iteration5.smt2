...
(set-info :ultimate-id apache-get-tag.i.v+lhb-reducer.c_AllErrorsAtOnce_Iteration5)
...
(declare-fun v_main_~__tmp_2~0_6_fresh_1 () Int)
...
(declare-fun v_main_~main____CPAchecker_TMP_2~0_4_fresh_1 () Int)
(declare-fun v_main_~main____CPAchecker_TMP_0~0_13_fresh_1 () Int)
(declare-fun main_~__VERIFIER_assert__cond~2_11 () Int)
(declare-fun v_main_~__tmp_3~0_5_fresh_1 () Int)
(declare-fun main_~main__t~0_12 () Int)
(declare-fun main_~__VERIFIER_assert__cond~2_12 () Int)
(declare-fun main_~__VERIFIER_assert__cond~3_12 () Int)
(declare-fun main_~main__tagbuf_len~0_12 () Int)
(declare-fun v_main_~__tmp_4~0_4_fresh_1 () Int)
(declare-fun main_~__VERIFIER_assert__cond~3_13 () Int)
...
(assert (! (and (= v_main_~__tmp_1~0_6_fresh_1 main_~__VERIFIER_assert__cond~0_7) (not (= main_~main____CPAchecker_TMP_0~0_6 0)) (= (ite (<= 0 main_~main__t~0_5) 1 0) v_main_~__tmp_1~0_6_fresh_1)) :named ssa_7))
(assert (! (and (= v_main_~__tmp_2~0_6_fresh_1 main_~__VERIFIER_assert__cond~1_8) (not (= main_~__VERIFIER_assert__cond~0_7 0)) (= v_main_~__tmp_2~0_6_fresh_1 (ite (<= main_~main__t~0_5 main_~main__tagbuf_len~0_5) 1 0))) :named ssa_8))
(assert (! (and (not (= main_~__VERIFIER_assert__cond~1_8 0)) (= main_~main____CPAchecker_TMP_0~0_6 ~__tmp_259_0~0_9)) :named ssa_9))
(assert (! (and (= v_main_~main____CPAchecker_TMP_2~0_4_fresh_1 main_~main__t~0_5) (= (+ main_~main__t~0_5 1) main_~main__t~0_10) (= ~__tmp_259_0~0_9 v_main_~main____CPAchecker_TMP_0~0_13_fresh_1)) :named ssa_10))
(assert (! (and (= v_main_~__tmp_3~0_5_fresh_1 (ite (<= 0 main_~main__t~0_10) 1 0)) (= main_~main__t~0_10 main_~main__tagbuf_len~0_5) (= v_main_~__tmp_3~0_5_fresh_1 main_~__VERIFIER_assert__cond~2_11)) :named ssa_11))
(assert (! (and (= v_main_~__tmp_4~0_4_fresh_1 main_~__VERIFIER_assert__cond~3_12) (not (= main_~__VERIFIER_assert__cond~2_11 0)) (= v_main_~__tmp_4~0_4_fresh_1 (ite (<= main_~main__t~0_10 main_~main__tagbuf_len~0_5) 1 0))) :named ssa_12))
(assert (! (= main_~__VERIFIER_assert__cond~3_12 0) :named ssa_13))
