...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration30)
...
(assert (! (<= 1000000 main_~i~0_33) :named ssa_34))
(assert (! true :named ssa_35_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_35| (ite (= main_~i~0_33 1000000) 1 0)) :named ssa_35_LocVarAssigCall))
