...
(set-info :ultimate-id nested_4.c_AllErrorsAtOnce_Iteration2)
...
(assert (! (or (not (= main_~c~0_4 6)) (not (= main_~d~0_4 6)) (not (= main_~b~0_4 6)) (not (= main_~a~0_4 6))) :named ssa_6))
