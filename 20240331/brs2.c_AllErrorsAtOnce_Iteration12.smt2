...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-30T23:50:44+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id brs2.c_AllErrorsAtOnce_Iteration12)
...
(declare-fun |main_~#sum~0.offset_45| () Int)
...
(assert (! (and (= (select |#valid_3| |main_~#sum~0.base_11|) 0) (= v_ArrVal_142_fresh_1 1) (< |#StackHeapBarrier_-1| |main_~#sum~0.base_11|) (< main_~a~0.base_11 |#StackHeapBarrier_-1|) (= |main_~#sum~0.offset_11| 0) (= v_ArrVal_144_fresh_1 8) (= v_ArrVal_141_fresh_1 (* (mod ~N~0_4 1073741824) 4)) (= v_ArrVal_143_fresh_1 1) (= |#valid_11| (store (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_142_fresh_1) main_~a~0.base_11 v_ArrVal_143_fresh_1)) (= (select (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_142_fresh_1) main_~a~0.base_11) 0) (not (= |main_~#sum~0.base_11| 0)) (= |#length_11| (store (store |#length_3| |main_~#sum~0.base_11| v_ArrVal_144_fresh_1) main_~a~0.base_11 v_ArrVal_141_fresh_1)) (= main_~a~0.offset_11 0) (not (= main_~a~0.base_11 0)) (= main_~i~0_11 0)) :named ssa_11))
(assert (! (< main_~i~0_11 ~N~0_4) :named ssa_12))
(assert (! (and (= v_ArrVal_146_fresh_1 (store (select |#memory_int#3_3| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_11 4)) v_ArrVal_145_fresh_1)) (= v_ArrVal_145_fresh_1 2) (= (store |#memory_int#3_3| main_~a~0.base_11 v_ArrVal_146_fresh_1) |#memory_int#3_13|) (= (ite (and (< main_~i~0_11 0) (not (= (mod main_~i~0_11 2) 0))) (+ (mod main_~i~0_11 2) (- 2)) (mod main_~i~0_11 2)) 0)) :named ssa_13))
(assert (! (= main_~i~0_14 (+ main_~i~0_11 1)) :named ssa_14))
(assert (! (< main_~i~0_14 ~N~0_4) :named ssa_15))
(assert (! (and (= v_ArrVal_147_fresh_1 (store (select |#memory_int#3_13| main_~a~0.base_11) (+ (* main_~i~0_14 4) main_~a~0.offset_11) 0)) (= (store |#memory_int#3_13| main_~a~0.base_11 v_ArrVal_147_fresh_1) |#memory_int#3_16|) (= v_ArrVal_148_fresh_1 0) (not (= (ite (and (not (= (mod main_~i~0_14 2) 0)) (< main_~i~0_14 0)) (+ (- 2) (mod main_~i~0_14 2)) (mod main_~i~0_14 2)) 0))) :named ssa_16))
(assert (! (= main_~i~0_17 (+ main_~i~0_14 1)) :named ssa_17))
(assert (! (< main_~i~0_17 ~N~0_4) :named ssa_18))
(assert (! (and (= v_ArrVal_149_fresh_1 2) (= v_ArrVal_150_fresh_1 (store (select |#memory_int#3_16| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_17 4)) v_ArrVal_149_fresh_1)) (= (store |#memory_int#3_16| main_~a~0.base_11 v_ArrVal_150_fresh_1) |#memory_int#3_19|) (= (ite (and (< main_~i~0_17 0) (not (= (mod main_~i~0_17 2) 0))) (+ (mod main_~i~0_17 2) (- 2)) (mod main_~i~0_17 2)) 0)) :named ssa_19))
(assert (! (= main_~i~0_20 (+ main_~i~0_17 1)) :named ssa_20))
(assert (! (< main_~i~0_20 ~N~0_4) :named ssa_21))
(assert (! (and (= v_ArrVal_152_fresh_1 0) (= (store |#memory_int#3_19| main_~a~0.base_11 v_ArrVal_151_fresh_1) |#memory_int#3_22|) (not (= (ite (and (not (= (mod main_~i~0_20 2) 0)) (< main_~i~0_20 0)) (+ (- 2) (mod main_~i~0_20 2)) (mod main_~i~0_20 2)) 0)) (= v_ArrVal_151_fresh_1 (store (select |#memory_int#3_19| main_~a~0.base_11) (+ (* main_~i~0_20 4) main_~a~0.offset_11) 0))) :named ssa_22))
(assert (! (= main_~i~0_23 (+ main_~i~0_20 1)) :named ssa_23))
(assert (! (< main_~i~0_23 ~N~0_4) :named ssa_24))
(assert (! (and (= v_ArrVal_154_fresh_1 (store (select |#memory_int#3_22| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_23 4)) v_ArrVal_153_fresh_1)) (= (store |#memory_int#3_22| main_~a~0.base_11 v_ArrVal_154_fresh_1) |#memory_int#3_25|) (= (ite (and (< main_~i~0_23 0) (not (= (mod main_~i~0_23 2) 0))) (+ (mod main_~i~0_23 2) (- 2)) (mod main_~i~0_23 2)) 0) (= v_ArrVal_153_fresh_1 2)) :named ssa_25))
...
(assert (! (and (= main_~i~0_28 0) (= v_ArrVal_155_fresh_1 0) (= v_ArrVal_156_fresh_1 (store (select |#memory_int#1_3| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| v_ArrVal_155_fresh_1)) (= (store |#memory_int#1_3| |main_~#sum~0.base_11| v_ArrVal_156_fresh_1) |#memory_int#1_30|)) :named ssa_30))
(assert (! (= main_~i~0_31 (+ main_~i~0_28 1)) :named ssa_31))
(assert (! (< main_~i~0_31 ~N~0_4) :named ssa_32))
(assert (! (and (= (store (select |#memory_int#1_30| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| v_ArrVal_157_fresh_1) v_ArrVal_158_fresh_1) (= (store |#memory_int#1_30| |main_~#sum~0.base_11| v_ArrVal_158_fresh_1) |#memory_int#1_33|) (= v_ArrVal_157_fresh_1 (+ (select (select |#memory_int#1_30| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|) (select (select |#memory_int#3_25| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_31 4))))) (not (= main_~i~0_31 0))) :named ssa_33))
(assert (! (= main_~i~0_34 (+ main_~i~0_31 1)) :named ssa_34))
(assert (! (< main_~i~0_34 ~N~0_4) :named ssa_35))
(assert (! (and (= (store |#memory_int#1_33| |main_~#sum~0.base_11| v_ArrVal_160_fresh_1) |#memory_int#1_36|) (= v_ArrVal_160_fresh_1 (store (select |#memory_int#1_33| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| v_ArrVal_159_fresh_1)) (= v_ArrVal_159_fresh_1 (+ (select (select |#memory_int#1_33| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|) (select (select |#memory_int#3_25| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_34 4))))) (not (= main_~i~0_34 0))) :named ssa_36))
(assert (! (= main_~i~0_37 (+ main_~i~0_34 1)) :named ssa_37))
(assert (! (< main_~i~0_37 ~N~0_4) :named ssa_38))
(assert (! (and (= v_ArrVal_161_fresh_1 (+ (select (select |#memory_int#1_36| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|) (select (select |#memory_int#3_25| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_37 4))))) (= (store |#memory_int#1_36| |main_~#sum~0.base_11| v_ArrVal_162_fresh_1) |#memory_int#1_39|) (= v_ArrVal_162_fresh_1 (store (select |#memory_int#1_36| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| v_ArrVal_161_fresh_1)) (not (= main_~i~0_37 0))) :named ssa_39))
(assert (! (= main_~i~0_40 (+ main_~i~0_37 1)) :named ssa_40))
(assert (! (< main_~i~0_40 ~N~0_4) :named ssa_41))
(assert (! (and (= (store |#memory_int#1_39| |main_~#sum~0.base_11| v_ArrVal_164_fresh_1) |#memory_int#1_42|) (= v_ArrVal_164_fresh_1 (store (select |#memory_int#1_39| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| v_ArrVal_163_fresh_1)) (= v_ArrVal_163_fresh_1 (+ (select (select |#memory_int#1_39| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|) (select (select |#memory_int#3_25| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_40 4))))) (not (= main_~i~0_40 0))) :named ssa_42))
(assert (! (= main_~i~0_43 (+ main_~i~0_40 1)) :named ssa_43))
(assert (! (<= ~N~0_4 main_~i~0_43) :named ssa_44))
(assert (! (= |main_#t~mem10_45| (select (select |#memory_int#1_42| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|)) :named ssa_45))
(assert (! true :named ssa_46_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_46| (ite (<= |main_#t~mem10_45| (* 2 ~N~0_4)) 1 0)) :named ssa_46_LocVarAssigCall))
