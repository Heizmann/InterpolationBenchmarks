...
(set-info :ultimate-id psyco_security.c_AllErrorsAtOnce_Iteration5)
...
(declare-fun v_main_~method_id~0_50_fresh_1 () Int)
...
(declare-fun v_main_~method_id~0_51_fresh_1 () Int)
...
(declare-fun v_main_~method_id~0_52_fresh_1 () Int)
(declare-fun main_~this_state~0_23 () Int)
...
(assert (! (= 3 v_main_~method_id~0_50_fresh_1) :named ssa_9))
...
(assert (! (= 1 v_main_~method_id~0_51_fresh_1) :named ssa_16))
...
(assert (! (and (= main_~q~0_17 1) (<= |main_#t~nondet5_20| 2147483647) (<= 0 (+ |main_#t~nondet5_20| 2147483648))) :named ssa_20))
(assert (! (not (= |main_#t~nondet5_20| 0)) :named ssa_21))
(assert (! (= 4 v_main_~method_id~0_52_fresh_1) :named ssa_22))
(assert (! (= 2 main_~this_state~0_17) :named ssa_23))
