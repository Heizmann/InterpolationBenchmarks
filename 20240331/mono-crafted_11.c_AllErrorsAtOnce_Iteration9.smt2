...
(set-info :ultimate-id mono-crafted_11.c_AllErrorsAtOnce_Iteration9)
...
(assert (! (<= 100000000 (mod main_~x~0_18 4294967296)) :named ssa_19))
(assert (! true :named ssa_20_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_20| (ite (= (mod main_~x~0_18 2) 0) 1 0)) :named ssa_20_LocVarAssigCall))
