...
(set-info :ultimate-id sep20-1.i_AllErrorsAtOnce_Iteration2)
...
(declare-fun |sep_#in~x.offset_7| () Int)
(declare-fun |sep_#in~x.base_7| () Int)
(declare-fun |main_~#x~0.base_7| () Int)
(declare-fun sep_~i~0_8 () Int)
(declare-fun sep_~x.offset_8 () Int)
(declare-fun sep_~x.base_8 () Int)
(declare-fun sep_~ret~0_8 () Int)
(declare-fun sep_~i~0_9 () Int)
(declare-fun sep_~i~0_10 () Int)
(declare-fun |sep_#res_10| () Int)
...
(assert (! (and (= main_~i~1_4 0) (= |main_~#x~0.offset_4| 0) (= (select |#valid_3| |main_~#x~0.base_4|) 0) (< |#StackHeapBarrier_-1| |main_~#x~0.base_4|) (= |#valid_4| (store |#valid_3| |main_~#x~0.base_4| v_ArrVal_9_fresh_1)) (not (= |main_~#x~0.base_4| 0)) (= v_ArrVal_8_fresh_1 80) (= (store |#length_3| |main_~#x~0.base_4| v_ArrVal_8_fresh_1) |#length_4|) (= v_ArrVal_9_fresh_1 1)) :named ssa_4))
(assert (! (<= 20 main_~i~1_4) :named ssa_5))
(assert (! true :named ssa_6))
(assert (! true :named ssa_7_GlobVarAssigCall))
(assert (! (and (= |main_~#x~0.offset_4| |sep_#in~x.offset_7|) (= |sep_#in~x.base_7| |main_~#x~0.base_4|)) :named ssa_7_LocVarAssigCall))
(assert (! true :named ssa_7_OldVarAssigCall))
(assert (! (and (= sep_~ret~0_8 0) (= sep_~i~0_8 0) (= |sep_#in~x.base_7| sep_~x.base_8) (= |sep_#in~x.offset_7| sep_~x.offset_8)) :named ssa_8))
(assert (! (<= 20 sep_~i~0_8) :named ssa_9))
(assert (! (= (ite (<= (mod sep_~ret~0_8 4294967296) 2147483647) (mod sep_~ret~0_8 4294967296) (+ (- 4294967296) (mod sep_~ret~0_8 4294967296))) |sep_#res_10|) :named ssa_10))
(assert (! (= |sep_#res_10| |main_#t~ret7_11|) :named ssa_11_return))
(assert (! (and (<= |main_#t~ret7_11| 2147483647) (= (store (store (select |#memory_int#1_3| |main_~#x~0.base_4|) |main_~#x~0.offset_4| v_ArrVal_10_fresh_1) (+ |main_~#x~0.offset_4| 4) v_main_~temp~0_7_fresh_1) v_ArrVal_11_fresh_1) (= (select (select |#memory_int#1_3| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4)) v_ArrVal_10_fresh_1) (= |main_#t~ret7_11| main_~ret~1_12) (<= 0 (+ |main_#t~ret7_11| 2147483648)) (= (select (select |#memory_int#1_3| |main_~#x~0.base_4|) |main_~#x~0.offset_4|) v_main_~temp~0_7_fresh_1) (= v_main_~temp~0_7_fresh_1 v_ArrVal_12_fresh_1) (= (store |#memory_int#1_3| |main_~#x~0.base_4| v_ArrVal_11_fresh_1) |#memory_int#1_12|)) :named ssa_12))
(assert (! true :named ssa_13_GlobVarAssigCall))
(assert (! (and (= |sep_#in~x.base_13| |main_~#x~0.base_4|) (= |main_~#x~0.offset_4| |sep_#in~x.offset_13|)) :named ssa_13_LocVarAssigCall))
...
(assert (! (<= 20 sep_~i~0_14) :named ssa_15))
(assert (! (= (ite (<= (mod sep_~ret~0_14 4294967296) 2147483647) (mod sep_~ret~0_14 4294967296) (+ (- 4294967296) (mod sep_~ret~0_14 4294967296))) |sep_#res_16|) :named ssa_16))
(assert (! (= |sep_#res_16| |main_#t~ret10_17|) :named ssa_17_return))
(assert (! (and (<= |main_#t~ret10_17| 2147483647) (= main_~ret2~0_18 |main_#t~ret10_17|) (= main_~i~2_18 0) (<= 0 (+ |main_#t~ret10_17| 2147483648)) (= main_~temp~0_18 (select (select |#memory_int#1_12| |main_~#x~0.base_4|) |main_~#x~0.offset_4|))) :named ssa_18))
(assert (! (<= 19 main_~i~2_18) :named ssa_19))
(assert (! (and (= (store |#memory_int#1_12| |main_~#x~0.base_4| v_ArrVal_13_fresh_1) |#memory_int#1_20|) (= main_~temp~0_18 v_ArrVal_14_fresh_1) (= (store (select |#memory_int#1_12| |main_~#x~0.base_4|) (+ 76 |main_~#x~0.offset_4|) main_~temp~0_18) v_ArrVal_13_fresh_1)) :named ssa_20))
...
(assert (! (= (ite (<= (mod sep_~ret~0_22 4294967296) 2147483647) (mod sep_~ret~0_22 4294967296) (+ (- 4294967296) (mod sep_~ret~0_22 4294967296))) |sep_#res_24|) :named ssa_24))
(assert (! (= |sep_#res_24| |main_#t~ret14_25|) :named ssa_25_return))
