...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:09:32+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id string_concat-noarr.i_AllErrorsAtOnce_Iteration27)
...
(assert (! (or (<= 1000000 main_~i~0_57) (= |main_#t~nondet3_58| 0)) :named ssa_59))
(assert (! (< main_~j~0_57 100) :named ssa_60))
(assert (! true :named ssa_61_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_61| (ite (< main_~i~0_57 200) 1 0)) :named ssa_61_LocVarAssigCall))
