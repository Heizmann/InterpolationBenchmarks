...
(set-info :ultimate-id standard_minInArray_ground-2.i_AllErrorsAtOnce_Iteration1)
...
(assert (! (and (not (= |main_~#a~0.base_4| 0)) (= main_~min~0_4 0) (< |#StackHeapBarrier_-1| |main_~#a~0.base_4|) (= v_ArrVal_1_fresh_1 1) (= 400000 v_ArrVal_2_fresh_1) (= |#valid_4| (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_1_fresh_1)) (= |main_~#a~0.offset_4| 0) (= (store |#length_3| |main_~#a~0.base_4| v_ArrVal_2_fresh_1) |#length_4|) (= (select |#valid_3| |main_~#a~0.base_4|) 0) (= main_~i~0_4 0)) :named ssa_4))
