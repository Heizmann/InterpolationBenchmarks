...
(set-info :ultimate-id gj2007.c.i.p+nlh-reducer.c_AllErrorsAtOnce_Iteration17)
...
(declare-fun v_main_~__tmp_1~0_20_fresh_1 () Int)
...
(assert (! (and (<= 50 main_~main__x~0_62) (= (+ main_~main__y~0_4 1) main_~main__y~0_64) (= main_~main__x~0_64 (+ main_~main__x~0_62 1))) :named ssa_64))
...
(assert (! (and (= v_main_~__tmp_1~0_20_fresh_1 (ite (= main_~main__y~0_138 100) 1 0)) (<= 100 main_~main__x~0_138) (= v_main_~__tmp_1~0_20_fresh_1 main_~__VERIFIER_assert__cond~0_139)) :named ssa_139))
