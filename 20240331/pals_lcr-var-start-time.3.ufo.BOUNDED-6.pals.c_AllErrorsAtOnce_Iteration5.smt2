...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:16:37+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id pals_lcr-var-start-time.3.ufo.BOUNDED-6.pals.c_AllErrorsAtOnce_Iteration5)
...
(declare-fun v_node1_~m1~0_20_fresh_1 () Int)
...
(declare-fun v_node2_~m2~0_20_fresh_1 () Int)
...
(declare-fun v_node3_~m3~0_20_fresh_1 () Int)
...
(assert (! (= ~nomsg~0_1 v_node1_~m1~0_20_fresh_1) :named ssa_31))
...
(assert (! (= ~nomsg~0_1 v_node2_~m2~0_20_fresh_1) :named ssa_38))
...
(assert (! (= ~nomsg~0_1 v_node3_~m3~0_20_fresh_1) :named ssa_45))
...
(assert (! (<= 3 ~r1~0_32) :named ssa_55))
(assert (! (and (= check_~tmp~1_56 0) (not (= (+ ~st1~0_30 ~st2~0_37 ~st3~0_44) 1))) :named ssa_56))
(assert (! (= |check_#res_57| check_~tmp~1_56) :named ssa_57))
(assert (! (= |check_#res_57| |main_#t~ret21_58|) :named ssa_58_return))
(assert (! (and (<= 0 (+ |main_#t~ret21_58| 2147483648)) (= |main_#t~ret21_58| main_~c1~0_59) (<= |main_#t~ret21_58| 2147483647)) :named ssa_59))
...
(assert (! true :named ssa_precond))
(assert (! (not (= ~r1~0_-2 0)) :named ssa_postcond))
...
(declare-fun ~send1~0_-1 () Int)
(declare-fun ~nomsg~0_-1 () Int)
(declare-fun v_node1_~m1~0_21_fresh_1 () Int)
(declare-fun ~r1~0_1 () Int)
(declare-fun ~p3_old~0_1 () Int)
...
(assert (! (not (< ~r1~0_1 2)) :named ssa_postcond))
(assert (! (= ~nomsg~0_-1 v_node1_~m1~0_21_fresh_1) :named ssa_0))
...
(assert (! (= ~r1~0_-2 0) :named ssa_-2_PendingContext))
(assert (! true :named ssa_-2_LocVarAssignPendingContext))
...
(declare-fun ~send2~0_-1 () Int)
(declare-fun ~nomsg~0_-1 () Int)
(declare-fun v_node2_~m2~0_21_fresh_1 () Int)
...
(assert (! (not (< ~r1~0_-2 2)) :named ssa_postcond))
(assert (! (= ~nomsg~0_-1 v_node2_~m2~0_21_fresh_1) :named ssa_0))
...
(assert (! true :named ssa_4))
(assert (! true :named ssa_5_return))
(assert (! (< ~r1~0_-2 2) :named ssa_-2_PendingContext))
(assert (! true :named ssa_-2_LocVarAssignPendingContext))
...
(declare-fun ~p2_old~0_-1 () Int)
(declare-fun ~nomsg~0_-1 () Int)
(declare-fun v_node3_~m3~0_21_fresh_1 () Int)
...
(assert (! (not (< ~r1~0_-2 2)) :named ssa_postcond))
(assert (! (= ~nomsg~0_-1 v_node3_~m3~0_21_fresh_1) :named ssa_0))
