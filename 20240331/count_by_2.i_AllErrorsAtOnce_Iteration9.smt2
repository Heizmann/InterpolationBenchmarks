...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration9)
...
(assert (! (<= 1000000 main_~i~0_12) :named ssa_13))
(assert (! true :named ssa_14_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_14| (ite (= main_~i~0_12 1000000) 1 0)) :named ssa_14_LocVarAssigCall))
