...
(set-info :ultimate-id parity.i_AllErrorsAtOnce_Iteration12)
...
(declare-fun v_main_~parity2~0_19_fresh_1 () Int)
...
(assert (! (and (= main_~v2~0_10 main_~v~0_4) (= v_main_~parity2~0_19_fresh_1 0)) :named ssa_10))
...
(assert (! (and (= main_~v2~0_16 |main_#t~bitwise5_18|) (= (mod main_~v2~0_16 4294967296) 286331153)) :named ssa_18))
