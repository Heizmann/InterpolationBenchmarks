...
(set-info :ultimate-id Ackermann01-2.c_AllErrorsAtOnce_Iteration8)
...
(declare-fun |ackermann_#t~ret6_56| () Int)
(declare-fun |ackermann_#t~ret5_56| () Int)
(declare-fun |ackermann_#res_58| () Int)
(declare-fun |main_#t~ret9_58| () Int)
(declare-fun main_~result~0_59 () Int)
(declare-fun |main_#t~ret9_59| () Int)
(declare-fun main_~result~0_60 () Int)
(declare-fun main_~m~0_60 () Int)
(declare-fun main_~n~0_60 () Int)
...
(assert (! (= |ackermann_#res_53| |ackermann_#t~ret6_55|) :named ssa_55_return))
(assert (! (and (= |ackermann_#res_56| |ackermann_#t~ret6_55|) (<= |ackermann_#t~ret6_55| 2147483647) (<= 0 (+ |ackermann_#t~ret6_55| 2147483648))) :named ssa_56))
(assert (! true :named ssa_57))
(assert (! (= |main_#t~ret9_58| |ackermann_#res_56|) :named ssa_58_return))
(assert (! (and (<= 0 (+ |main_#t~ret9_58| 2147483648)) (= main_~result~0_59 |main_#t~ret9_58|) (<= |main_#t~ret9_58| 2147483647)) :named ssa_59))
(assert (! (and (< main_~result~0_59 0) (<= 0 main_~m~0_4) (<= 0 main_~n~0_5)) :named ssa_60))
(assert (! true :named ssa_61))
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 ssa_5 ssa_6 (and ssa_13 ssa_20 ssa_19_GlobVarAssigCall ssa_44_LocVarAssigCall ssa_31 ssa_55_return ssa_16 ssa_57 ssa_15_LocVarAssigCall ssa_26 ssa_34 ssa_7_LocVarAssigCall ssa_11_LocVarAssigCall ssa_27_return ssa_40 ssa_10 ssa_14 ssa_8 ssa_45 ssa_9 ssa_32_LocVarAssigCall ssa_46 ssa_47 ssa_25 ssa_53 ssa_15_GlobVarAssigCall ssa_44_OldVarAssigCall ssa_39_return ssa_32_OldVarAssigCall ssa_23_OldVarAssigCall ssa_44_GlobVarAssigCall ssa_48_OldVarAssigCall ssa_19_OldVarAssigCall ssa_7_OldVarAssigCall ssa_43 ssa_23_LocVarAssigCall ssa_37 ssa_38 ssa_12 ssa_11_OldVarAssigCall ssa_32_GlobVarAssigCall ssa_50 ssa_19_LocVarAssigCall ssa_28 ssa_48_GlobVarAssigCall ssa_54 ssa_22 ssa_51 ssa_49 ssa_48_LocVarAssigCall ssa_29 ssa_42_return ssa_23_GlobVarAssigCall ssa_21 ssa_30_return ssa_11_GlobVarAssigCall ssa_18 ssa_36_return ssa_17 ssa_56 ssa_33 ssa_7_GlobVarAssigCall ssa_35 ssa_15_OldVarAssigCall ssa_58_return ssa_41 ssa_24 ssa_52_return) ssa_59 ssa_60 (and ssa_61 ssa_postcond))
...
(declare-fun |ackermann_#res_50| () Int)
(declare-fun |main_#t~ret9_50| () Int)
(assert (! true :named ssa_precond))
(assert (! (not (<= 5 |main_#t~ret9_50|)) :named ssa_postcond))
...
(assert (! (= |main_#t~ret9_50| |ackermann_#res_48|) :named ssa_50_return))
(assert (! true :named ssa_-2_PendingContext))
