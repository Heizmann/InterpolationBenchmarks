...
(set-info :ultimate-id watermelon.c_AllErrorsAtOnce_Iteration15)
...
(declare-fun v_main_~is_divisible2~0_20_fresh_1 () Int)
(declare-fun v_main_~is_divisible1~0_20_fresh_1 () Int)
...
(assert (! (and (= ~true~0_1 v_main_~is_divisible1~0_20_fresh_1) (= ~true~0_1 v_main_~is_divisible2~0_20_fresh_1)) :named ssa_4))
...
(assert (! (<= student_version_~w_20 student_version_~i~1_24) :named ssa_25))
(assert (! (= student_version_~w_20 student_version_~i~1_24) :named ssa_26))
(assert (! true :named ssa_27))
(assert (! (= student_version_~is_divisible~1_20 |student_version_#res_28|) :named ssa_28))
...
(assert (! (= (ite (= main_~is_divisible1~0_18 main_~is_divisible2~0_30) 1 0) |__VERIFIER_assert_#in~cond_31|) :named ssa_31_LocVarAssigCall))
...
(assert (! true :named ssa_precond))
(assert (! (not (and (<= main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647)) (<= (+ (* (div main_~w~0_-2 4294967296) 4294967296) 7) main_~w~0_-2))) :named ssa_postcond))
...
(assert (! (and (<= main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647)) (<= (+ (* (div main_~w~0_-2 4294967296) 4294967296) 7) main_~w~0_-2)) :named ssa_-2_PendingContext))
