...
(set-info :ultimate-id array_ptr_single_elem_init-1.i_AllErrorsAtOnce_Iteration3)
...
(declare-fun main_~s~0.offset_6 () Int)
(declare-fun |main_#t~malloc2.offset_6| () Int)
...
(declare-fun |v_main_#t~mem8_7_fresh_1| () Int)
(declare-fun |main_#t~mem10.base_13| () Int)
(declare-fun |main_#t~mem10.offset_13| () Int)
(declare-fun |main_#t~mem8_13| () Int)
(declare-fun main_~s1~0.offset_13 () Int)
(declare-fun |main_#t~short9_13| () Bool)
(declare-fun main_~s1~0.base_13 () Int)
(declare-fun |main_#t~mem10.base_14| () Int)
(declare-fun |__VERIFIER_assert_#in~cond_14| () Int)
(declare-fun |main_#t~mem10.offset_14| () Int)
...
(assert (! (and (< 0 |#StackHeapBarrier_-1|) (= (select |#valid_-1| 0) 0) (= 31 (select |#length_-1| 2)) (= (select |#valid_-1| 2) 1) (= |~#a~0.base_1| 3) (= (select |#valid_-1| 3) 1) (= ((as const (Array Int Int)) 0) v_ArrVal_26_fresh_1) (= |~#a~0.offset_1| 0) (= (select |#valid_-1| 1) 1) (= (store |#memory_$Pointer$#1.base_0| |~#a~0.base_1| v_ArrVal_25_fresh_1) |#memory_$Pointer$#1.base_1|) (= ((as const (Array Int Int)) 0) v_ArrVal_25_fresh_1) (= (select (select |#memory_int#0_-1| 1) 1) 0) (= 2 (select |#length_-1| 1)) (= (select |#length_-1| 3) 400000) (= (select (select |#memory_int#0_-1| 1) 0) 48) (= (store |#memory_$Pointer$#1.offset_0| |~#a~0.base_1| v_ArrVal_26_fresh_1) |#memory_$Pointer$#1.offset_1|)) :named ssa_1))
...
(assert (! (and (= (select (select |#memory_$Pointer$#2.offset_6| main_~s~0.base_6) (+ main_~s~0.offset_6 4)) v_ArrVal_30_fresh_1) (= (store (select |#memory_$Pointer$#2.base_3| main_~s~0.base_6) (+ main_~s~0.offset_6 4) v_ArrVal_29_fresh_1) v_ArrVal_32_fresh_1) (= (store |#memory_$Pointer$#2.offset_3| main_~s~0.base_6 v_ArrVal_31_fresh_1) |#memory_$Pointer$#2.offset_6|) (not (= main_~s~0.base_6 0)) (= |#valid_6| (store |#valid_3| main_~s~0.base_6 v_ArrVal_34_fresh_1)) (= |#memory_$Pointer$#2.base_6| (store |#memory_$Pointer$#2.base_3| main_~s~0.base_6 v_ArrVal_32_fresh_1)) (= 8 v_ArrVal_27_fresh_1) (= v_ArrVal_34_fresh_1 1) (= main_~q~0_5 0) (= v_ArrVal_29_fresh_1 (select (select |#memory_$Pointer$#2.base_6| main_~s~0.base_6) (+ main_~s~0.offset_6 4))) (= (ite (and (not (= (mod main_~q~0_5 2) 0)) (< main_~q~0_5 0)) (+ (- 2) (mod main_~q~0_5 2)) (mod main_~q~0_5 2)) v_ArrVal_33_fresh_1) (= (store (select |#memory_$Pointer$#2.offset_3| main_~s~0.base_6) (+ main_~s~0.offset_6 4) v_ArrVal_30_fresh_1) v_ArrVal_31_fresh_1) (= |#length_6| (store |#length_3| main_~s~0.base_6 v_ArrVal_27_fresh_1)) (< main_~s~0.base_6 |#StackHeapBarrier_-1|) (= main_~s~0.offset_6 0) (= (select |#valid_3| main_~s~0.base_6) 0) (= v_ArrVal_28_fresh_1 (store (select |#memory_int#2_3| main_~s~0.base_6) (+ main_~s~0.offset_6 4) (ite (and (not (= (mod main_~q~0_5 2) 0)) (< main_~q~0_5 0)) (+ (- 2) (mod main_~q~0_5 2)) (mod main_~q~0_5 2)))) (= (store |#memory_int#2_3| main_~s~0.base_6 v_ArrVal_28_fresh_1) |#memory_int#2_6|)) :named ssa_6))
(assert (! (and (= main_~s~0.offset_6 0) (= main_~s~0.base_6 0)) :named ssa_7))
(assert (! (and (= |#memory_$Pointer$#1.offset_8| (store |#memory_$Pointer$#1.offset_3| |~#a~0.base_1| v_ArrVal_40_fresh_1)) (= (store (select |#memory_int#1_3| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4)) (select (select |#memory_int#1_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4)))) v_ArrVal_35_fresh_1) (= (store |#memory_int#1_3| |~#a~0.base_1| v_ArrVal_35_fresh_1) |#memory_int#1_8|) (= (store |#memory_$Pointer$#1.base_3| |~#a~0.base_1| v_ArrVal_38_fresh_1) |#memory_$Pointer$#1.base_8|) (= main_~i~0_8 (+ main_~i~0_4 1)) (= (select (select |#memory_int#1_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4))) v_ArrVal_36_fresh_1) (= (store (select |#memory_$Pointer$#1.base_3| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4)) main_~s~0.base_6) v_ArrVal_38_fresh_1) (= (store (select |#memory_$Pointer$#1.offset_3| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4)) v_ArrVal_37_fresh_1) v_ArrVal_40_fresh_1) (= main_~s~0.offset_6 v_ArrVal_37_fresh_1) (= main_~s~0.base_6 v_ArrVal_39_fresh_1)) :named ssa_8))
(assert (! (<= 100000 main_~i~0_8) :named ssa_9))
(assert (! (and (not (= 0 |v_main_#t~malloc6.base_6_fresh_1|)) (= v_ArrVal_47_fresh_1 |v_main_#t~malloc6.base_6_fresh_1|) (< |v_main_#t~malloc6.base_6_fresh_1| |#StackHeapBarrier_-1|) (= v_ArrVal_41_fresh_1 1) (= (store |#memory_$Pointer$#1.offset_8| |~#a~0.base_1| v_ArrVal_42_fresh_1) |#memory_$Pointer$#1.offset_10|) (= (store (select |#memory_$Pointer$#1.offset_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12) 0) v_ArrVal_42_fresh_1) (= |#valid_10| (store |#valid_6| |v_main_#t~malloc6.base_6_fresh_1| v_ArrVal_41_fresh_1)) (= v_ArrVal_45_fresh_1 0) (= |#length_10| (store |#length_6| |v_main_#t~malloc6.base_6_fresh_1| v_ArrVal_43_fresh_1)) (= 8 v_ArrVal_43_fresh_1) (= (select (select |#memory_int#1_10| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12)) v_ArrVal_48_fresh_1) (= (store |#memory_$Pointer$#1.base_8| |~#a~0.base_1| v_ArrVal_44_fresh_1) |#memory_$Pointer$#1.base_10|) (= (store (select |#memory_int#1_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12) (select (select |#memory_int#1_10| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12))) v_ArrVal_46_fresh_1) (= v_ArrVal_44_fresh_1 (store (select |#memory_$Pointer$#1.base_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12) |v_main_#t~malloc6.base_6_fresh_1|)) (= (select |#valid_6| |v_main_#t~malloc6.base_6_fresh_1|) 0) (= main_~i~0_10 0) (= (store |#memory_int#1_8| |~#a~0.base_1| v_ArrVal_46_fresh_1) |#memory_int#1_10|)) :named ssa_10))
(assert (! (and (= (select (select |#memory_$Pointer$#1.base_10| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_10 4))) main_~s1~0.base_11) (= main_~s1~0.offset_11 (select (select |#memory_$Pointer$#1.offset_10| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_10 4)))) (< main_~i~0_10 100000) (or (and (not |main_#t~short9_11|) (or (and (= main_~s1~0.offset_11 0) (= main_~s1~0.base_11 0)) (= main_~i~0_10 3))) (and |main_#t~short9_11| (or (not (= main_~s1~0.offset_11 0)) (not (= main_~s1~0.base_11 0))) (not (= main_~i~0_10 3))))) :named ssa_11))
(assert (! (and (or (and (not |main_#t~short9_12|) (not (= |v_main_#t~mem8_7_fresh_1| 0))) (and (= |v_main_#t~mem8_7_fresh_1| 0) |main_#t~short9_12|)) |main_#t~short9_11| (= (select (select |#memory_int#2_6| main_~s1~0.base_11) (+ main_~s1~0.offset_11 4)) |v_main_#t~mem8_7_fresh_1|)) :named ssa_12))
(assert (! (and |main_#t~short9_12| (= |main_#t~mem10.offset_13| (select (select |#memory_$Pointer$#2.offset_6| main_~s1~0.base_11) main_~s1~0.offset_11)) (= (select (select |#memory_$Pointer$#2.base_6| main_~s1~0.base_11) main_~s1~0.offset_11) |main_#t~mem10.base_13|)) :named ssa_13))
(assert (! true :named ssa_14_GlobVarAssigCall))
(assert (! (= (ite (or (not (= |main_#t~mem10.base_13| 0)) (not (= |main_#t~mem10.offset_13| 0))) 1 0) |__VERIFIER_assert_#in~cond_14|) :named ssa_14_LocVarAssigCall))
...
(assert (! (and (= |#memory_$Pointer$#1.offset_0| (store |#memory_$Pointer$#1.offset_-1| |~#a~0.base_0| v_ArrVal_50_fresh_1)) (< 0 |#StackHeapBarrier_-1|) (= (select |#valid_-2| 0) 0) (= 31 (select |#length_-2| 2)) (= (select |#valid_-2| 2) 1) (= |~#a~0.base_0| 3) (= (select |#valid_-2| 3) 1) (= (store |#memory_$Pointer$#1.base_-1| |~#a~0.base_0| v_ArrVal_49_fresh_1) |#memory_$Pointer$#1.base_0|) (= ((as const (Array Int Int)) 0) v_ArrVal_50_fresh_1) (= ((as const (Array Int Int)) 0) v_ArrVal_49_fresh_1) (= |~#a~0.offset_0| 0) (= (select |#valid_-2| 1) 1) (= (select (select |#memory_int#0_-2| 1) 1) 0) (= 2 (select |#length_-2| 1)) (= (select |#length_-2| 3) 400000) (= (select (select |#memory_int#0_-2| 1) 0) 48)) :named ssa_0))
