...
(set-info :ultimate-id num_conversion_2.c_AllErrorsAtOnce_Iteration3)
...
(assert (! (and (not (= (mod main_~bit~0_9 256) 0)) (= main_~y~0_10 (+ (mod main_~y~0_4 256) (mod main_~i~0_7 256)))) :named ssa_10))
...
(assert (! (= |__VERIFIER_assert_#in~cond_13| (ite (= (mod main_~x~0_4 256) (mod main_~y~0_10 256)) 1 0)) :named ssa_13_LocVarAssigCall))
