...
(set-info :ultimate-id pals_lcr-var-start-time.3.ufo.BOUNDED-6.pals.c_AllErrorsAtOnce_Iteration2)
...
(assert (! (and (<= ~id2~0_4 127) (<= 0 (+ ~send2~0_4 128)) (<= ~id1~0_4 127) (<= 0 (+ ~send3~0_4 128)) (<= ~send3~0_4 127) (<= ~st2~0_4 127) (<= 0 (+ ~id3~0_4 128)) (<= ~r1~0_4 127) (<= ~st1~0_4 127) (<= 0 (+ 128 ~st3~0_4)) (<= 0 (+ 128 ~st2~0_4)) (<= 0 (+ ~r1~0_4 128)) (= 0 v_main_~c1~0_8_fresh_1) (<= 0 (+ 128 ~st1~0_4)) (<= 0 (+ ~id2~0_4 128)) (<= ~id3~0_4 127) (<= ~st3~0_4 127) (<= 0 (+ ~send1~0_4 128)) (<= 0 (+ ~id1~0_4 128)) (<= ~send1~0_4 127) (<= ~send2~0_4 127)) :named ssa_4))
...
(assert (! (not (= main_~i2~0_10 0)) :named ssa_11))
...
(assert (! (= ~nomsg~0_1 v_node1_~m1~0_14_fresh_1) :named ssa_15))
...
(assert (! (= ~nomsg~0_1 v_node2_~m2~0_14_fresh_1) :named ssa_22))
...
(assert (! (= ~nomsg~0_1 v_node3_~m3~0_14_fresh_1) :named ssa_29))
...
(assert (! true :named ssa_precond))
(assert (! (not (= |main_#t~ret20_3| 0)) :named ssa_postcond))
