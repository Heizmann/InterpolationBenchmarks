...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:09:45+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id gj2007.c.i.p+nlh-reducer.c_AllErrorsAtOnce_Iteration15)
...
(declare-fun v_main_~__tmp_1~0_18_fresh_1 () Int)
...
(assert (! (and (= main_~main__y~0_60 (+ main_~main__y~0_4 1)) (= (+ main_~main__x~0_58 1) main_~main__x~0_60) (<= 50 main_~main__x~0_58)) :named ssa_60))
...
(assert (! (and (= v_main_~__tmp_1~0_18_fresh_1 main_~__VERIFIER_assert__cond~0_139) (<= 100 main_~main__x~0_138) (= v_main_~__tmp_1~0_18_fresh_1 (ite (= main_~main__y~0_138 100) 1 0))) :named ssa_139))
