...
(set-info :ultimate-id sep20-1.i_AllErrorsAtOnce_Iteration3)
...
(declare-fun |sep_#in~x.offset_8| () Int)
(declare-fun |sep_#in~x.base_8| () Int)
(declare-fun |main_~#x~0.base_8| () Int)
(declare-fun sep_~i~0_9 () Int)
(declare-fun sep_~x.offset_9 () Int)
(declare-fun sep_~x.base_9 () Int)
(declare-fun sep_~ret~0_9 () Int)
...
(assert (! (and (= main_~i~1_4 0) (= |main_~#x~0.offset_4| 0) (= (select |#valid_3| |main_~#x~0.base_4|) 0) (< |#StackHeapBarrier_-1| |main_~#x~0.base_4|) (= v_ArrVal_16_fresh_1 1) (not (= |main_~#x~0.base_4| 0)) (= (store |#valid_3| |main_~#x~0.base_4| v_ArrVal_16_fresh_1) |#valid_4|) (= v_ArrVal_15_fresh_1 80) (= (store |#length_3| |main_~#x~0.base_4| v_ArrVal_15_fresh_1) |#length_4|)) :named ssa_4))
(assert (! (and (= |v_main_#t~nondet5_8_fresh_1| v_ArrVal_17_fresh_1) (<= 0 (+ |v_main_#t~nondet5_8_fresh_1| 2147483648)) (= |#memory_int#1_5| (store |#memory_int#1_3| |main_~#x~0.base_4| v_ArrVal_18_fresh_1)) (< main_~i~1_4 20) (<= |v_main_#t~nondet5_8_fresh_1| 2147483647) (= (store (select |#memory_int#1_3| |main_~#x~0.base_4|) (+ (* main_~i~1_4 4) |main_~#x~0.offset_4|) v_ArrVal_17_fresh_1) v_ArrVal_18_fresh_1) (= main_~i~1_5 (+ main_~i~1_4 1))) :named ssa_5))
(assert (! (<= 20 main_~i~1_5) :named ssa_6))
(assert (! true :named ssa_7))
(assert (! true :named ssa_8_GlobVarAssigCall))
(assert (! (and (= |main_~#x~0.offset_4| |sep_#in~x.offset_8|) (= |sep_#in~x.base_8| |main_~#x~0.base_4|)) :named ssa_8_LocVarAssigCall))
(assert (! true :named ssa_8_OldVarAssigCall))
(assert (! (and (= sep_~ret~0_9 0) (= sep_~i~0_9 0) (= |sep_#in~x.base_8| sep_~x.base_9) (= |sep_#in~x.offset_8| sep_~x.offset_9)) :named ssa_9))
(assert (! (<= 20 sep_~i~0_9) :named ssa_10))
(assert (! (= (ite (<= (mod sep_~ret~0_9 4294967296) 2147483647) (mod sep_~ret~0_9 4294967296) (+ (- 4294967296) (mod sep_~ret~0_9 4294967296))) |sep_#res_11|) :named ssa_11))
(assert (! (= |sep_#res_11| |main_#t~ret7_12|) :named ssa_12_return))
(assert (! (and (= v_main_~temp~0_8_fresh_1 v_ArrVal_21_fresh_1) (= (select (select |#memory_int#1_5| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4)) v_ArrVal_19_fresh_1) (<= |main_#t~ret7_12| 2147483647) (= (store |#memory_int#1_5| |main_~#x~0.base_4| v_ArrVal_20_fresh_1) |#memory_int#1_13|) (= (select (select |#memory_int#1_5| |main_~#x~0.base_4|) |main_~#x~0.offset_4|) v_main_~temp~0_8_fresh_1) (= (store (store (select |#memory_int#1_5| |main_~#x~0.base_4|) |main_~#x~0.offset_4| v_ArrVal_19_fresh_1) (+ |main_~#x~0.offset_4| 4) v_main_~temp~0_8_fresh_1) v_ArrVal_20_fresh_1) (= |main_#t~ret7_12| main_~ret~1_13) (<= 0 (+ |main_#t~ret7_12| 2147483648))) :named ssa_13))
(assert (! true :named ssa_14_GlobVarAssigCall))
(assert (! (and (= |sep_#in~x.base_14| |main_~#x~0.base_4|) (= |main_~#x~0.offset_4| |sep_#in~x.offset_14|)) :named ssa_14_LocVarAssigCall))
...
(assert (! (= (ite (<= (mod sep_~ret~0_15 4294967296) 2147483647) (mod sep_~ret~0_15 4294967296) (+ (- 4294967296) (mod sep_~ret~0_15 4294967296))) |sep_#res_17|) :named ssa_17))
(assert (! (= |sep_#res_17| |main_#t~ret10_18|) :named ssa_18_return))
(assert (! (and (<= |main_#t~ret10_18| 2147483647) (= main_~ret2~0_19 |main_#t~ret10_18|) (= main_~i~2_19 0) (<= 0 (+ |main_#t~ret10_18| 2147483648)) (= main_~temp~0_19 (select (select |#memory_int#1_13| |main_~#x~0.base_4|) |main_~#x~0.offset_4|))) :named ssa_19))
(assert (! (<= 19 main_~i~2_19) :named ssa_20))
(assert (! (and (= (store |#memory_int#1_13| |main_~#x~0.base_4| v_ArrVal_22_fresh_1) |#memory_int#1_21|) (= (store (select |#memory_int#1_13| |main_~#x~0.base_4|) (+ 76 |main_~#x~0.offset_4|) main_~temp~0_19) v_ArrVal_22_fresh_1) (= main_~temp~0_19 v_ArrVal_23_fresh_1)) :named ssa_21))
...
(assert (! (= (ite (<= (mod sep_~ret~0_23 4294967296) 2147483647) (mod sep_~ret~0_23 4294967296) (+ (- 4294967296) (mod sep_~ret~0_23 4294967296))) |sep_#res_25|) :named ssa_25))
(assert (! (= |sep_#res_25| |main_#t~ret14_26|) :named ssa_26_return))
