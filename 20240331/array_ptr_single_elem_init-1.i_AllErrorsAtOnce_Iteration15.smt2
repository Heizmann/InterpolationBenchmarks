...
(set-info :ultimate-id array_ptr_single_elem_init-1.i_AllErrorsAtOnce_Iteration15)
...
(declare-fun |v_main_#t~malloc6.base_18_fresh_1| () Int)
...
(declare-fun |main_#t~mem7.base_55| () Int)
(declare-fun |main_#t~mem7.offset_55| () Int)
(declare-fun main_~s1~0.offset_55 () Int)
(declare-fun |main_#t~short9_55| () Bool)
(declare-fun main_~s1~0.base_55 () Int)
(declare-fun |main_#t~short9_56| () Bool)
(declare-fun |v_main_#t~mem8_19_fresh_1| () Int)
(declare-fun |main_#t~mem10.base_57| () Int)
(declare-fun |main_#t~mem10.offset_57| () Int)
(declare-fun |main_#t~mem8_57| () Int)
(declare-fun main_~s1~0.offset_57 () Int)
(declare-fun |main_#t~short9_57| () Bool)
(declare-fun main_~s1~0.base_57 () Int)
(declare-fun |main_#t~mem10.base_58| () Int)
(declare-fun |__VERIFIER_assert_#in~cond_58| () Int)
(declare-fun |main_#t~mem10.offset_58| () Int)
...
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_580_fresh_1) (< 0 |#StackHeapBarrier_-1|) (= (select |#valid_-1| 0) 0) (= (store |#memory_$Pointer$#1.base_0| |~#a~0.base_1| v_ArrVal_579_fresh_1) |#memory_$Pointer$#1.base_1|) (= ((as const (Array Int Int)) 0) v_ArrVal_579_fresh_1) (= 31 (select |#length_-1| 2)) (= (select |#valid_-1| 2) 1) (= |~#a~0.base_1| 3) (= (store |#memory_$Pointer$#1.offset_0| |~#a~0.base_1| v_ArrVal_580_fresh_1) |#memory_$Pointer$#1.offset_1|) (= (select |#valid_-1| 3) 1) (= |~#a~0.offset_1| 0) (= (select |#valid_-1| 1) 1) (= (select (select |#memory_int#0_-1| 1) 1) 0) (= 2 (select |#length_-1| 1)) (= (select |#length_-1| 3) 400000) (= (select (select |#memory_int#0_-1| 1) 0) 48)) :named ssa_1))
...
(assert (! (and (= (store |#memory_$Pointer$#1.offset_3| |~#a~0.base_1| v_ArrVal_586_fresh_1) |#memory_$Pointer$#1.offset_8|) (= main_~i~0_8 (+ main_~i~0_4 1)) (= v_ArrVal_583_fresh_1 main_~s~0.offset_5) (= (store |#memory_int#1_3| |~#a~0.base_1| v_ArrVal_581_fresh_1) |#memory_int#1_8|) (= v_ArrVal_586_fresh_1 (store (select |#memory_$Pointer$#1.offset_3| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4)) v_ArrVal_583_fresh_1)) (= v_ArrVal_584_fresh_1 (store (select |#memory_$Pointer$#1.base_3| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4)) main_~s~0.base_5)) (= v_ArrVal_582_fresh_1 (select (select |#memory_int#1_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4)))) (= v_ArrVal_581_fresh_1 (store (select |#memory_int#1_3| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4)) (select (select |#memory_int#1_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4))))) (= (store |#memory_$Pointer$#1.base_3| |~#a~0.base_1| v_ArrVal_584_fresh_1) |#memory_$Pointer$#1.base_8|) (= v_ArrVal_585_fresh_1 main_~s~0.base_5)) :named ssa_8))
...
(assert (! (and (= (store |#memory_int#1_8| |~#a~0.base_1| v_ArrVal_587_fresh_1) |#memory_int#1_12|) (= main_~i~0_12 (+ main_~i~0_8 1)) (= v_ArrVal_587_fresh_1 (store (select |#memory_int#1_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_8 4)) (select (select |#memory_int#1_12| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_8 4))))) (= v_ArrVal_588_fresh_1 (select (select |#memory_int#1_12| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_8 4)))) (= (store |#memory_$Pointer$#1.base_8| |~#a~0.base_1| v_ArrVal_590_fresh_1) |#memory_$Pointer$#1.base_12|) (= |#memory_$Pointer$#1.offset_12| (store |#memory_$Pointer$#1.offset_8| |~#a~0.base_1| v_ArrVal_592_fresh_1)) (= (store (select |#memory_$Pointer$#1.offset_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_8 4)) v_ArrVal_589_fresh_1) v_ArrVal_592_fresh_1) (= v_ArrVal_590_fresh_1 (store (select |#memory_$Pointer$#1.base_8| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_8 4)) main_~s~0.base_9)) (= v_ArrVal_591_fresh_1 main_~s~0.base_9) (= v_ArrVal_589_fresh_1 main_~s~0.offset_9)) :named ssa_12))
...
(assert (! (and (= v_ArrVal_596_fresh_1 (store (select |#memory_$Pointer$#1.base_12| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_12 4)) main_~s~0.base_13)) (= v_ArrVal_594_fresh_1 (select (select |#memory_int#1_16| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_12 4)))) (= (store |#memory_int#1_12| |~#a~0.base_1| v_ArrVal_593_fresh_1) |#memory_int#1_16|) (= v_ArrVal_597_fresh_1 main_~s~0.base_13) (= main_~i~0_16 (+ main_~i~0_12 1)) (= v_ArrVal_598_fresh_1 (store (select |#memory_$Pointer$#1.offset_12| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_12 4)) v_ArrVal_595_fresh_1)) (= (store |#memory_$Pointer$#1.base_12| |~#a~0.base_1| v_ArrVal_596_fresh_1) |#memory_$Pointer$#1.base_16|) (= v_ArrVal_595_fresh_1 main_~s~0.offset_13) (= (store |#memory_$Pointer$#1.offset_12| |~#a~0.base_1| v_ArrVal_598_fresh_1) |#memory_$Pointer$#1.offset_16|) (= v_ArrVal_593_fresh_1 (store (select |#memory_int#1_12| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_12 4)) (select (select |#memory_int#1_16| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_12 4)))))) :named ssa_16))
...
(assert (! (and (= v_ArrVal_602_fresh_1 (store (select |#memory_$Pointer$#1.base_16| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_16 4)) main_~s~0.base_17)) (= |#memory_$Pointer$#1.offset_20| (store |#memory_$Pointer$#1.offset_16| |~#a~0.base_1| v_ArrVal_604_fresh_1)) (= v_ArrVal_604_fresh_1 (store (select |#memory_$Pointer$#1.offset_16| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_16 4)) v_ArrVal_601_fresh_1)) (= main_~i~0_20 (+ main_~i~0_16 1)) (= (store |#memory_$Pointer$#1.base_16| |~#a~0.base_1| v_ArrVal_602_fresh_1) |#memory_$Pointer$#1.base_20|) (= v_ArrVal_600_fresh_1 (select (select |#memory_int#1_20| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_16 4)))) (= v_ArrVal_599_fresh_1 (store (select |#memory_int#1_16| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_16 4)) (select (select |#memory_int#1_20| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_16 4))))) (= v_ArrVal_601_fresh_1 main_~s~0.offset_17) (= v_ArrVal_603_fresh_1 main_~s~0.base_17) (= (store |#memory_int#1_16| |~#a~0.base_1| v_ArrVal_599_fresh_1) |#memory_int#1_20|)) :named ssa_20))
...
(assert (! (and (= v_ArrVal_609_fresh_1 main_~s~0.base_21) (= v_ArrVal_606_fresh_1 (select (select |#memory_int#1_24| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_20 4)))) (= (store |#memory_$Pointer$#1.base_20| |~#a~0.base_1| v_ArrVal_608_fresh_1) |#memory_$Pointer$#1.base_24|) (= main_~i~0_24 (+ main_~i~0_20 1)) (= v_ArrVal_608_fresh_1 (store (select |#memory_$Pointer$#1.base_20| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_20 4)) main_~s~0.base_21)) (= v_ArrVal_605_fresh_1 (store (select |#memory_int#1_20| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_20 4)) (select (select |#memory_int#1_24| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_20 4))))) (= v_ArrVal_607_fresh_1 main_~s~0.offset_21) (= (store |#memory_int#1_20| |~#a~0.base_1| v_ArrVal_605_fresh_1) |#memory_int#1_24|) (= v_ArrVal_610_fresh_1 (store (select |#memory_$Pointer$#1.offset_20| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_20 4)) v_ArrVal_607_fresh_1)) (= |#memory_$Pointer$#1.offset_24| (store |#memory_$Pointer$#1.offset_20| |~#a~0.base_1| v_ArrVal_610_fresh_1))) :named ssa_24))
...
(assert (! (and (= v_ArrVal_611_fresh_1 (store (select |#memory_int#1_24| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_24 4)) (select (select |#memory_int#1_28| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_24 4))))) (= v_ArrVal_613_fresh_1 main_~s~0.offset_25) (= v_ArrVal_614_fresh_1 (store (select |#memory_$Pointer$#1.base_24| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_24 4)) main_~s~0.base_25)) (= main_~i~0_28 (+ main_~i~0_24 1)) (= v_ArrVal_616_fresh_1 (store (select |#memory_$Pointer$#1.offset_24| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_24 4)) v_ArrVal_613_fresh_1)) (= (store |#memory_$Pointer$#1.base_24| |~#a~0.base_1| v_ArrVal_614_fresh_1) |#memory_$Pointer$#1.base_28|) (= (store |#memory_$Pointer$#1.offset_24| |~#a~0.base_1| v_ArrVal_616_fresh_1) |#memory_$Pointer$#1.offset_28|) (= (store |#memory_int#1_24| |~#a~0.base_1| v_ArrVal_611_fresh_1) |#memory_int#1_28|) (= v_ArrVal_612_fresh_1 (select (select |#memory_int#1_28| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_24 4)))) (= v_ArrVal_615_fresh_1 main_~s~0.base_25)) :named ssa_28))
...
(assert (! (and (= v_ArrVal_618_fresh_1 (select (select |#memory_int#1_32| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_28 4)))) (= (store |#memory_int#1_28| |~#a~0.base_1| v_ArrVal_617_fresh_1) |#memory_int#1_32|) (= v_ArrVal_617_fresh_1 (store (select |#memory_int#1_28| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_28 4)) (select (select |#memory_int#1_32| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_28 4))))) (= (store |#memory_$Pointer$#1.offset_28| |~#a~0.base_1| v_ArrVal_622_fresh_1) |#memory_$Pointer$#1.offset_32|) (= v_ArrVal_619_fresh_1 main_~s~0.offset_29) (= main_~i~0_32 (+ main_~i~0_28 1)) (= v_ArrVal_622_fresh_1 (store (select |#memory_$Pointer$#1.offset_28| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_28 4)) v_ArrVal_619_fresh_1)) (= v_ArrVal_620_fresh_1 (store (select |#memory_$Pointer$#1.base_28| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_28 4)) main_~s~0.base_29)) (= (store |#memory_$Pointer$#1.base_28| |~#a~0.base_1| v_ArrVal_620_fresh_1) |#memory_$Pointer$#1.base_32|) (= v_ArrVal_621_fresh_1 main_~s~0.base_29)) :named ssa_32))
...
(assert (! (and (= (store |#memory_int#1_32| |~#a~0.base_1| v_ArrVal_623_fresh_1) |#memory_int#1_36|) (= v_ArrVal_628_fresh_1 (store (select |#memory_$Pointer$#1.offset_32| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_32 4)) v_ArrVal_625_fresh_1)) (= (store |#memory_$Pointer$#1.base_32| |~#a~0.base_1| v_ArrVal_626_fresh_1) |#memory_$Pointer$#1.base_36|) (= main_~i~0_36 (+ main_~i~0_32 1)) (= v_ArrVal_625_fresh_1 main_~s~0.offset_33) (= v_ArrVal_627_fresh_1 main_~s~0.base_33) (= v_ArrVal_626_fresh_1 (store (select |#memory_$Pointer$#1.base_32| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_32 4)) main_~s~0.base_33)) (= v_ArrVal_623_fresh_1 (store (select |#memory_int#1_32| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_32 4)) (select (select |#memory_int#1_36| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_32 4))))) (= v_ArrVal_624_fresh_1 (select (select |#memory_int#1_36| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_32 4)))) (= |#memory_$Pointer$#1.offset_36| (store |#memory_$Pointer$#1.offset_32| |~#a~0.base_1| v_ArrVal_628_fresh_1))) :named ssa_36))
...
(assert (! (and (= (store |#memory_int#1_36| |~#a~0.base_1| v_ArrVal_629_fresh_1) |#memory_int#1_40|) (= v_ArrVal_630_fresh_1 (select (select |#memory_int#1_40| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_36 4)))) (= v_ArrVal_633_fresh_1 main_~s~0.base_37) (= v_ArrVal_634_fresh_1 (store (select |#memory_$Pointer$#1.offset_36| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_36 4)) v_ArrVal_631_fresh_1)) (= main_~i~0_40 (+ main_~i~0_36 1)) (= v_ArrVal_632_fresh_1 (store (select |#memory_$Pointer$#1.base_36| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_36 4)) main_~s~0.base_37)) (= |#memory_$Pointer$#1.offset_40| (store |#memory_$Pointer$#1.offset_36| |~#a~0.base_1| v_ArrVal_634_fresh_1)) (= (store |#memory_$Pointer$#1.base_36| |~#a~0.base_1| v_ArrVal_632_fresh_1) |#memory_$Pointer$#1.base_40|) (= v_ArrVal_631_fresh_1 main_~s~0.offset_37) (= v_ArrVal_629_fresh_1 (store (select |#memory_int#1_36| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_36 4)) (select (select |#memory_int#1_40| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_36 4)))))) :named ssa_40))
...
(assert (! (and (= v_ArrVal_635_fresh_1 (store (select |#memory_int#1_40| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_40 4)) (select (select |#memory_int#1_44| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_40 4))))) (= (store |#memory_$Pointer$#1.offset_40| |~#a~0.base_1| v_ArrVal_640_fresh_1) |#memory_$Pointer$#1.offset_44|) (= v_ArrVal_639_fresh_1 main_~s~0.base_41) (= v_ArrVal_638_fresh_1 (store (select |#memory_$Pointer$#1.base_40| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_40 4)) main_~s~0.base_41)) (= v_ArrVal_636_fresh_1 (select (select |#memory_int#1_44| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_40 4)))) (= v_ArrVal_637_fresh_1 main_~s~0.offset_41) (= main_~i~0_44 (+ main_~i~0_40 1)) (= v_ArrVal_640_fresh_1 (store (select |#memory_$Pointer$#1.offset_40| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_40 4)) v_ArrVal_637_fresh_1)) (= (store |#memory_$Pointer$#1.base_40| |~#a~0.base_1| v_ArrVal_638_fresh_1) |#memory_$Pointer$#1.base_44|) (= (store |#memory_int#1_40| |~#a~0.base_1| v_ArrVal_635_fresh_1) |#memory_int#1_44|)) :named ssa_44))
...
(assert (! (and (= v_ArrVal_644_fresh_1 (store (select |#memory_$Pointer$#1.base_44| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_44 4)) main_~s~0.base_45)) (= v_ArrVal_643_fresh_1 main_~s~0.offset_45) (= main_~i~0_48 (+ main_~i~0_44 1)) (= (store |#memory_int#1_44| |~#a~0.base_1| v_ArrVal_641_fresh_1) |#memory_int#1_48|) (= v_ArrVal_642_fresh_1 (select (select |#memory_int#1_48| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_44 4)))) (= v_ArrVal_645_fresh_1 main_~s~0.base_45) (= (store |#memory_$Pointer$#1.offset_44| |~#a~0.base_1| v_ArrVal_646_fresh_1) |#memory_$Pointer$#1.offset_48|) (= v_ArrVal_646_fresh_1 (store (select |#memory_$Pointer$#1.offset_44| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_44 4)) v_ArrVal_643_fresh_1)) (= v_ArrVal_641_fresh_1 (store (select |#memory_int#1_44| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_44 4)) (select (select |#memory_int#1_48| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_44 4))))) (= (store |#memory_$Pointer$#1.base_44| |~#a~0.base_1| v_ArrVal_644_fresh_1) |#memory_$Pointer$#1.base_48|)) :named ssa_48))
...
(assert (! (and (= |#memory_$Pointer$#1.base_52| (store |#memory_$Pointer$#1.base_48| |~#a~0.base_1| v_ArrVal_650_fresh_1)) (= (store |#memory_int#1_48| |~#a~0.base_1| v_ArrVal_647_fresh_1) |#memory_int#1_52|) (= main_~i~0_52 (+ main_~i~0_48 1)) (= (store |#memory_$Pointer$#1.offset_48| |~#a~0.base_1| v_ArrVal_652_fresh_1) |#memory_$Pointer$#1.offset_52|) (= v_ArrVal_651_fresh_1 main_~s~0.base_49) (= v_ArrVal_652_fresh_1 (store (select |#memory_$Pointer$#1.offset_48| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_48 4)) v_ArrVal_649_fresh_1)) (= v_ArrVal_650_fresh_1 (store (select |#memory_$Pointer$#1.base_48| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_48 4)) main_~s~0.base_49)) (= v_ArrVal_647_fresh_1 (store (select |#memory_int#1_48| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_48 4)) (select (select |#memory_int#1_52| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_48 4))))) (= v_ArrVal_648_fresh_1 (select (select |#memory_int#1_52| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_48 4)))) (= v_ArrVal_649_fresh_1 main_~s~0.offset_49)) :named ssa_52))
(assert (! (<= 100000 main_~i~0_52) :named ssa_53))
(assert (! (and (= (store |#memory_$Pointer$#1.base_52| |~#a~0.base_1| v_ArrVal_654_fresh_1) |#memory_$Pointer$#1.base_54|) (= (select |#valid_3| |v_main_#t~malloc6.base_18_fresh_1|) 0) (= (store |#valid_3| |v_main_#t~malloc6.base_18_fresh_1| v_ArrVal_655_fresh_1) |#valid_54|) (= v_ArrVal_653_fresh_1 (store (select |#memory_$Pointer$#1.offset_52| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12) 0)) (= v_ArrVal_659_fresh_1 |v_main_#t~malloc6.base_18_fresh_1|) (= |#memory_$Pointer$#1.offset_54| (store |#memory_$Pointer$#1.offset_52| |~#a~0.base_1| v_ArrVal_653_fresh_1)) (not (= |v_main_#t~malloc6.base_18_fresh_1| 0)) (= v_ArrVal_655_fresh_1 1) (= v_ArrVal_657_fresh_1 8) (= v_ArrVal_656_fresh_1 0) (= |#length_54| (store |#length_3| |v_main_#t~malloc6.base_18_fresh_1| v_ArrVal_657_fresh_1)) (< |v_main_#t~malloc6.base_18_fresh_1| |#StackHeapBarrier_-1|) (= (store |#memory_int#1_52| |~#a~0.base_1| v_ArrVal_658_fresh_1) |#memory_int#1_54|) (= v_ArrVal_654_fresh_1 (store (select |#memory_$Pointer$#1.base_52| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12) |v_main_#t~malloc6.base_18_fresh_1|)) (= main_~i~0_54 0) (= v_ArrVal_658_fresh_1 (store (select |#memory_int#1_52| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12) (select (select |#memory_int#1_54| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12)))) (= v_ArrVal_660_fresh_1 (select (select |#memory_int#1_54| |~#a~0.base_1|) (+ |~#a~0.offset_1| 12)))) :named ssa_54))
(assert (! (and (= (select (select |#memory_$Pointer$#1.base_54| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_54 4))) main_~s1~0.base_55) (= main_~s1~0.offset_55 (select (select |#memory_$Pointer$#1.offset_54| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_54 4)))) (< main_~i~0_54 100000) (or (and (not |main_#t~short9_55|) (or (and (= main_~s1~0.offset_55 0) (= main_~s1~0.base_55 0)) (= main_~i~0_54 3))) (and |main_#t~short9_55| (or (not (= main_~s1~0.offset_55 0)) (not (= main_~s1~0.base_55 0))) (not (= main_~i~0_54 3))))) :named ssa_55))
(assert (! (and |main_#t~short9_55| (= (select (select |#memory_int#2_3| main_~s1~0.base_55) (+ main_~s1~0.offset_55 4)) |v_main_#t~mem8_19_fresh_1|) (or (and |main_#t~short9_56| (= |v_main_#t~mem8_19_fresh_1| 0)) (and (not (= |v_main_#t~mem8_19_fresh_1| 0)) (not |main_#t~short9_56|)))) :named ssa_56))
(assert (! (and |main_#t~short9_56| (= |main_#t~mem10.offset_57| (select (select |#memory_$Pointer$#2.offset_3| main_~s1~0.base_55) main_~s1~0.offset_55)) (= (select (select |#memory_$Pointer$#2.base_3| main_~s1~0.base_55) main_~s1~0.offset_55) |main_#t~mem10.base_57|)) :named ssa_57))
(assert (! true :named ssa_58_GlobVarAssigCall))
(assert (! (= (ite (or (not (= |main_#t~mem10.base_57| 0)) (not (= |main_#t~mem10.offset_57| 0))) 1 0) |__VERIFIER_assert_#in~cond_58|) :named ssa_58_LocVarAssigCall))
...
(assert (! (and (< 0 |#StackHeapBarrier_-1|) (= ((as const (Array Int Int)) 0) v_ArrVal_661_fresh_1) (= (select |#valid_-2| 0) 0) (= 31 (select |#length_-2| 2)) (= (select |#valid_-2| 2) 1) (= |~#a~0.base_0| 3) (= (select |#valid_-2| 3) 1) (= |#memory_$Pointer$#1.offset_0| (store |#memory_$Pointer$#1.offset_-1| |~#a~0.base_0| v_ArrVal_662_fresh_1)) (= |~#a~0.offset_0| 0) (= (select |#valid_-2| 1) 1) (= ((as const (Array Int Int)) 0) v_ArrVal_662_fresh_1) (= (select (select |#memory_int#0_-2| 1) 1) 0) (= 2 (select |#length_-2| 1)) (= (store |#memory_$Pointer$#1.base_-1| |~#a~0.base_0| v_ArrVal_661_fresh_1) |#memory_$Pointer$#1.base_0|) (= (select |#length_-2| 3) 400000) (= (select (select |#memory_int#0_-2| 1) 0) 48)) :named ssa_0))
