...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:18:03+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id cancel_var_through_overflow.i_AllErrorsAtOnce_Iteration2)
...
(declare-fun c_main_~p0~0 () Int)
(declare-fun c_main_~p0~0_primed () Int)
...
(declare-fun main_~r~0_6 () Int)
(declare-fun main_~p0~0_7 () Int)
(declare-fun |__VERIFIER_assert_#in~cond_7| () Int)
(declare-fun main_~p1~0_7 () Int)
...
(assert (! (and (< 0 |#StackHeapBarrier_-1|) (= 30 (select |#length_-1| 2)) (= (select |#valid_-1| 2) 1) (= (select |#valid_-1| 1) 1) (= (select (select |#memory_int#0_-1| 1) 1) 0) (= (select |#length_-1| 1) 2) (= (select (select |#memory_int#0_-1| 1) 0) 48) (= (select |#valid_-1| 0) 0)) :named ssa_1))
(assert (! true :named ssa_2_return))
(assert (! true :named ssa_3_GlobVarAssigCall))
(assert (! true :named ssa_3_LocVarAssigCall))
(assert (! true :named ssa_3_OldVarAssigCall))
(assert (! (and (<= v_main_~x~0_5_fresh_1 2147483647) (<= 0 (+ main_~p0~0_4 2147483648)) (<= 0 (+ v_main_~x~0_5_fresh_1 2147483648)) (<= main_~p1~0_4 2147483647) (<= 0 (+ main_~p1~0_4 2147483648)) (<= main_~p0~0_4 2147483647)) :named ssa_4))
(assert (! (<= main_~p0~0_4 main_~p1~0_4) :named ssa_5))
(assert (! (= main_~p1~0_4 (+ main_~p0~0_4 main_~r~0_6)) :named ssa_6))
(assert (! true :named ssa_7_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_7| (ite (= main_~p1~0_4 (+ main_~p0~0_4 (mod main_~r~0_6 4294967296))) 1 0)) :named ssa_7_LocVarAssigCall))
...
(assert (! (and (< 0 |#StackHeapBarrier_-1|) (= 30 (select |#length_-1| 2)) (= (select |#valid_-1| 2) 1) (= (select |#valid_-1| 1) 1) (= (select (select |#memory_int#0_-1| 1) 1) 0) (= (select |#length_-1| 1) 2) (= (select (select |#memory_int#0_-1| 1) 0) 48) (= (select |#valid_-1| 0) 0)) :named ssa_0))
