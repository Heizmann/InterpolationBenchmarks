...
(set-info :ultimate-id test_locks_7.c_AllErrorsAtOnce_Iteration16)
...
(declare-fun main_~lk6~0_20 () Int)
...
(assert (! (not (= main_~p6~0_4 0)) :named ssa_19))
(assert (! (not (= main_~lk6~0_6 1)) :named ssa_20))
