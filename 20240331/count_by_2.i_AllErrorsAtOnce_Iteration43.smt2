...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration43)
...
(assert (! (<= 1000000 main_~i~0_46) :named ssa_47))
(assert (! true :named ssa_48_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_48| (ite (= main_~i~0_46 1000000) 1 0)) :named ssa_48_LocVarAssigCall))
