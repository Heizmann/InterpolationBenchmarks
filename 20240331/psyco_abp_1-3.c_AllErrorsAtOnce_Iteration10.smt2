...
(set-info :ultimate-id psyco_abp_1-3.c_AllErrorsAtOnce_Iteration10)
...
(declare-fun v_main_~P7~0_26_fresh_1 () Int)
(declare-fun v_main_~P2~0_26_fresh_1 () Int)
(declare-fun v_main_~P5~0_26_fresh_1 () Int)
(declare-fun |main_#t~nondet13_7| () Int)
(declare-fun |main_#t~nondet13_8| () Int)
(declare-fun v_main_~method_id~0_86_fresh_1 () Int)
...
(declare-fun v_main_~P7~0_27_fresh_1 () Int)
(declare-fun v_main_~P2~0_27_fresh_1 () Int)
(declare-fun v_main_~P5~0_27_fresh_1 () Int)
(declare-fun |main_#t~nondet14_13| () Int)
(declare-fun |main_#t~nondet14_14| () Int)
(declare-fun v_main_~method_id~0_87_fresh_1 () Int)
...
(declare-fun v_main_~P2~0_28_fresh_1 () Int)
(declare-fun v_main_~P7~0_28_fresh_1 () Int)
(declare-fun v_main_~P5~0_28_fresh_1 () Int)
...
(declare-fun v_main_~method_id~0_88_fresh_1 () Int)
...
(declare-fun v_main_~P7~0_29_fresh_1 () Int)
(declare-fun v_main_~P2~0_29_fresh_1 () Int)
(declare-fun v_main_~P5~0_29_fresh_1 () Int)
...
(declare-fun main_~P1~0_34 () Int)
(declare-fun v_main_~method_id~0_89_fresh_1 () Int)
(declare-fun main_~this_expect~0_35 () Int)
(declare-fun main_~this_buffer_empty~0_35 () Int)
(declare-fun main_~P3~0_35 () Int)
...
(assert (! (and (<= v_main_~P2~0_26_fresh_1 2147483647) (<= main_~P4~0_6 2147483647) (<= v_main_~P5~0_26_fresh_1 2147483647) (<= v_main_~P7~0_26_fresh_1 2147483647) (<= 0 (+ main_~P1~0_6 2147483648)) (<= main_~P3~0_6 2147483647) (<= main_~P8~0_6 2147483647) (<= 0 (+ main_~P8~0_6 2147483648)) (<= 0 (+ main_~P6~0_6 2147483648)) (<= 0 (+ main_~P3~0_6 2147483648)) (<= 0 (+ main_~P9~0_6 2147483648)) (<= 0 (+ v_main_~P7~0_26_fresh_1 2147483648)) (<= 0 (+ v_main_~P5~0_26_fresh_1 2147483648)) (<= main_~P9~0_6 2147483647) (<= 0 (+ main_~P4~0_6 2147483648)) (<= main_~P1~0_6 2147483647) (<= 0 (+ v_main_~P2~0_26_fresh_1 2147483648)) (<= main_~P6~0_6 2147483647)) :named ssa_6))
...
(assert (! (= 1 v_main_~method_id~0_86_fresh_1) :named ssa_9))
(assert (! (and (= main_~this_buffer_empty~0_10 1) (= main_~q~0_10 1) (= main_~this_expect~0_10 0)) :named ssa_10))
(assert (! (and (<= main_~P4~0_11 2147483647) (<= v_main_~P2~0_27_fresh_1 2147483647) (<= 0 (+ main_~P1~0_11 2147483648)) (<= 0 (+ v_main_~P7~0_27_fresh_1 2147483648)) (<= main_~P3~0_11 2147483647) (<= main_~P8~0_11 2147483647) (<= 0 (+ main_~P8~0_11 2147483648)) (<= 0 (+ main_~P6~0_11 2147483648)) (<= 0 (+ main_~P3~0_11 2147483648)) (<= 0 (+ main_~P9~0_11 2147483648)) (<= main_~P9~0_11 2147483647) (<= 0 (+ main_~P4~0_11 2147483648)) (<= main_~P1~0_11 2147483647) (<= 0 (+ v_main_~P5~0_27_fresh_1 2147483648)) (<= v_main_~P5~0_27_fresh_1 2147483647) (<= 0 (+ v_main_~P2~0_27_fresh_1 2147483648)) (<= v_main_~P7~0_27_fresh_1 2147483647) (<= main_~P6~0_11 2147483647)) :named ssa_11))
...
(assert (! (and (= (ite (and (< main_~P1~0_11 0) (not (= (mod main_~P1~0_11 2) 0))) (+ (- 2) (mod main_~P1~0_11 2)) (mod main_~P1~0_11 2)) 0) (= 2 v_main_~method_id~0_87_fresh_1)) :named ssa_15))
...
(assert (! (and (<= main_~P4~0_17 2147483647) (<= 0 (+ v_main_~P7~0_28_fresh_1 2147483648)) (<= 0 (+ v_main_~P5~0_28_fresh_1 2147483648)) (<= 0 (+ main_~P1~0_17 2147483648)) (<= main_~P3~0_17 2147483647) (<= 0 (+ v_main_~P2~0_28_fresh_1 2147483648)) (<= main_~P8~0_17 2147483647) (<= 0 (+ main_~P8~0_17 2147483648)) (<= 0 (+ main_~P6~0_17 2147483648)) (<= 0 (+ main_~P3~0_17 2147483648)) (<= 0 (+ main_~P9~0_17 2147483648)) (<= v_main_~P7~0_28_fresh_1 2147483647) (<= v_main_~P5~0_28_fresh_1 2147483647) (<= main_~P9~0_17 2147483647) (<= 0 (+ main_~P4~0_17 2147483648)) (<= main_~P1~0_17 2147483647) (<= v_main_~P2~0_28_fresh_1 2147483647) (<= main_~P6~0_17 2147483647)) :named ssa_17))
...
(assert (! (and (= 3 v_main_~method_id~0_88_fresh_1) (= main_~P1~0_17 0)) :named ssa_24))
...
(assert (! (and (<= main_~P4~0_26 2147483647) (<= 0 (+ main_~P1~0_26 2147483648)) (<= main_~P3~0_26 2147483647) (<= main_~P8~0_26 2147483647) (<= 0 (+ main_~P8~0_26 2147483648)) (<= 0 (+ main_~P6~0_26 2147483648)) (<= 0 (+ main_~P3~0_26 2147483648)) (<= 0 (+ main_~P9~0_26 2147483648)) (<= v_main_~P7~0_29_fresh_1 2147483647) (<= 0 (+ v_main_~P2~0_29_fresh_1 2147483648)) (<= main_~P9~0_26 2147483647) (<= 0 (+ main_~P4~0_26 2147483648)) (<= main_~P1~0_26 2147483647) (<= 0 (+ v_main_~P7~0_29_fresh_1 2147483648)) (<= v_main_~P5~0_29_fresh_1 2147483647) (<= main_~P6~0_26 2147483647) (<= v_main_~P2~0_29_fresh_1 2147483647) (<= 0 (+ v_main_~P5~0_29_fresh_1 2147483648))) :named ssa_26))
...
(assert (! (not (= |main_#t~nondet33_32| 0)) :named ssa_33))
(assert (! (and (= main_~P1~0_26 0) (= 3 v_main_~method_id~0_89_fresh_1)) :named ssa_34))
(assert (! (and (not (= (mod main_~this_buffer_empty~0_25 4294967296) 1)) (= main_~P3~0_26 0) (= (mod (+ 1 main_~this_expect~0_25) 2) (mod main_~P3~0_26 4294967296))) :named ssa_35))
