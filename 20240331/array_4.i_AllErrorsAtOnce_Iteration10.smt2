...
(set-info :ultimate-id array_4.i_AllErrorsAtOnce_Iteration10)
...
(assert (! (and (= 4096 v_ArrVal_76_fresh_1) (= |#valid_4| (store |#valid_3| |main_~#A~0.base_4| v_ArrVal_75_fresh_1)) (= v_ArrVal_75_fresh_1 1) (= (select |#valid_3| |main_~#A~0.base_4|) 0) (not (= |main_~#A~0.base_4| 0)) (= 0 |main_~#A~0.offset_4|) (< |#StackHeapBarrier_-1| |main_~#A~0.base_4|) (= (store |#length_3| |main_~#A~0.base_4| v_ArrVal_76_fresh_1) |#length_4|) (= main_~i~0_4 0)) :named ssa_4))
(assert (! (and (= (store (select |#memory_int#1_3| |main_~#A~0.base_4|) (+ (* main_~i~0_4 4) |main_~#A~0.offset_4|) v_ArrVal_77_fresh_1) v_ArrVal_78_fresh_1) (= |v_main_#t~nondet1_27_fresh_1| v_ArrVal_77_fresh_1) (= main_~i~0_5 (+ main_~i~0_4 1)) (<= |v_main_#t~nondet1_27_fresh_1| 2147483647) (< main_~i~0_4 1023) (= (store |#memory_int#1_3| |main_~#A~0.base_4| v_ArrVal_78_fresh_1) |#memory_int#1_5|) (<= 0 (+ |v_main_#t~nondet1_27_fresh_1| 2147483648))) :named ssa_5))
(assert (! (and (= (store (select |#memory_int#1_5| |main_~#A~0.base_4|) (+ (* main_~i~0_5 4) |main_~#A~0.offset_4|) v_ArrVal_79_fresh_1) v_ArrVal_80_fresh_1) (= |v_main_#t~nondet1_28_fresh_1| v_ArrVal_79_fresh_1) (= main_~i~0_6 (+ main_~i~0_5 1)) (< main_~i~0_5 1023) (<= 0 (+ |v_main_#t~nondet1_28_fresh_1| 2147483648)) (= |#memory_int#1_6| (store |#memory_int#1_5| |main_~#A~0.base_4| v_ArrVal_80_fresh_1)) (<= |v_main_#t~nondet1_28_fresh_1| 2147483647)) :named ssa_6))
(assert (! (and (= (store (select |#memory_int#1_6| |main_~#A~0.base_4|) (+ (* main_~i~0_6 4) |main_~#A~0.offset_4|) v_ArrVal_81_fresh_1) v_ArrVal_82_fresh_1) (= main_~i~0_7 (+ main_~i~0_6 1)) (<= 0 (+ |v_main_#t~nondet1_29_fresh_1| 2147483648)) (< main_~i~0_6 1023) (= |v_main_#t~nondet1_29_fresh_1| v_ArrVal_81_fresh_1) (<= |v_main_#t~nondet1_29_fresh_1| 2147483647) (= (store |#memory_int#1_6| |main_~#A~0.base_4| v_ArrVal_82_fresh_1) |#memory_int#1_7|)) :named ssa_7))
(assert (! (and (= main_~i~0_8 (+ main_~i~0_7 1)) (<= 0 (+ |v_main_#t~nondet1_30_fresh_1| 2147483648)) (< main_~i~0_7 1023) (= (store (select |#memory_int#1_7| |main_~#A~0.base_4|) (+ (* main_~i~0_7 4) |main_~#A~0.offset_4|) |v_main_#t~nondet1_30_fresh_1|) v_ArrVal_83_fresh_1) (= |#memory_int#1_8| (store |#memory_int#1_7| |main_~#A~0.base_4| v_ArrVal_83_fresh_1)) (<= |v_main_#t~nondet1_30_fresh_1| 2147483647) (= |v_main_#t~nondet1_30_fresh_1| v_ArrVal_84_fresh_1)) :named ssa_8))
(assert (! (and (= main_~i~0_9 (+ main_~i~0_8 1)) (<= 0 (+ |v_main_#t~nondet1_31_fresh_1| 2147483648)) (<= |v_main_#t~nondet1_31_fresh_1| 2147483647) (= (store |#memory_int#1_8| |main_~#A~0.base_4| v_ArrVal_85_fresh_1) |#memory_int#1_9|) (= |v_main_#t~nondet1_31_fresh_1| v_ArrVal_86_fresh_1) (< main_~i~0_8 1023) (= (store (select |#memory_int#1_8| |main_~#A~0.base_4|) (+ (* main_~i~0_8 4) |main_~#A~0.offset_4|) |v_main_#t~nondet1_31_fresh_1|) v_ArrVal_85_fresh_1)) :named ssa_9))
(assert (! (and (= main_~i~0_10 (+ main_~i~0_9 1)) (= |v_main_#t~nondet1_32_fresh_1| v_ArrVal_88_fresh_1) (= (store (select |#memory_int#1_9| |main_~#A~0.base_4|) (+ (* main_~i~0_9 4) |main_~#A~0.offset_4|) |v_main_#t~nondet1_32_fresh_1|) v_ArrVal_87_fresh_1) (<= 0 (+ |v_main_#t~nondet1_32_fresh_1| 2147483648)) (< main_~i~0_9 1023) (<= |v_main_#t~nondet1_32_fresh_1| 2147483647) (= (store |#memory_int#1_9| |main_~#A~0.base_4| v_ArrVal_87_fresh_1) |#memory_int#1_10|)) :named ssa_10))
(assert (! (<= 1023 main_~i~0_10) :named ssa_11))
(assert (! (and (= (store (select |#memory_int#1_10| |main_~#A~0.base_4|) (+ 4092 |main_~#A~0.offset_4|) 0) v_ArrVal_89_fresh_1) (= |#memory_int#1_12| (store |#memory_int#1_10| |main_~#A~0.base_4| v_ArrVal_89_fresh_1)) (= v_ArrVal_90_fresh_1 0) (= main_~i~0_12 0)) :named ssa_12))
(assert (! (= |main_#t~mem3_13| (select (select |#memory_int#1_12| |main_~#A~0.base_4|) (+ (* main_~i~0_12 4) |main_~#A~0.offset_4|))) :named ssa_13))
(assert (! (and (= main_~i~0_14 (+ main_~i~0_12 1)) (not (= |main_#t~mem3_13| 0))) :named ssa_14))
(assert (! (= |main_#t~mem3_15| (select (select |#memory_int#1_12| |main_~#A~0.base_4|) (+ (* main_~i~0_14 4) |main_~#A~0.offset_4|))) :named ssa_15))
(assert (! (and (= main_~i~0_16 (+ main_~i~0_14 1)) (not (= |main_#t~mem3_15| 0))) :named ssa_16))
(assert (! (= |main_#t~mem3_17| (select (select |#memory_int#1_12| |main_~#A~0.base_4|) (+ (* main_~i~0_16 4) |main_~#A~0.offset_4|))) :named ssa_17))
(assert (! (= |main_#t~mem3_17| 0) :named ssa_18))
(assert (! true :named ssa_19_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_19| (ite (<= main_~i~0_16 1024) 1 0)) :named ssa_19_LocVarAssigCall))
