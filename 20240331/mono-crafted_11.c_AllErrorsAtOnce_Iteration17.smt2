...
(set-info :ultimate-id mono-crafted_11.c_AllErrorsAtOnce_Iteration17)
...
(assert (! (<= 100000000 (mod main_~x~0_34 4294967296)) :named ssa_35))
(assert (! true :named ssa_36_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_36| (ite (= (mod main_~x~0_34 2) 0) 1 0)) :named ssa_36_LocVarAssigCall))
