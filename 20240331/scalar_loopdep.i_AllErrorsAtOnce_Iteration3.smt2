...
(set-info :ultimate-id scalar_loopdep.i_AllErrorsAtOnce_Iteration3)
...
(assert (! (and (= main_~i~0_5 (+ main_~i~0_4 1)) (= (store |#memory_int#1_3| |~#a~0.base_1| v_ArrVal_6_fresh_1) |#memory_int#1_5|) (< main_~i~0_4 100000) (= (store (select |#memory_int#1_3| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_4 4)) main_~y~0_4) v_ArrVal_6_fresh_1) (= main_~y~0_5 (+ main_~y~0_4 1)) (= main_~y~0_4 v_ArrVal_7_fresh_1)) :named ssa_5))
(assert (! (<= 100000 main_~i~0_5) :named ssa_6))
(assert (! (= main_~i~0_7 0) :named ssa_7))
(assert (! (and (= |main_#t~mem3_8| (select (select |#memory_int#1_5| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* main_~i~0_7 4)))) (< main_~i~0_7 100000)) :named ssa_8))
(assert (! true :named ssa_9_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_9| (ite (<= 100 |main_#t~mem3_8|) 1 0)) :named ssa_9_LocVarAssigCall))
...
(assert (! (and (= |#memory_int#1_0| (store |#memory_int#1_-1| |~#a~0.base_0| v_ArrVal_8_fresh_1)) (< 0 |#StackHeapBarrier_-1|) (= |~#a~0.base_0| 3) (= (select (select |#memory_int#0_-1| 1) 1) 0) (= ((as const (Array Int Int)) 0) v_ArrVal_8_fresh_1) (= 400000 (select |#length_-1| 3)) (= (select |#valid_-1| 3) 1) (= (select |#valid_-1| 2) 1) (= (select (select |#memory_int#0_-1| 1) 0) 48) (= |~#a~0.offset_0| 0) (= (select |#valid_-1| 1) 1) (= (select |#length_-1| 1) 2) (= (select |#valid_-1| 0) 0) (= (select |#length_-1| 2) 17)) :named ssa_0))
