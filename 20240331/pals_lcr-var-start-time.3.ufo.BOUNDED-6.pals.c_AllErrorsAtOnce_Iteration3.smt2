...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:16:35+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id pals_lcr-var-start-time.3.ufo.BOUNDED-6.pals.c_AllErrorsAtOnce_Iteration3)
...
(declare-fun check_~tmp~1_54 () Int)
(declare-fun |check_#res_55| () Int)
(declare-fun check_~tmp~1_55 () Int)
(declare-fun |main_#t~ret21_56| () Int)
(declare-fun |check_#res_56| () Int)
(declare-fun main_~c1~0_57 () Int)
...
(assert (! (and (<= ~id2~0_4 127) (= 0 v_main_~c1~0_9_fresh_1) (<= 0 (+ ~send2~0_4 128)) (<= ~id1~0_4 127) (<= 0 (+ ~send3~0_4 128)) (<= ~send3~0_4 127) (<= ~st2~0_4 127) (<= 0 (+ ~id3~0_4 128)) (<= ~r1~0_4 127) (<= ~st1~0_4 127) (<= 0 (+ 128 ~st3~0_4)) (<= 0 (+ 128 ~st2~0_4)) (<= 0 (+ ~r1~0_4 128)) (<= 0 (+ 128 ~st1~0_4)) (<= 0 (+ ~id2~0_4 128)) (<= ~id3~0_4 127) (<= ~st3~0_4 127) (<= 0 (+ ~send1~0_4 128)) (<= 0 (+ ~id1~0_4 128)) (<= ~send1~0_4 127) (<= ~send2~0_4 127)) :named ssa_4))
...
(assert (! (= ~nomsg~0_1 v_node1_~m1~0_16_fresh_1) :named ssa_31))
...
(assert (! (= ~nomsg~0_1 v_node2_~m2~0_16_fresh_1) :named ssa_38))
...
(assert (! (= ~nomsg~0_1 v_node3_~m3~0_16_fresh_1) :named ssa_45))
...
(assert (! (and (< 1 (+ ~st1~0_30 ~st2~0_37 ~st3~0_44)) (= check_~tmp~1_54 0)) :named ssa_54))
(assert (! (= |check_#res_55| check_~tmp~1_54) :named ssa_55))
(assert (! (= |check_#res_55| |main_#t~ret21_56|) :named ssa_56_return))
(assert (! (and (<= 0 (+ |main_#t~ret21_56| 2147483648)) (= |main_#t~ret21_56| main_~c1~0_57) (<= |main_#t~ret21_56| 2147483647)) :named ssa_57))
(assert (! true :named ssa_58_GlobVarAssigCall))
(assert (! (= (ite (= 0 main_~c1~0_57) 0 1) |assert_#in~arg_58|) :named ssa_58_LocVarAssigCall))
...
(assert (! true :named ssa_precond))
(assert (! (not (<= (+ ~st3~0_-2 ~st2~0_-2 ~st1~0_-2) 0)) :named ssa_postcond))
...
(assert (! (not (<= (+ ~st3~0_-2 ~st2~0_-2 ~st1~0_-1) 0)) :named ssa_postcond))
...
(assert (! (<= (+ ~st3~0_-2 ~st2~0_-2 ~st1~0_-2) 0) :named ssa_-2_PendingContext))
(assert (! true :named ssa_-2_LocVarAssignPendingContext))
...
(assert (! (not (<= (+ ~st3~0_-2 ~st2~0_-1 ~st1~0_-2) 0)) :named ssa_postcond))
...
(assert (! (not (<= (+ ~st3~0_-1 ~st2~0_-2 ~st1~0_-2) 0)) :named ssa_postcond))
