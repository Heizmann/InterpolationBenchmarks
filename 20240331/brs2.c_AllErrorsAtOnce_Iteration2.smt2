...
(set-info :ultimate-id brs2.c_AllErrorsAtOnce_Iteration2)
...
(assert (! (and (= (select |#valid_3| |main_~#sum~0.base_11|) 0) (= 8 v_ArrVal_8_fresh_1) (< |#StackHeapBarrier_-1| |main_~#sum~0.base_11|) (= v_ArrVal_7_fresh_1 1) (< main_~a~0.base_11 |#StackHeapBarrier_-1|) (= |main_~#sum~0.offset_11| 0) (= (select (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_6_fresh_1) main_~a~0.base_11) 0) (= (* (mod ~N~0_4 1073741824) 4) v_ArrVal_5_fresh_1) (= |#length_11| (store (store |#length_3| |main_~#sum~0.base_11| v_ArrVal_8_fresh_1) main_~a~0.base_11 v_ArrVal_5_fresh_1)) (= |#valid_11| (store (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_6_fresh_1) main_~a~0.base_11 v_ArrVal_7_fresh_1)) (not (= |main_~#sum~0.base_11| 0)) (= v_ArrVal_6_fresh_1 1) (= main_~a~0.offset_11 0) (not (= main_~a~0.base_11 0)) (= main_~i~0_11 0)) :named ssa_11))
