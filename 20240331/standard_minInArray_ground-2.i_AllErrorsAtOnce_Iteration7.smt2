...
(set-info :ultimate-id standard_minInArray_ground-2.i_AllErrorsAtOnce_Iteration7)
...
(assert (! (and (not (= |main_~#a~0.base_4| 0)) (= main_~min~0_4 0) (< |#StackHeapBarrier_-1| |main_~#a~0.base_4|) (= (store |#length_3| |main_~#a~0.base_4| v_ArrVal_34_fresh_1) |#length_4|) (= (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_33_fresh_1) |#valid_4|) (= |main_~#a~0.offset_4| 0) (= 400000 v_ArrVal_34_fresh_1) (= v_ArrVal_33_fresh_1 1) (= (select |#valid_3| |main_~#a~0.base_4|) 0) (= main_~i~0_4 0)) :named ssa_4))
(assert (! (and (= |v_main_#t~nondet1_18_fresh_1| v_ArrVal_35_fresh_1) (= (store (select |#memory_int#1_3| |main_~#a~0.base_4|) (+ (* main_~i~0_4 4) |main_~#a~0.offset_4|) v_ArrVal_35_fresh_1) v_ArrVal_36_fresh_1) (= main_~i~0_5 (+ main_~i~0_4 1)) (< main_~i~0_4 100000) (= |#memory_int#1_5| (store |#memory_int#1_3| |main_~#a~0.base_4| v_ArrVal_36_fresh_1)) (<= 0 (+ |v_main_#t~nondet1_18_fresh_1| 2147483648)) (<= |v_main_#t~nondet1_18_fresh_1| 2147483647)) :named ssa_5))
(assert (! (and (<= |v_main_#t~nondet1_19_fresh_1| 2147483647) (= main_~i~0_6 (+ main_~i~0_5 1)) (< main_~i~0_5 100000) (= |v_main_#t~nondet1_19_fresh_1| v_ArrVal_38_fresh_1) (<= 0 (+ |v_main_#t~nondet1_19_fresh_1| 2147483648)) (= (store |#memory_int#1_5| |main_~#a~0.base_4| v_ArrVal_37_fresh_1) |#memory_int#1_6|) (= (store (select |#memory_int#1_5| |main_~#a~0.base_4|) (+ (* main_~i~0_5 4) |main_~#a~0.offset_4|) |v_main_#t~nondet1_19_fresh_1|) v_ArrVal_37_fresh_1)) :named ssa_6))
(assert (! (and (= |v_main_#t~nondet1_20_fresh_1| v_ArrVal_40_fresh_1) (<= 0 (+ |v_main_#t~nondet1_20_fresh_1| 2147483648)) (= main_~i~0_7 (+ main_~i~0_6 1)) (<= |v_main_#t~nondet1_20_fresh_1| 2147483647) (= (store (select |#memory_int#1_6| |main_~#a~0.base_4|) (+ (* main_~i~0_6 4) |main_~#a~0.offset_4|) |v_main_#t~nondet1_20_fresh_1|) v_ArrVal_39_fresh_1) (< main_~i~0_6 100000) (= (store |#memory_int#1_6| |main_~#a~0.base_4| v_ArrVal_39_fresh_1) |#memory_int#1_7|)) :named ssa_7))
(assert (! (and (<= 0 (+ |v_main_#t~nondet1_21_fresh_1| 2147483648)) (= v_ArrVal_42_fresh_1 (store (select |#memory_int#1_7| |main_~#a~0.base_4|) (+ (* main_~i~0_7 4) |main_~#a~0.offset_4|) v_ArrVal_41_fresh_1)) (= (store |#memory_int#1_7| |main_~#a~0.base_4| v_ArrVal_42_fresh_1) |#memory_int#1_8|) (= main_~i~0_8 (+ main_~i~0_7 1)) (< main_~i~0_7 100000) (<= |v_main_#t~nondet1_21_fresh_1| 2147483647) (= |v_main_#t~nondet1_21_fresh_1| v_ArrVal_41_fresh_1)) :named ssa_8))
(assert (! (and (= main_~i~0_9 (+ main_~i~0_8 1)) (<= 0 (+ |v_main_#t~nondet1_22_fresh_1| 2147483648)) (= |v_main_#t~nondet1_22_fresh_1| v_ArrVal_43_fresh_1) (< main_~i~0_8 100000) (= (store |#memory_int#1_8| |main_~#a~0.base_4| v_ArrVal_44_fresh_1) |#memory_int#1_9|) (= (store (select |#memory_int#1_8| |main_~#a~0.base_4|) (+ (* main_~i~0_8 4) |main_~#a~0.offset_4|) v_ArrVal_43_fresh_1) v_ArrVal_44_fresh_1) (<= |v_main_#t~nondet1_22_fresh_1| 2147483647)) :named ssa_9))
(assert (! (<= 100000 main_~i~0_9) :named ssa_10))
(assert (! (= main_~i~0_11 0) :named ssa_11))
(assert (! (and (= |main_#t~mem3_12| (select (select |#memory_int#1_9| |main_~#a~0.base_4|) (+ (* main_~i~0_11 4) |main_~#a~0.offset_4|))) (< main_~i~0_11 100000)) :named ssa_12))
(assert (! (and (< |main_#t~mem3_12| main_~min~0_4) (= (select (select |#memory_int#1_9| |main_~#a~0.base_4|) (+ (* main_~i~0_11 4) |main_~#a~0.offset_4|)) main_~min~0_13)) :named ssa_13))
(assert (! (= main_~i~0_14 (+ main_~i~0_11 1)) :named ssa_14))
(assert (! (and (= |main_#t~mem3_15| (select (select |#memory_int#1_9| |main_~#a~0.base_4|) (+ (* main_~i~0_14 4) |main_~#a~0.offset_4|))) (< main_~i~0_14 100000)) :named ssa_15))
(assert (! (and (< |main_#t~mem3_15| main_~min~0_13) (= (select (select |#memory_int#1_9| |main_~#a~0.base_4|) (+ (* main_~i~0_14 4) |main_~#a~0.offset_4|)) main_~min~0_16)) :named ssa_16))
(assert (! (= main_~i~0_17 (+ main_~i~0_14 1)) :named ssa_17))
(assert (! (and (= |main_#t~mem3_18| (select (select |#memory_int#1_9| |main_~#a~0.base_4|) (+ (* main_~i~0_17 4) |main_~#a~0.offset_4|))) (< main_~i~0_17 100000)) :named ssa_18))
(assert (! (and (< |main_#t~mem3_18| main_~min~0_16) (= (select (select |#memory_int#1_9| |main_~#a~0.base_4|) (+ (* main_~i~0_17 4) |main_~#a~0.offset_4|)) main_~min~0_19)) :named ssa_19))
(assert (! (= main_~i~0_20 (+ main_~i~0_17 1)) :named ssa_20))
(assert (! (and (= |main_#t~mem3_21| (select (select |#memory_int#1_9| |main_~#a~0.base_4|) (+ (* main_~i~0_20 4) |main_~#a~0.offset_4|))) (< main_~i~0_20 100000)) :named ssa_21))
(assert (! (and (< |main_#t~mem3_21| main_~min~0_19) (= (select (select |#memory_int#1_9| |main_~#a~0.base_4|) (+ (* main_~i~0_20 4) |main_~#a~0.offset_4|)) main_~min~0_22)) :named ssa_22))
(assert (! (= main_~i~0_23 (+ main_~i~0_20 1)) :named ssa_23))
(assert (! (and (= |main_#t~mem3_24| (select (select |#memory_int#1_9| |main_~#a~0.base_4|) (+ (* main_~i~0_23 4) |main_~#a~0.offset_4|))) (< main_~i~0_23 100000)) :named ssa_24))
(assert (! (and (< |main_#t~mem3_24| main_~min~0_22) (= (select (select |#memory_int#1_9| |main_~#a~0.base_4|) (+ (* main_~i~0_23 4) |main_~#a~0.offset_4|)) main_~min~0_25)) :named ssa_25))
(assert (! (= main_~i~0_26 (+ main_~i~0_23 1)) :named ssa_26))
(assert (! (<= 100000 main_~i~0_26) :named ssa_27))
(assert (! (= main_~x~0_28 0) :named ssa_28))
(assert (! (and (< main_~x~0_28 100000) (= |main_#t~mem5_29| (select (select |#memory_int#1_9| |main_~#a~0.base_4|) (+ (* main_~x~0_28 4) |main_~#a~0.offset_4|)))) :named ssa_29))
(assert (! true :named ssa_30_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_30| (ite (<= main_~min~0_25 |main_#t~mem5_29|) 1 0)) :named ssa_30_LocVarAssigCall))
