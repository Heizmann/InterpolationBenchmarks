...
(set-info :ultimate-id bin-suffix-5.c_AllErrorsAtOnce_Iteration2)
...
(assert (! (and (= (mod main_~x~0_4 4294967296) 0) (= |main_#t~bitwise5_7| 0)) :named ssa_7))
(assert (! true :named ssa_8_GlobVarAssigCall))
(assert (! (= (ite (= 5 (mod |main_#t~bitwise5_7| 4294967296)) 1 0) |__VERIFIER_assert_#in~cond_8|) :named ssa_8_LocVarAssigCall))
