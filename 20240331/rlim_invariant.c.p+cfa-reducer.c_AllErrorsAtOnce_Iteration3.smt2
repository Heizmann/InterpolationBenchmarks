...
(set-info :ultimate-id rlim_invariant.c.p+cfa-reducer.c_AllErrorsAtOnce_Iteration3)
...
(declare-fun v_~someBinaryDOUBLEComparisonOperation_34_fresh_1 () Bool)
(declare-fun main_~main____CPAchecker_TMP_0~0_7 () Int)
(declare-fun v_~someBinaryDOUBLEComparisonOperation_35_fresh_1 () Bool)
(declare-fun main_~main____CPAchecker_TMP_0~0_8 () Int)
(declare-fun main_~main____CPAchecker_TMP_1~0_8 () Int)
(declare-fun v_~someBinaryDOUBLEComparisonOperation_36_fresh_1 () Bool)
(declare-fun main_~main____CPAchecker_TMP_1~0_10 () Int)
(declare-fun v_~someBinaryDOUBLEComparisonOperation_37_fresh_1 () Bool)
...
(declare-fun v_main_~main__S~0_6_fresh_1 () Real)
...
(declare-fun v_~someBinaryDOUBLEComparisonOperation_38_fresh_1 () Bool)
(declare-fun main_~main____CPAchecker_TMP_2~0_15 () Int)
(declare-fun v_~someBinaryDOUBLEComparisonOperation_39_fresh_1 () Bool)
...
(assert (! v_~someBinaryDOUBLEComparisonOperation_34_fresh_1 :named ssa_6))
(assert (! (and (= main_~main____CPAchecker_TMP_0~0_7 1) v_~someBinaryDOUBLEComparisonOperation_35_fresh_1) :named ssa_7))
(assert (! (not (= main_~main____CPAchecker_TMP_0~0_7 0)) :named ssa_8))
(assert (! v_~someBinaryDOUBLEComparisonOperation_36_fresh_1 :named ssa_9))
(assert (! (and v_~someBinaryDOUBLEComparisonOperation_37_fresh_1 (= main_~main____CPAchecker_TMP_1~0_10 1)) :named ssa_10))
(assert (! (and (not (= main_~main____CPAchecker_TMP_1~0_10 0)) (= main_~main__X~0_5 main_~main__Y~0_11) (= v_main_~main__S~0_6_fresh_1 main_~main__Y~0_4)) :named ssa_11))
(assert (! v_~someBinaryFLOATComparisonOperation_11_fresh_1 :named ssa_12))
(assert (! true :named ssa_13))
(assert (! v_~someBinaryDOUBLEComparisonOperation_38_fresh_1 :named ssa_14))
(assert (! (and (= main_~main____CPAchecker_TMP_2~0_15 1) v_~someBinaryDOUBLEComparisonOperation_39_fresh_1) :named ssa_15))
(assert (! (and (= v_main_~__tmp_1~0_6_fresh_1 main_~__VERIFIER_assert__cond~0_16) (= main_~main____CPAchecker_TMP_2~0_15 v_main_~__tmp_1~0_6_fresh_1)) :named ssa_16))
