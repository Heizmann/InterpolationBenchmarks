...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:18:20+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id duplets.c_AllErrorsAtOnce_Iteration4)
...
(declare-fun v_mkdup_~x~0_11_fresh_1 () Int)
...
(declare-fun finddup_~j~1_38 () Int)
(declare-fun |finddup_#t~post11_39| () Int)
(declare-fun finddup_~i~1_39 () Int)
(declare-fun finddup_~n_40 () Int)
(declare-fun finddup_~i~1_40 () Int)
(declare-fun |finddup_#res_41| () Int)
(declare-fun |main_#t~ret14_43| () Int)
(declare-fun |finddup_#res_43| () Int)
(declare-fun |main_#t~ret14_44| () Int)
(declare-fun main_~r~0_44 () Int)
(declare-fun |__VERIFIER_assert_#in~cond_45| () Int)
(declare-fun main_~r~0_45 () Int)
...
(assert (! (and (= (* 4 (mod main_~n~0_4 1073741824)) v_ArrVal_51_fresh_1) (not (= 0 |main_#t~malloc13.base_10|)) (= (store |#length_3| |main_#t~malloc13.base_10| v_ArrVal_51_fresh_1) |#length_10|) (= |#valid_10| (store |#valid_3| |main_#t~malloc13.base_10| v_ArrVal_52_fresh_1)) (< |main_#t~malloc13.base_10| |#StackHeapBarrier_-1|) (= |main_#t~malloc13.offset_10| 0) (= v_ArrVal_52_fresh_1 1) (= (select |#valid_3| |main_#t~malloc13.base_10|) 0)) :named ssa_10))
(assert (! (= |old(#memory_int#2)_11| |#memory_int#2_11|) :named ssa_11_GlobVarAssigCall))
(assert (! (and (= |v_#Ultimate.meminit_#ptr.offsetInParam_6_fresh_1| |main_#t~malloc13.offset_10|) (= |v_#Ultimate.meminit_#productInParam_6_fresh_1| (* main_~n~0_4 4)) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_6_fresh_1|) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_6_fresh_1| 4) (= |#Ultimate.meminit_#ptr.base_11| |main_#t~malloc13.base_10|)) :named ssa_11_LocVarAssigCall))
(assert (! (= |old(#memory_int#2)_11| |#memory_int#2_3|) :named ssa_11_OldVarAssigCall))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_53_fresh_1) (= (store |#memory_int#2_11| |#Ultimate.meminit_#ptr.base_11| v_ArrVal_53_fresh_1) |#memory_int#2_12|)) :named ssa_12))
...
(assert (! (and (<= v_mkdup_~x~0_11_fresh_1 2147483647) (<= 0 (+ v_mkdup_~x~0_11_fresh_1 2147483648)) (= (store (store (select |#memory_int#2_15| mkdup_~a.base_16) (+ (* mkdup_~i~0_16 4) mkdup_~a.offset_16) v_ArrVal_55_fresh_1) (+ mkdup_~a.offset_16 (* mkdup_~j~0_16 4)) v_ArrVal_54_fresh_1) v_ArrVal_56_fresh_1) (= v_mkdup_~x~0_11_fresh_1 v_ArrVal_54_fresh_1) (= |#memory_int#2_32| (store |#memory_int#2_15| mkdup_~a.base_16 v_ArrVal_56_fresh_1)) (= v_mkdup_~x~0_11_fresh_1 v_ArrVal_55_fresh_1)) :named ssa_32))
(assert (! true :named ssa_33_return))
(assert (! (and (= |main_~#i~2.offset_34| 0) (= |#length_34| (store (store |#length_10| |main_~#i~2.base_34| v_ArrVal_57_fresh_1) |main_~#j~2.base_34| v_ArrVal_59_fresh_1)) (= (select |#valid_10| |main_~#i~2.base_34|) 0) (= |main_~#j~2.offset_34| 0) (not (= |main_~#j~2.base_34| 0)) (= (store (store |#valid_10| |main_~#i~2.base_34| v_ArrVal_58_fresh_1) |main_~#j~2.base_34| v_ArrVal_60_fresh_1) |#valid_34|) (= (select (store |#valid_10| |main_~#i~2.base_34| v_ArrVal_58_fresh_1) |main_~#j~2.base_34|) 0) (< |#StackHeapBarrier_-1| |main_~#j~2.base_34|) (= v_ArrVal_60_fresh_1 1) (not (= |main_~#i~2.base_34| 0)) (= v_ArrVal_58_fresh_1 1) (< |#StackHeapBarrier_-1| |main_~#i~2.base_34|) (= 4 v_ArrVal_59_fresh_1) (= 4 v_ArrVal_57_fresh_1)) :named ssa_34))
...
(assert (! (<= finddup_~n_36 finddup_~j~1_37) :named ssa_38))
(assert (! (= finddup_~i~1_39 (+ finddup_~i~1_36 1)) :named ssa_39))
(assert (! (<= finddup_~n_36 finddup_~i~1_39) :named ssa_40))
(assert (! (= |finddup_#res_41| 0) :named ssa_41))
(assert (! true :named ssa_42))
(assert (! (= |main_#t~ret14_43| |finddup_#res_41|) :named ssa_43_return))
(assert (! (and (= main_~r~0_44 |main_#t~ret14_43|) (<= |main_#t~ret14_43| 2147483647) (<= 0 (+ |main_#t~ret14_43| 2147483648))) :named ssa_44))
(assert (! true :named ssa_45_GlobVarAssigCall))
(assert (! (= main_~r~0_44 |__VERIFIER_assert_#in~cond_45|) :named ssa_45_LocVarAssigCall))
...
(assert (! (not true) :named ssa_postcond))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_61_fresh_1) (= |#memory_int#2_0| (store |#memory_int#2_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_61_fresh_1))) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! true :named ssa_-2_PendingContext))
...
(declare-fun v_mkdup_~x~0_12_fresh_1 () Int)
...
(assert (! (and (= v_mkdup_~x~0_12_fresh_1 v_ArrVal_63_fresh_1) (= (store (store (select |#memory_int#2_-1| mkdup_~a.base_0) (+ (* mkdup_~i~0_0 4) mkdup_~a.offset_0) v_mkdup_~x~0_12_fresh_1) (+ mkdup_~a.offset_0 (* mkdup_~j~0_0 4)) v_mkdup_~x~0_12_fresh_1) v_ArrVal_62_fresh_1) (= (store |#memory_int#2_-1| mkdup_~a.base_0 v_ArrVal_62_fresh_1) |#memory_int#2_16|) (<= v_mkdup_~x~0_12_fresh_1 2147483647) (<= 0 (+ v_mkdup_~x~0_12_fresh_1 2147483648)) (= v_mkdup_~x~0_12_fresh_1 v_ArrVal_64_fresh_1)) :named ssa_16))
...
(assert (! true :named ssa_precond))
(assert (! (not (and (or (< mkdup_~i~0_-2 (+ mkdup_~j~0_-2 1)) (< mkdup_~i~0_-2 mkdup_~n_-2)) (= |mkdup_#in~n_-2| mkdup_~n_-2) (or (< mkdup_~j~0_-2 (+ mkdup_~i~0_-2 1)) (< 0 (+ mkdup_~i~0_-2 1))))) :named ssa_postcond))
(assert (! (= |assume_abort_if_not_#in~cond_-1| assume_abort_if_not_~cond_0) :named ssa_0))
(assert (! (not (= assume_abort_if_not_~cond_0 0)) :named ssa_1))
(assert (! true :named ssa_2))
(assert (! true :named ssa_3_return))
(assert (! (= |mkdup_#in~n_-2| mkdup_~n_-2) :named ssa_-2_PendingContext))
...
(declare-fun assume_abort_if_not_~cond_1 () Int)
(assert (! true :named ssa_precond))
(assert (! (not (or (and (<= (+ mkdup_~j~0_-2 1) (+ mkdup_~i~0_-2 |mkdup_#in~n_-2|)) (<= (+ mkdup_~i~0_-2 1) (+ mkdup_~j~0_-2 |mkdup_#in~n_-2|))) (= mkdup_~j~0_-2 mkdup_~i~0_-2))) :named ssa_postcond))
(assert (! (= |assume_abort_if_not_#in~cond_-1| assume_abort_if_not_~cond_0) :named ssa_0))
(assert (! (not (= assume_abort_if_not_~cond_0 0)) :named ssa_1))
(assert (! true :named ssa_2))
(assert (! true :named ssa_3_return))
(assert (! (and (or (< mkdup_~i~0_-2 (+ mkdup_~j~0_-2 1)) (< mkdup_~i~0_-2 mkdup_~n_-2)) (= |mkdup_#in~n_-2| mkdup_~n_-2) (or (< mkdup_~j~0_-2 (+ mkdup_~i~0_-2 1)) (< 0 (+ mkdup_~i~0_-2 1)))) :named ssa_-2_PendingContext))
...
(declare-fun assume_abort_if_not_~cond_1 () Int)
(assert (! true :named ssa_precond))
(assert (! (not (and (<= (+ mkdup_~j~0_-2 1) (+ mkdup_~i~0_-2 |mkdup_#in~n_-2|)) (not (= mkdup_~j~0_-2 mkdup_~i~0_-2)) (<= (+ mkdup_~i~0_-2 1) (+ mkdup_~j~0_-2 |mkdup_#in~n_-2|)))) :named ssa_postcond))
(assert (! (= |assume_abort_if_not_#in~cond_-1| assume_abort_if_not_~cond_0) :named ssa_0))
(assert (! (not (= assume_abort_if_not_~cond_0 0)) :named ssa_1))
(assert (! true :named ssa_2))
(assert (! true :named ssa_3_return))
(assert (! (or (and (<= (+ mkdup_~j~0_-2 1) (+ mkdup_~i~0_-2 |mkdup_#in~n_-2|)) (<= (+ mkdup_~i~0_-2 1) (+ mkdup_~j~0_-2 |mkdup_#in~n_-2|))) (= mkdup_~j~0_-2 mkdup_~i~0_-2)) :named ssa_-2_PendingContext))
...
(declare-fun finddup_~j~1_2 () Int)
(declare-fun |finddup_#t~post11_3| () Int)
(declare-fun finddup_~i~1_3 () Int)
(declare-fun finddup_~n_4 () Int)
(declare-fun finddup_~i~1_4 () Int)
(declare-fun |finddup_#res_5| () Int)
(declare-fun |main_#t~ret14_7| () Int)
(declare-fun |finddup_#res_7| () Int)
...
(assert (! (<= finddup_~n_0 finddup_~j~1_1) :named ssa_2))
(assert (! (= finddup_~i~1_3 (+ finddup_~i~1_0 1)) :named ssa_3))
(assert (! (<= finddup_~n_0 finddup_~i~1_3) :named ssa_4))
(assert (! (= |finddup_#res_5| 0) :named ssa_5))
(assert (! true :named ssa_6))
(assert (! (= |main_#t~ret14_7| |finddup_#res_5|) :named ssa_7_return))
