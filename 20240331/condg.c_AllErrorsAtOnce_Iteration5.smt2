...
(set-info :ultimate-id condg.c_AllErrorsAtOnce_Iteration5)
...
(declare-fun |main_#t~post13_21| () Int)
...
(assert (! (and (= (select (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_42_fresh_1) main_~a~0.base_11) 0) (= v_ArrVal_42_fresh_1 1) (= v_ArrVal_40_fresh_1 0) (< |#StackHeapBarrier_-1| |main_~#sum~0.base_11|) (= (select |#valid_3| |main_~#sum~0.base_11|) 0) (not (= |main_~#sum~0.base_11| 0)) (= |#length_11| (store (store |#length_3| |main_~#sum~0.base_11| v_ArrVal_39_fresh_1) main_~a~0.base_11 v_ArrVal_41_fresh_1)) (< main_~a~0.base_11 |#StackHeapBarrier_-1|) (= main_~i~0_11 0) (= 4 v_ArrVal_39_fresh_1) (= v_ArrVal_37_fresh_1 (store (select |#memory_int#1_3| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| 0)) (= |main_~#sum~0.offset_11| 0) (= main_~a~0.offset_11 0) (not (= main_~a~0.base_11 0)) (= v_ArrVal_38_fresh_1 1) (= (* (mod ~N~0_4 1073741824) 4) v_ArrVal_41_fresh_1) (= (store |#memory_int#1_3| |main_~#sum~0.base_11| v_ArrVal_37_fresh_1) |#memory_int#1_11|) (= |#valid_11| (store (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_42_fresh_1) main_~a~0.base_11 v_ArrVal_38_fresh_1))) :named ssa_11))
(assert (! (and (= (store (select |#memory_int#3_3| main_~a~0.base_11) (+ (* main_~i~0_11 4) main_~a~0.offset_11) 1) v_ArrVal_43_fresh_1) (= main_~i~0_12 (+ main_~i~0_11 1)) (= |#memory_int#3_12| (store |#memory_int#3_3| main_~a~0.base_11 v_ArrVal_43_fresh_1)) (= v_ArrVal_44_fresh_1 1) (< main_~i~0_11 ~N~0_4)) :named ssa_12))
(assert (! (and (= main_~i~0_13 (+ main_~i~0_12 1)) (= (store (select |#memory_int#3_12| main_~a~0.base_11) (+ (* main_~i~0_12 4) main_~a~0.offset_11) 1) v_ArrVal_45_fresh_1) (= (store |#memory_int#3_12| main_~a~0.base_11 v_ArrVal_45_fresh_1) |#memory_int#3_13|) (= v_ArrVal_46_fresh_1 1) (< main_~i~0_12 ~N~0_4)) :named ssa_13))
(assert (! (<= ~N~0_4 main_~i~0_13) :named ssa_14))
(assert (! (= main_~i~0_15 0) :named ssa_15))
(assert (! (and (= (+ (select (select |#memory_int#3_13| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_15 4))) (select (select |#memory_int#1_11| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|)) v_ArrVal_48_fresh_1) (< main_~i~0_15 ~N~0_4) (= (store |#memory_int#1_11| |main_~#sum~0.base_11| v_ArrVal_47_fresh_1) |#memory_int#1_16|) (= main_~i~0_16 (+ main_~i~0_15 1)) (= (store (select |#memory_int#1_11| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| (+ (select (select |#memory_int#3_13| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_15 4))) (select (select |#memory_int#1_11| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|))) v_ArrVal_47_fresh_1)) :named ssa_16))
(assert (! (<= ~N~0_4 main_~i~0_16) :named ssa_17))
(assert (! (= main_~i~0_18 0) :named ssa_18))
(assert (! (and (< main_~i~0_18 ~N~0_4) (= |main_#t~mem10_19| (select (select |#memory_int#1_16| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|))) :named ssa_19))
(assert (! (and (= (+ (select (select |#memory_int#3_13| main_~a~0.base_11) (+ (* main_~i~0_18 4) main_~a~0.offset_11)) 1) v_ArrVal_49_fresh_1) (= (store (select |#memory_int#3_13| main_~a~0.base_11) (+ (* main_~i~0_18 4) main_~a~0.offset_11) v_ArrVal_49_fresh_1) v_ArrVal_50_fresh_1) (= (store |#memory_int#3_13| main_~a~0.base_11 v_ArrVal_50_fresh_1) |#memory_int#3_20|) (not (= |main_#t~mem10_19| ~N~0_4))) :named ssa_20))
(assert (! (= main_~i~0_21 (+ main_~i~0_18 1)) :named ssa_21))
(assert (! (<= ~N~0_4 main_~i~0_21) :named ssa_22))
(assert (! (= main_~i~0_23 0) :named ssa_23))
(assert (! (and (< main_~i~0_23 ~N~0_4) (= |main_#t~mem14_24| (select (select |#memory_int#3_20| main_~a~0.base_11) (+ (* main_~i~0_23 4) main_~a~0.offset_11)))) :named ssa_24))
(assert (! true :named ssa_25_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_25| (ite (= |main_#t~mem14_24| 0) 1 0)) :named ssa_25_LocVarAssigCall))
