...
(set-info :ultimate-id id2_b3_o5.c_AllErrorsAtOnce_Iteration2)
...
(assert (! (and (= |id_#res_14| 3) (< 3 (mod id_~ret~0_13 4294967296))) :named ssa_14))
...
(assert (! (and (= |id_#res_8| 3) (< 3 (mod id_~ret~0_7 4294967296))) :named ssa_8))
