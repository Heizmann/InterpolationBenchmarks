...
(set-info :ultimate-id apache-get-tag.i.v+lhb-reducer.c_AllErrorsAtOnce_Iteration1)
...
(assert (! (and (= (ite (<= 0 main_~main__t~0_5) 1 0) v_main_~__tmp_1~0_4_fresh_1) (not (= main_~main____CPAchecker_TMP_0~0_6 0)) (= v_main_~__tmp_1~0_4_fresh_1 main_~__VERIFIER_assert__cond~0_7)) :named ssa_7))
(assert (! (and (not (= main_~__VERIFIER_assert__cond~0_7 0)) (= v_main_~__tmp_2~0_4_fresh_1 main_~__VERIFIER_assert__cond~1_8) (= v_main_~__tmp_2~0_4_fresh_1 (ite (<= main_~main__t~0_5 main_~main__tagbuf_len~0_5) 1 0))) :named ssa_8))
(assert (! (= main_~__VERIFIER_assert__cond~1_8 0) :named ssa_9))
