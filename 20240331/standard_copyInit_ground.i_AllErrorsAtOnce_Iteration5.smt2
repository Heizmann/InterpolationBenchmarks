...
(set-info :ultimate-id standard_copyInit_ground.i_AllErrorsAtOnce_Iteration5)
...
(assert (! (and (= main_~i~0_4 0) (< |#StackHeapBarrier_-1| |main_~#a~0.base_4|) (= |main_~#b~0.offset_4| 0) (= (store (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_30_fresh_1) |main_~#b~0.base_4| v_ArrVal_32_fresh_1) |#valid_4|) (= 400000 v_ArrVal_29_fresh_1) (not (= |main_~#a~0.base_4| 0)) (not (= |main_~#b~0.base_4| 0)) (= v_ArrVal_32_fresh_1 1) (= |main_~#a~0.offset_4| 0) (= (store (store |#length_3| |main_~#a~0.base_4| v_ArrVal_31_fresh_1) |main_~#b~0.base_4| v_ArrVal_29_fresh_1) |#length_4|) (= (select (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_30_fresh_1) |main_~#b~0.base_4|) 0) (< |#StackHeapBarrier_-1| |main_~#b~0.base_4|) (= v_ArrVal_30_fresh_1 1) (= (select |#valid_3| |main_~#a~0.base_4|) 0) (= 400000 v_ArrVal_31_fresh_1)) :named ssa_4))
(assert (! (and (= (store |#memory_int#2_3| |main_~#a~0.base_4| v_ArrVal_33_fresh_1) |#memory_int#2_5|) (= (store (select |#memory_int#2_3| |main_~#a~0.base_4|) (+ (* main_~i~0_4 4) |main_~#a~0.offset_4|) 42) v_ArrVal_33_fresh_1) (= 42 v_ArrVal_34_fresh_1) (< main_~i~0_4 100000) (= main_~i~0_5 (+ main_~i~0_4 1))) :named ssa_5))
(assert (! (and (= (store (select |#memory_int#2_5| |main_~#a~0.base_4|) (+ (* main_~i~0_5 4) |main_~#a~0.offset_4|) 42) v_ArrVal_35_fresh_1) (< main_~i~0_5 100000) (= (store |#memory_int#2_5| |main_~#a~0.base_4| v_ArrVal_35_fresh_1) |#memory_int#2_6|) (= main_~i~0_6 (+ main_~i~0_5 1)) (= 42 v_ArrVal_36_fresh_1)) :named ssa_6))
(assert (! (and (= 42 v_ArrVal_38_fresh_1) (= (store (select |#memory_int#2_6| |main_~#a~0.base_4|) (+ (* main_~i~0_6 4) |main_~#a~0.offset_4|) 42) v_ArrVal_37_fresh_1) (< main_~i~0_6 100000) (= main_~i~0_7 (+ main_~i~0_6 1)) (= (store |#memory_int#2_6| |main_~#a~0.base_4| v_ArrVal_37_fresh_1) |#memory_int#2_7|)) :named ssa_7))
(assert (! (<= 100000 main_~i~0_7) :named ssa_8))
(assert (! (= main_~i~0_9 0) :named ssa_9))
(assert (! (and (= (select (select |#memory_int#2_7| |main_~#a~0.base_4|) (+ (* main_~i~0_9 4) |main_~#a~0.offset_4|)) v_ArrVal_39_fresh_1) (= (store (select |#memory_int#1_3| |main_~#b~0.base_4|) (+ (* main_~i~0_9 4) |main_~#b~0.offset_4|) v_ArrVal_39_fresh_1) v_ArrVal_40_fresh_1) (< main_~i~0_9 100000) (= main_~i~0_10 (+ main_~i~0_9 1)) (= (store |#memory_int#1_3| |main_~#b~0.base_4| v_ArrVal_40_fresh_1) |#memory_int#1_10|)) :named ssa_10))
(assert (! (and (= (store |#memory_int#1_10| |main_~#b~0.base_4| v_ArrVal_42_fresh_1) |#memory_int#1_11|) (= (store (select |#memory_int#1_10| |main_~#b~0.base_4|) (+ (* main_~i~0_10 4) |main_~#b~0.offset_4|) v_ArrVal_41_fresh_1) v_ArrVal_42_fresh_1) (= (select (select |#memory_int#2_7| |main_~#a~0.base_4|) (+ (* main_~i~0_10 4) |main_~#a~0.offset_4|)) v_ArrVal_41_fresh_1) (< main_~i~0_10 100000) (= main_~i~0_11 (+ main_~i~0_10 1))) :named ssa_11))
(assert (! (and (= (store |#memory_int#1_11| |main_~#b~0.base_4| v_ArrVal_44_fresh_1) |#memory_int#1_12|) (= (store (select |#memory_int#1_11| |main_~#b~0.base_4|) (+ (* main_~i~0_11 4) |main_~#b~0.offset_4|) v_ArrVal_43_fresh_1) v_ArrVal_44_fresh_1) (< main_~i~0_11 100000) (= main_~i~0_12 (+ main_~i~0_11 1)) (= (select (select |#memory_int#2_7| |main_~#a~0.base_4|) (+ (* main_~i~0_11 4) |main_~#a~0.offset_4|)) v_ArrVal_43_fresh_1)) :named ssa_12))
(assert (! (<= 100000 main_~i~0_12) :named ssa_13))
(assert (! (= main_~x~0_14 0) :named ssa_14))
(assert (! (and (< main_~x~0_14 100000) (= |main_#t~mem3_15| (select (select |#memory_int#1_12| |main_~#b~0.base_4|) (+ (* main_~x~0_14 4) |main_~#b~0.offset_4|)))) :named ssa_15))
(assert (! true :named ssa_16_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_16| (ite (= |main_#t~mem3_15| 42) 1 0)) :named ssa_16_LocVarAssigCall))
