...
(set-info :ultimate-id array_of_struct_ptr_monotonic.i_AllErrorsAtOnce_Iteration2)
...
(assert (! (and (= (store |#memory_$Pointer$#1.base_0| |~#a~0.base_1| v_ArrVal_6_fresh_1) |#memory_$Pointer$#1.base_1|) (= |~#a~0.base_1| 3) (= 32 (select |#length_-1| 2)) (= ((as const (Array Int Int)) 0) v_ArrVal_6_fresh_1) (= (store |#memory_$Pointer$#1.offset_0| |~#a~0.base_1| v_ArrVal_5_fresh_1) |#memory_$Pointer$#1.offset_1|) (< 0 |#StackHeapBarrier_-1|) (= (select |#valid_-1| 0) 0) (= (select |#valid_-1| 1) 1) (= (select |#valid_-1| 2) 1) (= |~#a~0.offset_1| 0) (= (select (select |#memory_int#0_-1| 1) 1) 0) (= (select |#valid_-1| 3) 1) (= (select |#length_-1| 3) 400000) (= (select (select |#memory_int#0_-1| 1) 0) 48) (= ((as const (Array Int Int)) 0) v_ArrVal_5_fresh_1) (= (select |#length_-1| 1) 2)) :named ssa_1))
