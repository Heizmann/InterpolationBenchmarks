...
(set-info :ultimate-id string_concat-noarr.i_AllErrorsAtOnce_Iteration18)
...
(assert (! (or (<= 1000000 main_~i~0_39) (= |main_#t~nondet3_40| 0)) :named ssa_41))
(assert (! (< main_~j~0_39 100) :named ssa_42))
(assert (! true :named ssa_43_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_43| (ite (< main_~i~0_39 200) 1 0)) :named ssa_43_LocVarAssigCall))
