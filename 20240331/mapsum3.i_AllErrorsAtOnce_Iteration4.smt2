...
(set-info :ultimate-id mapsum3.i_AllErrorsAtOnce_Iteration4)
...
(assert (! (and (= (store |#length_3| |main_~#x~0.base_4| v_ArrVal_25_fresh_1) |#length_4|) (< |#StackHeapBarrier_-1| |main_~#x~0.base_4|) (= v_ArrVal_25_fresh_1 40000) (= |#valid_4| (store |#valid_3| |main_~#x~0.base_4| v_ArrVal_24_fresh_1)) (= v_ArrVal_24_fresh_1 1) (not (= |main_~#x~0.base_4| 0)) (= (select |#valid_3| |main_~#x~0.base_4|) 0) (= |main_~#x~0.offset_4| 0) (= main_~i~1_4 0)) :named ssa_4))
(assert (! (and (< main_~i~1_4 10000) (= |v_main_#t~nondet3_9_fresh_1| v_ArrVal_27_fresh_1) (<= |v_main_#t~nondet3_9_fresh_1| 2147483647) (= |#memory_int#1_5| (store |#memory_int#1_3| |main_~#x~0.base_4| v_ArrVal_26_fresh_1)) (<= 0 (+ |v_main_#t~nondet3_9_fresh_1| 2147483648)) (= (store (select |#memory_int#1_3| |main_~#x~0.base_4|) (+ (* main_~i~1_4 4) |main_~#x~0.offset_4|) |v_main_#t~nondet3_9_fresh_1|) v_ArrVal_26_fresh_1) (= main_~i~1_5 (+ main_~i~1_4 1))) :named ssa_5))
(assert (! (and (< main_~i~1_5 10000) (<= 0 (+ |v_main_#t~nondet3_10_fresh_1| 2147483648)) (= |#memory_int#1_6| (store |#memory_int#1_5| |main_~#x~0.base_4| v_ArrVal_28_fresh_1)) (<= |v_main_#t~nondet3_10_fresh_1| 2147483647) (= (store (select |#memory_int#1_5| |main_~#x~0.base_4|) (+ (* main_~i~1_5 4) |main_~#x~0.offset_4|) |v_main_#t~nondet3_10_fresh_1|) v_ArrVal_28_fresh_1) (= |v_main_#t~nondet3_10_fresh_1| v_ArrVal_29_fresh_1) (= main_~i~1_6 (+ main_~i~1_5 1))) :named ssa_6))
...
(assert (! (<= 10000 mapsum_~i~0_10) :named ssa_11))
(assert (! (= (ite (<= (mod mapsum_~ret~0_10 4294967296) 2147483647) (mod mapsum_~ret~0_10 4294967296) (+ (- 4294967296) (mod mapsum_~ret~0_10 4294967296))) |mapsum_#res_12|) :named ssa_12))
(assert (! (= |main_#t~ret5_13| |mapsum_#res_12|) :named ssa_13_return))
(assert (! (and (= (select (select |#memory_int#1_6| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4)) v_ArrVal_31_fresh_1) (= (store |#memory_int#1_6| |main_~#x~0.base_4| v_ArrVal_32_fresh_1) |#memory_int#1_14|) (= v_main_~temp~0_9_fresh_1 v_ArrVal_30_fresh_1) (<= 0 (+ |main_#t~ret5_13| 2147483648)) (= |main_#t~ret5_13| main_~ret~1_14) (<= |main_#t~ret5_13| 2147483647) (= (store (store (select |#memory_int#1_6| |main_~#x~0.base_4|) |main_~#x~0.offset_4| v_ArrVal_31_fresh_1) (+ |main_~#x~0.offset_4| 4) v_ArrVal_30_fresh_1) v_ArrVal_32_fresh_1) (= (select (select |#memory_int#1_6| |main_~#x~0.base_4|) |main_~#x~0.offset_4|) v_main_~temp~0_9_fresh_1)) :named ssa_14))
(assert (! true :named ssa_15_GlobVarAssigCall))
(assert (! (and (= |mapsum_#in~x.offset_15| |main_~#x~0.offset_4|) (= |main_~#x~0.base_4| |mapsum_#in~x.base_15|)) :named ssa_15_LocVarAssigCall))
...
(assert (! (= |main_#t~ret8_19| |mapsum_#res_18|) :named ssa_19_return))
(assert (! (and (= (select (select |#memory_int#1_14| |main_~#x~0.base_4|) |main_~#x~0.offset_4|) main_~temp~0_20) (<= |main_#t~ret8_19| 2147483647) (= main_~ret2~0_20 |main_#t~ret8_19|) (<= 0 (+ |main_#t~ret8_19| 2147483648)) (= main_~i~2_20 0)) :named ssa_20))
(assert (! (<= 9999 main_~i~2_20) :named ssa_21))
(assert (! (and (= |#memory_int#1_22| (store |#memory_int#1_14| |main_~#x~0.base_4| v_ArrVal_34_fresh_1)) (= v_ArrVal_34_fresh_1 (store (select |#memory_int#1_14| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 39996) v_ArrVal_33_fresh_1)) (= main_~temp~0_20 v_ArrVal_33_fresh_1)) :named ssa_22))
...
(assert (! (= |main_#t~ret12_27| |mapsum_#res_26|) :named ssa_27_return))
...
(assert (! (<= 10000 mapsum_~i~0_0) :named ssa_1))
