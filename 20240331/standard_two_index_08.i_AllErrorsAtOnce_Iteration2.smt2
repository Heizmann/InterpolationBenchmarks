...
(set-info :ultimate-id standard_two_index_08.i_AllErrorsAtOnce_Iteration2)
...
(assert (! (and (= (store (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_6_fresh_1) |main_~#b~0.base_4| v_ArrVal_8_fresh_1) |#valid_4|) (= main_~j~0_4 0) (= v_ArrVal_8_fresh_1 1) (< |#StackHeapBarrier_-1| |main_~#a~0.base_4|) (= (store (store |#length_3| |main_~#a~0.base_4| v_ArrVal_7_fresh_1) |main_~#b~0.base_4| v_ArrVal_5_fresh_1) |#length_4|) (= |main_~#b~0.offset_4| 0) (= main_~i~0_4 0) (not (= |main_~#a~0.base_4| 0)) (not (= |main_~#b~0.base_4| 0)) (= 400000 v_ArrVal_5_fresh_1) (= |main_~#a~0.offset_4| 0) (= 400000 v_ArrVal_7_fresh_1) (= (select (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_6_fresh_1) |main_~#b~0.base_4|) 0) (< |#StackHeapBarrier_-1| |main_~#b~0.base_4|) (= (select |#valid_3| |main_~#a~0.base_4|) 0) (= v_ArrVal_6_fresh_1 1)) :named ssa_4))
(assert (! (<= 100000 main_~i~0_4) :named ssa_5))
(assert (! (= main_~i~0_6 1) :named ssa_6))
(assert (! (<= 100000 main_~i~0_6) :named ssa_7))
(assert (! (and (= main_~j~0_8 0) (= main_~i~0_8 1)) :named ssa_8))
(assert (! (and (< main_~i~0_8 100000) (= (select (select |#memory_int#1_3| |main_~#b~0.base_4|) (+ 4 |main_~#b~0.offset_4| (* main_~j~0_8 32))) |main_#t~mem4_9|) (= (select (select |#memory_int#2_3| |main_~#a~0.base_4|) (+ (* main_~j~0_8 4) |main_~#a~0.offset_4|)) |main_#t~mem3_9|)) :named ssa_9))
(assert (! true :named ssa_10_GlobVarAssigCall))
(assert (! (= (ite (= |main_#t~mem4_9| |main_#t~mem3_9|) 1 0) |__VERIFIER_assert_#in~cond_10|) :named ssa_10_LocVarAssigCall))
