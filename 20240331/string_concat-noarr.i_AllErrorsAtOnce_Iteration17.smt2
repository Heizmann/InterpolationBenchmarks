...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:09:30+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id string_concat-noarr.i_AllErrorsAtOnce_Iteration17)
...
(assert (! (or (<= 1000000 main_~i~0_37) (= |main_#t~nondet3_38| 0)) :named ssa_39))
(assert (! (< main_~j~0_37 100) :named ssa_40))
(assert (! true :named ssa_41_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_41| (ite (< main_~i~0_37 200) 1 0)) :named ssa_41_LocVarAssigCall))
