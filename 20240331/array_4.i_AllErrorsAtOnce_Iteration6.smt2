...
(set-info :ultimate-id array_4.i_AllErrorsAtOnce_Iteration6)
...
(assert (! (and (= |#valid_4| (store |#valid_3| |main_~#A~0.base_4| v_ArrVal_31_fresh_1)) (= (select |#valid_3| |main_~#A~0.base_4|) 0) (not (= |main_~#A~0.base_4| 0)) (= 0 |main_~#A~0.offset_4|) (= (store |#length_3| |main_~#A~0.base_4| v_ArrVal_32_fresh_1) |#length_4|) (= v_ArrVal_31_fresh_1 1) (= 4096 v_ArrVal_32_fresh_1) (< |#StackHeapBarrier_-1| |main_~#A~0.base_4|) (= main_~i~0_4 0)) :named ssa_4))
(assert (! (and (= main_~i~0_5 (+ main_~i~0_4 1)) (<= 0 (+ |v_main_#t~nondet1_13_fresh_1| 2147483648)) (<= |v_main_#t~nondet1_13_fresh_1| 2147483647) (< main_~i~0_4 1023) (= (store |#memory_int#1_3| |main_~#A~0.base_4| v_ArrVal_34_fresh_1) |#memory_int#1_5|) (= |v_main_#t~nondet1_13_fresh_1| v_ArrVal_33_fresh_1) (= (store (select |#memory_int#1_3| |main_~#A~0.base_4|) (+ (* main_~i~0_4 4) |main_~#A~0.offset_4|) v_ArrVal_33_fresh_1) v_ArrVal_34_fresh_1)) :named ssa_5))
(assert (! (and (= main_~i~0_6 (+ main_~i~0_5 1)) (<= 0 (+ |v_main_#t~nondet1_14_fresh_1| 2147483648)) (< main_~i~0_5 1023) (= (store (select |#memory_int#1_5| |main_~#A~0.base_4|) (+ (* main_~i~0_5 4) |main_~#A~0.offset_4|) v_ArrVal_35_fresh_1) v_ArrVal_36_fresh_1) (= |v_main_#t~nondet1_14_fresh_1| v_ArrVal_35_fresh_1) (= (store |#memory_int#1_5| |main_~#A~0.base_4| v_ArrVal_36_fresh_1) |#memory_int#1_6|) (<= |v_main_#t~nondet1_14_fresh_1| 2147483647)) :named ssa_6))
(assert (! (<= 1023 main_~i~0_6) :named ssa_7))
(assert (! (and (= v_ArrVal_38_fresh_1 0) (= (store |#memory_int#1_6| |main_~#A~0.base_4| v_ArrVal_37_fresh_1) |#memory_int#1_8|) (= (store (select |#memory_int#1_6| |main_~#A~0.base_4|) (+ 4092 |main_~#A~0.offset_4|) 0) v_ArrVal_37_fresh_1) (= main_~i~0_8 0)) :named ssa_8))
...
(assert (! (= |main_#t~mem3_13| (select (select |#memory_int#1_8| |main_~#A~0.base_4|) (+ (* main_~i~0_12 4) |main_~#A~0.offset_4|))) :named ssa_13))
(assert (! (= |main_#t~mem3_13| 0) :named ssa_14))
(assert (! true :named ssa_15_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_15| (ite (<= main_~i~0_12 1024) 1 0)) :named ssa_15_LocVarAssigCall))
