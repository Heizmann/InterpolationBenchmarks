...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:10:08+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration36)
...
(assert (! (<= 1000000 main_~i~0_39) :named ssa_40))
(assert (! true :named ssa_41_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_41| (ite (= main_~i~0_39 1000000) 1 0)) :named ssa_41_LocVarAssigCall))
