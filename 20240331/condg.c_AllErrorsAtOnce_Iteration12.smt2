...
(set-info :ultimate-id condg.c_AllErrorsAtOnce_Iteration12)
...
(declare-fun |main_#t~mem12_23| () Int)
...
(assert (! (and (= (store |#memory_int#1_3| |main_~#sum~0.base_11| v_ArrVal_159_fresh_1) |#memory_int#1_11|) (= v_ArrVal_161_fresh_1 4) (= (store (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_164_fresh_1) main_~a~0.base_11 v_ArrVal_160_fresh_1) |#valid_11|) (= v_ArrVal_160_fresh_1 1) (< |#StackHeapBarrier_-1| |main_~#sum~0.base_11|) (= (select |#valid_3| |main_~#sum~0.base_11|) 0) (not (= |main_~#sum~0.base_11| 0)) (= v_ArrVal_164_fresh_1 1) (= v_ArrVal_162_fresh_1 0) (< main_~a~0.base_11 |#StackHeapBarrier_-1|) (= v_ArrVal_163_fresh_1 (* (mod ~N~0_4 1073741824) 4)) (= main_~i~0_11 0) (= 0 (select (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_164_fresh_1) main_~a~0.base_11)) (= v_ArrVal_159_fresh_1 (store (select |#memory_int#1_3| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| 0)) (= |#length_11| (store (store |#length_3| |main_~#sum~0.base_11| v_ArrVal_161_fresh_1) main_~a~0.base_11 v_ArrVal_163_fresh_1)) (= |main_~#sum~0.offset_11| 0) (= main_~a~0.offset_11 0) (not (= main_~a~0.base_11 0))) :named ssa_11))
(assert (! (and (= main_~i~0_12 (+ main_~i~0_11 1)) (= |#memory_int#3_12| (store |#memory_int#3_3| main_~a~0.base_11 v_ArrVal_165_fresh_1)) (= v_ArrVal_165_fresh_1 (store (select |#memory_int#3_3| main_~a~0.base_11) (+ (* main_~i~0_11 4) main_~a~0.offset_11) 1)) (= v_ArrVal_166_fresh_1 1) (< main_~i~0_11 ~N~0_4)) :named ssa_12))
(assert (! (and (= main_~i~0_13 (+ main_~i~0_12 1)) (= v_ArrVal_167_fresh_1 (store (select |#memory_int#3_12| main_~a~0.base_11) (+ (* main_~i~0_12 4) main_~a~0.offset_11) 1)) (= (store |#memory_int#3_12| main_~a~0.base_11 v_ArrVal_167_fresh_1) |#memory_int#3_13|) (= v_ArrVal_168_fresh_1 1) (< main_~i~0_12 ~N~0_4)) :named ssa_13))
(assert (! (and (= v_ArrVal_170_fresh_1 1) (= main_~i~0_14 (+ main_~i~0_13 1)) (= |#memory_int#3_14| (store |#memory_int#3_13| main_~a~0.base_11 v_ArrVal_169_fresh_1)) (= v_ArrVal_169_fresh_1 (store (select |#memory_int#3_13| main_~a~0.base_11) (+ (* main_~i~0_13 4) main_~a~0.offset_11) 1)) (< main_~i~0_13 ~N~0_4)) :named ssa_14))
(assert (! (<= ~N~0_4 main_~i~0_14) :named ssa_15))
(assert (! (= main_~i~0_16 0) :named ssa_16))
(assert (! (and (= v_ArrVal_172_fresh_1 (+ (select (select |#memory_int#3_14| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_16 4))) (select (select |#memory_int#1_11| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|))) (= (store |#memory_int#1_11| |main_~#sum~0.base_11| v_ArrVal_171_fresh_1) |#memory_int#1_17|) (< main_~i~0_16 ~N~0_4) (= v_ArrVal_171_fresh_1 (store (select |#memory_int#1_11| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| (+ (select (select |#memory_int#3_14| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_16 4))) (select (select |#memory_int#1_11| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|)))) (= main_~i~0_17 (+ main_~i~0_16 1))) :named ssa_17))
(assert (! (and (= v_ArrVal_173_fresh_1 (store (select |#memory_int#1_17| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| (+ (select (select |#memory_int#3_14| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_17 4))) (select (select |#memory_int#1_17| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|)))) (= v_ArrVal_174_fresh_1 (+ (select (select |#memory_int#3_14| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_17 4))) (select (select |#memory_int#1_17| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|))) (< main_~i~0_17 ~N~0_4) (= main_~i~0_18 (+ main_~i~0_17 1)) (= |#memory_int#1_18| (store |#memory_int#1_17| |main_~#sum~0.base_11| v_ArrVal_173_fresh_1))) :named ssa_18))
(assert (! (and (= (store |#memory_int#1_18| |main_~#sum~0.base_11| v_ArrVal_175_fresh_1) |#memory_int#1_19|) (< main_~i~0_18 ~N~0_4) (= v_ArrVal_176_fresh_1 (+ (select (select |#memory_int#3_14| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_18 4))) (select (select |#memory_int#1_18| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|))) (= main_~i~0_19 (+ main_~i~0_18 1)) (= v_ArrVal_175_fresh_1 (store (select |#memory_int#1_18| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| (+ (select (select |#memory_int#3_14| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_18 4))) (select (select |#memory_int#1_18| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|))))) :named ssa_19))
...
(assert (! (and (= v_ArrVal_178_fresh_1 (store (select |#memory_int#3_14| main_~a~0.base_11) (+ (* main_~i~0_21 4) main_~a~0.offset_11) v_ArrVal_177_fresh_1)) (= v_ArrVal_177_fresh_1 (+ (select (select |#memory_int#3_14| main_~a~0.base_11) (+ (* main_~i~0_21 4) main_~a~0.offset_11)) 1)) (= (store |#memory_int#3_14| main_~a~0.base_11 v_ArrVal_178_fresh_1) |#memory_int#3_23|) (not (= |main_#t~mem10_22| ~N~0_4))) :named ssa_23))
...
(assert (! (and (= v_ArrVal_179_fresh_1 (+ (select (select |#memory_int#3_23| main_~a~0.base_11) (+ (* main_~i~0_24 4) main_~a~0.offset_11)) 1)) (= (store (select |#memory_int#3_23| main_~a~0.base_11) (+ (* main_~i~0_24 4) main_~a~0.offset_11) v_ArrVal_179_fresh_1) v_ArrVal_180_fresh_1) (= (store |#memory_int#3_23| main_~a~0.base_11 v_ArrVal_180_fresh_1) |#memory_int#3_26|) (not (= |main_#t~mem10_25| ~N~0_4))) :named ssa_26))
...
(assert (! (and (= v_ArrVal_181_fresh_1 (+ (select (select |#memory_int#3_26| main_~a~0.base_11) (+ (* main_~i~0_27 4) main_~a~0.offset_11)) 1)) (= v_ArrVal_182_fresh_1 (store (select |#memory_int#3_26| main_~a~0.base_11) (+ (* main_~i~0_27 4) main_~a~0.offset_11) v_ArrVal_181_fresh_1)) (= |#memory_int#3_29| (store |#memory_int#3_26| main_~a~0.base_11 v_ArrVal_182_fresh_1)) (not (= |main_#t~mem10_28| ~N~0_4))) :named ssa_29))
