...
(set-info :ultimate-id array_4.i_AllErrorsAtOnce_Iteration1)
...
(assert (! (and (= |#valid_4| (store |#valid_3| |main_~#A~0.base_4| v_ArrVal_1_fresh_1)) (= (select |#valid_3| |main_~#A~0.base_4|) 0) (not (= |main_~#A~0.base_4| 0)) (= v_ArrVal_1_fresh_1 1) (= 0 |main_~#A~0.offset_4|) (= (store |#length_3| |main_~#A~0.base_4| v_ArrVal_2_fresh_1) |#length_4|) (< |#StackHeapBarrier_-1| |main_~#A~0.base_4|) (= 4096 v_ArrVal_2_fresh_1) (= main_~i~0_4 0)) :named ssa_4))
(assert (! false :named ssa_5))
(assert (! (and (= (store (select |#memory_int#1_3| |main_~#A~0.base_4|) (+ 4092 |main_~#A~0.offset_4|) 0) v_ArrVal_3_fresh_1) (= v_ArrVal_4_fresh_1 0) (= (store |#memory_int#1_3| |main_~#A~0.base_4| v_ArrVal_3_fresh_1) |#memory_int#1_6|) (= main_~i~0_6 0)) :named ssa_6))
(assert (! false :named ssa_7))
(assert (! true :named ssa_8_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_8| (ite (<= main_~i~0_6 1024) 1 0)) :named ssa_8_LocVarAssigCall))
