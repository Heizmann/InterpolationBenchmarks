...
(set-info :ultimate-id avg40-2.i_AllErrorsAtOnce_Iteration5)
...
(assert (! (and (= |#length_4| (store |#length_3| |main_~#x~0.base_4| v_ArrVal_36_fresh_1)) (= main_~i~1_4 0) (= |main_~#x~0.offset_4| 0) (= (select |#valid_3| |main_~#x~0.base_4|) 0) (< |#StackHeapBarrier_-1| |main_~#x~0.base_4|) (not (= |main_~#x~0.base_4| 0)) (= v_ArrVal_35_fresh_1 1) (= 160 v_ArrVal_36_fresh_1) (= (store |#valid_3| |main_~#x~0.base_4| v_ArrVal_35_fresh_1) |#valid_4|)) :named ssa_4))
(assert (! (and (< main_~i~1_4 40) (= (store (select |#memory_int#1_3| |main_~#x~0.base_4|) (+ (* main_~i~1_4 4) |main_~#x~0.offset_4|) |v_main_#t~nondet3_11_fresh_1|) v_ArrVal_37_fresh_1) (= |#memory_int#1_5| (store |#memory_int#1_3| |main_~#x~0.base_4| v_ArrVal_37_fresh_1)) (= |v_main_#t~nondet3_11_fresh_1| v_ArrVal_38_fresh_1) (<= |v_main_#t~nondet3_11_fresh_1| 2147483647) (<= 0 (+ |v_main_#t~nondet3_11_fresh_1| 2147483648)) (= main_~i~1_5 (+ main_~i~1_4 1))) :named ssa_5))
(assert (! (and (<= |v_main_#t~nondet3_12_fresh_1| 2147483647) (<= 0 (+ |v_main_#t~nondet3_12_fresh_1| 2147483648)) (= |#memory_int#1_6| (store |#memory_int#1_5| |main_~#x~0.base_4| v_ArrVal_40_fresh_1)) (= |v_main_#t~nondet3_12_fresh_1| v_ArrVal_39_fresh_1) (< main_~i~1_5 40) (= (store (select |#memory_int#1_5| |main_~#x~0.base_4|) (+ (* main_~i~1_5 4) |main_~#x~0.offset_4|) v_ArrVal_39_fresh_1) v_ArrVal_40_fresh_1) (= main_~i~1_6 (+ main_~i~1_5 1))) :named ssa_6))
...
(assert (! (<= 40 avg_~i~0_11) :named ssa_12))
(assert (! (= (ite (<= (mod (ite (and (not (= (mod avg_~ret~0_11 40) 0)) (< avg_~ret~0_11 0)) (+ (div avg_~ret~0_11 40) 1) (div avg_~ret~0_11 40)) 4294967296) 2147483647) (mod (ite (and (not (= (mod avg_~ret~0_11 40) 0)) (< avg_~ret~0_11 0)) (+ (div avg_~ret~0_11 40) 1) (div avg_~ret~0_11 40)) 4294967296) (+ (mod (ite (and (not (= (mod avg_~ret~0_11 40) 0)) (< avg_~ret~0_11 0)) (+ (div avg_~ret~0_11 40) 1) (div avg_~ret~0_11 40)) 4294967296) (- 4294967296))) |avg_#res_13|) :named ssa_13))
(assert (! (= |main_#t~ret5_14| |avg_#res_13|) :named ssa_14_return))
(assert (! (and (= v_main_~temp~0_10_fresh_1 v_ArrVal_42_fresh_1) (= |#memory_int#1_15| (store |#memory_int#1_6| |main_~#x~0.base_4| v_ArrVal_43_fresh_1)) (<= 0 (+ |main_#t~ret5_14| 2147483648)) (= |main_#t~ret5_14| main_~ret~1_15) (<= |main_#t~ret5_14| 2147483647) (= v_ArrVal_43_fresh_1 (store (store (select |#memory_int#1_6| |main_~#x~0.base_4|) |main_~#x~0.offset_4| v_ArrVal_41_fresh_1) (+ |main_~#x~0.offset_4| 4) v_ArrVal_42_fresh_1)) (= (select (select |#memory_int#1_6| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4)) v_ArrVal_41_fresh_1) (= v_main_~temp~0_10_fresh_1 (select (select |#memory_int#1_6| |main_~#x~0.base_4|) |main_~#x~0.offset_4|))) :named ssa_15))
...
(assert (! (and (= avg_~i~0_18 (+ avg_~i~0_17 1)) (= (+ (select (select |#memory_int#1_15| avg_~x.base_17) (+ (* avg_~i~0_17 4) avg_~x.offset_17)) avg_~ret~0_17) avg_~ret~0_18) (< avg_~i~0_17 40)) :named ssa_18))
...
(assert (! (= |main_#t~ret8_21| |avg_#res_20|) :named ssa_21_return))
(assert (! (and (= main_~ret2~0_22 |main_#t~ret8_21|) (<= |main_#t~ret8_21| 2147483647) (<= 0 (+ |main_#t~ret8_21| 2147483648)) (= main_~i~2_22 0) (= main_~temp~0_22 (select (select |#memory_int#1_15| |main_~#x~0.base_4|) |main_~#x~0.offset_4|))) :named ssa_22))
(assert (! (<= 39 main_~i~2_22) :named ssa_23))
(assert (! (and (= (store (select |#memory_int#1_15| |main_~#x~0.base_4|) (+ 156 |main_~#x~0.offset_4|) v_ArrVal_44_fresh_1) v_ArrVal_45_fresh_1) (= main_~temp~0_22 v_ArrVal_44_fresh_1) (= (store |#memory_int#1_15| |main_~#x~0.base_4| v_ArrVal_45_fresh_1) |#memory_int#1_24|)) :named ssa_24))
(assert (! true :named ssa_25_GlobVarAssigCall))
(assert (! (and (= |main_~#x~0.base_4| |avg_#in~x.base_25|) (= |main_~#x~0.offset_4| |avg_#in~x.offset_25|)) :named ssa_25_LocVarAssigCall))
...
(assert (! (= |main_#t~ret12_30| |avg_#res_29|) :named ssa_30_return))
...
(assert (! (<= 40 avg_~i~0_1) :named ssa_2))
(assert (! (= (ite (<= (mod (ite (and (not (= (mod avg_~ret~0_1 40) 0)) (< avg_~ret~0_1 0)) (+ (div avg_~ret~0_1 40) 1) (div avg_~ret~0_1 40)) 4294967296) 2147483647) (mod (ite (and (not (= (mod avg_~ret~0_1 40) 0)) (< avg_~ret~0_1 0)) (+ (div avg_~ret~0_1 40) 1) (div avg_~ret~0_1 40)) 4294967296) (+ (mod (ite (and (not (= (mod avg_~ret~0_1 40) 0)) (< avg_~ret~0_1 0)) (+ (div avg_~ret~0_1 40) 1) (div avg_~ret~0_1 40)) 4294967296) (- 4294967296))) |avg_#res_3|) :named ssa_3))
(assert (! (= |main_#t~ret5_4| |avg_#res_3|) :named ssa_4_return))
(assert (! true :named ssa_-2_PendingContext))
...
(assert (! (<= 40 avg_~i~0_1) :named ssa_2))
(assert (! (= (ite (<= (mod (ite (and (not (= (mod avg_~ret~0_1 40) 0)) (< avg_~ret~0_1 0)) (+ (div avg_~ret~0_1 40) 1) (div avg_~ret~0_1 40)) 4294967296) 2147483647) (mod (ite (and (not (= (mod avg_~ret~0_1 40) 0)) (< avg_~ret~0_1 0)) (+ (div avg_~ret~0_1 40) 1) (div avg_~ret~0_1 40)) 4294967296) (+ (mod (ite (and (not (= (mod avg_~ret~0_1 40) 0)) (< avg_~ret~0_1 0)) (+ (div avg_~ret~0_1 40) 1) (div avg_~ret~0_1 40)) 4294967296) (- 4294967296))) |avg_#res_3|) :named ssa_3))
(assert (! (= |main_#t~ret8_4| |avg_#res_3|) :named ssa_4_return))
...
(assert (! (<= 40 avg_~i~0_1) :named ssa_2))
(assert (! (= (ite (<= (mod (ite (and (not (= (mod avg_~ret~0_1 40) 0)) (< avg_~ret~0_1 0)) (+ (div avg_~ret~0_1 40) 1) (div avg_~ret~0_1 40)) 4294967296) 2147483647) (mod (ite (and (not (= (mod avg_~ret~0_1 40) 0)) (< avg_~ret~0_1 0)) (+ (div avg_~ret~0_1 40) 1) (div avg_~ret~0_1 40)) 4294967296) (+ (mod (ite (and (not (= (mod avg_~ret~0_1 40) 0)) (< avg_~ret~0_1 0)) (+ (div avg_~ret~0_1 40) 1) (div avg_~ret~0_1 40)) 4294967296) (- 4294967296))) |avg_#res_3|) :named ssa_3))
(assert (! (= |main_#t~ret12_4| |avg_#res_3|) :named ssa_4_return))
(assert (! false :named ssa_-2_PendingContext))
