...
(set-info :ultimate-id avg40-2.i_AllErrorsAtOnce_Iteration8)
...
(declare-fun |avg_#in~x.base_9| () Int)
(declare-fun |main_~#x~0.offset_9| () Int)
(declare-fun |avg_#in~x.offset_9| () Int)
(declare-fun |main_~#x~0.base_9| () Int)
(declare-fun avg_~ret~0_10 () Int)
(declare-fun avg_~x.base_10 () Int)
(declare-fun avg_~i~0_10 () Int)
(declare-fun avg_~x.offset_10 () Int)
(declare-fun |avg_#t~post2_11| () Int)
(declare-fun avg_~ret~0_11 () Int)
(declare-fun |avg_#t~mem1_11| () Int)
...
(assert (! (and (= main_~i~1_4 0) (= |main_~#x~0.offset_4| 0) (= (select |#valid_3| |main_~#x~0.base_4|) 0) (< |#StackHeapBarrier_-1| |main_~#x~0.base_4|) (= |#valid_4| (store |#valid_3| |main_~#x~0.base_4| v_ArrVal_70_fresh_1)) (= v_ArrVal_70_fresh_1 1) (= 160 v_ArrVal_71_fresh_1) (not (= |main_~#x~0.base_4| 0)) (= |#length_4| (store |#length_3| |main_~#x~0.base_4| v_ArrVal_71_fresh_1))) :named ssa_4))
(assert (! (and (<= |v_main_#t~nondet3_17_fresh_1| 2147483647) (< main_~i~1_4 40) (= (store (select |#memory_int#1_3| |main_~#x~0.base_4|) (+ (* main_~i~1_4 4) |main_~#x~0.offset_4|) |v_main_#t~nondet3_17_fresh_1|) v_ArrVal_72_fresh_1) (<= 0 (+ |v_main_#t~nondet3_17_fresh_1| 2147483648)) (= |v_main_#t~nondet3_17_fresh_1| v_ArrVal_73_fresh_1) (= (store |#memory_int#1_3| |main_~#x~0.base_4| v_ArrVal_72_fresh_1) |#memory_int#1_5|) (= main_~i~1_5 (+ main_~i~1_4 1))) :named ssa_5))
(assert (! (and (<= |v_main_#t~nondet3_18_fresh_1| 2147483647) (< main_~i~1_5 40) (= |#memory_int#1_6| (store |#memory_int#1_5| |main_~#x~0.base_4| v_ArrVal_75_fresh_1)) (= |v_main_#t~nondet3_18_fresh_1| v_ArrVal_74_fresh_1) (<= 0 (+ |v_main_#t~nondet3_18_fresh_1| 2147483648)) (= (store (select |#memory_int#1_5| |main_~#x~0.base_4|) (+ (* main_~i~1_5 4) |main_~#x~0.offset_4|) v_ArrVal_74_fresh_1) v_ArrVal_75_fresh_1) (= main_~i~1_6 (+ main_~i~1_5 1))) :named ssa_6))
(assert (! (<= 40 main_~i~1_6) :named ssa_7))
(assert (! true :named ssa_8))
(assert (! true :named ssa_9_GlobVarAssigCall))
(assert (! (and (= |main_~#x~0.offset_4| |avg_#in~x.offset_9|) (= |main_~#x~0.base_4| |avg_#in~x.base_9|)) :named ssa_9_LocVarAssigCall))
(assert (! true :named ssa_9_OldVarAssigCall))
(assert (! (and (= avg_~ret~0_10 0) (= avg_~x.base_10 |avg_#in~x.base_9|) (= avg_~x.offset_10 |avg_#in~x.offset_9|) (= avg_~i~0_10 0)) :named ssa_10))
(assert (! (and (= avg_~i~0_11 (+ avg_~i~0_10 1)) (= (+ (select (select |#memory_int#1_6| avg_~x.base_10) (+ (* avg_~i~0_10 4) avg_~x.offset_10)) avg_~ret~0_10) avg_~ret~0_11) (< avg_~i~0_10 40)) :named ssa_11))
(assert (! (and (= avg_~i~0_12 (+ avg_~i~0_11 1)) (= (+ (select (select |#memory_int#1_6| avg_~x.base_10) (+ (* avg_~i~0_11 4) avg_~x.offset_10)) avg_~ret~0_11) avg_~ret~0_12) (< avg_~i~0_11 40)) :named ssa_12))
(assert (! (<= 40 avg_~i~0_12) :named ssa_13))
(assert (! (= (ite (<= (mod (ite (and (not (= (mod avg_~ret~0_12 40) 0)) (< avg_~ret~0_12 0)) (+ (div avg_~ret~0_12 40) 1) (div avg_~ret~0_12 40)) 4294967296) 2147483647) (mod (ite (and (not (= (mod avg_~ret~0_12 40) 0)) (< avg_~ret~0_12 0)) (+ (div avg_~ret~0_12 40) 1) (div avg_~ret~0_12 40)) 4294967296) (+ (mod (ite (and (not (= (mod avg_~ret~0_12 40) 0)) (< avg_~ret~0_12 0)) (+ (div avg_~ret~0_12 40) 1) (div avg_~ret~0_12 40)) 4294967296) (- 4294967296))) |avg_#res_14|) :named ssa_14))
(assert (! (= |main_#t~ret5_15| |avg_#res_14|) :named ssa_15_return))
(assert (! (and (= v_main_~temp~0_13_fresh_1 (select (select |#memory_int#1_6| |main_~#x~0.base_4|) |main_~#x~0.offset_4|)) (= v_main_~temp~0_13_fresh_1 v_ArrVal_78_fresh_1) (<= 0 (+ |main_#t~ret5_15| 2147483648)) (= (store (store (select |#memory_int#1_6| |main_~#x~0.base_4|) |main_~#x~0.offset_4| (select (select |#memory_int#1_6| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4))) (+ |main_~#x~0.offset_4| 4) v_main_~temp~0_13_fresh_1) v_ArrVal_76_fresh_1) (= |main_#t~ret5_15| main_~ret~1_16) (<= |main_#t~ret5_15| 2147483647) (= (select (select |#memory_int#1_6| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4)) v_ArrVal_77_fresh_1) (= (store |#memory_int#1_6| |main_~#x~0.base_4| v_ArrVal_76_fresh_1) |#memory_int#1_16|)) :named ssa_16))
...
(assert (! (and (= avg_~i~0_19 (+ avg_~i~0_18 1)) (= (+ (select (select |#memory_int#1_16| avg_~x.base_18) (+ (* avg_~i~0_18 4) avg_~x.offset_18)) avg_~ret~0_18) avg_~ret~0_19) (< avg_~i~0_18 40)) :named ssa_19))
(assert (! (and (= avg_~i~0_20 (+ avg_~i~0_19 1)) (= (+ (select (select |#memory_int#1_16| avg_~x.base_18) (+ (* avg_~i~0_19 4) avg_~x.offset_18)) avg_~ret~0_19) avg_~ret~0_20) (< avg_~i~0_19 40)) :named ssa_20))
...
(assert (! (= |main_#t~ret8_23| |avg_#res_22|) :named ssa_23_return))
(assert (! (and (= main_~ret2~0_24 |main_#t~ret8_23|) (<= |main_#t~ret8_23| 2147483647) (<= 0 (+ |main_#t~ret8_23| 2147483648)) (= main_~i~2_24 0) (= main_~temp~0_24 (select (select |#memory_int#1_16| |main_~#x~0.base_4|) |main_~#x~0.offset_4|))) :named ssa_24))
(assert (! (and (< main_~i~2_24 39) (= v_ArrVal_79_fresh_1 (store (select |#memory_int#1_16| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| (* main_~i~2_24 4)) (select (select |#memory_int#1_16| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4 (* main_~i~2_24 4))))) (= |#memory_int#1_25| (store |#memory_int#1_16| |main_~#x~0.base_4| v_ArrVal_79_fresh_1)) (= main_~i~2_25 (+ main_~i~2_24 1)) (= (select (select |#memory_int#1_16| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4 (* main_~i~2_24 4))) v_ArrVal_80_fresh_1)) :named ssa_25))
(assert (! (and (< main_~i~2_25 39) (= v_ArrVal_81_fresh_1 (store (select |#memory_int#1_25| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| (* main_~i~2_25 4)) (select (select |#memory_int#1_25| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4 (* main_~i~2_25 4))))) (= main_~i~2_26 (+ main_~i~2_25 1)) (= |#memory_int#1_26| (store |#memory_int#1_25| |main_~#x~0.base_4| v_ArrVal_81_fresh_1)) (= (select (select |#memory_int#1_25| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4 (* main_~i~2_25 4))) v_ArrVal_82_fresh_1)) :named ssa_26))
(assert (! (<= 39 main_~i~2_26) :named ssa_27))
(assert (! (and (= main_~temp~0_24 v_ArrVal_83_fresh_1) (= (store (select |#memory_int#1_26| |main_~#x~0.base_4|) (+ 156 |main_~#x~0.offset_4|) v_ArrVal_83_fresh_1) v_ArrVal_84_fresh_1) (= (store |#memory_int#1_26| |main_~#x~0.base_4| v_ArrVal_84_fresh_1) |#memory_int#1_28|)) :named ssa_28))
(assert (! true :named ssa_29_GlobVarAssigCall))
(assert (! (and (= |main_~#x~0.base_4| |avg_#in~x.base_29|) (= |main_~#x~0.offset_4| |avg_#in~x.offset_29|)) :named ssa_29_LocVarAssigCall))
...
(assert (! (= |main_#t~ret12_35| |avg_#res_34|) :named ssa_35_return))
