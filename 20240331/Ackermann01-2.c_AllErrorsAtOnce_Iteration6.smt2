...
(set-info :ultimate-id Ackermann01-2.c_AllErrorsAtOnce_Iteration6)
...
(declare-fun |ackermann_#t~ret4_33| () Int)
(declare-fun |ackermann_#res_35| () Int)
(declare-fun |ackermann_#t~ret6_35| () Int)
...
(declare-fun |main_#t~ret9_38| () Int)
(declare-fun main_~result~0_39 () Int)
(declare-fun |main_#t~ret9_39| () Int)
(declare-fun main_~result~0_40 () Int)
(declare-fun main_~m~0_40 () Int)
(declare-fun main_~n~0_40 () Int)
...
(assert (! (not (= ackermann_~m_25 0)) :named ssa_26))
(assert (! (= ackermann_~n_25 0) :named ssa_27))
(assert (! true :named ssa_28_GlobVarAssigCall))
(assert (! (and (= ackermann_~m_25 (+ |ackermann_#in~m_28| 1)) (= |ackermann_#in~n_28| 1)) :named ssa_28_LocVarAssigCall))
...
(assert (! (= |ackermann_#res_30| |ackermann_#t~ret4_32|) :named ssa_32_return))
(assert (! (and (<= 0 (+ |ackermann_#t~ret4_32| 2147483648)) (<= |ackermann_#t~ret4_32| 2147483647) (= |ackermann_#res_33| |ackermann_#t~ret4_32|)) :named ssa_33))
(assert (! true :named ssa_34))
(assert (! (= |ackermann_#res_33| |ackermann_#t~ret6_35|) :named ssa_35_return))
(assert (! (and (= |ackermann_#res_36| |ackermann_#t~ret6_35|) (<= |ackermann_#t~ret6_35| 2147483647) (<= 0 (+ |ackermann_#t~ret6_35| 2147483648))) :named ssa_36))
(assert (! true :named ssa_37))
(assert (! (= |main_#t~ret9_38| |ackermann_#res_36|) :named ssa_38_return))
(assert (! (and (<= 0 (+ |main_#t~ret9_38| 2147483648)) (= main_~result~0_39 |main_#t~ret9_38|) (<= |main_#t~ret9_38| 2147483647)) :named ssa_39))
(assert (! (and (< main_~result~0_39 0) (<= 0 main_~m~0_4) (<= 0 main_~n~0_5)) :named ssa_40))
(assert (! true :named ssa_41))
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 ssa_5 ssa_6 (and ssa_13 ssa_24_GlobVarAssigCall ssa_27 ssa_20 ssa_31 ssa_16 ssa_15_LocVarAssigCall ssa_26 ssa_34 ssa_7_LocVarAssigCall ssa_11_LocVarAssigCall ssa_10 ssa_14 ssa_38_return ssa_8 ssa_24_LocVarAssigCall ssa_9 ssa_25 ssa_15_GlobVarAssigCall ssa_7_OldVarAssigCall ssa_24_OldVarAssigCall ssa_32_return ssa_37 ssa_22_return ssa_12 ssa_11_OldVarAssigCall ssa_19_return ssa_28_OldVarAssigCall ssa_36 ssa_35_return ssa_29 ssa_21 ssa_11_GlobVarAssigCall ssa_18 ssa_23 ssa_30 ssa_17 ssa_28_GlobVarAssigCall ssa_33 ssa_7_GlobVarAssigCall ssa_28_LocVarAssigCall ssa_15_OldVarAssigCall) ssa_39 ssa_40 (and ssa_postcond ssa_41))
...
(assert (! (not (= ackermann_~m_17 0)) :named ssa_18))
(assert (! (= ackermann_~n_17 0) :named ssa_19))
(assert (! true :named ssa_20_GlobVarAssigCall))
(assert (! (and (= ackermann_~m_17 (+ |ackermann_#in~m_20| 1)) (= |ackermann_#in~n_20| 1)) :named ssa_20_LocVarAssigCall))
...
(assert (! (= |ackermann_#res_22| |ackermann_#t~ret4_24|) :named ssa_24_return))
(assert (! (and (<= 0 (+ |ackermann_#t~ret4_24| 2147483648)) (<= |ackermann_#t~ret4_24| 2147483647) (= |ackermann_#res_25| |ackermann_#t~ret4_24|)) :named ssa_25))
(assert (! true :named ssa_26))
(assert (! (= |ackermann_#res_25| |ackermann_#t~ret6_27|) :named ssa_27_return))
(assert (! (and (= |ackermann_#res_28| |ackermann_#t~ret6_27|) (<= |ackermann_#t~ret6_27| 2147483647) (<= 0 (+ |ackermann_#t~ret6_27| 2147483648))) :named ssa_28))
(assert (! true :named ssa_29))
(assert (! (= |main_#t~ret9_30| |ackermann_#res_28|) :named ssa_30_return))
(assert (! true :named ssa_-2_PendingContext))
(assert (! (and (= main_~n~0_-2 |ackermann_#in~n_-1|) (= main_~m~0_-2 |ackermann_#in~m_-1|)) :named ssa_-2_LocVarAssignPendingContext))
(assert (! true :named ssa_-2_OldVarAssignPendingContext))
(check-sat)
(get-interpolants (and ssa_0 ssa_precond) ssa_1 ssa_2 (and ssa_13 ssa_3_OldVarAssigCall ssa_11_return ssa_6 ssa_3_LocVarAssigCall ssa_7_LocVarAssigCall ssa_10 ssa_8 ssa_9 ssa_3_GlobVarAssigCall ssa_7_OldVarAssigCall ssa_12 ssa_5 ssa_4 ssa_7_GlobVarAssigCall ssa_14_return) ssa_15 (and ssa_26 ssa_27_return ssa_25 ssa_20_GlobVarAssigCall ssa_20_OldVarAssigCall ssa_24_return ssa_19 ssa_16_OldVarAssigCall ssa_16_LocVarAssigCall ssa_20_LocVarAssigCall ssa_16_GlobVarAssigCall ssa_22 ssa_21 ssa_18 ssa_23 ssa_17) ssa_28 ssa_29 (and ssa_-2_PendingContext ssa_-2_LocVarAssignPendingContext ssa_-2_OldVarAssignPendingContext ssa_30_return ssa_postcond))
(echo "finished trace check")
(pop 1)
(echo "starting trace check")
(push 1)
...
(assert (! true :named ssa_precond))
(assert (! (not (<= ackermann_~m_-2 1)) :named ssa_postcond))
(assert (! (and (= ackermann_~n_0 |ackermann_#in~n_-1|) (= ackermann_~m_0 |ackermann_#in~m_-1|)) :named ssa_0))
(assert (! (not (= ackermann_~m_0 0)) :named ssa_1))
...
(assert (! (<= ackermann_~m_-2 1) :named ssa_-2_PendingContext))
