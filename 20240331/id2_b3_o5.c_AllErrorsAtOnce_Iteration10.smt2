...
(set-info :ultimate-id id2_b3_o5.c_AllErrorsAtOnce_Iteration10)
...
(assert (! (and (= 3 |id2_#res_31|) (< 3 (mod id2_~ret~1_30 4294967296))) :named ssa_31))
...
(assert (! (and (= 3 |id2_#res_25|) (< 3 (mod id2_~ret~1_24 4294967296))) :named ssa_25))
...
(assert (! (and (= 3 |id2_#res_22|) (< 3 (mod id2_~ret~1_21 4294967296))) :named ssa_22))
