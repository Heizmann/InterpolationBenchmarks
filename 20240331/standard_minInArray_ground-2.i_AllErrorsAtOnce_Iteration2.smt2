...
(set-info :ultimate-id standard_minInArray_ground-2.i_AllErrorsAtOnce_Iteration2)
...
(declare-fun |main_#t~mem5_9| () Int)
...
(assert (! (and (= 400000 v_ArrVal_4_fresh_1) (not (= |main_~#a~0.base_4| 0)) (= (store |#length_3| |main_~#a~0.base_4| v_ArrVal_4_fresh_1) |#length_4|) (= main_~min~0_4 0) (< |#StackHeapBarrier_-1| |main_~#a~0.base_4|) (= v_ArrVal_3_fresh_1 1) (= |main_~#a~0.offset_4| 0) (= (select |#valid_3| |main_~#a~0.base_4|) 0) (= main_~i~0_4 0) (= |#valid_4| (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_3_fresh_1))) :named ssa_4))
...
(assert (! (and (< main_~x~0_8 100000) (= |main_#t~mem5_9| (select (select |#memory_int#1_3| |main_~#a~0.base_4|) (+ (* main_~x~0_8 4) |main_~#a~0.offset_4|)))) :named ssa_9))
(assert (! true :named ssa_10_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_10| (ite (<= main_~min~0_4 |main_#t~mem5_9|) 1 0)) :named ssa_10_LocVarAssigCall))
