...
(set-info :ultimate-id num_conversion_2.c_AllErrorsAtOnce_Iteration10)
...
(assert (! (<= 8 (mod main_~c~0_53 256)) :named ssa_54))
(assert (! true :named ssa_55_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_55| (ite (= (mod main_~x~0_4 256) (mod main_~y~0_4 256)) 1 0)) :named ssa_55_LocVarAssigCall))
