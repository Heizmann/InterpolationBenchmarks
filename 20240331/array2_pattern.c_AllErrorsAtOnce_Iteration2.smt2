...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-30T23:52:26+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id array2_pattern.c_AllErrorsAtOnce_Iteration2)
...
(declare-fun main_~sum~0_22 () Int)
...
(assert (! (and (< |#StackHeapBarrier_-1| |main_~#array1~0.base_10|) (= v_ArrVal_8_fresh_1 1) (not (= |main_~#array2~0.base_10| 0)) (= v_ArrVal_7_fresh_1 1) (= main_~count~0_10 0) (= (store (store |#valid_3| |main_~#array1~0.base_10| v_ArrVal_7_fresh_1) |main_~#array2~0.base_10| v_ArrVal_8_fresh_1) |#valid_10|) (= (store (store |#length_3| |main_~#array1~0.base_10| v_ArrVal_6_fresh_1) |main_~#array2~0.base_10| v_ArrVal_5_fresh_1) |#length_10|) (= v_ArrVal_6_fresh_1 (* (mod ~ARR_SIZE~0_4 1073741824) 4)) (= (+ main_~num~0_10 1) 0) (= v_ArrVal_5_fresh_1 (* (mod ~ARR_SIZE~0_4 1073741824) 4)) (= (select (store |#valid_3| |main_~#array1~0.base_10| v_ArrVal_7_fresh_1) |main_~#array2~0.base_10|) 0) (not (= |main_~#array1~0.base_10| 0)) (= (select |#valid_3| |main_~#array1~0.base_10|) 0) (= 0 main_~sum~0_10) (= |main_~#array2~0.offset_10| 0) (< |#StackHeapBarrier_-1| |main_~#array2~0.base_10|) (= |main_~#array1~0.offset_10| 0)) :named ssa_10))
(assert (! (<= ~ARR_SIZE~0_4 main_~count~0_10) :named ssa_11))
(assert (! (and (<= main_~index~0_12 32767) (<= 0 (+ main_~index~0_12 32768))) :named ssa_12))
...
(assert (! (and (<= main_~temp~0_18 2147483647) (= (store |#memory_int#2_3| |main_~#array2~0.base_10| v_ArrVal_11_fresh_1) |#memory_int#2_18|) (= (store |#memory_int#1_3| |main_~#array1~0.base_10| v_ArrVal_12_fresh_1) |#memory_int#1_18|) (= v_ArrVal_11_fresh_1 (store (select |#memory_int#2_3| |main_~#array2~0.base_10|) (+ |main_~#array2~0.offset_10| (* (ite (<= (mod (+ ~ARR_SIZE~0_4 4294967295 (* 4294967295 main_~index~0_12)) 4294967296) 2147483647) (mod (+ ~ARR_SIZE~0_4 4294967295 (* 4294967295 main_~index~0_12)) 4294967296) (+ (mod (+ ~ARR_SIZE~0_4 4294967295 (* 4294967295 main_~index~0_12)) 4294967296) (- 4294967296))) 4)) v_ArrVal_9_fresh_1)) (= (+ (* main_~index~0_12 main_~num~0_10 main_~num~0_10) (select (select |#memory_int#1_3| |main_~#array1~0.base_10|) (+ (* main_~index~0_12 4) |main_~#array1~0.offset_10|))) v_ArrVal_10_fresh_1) (<= 0 (+ main_~temp~0_18 2147483648)) (= (store (select |#memory_int#1_3| |main_~#array1~0.base_10|) (+ (* main_~index~0_12 4) |main_~#array1~0.offset_10|) v_ArrVal_10_fresh_1) v_ArrVal_12_fresh_1) (= (+ (* main_~index~0_12 main_~num~0_10) (select (select |#memory_int#2_3| |main_~#array2~0.base_10|) (+ |main_~#array2~0.offset_10| (* (ite (<= (mod (+ ~ARR_SIZE~0_4 4294967295 (* 4294967295 main_~index~0_12)) 4294967296) 2147483647) (mod (+ ~ARR_SIZE~0_4 4294967295 (* 4294967295 main_~index~0_12)) 4294967296) (+ (mod (+ ~ARR_SIZE~0_4 4294967295 (* 4294967295 main_~index~0_12)) 4294967296) (- 4294967296))) 4)))) v_ArrVal_9_fresh_1)) :named ssa_18))
(exit)
