...
(set-info :ultimate-id nested_5.c_AllErrorsAtOnce_Iteration8)
...
(assert (! (<= 6 main_~c~0_14) :named ssa_15))
(assert (! (= (+ main_~b~0_5 1) main_~b~0_16) :named ssa_16))
(assert (! (<= 6 main_~b~0_16) :named ssa_17))
(assert (! (= (+ main_~a~0_4 1) main_~a~0_18) :named ssa_18))
(assert (! (<= 6 main_~a~0_18) :named ssa_19))
(assert (! (or (not (= main_~d~0_12 6)) (not (= main_~b~0_16 6)) (not (= main_~a~0_18 6)) (not (= main_~e~0_10 6)) (not (= main_~c~0_14 6))) :named ssa_20))
