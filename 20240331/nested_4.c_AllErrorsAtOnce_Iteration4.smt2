...
(set-info :ultimate-id nested_4.c_AllErrorsAtOnce_Iteration4)
...
(declare-fun |main_#t~pre6_8| () Int)
(declare-fun |main_#t~pre7_10| () Int)
...
(assert (! (or (not (= main_~c~0_6 6)) (not (= main_~d~0_4 6)) (not (= main_~b~0_8 6)) (not (= main_~a~0_10 6))) :named ssa_12))
