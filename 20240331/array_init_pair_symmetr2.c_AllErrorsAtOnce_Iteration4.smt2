...
(set-info :ultimate-id array_init_pair_symmetr2.c_AllErrorsAtOnce_Iteration4)
...
(declare-fun |main_#t~mem8_58| () Int)
...
(declare-fun |main_#t~post9_59| () Int)
...
(assert (! (and (= main_~x~0_5 v_ArrVal_46_fresh_1) (= (store |#memory_int#1_3| |main_~#b~0.base_4| v_ArrVal_45_fresh_1) |#memory_int#1_21|) (= main_~i~0_21 (+ main_~i~0_4 1)) (= (store (select |#memory_int#1_3| |main_~#b~0.base_4|) (+ |main_~#b~0.offset_4| (* main_~i~0_4 4)) v_ArrVal_44_fresh_1) v_ArrVal_45_fresh_1) (= (store (select |#memory_int#2_3| |main_~#a~0.base_4|) (+ (* main_~i~0_4 4) |main_~#a~0.offset_4|) main_~x~0_5) v_ArrVal_43_fresh_1) (= main_~y~0_5 v_ArrVal_44_fresh_1) (= (store |#memory_int#2_3| |main_~#a~0.base_4| v_ArrVal_43_fresh_1) |#memory_int#2_21|)) :named ssa_21))
...
(assert (! (and (= (store (select |#memory_int#2_21| |main_~#a~0.base_4|) (+ (* main_~i~0_21 4) |main_~#a~0.offset_4|) main_~x~0_22) v_ArrVal_47_fresh_1) (= (store (select |#memory_int#1_21| |main_~#b~0.base_4|) (+ |main_~#b~0.offset_4| (* main_~i~0_21 4)) v_ArrVal_48_fresh_1) v_ArrVal_49_fresh_1) (= |#memory_int#1_38| (store |#memory_int#1_21| |main_~#b~0.base_4| v_ArrVal_49_fresh_1)) (= main_~y~0_22 v_ArrVal_48_fresh_1) (= (store |#memory_int#2_21| |main_~#a~0.base_4| v_ArrVal_47_fresh_1) |#memory_int#2_38|) (= main_~i~0_38 (+ main_~i~0_21 1)) (= main_~x~0_22 v_ArrVal_50_fresh_1)) :named ssa_38))
...
(assert (! (and (= (store |#memory_int#1_38| |main_~#b~0.base_4| v_ArrVal_53_fresh_1) |#memory_int#1_55|) (= (store (select |#memory_int#1_38| |main_~#b~0.base_4|) (+ |main_~#b~0.offset_4| (* main_~i~0_38 4)) v_ArrVal_52_fresh_1) v_ArrVal_53_fresh_1) (= main_~y~0_39 v_ArrVal_52_fresh_1) (= (store (select |#memory_int#2_38| |main_~#a~0.base_4|) (+ (* main_~i~0_38 4) |main_~#a~0.offset_4|) main_~x~0_39) v_ArrVal_51_fresh_1) (= main_~i~0_55 (+ main_~i~0_38 1)) (= (store |#memory_int#2_38| |main_~#a~0.base_4| v_ArrVal_51_fresh_1) |#memory_int#2_55|) (= main_~x~0_39 v_ArrVal_54_fresh_1)) :named ssa_55))
(assert (! (<= ~N~0_1 main_~i~0_55) :named ssa_56))
(assert (! (= main_~i~0_57 0) :named ssa_57))
(assert (! (and (= (store |#memory_int#3_3| |main_~#c~0.base_4| v_ArrVal_56_fresh_1) |#memory_int#3_58|) (= main_~i~0_58 (+ main_~i~0_57 1)) (= (+ v_ArrVal_55_fresh_1 (select (select |#memory_int#1_55| |main_~#b~0.base_4|) (+ (* main_~i~0_57 4) |main_~#b~0.offset_4|))) (select (select |#memory_int#2_55| |main_~#a~0.base_4|) (+ (* main_~i~0_57 4) |main_~#a~0.offset_4|))) (= v_ArrVal_56_fresh_1 (store (select |#memory_int#3_3| |main_~#c~0.base_4|) (+ (* main_~i~0_57 4) |main_~#c~0.offset_4|) v_ArrVal_55_fresh_1)) (< main_~i~0_57 ~N~0_1)) :named ssa_58))
(assert (! (and (= main_~i~0_59 (+ main_~i~0_58 1)) (= (select (select |#memory_int#2_55| |main_~#a~0.base_4|) (+ (* main_~i~0_58 4) |main_~#a~0.offset_4|)) (+ v_ArrVal_57_fresh_1 (select (select |#memory_int#1_55| |main_~#b~0.base_4|) (+ (* main_~i~0_58 4) |main_~#b~0.offset_4|)))) (< main_~i~0_58 ~N~0_1) (= (store (select |#memory_int#3_58| |main_~#c~0.base_4|) (+ (* main_~i~0_58 4) |main_~#c~0.offset_4|) v_ArrVal_57_fresh_1) v_ArrVal_58_fresh_1) (= |#memory_int#3_59| (store |#memory_int#3_58| |main_~#c~0.base_4| v_ArrVal_58_fresh_1))) :named ssa_59))
(assert (! (and (= (+ v_ArrVal_59_fresh_1 (select (select |#memory_int#1_55| |main_~#b~0.base_4|) (+ (* main_~i~0_59 4) |main_~#b~0.offset_4|))) (select (select |#memory_int#2_55| |main_~#a~0.base_4|) (+ (* main_~i~0_59 4) |main_~#a~0.offset_4|))) (= main_~i~0_60 (+ main_~i~0_59 1)) (< main_~i~0_59 ~N~0_1) (= (store |#memory_int#3_59| |main_~#c~0.base_4| v_ArrVal_60_fresh_1) |#memory_int#3_60|) (= (store (select |#memory_int#3_59| |main_~#c~0.base_4|) (+ (* main_~i~0_59 4) |main_~#c~0.offset_4|) v_ArrVal_59_fresh_1) v_ArrVal_60_fresh_1)) :named ssa_60))
(assert (! (<= ~N~0_1 main_~i~0_60) :named ssa_61))
(assert (! (= main_~i~0_62 1) :named ssa_62))
(assert (! (and (< main_~i~0_62 ~N~0_1) (= |main_#t~mem10_63| (select (select |#memory_int#3_60| |main_~#c~0.base_4|) (+ (* main_~i~0_62 4) |main_~#c~0.offset_4|)))) :named ssa_63))
(assert (! true :named ssa_64_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_64| (ite (< 0 |main_#t~mem10_63|) 1 0)) :named ssa_64_LocVarAssigCall))
