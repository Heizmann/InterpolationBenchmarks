...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:09:33+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id string_concat-noarr.i_AllErrorsAtOnce_Iteration29)
...
(assert (! (or (<= 1000000 main_~i~0_61) (= |main_#t~nondet3_62| 0)) :named ssa_63))
(assert (! (< main_~j~0_61 100) :named ssa_64))
(assert (! true :named ssa_65_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_65| (ite (< main_~i~0_61 200) 1 0)) :named ssa_65_LocVarAssigCall))
