...
(set-info :ultimate-id mapsum3.i_AllErrorsAtOnce_Iteration14)
...
(declare-fun |mapsum_#in~x.base_15| () Int)
(declare-fun |mapsum_#in~x.offset_15| () Int)
(declare-fun |main_~#x~0.base_15| () Int)
(declare-fun mapsum_~x.base_16 () Int)
(declare-fun mapsum_~ret~0_16 () Int)
(declare-fun mapsum_~x.offset_16 () Int)
...
(assert (! (and (= (store |#length_3| |main_~#x~0.base_4| v_ArrVal_191_fresh_1) |#length_4|) (< |#StackHeapBarrier_-1| |main_~#x~0.base_4|) (= (store |#valid_3| |main_~#x~0.base_4| v_ArrVal_190_fresh_1) |#valid_4|) (= v_ArrVal_191_fresh_1 40000) (= v_ArrVal_190_fresh_1 1) (not (= |main_~#x~0.base_4| 0)) (= (select |#valid_3| |main_~#x~0.base_4|) 0) (= |main_~#x~0.offset_4| 0) (= main_~i~1_4 0)) :named ssa_4))
(assert (! (and (< main_~i~1_4 10000) (= v_ArrVal_192_fresh_1 (store (select |#memory_int#1_3| |main_~#x~0.base_4|) (+ (* main_~i~1_4 4) |main_~#x~0.offset_4|) |v_main_#t~nondet3_44_fresh_1|)) (<= |v_main_#t~nondet3_44_fresh_1| 2147483647) (<= 0 (+ |v_main_#t~nondet3_44_fresh_1| 2147483648)) (= v_ArrVal_193_fresh_1 |v_main_#t~nondet3_44_fresh_1|) (= |#memory_int#1_5| (store |#memory_int#1_3| |main_~#x~0.base_4| v_ArrVal_192_fresh_1)) (= main_~i~1_5 (+ main_~i~1_4 1))) :named ssa_5))
(assert (! (and (< main_~i~1_5 10000) (= v_ArrVal_195_fresh_1 |v_main_#t~nondet3_45_fresh_1|) (= |#memory_int#1_6| (store |#memory_int#1_5| |main_~#x~0.base_4| v_ArrVal_194_fresh_1)) (<= |v_main_#t~nondet3_45_fresh_1| 2147483647) (<= 0 (+ |v_main_#t~nondet3_45_fresh_1| 2147483648)) (= v_ArrVal_194_fresh_1 (store (select |#memory_int#1_5| |main_~#x~0.base_4|) (+ (* main_~i~1_5 4) |main_~#x~0.offset_4|) |v_main_#t~nondet3_45_fresh_1|)) (= main_~i~1_6 (+ main_~i~1_5 1))) :named ssa_6))
(assert (! (and (< main_~i~1_6 10000) (<= 0 (+ |v_main_#t~nondet3_46_fresh_1| 2147483648)) (= (store |#memory_int#1_6| |main_~#x~0.base_4| v_ArrVal_196_fresh_1) |#memory_int#1_7|) (<= |v_main_#t~nondet3_46_fresh_1| 2147483647) (= v_ArrVal_197_fresh_1 |v_main_#t~nondet3_46_fresh_1|) (= v_ArrVal_196_fresh_1 (store (select |#memory_int#1_6| |main_~#x~0.base_4|) (+ (* main_~i~1_6 4) |main_~#x~0.offset_4|) |v_main_#t~nondet3_46_fresh_1|)) (= main_~i~1_7 (+ main_~i~1_6 1))) :named ssa_7))
(assert (! (and (< main_~i~1_7 10000) (= v_ArrVal_199_fresh_1 (store (select |#memory_int#1_7| |main_~#x~0.base_4|) (+ (* main_~i~1_7 4) |main_~#x~0.offset_4|) v_ArrVal_198_fresh_1)) (= v_ArrVal_198_fresh_1 |v_main_#t~nondet3_47_fresh_1|) (<= |v_main_#t~nondet3_47_fresh_1| 2147483647) (<= 0 (+ |v_main_#t~nondet3_47_fresh_1| 2147483648)) (= |#memory_int#1_8| (store |#memory_int#1_7| |main_~#x~0.base_4| v_ArrVal_199_fresh_1)) (= main_~i~1_8 (+ main_~i~1_7 1))) :named ssa_8))
(assert (! (and (= v_ArrVal_201_fresh_1 (store (select |#memory_int#1_8| |main_~#x~0.base_4|) (+ (* main_~i~1_8 4) |main_~#x~0.offset_4|) v_ArrVal_200_fresh_1)) (< main_~i~1_8 10000) (= v_ArrVal_200_fresh_1 |v_main_#t~nondet3_48_fresh_1|) (<= |v_main_#t~nondet3_48_fresh_1| 2147483647) (<= 0 (+ |v_main_#t~nondet3_48_fresh_1| 2147483648)) (= (store |#memory_int#1_8| |main_~#x~0.base_4| v_ArrVal_201_fresh_1) |#memory_int#1_9|) (= main_~i~1_9 (+ main_~i~1_8 1))) :named ssa_9))
(assert (! (and (< main_~i~1_9 10000) (= v_ArrVal_203_fresh_1 |v_main_#t~nondet3_49_fresh_1|) (<= 0 (+ |v_main_#t~nondet3_49_fresh_1| 2147483648)) (= (store |#memory_int#1_9| |main_~#x~0.base_4| v_ArrVal_202_fresh_1) |#memory_int#1_10|) (<= |v_main_#t~nondet3_49_fresh_1| 2147483647) (= v_ArrVal_202_fresh_1 (store (select |#memory_int#1_9| |main_~#x~0.base_4|) (+ (* main_~i~1_9 4) |main_~#x~0.offset_4|) |v_main_#t~nondet3_49_fresh_1|)) (= main_~i~1_10 (+ main_~i~1_9 1))) :named ssa_10))
(assert (! (and (= v_ArrVal_205_fresh_1 (store (select |#memory_int#1_10| |main_~#x~0.base_4|) (+ (* main_~i~1_10 4) |main_~#x~0.offset_4|) v_ArrVal_204_fresh_1)) (< main_~i~1_10 10000) (= (store |#memory_int#1_10| |main_~#x~0.base_4| v_ArrVal_205_fresh_1) |#memory_int#1_11|) (<= 0 (+ |v_main_#t~nondet3_50_fresh_1| 2147483648)) (= v_ArrVal_204_fresh_1 |v_main_#t~nondet3_50_fresh_1|) (<= |v_main_#t~nondet3_50_fresh_1| 2147483647) (= main_~i~1_11 (+ main_~i~1_10 1))) :named ssa_11))
(assert (! (and (< main_~i~1_11 10000) (= (store |#memory_int#1_11| |main_~#x~0.base_4| v_ArrVal_207_fresh_1) |#memory_int#1_12|) (= v_ArrVal_206_fresh_1 |v_main_#t~nondet3_51_fresh_1|) (<= 0 (+ |v_main_#t~nondet3_51_fresh_1| 2147483648)) (<= |v_main_#t~nondet3_51_fresh_1| 2147483647) (= v_ArrVal_207_fresh_1 (store (select |#memory_int#1_11| |main_~#x~0.base_4|) (+ (* main_~i~1_11 4) |main_~#x~0.offset_4|) v_ArrVal_206_fresh_1)) (= main_~i~1_12 (+ main_~i~1_11 1))) :named ssa_12))
(assert (! (<= 10000 main_~i~1_12) :named ssa_13))
(assert (! true :named ssa_14))
(assert (! true :named ssa_15_GlobVarAssigCall))
(assert (! (and (= |main_~#x~0.base_4| |mapsum_#in~x.base_15|) (= |mapsum_#in~x.offset_15| |main_~#x~0.offset_4|)) :named ssa_15_LocVarAssigCall))
(assert (! true :named ssa_15_OldVarAssigCall))
(assert (! (and (= |mapsum_#in~x.offset_15| mapsum_~x.offset_16) (= mapsum_~ret~0_16 0) (= mapsum_~x.base_16 |mapsum_#in~x.base_15|) (= mapsum_~i~0_16 0)) :named ssa_16))
(assert (! (and (= mapsum_~ret~0_17 (+ mapsum_~ret~0_16 mapsum_~i~0_16 (select (select |#memory_int#1_12| mapsum_~x.base_16) (+ (* mapsum_~i~0_16 4) mapsum_~x.offset_16)))) (< mapsum_~i~0_16 10000) (= (+ mapsum_~i~0_16 1) mapsum_~i~0_17)) :named ssa_17))
(assert (! (and (= mapsum_~ret~0_18 (+ mapsum_~ret~0_17 mapsum_~i~0_17 (select (select |#memory_int#1_12| mapsum_~x.base_16) (+ (* mapsum_~i~0_17 4) mapsum_~x.offset_16)))) (< mapsum_~i~0_17 10000) (= (+ mapsum_~i~0_17 1) mapsum_~i~0_18)) :named ssa_18))
(assert (! (<= 10000 mapsum_~i~0_18) :named ssa_19))
...
(assert (! (= |main_#t~ret5_21| |mapsum_#res_20|) :named ssa_21_return))
(assert (! (and (= v_ArrVal_210_fresh_1 v_main_~temp~0_19_fresh_1) (= v_ArrVal_208_fresh_1 (store (store (select |#memory_int#1_12| |main_~#x~0.base_4|) |main_~#x~0.offset_4| (select (select |#memory_int#1_12| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4))) (+ |main_~#x~0.offset_4| 4) v_main_~temp~0_19_fresh_1)) (<= 0 (+ |main_#t~ret5_21| 2147483648)) (= |main_#t~ret5_21| main_~ret~1_22) (<= |main_#t~ret5_21| 2147483647) (= (store |#memory_int#1_12| |main_~#x~0.base_4| v_ArrVal_208_fresh_1) |#memory_int#1_22|) (= v_main_~temp~0_19_fresh_1 (select (select |#memory_int#1_12| |main_~#x~0.base_4|) |main_~#x~0.offset_4|)) (= v_ArrVal_209_fresh_1 (select (select |#memory_int#1_12| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4)))) :named ssa_22))
(assert (! true :named ssa_23_GlobVarAssigCall))
(assert (! (and (= |mapsum_#in~x.offset_23| |main_~#x~0.offset_4|) (= |main_~#x~0.base_4| |mapsum_#in~x.base_23|)) :named ssa_23_LocVarAssigCall))
...
(assert (! (and (= mapsum_~ret~0_25 (+ mapsum_~ret~0_24 mapsum_~i~0_24 (select (select |#memory_int#1_22| mapsum_~x.base_24) (+ (* mapsum_~i~0_24 4) mapsum_~x.offset_24)))) (< mapsum_~i~0_24 10000) (= (+ mapsum_~i~0_24 1) mapsum_~i~0_25)) :named ssa_25))
(assert (! (and (= mapsum_~ret~0_26 (+ mapsum_~ret~0_25 mapsum_~i~0_25 (select (select |#memory_int#1_22| mapsum_~x.base_24) (+ (* mapsum_~i~0_25 4) mapsum_~x.offset_24)))) (< mapsum_~i~0_25 10000) (= (+ mapsum_~i~0_25 1) mapsum_~i~0_26)) :named ssa_26))
...
(assert (! (= |main_#t~ret8_29| |mapsum_#res_28|) :named ssa_29_return))
(assert (! (and (= (select (select |#memory_int#1_22| |main_~#x~0.base_4|) |main_~#x~0.offset_4|) main_~temp~0_30) (<= |main_#t~ret8_29| 2147483647) (= main_~ret2~0_30 |main_#t~ret8_29|) (<= 0 (+ |main_#t~ret8_29| 2147483648)) (= main_~i~2_30 0)) :named ssa_30))
(assert (! (and (= v_ArrVal_212_fresh_1 (store (select |#memory_int#1_22| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| (* main_~i~2_30 4)) v_ArrVal_211_fresh_1)) (= |#memory_int#1_31| (store |#memory_int#1_22| |main_~#x~0.base_4| v_ArrVal_212_fresh_1)) (= main_~i~2_31 (+ main_~i~2_30 1)) (< main_~i~2_30 9999) (= v_ArrVal_211_fresh_1 (select (select |#memory_int#1_22| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4 (* main_~i~2_30 4))))) :named ssa_31))
(assert (! (and (= v_ArrVal_214_fresh_1 (store (select |#memory_int#1_31| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| (* main_~i~2_31 4)) v_ArrVal_213_fresh_1)) (= (store |#memory_int#1_31| |main_~#x~0.base_4| v_ArrVal_214_fresh_1) |#memory_int#1_32|) (= main_~i~2_32 (+ main_~i~2_31 1)) (= v_ArrVal_213_fresh_1 (select (select |#memory_int#1_31| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4 (* main_~i~2_31 4)))) (< main_~i~2_31 9999)) :named ssa_32))
(assert (! (<= 9999 main_~i~2_32) :named ssa_33))
(assert (! (and (= v_ArrVal_216_fresh_1 (store (select |#memory_int#1_32| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 39996) v_ArrVal_215_fresh_1)) (= v_ArrVal_215_fresh_1 main_~temp~0_30) (= (store |#memory_int#1_32| |main_~#x~0.base_4| v_ArrVal_216_fresh_1) |#memory_int#1_34|)) :named ssa_34))
...
(assert (! (= |main_#t~ret12_41| |mapsum_#res_40|) :named ssa_41_return))
