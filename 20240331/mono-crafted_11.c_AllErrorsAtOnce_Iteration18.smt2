...
(set-info :ultimate-id mono-crafted_11.c_AllErrorsAtOnce_Iteration18)
...
(assert (! (<= 100000000 (mod main_~x~0_36 4294967296)) :named ssa_37))
(assert (! true :named ssa_38_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_38| (ite (= (mod main_~x~0_36 2) 0) 1 0)) :named ssa_38_LocVarAssigCall))
