...
(set-info :ultimate-id gsv2008.c.i.p+cfa-reducer.c_AllErrorsAtOnce_Iteration3)
...
(declare-fun v_main_~main____CPAchecker_TMP_0~0_4_fresh_1 () Int)
(declare-fun main_~main__x~0_8 () Int)
(declare-fun main_~main__y~0_8 () Int)
(declare-fun v_main_~main____CPAchecker_TMP_0~0_5_fresh_1 () Int)
(declare-fun main_~__VERIFIER_assert__cond~0_9 () Int)
...
(assert (! (and (= (+ main_~main__y~0_4 1) main_~main__y~0_7) (< main_~main__x~0_4 0) (= (+ main_~main__x~0_4 main_~main__y~0_4) main_~main__x~0_7) (= v_main_~main____CPAchecker_TMP_0~0_4_fresh_1 main_~main__y~0_4)) :named ssa_7))
(assert (! (and (= v_main_~main____CPAchecker_TMP_0~0_5_fresh_1 main_~main__y~0_7) (= (+ main_~main__y~0_7 1) main_~main__y~0_8) (< main_~main__x~0_7 0) (= (+ main_~main__x~0_7 main_~main__y~0_7) main_~main__x~0_8)) :named ssa_8))
(assert (! (and (= v_main_~__tmp_1~0_6_fresh_1 main_~__VERIFIER_assert__cond~0_9) (<= 0 main_~main__x~0_8) (= (ite (< 0 main_~main__y~0_8) 1 0) v_main_~__tmp_1~0_6_fresh_1)) :named ssa_9))
(assert (! (= main_~__VERIFIER_assert__cond~0_9 0) :named ssa_10))
