...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-30T23:53:01+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id pr5.c_AllErrorsAtOnce_Iteration17)
...
(declare-fun |v_main_#t~mem6_37_fresh_1| () Int)
...
(declare-fun |v_main_#t~mem6_38_fresh_1| () Int)
...
(declare-fun |v_main_#t~mem6_39_fresh_1| () Int)
(declare-fun |main_#t~short8_46| () Bool)
(declare-fun |v_main_#t~mem7_20_fresh_1| () Int)
...
(assert (! (and (= 2 main_~CCCELVOL5~0_5) (= |main_~#volArray~0.offset_5| 0) (< |#StackHeapBarrier_-1| |main_~#volArray~0.base_5|) (= 7 main_~CCCELVOL3~0_5) (= (select |#valid_3| |main_~#volArray~0.base_5|) 0) (= 5 main_~CCCELVOL4~0_5) (= v_ArrVal_164_fresh_1 (* (mod ~CELLCOUNT~0_4 1073741824) 4)) (< 1 ~CELLCOUNT~0_4) (= |#length_5| (store |#length_3| |main_~#volArray~0.base_5| v_ArrVal_164_fresh_1)) (= v_ArrVal_163_fresh_1 1) (= 3 main_~CCCELVOL2~0_5) (= |#valid_5| (store |#valid_3| |main_~#volArray~0.base_5| v_ArrVal_163_fresh_1)) (= main_~CCCELVOL1~0_5 1) (not (= |main_~#volArray~0.base_5| 0))) :named ssa_5))
...
(assert (! (and (= (store |#memory_int#1_3| |main_~#volArray~0.base_5| v_ArrVal_165_fresh_1) |#memory_int#1_14|) (< main_~CCCELVOL5~0_5 main_~MINVAL~0_5) (= v_ArrVal_165_fresh_1 (store (select |#memory_int#1_3| |main_~#volArray~0.base_5|) (+ (- 20) |main_~#volArray~0.offset_5| (* main_~i~0_12 20)) 0)) (= v_ArrVal_166_fresh_1 0)) :named ssa_14))
(assert (! (and (= v_ArrVal_167_fresh_1 (store (select |#memory_int#1_14| |main_~#volArray~0.base_5|) (+ (* main_~i~0_12 20) |main_~#volArray~0.offset_5| (- 16)) main_~CCCELVOL4~0_5)) (= (store |#memory_int#1_14| |main_~#volArray~0.base_5| v_ArrVal_167_fresh_1) |#memory_int#1_15|) (= v_ArrVal_168_fresh_1 main_~CCCELVOL4~0_5) (<= main_~MINVAL~0_5 main_~CCCELVOL4~0_5)) :named ssa_15))
(assert (! (and (= (store |#memory_int#1_15| |main_~#volArray~0.base_5| v_ArrVal_170_fresh_1) |#memory_int#1_16|) (<= main_~MINVAL~0_5 main_~CCCELVOL3~0_5) (= v_ArrVal_170_fresh_1 (store (select |#memory_int#1_15| |main_~#volArray~0.base_5|) (+ (* main_~i~0_12 20) |main_~#volArray~0.offset_5| (- 12)) v_ArrVal_169_fresh_1)) (= v_ArrVal_169_fresh_1 main_~CCCELVOL3~0_5)) :named ssa_16))
(assert (! (and (<= main_~MINVAL~0_5 main_~CCCELVOL2~0_5) (= v_ArrVal_171_fresh_1 (store (select |#memory_int#1_16| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_12 20) (- 8)) main_~CCCELVOL2~0_5)) (= (store |#memory_int#1_16| |main_~#volArray~0.base_5| v_ArrVal_171_fresh_1) |#memory_int#1_17|) (= v_ArrVal_172_fresh_1 main_~CCCELVOL2~0_5)) :named ssa_17))
(assert (! (and (= v_ArrVal_174_fresh_1 (store (select |#memory_int#1_17| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_12 20) (- 4)) v_ArrVal_173_fresh_1)) (= (store |#memory_int#1_17| |main_~#volArray~0.base_5| v_ArrVal_174_fresh_1) |#memory_int#1_18|) (< main_~CCCELVOL1~0_5 main_~MINVAL~0_5) (= v_ArrVal_173_fresh_1 0)) :named ssa_18))
...
(assert (! (and (< main_~CCCELVOL5~0_5 main_~MINVAL~0_5) (= (store |#memory_int#1_18| |main_~#volArray~0.base_5| v_ArrVal_175_fresh_1) |#memory_int#1_21|) (= v_ArrVal_175_fresh_1 (store (select |#memory_int#1_18| |main_~#volArray~0.base_5|) (+ (- 20) |main_~#volArray~0.offset_5| (* main_~i~0_19 20)) 0)) (= v_ArrVal_176_fresh_1 0)) :named ssa_21))
(assert (! (and (= v_ArrVal_178_fresh_1 main_~CCCELVOL4~0_5) (= (store |#memory_int#1_21| |main_~#volArray~0.base_5| v_ArrVal_177_fresh_1) |#memory_int#1_22|) (= v_ArrVal_177_fresh_1 (store (select |#memory_int#1_21| |main_~#volArray~0.base_5|) (+ (* main_~i~0_19 20) |main_~#volArray~0.offset_5| (- 16)) main_~CCCELVOL4~0_5)) (<= main_~MINVAL~0_5 main_~CCCELVOL4~0_5)) :named ssa_22))
(assert (! (and (= v_ArrVal_180_fresh_1 (store (select |#memory_int#1_22| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_19 20) (- 12)) v_ArrVal_179_fresh_1)) (< main_~CCCELVOL3~0_5 main_~MINVAL~0_5) (= (store |#memory_int#1_22| |main_~#volArray~0.base_5| v_ArrVal_180_fresh_1) |#memory_int#1_23|) (= v_ArrVal_179_fresh_1 0)) :named ssa_23))
(assert (! (and (= |#memory_int#1_24| (store |#memory_int#1_23| |main_~#volArray~0.base_5| v_ArrVal_181_fresh_1)) (<= main_~MINVAL~0_5 main_~CCCELVOL2~0_5) (= v_ArrVal_181_fresh_1 (store (select |#memory_int#1_23| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_19 20) (- 8)) main_~CCCELVOL2~0_5)) (= v_ArrVal_182_fresh_1 main_~CCCELVOL2~0_5)) :named ssa_24))
(assert (! (and (= v_ArrVal_183_fresh_1 0) (= v_ArrVal_184_fresh_1 (store (select |#memory_int#1_24| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_19 20) (- 4)) v_ArrVal_183_fresh_1)) (< main_~CCCELVOL1~0_5 main_~MINVAL~0_5) (= |#memory_int#1_25| (store |#memory_int#1_24| |main_~#volArray~0.base_5| v_ArrVal_184_fresh_1))) :named ssa_25))
...
(assert (! (and (or (and (not |main_#t~short8_29|) (< |v_main_#t~mem6_37_fresh_1| main_~MINVAL~0_5)) (and |main_#t~short8_29| (<= main_~MINVAL~0_5 |v_main_#t~mem6_37_fresh_1|))) (< main_~i~0_28 ~CELLCOUNT~0_4) (= (select (select |#memory_int#1_25| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_28 4))) |v_main_#t~mem6_37_fresh_1|)) :named ssa_29))
...
(assert (! (and (or (and (< |v_main_#t~mem6_38_fresh_1| main_~MINVAL~0_5) (not |main_#t~short8_37|)) (and |main_#t~short8_37| (<= main_~MINVAL~0_5 |v_main_#t~mem6_38_fresh_1|))) (< main_~i~0_36 ~CELLCOUNT~0_4) (= (select (select |#memory_int#1_25| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_36 4))) |v_main_#t~mem6_38_fresh_1|)) :named ssa_37))
...
(assert (! (and (= (select (select |#memory_int#1_25| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_44 4))) |v_main_#t~mem6_39_fresh_1|) (< main_~i~0_44 ~CELLCOUNT~0_4) (or (and (< |v_main_#t~mem6_39_fresh_1| main_~MINVAL~0_5) (not |main_#t~short8_45|)) (and |main_#t~short8_45| (<= main_~MINVAL~0_5 |v_main_#t~mem6_39_fresh_1|)))) :named ssa_45))
(assert (! (and (or (and |main_#t~short8_46| (= |v_main_#t~mem7_20_fresh_1| 0)) (and (not (= |v_main_#t~mem7_20_fresh_1| 0)) (not |main_#t~short8_46|))) (= |v_main_#t~mem7_20_fresh_1| (select (select |#memory_int#1_25| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_44 4)))) (not |main_#t~short8_45|)) :named ssa_46))
(assert (! true :named ssa_47_GlobVarAssigCall))
(assert (! (= (ite |main_#t~short8_46| 1 0) |__VERIFIER_assert_#in~cond_47|) :named ssa_47_LocVarAssigCall))
