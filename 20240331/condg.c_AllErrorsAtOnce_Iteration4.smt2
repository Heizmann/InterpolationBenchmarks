...
(set-info :ultimate-id condg.c_AllErrorsAtOnce_Iteration4)
...
(assert (! (and (< |#StackHeapBarrier_-1| |main_~#sum~0.base_11|) (= (select |#valid_3| |main_~#sum~0.base_11|) 0) (not (= |main_~#sum~0.base_11| 0)) (< main_~a~0.base_11 |#StackHeapBarrier_-1|) (= main_~i~0_11 0) (= |#valid_11| (store (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_30_fresh_1) main_~a~0.base_11 v_ArrVal_26_fresh_1)) (= v_ArrVal_26_fresh_1 1) (= (store (store |#length_3| |main_~#sum~0.base_11| v_ArrVal_27_fresh_1) main_~a~0.base_11 v_ArrVal_29_fresh_1) |#length_11|) (= v_ArrVal_28_fresh_1 0) (= (select (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_30_fresh_1) main_~a~0.base_11) 0) (= v_ArrVal_30_fresh_1 1) (= |main_~#sum~0.offset_11| 0) (= main_~a~0.offset_11 0) (not (= main_~a~0.base_11 0)) (= 4 v_ArrVal_27_fresh_1) (= (store |#memory_int#1_3| |main_~#sum~0.base_11| v_ArrVal_25_fresh_1) |#memory_int#1_11|) (= (* (mod ~N~0_4 1073741824) 4) v_ArrVal_29_fresh_1) (= v_ArrVal_25_fresh_1 (store (select |#memory_int#1_3| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| 0))) :named ssa_11))
(assert (! (and (= |#memory_int#3_12| (store |#memory_int#3_3| main_~a~0.base_11 v_ArrVal_31_fresh_1)) (= main_~i~0_12 (+ main_~i~0_11 1)) (= v_ArrVal_32_fresh_1 1) (= (store (select |#memory_int#3_3| main_~a~0.base_11) (+ (* main_~i~0_11 4) main_~a~0.offset_11) 1) v_ArrVal_31_fresh_1) (< main_~i~0_11 ~N~0_4)) :named ssa_12))
(assert (! (<= ~N~0_4 main_~i~0_12) :named ssa_13))
(assert (! (= main_~i~0_14 0) :named ssa_14))
(assert (! (and (= (+ (select (select |#memory_int#3_12| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_14 4))) (select (select |#memory_int#1_11| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|)) v_ArrVal_34_fresh_1) (= (store (select |#memory_int#1_11| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| (+ (select (select |#memory_int#3_12| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_14 4))) (select (select |#memory_int#1_11| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|))) v_ArrVal_33_fresh_1) (= |#memory_int#1_15| (store |#memory_int#1_11| |main_~#sum~0.base_11| v_ArrVal_33_fresh_1)) (< main_~i~0_14 ~N~0_4) (= main_~i~0_15 (+ main_~i~0_14 1))) :named ssa_15))
...
(assert (! (and (= (store |#memory_int#3_12| main_~a~0.base_11 v_ArrVal_36_fresh_1) |#memory_int#3_19|) (= (store (select |#memory_int#3_12| main_~a~0.base_11) (+ (* main_~i~0_17 4) main_~a~0.offset_11) v_ArrVal_35_fresh_1) v_ArrVal_36_fresh_1) (= (+ v_ArrVal_35_fresh_1 1) (select (select |#memory_int#3_12| main_~a~0.base_11) (+ (* main_~i~0_17 4) main_~a~0.offset_11))) (= |main_#t~mem10_18| ~N~0_4)) :named ssa_19))
