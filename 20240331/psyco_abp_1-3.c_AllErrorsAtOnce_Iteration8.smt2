...
(set-info :ultimate-id psyco_abp_1-3.c_AllErrorsAtOnce_Iteration8)
...
(declare-fun v_main_~P7~0_19_fresh_1 () Int)
(declare-fun v_main_~P2~0_19_fresh_1 () Int)
(declare-fun v_main_~P5~0_19_fresh_1 () Int)
(declare-fun |main_#t~nondet13_7| () Int)
(declare-fun |main_#t~nondet13_8| () Int)
(declare-fun v_main_~method_id~0_79_fresh_1 () Int)
...
(declare-fun v_main_~P5~0_20_fresh_1 () Int)
(declare-fun v_main_~P2~0_20_fresh_1 () Int)
(declare-fun v_main_~P7~0_20_fresh_1 () Int)
(declare-fun |main_#t~nondet14_13| () Int)
(declare-fun |main_#t~nondet14_14| () Int)
(declare-fun v_main_~method_id~0_80_fresh_1 () Int)
...
(declare-fun v_main_~P5~0_21_fresh_1 () Int)
(declare-fun v_main_~P7~0_21_fresh_1 () Int)
(declare-fun v_main_~P2~0_21_fresh_1 () Int)
...
(declare-fun |main_#t~nondet28_23| () Int)
(declare-fun |main_#t~nondet29_24| () Int)
(declare-fun |main_#t~nondet28_24| () Int)
(declare-fun |main_#t~nondet29_25| () Int)
(declare-fun |main_#t~nondet30_25| () Int)
(declare-fun |main_#t~nondet30_26| () Int)
(declare-fun main_~P1~0_27 () Int)
(declare-fun v_main_~method_id~0_81_fresh_1 () Int)
(declare-fun main_~this_expect~0_28 () Int)
(declare-fun main_~this_buffer_empty~0_28 () Int)
(declare-fun main_~P8~0_28 () Int)
...
(assert (! (and (<= main_~P4~0_6 2147483647) (<= 0 (+ v_main_~P5~0_19_fresh_1 2147483648)) (<= v_main_~P2~0_19_fresh_1 2147483647) (<= 0 (+ main_~P1~0_6 2147483648)) (<= v_main_~P5~0_19_fresh_1 2147483647) (<= main_~P3~0_6 2147483647) (<= main_~P8~0_6 2147483647) (<= 0 (+ main_~P8~0_6 2147483648)) (<= 0 (+ main_~P6~0_6 2147483648)) (<= 0 (+ main_~P3~0_6 2147483648)) (<= 0 (+ main_~P9~0_6 2147483648)) (<= v_main_~P7~0_19_fresh_1 2147483647) (<= 0 (+ v_main_~P7~0_19_fresh_1 2147483648)) (<= main_~P9~0_6 2147483647) (<= 0 (+ main_~P4~0_6 2147483648)) (<= main_~P1~0_6 2147483647) (<= 0 (+ v_main_~P2~0_19_fresh_1 2147483648)) (<= main_~P6~0_6 2147483647)) :named ssa_6))
...
(assert (! (= 1 v_main_~method_id~0_79_fresh_1) :named ssa_9))
(assert (! (and (= main_~this_buffer_empty~0_10 1) (= main_~q~0_10 1) (= main_~this_expect~0_10 0)) :named ssa_10))
(assert (! (and (<= main_~P4~0_11 2147483647) (<= 0 (+ v_main_~P7~0_20_fresh_1 2147483648)) (<= v_main_~P2~0_20_fresh_1 2147483647) (<= 0 (+ v_main_~P2~0_20_fresh_1 2147483648)) (<= 0 (+ main_~P1~0_11 2147483648)) (<= 0 (+ v_main_~P5~0_20_fresh_1 2147483648)) (<= main_~P3~0_11 2147483647) (<= main_~P8~0_11 2147483647) (<= 0 (+ main_~P8~0_11 2147483648)) (<= 0 (+ main_~P6~0_11 2147483648)) (<= 0 (+ main_~P3~0_11 2147483648)) (<= 0 (+ main_~P9~0_11 2147483648)) (<= v_main_~P5~0_20_fresh_1 2147483647) (<= main_~P9~0_11 2147483647) (<= v_main_~P7~0_20_fresh_1 2147483647) (<= 0 (+ main_~P4~0_11 2147483648)) (<= main_~P1~0_11 2147483647) (<= main_~P6~0_11 2147483647)) :named ssa_11))
...
(assert (! (and (= (ite (and (< main_~P1~0_11 0) (not (= (mod main_~P1~0_11 2) 0))) (+ (- 2) (mod main_~P1~0_11 2)) (mod main_~P1~0_11 2)) 0) (= 2 v_main_~method_id~0_80_fresh_1)) :named ssa_15))
...
(assert (! (and (<= main_~P4~0_17 2147483647) (<= v_main_~P5~0_21_fresh_1 2147483647) (<= 0 (+ main_~P1~0_17 2147483648)) (<= 0 (+ v_main_~P7~0_21_fresh_1 2147483648)) (<= main_~P3~0_17 2147483647) (<= main_~P8~0_17 2147483647) (<= 0 (+ main_~P8~0_17 2147483648)) (<= 0 (+ main_~P6~0_17 2147483648)) (<= v_main_~P2~0_21_fresh_1 2147483647) (<= 0 (+ main_~P3~0_17 2147483648)) (<= 0 (+ main_~P9~0_17 2147483648)) (<= 0 (+ v_main_~P5~0_21_fresh_1 2147483648)) (<= v_main_~P7~0_21_fresh_1 2147483647) (<= 0 (+ v_main_~P2~0_21_fresh_1 2147483648)) (<= main_~P9~0_17 2147483647) (<= 0 (+ main_~P4~0_17 2147483648)) (<= main_~P1~0_17 2147483647) (<= main_~P6~0_17 2147483647)) :named ssa_17))
...
(assert (! (and (<= 0 (+ |main_#t~nondet28_23| 2147483648)) (<= |main_#t~nondet28_23| 2147483647) (= |main_#t~nondet27_22| 0)) :named ssa_23))
(assert (! (and (= |main_#t~nondet28_23| 0) (<= 0 (+ |main_#t~nondet29_24| 2147483648)) (<= |main_#t~nondet29_24| 2147483647)) :named ssa_24))
(assert (! (and (= |main_#t~nondet29_24| 0) (<= 0 (+ |main_#t~nondet30_25| 2147483648)) (<= |main_#t~nondet30_25| 2147483647)) :named ssa_25))
(assert (! (not (= |main_#t~nondet30_25| 0)) :named ssa_26))
(assert (! (and (= 6 v_main_~method_id~0_81_fresh_1) (not (= main_~P1~0_17 0)) (not (= main_~P1~0_17 1))) :named ssa_27))
(assert (! (and (not (= (mod main_~this_buffer_empty~0_16 4294967296) 1)) (not (= main_~P8~0_17 1)) (= (mod main_~P8~0_17 4294967296) (mod (+ 1 main_~this_expect~0_16) 2)) (not (= main_~P8~0_17 0))) :named ssa_28))
