...
(set-info :ultimate-id standard_copyInit_ground.i_AllErrorsAtOnce_Iteration2)
...
(assert (! (and (= (store (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_6_fresh_1) |main_~#b~0.base_4| v_ArrVal_8_fresh_1) |#valid_4|) (= v_ArrVal_8_fresh_1 1) (= main_~i~0_4 0) (< |#StackHeapBarrier_-1| |main_~#a~0.base_4|) (= (store (store |#length_3| |main_~#a~0.base_4| v_ArrVal_7_fresh_1) |main_~#b~0.base_4| v_ArrVal_5_fresh_1) |#length_4|) (= |main_~#b~0.offset_4| 0) (not (= |main_~#a~0.base_4| 0)) (not (= |main_~#b~0.base_4| 0)) (= 400000 v_ArrVal_5_fresh_1) (= |main_~#a~0.offset_4| 0) (= 400000 v_ArrVal_7_fresh_1) (= (select (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_6_fresh_1) |main_~#b~0.base_4|) 0) (< |#StackHeapBarrier_-1| |main_~#b~0.base_4|) (= (select |#valid_3| |main_~#a~0.base_4|) 0) (= v_ArrVal_6_fresh_1 1)) :named ssa_4))
