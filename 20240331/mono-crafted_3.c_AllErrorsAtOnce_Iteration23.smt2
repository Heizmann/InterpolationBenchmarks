...
(set-info :ultimate-id mono-crafted_3.c_AllErrorsAtOnce_Iteration23)
...
(declare-fun |v_main_#t~post4_41_fresh_1| () Int)
(declare-fun main_~x~0_8 () Int)
(declare-fun |v_main_#t~post4_42_fresh_1| () Int)
...
(assert (! (and (< main_~x~0_4 500000) (= main_~x~0_6 (+ |v_main_#t~post4_41_fresh_1| 1)) (= main_~x~0_4 |v_main_#t~post4_41_fresh_1|)) :named ssa_6))
(assert (! (< main_~x~0_6 1000000) :named ssa_7))
(assert (! (and (= main_~x~0_6 |v_main_#t~post4_42_fresh_1|) (< main_~x~0_6 500000) (= main_~x~0_8 (+ |v_main_#t~post4_42_fresh_1| 1))) :named ssa_8))
...
(assert (! (<= main_~y~0_28 0) :named ssa_29))
(assert (! true :named ssa_30_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_30| (ite (= main_~x~0_28 main_~z~0_28) 1 0)) :named ssa_30_LocVarAssigCall))
