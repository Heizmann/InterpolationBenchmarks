...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:08:59+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id simple_2-1_abstracted.c_AllErrorsAtOnce_Iteration2)
...
(assert (! (and (< 0 |#StackHeapBarrier_-1|) (= 12 (select |#length_-1| 3)) (= (select |#valid_-1| 3) 1) (= (select |#valid_-1| 2) 1) (= (select |#length_-1| 2) 24) (= (select |#valid_-1| 1) 1) (= (select (select |#memory_int#0_-1| 1) 1) 0) (= (select |#length_-1| 1) 2) (= (select (select |#memory_int#0_-1| 1) 0) 48) (= (select |#valid_-1| 0) 0)) :named ssa_1))
(assert (! true :named ssa_2_return))
(assert (! true :named ssa_3_GlobVarAssigCall))
(assert (! true :named ssa_3_LocVarAssigCall))
(assert (! true :named ssa_3_OldVarAssigCall))
(assert (! true :named ssa_4))
(assert (! (< (mod main_~x~0_4 4294967296) 268435455) :named ssa_5))
(assert (! (<= 268435455 (mod main_~x~0_5 4294967296)) :named ssa_6))
(assert (! true :named ssa_7_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_7| (ite (<= 268435455 (mod main_~x~0_5 4294967296)) 1 0)) :named ssa_7_LocVarAssigCall))
...
(assert (! (and (< 0 |#StackHeapBarrier_-1|) (= 12 (select |#length_-1| 3)) (= (select |#valid_-1| 3) 1) (= (select |#valid_-1| 2) 1) (= (select |#length_-1| 2) 24) (= (select |#valid_-1| 1) 1) (= (select (select |#memory_int#0_-1| 1) 1) 0) (= (select |#length_-1| 1) 2) (= (select (select |#memory_int#0_-1| 1) 0) 48) (= (select |#valid_-1| 0) 0)) :named ssa_0))
