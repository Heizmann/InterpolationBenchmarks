...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-30T23:52:48+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id nr4.c_AllErrorsAtOnce_Iteration12)
...
(assert (! (and (= (store |#valid_3| |main_~#volArray~0.base_5| v_ArrVal_64_fresh_1) |#valid_5|) (< |#StackHeapBarrier_-1| |main_~#volArray~0.base_5|) (= |main_~#volArray~0.offset_5| 0) (not (= |main_~#volArray~0.base_5| 0)) (= (* (mod ~CELLCOUNT~0_4 1073741824) 4) v_ArrVal_63_fresh_1) (= v_ArrVal_64_fresh_1 1) (= 0 (select |#valid_3| |main_~#volArray~0.base_5|)) (= main_~MINVAL~0_5 2) (< 1 ~CELLCOUNT~0_4) (= |#length_5| (store |#length_3| |main_~#volArray~0.base_5| v_ArrVal_63_fresh_1))) :named ssa_5))
...
(assert (! (and (= (store (select |#memory_int#1_3| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~j~0_13 (- 4)) (* main_~i~0_12 16)) main_~j~0_13) v_ArrVal_65_fresh_1) (<= main_~MINVAL~0_5 main_~j~0_13) (= (store |#memory_int#1_3| |main_~#volArray~0.base_5| v_ArrVal_65_fresh_1) |#memory_int#1_15|) (= main_~j~0_13 v_ArrVal_66_fresh_1)) :named ssa_15))
(assert (! (= main_~j~0_13 (+ main_~j~0_16 1)) :named ssa_16))
(assert (! (<= 1 main_~j~0_16) :named ssa_17))
(assert (! (and (= (store |#memory_int#1_15| |main_~#volArray~0.base_5| v_ArrVal_67_fresh_1) |#memory_int#1_18|) (= main_~j~0_16 v_ArrVal_68_fresh_1) (<= main_~MINVAL~0_5 main_~j~0_16) (= (store (select |#memory_int#1_15| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~j~0_16 (- 4)) (* main_~i~0_12 16)) main_~j~0_16) v_ArrVal_67_fresh_1)) :named ssa_18))
(assert (! (= main_~j~0_16 (+ main_~j~0_19 1)) :named ssa_19))
(assert (! (<= 1 main_~j~0_19) :named ssa_20))
(assert (! (and (= (store |#memory_int#1_18| |main_~#volArray~0.base_5| v_ArrVal_69_fresh_1) |#memory_int#1_21|) (= main_~j~0_19 v_ArrVal_70_fresh_1) (= (store (select |#memory_int#1_18| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~j~0_19 (- 4)) (* main_~i~0_12 16)) main_~j~0_19) v_ArrVal_69_fresh_1) (<= main_~MINVAL~0_5 main_~j~0_19)) :named ssa_21))
(assert (! (= main_~j~0_19 (+ main_~j~0_22 1)) :named ssa_22))
(assert (! (<= 1 main_~j~0_22) :named ssa_23))
(assert (! (and (< main_~j~0_22 main_~MINVAL~0_5) (= (store |#memory_int#1_21| |main_~#volArray~0.base_5| v_ArrVal_72_fresh_1) |#memory_int#1_24|) (= (store (select |#memory_int#1_21| |main_~#volArray~0.base_5|) (+ (* main_~i~0_12 16) |main_~#volArray~0.offset_5| (* main_~j~0_22 (- 4))) v_ArrVal_71_fresh_1) v_ArrVal_72_fresh_1) (= v_ArrVal_71_fresh_1 0)) :named ssa_24))
...
(assert (! (and (= main_~j~0_28 v_ArrVal_74_fresh_1) (= (store |#memory_int#1_24| |main_~#volArray~0.base_5| v_ArrVal_73_fresh_1) |#memory_int#1_30|) (<= main_~MINVAL~0_5 main_~j~0_28) (= (store (select |#memory_int#1_24| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~j~0_28 (- 4)) (* main_~i~0_27 16)) main_~j~0_28) v_ArrVal_73_fresh_1)) :named ssa_30))
(assert (! (= main_~j~0_28 (+ main_~j~0_31 1)) :named ssa_31))
(assert (! (<= 1 main_~j~0_31) :named ssa_32))
(assert (! (and (= (store (select |#memory_int#1_30| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~j~0_31 (- 4)) (* main_~i~0_27 16)) main_~j~0_31) v_ArrVal_75_fresh_1) (= main_~j~0_31 v_ArrVal_76_fresh_1) (<= main_~MINVAL~0_5 main_~j~0_31) (= |#memory_int#1_33| (store |#memory_int#1_30| |main_~#volArray~0.base_5| v_ArrVal_75_fresh_1))) :named ssa_33))
(assert (! (= main_~j~0_31 (+ main_~j~0_34 1)) :named ssa_34))
(assert (! (<= 1 main_~j~0_34) :named ssa_35))
(assert (! (and (= main_~j~0_34 v_ArrVal_78_fresh_1) (= (store |#memory_int#1_33| |main_~#volArray~0.base_5| v_ArrVal_77_fresh_1) |#memory_int#1_36|) (<= main_~MINVAL~0_5 main_~j~0_34) (= (store (select |#memory_int#1_33| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~j~0_34 (- 4)) (* main_~i~0_27 16)) main_~j~0_34) v_ArrVal_77_fresh_1)) :named ssa_36))
(assert (! (= main_~j~0_34 (+ main_~j~0_37 1)) :named ssa_37))
(assert (! (<= 1 main_~j~0_37) :named ssa_38))
(assert (! (and (< main_~j~0_37 main_~MINVAL~0_5) (= v_ArrVal_79_fresh_1 0) (= v_ArrVal_80_fresh_1 (store (select |#memory_int#1_36| |main_~#volArray~0.base_5|) (+ (* main_~i~0_27 16) |main_~#volArray~0.offset_5| (* main_~j~0_37 (- 4))) v_ArrVal_79_fresh_1)) (= (store |#memory_int#1_36| |main_~#volArray~0.base_5| v_ArrVal_80_fresh_1) |#memory_int#1_39|)) :named ssa_39))
...
(assert (! (and (= (select (select |#memory_int#1_39| |main_~#volArray~0.base_5|) (+ (* main_~i~0_44 4) |main_~#volArray~0.offset_5|)) |v_main_#t~mem7_20_fresh_1|) (< main_~i~0_44 ~CELLCOUNT~0_4) (or (and (< |v_main_#t~mem7_20_fresh_1| main_~MINVAL~0_5) (not |main_#t~short9_45|)) (and |main_#t~short9_45| (<= main_~MINVAL~0_5 |v_main_#t~mem7_20_fresh_1|)))) :named ssa_45))
(assert (! (and (= |v_main_#t~mem8_15_fresh_1| (select (select |#memory_int#1_39| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_44 4)))) (not |main_#t~short9_45|) (or (and (not (= |v_main_#t~mem8_15_fresh_1| 0)) (not |main_#t~short9_46|)) (and |main_#t~short9_46| (= |v_main_#t~mem8_15_fresh_1| 0)))) :named ssa_46))
(assert (! true :named ssa_47_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_47| (ite |main_#t~short9_46| 1 0)) :named ssa_47_LocVarAssigCall))
