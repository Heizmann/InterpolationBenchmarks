...
(set-info :ultimate-id trex03-2_abstracted.c_AllErrorsAtOnce_Iteration1)
...
(declare-fun v_main_~d3~0_3_fresh_1 () Int)
(declare-fun v_main_~d1~0_3_fresh_1 () Int)
(declare-fun v_main_~d2~0_3_fresh_1 () Int)
(declare-fun |main_#t~bitwise9_5| () Int)
(declare-fun |main_#t~bitwise9_6| () Int)
(declare-fun |main_#t~bitwise10_6| () Int)
(declare-fun main_~c1~0_7 () Int)
(declare-fun |main_#t~nondet15_7| () Int)
(declare-fun |main_#t~bitwise9_7| () Int)
(declare-fun |main_#t~nondet14_7| () Int)
(declare-fun |main_#t~nondet13_7| () Int)
(declare-fun |main_#t~bitwise10_7| () Int)
(declare-fun main_~x2~0_7 () Int)
(declare-fun main_~x1~0_7 () Int)
(declare-fun |main_#t~nondet12_7| () Int)
(declare-fun main_~c2~0_7 () Int)
(declare-fun |main_#t~nondet11_7| () Int)
(declare-fun main_~x3~0_7 () Int)
...
(assert (! (and (= 1 v_main_~d2~0_3_fresh_1) (= 1 v_main_~d3~0_3_fresh_1) (= 1 v_main_~d1~0_3_fresh_1)) :named ssa_4))
...
(assert (! (not (= |main_#t~bitwise10_6| 0)) :named ssa_7))
(assert (! (and (or (= (ite (< 0 (mod main_~x1~0_7 4294967296)) 1 0) 0) (= (ite (< 0 (mod main_~x2~0_7 4294967296)) 1 0) 0)) (= |main_#t~bitwise16_8| 0)) :named ssa_8))
(assert (! (and (= |main_#t~bitwise17_9| 0) (or (= |main_#t~bitwise16_8| 0) (= (ite (< 0 (mod main_~x3~0_7 4294967296)) 1 0) 0))) :named ssa_9))
(assert (! false :named ssa_10))
(assert (! true :named ssa_11_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_11| (ite (or (= (mod main_~x1~0_7 4294967296) 0) (= (mod main_~x2~0_7 4294967296) 0) (= (mod main_~x3~0_7 4294967296) 0)) 1 0)) :named ssa_11_LocVarAssigCall))
