...
(set-info :ultimate-id string_concat-noarr.i_AllErrorsAtOnce_Iteration26)
...
(assert (! (or (<= 1000000 main_~i~0_55) (= |main_#t~nondet3_56| 0)) :named ssa_57))
(assert (! (< main_~j~0_55 100) :named ssa_58))
(assert (! true :named ssa_59_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_59| (ite (< main_~i~0_55 200) 1 0)) :named ssa_59_LocVarAssigCall))
