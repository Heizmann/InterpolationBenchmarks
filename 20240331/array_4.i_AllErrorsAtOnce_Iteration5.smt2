...
(set-info :ultimate-id array_4.i_AllErrorsAtOnce_Iteration5)
...
(assert (! (and (= (select |#valid_3| |main_~#A~0.base_4|) 0) (= |#length_4| (store |#length_3| |main_~#A~0.base_4| v_ArrVal_24_fresh_1)) (not (= |main_~#A~0.base_4| 0)) (= 4096 v_ArrVal_24_fresh_1) (= 0 |main_~#A~0.offset_4|) (< |#StackHeapBarrier_-1| |main_~#A~0.base_4|) (= (store |#valid_3| |main_~#A~0.base_4| v_ArrVal_23_fresh_1) |#valid_4|) (= main_~i~0_4 0) (= v_ArrVal_23_fresh_1 1)) :named ssa_4))
(assert (! (and (= |v_main_#t~nondet1_11_fresh_1| v_ArrVal_25_fresh_1) (= (store |#memory_int#1_3| |main_~#A~0.base_4| v_ArrVal_26_fresh_1) |#memory_int#1_5|) (= main_~i~0_5 (+ main_~i~0_4 1)) (= v_ArrVal_26_fresh_1 (store (select |#memory_int#1_3| |main_~#A~0.base_4|) (+ (* main_~i~0_4 4) |main_~#A~0.offset_4|) v_ArrVal_25_fresh_1)) (<= 0 (+ |v_main_#t~nondet1_11_fresh_1| 2147483648)) (< main_~i~0_4 1023) (<= |v_main_#t~nondet1_11_fresh_1| 2147483647)) :named ssa_5))
(assert (! (and (= (store |#memory_int#1_5| |main_~#A~0.base_4| v_ArrVal_28_fresh_1) |#memory_int#1_6|) (<= |v_main_#t~nondet1_12_fresh_1| 2147483647) (= main_~i~0_6 (+ main_~i~0_5 1)) (<= 0 (+ |v_main_#t~nondet1_12_fresh_1| 2147483648)) (= (store (select |#memory_int#1_5| |main_~#A~0.base_4|) (+ (* main_~i~0_5 4) |main_~#A~0.offset_4|) v_ArrVal_27_fresh_1) v_ArrVal_28_fresh_1) (= |v_main_#t~nondet1_12_fresh_1| v_ArrVal_27_fresh_1) (< main_~i~0_5 1023)) :named ssa_6))
(assert (! (<= 1023 main_~i~0_6) :named ssa_7))
(assert (! (and (= v_ArrVal_30_fresh_1 0) (= (store |#memory_int#1_6| |main_~#A~0.base_4| v_ArrVal_29_fresh_1) |#memory_int#1_8|) (= (store (select |#memory_int#1_6| |main_~#A~0.base_4|) (+ 4092 |main_~#A~0.offset_4|) 0) v_ArrVal_29_fresh_1) (= main_~i~0_8 0)) :named ssa_8))
(assert (! (= |main_#t~mem3_9| (select (select |#memory_int#1_8| |main_~#A~0.base_4|) (+ (* main_~i~0_8 4) |main_~#A~0.offset_4|))) :named ssa_9))
(assert (! (and (= main_~i~0_10 (+ main_~i~0_8 1)) (not (= |main_#t~mem3_9| 0))) :named ssa_10))
(assert (! (= |main_#t~mem3_11| (select (select |#memory_int#1_8| |main_~#A~0.base_4|) (+ (* main_~i~0_10 4) |main_~#A~0.offset_4|))) :named ssa_11))
(assert (! (= |main_#t~mem3_11| 0) :named ssa_12))
(assert (! true :named ssa_13_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_13| (ite (<= main_~i~0_10 1024) 1 0)) :named ssa_13_LocVarAssigCall))
