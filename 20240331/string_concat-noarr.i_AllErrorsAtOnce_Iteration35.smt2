...
(set-info :ultimate-id string_concat-noarr.i_AllErrorsAtOnce_Iteration35)
...
(declare-fun main_~j~0_76 () Int)
(declare-fun |__VERIFIER_assert_#in~cond_77| () Int)
