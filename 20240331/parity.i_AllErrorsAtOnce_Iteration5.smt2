...
(set-info :ultimate-id parity.i_AllErrorsAtOnce_Iteration5)
...
(declare-fun v_main_~parity2~0_12_fresh_1 () Int)
...
(declare-fun |main_#t~bitwise4_11| () Int)
...
(declare-fun main_~parity2~0_16 () Int)
(declare-fun main_~parity1~0_16 () Int)
...
(assert (! (and (= main_~v2~0_6 main_~v~0_4) (= v_main_~parity2~0_12_fresh_1 0)) :named ssa_6))
...
(assert (! (not (= (mod main_~v2~0_8 4294967296) 0)) :named ssa_9))
(assert (! (and (= (mod (div (mod main_~v2~0_8 4294967296) 4) 4294967296) 0) (= main_~v2~0_8 |main_#t~bitwise4_10|)) :named ssa_10))
(assert (! (= main_~v2~0_11 |main_#t~bitwise4_10|) :named ssa_11))
(assert (! (not (= (mod main_~v2~0_11 4294967296) 0)) :named ssa_12))
(assert (! (and (= main_~v2~0_11 |main_#t~bitwise5_13|) (= (mod main_~v2~0_11 4294967296) 286331153)) :named ssa_13))
(assert (! (= main_~v2~0_14 (* 286331153 |main_#t~bitwise5_13|)) :named ssa_14))
(assert (! (and (not (= (mod (div (mod main_~v2~0_14 4294967296) 268435456) 2) 0)) (= main_~parity2~0_15 1)) :named ssa_15))
(assert (! true :named ssa_16_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_16| (ite (= main_~parity1~0_4 main_~parity2~0_15) 1 0)) :named ssa_16_LocVarAssigCall))
