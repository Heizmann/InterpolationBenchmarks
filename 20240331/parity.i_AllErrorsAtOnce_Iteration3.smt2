...
(set-info :ultimate-id parity.i_AllErrorsAtOnce_Iteration3)
...
(declare-fun v_main_~parity2~0_10_fresh_1 () Int)
...
(assert (! (and (= main_~v2~0_6 main_~v~0_4) (= v_main_~parity2~0_10_fresh_1 0)) :named ssa_6))
...
(assert (! (and (not (= (mod (div (mod main_~v2~0_12 4294967296) 268435456) 2) 0)) (= main_~parity2~0_13 1)) :named ssa_13))
