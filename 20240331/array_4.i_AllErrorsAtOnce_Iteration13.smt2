...
(set-info :ultimate-id array_4.i_AllErrorsAtOnce_Iteration13)
...
(assert (! (and (= (select |#valid_3| |main_~#A~0.base_4|) 0) (not (= |main_~#A~0.base_4| 0)) (= |#valid_4| (store |#valid_3| |main_~#A~0.base_4| v_ArrVal_129_fresh_1)) (= 0 |main_~#A~0.offset_4|) (= (store |#length_3| |main_~#A~0.base_4| v_ArrVal_130_fresh_1) |#length_4|) (= v_ArrVal_130_fresh_1 4096) (= v_ArrVal_129_fresh_1 1) (< |#StackHeapBarrier_-1| |main_~#A~0.base_4|) (= main_~i~0_4 0)) :named ssa_4))
(assert (! (and (<= 0 (+ |v_main_#t~nondet1_48_fresh_1| 2147483648)) (= main_~i~0_5 (+ main_~i~0_4 1)) (< main_~i~0_4 1023) (<= |v_main_#t~nondet1_48_fresh_1| 2147483647) (= v_ArrVal_132_fresh_1 (store (select |#memory_int#1_3| |main_~#A~0.base_4|) (+ (* main_~i~0_4 4) |main_~#A~0.offset_4|) v_ArrVal_131_fresh_1)) (= (store |#memory_int#1_3| |main_~#A~0.base_4| v_ArrVal_132_fresh_1) |#memory_int#1_5|) (= v_ArrVal_131_fresh_1 |v_main_#t~nondet1_48_fresh_1|)) :named ssa_5))
(assert (! (and (<= 0 (+ |v_main_#t~nondet1_49_fresh_1| 2147483648)) (= main_~i~0_6 (+ main_~i~0_5 1)) (= v_ArrVal_134_fresh_1 (store (select |#memory_int#1_5| |main_~#A~0.base_4|) (+ (* main_~i~0_5 4) |main_~#A~0.offset_4|) v_ArrVal_133_fresh_1)) (= (store |#memory_int#1_5| |main_~#A~0.base_4| v_ArrVal_134_fresh_1) |#memory_int#1_6|) (< main_~i~0_5 1023) (= v_ArrVal_133_fresh_1 |v_main_#t~nondet1_49_fresh_1|) (<= |v_main_#t~nondet1_49_fresh_1| 2147483647)) :named ssa_6))
(assert (! (and (<= |v_main_#t~nondet1_50_fresh_1| 2147483647) (= main_~i~0_7 (+ main_~i~0_6 1)) (< main_~i~0_6 1023) (= v_ArrVal_135_fresh_1 |v_main_#t~nondet1_50_fresh_1|) (<= 0 (+ |v_main_#t~nondet1_50_fresh_1| 2147483648)) (= (store |#memory_int#1_6| |main_~#A~0.base_4| v_ArrVal_136_fresh_1) |#memory_int#1_7|) (= v_ArrVal_136_fresh_1 (store (select |#memory_int#1_6| |main_~#A~0.base_4|) (+ (* main_~i~0_6 4) |main_~#A~0.offset_4|) v_ArrVal_135_fresh_1))) :named ssa_7))
(assert (! (and (= main_~i~0_8 (+ main_~i~0_7 1)) (<= |v_main_#t~nondet1_51_fresh_1| 2147483647) (<= 0 (+ |v_main_#t~nondet1_51_fresh_1| 2147483648)) (< main_~i~0_7 1023) (= v_ArrVal_137_fresh_1 |v_main_#t~nondet1_51_fresh_1|) (= (store |#memory_int#1_7| |main_~#A~0.base_4| v_ArrVal_138_fresh_1) |#memory_int#1_8|) (= v_ArrVal_138_fresh_1 (store (select |#memory_int#1_7| |main_~#A~0.base_4|) (+ (* main_~i~0_7 4) |main_~#A~0.offset_4|) v_ArrVal_137_fresh_1))) :named ssa_8))
(assert (! (and (= main_~i~0_9 (+ main_~i~0_8 1)) (= (store |#memory_int#1_8| |main_~#A~0.base_4| v_ArrVal_140_fresh_1) |#memory_int#1_9|) (< main_~i~0_8 1023) (= v_ArrVal_140_fresh_1 (store (select |#memory_int#1_8| |main_~#A~0.base_4|) (+ (* main_~i~0_8 4) |main_~#A~0.offset_4|) v_ArrVal_139_fresh_1)) (<= 0 (+ |v_main_#t~nondet1_52_fresh_1| 2147483648)) (= v_ArrVal_139_fresh_1 |v_main_#t~nondet1_52_fresh_1|) (<= |v_main_#t~nondet1_52_fresh_1| 2147483647)) :named ssa_9))
(assert (! (and (<= 0 (+ |v_main_#t~nondet1_53_fresh_1| 2147483648)) (= v_ArrVal_141_fresh_1 (store (select |#memory_int#1_9| |main_~#A~0.base_4|) (+ (* main_~i~0_9 4) |main_~#A~0.offset_4|) |v_main_#t~nondet1_53_fresh_1|)) (= main_~i~0_10 (+ main_~i~0_9 1)) (= v_ArrVal_142_fresh_1 |v_main_#t~nondet1_53_fresh_1|) (< main_~i~0_9 1023) (= |#memory_int#1_10| (store |#memory_int#1_9| |main_~#A~0.base_4| v_ArrVal_141_fresh_1)) (<= |v_main_#t~nondet1_53_fresh_1| 2147483647)) :named ssa_10))
(assert (! (and (<= |v_main_#t~nondet1_54_fresh_1| 2147483647) (= main_~i~0_11 (+ main_~i~0_10 1)) (= v_ArrVal_143_fresh_1 (store (select |#memory_int#1_10| |main_~#A~0.base_4|) (+ (* main_~i~0_10 4) |main_~#A~0.offset_4|) |v_main_#t~nondet1_54_fresh_1|)) (= (store |#memory_int#1_10| |main_~#A~0.base_4| v_ArrVal_143_fresh_1) |#memory_int#1_11|) (< main_~i~0_10 1023) (<= 0 (+ |v_main_#t~nondet1_54_fresh_1| 2147483648)) (= v_ArrVal_144_fresh_1 |v_main_#t~nondet1_54_fresh_1|)) :named ssa_11))
(assert (! (and (= v_ArrVal_145_fresh_1 (store (select |#memory_int#1_11| |main_~#A~0.base_4|) (+ (* main_~i~0_11 4) |main_~#A~0.offset_4|) |v_main_#t~nondet1_55_fresh_1|)) (= main_~i~0_12 (+ main_~i~0_11 1)) (< main_~i~0_11 1023) (<= |v_main_#t~nondet1_55_fresh_1| 2147483647) (= v_ArrVal_146_fresh_1 |v_main_#t~nondet1_55_fresh_1|) (= (store |#memory_int#1_11| |main_~#A~0.base_4| v_ArrVal_145_fresh_1) |#memory_int#1_12|) (<= 0 (+ |v_main_#t~nondet1_55_fresh_1| 2147483648))) :named ssa_12))
(assert (! (and (= main_~i~0_13 (+ main_~i~0_12 1)) (<= 0 (+ |v_main_#t~nondet1_56_fresh_1| 2147483648)) (<= |v_main_#t~nondet1_56_fresh_1| 2147483647) (< main_~i~0_12 1023) (= (store |#memory_int#1_12| |main_~#A~0.base_4| v_ArrVal_147_fresh_1) |#memory_int#1_13|) (= v_ArrVal_148_fresh_1 |v_main_#t~nondet1_56_fresh_1|) (= v_ArrVal_147_fresh_1 (store (select |#memory_int#1_12| |main_~#A~0.base_4|) (+ (* main_~i~0_12 4) |main_~#A~0.offset_4|) |v_main_#t~nondet1_56_fresh_1|))) :named ssa_13))
(assert (! (<= 1023 main_~i~0_13) :named ssa_14))
(assert (! (and (= (store |#memory_int#1_13| |main_~#A~0.base_4| v_ArrVal_149_fresh_1) |#memory_int#1_15|) (= v_ArrVal_149_fresh_1 (store (select |#memory_int#1_13| |main_~#A~0.base_4|) (+ 4092 |main_~#A~0.offset_4|) 0)) (= main_~i~0_15 0) (= v_ArrVal_150_fresh_1 0)) :named ssa_15))
(assert (! (= |main_#t~mem3_16| (select (select |#memory_int#1_15| |main_~#A~0.base_4|) (+ (* main_~i~0_15 4) |main_~#A~0.offset_4|))) :named ssa_16))
(assert (! (and (= main_~i~0_17 (+ main_~i~0_15 1)) (not (= |main_#t~mem3_16| 0))) :named ssa_17))
(assert (! (= |main_#t~mem3_18| (select (select |#memory_int#1_15| |main_~#A~0.base_4|) (+ (* main_~i~0_17 4) |main_~#A~0.offset_4|))) :named ssa_18))
(assert (! (and (= main_~i~0_19 (+ main_~i~0_17 1)) (not (= |main_#t~mem3_18| 0))) :named ssa_19))
(assert (! (= |main_#t~mem3_20| (select (select |#memory_int#1_15| |main_~#A~0.base_4|) (+ (* main_~i~0_19 4) |main_~#A~0.offset_4|))) :named ssa_20))
(assert (! (= |main_#t~mem3_20| 0) :named ssa_21))
(assert (! true :named ssa_22_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_22| (ite (<= main_~i~0_19 1024) 1 0)) :named ssa_22_LocVarAssigCall))
