...
(set-info :ultimate-id string_concat-noarr.i_AllErrorsAtOnce_Iteration28)
...
(assert (! (or (<= 1000000 main_~i~0_59) (= |main_#t~nondet3_60| 0)) :named ssa_61))
(assert (! (< main_~j~0_59 100) :named ssa_62))
(assert (! true :named ssa_63_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_63| (ite (< main_~i~0_59 200) 1 0)) :named ssa_63_LocVarAssigCall))
