...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:08:43+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id test_locks_7.c_AllErrorsAtOnce_Iteration5)
...
(declare-fun |main_#t~nondet11_5| () Int)
...
(declare-fun main_~lk2~0_16 () Int)
...
(assert (! (and (<= main_~p2~0_4 2147483647) (<= 0 (+ main_~p2~0_4 2147483648)) (<= main_~p5~0_4 2147483647) (<= 0 (+ main_~p6~0_4 2147483648)) (<= main_~p1~0_4 2147483647) (<= main_~p6~0_4 2147483647) (<= 0 (+ main_~p5~0_4 2147483648)) (<= 0 (+ main_~p1~0_4 2147483648)) (<= main_~p3~0_4 2147483647) (<= 0 (+ main_~p4~0_4 2147483648)) (<= main_~p7~0_4 2147483647) (<= 0 (+ main_~p3~0_4 2147483648)) (<= 0 (+ main_~p7~0_4 2147483648)) (<= main_~p4~0_4 2147483647)) :named ssa_4))
(assert (! (and (<= main_~cond~0_5 2147483647) (<= 0 (+ 2147483648 main_~cond~0_5))) :named ssa_5))
(assert (! (and (= main_~lk4~0_6 0) (= main_~lk1~0_6 0) (= main_~lk3~0_6 0) (= main_~lk7~0_6 0) (= main_~lk6~0_6 0) (= main_~lk2~0_6 0) (not (= 0 main_~cond~0_5)) (= main_~lk5~0_6 0)) :named ssa_6))
(assert (! (= main_~p1~0_4 0) :named ssa_7))
(assert (! (and (= main_~lk2~0_8 1) (not (= main_~p2~0_4 0))) :named ssa_8))
...
(assert (! (= main_~p1~0_4 0) :named ssa_14))
(assert (! (not (= main_~p2~0_4 0)) :named ssa_15))
(assert (! (not (= main_~lk2~0_8 1)) :named ssa_16))
