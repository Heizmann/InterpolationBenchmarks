...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration6)
...
(assert (! (<= 1000000 main_~i~0_9) :named ssa_10))
(assert (! true :named ssa_11_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_11| (ite (= main_~i~0_9 1000000) 1 0)) :named ssa_11_LocVarAssigCall))
