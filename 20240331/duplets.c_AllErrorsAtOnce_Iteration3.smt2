...
(set-info :ultimate-id duplets.c_AllErrorsAtOnce_Iteration3)
...
(declare-fun v_mkdup_~x~0_9_fresh_1 () Int)
...
(assert (! (and (= (store |#valid_3| |main_#t~malloc13.base_10| v_ArrVal_30_fresh_1) |#valid_10|) (not (= 0 |main_#t~malloc13.base_10|)) (< |main_#t~malloc13.base_10| |#StackHeapBarrier_-1|) (= |main_#t~malloc13.offset_10| 0) (= (* 4 (mod main_~n~0_4 1073741824)) v_ArrVal_29_fresh_1) (= (store |#length_3| |main_#t~malloc13.base_10| v_ArrVal_29_fresh_1) |#length_10|) (= (select |#valid_3| |main_#t~malloc13.base_10|) 0) (= v_ArrVal_30_fresh_1 1)) :named ssa_10))
(assert (! (= |old(#memory_int#2)_11| |#memory_int#2_11|) :named ssa_11_GlobVarAssigCall))
(assert (! (and (= |v_#Ultimate.meminit_#ptr.offsetInParam_5_fresh_1| |main_#t~malloc13.offset_10|) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_5_fresh_1|) (= |v_#Ultimate.meminit_#productInParam_5_fresh_1| (* main_~n~0_4 4)) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_5_fresh_1| 4) (= |#Ultimate.meminit_#ptr.base_11| |main_#t~malloc13.base_10|)) :named ssa_11_LocVarAssigCall))
(assert (! (= |old(#memory_int#2)_11| |#memory_int#2_3|) :named ssa_11_OldVarAssigCall))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_31_fresh_1) (= (store |#memory_int#2_11| |#Ultimate.meminit_#ptr.base_11| v_ArrVal_31_fresh_1) |#memory_int#2_12|)) :named ssa_12))
...
(assert (! (and (<= v_mkdup_~x~0_9_fresh_1 2147483647) (= v_mkdup_~x~0_9_fresh_1 v_ArrVal_33_fresh_1) (<= 0 (+ v_mkdup_~x~0_9_fresh_1 2147483648)) (= |#memory_int#2_32| (store |#memory_int#2_15| mkdup_~a.base_16 v_ArrVal_32_fresh_1)) (= v_mkdup_~x~0_9_fresh_1 v_ArrVal_34_fresh_1) (= (store (store (select |#memory_int#2_15| mkdup_~a.base_16) (+ (* mkdup_~i~0_16 4) mkdup_~a.offset_16) v_mkdup_~x~0_9_fresh_1) (+ mkdup_~a.offset_16 (* mkdup_~j~0_16 4)) v_mkdup_~x~0_9_fresh_1) v_ArrVal_32_fresh_1)) :named ssa_32))
(assert (! true :named ssa_33_return))
(assert (! (and (= |main_~#i~2.offset_34| 0) (= 0 (select (store |#valid_10| |main_~#i~2.base_34| v_ArrVal_36_fresh_1) |main_~#j~2.base_34|)) (= (select |#valid_10| |main_~#i~2.base_34|) 0) (= |main_~#j~2.offset_34| 0) (= |#length_34| (store (store |#length_10| |main_~#i~2.base_34| v_ArrVal_35_fresh_1) |main_~#j~2.base_34| v_ArrVal_37_fresh_1)) (not (= |main_~#j~2.base_34| 0)) (= v_ArrVal_36_fresh_1 1) (< |#StackHeapBarrier_-1| |main_~#j~2.base_34|) (= 4 v_ArrVal_37_fresh_1) (not (= |main_~#i~2.base_34| 0)) (= (store (store |#valid_10| |main_~#i~2.base_34| v_ArrVal_36_fresh_1) |main_~#j~2.base_34| v_ArrVal_38_fresh_1) |#valid_34|) (= 4 v_ArrVal_35_fresh_1) (< |#StackHeapBarrier_-1| |main_~#i~2.base_34|) (= v_ArrVal_38_fresh_1 1)) :named ssa_34))
...
(assert (! (and (= finddup_~j~1_37 v_ArrVal_41_fresh_1) (= (store |#memory_int#3_35| finddup_~_j.base_36 v_ArrVal_40_fresh_1) |#memory_int#3_39|) (= (store (select |#memory_int#1_35| finddup_~_i.base_36) finddup_~_i.offset_36 v_ArrVal_39_fresh_1) v_ArrVal_42_fresh_1) (= finddup_~i~1_36 v_ArrVal_39_fresh_1) (= |finddup_#res_39| 1) (= |finddup_#t~mem8_38| |finddup_#t~mem9_38|) (= (store (select |#memory_int#3_35| finddup_~_j.base_36) finddup_~_j.offset_36 finddup_~j~1_37) v_ArrVal_40_fresh_1) (= (store |#memory_int#1_35| finddup_~_i.base_36 v_ArrVal_42_fresh_1) |#memory_int#1_39|)) :named ssa_39))
...
(assert (! (not true) :named ssa_postcond))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_43_fresh_1) (= (store |#memory_int#2_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_43_fresh_1) |#memory_int#2_0|)) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! true :named ssa_-2_PendingContext))
...
(declare-fun v_mkdup_~x~0_10_fresh_1 () Int)
(assert (! (= |#memory_int#2_-1| |old(#memory_int#2)_-1|) :named ssa_precond))
(assert (! (not true) :named ssa_postcond))
...
(assert (! (and (= v_mkdup_~x~0_10_fresh_1 v_ArrVal_44_fresh_1) (<= 0 (+ v_mkdup_~x~0_10_fresh_1 2147483648)) (= (store (store (select |#memory_int#2_-1| mkdup_~a.base_0) (+ (* mkdup_~i~0_0 4) mkdup_~a.offset_0) v_mkdup_~x~0_10_fresh_1) (+ mkdup_~a.offset_0 (* mkdup_~j~0_0 4)) v_ArrVal_44_fresh_1) v_ArrVal_45_fresh_1) (<= v_mkdup_~x~0_10_fresh_1 2147483647) (= v_mkdup_~x~0_10_fresh_1 v_ArrVal_46_fresh_1) (= (store |#memory_int#2_-1| mkdup_~a.base_0 v_ArrVal_45_fresh_1) |#memory_int#2_16|)) :named ssa_16))
...
(assert (! (not (= |main_#t~ret14_5| 1)) :named ssa_postcond))
...
(assert (! (and (= (store |#memory_int#3_-1| finddup_~_j.base_0 v_ArrVal_48_fresh_1) |#memory_int#3_3|) (= finddup_~i~1_0 v_ArrVal_47_fresh_1) (= (store (select |#memory_int#3_-1| finddup_~_j.base_0) finddup_~_j.offset_0 finddup_~j~1_1) v_ArrVal_48_fresh_1) (= (store (select |#memory_int#1_-1| finddup_~_i.base_0) finddup_~_i.offset_0 v_ArrVal_47_fresh_1) v_ArrVal_50_fresh_1) (= finddup_~j~1_1 v_ArrVal_49_fresh_1) (= |finddup_#res_3| 1) (= (store |#memory_int#1_-1| finddup_~_i.base_0 v_ArrVal_50_fresh_1) |#memory_int#1_3|) (= |finddup_#t~mem8_2| |finddup_#t~mem9_2|)) :named ssa_3))
(assert (! true :named ssa_4))
