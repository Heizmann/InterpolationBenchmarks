...
(set-info :ultimate-id benchmark43_conjunctive_abstracted.i_AllErrorsAtOnce_Iteration3)
...
(declare-fun |main_#t~bitwise7_12| () Int)
...
(assert (! (and (or (= (ite (< main_~x~0_8 100) 1 0) 0) (= (ite (< main_~y~0_8 100) 1 0) 0)) (= |main_#t~bitwise6_9| 0)) :named ssa_9))
(assert (! (not (= |main_#t~bitwise6_9| 0)) :named ssa_10))
(assert (! (and (= main_~x~0_11 (+ main_~x~0_8 1)) (< main_~y~0_8 100) (= main_~y~0_11 (+ main_~y~0_8 1)) (< main_~x~0_8 100)) :named ssa_11))
(assert (! (and (or (= (ite (< main_~x~0_11 100) 1 0) 0) (= (ite (< main_~y~0_11 100) 1 0) 0)) (= |main_#t~bitwise7_12| 0)) :named ssa_12))
(assert (! (= |main_#t~bitwise7_12| 0) :named ssa_13))
(assert (! true :named ssa_14_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_14| (ite (or (= main_~y~0_11 100) (= main_~x~0_11 100)) 1 0)) :named ssa_14_LocVarAssigCall))
