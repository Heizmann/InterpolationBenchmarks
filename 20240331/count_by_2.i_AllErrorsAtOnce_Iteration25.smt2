...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration25)
...
(assert (! (<= 1000000 main_~i~0_28) :named ssa_29))
(assert (! true :named ssa_30_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_30| (ite (= main_~i~0_28 1000000) 1 0)) :named ssa_30_LocVarAssigCall))
