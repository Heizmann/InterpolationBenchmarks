...
(set-info :ultimate-id bin-suffix-5.c_AllErrorsAtOnce_Iteration4)
...
(declare-fun |main_#t~bitwise5_10| () Int)
...
(assert (! (and (= (mod main_~x~0_6 4294967296) 0) (= |main_#t~bitwise5_9| 0)) :named ssa_9))
(assert (! true :named ssa_10_GlobVarAssigCall))
(assert (! (= (ite (= 5 (mod |main_#t~bitwise5_9| 4294967296)) 1 0) |__VERIFIER_assert_#in~cond_10|) :named ssa_10_LocVarAssigCall))
