...
(set-info :ultimate-id watermelon.c_AllErrorsAtOnce_Iteration18)
...
(declare-fun v_main_~is_divisible2~0_23_fresh_1 () Int)
(declare-fun v_main_~is_divisible1~0_23_fresh_1 () Int)
...
(assert (! (and (= ~true~0_1 v_main_~is_divisible2~0_23_fresh_1) (= ~true~0_1 v_main_~is_divisible1~0_23_fresh_1)) :named ssa_4))
...
(assert (! (and (not (= student_version_~w_20 student_version_~i~1_25)) (= ~false~0_1 student_version_~is_divisible~1_27)) :named ssa_27))
(assert (! true :named ssa_28))
(assert (! (= student_version_~is_divisible~1_27 |student_version_#res_29|) :named ssa_29))
...
(assert (! true :named ssa_precond))
(assert (! (not (and (<= main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647)) (<= (+ (* (div main_~w~0_-2 4294967296) 4294967296) 8) main_~w~0_-2))) :named ssa_postcond))
...
(assert (! (and (<= main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647)) (<= (+ (* (div main_~w~0_-2 4294967296) 4294967296) 8) main_~w~0_-2)) :named ssa_-2_PendingContext))
