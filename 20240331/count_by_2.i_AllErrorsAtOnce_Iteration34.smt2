...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration34)
...
(assert (! (<= 1000000 main_~i~0_37) :named ssa_38))
(assert (! true :named ssa_39_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_39| (ite (= main_~i~0_37 1000000) 1 0)) :named ssa_39_LocVarAssigCall))
