...
(set-info :ultimate-id mbpr4.c_AllErrorsAtOnce_Iteration10)
...
(declare-fun |v_main_#t~mem21_21_fresh_1| () Int)
...
(declare-fun |v_main_#t~mem21_22_fresh_1| () Int)
...
(declare-fun |v_main_#t~mem21_23_fresh_1| () Int)
...
(declare-fun |v_main_#t~mem21_24_fresh_1| () Int)
...
(declare-fun |main_#t~short23_64| () Bool)
(declare-fun |main_#t~mem22_64| () Int)
(declare-fun |main_#t~mem21_64| () Int)
(declare-fun main_~i~0_64 () Int)
(declare-fun |main_#t~post24_64| () Int)
(declare-fun |main_#t~short23_65| () Bool)
(declare-fun |v_main_#t~mem21_25_fresh_1| () Int)
(declare-fun |main_#t~short23_66| () Bool)
(declare-fun |v_main_#t~mem22_13_fresh_1| () Int)
(declare-fun |main_#t~short23_67| () Bool)
...
(assert (! (and (= |#valid_5| (store |#valid_3| |main_~#volArray~0.base_5| v_ArrVal_164_fresh_1)) (= 7 main_~CCCELVOL3~0_5) (= v_ArrVal_164_fresh_1 1) (= 5 main_~CCCELVOL4~0_5) (< 1 ~CELLCOUNT~0_4) (= v_ArrVal_163_fresh_1 (* (mod ~CELLCOUNT~0_4 1073741824) 4)) (= (select |#valid_3| |main_~#volArray~0.base_5|) 0) (= main_~MINVAL~0_5 2) (= 3 main_~CCCELVOL2~0_5) (not (= |main_~#volArray~0.base_5| 0)) (= (store |#length_3| |main_~#volArray~0.base_5| v_ArrVal_163_fresh_1) |#length_5|) (= main_~CCCELVOL1~0_5 1) (= |main_~#volArray~0.offset_5| 0) (< |#StackHeapBarrier_-1| |main_~#volArray~0.base_5|)) :named ssa_5))
...
(assert (! (and (<= main_~MINVAL~0_5 main_~CCCELVOL4~0_5) (= |#memory_int#1_14| (store |#memory_int#1_3| |main_~#volArray~0.base_5| v_ArrVal_165_fresh_1)) (= v_ArrVal_165_fresh_1 (store (select |#memory_int#1_3| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 16) (* main_~i~0_12 16)) main_~CCCELVOL4~0_5)) (= v_ArrVal_166_fresh_1 main_~CCCELVOL4~0_5)) :named ssa_14))
(assert (! (and (= main_~i~0_15 (+ main_~i~0_12 1)) (= v_ArrVal_170_fresh_1 (select (select |#memory_int#1_14| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_12 16) (- 8)))) (= v_ArrVal_169_fresh_1 (select (select |#memory_int#1_14| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_12 16)))) (= (store |#memory_int#1_14| |main_~#volArray~0.base_5| v_ArrVal_168_fresh_1) |#memory_int#1_15|) (= v_ArrVal_168_fresh_1 (store (store (store (select |#memory_int#1_14| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 12) (* main_~i~0_12 16)) v_ArrVal_167_fresh_1) (+ |main_~#volArray~0.offset_5| (* main_~i~0_12 16) (- 8)) (select (select |#memory_int#1_14| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_12 16) (- 8)))) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_12 16)) (select (select |#memory_int#1_14| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_12 16))))) (= v_ArrVal_167_fresh_1 (select (select |#memory_int#1_14| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 12) (* main_~i~0_12 16))))) :named ssa_15))
...
(assert (! (and (= (store |#memory_int#1_15| |main_~#volArray~0.base_5| v_ArrVal_172_fresh_1) |#memory_int#1_19|) (= v_ArrVal_172_fresh_1 (store (select |#memory_int#1_15| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_17 16) (- 12)) v_ArrVal_171_fresh_1)) (= v_ArrVal_171_fresh_1 main_~CCCELVOL3~0_5) (<= main_~MINVAL~0_5 main_~CCCELVOL3~0_5)) :named ssa_19))
(assert (! (and (= v_ArrVal_174_fresh_1 (select (select |#memory_int#1_19| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 16) (* main_~i~0_17 16)))) (= (select (select |#memory_int#1_19| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_17 16))) v_ArrVal_176_fresh_1) (= |#memory_int#1_20| (store |#memory_int#1_19| |main_~#volArray~0.base_5| v_ArrVal_173_fresh_1)) (= v_ArrVal_175_fresh_1 (select (select |#memory_int#1_19| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_17 16) (- 8)))) (= main_~i~0_20 (+ main_~i~0_17 1)) (= v_ArrVal_173_fresh_1 (store (store (store (select |#memory_int#1_19| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 16) (* main_~i~0_17 16)) (select (select |#memory_int#1_19| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 16) (* main_~i~0_17 16)))) (+ |main_~#volArray~0.offset_5| (* main_~i~0_17 16) (- 8)) (select (select |#memory_int#1_19| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_17 16) (- 8)))) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_17 16)) (select (select |#memory_int#1_19| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_17 16)))))) :named ssa_20))
...
(assert (! (and (= |#memory_int#1_24| (store |#memory_int#1_20| |main_~#volArray~0.base_5| v_ArrVal_177_fresh_1)) (= v_ArrVal_178_fresh_1 main_~CCCELVOL2~0_5) (= v_ArrVal_177_fresh_1 (store (select |#memory_int#1_20| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_22 16) (- 8)) main_~CCCELVOL2~0_5)) (<= main_~MINVAL~0_5 main_~CCCELVOL2~0_5)) :named ssa_24))
(assert (! (and (= v_ArrVal_179_fresh_1 (store (store (store (select |#memory_int#1_24| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 16) (* main_~i~0_22 16)) (select (select |#memory_int#1_24| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 16) (* main_~i~0_22 16)))) (+ |main_~#volArray~0.offset_5| (* main_~i~0_22 16) (- 12)) (select (select |#memory_int#1_24| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_22 16) (- 12)))) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_22 16)) (select (select |#memory_int#1_24| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_22 16))))) (= v_ArrVal_180_fresh_1 (select (select |#memory_int#1_24| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 4) (* main_~i~0_22 16)))) (= (store |#memory_int#1_24| |main_~#volArray~0.base_5| v_ArrVal_179_fresh_1) |#memory_int#1_25|) (= (+ main_~i~0_22 1) main_~i~0_25) (= v_ArrVal_181_fresh_1 (select (select |#memory_int#1_24| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_22 16) (- 12)))) (= v_ArrVal_182_fresh_1 (select (select |#memory_int#1_24| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (- 16) (* main_~i~0_22 16))))) :named ssa_25))
...
(assert (! (and (= (store |#memory_int#1_25| |main_~#volArray~0.base_5| v_ArrVal_183_fresh_1) |#memory_int#1_29|) (< main_~CCCELVOL1~0_5 main_~MINVAL~0_5) (= v_ArrVal_183_fresh_1 (store (select |#memory_int#1_25| |main_~#volArray~0.base_5|) (+ (* main_~i~0_27 16) |main_~#volArray~0.offset_5| (- 4)) 0)) (= v_ArrVal_184_fresh_1 0)) :named ssa_29))
(assert (! (and (= v_ArrVal_185_fresh_1 (select (select |#memory_int#1_29| |main_~#volArray~0.base_5|) (+ (* main_~i~0_27 16) |main_~#volArray~0.offset_5| (- 8)))) (= |#memory_int#1_30| (store |#memory_int#1_29| |main_~#volArray~0.base_5| v_ArrVal_188_fresh_1)) (= v_ArrVal_187_fresh_1 (select (select |#memory_int#1_29| |main_~#volArray~0.base_5|) (+ (* main_~i~0_27 16) |main_~#volArray~0.offset_5| (- 16)))) (= v_ArrVal_188_fresh_1 (store (store (store (select |#memory_int#1_29| |main_~#volArray~0.base_5|) (+ (* main_~i~0_27 16) |main_~#volArray~0.offset_5| (- 16)) v_ArrVal_187_fresh_1) (+ (* main_~i~0_27 16) |main_~#volArray~0.offset_5| (- 12)) v_ArrVal_186_fresh_1) (+ (* main_~i~0_27 16) |main_~#volArray~0.offset_5| (- 8)) v_ArrVal_185_fresh_1)) (= main_~i~0_30 (+ main_~i~0_27 1)) (= v_ArrVal_186_fresh_1 (select (select |#memory_int#1_29| |main_~#volArray~0.base_5|) (+ (* main_~i~0_27 16) |main_~#volArray~0.offset_5| (- 12))))) :named ssa_30))
...
(assert (! (and (or (and (not |main_#t~short23_33|) (< |v_main_#t~mem21_21_fresh_1| main_~MINVAL~0_5)) (and |main_#t~short23_33| (<= main_~MINVAL~0_5 |v_main_#t~mem21_21_fresh_1|))) (< main_~i~0_32 ~CELLCOUNT~0_4) (= (select (select |#memory_int#1_30| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_32 4))) |v_main_#t~mem21_21_fresh_1|)) :named ssa_33))
...
(assert (! (and (= (select (select |#memory_int#1_30| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_40 4))) |v_main_#t~mem21_22_fresh_1|) (< main_~i~0_40 ~CELLCOUNT~0_4) (or (and (<= main_~MINVAL~0_5 |v_main_#t~mem21_22_fresh_1|) |main_#t~short23_41|) (and (< |v_main_#t~mem21_22_fresh_1| main_~MINVAL~0_5) (not |main_#t~short23_41|)))) :named ssa_41))
...
(assert (! (and (< main_~i~0_48 ~CELLCOUNT~0_4) (or (and (<= main_~MINVAL~0_5 |v_main_#t~mem21_23_fresh_1|) |main_#t~short23_49|) (and (not |main_#t~short23_49|) (< |v_main_#t~mem21_23_fresh_1| main_~MINVAL~0_5))) (= (select (select |#memory_int#1_30| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_48 4))) |v_main_#t~mem21_23_fresh_1|)) :named ssa_49))
...
(assert (! (and (< main_~i~0_56 ~CELLCOUNT~0_4) (= (select (select |#memory_int#1_30| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_56 4))) |v_main_#t~mem21_24_fresh_1|) (or (and (< |v_main_#t~mem21_24_fresh_1| main_~MINVAL~0_5) (not |main_#t~short23_57|)) (and |main_#t~short23_57| (<= main_~MINVAL~0_5 |v_main_#t~mem21_24_fresh_1|)))) :named ssa_57))
(assert (! |main_#t~short23_57| :named ssa_58))
(assert (! true :named ssa_59_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_59| (ite |main_#t~short23_57| 1 0)) :named ssa_59_LocVarAssigCall))
(assert (! true :named ssa_59_OldVarAssigCall))
(assert (! (= __VERIFIER_assert_~cond_60 |__VERIFIER_assert_#in~cond_59|) :named ssa_60))
(assert (! (not (= __VERIFIER_assert_~cond_60 0)) :named ssa_61))
(assert (! true :named ssa_62))
(assert (! true :named ssa_63_return))
(assert (! (= main_~i~0_64 (+ main_~i~0_56 1)) :named ssa_64))
(assert (! (and (< main_~i~0_64 ~CELLCOUNT~0_4) (= (select (select |#memory_int#1_30| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_64 4))) |v_main_#t~mem21_25_fresh_1|) (or (and (not |main_#t~short23_65|) (< |v_main_#t~mem21_25_fresh_1| main_~MINVAL~0_5)) (and |main_#t~short23_65| (<= main_~MINVAL~0_5 |v_main_#t~mem21_25_fresh_1|)))) :named ssa_65))
(assert (! (and (= (select (select |#memory_int#1_30| |main_~#volArray~0.base_5|) (+ |main_~#volArray~0.offset_5| (* main_~i~0_64 4))) |v_main_#t~mem22_13_fresh_1|) (or (and (= 0 |v_main_#t~mem22_13_fresh_1|) |main_#t~short23_66|) (and (not (= 0 |v_main_#t~mem22_13_fresh_1|)) (not |main_#t~short23_66|))) (not |main_#t~short23_65|)) :named ssa_66))
(assert (! true :named ssa_67_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_67| (ite |main_#t~short23_66| 1 0)) :named ssa_67_LocVarAssigCall))
...
(assert (! true :named ssa_precond))
(assert (! (not (= ~CELLCOUNT~0_-2 (* (div ~CELLCOUNT~0_-2 4) 4))) :named ssa_postcond))
...
(assert (! (= ~CELLCOUNT~0_-2 (* (div ~CELLCOUNT~0_-2 4) 4)) :named ssa_-2_PendingContext))
...
(assert (! true :named ssa_precond))
(assert (! (not (and (<= (div ~CELLCOUNT~0_-2 4) 1) (= main_~i~0_-2 0) (= ~CELLCOUNT~0_-2 (* (div ~CELLCOUNT~0_-2 4) 4)))) :named ssa_postcond))
...
(assert (! true :named ssa_2))
(assert (! true :named ssa_3_return))
(assert (! (and (<= (div ~CELLCOUNT~0_-2 4) 1) (= main_~i~0_-2 0) (= ~CELLCOUNT~0_-2 (* (div ~CELLCOUNT~0_-2 4) 4))) :named ssa_-2_PendingContext))
...
(declare-fun __VERIFIER_assert_~cond_1 () Int)
(assert (! true :named ssa_precond))
(assert (! (not (and (<= (* (div ~CELLCOUNT~0_-2 4) 4) (+ main_~i~0_-2 3)) (= ~CELLCOUNT~0_-2 (* (div ~CELLCOUNT~0_-2 4) 4)))) :named ssa_postcond))
(assert (! (= __VERIFIER_assert_~cond_0 |__VERIFIER_assert_#in~cond_-1|) :named ssa_0))
(assert (! (not (= __VERIFIER_assert_~cond_0 0)) :named ssa_1))
(assert (! true :named ssa_2))
(assert (! true :named ssa_3_return))
(assert (! (and (<= (* (div ~CELLCOUNT~0_-2 4) 4) (+ main_~i~0_-2 3)) (= ~CELLCOUNT~0_-2 (* (div ~CELLCOUNT~0_-2 4) 4))) :named ssa_-2_PendingContext))
(assert (! (= |__VERIFIER_assert_#in~cond_-1| (ite |main_#t~short23_-2| 1 0)) :named ssa_-2_LocVarAssignPendingContext))
(assert (! true :named ssa_-2_OldVarAssignPendingContext))
(check-sat)
(get-interpolants (and ssa_0 ssa_precond) ssa_1 ssa_2 (and ssa_-2_PendingContext ssa_3_return ssa_-2_LocVarAssignPendingContext ssa_-2_OldVarAssignPendingContext ssa_postcond))
...
(declare-fun __VERIFIER_assert_~cond_1 () Int)
(assert (! true :named ssa_precond))
(assert (! (not (and (<= (* (div ~CELLCOUNT~0_-2 4) 4) (+ main_~i~0_-2 2)) (= ~CELLCOUNT~0_-2 (* (div ~CELLCOUNT~0_-2 4) 4)))) :named ssa_postcond))
(assert (! (= __VERIFIER_assert_~cond_0 |__VERIFIER_assert_#in~cond_-1|) :named ssa_0))
(assert (! (not (= __VERIFIER_assert_~cond_0 0)) :named ssa_1))
(assert (! true :named ssa_2))
(assert (! true :named ssa_3_return))
(assert (! (and (<= (* (div ~CELLCOUNT~0_-2 4) 4) (+ main_~i~0_-2 2)) (= ~CELLCOUNT~0_-2 (* (div ~CELLCOUNT~0_-2 4) 4))) :named ssa_-2_PendingContext))
(assert (! (= |__VERIFIER_assert_#in~cond_-1| (ite |main_#t~short23_-2| 1 0)) :named ssa_-2_LocVarAssignPendingContext))
(assert (! true :named ssa_-2_OldVarAssignPendingContext))
(check-sat)
(get-interpolants (and ssa_0 ssa_precond) ssa_1 ssa_2 (and ssa_-2_PendingContext ssa_3_return ssa_-2_LocVarAssignPendingContext ssa_-2_OldVarAssignPendingContext ssa_postcond))
...
(declare-fun __VERIFIER_assert_~cond_1 () Int)
(assert (! true :named ssa_precond))
(assert (! (not (and (= ~CELLCOUNT~0_-2 (* (div ~CELLCOUNT~0_-2 4) 4)) (<= (* (div ~CELLCOUNT~0_-2 4) 4) (+ main_~i~0_-2 1)))) :named ssa_postcond))
(assert (! (= __VERIFIER_assert_~cond_0 |__VERIFIER_assert_#in~cond_-1|) :named ssa_0))
(assert (! (not (= __VERIFIER_assert_~cond_0 0)) :named ssa_1))
(assert (! true :named ssa_2))
(assert (! true :named ssa_3_return))
(assert (! (and (= ~CELLCOUNT~0_-2 (* (div ~CELLCOUNT~0_-2 4) 4)) (<= (* (div ~CELLCOUNT~0_-2 4) 4) (+ main_~i~0_-2 1))) :named ssa_-2_PendingContext))
(assert (! (= |__VERIFIER_assert_#in~cond_-1| (ite |main_#t~short23_-2| 1 0)) :named ssa_-2_LocVarAssignPendingContext))
(assert (! true :named ssa_-2_OldVarAssignPendingContext))
(check-sat)
(get-interpolants (and ssa_0 ssa_precond) ssa_1 ssa_2 (and ssa_-2_PendingContext ssa_3_return ssa_-2_LocVarAssignPendingContext ssa_-2_OldVarAssignPendingContext ssa_postcond))
