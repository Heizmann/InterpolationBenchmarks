...
(set-info :ultimate-id nested_4.c_AllErrorsAtOnce_Iteration5)
...
(declare-fun |main_#t~pre5_9| () Int)
(declare-fun main_~b~0_11 () Int)
(declare-fun |main_#t~pre6_11| () Int)
(declare-fun |main_#t~pre7_13| () Int)
...
(assert (! (or (not (= main_~c~0_9 6)) (not (= main_~d~0_7 6)) (not (= main_~b~0_11 6)) (not (= main_~a~0_13 6))) :named ssa_15))
