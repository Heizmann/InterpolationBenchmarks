...
(set-info :ultimate-id partial_mod_count_3.c_AllErrorsAtOnce_Iteration2)
...
(declare-fun |v_main_#t~post6_4_fresh_1| () Int)
...
(assert (! (and (= (store |#length_3| |main_~#a~0.base_4| v_ArrVal_4_fresh_1) |#length_4|) (= main_~i~0_4 0) (< |#StackHeapBarrier_-1| |main_~#a~0.base_4|) (= main_~j~0_4 0) (not (= |main_~#a~0.base_4| 0)) (= v_ArrVal_3_fresh_1 1) (= |main_~#a~0.offset_4| 0) (= (select |#valid_3| |main_~#a~0.base_4|) 0) (= (* (mod ~N~0_1 1073741824) 4) v_ArrVal_4_fresh_1) (= |#valid_4| (store |#valid_3| |main_~#a~0.base_4| v_ArrVal_3_fresh_1)) (= main_~R~0_4 3)) :named ssa_4))
...
(assert (! (and (= main_~j~0_8 (+ |v_main_#t~post6_4_fresh_1| 1)) (= main_~j~0_4 |v_main_#t~post6_4_fresh_1|) (= |main_#t~mem5_7| 0)) :named ssa_8))
