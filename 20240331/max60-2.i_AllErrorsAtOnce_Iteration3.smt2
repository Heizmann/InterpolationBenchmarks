...
(set-info :ultimate-id max60-2.i_AllErrorsAtOnce_Iteration3)
...
(assert (! (and (not (= |main_~#x~0.base_4| 0)) (= 240 v_ArrVal_18_fresh_1) (= |#length_4| (store |#length_3| |main_~#x~0.base_4| v_ArrVal_18_fresh_1)) (= v_ArrVal_17_fresh_1 1) (= (store |#valid_3| |main_~#x~0.base_4| v_ArrVal_17_fresh_1) |#valid_4|) (< |#StackHeapBarrier_-1| |main_~#x~0.base_4|) (= main_~i~1_4 0) (= (select |#valid_3| |main_~#x~0.base_4|) 0) (= |main_~#x~0.offset_4| 0)) :named ssa_4))
(assert (! (and (<= |v_main_#t~nondet5_9_fresh_1| 2147483647) (< main_~i~1_4 60) (= |v_main_#t~nondet5_9_fresh_1| v_ArrVal_20_fresh_1) (= (store (select |#memory_int#1_3| |main_~#x~0.base_4|) (+ (* main_~i~1_4 4) |main_~#x~0.offset_4|) |v_main_#t~nondet5_9_fresh_1|) v_ArrVal_19_fresh_1) (<= 0 (+ |v_main_#t~nondet5_9_fresh_1| 2147483648)) (= |#memory_int#1_5| (store |#memory_int#1_3| |main_~#x~0.base_4| v_ArrVal_19_fresh_1)) (= main_~i~1_5 (+ main_~i~1_4 1))) :named ssa_5))
(assert (! (and (<= 0 (+ |v_main_#t~nondet5_10_fresh_1| 2147483648)) (< main_~i~1_5 60) (<= |v_main_#t~nondet5_10_fresh_1| 2147483647) (= (store (select |#memory_int#1_5| |main_~#x~0.base_4|) (+ (* main_~i~1_5 4) |main_~#x~0.offset_4|) |v_main_#t~nondet5_10_fresh_1|) v_ArrVal_21_fresh_1) (= |v_main_#t~nondet5_10_fresh_1| v_ArrVal_22_fresh_1) (= |#memory_int#1_6| (store |#memory_int#1_5| |main_~#x~0.base_4| v_ArrVal_21_fresh_1)) (= main_~i~1_6 (+ main_~i~1_5 1))) :named ssa_6))
...
(assert (! (<= 60 max_~i~0_10) :named ssa_11))
(assert (! (= |max_#res_12| (ite (<= (mod max_~ret~0_10 4294967296) 2147483647) (mod max_~ret~0_10 4294967296) (+ (mod max_~ret~0_10 4294967296) (- 4294967296)))) :named ssa_12))
(assert (! (= |main_#t~ret7_13| |max_#res_12|) :named ssa_13_return))
(assert (! (and (= (select (select |#memory_int#1_6| |main_~#x~0.base_4|) |main_~#x~0.offset_4|) v_main_~temp~0_8_fresh_1) (= |main_#t~ret7_13| main_~ret~1_14) (<= |main_#t~ret7_13| 2147483647) (= v_main_~temp~0_8_fresh_1 v_ArrVal_23_fresh_1) (= (store |#memory_int#1_6| |main_~#x~0.base_4| v_ArrVal_24_fresh_1) |#memory_int#1_14|) (<= 0 (+ |main_#t~ret7_13| 2147483648)) (= (select (select |#memory_int#1_6| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4)) v_ArrVal_25_fresh_1) (= (store (store (select |#memory_int#1_6| |main_~#x~0.base_4|) |main_~#x~0.offset_4| (select (select |#memory_int#1_6| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4))) (+ |main_~#x~0.offset_4| 4) v_ArrVal_23_fresh_1) v_ArrVal_24_fresh_1)) :named ssa_14))
...
(assert (! (= |max_#res_18| |main_#t~ret10_19|) :named ssa_19_return))
(assert (! (and (<= |main_#t~ret10_19| 2147483647) (= (select (select |#memory_int#1_14| |main_~#x~0.base_4|) |main_~#x~0.offset_4|) main_~temp~0_20) (= main_~i~2_20 0) (= main_~ret2~0_20 |main_#t~ret10_19|) (<= 0 (+ |main_#t~ret10_19| 2147483648))) :named ssa_20))
(assert (! (<= 59 main_~i~2_20) :named ssa_21))
(assert (! (and (= (store |#memory_int#1_14| |main_~#x~0.base_4| v_ArrVal_27_fresh_1) |#memory_int#1_22|) (= main_~temp~0_20 v_ArrVal_26_fresh_1) (= v_ArrVal_27_fresh_1 (store (select |#memory_int#1_14| |main_~#x~0.base_4|) (+ 236 |main_~#x~0.offset_4|) v_ArrVal_26_fresh_1))) :named ssa_22))
(assert (! true :named ssa_23_GlobVarAssigCall))
(assert (! (and (= |max_#in~x.offset_23| |main_~#x~0.offset_4|) (= |max_#in~x.base_23| |main_~#x~0.base_4|)) :named ssa_23_LocVarAssigCall))
...
(assert (! (= |max_#res_26| |main_#t~ret14_27|) :named ssa_27_return))
