...
(set-info :ultimate-id parity.i_AllErrorsAtOnce_Iteration11)
...
(declare-fun v_main_~parity2~0_18_fresh_1 () Int)
...
(declare-fun |main_#t~bitwise4_3| () Int)
(declare-fun main_~v2~0_16 () Int)
(declare-fun main_~v2~0_17 () Int)
(declare-fun |main_#t~bitwise4_17| () Int)
...
(assert (! (and (= main_~v2~0_10 main_~v~0_4) (= v_main_~parity2~0_18_fresh_1 0)) :named ssa_10))
...
(assert (! (not (= (mod (div (mod main_~v2~0_13 4294967296) 4) 4294967296) 0)) :named ssa_15))
(assert (! (and (<= (mod |main_#t~bitwise4_3| 4294967296) (+ (mod main_~v2~0_13 4294967296) (mod (div (mod main_~v2~0_13 4294967296) 4) 4294967296))) (not (= (mod main_~v2~0_13 4294967296) (mod (div (mod main_~v2~0_13 4294967296) 4) 4294967296)))) :named ssa_16))
(assert (! (= main_~v2~0_17 |main_#t~bitwise4_3|) :named ssa_17))
(assert (! (and (= (mod main_~v2~0_17 4294967296) 0) (= |main_#t~bitwise5_18| 0)) :named ssa_18))
(assert (! (= main_~v2~0_19 (* 286331153 |main_#t~bitwise5_18|)) :named ssa_19))
