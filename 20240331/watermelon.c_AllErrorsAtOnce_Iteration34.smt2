...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:11:30+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id watermelon.c_AllErrorsAtOnce_Iteration34)
...
(declare-fun c_aux_v_main_~is_divisible1~0_37 () Int)
(declare-fun c_aux_v_main_~is_divisible2~0_37 () Int)
(declare-fun c_aux_v_main_~is_divisible1~0_38 () Int)
(declare-fun c_aux_v_main_~is_divisible2~0_38 () Int)
...
(declare-fun v_main_~is_divisible1~0_39_fresh_1 () Int)
(declare-fun v_main_~is_divisible2~0_39_fresh_1 () Int)
...
(declare-fun student_version_~w_35 () Int)
(declare-fun student_version_~is_divisible~1_35 () Int)
(declare-fun student_version_~i~1_36 () Int)
(declare-fun |student_version_#res_37| () Int)
(declare-fun student_version_~is_divisible~1_37 () Int)
(declare-fun |main_#t~ret6_38| () Int)
(declare-fun |student_version_#res_38| () Int)
(declare-fun |main_#t~ret6_39| () Int)
(declare-fun main_~is_divisible2~0_39 () Int)
(declare-fun |__VERIFIER_assert_#in~cond_40| () Int)
(declare-fun main_~is_divisible1~0_40 () Int)
(declare-fun main_~is_divisible2~0_40 () Int)
...
(assert (! (and (= ~true~0_1 v_main_~is_divisible1~0_39_fresh_1) (= ~true~0_1 v_main_~is_divisible2~0_39_fresh_1)) :named ssa_4))
...
(assert (! (= correct_version_~i~0_16 correct_version_~w_7) :named ssa_18))
(assert (! true :named ssa_19))
(assert (! (= |correct_version_#res_20| correct_version_~is_divisible~0_7) :named ssa_20))
...
(assert (! (and (= (+ 2 student_version_~i~1_32) student_version_~i~1_33) (< student_version_~i~1_32 student_version_~w_24)) :named ssa_33))
(assert (! (<= student_version_~w_24 student_version_~i~1_33) :named ssa_34))
(assert (! (and (not (= student_version_~w_24 student_version_~i~1_33)) (= ~false~0_1 student_version_~is_divisible~1_35)) :named ssa_35))
(assert (! true :named ssa_36))
(assert (! (= student_version_~is_divisible~1_35 |student_version_#res_37|) :named ssa_37))
(assert (! (= |main_#t~ret6_38| |student_version_#res_37|) :named ssa_38_return))
(assert (! (and (<= |main_#t~ret6_38| 2147483647) (= main_~is_divisible2~0_39 |main_#t~ret6_38|) (<= 0 (+ |main_#t~ret6_38| 2147483648))) :named ssa_39))
(assert (! true :named ssa_40_GlobVarAssigCall))
(assert (! (= (ite (= main_~is_divisible1~0_22 main_~is_divisible2~0_39) 1 0) |__VERIFIER_assert_#in~cond_40|) :named ssa_40_LocVarAssigCall))
...
(assert (! true :named ssa_precond))
(assert (! (not (and (<= main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647)) (<= (+ (* (div main_~w~0_-2 4294967296) 4294967296) 16) main_~w~0_-2))) :named ssa_postcond))
...
(assert (! (= correct_version_~i~0_9 correct_version_~w_0) :named ssa_11))
(assert (! true :named ssa_12))
(assert (! (= |correct_version_#res_13| correct_version_~is_divisible~0_0) :named ssa_13))
...
(assert (! (and (<= main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647)) (<= (+ (* (div main_~w~0_-2 4294967296) 4294967296) 16) main_~w~0_-2)) :named ssa_-2_PendingContext))
