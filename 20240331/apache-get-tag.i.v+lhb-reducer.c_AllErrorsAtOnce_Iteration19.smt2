...
(set-info :ultimate-id apache-get-tag.i.v+lhb-reducer.c_AllErrorsAtOnce_Iteration19)
...
(declare-fun v_main_~__tmp_1~0_15_fresh_1 () Int)
(declare-fun main_~__VERIFIER_assert__cond~0_8 () Int)
(declare-fun main_~__VERIFIER_assert__cond~1_8 () Int)
(declare-fun v_main_~__tmp_2~0_15_fresh_1 () Int)
(declare-fun main_~__VERIFIER_assert__cond~1_9 () Int)
(declare-fun ~__tmp_259_0~0_9 () Int)
(declare-fun main_~main____CPAchecker_TMP_0~0_9 () Int)
(declare-fun main_~main__t~0_10 () Int)
(declare-fun v_main_~main____CPAchecker_TMP_2~0_13_fresh_1 () Int)
(declare-fun v_main_~main____CPAchecker_TMP_0~0_27_fresh_1 () Int)
(declare-fun |main_#t~nondet6_11| () Int)
(declare-fun main_~main____CPAchecker_TMP_3~0_11 () Int)
(declare-fun |main_#t~nondet7_12| () Int)
(declare-fun main_~main____CPAchecker_TMP_3~0_12 () Int)
(declare-fun main_~main____CPAchecker_TMP_4~0_12 () Int)
(declare-fun main_~__VERIFIER_assert__cond~4_13 () Int)
(declare-fun main_~main____CPAchecker_TMP_4~0_13 () Int)
(declare-fun v_main_~__tmp_5~0_8_fresh_1 () Int)
(declare-fun main_~__VERIFIER_assert__cond~4_14 () Int)
(declare-fun main_~__VERIFIER_assert__cond~5_14 () Int)
(declare-fun v_main_~__tmp_6~0_7_fresh_1 () Int)
(declare-fun main_~main__t~0_15 () Int)
(declare-fun main_~__VERIFIER_assert__cond~5_15 () Int)
(declare-fun v_main_~main____CPAchecker_TMP_5~0_5_fresh_1 () Int)
(declare-fun main_~__VERIFIER_assert__cond~8_17 () Int)
(declare-fun v_main_~__tmp_9~0_6_fresh_1 () Int)
(declare-fun main_~__VERIFIER_assert__cond~9_18 () Int)
...
(assert (! (and (= v_main_~__tmp_1~0_15_fresh_1 main_~__VERIFIER_assert__cond~0_7) (not (= main_~main____CPAchecker_TMP_0~0_6 0)) (= (ite (<= 0 main_~main__t~0_5) 1 0) v_main_~__tmp_1~0_15_fresh_1)) :named ssa_7))
(assert (! (and (not (= main_~__VERIFIER_assert__cond~0_7 0)) (= v_main_~__tmp_2~0_15_fresh_1 (ite (<= main_~main__t~0_5 main_~main__tagbuf_len~0_5) 1 0)) (= v_main_~__tmp_2~0_15_fresh_1 main_~__VERIFIER_assert__cond~1_8)) :named ssa_8))
(assert (! (and (not (= main_~__VERIFIER_assert__cond~1_8 0)) (= main_~main____CPAchecker_TMP_0~0_6 ~__tmp_259_0~0_9)) :named ssa_9))
(assert (! (and (= v_main_~main____CPAchecker_TMP_2~0_13_fresh_1 main_~main__t~0_5) (= (+ main_~main__t~0_5 1) main_~main__t~0_10) (= ~__tmp_259_0~0_9 v_main_~main____CPAchecker_TMP_0~0_27_fresh_1)) :named ssa_10))
(assert (! (and (not (= main_~main__t~0_10 main_~main__tagbuf_len~0_5)) (<= main_~main____CPAchecker_TMP_3~0_11 2147483647) (<= 0 (+ main_~main____CPAchecker_TMP_3~0_11 2147483648))) :named ssa_11))
(assert (! (and (not (= main_~main____CPAchecker_TMP_3~0_11 0)) (<= main_~main____CPAchecker_TMP_4~0_12 2147483647) (<= 0 (+ main_~main____CPAchecker_TMP_4~0_12 2147483648))) :named ssa_12))
(assert (! (and (= v_main_~__tmp_5~0_8_fresh_1 (ite (<= 0 main_~main__t~0_10) 1 0)) (not (= main_~main____CPAchecker_TMP_4~0_12 0)) (= v_main_~__tmp_5~0_8_fresh_1 main_~__VERIFIER_assert__cond~4_13)) :named ssa_13))
(assert (! (and (not (= main_~__VERIFIER_assert__cond~4_13 0)) (= (ite (<= main_~main__t~0_10 main_~main__tagbuf_len~0_5) 1 0) v_main_~__tmp_6~0_7_fresh_1) (= v_main_~__tmp_6~0_7_fresh_1 main_~__VERIFIER_assert__cond~5_14)) :named ssa_14))
(assert (! (and (not (= main_~__VERIFIER_assert__cond~5_14 0)) (= v_main_~main____CPAchecker_TMP_5~0_5_fresh_1 main_~main__t~0_10) (= main_~main__t~0_15 (+ main_~main__t~0_10 1))) :named ssa_15))
(assert (! (not (= main_~main__t~0_15 main_~main__tagbuf_len~0_5)) :named ssa_16))
(assert (! (and (= v_main_~__tmp_9~0_6_fresh_1 (ite (<= 0 main_~main__t~0_15) 1 0)) (= v_main_~__tmp_9~0_6_fresh_1 main_~__VERIFIER_assert__cond~8_17)) :named ssa_17))
(assert (! (and (= v_main_~__tmp_10~0_5_fresh_1 (ite (<= main_~main__t~0_15 main_~main__tagbuf_len~0_5) 1 0)) (= v_main_~__tmp_10~0_5_fresh_1 main_~__VERIFIER_assert__cond~9_18) (not (= main_~__VERIFIER_assert__cond~8_17 0))) :named ssa_18))
(assert (! (= main_~__VERIFIER_assert__cond~9_18 0) :named ssa_19))
