...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-30T23:51:05+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id condg.c_AllErrorsAtOnce_Iteration15)
...
(declare-fun |main_#t~post9_16| () Int)
...
(declare-fun |main_#t~mem11_21| () Int)
...
(declare-fun |main_#t~post13_22| () Int)
...
(declare-fun |main_#t~post15_34| () Int)
...
(assert (! (and (< |#StackHeapBarrier_-1| |main_~#sum~0.base_11|) (= (select |#valid_3| |main_~#sum~0.base_11|) 0) (not (= |main_~#sum~0.base_11| 0)) (< main_~a~0.base_11 |#StackHeapBarrier_-1|) (= main_~i~0_11 0) (= v_ArrVal_235_fresh_1 4) (= (store |#memory_int#1_3| |main_~#sum~0.base_11| v_ArrVal_233_fresh_1) |#memory_int#1_11|) (= v_ArrVal_238_fresh_1 1) (= v_ArrVal_237_fresh_1 (* (mod ~N~0_4 1073741824) 4)) (= (store (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_238_fresh_1) main_~a~0.base_11 v_ArrVal_234_fresh_1) |#valid_11|) (= |main_~#sum~0.offset_11| 0) (= (store (store |#length_3| |main_~#sum~0.base_11| v_ArrVal_235_fresh_1) main_~a~0.base_11 v_ArrVal_237_fresh_1) |#length_11|) (= main_~a~0.offset_11 0) (not (= main_~a~0.base_11 0)) (= v_ArrVal_234_fresh_1 1) (= (select (store |#valid_3| |main_~#sum~0.base_11| v_ArrVal_238_fresh_1) main_~a~0.base_11) 0) (= v_ArrVal_233_fresh_1 (store (select |#memory_int#1_3| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| 0)) (= v_ArrVal_236_fresh_1 0)) :named ssa_11))
(assert (! (and (= v_ArrVal_240_fresh_1 1) (= main_~i~0_12 (+ main_~i~0_11 1)) (= |#memory_int#3_12| (store |#memory_int#3_3| main_~a~0.base_11 v_ArrVal_239_fresh_1)) (= v_ArrVal_239_fresh_1 (store (select |#memory_int#3_3| main_~a~0.base_11) (+ (* main_~i~0_11 4) main_~a~0.offset_11) 1)) (< main_~i~0_11 ~N~0_4)) :named ssa_12))
(assert (! (and (= v_ArrVal_241_fresh_1 (store (select |#memory_int#3_12| main_~a~0.base_11) (+ (* main_~i~0_12 4) main_~a~0.offset_11) 1)) (= main_~i~0_13 (+ main_~i~0_12 1)) (= (store |#memory_int#3_12| main_~a~0.base_11 v_ArrVal_241_fresh_1) |#memory_int#3_13|) (= v_ArrVal_242_fresh_1 1) (< main_~i~0_12 ~N~0_4)) :named ssa_13))
(assert (! (<= ~N~0_4 main_~i~0_13) :named ssa_14))
(assert (! (= main_~i~0_15 0) :named ssa_15))
(assert (! (and (= v_ArrVal_244_fresh_1 (+ (select (select |#memory_int#3_13| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_15 4))) (select (select |#memory_int#1_11| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|))) (< main_~i~0_15 ~N~0_4) (= |#memory_int#1_16| (store |#memory_int#1_11| |main_~#sum~0.base_11| v_ArrVal_243_fresh_1)) (= main_~i~0_16 (+ main_~i~0_15 1)) (= v_ArrVal_243_fresh_1 (store (select |#memory_int#1_11| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| (+ (select (select |#memory_int#3_13| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_15 4))) (select (select |#memory_int#1_11| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|))))) :named ssa_16))
(assert (! (and (= (store |#memory_int#1_16| |main_~#sum~0.base_11| v_ArrVal_245_fresh_1) |#memory_int#1_17|) (< main_~i~0_16 ~N~0_4) (= v_ArrVal_245_fresh_1 (store (select |#memory_int#1_16| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11| (+ (select (select |#memory_int#3_13| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_16 4))) (select (select |#memory_int#1_16| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|)))) (= v_ArrVal_246_fresh_1 (+ (select (select |#memory_int#3_13| main_~a~0.base_11) (+ main_~a~0.offset_11 (* main_~i~0_16 4))) (select (select |#memory_int#1_16| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|))) (= main_~i~0_17 (+ main_~i~0_16 1))) :named ssa_17))
(assert (! (<= ~N~0_4 main_~i~0_17) :named ssa_18))
(assert (! (= main_~i~0_19 0) :named ssa_19))
(assert (! (and (< main_~i~0_19 ~N~0_4) (= |main_#t~mem10_20| (select (select |#memory_int#1_17| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|))) :named ssa_20))
(assert (! (and (= (store |#memory_int#3_13| main_~a~0.base_11 v_ArrVal_248_fresh_1) |#memory_int#3_21|) (= (+ v_ArrVal_247_fresh_1 1) (select (select |#memory_int#3_13| main_~a~0.base_11) (+ (* main_~i~0_19 4) main_~a~0.offset_11))) (= (store (select |#memory_int#3_13| main_~a~0.base_11) (+ (* main_~i~0_19 4) main_~a~0.offset_11) v_ArrVal_247_fresh_1) v_ArrVal_248_fresh_1) (= |main_#t~mem10_20| ~N~0_4)) :named ssa_21))
(assert (! (= main_~i~0_22 (+ main_~i~0_19 1)) :named ssa_22))
(assert (! (and (< main_~i~0_22 ~N~0_4) (= |main_#t~mem10_23| (select (select |#memory_int#1_17| |main_~#sum~0.base_11|) |main_~#sum~0.offset_11|))) :named ssa_23))
(assert (! (and (= (store |#memory_int#3_21| main_~a~0.base_11 v_ArrVal_250_fresh_1) |#memory_int#3_24|) (= (+ v_ArrVal_249_fresh_1 1) (select (select |#memory_int#3_21| main_~a~0.base_11) (+ (* main_~i~0_22 4) main_~a~0.offset_11))) (= v_ArrVal_250_fresh_1 (store (select |#memory_int#3_21| main_~a~0.base_11) (+ (* main_~i~0_22 4) main_~a~0.offset_11) v_ArrVal_249_fresh_1)) (= |main_#t~mem10_23| ~N~0_4)) :named ssa_24))
(assert (! (= main_~i~0_25 (+ main_~i~0_22 1)) :named ssa_25))
(assert (! (<= ~N~0_4 main_~i~0_25) :named ssa_26))
(assert (! (= main_~i~0_27 0) :named ssa_27))
(assert (! (and (< main_~i~0_27 ~N~0_4) (= |main_#t~mem14_28| (select (select |#memory_int#3_24| main_~a~0.base_11) (+ (* main_~i~0_27 4) main_~a~0.offset_11)))) :named ssa_28))
(assert (! true :named ssa_29_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_29| (ite (= |main_#t~mem14_28| 0) 1 0)) :named ssa_29_LocVarAssigCall))
(assert (! true :named ssa_29_OldVarAssigCall))
(assert (! (= __VERIFIER_assert_~cond_30 |__VERIFIER_assert_#in~cond_29|) :named ssa_30))
(assert (! (not (= __VERIFIER_assert_~cond_30 0)) :named ssa_31))
(assert (! true :named ssa_32))
(assert (! true :named ssa_33_return))
(assert (! (= main_~i~0_34 (+ main_~i~0_27 1)) :named ssa_34))
(assert (! (and (< main_~i~0_34 ~N~0_4) (= |main_#t~mem14_35| (select (select |#memory_int#3_24| main_~a~0.base_11) (+ (* main_~i~0_34 4) main_~a~0.offset_11)))) :named ssa_35))
(assert (! true :named ssa_36_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_36| (ite (= |main_#t~mem14_35| 0) 1 0)) :named ssa_36_LocVarAssigCall))
