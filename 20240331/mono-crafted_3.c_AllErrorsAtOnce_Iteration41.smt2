...
(set-info :ultimate-id mono-crafted_3.c_AllErrorsAtOnce_Iteration41)
...
(declare-fun |v_main_#t~post4_77_fresh_1| () Int)
(declare-fun main_~x~0_8 () Int)
(declare-fun |v_main_#t~post4_78_fresh_1| () Int)
...
(assert (! (and (= main_~x~0_4 |v_main_#t~post4_77_fresh_1|) (< main_~x~0_4 500000) (= main_~x~0_6 (+ |v_main_#t~post4_77_fresh_1| 1))) :named ssa_6))
(assert (! (< main_~x~0_6 1000000) :named ssa_7))
(assert (! (and (= main_~x~0_6 |v_main_#t~post4_78_fresh_1|) (< main_~x~0_6 500000) (= main_~x~0_8 (+ |v_main_#t~post4_78_fresh_1| 1))) :named ssa_8))
...
(assert (! (<= main_~y~0_46 0) :named ssa_47))
(assert (! true :named ssa_48_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_48| (ite (= main_~x~0_46 main_~z~0_46) 1 0)) :named ssa_48_LocVarAssigCall))
