...
(set-info :ultimate-id watermelon.c_AllErrorsAtOnce_Iteration28)
...
(declare-fun v_main_~is_divisible2~0_33_fresh_1 () Int)
(declare-fun v_main_~is_divisible1~0_33_fresh_1 () Int)
...
(assert (! (and (= ~true~0_1 v_main_~is_divisible1~0_33_fresh_1) (= ~true~0_1 v_main_~is_divisible2~0_33_fresh_1)) :named ssa_4))
...
(assert (! (and (= (+ 2 student_version_~i~1_29) student_version_~i~1_30) (< student_version_~i~1_29 student_version_~w_22)) :named ssa_30))
(assert (! (<= student_version_~w_22 student_version_~i~1_30) :named ssa_31))
(assert (! (and (not (= student_version_~w_22 student_version_~i~1_30)) (= ~false~0_1 student_version_~is_divisible~1_32)) :named ssa_32))
(assert (! true :named ssa_33))
(assert (! (= student_version_~is_divisible~1_32 |student_version_#res_34|) :named ssa_34))
...
(assert (! (= (ite (= main_~is_divisible1~0_20 main_~is_divisible2~0_36) 1 0) |__VERIFIER_assert_#in~cond_37|) :named ssa_37_LocVarAssigCall))
...
(assert (! true :named ssa_precond))
(assert (! (not (or (< (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647) main_~w~0_-2) (< main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 13)))) :named ssa_postcond))
...
(assert (! (or (< (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647) main_~w~0_-2) (< main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 13))) :named ssa_-2_PendingContext))
