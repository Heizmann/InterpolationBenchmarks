...
(set-info :ultimate-id duplets.c_AllErrorsAtOnce_Iteration1)
...
(declare-fun v_mkdup_~x~0_5_fresh_1 () Int)
...
(assert (! (and (not (= 0 |main_#t~malloc13.base_10|)) (< |main_#t~malloc13.base_10| |#StackHeapBarrier_-1|) (= |main_#t~malloc13.offset_10| 0) (= v_ArrVal_2_fresh_1 1) (= (* 4 (mod main_~n~0_4 1073741824)) v_ArrVal_1_fresh_1) (= |#valid_10| (store |#valid_3| |main_#t~malloc13.base_10| v_ArrVal_2_fresh_1)) (= (select |#valid_3| |main_#t~malloc13.base_10|) 0) (= (store |#length_3| |main_#t~malloc13.base_10| v_ArrVal_1_fresh_1) |#length_10|)) :named ssa_10))
(assert (! (= |old(#memory_int#2)_11| |#memory_int#2_11|) :named ssa_11_GlobVarAssigCall))
(assert (! (and (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_3_fresh_1|) (= |v_#Ultimate.meminit_#ptr.offsetInParam_3_fresh_1| |main_#t~malloc13.offset_10|) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_3_fresh_1| 4) (= |v_#Ultimate.meminit_#productInParam_3_fresh_1| (* main_~n~0_4 4)) (= |#Ultimate.meminit_#ptr.base_11| |main_#t~malloc13.base_10|)) :named ssa_11_LocVarAssigCall))
...
(assert (! (and (<= 0 (+ v_mkdup_~x~0_5_fresh_1 2147483648)) (= |#memory_int#2_32| (store |#memory_int#2_15| mkdup_~a.base_16 v_ArrVal_6_fresh_1)) (= v_mkdup_~x~0_5_fresh_1 v_ArrVal_5_fresh_1) (= (store (store (select |#memory_int#2_15| mkdup_~a.base_16) (+ (* mkdup_~i~0_16 4) mkdup_~a.offset_16) v_ArrVal_5_fresh_1) (+ mkdup_~a.offset_16 (* mkdup_~j~0_16 4)) v_ArrVal_4_fresh_1) v_ArrVal_6_fresh_1) (= v_mkdup_~x~0_5_fresh_1 v_ArrVal_4_fresh_1) (<= v_mkdup_~x~0_5_fresh_1 2147483647)) :named ssa_32))
(assert (! true :named ssa_33_return))
(assert (! (and (= |main_~#i~2.offset_34| 0) (= v_ArrVal_8_fresh_1 1) (= 4 v_ArrVal_9_fresh_1) (= (select |#valid_10| |main_~#i~2.base_34|) 0) (= |main_~#j~2.offset_34| 0) (not (= |main_~#j~2.base_34| 0)) (= (select (store |#valid_10| |main_~#i~2.base_34| v_ArrVal_8_fresh_1) |main_~#j~2.base_34|) 0) (< |#StackHeapBarrier_-1| |main_~#j~2.base_34|) (= |#length_34| (store (store |#length_10| |main_~#i~2.base_34| v_ArrVal_7_fresh_1) |main_~#j~2.base_34| v_ArrVal_9_fresh_1)) (not (= |main_~#i~2.base_34| 0)) (= v_ArrVal_10_fresh_1 1) (< |#StackHeapBarrier_-1| |main_~#i~2.base_34|) (= |#valid_34| (store (store |#valid_10| |main_~#i~2.base_34| v_ArrVal_8_fresh_1) |main_~#j~2.base_34| v_ArrVal_10_fresh_1)) (= 4 v_ArrVal_7_fresh_1)) :named ssa_34))
...
(assert (! (not false) :named ssa_postcond))
(assert (! (and (= |#memory_int#2_0| (store |#memory_int#2_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_11_fresh_1)) (= ((as const (Array Int Int)) 0) v_ArrVal_11_fresh_1)) :named ssa_0))
(assert (! true :named ssa_1_return))
...
(declare-fun mkdup_~a.base_16 () Int)
(declare-fun mkdup_~i~0_16 () Int)
(declare-fun v_mkdup_~x~0_6_fresh_1 () Int)
...
(assert (! (and (= |#memory_int#2_16| (store |#memory_int#2_-1| mkdup_~a.base_0 v_ArrVal_13_fresh_1)) (= v_mkdup_~x~0_6_fresh_1 v_ArrVal_12_fresh_1) (<= 0 (+ v_mkdup_~x~0_6_fresh_1 2147483648)) (<= v_mkdup_~x~0_6_fresh_1 2147483647) (= (store (store (select |#memory_int#2_-1| mkdup_~a.base_0) (+ (* mkdup_~i~0_0 4) mkdup_~a.offset_0) v_mkdup_~x~0_6_fresh_1) (+ mkdup_~a.offset_0 (* mkdup_~j~0_0 4)) v_ArrVal_12_fresh_1) v_ArrVal_13_fresh_1) (= v_mkdup_~x~0_6_fresh_1 v_ArrVal_14_fresh_1)) :named ssa_16))
