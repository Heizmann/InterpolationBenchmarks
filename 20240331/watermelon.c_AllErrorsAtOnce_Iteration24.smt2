...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:11:26+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id watermelon.c_AllErrorsAtOnce_Iteration24)
...
(declare-fun v_main_~is_divisible1~0_29_fresh_1 () Int)
(declare-fun v_main_~is_divisible2~0_29_fresh_1 () Int)
...
(declare-fun student_version_~w_30 () Int)
...
(declare-fun student_version_~is_divisible~1_32 () Int)
(declare-fun |main_#t~ret6_33| () Int)
(declare-fun |student_version_#res_33| () Int)
(declare-fun |main_#t~ret6_34| () Int)
(declare-fun main_~is_divisible2~0_34 () Int)
(declare-fun |__VERIFIER_assert_#in~cond_35| () Int)
(declare-fun main_~is_divisible1~0_35 () Int)
(declare-fun main_~is_divisible2~0_35 () Int)
...
(assert (! (and (= ~true~0_1 v_main_~is_divisible2~0_29_fresh_1) (= ~true~0_1 v_main_~is_divisible1~0_29_fresh_1)) :named ssa_4))
...
(assert (! (and (= (+ 2 student_version_~i~1_27) student_version_~i~1_28) (< student_version_~i~1_27 student_version_~w_21)) :named ssa_28))
(assert (! (<= student_version_~w_21 student_version_~i~1_28) :named ssa_29))
(assert (! (and (not (= student_version_~w_21 student_version_~i~1_28)) (= ~false~0_1 student_version_~is_divisible~1_30)) :named ssa_30))
(assert (! true :named ssa_31))
(assert (! (= student_version_~is_divisible~1_30 |student_version_#res_32|) :named ssa_32))
(assert (! (= |main_#t~ret6_33| |student_version_#res_32|) :named ssa_33_return))
(assert (! (and (<= |main_#t~ret6_33| 2147483647) (= main_~is_divisible2~0_34 |main_#t~ret6_33|) (<= 0 (+ |main_#t~ret6_33| 2147483648))) :named ssa_34))
(assert (! true :named ssa_35_GlobVarAssigCall))
(assert (! (= (ite (= main_~is_divisible1~0_19 main_~is_divisible2~0_34) 1 0) |__VERIFIER_assert_#in~cond_35|) :named ssa_35_LocVarAssigCall))
...
(assert (! true :named ssa_precond))
(assert (! (not (or (< main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 11)) (< (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647) main_~w~0_-2))) :named ssa_postcond))
...
(assert (! (and (not (= student_version_~w_0 student_version_~i~1_7)) (= ~false~0_-1 student_version_~is_divisible~1_9)) :named ssa_9))
(assert (! true :named ssa_10))
(assert (! (= student_version_~is_divisible~1_9 |student_version_#res_11|) :named ssa_11))
(assert (! (= |main_#t~ret6_12| |student_version_#res_11|) :named ssa_12_return))
(assert (! (or (< main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 11)) (< (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647) main_~w~0_-2)) :named ssa_-2_PendingContext))
