...
(set-info :ultimate-id prefixsum_iter.c_AllErrorsAtOnce_Iteration1)
...
(assert (! (and (not (= |main_#t~malloc15.base_21| 0)) (< |main_#t~malloc15.base_21| |#StackHeapBarrier_-1|) (= |main_#t~malloc15.offset_21| 0) (= v_ArrVal_1_fresh_1 1) (= (store |#valid_3| |main_#t~malloc15.base_21| v_ArrVal_1_fresh_1) |#valid_21|) (= (store |#length_3| |main_#t~malloc15.base_21| v_ArrVal_2_fresh_1) |#length_21|) (= v_ArrVal_2_fresh_1 (* (mod main_~n~0_4 1073741824) 4)) (= (select |#valid_3| |main_#t~malloc15.base_21|) 0)) :named ssa_21))
(assert (! (= |old(#memory_int#1)_22| |#memory_int#1_22|) :named ssa_22_GlobVarAssigCall))
(assert (! (and (= |#Ultimate.meminit_#ptr.base_22| |main_#t~malloc15.base_21|) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_5_fresh_1|) (= |v_#Ultimate.meminit_#productInParam_5_fresh_1| (* main_~n~0_4 4)) (= |v_#Ultimate.meminit_#ptr.offsetInParam_5_fresh_1| |main_#t~malloc15.offset_21|) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_5_fresh_1| 4)) :named ssa_22_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_22| |#memory_int#1_3|) :named ssa_22_OldVarAssigCall))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_3_fresh_1) (= (store |#memory_int#1_22| |#Ultimate.meminit_#ptr.base_22| v_ArrVal_3_fresh_1) |#memory_int#1_23|)) :named ssa_23))
(assert (! true :named ssa_24_return))
(assert (! (and (= (select |#valid_21| |main_#t~malloc16.base_25|) 0) (= v_ArrVal_4_fresh_1 1) (= |#length_25| (store |#length_21| |main_#t~malloc16.base_25| v_ArrVal_5_fresh_1)) (not (= |main_#t~malloc16.base_25| 0)) (= (* (mod main_~n~0_4 1073741824) 4) v_ArrVal_5_fresh_1) (= |#valid_25| (store |#valid_21| |main_#t~malloc16.base_25| v_ArrVal_4_fresh_1)) (= |main_#t~malloc16.offset_25| 0) (= main_~a~0.offset_25 |main_#t~malloc15.offset_21|) (= main_~a~0.base_25 |main_#t~malloc15.base_21|) (< |main_#t~malloc16.base_25| |#StackHeapBarrier_-1|)) :named ssa_25))
(assert (! (= |old(#memory_int#1)_26| |#memory_int#1_26|) :named ssa_26_GlobVarAssigCall))
(assert (! (and (= |v_#Ultimate.meminit_#productInParam_6_fresh_1| (* main_~n~0_4 4)) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_6_fresh_1|) (= |main_#t~malloc16.offset_25| |v_#Ultimate.meminit_#ptr.offsetInParam_6_fresh_1|) (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_6_fresh_1| 4) (= |#Ultimate.meminit_#ptr.base_26| |main_#t~malloc16.base_25|)) :named ssa_26_LocVarAssigCall))
(assert (! (= |old(#memory_int#1)_26| |#memory_int#1_23|) :named ssa_26_OldVarAssigCall))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_6_fresh_1) (= |#memory_int#1_27| (store |#memory_int#1_26| |#Ultimate.meminit_#ptr.base_26| v_ArrVal_6_fresh_1))) :named ssa_27))
...
(assert (! (and (= (store (select |#memory_int#1_37| downsweep_~a.base_38) (+ downsweep_~a.offset_38 (- 4) (* downsweep_~n_38 4)) v_ArrVal_7_fresh_1) v_ArrVal_8_fresh_1) (= downsweep_~space_38 (ite (and (not (= (mod |downsweep_#in~space_37| 2) 0)) (< |downsweep_#in~space_37| 0)) (+ (div |downsweep_#in~space_37| 2) 1) (div |downsweep_#in~space_37| 2))) (= downsweep_~a.base_38 |downsweep_#in~a.base_37|) (= v_ArrVal_7_fresh_1 0) (= downsweep_~a.offset_38 |downsweep_#in~a.offset_37|) (= |#memory_int#1_38| (store |#memory_int#1_37| downsweep_~a.base_38 v_ArrVal_8_fresh_1)) (= downsweep_~n_38 |downsweep_#in~n_37|)) :named ssa_38))
...
(assert (! (not false) :named ssa_postcond))
(assert (! (and (= |#memory_int#1_0| (store |#memory_int#1_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_9_fresh_1)) (= ((as const (Array Int Int)) 0) v_ArrVal_9_fresh_1)) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! false :named ssa_-2_PendingContext))
...
(assert (! (= |#memory_int#1_-1| |old(#memory_int#1)_-1|) :named ssa_precond))
(assert (! (not false) :named ssa_postcond))
(assert (! (and (= (store |#memory_int#1_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_10_fresh_1) |#memory_int#1_0|) (= ((as const (Array Int Int)) 0) v_ArrVal_10_fresh_1)) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! false :named ssa_-2_PendingContext))
...
(assert (! (= |#memory_int#1_-1| |old(#memory_int#1)_-1|) :named ssa_precond))
(assert (! (not false) :named ssa_postcond))
(assert (! (and (= downsweep_~space_0 (ite (and (not (= (mod |downsweep_#in~space_-1| 2) 0)) (< |downsweep_#in~space_-1| 0)) (+ (div |downsweep_#in~space_-1| 2) 1) (div |downsweep_#in~space_-1| 2))) (= |#memory_int#1_0| (store |#memory_int#1_-1| downsweep_~a.base_0 v_ArrVal_12_fresh_1)) (= downsweep_~a.base_0 |downsweep_#in~a.base_-1|) (= v_ArrVal_11_fresh_1 0) (= downsweep_~a.offset_0 |downsweep_#in~a.offset_-1|) (= (store (select |#memory_int#1_-1| downsweep_~a.base_0) (+ downsweep_~a.offset_0 (- 4) (* downsweep_~n_0 4)) v_ArrVal_11_fresh_1) v_ArrVal_12_fresh_1) (= downsweep_~n_0 |downsweep_#in~n_-1|)) :named ssa_0))
