...
(set-info :ultimate-id array2_pattern.c_AllErrorsAtOnce_Iteration1)
...
(declare-fun main_~count~0_13 () Int)
(declare-fun main_~count~0_14 () Int)
...
(assert (! (and (= (store (store |#length_3| |main_~#array1~0.base_10| v_ArrVal_2_fresh_1) |main_~#array2~0.base_10| v_ArrVal_1_fresh_1) |#length_10|) (< |#StackHeapBarrier_-1| |main_~#array1~0.base_10|) (not (= |main_~#array2~0.base_10| 0)) (= v_ArrVal_4_fresh_1 1) (= main_~count~0_10 0) (= v_ArrVal_1_fresh_1 (* (mod ~ARR_SIZE~0_4 1073741824) 4)) (= |#valid_10| (store (store |#valid_3| |main_~#array1~0.base_10| v_ArrVal_3_fresh_1) |main_~#array2~0.base_10| v_ArrVal_4_fresh_1)) (= v_ArrVal_3_fresh_1 1) (= (+ main_~num~0_10 1) 0) (not (= |main_~#array1~0.base_10| 0)) (= (select |#valid_3| |main_~#array1~0.base_10|) 0) (= 0 main_~sum~0_10) (= |main_~#array2~0.offset_10| 0) (= (select (store |#valid_3| |main_~#array1~0.base_10| v_ArrVal_3_fresh_1) |main_~#array2~0.base_10|) 0) (< |#StackHeapBarrier_-1| |main_~#array2~0.base_10|) (= v_ArrVal_2_fresh_1 (* (mod ~ARR_SIZE~0_4 1073741824) 4)) (= |main_~#array1~0.offset_10| 0)) :named ssa_10))
(assert (! (<= ~ARR_SIZE~0_4 main_~count~0_10) :named ssa_11))
(assert (! false :named ssa_12))
(assert (! (= main_~count~0_13 0) :named ssa_13))
(assert (! (<= ~ARR_SIZE~0_4 main_~count~0_13) :named ssa_14))
(assert (! true :named ssa_15_GlobVarAssigCall))
(assert (! (= (ite (= 0 main_~sum~0_10) 1 0) |__VERIFIER_assert_#in~cond_15|) :named ssa_15_LocVarAssigCall))
...
(declare-fun |old(~ARR_SIZE~0)_-2| () Int)
(declare-fun |old(#memory_int#1)_-2| () (Array Int (Array Int Int)))
(declare-fun |old(~ARR_SIZE~0)_-1| () Int)
(declare-fun ~ARR_SIZE~0_-1 () Int)
(declare-fun |#StackHeapBarrier_-1| () Int)
(declare-fun ~ARR_SIZE~0_0 () Int)
(assert (! (= |old(~ARR_SIZE~0)_-1| ~ARR_SIZE~0_-1) :named ssa_precond))
(assert (! (not true) :named ssa_postcond))
(assert (! (and (= (select |#length_-2| 2) 17) (< 0 |#StackHeapBarrier_-1|) (= ~ARR_SIZE~0_0 0) (= (select |#valid_-2| 0) 0) (= 2 (select |#length_-2| 1)) (= (select |#valid_-2| 3) 1) (= (select (select |#memory_int#0_-2| 1) 1) 0) (= (select |#valid_-2| 1) 1) (= (select |#valid_-2| 2) 1) (= (select (select |#memory_int#0_-2| 1) 0) 48) (= (select |#length_-2| 3) 12)) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! true :named ssa_-2_PendingContext))
(assert (! true :named ssa_-2_LocVarAssignPendingContext))
(assert (! (= ~ARR_SIZE~0_-2 |old(~ARR_SIZE~0)_-1|) :named ssa_-2_OldVarAssignPendingContext))
(check-sat)
...
(assert (! true :named ssa_-2_PendingContext))
(assert (! (= |assume_abort_if_not_#in~cond_-1| (ite (< 0 ~ARR_SIZE~0_-2) 1 0)) :named ssa_-2_LocVarAssignPendingContext))
