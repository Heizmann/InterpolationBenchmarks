...
(set-info :ultimate-id nested_4.c_AllErrorsAtOnce_Iteration10)
...
(declare-fun |main_#t~pre5_40| () Int)
...
(declare-fun main_~c~0_58 () Int)
(declare-fun |main_#t~pre5_58| () Int)
(declare-fun main_~b~0_60 () Int)
(declare-fun |main_#t~pre6_60| () Int)
(declare-fun |main_#t~pre7_62| () Int)
(declare-fun main_~a~0_62 () Int)
(declare-fun main_~c~0_64 () Int)
(declare-fun main_~d~0_64 () Int)
(declare-fun main_~b~0_64 () Int)
(declare-fun main_~a~0_64 () Int)
...
(assert (! (and (= main_~b~0_34 0) (< main_~a~0_33 6)) :named ssa_34))
(assert (! (and (< main_~b~0_34 6) (= main_~c~0_35 0)) :named ssa_35))
(assert (! (and (< main_~c~0_35 6) (= main_~d~0_36 0)) :named ssa_36))
...
(assert (! (= main_~c~0_40 (+ main_~c~0_35 1)) :named ssa_40))
(assert (! (and (< main_~c~0_40 6) (= main_~d~0_41 0)) :named ssa_41))
...
(assert (! (= main_~c~0_45 (+ main_~c~0_40 1)) :named ssa_45))
(assert (! (<= 6 main_~c~0_45) :named ssa_46))
(assert (! (= (+ main_~b~0_34 1) main_~b~0_47) :named ssa_47))
(assert (! (and (< main_~b~0_47 6) (= main_~c~0_48 0)) :named ssa_48))
(assert (! (and (< main_~c~0_48 6) (= main_~d~0_49 0)) :named ssa_49))
...
(assert (! (<= 6 main_~d~0_51) :named ssa_52))
(assert (! (= main_~c~0_53 (+ main_~c~0_48 1)) :named ssa_53))
(assert (! (and (< main_~c~0_53 6) (= main_~d~0_54 0)) :named ssa_54))
