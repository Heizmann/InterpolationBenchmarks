...
(set-info :ultimate-id partial_lesser_bound-1.i_AllErrorsAtOnce_Iteration2)
...
(assert (! (and (< 0 |#StackHeapBarrier_-1|) (= |~#a~0.offset_1| 0) (= ((as const (Array Int Int)) 0) v_ArrVal_3_fresh_1) (= |~#a~0.base_1| 3) (= (select (select |#memory_int#0_0| 1) 1) 0) (= 40000000 (select |#length_-1| 3)) (= (select |#length_-1| 2) 25) (= (select |#valid_-1| 3) 1) (= (select |#valid_-1| 2) 1) (= (select (select |#memory_int#0_0| 1) 0) 48) (= ~i~0_1 0) (= (select |#valid_-1| 1) 1) (= (select |#length_-1| 1) 2) (= (store |#memory_int#1_0| |~#a~0.base_1| v_ArrVal_3_fresh_1) |#memory_int#1_1|) (= (select |#valid_-1| 0) 0)) :named ssa_1))
...
(assert (! (<= 10000000 ~i~0_4) :named ssa_5))
(assert (! (= ~i~0_6 0) :named ssa_6))
(assert (! (<= 5000000 ~i~0_6) :named ssa_7))
(assert (! (= ~i~0_8 0) :named ssa_8))
(assert (! (and (< ~i~0_8 5000000) (= (select (select |#memory_int#1_3| |~#a~0.base_1|) (+ |~#a~0.offset_1| (* 4 ~i~0_8))) |main_#t~mem3_9|)) :named ssa_9))
(assert (! true :named ssa_10_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_10| (ite (= |main_#t~mem3_9| 10) 1 0)) :named ssa_10_LocVarAssigCall))
...
(assert (! (and (< 0 |#StackHeapBarrier_-1|) (= |~#a~0.offset_0| 0) (= |~#a~0.base_0| 3) (= (select (select |#memory_int#0_-1| 1) 1) 0) (= ((as const (Array Int Int)) 0) v_ArrVal_4_fresh_1) (= (store |#memory_int#1_-1| |~#a~0.base_0| v_ArrVal_4_fresh_1) |#memory_int#1_0|) (= 40000000 (select |#length_-1| 3)) (= (select |#length_-1| 2) 25) (= (select |#valid_-1| 3) 1) (= (select |#valid_-1| 2) 1) (= (select (select |#memory_int#0_-1| 1) 0) 48) (= ~i~0_0 0) (= (select |#valid_-1| 1) 1) (= (select |#length_-1| 1) 2) (= (select |#valid_-1| 0) 0)) :named ssa_0))
