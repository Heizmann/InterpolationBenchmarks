...
(set-info :ultimate-id array_init_pair_symmetr.c_AllErrorsAtOnce_Iteration2)
...
(assert (! (and (= (store (select |#memory_int#1_3| |main_~#b~0.base_4|) (+ |main_~#b~0.offset_4| (* main_~i~0_4 4)) (- main_~x~0_5)) v_ArrVal_13_fresh_1) (= (store |#memory_int#1_3| |main_~#b~0.base_4| v_ArrVal_13_fresh_1) |#memory_int#1_11|) (= (store |#memory_int#2_3| |main_~#a~0.base_4| v_ArrVal_15_fresh_1) |#memory_int#2_11|) (= (store (select |#memory_int#2_3| |main_~#a~0.base_4|) (+ (* main_~i~0_4 4) |main_~#a~0.offset_4|) main_~x~0_5) v_ArrVal_15_fresh_1) (= (+ main_~x~0_5 v_ArrVal_14_fresh_1) 0) (= main_~x~0_5 v_ArrVal_16_fresh_1) (= main_~i~0_11 (+ main_~i~0_4 1))) :named ssa_11))
(assert (! (<= ~N~0_1 main_~i~0_11) :named ssa_12))
(assert (! (= main_~i~0_13 0) :named ssa_13))
(assert (! (and (= (store |#memory_int#3_3| |main_~#c~0.base_4| v_ArrVal_18_fresh_1) |#memory_int#3_14|) (= (+ (select (select |#memory_int#1_11| |main_~#b~0.base_4|) (+ (* main_~i~0_13 4) |main_~#b~0.offset_4|)) (select (select |#memory_int#2_11| |main_~#a~0.base_4|) (+ (* main_~i~0_13 4) |main_~#a~0.offset_4|))) v_ArrVal_17_fresh_1) (= main_~i~0_14 (+ main_~i~0_13 1)) (< main_~i~0_13 ~N~0_1) (= (store (select |#memory_int#3_3| |main_~#c~0.base_4|) (+ (* main_~i~0_13 4) |main_~#c~0.offset_4|) v_ArrVal_17_fresh_1) v_ArrVal_18_fresh_1)) :named ssa_14))
(assert (! (<= ~N~0_1 main_~i~0_14) :named ssa_15))
(assert (! (= main_~i~0_16 1) :named ssa_16))
(assert (! (and (= (select (select |#memory_int#3_14| |main_~#c~0.base_4|) (+ (* main_~i~0_16 4) |main_~#c~0.offset_4|)) |main_#t~mem9_17|) (< main_~i~0_16 ~N~0_1)) :named ssa_17))
(assert (! true :named ssa_18_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_18| (ite (= |main_#t~mem9_17| 0) 1 0)) :named ssa_18_LocVarAssigCall))
