...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:11:27+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id watermelon.c_AllErrorsAtOnce_Iteration27)
...
(declare-fun v_main_~is_divisible2~0_32_fresh_1 () Int)
(declare-fun v_main_~is_divisible1~0_32_fresh_1 () Int)
...
(declare-fun correct_version_~w_17 () Int)
(declare-fun correct_version_~i~0_17 () Int)
(declare-fun correct_version_~i~0_18 () Int)
(declare-fun correct_version_~is_divisible~0_19 () Int)
(declare-fun |correct_version_#res_19| () Int)
...
(declare-fun main_~w~0_22 () Int)
(declare-fun |student_version_#in~w_22| () Int)
(declare-fun student_version_~w_23 () Int)
(declare-fun student_version_~is_divisible~1_23 () Int)
...
(declare-fun student_version_~w_32 () Int)
(declare-fun student_version_~i~1_33 () Int)
(declare-fun |student_version_#res_34| () Int)
(declare-fun student_version_~is_divisible~1_34 () Int)
(declare-fun |main_#t~ret6_35| () Int)
(declare-fun |student_version_#res_35| () Int)
(declare-fun |main_#t~ret6_36| () Int)
(declare-fun main_~is_divisible2~0_36 () Int)
(declare-fun |__VERIFIER_assert_#in~cond_37| () Int)
(declare-fun main_~is_divisible1~0_37 () Int)
(declare-fun main_~is_divisible2~0_37 () Int)
...
(assert (! (and (= ~true~0_1 v_main_~is_divisible2~0_32_fresh_1) (= ~true~0_1 v_main_~is_divisible1~0_32_fresh_1)) :named ssa_4))
...
(assert (! (<= correct_version_~w_7 correct_version_~i~0_15) :named ssa_16))
(assert (! (and (not (= correct_version_~i~0_15 correct_version_~w_7)) (= ~false~0_1 correct_version_~is_divisible~0_17)) :named ssa_17))
(assert (! true :named ssa_18))
(assert (! (= |correct_version_#res_19| correct_version_~is_divisible~0_17) :named ssa_19))
(assert (! (= |main_#t~ret5_20| |correct_version_#res_19|) :named ssa_20_return))
(assert (! (and (= main_~is_divisible1~0_21 |main_#t~ret5_20|) (<= 0 (+ |main_#t~ret5_20| 2147483648)) (<= |main_#t~ret5_20| 2147483647)) :named ssa_21))
(assert (! true :named ssa_22_GlobVarAssigCall))
(assert (! (= |student_version_#in~w_22| (ite (<= (mod main_~w~0_4 4294967296) 2147483647) (mod main_~w~0_4 4294967296) (+ (mod main_~w~0_4 4294967296) (- 4294967296)))) :named ssa_22_LocVarAssigCall))
(assert (! true :named ssa_22_OldVarAssigCall))
(assert (! (and (= student_version_~w_23 |student_version_#in~w_22|) (= ~true~0_1 student_version_~is_divisible~1_23)) :named ssa_23))
(assert (! (and (<= 4 student_version_~w_23) (= student_version_~i~1_24 0)) :named ssa_24))
(assert (! (and (= (+ 2 student_version_~i~1_24) student_version_~i~1_25) (< student_version_~i~1_24 student_version_~w_23)) :named ssa_25))
(assert (! (and (= (+ 2 student_version_~i~1_25) student_version_~i~1_26) (< student_version_~i~1_25 student_version_~w_23)) :named ssa_26))
(assert (! (and (= (+ 2 student_version_~i~1_26) student_version_~i~1_27) (< student_version_~i~1_26 student_version_~w_23)) :named ssa_27))
(assert (! (and (= (+ 2 student_version_~i~1_27) student_version_~i~1_28) (< student_version_~i~1_27 student_version_~w_23)) :named ssa_28))
(assert (! (and (= (+ 2 student_version_~i~1_28) student_version_~i~1_29) (< student_version_~i~1_28 student_version_~w_23)) :named ssa_29))
(assert (! (and (= (+ 2 student_version_~i~1_29) student_version_~i~1_30) (< student_version_~i~1_29 student_version_~w_23)) :named ssa_30))
(assert (! (<= student_version_~w_23 student_version_~i~1_30) :named ssa_31))
(assert (! (= student_version_~w_23 student_version_~i~1_30) :named ssa_32))
(assert (! true :named ssa_33))
(assert (! (= student_version_~is_divisible~1_23 |student_version_#res_34|) :named ssa_34))
(assert (! (= |main_#t~ret6_35| |student_version_#res_34|) :named ssa_35_return))
(assert (! (and (<= |main_#t~ret6_35| 2147483647) (= main_~is_divisible2~0_36 |main_#t~ret6_35|) (<= 0 (+ |main_#t~ret6_35| 2147483648))) :named ssa_36))
(assert (! true :named ssa_37_GlobVarAssigCall))
(assert (! (= (ite (= main_~is_divisible1~0_21 main_~is_divisible2~0_36) 1 0) |__VERIFIER_assert_#in~cond_37|) :named ssa_37_LocVarAssigCall))
...
(check-sat)
(get-interpolants (and ssa_0_LocVarAssigCall ssa_precond ssa_0_GlobVarAssigCall ssa_0_OldVarAssigCall ssa_2_return ssa_1) (and ssa_3_OldVarAssigCall ssa_3_LocVarAssigCall ssa_3_GlobVarAssigCall) ssa_4 ssa_5 (and ssa_13 ssa_7 ssa_16 ssa_10 ssa_14 ssa_8 ssa_9 ssa_19 ssa_6_OldVarAssigCall ssa_20_return ssa_12 ssa_6_GlobVarAssigCall ssa_11 ssa_15 ssa_6_LocVarAssigCall ssa_18 ssa_17) ssa_21 (and ssa_27 ssa_22_OldVarAssigCall ssa_31 ssa_26 ssa_34 ssa_25 ssa_22_LocVarAssigCall ssa_22_GlobVarAssigCall ssa_32 ssa_28 ssa_35_return ssa_29 ssa_23 ssa_30 ssa_33 ssa_24) ssa_36 (and ssa_37_LocVarAssigCall ssa_37_GlobVarAssigCall ssa_37_OldVarAssigCall) ssa_38 ssa_39 (and ssa_40 ssa_postcond))
...
(declare-fun correct_version_~w_10 () Int)
(declare-fun correct_version_~i~0_10 () Int)
(declare-fun correct_version_~i~0_11 () Int)
(declare-fun correct_version_~is_divisible~0_12 () Int)
(declare-fun |correct_version_#res_12| () Int)
(declare-fun |main_#t~ret5_13| () Int)
(declare-fun |correct_version_#res_13| () Int)
(assert (! true :named ssa_precond))
(assert (! (not (and (<= main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647)) (<= (+ (* (div main_~w~0_-2 4294967296) 4294967296) 13) main_~w~0_-2))) :named ssa_postcond))
...
(assert (! (<= correct_version_~w_0 correct_version_~i~0_8) :named ssa_9))
(assert (! (and (not (= correct_version_~i~0_8 correct_version_~w_0)) (= ~false~0_-1 correct_version_~is_divisible~0_10)) :named ssa_10))
(assert (! true :named ssa_11))
(assert (! (= |correct_version_#res_12| correct_version_~is_divisible~0_10) :named ssa_12))
(assert (! (= |main_#t~ret5_13| |correct_version_#res_12|) :named ssa_13_return))
(assert (! true :named ssa_-2_PendingContext))
...
(declare-fun student_version_~i~1_9 () Int)
(declare-fun student_version_~w_9 () Int)
(declare-fun student_version_~i~1_10 () Int)
(declare-fun |student_version_#res_11| () Int)
(declare-fun student_version_~is_divisible~1_11 () Int)
(declare-fun |main_#t~ret6_12| () Int)
...
(assert (! (<= student_version_~w_0 student_version_~i~1_7) :named ssa_8))
(assert (! (= student_version_~w_0 student_version_~i~1_7) :named ssa_9))
(assert (! true :named ssa_10))
(assert (! (= student_version_~is_divisible~1_0 |student_version_#res_11|) :named ssa_11))
(assert (! (= |main_#t~ret6_12| |student_version_#res_11|) :named ssa_12_return))
(assert (! (and (<= main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647)) (<= (+ (* (div main_~w~0_-2 4294967296) 4294967296) 13) main_~w~0_-2)) :named ssa_-2_PendingContext))
