...
(set-info :ultimate-id watermelon.c_AllErrorsAtOnce_Iteration32)
...
(declare-fun c_aux_v_main_~is_divisible1~0_36 () Int)
(declare-fun c_aux_v_main_~is_divisible2~0_36 () Int)
...
(declare-fun v_main_~is_divisible1~0_37_fresh_1 () Int)
(declare-fun v_main_~is_divisible2~0_37_fresh_1 () Int)
...
(assert (! (and (= ~true~0_1 v_main_~is_divisible1~0_37_fresh_1) (= ~true~0_1 v_main_~is_divisible2~0_37_fresh_1)) :named ssa_4))
...
(assert (! (and (= (+ 2 student_version_~i~1_31) student_version_~i~1_32) (< student_version_~i~1_31 student_version_~w_23)) :named ssa_32))
(assert (! (<= student_version_~w_23 student_version_~i~1_32) :named ssa_33))
(assert (! (and (not (= student_version_~w_23 student_version_~i~1_32)) (= ~false~0_1 student_version_~is_divisible~1_34)) :named ssa_34))
(assert (! true :named ssa_35))
(assert (! (= student_version_~is_divisible~1_34 |student_version_#res_36|) :named ssa_36))
...
(assert (! (= (ite (= main_~is_divisible1~0_21 main_~is_divisible2~0_38) 1 0) |__VERIFIER_assert_#in~cond_39|) :named ssa_39_LocVarAssigCall))
...
(assert (! true :named ssa_precond))
(assert (! (not (or (< (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647) main_~w~0_-2) (< main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 15)))) :named ssa_postcond))
...
(declare-fun student_version_~w_11 () Int)
(declare-fun student_version_~is_divisible~1_11 () Int)
(declare-fun student_version_~i~1_12 () Int)
(declare-fun |student_version_#res_13| () Int)
(declare-fun student_version_~is_divisible~1_13 () Int)
(declare-fun |main_#t~ret6_14| () Int)
(declare-fun |student_version_#res_14| () Int)
(assert (! true :named ssa_precond))
(assert (! (not false) :named ssa_postcond))
...
(assert (! (and (= (+ 2 student_version_~i~1_8) student_version_~i~1_9) (< student_version_~i~1_8 student_version_~w_0)) :named ssa_9))
(assert (! (<= student_version_~w_0 student_version_~i~1_9) :named ssa_10))
(assert (! (and (not (= student_version_~w_0 student_version_~i~1_9)) (= ~false~0_-1 student_version_~is_divisible~1_11)) :named ssa_11))
(assert (! true :named ssa_12))
(assert (! (= student_version_~is_divisible~1_11 |student_version_#res_13|) :named ssa_13))
(assert (! (= |main_#t~ret6_14| |student_version_#res_13|) :named ssa_14_return))
(assert (! (or (< (+ (* (div main_~w~0_-2 4294967296) 4294967296) 2147483647) main_~w~0_-2) (< main_~w~0_-2 (+ (* (div main_~w~0_-2 4294967296) 4294967296) 15))) :named ssa_-2_PendingContext))
