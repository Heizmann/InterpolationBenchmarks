...
(set-info :ultimate-id mono-crafted_11.c_AllErrorsAtOnce_Iteration19)
...
(assert (! (<= 100000000 (mod main_~x~0_38 4294967296)) :named ssa_39))
(assert (! true :named ssa_40_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_40| (ite (= (mod main_~x~0_38 2) 0) 1 0)) :named ssa_40_LocVarAssigCall))
