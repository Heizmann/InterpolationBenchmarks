...
(set-info :ultimate-id psyco_abp_1-3.c_AllErrorsAtOnce_Iteration1)
...
(declare-fun v_main_~P7~0_4_fresh_1 () Int)
(declare-fun v_main_~P5~0_4_fresh_1 () Int)
(declare-fun v_main_~P2~0_4_fresh_1 () Int)
(declare-fun |main_#t~nondet13_7| () Int)
(declare-fun |main_#t~nondet13_8| () Int)
(declare-fun v_main_~method_id~0_64_fresh_1 () Int)
...
(assert (! (and (<= main_~P4~0_6 2147483647) (<= 0 (+ main_~P1~0_6 2147483648)) (<= 0 (+ v_main_~P7~0_4_fresh_1 2147483648)) (<= main_~P3~0_6 2147483647) (<= main_~P8~0_6 2147483647) (<= 0 (+ main_~P8~0_6 2147483648)) (<= 0 (+ main_~P6~0_6 2147483648)) (<= 0 (+ v_main_~P2~0_4_fresh_1 2147483648)) (<= 0 (+ main_~P3~0_6 2147483648)) (<= 0 (+ main_~P9~0_6 2147483648)) (<= v_main_~P2~0_4_fresh_1 2147483647) (<= 0 (+ v_main_~P5~0_4_fresh_1 2147483648)) (<= main_~P9~0_6 2147483647) (<= v_main_~P7~0_4_fresh_1 2147483647) (<= 0 (+ main_~P4~0_6 2147483648)) (<= v_main_~P5~0_4_fresh_1 2147483647) (<= main_~P1~0_6 2147483647) (<= main_~P6~0_6 2147483647)) :named ssa_6))
...
(assert (! (= 1 v_main_~method_id~0_64_fresh_1) :named ssa_9))
