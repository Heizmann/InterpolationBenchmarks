...
(set-info :ultimate-id num_conversion_2.c_AllErrorsAtOnce_Iteration7)
...
(assert (! (<= 8 (mod main_~c~0_32 256)) :named ssa_33))
(assert (! true :named ssa_34_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_34| (ite (= (mod main_~x~0_4 256) (mod main_~y~0_4 256)) 1 0)) :named ssa_34_LocVarAssigCall))
