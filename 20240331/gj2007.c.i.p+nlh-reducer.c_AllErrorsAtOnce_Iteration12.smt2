...
(set-info :ultimate-id gj2007.c.i.p+nlh-reducer.c_AllErrorsAtOnce_Iteration12)
...
(assert (! (and (= main_~main__y~0_46 (+ main_~main__y~0_4 1)) (= main_~main__x~0_46 (+ main_~main__x~0_44 1)) (<= 50 main_~main__x~0_44)) :named ssa_46))
...
(assert (! (and (= v_main_~__tmp_1~0_15_fresh_1 main_~__VERIFIER_assert__cond~0_139) (<= 100 main_~main__x~0_138) (= v_main_~__tmp_1~0_15_fresh_1 (ite (= main_~main__y~0_138 100) 1 0))) :named ssa_139))
