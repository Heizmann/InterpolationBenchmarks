...
(set-info :ultimate-id mono-crafted_11.c_AllErrorsAtOnce_Iteration33)
...
(assert (! (<= 100000000 (mod main_~x~0_66 4294967296)) :named ssa_67))
(assert (! true :named ssa_68_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_68| (ite (= (mod main_~x~0_66 2) 0) 1 0)) :named ssa_68_LocVarAssigCall))
