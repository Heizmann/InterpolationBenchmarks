...
(set-logic ALL)
(set-info :source |SMT script generated on 2024-03-31T00:18:21+01:00 by Ultimate (https://ultimate.informatik.uni-freiburg.de/)|)
(set-info :smt-lib-version 2.5)
(set-info :category "industrial")
(set-info :ultimate-id duplets.c_AllErrorsAtOnce_Iteration8)
...
(declare-fun v_mkdup_~x~0_19_fresh_1 () Int)
...
(declare-fun finddup_~j~1_40 () Int)
(declare-fun |finddup_#t~post11_41| () Int)
(declare-fun finddup_~i~1_41 () Int)
(declare-fun finddup_~j~1_42 () Int)
(declare-fun finddup_~j~1_43 () Int)
(declare-fun |finddup_#t~post11_44| () Int)
(declare-fun finddup_~i~1_44 () Int)
(declare-fun finddup_~n_45 () Int)
(declare-fun finddup_~i~1_45 () Int)
...
(assert (! (and (not (= 0 |main_#t~malloc13.base_10|)) (< |main_#t~malloc13.base_10| |#StackHeapBarrier_-1|) (= |main_#t~malloc13.offset_10| 0) (= (select |#valid_3| |main_#t~malloc13.base_10|) 0) (= v_ArrVal_124_fresh_1 1) (= v_ArrVal_123_fresh_1 (* 4 (mod main_~n~0_4 1073741824))) (= (store |#valid_3| |main_#t~malloc13.base_10| v_ArrVal_124_fresh_1) |#valid_10|) (= |#length_10| (store |#length_3| |main_#t~malloc13.base_10| v_ArrVal_123_fresh_1))) :named ssa_10))
(assert (! (= |old(#memory_int#2)_11| |#memory_int#2_11|) :named ssa_11_GlobVarAssigCall))
(assert (! (and (= |v_#Ultimate.meminit_#sizeOfFieldsInParam_10_fresh_1| 4) (= main_~n~0_4 |v_#Ultimate.meminit_#amountOfFieldsInParam_10_fresh_1|) (= |v_#Ultimate.meminit_#productInParam_10_fresh_1| (* main_~n~0_4 4)) (= |v_#Ultimate.meminit_#ptr.offsetInParam_10_fresh_1| |main_#t~malloc13.offset_10|) (= |#Ultimate.meminit_#ptr.base_11| |main_#t~malloc13.base_10|)) :named ssa_11_LocVarAssigCall))
(assert (! (= |old(#memory_int#2)_11| |#memory_int#2_3|) :named ssa_11_OldVarAssigCall))
(assert (! (and (= ((as const (Array Int Int)) 0) v_ArrVal_125_fresh_1) (= |#memory_int#2_12| (store |#memory_int#2_11| |#Ultimate.meminit_#ptr.base_11| v_ArrVal_125_fresh_1))) :named ssa_12))
...
(assert (! (and (= v_ArrVal_127_fresh_1 v_mkdup_~x~0_19_fresh_1) (<= v_mkdup_~x~0_19_fresh_1 2147483647) (= v_ArrVal_128_fresh_1 v_mkdup_~x~0_19_fresh_1) (= v_ArrVal_126_fresh_1 (store (store (select |#memory_int#2_15| mkdup_~a.base_16) (+ (* mkdup_~i~0_16 4) mkdup_~a.offset_16) v_mkdup_~x~0_19_fresh_1) (+ mkdup_~a.offset_16 (* mkdup_~j~0_16 4)) v_mkdup_~x~0_19_fresh_1)) (<= 0 (+ v_mkdup_~x~0_19_fresh_1 2147483648)) (= |#memory_int#2_32| (store |#memory_int#2_15| mkdup_~a.base_16 v_ArrVal_126_fresh_1))) :named ssa_32))
(assert (! true :named ssa_33_return))
(assert (! (and (= |main_~#i~2.offset_34| 0) (= v_ArrVal_130_fresh_1 1) (= (select (store |#valid_10| |main_~#i~2.base_34| v_ArrVal_130_fresh_1) |main_~#j~2.base_34|) 0) (= v_ArrVal_129_fresh_1 4) (= (select |#valid_10| |main_~#i~2.base_34|) 0) (= v_ArrVal_132_fresh_1 1) (= |main_~#j~2.offset_34| 0) (= (store (store |#length_10| |main_~#i~2.base_34| v_ArrVal_129_fresh_1) |main_~#j~2.base_34| v_ArrVal_131_fresh_1) |#length_34|) (not (= |main_~#j~2.base_34| 0)) (< |#StackHeapBarrier_-1| |main_~#j~2.base_34|) (not (= |main_~#i~2.base_34| 0)) (= (store (store |#valid_10| |main_~#i~2.base_34| v_ArrVal_130_fresh_1) |main_~#j~2.base_34| v_ArrVal_132_fresh_1) |#valid_34|) (< |#StackHeapBarrier_-1| |main_~#i~2.base_34|) (= v_ArrVal_131_fresh_1 4)) :named ssa_34))
...
(assert (! (<= finddup_~n_36 finddup_~j~1_39) :named ssa_40))
(assert (! (= finddup_~i~1_41 (+ finddup_~i~1_36 1)) :named ssa_41))
(assert (! (and (< finddup_~i~1_41 finddup_~n_36) (= finddup_~j~1_42 (+ finddup_~i~1_41 1))) :named ssa_42))
(assert (! (<= finddup_~n_36 finddup_~j~1_42) :named ssa_43))
(assert (! (= finddup_~i~1_44 (+ finddup_~i~1_41 1)) :named ssa_44))
(assert (! (<= finddup_~n_36 finddup_~i~1_44) :named ssa_45))
(assert (! (= |finddup_#res_46| 0) :named ssa_46))
...
(assert (! (not (= |main_#t~malloc13.offset_-2| 0)) :named ssa_postcond))
(assert (! (and (= |#memory_int#2_0| (store |#memory_int#2_-1| |#Ultimate.meminit_#ptr.base_-1| v_ArrVal_133_fresh_1)) (= ((as const (Array Int Int)) 0) v_ArrVal_133_fresh_1)) :named ssa_0))
(assert (! true :named ssa_1_return))
(assert (! (= |main_#t~malloc13.offset_-2| 0) :named ssa_-2_PendingContext))
...
(declare-fun v_mkdup_~x~0_20_fresh_1 () Int)
(declare-fun v_ArrVal_134_fresh_1 () (Array Int Int))
(assert (! (= |#memory_int#2_-1| |old(#memory_int#2)_-1|) :named ssa_precond))
(assert (! (not (and (or (and (= main_~n~0_-2 2) (= (select (select |#memory_int#2_16| main_~a~0.base_-2) 4) (select (select |#memory_int#2_16| main_~a~0.base_-2) 0))) (< 2 main_~n~0_-2)) (= main_~a~0.offset_-2 0))) :named ssa_postcond))
...
(assert (! (and (= v_ArrVal_134_fresh_1 (store (store (select |#memory_int#2_-1| mkdup_~a.base_0) (+ (* mkdup_~i~0_0 4) mkdup_~a.offset_0) v_mkdup_~x~0_20_fresh_1) (+ mkdup_~a.offset_0 (* mkdup_~j~0_0 4)) v_mkdup_~x~0_20_fresh_1)) (= (store |#memory_int#2_-1| mkdup_~a.base_0 v_ArrVal_134_fresh_1) |#memory_int#2_16|) (= v_ArrVal_135_fresh_1 v_mkdup_~x~0_20_fresh_1) (= v_ArrVal_136_fresh_1 v_mkdup_~x~0_20_fresh_1) (<= v_mkdup_~x~0_20_fresh_1 2147483647) (<= 0 (+ v_mkdup_~x~0_20_fresh_1 2147483648))) :named ssa_16))
...
(declare-fun |#memory_int#2_-2| () (Array Int (Array Int Int)))
(declare-fun |old(#memory_int#2)_-2| () (Array Int (Array Int Int)))
(declare-fun |mkdup_#in~a.base_-2| () Int)
(declare-fun |mkdup_#in~n_-2| () Int)
(declare-fun mkdup_~n_-2 () Int)
(declare-fun |mkdup_#in~a.offset_-2| () Int)
(declare-fun mkdup_~a.offset_-2 () Int)
(declare-fun mkdup_~j~0_-2 () Int)
(declare-fun mkdup_~a.base_-2 () Int)
...
(declare-fun assume_abort_if_not_~cond_1 () Int)
(assert (! true :named ssa_precond))
(assert (! (not (or (and (= |mkdup_#in~n_-2| mkdup_~n_-2) (or (= mkdup_~a.offset_-2 0) (= |mkdup_#in~a.offset_-2| mkdup_~a.offset_-2)) (or (and (or (not (= mkdup_~j~0_-2 0)) (and (= mkdup_~a.base_-2 |mkdup_#in~a.base_-2|) (<= (+ mkdup_~i~0_-2 1) mkdup_~n_-2))) (or (< mkdup_~j~0_-2 1) (< mkdup_~i~0_-2 (+ mkdup_~j~0_-2 1)) (< mkdup_~i~0_-2 mkdup_~n_-2)) (or (and (= mkdup_~i~0_-2 0) (= mkdup_~a.base_-2 |mkdup_#in~a.base_-2|)) (< mkdup_~j~0_-2 mkdup_~i~0_-2) (< 1 mkdup_~j~0_-2))) (not (= mkdup_~a.offset_-2 0)))) (= mkdup_~j~0_-2 mkdup_~i~0_-2))) :named ssa_postcond))
(assert (! (= |assume_abort_if_not_#in~cond_-1| assume_abort_if_not_~cond_0) :named ssa_0))
(assert (! (not (= assume_abort_if_not_~cond_0 0)) :named ssa_1))
(assert (! true :named ssa_2))
(assert (! true :named ssa_3_return))
(assert (! (or (= mkdup_~j~0_-2 mkdup_~i~0_-2) (and (= |mkdup_#in~n_-2| mkdup_~n_-2) (or (= mkdup_~a.offset_-2 0) (= |mkdup_#in~a.offset_-2| mkdup_~a.offset_-2)) (or (not (= mkdup_~a.offset_-2 0)) (and (or (not (= mkdup_~j~0_-2 0)) (= mkdup_~a.base_-2 |mkdup_#in~a.base_-2|)) (or (not (= mkdup_~j~0_-2 1)) (= mkdup_~a.base_-2 |mkdup_#in~a.base_-2|) (not (= mkdup_~i~0_-2 0))))))) :named ssa_-2_PendingContext))
...
(declare-fun assume_abort_if_not_~cond_1 () Int)
(assert (! true :named ssa_precond))
(assert (! (not (or (and (or (= mkdup_~a.offset_-2 0) (= |mkdup_#in~a.offset_-2| mkdup_~a.offset_-2)) (or (not (= mkdup_~a.offset_-2 0)) (and (<= 0 mkdup_~j~0_-2) (<= (+ mkdup_~i~0_-2 1) |mkdup_#in~n_-2|) (or (not (= mkdup_~j~0_-2 0)) (= mkdup_~a.base_-2 |mkdup_#in~a.base_-2|)) (or (< mkdup_~j~0_-2 mkdup_~i~0_-2) (and (or (and (= mkdup_~i~0_-2 0) (= mkdup_~a.base_-2 |mkdup_#in~a.base_-2|)) (< 1 mkdup_~j~0_-2)) (<= (+ mkdup_~j~0_-2 1) |mkdup_#in~n_-2|)))))) (= mkdup_~j~0_-2 mkdup_~i~0_-2))) :named ssa_postcond))
(assert (! (= |assume_abort_if_not_#in~cond_-1| assume_abort_if_not_~cond_0) :named ssa_0))
(assert (! (not (= assume_abort_if_not_~cond_0 0)) :named ssa_1))
(assert (! true :named ssa_2))
(assert (! true :named ssa_3_return))
(assert (! (or (and (= |mkdup_#in~n_-2| mkdup_~n_-2) (or (= mkdup_~a.offset_-2 0) (= |mkdup_#in~a.offset_-2| mkdup_~a.offset_-2)) (or (and (or (not (= mkdup_~j~0_-2 0)) (and (= mkdup_~a.base_-2 |mkdup_#in~a.base_-2|) (<= (+ mkdup_~i~0_-2 1) mkdup_~n_-2))) (or (< mkdup_~j~0_-2 1) (< mkdup_~i~0_-2 (+ mkdup_~j~0_-2 1)) (< mkdup_~i~0_-2 mkdup_~n_-2)) (or (and (= mkdup_~i~0_-2 0) (= mkdup_~a.base_-2 |mkdup_#in~a.base_-2|)) (< mkdup_~j~0_-2 mkdup_~i~0_-2) (< 1 mkdup_~j~0_-2))) (not (= mkdup_~a.offset_-2 0)))) (= mkdup_~j~0_-2 mkdup_~i~0_-2)) :named ssa_-2_PendingContext))
...
(declare-fun assume_abort_if_not_~cond_1 () Int)
(assert (! true :named ssa_precond))
(assert (! (not (and (or (= mkdup_~a.offset_-2 0) (= |mkdup_#in~a.offset_-2| mkdup_~a.offset_-2)) (not (= mkdup_~j~0_-2 mkdup_~i~0_-2)) (or (not (= mkdup_~a.offset_-2 0)) (and (<= 0 mkdup_~j~0_-2) (<= (+ mkdup_~i~0_-2 1) |mkdup_#in~n_-2|) (or (not (= mkdup_~j~0_-2 0)) (= mkdup_~a.base_-2 |mkdup_#in~a.base_-2|)) (or (< mkdup_~j~0_-2 mkdup_~i~0_-2) (and (or (and (= mkdup_~i~0_-2 0) (= mkdup_~a.base_-2 |mkdup_#in~a.base_-2|)) (< 1 mkdup_~j~0_-2)) (<= (+ mkdup_~j~0_-2 1) |mkdup_#in~n_-2|))))))) :named ssa_postcond))
(assert (! (= |assume_abort_if_not_#in~cond_-1| assume_abort_if_not_~cond_0) :named ssa_0))
(assert (! (not (= assume_abort_if_not_~cond_0 0)) :named ssa_1))
(assert (! true :named ssa_2))
(assert (! true :named ssa_3_return))
(assert (! (or (and (or (= mkdup_~a.offset_-2 0) (= |mkdup_#in~a.offset_-2| mkdup_~a.offset_-2)) (or (not (= mkdup_~a.offset_-2 0)) (and (<= 0 mkdup_~j~0_-2) (<= (+ mkdup_~i~0_-2 1) |mkdup_#in~n_-2|) (or (not (= mkdup_~j~0_-2 0)) (= mkdup_~a.base_-2 |mkdup_#in~a.base_-2|)) (or (< mkdup_~j~0_-2 mkdup_~i~0_-2) (and (or (and (= mkdup_~i~0_-2 0) (= mkdup_~a.base_-2 |mkdup_#in~a.base_-2|)) (< 1 mkdup_~j~0_-2)) (<= (+ mkdup_~j~0_-2 1) |mkdup_#in~n_-2|)))))) (= mkdup_~j~0_-2 mkdup_~i~0_-2)) :named ssa_-2_PendingContext))
...
(declare-fun finddup_~j~1_4 () Int)
(declare-fun |finddup_#t~post11_5| () Int)
(declare-fun finddup_~i~1_5 () Int)
(declare-fun finddup_~j~1_6 () Int)
(declare-fun finddup_~j~1_7 () Int)
(declare-fun |finddup_#t~post11_8| () Int)
(declare-fun finddup_~i~1_8 () Int)
(declare-fun finddup_~n_9 () Int)
(declare-fun finddup_~i~1_9 () Int)
...
(assert (! (<= finddup_~n_0 finddup_~j~1_3) :named ssa_4))
(assert (! (= finddup_~i~1_5 (+ finddup_~i~1_0 1)) :named ssa_5))
(assert (! (and (< finddup_~i~1_5 finddup_~n_0) (= finddup_~j~1_6 (+ finddup_~i~1_5 1))) :named ssa_6))
(assert (! (<= finddup_~n_0 finddup_~j~1_6) :named ssa_7))
(assert (! (= finddup_~i~1_8 (+ finddup_~i~1_5 1)) :named ssa_8))
(assert (! (<= finddup_~n_0 finddup_~i~1_8) :named ssa_9))
(assert (! (= |finddup_#res_10| 0) :named ssa_10))
(assert (! true :named ssa_11))
(assert (! (= |main_#t~ret14_12| |finddup_#res_10|) :named ssa_12_return))
(assert (! (and (= main_~a~0.offset_-2 0) (or (< 2 main_~n~0_-2) (= (select (select |#memory_int#2_-2| main_~a~0.base_-2) 4) (select (select |#memory_int#2_-2| main_~a~0.base_-2) 0)))) :named ssa_-2_PendingContext))
