...
(set-info :ultimate-id gj2007.c.i.p+nlh-reducer.c_AllErrorsAtOnce_Iteration3)
...
(assert (! (and (= (+ main_~main__y~0_10 1) main_~main__y~0_12) (<= 50 main_~main__x~0_10) (= (+ main_~main__x~0_10 1) main_~main__x~0_12)) :named ssa_12))
(assert (! (< main_~main__x~0_12 100) :named ssa_13))
(assert (! (and (= (+ main_~main__y~0_12 1) main_~main__y~0_14) (= main_~main__x~0_14 (+ main_~main__x~0_12 1)) (<= 50 main_~main__x~0_12)) :named ssa_14))
(assert (! (< main_~main__x~0_14 100) :named ssa_15))
(assert (! (and (<= 50 main_~main__x~0_14) (= (+ main_~main__x~0_14 1) main_~main__x~0_16) (= (+ main_~main__y~0_14 1) main_~main__y~0_16)) :named ssa_16))
(assert (! (< main_~main__x~0_16 100) :named ssa_17))
(assert (! (and (= (+ main_~main__y~0_16 1) main_~main__y~0_18) (= (+ main_~main__x~0_16 1) main_~main__x~0_18) (<= 50 main_~main__x~0_16)) :named ssa_18))
(assert (! (< main_~main__x~0_18 100) :named ssa_19))
(assert (! (and (<= 50 main_~main__x~0_18) (= main_~main__y~0_20 (+ main_~main__y~0_18 1)) (= (+ main_~main__x~0_18 1) main_~main__x~0_20)) :named ssa_20))
(assert (! (< main_~main__x~0_20 100) :named ssa_21))
(assert (! (and (= (+ main_~main__x~0_20 1) main_~main__x~0_22) (<= 50 main_~main__x~0_20) (= (+ main_~main__y~0_20 1) main_~main__y~0_22)) :named ssa_22))
(assert (! (< main_~main__x~0_22 100) :named ssa_23))
(assert (! (and (<= 50 main_~main__x~0_22) (= main_~main__y~0_24 (+ main_~main__y~0_22 1)) (= (+ main_~main__x~0_22 1) main_~main__x~0_24)) :named ssa_24))
(assert (! (< main_~main__x~0_24 100) :named ssa_25))
(assert (! (and (= (+ main_~main__y~0_24 1) main_~main__y~0_26) (= (+ main_~main__x~0_24 1) main_~main__x~0_26) (<= 50 main_~main__x~0_24)) :named ssa_26))
(assert (! (< main_~main__x~0_26 100) :named ssa_27))
(assert (! (and (= (+ main_~main__x~0_26 1) main_~main__x~0_28) (= (+ main_~main__y~0_26 1) main_~main__y~0_28) (<= 50 main_~main__x~0_26)) :named ssa_28))
...
(assert (! (and (= v_main_~__tmp_1~0_6_fresh_1 (ite (= main_~main__y~0_138 100) 1 0)) (= v_main_~__tmp_1~0_6_fresh_1 main_~__VERIFIER_assert__cond~0_139) (<= 100 main_~main__x~0_138)) :named ssa_139))
