...
(set-info :ultimate-id mapsum3.i_AllErrorsAtOnce_Iteration19)
...
(assert (! (and (= mapsum_~ret~0_22 (+ mapsum_~ret~0_21 mapsum_~i~0_21 (select (select |#memory_int#1_17| mapsum_~x.base_21) (+ (* mapsum_~i~0_21 4) mapsum_~x.offset_21)))) (< mapsum_~i~0_21 10000) (= (+ mapsum_~i~0_21 1) mapsum_~i~0_22)) :named ssa_22))
(assert (! (and (= mapsum_~ret~0_23 (+ mapsum_~ret~0_22 mapsum_~i~0_22 (select (select |#memory_int#1_17| mapsum_~x.base_21) (+ (* mapsum_~i~0_22 4) mapsum_~x.offset_21)))) (< mapsum_~i~0_22 10000) (= (+ mapsum_~i~0_22 1) mapsum_~i~0_23)) :named ssa_23))
(assert (! (<= 10000 mapsum_~i~0_23) :named ssa_24))
...
(assert (! (and (= v_ArrVal_377_fresh_1 (store (select |#memory_int#1_27| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| (* main_~i~2_35 4)) v_ArrVal_376_fresh_1)) (= |#memory_int#1_36| (store |#memory_int#1_27| |main_~#x~0.base_4| v_ArrVal_377_fresh_1)) (= main_~i~2_36 (+ main_~i~2_35 1)) (< main_~i~2_35 9999) (= v_ArrVal_376_fresh_1 (select (select |#memory_int#1_27| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4 (* main_~i~2_35 4))))) :named ssa_36))
(assert (! (and (= |#memory_int#1_37| (store |#memory_int#1_36| |main_~#x~0.base_4| v_ArrVal_379_fresh_1)) (= main_~i~2_37 (+ main_~i~2_36 1)) (= v_ArrVal_379_fresh_1 (store (select |#memory_int#1_36| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| (* main_~i~2_36 4)) v_ArrVal_378_fresh_1)) (< main_~i~2_36 9999) (= v_ArrVal_378_fresh_1 (select (select |#memory_int#1_36| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4 (* main_~i~2_36 4))))) :named ssa_37))
(assert (! (<= 9999 main_~i~2_37) :named ssa_38))
(assert (! (and (= v_ArrVal_380_fresh_1 main_~temp~0_35) (= (store |#memory_int#1_37| |main_~#x~0.base_4| v_ArrVal_381_fresh_1) |#memory_int#1_39|) (= v_ArrVal_381_fresh_1 (store (select |#memory_int#1_37| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 39996) v_ArrVal_380_fresh_1))) :named ssa_39))
