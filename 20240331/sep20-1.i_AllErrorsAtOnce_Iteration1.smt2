...
(set-info :ultimate-id sep20-1.i_AllErrorsAtOnce_Iteration1)
...
(assert (! (and (= main_~i~1_4 0) (= |#valid_4| (store |#valid_3| |main_~#x~0.base_4| v_ArrVal_2_fresh_1)) (= |main_~#x~0.offset_4| 0) (= (select |#valid_3| |main_~#x~0.base_4|) 0) (< |#StackHeapBarrier_-1| |main_~#x~0.base_4|) (= v_ArrVal_1_fresh_1 80) (not (= |main_~#x~0.base_4| 0)) (= v_ArrVal_2_fresh_1 1) (= (store |#length_3| |main_~#x~0.base_4| v_ArrVal_1_fresh_1) |#length_4|)) :named ssa_4))
...
(assert (! (and (= v_main_~temp~0_6_fresh_1 v_ArrVal_4_fresh_1) (= (store (store (select |#memory_int#1_3| |main_~#x~0.base_4|) |main_~#x~0.offset_4| v_ArrVal_3_fresh_1) (+ |main_~#x~0.offset_4| 4) v_ArrVal_4_fresh_1) v_ArrVal_5_fresh_1) (<= |main_#t~ret7_11| 2147483647) (= (select (select |#memory_int#1_3| |main_~#x~0.base_4|) (+ |main_~#x~0.offset_4| 4)) v_ArrVal_3_fresh_1) (= |main_#t~ret7_11| main_~ret~1_12) (<= 0 (+ |main_#t~ret7_11| 2147483648)) (= (select (select |#memory_int#1_3| |main_~#x~0.base_4|) |main_~#x~0.offset_4|) v_main_~temp~0_6_fresh_1) (= (store |#memory_int#1_3| |main_~#x~0.base_4| v_ArrVal_5_fresh_1) |#memory_int#1_12|)) :named ssa_12))
...
(assert (! (and (= main_~temp~0_18 v_ArrVal_7_fresh_1) (= (store |#memory_int#1_12| |main_~#x~0.base_4| v_ArrVal_6_fresh_1) |#memory_int#1_20|) (= (store (select |#memory_int#1_12| |main_~#x~0.base_4|) (+ 76 |main_~#x~0.offset_4|) main_~temp~0_18) v_ArrVal_6_fresh_1)) :named ssa_20))
