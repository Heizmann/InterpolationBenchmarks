...
(set-info :ultimate-id id2_b3_o5.c_AllErrorsAtOnce_Iteration4)
...
(assert (! (and (= 3 |id2_#res_17|) (< 3 (mod id2_~ret~1_16 4294967296))) :named ssa_17))
...
(assert (! (and (= 3 |id2_#res_11|) (< 3 (mod id2_~ret~1_10 4294967296))) :named ssa_11))
...
(assert (! (and (= 3 |id2_#res_8|) (< 3 (mod id2_~ret~1_7 4294967296))) :named ssa_8))
