...
(set-info :ultimate-id test_locks_8.c_AllErrorsAtOnce_Iteration19)
...
(declare-fun main_~lk7~0_22 () Int)
...
(assert (! (not (= main_~p7~0_4 0)) :named ssa_21))
(assert (! (not (= main_~lk7~0_6 1)) :named ssa_22))
