...
(set-info :ultimate-id count_by_2.i_AllErrorsAtOnce_Iteration16)
...
(assert (! (<= 1000000 main_~i~0_19) :named ssa_20))
(assert (! true :named ssa_21_GlobVarAssigCall))
(assert (! (= |__VERIFIER_assert_#in~cond_21| (ite (= main_~i~0_19 1000000) 1 0)) :named ssa_21_LocVarAssigCall))
